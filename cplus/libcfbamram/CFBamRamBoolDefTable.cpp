...
// Description: C++18 Implementation for an in-memory RAM DbIO for BoolDef.
...
namespace cfbam {
	...
	const std::string CFBamRamBoolDefTable::CLASS_NAME( "CFBamRamBoolDefTable" );

	CFBamRamBoolDefTable::CFBamRamBoolDefTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamBoolDefTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamBoolDefBuff*>();
	}

	CFBamRamBoolDefTable::~CFBamRamBoolDefTable() {
		if( dictByPKey != NULL ) {
			delete dictByPKey;
			dictByPKey = NULL;
		}
	...
	cfbam::CFBamBoolDefBuff* CFBamRamBoolDefTable::createBoolDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamBoolDefBuff* Buff )
	{
		...
		cfbam::CFBamBoolDefBuff* buff = dynamic_cast<cfbam::CFBamBoolDefBuff*>( schema->getTableAtom()->createAtom( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamBoolDefBuff*>::value_type( pkey, buff ) );

		// The top level code has to clone the final buffer. The one passed in is now part of the persistent storage.
		if( buff->getClassCode() == cfbam::CFBamBoolDefBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamBoolDefBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamBoolDefBuff* CFBamRamBoolDefTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamBoolDefBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamBoolDefBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamBoolDefBuff* CFBamRamBoolDefTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> CFBamRamBoolDefTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamBoolDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamBoolDefBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamBoolDefBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamBoolDefBuff*>( iter->second->clone() );
	...
	cfbam::CFBamBoolDefBuff* CFBamRamBoolDefTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamBoolDefBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamBoolDefBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> CFBamRamBoolDefTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamBoolDefBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamBoolDefBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> CFBamRamBoolDefTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> CFBamRamBoolDefTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> CFBamRamBoolDefTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> CFBamRamBoolDefTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> CFBamRamBoolDefTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> CFBamRamBoolDefTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	cfbam::CFBamBoolDefBuff* CFBamRamBoolDefTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamBoolDefBuff* CFBamRamBoolDefTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamBoolDefBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamBoolDefBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamBoolDefBuff* CFBamRamBoolDefTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamBoolDefBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamBoolDefBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> CFBamRamBoolDefTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamBoolDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamBoolDefBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamBoolDefBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamBoolDefBuff* CFBamRamBoolDefTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamBoolDefBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamBoolDefBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamBoolDefBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamBoolDefBuff* CFBamRamBoolDefTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamBoolDefBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> CFBamRamBoolDefTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamBoolDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> CFBamRamBoolDefTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamBoolDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> CFBamRamBoolDefTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamBoolDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> CFBamRamBoolDefTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamBoolDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> CFBamRamBoolDefTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamBoolDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> CFBamRamBoolDefTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamBoolDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> CFBamRamBoolDefTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamBoolDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	cfbam::CFBamBoolDefBuff* CFBamRamBoolDefTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamBoolDefBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamBoolDefBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamBoolDefBuff*>( editCur ) );
	}

	cfbam::CFBamBoolDefBuff* CFBamRamBoolDefTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamBoolDefBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamBoolDefBuff* CFBamRamBoolDefTable::updateBoolDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamBoolDefBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in BoolDef for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamBoolDefBuff* existing = searchExisting->second;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamBoolDefBuff*>( schema->getTableAtom()->updateAtom( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamBoolDefBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamBoolDefBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamBoolDefBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamBoolDefBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamBoolDefBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamBoolDefTable::deleteBoolDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamBoolDefBuff* Buff )
	{
		static const std::string S_ProcName( "deleteBoolDef" );
		...
		{
			cfbam::CFBamBoolTypeBuff* refIdIdx = dynamic_cast<cfbam::CFBamBoolTypeBuff*>( schema->getTableBoolType()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table BoolType for primary key " + pkey.toString() );
		...
		{
			cfbam::CFBamBoolColBuff* refIdIdx = dynamic_cast<cfbam::CFBamBoolColBuff*>( schema->getTableBoolCol()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table BoolCol for primary key " + pkey.toString() );
				throw cflib::CFLibDependentsDetectedException( CLASS_NAME,
					S_ProcName,
					Msg );
			}
	...
	void CFBamRamBoolDefTable::deleteBoolDefByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteBoolDefByIdIdx" );
		...
		cfbam::CFBamBoolDefBuff* cur = NULL;
		cfbam::CFBamBoolDefBuff* rereadCur = NULL;
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamBoolDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamBoolDefBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamValueBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamBoolDefBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamBoolDefBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamBoolDefBuff::CLASS_CODE ) {
	...
	void CFBamRamBoolDefTable::deleteBoolDefByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteBoolDefByUNameIdx" );
		cfbam::CFBamBoolDefBuff* cur = NULL;
		cfbam::CFBamBoolDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamBoolDefTable::deleteBoolDefByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteBoolDefByValTentIdx" );
		cfbam::CFBamBoolDefBuff* cur = NULL;
		cfbam::CFBamBoolDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamBoolDefTable::deleteBoolDefByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteBoolDefByScopeIdx" );
		cfbam::CFBamBoolDefBuff* cur = NULL;
		cfbam::CFBamBoolDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamBoolDefTable::deleteBoolDefByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteBoolDefByDefSchemaIdx" );
		cfbam::CFBamBoolDefBuff* cur = NULL;
		cfbam::CFBamBoolDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamBoolDefTable::deleteBoolDefByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteBoolDefByPrevIdx" );
		cfbam::CFBamBoolDefBuff* cur = NULL;
		cfbam::CFBamBoolDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamBoolDefTable::deleteBoolDefByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteBoolDefByNextIdx" );
		cfbam::CFBamBoolDefBuff* cur = NULL;
		cfbam::CFBamBoolDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamBoolDefTable::deleteBoolDefByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteBoolDefByContPrevIdx" );
		cfbam::CFBamBoolDefBuff* cur = NULL;
		cfbam::CFBamBoolDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamBoolDefTable::deleteBoolDefByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteBoolDefByContNextIdx" );
		cfbam::CFBamBoolDefBuff* cur = NULL;
		cfbam::CFBamBoolDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamBoolDefTable::releasePreparedStatements() {
	}
