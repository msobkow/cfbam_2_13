...
// Description: C++18 Implementation for an in-memory RAM DbIO for TimeCol.
...
namespace cfbam {
	...
	const std::string CFBamRamTimeColTable::CLASS_NAME( "CFBamRamTimeColTable" );

	CFBamRamTimeColTable::CFBamRamTimeColTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamTimeColTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimeColBuff*>();
		dictByTableIdx = new std::map<cfbam::CFBamTimeColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTimeColBuff*>*>();
	}

	CFBamRamTimeColTable::~CFBamRamTimeColTable() {
	...
	cfbam::CFBamTimeColBuff* CFBamRamTimeColTable::createTimeCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTimeColBuff* Buff )
	{
		static const std::string S_ProcName( "createTimeCol" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamTimeColBuff::CLASS_CODE ) {
		...
		cfbam::CFBamTimeColBuff* buff = dynamic_cast<cfbam::CFBamTimeColBuff*>( schema->getTableTimeDef()->createTimeDef( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimeColBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimeColBuff*>* subdictTableIdx;
		...
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			...
			subdictTableIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimeColBuff*>();
			dictByTableIdx->insert( std::map<cfbam::CFBamTimeColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamTimeColBuff*>*>::value_type( keyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimeColBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamTimeColBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamTimeColBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamTimeColBuff* CFBamRamTimeColTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamTimeColBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamTimeColBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamTimeColBuff* CFBamRamTimeColTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> CFBamRamTimeColTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTimeColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTimeColBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamTimeColBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamTimeColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTimeColBuff* CFBamRamTimeColTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamTimeColBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamTimeColBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> CFBamRamTimeColTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamTimeColBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamTimeColBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> CFBamRamTimeColTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> CFBamRamTimeColTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> CFBamRamTimeColTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> CFBamRamTimeColTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> CFBamRamTimeColTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> CFBamRamTimeColTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> CFBamRamTimeColTable::readDerivedByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> recVec;
		cfbam::CFBamTimeColBuff* clone;
		auto searchDictByTableIdx = dictByTableIdx->find( key );
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamTimeColBuff*>* subdictTableIdx = searchDictByTableIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTimeColBuff*>::iterator iter = subdictTableIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTimeColBuff*>::iterator end = subdictTableIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamTimeColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTimeColBuff* CFBamRamTimeColTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamTimeColBuff* CFBamRamTimeColTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamTimeColBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamTimeColBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamTimeColBuff* CFBamRamTimeColTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamTimeColBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamTimeColBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> CFBamRamTimeColTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamTimeColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamTimeColBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamTimeColBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamTimeColBuff* CFBamRamTimeColTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamTimeColBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamTimeColBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamTimeColBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamTimeColBuff* CFBamRamTimeColTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamTimeColBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> CFBamRamTimeColTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamTimeColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> CFBamRamTimeColTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamTimeColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> CFBamRamTimeColTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamTimeColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> CFBamRamTimeColTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTimeColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> CFBamRamTimeColTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTimeColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> CFBamRamTimeColTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTimeColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> CFBamRamTimeColTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTimeColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> CFBamRamTimeColTable::readBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		cfbam::CFBamTimeColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> CFBamRamTimeColTable::pageBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId,
	...
	cfbam::CFBamTimeColBuff* CFBamRamTimeColTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamTimeColBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTimeColBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamTimeColBuff*>( editCur ) );
	}

	cfbam::CFBamTimeColBuff* CFBamRamTimeColTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTimeColBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamTimeColBuff* CFBamRamTimeColTable::updateTimeCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTimeColBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in TimeCol for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamTimeColBuff* existing = searchExisting->second;
		...
		cfbam::CFBamTimeColByTableIdxKey existingKeyTableIdx;
		...
		cfbam::CFBamTimeColByTableIdxKey newKeyTableIdx;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamTimeColBuff*>( schema->getTableTimeDef()->updateTimeDef( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimeColBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimeColBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamTimeColBuff*>* subdictTableIdx;
		...
		if( searchNewKeyDictByTableIdx != dictByTableIdx->end() ) {
			...
			dictByTableIdx->insert( std::map<cfbam::CFBamTimeColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamTimeColBuff*>*>::value_type( newKeyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimeColBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamTimeColBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamTimeColBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamTimeColBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamTimeColTable::deleteTimeCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTimeColBuff* Buff )
	{
		static const std::string S_ProcName( "deleteTimeCol" );
	...
	void CFBamRamTimeColTable::deleteTimeColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTimeColTable::deleteTimeColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamTimeColByTableIdxKey* argKey )
	{
		cfbam::CFBamTimeColBuff* cur = NULL;
		cfbam::CFBamTimeColBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTimeColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTimeColBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamTimeColBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamTimeColBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimeColBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamTimeColTable::deleteTimeColByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamTimeColTable::deleteTimeColByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamTimeColTable::deleteTimeColByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamTimeColTable::deleteTimeColByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamTimeColTable::deleteTimeColByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTimeColTable::deleteTimeColByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTimeColTable::deleteTimeColByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTimeColTable::deleteTimeColByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamTimeColTable::deleteTimeColByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamTimeColTable::releasePreparedStatements() {
	}
