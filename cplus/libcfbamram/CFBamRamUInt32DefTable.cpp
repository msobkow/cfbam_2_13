...
// Description: C++18 Implementation for an in-memory RAM DbIO for UInt32Def.
...
namespace cfbam {
	...
	const std::string CFBamRamUInt32DefTable::CLASS_NAME( "CFBamRamUInt32DefTable" );

	CFBamRamUInt32DefTable::CFBamRamUInt32DefTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamUInt32DefTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt32DefBuff*>();
	}

	CFBamRamUInt32DefTable::~CFBamRamUInt32DefTable() {
		if( dictByPKey != NULL ) {
			delete dictByPKey;
			dictByPKey = NULL;
		}
	...
	cfbam::CFBamUInt32DefBuff* CFBamRamUInt32DefTable::createUInt32Def( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUInt32DefBuff* Buff )
	{
		...
		cfbam::CFBamUInt32DefBuff* buff = dynamic_cast<cfbam::CFBamUInt32DefBuff*>( schema->getTableAtom()->createAtom( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt32DefBuff*>::value_type( pkey, buff ) );

		// The top level code has to clone the final buffer. The one passed in is now part of the persistent storage.
		if( buff->getClassCode() == cfbam::CFBamUInt32DefBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamUInt32DefBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamUInt32DefBuff* CFBamRamUInt32DefTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamUInt32DefBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamUInt32DefBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamUInt32DefBuff* CFBamRamUInt32DefTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> CFBamRamUInt32DefTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUInt32DefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUInt32DefBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamUInt32DefBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamUInt32DefBuff*>( iter->second->clone() );
	...
	cfbam::CFBamUInt32DefBuff* CFBamRamUInt32DefTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamUInt32DefBuff::CLASS_CODE ) ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> CFBamRamUInt32DefTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamUInt32DefBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamUInt32DefBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> CFBamRamUInt32DefTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> CFBamRamUInt32DefTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> CFBamRamUInt32DefTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> CFBamRamUInt32DefTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> CFBamRamUInt32DefTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> CFBamRamUInt32DefTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	cfbam::CFBamUInt32DefBuff* CFBamRamUInt32DefTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamUInt32DefBuff* CFBamRamUInt32DefTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamUInt32DefBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamUInt32DefBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamUInt32DefBuff* CFBamRamUInt32DefTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamUInt32DefBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamUInt32DefBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> CFBamRamUInt32DefTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamUInt32DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamUInt32DefBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamUInt32DefBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamUInt32DefBuff* CFBamRamUInt32DefTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamUInt32DefBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamUInt32DefBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamUInt32DefBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamUInt32DefBuff* CFBamRamUInt32DefTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamUInt32DefBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> CFBamRamUInt32DefTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamUInt32DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> CFBamRamUInt32DefTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamUInt32DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> CFBamRamUInt32DefTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamUInt32DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> CFBamRamUInt32DefTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamUInt32DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> CFBamRamUInt32DefTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamUInt32DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> CFBamRamUInt32DefTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamUInt32DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> CFBamRamUInt32DefTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamUInt32DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*>::iterator iterBuffList = buffList.begin();
	...
	cfbam::CFBamUInt32DefBuff* CFBamRamUInt32DefTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamUInt32DefBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamUInt32DefBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamUInt32DefBuff*>( editCur ) );
	}

	cfbam::CFBamUInt32DefBuff* CFBamRamUInt32DefTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamUInt32DefBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamUInt32DefBuff* CFBamRamUInt32DefTable::updateUInt32Def( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUInt32DefBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in UInt32Def for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamUInt32DefBuff* existing = searchExisting->second;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamUInt32DefBuff*>( schema->getTableAtom()->updateAtom( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt32DefBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt32DefBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamUInt32DefBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamUInt32DefBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamUInt32DefBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamUInt32DefTable::deleteUInt32Def( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUInt32DefBuff* Buff )
	{
		static const std::string S_ProcName( "deleteUInt32Def" );
		...
		{
			cfbam::CFBamUInt32TypeBuff* refIdIdx = dynamic_cast<cfbam::CFBamUInt32TypeBuff*>( schema->getTableUInt32Type()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table UInt32Type for primary key " + pkey.toString() );
		...
		{
			cfbam::CFBamUInt32ColBuff* refIdIdx = dynamic_cast<cfbam::CFBamUInt32ColBuff*>( schema->getTableUInt32Col()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table UInt32Col for primary key " + pkey.toString() );
				throw cflib::CFLibDependentsDetectedException( CLASS_NAME,
					S_ProcName,
					Msg );
			}
	...
	void CFBamRamUInt32DefTable::deleteUInt32DefByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteUInt32DefByIdIdx" );
		...
		cfbam::CFBamUInt32DefBuff* cur = NULL;
		cfbam::CFBamUInt32DefBuff* rereadCur = NULL;
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUInt32DefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUInt32DefBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamValueBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamUInt32DefBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt32DefBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamUInt32DefBuff::CLASS_CODE ) {
	...
	void CFBamRamUInt32DefTable::deleteUInt32DefByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteUInt32DefByUNameIdx" );
		cfbam::CFBamUInt32DefBuff* cur = NULL;
		cfbam::CFBamUInt32DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamUInt32DefTable::deleteUInt32DefByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteUInt32DefByValTentIdx" );
		cfbam::CFBamUInt32DefBuff* cur = NULL;
		cfbam::CFBamUInt32DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamUInt32DefTable::deleteUInt32DefByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteUInt32DefByScopeIdx" );
		cfbam::CFBamUInt32DefBuff* cur = NULL;
		cfbam::CFBamUInt32DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamUInt32DefTable::deleteUInt32DefByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteUInt32DefByDefSchemaIdx" );
		cfbam::CFBamUInt32DefBuff* cur = NULL;
		cfbam::CFBamUInt32DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamUInt32DefTable::deleteUInt32DefByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteUInt32DefByPrevIdx" );
		cfbam::CFBamUInt32DefBuff* cur = NULL;
		cfbam::CFBamUInt32DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamUInt32DefTable::deleteUInt32DefByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteUInt32DefByNextIdx" );
		cfbam::CFBamUInt32DefBuff* cur = NULL;
		cfbam::CFBamUInt32DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamUInt32DefTable::deleteUInt32DefByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteUInt32DefByContPrevIdx" );
		cfbam::CFBamUInt32DefBuff* cur = NULL;
		cfbam::CFBamUInt32DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamUInt32DefTable::deleteUInt32DefByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteUInt32DefByContNextIdx" );
		cfbam::CFBamUInt32DefBuff* cur = NULL;
		cfbam::CFBamUInt32DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamUInt32DefTable::releasePreparedStatements() {
	}
