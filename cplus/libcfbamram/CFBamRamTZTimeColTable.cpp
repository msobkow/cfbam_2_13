...
// Description: C++18 Implementation for an in-memory RAM DbIO for TZTimeCol.
...
namespace cfbam {
	...
	const std::string CFBamRamTZTimeColTable::CLASS_NAME( "CFBamRamTZTimeColTable" );

	CFBamRamTZTimeColTable::CFBamRamTZTimeColTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamTZTimeColTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimeColBuff*>();
		dictByTableIdx = new std::map<cfbam::CFBamTZTimeColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTZTimeColBuff*>*>();
	}

	CFBamRamTZTimeColTable::~CFBamRamTZTimeColTable() {
	...
	cfbam::CFBamTZTimeColBuff* CFBamRamTZTimeColTable::createTZTimeCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTZTimeColBuff* Buff )
	{
		static const std::string S_ProcName( "createTZTimeCol" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamTZTimeColBuff::CLASS_CODE ) {
		...
		cfbam::CFBamTZTimeColBuff* buff = dynamic_cast<cfbam::CFBamTZTimeColBuff*>( schema->getTableTZTimeDef()->createTZTimeDef( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimeColBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimeColBuff*>* subdictTableIdx;
		...
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			...
			subdictTableIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimeColBuff*>();
			dictByTableIdx->insert( std::map<cfbam::CFBamTZTimeColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamTZTimeColBuff*>*>::value_type( keyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimeColBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamTZTimeColBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamTZTimeColBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamTZTimeColBuff* CFBamRamTZTimeColTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamTZTimeColBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamTZTimeColBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamTZTimeColBuff* CFBamRamTZTimeColTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> CFBamRamTZTimeColTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZTimeColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZTimeColBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamTZTimeColBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamTZTimeColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTZTimeColBuff* CFBamRamTZTimeColTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamTZTimeColBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamTZTimeColBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> CFBamRamTZTimeColTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamTZTimeColBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamTZTimeColBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> CFBamRamTZTimeColTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> CFBamRamTZTimeColTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> CFBamRamTZTimeColTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> CFBamRamTZTimeColTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> CFBamRamTZTimeColTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> CFBamRamTZTimeColTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> CFBamRamTZTimeColTable::readDerivedByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> recVec;
		cfbam::CFBamTZTimeColBuff* clone;
		auto searchDictByTableIdx = dictByTableIdx->find( key );
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamTZTimeColBuff*>* subdictTableIdx = searchDictByTableIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTZTimeColBuff*>::iterator iter = subdictTableIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTZTimeColBuff*>::iterator end = subdictTableIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamTZTimeColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTZTimeColBuff* CFBamRamTZTimeColTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamTZTimeColBuff* CFBamRamTZTimeColTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamTZTimeColBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamTZTimeColBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamTZTimeColBuff* CFBamRamTZTimeColTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamTZTimeColBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamTZTimeColBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> CFBamRamTZTimeColTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamTZTimeColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamTZTimeColBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamTZTimeColBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamTZTimeColBuff* CFBamRamTZTimeColTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamTZTimeColBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamTZTimeColBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamTZTimeColBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamTZTimeColBuff* CFBamRamTZTimeColTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamTZTimeColBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> CFBamRamTZTimeColTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamTZTimeColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> CFBamRamTZTimeColTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamTZTimeColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> CFBamRamTZTimeColTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamTZTimeColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> CFBamRamTZTimeColTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTZTimeColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> CFBamRamTZTimeColTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTZTimeColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> CFBamRamTZTimeColTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTZTimeColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> CFBamRamTZTimeColTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTZTimeColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> CFBamRamTZTimeColTable::readBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		cfbam::CFBamTZTimeColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> CFBamRamTZTimeColTable::pageBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId,
	...
	cfbam::CFBamTZTimeColBuff* CFBamRamTZTimeColTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamTZTimeColBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTZTimeColBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamTZTimeColBuff*>( editCur ) );
	}

	cfbam::CFBamTZTimeColBuff* CFBamRamTZTimeColTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTZTimeColBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamTZTimeColBuff* CFBamRamTZTimeColTable::updateTZTimeCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTZTimeColBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in TZTimeCol for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamTZTimeColBuff* existing = searchExisting->second;
		...
		cfbam::CFBamTZTimeColByTableIdxKey existingKeyTableIdx;
		...
		cfbam::CFBamTZTimeColByTableIdxKey newKeyTableIdx;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamTZTimeColBuff*>( schema->getTableTZTimeDef()->updateTZTimeDef( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimeColBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimeColBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamTZTimeColBuff*>* subdictTableIdx;
		...
		if( searchNewKeyDictByTableIdx != dictByTableIdx->end() ) {
			...
			dictByTableIdx->insert( std::map<cfbam::CFBamTZTimeColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamTZTimeColBuff*>*>::value_type( newKeyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimeColBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamTZTimeColBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamTZTimeColBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamTZTimeColBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamTZTimeColTable::deleteTZTimeCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTZTimeColBuff* Buff )
	{
		static const std::string S_ProcName( "deleteTZTimeCol" );
	...
	void CFBamRamTZTimeColTable::deleteTZTimeColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamTZTimeColBuff* cur = NULL;
		cfbam::CFBamTZTimeColBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZTimeColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZTimeColBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamTZTimeColBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamTZTimeColBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamTZTimeColTable::deleteTZTimeColByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamTZTimeColTable::deleteTZTimeColByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamTZTimeColTable::deleteTZTimeColByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamTZTimeColTable::deleteTZTimeColByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamTZTimeColTable::deleteTZTimeColByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTZTimeColTable::deleteTZTimeColByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTZTimeColTable::deleteTZTimeColByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTZTimeColTable::deleteTZTimeColByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamTZTimeColTable::deleteTZTimeColByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamTZTimeColTable::releasePreparedStatements() {
	}
