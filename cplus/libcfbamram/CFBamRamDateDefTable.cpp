...
// Description: C++18 Implementation for an in-memory RAM DbIO for DateDef.
...
namespace cfbam {
	...
	const std::string CFBamRamDateDefTable::CLASS_NAME( "CFBamRamDateDefTable" );

	CFBamRamDateDefTable::CFBamRamDateDefTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamDateDefTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamDateDefBuff*>();
	}

	CFBamRamDateDefTable::~CFBamRamDateDefTable() {
		if( dictByPKey != NULL ) {
			delete dictByPKey;
			dictByPKey = NULL;
		}
	...
	cfbam::CFBamDateDefBuff* CFBamRamDateDefTable::createDateDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamDateDefBuff* Buff )
	{
		...
		cfbam::CFBamDateDefBuff* buff = dynamic_cast<cfbam::CFBamDateDefBuff*>( schema->getTableAtom()->createAtom( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamDateDefBuff*>::value_type( pkey, buff ) );

		// The top level code has to clone the final buffer. The one passed in is now part of the persistent storage.
		if( buff->getClassCode() == cfbam::CFBamDateDefBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamDateDefBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamDateDefBuff* CFBamRamDateDefTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamDateDefBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamDateDefBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamDateDefBuff* CFBamRamDateDefTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> CFBamRamDateDefTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamDateDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamDateDefBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamDateDefBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamDateDefBuff*>( iter->second->clone() );
	...
	cfbam::CFBamDateDefBuff* CFBamRamDateDefTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamDateDefBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamDateDefBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> CFBamRamDateDefTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamDateDefBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamDateDefBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> CFBamRamDateDefTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> CFBamRamDateDefTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> CFBamRamDateDefTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> CFBamRamDateDefTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> CFBamRamDateDefTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> CFBamRamDateDefTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	cfbam::CFBamDateDefBuff* CFBamRamDateDefTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamDateDefBuff* CFBamRamDateDefTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamDateDefBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamDateDefBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamDateDefBuff* CFBamRamDateDefTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamDateDefBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamDateDefBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> CFBamRamDateDefTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamDateDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamDateDefBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamDateDefBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamDateDefBuff* CFBamRamDateDefTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamDateDefBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamDateDefBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamDateDefBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamDateDefBuff* CFBamRamDateDefTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamDateDefBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> CFBamRamDateDefTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamDateDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> CFBamRamDateDefTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamDateDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> CFBamRamDateDefTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamDateDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> CFBamRamDateDefTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamDateDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> CFBamRamDateDefTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamDateDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> CFBamRamDateDefTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamDateDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> CFBamRamDateDefTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamDateDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	cfbam::CFBamDateDefBuff* CFBamRamDateDefTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamDateDefBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamDateDefBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamDateDefBuff*>( editCur ) );
	}

	cfbam::CFBamDateDefBuff* CFBamRamDateDefTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamDateDefBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamDateDefBuff* CFBamRamDateDefTable::updateDateDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamDateDefBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in DateDef for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamDateDefBuff* existing = searchExisting->second;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamDateDefBuff*>( schema->getTableAtom()->updateAtom( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamDateDefBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamDateDefBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamDateDefBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamDateDefBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamDateDefBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamDateDefTable::deleteDateDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamDateDefBuff* Buff )
	{
		static const std::string S_ProcName( "deleteDateDef" );
		...
		{
			cfbam::CFBamDateTypeBuff* refIdIdx = dynamic_cast<cfbam::CFBamDateTypeBuff*>( schema->getTableDateType()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table DateType for primary key " + pkey.toString() );
		...
		{
			cfbam::CFBamDateColBuff* refIdIdx = dynamic_cast<cfbam::CFBamDateColBuff*>( schema->getTableDateCol()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table DateCol for primary key " + pkey.toString() );
				throw cflib::CFLibDependentsDetectedException( CLASS_NAME,
					S_ProcName,
					Msg );
			}
	...
	void CFBamRamDateDefTable::deleteDateDefByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteDateDefByIdIdx" );
		...
		cfbam::CFBamDateDefBuff* cur = NULL;
		cfbam::CFBamDateDefBuff* rereadCur = NULL;
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamDateDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamDateDefBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamValueBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamDateDefBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamDateDefBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamDateDefBuff::CLASS_CODE ) {
	...
	void CFBamRamDateDefTable::deleteDateDefByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteDateDefByUNameIdx" );
		cfbam::CFBamDateDefBuff* cur = NULL;
		cfbam::CFBamDateDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamDateDefTable::deleteDateDefByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteDateDefByValTentIdx" );
		cfbam::CFBamDateDefBuff* cur = NULL;
		cfbam::CFBamDateDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamDateDefTable::deleteDateDefByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteDateDefByScopeIdx" );
		cfbam::CFBamDateDefBuff* cur = NULL;
		cfbam::CFBamDateDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamDateDefTable::deleteDateDefByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteDateDefByDefSchemaIdx" );
		cfbam::CFBamDateDefBuff* cur = NULL;
		cfbam::CFBamDateDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamDateDefTable::deleteDateDefByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteDateDefByPrevIdx" );
		cfbam::CFBamDateDefBuff* cur = NULL;
		cfbam::CFBamDateDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamDateDefTable::deleteDateDefByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteDateDefByNextIdx" );
		cfbam::CFBamDateDefBuff* cur = NULL;
		cfbam::CFBamDateDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamDateDefTable::deleteDateDefByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteDateDefByContPrevIdx" );
		cfbam::CFBamDateDefBuff* cur = NULL;
		cfbam::CFBamDateDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamDateDefTable::deleteDateDefByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteDateDefByContNextIdx" );
		cfbam::CFBamDateDefBuff* cur = NULL;
		cfbam::CFBamDateDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamDateDefTable::releasePreparedStatements() {
	}
