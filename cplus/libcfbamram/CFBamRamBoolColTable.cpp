...
// Description: C++18 Implementation for an in-memory RAM DbIO for BoolCol.
...
namespace cfbam {
	...
	const std::string CFBamRamBoolColTable::CLASS_NAME( "CFBamRamBoolColTable" );

	CFBamRamBoolColTable::CFBamRamBoolColTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamBoolColTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamBoolColBuff*>();
		dictByTableIdx = new std::map<cfbam::CFBamBoolColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamBoolColBuff*>*>();
	}

	CFBamRamBoolColTable::~CFBamRamBoolColTable() {
	...
	cfbam::CFBamBoolColBuff* CFBamRamBoolColTable::createBoolCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamBoolColBuff* Buff )
	{
		static const std::string S_ProcName( "createBoolCol" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamBoolColBuff::CLASS_CODE ) {
		...
		cfbam::CFBamBoolColBuff* buff = dynamic_cast<cfbam::CFBamBoolColBuff*>( schema->getTableBoolDef()->createBoolDef( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamBoolColBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamBoolColBuff*>* subdictTableIdx;
		...
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			...
			subdictTableIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamBoolColBuff*>();
			dictByTableIdx->insert( std::map<cfbam::CFBamBoolColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamBoolColBuff*>*>::value_type( keyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamBoolColBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamBoolColBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamBoolColBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamBoolColBuff* CFBamRamBoolColTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamBoolColBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamBoolColBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamBoolColBuff* CFBamRamBoolColTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> CFBamRamBoolColTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamBoolColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamBoolColBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamBoolColBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamBoolColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamBoolColBuff* CFBamRamBoolColTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamBoolColBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamBoolColBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> CFBamRamBoolColTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamBoolColBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamBoolColBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> CFBamRamBoolColTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> CFBamRamBoolColTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> CFBamRamBoolColTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> CFBamRamBoolColTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> CFBamRamBoolColTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> CFBamRamBoolColTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> CFBamRamBoolColTable::readDerivedByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> recVec;
		cfbam::CFBamBoolColBuff* clone;
		auto searchDictByTableIdx = dictByTableIdx->find( key );
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamBoolColBuff*>* subdictTableIdx = searchDictByTableIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamBoolColBuff*>::iterator iter = subdictTableIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamBoolColBuff*>::iterator end = subdictTableIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamBoolColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamBoolColBuff* CFBamRamBoolColTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamBoolColBuff* CFBamRamBoolColTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamBoolColBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamBoolColBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamBoolColBuff* CFBamRamBoolColTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamBoolColBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamBoolColBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> CFBamRamBoolColTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamBoolColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamBoolColBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamBoolColBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamBoolColBuff* CFBamRamBoolColTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamBoolColBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamBoolColBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamBoolColBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamBoolColBuff* CFBamRamBoolColTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamBoolColBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> CFBamRamBoolColTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamBoolColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> CFBamRamBoolColTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamBoolColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> CFBamRamBoolColTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamBoolColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> CFBamRamBoolColTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamBoolColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> CFBamRamBoolColTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamBoolColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> CFBamRamBoolColTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamBoolColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> CFBamRamBoolColTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamBoolColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> CFBamRamBoolColTable::readBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		cfbam::CFBamBoolColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> CFBamRamBoolColTable::pageBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId,
	...
	cfbam::CFBamBoolColBuff* CFBamRamBoolColTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamBoolColBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamBoolColBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamBoolColBuff*>( editCur ) );
	}

	cfbam::CFBamBoolColBuff* CFBamRamBoolColTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamBoolColBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamBoolColBuff* CFBamRamBoolColTable::updateBoolCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamBoolColBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in BoolCol for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamBoolColBuff* existing = searchExisting->second;
		...
		cfbam::CFBamBoolColByTableIdxKey existingKeyTableIdx;
		...
		cfbam::CFBamBoolColByTableIdxKey newKeyTableIdx;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamBoolColBuff*>( schema->getTableBoolDef()->updateBoolDef( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamBoolColBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamBoolColBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamBoolColBuff*>* subdictTableIdx;
		...
		if( searchNewKeyDictByTableIdx != dictByTableIdx->end() ) {
			...
			dictByTableIdx->insert( std::map<cfbam::CFBamBoolColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamBoolColBuff*>*>::value_type( newKeyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamBoolColBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamBoolColBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamBoolColBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamBoolColBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamBoolColTable::deleteBoolCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamBoolColBuff* Buff )
	{
		static const std::string S_ProcName( "deleteBoolCol" );
	...
	void CFBamRamBoolColTable::deleteBoolColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamBoolColBuff* cur = NULL;
		cfbam::CFBamBoolColBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamBoolColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamBoolColBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamBoolColBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamBoolColBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamBoolColBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamBoolColTable::deleteBoolColByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamBoolColTable::deleteBoolColByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamBoolColTable::deleteBoolColByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamBoolColTable::deleteBoolColByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamBoolColTable::deleteBoolColByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamBoolColTable::deleteBoolColByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamBoolColTable::deleteBoolColByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamBoolColTable::deleteBoolColByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamBoolColTable::deleteBoolColByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamBoolColTable::releasePreparedStatements() {
	}
