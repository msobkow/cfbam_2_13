...
// Description: C++18 Implementation for an in-memory RAM DbIO for TextDef.
...
namespace cfbam {
	...
	const std::string CFBamRamTextDefTable::CLASS_NAME( "CFBamRamTextDefTable" );

	CFBamRamTextDefTable::CFBamRamTextDefTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamTextDefTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTextDefBuff*>();
	}

	CFBamRamTextDefTable::~CFBamRamTextDefTable() {
		if( dictByPKey != NULL ) {
			delete dictByPKey;
			dictByPKey = NULL;
		}
	...
	cfbam::CFBamTextDefBuff* CFBamRamTextDefTable::createTextDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTextDefBuff* Buff )
	{
		...
		cfbam::CFBamTextDefBuff* buff = dynamic_cast<cfbam::CFBamTextDefBuff*>( schema->getTableAtom()->createAtom( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTextDefBuff*>::value_type( pkey, buff ) );

		// The top level code has to clone the final buffer. The one passed in is now part of the persistent storage.
		if( buff->getClassCode() == cfbam::CFBamTextDefBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamTextDefBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamTextDefBuff* CFBamRamTextDefTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamTextDefBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamTextDefBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamTextDefBuff* CFBamRamTextDefTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> CFBamRamTextDefTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTextDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTextDefBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamTextDefBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamTextDefBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTextDefBuff* CFBamRamTextDefTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamTextDefBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamTextDefBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> CFBamRamTextDefTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamTextDefBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamTextDefBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> CFBamRamTextDefTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> CFBamRamTextDefTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> CFBamRamTextDefTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> CFBamRamTextDefTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> CFBamRamTextDefTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> CFBamRamTextDefTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	cfbam::CFBamTextDefBuff* CFBamRamTextDefTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamTextDefBuff* CFBamRamTextDefTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamTextDefBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamTextDefBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamTextDefBuff* CFBamRamTextDefTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamTextDefBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamTextDefBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> CFBamRamTextDefTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamTextDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamTextDefBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamTextDefBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamTextDefBuff* CFBamRamTextDefTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamTextDefBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamTextDefBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamTextDefBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamTextDefBuff* CFBamRamTextDefTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamTextDefBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> CFBamRamTextDefTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamTextDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> CFBamRamTextDefTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamTextDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> CFBamRamTextDefTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamTextDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> CFBamRamTextDefTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTextDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> CFBamRamTextDefTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTextDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> CFBamRamTextDefTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTextDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> CFBamRamTextDefTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTextDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	cfbam::CFBamTextDefBuff* CFBamRamTextDefTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamTextDefBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTextDefBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamTextDefBuff*>( editCur ) );
	}

	cfbam::CFBamTextDefBuff* CFBamRamTextDefTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTextDefBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamTextDefBuff* CFBamRamTextDefTable::updateTextDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTextDefBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in TextDef for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamTextDefBuff* existing = searchExisting->second;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamTextDefBuff*>( schema->getTableAtom()->updateAtom( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTextDefBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTextDefBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamTextDefBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamTextDefBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamTextDefBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamTextDefTable::deleteTextDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTextDefBuff* Buff )
	{
		static const std::string S_ProcName( "deleteTextDef" );
		...
		{
			cfbam::CFBamTextTypeBuff* refIdIdx = dynamic_cast<cfbam::CFBamTextTypeBuff*>( schema->getTableTextType()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table TextType for primary key " + pkey.toString() );
		...
		{
			cfbam::CFBamTextColBuff* refIdIdx = dynamic_cast<cfbam::CFBamTextColBuff*>( schema->getTableTextCol()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table TextCol for primary key " + pkey.toString() );
				throw cflib::CFLibDependentsDetectedException( CLASS_NAME,
					S_ProcName,
					Msg );
			}
	...
	void CFBamRamTextDefTable::deleteTextDefByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTextDefByIdIdx" );
		...
		cfbam::CFBamTextDefBuff* cur = NULL;
		cfbam::CFBamTextDefBuff* rereadCur = NULL;
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTextDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTextDefBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamValueBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamTextDefBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamTextDefBuff::CLASS_CODE ) {
	...
	void CFBamRamTextDefTable::deleteTextDefByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteTextDefByUNameIdx" );
		cfbam::CFBamTextDefBuff* cur = NULL;
		cfbam::CFBamTextDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTextDefTable::deleteTextDefByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTextDefByValTentIdx" );
		cfbam::CFBamTextDefBuff* cur = NULL;
		cfbam::CFBamTextDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTextDefTable::deleteTextDefByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTextDefByScopeIdx" );
		cfbam::CFBamTextDefBuff* cur = NULL;
		cfbam::CFBamTextDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTextDefTable::deleteTextDefByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTextDefByDefSchemaIdx" );
		cfbam::CFBamTextDefBuff* cur = NULL;
		cfbam::CFBamTextDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamTextDefTable::deleteTextDefByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTextDefByPrevIdx" );
		cfbam::CFBamTextDefBuff* cur = NULL;
		cfbam::CFBamTextDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamTextDefTable::deleteTextDefByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTextDefByNextIdx" );
		cfbam::CFBamTextDefBuff* cur = NULL;
		cfbam::CFBamTextDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamTextDefTable::deleteTextDefByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTextDefByContPrevIdx" );
		cfbam::CFBamTextDefBuff* cur = NULL;
		cfbam::CFBamTextDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTextDefTable::deleteTextDefByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTextDefByContNextIdx" );
		cfbam::CFBamTextDefBuff* cur = NULL;
		cfbam::CFBamTextDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTextDefTable::releasePreparedStatements() {
	}
