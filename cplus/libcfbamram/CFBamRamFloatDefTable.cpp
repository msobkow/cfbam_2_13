...
// Description: C++18 Implementation for an in-memory RAM DbIO for FloatDef.
...
namespace cfbam {
	...
	const std::string CFBamRamFloatDefTable::CLASS_NAME( "CFBamRamFloatDefTable" );

	CFBamRamFloatDefTable::CFBamRamFloatDefTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamFloatDefTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamFloatDefBuff*>();
	}

	CFBamRamFloatDefTable::~CFBamRamFloatDefTable() {
		if( dictByPKey != NULL ) {
			delete dictByPKey;
			dictByPKey = NULL;
		}
	...
	cfbam::CFBamFloatDefBuff* CFBamRamFloatDefTable::createFloatDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamFloatDefBuff* Buff )
	{
		...
		cfbam::CFBamFloatDefBuff* buff = dynamic_cast<cfbam::CFBamFloatDefBuff*>( schema->getTableAtom()->createAtom( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamFloatDefBuff*>::value_type( pkey, buff ) );

		// The top level code has to clone the final buffer. The one passed in is now part of the persistent storage.
		if( buff->getClassCode() == cfbam::CFBamFloatDefBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamFloatDefBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamFloatDefBuff* CFBamRamFloatDefTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamFloatDefBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamFloatDefBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamFloatDefBuff* CFBamRamFloatDefTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> CFBamRamFloatDefTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamFloatDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamFloatDefBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamFloatDefBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamFloatDefBuff*>( iter->second->clone() );
	...
	cfbam::CFBamFloatDefBuff* CFBamRamFloatDefTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamFloatDefBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamFloatDefBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> CFBamRamFloatDefTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamFloatDefBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamFloatDefBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> CFBamRamFloatDefTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> CFBamRamFloatDefTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> CFBamRamFloatDefTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> CFBamRamFloatDefTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> CFBamRamFloatDefTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> CFBamRamFloatDefTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	cfbam::CFBamFloatDefBuff* CFBamRamFloatDefTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamFloatDefBuff* CFBamRamFloatDefTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamFloatDefBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamFloatDefBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamFloatDefBuff* CFBamRamFloatDefTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamFloatDefBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamFloatDefBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> CFBamRamFloatDefTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamFloatDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamFloatDefBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamFloatDefBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamFloatDefBuff* CFBamRamFloatDefTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamFloatDefBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamFloatDefBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamFloatDefBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamFloatDefBuff* CFBamRamFloatDefTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamFloatDefBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> CFBamRamFloatDefTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamFloatDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> CFBamRamFloatDefTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamFloatDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> CFBamRamFloatDefTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamFloatDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> CFBamRamFloatDefTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamFloatDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> CFBamRamFloatDefTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamFloatDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> CFBamRamFloatDefTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamFloatDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> CFBamRamFloatDefTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamFloatDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	cfbam::CFBamFloatDefBuff* CFBamRamFloatDefTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamFloatDefBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamFloatDefBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamFloatDefBuff*>( editCur ) );
	}

	cfbam::CFBamFloatDefBuff* CFBamRamFloatDefTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamFloatDefBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamFloatDefBuff* CFBamRamFloatDefTable::updateFloatDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamFloatDefBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in FloatDef for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamFloatDefBuff* existing = searchExisting->second;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamFloatDefBuff*>( schema->getTableAtom()->updateAtom( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamFloatDefBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamFloatDefBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamFloatDefBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamFloatDefBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamFloatDefBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamFloatDefTable::deleteFloatDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamFloatDefBuff* Buff )
	{
		static const std::string S_ProcName( "deleteFloatDef" );
		...
		{
			cfbam::CFBamFloatTypeBuff* refIdIdx = dynamic_cast<cfbam::CFBamFloatTypeBuff*>( schema->getTableFloatType()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table FloatType for primary key " + pkey.toString() );
		...
		{
			cfbam::CFBamFloatColBuff* refIdIdx = dynamic_cast<cfbam::CFBamFloatColBuff*>( schema->getTableFloatCol()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table FloatCol for primary key " + pkey.toString() );
				throw cflib::CFLibDependentsDetectedException( CLASS_NAME,
					S_ProcName,
					Msg );
			}
	...
	void CFBamRamFloatDefTable::deleteFloatDefByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteFloatDefByIdIdx" );
		...
		cfbam::CFBamFloatDefBuff* cur = NULL;
		cfbam::CFBamFloatDefBuff* rereadCur = NULL;
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamFloatDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamFloatDefBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamValueBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamFloatDefBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamFloatDefBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamFloatDefBuff::CLASS_CODE ) {
	...
	void CFBamRamFloatDefTable::deleteFloatDefByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteFloatDefByUNameIdx" );
		cfbam::CFBamFloatDefBuff* cur = NULL;
		cfbam::CFBamFloatDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamFloatDefTable::deleteFloatDefByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteFloatDefByValTentIdx" );
		cfbam::CFBamFloatDefBuff* cur = NULL;
		cfbam::CFBamFloatDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamFloatDefTable::deleteFloatDefByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteFloatDefByScopeIdx" );
		cfbam::CFBamFloatDefBuff* cur = NULL;
		cfbam::CFBamFloatDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamFloatDefTable::deleteFloatDefByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteFloatDefByDefSchemaIdx" );
		cfbam::CFBamFloatDefBuff* cur = NULL;
		cfbam::CFBamFloatDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamFloatDefTable::deleteFloatDefByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteFloatDefByPrevIdx" );
		cfbam::CFBamFloatDefBuff* cur = NULL;
		cfbam::CFBamFloatDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamFloatDefTable::deleteFloatDefByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteFloatDefByNextIdx" );
		cfbam::CFBamFloatDefBuff* cur = NULL;
		cfbam::CFBamFloatDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamFloatDefTable::deleteFloatDefByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteFloatDefByContPrevIdx" );
		cfbam::CFBamFloatDefBuff* cur = NULL;
		cfbam::CFBamFloatDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamFloatDefTable::deleteFloatDefByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteFloatDefByContNextIdx" );
		cfbam::CFBamFloatDefBuff* cur = NULL;
		cfbam::CFBamFloatDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamFloatDefTable::releasePreparedStatements() {
	}
