...
// Description: C++18 Implementation for an in-memory RAM DbIO for TimeDef.
...
namespace cfbam {
	...
	const std::string CFBamRamTimeDefTable::CLASS_NAME( "CFBamRamTimeDefTable" );

	CFBamRamTimeDefTable::CFBamRamTimeDefTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamTimeDefTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimeDefBuff*>();
	}

	CFBamRamTimeDefTable::~CFBamRamTimeDefTable() {
		if( dictByPKey != NULL ) {
			delete dictByPKey;
			dictByPKey = NULL;
		}
	...
	cfbam::CFBamTimeDefBuff* CFBamRamTimeDefTable::createTimeDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTimeDefBuff* Buff )
	{
		...
		cfbam::CFBamTimeDefBuff* buff = dynamic_cast<cfbam::CFBamTimeDefBuff*>( schema->getTableAtom()->createAtom( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimeDefBuff*>::value_type( pkey, buff ) );

		// The top level code has to clone the final buffer. The one passed in is now part of the persistent storage.
		if( buff->getClassCode() == cfbam::CFBamTimeDefBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamTimeDefBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamTimeDefBuff* CFBamRamTimeDefTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamTimeDefBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamTimeDefBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamTimeDefBuff* CFBamRamTimeDefTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> CFBamRamTimeDefTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTimeDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTimeDefBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamTimeDefBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamTimeDefBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTimeDefBuff* CFBamRamTimeDefTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamTimeDefBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamTimeDefBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> CFBamRamTimeDefTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamTimeDefBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamTimeDefBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> CFBamRamTimeDefTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> CFBamRamTimeDefTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> CFBamRamTimeDefTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> CFBamRamTimeDefTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> CFBamRamTimeDefTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> CFBamRamTimeDefTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	cfbam::CFBamTimeDefBuff* CFBamRamTimeDefTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamTimeDefBuff* CFBamRamTimeDefTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamTimeDefBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamTimeDefBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamTimeDefBuff* CFBamRamTimeDefTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamTimeDefBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamTimeDefBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> CFBamRamTimeDefTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamTimeDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamTimeDefBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamTimeDefBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamTimeDefBuff* CFBamRamTimeDefTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamTimeDefBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamTimeDefBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamTimeDefBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamTimeDefBuff* CFBamRamTimeDefTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamTimeDefBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> CFBamRamTimeDefTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamTimeDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> CFBamRamTimeDefTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamTimeDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> CFBamRamTimeDefTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamTimeDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> CFBamRamTimeDefTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTimeDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> CFBamRamTimeDefTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTimeDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> CFBamRamTimeDefTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTimeDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> CFBamRamTimeDefTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTimeDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	cfbam::CFBamTimeDefBuff* CFBamRamTimeDefTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamTimeDefBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTimeDefBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamTimeDefBuff*>( editCur ) );
	}

	cfbam::CFBamTimeDefBuff* CFBamRamTimeDefTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTimeDefBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamTimeDefBuff* CFBamRamTimeDefTable::updateTimeDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTimeDefBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in TimeDef for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamTimeDefBuff* existing = searchExisting->second;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamTimeDefBuff*>( schema->getTableAtom()->updateAtom( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimeDefBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimeDefBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamTimeDefBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamTimeDefBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamTimeDefBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamTimeDefTable::deleteTimeDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTimeDefBuff* Buff )
	{
		static const std::string S_ProcName( "deleteTimeDef" );
		...
		{
			cfbam::CFBamTimeTypeBuff* refIdIdx = dynamic_cast<cfbam::CFBamTimeTypeBuff*>( schema->getTableTimeType()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table TimeType for primary key " + pkey.toString() );
		...
		{
			cfbam::CFBamTimeColBuff* refIdIdx = dynamic_cast<cfbam::CFBamTimeColBuff*>( schema->getTableTimeCol()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table TimeCol for primary key " + pkey.toString() );
				throw cflib::CFLibDependentsDetectedException( CLASS_NAME,
					S_ProcName,
					Msg );
			}
	...
	void CFBamRamTimeDefTable::deleteTimeDefByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTimeDefByIdIdx" );
		...
		cfbam::CFBamTimeDefBuff* cur = NULL;
		cfbam::CFBamTimeDefBuff* rereadCur = NULL;
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTimeDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTimeDefBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamValueBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamTimeDefBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamTimeDefBuff::CLASS_CODE ) {
	...
	void CFBamRamTimeDefTable::deleteTimeDefByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteTimeDefByUNameIdx" );
		cfbam::CFBamTimeDefBuff* cur = NULL;
		cfbam::CFBamTimeDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTimeDefTable::deleteTimeDefByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTimeDefByValTentIdx" );
		cfbam::CFBamTimeDefBuff* cur = NULL;
		cfbam::CFBamTimeDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTimeDefTable::deleteTimeDefByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTimeDefByScopeIdx" );
		cfbam::CFBamTimeDefBuff* cur = NULL;
		cfbam::CFBamTimeDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTimeDefTable::deleteTimeDefByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTimeDefByDefSchemaIdx" );
		cfbam::CFBamTimeDefBuff* cur = NULL;
		cfbam::CFBamTimeDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamTimeDefTable::deleteTimeDefByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTimeDefByPrevIdx" );
		cfbam::CFBamTimeDefBuff* cur = NULL;
		cfbam::CFBamTimeDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamTimeDefTable::deleteTimeDefByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTimeDefByNextIdx" );
		cfbam::CFBamTimeDefBuff* cur = NULL;
		cfbam::CFBamTimeDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamTimeDefTable::deleteTimeDefByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTimeDefByContPrevIdx" );
		cfbam::CFBamTimeDefBuff* cur = NULL;
		cfbam::CFBamTimeDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTimeDefTable::deleteTimeDefByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTimeDefByContNextIdx" );
		cfbam::CFBamTimeDefBuff* cur = NULL;
		cfbam::CFBamTimeDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTimeDefTable::releasePreparedStatements() {
	}
