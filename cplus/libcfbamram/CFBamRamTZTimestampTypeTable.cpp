...
// Description: C++18 Implementation for an in-memory RAM DbIO for TZTimestampType.
...
namespace cfbam {
	...
	const std::string CFBamRamTZTimestampTypeTable::CLASS_NAME( "CFBamRamTZTimestampTypeTable" );

	CFBamRamTZTimestampTypeTable::CFBamRamTZTimestampTypeTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamTZTimestampTypeTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimestampTypeBuff*>();
		dictBySchemaIdx = new std::map<cfbam::CFBamTZTimestampTypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTZTimestampTypeBuff*>*>();
	}

	CFBamRamTZTimestampTypeTable::~CFBamRamTZTimestampTypeTable() {
	...
	cfbam::CFBamTZTimestampTypeBuff* CFBamRamTZTimestampTypeTable::createTZTimestampType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTZTimestampTypeBuff* Buff )
	{
		...
		if( Buff->getClassCode() == cfbam::CFBamTZTimestampTypeBuff::CLASS_CODE ) {
		...
		cfbam::CFBamTZTimestampTypeBuff* buff = dynamic_cast<cfbam::CFBamTZTimestampTypeBuff*>( schema->getTableTZTimestampDef()->createTZTimestampDef( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimestampTypeBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimestampTypeBuff*>* subdictSchemaIdx;
		...
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			subdictSchemaIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimestampTypeBuff*>();
			dictBySchemaIdx->insert( std::map<cfbam::CFBamTZTimestampTypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamTZTimestampTypeBuff*>*>::value_type( keySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimestampTypeBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamTZTimestampTypeBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamTZTimestampTypeBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamTZTimestampTypeBuff* CFBamRamTZTimestampTypeTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamTZTimestampTypeBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamTZTimestampTypeBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamTZTimestampTypeBuff* CFBamRamTZTimestampTypeTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> CFBamRamTZTimestampTypeTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZTimestampTypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZTimestampTypeBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamTZTimestampTypeBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamTZTimestampTypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTZTimestampTypeBuff* CFBamRamTZTimestampTypeTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamTZTimestampTypeBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamTZTimestampTypeBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> CFBamRamTZTimestampTypeTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamTZTimestampTypeBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamTZTimestampTypeBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> CFBamRamTZTimestampTypeTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> CFBamRamTZTimestampTypeTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> CFBamRamTZTimestampTypeTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> CFBamRamTZTimestampTypeTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> CFBamRamTZTimestampTypeTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> CFBamRamTZTimestampTypeTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> CFBamRamTZTimestampTypeTable::readDerivedBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> recVec;
		cfbam::CFBamTZTimestampTypeBuff* clone;
		auto searchDictBySchemaIdx = dictBySchemaIdx->find( key );
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamTZTimestampTypeBuff*>* subdictSchemaIdx = searchDictBySchemaIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTZTimestampTypeBuff*>::iterator iter = subdictSchemaIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTZTimestampTypeBuff*>::iterator end = subdictSchemaIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamTZTimestampTypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTZTimestampTypeBuff* CFBamRamTZTimestampTypeTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamTZTimestampTypeBuff* CFBamRamTZTimestampTypeTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamTZTimestampTypeBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamTZTimestampTypeBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamTZTimestampTypeBuff* CFBamRamTZTimestampTypeTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamTZTimestampTypeBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamTZTimestampTypeBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> CFBamRamTZTimestampTypeTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamTZTimestampTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamTZTimestampTypeBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamTZTimestampTypeBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamTZTimestampTypeBuff* CFBamRamTZTimestampTypeTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamTZTimestampTypeBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamTZTimestampTypeBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamTZTimestampTypeBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamTZTimestampTypeBuff* CFBamRamTZTimestampTypeTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamTZTimestampTypeBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> CFBamRamTZTimestampTypeTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamTZTimestampTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> CFBamRamTZTimestampTypeTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamTZTimestampTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> CFBamRamTZTimestampTypeTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamTZTimestampTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> CFBamRamTZTimestampTypeTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTZTimestampTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> CFBamRamTZTimestampTypeTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTZTimestampTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> CFBamRamTZTimestampTypeTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTZTimestampTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> CFBamRamTZTimestampTypeTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTZTimestampTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> CFBamRamTZTimestampTypeTable::readBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		cfbam::CFBamTZTimestampTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> CFBamRamTZTimestampTypeTable::pageBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId,
	...
	cfbam::CFBamTZTimestampTypeBuff* CFBamRamTZTimestampTypeTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamTZTimestampTypeBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTZTimestampTypeBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamTZTimestampTypeBuff*>( editCur ) );
	}

	cfbam::CFBamTZTimestampTypeBuff* CFBamRamTZTimestampTypeTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTZTimestampTypeBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamTZTimestampTypeBuff* CFBamRamTZTimestampTypeTable::updateTZTimestampType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTZTimestampTypeBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in TZTimestampType for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamTZTimestampTypeBuff* existing = searchExisting->second;
		...
		cfbam::CFBamTZTimestampTypeBySchemaIdxKey existingKeySchemaIdx;
		...
		cfbam::CFBamTZTimestampTypeBySchemaIdxKey newKeySchemaIdx;
...

		{
			...
			if( allNull ) {
				cfbam::CFBamTZTimestampDefBuff* chk = dynamic_cast<cfbam::CFBamTZTimestampDefBuff*>( schema->getTableTZTimestampDef()->readDerivedByIdIdx( Authorization,
						Buff->getRequiredTenantId(),
						Buff->getRequiredId() ) );
				if( chk == NULL ) {
					delete Buff;
					std::string Msg( "Could not resolve Superclass relationship SuperClass to table TZTimestampDef" );
					throw cflib::CFLibUnresolvedRelationException( CLASS_NAME,
						S_ProcName,
						Msg );
				}
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamTZTimestampTypeBuff*>( schema->getTableTZTimestampDef()->updateTZTimestampDef( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimestampTypeBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimestampTypeBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamTZTimestampTypeBuff*>* subdictSchemaIdx;
		...
		if( searchNewKeyDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			dictBySchemaIdx->insert( std::map<cfbam::CFBamTZTimestampTypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamTZTimestampTypeBuff*>*>::value_type( newKeySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimestampTypeBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamTZTimestampTypeBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamTZTimestampTypeBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamTZTimestampTypeBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamTZTimestampTypeTable::deleteTZTimestampType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTZTimestampTypeBuff* Buff )
	{
		static const std::string S_ProcName( "deleteTZTimestampType" );
	...
	void CFBamRamTZTimestampTypeTable::deleteTZTimestampTypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamTZTimestampTypeBuff* cur = NULL;
		cfbam::CFBamTZTimestampTypeBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZTimestampTypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZTimestampTypeBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamTZTimestampTypeBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamTZTimestampTypeBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampTypeBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamTZTimestampTypeTable::deleteTZTimestampTypeByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamTZTimestampTypeTable::deleteTZTimestampTypeByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamTZTimestampTypeTable::deleteTZTimestampTypeByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamTZTimestampTypeTable::deleteTZTimestampTypeByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamTZTimestampTypeTable::deleteTZTimestampTypeByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTZTimestampTypeTable::deleteTZTimestampTypeByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTZTimestampTypeTable::deleteTZTimestampTypeByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTZTimestampTypeTable::deleteTZTimestampTypeByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamTZTimestampTypeTable::deleteTZTimestampTypeByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamTZTimestampTypeTable::releasePreparedStatements() {
	}
