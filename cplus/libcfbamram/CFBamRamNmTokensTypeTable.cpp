...
// Description: C++18 Implementation for an in-memory RAM DbIO for NmTokensType.
...
namespace cfbam {
	...
	const std::string CFBamRamNmTokensTypeTable::CLASS_NAME( "CFBamRamNmTokensTypeTable" );

	CFBamRamNmTokensTypeTable::CFBamRamNmTokensTypeTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamNmTokensTypeTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokensTypeBuff*>();
		dictBySchemaIdx = new std::map<cfbam::CFBamNmTokensTypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamNmTokensTypeBuff*>*>();
	}

	CFBamRamNmTokensTypeTable::~CFBamRamNmTokensTypeTable() {
	...
	cfbam::CFBamNmTokensTypeBuff* CFBamRamNmTokensTypeTable::createNmTokensType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNmTokensTypeBuff* Buff )
	{
		static const std::string S_ProcName( "createNmTokensType" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamNmTokensTypeBuff::CLASS_CODE ) {
		...
		cfbam::CFBamNmTokensTypeBuff* buff = dynamic_cast<cfbam::CFBamNmTokensTypeBuff*>( schema->getTableNmTokensDef()->createNmTokensDef( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokensTypeBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokensTypeBuff*>* subdictSchemaIdx;
		...
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			subdictSchemaIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokensTypeBuff*>();
			dictBySchemaIdx->insert( std::map<cfbam::CFBamNmTokensTypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamNmTokensTypeBuff*>*>::value_type( keySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokensTypeBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamNmTokensTypeBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamNmTokensTypeBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamNmTokensTypeBuff* CFBamRamNmTokensTypeTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamNmTokensTypeBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamNmTokensTypeBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamNmTokensTypeBuff* CFBamRamNmTokensTypeTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> CFBamRamNmTokensTypeTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNmTokensTypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNmTokensTypeBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamNmTokensTypeBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamNmTokensTypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamNmTokensTypeBuff* CFBamRamNmTokensTypeTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamNmTokensTypeBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamNmTokensTypeBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> CFBamRamNmTokensTypeTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamNmTokensTypeBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamNmTokensTypeBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> CFBamRamNmTokensTypeTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> CFBamRamNmTokensTypeTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> CFBamRamNmTokensTypeTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> CFBamRamNmTokensTypeTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> CFBamRamNmTokensTypeTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> CFBamRamNmTokensTypeTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> CFBamRamNmTokensTypeTable::readDerivedBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> recVec;
		cfbam::CFBamNmTokensTypeBuff* clone;
		auto searchDictBySchemaIdx = dictBySchemaIdx->find( key );
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamNmTokensTypeBuff*>* subdictSchemaIdx = searchDictBySchemaIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamNmTokensTypeBuff*>::iterator iter = subdictSchemaIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamNmTokensTypeBuff*>::iterator end = subdictSchemaIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamNmTokensTypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamNmTokensTypeBuff* CFBamRamNmTokensTypeTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamNmTokensTypeBuff* CFBamRamNmTokensTypeTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamNmTokensTypeBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamNmTokensTypeBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamNmTokensTypeBuff* CFBamRamNmTokensTypeTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamNmTokensTypeBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamNmTokensTypeBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> CFBamRamNmTokensTypeTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamNmTokensTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamNmTokensTypeBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamNmTokensTypeBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamNmTokensTypeBuff* CFBamRamNmTokensTypeTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamNmTokensTypeBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamNmTokensTypeBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamNmTokensTypeBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamNmTokensTypeBuff* CFBamRamNmTokensTypeTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamNmTokensTypeBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> CFBamRamNmTokensTypeTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamNmTokensTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> CFBamRamNmTokensTypeTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamNmTokensTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> CFBamRamNmTokensTypeTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamNmTokensTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> CFBamRamNmTokensTypeTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamNmTokensTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> CFBamRamNmTokensTypeTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamNmTokensTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> CFBamRamNmTokensTypeTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamNmTokensTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> CFBamRamNmTokensTypeTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamNmTokensTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> CFBamRamNmTokensTypeTable::readBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		cfbam::CFBamNmTokensTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> CFBamRamNmTokensTypeTable::pageBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId,
	...
	cfbam::CFBamNmTokensTypeBuff* CFBamRamNmTokensTypeTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamNmTokensTypeBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamNmTokensTypeBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamNmTokensTypeBuff*>( editCur ) );
	}

	cfbam::CFBamNmTokensTypeBuff* CFBamRamNmTokensTypeTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamNmTokensTypeBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamNmTokensTypeBuff* CFBamRamNmTokensTypeTable::updateNmTokensType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNmTokensTypeBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in NmTokensType for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamNmTokensTypeBuff* existing = searchExisting->second;
		...
		cfbam::CFBamNmTokensTypeBySchemaIdxKey existingKeySchemaIdx;
		...
		cfbam::CFBamNmTokensTypeBySchemaIdxKey newKeySchemaIdx;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamNmTokensTypeBuff*>( schema->getTableNmTokensDef()->updateNmTokensDef( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokensTypeBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokensTypeBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamNmTokensTypeBuff*>* subdictSchemaIdx;
		...
		if( searchNewKeyDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			dictBySchemaIdx->insert( std::map<cfbam::CFBamNmTokensTypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamNmTokensTypeBuff*>*>::value_type( newKeySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokensTypeBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamNmTokensTypeBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamNmTokensTypeBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamNmTokensTypeBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamNmTokensTypeTable::deleteNmTokensType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNmTokensTypeBuff* Buff )
	{
		static const std::string S_ProcName( "deleteNmTokensType" );
	...
	void CFBamRamNmTokensTypeTable::deleteNmTokensTypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamNmTokensTypeBuff* cur = NULL;
		cfbam::CFBamNmTokensTypeBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNmTokensTypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNmTokensTypeBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamNmTokensTypeBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamNmTokensTypeBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamNmTokensTypeTable::deleteNmTokensTypeByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamNmTokensTypeTable::deleteNmTokensTypeByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamNmTokensTypeTable::deleteNmTokensTypeByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamNmTokensTypeTable::deleteNmTokensTypeByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamNmTokensTypeTable::deleteNmTokensTypeByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamNmTokensTypeTable::deleteNmTokensTypeByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamNmTokensTypeTable::deleteNmTokensTypeByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamNmTokensTypeTable::deleteNmTokensTypeByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamNmTokensTypeTable::deleteNmTokensTypeByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamNmTokensTypeTable::releasePreparedStatements() {
	}
