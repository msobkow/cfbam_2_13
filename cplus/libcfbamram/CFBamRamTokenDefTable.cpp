...
// Description: C++18 Implementation for an in-memory RAM DbIO for TokenDef.
...
namespace cfbam {
	...
	const std::string CFBamRamTokenDefTable::CLASS_NAME( "CFBamRamTokenDefTable" );

	CFBamRamTokenDefTable::CFBamRamTokenDefTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamTokenDefTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTokenDefBuff*>();
	}

	CFBamRamTokenDefTable::~CFBamRamTokenDefTable() {
		if( dictByPKey != NULL ) {
			delete dictByPKey;
			dictByPKey = NULL;
		}
	...
	cfbam::CFBamTokenDefBuff* CFBamRamTokenDefTable::createTokenDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTokenDefBuff* Buff )
	{
		...
		cfbam::CFBamTokenDefBuff* buff = dynamic_cast<cfbam::CFBamTokenDefBuff*>( schema->getTableAtom()->createAtom( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTokenDefBuff*>::value_type( pkey, buff ) );

		// The top level code has to clone the final buffer. The one passed in is now part of the persistent storage.
		if( buff->getClassCode() == cfbam::CFBamTokenDefBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamTokenDefBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamTokenDefBuff* CFBamRamTokenDefTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamTokenDefBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamTokenDefBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamTokenDefBuff* CFBamRamTokenDefTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> CFBamRamTokenDefTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTokenDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTokenDefBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamTokenDefBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamTokenDefBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTokenDefBuff* CFBamRamTokenDefTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamTokenDefBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamTokenDefBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> CFBamRamTokenDefTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamTokenDefBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamTokenDefBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> CFBamRamTokenDefTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> CFBamRamTokenDefTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> CFBamRamTokenDefTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> CFBamRamTokenDefTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> CFBamRamTokenDefTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> CFBamRamTokenDefTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	cfbam::CFBamTokenDefBuff* CFBamRamTokenDefTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamTokenDefBuff* CFBamRamTokenDefTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamTokenDefBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamTokenDefBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamTokenDefBuff* CFBamRamTokenDefTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamTokenDefBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamTokenDefBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> CFBamRamTokenDefTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamTokenDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamTokenDefBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamTokenDefBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamTokenDefBuff* CFBamRamTokenDefTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamTokenDefBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamTokenDefBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamTokenDefBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamTokenDefBuff* CFBamRamTokenDefTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamTokenDefBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> CFBamRamTokenDefTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamTokenDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> CFBamRamTokenDefTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamTokenDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> CFBamRamTokenDefTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamTokenDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> CFBamRamTokenDefTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTokenDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> CFBamRamTokenDefTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTokenDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> CFBamRamTokenDefTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTokenDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> CFBamRamTokenDefTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTokenDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	cfbam::CFBamTokenDefBuff* CFBamRamTokenDefTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamTokenDefBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTokenDefBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamTokenDefBuff*>( editCur ) );
	}

	cfbam::CFBamTokenDefBuff* CFBamRamTokenDefTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTokenDefBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamTokenDefBuff* CFBamRamTokenDefTable::updateTokenDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTokenDefBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in TokenDef for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamTokenDefBuff* existing = searchExisting->second;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamTokenDefBuff*>( schema->getTableAtom()->updateAtom( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTokenDefBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTokenDefBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamTokenDefBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamTokenDefBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamTokenDefBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamTokenDefTable::deleteTokenDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTokenDefBuff* Buff )
	{
		static const std::string S_ProcName( "deleteTokenDef" );
		...
		{
			cfbam::CFBamTokenTypeBuff* refIdIdx = dynamic_cast<cfbam::CFBamTokenTypeBuff*>( schema->getTableTokenType()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table TokenType for primary key " + pkey.toString() );
		...
		{
			cfbam::CFBamTokenColBuff* refIdIdx = dynamic_cast<cfbam::CFBamTokenColBuff*>( schema->getTableTokenCol()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table TokenCol for primary key " + pkey.toString() );
				throw cflib::CFLibDependentsDetectedException( CLASS_NAME,
					S_ProcName,
					Msg );
			}
	...
	void CFBamRamTokenDefTable::deleteTokenDefByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTokenDefByIdIdx" );
		...
		cfbam::CFBamTokenDefBuff* cur = NULL;
		cfbam::CFBamTokenDefBuff* rereadCur = NULL;
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTokenDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTokenDefBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamValueBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamTokenDefBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamTokenDefBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamTokenDefBuff::CLASS_CODE ) {
	...
	void CFBamRamTokenDefTable::deleteTokenDefByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteTokenDefByUNameIdx" );
		cfbam::CFBamTokenDefBuff* cur = NULL;
		cfbam::CFBamTokenDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTokenDefTable::deleteTokenDefByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTokenDefByValTentIdx" );
		cfbam::CFBamTokenDefBuff* cur = NULL;
		cfbam::CFBamTokenDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTokenDefTable::deleteTokenDefByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTokenDefByScopeIdx" );
		cfbam::CFBamTokenDefBuff* cur = NULL;
		cfbam::CFBamTokenDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTokenDefTable::deleteTokenDefByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTokenDefByDefSchemaIdx" );
		cfbam::CFBamTokenDefBuff* cur = NULL;
		cfbam::CFBamTokenDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamTokenDefTable::deleteTokenDefByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTokenDefByPrevIdx" );
		cfbam::CFBamTokenDefBuff* cur = NULL;
		cfbam::CFBamTokenDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamTokenDefTable::deleteTokenDefByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTokenDefByNextIdx" );
		cfbam::CFBamTokenDefBuff* cur = NULL;
		cfbam::CFBamTokenDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamTokenDefTable::deleteTokenDefByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTokenDefByContPrevIdx" );
		cfbam::CFBamTokenDefBuff* cur = NULL;
		cfbam::CFBamTokenDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTokenDefTable::deleteTokenDefByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTokenDefByContNextIdx" );
		cfbam::CFBamTokenDefBuff* cur = NULL;
		cfbam::CFBamTokenDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTokenDefTable::releasePreparedStatements() {
	}
