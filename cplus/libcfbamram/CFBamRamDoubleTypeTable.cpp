...
// Description: C++18 Implementation for an in-memory RAM DbIO for DoubleType.
...
namespace cfbam {
	...
	const std::string CFBamRamDoubleTypeTable::CLASS_NAME( "CFBamRamDoubleTypeTable" );

	CFBamRamDoubleTypeTable::CFBamRamDoubleTypeTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamDoubleTypeTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamDoubleTypeBuff*>();
		dictBySchemaIdx = new std::map<cfbam::CFBamDoubleTypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamDoubleTypeBuff*>*>();
	}

	CFBamRamDoubleTypeTable::~CFBamRamDoubleTypeTable() {
	...
	cfbam::CFBamDoubleTypeBuff* CFBamRamDoubleTypeTable::createDoubleType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamDoubleTypeBuff* Buff )
	{
		static const std::string S_ProcName( "createDoubleType" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamDoubleTypeBuff::CLASS_CODE ) {
		...
		cfbam::CFBamDoubleTypeBuff* buff = dynamic_cast<cfbam::CFBamDoubleTypeBuff*>( schema->getTableDoubleDef()->createDoubleDef( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamDoubleTypeBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamDoubleTypeBuff*>* subdictSchemaIdx;
		...
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			subdictSchemaIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamDoubleTypeBuff*>();
			dictBySchemaIdx->insert( std::map<cfbam::CFBamDoubleTypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamDoubleTypeBuff*>*>::value_type( keySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamDoubleTypeBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamDoubleTypeBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamDoubleTypeBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamDoubleTypeBuff* CFBamRamDoubleTypeTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamDoubleTypeBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamDoubleTypeBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamDoubleTypeBuff* CFBamRamDoubleTypeTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> CFBamRamDoubleTypeTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamDoubleTypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamDoubleTypeBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamDoubleTypeBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamDoubleTypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamDoubleTypeBuff* CFBamRamDoubleTypeTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamDoubleTypeBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamDoubleTypeBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> CFBamRamDoubleTypeTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamDoubleTypeBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamDoubleTypeBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> CFBamRamDoubleTypeTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> CFBamRamDoubleTypeTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> CFBamRamDoubleTypeTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> CFBamRamDoubleTypeTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> CFBamRamDoubleTypeTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> CFBamRamDoubleTypeTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> CFBamRamDoubleTypeTable::readDerivedBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> recVec;
		cfbam::CFBamDoubleTypeBuff* clone;
		auto searchDictBySchemaIdx = dictBySchemaIdx->find( key );
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamDoubleTypeBuff*>* subdictSchemaIdx = searchDictBySchemaIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamDoubleTypeBuff*>::iterator iter = subdictSchemaIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamDoubleTypeBuff*>::iterator end = subdictSchemaIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamDoubleTypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamDoubleTypeBuff* CFBamRamDoubleTypeTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamDoubleTypeBuff* CFBamRamDoubleTypeTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamDoubleTypeBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamDoubleTypeBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamDoubleTypeBuff* CFBamRamDoubleTypeTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamDoubleTypeBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamDoubleTypeBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> CFBamRamDoubleTypeTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamDoubleTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamDoubleTypeBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamDoubleTypeBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamDoubleTypeBuff* CFBamRamDoubleTypeTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamDoubleTypeBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamDoubleTypeBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamDoubleTypeBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamDoubleTypeBuff* CFBamRamDoubleTypeTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamDoubleTypeBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> CFBamRamDoubleTypeTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamDoubleTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> CFBamRamDoubleTypeTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamDoubleTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> CFBamRamDoubleTypeTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamDoubleTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> CFBamRamDoubleTypeTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamDoubleTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> CFBamRamDoubleTypeTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamDoubleTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> CFBamRamDoubleTypeTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamDoubleTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> CFBamRamDoubleTypeTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamDoubleTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> CFBamRamDoubleTypeTable::readBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		cfbam::CFBamDoubleTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> CFBamRamDoubleTypeTable::pageBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId,
	...
	cfbam::CFBamDoubleTypeBuff* CFBamRamDoubleTypeTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamDoubleTypeBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamDoubleTypeBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamDoubleTypeBuff*>( editCur ) );
	}

	cfbam::CFBamDoubleTypeBuff* CFBamRamDoubleTypeTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamDoubleTypeBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamDoubleTypeBuff* CFBamRamDoubleTypeTable::updateDoubleType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamDoubleTypeBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in DoubleType for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamDoubleTypeBuff* existing = searchExisting->second;
		...
		cfbam::CFBamDoubleTypeBySchemaIdxKey existingKeySchemaIdx;
		...
		cfbam::CFBamDoubleTypeBySchemaIdxKey newKeySchemaIdx;
...

		{
			...
			if( allNull ) {
				cfbam::CFBamDoubleDefBuff* chk = dynamic_cast<cfbam::CFBamDoubleDefBuff*>( schema->getTableDoubleDef()->readDerivedByIdIdx( Authorization,
						Buff->getRequiredTenantId(),
						Buff->getRequiredId() ) );
				if( chk == NULL ) {
					delete Buff;
					std::string Msg( "Could not resolve Superclass relationship SuperClass to table DoubleDef" );
					throw cflib::CFLibUnresolvedRelationException( CLASS_NAME,
						S_ProcName,
						Msg );
				}
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamDoubleTypeBuff*>( schema->getTableDoubleDef()->updateDoubleDef( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamDoubleTypeBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamDoubleTypeBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamDoubleTypeBuff*>* subdictSchemaIdx;
		...
		if( searchNewKeyDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			dictBySchemaIdx->insert( std::map<cfbam::CFBamDoubleTypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamDoubleTypeBuff*>*>::value_type( newKeySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamDoubleTypeBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamDoubleTypeBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamDoubleTypeBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamDoubleTypeBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamDoubleTypeTable::deleteDoubleType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamDoubleTypeBuff* Buff )
	{
		static const std::string S_ProcName( "deleteDoubleType" );
	...
	void CFBamRamDoubleTypeTable::deleteDoubleTypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamDoubleTypeBuff* cur = NULL;
		cfbam::CFBamDoubleTypeBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamDoubleTypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamDoubleTypeBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamDoubleTypeBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamDoubleTypeBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamDoubleTypeTable::deleteDoubleTypeByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamDoubleTypeTable::deleteDoubleTypeByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamDoubleTypeTable::deleteDoubleTypeByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamDoubleTypeTable::deleteDoubleTypeByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamDoubleTypeTable::deleteDoubleTypeByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamDoubleTypeTable::deleteDoubleTypeByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamDoubleTypeTable::deleteDoubleTypeByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamDoubleTypeTable::deleteDoubleTypeByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamDoubleTypeTable::deleteDoubleTypeByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamDoubleTypeTable::releasePreparedStatements() {
	}
