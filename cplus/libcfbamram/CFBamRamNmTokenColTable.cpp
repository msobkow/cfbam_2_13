...
// Description: C++18 Implementation for an in-memory RAM DbIO for NmTokenCol.
...
namespace cfbam {
	...
	const std::string CFBamRamNmTokenColTable::CLASS_NAME( "CFBamRamNmTokenColTable" );

	CFBamRamNmTokenColTable::CFBamRamNmTokenColTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamNmTokenColTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokenColBuff*>();
		dictByTableIdx = new std::map<cfbam::CFBamNmTokenColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamNmTokenColBuff*>*>();
	}

	CFBamRamNmTokenColTable::~CFBamRamNmTokenColTable() {
	...
	cfbam::CFBamNmTokenColBuff* CFBamRamNmTokenColTable::createNmTokenCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNmTokenColBuff* Buff )
	{
		static const std::string S_ProcName( "createNmTokenCol" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamNmTokenColBuff::CLASS_CODE ) {
		...
		cfbam::CFBamNmTokenColBuff* buff = dynamic_cast<cfbam::CFBamNmTokenColBuff*>( schema->getTableNmTokenDef()->createNmTokenDef( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokenColBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokenColBuff*>* subdictTableIdx;
		...
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			...
			subdictTableIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokenColBuff*>();
			dictByTableIdx->insert( std::map<cfbam::CFBamNmTokenColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamNmTokenColBuff*>*>::value_type( keyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokenColBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamNmTokenColBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamNmTokenColBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamNmTokenColBuff* CFBamRamNmTokenColTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamNmTokenColBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamNmTokenColBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamNmTokenColBuff* CFBamRamNmTokenColTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> CFBamRamNmTokenColTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNmTokenColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNmTokenColBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamNmTokenColBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamNmTokenColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamNmTokenColBuff* CFBamRamNmTokenColTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamNmTokenColBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamNmTokenColBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> CFBamRamNmTokenColTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamNmTokenColBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamNmTokenColBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> CFBamRamNmTokenColTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> CFBamRamNmTokenColTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> CFBamRamNmTokenColTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> CFBamRamNmTokenColTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> CFBamRamNmTokenColTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> CFBamRamNmTokenColTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> CFBamRamNmTokenColTable::readDerivedByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> recVec;
		cfbam::CFBamNmTokenColBuff* clone;
		auto searchDictByTableIdx = dictByTableIdx->find( key );
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamNmTokenColBuff*>* subdictTableIdx = searchDictByTableIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamNmTokenColBuff*>::iterator iter = subdictTableIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamNmTokenColBuff*>::iterator end = subdictTableIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamNmTokenColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamNmTokenColBuff* CFBamRamNmTokenColTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamNmTokenColBuff* CFBamRamNmTokenColTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamNmTokenColBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamNmTokenColBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamNmTokenColBuff* CFBamRamNmTokenColTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamNmTokenColBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamNmTokenColBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> CFBamRamNmTokenColTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamNmTokenColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamNmTokenColBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamNmTokenColBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamNmTokenColBuff* CFBamRamNmTokenColTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamNmTokenColBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamNmTokenColBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamNmTokenColBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamNmTokenColBuff* CFBamRamNmTokenColTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamNmTokenColBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> CFBamRamNmTokenColTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamNmTokenColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> CFBamRamNmTokenColTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamNmTokenColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> CFBamRamNmTokenColTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamNmTokenColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> CFBamRamNmTokenColTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamNmTokenColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> CFBamRamNmTokenColTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamNmTokenColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> CFBamRamNmTokenColTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamNmTokenColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> CFBamRamNmTokenColTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamNmTokenColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> CFBamRamNmTokenColTable::readBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		cfbam::CFBamNmTokenColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> CFBamRamNmTokenColTable::pageBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId,
	...
	cfbam::CFBamNmTokenColBuff* CFBamRamNmTokenColTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamNmTokenColBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamNmTokenColBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamNmTokenColBuff*>( editCur ) );
	}

	cfbam::CFBamNmTokenColBuff* CFBamRamNmTokenColTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamNmTokenColBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamNmTokenColBuff* CFBamRamNmTokenColTable::updateNmTokenCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNmTokenColBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in NmTokenCol for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamNmTokenColBuff* existing = searchExisting->second;
		...
		cfbam::CFBamNmTokenColByTableIdxKey existingKeyTableIdx;
		...
		cfbam::CFBamNmTokenColByTableIdxKey newKeyTableIdx;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamNmTokenColBuff*>( schema->getTableNmTokenDef()->updateNmTokenDef( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokenColBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokenColBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamNmTokenColBuff*>* subdictTableIdx;
		...
		if( searchNewKeyDictByTableIdx != dictByTableIdx->end() ) {
			...
			dictByTableIdx->insert( std::map<cfbam::CFBamNmTokenColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamNmTokenColBuff*>*>::value_type( newKeyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokenColBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamNmTokenColBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamNmTokenColBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamNmTokenColBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamNmTokenColTable::deleteNmTokenCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNmTokenColBuff* Buff )
	{
		static const std::string S_ProcName( "deleteNmTokenCol" );
	...
	void CFBamRamNmTokenColTable::deleteNmTokenColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamNmTokenColBuff* cur = NULL;
		cfbam::CFBamNmTokenColBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNmTokenColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNmTokenColBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamNmTokenColBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamNmTokenColBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokenColBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamNmTokenColTable::deleteNmTokenColByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamNmTokenColTable::deleteNmTokenColByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamNmTokenColTable::deleteNmTokenColByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamNmTokenColTable::deleteNmTokenColByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamNmTokenColTable::deleteNmTokenColByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamNmTokenColTable::deleteNmTokenColByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamNmTokenColTable::deleteNmTokenColByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamNmTokenColTable::deleteNmTokenColByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamNmTokenColTable::deleteNmTokenColByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamNmTokenColTable::releasePreparedStatements() {
	}
