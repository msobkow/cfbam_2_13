...
// Description: C++18 Implementation for an in-memory RAM DbIO for TZDateCol.
...
namespace cfbam {
	...
	const std::string CFBamRamTZDateColTable::CLASS_NAME( "CFBamRamTZDateColTable" );

	CFBamRamTZDateColTable::CFBamRamTZDateColTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamTZDateColTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZDateColBuff*>();
		dictByTableIdx = new std::map<cfbam::CFBamTZDateColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTZDateColBuff*>*>();
	}

	CFBamRamTZDateColTable::~CFBamRamTZDateColTable() {
	...
	cfbam::CFBamTZDateColBuff* CFBamRamTZDateColTable::createTZDateCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTZDateColBuff* Buff )
	{
		static const std::string S_ProcName( "createTZDateCol" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamTZDateColBuff::CLASS_CODE ) {
		...
		cfbam::CFBamTZDateColBuff* buff = dynamic_cast<cfbam::CFBamTZDateColBuff*>( schema->getTableTZDateDef()->createTZDateDef( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZDateColBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZDateColBuff*>* subdictTableIdx;
		...
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			...
			subdictTableIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZDateColBuff*>();
			dictByTableIdx->insert( std::map<cfbam::CFBamTZDateColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamTZDateColBuff*>*>::value_type( keyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZDateColBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamTZDateColBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamTZDateColBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamTZDateColBuff* CFBamRamTZDateColTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamTZDateColBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamTZDateColBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamTZDateColBuff* CFBamRamTZDateColTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> CFBamRamTZDateColTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZDateColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZDateColBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamTZDateColBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamTZDateColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTZDateColBuff* CFBamRamTZDateColTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamTZDateColBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamTZDateColBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> CFBamRamTZDateColTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamTZDateColBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamTZDateColBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> CFBamRamTZDateColTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> CFBamRamTZDateColTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> CFBamRamTZDateColTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> CFBamRamTZDateColTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> CFBamRamTZDateColTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> CFBamRamTZDateColTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> CFBamRamTZDateColTable::readDerivedByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> recVec;
		cfbam::CFBamTZDateColBuff* clone;
		auto searchDictByTableIdx = dictByTableIdx->find( key );
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamTZDateColBuff*>* subdictTableIdx = searchDictByTableIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTZDateColBuff*>::iterator iter = subdictTableIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTZDateColBuff*>::iterator end = subdictTableIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamTZDateColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTZDateColBuff* CFBamRamTZDateColTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamTZDateColBuff* CFBamRamTZDateColTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamTZDateColBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamTZDateColBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamTZDateColBuff* CFBamRamTZDateColTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamTZDateColBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamTZDateColBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> CFBamRamTZDateColTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamTZDateColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamTZDateColBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamTZDateColBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamTZDateColBuff* CFBamRamTZDateColTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamTZDateColBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamTZDateColBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamTZDateColBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamTZDateColBuff* CFBamRamTZDateColTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamTZDateColBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> CFBamRamTZDateColTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamTZDateColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> CFBamRamTZDateColTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamTZDateColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> CFBamRamTZDateColTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamTZDateColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> CFBamRamTZDateColTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTZDateColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> CFBamRamTZDateColTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTZDateColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> CFBamRamTZDateColTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTZDateColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> CFBamRamTZDateColTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTZDateColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> CFBamRamTZDateColTable::readBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		cfbam::CFBamTZDateColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> CFBamRamTZDateColTable::pageBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId,
	...
	cfbam::CFBamTZDateColBuff* CFBamRamTZDateColTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamTZDateColBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTZDateColBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamTZDateColBuff*>( editCur ) );
	}

	cfbam::CFBamTZDateColBuff* CFBamRamTZDateColTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTZDateColBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamTZDateColBuff* CFBamRamTZDateColTable::updateTZDateCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTZDateColBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in TZDateCol for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamTZDateColBuff* existing = searchExisting->second;
		...
		cfbam::CFBamTZDateColByTableIdxKey existingKeyTableIdx;
		...
		cfbam::CFBamTZDateColByTableIdxKey newKeyTableIdx;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamTZDateColBuff*>( schema->getTableTZDateDef()->updateTZDateDef( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZDateColBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZDateColBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamTZDateColBuff*>* subdictTableIdx;
		...
		if( searchNewKeyDictByTableIdx != dictByTableIdx->end() ) {
			...
			dictByTableIdx->insert( std::map<cfbam::CFBamTZDateColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamTZDateColBuff*>*>::value_type( newKeyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZDateColBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamTZDateColBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamTZDateColBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamTZDateColBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamTZDateColTable::deleteTZDateCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTZDateColBuff* Buff )
	{
		static const std::string S_ProcName( "deleteTZDateCol" );
	...
	void CFBamRamTZDateColTable::deleteTZDateColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamTZDateColBuff* cur = NULL;
		cfbam::CFBamTZDateColBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZDateColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZDateColBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamTZDateColBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamTZDateColBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamTZDateColTable::deleteTZDateColByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamTZDateColTable::deleteTZDateColByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamTZDateColTable::deleteTZDateColByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamTZDateColTable::deleteTZDateColByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamTZDateColTable::deleteTZDateColByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTZDateColTable::deleteTZDateColByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTZDateColTable::deleteTZDateColByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTZDateColTable::deleteTZDateColByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamTZDateColTable::deleteTZDateColByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamTZDateColTable::releasePreparedStatements() {
	}
