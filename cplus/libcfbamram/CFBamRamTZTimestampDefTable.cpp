...
// Description: C++18 Implementation for an in-memory RAM DbIO for TZTimestampDef.
...
namespace cfbam {
	...
	const std::string CFBamRamTZTimestampDefTable::CLASS_NAME( "CFBamRamTZTimestampDefTable" );

	CFBamRamTZTimestampDefTable::CFBamRamTZTimestampDefTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamTZTimestampDefTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimestampDefBuff*>();
	}

	CFBamRamTZTimestampDefTable::~CFBamRamTZTimestampDefTable() {
		if( dictByPKey != NULL ) {
			delete dictByPKey;
			dictByPKey = NULL;
		}
	...
	cfbam::CFBamTZTimestampDefBuff* CFBamRamTZTimestampDefTable::createTZTimestampDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTZTimestampDefBuff* Buff )
	{
		...
		cfbam::CFBamTZTimestampDefBuff* buff = dynamic_cast<cfbam::CFBamTZTimestampDefBuff*>( schema->getTableAtom()->createAtom( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimestampDefBuff*>::value_type( pkey, buff ) );

		// The top level code has to clone the final buffer. The one passed in is now part of the persistent storage.
		if( buff->getClassCode() == cfbam::CFBamTZTimestampDefBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamTZTimestampDefBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamTZTimestampDefBuff* CFBamRamTZTimestampDefTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamTZTimestampDefBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamTZTimestampDefBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamTZTimestampDefBuff* CFBamRamTZTimestampDefTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> CFBamRamTZTimestampDefTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZTimestampDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZTimestampDefBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamTZTimestampDefBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamTZTimestampDefBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTZTimestampDefBuff* CFBamRamTZTimestampDefTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamTZTimestampDefBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamTZTimestampDefBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> CFBamRamTZTimestampDefTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamTZTimestampDefBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamTZTimestampDefBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> CFBamRamTZTimestampDefTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> CFBamRamTZTimestampDefTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> CFBamRamTZTimestampDefTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> CFBamRamTZTimestampDefTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> CFBamRamTZTimestampDefTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> CFBamRamTZTimestampDefTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	cfbam::CFBamTZTimestampDefBuff* CFBamRamTZTimestampDefTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamTZTimestampDefBuff* CFBamRamTZTimestampDefTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamTZTimestampDefBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamTZTimestampDefBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamTZTimestampDefBuff* CFBamRamTZTimestampDefTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamTZTimestampDefBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamTZTimestampDefBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> CFBamRamTZTimestampDefTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamTZTimestampDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamTZTimestampDefBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamTZTimestampDefBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamTZTimestampDefBuff* CFBamRamTZTimestampDefTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamTZTimestampDefBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamTZTimestampDefBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamTZTimestampDefBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamTZTimestampDefBuff* CFBamRamTZTimestampDefTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamTZTimestampDefBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> CFBamRamTZTimestampDefTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamTZTimestampDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> CFBamRamTZTimestampDefTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamTZTimestampDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> CFBamRamTZTimestampDefTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamTZTimestampDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> CFBamRamTZTimestampDefTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTZTimestampDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> CFBamRamTZTimestampDefTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTZTimestampDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> CFBamRamTZTimestampDefTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTZTimestampDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> CFBamRamTZTimestampDefTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTZTimestampDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	cfbam::CFBamTZTimestampDefBuff* CFBamRamTZTimestampDefTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamTZTimestampDefBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTZTimestampDefBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamTZTimestampDefBuff*>( editCur ) );
	}

	cfbam::CFBamTZTimestampDefBuff* CFBamRamTZTimestampDefTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTZTimestampDefBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamTZTimestampDefBuff* CFBamRamTZTimestampDefTable::updateTZTimestampDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTZTimestampDefBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in TZTimestampDef for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamTZTimestampDefBuff* existing = searchExisting->second;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamTZTimestampDefBuff*>( schema->getTableAtom()->updateAtom( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimestampDefBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimestampDefBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamTZTimestampDefBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamTZTimestampDefBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamTZTimestampDefBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamTZTimestampDefTable::deleteTZTimestampDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTZTimestampDefBuff* Buff )
	{
		static const std::string S_ProcName( "deleteTZTimestampDef" );
		...
		{
			cfbam::CFBamTZTimestampTypeBuff* refIdIdx = dynamic_cast<cfbam::CFBamTZTimestampTypeBuff*>( schema->getTableTZTimestampType()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table TZTimestampType for primary key " + pkey.toString() );
		...
		{
			cfbam::CFBamTZTimestampColBuff* refIdIdx = dynamic_cast<cfbam::CFBamTZTimestampColBuff*>( schema->getTableTZTimestampCol()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table TZTimestampCol for primary key " + pkey.toString() );
				throw cflib::CFLibDependentsDetectedException( CLASS_NAME,
					S_ProcName,
					Msg );
			}
	...
	void CFBamRamTZTimestampDefTable::deleteTZTimestampDefByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTZTimestampDefByIdIdx" );
		...
		cfbam::CFBamTZTimestampDefBuff* cur = NULL;
		cfbam::CFBamTZTimestampDefBuff* rereadCur = NULL;
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZTimestampDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZTimestampDefBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamValueBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamTZTimestampDefBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimestampDefBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamTZTimestampDefBuff::CLASS_CODE ) {
	...
	void CFBamRamTZTimestampDefTable::deleteTZTimestampDefByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteTZTimestampDefByUNameIdx" );
		cfbam::CFBamTZTimestampDefBuff* cur = NULL;
		cfbam::CFBamTZTimestampDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTZTimestampDefTable::deleteTZTimestampDefByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTZTimestampDefByValTentIdx" );
		cfbam::CFBamTZTimestampDefBuff* cur = NULL;
		cfbam::CFBamTZTimestampDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTZTimestampDefTable::deleteTZTimestampDefByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTZTimestampDefByScopeIdx" );
		cfbam::CFBamTZTimestampDefBuff* cur = NULL;
		cfbam::CFBamTZTimestampDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTZTimestampDefTable::deleteTZTimestampDefByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTZTimestampDefByDefSchemaIdx" );
		cfbam::CFBamTZTimestampDefBuff* cur = NULL;
		cfbam::CFBamTZTimestampDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamTZTimestampDefTable::deleteTZTimestampDefByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTZTimestampDefByPrevIdx" );
		cfbam::CFBamTZTimestampDefBuff* cur = NULL;
		cfbam::CFBamTZTimestampDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamTZTimestampDefTable::deleteTZTimestampDefByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTZTimestampDefByNextIdx" );
		cfbam::CFBamTZTimestampDefBuff* cur = NULL;
		cfbam::CFBamTZTimestampDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamTZTimestampDefTable::deleteTZTimestampDefByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTZTimestampDefByContPrevIdx" );
		cfbam::CFBamTZTimestampDefBuff* cur = NULL;
		cfbam::CFBamTZTimestampDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTZTimestampDefTable::deleteTZTimestampDefByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTZTimestampDefByContNextIdx" );
		cfbam::CFBamTZTimestampDefBuff* cur = NULL;
		cfbam::CFBamTZTimestampDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTZTimestampDefTable::releasePreparedStatements() {
	}
