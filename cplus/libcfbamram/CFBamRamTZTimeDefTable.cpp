...
// Description: C++18 Implementation for an in-memory RAM DbIO for TZTimeDef.
...
namespace cfbam {
	...
	const std::string CFBamRamTZTimeDefTable::CLASS_NAME( "CFBamRamTZTimeDefTable" );

	CFBamRamTZTimeDefTable::CFBamRamTZTimeDefTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamTZTimeDefTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimeDefBuff*>();
	}

	CFBamRamTZTimeDefTable::~CFBamRamTZTimeDefTable() {
		if( dictByPKey != NULL ) {
			delete dictByPKey;
			dictByPKey = NULL;
		}
	...
	cfbam::CFBamTZTimeDefBuff* CFBamRamTZTimeDefTable::createTZTimeDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTZTimeDefBuff* Buff )
	{
		...
		cfbam::CFBamTZTimeDefBuff* buff = dynamic_cast<cfbam::CFBamTZTimeDefBuff*>( schema->getTableAtom()->createAtom( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimeDefBuff*>::value_type( pkey, buff ) );

		// The top level code has to clone the final buffer. The one passed in is now part of the persistent storage.
		if( buff->getClassCode() == cfbam::CFBamTZTimeDefBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamTZTimeDefBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamTZTimeDefBuff* CFBamRamTZTimeDefTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamTZTimeDefBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamTZTimeDefBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamTZTimeDefBuff* CFBamRamTZTimeDefTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> CFBamRamTZTimeDefTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZTimeDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZTimeDefBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamTZTimeDefBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamTZTimeDefBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTZTimeDefBuff* CFBamRamTZTimeDefTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamTZTimeDefBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamTZTimeDefBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> CFBamRamTZTimeDefTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamTZTimeDefBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamTZTimeDefBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> CFBamRamTZTimeDefTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> CFBamRamTZTimeDefTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> CFBamRamTZTimeDefTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> CFBamRamTZTimeDefTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> CFBamRamTZTimeDefTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> CFBamRamTZTimeDefTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	cfbam::CFBamTZTimeDefBuff* CFBamRamTZTimeDefTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamTZTimeDefBuff* CFBamRamTZTimeDefTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamTZTimeDefBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamTZTimeDefBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamTZTimeDefBuff* CFBamRamTZTimeDefTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamTZTimeDefBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamTZTimeDefBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> CFBamRamTZTimeDefTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamTZTimeDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamTZTimeDefBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamTZTimeDefBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamTZTimeDefBuff* CFBamRamTZTimeDefTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamTZTimeDefBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamTZTimeDefBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamTZTimeDefBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamTZTimeDefBuff* CFBamRamTZTimeDefTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamTZTimeDefBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> CFBamRamTZTimeDefTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamTZTimeDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> CFBamRamTZTimeDefTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamTZTimeDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> CFBamRamTZTimeDefTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamTZTimeDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> CFBamRamTZTimeDefTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTZTimeDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> CFBamRamTZTimeDefTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTZTimeDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> CFBamRamTZTimeDefTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTZTimeDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> CFBamRamTZTimeDefTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTZTimeDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	cfbam::CFBamTZTimeDefBuff* CFBamRamTZTimeDefTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamTZTimeDefBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTZTimeDefBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamTZTimeDefBuff*>( editCur ) );
	}

	cfbam::CFBamTZTimeDefBuff* CFBamRamTZTimeDefTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTZTimeDefBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamTZTimeDefBuff* CFBamRamTZTimeDefTable::updateTZTimeDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTZTimeDefBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in TZTimeDef for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamTZTimeDefBuff* existing = searchExisting->second;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamTZTimeDefBuff*>( schema->getTableAtom()->updateAtom( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimeDefBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimeDefBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamTZTimeDefBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamTZTimeDefBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamTZTimeDefBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamTZTimeDefTable::deleteTZTimeDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTZTimeDefBuff* Buff )
	{
		static const std::string S_ProcName( "deleteTZTimeDef" );
		...
		{
			cfbam::CFBamTZTimeTypeBuff* refIdIdx = dynamic_cast<cfbam::CFBamTZTimeTypeBuff*>( schema->getTableTZTimeType()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table TZTimeType for primary key " + pkey.toString() );
		...
		{
			cfbam::CFBamTZTimeColBuff* refIdIdx = dynamic_cast<cfbam::CFBamTZTimeColBuff*>( schema->getTableTZTimeCol()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table TZTimeCol for primary key " + pkey.toString() );
				throw cflib::CFLibDependentsDetectedException( CLASS_NAME,
					S_ProcName,
					Msg );
			}
	...
	void CFBamRamTZTimeDefTable::deleteTZTimeDefByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTZTimeDefByIdIdx" );
		...
		cfbam::CFBamTZTimeDefBuff* cur = NULL;
		cfbam::CFBamTZTimeDefBuff* rereadCur = NULL;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZTimeDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZTimeDefBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamValueBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamTZTimeDefBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamTZTimeDefBuff::CLASS_CODE ) {
	...
	void CFBamRamTZTimeDefTable::deleteTZTimeDefByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteTZTimeDefByUNameIdx" );
		cfbam::CFBamTZTimeDefBuff* cur = NULL;
		cfbam::CFBamTZTimeDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTZTimeDefTable::deleteTZTimeDefByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTZTimeDefByValTentIdx" );
		cfbam::CFBamTZTimeDefBuff* cur = NULL;
		cfbam::CFBamTZTimeDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTZTimeDefTable::deleteTZTimeDefByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTZTimeDefByScopeIdx" );
		cfbam::CFBamTZTimeDefBuff* cur = NULL;
		cfbam::CFBamTZTimeDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTZTimeDefTable::deleteTZTimeDefByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTZTimeDefByDefSchemaIdx" );
		cfbam::CFBamTZTimeDefBuff* cur = NULL;
		cfbam::CFBamTZTimeDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamTZTimeDefTable::deleteTZTimeDefByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTZTimeDefByPrevIdx" );
		cfbam::CFBamTZTimeDefBuff* cur = NULL;
		cfbam::CFBamTZTimeDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamTZTimeDefTable::deleteTZTimeDefByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTZTimeDefByNextIdx" );
		cfbam::CFBamTZTimeDefBuff* cur = NULL;
		cfbam::CFBamTZTimeDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamTZTimeDefTable::deleteTZTimeDefByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTZTimeDefByContPrevIdx" );
		cfbam::CFBamTZTimeDefBuff* cur = NULL;
		cfbam::CFBamTZTimeDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTZTimeDefTable::deleteTZTimeDefByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTZTimeDefByContNextIdx" );
		cfbam::CFBamTZTimeDefBuff* cur = NULL;
		cfbam::CFBamTZTimeDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTZTimeDefTable::releasePreparedStatements() {
	}
