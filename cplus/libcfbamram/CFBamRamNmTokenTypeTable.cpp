...
// Description: C++18 Implementation for an in-memory RAM DbIO for NmTokenType.
...
namespace cfbam {
	...
	const std::string CFBamRamNmTokenTypeTable::CLASS_NAME( "CFBamRamNmTokenTypeTable" );

	CFBamRamNmTokenTypeTable::CFBamRamNmTokenTypeTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamNmTokenTypeTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokenTypeBuff*>();
		dictBySchemaIdx = new std::map<cfbam::CFBamNmTokenTypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamNmTokenTypeBuff*>*>();
	}

	CFBamRamNmTokenTypeTable::~CFBamRamNmTokenTypeTable() {
	...
	cfbam::CFBamNmTokenTypeBuff* CFBamRamNmTokenTypeTable::createNmTokenType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNmTokenTypeBuff* Buff )
	{
		static const std::string S_ProcName( "createNmTokenType" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamNmTokenTypeBuff::CLASS_CODE ) {
		...
		cfbam::CFBamNmTokenTypeBuff* buff = dynamic_cast<cfbam::CFBamNmTokenTypeBuff*>( schema->getTableNmTokenDef()->createNmTokenDef( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokenTypeBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokenTypeBuff*>* subdictSchemaIdx;
		...
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			subdictSchemaIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokenTypeBuff*>();
			dictBySchemaIdx->insert( std::map<cfbam::CFBamNmTokenTypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamNmTokenTypeBuff*>*>::value_type( keySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokenTypeBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamNmTokenTypeBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamNmTokenTypeBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamNmTokenTypeBuff* CFBamRamNmTokenTypeTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamNmTokenTypeBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamNmTokenTypeBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamNmTokenTypeBuff* CFBamRamNmTokenTypeTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> CFBamRamNmTokenTypeTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNmTokenTypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNmTokenTypeBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamNmTokenTypeBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamNmTokenTypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamNmTokenTypeBuff* CFBamRamNmTokenTypeTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamNmTokenTypeBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamNmTokenTypeBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> CFBamRamNmTokenTypeTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamNmTokenTypeBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamNmTokenTypeBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> CFBamRamNmTokenTypeTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> CFBamRamNmTokenTypeTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> CFBamRamNmTokenTypeTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> CFBamRamNmTokenTypeTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> CFBamRamNmTokenTypeTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> CFBamRamNmTokenTypeTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> CFBamRamNmTokenTypeTable::readDerivedBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> recVec;
		cfbam::CFBamNmTokenTypeBuff* clone;
		auto searchDictBySchemaIdx = dictBySchemaIdx->find( key );
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamNmTokenTypeBuff*>* subdictSchemaIdx = searchDictBySchemaIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamNmTokenTypeBuff*>::iterator iter = subdictSchemaIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamNmTokenTypeBuff*>::iterator end = subdictSchemaIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamNmTokenTypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamNmTokenTypeBuff* CFBamRamNmTokenTypeTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamNmTokenTypeBuff* CFBamRamNmTokenTypeTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamNmTokenTypeBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamNmTokenTypeBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamNmTokenTypeBuff* CFBamRamNmTokenTypeTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamNmTokenTypeBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamNmTokenTypeBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> CFBamRamNmTokenTypeTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamNmTokenTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamNmTokenTypeBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamNmTokenTypeBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamNmTokenTypeBuff* CFBamRamNmTokenTypeTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamNmTokenTypeBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamNmTokenTypeBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamNmTokenTypeBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamNmTokenTypeBuff* CFBamRamNmTokenTypeTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamNmTokenTypeBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> CFBamRamNmTokenTypeTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamNmTokenTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> CFBamRamNmTokenTypeTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamNmTokenTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> CFBamRamNmTokenTypeTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamNmTokenTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> CFBamRamNmTokenTypeTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamNmTokenTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> CFBamRamNmTokenTypeTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamNmTokenTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> CFBamRamNmTokenTypeTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamNmTokenTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> CFBamRamNmTokenTypeTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamNmTokenTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> CFBamRamNmTokenTypeTable::readBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		cfbam::CFBamNmTokenTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> CFBamRamNmTokenTypeTable::pageBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId,
	...
	cfbam::CFBamNmTokenTypeBuff* CFBamRamNmTokenTypeTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamNmTokenTypeBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamNmTokenTypeBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamNmTokenTypeBuff*>( editCur ) );
	}

	cfbam::CFBamNmTokenTypeBuff* CFBamRamNmTokenTypeTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamNmTokenTypeBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamNmTokenTypeBuff* CFBamRamNmTokenTypeTable::updateNmTokenType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNmTokenTypeBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in NmTokenType for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamNmTokenTypeBuff* existing = searchExisting->second;
		...
		cfbam::CFBamNmTokenTypeBySchemaIdxKey existingKeySchemaIdx;
		...
		cfbam::CFBamNmTokenTypeBySchemaIdxKey newKeySchemaIdx;
...

		{
			...
			if( allNull ) {
				cfbam::CFBamNmTokenDefBuff* chk = dynamic_cast<cfbam::CFBamNmTokenDefBuff*>( schema->getTableNmTokenDef()->readDerivedByIdIdx( Authorization,
						Buff->getRequiredTenantId(),
						Buff->getRequiredId() ) );
				if( chk == NULL ) {
					delete Buff;
					std::string Msg( "Could not resolve Superclass relationship SuperClass to table NmTokenDef" );
					throw cflib::CFLibUnresolvedRelationException( CLASS_NAME,
						S_ProcName,
						Msg );
				}
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamNmTokenTypeBuff*>( schema->getTableNmTokenDef()->updateNmTokenDef( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokenTypeBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokenTypeBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamNmTokenTypeBuff*>* subdictSchemaIdx;
		...
		if( searchNewKeyDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			dictBySchemaIdx->insert( std::map<cfbam::CFBamNmTokenTypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamNmTokenTypeBuff*>*>::value_type( newKeySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokenTypeBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamNmTokenTypeBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamNmTokenTypeBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamNmTokenTypeBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamNmTokenTypeTable::deleteNmTokenType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNmTokenTypeBuff* Buff )
	{
		static const std::string S_ProcName( "deleteNmTokenType" );
	...
	void CFBamRamNmTokenTypeTable::deleteNmTokenTypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamNmTokenTypeBuff* cur = NULL;
		cfbam::CFBamNmTokenTypeBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNmTokenTypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNmTokenTypeBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamNmTokenTypeBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamNmTokenTypeBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamNmTokenTypeTable::deleteNmTokenTypeByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamNmTokenTypeTable::deleteNmTokenTypeByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamNmTokenTypeTable::deleteNmTokenTypeByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamNmTokenTypeTable::deleteNmTokenTypeByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamNmTokenTypeTable::deleteNmTokenTypeByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamNmTokenTypeTable::deleteNmTokenTypeByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamNmTokenTypeTable::deleteNmTokenTypeByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamNmTokenTypeTable::deleteNmTokenTypeByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamNmTokenTypeTable::deleteNmTokenTypeByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamNmTokenTypeTable::releasePreparedStatements() {
	}
