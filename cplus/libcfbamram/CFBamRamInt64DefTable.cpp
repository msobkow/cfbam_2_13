...
// Description: C++18 Implementation for an in-memory RAM DbIO for Int64Def.
...
namespace cfbam {
	...
	const std::string CFBamRamInt64DefTable::CLASS_NAME( "CFBamRamInt64DefTable" );

	CFBamRamInt64DefTable::CFBamRamInt64DefTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamInt64DefTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt64DefBuff*>();
	}

	CFBamRamInt64DefTable::~CFBamRamInt64DefTable() {
		if( dictByPKey != NULL ) {
			delete dictByPKey;
			dictByPKey = NULL;
		}
	...
	cfbam::CFBamInt64DefBuff* CFBamRamInt64DefTable::createInt64Def( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt64DefBuff* Buff )
	{
		...
		cfbam::CFBamInt64DefBuff* buff = dynamic_cast<cfbam::CFBamInt64DefBuff*>( schema->getTableAtom()->createAtom( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt64DefBuff*>::value_type( pkey, buff ) );

		// The top level code has to clone the final buffer. The one passed in is now part of the persistent storage.
		if( buff->getClassCode() == cfbam::CFBamInt64DefBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamInt64DefBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamInt64DefBuff* CFBamRamInt64DefTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamInt64DefBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamInt64DefBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamInt64DefBuff* CFBamRamInt64DefTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> CFBamRamInt64DefTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt64DefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt64DefBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamInt64DefBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamInt64DefBuff*>( iter->second->clone() );
	...
	cfbam::CFBamInt64DefBuff* CFBamRamInt64DefTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamInt64DefBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamInt64DefBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> CFBamRamInt64DefTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamInt64DefBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamInt64DefBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> CFBamRamInt64DefTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> CFBamRamInt64DefTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> CFBamRamInt64DefTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> CFBamRamInt64DefTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> CFBamRamInt64DefTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> CFBamRamInt64DefTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	cfbam::CFBamInt64DefBuff* CFBamRamInt64DefTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamInt64DefBuff* CFBamRamInt64DefTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamInt64DefBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamInt64DefBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamInt64DefBuff* CFBamRamInt64DefTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamInt64DefBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamInt64DefBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> CFBamRamInt64DefTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamInt64DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamInt64DefBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamInt64DefBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamInt64DefBuff* CFBamRamInt64DefTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamInt64DefBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamInt64DefBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamInt64DefBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamInt64DefBuff* CFBamRamInt64DefTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamInt64DefBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> CFBamRamInt64DefTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamInt64DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> CFBamRamInt64DefTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamInt64DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> CFBamRamInt64DefTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamInt64DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> CFBamRamInt64DefTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamInt64DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> CFBamRamInt64DefTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamInt64DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> CFBamRamInt64DefTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamInt64DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> CFBamRamInt64DefTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamInt64DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*>::iterator iterBuffList = buffList.begin();
	...
	cfbam::CFBamInt64DefBuff* CFBamRamInt64DefTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamInt64DefBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamInt64DefBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamInt64DefBuff*>( editCur ) );
	}

	cfbam::CFBamInt64DefBuff* CFBamRamInt64DefTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamInt64DefBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamInt64DefBuff* CFBamRamInt64DefTable::updateInt64Def( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt64DefBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in Int64Def for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamInt64DefBuff* existing = searchExisting->second;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamInt64DefBuff*>( schema->getTableAtom()->updateAtom( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt64DefBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt64DefBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamInt64DefBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamInt64DefBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamInt64DefBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamInt64DefTable::deleteInt64Def( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt64DefBuff* Buff )
	{
		static const std::string S_ProcName( "deleteInt64Def" );
		...
		{
			cfbam::CFBamInt64TypeBuff* refIdIdx = dynamic_cast<cfbam::CFBamInt64TypeBuff*>( schema->getTableInt64Type()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table Int64Type for primary key " + pkey.toString() );
		...
		{
			cfbam::CFBamInt64ColBuff* refIdIdx = dynamic_cast<cfbam::CFBamInt64ColBuff*>( schema->getTableInt64Col()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table Int64Col for primary key " + pkey.toString() );
				throw cflib::CFLibDependentsDetectedException( CLASS_NAME,
					S_ProcName,
					Msg );
			}
	...
	void CFBamRamInt64DefTable::deleteInt64DefByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt64DefByIdIdx" );
		...
		cfbam::CFBamInt64DefBuff* cur = NULL;
		cfbam::CFBamInt64DefBuff* rereadCur = NULL;
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt64DefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt64DefBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamValueBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamInt64DefBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamInt64DefBuff::CLASS_CODE ) {
	...
	void CFBamRamInt64DefTable::deleteInt64DefByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteInt64DefByUNameIdx" );
		cfbam::CFBamInt64DefBuff* cur = NULL;
		cfbam::CFBamInt64DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt64DefTable::deleteInt64DefByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt64DefByValTentIdx" );
		cfbam::CFBamInt64DefBuff* cur = NULL;
		cfbam::CFBamInt64DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt64DefTable::deleteInt64DefByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt64DefByScopeIdx" );
		cfbam::CFBamInt64DefBuff* cur = NULL;
		cfbam::CFBamInt64DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt64DefTable::deleteInt64DefByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt64DefByDefSchemaIdx" );
		cfbam::CFBamInt64DefBuff* cur = NULL;
		cfbam::CFBamInt64DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamInt64DefTable::deleteInt64DefByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt64DefByPrevIdx" );
		cfbam::CFBamInt64DefBuff* cur = NULL;
		cfbam::CFBamInt64DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamInt64DefTable::deleteInt64DefByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt64DefByNextIdx" );
		cfbam::CFBamInt64DefBuff* cur = NULL;
		cfbam::CFBamInt64DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamInt64DefTable::deleteInt64DefByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt64DefByContPrevIdx" );
		cfbam::CFBamInt64DefBuff* cur = NULL;
		cfbam::CFBamInt64DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt64DefTable::deleteInt64DefByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt64DefByContNextIdx" );
		cfbam::CFBamInt64DefBuff* cur = NULL;
		cfbam::CFBamInt64DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt64DefTable::releasePreparedStatements() {
	}
