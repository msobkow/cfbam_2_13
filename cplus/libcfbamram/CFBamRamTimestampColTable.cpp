...
// Description: C++18 Implementation for an in-memory RAM DbIO for TimestampCol.
...
namespace cfbam {
	...
	const std::string CFBamRamTimestampColTable::CLASS_NAME( "CFBamRamTimestampColTable" );

	CFBamRamTimestampColTable::CFBamRamTimestampColTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamTimestampColTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimestampColBuff*>();
		dictByTableIdx = new std::map<cfbam::CFBamTimestampColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTimestampColBuff*>*>();
	}

	CFBamRamTimestampColTable::~CFBamRamTimestampColTable() {
	...
	cfbam::CFBamTimestampColBuff* CFBamRamTimestampColTable::createTimestampCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTimestampColBuff* Buff )
	{
		static const std::string S_ProcName( "createTimestampCol" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamTimestampColBuff::CLASS_CODE ) {
		...
		cfbam::CFBamTimestampColBuff* buff = dynamic_cast<cfbam::CFBamTimestampColBuff*>( schema->getTableTimestampDef()->createTimestampDef( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimestampColBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimestampColBuff*>* subdictTableIdx;
		...
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			...
			subdictTableIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimestampColBuff*>();
			dictByTableIdx->insert( std::map<cfbam::CFBamTimestampColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamTimestampColBuff*>*>::value_type( keyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimestampColBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamTimestampColBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamTimestampColBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamTimestampColBuff* CFBamRamTimestampColTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamTimestampColBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamTimestampColBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamTimestampColBuff* CFBamRamTimestampColTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> CFBamRamTimestampColTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTimestampColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTimestampColBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamTimestampColBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamTimestampColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTimestampColBuff* CFBamRamTimestampColTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamTimestampColBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamTimestampColBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> CFBamRamTimestampColTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamTimestampColBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamTimestampColBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> CFBamRamTimestampColTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> CFBamRamTimestampColTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> CFBamRamTimestampColTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> CFBamRamTimestampColTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> CFBamRamTimestampColTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> CFBamRamTimestampColTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> CFBamRamTimestampColTable::readDerivedByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> recVec;
		cfbam::CFBamTimestampColBuff* clone;
		auto searchDictByTableIdx = dictByTableIdx->find( key );
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamTimestampColBuff*>* subdictTableIdx = searchDictByTableIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTimestampColBuff*>::iterator iter = subdictTableIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTimestampColBuff*>::iterator end = subdictTableIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamTimestampColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTimestampColBuff* CFBamRamTimestampColTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamTimestampColBuff* CFBamRamTimestampColTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamTimestampColBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamTimestampColBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamTimestampColBuff* CFBamRamTimestampColTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamTimestampColBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamTimestampColBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> CFBamRamTimestampColTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamTimestampColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamTimestampColBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamTimestampColBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamTimestampColBuff* CFBamRamTimestampColTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamTimestampColBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamTimestampColBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamTimestampColBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamTimestampColBuff* CFBamRamTimestampColTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamTimestampColBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> CFBamRamTimestampColTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamTimestampColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> CFBamRamTimestampColTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamTimestampColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> CFBamRamTimestampColTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamTimestampColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> CFBamRamTimestampColTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTimestampColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> CFBamRamTimestampColTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTimestampColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> CFBamRamTimestampColTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTimestampColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> CFBamRamTimestampColTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTimestampColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> CFBamRamTimestampColTable::readBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		cfbam::CFBamTimestampColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> CFBamRamTimestampColTable::pageBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId,
	...
	cfbam::CFBamTimestampColBuff* CFBamRamTimestampColTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamTimestampColBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTimestampColBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamTimestampColBuff*>( editCur ) );
	}

	cfbam::CFBamTimestampColBuff* CFBamRamTimestampColTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTimestampColBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamTimestampColBuff* CFBamRamTimestampColTable::updateTimestampCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTimestampColBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in TimestampCol for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamTimestampColBuff* existing = searchExisting->second;
		...
		cfbam::CFBamTimestampColByTableIdxKey existingKeyTableIdx;
		...
		cfbam::CFBamTimestampColByTableIdxKey newKeyTableIdx;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamTimestampColBuff*>( schema->getTableTimestampDef()->updateTimestampDef( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimestampColBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimestampColBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamTimestampColBuff*>* subdictTableIdx;
		...
		if( searchNewKeyDictByTableIdx != dictByTableIdx->end() ) {
			...
			dictByTableIdx->insert( std::map<cfbam::CFBamTimestampColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamTimestampColBuff*>*>::value_type( newKeyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimestampColBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamTimestampColBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamTimestampColBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamTimestampColBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamTimestampColTable::deleteTimestampCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTimestampColBuff* Buff )
	{
		static const std::string S_ProcName( "deleteTimestampCol" );
	...
	void CFBamRamTimestampColTable::deleteTimestampColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamTimestampColBuff* cur = NULL;
		cfbam::CFBamTimestampColBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTimestampColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTimestampColBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamTimestampColBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamTimestampColBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimestampColBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamTimestampColTable::deleteTimestampColByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamTimestampColTable::deleteTimestampColByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamTimestampColTable::deleteTimestampColByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamTimestampColTable::deleteTimestampColByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamTimestampColTable::deleteTimestampColByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTimestampColTable::deleteTimestampColByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTimestampColTable::deleteTimestampColByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTimestampColTable::deleteTimestampColByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamTimestampColTable::deleteTimestampColByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamTimestampColTable::releasePreparedStatements() {
	}
