...
// Description: C++18 Implementation for an in-memory RAM DbIO for UInt16Def.
...
namespace cfbam {
	...
	const std::string CFBamRamUInt16DefTable::CLASS_NAME( "CFBamRamUInt16DefTable" );

	CFBamRamUInt16DefTable::CFBamRamUInt16DefTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamUInt16DefTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt16DefBuff*>();
	}

	CFBamRamUInt16DefTable::~CFBamRamUInt16DefTable() {
		if( dictByPKey != NULL ) {
			delete dictByPKey;
			dictByPKey = NULL;
		}
	...
	cfbam::CFBamUInt16DefBuff* CFBamRamUInt16DefTable::createUInt16Def( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUInt16DefBuff* Buff )
	{
		...
		cfbam::CFBamUInt16DefBuff* buff = dynamic_cast<cfbam::CFBamUInt16DefBuff*>( schema->getTableAtom()->createAtom( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt16DefBuff*>::value_type( pkey, buff ) );

		// The top level code has to clone the final buffer. The one passed in is now part of the persistent storage.
		if( buff->getClassCode() == cfbam::CFBamUInt16DefBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamUInt16DefBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamUInt16DefBuff* CFBamRamUInt16DefTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamUInt16DefBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamUInt16DefBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamUInt16DefBuff* CFBamRamUInt16DefTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> CFBamRamUInt16DefTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUInt16DefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUInt16DefBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamUInt16DefBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamUInt16DefBuff*>( iter->second->clone() );
	...
	cfbam::CFBamUInt16DefBuff* CFBamRamUInt16DefTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamUInt16DefBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamUInt16DefBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> CFBamRamUInt16DefTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamUInt16DefBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamUInt16DefBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> CFBamRamUInt16DefTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> CFBamRamUInt16DefTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> CFBamRamUInt16DefTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> CFBamRamUInt16DefTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> CFBamRamUInt16DefTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> CFBamRamUInt16DefTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	cfbam::CFBamUInt16DefBuff* CFBamRamUInt16DefTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamUInt16DefBuff* CFBamRamUInt16DefTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamUInt16DefBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamUInt16DefBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamUInt16DefBuff* CFBamRamUInt16DefTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamUInt16DefBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamUInt16DefBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> CFBamRamUInt16DefTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamUInt16DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamUInt16DefBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamUInt16DefBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamUInt16DefBuff* CFBamRamUInt16DefTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamUInt16DefBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamUInt16DefBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamUInt16DefBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamUInt16DefBuff* CFBamRamUInt16DefTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamUInt16DefBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> CFBamRamUInt16DefTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamUInt16DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> CFBamRamUInt16DefTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamUInt16DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> CFBamRamUInt16DefTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamUInt16DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> CFBamRamUInt16DefTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamUInt16DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> CFBamRamUInt16DefTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamUInt16DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> CFBamRamUInt16DefTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamUInt16DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> CFBamRamUInt16DefTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamUInt16DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*>::iterator iterBuffList = buffList.begin();
	...
	cfbam::CFBamUInt16DefBuff* CFBamRamUInt16DefTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamUInt16DefBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamUInt16DefBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamUInt16DefBuff*>( editCur ) );
	}

	cfbam::CFBamUInt16DefBuff* CFBamRamUInt16DefTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamUInt16DefBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamUInt16DefBuff* CFBamRamUInt16DefTable::updateUInt16Def( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUInt16DefBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in UInt16Def for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamUInt16DefBuff* existing = searchExisting->second;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamUInt16DefBuff*>( schema->getTableAtom()->updateAtom( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt16DefBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt16DefBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamUInt16DefBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamUInt16DefBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamUInt16DefBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamUInt16DefTable::deleteUInt16Def( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUInt16DefBuff* Buff )
	{
		static const std::string S_ProcName( "deleteUInt16Def" );
		...
		{
			cfbam::CFBamUInt16TypeBuff* refIdIdx = dynamic_cast<cfbam::CFBamUInt16TypeBuff*>( schema->getTableUInt16Type()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table UInt16Type for primary key " + pkey.toString() );
		...
		{
			cfbam::CFBamUInt16ColBuff* refIdIdx = dynamic_cast<cfbam::CFBamUInt16ColBuff*>( schema->getTableUInt16Col()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table UInt16Col for primary key " + pkey.toString() );
				throw cflib::CFLibDependentsDetectedException( CLASS_NAME,
					S_ProcName,
					Msg );
			}
	...
	void CFBamRamUInt16DefTable::deleteUInt16DefByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteUInt16DefByIdIdx" );
		...
		cfbam::CFBamUInt16DefBuff* cur = NULL;
		cfbam::CFBamUInt16DefBuff* rereadCur = NULL;
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUInt16DefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUInt16DefBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamValueBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamUInt16DefBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamUInt16DefBuff::CLASS_CODE ) {
	...
	void CFBamRamUInt16DefTable::deleteUInt16DefByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteUInt16DefByUNameIdx" );
		cfbam::CFBamUInt16DefBuff* cur = NULL;
		cfbam::CFBamUInt16DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamUInt16DefTable::deleteUInt16DefByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteUInt16DefByValTentIdx" );
		cfbam::CFBamUInt16DefBuff* cur = NULL;
		cfbam::CFBamUInt16DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamUInt16DefTable::deleteUInt16DefByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteUInt16DefByScopeIdx" );
		cfbam::CFBamUInt16DefBuff* cur = NULL;
		cfbam::CFBamUInt16DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamUInt16DefTable::deleteUInt16DefByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteUInt16DefByDefSchemaIdx" );
		cfbam::CFBamUInt16DefBuff* cur = NULL;
		cfbam::CFBamUInt16DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamUInt16DefTable::deleteUInt16DefByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteUInt16DefByPrevIdx" );
		cfbam::CFBamUInt16DefBuff* cur = NULL;
		cfbam::CFBamUInt16DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamUInt16DefTable::deleteUInt16DefByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteUInt16DefByNextIdx" );
		cfbam::CFBamUInt16DefBuff* cur = NULL;
		cfbam::CFBamUInt16DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamUInt16DefTable::deleteUInt16DefByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteUInt16DefByContPrevIdx" );
		cfbam::CFBamUInt16DefBuff* cur = NULL;
		cfbam::CFBamUInt16DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamUInt16DefTable::deleteUInt16DefByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteUInt16DefByContNextIdx" );
		cfbam::CFBamUInt16DefBuff* cur = NULL;
		cfbam::CFBamUInt16DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamUInt16DefTable::releasePreparedStatements() {
	}
