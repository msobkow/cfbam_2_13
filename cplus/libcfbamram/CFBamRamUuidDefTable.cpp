...
// Description: C++18 Implementation for an in-memory RAM DbIO for UuidDef.
...
namespace cfbam {
	...
	const std::string CFBamRamUuidDefTable::CLASS_NAME( "CFBamRamUuidDefTable" );

	CFBamRamUuidDefTable::CFBamRamUuidDefTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamUuidDefTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidDefBuff*>();
	}

	CFBamRamUuidDefTable::~CFBamRamUuidDefTable() {
		if( dictByPKey != NULL ) {
			delete dictByPKey;
			dictByPKey = NULL;
		}
	...
	cfbam::CFBamUuidDefBuff* CFBamRamUuidDefTable::createUuidDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUuidDefBuff* Buff )
	{
		...
		cfbam::CFBamUuidDefBuff* buff = dynamic_cast<cfbam::CFBamUuidDefBuff*>( schema->getTableAtom()->createAtom( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidDefBuff*>::value_type( pkey, buff ) );

		// The top level code has to clone the final buffer. The one passed in is now part of the persistent storage.
		if( buff->getClassCode() == cfbam::CFBamUuidDefBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamUuidDefBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamUuidDefBuff* CFBamRamUuidDefTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamUuidDefBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamUuidDefBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamUuidDefBuff* CFBamRamUuidDefTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> CFBamRamUuidDefTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUuidDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUuidDefBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamUuidDefBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamUuidDefBuff*>( iter->second->clone() );
	...
	cfbam::CFBamUuidDefBuff* CFBamRamUuidDefTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamUuidDefBuff::CLASS_CODE ) ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> CFBamRamUuidDefTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamUuidDefBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamUuidDefBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> CFBamRamUuidDefTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> CFBamRamUuidDefTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> CFBamRamUuidDefTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> CFBamRamUuidDefTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> CFBamRamUuidDefTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> CFBamRamUuidDefTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	cfbam::CFBamUuidDefBuff* CFBamRamUuidDefTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamUuidDefBuff* CFBamRamUuidDefTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamUuidDefBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamUuidDefBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamUuidDefBuff* CFBamRamUuidDefTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamUuidDefBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamUuidDefBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> CFBamRamUuidDefTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamUuidDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamUuidDefBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamUuidDefBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamUuidDefBuff* CFBamRamUuidDefTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamUuidDefBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamUuidDefBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamUuidDefBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamUuidDefBuff* CFBamRamUuidDefTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamUuidDefBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> CFBamRamUuidDefTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamUuidDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> CFBamRamUuidDefTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamUuidDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> CFBamRamUuidDefTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamUuidDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> CFBamRamUuidDefTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamUuidDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> CFBamRamUuidDefTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamUuidDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> CFBamRamUuidDefTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamUuidDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> CFBamRamUuidDefTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamUuidDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	cfbam::CFBamUuidDefBuff* CFBamRamUuidDefTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamUuidDefBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamUuidDefBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamUuidDefBuff*>( editCur ) );
	}

	cfbam::CFBamUuidDefBuff* CFBamRamUuidDefTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamUuidDefBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamUuidDefBuff* CFBamRamUuidDefTable::updateUuidDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUuidDefBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in UuidDef for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamUuidDefBuff* existing = searchExisting->second;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamUuidDefBuff*>( schema->getTableAtom()->updateAtom( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidDefBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidDefBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamUuidDefBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamUuidDefBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamUuidDefBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamUuidDefTable::deleteUuidDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUuidDefBuff* Buff )
	{
		static const std::string S_ProcName( "deleteUuidDef" );
		...
		{
			cfbam::CFBamUuidTypeBuff* refIdIdx = dynamic_cast<cfbam::CFBamUuidTypeBuff*>( schema->getTableUuidType()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table UuidType for primary key " + pkey.toString() );
		...
		{
			cfbam::CFBamUuidColBuff* refIdIdx = dynamic_cast<cfbam::CFBamUuidColBuff*>( schema->getTableUuidCol()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table UuidCol for primary key " + pkey.toString() );
				throw cflib::CFLibDependentsDetectedException( CLASS_NAME,
					S_ProcName,
					Msg );
			}
	...
	void CFBamRamUuidDefTable::deleteUuidDefByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteUuidDefByIdIdx" );
		...
		cfbam::CFBamUuidDefBuff* cur = NULL;
		cfbam::CFBamUuidDefBuff* rereadCur = NULL;
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUuidDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUuidDefBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamValueBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamUuidDefBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamUuidDefBuff::CLASS_CODE ) {
	...
	void CFBamRamUuidDefTable::deleteUuidDefByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteUuidDefByUNameIdx" );
		cfbam::CFBamUuidDefBuff* cur = NULL;
		cfbam::CFBamUuidDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamUuidDefTable::deleteUuidDefByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteUuidDefByValTentIdx" );
		cfbam::CFBamUuidDefBuff* cur = NULL;
		cfbam::CFBamUuidDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamUuidDefTable::deleteUuidDefByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteUuidDefByScopeIdx" );
		cfbam::CFBamUuidDefBuff* cur = NULL;
		cfbam::CFBamUuidDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamUuidDefTable::deleteUuidDefByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteUuidDefByDefSchemaIdx" );
		cfbam::CFBamUuidDefBuff* cur = NULL;
		cfbam::CFBamUuidDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamUuidDefTable::deleteUuidDefByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteUuidDefByPrevIdx" );
		cfbam::CFBamUuidDefBuff* cur = NULL;
		cfbam::CFBamUuidDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamUuidDefTable::deleteUuidDefByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteUuidDefByNextIdx" );
		cfbam::CFBamUuidDefBuff* cur = NULL;
		cfbam::CFBamUuidDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamUuidDefTable::deleteUuidDefByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteUuidDefByContPrevIdx" );
		cfbam::CFBamUuidDefBuff* cur = NULL;
		cfbam::CFBamUuidDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamUuidDefTable::deleteUuidDefByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteUuidDefByContNextIdx" );
		cfbam::CFBamUuidDefBuff* cur = NULL;
		cfbam::CFBamUuidDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamUuidDefTable::releasePreparedStatements() {
	}
