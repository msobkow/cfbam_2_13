...
// Description: C++18 Implementation for an in-memory RAM DbIO for Int64Col.
...
namespace cfbam {
	...
	const std::string CFBamRamInt64ColTable::CLASS_NAME( "CFBamRamInt64ColTable" );

	CFBamRamInt64ColTable::CFBamRamInt64ColTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamInt64ColTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt64ColBuff*>();
		dictByTableIdx = new std::map<cfbam::CFBamInt64ColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamInt64ColBuff*>*>();
	}

	CFBamRamInt64ColTable::~CFBamRamInt64ColTable() {
	...
	cfbam::CFBamInt64ColBuff* CFBamRamInt64ColTable::createInt64Col( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt64ColBuff* Buff )
	{
		static const std::string S_ProcName( "createInt64Col" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamInt64ColBuff::CLASS_CODE ) {
		...
		cfbam::CFBamInt64ColBuff* buff = dynamic_cast<cfbam::CFBamInt64ColBuff*>( schema->getTableInt64Def()->createInt64Def( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt64ColBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt64ColBuff*>* subdictTableIdx;
		...
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			...
			subdictTableIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt64ColBuff*>();
			dictByTableIdx->insert( std::map<cfbam::CFBamInt64ColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamInt64ColBuff*>*>::value_type( keyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt64ColBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamInt64ColBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamInt64ColBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamInt64ColBuff* CFBamRamInt64ColTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamInt64ColBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamInt64ColBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamInt64ColBuff* CFBamRamInt64ColTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> CFBamRamInt64ColTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt64ColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt64ColBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamInt64ColBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamInt64ColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamInt64ColBuff* CFBamRamInt64ColTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamInt64ColBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamInt64ColBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> CFBamRamInt64ColTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamInt64ColBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamInt64ColBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> CFBamRamInt64ColTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> CFBamRamInt64ColTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> CFBamRamInt64ColTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> CFBamRamInt64ColTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> CFBamRamInt64ColTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> CFBamRamInt64ColTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> CFBamRamInt64ColTable::readDerivedByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> recVec;
		cfbam::CFBamInt64ColBuff* clone;
		auto searchDictByTableIdx = dictByTableIdx->find( key );
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamInt64ColBuff*>* subdictTableIdx = searchDictByTableIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamInt64ColBuff*>::iterator iter = subdictTableIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamInt64ColBuff*>::iterator end = subdictTableIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamInt64ColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamInt64ColBuff* CFBamRamInt64ColTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamInt64ColBuff* CFBamRamInt64ColTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamInt64ColBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamInt64ColBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamInt64ColBuff* CFBamRamInt64ColTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamInt64ColBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamInt64ColBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> CFBamRamInt64ColTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamInt64ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamInt64ColBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamInt64ColBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamInt64ColBuff* CFBamRamInt64ColTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamInt64ColBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamInt64ColBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamInt64ColBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamInt64ColBuff* CFBamRamInt64ColTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamInt64ColBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> CFBamRamInt64ColTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamInt64ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> CFBamRamInt64ColTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamInt64ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> CFBamRamInt64ColTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamInt64ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> CFBamRamInt64ColTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamInt64ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> CFBamRamInt64ColTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamInt64ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> CFBamRamInt64ColTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamInt64ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> CFBamRamInt64ColTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamInt64ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> CFBamRamInt64ColTable::readBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		cfbam::CFBamInt64ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> CFBamRamInt64ColTable::pageBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId,
	...
	cfbam::CFBamInt64ColBuff* CFBamRamInt64ColTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamInt64ColBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamInt64ColBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamInt64ColBuff*>( editCur ) );
	}

	cfbam::CFBamInt64ColBuff* CFBamRamInt64ColTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamInt64ColBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamInt64ColBuff* CFBamRamInt64ColTable::updateInt64Col( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt64ColBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in Int64Col for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamInt64ColBuff* existing = searchExisting->second;
		...
		cfbam::CFBamInt64ColByTableIdxKey existingKeyTableIdx;
		...
		cfbam::CFBamInt64ColByTableIdxKey newKeyTableIdx;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamInt64ColBuff*>( schema->getTableInt64Def()->updateInt64Def( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt64ColBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt64ColBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamInt64ColBuff*>* subdictTableIdx;
		...
		if( searchNewKeyDictByTableIdx != dictByTableIdx->end() ) {
			...
			dictByTableIdx->insert( std::map<cfbam::CFBamInt64ColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamInt64ColBuff*>*>::value_type( newKeyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt64ColBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamInt64ColBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamInt64ColBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamInt64ColBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamInt64ColTable::deleteInt64Col( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt64ColBuff* Buff )
	{
		static const std::string S_ProcName( "deleteInt64Col" );
	...
	void CFBamRamInt64ColTable::deleteInt64ColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamInt64ColBuff* cur = NULL;
		cfbam::CFBamInt64ColBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt64ColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt64ColBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamInt64ColBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamInt64ColBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamInt64ColTable::deleteInt64ColByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamInt64ColTable::deleteInt64ColByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamInt64ColTable::deleteInt64ColByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamInt64ColTable::deleteInt64ColByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamInt64ColTable::deleteInt64ColByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamInt64ColTable::deleteInt64ColByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamInt64ColTable::deleteInt64ColByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamInt64ColTable::deleteInt64ColByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamInt64ColTable::deleteInt64ColByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamInt64ColTable::releasePreparedStatements() {
	}
