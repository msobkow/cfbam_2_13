...
// Description: C++18 Implementation for an in-memory RAM DbIO for UInt64Col.
...
namespace cfbam {
	...
	const std::string CFBamRamUInt64ColTable::CLASS_NAME( "CFBamRamUInt64ColTable" );

	CFBamRamUInt64ColTable::CFBamRamUInt64ColTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamUInt64ColTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt64ColBuff*>();
		dictByTableIdx = new std::map<cfbam::CFBamUInt64ColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamUInt64ColBuff*>*>();
	}

	CFBamRamUInt64ColTable::~CFBamRamUInt64ColTable() {
	...
	cfbam::CFBamUInt64ColBuff* CFBamRamUInt64ColTable::createUInt64Col( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUInt64ColBuff* Buff )
	{
		static const std::string S_ProcName( "createUInt64Col" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamUInt64ColBuff::CLASS_CODE ) {
		...
		cfbam::CFBamUInt64ColBuff* buff = dynamic_cast<cfbam::CFBamUInt64ColBuff*>( schema->getTableUInt64Def()->createUInt64Def( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt64ColBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt64ColBuff*>* subdictTableIdx;
		...
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			...
			subdictTableIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt64ColBuff*>();
			dictByTableIdx->insert( std::map<cfbam::CFBamUInt64ColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamUInt64ColBuff*>*>::value_type( keyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt64ColBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamUInt64ColBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamUInt64ColBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamUInt64ColBuff* CFBamRamUInt64ColTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamUInt64ColBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamUInt64ColBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamUInt64ColBuff* CFBamRamUInt64ColTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> CFBamRamUInt64ColTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUInt64ColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUInt64ColBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamUInt64ColBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamUInt64ColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamUInt64ColBuff* CFBamRamUInt64ColTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamUInt64ColBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamUInt64ColBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> CFBamRamUInt64ColTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamUInt64ColBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamUInt64ColBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> CFBamRamUInt64ColTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> CFBamRamUInt64ColTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> CFBamRamUInt64ColTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> CFBamRamUInt64ColTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> CFBamRamUInt64ColTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> CFBamRamUInt64ColTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> CFBamRamUInt64ColTable::readDerivedByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> recVec;
		cfbam::CFBamUInt64ColBuff* clone;
		auto searchDictByTableIdx = dictByTableIdx->find( key );
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamUInt64ColBuff*>* subdictTableIdx = searchDictByTableIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamUInt64ColBuff*>::iterator iter = subdictTableIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamUInt64ColBuff*>::iterator end = subdictTableIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamUInt64ColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamUInt64ColBuff* CFBamRamUInt64ColTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamUInt64ColBuff* CFBamRamUInt64ColTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamUInt64ColBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamUInt64ColBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamUInt64ColBuff* CFBamRamUInt64ColTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamUInt64ColBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamUInt64ColBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> CFBamRamUInt64ColTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamUInt64ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamUInt64ColBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamUInt64ColBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamUInt64ColBuff* CFBamRamUInt64ColTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamUInt64ColBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamUInt64ColBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamUInt64ColBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamUInt64ColBuff* CFBamRamUInt64ColTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamUInt64ColBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> CFBamRamUInt64ColTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamUInt64ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> CFBamRamUInt64ColTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamUInt64ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> CFBamRamUInt64ColTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamUInt64ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> CFBamRamUInt64ColTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamUInt64ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> CFBamRamUInt64ColTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamUInt64ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> CFBamRamUInt64ColTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamUInt64ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> CFBamRamUInt64ColTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamUInt64ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> CFBamRamUInt64ColTable::readBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		cfbam::CFBamUInt64ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> CFBamRamUInt64ColTable::pageBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId,
	...
	cfbam::CFBamUInt64ColBuff* CFBamRamUInt64ColTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamUInt64ColBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamUInt64ColBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamUInt64ColBuff*>( editCur ) );
	}

	cfbam::CFBamUInt64ColBuff* CFBamRamUInt64ColTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamUInt64ColBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamUInt64ColBuff* CFBamRamUInt64ColTable::updateUInt64Col( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUInt64ColBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in UInt64Col for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamUInt64ColBuff* existing = searchExisting->second;
		...
		cfbam::CFBamUInt64ColByTableIdxKey existingKeyTableIdx;
		...
		cfbam::CFBamUInt64ColByTableIdxKey newKeyTableIdx;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamUInt64ColBuff*>( schema->getTableUInt64Def()->updateUInt64Def( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt64ColBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt64ColBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamUInt64ColBuff*>* subdictTableIdx;
		...
		if( searchNewKeyDictByTableIdx != dictByTableIdx->end() ) {
			...
			dictByTableIdx->insert( std::map<cfbam::CFBamUInt64ColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamUInt64ColBuff*>*>::value_type( newKeyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt64ColBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamUInt64ColBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamUInt64ColBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamUInt64ColBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamUInt64ColTable::deleteUInt64Col( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUInt64ColBuff* Buff )
	{
		static const std::string S_ProcName( "deleteUInt64Col" );
	...
	void CFBamRamUInt64ColTable::deleteUInt64ColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamUInt64ColBuff* cur = NULL;
		cfbam::CFBamUInt64ColBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUInt64ColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUInt64ColBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamUInt64ColBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamUInt64ColBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamUInt64ColTable::deleteUInt64ColByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamUInt64ColTable::deleteUInt64ColByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamUInt64ColTable::deleteUInt64ColByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamUInt64ColTable::deleteUInt64ColByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamUInt64ColTable::deleteUInt64ColByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamUInt64ColTable::deleteUInt64ColByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamUInt64ColTable::deleteUInt64ColByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamUInt64ColTable::deleteUInt64ColByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamUInt64ColTable::deleteUInt64ColByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamUInt64ColTable::releasePreparedStatements() {
	}
