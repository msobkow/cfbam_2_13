...
// Description: C++18 Implementation for an in-memory RAM DbIO for BlobDef.
...
namespace cfbam {
	...
	const std::string CFBamRamBlobDefTable::CLASS_NAME( "CFBamRamBlobDefTable" );

	CFBamRamBlobDefTable::CFBamRamBlobDefTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamBlobDefTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamBlobDefBuff*>();
	}

	CFBamRamBlobDefTable::~CFBamRamBlobDefTable() {
		if( dictByPKey != NULL ) {
			delete dictByPKey;
			dictByPKey = NULL;
		}
	...
	cfbam::CFBamBlobDefBuff* CFBamRamBlobDefTable::createBlobDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamBlobDefBuff* Buff )
	{
		...
		cfbam::CFBamBlobDefBuff* buff = dynamic_cast<cfbam::CFBamBlobDefBuff*>( schema->getTableAtom()->createAtom( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamBlobDefBuff*>::value_type( pkey, buff ) );

		// The top level code has to clone the final buffer. The one passed in is now part of the persistent storage.
		if( buff->getClassCode() == cfbam::CFBamBlobDefBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamBlobDefBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamBlobDefBuff* CFBamRamBlobDefTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamBlobDefBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamBlobDefBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamBlobDefBuff* CFBamRamBlobDefTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> CFBamRamBlobDefTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamBlobDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamBlobDefBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamBlobDefBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamBlobDefBuff*>( iter->second->clone() );
	...
	cfbam::CFBamBlobDefBuff* CFBamRamBlobDefTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamBlobDefBuff::CLASS_CODE ) ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> CFBamRamBlobDefTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamBlobDefBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamBlobDefBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> CFBamRamBlobDefTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> CFBamRamBlobDefTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> CFBamRamBlobDefTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> CFBamRamBlobDefTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> CFBamRamBlobDefTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> CFBamRamBlobDefTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	cfbam::CFBamBlobDefBuff* CFBamRamBlobDefTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamBlobDefBuff* CFBamRamBlobDefTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamBlobDefBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamBlobDefBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamBlobDefBuff* CFBamRamBlobDefTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamBlobDefBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamBlobDefBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> CFBamRamBlobDefTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamBlobDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamBlobDefBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamBlobDefBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamBlobDefBuff* CFBamRamBlobDefTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamBlobDefBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamBlobDefBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamBlobDefBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamBlobDefBuff* CFBamRamBlobDefTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamBlobDefBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> CFBamRamBlobDefTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamBlobDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> CFBamRamBlobDefTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamBlobDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> CFBamRamBlobDefTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamBlobDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> CFBamRamBlobDefTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamBlobDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> CFBamRamBlobDefTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamBlobDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> CFBamRamBlobDefTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamBlobDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> CFBamRamBlobDefTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamBlobDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	cfbam::CFBamBlobDefBuff* CFBamRamBlobDefTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamBlobDefBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamBlobDefBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamBlobDefBuff*>( editCur ) );
	}

	cfbam::CFBamBlobDefBuff* CFBamRamBlobDefTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamBlobDefBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamBlobDefBuff* CFBamRamBlobDefTable::updateBlobDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamBlobDefBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in BlobDef for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamBlobDefBuff* existing = searchExisting->second;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamBlobDefBuff*>( schema->getTableAtom()->updateAtom( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamBlobDefBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamBlobDefBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamBlobDefBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamBlobDefBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamBlobDefBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamBlobDefTable::deleteBlobDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamBlobDefBuff* Buff )
	{
		static const std::string S_ProcName( "deleteBlobDef" );
		...
		{
			cfbam::CFBamBlobTypeBuff* refIdIdx = dynamic_cast<cfbam::CFBamBlobTypeBuff*>( schema->getTableBlobType()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table BlobType for primary key " + pkey.toString() );
		...
		{
			cfbam::CFBamBlobColBuff* refIdIdx = dynamic_cast<cfbam::CFBamBlobColBuff*>( schema->getTableBlobCol()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table BlobCol for primary key " + pkey.toString() );
				throw cflib::CFLibDependentsDetectedException( CLASS_NAME,
					S_ProcName,
					Msg );
			}
	...
	void CFBamRamBlobDefTable::deleteBlobDefByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteBlobDefByIdIdx" );
		...
		cfbam::CFBamBlobDefBuff* cur = NULL;
		cfbam::CFBamBlobDefBuff* rereadCur = NULL;
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamBlobDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamBlobDefBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamValueBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamBlobDefBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamBlobDefBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamBlobDefBuff::CLASS_CODE ) {
	...
	void CFBamRamBlobDefTable::deleteBlobDefByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteBlobDefByUNameIdx" );
		cfbam::CFBamBlobDefBuff* cur = NULL;
		cfbam::CFBamBlobDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamBlobDefTable::deleteBlobDefByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteBlobDefByValTentIdx" );
		cfbam::CFBamBlobDefBuff* cur = NULL;
		cfbam::CFBamBlobDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamBlobDefTable::deleteBlobDefByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteBlobDefByScopeIdx" );
		cfbam::CFBamBlobDefBuff* cur = NULL;
		cfbam::CFBamBlobDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamBlobDefTable::deleteBlobDefByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteBlobDefByDefSchemaIdx" );
		cfbam::CFBamBlobDefBuff* cur = NULL;
		cfbam::CFBamBlobDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamBlobDefTable::deleteBlobDefByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteBlobDefByPrevIdx" );
		cfbam::CFBamBlobDefBuff* cur = NULL;
		cfbam::CFBamBlobDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamBlobDefTable::deleteBlobDefByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteBlobDefByNextIdx" );
		cfbam::CFBamBlobDefBuff* cur = NULL;
		cfbam::CFBamBlobDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamBlobDefTable::deleteBlobDefByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteBlobDefByContPrevIdx" );
		cfbam::CFBamBlobDefBuff* cur = NULL;
		cfbam::CFBamBlobDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamBlobDefTable::deleteBlobDefByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteBlobDefByContNextIdx" );
		cfbam::CFBamBlobDefBuff* cur = NULL;
		cfbam::CFBamBlobDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamBlobDefTable::releasePreparedStatements() {
	}
