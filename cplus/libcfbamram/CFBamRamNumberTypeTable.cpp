...
// Description: C++18 Implementation for an in-memory RAM DbIO for NumberType.
...
namespace cfbam {
	...
	const std::string CFBamRamNumberTypeTable::CLASS_NAME( "CFBamRamNumberTypeTable" );

	CFBamRamNumberTypeTable::CFBamRamNumberTypeTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamNumberTypeTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamNumberTypeBuff*>();
		dictBySchemaIdx = new std::map<cfbam::CFBamNumberTypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamNumberTypeBuff*>*>();
	}

	CFBamRamNumberTypeTable::~CFBamRamNumberTypeTable() {
	...
	cfbam::CFBamNumberTypeBuff* CFBamRamNumberTypeTable::createNumberType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNumberTypeBuff* Buff )
	{
		static const std::string S_ProcName( "createNumberType" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamNumberTypeBuff::CLASS_CODE ) {
		...
		cfbam::CFBamNumberTypeBuff* buff = dynamic_cast<cfbam::CFBamNumberTypeBuff*>( schema->getTableNumberDef()->createNumberDef( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNumberTypeBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamNumberTypeBuff*>* subdictSchemaIdx;
		...
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			subdictSchemaIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamNumberTypeBuff*>();
			dictBySchemaIdx->insert( std::map<cfbam::CFBamNumberTypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamNumberTypeBuff*>*>::value_type( keySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNumberTypeBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamNumberTypeBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamNumberTypeBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamNumberTypeBuff* CFBamRamNumberTypeTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamNumberTypeBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamNumberTypeBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamNumberTypeBuff* CFBamRamNumberTypeTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> CFBamRamNumberTypeTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNumberTypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNumberTypeBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamNumberTypeBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamNumberTypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamNumberTypeBuff* CFBamRamNumberTypeTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamNumberTypeBuff::CLASS_CODE ) ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> CFBamRamNumberTypeTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamNumberTypeBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamNumberTypeBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> CFBamRamNumberTypeTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> CFBamRamNumberTypeTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> CFBamRamNumberTypeTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> CFBamRamNumberTypeTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> CFBamRamNumberTypeTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> CFBamRamNumberTypeTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> CFBamRamNumberTypeTable::readDerivedBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> recVec;
		cfbam::CFBamNumberTypeBuff* clone;
		auto searchDictBySchemaIdx = dictBySchemaIdx->find( key );
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamNumberTypeBuff*>* subdictSchemaIdx = searchDictBySchemaIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamNumberTypeBuff*>::iterator iter = subdictSchemaIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamNumberTypeBuff*>::iterator end = subdictSchemaIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamNumberTypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamNumberTypeBuff* CFBamRamNumberTypeTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamNumberTypeBuff* CFBamRamNumberTypeTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamNumberTypeBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamNumberTypeBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamNumberTypeBuff* CFBamRamNumberTypeTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamNumberTypeBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamNumberTypeBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> CFBamRamNumberTypeTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamNumberTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamNumberTypeBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamNumberTypeBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamNumberTypeBuff* CFBamRamNumberTypeTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamNumberTypeBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamNumberTypeBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamNumberTypeBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamNumberTypeBuff* CFBamRamNumberTypeTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamNumberTypeBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> CFBamRamNumberTypeTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamNumberTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> CFBamRamNumberTypeTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamNumberTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> CFBamRamNumberTypeTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamNumberTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> CFBamRamNumberTypeTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamNumberTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> CFBamRamNumberTypeTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamNumberTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> CFBamRamNumberTypeTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamNumberTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> CFBamRamNumberTypeTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamNumberTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> CFBamRamNumberTypeTable::readBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		cfbam::CFBamNumberTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> CFBamRamNumberTypeTable::pageBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId,
	...
	cfbam::CFBamNumberTypeBuff* CFBamRamNumberTypeTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamNumberTypeBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamNumberTypeBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamNumberTypeBuff*>( editCur ) );
	}

	cfbam::CFBamNumberTypeBuff* CFBamRamNumberTypeTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamNumberTypeBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamNumberTypeBuff* CFBamRamNumberTypeTable::updateNumberType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNumberTypeBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in NumberType for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamNumberTypeBuff* existing = searchExisting->second;
		...
		cfbam::CFBamNumberTypeBySchemaIdxKey existingKeySchemaIdx;
		...
		cfbam::CFBamNumberTypeBySchemaIdxKey newKeySchemaIdx;
...

		{
			...
			if( allNull ) {
				cfbam::CFBamNumberDefBuff* chk = dynamic_cast<cfbam::CFBamNumberDefBuff*>( schema->getTableNumberDef()->readDerivedByIdIdx( Authorization,
						Buff->getRequiredTenantId(),
						Buff->getRequiredId() ) );
				if( chk == NULL ) {
					delete Buff;
					std::string Msg( "Could not resolve Superclass relationship SuperClass to table NumberDef" );
					throw cflib::CFLibUnresolvedRelationException( CLASS_NAME,
						S_ProcName,
						Msg );
				}
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamNumberTypeBuff*>( schema->getTableNumberDef()->updateNumberDef( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamNumberTypeBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNumberTypeBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamNumberTypeBuff*>* subdictSchemaIdx;
		...
		if( searchNewKeyDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			dictBySchemaIdx->insert( std::map<cfbam::CFBamNumberTypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamNumberTypeBuff*>*>::value_type( newKeySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNumberTypeBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamNumberTypeBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamNumberTypeBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamNumberTypeBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamNumberTypeTable::deleteNumberType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNumberTypeBuff* Buff )
	{
		static const std::string S_ProcName( "deleteNumberType" );
	...
	void CFBamRamNumberTypeTable::deleteNumberTypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamNumberTypeTable::deleteNumberTypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamNumberTypeBySchemaIdxKey* argKey )
	{
		cfbam::CFBamNumberTypeBuff* cur = NULL;
		cfbam::CFBamNumberTypeBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNumberTypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNumberTypeBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamNumberTypeBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamNumberTypeBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamNumberTypeBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamNumberTypeTable::deleteNumberTypeByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamNumberTypeTable::deleteNumberTypeByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamNumberTypeTable::deleteNumberTypeByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamNumberTypeTable::deleteNumberTypeByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamNumberTypeTable::deleteNumberTypeByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamNumberTypeTable::deleteNumberTypeByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamNumberTypeTable::deleteNumberTypeByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamNumberTypeTable::deleteNumberTypeByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamNumberTypeTable::deleteNumberTypeByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamNumberTypeTable::releasePreparedStatements() {
	}
