...
// Description: C++18 Implementation for an in-memory RAM DbIO for Int32Type.
...
namespace cfbam {
	...
	const std::string CFBamRamInt32TypeTable::CLASS_NAME( "CFBamRamInt32TypeTable" );

	CFBamRamInt32TypeTable::CFBamRamInt32TypeTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamInt32TypeTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt32TypeBuff*>();
		dictBySchemaIdx = new std::map<cfbam::CFBamInt32TypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamInt32TypeBuff*>*>();
	}

	CFBamRamInt32TypeTable::~CFBamRamInt32TypeTable() {
	...
	cfbam::CFBamInt32TypeBuff* CFBamRamInt32TypeTable::createInt32Type( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt32TypeBuff* Buff )
	{
		static const std::string S_ProcName( "createInt32Type" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamInt32TypeBuff::CLASS_CODE ) {
		...
		cfbam::CFBamInt32TypeBuff* buff = dynamic_cast<cfbam::CFBamInt32TypeBuff*>( schema->getTableInt32Def()->createInt32Def( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt32TypeBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt32TypeBuff*>* subdictSchemaIdx;
		...
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			subdictSchemaIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt32TypeBuff*>();
			dictBySchemaIdx->insert( std::map<cfbam::CFBamInt32TypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamInt32TypeBuff*>*>::value_type( keySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt32TypeBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamInt32TypeBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamInt32TypeBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamInt32TypeBuff* CFBamRamInt32TypeTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamInt32TypeBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamInt32TypeBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamInt32TypeBuff* CFBamRamInt32TypeTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> CFBamRamInt32TypeTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt32TypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt32TypeBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamInt32TypeBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamInt32TypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamInt32TypeBuff* CFBamRamInt32TypeTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamInt32TypeBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamInt32TypeBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> CFBamRamInt32TypeTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamInt32TypeBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamInt32TypeBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> CFBamRamInt32TypeTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> CFBamRamInt32TypeTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> CFBamRamInt32TypeTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> CFBamRamInt32TypeTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> CFBamRamInt32TypeTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> CFBamRamInt32TypeTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> CFBamRamInt32TypeTable::readDerivedBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> recVec;
		cfbam::CFBamInt32TypeBuff* clone;
		auto searchDictBySchemaIdx = dictBySchemaIdx->find( key );
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamInt32TypeBuff*>* subdictSchemaIdx = searchDictBySchemaIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamInt32TypeBuff*>::iterator iter = subdictSchemaIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamInt32TypeBuff*>::iterator end = subdictSchemaIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamInt32TypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamInt32TypeBuff* CFBamRamInt32TypeTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamInt32TypeBuff* CFBamRamInt32TypeTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamInt32TypeBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamInt32TypeBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamInt32TypeBuff* CFBamRamInt32TypeTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamInt32TypeBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamInt32TypeBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> CFBamRamInt32TypeTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamInt32TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> buffList = readAllDerived( Authorization );
		...
		while( iterBuffList != endBuffList ) {
			...
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamInt32TypeBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamInt32TypeBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamInt32TypeBuff* CFBamRamInt32TypeTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamInt32TypeBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamInt32TypeBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamInt32TypeBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamInt32TypeBuff* CFBamRamInt32TypeTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamInt32TypeBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> CFBamRamInt32TypeTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamInt32TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> CFBamRamInt32TypeTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamInt32TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> CFBamRamInt32TypeTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamInt32TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> CFBamRamInt32TypeTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamInt32TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> CFBamRamInt32TypeTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamInt32TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> CFBamRamInt32TypeTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamInt32TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> CFBamRamInt32TypeTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamInt32TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> CFBamRamInt32TypeTable::readBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		cfbam::CFBamInt32TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> CFBamRamInt32TypeTable::pageBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId,
	...
	cfbam::CFBamInt32TypeBuff* CFBamRamInt32TypeTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamInt32TypeBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamInt32TypeBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamInt32TypeBuff*>( editCur ) );
	}

	cfbam::CFBamInt32TypeBuff* CFBamRamInt32TypeTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamInt32TypeBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamInt32TypeBuff* CFBamRamInt32TypeTable::updateInt32Type( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt32TypeBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in Int32Type for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamInt32TypeBuff* existing = searchExisting->second;
		...
		cfbam::CFBamInt32TypeBySchemaIdxKey existingKeySchemaIdx;
		...
		cfbam::CFBamInt32TypeBySchemaIdxKey newKeySchemaIdx;
...

		{
			...
			if( allNull ) {
				cfbam::CFBamInt32DefBuff* chk = dynamic_cast<cfbam::CFBamInt32DefBuff*>( schema->getTableInt32Def()->readDerivedByIdIdx( Authorization,
						Buff->getRequiredTenantId(),
						Buff->getRequiredId() ) );
				if( chk == NULL ) {
					delete Buff;
					std::string Msg( "Could not resolve Superclass relationship SuperClass to table Int32Def" );
					throw cflib::CFLibUnresolvedRelationException( CLASS_NAME,
						S_ProcName,
						Msg );
				}
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamInt32TypeBuff*>( schema->getTableInt32Def()->updateInt32Def( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt32TypeBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt32TypeBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamInt32TypeBuff*>* subdictSchemaIdx;
		...
		if( searchNewKeyDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			dictBySchemaIdx->insert( std::map<cfbam::CFBamInt32TypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamInt32TypeBuff*>*>::value_type( newKeySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt32TypeBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamInt32TypeBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamInt32TypeBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamInt32TypeBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamInt32TypeTable::deleteInt32Type( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt32TypeBuff* Buff )
	{
		static const std::string S_ProcName( "deleteInt32Type" );
		...
		{
			cfbam::CFBamId32GenBuff* refIdIdx = dynamic_cast<cfbam::CFBamId32GenBuff*>( schema->getTableId32Gen()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table Id32Gen for primary key " + pkey.toString() );
	...
	void CFBamRamInt32TypeTable::deleteInt32TypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt32TypeBySchemaIdx" );
		cfbam::CFBamInt32TypeBuff* cur = NULL;
		cfbam::CFBamInt32TypeBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt32TypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt32TypeBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamInt32TypeBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamInt32TypeBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamInt32TypeBuff::CLASS_CODE ) {
	...
	void CFBamRamInt32TypeTable::deleteInt32TypeByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	{
		static const std::string S_ProcName( "deleteInt32TypeByIdIdx" );
		bool anyNotNull = false;
		anyNotNull = true;
		anyNotNull = true;
		if( ! anyNotNull ) {
	...
	void CFBamRamInt32TypeTable::deleteInt32TypeByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteInt32TypeByUNameIdx" );
		cfbam::CFBamInt32TypeBuff* cur = NULL;
		cfbam::CFBamInt32TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt32TypeTable::deleteInt32TypeByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt32TypeByValTentIdx" );
		cfbam::CFBamInt32TypeBuff* cur = NULL;
		cfbam::CFBamInt32TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt32TypeTable::deleteInt32TypeByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt32TypeByScopeIdx" );
		cfbam::CFBamInt32TypeBuff* cur = NULL;
		cfbam::CFBamInt32TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt32TypeTable::deleteInt32TypeByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt32TypeByDefSchemaIdx" );
		cfbam::CFBamInt32TypeBuff* cur = NULL;
		cfbam::CFBamInt32TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamInt32TypeTable::deleteInt32TypeByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt32TypeByPrevIdx" );
		cfbam::CFBamInt32TypeBuff* cur = NULL;
		cfbam::CFBamInt32TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamInt32TypeTable::deleteInt32TypeByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt32TypeByNextIdx" );
		cfbam::CFBamInt32TypeBuff* cur = NULL;
		cfbam::CFBamInt32TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamInt32TypeTable::deleteInt32TypeByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt32TypeByContPrevIdx" );
		cfbam::CFBamInt32TypeBuff* cur = NULL;
		cfbam::CFBamInt32TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt32TypeTable::deleteInt32TypeByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt32TypeByContNextIdx" );
		cfbam::CFBamInt32TypeBuff* cur = NULL;
		cfbam::CFBamInt32TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt32TypeTable::releasePreparedStatements() {
	}
