...
// Description: C++18 Implementation for an in-memory RAM DbIO for EnumType.
...
namespace cfbam {
	...
	const std::string CFBamRamEnumTypeTable::CLASS_NAME( "CFBamRamEnumTypeTable" );

	CFBamRamEnumTypeTable::CFBamRamEnumTypeTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamEnumTypeTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamEnumTypeBuff*>();
		dictBySchemaIdx = new std::map<cfbam::CFBamEnumTypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamEnumTypeBuff*>*>();
	}

	CFBamRamEnumTypeTable::~CFBamRamEnumTypeTable() {
	...
	cfbam::CFBamEnumTypeBuff* CFBamRamEnumTypeTable::createEnumType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamEnumTypeBuff* Buff )
	{
		static const std::string S_ProcName( "createEnumType" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamEnumTypeBuff::CLASS_CODE ) {
		...
		cfbam::CFBamEnumTypeBuff* buff = dynamic_cast<cfbam::CFBamEnumTypeBuff*>( schema->getTableEnumDef()->createEnumDef( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamEnumTypeBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamEnumTypeBuff*>* subdictSchemaIdx;
		...
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			subdictSchemaIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamEnumTypeBuff*>();
			dictBySchemaIdx->insert( std::map<cfbam::CFBamEnumTypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamEnumTypeBuff*>*>::value_type( keySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamEnumTypeBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamEnumTypeBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamEnumTypeBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamEnumTypeBuff* CFBamRamEnumTypeTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamEnumTypeBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamEnumTypeBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamEnumTypeBuff* CFBamRamEnumTypeTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> CFBamRamEnumTypeTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamEnumTypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamEnumTypeBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamEnumTypeBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamEnumTypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamEnumTypeBuff* CFBamRamEnumTypeTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamEnumTypeBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamEnumTypeBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> CFBamRamEnumTypeTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamEnumTypeBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamEnumTypeBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> CFBamRamEnumTypeTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> CFBamRamEnumTypeTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> CFBamRamEnumTypeTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> CFBamRamEnumTypeTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> CFBamRamEnumTypeTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> CFBamRamEnumTypeTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> CFBamRamEnumTypeTable::readDerivedBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> recVec;
		cfbam::CFBamEnumTypeBuff* clone;
		auto searchDictBySchemaIdx = dictBySchemaIdx->find( key );
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamEnumTypeBuff*>* subdictSchemaIdx = searchDictBySchemaIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamEnumTypeBuff*>::iterator iter = subdictSchemaIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamEnumTypeBuff*>::iterator end = subdictSchemaIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamEnumTypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamEnumTypeBuff* CFBamRamEnumTypeTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamEnumTypeBuff* CFBamRamEnumTypeTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamEnumTypeBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamEnumTypeBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamEnumTypeBuff* CFBamRamEnumTypeTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamEnumTypeBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamEnumTypeBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> CFBamRamEnumTypeTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamEnumTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamEnumTypeBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamEnumTypeBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamEnumTypeBuff* CFBamRamEnumTypeTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamEnumTypeBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamEnumTypeBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamEnumTypeBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamEnumTypeBuff* CFBamRamEnumTypeTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamEnumTypeBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> CFBamRamEnumTypeTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamEnumTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> CFBamRamEnumTypeTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamEnumTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> CFBamRamEnumTypeTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamEnumTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> CFBamRamEnumTypeTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamEnumTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> CFBamRamEnumTypeTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamEnumTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> CFBamRamEnumTypeTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamEnumTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> CFBamRamEnumTypeTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamEnumTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> CFBamRamEnumTypeTable::readBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		cfbam::CFBamEnumTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> CFBamRamEnumTypeTable::pageBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId,
	...
	cfbam::CFBamEnumTypeBuff* CFBamRamEnumTypeTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamEnumTypeBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamEnumTypeBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamEnumTypeBuff*>( editCur ) );
	}

	cfbam::CFBamEnumTypeBuff* CFBamRamEnumTypeTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamEnumTypeBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamEnumTypeBuff* CFBamRamEnumTypeTable::updateEnumType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamEnumTypeBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in EnumType for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamEnumTypeBuff* existing = searchExisting->second;
		...
		cfbam::CFBamEnumTypeBySchemaIdxKey existingKeySchemaIdx;
		...
		cfbam::CFBamEnumTypeBySchemaIdxKey newKeySchemaIdx;
...

		{
			...
			if( allNull ) {
				...
				if( chk == NULL ) {
					delete Buff;
					std::string Msg( "Could not resolve Superclass relationship SuperClass to table EnumDef" );
					throw cflib::CFLibUnresolvedRelationException( CLASS_NAME,
						S_ProcName,
						Msg );
				}
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamEnumTypeBuff*>( schema->getTableEnumDef()->updateEnumDef( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamEnumTypeBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamEnumTypeBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamEnumTypeBuff*>* subdictSchemaIdx;
		...
		if( searchNewKeyDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			dictBySchemaIdx->insert( std::map<cfbam::CFBamEnumTypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamEnumTypeBuff*>*>::value_type( newKeySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamEnumTypeBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamEnumTypeBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamEnumTypeBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamEnumTypeBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamEnumTypeTable::deleteEnumType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamEnumTypeBuff* Buff )
	{
		static const std::string S_ProcName( "deleteEnumType" );
		...
		cfbam::CFBamEnumTypeBuff* existing = searchExisting->second;
		std::TCFLibOwningVector<cfbam::CFBamEnumTagBuff*> arrCheckTags = schema->getTableEnumTag()->readDerivedByEnumIdx( Authorization,
			existing->getRequiredTenantId(),
			existing->getRequiredId() );
		if( arrCheckTags.size() > 0 ) {
	...
	void CFBamRamEnumTypeTable::deleteEnumTypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamEnumTypeBuff* cur = NULL;
		cfbam::CFBamEnumTypeBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamEnumTypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamEnumTypeBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamEnumTypeBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamEnumTypeBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamEnumTypeTable::deleteEnumTypeByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamEnumTypeTable::deleteEnumTypeByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamEnumTypeTable::deleteEnumTypeByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamEnumTypeTable::deleteEnumTypeByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamEnumTypeTable::deleteEnumTypeByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamEnumTypeTable::deleteEnumTypeByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamEnumTypeTable::deleteEnumTypeByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamEnumTypeTable::deleteEnumTypeByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamEnumTypeTable::deleteEnumTypeByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamEnumTypeTable::releasePreparedStatements() {
	}
