...
// Description: C++18 Implementation for an in-memory RAM DbIO for NumberDef.
...
namespace cfbam {
	...
	const std::string CFBamRamNumberDefTable::CLASS_NAME( "CFBamRamNumberDefTable" );

	CFBamRamNumberDefTable::CFBamRamNumberDefTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamNumberDefTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamNumberDefBuff*>();
	}

	CFBamRamNumberDefTable::~CFBamRamNumberDefTable() {
		if( dictByPKey != NULL ) {
			delete dictByPKey;
			dictByPKey = NULL;
		}
	...
	cfbam::CFBamNumberDefBuff* CFBamRamNumberDefTable::createNumberDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNumberDefBuff* Buff )
	{
		...
		cfbam::CFBamNumberDefBuff* buff = dynamic_cast<cfbam::CFBamNumberDefBuff*>( schema->getTableAtom()->createAtom( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNumberDefBuff*>::value_type( pkey, buff ) );

		// The top level code has to clone the final buffer. The one passed in is now part of the persistent storage.
		if( buff->getClassCode() == cfbam::CFBamNumberDefBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamNumberDefBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamNumberDefBuff* CFBamRamNumberDefTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamNumberDefBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamNumberDefBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamNumberDefBuff* CFBamRamNumberDefTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> CFBamRamNumberDefTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNumberDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNumberDefBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamNumberDefBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamNumberDefBuff*>( iter->second->clone() );
	...
	cfbam::CFBamNumberDefBuff* CFBamRamNumberDefTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamNumberDefBuff::CLASS_CODE ) ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> CFBamRamNumberDefTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamNumberDefBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamNumberDefBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> CFBamRamNumberDefTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> CFBamRamNumberDefTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> CFBamRamNumberDefTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> CFBamRamNumberDefTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> CFBamRamNumberDefTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> CFBamRamNumberDefTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	cfbam::CFBamNumberDefBuff* CFBamRamNumberDefTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamNumberDefBuff* CFBamRamNumberDefTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamNumberDefBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamNumberDefBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamNumberDefBuff* CFBamRamNumberDefTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamNumberDefBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamNumberDefBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> CFBamRamNumberDefTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamNumberDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamNumberDefBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamNumberDefBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamNumberDefBuff* CFBamRamNumberDefTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamNumberDefBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamNumberDefBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamNumberDefBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamNumberDefBuff* CFBamRamNumberDefTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamNumberDefBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> CFBamRamNumberDefTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamNumberDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> CFBamRamNumberDefTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamNumberDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> CFBamRamNumberDefTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamNumberDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> CFBamRamNumberDefTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamNumberDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> CFBamRamNumberDefTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamNumberDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> CFBamRamNumberDefTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamNumberDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> CFBamRamNumberDefTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamNumberDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	cfbam::CFBamNumberDefBuff* CFBamRamNumberDefTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamNumberDefBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamNumberDefBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamNumberDefBuff*>( editCur ) );
	}

	cfbam::CFBamNumberDefBuff* CFBamRamNumberDefTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamNumberDefBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamNumberDefBuff* CFBamRamNumberDefTable::updateNumberDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNumberDefBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in NumberDef for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamNumberDefBuff* existing = searchExisting->second;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamNumberDefBuff*>( schema->getTableAtom()->updateAtom( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamNumberDefBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNumberDefBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamNumberDefBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamNumberDefBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamNumberDefBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamNumberDefTable::deleteNumberDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNumberDefBuff* Buff )
	{
		static const std::string S_ProcName( "deleteNumberDef" );
		...
		{
			cfbam::CFBamNumberTypeBuff* refIdIdx = dynamic_cast<cfbam::CFBamNumberTypeBuff*>( schema->getTableNumberType()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table NumberType for primary key " + pkey.toString() );
		...
		{
			cfbam::CFBamNumberColBuff* refIdIdx = dynamic_cast<cfbam::CFBamNumberColBuff*>( schema->getTableNumberCol()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table NumberCol for primary key " + pkey.toString() );
				throw cflib::CFLibDependentsDetectedException( CLASS_NAME,
					S_ProcName,
					Msg );
			}
	...
	void CFBamRamNumberDefTable::deleteNumberDefByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteNumberDefByIdIdx" );
		...
		cfbam::CFBamNumberDefBuff* cur = NULL;
		cfbam::CFBamNumberDefBuff* rereadCur = NULL;
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNumberDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNumberDefBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamValueBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamNumberDefBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamNumberDefBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamNumberDefBuff::CLASS_CODE ) {
	...
	void CFBamRamNumberDefTable::deleteNumberDefByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteNumberDefByUNameIdx" );
		cfbam::CFBamNumberDefBuff* cur = NULL;
		cfbam::CFBamNumberDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamNumberDefTable::deleteNumberDefByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteNumberDefByValTentIdx" );
		cfbam::CFBamNumberDefBuff* cur = NULL;
		cfbam::CFBamNumberDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamNumberDefTable::deleteNumberDefByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteNumberDefByScopeIdx" );
		cfbam::CFBamNumberDefBuff* cur = NULL;
		cfbam::CFBamNumberDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamNumberDefTable::deleteNumberDefByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteNumberDefByDefSchemaIdx" );
		cfbam::CFBamNumberDefBuff* cur = NULL;
		cfbam::CFBamNumberDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamNumberDefTable::deleteNumberDefByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteNumberDefByPrevIdx" );
		cfbam::CFBamNumberDefBuff* cur = NULL;
		cfbam::CFBamNumberDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamNumberDefTable::deleteNumberDefByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteNumberDefByNextIdx" );
		cfbam::CFBamNumberDefBuff* cur = NULL;
		cfbam::CFBamNumberDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamNumberDefTable::deleteNumberDefByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteNumberDefByContPrevIdx" );
		cfbam::CFBamNumberDefBuff* cur = NULL;
		cfbam::CFBamNumberDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamNumberDefTable::deleteNumberDefByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteNumberDefByContNextIdx" );
		cfbam::CFBamNumberDefBuff* cur = NULL;
		cfbam::CFBamNumberDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamNumberDefTable::releasePreparedStatements() {
	}
