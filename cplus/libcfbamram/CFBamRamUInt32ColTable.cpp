...
// Description: C++18 Implementation for an in-memory RAM DbIO for UInt32Col.
...
namespace cfbam {
	...
	const std::string CFBamRamUInt32ColTable::CLASS_NAME( "CFBamRamUInt32ColTable" );

	CFBamRamUInt32ColTable::CFBamRamUInt32ColTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamUInt32ColTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt32ColBuff*>();
		dictByTableIdx = new std::map<cfbam::CFBamUInt32ColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamUInt32ColBuff*>*>();
	}

	CFBamRamUInt32ColTable::~CFBamRamUInt32ColTable() {
	...
	cfbam::CFBamUInt32ColBuff* CFBamRamUInt32ColTable::createUInt32Col( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUInt32ColBuff* Buff )
	{
		static const std::string S_ProcName( "createUInt32Col" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamUInt32ColBuff::CLASS_CODE ) {
		...
		cfbam::CFBamUInt32ColBuff* buff = dynamic_cast<cfbam::CFBamUInt32ColBuff*>( schema->getTableUInt32Def()->createUInt32Def( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt32ColBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt32ColBuff*>* subdictTableIdx;
		...
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			...
			subdictTableIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt32ColBuff*>();
			dictByTableIdx->insert( std::map<cfbam::CFBamUInt32ColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamUInt32ColBuff*>*>::value_type( keyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt32ColBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamUInt32ColBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamUInt32ColBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamUInt32ColBuff* CFBamRamUInt32ColTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamUInt32ColBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamUInt32ColBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamUInt32ColBuff* CFBamRamUInt32ColTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> CFBamRamUInt32ColTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUInt32ColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUInt32ColBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamUInt32ColBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamUInt32ColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamUInt32ColBuff* CFBamRamUInt32ColTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamUInt32ColBuff::CLASS_CODE ) ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> CFBamRamUInt32ColTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamUInt32ColBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamUInt32ColBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> CFBamRamUInt32ColTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> CFBamRamUInt32ColTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> CFBamRamUInt32ColTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> CFBamRamUInt32ColTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> CFBamRamUInt32ColTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> CFBamRamUInt32ColTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> CFBamRamUInt32ColTable::readDerivedByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> recVec;
		cfbam::CFBamUInt32ColBuff* clone;
		auto searchDictByTableIdx = dictByTableIdx->find( key );
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamUInt32ColBuff*>* subdictTableIdx = searchDictByTableIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamUInt32ColBuff*>::iterator iter = subdictTableIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamUInt32ColBuff*>::iterator end = subdictTableIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamUInt32ColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamUInt32ColBuff* CFBamRamUInt32ColTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamUInt32ColBuff* CFBamRamUInt32ColTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamUInt32ColBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamUInt32ColBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamUInt32ColBuff* CFBamRamUInt32ColTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamUInt32ColBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamUInt32ColBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> CFBamRamUInt32ColTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamUInt32ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamUInt32ColBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamUInt32ColBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamUInt32ColBuff* CFBamRamUInt32ColTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamUInt32ColBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamUInt32ColBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamUInt32ColBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamUInt32ColBuff* CFBamRamUInt32ColTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamUInt32ColBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> CFBamRamUInt32ColTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamUInt32ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> CFBamRamUInt32ColTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamUInt32ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> CFBamRamUInt32ColTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamUInt32ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> CFBamRamUInt32ColTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamUInt32ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> CFBamRamUInt32ColTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamUInt32ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> CFBamRamUInt32ColTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamUInt32ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> CFBamRamUInt32ColTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamUInt32ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> CFBamRamUInt32ColTable::readBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		cfbam::CFBamUInt32ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> CFBamRamUInt32ColTable::pageBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId,
	...
	cfbam::CFBamUInt32ColBuff* CFBamRamUInt32ColTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamUInt32ColBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamUInt32ColBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamUInt32ColBuff*>( editCur ) );
	}

	cfbam::CFBamUInt32ColBuff* CFBamRamUInt32ColTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamUInt32ColBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamUInt32ColBuff* CFBamRamUInt32ColTable::updateUInt32Col( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUInt32ColBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in UInt32Col for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamUInt32ColBuff* existing = searchExisting->second;
		...
		cfbam::CFBamUInt32ColByTableIdxKey existingKeyTableIdx;
		...
		cfbam::CFBamUInt32ColByTableIdxKey newKeyTableIdx;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamUInt32ColBuff*>( schema->getTableUInt32Def()->updateUInt32Def( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt32ColBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt32ColBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamUInt32ColBuff*>* subdictTableIdx;
		...
		if( searchNewKeyDictByTableIdx != dictByTableIdx->end() ) {
			...
			dictByTableIdx->insert( std::map<cfbam::CFBamUInt32ColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamUInt32ColBuff*>*>::value_type( newKeyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt32ColBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamUInt32ColBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamUInt32ColBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamUInt32ColBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamUInt32ColTable::deleteUInt32Col( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUInt32ColBuff* Buff )
	{
		static const std::string S_ProcName( "deleteUInt32Col" );
	...
	void CFBamRamUInt32ColTable::deleteUInt32ColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamUInt32ColBuff* cur = NULL;
		cfbam::CFBamUInt32ColBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUInt32ColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUInt32ColBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamUInt32ColBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamUInt32ColBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamUInt32ColTable::deleteUInt32ColByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamUInt32ColTable::deleteUInt32ColByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamUInt32ColTable::deleteUInt32ColByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamUInt32ColTable::deleteUInt32ColByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamUInt32ColTable::deleteUInt32ColByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamUInt32ColTable::deleteUInt32ColByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamUInt32ColTable::deleteUInt32ColByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamUInt32ColTable::deleteUInt32ColByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamUInt32ColTable::deleteUInt32ColByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamUInt32ColTable::releasePreparedStatements() {
	}
