...
// Description: C++18 Implementation for an in-memory RAM DbIO for StringDef.
...
namespace cfbam {
	...
	const std::string CFBamRamStringDefTable::CLASS_NAME( "CFBamRamStringDefTable" );

	CFBamRamStringDefTable::CFBamRamStringDefTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamStringDefTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamStringDefBuff*>();
	}

	CFBamRamStringDefTable::~CFBamRamStringDefTable() {
		if( dictByPKey != NULL ) {
			delete dictByPKey;
			dictByPKey = NULL;
		}
	...
	cfbam::CFBamStringDefBuff* CFBamRamStringDefTable::createStringDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamStringDefBuff* Buff )
	{
		...
		cfbam::CFBamStringDefBuff* buff = dynamic_cast<cfbam::CFBamStringDefBuff*>( schema->getTableAtom()->createAtom( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamStringDefBuff*>::value_type( pkey, buff ) );

		// The top level code has to clone the final buffer. The one passed in is now part of the persistent storage.
		if( buff->getClassCode() == cfbam::CFBamStringDefBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamStringDefBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamStringDefBuff* CFBamRamStringDefTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamStringDefBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamStringDefBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamStringDefBuff* CFBamRamStringDefTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> CFBamRamStringDefTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamStringDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamStringDefBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamStringDefBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamStringDefBuff*>( iter->second->clone() );
	...
	cfbam::CFBamStringDefBuff* CFBamRamStringDefTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamStringDefBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamStringDefBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> CFBamRamStringDefTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamStringDefBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamStringDefBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> CFBamRamStringDefTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> CFBamRamStringDefTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> CFBamRamStringDefTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> CFBamRamStringDefTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> CFBamRamStringDefTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> CFBamRamStringDefTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	cfbam::CFBamStringDefBuff* CFBamRamStringDefTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamStringDefBuff* CFBamRamStringDefTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamStringDefBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamStringDefBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamStringDefBuff* CFBamRamStringDefTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamStringDefBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamStringDefBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> CFBamRamStringDefTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamStringDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamStringDefBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamStringDefBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamStringDefBuff* CFBamRamStringDefTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamStringDefBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamStringDefBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamStringDefBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamStringDefBuff* CFBamRamStringDefTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamStringDefBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> CFBamRamStringDefTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamStringDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> CFBamRamStringDefTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamStringDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> CFBamRamStringDefTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamStringDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> CFBamRamStringDefTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamStringDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> CFBamRamStringDefTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamStringDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> CFBamRamStringDefTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamStringDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> CFBamRamStringDefTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamStringDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	cfbam::CFBamStringDefBuff* CFBamRamStringDefTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamStringDefBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamStringDefBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamStringDefBuff*>( editCur ) );
	}

	cfbam::CFBamStringDefBuff* CFBamRamStringDefTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamStringDefBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamStringDefBuff* CFBamRamStringDefTable::updateStringDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamStringDefBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in StringDef for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamStringDefBuff* existing = searchExisting->second;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamStringDefBuff*>( schema->getTableAtom()->updateAtom( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamStringDefBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamStringDefBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamStringDefBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamStringDefBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamStringDefBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamStringDefTable::deleteStringDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamStringDefBuff* Buff )
	{
		static const std::string S_ProcName( "deleteStringDef" );
		...
		{
			cfbam::CFBamStringTypeBuff* refIdIdx = dynamic_cast<cfbam::CFBamStringTypeBuff*>( schema->getTableStringType()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table StringType for primary key " + pkey.toString() );
		...
		{
			cfbam::CFBamStringColBuff* refIdIdx = dynamic_cast<cfbam::CFBamStringColBuff*>( schema->getTableStringCol()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table StringCol for primary key " + pkey.toString() );
				throw cflib::CFLibDependentsDetectedException( CLASS_NAME,
					S_ProcName,
					Msg );
			}
	...
	void CFBamRamStringDefTable::deleteStringDefByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteStringDefByIdIdx" );
		...
		cfbam::CFBamStringDefBuff* cur = NULL;
		cfbam::CFBamStringDefBuff* rereadCur = NULL;
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamStringDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamStringDefBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamValueBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamStringDefBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamStringDefBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamStringDefBuff::CLASS_CODE ) {
	...
	void CFBamRamStringDefTable::deleteStringDefByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteStringDefByUNameIdx" );
		cfbam::CFBamStringDefBuff* cur = NULL;
		cfbam::CFBamStringDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamStringDefTable::deleteStringDefByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteStringDefByValTentIdx" );
		cfbam::CFBamStringDefBuff* cur = NULL;
		cfbam::CFBamStringDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamStringDefTable::deleteStringDefByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteStringDefByScopeIdx" );
		cfbam::CFBamStringDefBuff* cur = NULL;
		cfbam::CFBamStringDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamStringDefTable::deleteStringDefByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteStringDefByDefSchemaIdx" );
		cfbam::CFBamStringDefBuff* cur = NULL;
		cfbam::CFBamStringDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamStringDefTable::deleteStringDefByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteStringDefByPrevIdx" );
		cfbam::CFBamStringDefBuff* cur = NULL;
		cfbam::CFBamStringDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamStringDefTable::deleteStringDefByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteStringDefByNextIdx" );
		cfbam::CFBamStringDefBuff* cur = NULL;
		cfbam::CFBamStringDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamStringDefTable::deleteStringDefByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteStringDefByContPrevIdx" );
		cfbam::CFBamStringDefBuff* cur = NULL;
		cfbam::CFBamStringDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamStringDefTable::deleteStringDefByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteStringDefByContNextIdx" );
		cfbam::CFBamStringDefBuff* cur = NULL;
		cfbam::CFBamStringDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamStringDefTable::releasePreparedStatements() {
	}
