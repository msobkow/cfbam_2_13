...
// Description: C++18 Implementation for an in-memory RAM DbIO for Int32Def.
...
namespace cfbam {
	...
	const std::string CFBamRamInt32DefTable::CLASS_NAME( "CFBamRamInt32DefTable" );

	CFBamRamInt32DefTable::CFBamRamInt32DefTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamInt32DefTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt32DefBuff*>();
	}

	CFBamRamInt32DefTable::~CFBamRamInt32DefTable() {
		if( dictByPKey != NULL ) {
			delete dictByPKey;
			dictByPKey = NULL;
		}
	...
	cfbam::CFBamInt32DefBuff* CFBamRamInt32DefTable::createInt32Def( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt32DefBuff* Buff )
	{
		...
		cfbam::CFBamInt32DefBuff* buff = dynamic_cast<cfbam::CFBamInt32DefBuff*>( schema->getTableAtom()->createAtom( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt32DefBuff*>::value_type( pkey, buff ) );

		// The top level code has to clone the final buffer. The one passed in is now part of the persistent storage.
		if( buff->getClassCode() == cfbam::CFBamInt32DefBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamInt32DefBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamInt32DefBuff* CFBamRamInt32DefTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamInt32DefBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamInt32DefBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamInt32DefBuff* CFBamRamInt32DefTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> CFBamRamInt32DefTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt32DefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt32DefBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamInt32DefBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamInt32DefBuff*>( iter->second->clone() );
	...
	cfbam::CFBamInt32DefBuff* CFBamRamInt32DefTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamInt32DefBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamInt32DefBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> CFBamRamInt32DefTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamInt32DefBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamInt32DefBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> CFBamRamInt32DefTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> CFBamRamInt32DefTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> CFBamRamInt32DefTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> CFBamRamInt32DefTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> CFBamRamInt32DefTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> CFBamRamInt32DefTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	cfbam::CFBamInt32DefBuff* CFBamRamInt32DefTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamInt32DefBuff* CFBamRamInt32DefTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamInt32DefBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamInt32DefBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamInt32DefBuff* CFBamRamInt32DefTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamInt32DefBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamInt32DefBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> CFBamRamInt32DefTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamInt32DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamInt32DefBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamInt32DefBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamInt32DefBuff* CFBamRamInt32DefTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamInt32DefBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamInt32DefBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamInt32DefBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamInt32DefBuff* CFBamRamInt32DefTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamInt32DefBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> CFBamRamInt32DefTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamInt32DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> CFBamRamInt32DefTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamInt32DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> CFBamRamInt32DefTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamInt32DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> CFBamRamInt32DefTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamInt32DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> CFBamRamInt32DefTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamInt32DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> CFBamRamInt32DefTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamInt32DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> CFBamRamInt32DefTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamInt32DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*>::iterator iterBuffList = buffList.begin();
	...
	cfbam::CFBamInt32DefBuff* CFBamRamInt32DefTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamInt32DefBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamInt32DefBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamInt32DefBuff*>( editCur ) );
	}

	cfbam::CFBamInt32DefBuff* CFBamRamInt32DefTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamInt32DefBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamInt32DefBuff* CFBamRamInt32DefTable::updateInt32Def( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt32DefBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in Int32Def for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamInt32DefBuff* existing = searchExisting->second;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamInt32DefBuff*>( schema->getTableAtom()->updateAtom( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt32DefBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt32DefBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamInt32DefBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamInt32DefBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamInt32DefBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamInt32DefTable::deleteInt32Def( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt32DefBuff* Buff )
	{
		static const std::string S_ProcName( "deleteInt32Def" );
		...
		{
			cfbam::CFBamInt32TypeBuff* refIdIdx = dynamic_cast<cfbam::CFBamInt32TypeBuff*>( schema->getTableInt32Type()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table Int32Type for primary key " + pkey.toString() );
		...
		{
			cfbam::CFBamInt32ColBuff* refIdIdx = dynamic_cast<cfbam::CFBamInt32ColBuff*>( schema->getTableInt32Col()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table Int32Col for primary key " + pkey.toString() );
				throw cflib::CFLibDependentsDetectedException( CLASS_NAME,
					S_ProcName,
					Msg );
			}
	...
	void CFBamRamInt32DefTable::deleteInt32DefByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt32DefByIdIdx" );
		...
		cfbam::CFBamInt32DefBuff* cur = NULL;
		cfbam::CFBamInt32DefBuff* rereadCur = NULL;
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt32DefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt32DefBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamValueBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamInt32DefBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamInt32DefBuff::CLASS_CODE ) {
	...
	void CFBamRamInt32DefTable::deleteInt32DefByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteInt32DefByUNameIdx" );
		cfbam::CFBamInt32DefBuff* cur = NULL;
		cfbam::CFBamInt32DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt32DefTable::deleteInt32DefByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt32DefByValTentIdx" );
		cfbam::CFBamInt32DefBuff* cur = NULL;
		cfbam::CFBamInt32DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt32DefTable::deleteInt32DefByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt32DefByScopeIdx" );
		cfbam::CFBamInt32DefBuff* cur = NULL;
		cfbam::CFBamInt32DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt32DefTable::deleteInt32DefByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt32DefByDefSchemaIdx" );
		cfbam::CFBamInt32DefBuff* cur = NULL;
		cfbam::CFBamInt32DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamInt32DefTable::deleteInt32DefByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt32DefByPrevIdx" );
		cfbam::CFBamInt32DefBuff* cur = NULL;
		cfbam::CFBamInt32DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamInt32DefTable::deleteInt32DefByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt32DefByNextIdx" );
		cfbam::CFBamInt32DefBuff* cur = NULL;
		cfbam::CFBamInt32DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamInt32DefTable::deleteInt32DefByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt32DefByContPrevIdx" );
		cfbam::CFBamInt32DefBuff* cur = NULL;
		cfbam::CFBamInt32DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt32DefTable::deleteInt32DefByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt32DefByContNextIdx" );
		cfbam::CFBamInt32DefBuff* cur = NULL;
		cfbam::CFBamInt32DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt32DefTable::releasePreparedStatements() {
	}
