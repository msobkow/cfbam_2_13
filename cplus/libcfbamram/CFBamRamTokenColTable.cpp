...
// Description: C++18 Implementation for an in-memory RAM DbIO for TokenCol.
...
namespace cfbam {
	...
	const std::string CFBamRamTokenColTable::CLASS_NAME( "CFBamRamTokenColTable" );

	CFBamRamTokenColTable::CFBamRamTokenColTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamTokenColTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTokenColBuff*>();
		dictByTableIdx = new std::map<cfbam::CFBamTokenColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTokenColBuff*>*>();
	}

	CFBamRamTokenColTable::~CFBamRamTokenColTable() {
	...
	cfbam::CFBamTokenColBuff* CFBamRamTokenColTable::createTokenCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTokenColBuff* Buff )
	{
		static const std::string S_ProcName( "createTokenCol" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamTokenColBuff::CLASS_CODE ) {
		...
		cfbam::CFBamTokenColBuff* buff = dynamic_cast<cfbam::CFBamTokenColBuff*>( schema->getTableTokenDef()->createTokenDef( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTokenColBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTokenColBuff*>* subdictTableIdx;
		...
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			...
			subdictTableIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTokenColBuff*>();
			dictByTableIdx->insert( std::map<cfbam::CFBamTokenColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamTokenColBuff*>*>::value_type( keyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTokenColBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamTokenColBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamTokenColBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamTokenColBuff* CFBamRamTokenColTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamTokenColBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamTokenColBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamTokenColBuff* CFBamRamTokenColTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> CFBamRamTokenColTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTokenColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTokenColBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamTokenColBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamTokenColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTokenColBuff* CFBamRamTokenColTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamTokenColBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamTokenColBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> CFBamRamTokenColTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamTokenColBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamTokenColBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> CFBamRamTokenColTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> CFBamRamTokenColTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> CFBamRamTokenColTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> CFBamRamTokenColTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> CFBamRamTokenColTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> CFBamRamTokenColTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> CFBamRamTokenColTable::readDerivedByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> recVec;
		cfbam::CFBamTokenColBuff* clone;
		auto searchDictByTableIdx = dictByTableIdx->find( key );
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamTokenColBuff*>* subdictTableIdx = searchDictByTableIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTokenColBuff*>::iterator iter = subdictTableIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTokenColBuff*>::iterator end = subdictTableIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamTokenColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTokenColBuff* CFBamRamTokenColTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamTokenColBuff* CFBamRamTokenColTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamTokenColBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamTokenColBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamTokenColBuff* CFBamRamTokenColTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamTokenColBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamTokenColBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> CFBamRamTokenColTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamTokenColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamTokenColBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamTokenColBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamTokenColBuff* CFBamRamTokenColTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamTokenColBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamTokenColBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamTokenColBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamTokenColBuff* CFBamRamTokenColTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamTokenColBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> CFBamRamTokenColTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamTokenColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> CFBamRamTokenColTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamTokenColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> CFBamRamTokenColTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamTokenColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> CFBamRamTokenColTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTokenColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> CFBamRamTokenColTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTokenColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> CFBamRamTokenColTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTokenColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> CFBamRamTokenColTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTokenColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> CFBamRamTokenColTable::readBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		cfbam::CFBamTokenColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> CFBamRamTokenColTable::pageBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId,
	...
	cfbam::CFBamTokenColBuff* CFBamRamTokenColTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamTokenColBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTokenColBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamTokenColBuff*>( editCur ) );
	}

	cfbam::CFBamTokenColBuff* CFBamRamTokenColTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTokenColBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamTokenColBuff* CFBamRamTokenColTable::updateTokenCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTokenColBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in TokenCol for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamTokenColBuff* existing = searchExisting->second;
		...
		cfbam::CFBamTokenColByTableIdxKey existingKeyTableIdx;
		...
		cfbam::CFBamTokenColByTableIdxKey newKeyTableIdx;
...

		{
			...
			if( allNull ) {
				cfbam::CFBamTokenDefBuff* chk = dynamic_cast<cfbam::CFBamTokenDefBuff*>( schema->getTableTokenDef()->readDerivedByIdIdx( Authorization,
						Buff->getRequiredTenantId(),
						Buff->getRequiredId() ) );
				if( chk == NULL ) {
					delete Buff;
					std::string Msg( "Could not resolve Superclass relationship SuperClass to table TokenDef" );
					throw cflib::CFLibUnresolvedRelationException( CLASS_NAME,
						S_ProcName,
						Msg );
				}
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamTokenColBuff*>( schema->getTableTokenDef()->updateTokenDef( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTokenColBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTokenColBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamTokenColBuff*>* subdictTableIdx;
		...
		if( searchNewKeyDictByTableIdx != dictByTableIdx->end() ) {
			...
			dictByTableIdx->insert( std::map<cfbam::CFBamTokenColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamTokenColBuff*>*>::value_type( newKeyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTokenColBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamTokenColBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamTokenColBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamTokenColBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamTokenColTable::deleteTokenCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTokenColBuff* Buff )
	{
		static const std::string S_ProcName( "deleteTokenCol" );
	...
	void CFBamRamTokenColTable::deleteTokenColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTokenColTable::deleteTokenColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamTokenColByTableIdxKey* argKey )
	{
		cfbam::CFBamTokenColBuff* cur = NULL;
		cfbam::CFBamTokenColBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTokenColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTokenColBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamTokenColBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamTokenColBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamTokenColBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamTokenColTable::deleteTokenColByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamTokenColTable::deleteTokenColByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamTokenColTable::deleteTokenColByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamTokenColTable::deleteTokenColByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamTokenColTable::deleteTokenColByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTokenColTable::deleteTokenColByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTokenColTable::deleteTokenColByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTokenColTable::deleteTokenColByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamTokenColTable::deleteTokenColByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamTokenColTable::releasePreparedStatements() {
	}
