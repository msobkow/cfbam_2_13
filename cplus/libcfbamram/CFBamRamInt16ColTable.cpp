...
// Description: C++18 Implementation for an in-memory RAM DbIO for Int16Col.
...
namespace cfbam {
	...
	const std::string CFBamRamInt16ColTable::CLASS_NAME( "CFBamRamInt16ColTable" );

	CFBamRamInt16ColTable::CFBamRamInt16ColTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamInt16ColTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt16ColBuff*>();
		dictByTableIdx = new std::map<cfbam::CFBamInt16ColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamInt16ColBuff*>*>();
	}

	CFBamRamInt16ColTable::~CFBamRamInt16ColTable() {
	...
	cfbam::CFBamInt16ColBuff* CFBamRamInt16ColTable::createInt16Col( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt16ColBuff* Buff )
	{
		static const std::string S_ProcName( "createInt16Col" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamInt16ColBuff::CLASS_CODE ) {
		...
		cfbam::CFBamInt16ColBuff* buff = dynamic_cast<cfbam::CFBamInt16ColBuff*>( schema->getTableInt16Def()->createInt16Def( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt16ColBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt16ColBuff*>* subdictTableIdx;
		...
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			...
			subdictTableIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt16ColBuff*>();
			dictByTableIdx->insert( std::map<cfbam::CFBamInt16ColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamInt16ColBuff*>*>::value_type( keyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt16ColBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamInt16ColBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamInt16ColBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamInt16ColBuff* CFBamRamInt16ColTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamInt16ColBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamInt16ColBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamInt16ColBuff* CFBamRamInt16ColTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> CFBamRamInt16ColTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt16ColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt16ColBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamInt16ColBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamInt16ColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamInt16ColBuff* CFBamRamInt16ColTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamInt16ColBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamInt16ColBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> CFBamRamInt16ColTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamInt16ColBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamInt16ColBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> CFBamRamInt16ColTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> CFBamRamInt16ColTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> CFBamRamInt16ColTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> CFBamRamInt16ColTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> CFBamRamInt16ColTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> CFBamRamInt16ColTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> CFBamRamInt16ColTable::readDerivedByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> recVec;
		cfbam::CFBamInt16ColBuff* clone;
		auto searchDictByTableIdx = dictByTableIdx->find( key );
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamInt16ColBuff*>* subdictTableIdx = searchDictByTableIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamInt16ColBuff*>::iterator iter = subdictTableIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamInt16ColBuff*>::iterator end = subdictTableIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamInt16ColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamInt16ColBuff* CFBamRamInt16ColTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamInt16ColBuff* CFBamRamInt16ColTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamInt16ColBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamInt16ColBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamInt16ColBuff* CFBamRamInt16ColTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamInt16ColBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamInt16ColBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> CFBamRamInt16ColTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamInt16ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamInt16ColBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamInt16ColBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamInt16ColBuff* CFBamRamInt16ColTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamInt16ColBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamInt16ColBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamInt16ColBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamInt16ColBuff* CFBamRamInt16ColTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamInt16ColBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> CFBamRamInt16ColTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamInt16ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> CFBamRamInt16ColTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamInt16ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> CFBamRamInt16ColTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamInt16ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> CFBamRamInt16ColTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamInt16ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> CFBamRamInt16ColTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamInt16ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> CFBamRamInt16ColTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamInt16ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> CFBamRamInt16ColTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamInt16ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> CFBamRamInt16ColTable::readBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		cfbam::CFBamInt16ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> CFBamRamInt16ColTable::pageBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId,
	...
	cfbam::CFBamInt16ColBuff* CFBamRamInt16ColTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamInt16ColBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamInt16ColBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamInt16ColBuff*>( editCur ) );
	}

	cfbam::CFBamInt16ColBuff* CFBamRamInt16ColTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamInt16ColBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamInt16ColBuff* CFBamRamInt16ColTable::updateInt16Col( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt16ColBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in Int16Col for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamInt16ColBuff* existing = searchExisting->second;
		...
		cfbam::CFBamInt16ColByTableIdxKey existingKeyTableIdx;
		...
		cfbam::CFBamInt16ColByTableIdxKey newKeyTableIdx;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamInt16ColBuff*>( schema->getTableInt16Def()->updateInt16Def( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt16ColBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt16ColBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamInt16ColBuff*>* subdictTableIdx;
		...
		if( searchNewKeyDictByTableIdx != dictByTableIdx->end() ) {
			...
			dictByTableIdx->insert( std::map<cfbam::CFBamInt16ColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamInt16ColBuff*>*>::value_type( newKeyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt16ColBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamInt16ColBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamInt16ColBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamInt16ColBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamInt16ColTable::deleteInt16Col( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt16ColBuff* Buff )
	{
		static const std::string S_ProcName( "deleteInt16Col" );
	...
	void CFBamRamInt16ColTable::deleteInt16ColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamInt16ColBuff* cur = NULL;
		cfbam::CFBamInt16ColBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt16ColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt16ColBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamInt16ColBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamInt16ColBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamInt16ColTable::deleteInt16ColByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamInt16ColTable::deleteInt16ColByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamInt16ColTable::deleteInt16ColByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamInt16ColTable::deleteInt16ColByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamInt16ColTable::deleteInt16ColByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamInt16ColTable::deleteInt16ColByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamInt16ColTable::deleteInt16ColByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamInt16ColTable::deleteInt16ColByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamInt16ColTable::deleteInt16ColByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamInt16ColTable::releasePreparedStatements() {
	}
