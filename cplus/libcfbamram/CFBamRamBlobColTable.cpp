...
// Description: C++18 Implementation for an in-memory RAM DbIO for BlobCol.
...
namespace cfbam {
	...
	const std::string CFBamRamBlobColTable::CLASS_NAME( "CFBamRamBlobColTable" );

	CFBamRamBlobColTable::CFBamRamBlobColTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamBlobColTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamBlobColBuff*>();
		dictByTableIdx = new std::map<cfbam::CFBamBlobColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamBlobColBuff*>*>();
	}

	CFBamRamBlobColTable::~CFBamRamBlobColTable() {
	...
	cfbam::CFBamBlobColBuff* CFBamRamBlobColTable::createBlobCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamBlobColBuff* Buff )
	{
		static const std::string S_ProcName( "createBlobCol" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamBlobColBuff::CLASS_CODE ) {
		...
		cfbam::CFBamBlobColBuff* buff = dynamic_cast<cfbam::CFBamBlobColBuff*>( schema->getTableBlobDef()->createBlobDef( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamBlobColBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamBlobColBuff*>* subdictTableIdx;
		...
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			...
			subdictTableIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamBlobColBuff*>();
			dictByTableIdx->insert( std::map<cfbam::CFBamBlobColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamBlobColBuff*>*>::value_type( keyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamBlobColBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamBlobColBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamBlobColBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamBlobColBuff* CFBamRamBlobColTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamBlobColBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamBlobColBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamBlobColBuff* CFBamRamBlobColTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> CFBamRamBlobColTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamBlobColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamBlobColBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamBlobColBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamBlobColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamBlobColBuff* CFBamRamBlobColTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamBlobColBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamBlobColBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> CFBamRamBlobColTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamBlobColBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamBlobColBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> CFBamRamBlobColTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> CFBamRamBlobColTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> CFBamRamBlobColTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> CFBamRamBlobColTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> CFBamRamBlobColTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> CFBamRamBlobColTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> CFBamRamBlobColTable::readDerivedByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> recVec;
		cfbam::CFBamBlobColBuff* clone;
		auto searchDictByTableIdx = dictByTableIdx->find( key );
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamBlobColBuff*>* subdictTableIdx = searchDictByTableIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamBlobColBuff*>::iterator iter = subdictTableIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamBlobColBuff*>::iterator end = subdictTableIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamBlobColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamBlobColBuff* CFBamRamBlobColTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamBlobColBuff* CFBamRamBlobColTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamBlobColBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamBlobColBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamBlobColBuff* CFBamRamBlobColTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamBlobColBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamBlobColBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> CFBamRamBlobColTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamBlobColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamBlobColBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamBlobColBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamBlobColBuff* CFBamRamBlobColTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamBlobColBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamBlobColBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamBlobColBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamBlobColBuff* CFBamRamBlobColTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamBlobColBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> CFBamRamBlobColTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamBlobColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> CFBamRamBlobColTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamBlobColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> CFBamRamBlobColTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamBlobColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> CFBamRamBlobColTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamBlobColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> CFBamRamBlobColTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamBlobColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> CFBamRamBlobColTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamBlobColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> CFBamRamBlobColTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamBlobColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> CFBamRamBlobColTable::readBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		cfbam::CFBamBlobColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> CFBamRamBlobColTable::pageBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId,
	...
	cfbam::CFBamBlobColBuff* CFBamRamBlobColTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamBlobColBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamBlobColBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamBlobColBuff*>( editCur ) );
	}

	cfbam::CFBamBlobColBuff* CFBamRamBlobColTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamBlobColBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamBlobColBuff* CFBamRamBlobColTable::updateBlobCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamBlobColBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in BlobCol for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamBlobColBuff* existing = searchExisting->second;
		...
		cfbam::CFBamBlobColByTableIdxKey existingKeyTableIdx;
		...
		cfbam::CFBamBlobColByTableIdxKey newKeyTableIdx;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamBlobColBuff*>( schema->getTableBlobDef()->updateBlobDef( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamBlobColBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamBlobColBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamBlobColBuff*>* subdictTableIdx;
		...
		if( searchNewKeyDictByTableIdx != dictByTableIdx->end() ) {
			...
			dictByTableIdx->insert( std::map<cfbam::CFBamBlobColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamBlobColBuff*>*>::value_type( newKeyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamBlobColBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamBlobColBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamBlobColBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamBlobColBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamBlobColTable::deleteBlobCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamBlobColBuff* Buff )
	{
		static const std::string S_ProcName( "deleteBlobCol" );
	...
	void CFBamRamBlobColTable::deleteBlobColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamBlobColBuff* cur = NULL;
		cfbam::CFBamBlobColBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamBlobColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamBlobColBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamBlobColBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamBlobColBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamBlobColBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamBlobColTable::deleteBlobColByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamBlobColTable::deleteBlobColByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamBlobColTable::deleteBlobColByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamBlobColTable::deleteBlobColByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamBlobColTable::deleteBlobColByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamBlobColTable::deleteBlobColByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamBlobColTable::deleteBlobColByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamBlobColTable::deleteBlobColByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamBlobColTable::deleteBlobColByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamBlobColTable::releasePreparedStatements() {
	}
