...
// Description: C++18 Implementation for an in-memory RAM DbIO for TextType.
...
namespace cfbam {
	...
	const std::string CFBamRamTextTypeTable::CLASS_NAME( "CFBamRamTextTypeTable" );

	CFBamRamTextTypeTable::CFBamRamTextTypeTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamTextTypeTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTextTypeBuff*>();
		dictBySchemaIdx = new std::map<cfbam::CFBamTextTypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTextTypeBuff*>*>();
	}

	CFBamRamTextTypeTable::~CFBamRamTextTypeTable() {
	...
	cfbam::CFBamTextTypeBuff* CFBamRamTextTypeTable::createTextType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTextTypeBuff* Buff )
	{
		static const std::string S_ProcName( "createTextType" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamTextTypeBuff::CLASS_CODE ) {
		...
		cfbam::CFBamTextTypeBuff* buff = dynamic_cast<cfbam::CFBamTextTypeBuff*>( schema->getTableTextDef()->createTextDef( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTextTypeBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTextTypeBuff*>* subdictSchemaIdx;
		...
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			subdictSchemaIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTextTypeBuff*>();
			dictBySchemaIdx->insert( std::map<cfbam::CFBamTextTypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamTextTypeBuff*>*>::value_type( keySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTextTypeBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamTextTypeBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamTextTypeBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamTextTypeBuff* CFBamRamTextTypeTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamTextTypeBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamTextTypeBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamTextTypeBuff* CFBamRamTextTypeTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> CFBamRamTextTypeTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTextTypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTextTypeBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamTextTypeBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamTextTypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTextTypeBuff* CFBamRamTextTypeTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamTextTypeBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamTextTypeBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> CFBamRamTextTypeTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamTextTypeBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamTextTypeBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> CFBamRamTextTypeTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> CFBamRamTextTypeTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> CFBamRamTextTypeTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> CFBamRamTextTypeTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> CFBamRamTextTypeTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> CFBamRamTextTypeTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> CFBamRamTextTypeTable::readDerivedBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> recVec;
		cfbam::CFBamTextTypeBuff* clone;
		auto searchDictBySchemaIdx = dictBySchemaIdx->find( key );
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamTextTypeBuff*>* subdictSchemaIdx = searchDictBySchemaIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTextTypeBuff*>::iterator iter = subdictSchemaIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTextTypeBuff*>::iterator end = subdictSchemaIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamTextTypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTextTypeBuff* CFBamRamTextTypeTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamTextTypeBuff* CFBamRamTextTypeTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamTextTypeBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamTextTypeBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamTextTypeBuff* CFBamRamTextTypeTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamTextTypeBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamTextTypeBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> CFBamRamTextTypeTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamTextTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamTextTypeBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamTextTypeBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamTextTypeBuff* CFBamRamTextTypeTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamTextTypeBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamTextTypeBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamTextTypeBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamTextTypeBuff* CFBamRamTextTypeTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamTextTypeBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> CFBamRamTextTypeTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamTextTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> CFBamRamTextTypeTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamTextTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> CFBamRamTextTypeTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamTextTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> CFBamRamTextTypeTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTextTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> CFBamRamTextTypeTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTextTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> CFBamRamTextTypeTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTextTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> CFBamRamTextTypeTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTextTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> CFBamRamTextTypeTable::readBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		cfbam::CFBamTextTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> CFBamRamTextTypeTable::pageBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId,
	...
	cfbam::CFBamTextTypeBuff* CFBamRamTextTypeTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamTextTypeBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTextTypeBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamTextTypeBuff*>( editCur ) );
	}

	cfbam::CFBamTextTypeBuff* CFBamRamTextTypeTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTextTypeBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamTextTypeBuff* CFBamRamTextTypeTable::updateTextType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTextTypeBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in TextType for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamTextTypeBuff* existing = searchExisting->second;
		...
		cfbam::CFBamTextTypeBySchemaIdxKey existingKeySchemaIdx;
		...
		cfbam::CFBamTextTypeBySchemaIdxKey newKeySchemaIdx;
...

		{
			...
			if( allNull ) {
				cfbam::CFBamTextDefBuff* chk = dynamic_cast<cfbam::CFBamTextDefBuff*>( schema->getTableTextDef()->readDerivedByIdIdx( Authorization,
						Buff->getRequiredTenantId(),
						Buff->getRequiredId() ) );
				if( chk == NULL ) {
					delete Buff;
					std::string Msg( "Could not resolve Superclass relationship SuperClass to table TextDef" );
					throw cflib::CFLibUnresolvedRelationException( CLASS_NAME,
						S_ProcName,
						Msg );
				}
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamTextTypeBuff*>( schema->getTableTextDef()->updateTextDef( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTextTypeBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTextTypeBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamTextTypeBuff*>* subdictSchemaIdx;
		...
		if( searchNewKeyDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			dictBySchemaIdx->insert( std::map<cfbam::CFBamTextTypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamTextTypeBuff*>*>::value_type( newKeySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTextTypeBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamTextTypeBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamTextTypeBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamTextTypeBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamTextTypeTable::deleteTextType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTextTypeBuff* Buff )
	{
		static const std::string S_ProcName( "deleteTextType" );
	...
	void CFBamRamTextTypeTable::deleteTextTypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamTextTypeBuff* cur = NULL;
		cfbam::CFBamTextTypeBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTextTypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTextTypeBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamTextTypeBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamTextTypeBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamTextTypeBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamTextTypeTable::deleteTextTypeByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamTextTypeTable::deleteTextTypeByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamTextTypeTable::deleteTextTypeByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamTextTypeTable::deleteTextTypeByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamTextTypeTable::deleteTextTypeByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTextTypeTable::deleteTextTypeByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTextTypeTable::deleteTextTypeByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTextTypeTable::deleteTextTypeByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamTextTypeTable::deleteTextTypeByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamTextTypeTable::releasePreparedStatements() {
	}
