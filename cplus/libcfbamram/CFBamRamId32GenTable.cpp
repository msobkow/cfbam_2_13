...
// Description: C++18 Implementation for an in-memory RAM DbIO for Id32Gen.
...
namespace cfbam {
	...
	const std::string CFBamRamId32GenTable::CLASS_NAME( "CFBamRamId32GenTable" );

	CFBamRamId32GenTable::CFBamRamId32GenTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamId32GenTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamId32GenBuff*>();
		dictByDispIdx = new std::map<cfbam::CFBamId32GenByDispIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamId32GenBuff*>*>();
	}

	CFBamRamId32GenTable::~CFBamRamId32GenTable() {
	...
	cfbam::CFBamId32GenBuff* CFBamRamId32GenTable::createId32Gen( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamId32GenBuff* Buff )
	{
		static const std::string S_ProcName( "createId32Gen" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamId32GenBuff::CLASS_CODE ) {
		...
		cfbam::CFBamId32GenBuff* buff = dynamic_cast<cfbam::CFBamId32GenBuff*>( schema->getTableInt32Type()->createInt32Type( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamId32GenBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamId32GenBuff*>* subdictDispIdx;
		...
		if( searchDictByDispIdx != dictByDispIdx->end() ) {
			...
			subdictDispIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamId32GenBuff*>();
			dictByDispIdx->insert( std::map<cfbam::CFBamId32GenByDispIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamId32GenBuff*>*>::value_type( keyDispIdx, subdictDispIdx ) );
		}
		subdictDispIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamId32GenBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamId32GenBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamId32GenBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamId32GenBuff* CFBamRamId32GenTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamId32GenBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamId32GenBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamId32GenBuff* CFBamRamId32GenTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> CFBamRamId32GenTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamId32GenBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamId32GenBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamId32GenBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamId32GenBuff*>( iter->second->clone() );
	...
	cfbam::CFBamId32GenBuff* CFBamRamId32GenTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamId32GenBuff::CLASS_CODE ) ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> CFBamRamId32GenTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamId32GenBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamId32GenBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> CFBamRamId32GenTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> CFBamRamId32GenTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> CFBamRamId32GenTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> CFBamRamId32GenTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> CFBamRamId32GenTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> CFBamRamId32GenTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> CFBamRamId32GenTable::readDerivedBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		static const std::string S_ProcName( "readDerivedBySchemaIdx" );
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> buffList = schema->getTableInt32Type()->readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		cfbam::CFBamInt32TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamId32GenBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> CFBamRamId32GenTable::readDerivedByDispIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const int64_t* DispenserId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> recVec;
		cfbam::CFBamId32GenBuff* clone;
		auto searchDictByDispIdx = dictByDispIdx->find( key );
		if( searchDictByDispIdx != dictByDispIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamId32GenBuff*>* subdictDispIdx = searchDictByDispIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamId32GenBuff*>::iterator iter = subdictDispIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamId32GenBuff*>::iterator end = subdictDispIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamId32GenBuff*>( iter->second->clone() );
	...
	cfbam::CFBamId32GenBuff* CFBamRamId32GenTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamId32GenBuff* CFBamRamId32GenTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamId32GenBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamId32GenBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamId32GenBuff* CFBamRamId32GenTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamId32GenBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamId32GenBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> CFBamRamId32GenTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamId32GenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamId32GenBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamId32GenBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamId32GenBuff* CFBamRamId32GenTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamId32GenBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamId32GenBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamId32GenBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamId32GenBuff* CFBamRamId32GenTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamId32GenBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> CFBamRamId32GenTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamId32GenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> CFBamRamId32GenTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamId32GenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> CFBamRamId32GenTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamId32GenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> CFBamRamId32GenTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamId32GenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> CFBamRamId32GenTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamId32GenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> CFBamRamId32GenTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamId32GenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> CFBamRamId32GenTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamId32GenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> CFBamRamId32GenTable::readBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		cfbam::CFBamId32GenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamInt32TypeBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamId32GenBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> CFBamRamId32GenTable::readBuffByDispIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DispenserTenantId,
			const int64_t* DispenserId )
	{
		...
		cfbam::CFBamId32GenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> buffList = readDerivedByDispIdx( Authorization,
			DispenserTenantId,
			DispenserId );
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> CFBamRamId32GenTable::pageBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId,
	...
	std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> CFBamRamId32GenTable::pageBuffByDispIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DispenserTenantId,
			const int64_t* DispenserId,
			const int64_t* priorTenantId,
			const int64_t* priorId )
	...
	cfbam::CFBamId32GenBuff* CFBamRamId32GenTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamId32GenBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamId32GenBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamId32GenBuff*>( editCur ) );
	}

	cfbam::CFBamId32GenBuff* CFBamRamId32GenTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamId32GenBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamId32GenBuff* CFBamRamId32GenTable::updateId32Gen( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamId32GenBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in Id32Gen for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamId32GenBuff* existing = searchExisting->second;
		...
		cfbam::CFBamId32GenByDispIdxKey existingKeyDispIdx;
		...
		cfbam::CFBamId32GenByDispIdxKey newKeyDispIdx;
		if( Buff->isOptionalDispenserTenantIdNull() ) {
...

		{
			...
			if( allNull ) {
				cfbam::CFBamInt32TypeBuff* chk = dynamic_cast<cfbam::CFBamInt32TypeBuff*>( schema->getTableInt32Type()->readDerivedByIdIdx( Authorization,
						Buff->getRequiredTenantId(),
						Buff->getRequiredId() ) );
				if( chk == NULL ) {
					delete Buff;
					std::string Msg( "Could not resolve Superclass relationship SuperClass to table Int32Type" );
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamId32GenBuff*>( schema->getTableInt32Type()->updateInt32Type( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamId32GenBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamId32GenBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamId32GenBuff*>* subdictDispIdx;
		...
		if( searchNewKeyDictByDispIdx != dictByDispIdx->end() ) {
			...
			dictByDispIdx->insert( std::map<cfbam::CFBamId32GenByDispIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamId32GenBuff*>*>::value_type( newKeyDispIdx, subdictDispIdx ) );
		}
		subdictDispIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamId32GenBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamId32GenBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamId32GenBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamId32GenBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamId32GenTable::deleteId32Gen( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamId32GenBuff* Buff )
	{
		static const std::string S_ProcName( "deleteId32Gen" );
	...
	void CFBamRamId32GenTable::deleteId32GenByDispIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamId32GenBuff* cur = NULL;
		cfbam::CFBamId32GenBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamId32GenBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamId32GenBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamId32GenBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamId32GenBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamId32GenTable::deleteId32GenBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
		...
		const cfbam::CFBamInt32TypeBySchemaIdxKey* argKey )
	{
		...
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamInt32TypeBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamId32GenBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*>::iterator iterMatch = matchSet.begin();
	...
	void CFBamRamId32GenTable::deleteId32GenByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamId32GenTable::deleteId32GenByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamId32GenTable::deleteId32GenByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamId32GenTable::deleteId32GenByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamId32GenTable::deleteId32GenByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamId32GenTable::deleteId32GenByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamId32GenTable::deleteId32GenByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamId32GenTable::deleteId32GenByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamId32GenTable::deleteId32GenByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamId32GenTable::releasePreparedStatements() {
	}
