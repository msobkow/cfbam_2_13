...
// Description: C++18 Implementation for an in-memory RAM DbIO for Int32Col.
...
namespace cfbam {
	...
	const std::string CFBamRamInt32ColTable::CLASS_NAME( "CFBamRamInt32ColTable" );

	CFBamRamInt32ColTable::CFBamRamInt32ColTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamInt32ColTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt32ColBuff*>();
		dictByTableIdx = new std::map<cfbam::CFBamInt32ColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamInt32ColBuff*>*>();
	}

	CFBamRamInt32ColTable::~CFBamRamInt32ColTable() {
	...
	cfbam::CFBamInt32ColBuff* CFBamRamInt32ColTable::createInt32Col( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt32ColBuff* Buff )
	{
		static const std::string S_ProcName( "createInt32Col" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamInt32ColBuff::CLASS_CODE ) {
		...
		cfbam::CFBamInt32ColBuff* buff = dynamic_cast<cfbam::CFBamInt32ColBuff*>( schema->getTableInt32Def()->createInt32Def( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt32ColBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt32ColBuff*>* subdictTableIdx;
		...
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			...
			subdictTableIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt32ColBuff*>();
			dictByTableIdx->insert( std::map<cfbam::CFBamInt32ColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamInt32ColBuff*>*>::value_type( keyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt32ColBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamInt32ColBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamInt32ColBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamInt32ColBuff* CFBamRamInt32ColTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamInt32ColBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamInt32ColBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamInt32ColBuff* CFBamRamInt32ColTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> CFBamRamInt32ColTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt32ColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt32ColBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamInt32ColBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamInt32ColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamInt32ColBuff* CFBamRamInt32ColTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamInt32ColBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamInt32ColBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> CFBamRamInt32ColTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamInt32ColBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamInt32ColBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> CFBamRamInt32ColTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> CFBamRamInt32ColTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> CFBamRamInt32ColTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> CFBamRamInt32ColTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> CFBamRamInt32ColTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> CFBamRamInt32ColTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> CFBamRamInt32ColTable::readDerivedByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> recVec;
		cfbam::CFBamInt32ColBuff* clone;
		auto searchDictByTableIdx = dictByTableIdx->find( key );
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamInt32ColBuff*>* subdictTableIdx = searchDictByTableIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamInt32ColBuff*>::iterator iter = subdictTableIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamInt32ColBuff*>::iterator end = subdictTableIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamInt32ColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamInt32ColBuff* CFBamRamInt32ColTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamInt32ColBuff* CFBamRamInt32ColTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamInt32ColBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamInt32ColBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamInt32ColBuff* CFBamRamInt32ColTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamInt32ColBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamInt32ColBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> CFBamRamInt32ColTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamInt32ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamInt32ColBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamInt32ColBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamInt32ColBuff* CFBamRamInt32ColTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamInt32ColBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamInt32ColBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamInt32ColBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamInt32ColBuff* CFBamRamInt32ColTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamInt32ColBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> CFBamRamInt32ColTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamInt32ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> CFBamRamInt32ColTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamInt32ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> CFBamRamInt32ColTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamInt32ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> CFBamRamInt32ColTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamInt32ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> CFBamRamInt32ColTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamInt32ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> CFBamRamInt32ColTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamInt32ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> CFBamRamInt32ColTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamInt32ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> CFBamRamInt32ColTable::readBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		cfbam::CFBamInt32ColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> CFBamRamInt32ColTable::pageBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId,
	...
	cfbam::CFBamInt32ColBuff* CFBamRamInt32ColTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamInt32ColBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamInt32ColBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamInt32ColBuff*>( editCur ) );
	}

	cfbam::CFBamInt32ColBuff* CFBamRamInt32ColTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamInt32ColBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamInt32ColBuff* CFBamRamInt32ColTable::updateInt32Col( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt32ColBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in Int32Col for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamInt32ColBuff* existing = searchExisting->second;
		...
		cfbam::CFBamInt32ColByTableIdxKey existingKeyTableIdx;
		...
		cfbam::CFBamInt32ColByTableIdxKey newKeyTableIdx;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamInt32ColBuff*>( schema->getTableInt32Def()->updateInt32Def( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt32ColBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt32ColBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamInt32ColBuff*>* subdictTableIdx;
		...
		if( searchNewKeyDictByTableIdx != dictByTableIdx->end() ) {
			...
			dictByTableIdx->insert( std::map<cfbam::CFBamInt32ColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamInt32ColBuff*>*>::value_type( newKeyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt32ColBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamInt32ColBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamInt32ColBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamInt32ColBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamInt32ColTable::deleteInt32Col( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt32ColBuff* Buff )
	{
		static const std::string S_ProcName( "deleteInt32Col" );
	...
	void CFBamRamInt32ColTable::deleteInt32ColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamInt32ColBuff* cur = NULL;
		cfbam::CFBamInt32ColBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt32ColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt32ColBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamInt32ColBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamInt32ColBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamInt32ColTable::deleteInt32ColByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamInt32ColTable::deleteInt32ColByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamInt32ColTable::deleteInt32ColByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamInt32ColTable::deleteInt32ColByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamInt32ColTable::deleteInt32ColByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamInt32ColTable::deleteInt32ColByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamInt32ColTable::deleteInt32ColByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamInt32ColTable::deleteInt32ColByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamInt32ColTable::deleteInt32ColByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamInt32ColTable::releasePreparedStatements() {
	}
