...
// Description: C++18 Implementation for an in-memory RAM DbIO for NmTokensDef.
...
namespace cfbam {
	...
	const std::string CFBamRamNmTokensDefTable::CLASS_NAME( "CFBamRamNmTokensDefTable" );

	CFBamRamNmTokensDefTable::CFBamRamNmTokensDefTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamNmTokensDefTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokensDefBuff*>();
	}

	CFBamRamNmTokensDefTable::~CFBamRamNmTokensDefTable() {
		if( dictByPKey != NULL ) {
			delete dictByPKey;
			dictByPKey = NULL;
		}
	...
	cfbam::CFBamNmTokensDefBuff* CFBamRamNmTokensDefTable::createNmTokensDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNmTokensDefBuff* Buff )
	{
		...
		cfbam::CFBamNmTokensDefBuff* buff = dynamic_cast<cfbam::CFBamNmTokensDefBuff*>( schema->getTableAtom()->createAtom( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokensDefBuff*>::value_type( pkey, buff ) );

		// The top level code has to clone the final buffer. The one passed in is now part of the persistent storage.
		if( buff->getClassCode() == cfbam::CFBamNmTokensDefBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamNmTokensDefBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamNmTokensDefBuff* CFBamRamNmTokensDefTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamNmTokensDefBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamNmTokensDefBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamNmTokensDefBuff* CFBamRamNmTokensDefTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> CFBamRamNmTokensDefTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNmTokensDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNmTokensDefBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamNmTokensDefBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamNmTokensDefBuff*>( iter->second->clone() );
	...
	cfbam::CFBamNmTokensDefBuff* CFBamRamNmTokensDefTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamNmTokensDefBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamNmTokensDefBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> CFBamRamNmTokensDefTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamNmTokensDefBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamNmTokensDefBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> CFBamRamNmTokensDefTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> CFBamRamNmTokensDefTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> CFBamRamNmTokensDefTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> CFBamRamNmTokensDefTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> CFBamRamNmTokensDefTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> CFBamRamNmTokensDefTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	cfbam::CFBamNmTokensDefBuff* CFBamRamNmTokensDefTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamNmTokensDefBuff* CFBamRamNmTokensDefTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamNmTokensDefBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamNmTokensDefBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamNmTokensDefBuff* CFBamRamNmTokensDefTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamNmTokensDefBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamNmTokensDefBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> CFBamRamNmTokensDefTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamNmTokensDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamNmTokensDefBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamNmTokensDefBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamNmTokensDefBuff* CFBamRamNmTokensDefTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamNmTokensDefBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamNmTokensDefBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamNmTokensDefBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamNmTokensDefBuff* CFBamRamNmTokensDefTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamNmTokensDefBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> CFBamRamNmTokensDefTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamNmTokensDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> CFBamRamNmTokensDefTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamNmTokensDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> CFBamRamNmTokensDefTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamNmTokensDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> CFBamRamNmTokensDefTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamNmTokensDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> CFBamRamNmTokensDefTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamNmTokensDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> CFBamRamNmTokensDefTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamNmTokensDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> CFBamRamNmTokensDefTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamNmTokensDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	cfbam::CFBamNmTokensDefBuff* CFBamRamNmTokensDefTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamNmTokensDefBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamNmTokensDefBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamNmTokensDefBuff*>( editCur ) );
	}

	cfbam::CFBamNmTokensDefBuff* CFBamRamNmTokensDefTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamNmTokensDefBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamNmTokensDefBuff* CFBamRamNmTokensDefTable::updateNmTokensDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNmTokensDefBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in NmTokensDef for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamNmTokensDefBuff* existing = searchExisting->second;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamNmTokensDefBuff*>( schema->getTableAtom()->updateAtom( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokensDefBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokensDefBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamNmTokensDefBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamNmTokensDefBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamNmTokensDefBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamNmTokensDefTable::deleteNmTokensDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNmTokensDefBuff* Buff )
	{
		static const std::string S_ProcName( "deleteNmTokensDef" );
		...
		{
			cfbam::CFBamNmTokensTypeBuff* refIdIdx = dynamic_cast<cfbam::CFBamNmTokensTypeBuff*>( schema->getTableNmTokensType()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table NmTokensType for primary key " + pkey.toString() );
		...
		{
			cfbam::CFBamNmTokensColBuff* refIdIdx = dynamic_cast<cfbam::CFBamNmTokensColBuff*>( schema->getTableNmTokensCol()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table NmTokensCol for primary key " + pkey.toString() );
				throw cflib::CFLibDependentsDetectedException( CLASS_NAME,
					S_ProcName,
					Msg );
			}
	...
	void CFBamRamNmTokensDefTable::deleteNmTokensDefByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteNmTokensDefByIdIdx" );
		...
		cfbam::CFBamNmTokensDefBuff* cur = NULL;
		cfbam::CFBamNmTokensDefBuff* rereadCur = NULL;
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNmTokensDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNmTokensDefBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamValueBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamNmTokensDefBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamNmTokensDefBuff::CLASS_CODE ) {
	...
	void CFBamRamNmTokensDefTable::deleteNmTokensDefByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteNmTokensDefByUNameIdx" );
		cfbam::CFBamNmTokensDefBuff* cur = NULL;
		cfbam::CFBamNmTokensDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamNmTokensDefTable::deleteNmTokensDefByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteNmTokensDefByValTentIdx" );
		cfbam::CFBamNmTokensDefBuff* cur = NULL;
		cfbam::CFBamNmTokensDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamNmTokensDefTable::deleteNmTokensDefByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteNmTokensDefByScopeIdx" );
		cfbam::CFBamNmTokensDefBuff* cur = NULL;
		cfbam::CFBamNmTokensDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamNmTokensDefTable::deleteNmTokensDefByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteNmTokensDefByDefSchemaIdx" );
		cfbam::CFBamNmTokensDefBuff* cur = NULL;
		cfbam::CFBamNmTokensDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamNmTokensDefTable::deleteNmTokensDefByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteNmTokensDefByPrevIdx" );
		cfbam::CFBamNmTokensDefBuff* cur = NULL;
		cfbam::CFBamNmTokensDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamNmTokensDefTable::deleteNmTokensDefByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteNmTokensDefByNextIdx" );
		cfbam::CFBamNmTokensDefBuff* cur = NULL;
		cfbam::CFBamNmTokensDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamNmTokensDefTable::deleteNmTokensDefByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteNmTokensDefByContPrevIdx" );
		cfbam::CFBamNmTokensDefBuff* cur = NULL;
		cfbam::CFBamNmTokensDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamNmTokensDefTable::deleteNmTokensDefByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteNmTokensDefByContNextIdx" );
		cfbam::CFBamNmTokensDefBuff* cur = NULL;
		cfbam::CFBamNmTokensDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamNmTokensDefTable::releasePreparedStatements() {
	}
