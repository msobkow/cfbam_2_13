...
// Description: C++18 Implementation for an in-memory RAM DbIO for NumberCol.
...
namespace cfbam {
	...
	const std::string CFBamRamNumberColTable::CLASS_NAME( "CFBamRamNumberColTable" );

	CFBamRamNumberColTable::CFBamRamNumberColTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamNumberColTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamNumberColBuff*>();
		dictByTableIdx = new std::map<cfbam::CFBamNumberColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamNumberColBuff*>*>();
	}

	CFBamRamNumberColTable::~CFBamRamNumberColTable() {
	...
	cfbam::CFBamNumberColBuff* CFBamRamNumberColTable::createNumberCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNumberColBuff* Buff )
	{
		static const std::string S_ProcName( "createNumberCol" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamNumberColBuff::CLASS_CODE ) {
		...
		cfbam::CFBamNumberColBuff* buff = dynamic_cast<cfbam::CFBamNumberColBuff*>( schema->getTableNumberDef()->createNumberDef( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNumberColBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamNumberColBuff*>* subdictTableIdx;
		...
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			...
			subdictTableIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamNumberColBuff*>();
			dictByTableIdx->insert( std::map<cfbam::CFBamNumberColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamNumberColBuff*>*>::value_type( keyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNumberColBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamNumberColBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamNumberColBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamNumberColBuff* CFBamRamNumberColTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamNumberColBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamNumberColBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamNumberColBuff* CFBamRamNumberColTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> CFBamRamNumberColTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNumberColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNumberColBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamNumberColBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamNumberColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamNumberColBuff* CFBamRamNumberColTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamNumberColBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamNumberColBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> CFBamRamNumberColTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamNumberColBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamNumberColBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> CFBamRamNumberColTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> CFBamRamNumberColTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> CFBamRamNumberColTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> CFBamRamNumberColTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> CFBamRamNumberColTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> CFBamRamNumberColTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> CFBamRamNumberColTable::readDerivedByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> recVec;
		cfbam::CFBamNumberColBuff* clone;
		auto searchDictByTableIdx = dictByTableIdx->find( key );
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamNumberColBuff*>* subdictTableIdx = searchDictByTableIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamNumberColBuff*>::iterator iter = subdictTableIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamNumberColBuff*>::iterator end = subdictTableIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamNumberColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamNumberColBuff* CFBamRamNumberColTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamNumberColBuff* CFBamRamNumberColTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamNumberColBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamNumberColBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamNumberColBuff* CFBamRamNumberColTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamNumberColBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamNumberColBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> CFBamRamNumberColTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamNumberColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamNumberColBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamNumberColBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamNumberColBuff* CFBamRamNumberColTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamNumberColBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamNumberColBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamNumberColBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamNumberColBuff* CFBamRamNumberColTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamNumberColBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> CFBamRamNumberColTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamNumberColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> CFBamRamNumberColTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamNumberColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> CFBamRamNumberColTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamNumberColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> CFBamRamNumberColTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamNumberColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> CFBamRamNumberColTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamNumberColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> CFBamRamNumberColTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamNumberColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> CFBamRamNumberColTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamNumberColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> CFBamRamNumberColTable::readBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		cfbam::CFBamNumberColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> CFBamRamNumberColTable::pageBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId,
	...
	cfbam::CFBamNumberColBuff* CFBamRamNumberColTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamNumberColBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamNumberColBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamNumberColBuff*>( editCur ) );
	}

	cfbam::CFBamNumberColBuff* CFBamRamNumberColTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamNumberColBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamNumberColBuff* CFBamRamNumberColTable::updateNumberCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNumberColBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in NumberCol for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamNumberColBuff* existing = searchExisting->second;
		...
		cfbam::CFBamNumberColByTableIdxKey existingKeyTableIdx;
		...
		cfbam::CFBamNumberColByTableIdxKey newKeyTableIdx;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamNumberColBuff*>( schema->getTableNumberDef()->updateNumberDef( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamNumberColBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNumberColBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamNumberColBuff*>* subdictTableIdx;
		...
		if( searchNewKeyDictByTableIdx != dictByTableIdx->end() ) {
			...
			dictByTableIdx->insert( std::map<cfbam::CFBamNumberColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamNumberColBuff*>*>::value_type( newKeyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNumberColBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamNumberColBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamNumberColBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamNumberColBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamNumberColTable::deleteNumberCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNumberColBuff* Buff )
	{
		static const std::string S_ProcName( "deleteNumberCol" );
	...
	void CFBamRamNumberColTable::deleteNumberColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamNumberColBuff* cur = NULL;
		cfbam::CFBamNumberColBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNumberColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNumberColBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamNumberColBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamNumberColBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamNumberColBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamNumberColTable::deleteNumberColByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamNumberColTable::deleteNumberColByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamNumberColTable::deleteNumberColByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamNumberColTable::deleteNumberColByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamNumberColTable::deleteNumberColByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamNumberColTable::deleteNumberColByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamNumberColTable::deleteNumberColByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamNumberColTable::deleteNumberColByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamNumberColTable::deleteNumberColByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamNumberColTable::releasePreparedStatements() {
	}
