...
// Description: C++18 Implementation for an in-memory RAM DbIO for Int64Type.
...
namespace cfbam {
	...
	const std::string CFBamRamInt64TypeTable::CLASS_NAME( "CFBamRamInt64TypeTable" );

	CFBamRamInt64TypeTable::CFBamRamInt64TypeTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamInt64TypeTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt64TypeBuff*>();
		dictBySchemaIdx = new std::map<cfbam::CFBamInt64TypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamInt64TypeBuff*>*>();
	}

	CFBamRamInt64TypeTable::~CFBamRamInt64TypeTable() {
	...
	cfbam::CFBamInt64TypeBuff* CFBamRamInt64TypeTable::createInt64Type( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt64TypeBuff* Buff )
	{
		static const std::string S_ProcName( "createInt64Type" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamInt64TypeBuff::CLASS_CODE ) {
		...
		cfbam::CFBamInt64TypeBuff* buff = dynamic_cast<cfbam::CFBamInt64TypeBuff*>( schema->getTableInt64Def()->createInt64Def( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt64TypeBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt64TypeBuff*>* subdictSchemaIdx;
		...
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			subdictSchemaIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt64TypeBuff*>();
			dictBySchemaIdx->insert( std::map<cfbam::CFBamInt64TypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamInt64TypeBuff*>*>::value_type( keySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt64TypeBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamInt64TypeBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamInt64TypeBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamInt64TypeBuff* CFBamRamInt64TypeTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamInt64TypeBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamInt64TypeBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamInt64TypeBuff* CFBamRamInt64TypeTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> CFBamRamInt64TypeTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt64TypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt64TypeBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamInt64TypeBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamInt64TypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamInt64TypeBuff* CFBamRamInt64TypeTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamInt64TypeBuff::CLASS_CODE ) ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> CFBamRamInt64TypeTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamInt64TypeBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamInt64TypeBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> CFBamRamInt64TypeTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> CFBamRamInt64TypeTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> CFBamRamInt64TypeTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> CFBamRamInt64TypeTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> CFBamRamInt64TypeTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> CFBamRamInt64TypeTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> CFBamRamInt64TypeTable::readDerivedBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> recVec;
		cfbam::CFBamInt64TypeBuff* clone;
		auto searchDictBySchemaIdx = dictBySchemaIdx->find( key );
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamInt64TypeBuff*>* subdictSchemaIdx = searchDictBySchemaIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamInt64TypeBuff*>::iterator iter = subdictSchemaIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamInt64TypeBuff*>::iterator end = subdictSchemaIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamInt64TypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamInt64TypeBuff* CFBamRamInt64TypeTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamInt64TypeBuff* CFBamRamInt64TypeTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamInt64TypeBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamInt64TypeBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamInt64TypeBuff* CFBamRamInt64TypeTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamInt64TypeBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamInt64TypeBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> CFBamRamInt64TypeTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamInt64TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> buffList = readAllDerived( Authorization );
		...
		while( iterBuffList != endBuffList ) {
			...
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamInt64TypeBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamInt64TypeBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamInt64TypeBuff* CFBamRamInt64TypeTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamInt64TypeBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamInt64TypeBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamInt64TypeBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamInt64TypeBuff* CFBamRamInt64TypeTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamInt64TypeBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> CFBamRamInt64TypeTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamInt64TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> CFBamRamInt64TypeTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamInt64TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> CFBamRamInt64TypeTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamInt64TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> CFBamRamInt64TypeTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamInt64TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> CFBamRamInt64TypeTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamInt64TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> CFBamRamInt64TypeTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamInt64TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> CFBamRamInt64TypeTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamInt64TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> CFBamRamInt64TypeTable::readBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		cfbam::CFBamInt64TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> CFBamRamInt64TypeTable::pageBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId,
	...
	cfbam::CFBamInt64TypeBuff* CFBamRamInt64TypeTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamInt64TypeBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamInt64TypeBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamInt64TypeBuff*>( editCur ) );
	}

	cfbam::CFBamInt64TypeBuff* CFBamRamInt64TypeTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamInt64TypeBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamInt64TypeBuff* CFBamRamInt64TypeTable::updateInt64Type( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt64TypeBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in Int64Type for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamInt64TypeBuff* existing = searchExisting->second;
		...
		cfbam::CFBamInt64TypeBySchemaIdxKey existingKeySchemaIdx;
		...
		cfbam::CFBamInt64TypeBySchemaIdxKey newKeySchemaIdx;
...

		{
			...
			if( allNull ) {
				cfbam::CFBamInt64DefBuff* chk = dynamic_cast<cfbam::CFBamInt64DefBuff*>( schema->getTableInt64Def()->readDerivedByIdIdx( Authorization,
						Buff->getRequiredTenantId(),
						Buff->getRequiredId() ) );
				if( chk == NULL ) {
					delete Buff;
					std::string Msg( "Could not resolve Superclass relationship SuperClass to table Int64Def" );
					throw cflib::CFLibUnresolvedRelationException( CLASS_NAME,
						S_ProcName,
						Msg );
				}
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamInt64TypeBuff*>( schema->getTableInt64Def()->updateInt64Def( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt64TypeBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt64TypeBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamInt64TypeBuff*>* subdictSchemaIdx;
		...
		if( searchNewKeyDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			dictBySchemaIdx->insert( std::map<cfbam::CFBamInt64TypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamInt64TypeBuff*>*>::value_type( newKeySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt64TypeBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamInt64TypeBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamInt64TypeBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamInt64TypeBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamInt64TypeTable::deleteInt64Type( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt64TypeBuff* Buff )
	{
		static const std::string S_ProcName( "deleteInt64Type" );
		...
		{
			cfbam::CFBamId64GenBuff* refIdIdx = dynamic_cast<cfbam::CFBamId64GenBuff*>( schema->getTableId64Gen()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table Id64Gen for primary key " + pkey.toString() );
	...
	void CFBamRamInt64TypeTable::deleteInt64TypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt64TypeBySchemaIdx" );
		cfbam::CFBamInt64TypeBuff* cur = NULL;
		cfbam::CFBamInt64TypeBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt64TypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt64TypeBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamInt64TypeBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamInt64TypeBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamInt64TypeBuff::CLASS_CODE ) {
	...
	void CFBamRamInt64TypeTable::deleteInt64TypeByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	{
		static const std::string S_ProcName( "deleteInt64TypeByIdIdx" );
		bool anyNotNull = false;
		anyNotNull = true;
		anyNotNull = true;
		if( ! anyNotNull ) {
	...
	void CFBamRamInt64TypeTable::deleteInt64TypeByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteInt64TypeByUNameIdx" );
		cfbam::CFBamInt64TypeBuff* cur = NULL;
		cfbam::CFBamInt64TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt64TypeTable::deleteInt64TypeByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt64TypeByValTentIdx" );
		cfbam::CFBamInt64TypeBuff* cur = NULL;
		cfbam::CFBamInt64TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt64TypeTable::deleteInt64TypeByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt64TypeByScopeIdx" );
		cfbam::CFBamInt64TypeBuff* cur = NULL;
		cfbam::CFBamInt64TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt64TypeTable::deleteInt64TypeByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt64TypeByDefSchemaIdx" );
		cfbam::CFBamInt64TypeBuff* cur = NULL;
		cfbam::CFBamInt64TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamInt64TypeTable::deleteInt64TypeByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt64TypeByPrevIdx" );
		cfbam::CFBamInt64TypeBuff* cur = NULL;
		cfbam::CFBamInt64TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamInt64TypeTable::deleteInt64TypeByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt64TypeByNextIdx" );
		cfbam::CFBamInt64TypeBuff* cur = NULL;
		cfbam::CFBamInt64TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamInt64TypeTable::deleteInt64TypeByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt64TypeByContPrevIdx" );
		cfbam::CFBamInt64TypeBuff* cur = NULL;
		cfbam::CFBamInt64TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt64TypeTable::deleteInt64TypeByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt64TypeByContNextIdx" );
		cfbam::CFBamInt64TypeBuff* cur = NULL;
		cfbam::CFBamInt64TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt64TypeTable::releasePreparedStatements() {
	}
