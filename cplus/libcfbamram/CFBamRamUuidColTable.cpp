...
// Description: C++18 Implementation for an in-memory RAM DbIO for UuidCol.
...
namespace cfbam {
	...
	const std::string CFBamRamUuidColTable::CLASS_NAME( "CFBamRamUuidColTable" );

	CFBamRamUuidColTable::CFBamRamUuidColTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamUuidColTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidColBuff*>();
		dictByTableIdx = new std::map<cfbam::CFBamUuidColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamUuidColBuff*>*>();
	}

	CFBamRamUuidColTable::~CFBamRamUuidColTable() {
	...
	cfbam::CFBamUuidColBuff* CFBamRamUuidColTable::createUuidCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUuidColBuff* Buff )
	{
		static const std::string S_ProcName( "createUuidCol" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamUuidColBuff::CLASS_CODE ) {
		...
		cfbam::CFBamUuidColBuff* buff = dynamic_cast<cfbam::CFBamUuidColBuff*>( schema->getTableUuidDef()->createUuidDef( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidColBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidColBuff*>* subdictTableIdx;
		...
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			...
			subdictTableIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidColBuff*>();
			dictByTableIdx->insert( std::map<cfbam::CFBamUuidColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamUuidColBuff*>*>::value_type( keyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidColBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamUuidColBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamUuidColBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamUuidColBuff* CFBamRamUuidColTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamUuidColBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamUuidColBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamUuidColBuff* CFBamRamUuidColTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> CFBamRamUuidColTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUuidColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUuidColBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamUuidColBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamUuidColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamUuidColBuff* CFBamRamUuidColTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamUuidColBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamUuidColBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> CFBamRamUuidColTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamUuidColBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamUuidColBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> CFBamRamUuidColTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> CFBamRamUuidColTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> CFBamRamUuidColTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> CFBamRamUuidColTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> CFBamRamUuidColTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> CFBamRamUuidColTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> CFBamRamUuidColTable::readDerivedByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> recVec;
		cfbam::CFBamUuidColBuff* clone;
		auto searchDictByTableIdx = dictByTableIdx->find( key );
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamUuidColBuff*>* subdictTableIdx = searchDictByTableIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamUuidColBuff*>::iterator iter = subdictTableIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamUuidColBuff*>::iterator end = subdictTableIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamUuidColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamUuidColBuff* CFBamRamUuidColTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamUuidColBuff* CFBamRamUuidColTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamUuidColBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamUuidColBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamUuidColBuff* CFBamRamUuidColTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamUuidColBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamUuidColBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> CFBamRamUuidColTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamUuidColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamUuidColBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamUuidColBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamUuidColBuff* CFBamRamUuidColTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamUuidColBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamUuidColBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamUuidColBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamUuidColBuff* CFBamRamUuidColTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamUuidColBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> CFBamRamUuidColTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamUuidColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> CFBamRamUuidColTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamUuidColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> CFBamRamUuidColTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamUuidColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> CFBamRamUuidColTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamUuidColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> CFBamRamUuidColTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamUuidColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> CFBamRamUuidColTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamUuidColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> CFBamRamUuidColTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamUuidColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> CFBamRamUuidColTable::readBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		cfbam::CFBamUuidColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> CFBamRamUuidColTable::pageBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId,
	...
	cfbam::CFBamUuidColBuff* CFBamRamUuidColTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamUuidColBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamUuidColBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamUuidColBuff*>( editCur ) );
	}

	cfbam::CFBamUuidColBuff* CFBamRamUuidColTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamUuidColBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamUuidColBuff* CFBamRamUuidColTable::updateUuidCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUuidColBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in UuidCol for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamUuidColBuff* existing = searchExisting->second;
		...
		cfbam::CFBamUuidColByTableIdxKey existingKeyTableIdx;
		...
		cfbam::CFBamUuidColByTableIdxKey newKeyTableIdx;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamUuidColBuff*>( schema->getTableUuidDef()->updateUuidDef( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidColBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidColBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamUuidColBuff*>* subdictTableIdx;
		...
		if( searchNewKeyDictByTableIdx != dictByTableIdx->end() ) {
			...
			dictByTableIdx->insert( std::map<cfbam::CFBamUuidColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamUuidColBuff*>*>::value_type( newKeyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidColBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamUuidColBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamUuidColBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamUuidColBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamUuidColTable::deleteUuidCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUuidColBuff* Buff )
	{
		static const std::string S_ProcName( "deleteUuidCol" );
	...
	void CFBamRamUuidColTable::deleteUuidColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamUuidColBuff* cur = NULL;
		cfbam::CFBamUuidColBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUuidColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUuidColBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamUuidColBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamUuidColBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamUuidColTable::deleteUuidColByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamUuidColTable::deleteUuidColByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamUuidColTable::deleteUuidColByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamUuidColTable::deleteUuidColByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamUuidColTable::deleteUuidColByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamUuidColTable::deleteUuidColByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamUuidColTable::deleteUuidColByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamUuidColTable::deleteUuidColByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamUuidColTable::deleteUuidColByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamUuidColTable::releasePreparedStatements() {
	}
