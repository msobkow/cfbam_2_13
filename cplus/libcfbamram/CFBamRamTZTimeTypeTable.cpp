...
// Description: C++18 Implementation for an in-memory RAM DbIO for TZTimeType.
...
namespace cfbam {
	...
	const std::string CFBamRamTZTimeTypeTable::CLASS_NAME( "CFBamRamTZTimeTypeTable" );

	CFBamRamTZTimeTypeTable::CFBamRamTZTimeTypeTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamTZTimeTypeTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimeTypeBuff*>();
		dictBySchemaIdx = new std::map<cfbam::CFBamTZTimeTypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTZTimeTypeBuff*>*>();
	}

	CFBamRamTZTimeTypeTable::~CFBamRamTZTimeTypeTable() {
	...
	cfbam::CFBamTZTimeTypeBuff* CFBamRamTZTimeTypeTable::createTZTimeType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTZTimeTypeBuff* Buff )
	{
		static const std::string S_ProcName( "createTZTimeType" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamTZTimeTypeBuff::CLASS_CODE ) {
		...
		cfbam::CFBamTZTimeTypeBuff* buff = dynamic_cast<cfbam::CFBamTZTimeTypeBuff*>( schema->getTableTZTimeDef()->createTZTimeDef( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimeTypeBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimeTypeBuff*>* subdictSchemaIdx;
		...
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			subdictSchemaIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimeTypeBuff*>();
			dictBySchemaIdx->insert( std::map<cfbam::CFBamTZTimeTypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamTZTimeTypeBuff*>*>::value_type( keySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimeTypeBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamTZTimeTypeBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamTZTimeTypeBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamTZTimeTypeBuff* CFBamRamTZTimeTypeTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamTZTimeTypeBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamTZTimeTypeBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamTZTimeTypeBuff* CFBamRamTZTimeTypeTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> CFBamRamTZTimeTypeTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZTimeTypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZTimeTypeBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamTZTimeTypeBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamTZTimeTypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTZTimeTypeBuff* CFBamRamTZTimeTypeTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamTZTimeTypeBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamTZTimeTypeBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> CFBamRamTZTimeTypeTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamTZTimeTypeBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamTZTimeTypeBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> CFBamRamTZTimeTypeTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> CFBamRamTZTimeTypeTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> CFBamRamTZTimeTypeTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> CFBamRamTZTimeTypeTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> CFBamRamTZTimeTypeTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> CFBamRamTZTimeTypeTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> CFBamRamTZTimeTypeTable::readDerivedBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> recVec;
		cfbam::CFBamTZTimeTypeBuff* clone;
		auto searchDictBySchemaIdx = dictBySchemaIdx->find( key );
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamTZTimeTypeBuff*>* subdictSchemaIdx = searchDictBySchemaIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTZTimeTypeBuff*>::iterator iter = subdictSchemaIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTZTimeTypeBuff*>::iterator end = subdictSchemaIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamTZTimeTypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTZTimeTypeBuff* CFBamRamTZTimeTypeTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamTZTimeTypeBuff* CFBamRamTZTimeTypeTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamTZTimeTypeBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamTZTimeTypeBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamTZTimeTypeBuff* CFBamRamTZTimeTypeTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamTZTimeTypeBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamTZTimeTypeBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> CFBamRamTZTimeTypeTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamTZTimeTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamTZTimeTypeBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamTZTimeTypeBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamTZTimeTypeBuff* CFBamRamTZTimeTypeTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamTZTimeTypeBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamTZTimeTypeBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamTZTimeTypeBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamTZTimeTypeBuff* CFBamRamTZTimeTypeTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamTZTimeTypeBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> CFBamRamTZTimeTypeTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamTZTimeTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> CFBamRamTZTimeTypeTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamTZTimeTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> CFBamRamTZTimeTypeTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamTZTimeTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> CFBamRamTZTimeTypeTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTZTimeTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> CFBamRamTZTimeTypeTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTZTimeTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> CFBamRamTZTimeTypeTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTZTimeTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> CFBamRamTZTimeTypeTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTZTimeTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> CFBamRamTZTimeTypeTable::readBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		cfbam::CFBamTZTimeTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> CFBamRamTZTimeTypeTable::pageBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId,
	...
	cfbam::CFBamTZTimeTypeBuff* CFBamRamTZTimeTypeTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamTZTimeTypeBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTZTimeTypeBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamTZTimeTypeBuff*>( editCur ) );
	}

	cfbam::CFBamTZTimeTypeBuff* CFBamRamTZTimeTypeTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTZTimeTypeBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamTZTimeTypeBuff* CFBamRamTZTimeTypeTable::updateTZTimeType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTZTimeTypeBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in TZTimeType for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamTZTimeTypeBuff* existing = searchExisting->second;
		...
		cfbam::CFBamTZTimeTypeBySchemaIdxKey existingKeySchemaIdx;
		...
		cfbam::CFBamTZTimeTypeBySchemaIdxKey newKeySchemaIdx;
...

		{
			...
			if( allNull ) {
				cfbam::CFBamTZTimeDefBuff* chk = dynamic_cast<cfbam::CFBamTZTimeDefBuff*>( schema->getTableTZTimeDef()->readDerivedByIdIdx( Authorization,
						Buff->getRequiredTenantId(),
						Buff->getRequiredId() ) );
				if( chk == NULL ) {
					delete Buff;
					std::string Msg( "Could not resolve Superclass relationship SuperClass to table TZTimeDef" );
					throw cflib::CFLibUnresolvedRelationException( CLASS_NAME,
						S_ProcName,
						Msg );
				}
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamTZTimeTypeBuff*>( schema->getTableTZTimeDef()->updateTZTimeDef( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimeTypeBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimeTypeBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamTZTimeTypeBuff*>* subdictSchemaIdx;
		...
		if( searchNewKeyDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			dictBySchemaIdx->insert( std::map<cfbam::CFBamTZTimeTypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamTZTimeTypeBuff*>*>::value_type( newKeySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZTimeTypeBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamTZTimeTypeBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamTZTimeTypeBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamTZTimeTypeBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamTZTimeTypeTable::deleteTZTimeType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTZTimeTypeBuff* Buff )
	{
		static const std::string S_ProcName( "deleteTZTimeType" );
	...
	void CFBamRamTZTimeTypeTable::deleteTZTimeTypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamTZTimeTypeBuff* cur = NULL;
		cfbam::CFBamTZTimeTypeBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZTimeTypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZTimeTypeBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamTZTimeTypeBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamTZTimeTypeBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZTimeTypeBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamTZTimeTypeTable::deleteTZTimeTypeByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamTZTimeTypeTable::deleteTZTimeTypeByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamTZTimeTypeTable::deleteTZTimeTypeByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamTZTimeTypeTable::deleteTZTimeTypeByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamTZTimeTypeTable::deleteTZTimeTypeByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTZTimeTypeTable::deleteTZTimeTypeByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTZTimeTypeTable::deleteTZTimeTypeByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTZTimeTypeTable::deleteTZTimeTypeByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamTZTimeTypeTable::deleteTZTimeTypeByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamTZTimeTypeTable::releasePreparedStatements() {
	}
