...
namespace cfbam {
	...
	const std::string CFBamRamISOCtryLangTable::CLASS_NAME( "CFBamRamISOCtryLangTable" );

	CFBamRamISOCtryLangTable::CFBamRamISOCtryLangTable( ICFBamSchema* argSchema )
	...
	CFBamRamISOCtryLangTable::~CFBamRamISOCtryLangTable() {
	...
	cfsec::CFSecISOCtryLangBuff* CFBamRamISOCtryLangTable::createISOCtryLang( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecISOCtryLangBuff* CFBamRamISOCtryLangTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecISOCtryLangBuff* CFBamRamISOCtryLangTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecISOCtryLangPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecISOCtryLangBuff*> CFBamRamISOCtryLangTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
	...
	std::TCFLibOwningVector<cfsec::CFSecISOCtryLangBuff*> CFBamRamISOCtryLangTable::readDerivedByCtryIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfsec::CFSecISOCtryLangBuff*> CFBamRamISOCtryLangTable::readDerivedByLangIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecISOCtryLangBuff* CFBamRamISOCtryLangTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int16_t ISOCtryId,
			const int16_t ISOLangId )
	{
	...
	cfsec::CFSecISOCtryLangBuff* CFBamRamISOCtryLangTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecISOCtryLangPKey* PKey )
	{
	...
	cfsec::CFSecISOCtryLangBuff* CFBamRamISOCtryLangTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecISOCtryLangPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecISOCtryLangBuff*> CFBamRamISOCtryLangTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
	...
	cfsec::CFSecISOCtryLangBuff* CFBamRamISOCtryLangTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int16_t ISOCtryId,
			const int16_t ISOLangId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecISOCtryLangBuff*> CFBamRamISOCtryLangTable::readBuffByCtryIdx( const cfsec::CFSecAuthorization* Authorization,
			const int16_t ISOCtryId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecISOCtryLangBuff*> CFBamRamISOCtryLangTable::readBuffByLangIdx( const cfsec::CFSecAuthorization* Authorization,
			const int16_t ISOLangId )
	{
	...
	cfsec::CFSecISOCtryLangBuff* CFBamRamISOCtryLangTable::updateISOCtryLang( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecISOCtryLangBuff* Buff )
	{
	...
	void CFBamRamISOCtryLangTable::deleteISOCtryLang( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecISOCtryLangBuff* Buff )
	{
	...
	void CFBamRamISOCtryLangTable::deleteISOCtryLangByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamISOCtryLangTable::deleteISOCtryLangByCtryIdx( const cfsec::CFSecAuthorization* Authorization,
			const int16_t argISOCtryId )
	{
		cfsec::CFSecISOCtryLangByCtryIdxKey key;
		key.setRequiredISOCtryId( argISOCtryId );
	...
	void CFBamRamISOCtryLangTable::deleteISOCtryLangByLangIdx( const cfsec::CFSecAuthorization* Authorization,
			const int16_t argISOLangId )
	{
		cfsec::CFSecISOCtryLangByLangIdxKey key;
		key.setRequiredISOLangId( argISOLangId );
	...
	void CFBamRamISOCtryLangTable::releasePreparedStatements() {
	}
