...
// Description: C++18 Implementation for an in-memory RAM DbIO for UInt32Type.
...
namespace cfbam {
	...
	const std::string CFBamRamUInt32TypeTable::CLASS_NAME( "CFBamRamUInt32TypeTable" );

	CFBamRamUInt32TypeTable::CFBamRamUInt32TypeTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamUInt32TypeTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt32TypeBuff*>();
		dictBySchemaIdx = new std::map<cfbam::CFBamUInt32TypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamUInt32TypeBuff*>*>();
	}

	CFBamRamUInt32TypeTable::~CFBamRamUInt32TypeTable() {
	...
	cfbam::CFBamUInt32TypeBuff* CFBamRamUInt32TypeTable::createUInt32Type( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUInt32TypeBuff* Buff )
	{
		static const std::string S_ProcName( "createUInt32Type" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamUInt32TypeBuff::CLASS_CODE ) {
		...
		cfbam::CFBamUInt32TypeBuff* buff = dynamic_cast<cfbam::CFBamUInt32TypeBuff*>( schema->getTableUInt32Def()->createUInt32Def( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt32TypeBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt32TypeBuff*>* subdictSchemaIdx;
		...
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			subdictSchemaIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt32TypeBuff*>();
			dictBySchemaIdx->insert( std::map<cfbam::CFBamUInt32TypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamUInt32TypeBuff*>*>::value_type( keySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt32TypeBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamUInt32TypeBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamUInt32TypeBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamUInt32TypeBuff* CFBamRamUInt32TypeTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamUInt32TypeBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamUInt32TypeBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamUInt32TypeBuff* CFBamRamUInt32TypeTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> CFBamRamUInt32TypeTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUInt32TypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUInt32TypeBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamUInt32TypeBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamUInt32TypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamUInt32TypeBuff* CFBamRamUInt32TypeTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamUInt32TypeBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamUInt32TypeBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> CFBamRamUInt32TypeTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamUInt32TypeBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamUInt32TypeBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> CFBamRamUInt32TypeTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> CFBamRamUInt32TypeTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> CFBamRamUInt32TypeTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> CFBamRamUInt32TypeTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> CFBamRamUInt32TypeTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> CFBamRamUInt32TypeTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> CFBamRamUInt32TypeTable::readDerivedBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> recVec;
		cfbam::CFBamUInt32TypeBuff* clone;
		auto searchDictBySchemaIdx = dictBySchemaIdx->find( key );
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamUInt32TypeBuff*>* subdictSchemaIdx = searchDictBySchemaIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamUInt32TypeBuff*>::iterator iter = subdictSchemaIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamUInt32TypeBuff*>::iterator end = subdictSchemaIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamUInt32TypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamUInt32TypeBuff* CFBamRamUInt32TypeTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamUInt32TypeBuff* CFBamRamUInt32TypeTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamUInt32TypeBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamUInt32TypeBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamUInt32TypeBuff* CFBamRamUInt32TypeTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamUInt32TypeBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamUInt32TypeBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> CFBamRamUInt32TypeTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamUInt32TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamUInt32TypeBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamUInt32TypeBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamUInt32TypeBuff* CFBamRamUInt32TypeTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamUInt32TypeBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamUInt32TypeBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamUInt32TypeBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamUInt32TypeBuff* CFBamRamUInt32TypeTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamUInt32TypeBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> CFBamRamUInt32TypeTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamUInt32TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> CFBamRamUInt32TypeTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamUInt32TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> CFBamRamUInt32TypeTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamUInt32TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> CFBamRamUInt32TypeTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamUInt32TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> CFBamRamUInt32TypeTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamUInt32TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> CFBamRamUInt32TypeTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamUInt32TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> CFBamRamUInt32TypeTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamUInt32TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> CFBamRamUInt32TypeTable::readBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		cfbam::CFBamUInt32TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> CFBamRamUInt32TypeTable::pageBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId,
	...
	cfbam::CFBamUInt32TypeBuff* CFBamRamUInt32TypeTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamUInt32TypeBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamUInt32TypeBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamUInt32TypeBuff*>( editCur ) );
	}

	cfbam::CFBamUInt32TypeBuff* CFBamRamUInt32TypeTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamUInt32TypeBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamUInt32TypeBuff* CFBamRamUInt32TypeTable::updateUInt32Type( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUInt32TypeBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in UInt32Type for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamUInt32TypeBuff* existing = searchExisting->second;
		...
		cfbam::CFBamUInt32TypeBySchemaIdxKey existingKeySchemaIdx;
		...
		cfbam::CFBamUInt32TypeBySchemaIdxKey newKeySchemaIdx;
...

		{
			...
			if( allNull ) {
				cfbam::CFBamUInt32DefBuff* chk = dynamic_cast<cfbam::CFBamUInt32DefBuff*>( schema->getTableUInt32Def()->readDerivedByIdIdx( Authorization,
						Buff->getRequiredTenantId(),
						Buff->getRequiredId() ) );
				if( chk == NULL ) {
					delete Buff;
					std::string Msg( "Could not resolve Superclass relationship SuperClass to table UInt32Def" );
					throw cflib::CFLibUnresolvedRelationException( CLASS_NAME,
						S_ProcName,
						Msg );
				}
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamUInt32TypeBuff*>( schema->getTableUInt32Def()->updateUInt32Def( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt32TypeBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt32TypeBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamUInt32TypeBuff*>* subdictSchemaIdx;
		...
		if( searchNewKeyDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			dictBySchemaIdx->insert( std::map<cfbam::CFBamUInt32TypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamUInt32TypeBuff*>*>::value_type( newKeySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUInt32TypeBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamUInt32TypeBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamUInt32TypeBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamUInt32TypeBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamUInt32TypeTable::deleteUInt32Type( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUInt32TypeBuff* Buff )
	{
		static const std::string S_ProcName( "deleteUInt32Type" );
	...
	void CFBamRamUInt32TypeTable::deleteUInt32TypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamUInt32TypeBuff* cur = NULL;
		cfbam::CFBamUInt32TypeBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUInt32TypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUInt32TypeBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamUInt32TypeBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamUInt32TypeBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamUInt32TypeTable::deleteUInt32TypeByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamUInt32TypeTable::deleteUInt32TypeByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamUInt32TypeTable::deleteUInt32TypeByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamUInt32TypeTable::deleteUInt32TypeByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamUInt32TypeTable::deleteUInt32TypeByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamUInt32TypeTable::deleteUInt32TypeByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamUInt32TypeTable::deleteUInt32TypeByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamUInt32TypeTable::deleteUInt32TypeByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamUInt32TypeTable::deleteUInt32TypeByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamUInt32TypeTable::releasePreparedStatements() {
	}
