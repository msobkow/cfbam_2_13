...
// Description: C++18 Implementation for an in-memory RAM DbIO for NmTokenDef.
...
namespace cfbam {
	...
	const std::string CFBamRamNmTokenDefTable::CLASS_NAME( "CFBamRamNmTokenDefTable" );

	CFBamRamNmTokenDefTable::CFBamRamNmTokenDefTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamNmTokenDefTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokenDefBuff*>();
	}

	CFBamRamNmTokenDefTable::~CFBamRamNmTokenDefTable() {
		if( dictByPKey != NULL ) {
			delete dictByPKey;
			dictByPKey = NULL;
		}
	...
	cfbam::CFBamNmTokenDefBuff* CFBamRamNmTokenDefTable::createNmTokenDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNmTokenDefBuff* Buff )
	{
		...
		cfbam::CFBamNmTokenDefBuff* buff = dynamic_cast<cfbam::CFBamNmTokenDefBuff*>( schema->getTableAtom()->createAtom( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokenDefBuff*>::value_type( pkey, buff ) );

		// The top level code has to clone the final buffer. The one passed in is now part of the persistent storage.
		if( buff->getClassCode() == cfbam::CFBamNmTokenDefBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamNmTokenDefBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamNmTokenDefBuff* CFBamRamNmTokenDefTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamNmTokenDefBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamNmTokenDefBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamNmTokenDefBuff* CFBamRamNmTokenDefTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> CFBamRamNmTokenDefTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNmTokenDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNmTokenDefBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamNmTokenDefBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamNmTokenDefBuff*>( iter->second->clone() );
	...
	cfbam::CFBamNmTokenDefBuff* CFBamRamNmTokenDefTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamNmTokenDefBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamNmTokenDefBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> CFBamRamNmTokenDefTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamNmTokenDefBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamNmTokenDefBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> CFBamRamNmTokenDefTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> CFBamRamNmTokenDefTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> CFBamRamNmTokenDefTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> CFBamRamNmTokenDefTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> CFBamRamNmTokenDefTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> CFBamRamNmTokenDefTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	cfbam::CFBamNmTokenDefBuff* CFBamRamNmTokenDefTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamNmTokenDefBuff* CFBamRamNmTokenDefTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamNmTokenDefBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamNmTokenDefBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamNmTokenDefBuff* CFBamRamNmTokenDefTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamNmTokenDefBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamNmTokenDefBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> CFBamRamNmTokenDefTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamNmTokenDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamNmTokenDefBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamNmTokenDefBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamNmTokenDefBuff* CFBamRamNmTokenDefTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamNmTokenDefBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamNmTokenDefBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamNmTokenDefBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamNmTokenDefBuff* CFBamRamNmTokenDefTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamNmTokenDefBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> CFBamRamNmTokenDefTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamNmTokenDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> CFBamRamNmTokenDefTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamNmTokenDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> CFBamRamNmTokenDefTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamNmTokenDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> CFBamRamNmTokenDefTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamNmTokenDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> CFBamRamNmTokenDefTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamNmTokenDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> CFBamRamNmTokenDefTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamNmTokenDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> CFBamRamNmTokenDefTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamNmTokenDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	cfbam::CFBamNmTokenDefBuff* CFBamRamNmTokenDefTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamNmTokenDefBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamNmTokenDefBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamNmTokenDefBuff*>( editCur ) );
	}

	cfbam::CFBamNmTokenDefBuff* CFBamRamNmTokenDefTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamNmTokenDefBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamNmTokenDefBuff* CFBamRamNmTokenDefTable::updateNmTokenDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNmTokenDefBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in NmTokenDef for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamNmTokenDefBuff* existing = searchExisting->second;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamNmTokenDefBuff*>( schema->getTableAtom()->updateAtom( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokenDefBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamNmTokenDefBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamNmTokenDefBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamNmTokenDefBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamNmTokenDefBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamNmTokenDefTable::deleteNmTokenDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamNmTokenDefBuff* Buff )
	{
		static const std::string S_ProcName( "deleteNmTokenDef" );
		...
		{
			cfbam::CFBamNmTokenTypeBuff* refIdIdx = dynamic_cast<cfbam::CFBamNmTokenTypeBuff*>( schema->getTableNmTokenType()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table NmTokenType for primary key " + pkey.toString() );
		...
		{
			cfbam::CFBamNmTokenColBuff* refIdIdx = dynamic_cast<cfbam::CFBamNmTokenColBuff*>( schema->getTableNmTokenCol()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table NmTokenCol for primary key " + pkey.toString() );
				throw cflib::CFLibDependentsDetectedException( CLASS_NAME,
					S_ProcName,
					Msg );
			}
	...
	void CFBamRamNmTokenDefTable::deleteNmTokenDefByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteNmTokenDefByIdIdx" );
		...
		cfbam::CFBamNmTokenDefBuff* cur = NULL;
		cfbam::CFBamNmTokenDefBuff* rereadCur = NULL;
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNmTokenDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamNmTokenDefBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamValueBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamNmTokenDefBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamNmTokenDefBuff::CLASS_CODE ) {
	...
	void CFBamRamNmTokenDefTable::deleteNmTokenDefByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteNmTokenDefByUNameIdx" );
		cfbam::CFBamNmTokenDefBuff* cur = NULL;
		cfbam::CFBamNmTokenDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamNmTokenDefTable::deleteNmTokenDefByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteNmTokenDefByValTentIdx" );
		cfbam::CFBamNmTokenDefBuff* cur = NULL;
		cfbam::CFBamNmTokenDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamNmTokenDefTable::deleteNmTokenDefByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteNmTokenDefByScopeIdx" );
		cfbam::CFBamNmTokenDefBuff* cur = NULL;
		cfbam::CFBamNmTokenDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamNmTokenDefTable::deleteNmTokenDefByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteNmTokenDefByDefSchemaIdx" );
		cfbam::CFBamNmTokenDefBuff* cur = NULL;
		cfbam::CFBamNmTokenDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamNmTokenDefTable::deleteNmTokenDefByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteNmTokenDefByPrevIdx" );
		cfbam::CFBamNmTokenDefBuff* cur = NULL;
		cfbam::CFBamNmTokenDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamNmTokenDefTable::deleteNmTokenDefByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteNmTokenDefByNextIdx" );
		cfbam::CFBamNmTokenDefBuff* cur = NULL;
		cfbam::CFBamNmTokenDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamNmTokenDefTable::deleteNmTokenDefByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteNmTokenDefByContPrevIdx" );
		cfbam::CFBamNmTokenDefBuff* cur = NULL;
		cfbam::CFBamNmTokenDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamNmTokenDefTable::deleteNmTokenDefByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteNmTokenDefByContNextIdx" );
		cfbam::CFBamNmTokenDefBuff* cur = NULL;
		cfbam::CFBamNmTokenDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamNmTokenDefTable::releasePreparedStatements() {
	}
