...
// Description: C++18 Implementation for an in-memory RAM DbIO for TimestampType.
...
namespace cfbam {
	...
	const std::string CFBamRamTimestampTypeTable::CLASS_NAME( "CFBamRamTimestampTypeTable" );

	CFBamRamTimestampTypeTable::CFBamRamTimestampTypeTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamTimestampTypeTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimestampTypeBuff*>();
		dictBySchemaIdx = new std::map<cfbam::CFBamTimestampTypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTimestampTypeBuff*>*>();
	}

	CFBamRamTimestampTypeTable::~CFBamRamTimestampTypeTable() {
	...
	cfbam::CFBamTimestampTypeBuff* CFBamRamTimestampTypeTable::createTimestampType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTimestampTypeBuff* Buff )
	{
		static const std::string S_ProcName( "createTimestampType" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamTimestampTypeBuff::CLASS_CODE ) {
		...
		cfbam::CFBamTimestampTypeBuff* buff = dynamic_cast<cfbam::CFBamTimestampTypeBuff*>( schema->getTableTimestampDef()->createTimestampDef( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimestampTypeBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimestampTypeBuff*>* subdictSchemaIdx;
		...
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			subdictSchemaIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimestampTypeBuff*>();
			dictBySchemaIdx->insert( std::map<cfbam::CFBamTimestampTypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamTimestampTypeBuff*>*>::value_type( keySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimestampTypeBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamTimestampTypeBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamTimestampTypeBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamTimestampTypeBuff* CFBamRamTimestampTypeTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamTimestampTypeBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamTimestampTypeBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamTimestampTypeBuff* CFBamRamTimestampTypeTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> CFBamRamTimestampTypeTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTimestampTypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTimestampTypeBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamTimestampTypeBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamTimestampTypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTimestampTypeBuff* CFBamRamTimestampTypeTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamTimestampTypeBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamTimestampTypeBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> CFBamRamTimestampTypeTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamTimestampTypeBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamTimestampTypeBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> CFBamRamTimestampTypeTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> CFBamRamTimestampTypeTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> CFBamRamTimestampTypeTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> CFBamRamTimestampTypeTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> CFBamRamTimestampTypeTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> CFBamRamTimestampTypeTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> CFBamRamTimestampTypeTable::readDerivedBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> recVec;
		cfbam::CFBamTimestampTypeBuff* clone;
		auto searchDictBySchemaIdx = dictBySchemaIdx->find( key );
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamTimestampTypeBuff*>* subdictSchemaIdx = searchDictBySchemaIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTimestampTypeBuff*>::iterator iter = subdictSchemaIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamTimestampTypeBuff*>::iterator end = subdictSchemaIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamTimestampTypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTimestampTypeBuff* CFBamRamTimestampTypeTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamTimestampTypeBuff* CFBamRamTimestampTypeTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamTimestampTypeBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamTimestampTypeBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamTimestampTypeBuff* CFBamRamTimestampTypeTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamTimestampTypeBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamTimestampTypeBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> CFBamRamTimestampTypeTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamTimestampTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamTimestampTypeBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamTimestampTypeBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamTimestampTypeBuff* CFBamRamTimestampTypeTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamTimestampTypeBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamTimestampTypeBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamTimestampTypeBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamTimestampTypeBuff* CFBamRamTimestampTypeTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamTimestampTypeBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> CFBamRamTimestampTypeTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamTimestampTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> CFBamRamTimestampTypeTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamTimestampTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> CFBamRamTimestampTypeTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamTimestampTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> CFBamRamTimestampTypeTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTimestampTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> CFBamRamTimestampTypeTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTimestampTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> CFBamRamTimestampTypeTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTimestampTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> CFBamRamTimestampTypeTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTimestampTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> CFBamRamTimestampTypeTable::readBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		cfbam::CFBamTimestampTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> CFBamRamTimestampTypeTable::pageBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId,
	...
	cfbam::CFBamTimestampTypeBuff* CFBamRamTimestampTypeTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamTimestampTypeBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTimestampTypeBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamTimestampTypeBuff*>( editCur ) );
	}

	cfbam::CFBamTimestampTypeBuff* CFBamRamTimestampTypeTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTimestampTypeBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamTimestampTypeBuff* CFBamRamTimestampTypeTable::updateTimestampType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTimestampTypeBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in TimestampType for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamTimestampTypeBuff* existing = searchExisting->second;
		...
		cfbam::CFBamTimestampTypeBySchemaIdxKey existingKeySchemaIdx;
		...
		cfbam::CFBamTimestampTypeBySchemaIdxKey newKeySchemaIdx;
...

		{
			...
			if( allNull ) {
				cfbam::CFBamTimestampDefBuff* chk = dynamic_cast<cfbam::CFBamTimestampDefBuff*>( schema->getTableTimestampDef()->readDerivedByIdIdx( Authorization,
						Buff->getRequiredTenantId(),
						Buff->getRequiredId() ) );
				if( chk == NULL ) {
					delete Buff;
					std::string Msg( "Could not resolve Superclass relationship SuperClass to table TimestampDef" );
					throw cflib::CFLibUnresolvedRelationException( CLASS_NAME,
						S_ProcName,
						Msg );
				}
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamTimestampTypeBuff*>( schema->getTableTimestampDef()->updateTimestampDef( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimestampTypeBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimestampTypeBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamTimestampTypeBuff*>* subdictSchemaIdx;
		...
		if( searchNewKeyDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			dictBySchemaIdx->insert( std::map<cfbam::CFBamTimestampTypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamTimestampTypeBuff*>*>::value_type( newKeySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimestampTypeBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamTimestampTypeBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamTimestampTypeBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamTimestampTypeBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamTimestampTypeTable::deleteTimestampType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTimestampTypeBuff* Buff )
	{
		static const std::string S_ProcName( "deleteTimestampType" );
	...
	void CFBamRamTimestampTypeTable::deleteTimestampTypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamTimestampTypeBuff* cur = NULL;
		cfbam::CFBamTimestampTypeBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTimestampTypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTimestampTypeBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamTimestampTypeBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamTimestampTypeBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimestampTypeBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamTimestampTypeTable::deleteTimestampTypeByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamTimestampTypeTable::deleteTimestampTypeByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamTimestampTypeTable::deleteTimestampTypeByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamTimestampTypeTable::deleteTimestampTypeByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamTimestampTypeTable::deleteTimestampTypeByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTimestampTypeTable::deleteTimestampTypeByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTimestampTypeTable::deleteTimestampTypeByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamTimestampTypeTable::deleteTimestampTypeByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamTimestampTypeTable::deleteTimestampTypeByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamTimestampTypeTable::releasePreparedStatements() {
	}
