...
// Description: C++18 Implementation for an in-memory RAM DbIO for EnumDef.
...
namespace cfbam {
	...
	const std::string CFBamRamEnumDefTable::CLASS_NAME( "CFBamRamEnumDefTable" );

	CFBamRamEnumDefTable::CFBamRamEnumDefTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamEnumDefTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamEnumDefBuff*>();
	}

	CFBamRamEnumDefTable::~CFBamRamEnumDefTable() {
		if( dictByPKey != NULL ) {
			delete dictByPKey;
			dictByPKey = NULL;
		}
	...
	cfbam::CFBamEnumDefBuff* CFBamRamEnumDefTable::createEnumDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamEnumDefBuff* Buff )
	{
		...
		cfbam::CFBamEnumDefBuff* buff = dynamic_cast<cfbam::CFBamEnumDefBuff*>( schema->getTableInt16Def()->createInt16Def( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamEnumDefBuff*>::value_type( pkey, buff ) );

		// The top level code has to clone the final buffer. The one passed in is now part of the persistent storage.
		if( buff->getClassCode() == cfbam::CFBamEnumDefBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamEnumDefBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamEnumDefBuff* CFBamRamEnumDefTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamEnumDefBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamEnumDefBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamEnumDefBuff* CFBamRamEnumDefTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> CFBamRamEnumDefTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamEnumDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamEnumDefBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamEnumDefBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamEnumDefBuff*>( iter->second->clone() );
	...
	cfbam::CFBamEnumDefBuff* CFBamRamEnumDefTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamEnumDefBuff::CLASS_CODE ) ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> CFBamRamEnumDefTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamEnumDefBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamEnumDefBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> CFBamRamEnumDefTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> CFBamRamEnumDefTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> CFBamRamEnumDefTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> CFBamRamEnumDefTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> CFBamRamEnumDefTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> CFBamRamEnumDefTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	cfbam::CFBamEnumDefBuff* CFBamRamEnumDefTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamEnumDefBuff* CFBamRamEnumDefTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamEnumDefBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamEnumDefBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamEnumDefBuff* CFBamRamEnumDefTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamEnumDefBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamEnumDefBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> CFBamRamEnumDefTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamEnumDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamEnumDefBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamEnumDefBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamEnumDefBuff* CFBamRamEnumDefTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamEnumDefBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamEnumDefBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamEnumDefBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamEnumDefBuff* CFBamRamEnumDefTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamEnumDefBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> CFBamRamEnumDefTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamEnumDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> CFBamRamEnumDefTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamEnumDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> CFBamRamEnumDefTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamEnumDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> CFBamRamEnumDefTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamEnumDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> CFBamRamEnumDefTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamEnumDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> CFBamRamEnumDefTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamEnumDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> CFBamRamEnumDefTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamEnumDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	cfbam::CFBamEnumDefBuff* CFBamRamEnumDefTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamEnumDefBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamEnumDefBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamEnumDefBuff*>( editCur ) );
	}

	cfbam::CFBamEnumDefBuff* CFBamRamEnumDefTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamEnumDefBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamEnumDefBuff* CFBamRamEnumDefTable::updateEnumDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamEnumDefBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in EnumDef for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamEnumDefBuff* existing = searchExisting->second;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamEnumDefBuff*>( schema->getTableInt16Def()->updateInt16Def( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamEnumDefBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamEnumDefBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamEnumDefBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamEnumDefBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamEnumDefBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamEnumDefTable::deleteEnumDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamEnumDefBuff* Buff )
	{
		static const std::string S_ProcName( "deleteEnumDef" );
		...
		{
			cfbam::CFBamEnumTypeBuff* refIdIdx = dynamic_cast<cfbam::CFBamEnumTypeBuff*>( schema->getTableEnumType()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table EnumType for primary key " + pkey.toString() );
	...
	void CFBamRamEnumDefTable::deleteEnumDefByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteEnumDefByIdIdx" );
		...
		cfbam::CFBamEnumDefBuff* cur = NULL;
		cfbam::CFBamEnumDefBuff* rereadCur = NULL;
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamEnumDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamEnumDefBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamValueBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamEnumDefBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamEnumDefBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamEnumDefBuff::CLASS_CODE ) {
	...
	void CFBamRamEnumDefTable::deleteEnumDefByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteEnumDefByUNameIdx" );
		cfbam::CFBamEnumDefBuff* cur = NULL;
		cfbam::CFBamEnumDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamEnumDefTable::deleteEnumDefByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteEnumDefByValTentIdx" );
		cfbam::CFBamEnumDefBuff* cur = NULL;
		cfbam::CFBamEnumDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamEnumDefTable::deleteEnumDefByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteEnumDefByScopeIdx" );
		cfbam::CFBamEnumDefBuff* cur = NULL;
		cfbam::CFBamEnumDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamEnumDefTable::deleteEnumDefByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteEnumDefByDefSchemaIdx" );
		cfbam::CFBamEnumDefBuff* cur = NULL;
		cfbam::CFBamEnumDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamEnumDefTable::deleteEnumDefByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteEnumDefByPrevIdx" );
		cfbam::CFBamEnumDefBuff* cur = NULL;
		cfbam::CFBamEnumDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamEnumDefTable::deleteEnumDefByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteEnumDefByNextIdx" );
		cfbam::CFBamEnumDefBuff* cur = NULL;
		cfbam::CFBamEnumDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamEnumDefTable::deleteEnumDefByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteEnumDefByContPrevIdx" );
		cfbam::CFBamEnumDefBuff* cur = NULL;
		cfbam::CFBamEnumDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamEnumDefTable::deleteEnumDefByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteEnumDefByContNextIdx" );
		cfbam::CFBamEnumDefBuff* cur = NULL;
		cfbam::CFBamEnumDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamEnumDefTable::releasePreparedStatements() {
	}
