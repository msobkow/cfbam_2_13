...
// Description: C++18 Implementation for an in-memory RAM DbIO for Id64Gen.
...
namespace cfbam {
	...
	const std::string CFBamRamId64GenTable::CLASS_NAME( "CFBamRamId64GenTable" );

	CFBamRamId64GenTable::CFBamRamId64GenTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamId64GenTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamId64GenBuff*>();
		dictByDispIdx = new std::map<cfbam::CFBamId64GenByDispIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamId64GenBuff*>*>();
	}

	CFBamRamId64GenTable::~CFBamRamId64GenTable() {
	...
	cfbam::CFBamId64GenBuff* CFBamRamId64GenTable::createId64Gen( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamId64GenBuff* Buff )
	{
		static const std::string S_ProcName( "createId64Gen" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamId64GenBuff::CLASS_CODE ) {
		...
		cfbam::CFBamId64GenBuff* buff = dynamic_cast<cfbam::CFBamId64GenBuff*>( schema->getTableInt64Type()->createInt64Type( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamId64GenBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamId64GenBuff*>* subdictDispIdx;
		...
		if( searchDictByDispIdx != dictByDispIdx->end() ) {
			...
			subdictDispIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamId64GenBuff*>();
			dictByDispIdx->insert( std::map<cfbam::CFBamId64GenByDispIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamId64GenBuff*>*>::value_type( keyDispIdx, subdictDispIdx ) );
		}
		subdictDispIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamId64GenBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamId64GenBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamId64GenBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamId64GenBuff* CFBamRamId64GenTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamId64GenBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamId64GenBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamId64GenBuff* CFBamRamId64GenTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> CFBamRamId64GenTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamId64GenBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamId64GenBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamId64GenBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamId64GenBuff*>( iter->second->clone() );
	...
	cfbam::CFBamId64GenBuff* CFBamRamId64GenTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamId64GenBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamId64GenBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> CFBamRamId64GenTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamId64GenBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamId64GenBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> CFBamRamId64GenTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> CFBamRamId64GenTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> CFBamRamId64GenTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> CFBamRamId64GenTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> CFBamRamId64GenTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> CFBamRamId64GenTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> CFBamRamId64GenTable::readDerivedBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		static const std::string S_ProcName( "readDerivedBySchemaIdx" );
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*> buffList = schema->getTableInt64Type()->readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		cfbam::CFBamInt64TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt64TypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamId64GenBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> CFBamRamId64GenTable::readDerivedByDispIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const int64_t* DispenserId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> recVec;
		cfbam::CFBamId64GenBuff* clone;
		auto searchDictByDispIdx = dictByDispIdx->find( key );
		if( searchDictByDispIdx != dictByDispIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamId64GenBuff*>* subdictDispIdx = searchDictByDispIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamId64GenBuff*>::iterator iter = subdictDispIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamId64GenBuff*>::iterator end = subdictDispIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamId64GenBuff*>( iter->second->clone() );
	...
	cfbam::CFBamId64GenBuff* CFBamRamId64GenTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamId64GenBuff* CFBamRamId64GenTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamId64GenBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamId64GenBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamId64GenBuff* CFBamRamId64GenTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamId64GenBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamId64GenBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> CFBamRamId64GenTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamId64GenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamId64GenBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamId64GenBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamId64GenBuff* CFBamRamId64GenTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamId64GenBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamId64GenBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamId64GenBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamId64GenBuff* CFBamRamId64GenTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamId64GenBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> CFBamRamId64GenTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamId64GenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> CFBamRamId64GenTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamId64GenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> CFBamRamId64GenTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamId64GenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> CFBamRamId64GenTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamId64GenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> CFBamRamId64GenTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamId64GenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> CFBamRamId64GenTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamId64GenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> CFBamRamId64GenTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamId64GenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> CFBamRamId64GenTable::readBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		cfbam::CFBamId64GenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamInt64TypeBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamId64GenBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> CFBamRamId64GenTable::readBuffByDispIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DispenserTenantId,
			const int64_t* DispenserId )
	{
		...
		cfbam::CFBamId64GenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> buffList = readDerivedByDispIdx( Authorization,
			DispenserTenantId,
			DispenserId );
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> CFBamRamId64GenTable::pageBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId,
	...
	std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> CFBamRamId64GenTable::pageBuffByDispIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DispenserTenantId,
			const int64_t* DispenserId,
			const int64_t* priorTenantId,
			const int64_t* priorId )
	...
	cfbam::CFBamId64GenBuff* CFBamRamId64GenTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamId64GenBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamId64GenBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamId64GenBuff*>( editCur ) );
	}

	cfbam::CFBamId64GenBuff* CFBamRamId64GenTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamId64GenBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamId64GenBuff* CFBamRamId64GenTable::updateId64Gen( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamId64GenBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in Id64Gen for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamId64GenBuff* existing = searchExisting->second;
		...
		cfbam::CFBamId64GenByDispIdxKey existingKeyDispIdx;
		...
		cfbam::CFBamId64GenByDispIdxKey newKeyDispIdx;
		if( Buff->isOptionalDispenserTenantIdNull() ) {
...

		{
			...
			if( allNull ) {
				cfbam::CFBamInt64TypeBuff* chk = dynamic_cast<cfbam::CFBamInt64TypeBuff*>( schema->getTableInt64Type()->readDerivedByIdIdx( Authorization,
						Buff->getRequiredTenantId(),
						Buff->getRequiredId() ) );
				if( chk == NULL ) {
					delete Buff;
					std::string Msg( "Could not resolve Superclass relationship SuperClass to table Int64Type" );
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamId64GenBuff*>( schema->getTableInt64Type()->updateInt64Type( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamId64GenBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamId64GenBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamId64GenBuff*>* subdictDispIdx;
		...
		if( searchNewKeyDictByDispIdx != dictByDispIdx->end() ) {
			...
			dictByDispIdx->insert( std::map<cfbam::CFBamId64GenByDispIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamId64GenBuff*>*>::value_type( newKeyDispIdx, subdictDispIdx ) );
		}
		subdictDispIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamId64GenBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamId64GenBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamId64GenBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamId64GenBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamId64GenTable::deleteId64Gen( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamId64GenBuff* Buff )
	{
		static const std::string S_ProcName( "deleteId64Gen" );
	...
	void CFBamRamId64GenTable::deleteId64GenByDispIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamId64GenBuff* cur = NULL;
		cfbam::CFBamId64GenBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamId64GenBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamId64GenBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamId64GenBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamId64GenBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamId64GenTable::deleteId64GenBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
		...
		const cfbam::CFBamInt64TypeBySchemaIdxKey* argKey )
	{
		...
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamInt64TypeBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamId64GenBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*>::iterator iterMatch = matchSet.begin();
	...
	void CFBamRamId64GenTable::deleteId64GenByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamId64GenTable::deleteId64GenByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamId64GenTable::deleteId64GenByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamId64GenTable::deleteId64GenByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamId64GenTable::deleteId64GenByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamId64GenTable::deleteId64GenByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamId64GenTable::deleteId64GenByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamId64GenTable::deleteId64GenByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamId64GenTable::deleteId64GenByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamId64GenTable::releasePreparedStatements() {
	}
