...
// Description: C++18 Implementation for an in-memory RAM DbIO for FloatCol.
...
namespace cfbam {
	...
	const std::string CFBamRamFloatColTable::CLASS_NAME( "CFBamRamFloatColTable" );

	CFBamRamFloatColTable::CFBamRamFloatColTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamFloatColTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamFloatColBuff*>();
		dictByTableIdx = new std::map<cfbam::CFBamFloatColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamFloatColBuff*>*>();
	}

	CFBamRamFloatColTable::~CFBamRamFloatColTable() {
	...
	cfbam::CFBamFloatColBuff* CFBamRamFloatColTable::createFloatCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamFloatColBuff* Buff )
	{
		static const std::string S_ProcName( "createFloatCol" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamFloatColBuff::CLASS_CODE ) {
		...
		cfbam::CFBamFloatColBuff* buff = dynamic_cast<cfbam::CFBamFloatColBuff*>( schema->getTableFloatDef()->createFloatDef( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamFloatColBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamFloatColBuff*>* subdictTableIdx;
		...
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			...
			subdictTableIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamFloatColBuff*>();
			dictByTableIdx->insert( std::map<cfbam::CFBamFloatColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamFloatColBuff*>*>::value_type( keyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamFloatColBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamFloatColBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamFloatColBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamFloatColBuff* CFBamRamFloatColTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamFloatColBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamFloatColBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamFloatColBuff* CFBamRamFloatColTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> CFBamRamFloatColTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamFloatColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamFloatColBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamFloatColBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamFloatColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamFloatColBuff* CFBamRamFloatColTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamFloatColBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamFloatColBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> CFBamRamFloatColTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamFloatColBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamFloatColBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> CFBamRamFloatColTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> CFBamRamFloatColTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> CFBamRamFloatColTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> CFBamRamFloatColTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> CFBamRamFloatColTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> CFBamRamFloatColTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> CFBamRamFloatColTable::readDerivedByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> recVec;
		cfbam::CFBamFloatColBuff* clone;
		auto searchDictByTableIdx = dictByTableIdx->find( key );
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamFloatColBuff*>* subdictTableIdx = searchDictByTableIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamFloatColBuff*>::iterator iter = subdictTableIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamFloatColBuff*>::iterator end = subdictTableIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamFloatColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamFloatColBuff* CFBamRamFloatColTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamFloatColBuff* CFBamRamFloatColTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamFloatColBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamFloatColBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamFloatColBuff* CFBamRamFloatColTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamFloatColBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamFloatColBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> CFBamRamFloatColTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamFloatColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamFloatColBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamFloatColBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamFloatColBuff* CFBamRamFloatColTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamFloatColBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamFloatColBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamFloatColBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamFloatColBuff* CFBamRamFloatColTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamFloatColBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> CFBamRamFloatColTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamFloatColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> CFBamRamFloatColTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamFloatColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> CFBamRamFloatColTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamFloatColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> CFBamRamFloatColTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamFloatColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> CFBamRamFloatColTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamFloatColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> CFBamRamFloatColTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamFloatColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> CFBamRamFloatColTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamFloatColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> CFBamRamFloatColTable::readBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		cfbam::CFBamFloatColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> CFBamRamFloatColTable::pageBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId,
	...
	cfbam::CFBamFloatColBuff* CFBamRamFloatColTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamFloatColBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamFloatColBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamFloatColBuff*>( editCur ) );
	}

	cfbam::CFBamFloatColBuff* CFBamRamFloatColTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamFloatColBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamFloatColBuff* CFBamRamFloatColTable::updateFloatCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamFloatColBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in FloatCol for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamFloatColBuff* existing = searchExisting->second;
		...
		cfbam::CFBamFloatColByTableIdxKey existingKeyTableIdx;
		...
		cfbam::CFBamFloatColByTableIdxKey newKeyTableIdx;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamFloatColBuff*>( schema->getTableFloatDef()->updateFloatDef( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamFloatColBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamFloatColBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamFloatColBuff*>* subdictTableIdx;
		...
		if( searchNewKeyDictByTableIdx != dictByTableIdx->end() ) {
			...
			dictByTableIdx->insert( std::map<cfbam::CFBamFloatColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamFloatColBuff*>*>::value_type( newKeyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamFloatColBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamFloatColBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamFloatColBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamFloatColBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamFloatColTable::deleteFloatCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamFloatColBuff* Buff )
	{
		static const std::string S_ProcName( "deleteFloatCol" );
	...
	void CFBamRamFloatColTable::deleteFloatColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamFloatColBuff* cur = NULL;
		cfbam::CFBamFloatColBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamFloatColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamFloatColBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamFloatColBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamFloatColBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamFloatColTable::deleteFloatColByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamFloatColTable::deleteFloatColByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamFloatColTable::deleteFloatColByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamFloatColTable::deleteFloatColByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamFloatColTable::deleteFloatColByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamFloatColTable::deleteFloatColByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamFloatColTable::deleteFloatColByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamFloatColTable::deleteFloatColByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamFloatColTable::deleteFloatColByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamFloatColTable::releasePreparedStatements() {
	}
