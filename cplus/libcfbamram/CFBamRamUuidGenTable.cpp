...
// Description: C++18 Implementation for an in-memory RAM DbIO for UuidGen.
...
namespace cfbam {
	...
	const std::string CFBamRamUuidGenTable::CLASS_NAME( "CFBamRamUuidGenTable" );

	CFBamRamUuidGenTable::CFBamRamUuidGenTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamUuidGenTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidGenBuff*>();
	}

	CFBamRamUuidGenTable::~CFBamRamUuidGenTable() {
		if( dictByPKey != NULL ) {
			delete dictByPKey;
			dictByPKey = NULL;
		}
	...
	cfbam::CFBamUuidGenBuff* CFBamRamUuidGenTable::createUuidGen( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUuidGenBuff* Buff )
	{
		static const std::string S_ProcName( "createUuidGen" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamUuidGenBuff::CLASS_CODE ) {
		...
		cfbam::CFBamUuidGenBuff* buff = dynamic_cast<cfbam::CFBamUuidGenBuff*>( schema->getTableUuidType()->createUuidType( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidGenBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamUuidGenBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamUuidGenBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamUuidGenBuff* CFBamRamUuidGenTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamUuidGenBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamUuidGenBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamUuidGenBuff* CFBamRamUuidGenTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> CFBamRamUuidGenTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUuidGenBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUuidGenBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamUuidGenBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamUuidGenBuff*>( iter->second->clone() );
	...
	cfbam::CFBamUuidGenBuff* CFBamRamUuidGenTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamUuidGenBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamUuidGenBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> CFBamRamUuidGenTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamUuidGenBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamUuidGenBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> CFBamRamUuidGenTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> CFBamRamUuidGenTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> CFBamRamUuidGenTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> CFBamRamUuidGenTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> CFBamRamUuidGenTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> CFBamRamUuidGenTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> CFBamRamUuidGenTable::readDerivedBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		static const std::string S_ProcName( "readDerivedBySchemaIdx" );
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> buffList = schema->getTableUuidType()->readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
	...
	cfbam::CFBamUuidGenBuff* CFBamRamUuidGenTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamUuidGenBuff* CFBamRamUuidGenTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamUuidGenBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamUuidGenBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamUuidGenBuff* CFBamRamUuidGenTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamUuidGenBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamUuidGenBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> CFBamRamUuidGenTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamUuidGenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamUuidGenBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamUuidGenBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamUuidGenBuff* CFBamRamUuidGenTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamUuidGenBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamUuidGenBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamUuidGenBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamUuidGenBuff* CFBamRamUuidGenTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamUuidGenBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> CFBamRamUuidGenTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamUuidGenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> CFBamRamUuidGenTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamUuidGenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> CFBamRamUuidGenTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamUuidGenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> CFBamRamUuidGenTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamUuidGenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> CFBamRamUuidGenTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamUuidGenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> CFBamRamUuidGenTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamUuidGenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> CFBamRamUuidGenTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamUuidGenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> CFBamRamUuidGenTable::readBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		cfbam::CFBamUuidGenBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> CFBamRamUuidGenTable::pageBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId,
	...
	cfbam::CFBamUuidGenBuff* CFBamRamUuidGenTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamUuidGenBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamUuidGenBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamUuidGenBuff*>( editCur ) );
	}

	cfbam::CFBamUuidGenBuff* CFBamRamUuidGenTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamUuidGenBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamUuidGenBuff* CFBamRamUuidGenTable::updateUuidGen( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUuidGenBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in UuidGen for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamUuidGenBuff* existing = searchExisting->second;
...

		{
			...
			if( allNull ) {
				cfbam::CFBamUuidTypeBuff* chk = dynamic_cast<cfbam::CFBamUuidTypeBuff*>( schema->getTableUuidType()->readDerivedByIdIdx( Authorization,
						Buff->getRequiredTenantId(),
						Buff->getRequiredId() ) );
				if( chk == NULL ) {
					delete Buff;
					std::string Msg( "Could not resolve Superclass relationship SuperClass to table UuidType" );
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamUuidGenBuff*>( schema->getTableUuidType()->updateUuidType( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidGenBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidGenBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamUuidGenBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamUuidGenBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamUuidGenBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamUuidGenTable::deleteUuidGen( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUuidGenBuff* Buff )
	{
		static const std::string S_ProcName( "deleteUuidGen" );
	...
	void CFBamRamUuidGenTable::deleteUuidGenBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamUuidGenBuff* cur = NULL;
		cfbam::CFBamUuidGenBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUuidGenBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUuidGenBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamUuidTypeBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamUuidGenBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidGenBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamUuidGenTable::deleteUuidGenByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamUuidGenTable::deleteUuidGenByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamUuidGenTable::deleteUuidGenByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamUuidGenTable::deleteUuidGenByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamUuidGenTable::deleteUuidGenByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamUuidGenTable::deleteUuidGenByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamUuidGenTable::deleteUuidGenByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamUuidGenTable::deleteUuidGenByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamUuidGenTable::deleteUuidGenByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamUuidGenTable::releasePreparedStatements() {
	}
