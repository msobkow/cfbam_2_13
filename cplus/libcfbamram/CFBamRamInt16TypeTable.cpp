...
// Description: C++18 Implementation for an in-memory RAM DbIO for Int16Type.
...
namespace cfbam {
	...
	const std::string CFBamRamInt16TypeTable::CLASS_NAME( "CFBamRamInt16TypeTable" );

	CFBamRamInt16TypeTable::CFBamRamInt16TypeTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamInt16TypeTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt16TypeBuff*>();
		dictBySchemaIdx = new std::map<cfbam::CFBamInt16TypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamInt16TypeBuff*>*>();
	}

	CFBamRamInt16TypeTable::~CFBamRamInt16TypeTable() {
	...
	cfbam::CFBamInt16TypeBuff* CFBamRamInt16TypeTable::createInt16Type( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt16TypeBuff* Buff )
	{
		static const std::string S_ProcName( "createInt16Type" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamInt16TypeBuff::CLASS_CODE ) {
		...
		cfbam::CFBamInt16TypeBuff* buff = dynamic_cast<cfbam::CFBamInt16TypeBuff*>( schema->getTableInt16Def()->createInt16Def( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt16TypeBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt16TypeBuff*>* subdictSchemaIdx;
		...
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			subdictSchemaIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt16TypeBuff*>();
			dictBySchemaIdx->insert( std::map<cfbam::CFBamInt16TypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamInt16TypeBuff*>*>::value_type( keySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt16TypeBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamInt16TypeBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamInt16TypeBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamInt16TypeBuff* CFBamRamInt16TypeTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamInt16TypeBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamInt16TypeBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamInt16TypeBuff* CFBamRamInt16TypeTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> CFBamRamInt16TypeTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt16TypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt16TypeBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamInt16TypeBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamInt16TypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamInt16TypeBuff* CFBamRamInt16TypeTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamInt16TypeBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamInt16TypeBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> CFBamRamInt16TypeTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamInt16TypeBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamInt16TypeBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> CFBamRamInt16TypeTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> CFBamRamInt16TypeTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> CFBamRamInt16TypeTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> CFBamRamInt16TypeTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> CFBamRamInt16TypeTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> CFBamRamInt16TypeTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> CFBamRamInt16TypeTable::readDerivedBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> recVec;
		cfbam::CFBamInt16TypeBuff* clone;
		auto searchDictBySchemaIdx = dictBySchemaIdx->find( key );
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamInt16TypeBuff*>* subdictSchemaIdx = searchDictBySchemaIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamInt16TypeBuff*>::iterator iter = subdictSchemaIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamInt16TypeBuff*>::iterator end = subdictSchemaIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamInt16TypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamInt16TypeBuff* CFBamRamInt16TypeTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamInt16TypeBuff* CFBamRamInt16TypeTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamInt16TypeBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamInt16TypeBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamInt16TypeBuff* CFBamRamInt16TypeTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamInt16TypeBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamInt16TypeBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> CFBamRamInt16TypeTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamInt16TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> buffList = readAllDerived( Authorization );
		...
		while( iterBuffList != endBuffList ) {
			...
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamInt16TypeBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamInt16TypeBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamInt16TypeBuff* CFBamRamInt16TypeTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamInt16TypeBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamInt16TypeBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamInt16TypeBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamInt16TypeBuff* CFBamRamInt16TypeTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamInt16TypeBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> CFBamRamInt16TypeTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamInt16TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> CFBamRamInt16TypeTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamInt16TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> CFBamRamInt16TypeTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamInt16TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> CFBamRamInt16TypeTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamInt16TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> CFBamRamInt16TypeTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamInt16TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> CFBamRamInt16TypeTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamInt16TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> CFBamRamInt16TypeTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamInt16TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> CFBamRamInt16TypeTable::readBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		cfbam::CFBamInt16TypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> CFBamRamInt16TypeTable::pageBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId,
	...
	cfbam::CFBamInt16TypeBuff* CFBamRamInt16TypeTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamInt16TypeBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamInt16TypeBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamInt16TypeBuff*>( editCur ) );
	}

	cfbam::CFBamInt16TypeBuff* CFBamRamInt16TypeTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamInt16TypeBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamInt16TypeBuff* CFBamRamInt16TypeTable::updateInt16Type( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt16TypeBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in Int16Type for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamInt16TypeBuff* existing = searchExisting->second;
		...
		cfbam::CFBamInt16TypeBySchemaIdxKey existingKeySchemaIdx;
		...
		cfbam::CFBamInt16TypeBySchemaIdxKey newKeySchemaIdx;
...

		{
			...
			if( allNull ) {
				cfbam::CFBamInt16DefBuff* chk = dynamic_cast<cfbam::CFBamInt16DefBuff*>( schema->getTableInt16Def()->readDerivedByIdIdx( Authorization,
						Buff->getRequiredTenantId(),
						Buff->getRequiredId() ) );
				if( chk == NULL ) {
					delete Buff;
					std::string Msg( "Could not resolve Superclass relationship SuperClass to table Int16Def" );
					throw cflib::CFLibUnresolvedRelationException( CLASS_NAME,
						S_ProcName,
						Msg );
				}
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamInt16TypeBuff*>( schema->getTableInt16Def()->updateInt16Def( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt16TypeBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt16TypeBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamInt16TypeBuff*>* subdictSchemaIdx;
		...
		if( searchNewKeyDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			dictBySchemaIdx->insert( std::map<cfbam::CFBamInt16TypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamInt16TypeBuff*>*>::value_type( newKeySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt16TypeBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamInt16TypeBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamInt16TypeBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamInt16TypeBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamInt16TypeTable::deleteInt16Type( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt16TypeBuff* Buff )
	{
		static const std::string S_ProcName( "deleteInt16Type" );
		...
		{
			cfbam::CFBamId16GenBuff* refIdIdx = dynamic_cast<cfbam::CFBamId16GenBuff*>( schema->getTableId16Gen()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table Id16Gen for primary key " + pkey.toString() );
	...
	void CFBamRamInt16TypeTable::deleteInt16TypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt16TypeBySchemaIdx" );
		cfbam::CFBamInt16TypeBuff* cur = NULL;
		cfbam::CFBamInt16TypeBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt16TypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt16TypeBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamInt16TypeBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamInt16TypeBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamInt16TypeBuff::CLASS_CODE ) {
	...
	void CFBamRamInt16TypeTable::deleteInt16TypeByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	{
		static const std::string S_ProcName( "deleteInt16TypeByIdIdx" );
		bool anyNotNull = false;
		anyNotNull = true;
		anyNotNull = true;
		if( ! anyNotNull ) {
	...
	void CFBamRamInt16TypeTable::deleteInt16TypeByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteInt16TypeByUNameIdx" );
		cfbam::CFBamInt16TypeBuff* cur = NULL;
		cfbam::CFBamInt16TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt16TypeTable::deleteInt16TypeByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt16TypeByValTentIdx" );
		cfbam::CFBamInt16TypeBuff* cur = NULL;
		cfbam::CFBamInt16TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt16TypeTable::deleteInt16TypeByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt16TypeByScopeIdx" );
		cfbam::CFBamInt16TypeBuff* cur = NULL;
		cfbam::CFBamInt16TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt16TypeTable::deleteInt16TypeByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt16TypeByDefSchemaIdx" );
		cfbam::CFBamInt16TypeBuff* cur = NULL;
		cfbam::CFBamInt16TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamInt16TypeTable::deleteInt16TypeByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt16TypeByPrevIdx" );
		cfbam::CFBamInt16TypeBuff* cur = NULL;
		cfbam::CFBamInt16TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamInt16TypeTable::deleteInt16TypeByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt16TypeByNextIdx" );
		cfbam::CFBamInt16TypeBuff* cur = NULL;
		cfbam::CFBamInt16TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamInt16TypeTable::deleteInt16TypeByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt16TypeByContPrevIdx" );
		cfbam::CFBamInt16TypeBuff* cur = NULL;
		cfbam::CFBamInt16TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt16TypeTable::deleteInt16TypeByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt16TypeByContNextIdx" );
		cfbam::CFBamInt16TypeBuff* cur = NULL;
		cfbam::CFBamInt16TypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt16TypeTable::releasePreparedStatements() {
	}
