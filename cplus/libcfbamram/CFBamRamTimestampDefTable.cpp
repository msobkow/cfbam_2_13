...
// Description: C++18 Implementation for an in-memory RAM DbIO for TimestampDef.
...
namespace cfbam {
	...
	const std::string CFBamRamTimestampDefTable::CLASS_NAME( "CFBamRamTimestampDefTable" );

	CFBamRamTimestampDefTable::CFBamRamTimestampDefTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamTimestampDefTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimestampDefBuff*>();
	}

	CFBamRamTimestampDefTable::~CFBamRamTimestampDefTable() {
		if( dictByPKey != NULL ) {
			delete dictByPKey;
			dictByPKey = NULL;
		}
	...
	cfbam::CFBamTimestampDefBuff* CFBamRamTimestampDefTable::createTimestampDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTimestampDefBuff* Buff )
	{
		...
		cfbam::CFBamTimestampDefBuff* buff = dynamic_cast<cfbam::CFBamTimestampDefBuff*>( schema->getTableAtom()->createAtom( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimestampDefBuff*>::value_type( pkey, buff ) );

		// The top level code has to clone the final buffer. The one passed in is now part of the persistent storage.
		if( buff->getClassCode() == cfbam::CFBamTimestampDefBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamTimestampDefBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamTimestampDefBuff* CFBamRamTimestampDefTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamTimestampDefBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamTimestampDefBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamTimestampDefBuff* CFBamRamTimestampDefTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> CFBamRamTimestampDefTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTimestampDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTimestampDefBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamTimestampDefBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamTimestampDefBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTimestampDefBuff* CFBamRamTimestampDefTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamTimestampDefBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamTimestampDefBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> CFBamRamTimestampDefTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamTimestampDefBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamTimestampDefBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> CFBamRamTimestampDefTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> CFBamRamTimestampDefTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> CFBamRamTimestampDefTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> CFBamRamTimestampDefTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> CFBamRamTimestampDefTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> CFBamRamTimestampDefTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	cfbam::CFBamTimestampDefBuff* CFBamRamTimestampDefTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamTimestampDefBuff* CFBamRamTimestampDefTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamTimestampDefBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamTimestampDefBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamTimestampDefBuff* CFBamRamTimestampDefTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamTimestampDefBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamTimestampDefBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> CFBamRamTimestampDefTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamTimestampDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamTimestampDefBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamTimestampDefBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamTimestampDefBuff* CFBamRamTimestampDefTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamTimestampDefBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamTimestampDefBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamTimestampDefBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamTimestampDefBuff* CFBamRamTimestampDefTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamTimestampDefBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> CFBamRamTimestampDefTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamTimestampDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> CFBamRamTimestampDefTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamTimestampDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> CFBamRamTimestampDefTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamTimestampDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> CFBamRamTimestampDefTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTimestampDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> CFBamRamTimestampDefTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTimestampDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> CFBamRamTimestampDefTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTimestampDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> CFBamRamTimestampDefTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTimestampDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	cfbam::CFBamTimestampDefBuff* CFBamRamTimestampDefTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamTimestampDefBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTimestampDefBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamTimestampDefBuff*>( editCur ) );
	}

	cfbam::CFBamTimestampDefBuff* CFBamRamTimestampDefTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTimestampDefBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamTimestampDefBuff* CFBamRamTimestampDefTable::updateTimestampDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTimestampDefBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in TimestampDef for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamTimestampDefBuff* existing = searchExisting->second;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamTimestampDefBuff*>( schema->getTableAtom()->updateAtom( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimestampDefBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTimestampDefBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamTimestampDefBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamTimestampDefBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamTimestampDefBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamTimestampDefTable::deleteTimestampDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTimestampDefBuff* Buff )
	{
		static const std::string S_ProcName( "deleteTimestampDef" );
		...
		{
			cfbam::CFBamTimestampTypeBuff* refIdIdx = dynamic_cast<cfbam::CFBamTimestampTypeBuff*>( schema->getTableTimestampType()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table TimestampType for primary key " + pkey.toString() );
		...
		{
			cfbam::CFBamTimestampColBuff* refIdIdx = dynamic_cast<cfbam::CFBamTimestampColBuff*>( schema->getTableTimestampCol()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table TimestampCol for primary key " + pkey.toString() );
				throw cflib::CFLibDependentsDetectedException( CLASS_NAME,
					S_ProcName,
					Msg );
			}
	...
	void CFBamRamTimestampDefTable::deleteTimestampDefByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTimestampDefByIdIdx" );
		...
		cfbam::CFBamTimestampDefBuff* cur = NULL;
		cfbam::CFBamTimestampDefBuff* rereadCur = NULL;
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTimestampDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTimestampDefBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamValueBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamTimestampDefBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamTimestampDefBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamTimestampDefBuff::CLASS_CODE ) {
	...
	void CFBamRamTimestampDefTable::deleteTimestampDefByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteTimestampDefByUNameIdx" );
		cfbam::CFBamTimestampDefBuff* cur = NULL;
		cfbam::CFBamTimestampDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTimestampDefTable::deleteTimestampDefByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTimestampDefByValTentIdx" );
		cfbam::CFBamTimestampDefBuff* cur = NULL;
		cfbam::CFBamTimestampDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTimestampDefTable::deleteTimestampDefByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTimestampDefByScopeIdx" );
		cfbam::CFBamTimestampDefBuff* cur = NULL;
		cfbam::CFBamTimestampDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTimestampDefTable::deleteTimestampDefByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTimestampDefByDefSchemaIdx" );
		cfbam::CFBamTimestampDefBuff* cur = NULL;
		cfbam::CFBamTimestampDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamTimestampDefTable::deleteTimestampDefByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTimestampDefByPrevIdx" );
		cfbam::CFBamTimestampDefBuff* cur = NULL;
		cfbam::CFBamTimestampDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamTimestampDefTable::deleteTimestampDefByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTimestampDefByNextIdx" );
		cfbam::CFBamTimestampDefBuff* cur = NULL;
		cfbam::CFBamTimestampDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamTimestampDefTable::deleteTimestampDefByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTimestampDefByContPrevIdx" );
		cfbam::CFBamTimestampDefBuff* cur = NULL;
		cfbam::CFBamTimestampDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTimestampDefTable::deleteTimestampDefByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTimestampDefByContNextIdx" );
		cfbam::CFBamTimestampDefBuff* cur = NULL;
		cfbam::CFBamTimestampDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTimestampDefTable::releasePreparedStatements() {
	}
