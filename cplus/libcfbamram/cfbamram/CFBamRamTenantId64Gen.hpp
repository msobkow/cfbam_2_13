...
namespace cfbam {
	...
	size_t hashCode() const;
		...
		bool operator <( const cfbam::CFBamRamTenantId64Gen& rhs );
		...
		bool operator >( const cfbam::CFBamRamTenantId64Gen& rhs );
		CFBamRamTenantId64Gen operator =( CFBamRamTenantId64Gen& src );
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamRamTenantId64Gen> {
		typedef cfbam::CFBamRamTenantId64Gen argument_type;
