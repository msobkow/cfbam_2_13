...
namespace cfbam {
	...
	size_t hashCode() const;
		...
		bool operator <( const cfbam::CFBamRamClusterId64Gen& rhs );
		...
		bool operator >( const cfbam::CFBamRamClusterId64Gen& rhs );
		CFBamRamClusterId64Gen operator =( CFBamRamClusterId64Gen& src );
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamRamClusterId64Gen> {
		typedef cfbam::CFBamRamClusterId64Gen argument_type;
