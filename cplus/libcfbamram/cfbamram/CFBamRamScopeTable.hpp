...
// Description: C++18 Interface for an in-memory RAM DbIO declementation for Scope.
...
namespace cfbam {
	...
	class CFBamRamScopeTable
	: public virtual cfbam::ICFBamScopeTable
	{
	protected:
		cfbam::ICFBamSchema* schema;
		std::map<cfbam::CFBamScopePKey,
			cfbam::CFBamScopeBuff*>* dictByPKey;
		std::map<cfbam::CFBamScopeByTenantIdxKey,
			std::map<cfbam::CFBamScopePKey,
				cfbam::CFBamScopeBuff*>*>* dictByTenantIdx;
	public:
		static const std::string CLASS_NAME;
		CFBamRamScopeTable( cfbam::ICFBamSchema* argSchema );

		virtual ~CFBamRamScopeTable();
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamScopeBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization );
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamScopeBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization );
