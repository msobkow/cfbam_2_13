...
// Description: C++18 Interface for an in-memory RAM DbIO declementation for TextDef.
...
namespace cfbam {
	...
	class CFBamRamTextDefTable
	: public virtual cfbam::ICFBamTextDefTable
	{
	protected:
		cfbam::ICFBamSchema* schema;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTextDefBuff*>* dictByPKey;
	public:
		static const std::string CLASS_NAME;
		CFBamRamTextDefTable( cfbam::ICFBamSchema* argSchema );

		virtual ~CFBamRamTextDefTable();
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization );
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamTextDefBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization );
