...
namespace cfbam {
	...
	protected:
		...
		std::map<cfbam::CFBamRamClusterId32Gen, cfbam::CFBamRamClusterId32Gen*>* id32Generator;
		std::map<cfbam::CFBamRamClusterId64Gen, cfbam::CFBamRamClusterId64Gen*>* id64Generator;
	...
	public:
		...
		CFBamRamClusterTable( cfbam::ICFBamSchema* argSchema );

		virtual ~CFBamRamClusterTable();
