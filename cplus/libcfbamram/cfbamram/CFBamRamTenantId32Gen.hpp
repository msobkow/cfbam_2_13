...
namespace cfbam {
	...
	size_t hashCode() const;
		...
		bool operator <( const cfbam::CFBamRamTenantId32Gen& rhs );
		...
		bool operator >( const cfbam::CFBamRamTenantId32Gen& rhs );
		CFBamRamTenantId32Gen operator =( CFBamRamTenantId32Gen& src );
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamRamTenantId32Gen> {
		typedef cfbam::CFBamRamTenantId32Gen argument_type;
