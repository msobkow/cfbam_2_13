...
// Description: C++18 Implementation for an in-memory RAM DbIO for Int16Def.
...
namespace cfbam {
	...
	const std::string CFBamRamInt16DefTable::CLASS_NAME( "CFBamRamInt16DefTable" );

	CFBamRamInt16DefTable::CFBamRamInt16DefTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamInt16DefTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt16DefBuff*>();
	}

	CFBamRamInt16DefTable::~CFBamRamInt16DefTable() {
		if( dictByPKey != NULL ) {
			delete dictByPKey;
			dictByPKey = NULL;
		}
	...
	cfbam::CFBamInt16DefBuff* CFBamRamInt16DefTable::createInt16Def( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt16DefBuff* Buff )
	{
		...
		cfbam::CFBamInt16DefBuff* buff = dynamic_cast<cfbam::CFBamInt16DefBuff*>( schema->getTableAtom()->createAtom( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt16DefBuff*>::value_type( pkey, buff ) );

		// The top level code has to clone the final buffer. The one passed in is now part of the persistent storage.
		if( buff->getClassCode() == cfbam::CFBamInt16DefBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamInt16DefBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamInt16DefBuff* CFBamRamInt16DefTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamInt16DefBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamInt16DefBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamInt16DefBuff* CFBamRamInt16DefTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> CFBamRamInt16DefTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt16DefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt16DefBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamInt16DefBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamInt16DefBuff*>( iter->second->clone() );
	...
	cfbam::CFBamInt16DefBuff* CFBamRamInt16DefTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamInt16DefBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamInt16DefBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> CFBamRamInt16DefTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamInt16DefBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamInt16DefBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> CFBamRamInt16DefTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> CFBamRamInt16DefTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> CFBamRamInt16DefTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> CFBamRamInt16DefTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> CFBamRamInt16DefTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> CFBamRamInt16DefTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	cfbam::CFBamInt16DefBuff* CFBamRamInt16DefTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamInt16DefBuff* CFBamRamInt16DefTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamInt16DefBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamInt16DefBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamInt16DefBuff* CFBamRamInt16DefTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamInt16DefBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamInt16DefBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> CFBamRamInt16DefTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamInt16DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamInt16DefBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamInt16DefBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamInt16DefBuff* CFBamRamInt16DefTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamInt16DefBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamInt16DefBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamInt16DefBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamInt16DefBuff* CFBamRamInt16DefTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamInt16DefBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> CFBamRamInt16DefTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamInt16DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> CFBamRamInt16DefTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamInt16DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> CFBamRamInt16DefTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamInt16DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> CFBamRamInt16DefTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamInt16DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> CFBamRamInt16DefTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamInt16DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> CFBamRamInt16DefTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamInt16DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> CFBamRamInt16DefTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamInt16DefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*>::iterator iterBuffList = buffList.begin();
	...
	cfbam::CFBamInt16DefBuff* CFBamRamInt16DefTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamInt16DefBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamInt16DefBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamInt16DefBuff*>( editCur ) );
	}

	cfbam::CFBamInt16DefBuff* CFBamRamInt16DefTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamInt16DefBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamInt16DefBuff* CFBamRamInt16DefTable::updateInt16Def( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt16DefBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in Int16Def for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamInt16DefBuff* existing = searchExisting->second;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamInt16DefBuff*>( schema->getTableAtom()->updateAtom( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt16DefBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamInt16DefBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamInt16DefBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamInt16DefBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamInt16DefBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamInt16DefTable::deleteInt16Def( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamInt16DefBuff* Buff )
	{
		static const std::string S_ProcName( "deleteInt16Def" );
		...
		{
			cfbam::CFBamInt16TypeBuff* refIdIdx = dynamic_cast<cfbam::CFBamInt16TypeBuff*>( schema->getTableInt16Type()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table Int16Type for primary key " + pkey.toString() );
		...
		{
			cfbam::CFBamEnumDefBuff* refIdIdx = dynamic_cast<cfbam::CFBamEnumDefBuff*>( schema->getTableEnumDef()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table EnumDef for primary key " + pkey.toString() );
				throw cflib::CFLibDependentsDetectedException( CLASS_NAME,
					S_ProcName,
					Msg );
			}
		...
		{
			cfbam::CFBamInt16ColBuff* refIdIdx = dynamic_cast<cfbam::CFBamInt16ColBuff*>( schema->getTableInt16Col()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table Int16Col for primary key " + pkey.toString() );
				throw cflib::CFLibDependentsDetectedException( CLASS_NAME,
					S_ProcName,
					Msg );
			}
	...
	void CFBamRamInt16DefTable::deleteInt16DefByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt16DefByIdIdx" );
		...
		cfbam::CFBamInt16DefBuff* cur = NULL;
		cfbam::CFBamInt16DefBuff* rereadCur = NULL;
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt16DefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamInt16DefBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamValueBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamInt16DefBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamInt16DefBuff::CLASS_CODE ) {
	...
	void CFBamRamInt16DefTable::deleteInt16DefByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteInt16DefByUNameIdx" );
		cfbam::CFBamInt16DefBuff* cur = NULL;
		cfbam::CFBamInt16DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt16DefTable::deleteInt16DefByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt16DefByValTentIdx" );
		cfbam::CFBamInt16DefBuff* cur = NULL;
		cfbam::CFBamInt16DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt16DefTable::deleteInt16DefByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt16DefByScopeIdx" );
		cfbam::CFBamInt16DefBuff* cur = NULL;
		cfbam::CFBamInt16DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt16DefTable::deleteInt16DefByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt16DefByDefSchemaIdx" );
		cfbam::CFBamInt16DefBuff* cur = NULL;
		cfbam::CFBamInt16DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamInt16DefTable::deleteInt16DefByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt16DefByPrevIdx" );
		cfbam::CFBamInt16DefBuff* cur = NULL;
		cfbam::CFBamInt16DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamInt16DefTable::deleteInt16DefByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteInt16DefByNextIdx" );
		cfbam::CFBamInt16DefBuff* cur = NULL;
		cfbam::CFBamInt16DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamInt16DefTable::deleteInt16DefByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt16DefByContPrevIdx" );
		cfbam::CFBamInt16DefBuff* cur = NULL;
		cfbam::CFBamInt16DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt16DefTable::deleteInt16DefByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteInt16DefByContNextIdx" );
		cfbam::CFBamInt16DefBuff* cur = NULL;
		cfbam::CFBamInt16DefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamInt16DefTable::releasePreparedStatements() {
	}
