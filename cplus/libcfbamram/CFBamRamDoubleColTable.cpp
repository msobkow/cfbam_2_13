...
// Description: C++18 Implementation for an in-memory RAM DbIO for DoubleCol.
...
namespace cfbam {
	...
	const std::string CFBamRamDoubleColTable::CLASS_NAME( "CFBamRamDoubleColTable" );

	CFBamRamDoubleColTable::CFBamRamDoubleColTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamDoubleColTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamDoubleColBuff*>();
		dictByTableIdx = new std::map<cfbam::CFBamDoubleColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamDoubleColBuff*>*>();
	}

	CFBamRamDoubleColTable::~CFBamRamDoubleColTable() {
	...
	cfbam::CFBamDoubleColBuff* CFBamRamDoubleColTable::createDoubleCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamDoubleColBuff* Buff )
	{
		static const std::string S_ProcName( "createDoubleCol" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamDoubleColBuff::CLASS_CODE ) {
		...
		cfbam::CFBamDoubleColBuff* buff = dynamic_cast<cfbam::CFBamDoubleColBuff*>( schema->getTableDoubleDef()->createDoubleDef( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamDoubleColBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamDoubleColBuff*>* subdictTableIdx;
		...
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			...
			subdictTableIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamDoubleColBuff*>();
			dictByTableIdx->insert( std::map<cfbam::CFBamDoubleColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamDoubleColBuff*>*>::value_type( keyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamDoubleColBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamDoubleColBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamDoubleColBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamDoubleColBuff* CFBamRamDoubleColTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamDoubleColBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamDoubleColBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamDoubleColBuff* CFBamRamDoubleColTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> CFBamRamDoubleColTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamDoubleColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamDoubleColBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamDoubleColBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamDoubleColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamDoubleColBuff* CFBamRamDoubleColTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamDoubleColBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamDoubleColBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> CFBamRamDoubleColTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamDoubleColBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamDoubleColBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> CFBamRamDoubleColTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> CFBamRamDoubleColTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> CFBamRamDoubleColTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> CFBamRamDoubleColTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> CFBamRamDoubleColTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> CFBamRamDoubleColTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> CFBamRamDoubleColTable::readDerivedByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> recVec;
		cfbam::CFBamDoubleColBuff* clone;
		auto searchDictByTableIdx = dictByTableIdx->find( key );
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamDoubleColBuff*>* subdictTableIdx = searchDictByTableIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamDoubleColBuff*>::iterator iter = subdictTableIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamDoubleColBuff*>::iterator end = subdictTableIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamDoubleColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamDoubleColBuff* CFBamRamDoubleColTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamDoubleColBuff* CFBamRamDoubleColTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamDoubleColBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamDoubleColBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamDoubleColBuff* CFBamRamDoubleColTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamDoubleColBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamDoubleColBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> CFBamRamDoubleColTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamDoubleColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamDoubleColBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamDoubleColBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamDoubleColBuff* CFBamRamDoubleColTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamDoubleColBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamDoubleColBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamDoubleColBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamDoubleColBuff* CFBamRamDoubleColTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamDoubleColBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> CFBamRamDoubleColTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamDoubleColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> CFBamRamDoubleColTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamDoubleColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> CFBamRamDoubleColTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamDoubleColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> CFBamRamDoubleColTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamDoubleColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> CFBamRamDoubleColTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamDoubleColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> CFBamRamDoubleColTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamDoubleColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> CFBamRamDoubleColTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamDoubleColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> CFBamRamDoubleColTable::readBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		cfbam::CFBamDoubleColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> CFBamRamDoubleColTable::pageBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId,
	...
	cfbam::CFBamDoubleColBuff* CFBamRamDoubleColTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamDoubleColBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamDoubleColBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamDoubleColBuff*>( editCur ) );
	}

	cfbam::CFBamDoubleColBuff* CFBamRamDoubleColTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamDoubleColBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamDoubleColBuff* CFBamRamDoubleColTable::updateDoubleCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamDoubleColBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in DoubleCol for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamDoubleColBuff* existing = searchExisting->second;
		...
		cfbam::CFBamDoubleColByTableIdxKey existingKeyTableIdx;
		...
		cfbam::CFBamDoubleColByTableIdxKey newKeyTableIdx;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamDoubleColBuff*>( schema->getTableDoubleDef()->updateDoubleDef( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamDoubleColBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamDoubleColBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamDoubleColBuff*>* subdictTableIdx;
		...
		if( searchNewKeyDictByTableIdx != dictByTableIdx->end() ) {
			...
			dictByTableIdx->insert( std::map<cfbam::CFBamDoubleColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamDoubleColBuff*>*>::value_type( newKeyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamDoubleColBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamDoubleColBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamDoubleColBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamDoubleColBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamDoubleColTable::deleteDoubleCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamDoubleColBuff* Buff )
	{
		static const std::string S_ProcName( "deleteDoubleCol" );
	...
	void CFBamRamDoubleColTable::deleteDoubleColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamDoubleColBuff* cur = NULL;
		cfbam::CFBamDoubleColBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamDoubleColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamDoubleColBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamDoubleColBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamDoubleColBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamDoubleColTable::deleteDoubleColByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamDoubleColTable::deleteDoubleColByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamDoubleColTable::deleteDoubleColByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamDoubleColTable::deleteDoubleColByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamDoubleColTable::deleteDoubleColByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamDoubleColTable::deleteDoubleColByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamDoubleColTable::deleteDoubleColByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamDoubleColTable::deleteDoubleColByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamDoubleColTable::deleteDoubleColByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamDoubleColTable::releasePreparedStatements() {
	}
