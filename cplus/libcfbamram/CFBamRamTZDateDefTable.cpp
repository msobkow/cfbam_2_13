...
// Description: C++18 Implementation for an in-memory RAM DbIO for TZDateDef.
...
namespace cfbam {
	...
	const std::string CFBamRamTZDateDefTable::CLASS_NAME( "CFBamRamTZDateDefTable" );

	CFBamRamTZDateDefTable::CFBamRamTZDateDefTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamTZDateDefTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZDateDefBuff*>();
	}

	CFBamRamTZDateDefTable::~CFBamRamTZDateDefTable() {
		if( dictByPKey != NULL ) {
			delete dictByPKey;
			dictByPKey = NULL;
		}
	...
	cfbam::CFBamTZDateDefBuff* CFBamRamTZDateDefTable::createTZDateDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTZDateDefBuff* Buff )
	{
		...
		cfbam::CFBamTZDateDefBuff* buff = dynamic_cast<cfbam::CFBamTZDateDefBuff*>( schema->getTableAtom()->createAtom( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZDateDefBuff*>::value_type( pkey, buff ) );

		// The top level code has to clone the final buffer. The one passed in is now part of the persistent storage.
		if( buff->getClassCode() == cfbam::CFBamTZDateDefBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamTZDateDefBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamTZDateDefBuff* CFBamRamTZDateDefTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamTZDateDefBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamTZDateDefBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamTZDateDefBuff* CFBamRamTZDateDefTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> CFBamRamTZDateDefTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZDateDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZDateDefBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamTZDateDefBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamTZDateDefBuff*>( iter->second->clone() );
	...
	cfbam::CFBamTZDateDefBuff* CFBamRamTZDateDefTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamTZDateDefBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamTZDateDefBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> CFBamRamTZDateDefTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamTZDateDefBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamTZDateDefBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> CFBamRamTZDateDefTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> CFBamRamTZDateDefTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> CFBamRamTZDateDefTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> CFBamRamTZDateDefTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> CFBamRamTZDateDefTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> CFBamRamTZDateDefTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	cfbam::CFBamTZDateDefBuff* CFBamRamTZDateDefTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamTZDateDefBuff* CFBamRamTZDateDefTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamTZDateDefBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamTZDateDefBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamTZDateDefBuff* CFBamRamTZDateDefTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamTZDateDefBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamTZDateDefBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> CFBamRamTZDateDefTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamTZDateDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamTZDateDefBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamTZDateDefBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamTZDateDefBuff* CFBamRamTZDateDefTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamTZDateDefBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamTZDateDefBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamTZDateDefBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamTZDateDefBuff* CFBamRamTZDateDefTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamTZDateDefBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> CFBamRamTZDateDefTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamTZDateDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> CFBamRamTZDateDefTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamTZDateDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> CFBamRamTZDateDefTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamTZDateDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> CFBamRamTZDateDefTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTZDateDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> CFBamRamTZDateDefTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTZDateDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> CFBamRamTZDateDefTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamTZDateDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> CFBamRamTZDateDefTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamTZDateDefBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*>::iterator iterBuffList = buffList.begin();
	...
	cfbam::CFBamTZDateDefBuff* CFBamRamTZDateDefTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamTZDateDefBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTZDateDefBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamTZDateDefBuff*>( editCur ) );
	}

	cfbam::CFBamTZDateDefBuff* CFBamRamTZDateDefTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamTZDateDefBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamTZDateDefBuff* CFBamRamTZDateDefTable::updateTZDateDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTZDateDefBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in TZDateDef for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamTZDateDefBuff* existing = searchExisting->second;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamTZDateDefBuff*>( schema->getTableAtom()->updateAtom( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZDateDefBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamTZDateDefBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamTZDateDefBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamTZDateDefBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamTZDateDefBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamTZDateDefTable::deleteTZDateDef( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamTZDateDefBuff* Buff )
	{
		static const std::string S_ProcName( "deleteTZDateDef" );
		...
		{
			cfbam::CFBamTZDateTypeBuff* refIdIdx = dynamic_cast<cfbam::CFBamTZDateTypeBuff*>( schema->getTableTZDateType()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table TZDateType for primary key " + pkey.toString() );
		...
		{
			cfbam::CFBamTZDateColBuff* refIdIdx = dynamic_cast<cfbam::CFBamTZDateColBuff*>( schema->getTableTZDateCol()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table TZDateCol for primary key " + pkey.toString() );
				throw cflib::CFLibDependentsDetectedException( CLASS_NAME,
					S_ProcName,
					Msg );
			}
	...
	void CFBamRamTZDateDefTable::deleteTZDateDefByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTZDateDefByIdIdx" );
		...
		cfbam::CFBamTZDateDefBuff* cur = NULL;
		cfbam::CFBamTZDateDefBuff* rereadCur = NULL;
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZDateDefBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamTZDateDefBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			...
			if( *dynamic_cast<cfbam::CFBamValueBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamTZDateDefBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamTZDateDefBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamTZDateDefBuff::CLASS_CODE ) {
	...
	void CFBamRamTZDateDefTable::deleteTZDateDefByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteTZDateDefByUNameIdx" );
		cfbam::CFBamTZDateDefBuff* cur = NULL;
		cfbam::CFBamTZDateDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTZDateDefTable::deleteTZDateDefByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTZDateDefByValTentIdx" );
		cfbam::CFBamTZDateDefBuff* cur = NULL;
		cfbam::CFBamTZDateDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTZDateDefTable::deleteTZDateDefByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTZDateDefByScopeIdx" );
		cfbam::CFBamTZDateDefBuff* cur = NULL;
		cfbam::CFBamTZDateDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTZDateDefTable::deleteTZDateDefByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTZDateDefByDefSchemaIdx" );
		cfbam::CFBamTZDateDefBuff* cur = NULL;
		cfbam::CFBamTZDateDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamTZDateDefTable::deleteTZDateDefByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTZDateDefByPrevIdx" );
		cfbam::CFBamTZDateDefBuff* cur = NULL;
		cfbam::CFBamTZDateDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamTZDateDefTable::deleteTZDateDefByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteTZDateDefByNextIdx" );
		cfbam::CFBamTZDateDefBuff* cur = NULL;
		cfbam::CFBamTZDateDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamTZDateDefTable::deleteTZDateDefByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTZDateDefByContPrevIdx" );
		cfbam::CFBamTZDateDefBuff* cur = NULL;
		cfbam::CFBamTZDateDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTZDateDefTable::deleteTZDateDefByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteTZDateDefByContNextIdx" );
		cfbam::CFBamTZDateDefBuff* cur = NULL;
		cfbam::CFBamTZDateDefBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamTZDateDefTable::releasePreparedStatements() {
	}
