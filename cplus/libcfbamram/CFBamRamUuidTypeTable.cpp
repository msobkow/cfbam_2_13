...
// Description: C++18 Implementation for an in-memory RAM DbIO for UuidType.
...
namespace cfbam {
	...
	const std::string CFBamRamUuidTypeTable::CLASS_NAME( "CFBamRamUuidTypeTable" );

	CFBamRamUuidTypeTable::CFBamRamUuidTypeTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamUuidTypeTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidTypeBuff*>();
		dictBySchemaIdx = new std::map<cfbam::CFBamUuidTypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamUuidTypeBuff*>*>();
	}

	CFBamRamUuidTypeTable::~CFBamRamUuidTypeTable() {
	...
	cfbam::CFBamUuidTypeBuff* CFBamRamUuidTypeTable::createUuidType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUuidTypeBuff* Buff )
	{
		static const std::string S_ProcName( "createUuidType" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamUuidTypeBuff::CLASS_CODE ) {
		...
		cfbam::CFBamUuidTypeBuff* buff = dynamic_cast<cfbam::CFBamUuidTypeBuff*>( schema->getTableUuidDef()->createUuidDef( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidTypeBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidTypeBuff*>* subdictSchemaIdx;
		...
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			subdictSchemaIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidTypeBuff*>();
			dictBySchemaIdx->insert( std::map<cfbam::CFBamUuidTypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamUuidTypeBuff*>*>::value_type( keySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidTypeBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamUuidTypeBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamUuidTypeBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamUuidTypeBuff* CFBamRamUuidTypeTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamUuidTypeBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamUuidTypeBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamUuidTypeBuff* CFBamRamUuidTypeTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> CFBamRamUuidTypeTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUuidTypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUuidTypeBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamUuidTypeBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamUuidTypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamUuidTypeBuff* CFBamRamUuidTypeTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamUuidTypeBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamUuidTypeBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> CFBamRamUuidTypeTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamUuidTypeBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamUuidTypeBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> CFBamRamUuidTypeTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> CFBamRamUuidTypeTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> CFBamRamUuidTypeTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> CFBamRamUuidTypeTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> CFBamRamUuidTypeTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> CFBamRamUuidTypeTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> CFBamRamUuidTypeTable::readDerivedBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> recVec;
		cfbam::CFBamUuidTypeBuff* clone;
		auto searchDictBySchemaIdx = dictBySchemaIdx->find( key );
		if( searchDictBySchemaIdx != dictBySchemaIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamUuidTypeBuff*>* subdictSchemaIdx = searchDictBySchemaIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamUuidTypeBuff*>::iterator iter = subdictSchemaIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamUuidTypeBuff*>::iterator end = subdictSchemaIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamUuidTypeBuff*>( iter->second->clone() );
	...
	cfbam::CFBamUuidTypeBuff* CFBamRamUuidTypeTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamUuidTypeBuff* CFBamRamUuidTypeTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamUuidTypeBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamUuidTypeBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamUuidTypeBuff* CFBamRamUuidTypeTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamUuidTypeBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamUuidTypeBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> CFBamRamUuidTypeTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamUuidTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamUuidTypeBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamUuidTypeBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamUuidTypeBuff* CFBamRamUuidTypeTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamUuidTypeBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamUuidTypeBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamUuidTypeBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamUuidTypeBuff* CFBamRamUuidTypeTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamUuidTypeBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> CFBamRamUuidTypeTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamUuidTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> CFBamRamUuidTypeTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamUuidTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> CFBamRamUuidTypeTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamUuidTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> CFBamRamUuidTypeTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamUuidTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> CFBamRamUuidTypeTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamUuidTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> CFBamRamUuidTypeTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamUuidTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> CFBamRamUuidTypeTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamUuidTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> CFBamRamUuidTypeTable::readBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId )
	{
		...
		cfbam::CFBamUuidTypeBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> buffList = readDerivedBySchemaIdx( Authorization,
			TenantId,
			SchemaDefId );
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> CFBamRamUuidTypeTable::pageBuffBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t SchemaDefId,
	...
	cfbam::CFBamUuidTypeBuff* CFBamRamUuidTypeTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamUuidTypeBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamUuidTypeBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamUuidTypeBuff*>( editCur ) );
	}

	cfbam::CFBamUuidTypeBuff* CFBamRamUuidTypeTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamUuidTypeBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamUuidTypeBuff* CFBamRamUuidTypeTable::updateUuidType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUuidTypeBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in UuidType for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamUuidTypeBuff* existing = searchExisting->second;
		...
		cfbam::CFBamUuidTypeBySchemaIdxKey existingKeySchemaIdx;
		...
		cfbam::CFBamUuidTypeBySchemaIdxKey newKeySchemaIdx;
...

		{
			...
			if( allNull ) {
				cfbam::CFBamUuidDefBuff* chk = dynamic_cast<cfbam::CFBamUuidDefBuff*>( schema->getTableUuidDef()->readDerivedByIdIdx( Authorization,
						Buff->getRequiredTenantId(),
						Buff->getRequiredId() ) );
				if( chk == NULL ) {
					delete Buff;
					std::string Msg( "Could not resolve Superclass relationship SuperClass to table UuidDef" );
					throw cflib::CFLibUnresolvedRelationException( CLASS_NAME,
						S_ProcName,
						Msg );
				}
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamUuidTypeBuff*>( schema->getTableUuidDef()->updateUuidDef( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidTypeBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidTypeBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamUuidTypeBuff*>* subdictSchemaIdx;
		...
		if( searchNewKeyDictBySchemaIdx != dictBySchemaIdx->end() ) {
			...
			dictBySchemaIdx->insert( std::map<cfbam::CFBamUuidTypeBySchemaIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamUuidTypeBuff*>*>::value_type( newKeySchemaIdx, subdictSchemaIdx ) );
		}
		subdictSchemaIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamUuidTypeBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamUuidTypeBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamUuidTypeBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamUuidTypeBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamUuidTypeTable::deleteUuidType( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamUuidTypeBuff* Buff )
	{
		static const std::string S_ProcName( "deleteUuidType" );
		...
		{
			cfbam::CFBamUuidGenBuff* refIdIdx = dynamic_cast<cfbam::CFBamUuidGenBuff*>( schema->getTableUuidGen()->readDerivedByIdIdx( Authorization,
						existing->getRequiredTenantId(),
						existing->getRequiredId() ) );
			if( refIdIdx != NULL ) {
				delete refIdIdx;
				refIdIdx = NULL;
				std::string Msg( "Dependents detected for Superclass relationship SuperClass from table UuidGen for primary key " + pkey.toString() );
	...
	void CFBamRamUuidTypeTable::deleteUuidTypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteUuidTypeBySchemaIdx" );
		cfbam::CFBamUuidTypeBuff* cur = NULL;
		cfbam::CFBamUuidTypeBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUuidTypeBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamUuidTypeBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamUuidTypeBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamUuidTypeBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamUuidTypeBuff*>::iterator matchEnd = matchSet.end();
		while( iterMatch != matchEnd ) {
			...
			if( subClassCode == cfbam::CFBamUuidTypeBuff::CLASS_CODE ) {
	...
	void CFBamRamUuidTypeTable::deleteUuidTypeByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	{
		static const std::string S_ProcName( "deleteUuidTypeByIdIdx" );
		bool anyNotNull = false;
		anyNotNull = true;
		anyNotNull = true;
		if( ! anyNotNull ) {
	...
	void CFBamRamUuidTypeTable::deleteUuidTypeByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	{
		static const std::string S_ProcName( "deleteUuidTypeByUNameIdx" );
		cfbam::CFBamUuidTypeBuff* cur = NULL;
		cfbam::CFBamUuidTypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamUuidTypeTable::deleteUuidTypeByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	{
		static const std::string S_ProcName( "deleteUuidTypeByValTentIdx" );
		cfbam::CFBamUuidTypeBuff* cur = NULL;
		cfbam::CFBamUuidTypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamUuidTypeTable::deleteUuidTypeByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	{
		static const std::string S_ProcName( "deleteUuidTypeByScopeIdx" );
		cfbam::CFBamUuidTypeBuff* cur = NULL;
		cfbam::CFBamUuidTypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamUuidTypeTable::deleteUuidTypeByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteUuidTypeByDefSchemaIdx" );
		cfbam::CFBamUuidTypeBuff* cur = NULL;
		cfbam::CFBamUuidTypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamUuidTypeTable::deleteUuidTypeByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteUuidTypeByPrevIdx" );
		cfbam::CFBamUuidTypeBuff* cur = NULL;
		cfbam::CFBamUuidTypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamUuidTypeTable::deleteUuidTypeByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		static const std::string S_ProcName( "deleteUuidTypeByNextIdx" );
		cfbam::CFBamUuidTypeBuff* cur = NULL;
		cfbam::CFBamUuidTypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
	...
	void CFBamRamUuidTypeTable::deleteUuidTypeByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	{
		static const std::string S_ProcName( "deleteUuidTypeByContPrevIdx" );
		cfbam::CFBamUuidTypeBuff* cur = NULL;
		cfbam::CFBamUuidTypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamUuidTypeTable::deleteUuidTypeByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	{
		static const std::string S_ProcName( "deleteUuidTypeByContNextIdx" );
		cfbam::CFBamUuidTypeBuff* cur = NULL;
		cfbam::CFBamUuidTypeBuff* rereadCur = NULL;
		bool anyNotNull = false;
		anyNotNull = true;
	...
	void CFBamRamUuidTypeTable::releasePreparedStatements() {
	}
