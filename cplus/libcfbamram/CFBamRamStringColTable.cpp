...
// Description: C++18 Implementation for an in-memory RAM DbIO for StringCol.
...
namespace cfbam {
	...
	const std::string CFBamRamStringColTable::CLASS_NAME( "CFBamRamStringColTable" );

	CFBamRamStringColTable::CFBamRamStringColTable( ICFBamSchema* argSchema )
	: cfbam::ICFBamStringColTable()
	{
		schema = argSchema;
		dictByPKey = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamStringColBuff*>();
		dictByTableIdx = new std::map<cfbam::CFBamStringColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamStringColBuff*>*>();
	}

	CFBamRamStringColTable::~CFBamRamStringColTable() {
	...
	cfbam::CFBamStringColBuff* CFBamRamStringColTable::createStringCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamStringColBuff* Buff )
	{
		static const std::string S_ProcName( "createStringCol" );
		cfbam::CFBamValueBuff* tail = NULL;
		if( Buff->getClassCode() == cfbam::CFBamStringColBuff::CLASS_CODE ) {
		...
		cfbam::CFBamStringColBuff* buff = dynamic_cast<cfbam::CFBamStringColBuff*>( schema->getTableStringDef()->createStringDef( Authorization,
			Buff ) );
		pkey.setRequiredTenantId( buff->getRequiredTenantId() );
		pkey.setRequiredId( buff->getRequiredId() );
		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamStringColBuff*>::value_type( pkey, buff ) );

		std::map<cfbam::CFBamValuePKey, cfbam::CFBamStringColBuff*>* subdictTableIdx;
		...
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			...
			subdictTableIdx = new std::map<cfbam::CFBamValuePKey, cfbam::CFBamStringColBuff*>();
			dictByTableIdx->insert( std::map<cfbam::CFBamStringColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamStringColBuff*>*>::value_type( keyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamStringColBuff*>::value_type( pkey, buff ) );
		...
		if( buff->getClassCode() == cfbam::CFBamStringColBuff::CLASS_CODE ) {
			buff = dynamic_cast<cfbam::CFBamStringColBuff*>( buff->clone() );
		}
		return( buff );
	}

	cfbam::CFBamStringColBuff* CFBamRamStringColTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		...
		auto searchDictByPKey = dictByPKey->find( *PKey );
		if( searchDictByPKey != dictByPKey->end() ) {
			buff = dynamic_cast<cfbam::CFBamStringColBuff*>( searchDictByPKey->second );
			if( buff != NULL ) {
				buff = dynamic_cast<cfbam::CFBamStringColBuff*>( buff->clone() );
			}
		}
	...
	cfbam::CFBamStringColBuff* CFBamRamStringColTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> CFBamRamStringColTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
		static const std::string S_ProcName( "readAllDerived" );
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> retVec;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamStringColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamStringColBuff*>::iterator end = dictByPKey->end();
		cfbam::CFBamStringColBuff* clone;
		while( iter != end ) {
			clone = dynamic_cast<cfbam::CFBamStringColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamStringColBuff* CFBamRamStringColTable::readDerivedByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const std::string& Name )
	{
		...
		else if( buff->implementsClassCode( cfbam::CFBamStringColBuff::CLASS_CODE ) ) {
			return( dynamic_cast<cfbam::CFBamStringColBuff*>( buff ) );
		}
		else {
			delete buff;
			buff = NULL;
	...
	std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> CFBamRamStringColTable::readDerivedByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> filteredList;
		...
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			if( ( buff != NULL ) && ( buff->implementsClassCode( cfbam::CFBamStringColBuff::CLASS_CODE ) ) ) {
				*iterBuffList = NULL;
				filteredList.push_back( dynamic_cast<cfbam::CFBamStringColBuff*>( buff ) );
			}
			iterBuffList ++;
		}
		return( filteredList );
	...
	std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> CFBamRamStringColTable::readDerivedByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> CFBamRamStringColTable::readDerivedByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> CFBamRamStringColTable::readDerivedByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> CFBamRamStringColTable::readDerivedByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> CFBamRamStringColTable::readDerivedByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> CFBamRamStringColTable::readDerivedByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
	...
	std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> CFBamRamStringColTable::readDerivedByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> recVec;
		cfbam::CFBamStringColBuff* clone;
		auto searchDictByTableIdx = dictByTableIdx->find( key );
		if( searchDictByTableIdx != dictByTableIdx->end() ) {
			std::map<cfbam::CFBamValuePKey,
				 cfbam::CFBamStringColBuff*>* subdictTableIdx = searchDictByTableIdx->second;
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamStringColBuff*>::iterator iter = subdictTableIdx->begin();
			std::map<cfbam::CFBamValuePKey,
				cfbam::CFBamStringColBuff*>::iterator end = subdictTableIdx->end();
			while( iter != end ) {
				clone = dynamic_cast<cfbam::CFBamStringColBuff*>( iter->second->clone() );
	...
	cfbam::CFBamStringColBuff* CFBamRamStringColTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
	...
	cfbam::CFBamStringColBuff* CFBamRamStringColTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "readBuff" );
		cfbam::CFBamStringColBuff* buff = readDerived( Authorization, PKey );
		if( buff != NULL ) {
			if( buff->getClassCode() != cfbam::CFBamStringColBuff::CLASS_CODE ) {
				delete buff;
				buff = NULL;
	...
	cfbam::CFBamStringColBuff* CFBamRamStringColTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfbam::CFBamValuePKey* PKey )
	{
		static const std::string S_ProcName( "lockBuff" );
		cfbam::CFBamStringColBuff* buff = lockDerived( Authorization, PKey );
		return( dynamic_cast<cfbam::CFBamStringColBuff*>( buff ) );
	}

	std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> CFBamRamStringColTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
		static const std::string S_ProcName( "readAllBuff" );
		cfbam::CFBamStringColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> buffList = readAllDerived( Authorization );
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
			buff = *iterBuffList;
			iterBuffList ++;
			if( ( buff != NULL ) && ( buff->getClassCode() == cfbam::CFBamStringColBuff::CLASS_CODE ) ) {
				filteredList.push_back( dynamic_cast<cfbam::CFBamStringColBuff*>( buff->clone() ) );
			}
		}
		return( filteredList );
	}

	cfbam::CFBamStringColBuff* CFBamRamStringColTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id )
	{
		static const std::string S_ProcName( "readBuffByIdIdx" );
		cfbam::CFBamStringColBuff* buff = readDerivedByIdIdx( Authorization,
			TenantId,
			Id );
		if( buff == NULL ) {
			return( NULL );
		}
		else if( buff->getClassCode() == cfbam::CFBamStringColBuff::CLASS_CODE ) {
			return( dynamic_cast<cfbam::CFBamStringColBuff*>( buff ) );
		}
		else {
			delete buff;
	...
	cfbam::CFBamStringColBuff* CFBamRamStringColTable::readBuffByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name )
	{
		static const std::string S_ProcName( "readBuffByUNameIdx" );
		cfbam::CFBamStringColBuff* buff = readDerivedByUNameIdx( Authorization,
			TenantId,
			ScopeId,
			Name );
		if( buff == NULL ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> CFBamRamStringColTable::readBuffByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
		static const std::string S_ProcName( "readBuffByValTentIdx" );
		cfbam::CFBamStringColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> buffList = readDerivedByValTentIdx( Authorization,
			TenantId );
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*>::iterator endBuffList = buffList.end();
		while( iterBuffList != endBuffList ) {
	...
	std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> CFBamRamStringColTable::readBuffByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId )
	{
		...
		cfbam::CFBamStringColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> buffList = readDerivedByScopeIdx( Authorization,
			TenantId,
			ScopeId );
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> CFBamRamStringColTable::readBuffByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId )
	{
		...
		cfbam::CFBamStringColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> buffList = readDerivedByDefSchemaIdx( Authorization,
			DefSchemaTenantId,
			DefSchemaId );
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> CFBamRamStringColTable::readBuffByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* PrevTenantId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamStringColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> buffList = readDerivedByPrevIdx( Authorization,
			PrevTenantId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> CFBamRamStringColTable::readBuffByNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t* NextTenantId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamStringColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> buffList = readDerivedByNextIdx( Authorization,
			NextTenantId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> CFBamRamStringColTable::readBuffByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId )
	{
		...
		cfbam::CFBamStringColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> buffList = readDerivedByContPrevIdx( Authorization,
			TenantId,
			ScopeId,
			PrevId );
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> CFBamRamStringColTable::readBuffByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId )
	{
		...
		cfbam::CFBamStringColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> buffList = readDerivedByContNextIdx( Authorization,
			TenantId,
			ScopeId,
			NextId );
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*>::iterator iterBuffList = buffList.begin();
	...
	std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> CFBamRamStringColTable::readBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId )
	{
		...
		cfbam::CFBamStringColBuff* buff;
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> filteredList;
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> buffList = readDerivedByTableIdx( Authorization,
			TenantId,
			TableId );
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*>::iterator iterBuffList = buffList.begin();
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*>::iterator endBuffList = buffList.end();
	...
	std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> CFBamRamStringColTable::pageBuffByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TableId,
	...
	cfbam::CFBamStringColBuff* CFBamRamStringColTable::moveBuffUp( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( ( cur->isOptionalPrevTenantIdNull() )
			...
			return( dynamic_cast<cfbam::CFBamStringColBuff*>( cur ) );
		}
		...
		if( grandprev != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandprev = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamStringColBuff*>( grandprev ) );
			}
		...
		return( dynamic_cast<cfbam::CFBamStringColBuff*>( editCur ) );
	}

	cfbam::CFBamStringColBuff* CFBamRamStringColTable::moveBuffDown( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t Id,
		int32_t revision )
	{
		...
		if( editGrandnext != NULL ) {
			...
			if( classCode == cfbam::CFBamValueBuff::CLASS_CODE ) {
				editGrandnext = schema->getTableValue()->updateValue( Authorization, dynamic_cast<cfbam::CFBamStringColBuff*>( editGrandnext ) );
			}
			else if( classCode == cfbam::CFBamAtomBuff::CLASS_CODE ) {
	...
	cfbam::CFBamStringColBuff* CFBamRamStringColTable::updateStringCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamStringColBuff* Buff )
	{
		...
		if( searchExisting == dictByPKey->end() ) {
			delete Buff;
			std::string Msg( "Existing record not found in StringCol for key " + pkey.toString() );
			throw cflib::CFLibStaleCacheDetectedException( CLASS_NAME,
				S_ProcName,
				Msg );
		}

		cfbam::CFBamStringColBuff* existing = searchExisting->second;
		...
		cfbam::CFBamStringColByTableIdxKey existingKeyTableIdx;
		...
		cfbam::CFBamStringColByTableIdxKey newKeyTableIdx;
		...
		// Update is valid
		existing = dynamic_cast<cfbam::CFBamStringColBuff*>( schema->getTableStringDef()->updateStringDef( Authorization,
			Buff ) );
		std::map<cfbam::CFBamValuePKey, cfbam::CFBamStringColBuff*>* subdict;
		auto removalDictByPKey = dictByPKey->find( pkey );
		if( removalDictByPKey != dictByPKey->end() ) {
			dictByPKey->erase( removalDictByPKey );
		}

		dictByPKey->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamStringColBuff*>::value_type( pkey, existing ) );

		std::map<cfbam::CFBamValuePKey,
			 cfbam::CFBamStringColBuff*>* subdictTableIdx;
		...
		if( searchNewKeyDictByTableIdx != dictByTableIdx->end() ) {
			...
			dictByTableIdx->insert( std::map<cfbam::CFBamStringColByTableIdxKey,
				std::map<cfbam::CFBamValuePKey,
					cfbam::CFBamStringColBuff*>*>::value_type( newKeyTableIdx, subdictTableIdx ) );
		}
		subdictTableIdx->insert( std::map<cfbam::CFBamValuePKey, cfbam::CFBamStringColBuff*>::value_type( pkey, existing ) );
		...
		cfbam::CFBamStringColBuff* buff;
		if( existing->getClassCode() == cfbam::CFBamStringColBuff::CLASS_CODE ) {
			delete Buff;
			Buff = NULL;
			buff = dynamic_cast<cfbam::CFBamStringColBuff*>( existing->clone() );
		}
		else {
			buff = existing;
		}
	...
	void CFBamRamStringColTable::deleteStringCol( const cfsec::CFSecAuthorization* Authorization,
		cfbam::CFBamStringColBuff* Buff )
	{
		static const std::string S_ProcName( "deleteStringCol" );
	...
	void CFBamRamStringColTable::deleteStringColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	{
		cfbam::CFBamStringColBuff* cur = NULL;
		cfbam::CFBamStringColBuff* rereadCur = NULL;
		...
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> matchSet;
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamStringColBuff*>::iterator iter = dictByPKey->begin();
		std::map<cfbam::CFBamValuePKey,
			cfbam::CFBamStringColBuff*>::iterator end = dictByPKey->end();
		while( iter != end ) {
			cur = iter->second;
			iter ++;
			if( *dynamic_cast<cfbam::CFBamStringColBuff*>( cur ) == *argKey ) {
				matchSet.push_back( dynamic_cast<cfbam::CFBamStringColBuff*>( cur->clone() ) );
			}
		}
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*>::iterator iterMatch = matchSet.begin();
		std::TCFLibOwningVector<cfbam::CFBamStringColBuff*>::iterator matchEnd = matchSet.end();
	...
	void CFBamRamStringColTable::deleteStringColByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argId )
	{
		cfbam::CFBamValuePKey key;
	...
	void CFBamRamStringColTable::deleteStringColByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFBamRamStringColTable::deleteStringColByValTentIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
	...
	void CFBamRamStringColTable::deleteStringColByScopeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId )
	{
	...
	void CFBamRamStringColTable::deleteStringColByDefSchemaIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamStringColTable::deleteStringColByPrevIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamStringColTable::deleteStringColByNextIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFBamRamStringColTable::deleteStringColByContPrevIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argPrevId )
	{
	...
	void CFBamRamStringColTable::deleteStringColByContNextIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argScopeId,
			const int64_t* argNextId )
	{
	...
	void CFBamRamStringColTable::releasePreparedStatements() {
	}
