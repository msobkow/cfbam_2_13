...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusEditObjInterfaceHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusEditObjInterfaceHandler" );
	const std::string CFBamCustXmlLoaderHPlusEditObjInterfaceHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusEditObjInterfaceHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusEditObjInterfaceHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusEditObjInterfaceHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusEditObjInterfaceHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusEditObjInterfaceHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusEditObjInterfaceHandler::CFBamCustXmlLoaderHPlusEditObjInterfaceHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusEditObjInterfaceHandler::~CFBamCustXmlLoaderHPlusEditObjInterfaceHandler() {
	}

	void CFBamCustXmlLoaderHPlusEditObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusEditObjInterface" ) {
				static const std::string Msg( "Expected QName to be 'HPlusEditObjInterface'" );
	...
	void CFBamCustXmlLoaderHPlusEditObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppEditObjInterfaceNull() || tableObj->getOptionalHppEditObjInterfaceValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppEditObjInterfaceValue( text );
