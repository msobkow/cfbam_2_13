...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusMSSqlSchemaObjIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusMSSqlSchemaObjIncludeHandler" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlSchemaObjIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlSchemaObjIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlSchemaObjIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlSchemaObjIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlSchemaObjIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlSchemaObjIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusMSSqlSchemaObjIncludeHandler::CFBamCustXmlLoaderHPlusMSSqlSchemaObjIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusMSSqlSchemaObjIncludeHandler::~CFBamCustXmlLoaderHPlusMSSqlSchemaObjIncludeHandler() {
	}

	void CFBamCustXmlLoaderHPlusMSSqlSchemaObjIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusMSSqlSchemaObjInclude" ) {
				static const std::string Msg( "Expected QName to be 'HPlusMSSqlSchemaObjInclude'" );
	...
	void CFBamCustXmlLoaderHPlusMSSqlSchemaObjIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppMSSqlSchemaObjIncludeNull() || schemaDefObj->getOptionalHppMSSqlSchemaObjIncludeValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppMSSqlSchemaObjIncludeValue( text );
