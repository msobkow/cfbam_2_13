...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpEditObjInterfaceHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpEditObjInterfaceHandler" );
	const std::string CFBamCustXmlLoaderCSharpEditObjInterfaceHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpEditObjInterfaceHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpEditObjInterfaceHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpEditObjInterfaceHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpEditObjInterfaceHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpEditObjInterfaceHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpEditObjInterfaceHandler::CFBamCustXmlLoaderCSharpEditObjInterfaceHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpEditObjInterfaceHandler::~CFBamCustXmlLoaderCSharpEditObjInterfaceHandler() {
	}

	void CFBamCustXmlLoaderCSharpEditObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpEditObjInterface" ) {
				static const std::string Msg( "Expected QName to be 'CSharpEditObjInterface'" );
	...
	void CFBamCustXmlLoaderCSharpEditObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsEditObjInterfaceNull() || tableObj->getOptionalCsEditObjInterfaceValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsEditObjInterfaceValue( text );
