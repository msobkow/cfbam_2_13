...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusDb2LUWTableIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusDb2LUWTableIncludeHandler" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWTableIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWTableIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWTableIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWTableIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWTableIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWTableIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusDb2LUWTableIncludeHandler::CFBamCustXmlLoaderCPlusDb2LUWTableIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusDb2LUWTableIncludeHandler::~CFBamCustXmlLoaderCPlusDb2LUWTableIncludeHandler() {
	}

	void CFBamCustXmlLoaderCPlusDb2LUWTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusDb2LUWTableInclude" ) {
				static const std::string Msg( "Expected QName to be 'CPlusDb2LUWTableInclude'" );
	...
	void CFBamCustXmlLoaderCPlusDb2LUWTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppDb2LUWTableIncludeNull() || tableObj->getOptionalCppDb2LUWTableIncludeValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppDb2LUWTableIncludeValue( text );
