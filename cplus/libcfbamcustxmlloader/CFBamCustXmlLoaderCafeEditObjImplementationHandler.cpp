...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeEditObjImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeEditObjImplementationHandler" );
	const std::string CFBamCustXmlLoaderCafeEditObjImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeEditObjImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeEditObjImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeEditObjImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeEditObjImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeEditObjImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeEditObjImplementationHandler::CFBamCustXmlLoaderCafeEditObjImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeEditObjImplementationHandler::~CFBamCustXmlLoaderCafeEditObjImplementationHandler() {
	}

	void CFBamCustXmlLoaderCafeEditObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeEditObjImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CafeEditObjImplementation'" );
	...
	void CFBamCustXmlLoaderCafeEditObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJEditObjImplementationNull() || tableObj->getOptionalJEditObjImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJEditObjImplementationValue( text );
