...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderTimeTypeHandler::CLASS_NAME( "CFBamCustXmlLoaderTimeTypeHandler" );
	const std::string CFBamCustXmlLoaderTimeTypeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderTimeTypeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderTimeTypeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderTimeTypeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderTimeTypeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderTimeTypeHandler::S_1( "1" );

	CFBamCustXmlLoaderTimeTypeHandler::CFBamCustXmlLoaderTimeTypeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderTimeTypeHandler::~CFBamCustXmlLoaderTimeTypeHandler() {
	}

	void CFBamCustXmlLoaderTimeTypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "TimeType" ) {
				static const std::string Msg( "Expected QName to be 'TimeType'" );
			...
			origTimeType = dynamic_cast<cfbam::ICFBamTimeTypeObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderTimeTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
