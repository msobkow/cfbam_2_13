...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusSchemaObjIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusSchemaObjIncludeHandler" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusSchemaObjIncludeHandler::CFBamCustXmlLoaderCPlusSchemaObjIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusSchemaObjIncludeHandler::~CFBamCustXmlLoaderCPlusSchemaObjIncludeHandler() {
	}

	void CFBamCustXmlLoaderCPlusSchemaObjIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusSchemaObjInclude" ) {
				static const std::string Msg( "Expected QName to be 'CPlusSchemaObjInclude'" );
	...
	void CFBamCustXmlLoaderCPlusSchemaObjIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppSchemaObjIncludeNull() || schemaDefObj->getOptionalCppSchemaObjIncludeValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppSchemaObjIncludeValue( text );
