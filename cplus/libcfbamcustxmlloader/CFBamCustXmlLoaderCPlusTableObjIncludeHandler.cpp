...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusTableObjIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusTableObjIncludeHandler" );
	const std::string CFBamCustXmlLoaderCPlusTableObjIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusTableObjIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusTableObjIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusTableObjIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusTableObjIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusTableObjIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusTableObjIncludeHandler::CFBamCustXmlLoaderCPlusTableObjIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusTableObjIncludeHandler::~CFBamCustXmlLoaderCPlusTableObjIncludeHandler() {
	}

	void CFBamCustXmlLoaderCPlusTableObjIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusTableObjInclude" ) {
				static const std::string Msg( "Expected QName to be 'CPlusTableObjInclude'" );
	...
	void CFBamCustXmlLoaderCPlusTableObjIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppTableObjIncludeNull() || tableObj->getOptionalCppTableObjIncludeValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppTableObjIncludeValue( text );
