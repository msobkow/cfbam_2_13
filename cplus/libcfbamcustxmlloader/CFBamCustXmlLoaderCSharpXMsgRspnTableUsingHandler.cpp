...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnTableUsingHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpXMsgRspnTableUsingHandler" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnTableUsingHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnTableUsingHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnTableUsingHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnTableUsingHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnTableUsingHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnTableUsingHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpXMsgRspnTableUsingHandler::CFBamCustXmlLoaderCSharpXMsgRspnTableUsingHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpXMsgRspnTableUsingHandler::~CFBamCustXmlLoaderCSharpXMsgRspnTableUsingHandler() {
	}

	void CFBamCustXmlLoaderCSharpXMsgRspnTableUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpXMsgRspnTableUsing" ) {
				static const std::string Msg( "Expected QName to be 'CSharpXMsgRspnTableUsing'" );
	...
	void CFBamCustXmlLoaderCSharpXMsgRspnTableUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsXMsgRspnTableUsingNull() || tableObj->getOptionalCsXMsgRspnTableUsingValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsXMsgRspnTableUsingValue( text );
