...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderId32GenHandler::CLASS_NAME( "CFBamCustXmlLoaderId32GenHandler" );
	const std::string CFBamCustXmlLoaderId32GenHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderId32GenHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderId32GenHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderId32GenHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderId32GenHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderId32GenHandler::S_1( "1" );

	CFBamCustXmlLoaderId32GenHandler::CFBamCustXmlLoaderId32GenHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderId32GenHandler::~CFBamCustXmlLoaderId32GenHandler() {
	}

	void CFBamCustXmlLoaderId32GenHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "Id32Gen" ) {
				static const std::string Msg( "Expected QName to be 'Id32Gen'" );
			...
			origId32Gen = dynamic_cast<cfbam::ICFBamId32GenObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderId32GenHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
