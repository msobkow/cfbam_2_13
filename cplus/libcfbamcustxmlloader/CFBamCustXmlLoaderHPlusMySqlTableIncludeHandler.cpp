...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusMySqlTableIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusMySqlTableIncludeHandler" );
	const std::string CFBamCustXmlLoaderHPlusMySqlTableIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusMySqlTableIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusMySqlTableIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusMySqlTableIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusMySqlTableIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusMySqlTableIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusMySqlTableIncludeHandler::CFBamCustXmlLoaderHPlusMySqlTableIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusMySqlTableIncludeHandler::~CFBamCustXmlLoaderHPlusMySqlTableIncludeHandler() {
	}

	void CFBamCustXmlLoaderHPlusMySqlTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusMySqlTableInclude" ) {
				static const std::string Msg( "Expected QName to be 'HPlusMySqlTableInclude'" );
	...
	void CFBamCustXmlLoaderHPlusMySqlTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppMySqlTableIncludeNull() || tableObj->getOptionalHppMySqlTableIncludeValue().empty() ) {
				std::string text = curContext->getElementText();
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppMySqlTableIncludeValue( text );
