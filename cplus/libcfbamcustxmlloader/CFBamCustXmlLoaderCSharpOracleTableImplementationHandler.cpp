...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpOracleTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpOracleTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderCSharpOracleTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpOracleTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpOracleTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpOracleTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpOracleTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpOracleTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpOracleTableImplementationHandler::CFBamCustXmlLoaderCSharpOracleTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpOracleTableImplementationHandler::~CFBamCustXmlLoaderCSharpOracleTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderCSharpOracleTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpOracleTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CSharpOracleTableImplementation'" );
	...
	void CFBamCustXmlLoaderCSharpOracleTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsOracleTableImplementationNull() || tableObj->getOptionalCsOracleTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsOracleTableImplementationValue( text );
