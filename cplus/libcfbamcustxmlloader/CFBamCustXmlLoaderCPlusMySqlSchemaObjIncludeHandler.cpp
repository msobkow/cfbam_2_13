...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusMySqlSchemaObjIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusMySqlSchemaObjIncludeHandler" );
	const std::string CFBamCustXmlLoaderCPlusMySqlSchemaObjIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusMySqlSchemaObjIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusMySqlSchemaObjIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusMySqlSchemaObjIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusMySqlSchemaObjIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusMySqlSchemaObjIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusMySqlSchemaObjIncludeHandler::CFBamCustXmlLoaderCPlusMySqlSchemaObjIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusMySqlSchemaObjIncludeHandler::~CFBamCustXmlLoaderCPlusMySqlSchemaObjIncludeHandler() {
	}

	void CFBamCustXmlLoaderCPlusMySqlSchemaObjIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusMySqlSchemaObjInclude" ) {
				static const std::string Msg( "Expected QName to be 'CPlusMySqlSchemaObjInclude'" );
	...
	void CFBamCustXmlLoaderCPlusMySqlSchemaObjIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppMySqlSchemaObjIncludeNull() || schemaDefObj->getOptionalCppMySqlSchemaObjIncludeValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppMySqlSchemaObjIncludeValue( text );
