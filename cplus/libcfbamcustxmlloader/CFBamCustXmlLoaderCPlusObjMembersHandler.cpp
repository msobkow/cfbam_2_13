...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusObjMembersHandler" );
	const std::string CFBamCustXmlLoaderCPlusObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusObjMembersHandler::CFBamCustXmlLoaderCPlusObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusObjMembersHandler::~CFBamCustXmlLoaderCPlusObjMembersHandler() {
	}

	void CFBamCustXmlLoaderCPlusObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'CPlusObjMembers'" );
	...
	void CFBamCustXmlLoaderCPlusObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppObjMembersNull() || tableObj->getOptionalCppObjMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppObjMembersValue( text );
