...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstTableBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusXMsgRqstTableBodyHandler" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstTableBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstTableBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstTableBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstTableBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstTableBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstTableBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusXMsgRqstTableBodyHandler::CFBamCustXmlLoaderCPlusXMsgRqstTableBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusXMsgRqstTableBodyHandler::~CFBamCustXmlLoaderCPlusXMsgRqstTableBodyHandler() {
	}

	void CFBamCustXmlLoaderCPlusXMsgRqstTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusXMsgRqstTableBody" ) {
				static const std::string Msg( "Expected QName to be 'CPlusXMsgRqstTableBody'" );
	...
	void CFBamCustXmlLoaderCPlusXMsgRqstTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppXMsgRqstTableBodyNull() || tableObj->getOptionalCppXMsgRqstTableBodyValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppXMsgRqstTableBodyValue( text );
