...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdElementListHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdElementListHandler" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdElementListHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdElementListHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdElementListHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdElementListHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdElementListHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdElementListHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdElementListHandler::CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdElementListHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdElementListHandler::~CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdElementListHandler() {
	}

	void CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdElementListHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusXMsgRqstSchemaXsdElementList" ) {
				static const std::string Msg( "Expected QName to be 'CPlusXMsgRqstSchemaXsdElementList'" );
	...
	void CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdElementListHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppXMsgRqstSchemaXsdElementListNull() || schemaDefObj->getOptionalCppXMsgRqstSchemaXsdElementListValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppXMsgRqstSchemaXsdElementListValue( text );
