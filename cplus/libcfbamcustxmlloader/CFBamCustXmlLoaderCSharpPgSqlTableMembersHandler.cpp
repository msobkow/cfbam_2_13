...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpPgSqlTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpPgSqlTableMembersHandler" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpPgSqlTableMembersHandler::CFBamCustXmlLoaderCSharpPgSqlTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpPgSqlTableMembersHandler::~CFBamCustXmlLoaderCSharpPgSqlTableMembersHandler() {
	}

	void CFBamCustXmlLoaderCSharpPgSqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpPgSqlTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'CSharpPgSqlTableMembers'" );
	...
	void CFBamCustXmlLoaderCSharpPgSqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsPgSqlTableMembersNull() || tableObj->getOptionalCsPgSqlTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsPgSqlTableMembersValue( text );
