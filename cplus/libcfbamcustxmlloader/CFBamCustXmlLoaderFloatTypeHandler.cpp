...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderFloatTypeHandler::CLASS_NAME( "CFBamCustXmlLoaderFloatTypeHandler" );
	const std::string CFBamCustXmlLoaderFloatTypeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderFloatTypeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderFloatTypeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderFloatTypeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderFloatTypeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderFloatTypeHandler::S_1( "1" );

	CFBamCustXmlLoaderFloatTypeHandler::CFBamCustXmlLoaderFloatTypeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderFloatTypeHandler::~CFBamCustXmlLoaderFloatTypeHandler() {
	}

	void CFBamCustXmlLoaderFloatTypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "FloatType" ) {
				static const std::string Msg( "Expected QName to be 'FloatType'" );
			...
			origFloatType = dynamic_cast<cfbam::ICFBamFloatTypeObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderFloatTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
