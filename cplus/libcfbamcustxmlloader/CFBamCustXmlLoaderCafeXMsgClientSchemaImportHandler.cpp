...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeXMsgClientSchemaImportHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeXMsgClientSchemaImportHandler" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientSchemaImportHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientSchemaImportHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientSchemaImportHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientSchemaImportHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientSchemaImportHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientSchemaImportHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeXMsgClientSchemaImportHandler::CFBamCustXmlLoaderCafeXMsgClientSchemaImportHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeXMsgClientSchemaImportHandler::~CFBamCustXmlLoaderCafeXMsgClientSchemaImportHandler() {
	}

	void CFBamCustXmlLoaderCafeXMsgClientSchemaImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeXMsgClientSchemaImport" ) {
				static const std::string Msg( "Expected QName to be 'CafeXMsgClientSchemaImport'" );
	...
	void CFBamCustXmlLoaderCafeXMsgClientSchemaImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJXMsgClientSchemaImportNull() || schemaDefObj->getOptionalJXMsgClientSchemaImportValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJXMsgClientSchemaImportValue( text );
