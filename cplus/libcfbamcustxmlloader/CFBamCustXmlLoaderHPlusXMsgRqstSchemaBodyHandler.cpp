...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusXMsgRqstSchemaBodyHandler" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusXMsgRqstSchemaBodyHandler::CFBamCustXmlLoaderHPlusXMsgRqstSchemaBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusXMsgRqstSchemaBodyHandler::~CFBamCustXmlLoaderHPlusXMsgRqstSchemaBodyHandler() {
	}

	void CFBamCustXmlLoaderHPlusXMsgRqstSchemaBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusXMsgRqstSchemaBody" ) {
				static const std::string Msg( "Expected QName to be 'HPlusXMsgRqstSchemaBody'" );
	...
	void CFBamCustXmlLoaderHPlusXMsgRqstSchemaBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppXMsgRqstSchemaBodyNull() || schemaDefObj->getOptionalHppXMsgRqstSchemaBodyValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppXMsgRqstSchemaBodyValue( text );
