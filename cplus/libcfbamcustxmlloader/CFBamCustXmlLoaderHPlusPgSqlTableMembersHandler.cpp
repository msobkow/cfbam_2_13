...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusPgSqlTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusPgSqlTableMembersHandler" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusPgSqlTableMembersHandler::CFBamCustXmlLoaderHPlusPgSqlTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusPgSqlTableMembersHandler::~CFBamCustXmlLoaderHPlusPgSqlTableMembersHandler() {
	}

	void CFBamCustXmlLoaderHPlusPgSqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusPgSqlTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'HPlusPgSqlTableMembers'" );
	...
	void CFBamCustXmlLoaderHPlusPgSqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppPgSqlTableMembersNull() || tableObj->getOptionalHppPgSqlTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppPgSqlTableMembersValue( text );
