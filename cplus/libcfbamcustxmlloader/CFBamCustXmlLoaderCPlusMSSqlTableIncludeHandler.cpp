...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusMSSqlTableIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusMSSqlTableIncludeHandler" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlTableIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlTableIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlTableIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlTableIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlTableIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlTableIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusMSSqlTableIncludeHandler::CFBamCustXmlLoaderCPlusMSSqlTableIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusMSSqlTableIncludeHandler::~CFBamCustXmlLoaderCPlusMSSqlTableIncludeHandler() {
	}

	void CFBamCustXmlLoaderCPlusMSSqlTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusMSSqlTableInclude" ) {
				static const std::string Msg( "Expected QName to be 'CPlusMSSqlTableInclude'" );
	...
	void CFBamCustXmlLoaderCPlusMSSqlTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppMSSqlTableIncludeNull() || tableObj->getOptionalCppMSSqlTableIncludeValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppMSSqlTableIncludeValue( text );
