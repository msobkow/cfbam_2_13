...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusOracleSchemaObjImplHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusOracleSchemaObjImplHandler" );
	const std::string CFBamCustXmlLoaderCPlusOracleSchemaObjImplHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusOracleSchemaObjImplHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusOracleSchemaObjImplHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusOracleSchemaObjImplHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusOracleSchemaObjImplHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusOracleSchemaObjImplHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusOracleSchemaObjImplHandler::CFBamCustXmlLoaderCPlusOracleSchemaObjImplHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusOracleSchemaObjImplHandler::~CFBamCustXmlLoaderCPlusOracleSchemaObjImplHandler() {
	}

	void CFBamCustXmlLoaderCPlusOracleSchemaObjImplHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusOracleSchemaObjImpl" ) {
				static const std::string Msg( "Expected QName to be 'CPlusOracleSchemaObjImpl'" );
	...
	void CFBamCustXmlLoaderCPlusOracleSchemaObjImplHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppOracleSchemaObjImplNull() || schemaDefObj->getOptionalCppOracleSchemaObjImplValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppOracleSchemaObjImplValue( text );
