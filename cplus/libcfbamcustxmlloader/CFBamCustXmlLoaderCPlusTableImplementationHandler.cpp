...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderCPlusTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusTableImplementationHandler::CFBamCustXmlLoaderCPlusTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusTableImplementationHandler::~CFBamCustXmlLoaderCPlusTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderCPlusTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CPlusTableImplementation'" );
	...
	void CFBamCustXmlLoaderCPlusTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppTableImplementationNull() || tableObj->getOptionalCppTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppTableImplementationValue( text );
