...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderDoubleTypeHandler::CLASS_NAME( "CFBamCustXmlLoaderDoubleTypeHandler" );
	const std::string CFBamCustXmlLoaderDoubleTypeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderDoubleTypeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderDoubleTypeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderDoubleTypeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderDoubleTypeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderDoubleTypeHandler::S_1( "1" );

	CFBamCustXmlLoaderDoubleTypeHandler::CFBamCustXmlLoaderDoubleTypeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderDoubleTypeHandler::~CFBamCustXmlLoaderDoubleTypeHandler() {
	}

	void CFBamCustXmlLoaderDoubleTypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "DoubleType" ) {
				static const std::string Msg( "Expected QName to be 'DoubleType'" );
			...
			origDoubleType = dynamic_cast<cfbam::ICFBamDoubleTypeObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderDoubleTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
