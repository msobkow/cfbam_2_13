...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpXMsgRspnSchemaBodyHandler" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpXMsgRspnSchemaBodyHandler::CFBamCustXmlLoaderCSharpXMsgRspnSchemaBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpXMsgRspnSchemaBodyHandler::~CFBamCustXmlLoaderCSharpXMsgRspnSchemaBodyHandler() {
	}

	void CFBamCustXmlLoaderCSharpXMsgRspnSchemaBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpXMsgRspnSchemaBody" ) {
				static const std::string Msg( "Expected QName to be 'CSharpXMsgRspnSchemaBody'" );
	...
	void CFBamCustXmlLoaderCSharpXMsgRspnSchemaBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsXMsgRspnSchemaBodyNull() || schemaDefObj->getOptionalCsXMsgRspnSchemaBodyValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsXMsgRspnSchemaBodyValue( text );
