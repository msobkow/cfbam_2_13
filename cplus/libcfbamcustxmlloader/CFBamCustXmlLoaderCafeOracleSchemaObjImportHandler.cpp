...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeOracleSchemaObjImportHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeOracleSchemaObjImportHandler" );
	const std::string CFBamCustXmlLoaderCafeOracleSchemaObjImportHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeOracleSchemaObjImportHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeOracleSchemaObjImportHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeOracleSchemaObjImportHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeOracleSchemaObjImportHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeOracleSchemaObjImportHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeOracleSchemaObjImportHandler::CFBamCustXmlLoaderCafeOracleSchemaObjImportHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeOracleSchemaObjImportHandler::~CFBamCustXmlLoaderCafeOracleSchemaObjImportHandler() {
	}

	void CFBamCustXmlLoaderCafeOracleSchemaObjImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeOracleSchemaObjImport" ) {
				static const std::string Msg( "Expected QName to be 'CafeOracleSchemaObjImport'" );
	...
	void CFBamCustXmlLoaderCafeOracleSchemaObjImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJOracleSchemaObjImportNull() || schemaDefObj->getOptionalJOracleSchemaObjImportValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJOracleSchemaObjImportValue( text );
