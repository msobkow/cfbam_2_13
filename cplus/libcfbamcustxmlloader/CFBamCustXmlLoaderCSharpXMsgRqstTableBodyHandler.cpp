...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstTableBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpXMsgRqstTableBodyHandler" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstTableBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstTableBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstTableBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstTableBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstTableBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstTableBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpXMsgRqstTableBodyHandler::CFBamCustXmlLoaderCSharpXMsgRqstTableBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpXMsgRqstTableBodyHandler::~CFBamCustXmlLoaderCSharpXMsgRqstTableBodyHandler() {
	}

	void CFBamCustXmlLoaderCSharpXMsgRqstTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpXMsgRqstTableBody" ) {
				static const std::string Msg( "Expected QName to be 'CSharpXMsgRqstTableBody'" );
	...
	void CFBamCustXmlLoaderCSharpXMsgRqstTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsXMsgRqstTableBodyNull() || tableObj->getOptionalCsXMsgRqstTableBodyValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsXMsgRqstTableBodyValue( text );
