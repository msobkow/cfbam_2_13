...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusDb2LUWTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusDb2LUWTableMembersHandler" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusDb2LUWTableMembersHandler::CFBamCustXmlLoaderHPlusDb2LUWTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusDb2LUWTableMembersHandler::~CFBamCustXmlLoaderHPlusDb2LUWTableMembersHandler() {
	}

	void CFBamCustXmlLoaderHPlusDb2LUWTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusDb2LUWTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'HPlusDb2LUWTableMembers'" );
	...
	void CFBamCustXmlLoaderHPlusDb2LUWTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppDb2LUWTableMembersNull() || tableObj->getOptionalHppDb2LUWTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppDb2LUWTableMembersValue( text );
