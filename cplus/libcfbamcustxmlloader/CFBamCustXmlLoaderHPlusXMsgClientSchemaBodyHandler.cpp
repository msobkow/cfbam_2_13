...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusXMsgClientSchemaBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusXMsgClientSchemaBodyHandler" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientSchemaBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientSchemaBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientSchemaBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientSchemaBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientSchemaBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientSchemaBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusXMsgClientSchemaBodyHandler::CFBamCustXmlLoaderHPlusXMsgClientSchemaBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusXMsgClientSchemaBodyHandler::~CFBamCustXmlLoaderHPlusXMsgClientSchemaBodyHandler() {
	}

	void CFBamCustXmlLoaderHPlusXMsgClientSchemaBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusXMsgClientSchemaBody" ) {
				static const std::string Msg( "Expected QName to be 'HPlusXMsgClientSchemaBody'" );
	...
	void CFBamCustXmlLoaderHPlusXMsgClientSchemaBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppXMsgClientSchemaBodyNull() || schemaDefObj->getOptionalHppXMsgClientSchemaBodyValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppXMsgClientSchemaBodyValue( text );
