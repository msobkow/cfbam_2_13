...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpTableUsingHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpTableUsingHandler" );
	const std::string CFBamCustXmlLoaderCSharpTableUsingHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpTableUsingHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpTableUsingHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpTableUsingHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpTableUsingHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpTableUsingHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpTableUsingHandler::CFBamCustXmlLoaderCSharpTableUsingHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpTableUsingHandler::~CFBamCustXmlLoaderCSharpTableUsingHandler() {
	}

	void CFBamCustXmlLoaderCSharpTableUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpTableUsing" ) {
				static const std::string Msg( "Expected QName to be 'CSharpTableUsing'" );
	...
	void CFBamCustXmlLoaderCSharpTableUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsTableUsingNull() || tableObj->getOptionalCsTableUsingValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsTableUsingValue( text );
