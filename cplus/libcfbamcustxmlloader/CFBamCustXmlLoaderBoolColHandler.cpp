...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderBoolColHandler::CLASS_NAME( "CFBamCustXmlLoaderBoolColHandler" );
	const std::string CFBamCustXmlLoaderBoolColHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderBoolColHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderBoolColHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderBoolColHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderBoolColHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderBoolColHandler::S_1( "1" );

	CFBamCustXmlLoaderBoolColHandler::CFBamCustXmlLoaderBoolColHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderBoolColHandler::~CFBamCustXmlLoaderBoolColHandler() {
	}

	void CFBamCustXmlLoaderBoolColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "BoolCol" ) {
				static const std::string Msg( "Expected QName to be 'BoolCol'" );
			...
			origBoolCol = dynamic_cast<cfbam::ICFBamBoolColObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderBoolColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
