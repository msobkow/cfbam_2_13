...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeMySqlSchemaObjImportHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeMySqlSchemaObjImportHandler" );
	const std::string CFBamCustXmlLoaderCafeMySqlSchemaObjImportHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeMySqlSchemaObjImportHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeMySqlSchemaObjImportHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeMySqlSchemaObjImportHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeMySqlSchemaObjImportHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeMySqlSchemaObjImportHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeMySqlSchemaObjImportHandler::CFBamCustXmlLoaderCafeMySqlSchemaObjImportHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeMySqlSchemaObjImportHandler::~CFBamCustXmlLoaderCafeMySqlSchemaObjImportHandler() {
	}

	void CFBamCustXmlLoaderCafeMySqlSchemaObjImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeMySqlSchemaObjImport" ) {
				static const std::string Msg( "Expected QName to be 'CafeMySqlSchemaObjImport'" );
	...
	void CFBamCustXmlLoaderCafeMySqlSchemaObjImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJMySqlSchemaObjImportNull() || schemaDefObj->getOptionalJMySqlSchemaObjImportValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJMySqlSchemaObjImportValue( text );
