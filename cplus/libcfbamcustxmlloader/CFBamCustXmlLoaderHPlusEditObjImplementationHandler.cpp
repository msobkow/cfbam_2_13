...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusEditObjImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusEditObjImplementationHandler" );
	const std::string CFBamCustXmlLoaderHPlusEditObjImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusEditObjImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusEditObjImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusEditObjImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusEditObjImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusEditObjImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusEditObjImplementationHandler::CFBamCustXmlLoaderHPlusEditObjImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusEditObjImplementationHandler::~CFBamCustXmlLoaderHPlusEditObjImplementationHandler() {
	}

	void CFBamCustXmlLoaderHPlusEditObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusEditObjImplementation" ) {
				static const std::string Msg( "Expected QName to be 'HPlusEditObjImplementation'" );
	...
	void CFBamCustXmlLoaderHPlusEditObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppEditObjImplementationNull() || tableObj->getOptionalHppEditObjImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppEditObjImplementationValue( text );
