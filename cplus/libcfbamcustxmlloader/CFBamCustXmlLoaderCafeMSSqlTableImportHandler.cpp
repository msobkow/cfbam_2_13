...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeMSSqlTableImportHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeMSSqlTableImportHandler" );
	const std::string CFBamCustXmlLoaderCafeMSSqlTableImportHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeMSSqlTableImportHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeMSSqlTableImportHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeMSSqlTableImportHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeMSSqlTableImportHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeMSSqlTableImportHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeMSSqlTableImportHandler::CFBamCustXmlLoaderCafeMSSqlTableImportHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeMSSqlTableImportHandler::~CFBamCustXmlLoaderCafeMSSqlTableImportHandler() {
	}

	void CFBamCustXmlLoaderCafeMSSqlTableImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeMSSqlTableImport" ) {
				static const std::string Msg( "Expected QName to be 'CafeMSSqlTableImport'" );
	...
	void CFBamCustXmlLoaderCafeMSSqlTableImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJMSSqlTableImportNull() || tableObj->getOptionalJMSSqlTableImportValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJMSSqlTableImportValue( text );
