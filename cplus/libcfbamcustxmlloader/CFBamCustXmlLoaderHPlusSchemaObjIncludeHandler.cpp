...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusSchemaObjIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusSchemaObjIncludeHandler" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusSchemaObjIncludeHandler::CFBamCustXmlLoaderHPlusSchemaObjIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusSchemaObjIncludeHandler::~CFBamCustXmlLoaderHPlusSchemaObjIncludeHandler() {
	}

	void CFBamCustXmlLoaderHPlusSchemaObjIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusSchemaObjInclude" ) {
				static const std::string Msg( "Expected QName to be 'HPlusSchemaObjInclude'" );
	...
	void CFBamCustXmlLoaderHPlusSchemaObjIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppSchemaObjIncludeNull() || schemaDefObj->getOptionalHppSchemaObjIncludeValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppSchemaObjIncludeValue( text );
