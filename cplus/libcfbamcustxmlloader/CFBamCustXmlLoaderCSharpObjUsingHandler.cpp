...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpObjUsingHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpObjUsingHandler" );
	const std::string CFBamCustXmlLoaderCSharpObjUsingHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpObjUsingHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpObjUsingHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpObjUsingHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpObjUsingHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpObjUsingHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpObjUsingHandler::CFBamCustXmlLoaderCSharpObjUsingHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpObjUsingHandler::~CFBamCustXmlLoaderCSharpObjUsingHandler() {
	}

	void CFBamCustXmlLoaderCSharpObjUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpObjUsing" ) {
				static const std::string Msg( "Expected QName to be 'CSharpObjUsing'" );
	...
	void CFBamCustXmlLoaderCSharpObjUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsObjUsingNull() || tableObj->getOptionalCsObjUsingValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsObjUsingValue( text );
