...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusRamSchemaObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusRamSchemaObjMembersHandler" );
	const std::string CFBamCustXmlLoaderHPlusRamSchemaObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusRamSchemaObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusRamSchemaObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusRamSchemaObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusRamSchemaObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusRamSchemaObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusRamSchemaObjMembersHandler::CFBamCustXmlLoaderHPlusRamSchemaObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusRamSchemaObjMembersHandler::~CFBamCustXmlLoaderHPlusRamSchemaObjMembersHandler() {
	}

	void CFBamCustXmlLoaderHPlusRamSchemaObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusRamSchemaObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'HPlusRamSchemaObjMembers'" );
	...
	void CFBamCustXmlLoaderHPlusRamSchemaObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppRamSchemaObjMembersNull() || schemaDefObj->getOptionalHppRamSchemaObjMembersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppRamSchemaObjMembersValue( text );
