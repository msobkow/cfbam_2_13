...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusXMsgRspnSchemaBodyHandler" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusXMsgRspnSchemaBodyHandler::CFBamCustXmlLoaderHPlusXMsgRspnSchemaBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusXMsgRspnSchemaBodyHandler::~CFBamCustXmlLoaderHPlusXMsgRspnSchemaBodyHandler() {
	}

	void CFBamCustXmlLoaderHPlusXMsgRspnSchemaBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusXMsgRspnSchemaBody" ) {
				static const std::string Msg( "Expected QName to be 'HPlusXMsgRspnSchemaBody'" );
	...
	void CFBamCustXmlLoaderHPlusXMsgRspnSchemaBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppXMsgRspnSchemaBodyNull() || schemaDefObj->getOptionalHppXMsgRspnSchemaBodyValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppXMsgRspnSchemaBodyValue( text );
