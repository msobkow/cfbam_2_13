...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusTableObjIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusTableObjIncludeHandler" );
	const std::string CFBamCustXmlLoaderHPlusTableObjIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusTableObjIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusTableObjIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusTableObjIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusTableObjIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusTableObjIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusTableObjIncludeHandler::CFBamCustXmlLoaderHPlusTableObjIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusTableObjIncludeHandler::~CFBamCustXmlLoaderHPlusTableObjIncludeHandler() {
	}

	void CFBamCustXmlLoaderHPlusTableObjIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusTableObjInclude" ) {
				static const std::string Msg( "Expected QName to be 'HPlusTableObjInclude'" );
	...
	void CFBamCustXmlLoaderHPlusTableObjIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppTableObjIncludeNull() || tableObj->getOptionalHppTableObjIncludeValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppTableObjIncludeValue( text );
