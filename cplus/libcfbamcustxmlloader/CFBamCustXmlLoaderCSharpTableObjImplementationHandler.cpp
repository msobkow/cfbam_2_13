...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpTableObjImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpTableObjImplementationHandler" );
	const std::string CFBamCustXmlLoaderCSharpTableObjImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpTableObjImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpTableObjImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpTableObjImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpTableObjImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpTableObjImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpTableObjImplementationHandler::CFBamCustXmlLoaderCSharpTableObjImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpTableObjImplementationHandler::~CFBamCustXmlLoaderCSharpTableObjImplementationHandler() {
	}

	void CFBamCustXmlLoaderCSharpTableObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpTableObjImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CSharpTableObjImplementation'" );
	...
	void CFBamCustXmlLoaderCSharpTableObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsTableObjImplementationNull() || tableObj->getOptionalCsTableObjImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsTableObjImplementationValue( text );
