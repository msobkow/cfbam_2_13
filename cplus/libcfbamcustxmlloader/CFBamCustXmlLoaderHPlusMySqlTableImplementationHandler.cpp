...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusMySqlTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusMySqlTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderHPlusMySqlTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusMySqlTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusMySqlTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusMySqlTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusMySqlTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusMySqlTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusMySqlTableImplementationHandler::CFBamCustXmlLoaderHPlusMySqlTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusMySqlTableImplementationHandler::~CFBamCustXmlLoaderHPlusMySqlTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderHPlusMySqlTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusMySqlTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'HPlusMySqlTableImplementation'" );
	...
	void CFBamCustXmlLoaderHPlusMySqlTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppMySqlTableImplementationNull() || tableObj->getOptionalHppMySqlTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppMySqlTableImplementationValue( text );
