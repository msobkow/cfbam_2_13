...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderTextColHandler::CLASS_NAME( "CFBamCustXmlLoaderTextColHandler" );
	const std::string CFBamCustXmlLoaderTextColHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderTextColHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderTextColHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderTextColHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderTextColHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderTextColHandler::S_1( "1" );

	CFBamCustXmlLoaderTextColHandler::CFBamCustXmlLoaderTextColHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderTextColHandler::~CFBamCustXmlLoaderTextColHandler() {
	}

	void CFBamCustXmlLoaderTextColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "TextCol" ) {
				static const std::string Msg( "Expected QName to be 'TextCol'" );
			...
			origTextCol = dynamic_cast<cfbam::ICFBamTextColObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderTextColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
