...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeDb2LUWSchemaObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeDb2LUWSchemaObjMembersHandler" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWSchemaObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWSchemaObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWSchemaObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWSchemaObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWSchemaObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWSchemaObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeDb2LUWSchemaObjMembersHandler::CFBamCustXmlLoaderCafeDb2LUWSchemaObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeDb2LUWSchemaObjMembersHandler::~CFBamCustXmlLoaderCafeDb2LUWSchemaObjMembersHandler() {
	}

	void CFBamCustXmlLoaderCafeDb2LUWSchemaObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeDb2LUWSchemaObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'CafeDb2LUWSchemaObjMembers'" );
	...
	void CFBamCustXmlLoaderCafeDb2LUWSchemaObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJDb2LUWSchemaObjMembersNull() || schemaDefObj->getOptionalJDb2LUWSchemaObjMembersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJDb2LUWSchemaObjMembersValue( text );
