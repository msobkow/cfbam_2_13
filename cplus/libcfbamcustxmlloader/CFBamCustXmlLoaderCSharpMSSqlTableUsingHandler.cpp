...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpMSSqlTableUsingHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpMSSqlTableUsingHandler" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlTableUsingHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlTableUsingHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlTableUsingHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlTableUsingHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlTableUsingHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlTableUsingHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpMSSqlTableUsingHandler::CFBamCustXmlLoaderCSharpMSSqlTableUsingHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpMSSqlTableUsingHandler::~CFBamCustXmlLoaderCSharpMSSqlTableUsingHandler() {
	}

	void CFBamCustXmlLoaderCSharpMSSqlTableUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpMSSqlTableUsing" ) {
				static const std::string Msg( "Expected QName to be 'CSharpMSSqlTableUsing'" );
	...
	void CFBamCustXmlLoaderCSharpMSSqlTableUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsMSSqlTableUsingNull() || tableObj->getOptionalCsMSSqlTableUsingValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsMSSqlTableUsingValue( text );
