...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderCSharpTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpTableImplementationHandler::CFBamCustXmlLoaderCSharpTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpTableImplementationHandler::~CFBamCustXmlLoaderCSharpTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderCSharpTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CSharpTableImplementation'" );
	...
	void CFBamCustXmlLoaderCSharpTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsTableImplementationNull() || tableObj->getOptionalCsTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsTableImplementationValue( text );
