...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaImportHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeXMsgRqstSchemaImportHandler" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaImportHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaImportHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaImportHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaImportHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaImportHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaImportHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeXMsgRqstSchemaImportHandler::CFBamCustXmlLoaderCafeXMsgRqstSchemaImportHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeXMsgRqstSchemaImportHandler::~CFBamCustXmlLoaderCafeXMsgRqstSchemaImportHandler() {
	}

	void CFBamCustXmlLoaderCafeXMsgRqstSchemaImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeXMsgRqstSchemaImport" ) {
				static const std::string Msg( "Expected QName to be 'CafeXMsgRqstSchemaImport'" );
	...
	void CFBamCustXmlLoaderCafeXMsgRqstSchemaImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJXMsgRqstSchemaImportNull() || schemaDefObj->getOptionalJXMsgRqstSchemaImportValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJXMsgRqstSchemaImportValue( text );
