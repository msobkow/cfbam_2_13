...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeTableObjImportHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeTableObjImportHandler" );
	const std::string CFBamCustXmlLoaderCafeTableObjImportHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeTableObjImportHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeTableObjImportHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeTableObjImportHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeTableObjImportHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeTableObjImportHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeTableObjImportHandler::CFBamCustXmlLoaderCafeTableObjImportHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeTableObjImportHandler::~CFBamCustXmlLoaderCafeTableObjImportHandler() {
	}

	void CFBamCustXmlLoaderCafeTableObjImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeTableObjImport" ) {
				static const std::string Msg( "Expected QName to be 'CafeTableObjImport'" );
	...
	void CFBamCustXmlLoaderCafeTableObjImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJTableObjImportNull() || tableObj->getOptionalJTableObjImportValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJTableObjImportValue( text );
