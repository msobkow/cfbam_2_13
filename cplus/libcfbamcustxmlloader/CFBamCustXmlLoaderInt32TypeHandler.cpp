...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderInt32TypeHandler::CLASS_NAME( "CFBamCustXmlLoaderInt32TypeHandler" );
	const std::string CFBamCustXmlLoaderInt32TypeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderInt32TypeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderInt32TypeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderInt32TypeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderInt32TypeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderInt32TypeHandler::S_1( "1" );

	CFBamCustXmlLoaderInt32TypeHandler::CFBamCustXmlLoaderInt32TypeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderInt32TypeHandler::~CFBamCustXmlLoaderInt32TypeHandler() {
	}

	void CFBamCustXmlLoaderInt32TypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "Int32Type" ) {
				static const std::string Msg( "Expected QName to be 'Int32Type'" );
			...
			origInt32Type = dynamic_cast<cfbam::ICFBamInt32TypeObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderInt32TypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
