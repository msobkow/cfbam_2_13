...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeXMsgSchemaImportHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeXMsgSchemaImportHandler" );
	const std::string CFBamCustXmlLoaderCafeXMsgSchemaImportHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeXMsgSchemaImportHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeXMsgSchemaImportHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeXMsgSchemaImportHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeXMsgSchemaImportHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeXMsgSchemaImportHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeXMsgSchemaImportHandler::CFBamCustXmlLoaderCafeXMsgSchemaImportHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeXMsgSchemaImportHandler::~CFBamCustXmlLoaderCafeXMsgSchemaImportHandler() {
	}

	void CFBamCustXmlLoaderCafeXMsgSchemaImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeXMsgSchemaImport" ) {
				static const std::string Msg( "Expected QName to be 'CafeXMsgSchemaImport'" );
	...
	void CFBamCustXmlLoaderCafeXMsgSchemaImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJXMsgSchemaImportNull() || schemaDefObj->getOptionalJXMsgSchemaImportValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJXMsgSchemaImportValue( text );
