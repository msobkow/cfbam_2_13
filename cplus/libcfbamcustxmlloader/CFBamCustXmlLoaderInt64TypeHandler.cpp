...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderInt64TypeHandler::CLASS_NAME( "CFBamCustXmlLoaderInt64TypeHandler" );
	const std::string CFBamCustXmlLoaderInt64TypeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderInt64TypeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderInt64TypeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderInt64TypeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderInt64TypeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderInt64TypeHandler::S_1( "1" );

	CFBamCustXmlLoaderInt64TypeHandler::CFBamCustXmlLoaderInt64TypeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderInt64TypeHandler::~CFBamCustXmlLoaderInt64TypeHandler() {
	}

	void CFBamCustXmlLoaderInt64TypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "Int64Type" ) {
				static const std::string Msg( "Expected QName to be 'Int64Type'" );
			...
			origInt64Type = dynamic_cast<cfbam::ICFBamInt64TypeObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderInt64TypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
