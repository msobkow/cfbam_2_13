...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaWireParsersHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusXMsgRqstSchemaWireParsersHandler" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaWireParsersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaWireParsersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaWireParsersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaWireParsersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaWireParsersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaWireParsersHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusXMsgRqstSchemaWireParsersHandler::CFBamCustXmlLoaderHPlusXMsgRqstSchemaWireParsersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusXMsgRqstSchemaWireParsersHandler::~CFBamCustXmlLoaderHPlusXMsgRqstSchemaWireParsersHandler() {
	}

	void CFBamCustXmlLoaderHPlusXMsgRqstSchemaWireParsersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusXMsgRqstSchemaWireParsers" ) {
				static const std::string Msg( "Expected QName to be 'HPlusXMsgRqstSchemaWireParsers'" );
	...
	void CFBamCustXmlLoaderHPlusXMsgRqstSchemaWireParsersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppXMsgRqstSchemaWireParsersNull() || schemaDefObj->getOptionalHppXMsgRqstSchemaWireParsersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppXMsgRqstSchemaWireParsersValue( text );
