...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeXMsgRqstTableBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeXMsgRqstTableBodyHandler" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstTableBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstTableBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstTableBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstTableBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstTableBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstTableBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeXMsgRqstTableBodyHandler::CFBamCustXmlLoaderCafeXMsgRqstTableBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeXMsgRqstTableBodyHandler::~CFBamCustXmlLoaderCafeXMsgRqstTableBodyHandler() {
	}

	void CFBamCustXmlLoaderCafeXMsgRqstTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeXMsgRqstTableBody" ) {
				static const std::string Msg( "Expected QName to be 'CafeXMsgRqstTableBody'" );
	...
	void CFBamCustXmlLoaderCafeXMsgRqstTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJXMsgRqstTableBodyNull() || tableObj->getOptionalJXMsgRqstTableBodyValue().empty() ) {
				std::string text = curContext->getElementText();
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJXMsgRqstTableBodyValue( text );
