...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusTableIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusTableIncludeHandler" );
	const std::string CFBamCustXmlLoaderCPlusTableIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusTableIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusTableIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusTableIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusTableIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusTableIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusTableIncludeHandler::CFBamCustXmlLoaderCPlusTableIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusTableIncludeHandler::~CFBamCustXmlLoaderCPlusTableIncludeHandler() {
	}

	void CFBamCustXmlLoaderCPlusTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusTableInclude" ) {
				static const std::string Msg( "Expected QName to be 'CPlusTableInclude'" );
	...
	void CFBamCustXmlLoaderCPlusTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppTableIncludeNull() || tableObj->getOptionalCppTableIncludeValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppTableIncludeValue( text );
