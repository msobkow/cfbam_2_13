...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeObjImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeObjImplementationHandler" );
	const std::string CFBamCustXmlLoaderCafeObjImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeObjImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeObjImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeObjImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeObjImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeObjImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeObjImplementationHandler::CFBamCustXmlLoaderCafeObjImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeObjImplementationHandler::~CFBamCustXmlLoaderCafeObjImplementationHandler() {
	}

	void CFBamCustXmlLoaderCafeObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeObjImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CafeObjImplementation'" );
	...
	void CFBamCustXmlLoaderCafeObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJObjImplementationNull() || tableObj->getOptionalJObjImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJObjImplementationValue( text );
