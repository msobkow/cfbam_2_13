...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdSpecHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdSpecHandler" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdSpecHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdSpecHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdSpecHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdSpecHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdSpecHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdSpecHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdSpecHandler::CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdSpecHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdSpecHandler::~CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdSpecHandler() {
	}

	void CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdSpecHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeXMsgRqstSchemaXsdSpec" ) {
				static const std::string Msg( "Expected QName to be 'CafeXMsgRqstSchemaXsdSpec'" );
	...
	void CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdSpecHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJXMsgRqstSchemaXsdSpecNull() || schemaDefObj->getOptionalJXMsgRqstSchemaXsdSpecValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJXMsgRqstSchemaXsdSpecValue( text );
