...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeMSSqlTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeMSSqlTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderCafeMSSqlTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeMSSqlTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeMSSqlTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeMSSqlTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeMSSqlTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeMSSqlTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeMSSqlTableImplementationHandler::CFBamCustXmlLoaderCafeMSSqlTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeMSSqlTableImplementationHandler::~CFBamCustXmlLoaderCafeMSSqlTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderCafeMSSqlTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeMSSqlTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CafeMSSqlTableImplementation'" );
	...
	void CFBamCustXmlLoaderCafeMSSqlTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJMSSqlTableImplementationNull() || tableObj->getOptionalJMSSqlTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJMSSqlTableImplementationValue( text );
