...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusDb2LUWSchemaObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusDb2LUWSchemaObjMembersHandler" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWSchemaObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWSchemaObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWSchemaObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWSchemaObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWSchemaObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWSchemaObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusDb2LUWSchemaObjMembersHandler::CFBamCustXmlLoaderCPlusDb2LUWSchemaObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusDb2LUWSchemaObjMembersHandler::~CFBamCustXmlLoaderCPlusDb2LUWSchemaObjMembersHandler() {
	}

	void CFBamCustXmlLoaderCPlusDb2LUWSchemaObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusDb2LUWSchemaObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'CPlusDb2LUWSchemaObjMembers'" );
	...
	void CFBamCustXmlLoaderCPlusDb2LUWSchemaObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppDb2LUWSchemaObjMembersNull() || schemaDefObj->getOptionalCppDb2LUWSchemaObjMembersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppDb2LUWSchemaObjMembersValue( text );
