...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderMinorVersionHandler::CLASS_NAME( "CFBamCustXmlLoaderMinorVersionHandler" );
	const std::string CFBamCustXmlLoaderMinorVersionHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderMinorVersionHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderMinorVersionHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderMinorVersionHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderMinorVersionHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderMinorVersionHandler::S_1( "1" );

	CFBamCustXmlLoaderMinorVersionHandler::CFBamCustXmlLoaderMinorVersionHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderMinorVersionHandler::~CFBamCustXmlLoaderMinorVersionHandler() {
	}

	void CFBamCustXmlLoaderMinorVersionHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "MinorVersion" ) {
				static const std::string Msg( "Expected QName to be 'MinorVersion'" );
...
cleanup:
	...
	void CFBamCustXmlLoaderMinorVersionHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
