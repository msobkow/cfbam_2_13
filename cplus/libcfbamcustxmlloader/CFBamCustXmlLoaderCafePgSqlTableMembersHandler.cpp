...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafePgSqlTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCafePgSqlTableMembersHandler" );
	const std::string CFBamCustXmlLoaderCafePgSqlTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafePgSqlTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafePgSqlTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafePgSqlTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafePgSqlTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafePgSqlTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCafePgSqlTableMembersHandler::CFBamCustXmlLoaderCafePgSqlTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafePgSqlTableMembersHandler::~CFBamCustXmlLoaderCafePgSqlTableMembersHandler() {
	}

	void CFBamCustXmlLoaderCafePgSqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafePgSqlTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'CafePgSqlTableMembers'" );
	...
	void CFBamCustXmlLoaderCafePgSqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJPgSqlTableMembersNull() || tableObj->getOptionalJPgSqlTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJPgSqlTableMembersValue( text );
