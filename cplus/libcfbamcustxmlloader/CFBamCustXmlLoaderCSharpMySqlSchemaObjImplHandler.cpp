...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpMySqlSchemaObjImplHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpMySqlSchemaObjImplHandler" );
	const std::string CFBamCustXmlLoaderCSharpMySqlSchemaObjImplHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpMySqlSchemaObjImplHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpMySqlSchemaObjImplHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpMySqlSchemaObjImplHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpMySqlSchemaObjImplHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpMySqlSchemaObjImplHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpMySqlSchemaObjImplHandler::CFBamCustXmlLoaderCSharpMySqlSchemaObjImplHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpMySqlSchemaObjImplHandler::~CFBamCustXmlLoaderCSharpMySqlSchemaObjImplHandler() {
	}

	void CFBamCustXmlLoaderCSharpMySqlSchemaObjImplHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpMySqlSchemaObjImpl" ) {
				static const std::string Msg( "Expected QName to be 'CSharpMySqlSchemaObjImpl'" );
	...
	void CFBamCustXmlLoaderCSharpMySqlSchemaObjImplHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsMySqlSchemaObjImplNull() || schemaDefObj->getOptionalCsMySqlSchemaObjImplValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsMySqlSchemaObjImplValue( text );
