...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderDoubleColHandler::CLASS_NAME( "CFBamCustXmlLoaderDoubleColHandler" );
	const std::string CFBamCustXmlLoaderDoubleColHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderDoubleColHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderDoubleColHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderDoubleColHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderDoubleColHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderDoubleColHandler::S_1( "1" );

	CFBamCustXmlLoaderDoubleColHandler::CFBamCustXmlLoaderDoubleColHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderDoubleColHandler::~CFBamCustXmlLoaderDoubleColHandler() {
	}

	void CFBamCustXmlLoaderDoubleColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "DoubleCol" ) {
				static const std::string Msg( "Expected QName to be 'DoubleCol'" );
			...
			origDoubleCol = dynamic_cast<cfbam::ICFBamDoubleColObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderDoubleColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
