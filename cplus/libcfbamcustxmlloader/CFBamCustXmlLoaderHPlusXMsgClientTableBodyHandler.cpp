...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusXMsgClientTableBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusXMsgClientTableBodyHandler" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientTableBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientTableBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientTableBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientTableBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientTableBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientTableBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusXMsgClientTableBodyHandler::CFBamCustXmlLoaderHPlusXMsgClientTableBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusXMsgClientTableBodyHandler::~CFBamCustXmlLoaderHPlusXMsgClientTableBodyHandler() {
	}

	void CFBamCustXmlLoaderHPlusXMsgClientTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusXMsgClientTableBody" ) {
				static const std::string Msg( "Expected QName to be 'HPlusXMsgClientTableBody'" );
	...
	void CFBamCustXmlLoaderHPlusXMsgClientTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppXMsgClientTableBodyNull() || tableObj->getOptionalHppXMsgClientTableBodyValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppXMsgClientTableBodyValue( text );
