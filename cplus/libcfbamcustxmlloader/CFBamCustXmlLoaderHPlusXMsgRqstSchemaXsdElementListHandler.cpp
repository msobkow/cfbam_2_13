...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdElementListHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdElementListHandler" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdElementListHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdElementListHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdElementListHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdElementListHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdElementListHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdElementListHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdElementListHandler::CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdElementListHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdElementListHandler::~CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdElementListHandler() {
	}

	void CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdElementListHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusXMsgRqstSchemaXsdElementList" ) {
				static const std::string Msg( "Expected QName to be 'HPlusXMsgRqstSchemaXsdElementList'" );
	...
	void CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdElementListHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppXMsgRqstSchemaXsdElementListNull() || schemaDefObj->getOptionalHppXMsgRqstSchemaXsdElementListValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppXMsgRqstSchemaXsdElementListValue( text );
