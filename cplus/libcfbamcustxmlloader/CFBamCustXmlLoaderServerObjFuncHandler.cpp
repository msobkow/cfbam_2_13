...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderServerObjFuncHandler::CLASS_NAME( "CFBamCustXmlLoaderServerObjFuncHandler" );
	const std::string CFBamCustXmlLoaderServerObjFuncHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderServerObjFuncHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderServerObjFuncHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderServerObjFuncHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderServerObjFuncHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderServerObjFuncHandler::S_1( "1" );

	CFBamCustXmlLoaderServerObjFuncHandler::CFBamCustXmlLoaderServerObjFuncHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderServerObjFuncHandler::~CFBamCustXmlLoaderServerObjFuncHandler() {
	}

	void CFBamCustXmlLoaderServerObjFuncHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "ServerObjFunc" ) {
				static const std::string Msg( "Expected QName to be 'ServerObjFunc'" );
			...
			origServerObjFunc = dynamic_cast<cfbam::ICFBamServerObjFuncObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderServerObjFuncHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
