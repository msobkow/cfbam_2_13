...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpOracleSchemaObjImplHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpOracleSchemaObjImplHandler" );
	const std::string CFBamCustXmlLoaderCSharpOracleSchemaObjImplHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpOracleSchemaObjImplHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpOracleSchemaObjImplHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpOracleSchemaObjImplHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpOracleSchemaObjImplHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpOracleSchemaObjImplHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpOracleSchemaObjImplHandler::CFBamCustXmlLoaderCSharpOracleSchemaObjImplHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpOracleSchemaObjImplHandler::~CFBamCustXmlLoaderCSharpOracleSchemaObjImplHandler() {
	}

	void CFBamCustXmlLoaderCSharpOracleSchemaObjImplHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpOracleSchemaObjImpl" ) {
				static const std::string Msg( "Expected QName to be 'CSharpOracleSchemaObjImpl'" );
	...
	void CFBamCustXmlLoaderCSharpOracleSchemaObjImplHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsOracleSchemaObjImplNull() || schemaDefObj->getOptionalCsOracleSchemaObjImplValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsOracleSchemaObjImplValue( text );
