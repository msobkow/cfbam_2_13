...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusPgSqlTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusPgSqlTableMembersHandler" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusPgSqlTableMembersHandler::CFBamCustXmlLoaderCPlusPgSqlTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusPgSqlTableMembersHandler::~CFBamCustXmlLoaderCPlusPgSqlTableMembersHandler() {
	}

	void CFBamCustXmlLoaderCPlusPgSqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusPgSqlTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'CPlusPgSqlTableMembers'" );
	...
	void CFBamCustXmlLoaderCPlusPgSqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppPgSqlTableMembersNull() || tableObj->getOptionalCppPgSqlTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppPgSqlTableMembersValue( text );
