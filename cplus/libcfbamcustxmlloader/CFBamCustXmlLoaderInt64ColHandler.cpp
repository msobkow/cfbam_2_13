...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderInt64ColHandler::CLASS_NAME( "CFBamCustXmlLoaderInt64ColHandler" );
	const std::string CFBamCustXmlLoaderInt64ColHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderInt64ColHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderInt64ColHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderInt64ColHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderInt64ColHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderInt64ColHandler::S_1( "1" );

	CFBamCustXmlLoaderInt64ColHandler::CFBamCustXmlLoaderInt64ColHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderInt64ColHandler::~CFBamCustXmlLoaderInt64ColHandler() {
	}

	void CFBamCustXmlLoaderInt64ColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "Int64Col" ) {
				static const std::string Msg( "Expected QName to be 'Int64Col'" );
			...
			origInt64Col = dynamic_cast<cfbam::ICFBamInt64ColObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderInt64ColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
