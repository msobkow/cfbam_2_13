...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderInt32ColHandler::CLASS_NAME( "CFBamCustXmlLoaderInt32ColHandler" );
	const std::string CFBamCustXmlLoaderInt32ColHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderInt32ColHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderInt32ColHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderInt32ColHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderInt32ColHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderInt32ColHandler::S_1( "1" );

	CFBamCustXmlLoaderInt32ColHandler::CFBamCustXmlLoaderInt32ColHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderInt32ColHandler::~CFBamCustXmlLoaderInt32ColHandler() {
	}

	void CFBamCustXmlLoaderInt32ColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "Int32Col" ) {
				static const std::string Msg( "Expected QName to be 'Int32Col'" );
			...
			origInt32Col = dynamic_cast<cfbam::ICFBamInt32ColObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderInt32ColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
