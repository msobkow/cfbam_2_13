...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusMSSqlTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusMSSqlTableMembersHandler" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusMSSqlTableMembersHandler::CFBamCustXmlLoaderCPlusMSSqlTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusMSSqlTableMembersHandler::~CFBamCustXmlLoaderCPlusMSSqlTableMembersHandler() {
	}

	void CFBamCustXmlLoaderCPlusMSSqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusMSSqlTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'CPlusMSSqlTableMembers'" );
	...
	void CFBamCustXmlLoaderCPlusMSSqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppMSSqlTableMembersNull() || tableObj->getOptionalCppMSSqlTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppMSSqlTableMembersValue( text );
