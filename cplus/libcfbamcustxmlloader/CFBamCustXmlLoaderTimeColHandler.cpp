...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderTimeColHandler::CLASS_NAME( "CFBamCustXmlLoaderTimeColHandler" );
	const std::string CFBamCustXmlLoaderTimeColHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderTimeColHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderTimeColHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderTimeColHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderTimeColHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderTimeColHandler::S_1( "1" );

	CFBamCustXmlLoaderTimeColHandler::CFBamCustXmlLoaderTimeColHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderTimeColHandler::~CFBamCustXmlLoaderTimeColHandler() {
	}

	void CFBamCustXmlLoaderTimeColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "TimeCol" ) {
				static const std::string Msg( "Expected QName to be 'TimeCol'" );
			...
			origTimeCol = dynamic_cast<cfbam::ICFBamTimeColObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderTimeColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
