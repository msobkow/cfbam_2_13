...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusTableObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusTableObjMembersHandler" );
	const std::string CFBamCustXmlLoaderHPlusTableObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusTableObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusTableObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusTableObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusTableObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusTableObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusTableObjMembersHandler::CFBamCustXmlLoaderHPlusTableObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusTableObjMembersHandler::~CFBamCustXmlLoaderHPlusTableObjMembersHandler() {
	}

	void CFBamCustXmlLoaderHPlusTableObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusTableObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'HPlusTableObjMembers'" );
	...
	void CFBamCustXmlLoaderHPlusTableObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppTableObjMembersNull() || tableObj->getOptionalHppTableObjMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppTableObjMembersValue( text );
