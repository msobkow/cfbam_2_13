...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnTableIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusXMsgRspnTableIncludeHandler" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnTableIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnTableIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnTableIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnTableIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnTableIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnTableIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusXMsgRspnTableIncludeHandler::CFBamCustXmlLoaderCPlusXMsgRspnTableIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusXMsgRspnTableIncludeHandler::~CFBamCustXmlLoaderCPlusXMsgRspnTableIncludeHandler() {
	}

	void CFBamCustXmlLoaderCPlusXMsgRspnTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusXMsgRspnTableInclude" ) {
				static const std::string Msg( "Expected QName to be 'CPlusXMsgRspnTableInclude'" );
	...
	void CFBamCustXmlLoaderCPlusXMsgRspnTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppXMsgRspnTableIncludeNull() || tableObj->getOptionalCppXMsgRspnTableIncludeValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppXMsgRspnTableIncludeValue( text );
