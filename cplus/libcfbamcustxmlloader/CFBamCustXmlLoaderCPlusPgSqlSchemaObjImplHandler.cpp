...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusPgSqlSchemaObjImplHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusPgSqlSchemaObjImplHandler" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlSchemaObjImplHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlSchemaObjImplHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlSchemaObjImplHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlSchemaObjImplHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlSchemaObjImplHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlSchemaObjImplHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusPgSqlSchemaObjImplHandler::CFBamCustXmlLoaderCPlusPgSqlSchemaObjImplHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusPgSqlSchemaObjImplHandler::~CFBamCustXmlLoaderCPlusPgSqlSchemaObjImplHandler() {
	}

	void CFBamCustXmlLoaderCPlusPgSqlSchemaObjImplHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusPgSqlSchemaObjImpl" ) {
				static const std::string Msg( "Expected QName to be 'CPlusPgSqlSchemaObjImpl'" );
	...
	void CFBamCustXmlLoaderCPlusPgSqlSchemaObjImplHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppPgSqlSchemaObjImplNull() || schemaDefObj->getOptionalCppPgSqlSchemaObjImplValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppPgSqlSchemaObjImplValue( text );
