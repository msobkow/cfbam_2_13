...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdElementListHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdElementListHandler" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdElementListHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdElementListHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdElementListHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdElementListHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdElementListHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdElementListHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdElementListHandler::CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdElementListHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdElementListHandler::~CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdElementListHandler() {
	}

	void CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdElementListHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusXMsgRspnSchemaXsdElementList" ) {
				static const std::string Msg( "Expected QName to be 'CPlusXMsgRspnSchemaXsdElementList'" );
	...
	void CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdElementListHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppXMsgRspnSchemaXsdElementListNull() || schemaDefObj->getOptionalCppXMsgRspnSchemaXsdElementListValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppXMsgRspnSchemaXsdElementListValue( text );
