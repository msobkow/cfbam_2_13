...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusMySqlSchemaObjImplHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusMySqlSchemaObjImplHandler" );
	const std::string CFBamCustXmlLoaderHPlusMySqlSchemaObjImplHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusMySqlSchemaObjImplHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusMySqlSchemaObjImplHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusMySqlSchemaObjImplHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusMySqlSchemaObjImplHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusMySqlSchemaObjImplHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusMySqlSchemaObjImplHandler::CFBamCustXmlLoaderHPlusMySqlSchemaObjImplHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusMySqlSchemaObjImplHandler::~CFBamCustXmlLoaderHPlusMySqlSchemaObjImplHandler() {
	}

	void CFBamCustXmlLoaderHPlusMySqlSchemaObjImplHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusMySqlSchemaObjImpl" ) {
				static const std::string Msg( "Expected QName to be 'HPlusMySqlSchemaObjImpl'" );
	...
	void CFBamCustXmlLoaderHPlusMySqlSchemaObjImplHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppMySqlSchemaObjImplNull() || schemaDefObj->getOptionalHppMySqlSchemaObjImplValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppMySqlSchemaObjImplValue( text );
