...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaWireParsersHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeXMsgRqstSchemaWireParsersHandler" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaWireParsersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaWireParsersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaWireParsersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaWireParsersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaWireParsersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaWireParsersHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeXMsgRqstSchemaWireParsersHandler::CFBamCustXmlLoaderCafeXMsgRqstSchemaWireParsersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeXMsgRqstSchemaWireParsersHandler::~CFBamCustXmlLoaderCafeXMsgRqstSchemaWireParsersHandler() {
	}

	void CFBamCustXmlLoaderCafeXMsgRqstSchemaWireParsersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeXMsgRqstSchemaWireParsers" ) {
				static const std::string Msg( "Expected QName to be 'CafeXMsgRqstSchemaWireParsers'" );
	...
	void CFBamCustXmlLoaderCafeXMsgRqstSchemaWireParsersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJXMsgRqstSchemaWireParsersNull() || schemaDefObj->getOptionalJXMsgRqstSchemaWireParsersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJXMsgRqstSchemaWireParsersValue( text );
