...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderUInt64TypeHandler::CLASS_NAME( "CFBamCustXmlLoaderUInt64TypeHandler" );
	const std::string CFBamCustXmlLoaderUInt64TypeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderUInt64TypeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderUInt64TypeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderUInt64TypeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderUInt64TypeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderUInt64TypeHandler::S_1( "1" );

	CFBamCustXmlLoaderUInt64TypeHandler::CFBamCustXmlLoaderUInt64TypeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderUInt64TypeHandler::~CFBamCustXmlLoaderUInt64TypeHandler() {
	}

	void CFBamCustXmlLoaderUInt64TypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "UInt64Type" ) {
				static const std::string Msg( "Expected QName to be 'UInt64Type'" );
			...
			origUInt64Type = dynamic_cast<cfbam::ICFBamUInt64TypeObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderUInt64TypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
