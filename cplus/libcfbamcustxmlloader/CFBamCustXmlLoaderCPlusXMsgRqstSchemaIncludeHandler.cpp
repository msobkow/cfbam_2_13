...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusXMsgRqstSchemaIncludeHandler" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusXMsgRqstSchemaIncludeHandler::CFBamCustXmlLoaderCPlusXMsgRqstSchemaIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusXMsgRqstSchemaIncludeHandler::~CFBamCustXmlLoaderCPlusXMsgRqstSchemaIncludeHandler() {
	}

	void CFBamCustXmlLoaderCPlusXMsgRqstSchemaIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusXMsgRqstSchemaInclude" ) {
				static const std::string Msg( "Expected QName to be 'CPlusXMsgRqstSchemaInclude'" );
	...
	void CFBamCustXmlLoaderCPlusXMsgRqstSchemaIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppXMsgRqstSchemaIncludeNull() || schemaDefObj->getOptionalCppXMsgRqstSchemaIncludeValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppXMsgRqstSchemaIncludeValue( text );
