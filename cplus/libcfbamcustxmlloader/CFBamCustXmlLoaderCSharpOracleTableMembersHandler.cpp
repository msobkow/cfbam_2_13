...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpOracleTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpOracleTableMembersHandler" );
	const std::string CFBamCustXmlLoaderCSharpOracleTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpOracleTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpOracleTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpOracleTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpOracleTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpOracleTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpOracleTableMembersHandler::CFBamCustXmlLoaderCSharpOracleTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpOracleTableMembersHandler::~CFBamCustXmlLoaderCSharpOracleTableMembersHandler() {
	}

	void CFBamCustXmlLoaderCSharpOracleTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpOracleTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'CSharpOracleTableMembers'" );
	...
	void CFBamCustXmlLoaderCSharpOracleTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsOracleTableMembersNull() || tableObj->getOptionalCsOracleTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsOracleTableMembersValue( text );
