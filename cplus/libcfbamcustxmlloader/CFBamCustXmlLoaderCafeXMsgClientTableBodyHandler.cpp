...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeXMsgClientTableBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeXMsgClientTableBodyHandler" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientTableBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientTableBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientTableBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientTableBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientTableBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientTableBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeXMsgClientTableBodyHandler::CFBamCustXmlLoaderCafeXMsgClientTableBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeXMsgClientTableBodyHandler::~CFBamCustXmlLoaderCafeXMsgClientTableBodyHandler() {
	}

	void CFBamCustXmlLoaderCafeXMsgClientTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeXMsgClientTableBody" ) {
				static const std::string Msg( "Expected QName to be 'CafeXMsgClientTableBody'" );
	...
	void CFBamCustXmlLoaderCafeXMsgClientTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJXMsgClientTableBodyNull() || tableObj->getOptionalJXMsgClientTableBodyValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJXMsgClientTableBodyValue( text );
