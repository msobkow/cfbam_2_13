...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnTableBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpXMsgRspnTableBodyHandler" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnTableBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnTableBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnTableBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnTableBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnTableBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnTableBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpXMsgRspnTableBodyHandler::CFBamCustXmlLoaderCSharpXMsgRspnTableBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpXMsgRspnTableBodyHandler::~CFBamCustXmlLoaderCSharpXMsgRspnTableBodyHandler() {
	}

	void CFBamCustXmlLoaderCSharpXMsgRspnTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpXMsgRspnTableBody" ) {
				static const std::string Msg( "Expected QName to be 'CSharpXMsgRspnTableBody'" );
	...
	void CFBamCustXmlLoaderCSharpXMsgRspnTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsXMsgRspnTableBodyNull() || tableObj->getOptionalCsXMsgRspnTableBodyValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsXMsgRspnTableBodyValue( text );
