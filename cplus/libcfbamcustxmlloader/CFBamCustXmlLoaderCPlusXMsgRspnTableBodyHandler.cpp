...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnTableBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusXMsgRspnTableBodyHandler" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnTableBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnTableBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnTableBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnTableBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnTableBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnTableBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusXMsgRspnTableBodyHandler::CFBamCustXmlLoaderCPlusXMsgRspnTableBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusXMsgRspnTableBodyHandler::~CFBamCustXmlLoaderCPlusXMsgRspnTableBodyHandler() {
	}

	void CFBamCustXmlLoaderCPlusXMsgRspnTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusXMsgRspnTableBody" ) {
				static const std::string Msg( "Expected QName to be 'CPlusXMsgRspnTableBody'" );
	...
	void CFBamCustXmlLoaderCPlusXMsgRspnTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppXMsgRspnTableBodyNull() || tableObj->getOptionalCppXMsgRspnTableBodyValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppXMsgRspnTableBodyValue( text );
