...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderUuidTypeHandler::CLASS_NAME( "CFBamCustXmlLoaderUuidTypeHandler" );
	const std::string CFBamCustXmlLoaderUuidTypeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderUuidTypeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderUuidTypeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderUuidTypeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderUuidTypeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderUuidTypeHandler::S_1( "1" );

	CFBamCustXmlLoaderUuidTypeHandler::CFBamCustXmlLoaderUuidTypeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderUuidTypeHandler::~CFBamCustXmlLoaderUuidTypeHandler() {
	}

	void CFBamCustXmlLoaderUuidTypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "UuidType" ) {
				static const std::string Msg( "Expected QName to be 'UuidType'" );
			...
			origUuidType = dynamic_cast<cfbam::ICFBamUuidTypeObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderUuidTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
