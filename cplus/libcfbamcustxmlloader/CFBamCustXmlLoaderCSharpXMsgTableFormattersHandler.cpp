...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpXMsgTableFormattersHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpXMsgTableFormattersHandler" );
	const std::string CFBamCustXmlLoaderCSharpXMsgTableFormattersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpXMsgTableFormattersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpXMsgTableFormattersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpXMsgTableFormattersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpXMsgTableFormattersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpXMsgTableFormattersHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpXMsgTableFormattersHandler::CFBamCustXmlLoaderCSharpXMsgTableFormattersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpXMsgTableFormattersHandler::~CFBamCustXmlLoaderCSharpXMsgTableFormattersHandler() {
	}

	void CFBamCustXmlLoaderCSharpXMsgTableFormattersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpXMsgTableFormatters" ) {
				static const std::string Msg( "Expected QName to be 'CSharpXMsgTableFormatters'" );
	...
	void CFBamCustXmlLoaderCSharpXMsgTableFormattersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsXMsgTableFormattersNull() || tableObj->getOptionalCsXMsgTableFormattersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsXMsgTableFormattersValue( text );
