...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpDb2LUWTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpDb2LUWTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpDb2LUWTableImplementationHandler::CFBamCustXmlLoaderCSharpDb2LUWTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpDb2LUWTableImplementationHandler::~CFBamCustXmlLoaderCSharpDb2LUWTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderCSharpDb2LUWTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpDb2LUWTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CSharpDb2LUWTableImplementation'" );
	...
	void CFBamCustXmlLoaderCSharpDb2LUWTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsDb2LUWTableImplementationNull() || tableObj->getOptionalCsDb2LUWTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsDb2LUWTableImplementationValue( text );
