...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusXMsgSchemaFormattersHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusXMsgSchemaFormattersHandler" );
	const std::string CFBamCustXmlLoaderHPlusXMsgSchemaFormattersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusXMsgSchemaFormattersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusXMsgSchemaFormattersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusXMsgSchemaFormattersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusXMsgSchemaFormattersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusXMsgSchemaFormattersHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusXMsgSchemaFormattersHandler::CFBamCustXmlLoaderHPlusXMsgSchemaFormattersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusXMsgSchemaFormattersHandler::~CFBamCustXmlLoaderHPlusXMsgSchemaFormattersHandler() {
	}

	void CFBamCustXmlLoaderHPlusXMsgSchemaFormattersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusXMsgSchemaFormatters" ) {
				static const std::string Msg( "Expected QName to be 'HPlusXMsgSchemaFormatters'" );
	...
	void CFBamCustXmlLoaderHPlusXMsgSchemaFormattersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppXMsgSchemaFormattersNull() || schemaDefObj->getOptionalHppXMsgSchemaFormattersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppXMsgSchemaFormattersValue( text );
