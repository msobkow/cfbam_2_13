...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpMySqlSchemaObjUsingHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpMySqlSchemaObjUsingHandler" );
	const std::string CFBamCustXmlLoaderCSharpMySqlSchemaObjUsingHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpMySqlSchemaObjUsingHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpMySqlSchemaObjUsingHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpMySqlSchemaObjUsingHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpMySqlSchemaObjUsingHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpMySqlSchemaObjUsingHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpMySqlSchemaObjUsingHandler::CFBamCustXmlLoaderCSharpMySqlSchemaObjUsingHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpMySqlSchemaObjUsingHandler::~CFBamCustXmlLoaderCSharpMySqlSchemaObjUsingHandler() {
	}

	void CFBamCustXmlLoaderCSharpMySqlSchemaObjUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpMySqlSchemaObjUsing" ) {
				static const std::string Msg( "Expected QName to be 'CSharpMySqlSchemaObjUsing'" );
	...
	void CFBamCustXmlLoaderCSharpMySqlSchemaObjUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsMySqlSchemaObjUsingNull() || schemaDefObj->getOptionalCsMySqlSchemaObjUsingValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsMySqlSchemaObjUsingValue( text );
