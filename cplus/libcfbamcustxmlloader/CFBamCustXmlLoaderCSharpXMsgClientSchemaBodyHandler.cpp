...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpXMsgClientSchemaBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpXMsgClientSchemaBodyHandler" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientSchemaBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientSchemaBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientSchemaBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientSchemaBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientSchemaBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientSchemaBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpXMsgClientSchemaBodyHandler::CFBamCustXmlLoaderCSharpXMsgClientSchemaBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpXMsgClientSchemaBodyHandler::~CFBamCustXmlLoaderCSharpXMsgClientSchemaBodyHandler() {
	}

	void CFBamCustXmlLoaderCSharpXMsgClientSchemaBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpXMsgClientSchemaBody" ) {
				static const std::string Msg( "Expected QName to be 'CSharpXMsgClientSchemaBody'" );
	...
	void CFBamCustXmlLoaderCSharpXMsgClientSchemaBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsXMsgClientSchemaBodyNull() || schemaDefObj->getOptionalCsXMsgClientSchemaBodyValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsXMsgClientSchemaBodyValue( text );
