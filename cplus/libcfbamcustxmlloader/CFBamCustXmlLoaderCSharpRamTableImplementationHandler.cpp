...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpRamTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpRamTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderCSharpRamTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpRamTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpRamTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpRamTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpRamTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpRamTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpRamTableImplementationHandler::CFBamCustXmlLoaderCSharpRamTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpRamTableImplementationHandler::~CFBamCustXmlLoaderCSharpRamTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderCSharpRamTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpRamTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CSharpRamTableImplementation'" );
	...
	void CFBamCustXmlLoaderCSharpRamTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsRamTableImplementationNull() || tableObj->getOptionalCsRamTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsRamTableImplementationValue( text );
