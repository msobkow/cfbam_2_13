...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeEditObjImportHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeEditObjImportHandler" );
	const std::string CFBamCustXmlLoaderCafeEditObjImportHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeEditObjImportHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeEditObjImportHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeEditObjImportHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeEditObjImportHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeEditObjImportHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeEditObjImportHandler::CFBamCustXmlLoaderCafeEditObjImportHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeEditObjImportHandler::~CFBamCustXmlLoaderCafeEditObjImportHandler() {
	}

	void CFBamCustXmlLoaderCafeEditObjImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeEditObjImport" ) {
				static const std::string Msg( "Expected QName to be 'CafeEditObjImport'" );
	...
	void CFBamCustXmlLoaderCafeEditObjImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJEditObjImportNull() || tableObj->getOptionalJEditObjImportValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJEditObjImportValue( text );
