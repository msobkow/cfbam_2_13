...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderNmTokenTypeHandler::CLASS_NAME( "CFBamCustXmlLoaderNmTokenTypeHandler" );
	const std::string CFBamCustXmlLoaderNmTokenTypeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderNmTokenTypeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderNmTokenTypeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderNmTokenTypeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderNmTokenTypeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderNmTokenTypeHandler::S_1( "1" );

	CFBamCustXmlLoaderNmTokenTypeHandler::CFBamCustXmlLoaderNmTokenTypeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderNmTokenTypeHandler::~CFBamCustXmlLoaderNmTokenTypeHandler() {
	}

	void CFBamCustXmlLoaderNmTokenTypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "NmTokenType" ) {
				static const std::string Msg( "Expected QName to be 'NmTokenType'" );
			...
			origNmTokenType = dynamic_cast<cfbam::ICFBamNmTokenTypeObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderNmTokenTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
