...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderTimestampColHandler::CLASS_NAME( "CFBamCustXmlLoaderTimestampColHandler" );
	const std::string CFBamCustXmlLoaderTimestampColHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderTimestampColHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderTimestampColHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderTimestampColHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderTimestampColHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderTimestampColHandler::S_1( "1" );

	CFBamCustXmlLoaderTimestampColHandler::CFBamCustXmlLoaderTimestampColHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderTimestampColHandler::~CFBamCustXmlLoaderTimestampColHandler() {
	}

	void CFBamCustXmlLoaderTimestampColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "TimestampCol" ) {
				static const std::string Msg( "Expected QName to be 'TimestampCol'" );
			...
			origTimestampCol = dynamic_cast<cfbam::ICFBamTimestampColObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderTimestampColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
