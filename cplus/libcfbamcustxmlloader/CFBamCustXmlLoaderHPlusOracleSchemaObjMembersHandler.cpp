...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusOracleSchemaObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusOracleSchemaObjMembersHandler" );
	const std::string CFBamCustXmlLoaderHPlusOracleSchemaObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusOracleSchemaObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusOracleSchemaObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusOracleSchemaObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusOracleSchemaObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusOracleSchemaObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusOracleSchemaObjMembersHandler::CFBamCustXmlLoaderHPlusOracleSchemaObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusOracleSchemaObjMembersHandler::~CFBamCustXmlLoaderHPlusOracleSchemaObjMembersHandler() {
	}

	void CFBamCustXmlLoaderHPlusOracleSchemaObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusOracleSchemaObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'HPlusOracleSchemaObjMembers'" );
	...
	void CFBamCustXmlLoaderHPlusOracleSchemaObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppOracleSchemaObjMembersNull() || schemaDefObj->getOptionalHppOracleSchemaObjMembersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppOracleSchemaObjMembersValue( text );
