...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpRamTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpRamTableMembersHandler" );
	const std::string CFBamCustXmlLoaderCSharpRamTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpRamTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpRamTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpRamTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpRamTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpRamTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpRamTableMembersHandler::CFBamCustXmlLoaderCSharpRamTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpRamTableMembersHandler::~CFBamCustXmlLoaderCSharpRamTableMembersHandler() {
	}

	void CFBamCustXmlLoaderCSharpRamTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpRamTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'CSharpRamTableMembers'" );
	...
	void CFBamCustXmlLoaderCSharpRamTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsRamTableMembersNull() || tableObj->getOptionalCsRamTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsRamTableMembersValue( text );
