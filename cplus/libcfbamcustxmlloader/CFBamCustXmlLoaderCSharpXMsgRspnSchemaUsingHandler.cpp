...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaUsingHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpXMsgRspnSchemaUsingHandler" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaUsingHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaUsingHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaUsingHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaUsingHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaUsingHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaUsingHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpXMsgRspnSchemaUsingHandler::CFBamCustXmlLoaderCSharpXMsgRspnSchemaUsingHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpXMsgRspnSchemaUsingHandler::~CFBamCustXmlLoaderCSharpXMsgRspnSchemaUsingHandler() {
	}

	void CFBamCustXmlLoaderCSharpXMsgRspnSchemaUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpXMsgRspnSchemaUsing" ) {
				static const std::string Msg( "Expected QName to be 'CSharpXMsgRspnSchemaUsing'" );
	...
	void CFBamCustXmlLoaderCSharpXMsgRspnSchemaUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsXMsgRspnSchemaUsingNull() || schemaDefObj->getOptionalCsXMsgRspnSchemaUsingValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsXMsgRspnSchemaUsingValue( text );
