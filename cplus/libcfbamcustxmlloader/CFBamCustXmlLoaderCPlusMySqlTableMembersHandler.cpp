...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusMySqlTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusMySqlTableMembersHandler" );
	const std::string CFBamCustXmlLoaderCPlusMySqlTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusMySqlTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusMySqlTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusMySqlTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusMySqlTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusMySqlTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusMySqlTableMembersHandler::CFBamCustXmlLoaderCPlusMySqlTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusMySqlTableMembersHandler::~CFBamCustXmlLoaderCPlusMySqlTableMembersHandler() {
	}

	void CFBamCustXmlLoaderCPlusMySqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusMySqlTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'CPlusMySqlTableMembers'" );
	...
	void CFBamCustXmlLoaderCPlusMySqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppMySqlTableMembersNull() || tableObj->getOptionalCppMySqlTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppMySqlTableMembersValue( text );
