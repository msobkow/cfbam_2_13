...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusPgSqlTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusPgSqlTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusPgSqlTableImplementationHandler::CFBamCustXmlLoaderHPlusPgSqlTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusPgSqlTableImplementationHandler::~CFBamCustXmlLoaderHPlusPgSqlTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderHPlusPgSqlTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusPgSqlTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'HPlusPgSqlTableImplementation'" );
	...
	void CFBamCustXmlLoaderHPlusPgSqlTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppPgSqlTableImplementationNull() || tableObj->getOptionalHppPgSqlTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppPgSqlTableImplementationValue( text );
