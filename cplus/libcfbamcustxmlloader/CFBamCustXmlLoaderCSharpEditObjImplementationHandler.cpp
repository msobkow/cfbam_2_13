...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpEditObjImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpEditObjImplementationHandler" );
	const std::string CFBamCustXmlLoaderCSharpEditObjImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpEditObjImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpEditObjImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpEditObjImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpEditObjImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpEditObjImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpEditObjImplementationHandler::CFBamCustXmlLoaderCSharpEditObjImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpEditObjImplementationHandler::~CFBamCustXmlLoaderCSharpEditObjImplementationHandler() {
	}

	void CFBamCustXmlLoaderCSharpEditObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpEditObjImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CSharpEditObjImplementation'" );
	...
	void CFBamCustXmlLoaderCSharpEditObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsEditObjImplementationNull() || tableObj->getOptionalCsEditObjImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsEditObjImplementationValue( text );
