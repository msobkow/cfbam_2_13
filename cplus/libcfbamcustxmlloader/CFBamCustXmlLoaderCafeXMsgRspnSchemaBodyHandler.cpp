...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeXMsgRspnSchemaBodyHandler" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeXMsgRspnSchemaBodyHandler::CFBamCustXmlLoaderCafeXMsgRspnSchemaBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeXMsgRspnSchemaBodyHandler::~CFBamCustXmlLoaderCafeXMsgRspnSchemaBodyHandler() {
	}

	void CFBamCustXmlLoaderCafeXMsgRspnSchemaBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeXMsgRspnSchemaBody" ) {
				static const std::string Msg( "Expected QName to be 'CafeXMsgRspnSchemaBody'" );
	...
	void CFBamCustXmlLoaderCafeXMsgRspnSchemaBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJXMsgRspnSchemaBodyNull() || schemaDefObj->getOptionalJXMsgRspnSchemaBodyValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJXMsgRspnSchemaBodyValue( text );
