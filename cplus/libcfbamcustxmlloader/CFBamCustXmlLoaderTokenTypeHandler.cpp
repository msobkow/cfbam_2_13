...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderTokenTypeHandler::CLASS_NAME( "CFBamCustXmlLoaderTokenTypeHandler" );
	const std::string CFBamCustXmlLoaderTokenTypeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderTokenTypeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderTokenTypeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderTokenTypeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderTokenTypeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderTokenTypeHandler::S_1( "1" );

	CFBamCustXmlLoaderTokenTypeHandler::CFBamCustXmlLoaderTokenTypeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderTokenTypeHandler::~CFBamCustXmlLoaderTokenTypeHandler() {
	}

	void CFBamCustXmlLoaderTokenTypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "TokenType" ) {
				static const std::string Msg( "Expected QName to be 'TokenType'" );
			...
			origTokenType = dynamic_cast<cfbam::ICFBamTokenTypeObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderTokenTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
