...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpOracleSchemaObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpOracleSchemaObjMembersHandler" );
	const std::string CFBamCustXmlLoaderCSharpOracleSchemaObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpOracleSchemaObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpOracleSchemaObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpOracleSchemaObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpOracleSchemaObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpOracleSchemaObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpOracleSchemaObjMembersHandler::CFBamCustXmlLoaderCSharpOracleSchemaObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpOracleSchemaObjMembersHandler::~CFBamCustXmlLoaderCSharpOracleSchemaObjMembersHandler() {
	}

	void CFBamCustXmlLoaderCSharpOracleSchemaObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpOracleSchemaObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'CSharpOracleSchemaObjMembers'" );
	...
	void CFBamCustXmlLoaderCSharpOracleSchemaObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsOracleSchemaObjMembersNull() || schemaDefObj->getOptionalCsOracleSchemaObjMembersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsOracleSchemaObjMembersValue( text );
