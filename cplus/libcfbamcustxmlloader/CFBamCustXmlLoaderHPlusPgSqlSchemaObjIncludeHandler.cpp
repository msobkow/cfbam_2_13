...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusPgSqlSchemaObjIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusPgSqlSchemaObjIncludeHandler" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlSchemaObjIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlSchemaObjIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlSchemaObjIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlSchemaObjIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlSchemaObjIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlSchemaObjIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusPgSqlSchemaObjIncludeHandler::CFBamCustXmlLoaderHPlusPgSqlSchemaObjIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusPgSqlSchemaObjIncludeHandler::~CFBamCustXmlLoaderHPlusPgSqlSchemaObjIncludeHandler() {
	}

	void CFBamCustXmlLoaderHPlusPgSqlSchemaObjIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusPgSqlSchemaObjInclude" ) {
				static const std::string Msg( "Expected QName to be 'HPlusPgSqlSchemaObjInclude'" );
	...
	void CFBamCustXmlLoaderHPlusPgSqlSchemaObjIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppPgSqlSchemaObjIncludeNull() || schemaDefObj->getOptionalHppPgSqlSchemaObjIncludeValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppPgSqlSchemaObjIncludeValue( text );
