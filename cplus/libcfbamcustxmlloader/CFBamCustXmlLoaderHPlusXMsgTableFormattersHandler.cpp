...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusXMsgTableFormattersHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusXMsgTableFormattersHandler" );
	const std::string CFBamCustXmlLoaderHPlusXMsgTableFormattersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusXMsgTableFormattersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusXMsgTableFormattersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusXMsgTableFormattersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusXMsgTableFormattersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusXMsgTableFormattersHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusXMsgTableFormattersHandler::CFBamCustXmlLoaderHPlusXMsgTableFormattersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusXMsgTableFormattersHandler::~CFBamCustXmlLoaderHPlusXMsgTableFormattersHandler() {
	}

	void CFBamCustXmlLoaderHPlusXMsgTableFormattersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusXMsgTableFormatters" ) {
				static const std::string Msg( "Expected QName to be 'HPlusXMsgTableFormatters'" );
	...
	void CFBamCustXmlLoaderHPlusXMsgTableFormattersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppXMsgTableFormattersNull() || tableObj->getOptionalHppXMsgTableFormattersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppXMsgTableFormattersValue( text );
