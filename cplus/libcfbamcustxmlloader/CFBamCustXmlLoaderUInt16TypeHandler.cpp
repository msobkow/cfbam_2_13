...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderUInt16TypeHandler::CLASS_NAME( "CFBamCustXmlLoaderUInt16TypeHandler" );
	const std::string CFBamCustXmlLoaderUInt16TypeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderUInt16TypeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderUInt16TypeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderUInt16TypeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderUInt16TypeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderUInt16TypeHandler::S_1( "1" );

	CFBamCustXmlLoaderUInt16TypeHandler::CFBamCustXmlLoaderUInt16TypeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderUInt16TypeHandler::~CFBamCustXmlLoaderUInt16TypeHandler() {
	}

	void CFBamCustXmlLoaderUInt16TypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "UInt16Type" ) {
				static const std::string Msg( "Expected QName to be 'UInt16Type'" );
			...
			origUInt16Type = dynamic_cast<cfbam::ICFBamUInt16TypeObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderUInt16TypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
