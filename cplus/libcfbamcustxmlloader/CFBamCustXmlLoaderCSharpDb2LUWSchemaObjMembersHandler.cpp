...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpDb2LUWSchemaObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpDb2LUWSchemaObjMembersHandler" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWSchemaObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWSchemaObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWSchemaObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWSchemaObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWSchemaObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWSchemaObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpDb2LUWSchemaObjMembersHandler::CFBamCustXmlLoaderCSharpDb2LUWSchemaObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpDb2LUWSchemaObjMembersHandler::~CFBamCustXmlLoaderCSharpDb2LUWSchemaObjMembersHandler() {
	}

	void CFBamCustXmlLoaderCSharpDb2LUWSchemaObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpDb2LUWSchemaObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'CSharpDb2LUWSchemaObjMembers'" );
	...
	void CFBamCustXmlLoaderCSharpDb2LUWSchemaObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsDb2LUWSchemaObjMembersNull() || schemaDefObj->getOptionalCsDb2LUWSchemaObjMembersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsDb2LUWSchemaObjMembersValue( text );
