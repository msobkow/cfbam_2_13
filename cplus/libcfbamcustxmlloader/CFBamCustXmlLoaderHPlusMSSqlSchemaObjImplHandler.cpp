...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusMSSqlSchemaObjImplHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusMSSqlSchemaObjImplHandler" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlSchemaObjImplHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlSchemaObjImplHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlSchemaObjImplHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlSchemaObjImplHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlSchemaObjImplHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlSchemaObjImplHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusMSSqlSchemaObjImplHandler::CFBamCustXmlLoaderHPlusMSSqlSchemaObjImplHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusMSSqlSchemaObjImplHandler::~CFBamCustXmlLoaderHPlusMSSqlSchemaObjImplHandler() {
	}

	void CFBamCustXmlLoaderHPlusMSSqlSchemaObjImplHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusMSSqlSchemaObjImpl" ) {
				static const std::string Msg( "Expected QName to be 'HPlusMSSqlSchemaObjImpl'" );
	...
	void CFBamCustXmlLoaderHPlusMSSqlSchemaObjImplHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppMSSqlSchemaObjImplNull() || schemaDefObj->getOptionalHppMSSqlSchemaObjImplValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppMSSqlSchemaObjImplValue( text );
