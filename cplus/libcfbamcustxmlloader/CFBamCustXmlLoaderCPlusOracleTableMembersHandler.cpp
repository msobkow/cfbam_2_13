...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusOracleTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusOracleTableMembersHandler" );
	const std::string CFBamCustXmlLoaderCPlusOracleTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusOracleTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusOracleTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusOracleTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusOracleTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusOracleTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusOracleTableMembersHandler::CFBamCustXmlLoaderCPlusOracleTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusOracleTableMembersHandler::~CFBamCustXmlLoaderCPlusOracleTableMembersHandler() {
	}

	void CFBamCustXmlLoaderCPlusOracleTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusOracleTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'CPlusOracleTableMembers'" );
	...
	void CFBamCustXmlLoaderCPlusOracleTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppOracleTableMembersNull() || tableObj->getOptionalCppOracleTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppOracleTableMembersValue( text );
