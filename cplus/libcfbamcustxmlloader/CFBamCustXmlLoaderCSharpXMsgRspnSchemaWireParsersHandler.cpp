...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaWireParsersHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpXMsgRspnSchemaWireParsersHandler" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaWireParsersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaWireParsersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaWireParsersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaWireParsersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaWireParsersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaWireParsersHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpXMsgRspnSchemaWireParsersHandler::CFBamCustXmlLoaderCSharpXMsgRspnSchemaWireParsersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpXMsgRspnSchemaWireParsersHandler::~CFBamCustXmlLoaderCSharpXMsgRspnSchemaWireParsersHandler() {
	}

	void CFBamCustXmlLoaderCSharpXMsgRspnSchemaWireParsersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpXMsgRspnSchemaWireParsers" ) {
				static const std::string Msg( "Expected QName to be 'CSharpXMsgRspnSchemaWireParsers'" );
	...
	void CFBamCustXmlLoaderCSharpXMsgRspnSchemaWireParsersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsXMsgRspnSchemaWireParsersNull() || schemaDefObj->getOptionalCsXMsgRspnSchemaWireParsersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsXMsgRspnSchemaWireParsersValue( text );
