...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpTableMembersHandler" );
	const std::string CFBamCustXmlLoaderCSharpTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpTableMembersHandler::CFBamCustXmlLoaderCSharpTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpTableMembersHandler::~CFBamCustXmlLoaderCSharpTableMembersHandler() {
	}

	void CFBamCustXmlLoaderCSharpTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'CSharpTableMembers'" );
	...
	void CFBamCustXmlLoaderCSharpTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsTableMembersNull() || tableObj->getOptionalCsTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsTableMembersValue( text );
