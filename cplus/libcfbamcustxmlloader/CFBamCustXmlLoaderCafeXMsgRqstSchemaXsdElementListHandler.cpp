...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdElementListHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdElementListHandler" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdElementListHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdElementListHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdElementListHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdElementListHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdElementListHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdElementListHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdElementListHandler::CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdElementListHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdElementListHandler::~CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdElementListHandler() {
	}

	void CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdElementListHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeXMsgRqstSchemaXsdElementList" ) {
				static const std::string Msg( "Expected QName to be 'CafeXMsgRqstSchemaXsdElementList'" );
	...
	void CFBamCustXmlLoaderCafeXMsgRqstSchemaXsdElementListHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJXMsgRqstSchemaXsdElementListNull() || schemaDefObj->getOptionalJXMsgRqstSchemaXsdElementListValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJXMsgRqstSchemaXsdElementListValue( text );
