...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusXMsgRspnSchemaIncludeHandler" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusXMsgRspnSchemaIncludeHandler::CFBamCustXmlLoaderCPlusXMsgRspnSchemaIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusXMsgRspnSchemaIncludeHandler::~CFBamCustXmlLoaderCPlusXMsgRspnSchemaIncludeHandler() {
	}

	void CFBamCustXmlLoaderCPlusXMsgRspnSchemaIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusXMsgRspnSchemaInclude" ) {
				static const std::string Msg( "Expected QName to be 'CPlusXMsgRspnSchemaInclude'" );
	...
	void CFBamCustXmlLoaderCPlusXMsgRspnSchemaIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppXMsgRspnSchemaIncludeNull() || schemaDefObj->getOptionalCppXMsgRspnSchemaIncludeValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppXMsgRspnSchemaIncludeValue( text );
