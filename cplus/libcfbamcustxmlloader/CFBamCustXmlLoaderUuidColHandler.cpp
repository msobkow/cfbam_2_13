...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderUuidColHandler::CLASS_NAME( "CFBamCustXmlLoaderUuidColHandler" );
	const std::string CFBamCustXmlLoaderUuidColHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderUuidColHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderUuidColHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderUuidColHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderUuidColHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderUuidColHandler::S_1( "1" );

	CFBamCustXmlLoaderUuidColHandler::CFBamCustXmlLoaderUuidColHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderUuidColHandler::~CFBamCustXmlLoaderUuidColHandler() {
	}

	void CFBamCustXmlLoaderUuidColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "UuidCol" ) {
				static const std::string Msg( "Expected QName to be 'UuidCol'" );
			...
			origUuidCol = dynamic_cast<cfbam::ICFBamUuidColObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderUuidColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
