...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpDb2LUWTableUsingHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpDb2LUWTableUsingHandler" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWTableUsingHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWTableUsingHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWTableUsingHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWTableUsingHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWTableUsingHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWTableUsingHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpDb2LUWTableUsingHandler::CFBamCustXmlLoaderCSharpDb2LUWTableUsingHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpDb2LUWTableUsingHandler::~CFBamCustXmlLoaderCSharpDb2LUWTableUsingHandler() {
	}

	void CFBamCustXmlLoaderCSharpDb2LUWTableUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpDb2LUWTableUsing" ) {
				static const std::string Msg( "Expected QName to be 'CSharpDb2LUWTableUsing'" );
	...
	void CFBamCustXmlLoaderCSharpDb2LUWTableUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsDb2LUWTableUsingNull() || tableObj->getOptionalCsDb2LUWTableUsingValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsDb2LUWTableUsingValue( text );
