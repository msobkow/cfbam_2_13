...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeObjImportHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeObjImportHandler" );
	const std::string CFBamCustXmlLoaderCafeObjImportHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeObjImportHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeObjImportHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeObjImportHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeObjImportHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeObjImportHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeObjImportHandler::CFBamCustXmlLoaderCafeObjImportHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeObjImportHandler::~CFBamCustXmlLoaderCafeObjImportHandler() {
	}

	void CFBamCustXmlLoaderCafeObjImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeObjImport" ) {
				static const std::string Msg( "Expected QName to be 'CafeObjImport'" );
	...
	void CFBamCustXmlLoaderCafeObjImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJObjImportNull() || tableObj->getOptionalJObjImportValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJObjImportValue( text );
