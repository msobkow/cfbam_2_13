...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdSpecHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdSpecHandler" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdSpecHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdSpecHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdSpecHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdSpecHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdSpecHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdSpecHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdSpecHandler::CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdSpecHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdSpecHandler::~CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdSpecHandler() {
	}

	void CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdSpecHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusXMsgRqstSchemaXsdSpec" ) {
				static const std::string Msg( "Expected QName to be 'HPlusXMsgRqstSchemaXsdSpec'" );
	...
	void CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdSpecHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppXMsgRqstSchemaXsdSpecNull() || schemaDefObj->getOptionalHppXMsgRqstSchemaXsdSpecValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppXMsgRqstSchemaXsdSpecValue( text );
