...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderTimestampTypeHandler::CLASS_NAME( "CFBamCustXmlLoaderTimestampTypeHandler" );
	const std::string CFBamCustXmlLoaderTimestampTypeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderTimestampTypeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderTimestampTypeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderTimestampTypeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderTimestampTypeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderTimestampTypeHandler::S_1( "1" );

	CFBamCustXmlLoaderTimestampTypeHandler::CFBamCustXmlLoaderTimestampTypeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderTimestampTypeHandler::~CFBamCustXmlLoaderTimestampTypeHandler() {
	}

	void CFBamCustXmlLoaderTimestampTypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "TimestampType" ) {
				static const std::string Msg( "Expected QName to be 'TimestampType'" );
			...
			origTimestampType = dynamic_cast<cfbam::ICFBamTimestampTypeObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderTimestampTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
