...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeTableObjInterfaceHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeTableObjInterfaceHandler" );
	const std::string CFBamCustXmlLoaderCafeTableObjInterfaceHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeTableObjInterfaceHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeTableObjInterfaceHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeTableObjInterfaceHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeTableObjInterfaceHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeTableObjInterfaceHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeTableObjInterfaceHandler::CFBamCustXmlLoaderCafeTableObjInterfaceHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeTableObjInterfaceHandler::~CFBamCustXmlLoaderCafeTableObjInterfaceHandler() {
	}

	void CFBamCustXmlLoaderCafeTableObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeTableObjInterface" ) {
				static const std::string Msg( "Expected QName to be 'CafeTableObjInterface'" );
	...
	void CFBamCustXmlLoaderCafeTableObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJTableObjInterfaceNull() || tableObj->getOptionalJTableObjInterfaceValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJTableObjInterfaceValue( text );
