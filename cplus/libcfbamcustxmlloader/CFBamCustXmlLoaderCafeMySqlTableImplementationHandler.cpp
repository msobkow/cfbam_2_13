...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeMySqlTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeMySqlTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderCafeMySqlTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeMySqlTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeMySqlTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeMySqlTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeMySqlTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeMySqlTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeMySqlTableImplementationHandler::CFBamCustXmlLoaderCafeMySqlTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeMySqlTableImplementationHandler::~CFBamCustXmlLoaderCafeMySqlTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderCafeMySqlTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeMySqlTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CafeMySqlTableImplementation'" );
	...
	void CFBamCustXmlLoaderCafeMySqlTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJMySqlTableImplementationNull() || tableObj->getOptionalJMySqlTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJMySqlTableImplementationValue( text );
