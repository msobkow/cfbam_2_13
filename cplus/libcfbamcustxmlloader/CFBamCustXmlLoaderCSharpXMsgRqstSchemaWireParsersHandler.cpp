...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaWireParsersHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpXMsgRqstSchemaWireParsersHandler" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaWireParsersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaWireParsersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaWireParsersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaWireParsersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaWireParsersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaWireParsersHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpXMsgRqstSchemaWireParsersHandler::CFBamCustXmlLoaderCSharpXMsgRqstSchemaWireParsersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpXMsgRqstSchemaWireParsersHandler::~CFBamCustXmlLoaderCSharpXMsgRqstSchemaWireParsersHandler() {
	}

	void CFBamCustXmlLoaderCSharpXMsgRqstSchemaWireParsersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpXMsgRqstSchemaWireParsers" ) {
				static const std::string Msg( "Expected QName to be 'CSharpXMsgRqstSchemaWireParsers'" );
	...
	void CFBamCustXmlLoaderCSharpXMsgRqstSchemaWireParsersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsXMsgRqstSchemaWireParsersNull() || schemaDefObj->getOptionalCsXMsgRqstSchemaWireParsersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsXMsgRqstSchemaWireParsersValue( text );
