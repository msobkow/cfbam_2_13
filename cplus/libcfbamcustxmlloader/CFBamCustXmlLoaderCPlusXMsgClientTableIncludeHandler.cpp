...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusXMsgClientTableIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusXMsgClientTableIncludeHandler" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientTableIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientTableIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientTableIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientTableIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientTableIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientTableIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusXMsgClientTableIncludeHandler::CFBamCustXmlLoaderCPlusXMsgClientTableIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusXMsgClientTableIncludeHandler::~CFBamCustXmlLoaderCPlusXMsgClientTableIncludeHandler() {
	}

	void CFBamCustXmlLoaderCPlusXMsgClientTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusXMsgClientTableInclude" ) {
				static const std::string Msg( "Expected QName to be 'CPlusXMsgClientTableInclude'" );
	...
	void CFBamCustXmlLoaderCPlusXMsgClientTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppXMsgClientTableIncludeNull() || tableObj->getOptionalCppXMsgClientTableIncludeValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppXMsgClientTableIncludeValue( text );
