...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaImportHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeXMsgRspnSchemaImportHandler" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaImportHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaImportHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaImportHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaImportHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaImportHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaImportHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeXMsgRspnSchemaImportHandler::CFBamCustXmlLoaderCafeXMsgRspnSchemaImportHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeXMsgRspnSchemaImportHandler::~CFBamCustXmlLoaderCafeXMsgRspnSchemaImportHandler() {
	}

	void CFBamCustXmlLoaderCafeXMsgRspnSchemaImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeXMsgRspnSchemaImport" ) {
				static const std::string Msg( "Expected QName to be 'CafeXMsgRspnSchemaImport'" );
	...
	void CFBamCustXmlLoaderCafeXMsgRspnSchemaImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJXMsgRspnSchemaImportNull() || schemaDefObj->getOptionalJXMsgRspnSchemaImportValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJXMsgRspnSchemaImportValue( text );
