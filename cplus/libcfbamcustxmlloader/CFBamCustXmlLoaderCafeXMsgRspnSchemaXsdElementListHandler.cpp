...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdElementListHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdElementListHandler" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdElementListHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdElementListHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdElementListHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdElementListHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdElementListHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdElementListHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdElementListHandler::CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdElementListHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdElementListHandler::~CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdElementListHandler() {
	}

	void CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdElementListHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeXMsgRspnSchemaXsdElementList" ) {
				static const std::string Msg( "Expected QName to be 'CafeXMsgRspnSchemaXsdElementList'" );
	...
	void CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdElementListHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJXMsgRspnSchemaXsdElementListNull() || schemaDefObj->getOptionalJXMsgRspnSchemaXsdElementListValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJXMsgRspnSchemaXsdElementListValue( text );
