...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpObjImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpObjImplementationHandler" );
	const std::string CFBamCustXmlLoaderCSharpObjImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpObjImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpObjImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpObjImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpObjImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpObjImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpObjImplementationHandler::CFBamCustXmlLoaderCSharpObjImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpObjImplementationHandler::~CFBamCustXmlLoaderCSharpObjImplementationHandler() {
	}

	void CFBamCustXmlLoaderCSharpObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpObjImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CSharpObjImplementation'" );
	...
	void CFBamCustXmlLoaderCSharpObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsObjImplementationNull() || tableObj->getOptionalCsObjImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsObjImplementationValue( text );
