...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeSchemaObjInterfaceHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeSchemaObjInterfaceHandler" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjInterfaceHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjInterfaceHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjInterfaceHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjInterfaceHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjInterfaceHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjInterfaceHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeSchemaObjInterfaceHandler::CFBamCustXmlLoaderCafeSchemaObjInterfaceHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeSchemaObjInterfaceHandler::~CFBamCustXmlLoaderCafeSchemaObjInterfaceHandler() {
	}

	void CFBamCustXmlLoaderCafeSchemaObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeSchemaObjInterface" ) {
				static const std::string Msg( "Expected QName to be 'CafeSchemaObjInterface'" );
	...
	void CFBamCustXmlLoaderCafeSchemaObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJSchemaObjInterfaceNull() || schemaDefObj->getOptionalJSchemaObjInterfaceValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJSchemaObjInterfaceValue( text );
