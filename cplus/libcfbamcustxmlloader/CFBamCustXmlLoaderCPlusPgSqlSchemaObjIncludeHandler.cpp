...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusPgSqlSchemaObjIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusPgSqlSchemaObjIncludeHandler" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlSchemaObjIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlSchemaObjIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlSchemaObjIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlSchemaObjIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlSchemaObjIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlSchemaObjIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusPgSqlSchemaObjIncludeHandler::CFBamCustXmlLoaderCPlusPgSqlSchemaObjIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusPgSqlSchemaObjIncludeHandler::~CFBamCustXmlLoaderCPlusPgSqlSchemaObjIncludeHandler() {
	}

	void CFBamCustXmlLoaderCPlusPgSqlSchemaObjIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusPgSqlSchemaObjInclude" ) {
				static const std::string Msg( "Expected QName to be 'CPlusPgSqlSchemaObjInclude'" );
	...
	void CFBamCustXmlLoaderCPlusPgSqlSchemaObjIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppPgSqlSchemaObjIncludeNull() || schemaDefObj->getOptionalCppPgSqlSchemaObjIncludeValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppPgSqlSchemaObjIncludeValue( text );
