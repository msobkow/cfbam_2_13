...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpDb2LUWSchemaObjImplHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpDb2LUWSchemaObjImplHandler" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWSchemaObjImplHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWSchemaObjImplHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWSchemaObjImplHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWSchemaObjImplHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWSchemaObjImplHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWSchemaObjImplHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpDb2LUWSchemaObjImplHandler::CFBamCustXmlLoaderCSharpDb2LUWSchemaObjImplHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpDb2LUWSchemaObjImplHandler::~CFBamCustXmlLoaderCSharpDb2LUWSchemaObjImplHandler() {
	}

	void CFBamCustXmlLoaderCSharpDb2LUWSchemaObjImplHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpDb2LUWSchemaObjImpl" ) {
				static const std::string Msg( "Expected QName to be 'CSharpDb2LUWSchemaObjImpl'" );
	...
	void CFBamCustXmlLoaderCSharpDb2LUWSchemaObjImplHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsDb2LUWSchemaObjImplNull() || schemaDefObj->getOptionalCsDb2LUWSchemaObjImplValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsDb2LUWSchemaObjImplValue( text );
