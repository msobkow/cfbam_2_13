...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeTableObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeTableObjMembersHandler" );
	const std::string CFBamCustXmlLoaderCafeTableObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeTableObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeTableObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeTableObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeTableObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeTableObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeTableObjMembersHandler::CFBamCustXmlLoaderCafeTableObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeTableObjMembersHandler::~CFBamCustXmlLoaderCafeTableObjMembersHandler() {
	}

	void CFBamCustXmlLoaderCafeTableObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeTableObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'CafeTableObjMembers'" );
	...
	void CFBamCustXmlLoaderCafeTableObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJTableObjMembersNull() || tableObj->getOptionalJTableObjMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJTableObjMembersValue( text );
