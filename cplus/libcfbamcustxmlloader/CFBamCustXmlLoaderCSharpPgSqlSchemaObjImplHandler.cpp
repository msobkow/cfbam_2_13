...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpPgSqlSchemaObjImplHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpPgSqlSchemaObjImplHandler" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlSchemaObjImplHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlSchemaObjImplHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlSchemaObjImplHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlSchemaObjImplHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlSchemaObjImplHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlSchemaObjImplHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpPgSqlSchemaObjImplHandler::CFBamCustXmlLoaderCSharpPgSqlSchemaObjImplHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpPgSqlSchemaObjImplHandler::~CFBamCustXmlLoaderCSharpPgSqlSchemaObjImplHandler() {
	}

	void CFBamCustXmlLoaderCSharpPgSqlSchemaObjImplHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpPgSqlSchemaObjImpl" ) {
				static const std::string Msg( "Expected QName to be 'CSharpPgSqlSchemaObjImpl'" );
	...
	void CFBamCustXmlLoaderCSharpPgSqlSchemaObjImplHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsPgSqlSchemaObjImplNull() || schemaDefObj->getOptionalCsPgSqlSchemaObjImplValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsPgSqlSchemaObjImplValue( text );
