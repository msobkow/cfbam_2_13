...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpXMsgRqstSchemaBodyHandler" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpXMsgRqstSchemaBodyHandler::CFBamCustXmlLoaderCSharpXMsgRqstSchemaBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpXMsgRqstSchemaBodyHandler::~CFBamCustXmlLoaderCSharpXMsgRqstSchemaBodyHandler() {
	}

	void CFBamCustXmlLoaderCSharpXMsgRqstSchemaBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpXMsgRqstSchemaBody" ) {
				static const std::string Msg( "Expected QName to be 'CSharpXMsgRqstSchemaBody'" );
	...
	void CFBamCustXmlLoaderCSharpXMsgRqstSchemaBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsXMsgRqstSchemaBodyNull() || schemaDefObj->getOptionalCsXMsgRqstSchemaBodyValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsXMsgRqstSchemaBodyValue( text );
