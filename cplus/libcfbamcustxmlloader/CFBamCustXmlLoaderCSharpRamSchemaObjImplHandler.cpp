...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpRamSchemaObjImplHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpRamSchemaObjImplHandler" );
	const std::string CFBamCustXmlLoaderCSharpRamSchemaObjImplHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpRamSchemaObjImplHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpRamSchemaObjImplHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpRamSchemaObjImplHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpRamSchemaObjImplHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpRamSchemaObjImplHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpRamSchemaObjImplHandler::CFBamCustXmlLoaderCSharpRamSchemaObjImplHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpRamSchemaObjImplHandler::~CFBamCustXmlLoaderCSharpRamSchemaObjImplHandler() {
	}

	void CFBamCustXmlLoaderCSharpRamSchemaObjImplHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpRamSchemaObjImpl" ) {
				static const std::string Msg( "Expected QName to be 'CSharpRamSchemaObjImpl'" );
	...
	void CFBamCustXmlLoaderCSharpRamSchemaObjImplHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsRamSchemaObjImplNull() || schemaDefObj->getOptionalCsRamSchemaObjImplValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsRamSchemaObjImplValue( text );
