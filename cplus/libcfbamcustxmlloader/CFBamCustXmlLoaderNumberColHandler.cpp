...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderNumberColHandler::CLASS_NAME( "CFBamCustXmlLoaderNumberColHandler" );
	const std::string CFBamCustXmlLoaderNumberColHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderNumberColHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderNumberColHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderNumberColHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderNumberColHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderNumberColHandler::S_1( "1" );

	CFBamCustXmlLoaderNumberColHandler::CFBamCustXmlLoaderNumberColHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderNumberColHandler::~CFBamCustXmlLoaderNumberColHandler() {
	}

	void CFBamCustXmlLoaderNumberColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "NumberCol" ) {
				static const std::string Msg( "Expected QName to be 'NumberCol'" );
			...
			origNumberCol = dynamic_cast<cfbam::ICFBamNumberColObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderNumberColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
