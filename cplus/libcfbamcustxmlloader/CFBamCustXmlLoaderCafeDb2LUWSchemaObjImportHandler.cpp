...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeDb2LUWSchemaObjImportHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeDb2LUWSchemaObjImportHandler" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWSchemaObjImportHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWSchemaObjImportHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWSchemaObjImportHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWSchemaObjImportHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWSchemaObjImportHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWSchemaObjImportHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeDb2LUWSchemaObjImportHandler::CFBamCustXmlLoaderCafeDb2LUWSchemaObjImportHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeDb2LUWSchemaObjImportHandler::~CFBamCustXmlLoaderCafeDb2LUWSchemaObjImportHandler() {
	}

	void CFBamCustXmlLoaderCafeDb2LUWSchemaObjImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeDb2LUWSchemaObjImport" ) {
				static const std::string Msg( "Expected QName to be 'CafeDb2LUWSchemaObjImport'" );
	...
	void CFBamCustXmlLoaderCafeDb2LUWSchemaObjImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJDb2LUWSchemaObjImportNull() || schemaDefObj->getOptionalJDb2LUWSchemaObjImportValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJDb2LUWSchemaObjImportValue( text );
