...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpTableObjInterfaceHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpTableObjInterfaceHandler" );
	const std::string CFBamCustXmlLoaderCSharpTableObjInterfaceHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpTableObjInterfaceHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpTableObjInterfaceHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpTableObjInterfaceHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpTableObjInterfaceHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpTableObjInterfaceHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpTableObjInterfaceHandler::CFBamCustXmlLoaderCSharpTableObjInterfaceHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpTableObjInterfaceHandler::~CFBamCustXmlLoaderCSharpTableObjInterfaceHandler() {
	}

	void CFBamCustXmlLoaderCSharpTableObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpTableObjInterface" ) {
				static const std::string Msg( "Expected QName to be 'CSharpTableObjInterface'" );
	...
	void CFBamCustXmlLoaderCSharpTableObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsTableObjInterfaceNull() || tableObj->getOptionalCsTableObjInterfaceValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsTableObjInterfaceValue( text );
