...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpTableObjUsingHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpTableObjUsingHandler" );
	const std::string CFBamCustXmlLoaderCSharpTableObjUsingHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpTableObjUsingHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpTableObjUsingHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpTableObjUsingHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpTableObjUsingHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpTableObjUsingHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpTableObjUsingHandler::CFBamCustXmlLoaderCSharpTableObjUsingHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpTableObjUsingHandler::~CFBamCustXmlLoaderCSharpTableObjUsingHandler() {
	}

	void CFBamCustXmlLoaderCSharpTableObjUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpTableObjUsing" ) {
				static const std::string Msg( "Expected QName to be 'CSharpTableObjUsing'" );
	...
	void CFBamCustXmlLoaderCSharpTableObjUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsTableObjUsingNull() || tableObj->getOptionalCsTableObjUsingValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsTableObjUsingValue( text );
