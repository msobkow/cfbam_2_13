...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusDb2LUWSchemaObjImplHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusDb2LUWSchemaObjImplHandler" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWSchemaObjImplHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWSchemaObjImplHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWSchemaObjImplHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWSchemaObjImplHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWSchemaObjImplHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWSchemaObjImplHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusDb2LUWSchemaObjImplHandler::CFBamCustXmlLoaderCPlusDb2LUWSchemaObjImplHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusDb2LUWSchemaObjImplHandler::~CFBamCustXmlLoaderCPlusDb2LUWSchemaObjImplHandler() {
	}

	void CFBamCustXmlLoaderCPlusDb2LUWSchemaObjImplHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusDb2LUWSchemaObjImpl" ) {
				static const std::string Msg( "Expected QName to be 'CPlusDb2LUWSchemaObjImpl'" );
	...
	void CFBamCustXmlLoaderCPlusDb2LUWSchemaObjImplHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppDb2LUWSchemaObjImplNull() || schemaDefObj->getOptionalCppDb2LUWSchemaObjImplValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppDb2LUWSchemaObjImplValue( text );
