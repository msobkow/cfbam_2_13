...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusEditObjIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusEditObjIncludeHandler" );
	const std::string CFBamCustXmlLoaderCPlusEditObjIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusEditObjIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusEditObjIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusEditObjIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusEditObjIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusEditObjIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusEditObjIncludeHandler::CFBamCustXmlLoaderCPlusEditObjIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusEditObjIncludeHandler::~CFBamCustXmlLoaderCPlusEditObjIncludeHandler() {
	}

	void CFBamCustXmlLoaderCPlusEditObjIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusEditObjInclude" ) {
				static const std::string Msg( "Expected QName to be 'CPlusEditObjInclude'" );
	...
	void CFBamCustXmlLoaderCPlusEditObjIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppEditObjIncludeNull() || tableObj->getOptionalCppEditObjIncludeValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppEditObjIncludeValue( text );
