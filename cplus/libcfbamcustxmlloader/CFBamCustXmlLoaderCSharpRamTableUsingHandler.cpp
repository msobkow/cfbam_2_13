...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpRamTableUsingHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpRamTableUsingHandler" );
	const std::string CFBamCustXmlLoaderCSharpRamTableUsingHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpRamTableUsingHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpRamTableUsingHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpRamTableUsingHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpRamTableUsingHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpRamTableUsingHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpRamTableUsingHandler::CFBamCustXmlLoaderCSharpRamTableUsingHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpRamTableUsingHandler::~CFBamCustXmlLoaderCSharpRamTableUsingHandler() {
	}

	void CFBamCustXmlLoaderCSharpRamTableUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpRamTableUsing" ) {
				static const std::string Msg( "Expected QName to be 'CSharpRamTableUsing'" );
	...
	void CFBamCustXmlLoaderCSharpRamTableUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsRamTableUsingNull() || tableObj->getOptionalCsRamTableUsingValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsRamTableUsingValue( text );
