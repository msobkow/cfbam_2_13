...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpXMsgTableUsingHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpXMsgTableUsingHandler" );
	const std::string CFBamCustXmlLoaderCSharpXMsgTableUsingHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpXMsgTableUsingHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpXMsgTableUsingHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpXMsgTableUsingHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpXMsgTableUsingHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpXMsgTableUsingHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpXMsgTableUsingHandler::CFBamCustXmlLoaderCSharpXMsgTableUsingHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpXMsgTableUsingHandler::~CFBamCustXmlLoaderCSharpXMsgTableUsingHandler() {
	}

	void CFBamCustXmlLoaderCSharpXMsgTableUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpXMsgTableUsing" ) {
				static const std::string Msg( "Expected QName to be 'CSharpXMsgTableUsing'" );
	...
	void CFBamCustXmlLoaderCSharpXMsgTableUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsXMsgTableUsingNull() || tableObj->getOptionalCsXMsgTableUsingValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsXMsgTableUsingValue( text );
