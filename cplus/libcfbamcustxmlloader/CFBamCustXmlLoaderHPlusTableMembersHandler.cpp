...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusTableMembersHandler" );
	const std::string CFBamCustXmlLoaderHPlusTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusTableMembersHandler::CFBamCustXmlLoaderHPlusTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusTableMembersHandler::~CFBamCustXmlLoaderHPlusTableMembersHandler() {
	}

	void CFBamCustXmlLoaderHPlusTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'HPlusTableMembers'" );
	...
	void CFBamCustXmlLoaderHPlusTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppTableMembersNull() || tableObj->getOptionalHppTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppTableMembersValue( text );
