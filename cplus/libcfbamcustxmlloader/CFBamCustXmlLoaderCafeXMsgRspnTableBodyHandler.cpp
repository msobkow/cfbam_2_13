...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeXMsgRspnTableBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeXMsgRspnTableBodyHandler" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnTableBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnTableBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnTableBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnTableBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnTableBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnTableBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeXMsgRspnTableBodyHandler::CFBamCustXmlLoaderCafeXMsgRspnTableBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeXMsgRspnTableBodyHandler::~CFBamCustXmlLoaderCafeXMsgRspnTableBodyHandler() {
	}

	void CFBamCustXmlLoaderCafeXMsgRspnTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeXMsgRspnTableBody" ) {
				static const std::string Msg( "Expected QName to be 'CafeXMsgRspnTableBody'" );
	...
	void CFBamCustXmlLoaderCafeXMsgRspnTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJXMsgRspnTableBodyNull() || tableObj->getOptionalJXMsgRspnTableBodyValue().empty() ) {
				std::string text = curContext->getElementText();
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJXMsgRspnTableBodyValue( text );
