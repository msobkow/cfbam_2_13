...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusPgSqlTableIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusPgSqlTableIncludeHandler" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlTableIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlTableIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlTableIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlTableIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlTableIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlTableIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusPgSqlTableIncludeHandler::CFBamCustXmlLoaderHPlusPgSqlTableIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusPgSqlTableIncludeHandler::~CFBamCustXmlLoaderHPlusPgSqlTableIncludeHandler() {
	}

	void CFBamCustXmlLoaderHPlusPgSqlTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusPgSqlTableInclude" ) {
				static const std::string Msg( "Expected QName to be 'HPlusPgSqlTableInclude'" );
	...
	void CFBamCustXmlLoaderHPlusPgSqlTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppPgSqlTableIncludeNull() || tableObj->getOptionalHppPgSqlTableIncludeValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppPgSqlTableIncludeValue( text );
