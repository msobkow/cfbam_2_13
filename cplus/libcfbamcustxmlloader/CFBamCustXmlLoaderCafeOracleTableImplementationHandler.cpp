...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeOracleTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeOracleTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderCafeOracleTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeOracleTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeOracleTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeOracleTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeOracleTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeOracleTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeOracleTableImplementationHandler::CFBamCustXmlLoaderCafeOracleTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeOracleTableImplementationHandler::~CFBamCustXmlLoaderCafeOracleTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderCafeOracleTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeOracleTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CafeOracleTableImplementation'" );
	...
	void CFBamCustXmlLoaderCafeOracleTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJOracleTableImplementationNull() || tableObj->getOptionalJOracleTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJOracleTableImplementationValue( text );
