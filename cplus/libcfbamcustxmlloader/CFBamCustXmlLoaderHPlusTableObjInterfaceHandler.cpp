...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusTableObjInterfaceHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusTableObjInterfaceHandler" );
	const std::string CFBamCustXmlLoaderHPlusTableObjInterfaceHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusTableObjInterfaceHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusTableObjInterfaceHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusTableObjInterfaceHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusTableObjInterfaceHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusTableObjInterfaceHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusTableObjInterfaceHandler::CFBamCustXmlLoaderHPlusTableObjInterfaceHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusTableObjInterfaceHandler::~CFBamCustXmlLoaderHPlusTableObjInterfaceHandler() {
	}

	void CFBamCustXmlLoaderHPlusTableObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusTableObjInterface" ) {
				static const std::string Msg( "Expected QName to be 'HPlusTableObjInterface'" );
	...
	void CFBamCustXmlLoaderHPlusTableObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppTableObjInterfaceNull() || tableObj->getOptionalHppTableObjInterfaceValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppTableObjInterfaceValue( text );
