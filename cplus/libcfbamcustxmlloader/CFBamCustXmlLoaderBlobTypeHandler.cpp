...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderBlobTypeHandler::CLASS_NAME( "CFBamCustXmlLoaderBlobTypeHandler" );
	const std::string CFBamCustXmlLoaderBlobTypeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderBlobTypeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderBlobTypeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderBlobTypeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderBlobTypeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderBlobTypeHandler::S_1( "1" );

	CFBamCustXmlLoaderBlobTypeHandler::CFBamCustXmlLoaderBlobTypeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderBlobTypeHandler::~CFBamCustXmlLoaderBlobTypeHandler() {
	}

	void CFBamCustXmlLoaderBlobTypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "BlobType" ) {
				static const std::string Msg( "Expected QName to be 'BlobType'" );
			...
			origBlobType = dynamic_cast<cfbam::ICFBamBlobTypeObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderBlobTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
