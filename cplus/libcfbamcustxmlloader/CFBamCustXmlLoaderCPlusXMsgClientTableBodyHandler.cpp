...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusXMsgClientTableBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusXMsgClientTableBodyHandler" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientTableBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientTableBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientTableBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientTableBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientTableBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientTableBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusXMsgClientTableBodyHandler::CFBamCustXmlLoaderCPlusXMsgClientTableBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusXMsgClientTableBodyHandler::~CFBamCustXmlLoaderCPlusXMsgClientTableBodyHandler() {
	}

	void CFBamCustXmlLoaderCPlusXMsgClientTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusXMsgClientTableBody" ) {
				static const std::string Msg( "Expected QName to be 'CPlusXMsgClientTableBody'" );
	...
	void CFBamCustXmlLoaderCPlusXMsgClientTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppXMsgClientTableBodyNull() || tableObj->getOptionalCppXMsgClientTableBodyValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppXMsgClientTableBodyValue( text );
