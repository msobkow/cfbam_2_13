...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdSpecHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdSpecHandler" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdSpecHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdSpecHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdSpecHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdSpecHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdSpecHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdSpecHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdSpecHandler::CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdSpecHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdSpecHandler::~CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdSpecHandler() {
	}

	void CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdSpecHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpXMsgRspnSchemaXsdSpec" ) {
				static const std::string Msg( "Expected QName to be 'CSharpXMsgRspnSchemaXsdSpec'" );
	...
	void CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdSpecHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsXMsgRspnSchemaXsdSpecNull() || schemaDefObj->getOptionalCsXMsgRspnSchemaXsdSpecValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsXMsgRspnSchemaXsdSpecValue( text );
