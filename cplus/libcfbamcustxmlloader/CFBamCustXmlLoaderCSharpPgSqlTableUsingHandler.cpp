...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpPgSqlTableUsingHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpPgSqlTableUsingHandler" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlTableUsingHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlTableUsingHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlTableUsingHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlTableUsingHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlTableUsingHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlTableUsingHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpPgSqlTableUsingHandler::CFBamCustXmlLoaderCSharpPgSqlTableUsingHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpPgSqlTableUsingHandler::~CFBamCustXmlLoaderCSharpPgSqlTableUsingHandler() {
	}

	void CFBamCustXmlLoaderCSharpPgSqlTableUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpPgSqlTableUsing" ) {
				static const std::string Msg( "Expected QName to be 'CSharpPgSqlTableUsing'" );
	...
	void CFBamCustXmlLoaderCSharpPgSqlTableUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsPgSqlTableUsingNull() || tableObj->getOptionalCsPgSqlTableUsingValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsPgSqlTableUsingValue( text );
