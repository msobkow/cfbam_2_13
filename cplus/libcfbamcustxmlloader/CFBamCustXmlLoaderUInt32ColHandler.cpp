...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderUInt32ColHandler::CLASS_NAME( "CFBamCustXmlLoaderUInt32ColHandler" );
	const std::string CFBamCustXmlLoaderUInt32ColHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderUInt32ColHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderUInt32ColHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderUInt32ColHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderUInt32ColHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderUInt32ColHandler::S_1( "1" );

	CFBamCustXmlLoaderUInt32ColHandler::CFBamCustXmlLoaderUInt32ColHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderUInt32ColHandler::~CFBamCustXmlLoaderUInt32ColHandler() {
	}

	void CFBamCustXmlLoaderUInt32ColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "UInt32Col" ) {
				static const std::string Msg( "Expected QName to be 'UInt32Col'" );
			...
			origUInt32Col = dynamic_cast<cfbam::ICFBamUInt32ColObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderUInt32ColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
