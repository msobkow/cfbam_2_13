...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeMSSqlTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeMSSqlTableMembersHandler" );
	const std::string CFBamCustXmlLoaderCafeMSSqlTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeMSSqlTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeMSSqlTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeMSSqlTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeMSSqlTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeMSSqlTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeMSSqlTableMembersHandler::CFBamCustXmlLoaderCafeMSSqlTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeMSSqlTableMembersHandler::~CFBamCustXmlLoaderCafeMSSqlTableMembersHandler() {
	}

	void CFBamCustXmlLoaderCafeMSSqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeMSSqlTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'CafeMSSqlTableMembers'" );
	...
	void CFBamCustXmlLoaderCafeMSSqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJMSSqlTableMembersNull() || tableObj->getOptionalJMSSqlTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJMSSqlTableMembersValue( text );
