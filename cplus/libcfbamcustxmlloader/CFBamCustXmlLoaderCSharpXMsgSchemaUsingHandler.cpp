...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpXMsgSchemaUsingHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpXMsgSchemaUsingHandler" );
	const std::string CFBamCustXmlLoaderCSharpXMsgSchemaUsingHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpXMsgSchemaUsingHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpXMsgSchemaUsingHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpXMsgSchemaUsingHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpXMsgSchemaUsingHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpXMsgSchemaUsingHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpXMsgSchemaUsingHandler::CFBamCustXmlLoaderCSharpXMsgSchemaUsingHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpXMsgSchemaUsingHandler::~CFBamCustXmlLoaderCSharpXMsgSchemaUsingHandler() {
	}

	void CFBamCustXmlLoaderCSharpXMsgSchemaUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpXMsgSchemaUsing" ) {
				static const std::string Msg( "Expected QName to be 'CSharpXMsgSchemaUsing'" );
	...
	void CFBamCustXmlLoaderCSharpXMsgSchemaUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsXMsgSchemaUsingNull() || schemaDefObj->getOptionalCsXMsgSchemaUsingValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsXMsgSchemaUsingValue( text );
