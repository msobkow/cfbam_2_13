...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeMySqlTableImportHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeMySqlTableImportHandler" );
	const std::string CFBamCustXmlLoaderCafeMySqlTableImportHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeMySqlTableImportHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeMySqlTableImportHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeMySqlTableImportHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeMySqlTableImportHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeMySqlTableImportHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeMySqlTableImportHandler::CFBamCustXmlLoaderCafeMySqlTableImportHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeMySqlTableImportHandler::~CFBamCustXmlLoaderCafeMySqlTableImportHandler() {
	}

	void CFBamCustXmlLoaderCafeMySqlTableImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeMySqlTableImport" ) {
				static const std::string Msg( "Expected QName to be 'CafeMySqlTableImport'" );
	...
	void CFBamCustXmlLoaderCafeMySqlTableImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJMySqlTableImportNull() || tableObj->getOptionalJMySqlTableImportValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJMySqlTableImportValue( text );
