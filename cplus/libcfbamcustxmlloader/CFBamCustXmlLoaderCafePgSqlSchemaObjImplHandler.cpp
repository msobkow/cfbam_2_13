...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafePgSqlSchemaObjImplHandler::CLASS_NAME( "CFBamCustXmlLoaderCafePgSqlSchemaObjImplHandler" );
	const std::string CFBamCustXmlLoaderCafePgSqlSchemaObjImplHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafePgSqlSchemaObjImplHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafePgSqlSchemaObjImplHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafePgSqlSchemaObjImplHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafePgSqlSchemaObjImplHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafePgSqlSchemaObjImplHandler::S_1( "1" );

	CFBamCustXmlLoaderCafePgSqlSchemaObjImplHandler::CFBamCustXmlLoaderCafePgSqlSchemaObjImplHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafePgSqlSchemaObjImplHandler::~CFBamCustXmlLoaderCafePgSqlSchemaObjImplHandler() {
	}

	void CFBamCustXmlLoaderCafePgSqlSchemaObjImplHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafePgSqlSchemaObjImpl" ) {
				static const std::string Msg( "Expected QName to be 'CafePgSqlSchemaObjImpl'" );
	...
	void CFBamCustXmlLoaderCafePgSqlSchemaObjImplHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJPgSqlSchemaObjImplNull() || schemaDefObj->getOptionalJPgSqlSchemaObjImplValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJPgSqlSchemaObjImplValue( text );
