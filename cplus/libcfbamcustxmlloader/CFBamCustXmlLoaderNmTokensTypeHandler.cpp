...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderNmTokensTypeHandler::CLASS_NAME( "CFBamCustXmlLoaderNmTokensTypeHandler" );
	const std::string CFBamCustXmlLoaderNmTokensTypeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderNmTokensTypeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderNmTokensTypeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderNmTokensTypeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderNmTokensTypeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderNmTokensTypeHandler::S_1( "1" );

	CFBamCustXmlLoaderNmTokensTypeHandler::CFBamCustXmlLoaderNmTokensTypeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderNmTokensTypeHandler::~CFBamCustXmlLoaderNmTokensTypeHandler() {
	}

	void CFBamCustXmlLoaderNmTokensTypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "NmTokensType" ) {
				static const std::string Msg( "Expected QName to be 'NmTokensType'" );
			...
			origNmTokensType = dynamic_cast<cfbam::ICFBamNmTokensTypeObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderNmTokensTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
