...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafePgSqlTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCafePgSqlTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderCafePgSqlTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafePgSqlTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafePgSqlTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafePgSqlTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafePgSqlTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafePgSqlTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCafePgSqlTableImplementationHandler::CFBamCustXmlLoaderCafePgSqlTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafePgSqlTableImplementationHandler::~CFBamCustXmlLoaderCafePgSqlTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderCafePgSqlTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafePgSqlTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CafePgSqlTableImplementation'" );
	...
	void CFBamCustXmlLoaderCafePgSqlTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJPgSqlTableImplementationNull() || tableObj->getOptionalJPgSqlTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJPgSqlTableImplementationValue( text );
