...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstTableUsingHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpXMsgRqstTableUsingHandler" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstTableUsingHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstTableUsingHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstTableUsingHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstTableUsingHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstTableUsingHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstTableUsingHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpXMsgRqstTableUsingHandler::CFBamCustXmlLoaderCSharpXMsgRqstTableUsingHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpXMsgRqstTableUsingHandler::~CFBamCustXmlLoaderCSharpXMsgRqstTableUsingHandler() {
	}

	void CFBamCustXmlLoaderCSharpXMsgRqstTableUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpXMsgRqstTableUsing" ) {
				static const std::string Msg( "Expected QName to be 'CSharpXMsgRqstTableUsing'" );
	...
	void CFBamCustXmlLoaderCSharpXMsgRqstTableUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsXMsgRqstTableUsingNull() || tableObj->getOptionalCsXMsgRqstTableUsingValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsXMsgRqstTableUsingValue( text );
