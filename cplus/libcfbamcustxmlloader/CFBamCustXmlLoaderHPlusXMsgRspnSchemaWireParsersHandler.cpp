...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaWireParsersHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusXMsgRspnSchemaWireParsersHandler" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaWireParsersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaWireParsersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaWireParsersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaWireParsersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaWireParsersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaWireParsersHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusXMsgRspnSchemaWireParsersHandler::CFBamCustXmlLoaderHPlusXMsgRspnSchemaWireParsersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusXMsgRspnSchemaWireParsersHandler::~CFBamCustXmlLoaderHPlusXMsgRspnSchemaWireParsersHandler() {
	}

	void CFBamCustXmlLoaderHPlusXMsgRspnSchemaWireParsersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusXMsgRspnSchemaWireParsers" ) {
				static const std::string Msg( "Expected QName to be 'HPlusXMsgRspnSchemaWireParsers'" );
	...
	void CFBamCustXmlLoaderHPlusXMsgRspnSchemaWireParsersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppXMsgRspnSchemaWireParsersNull() || schemaDefObj->getOptionalHppXMsgRspnSchemaWireParsersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppXMsgRspnSchemaWireParsersValue( text );
