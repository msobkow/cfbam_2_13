...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpOracleTableUsingHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpOracleTableUsingHandler" );
	const std::string CFBamCustXmlLoaderCSharpOracleTableUsingHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpOracleTableUsingHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpOracleTableUsingHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpOracleTableUsingHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpOracleTableUsingHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpOracleTableUsingHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpOracleTableUsingHandler::CFBamCustXmlLoaderCSharpOracleTableUsingHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpOracleTableUsingHandler::~CFBamCustXmlLoaderCSharpOracleTableUsingHandler() {
	}

	void CFBamCustXmlLoaderCSharpOracleTableUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpOracleTableUsing" ) {
				static const std::string Msg( "Expected QName to be 'CSharpOracleTableUsing'" );
	...
	void CFBamCustXmlLoaderCSharpOracleTableUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsOracleTableUsingNull() || tableObj->getOptionalCsOracleTableUsingValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsOracleTableUsingValue( text );
