...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeObjMembersHandler" );
	const std::string CFBamCustXmlLoaderCafeObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeObjMembersHandler::CFBamCustXmlLoaderCafeObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeObjMembersHandler::~CFBamCustXmlLoaderCafeObjMembersHandler() {
	}

	void CFBamCustXmlLoaderCafeObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'CafeObjMembers'" );
	...
	void CFBamCustXmlLoaderCafeObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJObjMembersNull() || tableObj->getOptionalJObjMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJObjMembersValue( text );
