...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnTableBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusXMsgRspnTableBodyHandler" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnTableBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnTableBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnTableBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnTableBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnTableBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnTableBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusXMsgRspnTableBodyHandler::CFBamCustXmlLoaderHPlusXMsgRspnTableBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusXMsgRspnTableBodyHandler::~CFBamCustXmlLoaderHPlusXMsgRspnTableBodyHandler() {
	}

	void CFBamCustXmlLoaderHPlusXMsgRspnTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusXMsgRspnTableBody" ) {
				static const std::string Msg( "Expected QName to be 'HPlusXMsgRspnTableBody'" );
	...
	void CFBamCustXmlLoaderHPlusXMsgRspnTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppXMsgRspnTableBodyNull() || tableObj->getOptionalHppXMsgRspnTableBodyValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppXMsgRspnTableBodyValue( text );
