...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusDb2LUWSchemaObjIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusDb2LUWSchemaObjIncludeHandler" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWSchemaObjIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWSchemaObjIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWSchemaObjIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWSchemaObjIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWSchemaObjIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWSchemaObjIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusDb2LUWSchemaObjIncludeHandler::CFBamCustXmlLoaderHPlusDb2LUWSchemaObjIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusDb2LUWSchemaObjIncludeHandler::~CFBamCustXmlLoaderHPlusDb2LUWSchemaObjIncludeHandler() {
	}

	void CFBamCustXmlLoaderHPlusDb2LUWSchemaObjIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusDb2LUWSchemaObjInclude" ) {
				static const std::string Msg( "Expected QName to be 'HPlusDb2LUWSchemaObjInclude'" );
	...
	void CFBamCustXmlLoaderHPlusDb2LUWSchemaObjIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppDb2LUWSchemaObjIncludeNull() || schemaDefObj->getOptionalHppDb2LUWSchemaObjIncludeValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppDb2LUWSchemaObjIncludeValue( text );
