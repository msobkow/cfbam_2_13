...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderStringTypeHandler::CLASS_NAME( "CFBamCustXmlLoaderStringTypeHandler" );
	const std::string CFBamCustXmlLoaderStringTypeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderStringTypeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderStringTypeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderStringTypeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderStringTypeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderStringTypeHandler::S_1( "1" );

	CFBamCustXmlLoaderStringTypeHandler::CFBamCustXmlLoaderStringTypeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderStringTypeHandler::~CFBamCustXmlLoaderStringTypeHandler() {
	}

	void CFBamCustXmlLoaderStringTypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "StringType" ) {
				static const std::string Msg( "Expected QName to be 'StringType'" );
			...
			origStringType = dynamic_cast<cfbam::ICFBamStringTypeObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderStringTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
