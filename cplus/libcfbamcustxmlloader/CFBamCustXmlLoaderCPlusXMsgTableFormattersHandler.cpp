...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusXMsgTableFormattersHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusXMsgTableFormattersHandler" );
	const std::string CFBamCustXmlLoaderCPlusXMsgTableFormattersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusXMsgTableFormattersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusXMsgTableFormattersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusXMsgTableFormattersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusXMsgTableFormattersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusXMsgTableFormattersHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusXMsgTableFormattersHandler::CFBamCustXmlLoaderCPlusXMsgTableFormattersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusXMsgTableFormattersHandler::~CFBamCustXmlLoaderCPlusXMsgTableFormattersHandler() {
	}

	void CFBamCustXmlLoaderCPlusXMsgTableFormattersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusXMsgTableFormatters" ) {
				static const std::string Msg( "Expected QName to be 'CPlusXMsgTableFormatters'" );
	...
	void CFBamCustXmlLoaderCPlusXMsgTableFormattersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppXMsgTableFormattersNull() || tableObj->getOptionalCppXMsgTableFormattersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppXMsgTableFormattersValue( text );
