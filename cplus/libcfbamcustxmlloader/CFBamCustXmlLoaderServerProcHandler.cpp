...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderServerProcHandler::CLASS_NAME( "CFBamCustXmlLoaderServerProcHandler" );
	const std::string CFBamCustXmlLoaderServerProcHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderServerProcHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderServerProcHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderServerProcHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderServerProcHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderServerProcHandler::S_1( "1" );

	CFBamCustXmlLoaderServerProcHandler::CFBamCustXmlLoaderServerProcHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderServerProcHandler::~CFBamCustXmlLoaderServerProcHandler() {
	}

	void CFBamCustXmlLoaderServerProcHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "ServerProc" ) {
				static const std::string Msg( "Expected QName to be 'ServerProc'" );
			...
			origServerProc = dynamic_cast<cfbam::ICFBamServerProcObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderServerProcHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
