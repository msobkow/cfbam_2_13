...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderBoolTypeHandler::CLASS_NAME( "CFBamCustXmlLoaderBoolTypeHandler" );
	const std::string CFBamCustXmlLoaderBoolTypeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderBoolTypeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderBoolTypeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderBoolTypeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderBoolTypeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderBoolTypeHandler::S_1( "1" );

	CFBamCustXmlLoaderBoolTypeHandler::CFBamCustXmlLoaderBoolTypeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderBoolTypeHandler::~CFBamCustXmlLoaderBoolTypeHandler() {
	}

	void CFBamCustXmlLoaderBoolTypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "BoolType" ) {
				static const std::string Msg( "Expected QName to be 'BoolType'" );
			...
			cfbam::ICFBamBoolTypeObj* tmpBuff = schemaObj->getBoolTypeTableObj()->newInstance();
			cfbam::ICFBamBoolTypeEditObj* editBuff = dynamic_cast<cfbam::ICFBamBoolTypeEditObj*>( tmpBuff->beginEdit() );
			...
			cflib::CFLibXmlCoreContext* parentContext = curContext->getPrevContext();
			cflib::ICFLibAnyObj* scopeObj;
			...
			cfbam::ICFBamBoolTypeObj* origBoolType = dynamic_cast<cfbam::ICFBamBoolTypeObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderBoolTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
