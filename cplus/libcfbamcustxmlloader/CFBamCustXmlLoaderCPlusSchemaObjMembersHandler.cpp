...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusSchemaObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusSchemaObjMembersHandler" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusSchemaObjMembersHandler::CFBamCustXmlLoaderCPlusSchemaObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusSchemaObjMembersHandler::~CFBamCustXmlLoaderCPlusSchemaObjMembersHandler() {
	}

	void CFBamCustXmlLoaderCPlusSchemaObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusSchemaObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'CPlusSchemaObjMembers'" );
	...
	void CFBamCustXmlLoaderCPlusSchemaObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppSchemaObjMembersNull() || schemaDefObj->getOptionalCppSchemaObjMembersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppSchemaObjMembersValue( text );
