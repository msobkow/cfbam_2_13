...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusDb2LUWTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusDb2LUWTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusDb2LUWTableImplementationHandler::CFBamCustXmlLoaderHPlusDb2LUWTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusDb2LUWTableImplementationHandler::~CFBamCustXmlLoaderHPlusDb2LUWTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderHPlusDb2LUWTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusDb2LUWTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'HPlusDb2LUWTableImplementation'" );
	...
	void CFBamCustXmlLoaderHPlusDb2LUWTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppDb2LUWTableImplementationNull() || tableObj->getOptionalHppDb2LUWTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppDb2LUWTableImplementationValue( text );
