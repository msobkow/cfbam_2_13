...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderUInt32TypeHandler::CLASS_NAME( "CFBamCustXmlLoaderUInt32TypeHandler" );
	const std::string CFBamCustXmlLoaderUInt32TypeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderUInt32TypeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderUInt32TypeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderUInt32TypeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderUInt32TypeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderUInt32TypeHandler::S_1( "1" );

	CFBamCustXmlLoaderUInt32TypeHandler::CFBamCustXmlLoaderUInt32TypeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderUInt32TypeHandler::~CFBamCustXmlLoaderUInt32TypeHandler() {
	}

	void CFBamCustXmlLoaderUInt32TypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "UInt32Type" ) {
				static const std::string Msg( "Expected QName to be 'UInt32Type'" );
			...
			origUInt32Type = dynamic_cast<cfbam::ICFBamUInt32TypeObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderUInt32TypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
