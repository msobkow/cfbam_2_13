...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeOracleSchemaObjImplHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeOracleSchemaObjImplHandler" );
	const std::string CFBamCustXmlLoaderCafeOracleSchemaObjImplHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeOracleSchemaObjImplHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeOracleSchemaObjImplHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeOracleSchemaObjImplHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeOracleSchemaObjImplHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeOracleSchemaObjImplHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeOracleSchemaObjImplHandler::CFBamCustXmlLoaderCafeOracleSchemaObjImplHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeOracleSchemaObjImplHandler::~CFBamCustXmlLoaderCafeOracleSchemaObjImplHandler() {
	}

	void CFBamCustXmlLoaderCafeOracleSchemaObjImplHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeOracleSchemaObjImpl" ) {
				static const std::string Msg( "Expected QName to be 'CafeOracleSchemaObjImpl'" );
	...
	void CFBamCustXmlLoaderCafeOracleSchemaObjImplHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJOracleSchemaObjImplNull() || schemaDefObj->getOptionalJOracleSchemaObjImplValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJOracleSchemaObjImplValue( text );
