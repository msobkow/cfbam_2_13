...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusOracleTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusOracleTableMembersHandler" );
	const std::string CFBamCustXmlLoaderHPlusOracleTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusOracleTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusOracleTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusOracleTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusOracleTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusOracleTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusOracleTableMembersHandler::CFBamCustXmlLoaderHPlusOracleTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusOracleTableMembersHandler::~CFBamCustXmlLoaderHPlusOracleTableMembersHandler() {
	}

	void CFBamCustXmlLoaderHPlusOracleTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusOracleTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'HPlusOracleTableMembers'" );
	...
	void CFBamCustXmlLoaderHPlusOracleTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppOracleTableMembersNull() || tableObj->getOptionalHppOracleTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppOracleTableMembersValue( text );
