...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusRamSchemaObjImplHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusRamSchemaObjImplHandler" );
	const std::string CFBamCustXmlLoaderCPlusRamSchemaObjImplHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusRamSchemaObjImplHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusRamSchemaObjImplHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusRamSchemaObjImplHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusRamSchemaObjImplHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusRamSchemaObjImplHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusRamSchemaObjImplHandler::CFBamCustXmlLoaderCPlusRamSchemaObjImplHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusRamSchemaObjImplHandler::~CFBamCustXmlLoaderCPlusRamSchemaObjImplHandler() {
	}

	void CFBamCustXmlLoaderCPlusRamSchemaObjImplHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusRamSchemaObjImpl" ) {
				static const std::string Msg( "Expected QName to be 'CPlusRamSchemaObjImpl'" );
	...
	void CFBamCustXmlLoaderCPlusRamSchemaObjImplHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppRamSchemaObjImplNull() || schemaDefObj->getOptionalCppRamSchemaObjImplValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppRamSchemaObjImplValue( text );
