...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeXMsgRspnTableImportHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeXMsgRspnTableImportHandler" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnTableImportHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnTableImportHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnTableImportHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnTableImportHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnTableImportHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnTableImportHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeXMsgRspnTableImportHandler::CFBamCustXmlLoaderCafeXMsgRspnTableImportHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeXMsgRspnTableImportHandler::~CFBamCustXmlLoaderCafeXMsgRspnTableImportHandler() {
	}

	void CFBamCustXmlLoaderCafeXMsgRspnTableImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeXMsgRspnTableImport" ) {
				static const std::string Msg( "Expected QName to be 'CafeXMsgRspnTableImport'" );
	...
	void CFBamCustXmlLoaderCafeXMsgRspnTableImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJXMsgRspnTableImportNull() || tableObj->getOptionalJXMsgRspnTableImportValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJXMsgRspnTableImportValue( text );
