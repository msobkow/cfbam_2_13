...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusXMsgClientSchemaIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusXMsgClientSchemaIncludeHandler" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientSchemaIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientSchemaIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientSchemaIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientSchemaIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientSchemaIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientSchemaIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusXMsgClientSchemaIncludeHandler::CFBamCustXmlLoaderHPlusXMsgClientSchemaIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusXMsgClientSchemaIncludeHandler::~CFBamCustXmlLoaderHPlusXMsgClientSchemaIncludeHandler() {
	}

	void CFBamCustXmlLoaderHPlusXMsgClientSchemaIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusXMsgClientSchemaInclude" ) {
				static const std::string Msg( "Expected QName to be 'HPlusXMsgClientSchemaInclude'" );
	...
	void CFBamCustXmlLoaderHPlusXMsgClientSchemaIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppXMsgClientSchemaIncludeNull() || schemaDefObj->getOptionalHppXMsgClientSchemaIncludeValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppXMsgClientSchemaIncludeValue( text );
