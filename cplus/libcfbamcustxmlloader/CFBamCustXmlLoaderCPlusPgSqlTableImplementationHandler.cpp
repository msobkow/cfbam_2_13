...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusPgSqlTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusPgSqlTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusPgSqlTableImplementationHandler::CFBamCustXmlLoaderCPlusPgSqlTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusPgSqlTableImplementationHandler::~CFBamCustXmlLoaderCPlusPgSqlTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderCPlusPgSqlTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusPgSqlTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CPlusPgSqlTableImplementation'" );
	...
	void CFBamCustXmlLoaderCPlusPgSqlTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppPgSqlTableImplementationNull() || tableObj->getOptionalCppPgSqlTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppPgSqlTableImplementationValue( text );
