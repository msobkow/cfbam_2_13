...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeDb2LUWTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeDb2LUWTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeDb2LUWTableImplementationHandler::CFBamCustXmlLoaderCafeDb2LUWTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeDb2LUWTableImplementationHandler::~CFBamCustXmlLoaderCafeDb2LUWTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderCafeDb2LUWTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeDb2LUWTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CafeDb2LUWTableImplementation'" );
	...
	void CFBamCustXmlLoaderCafeDb2LUWTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJDb2LUWTableImplementationNull() || tableObj->getOptionalJDb2LUWTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJDb2LUWTableImplementationValue( text );
