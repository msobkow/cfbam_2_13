...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusMySqlSchemaObjImplHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusMySqlSchemaObjImplHandler" );
	const std::string CFBamCustXmlLoaderCPlusMySqlSchemaObjImplHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusMySqlSchemaObjImplHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusMySqlSchemaObjImplHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusMySqlSchemaObjImplHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusMySqlSchemaObjImplHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusMySqlSchemaObjImplHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusMySqlSchemaObjImplHandler::CFBamCustXmlLoaderCPlusMySqlSchemaObjImplHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusMySqlSchemaObjImplHandler::~CFBamCustXmlLoaderCPlusMySqlSchemaObjImplHandler() {
	}

	void CFBamCustXmlLoaderCPlusMySqlSchemaObjImplHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusMySqlSchemaObjImpl" ) {
				static const std::string Msg( "Expected QName to be 'CPlusMySqlSchemaObjImpl'" );
	...
	void CFBamCustXmlLoaderCPlusMySqlSchemaObjImplHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppMySqlSchemaObjImplNull() || schemaDefObj->getOptionalCppMySqlSchemaObjImplValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppMySqlSchemaObjImplValue( text );
