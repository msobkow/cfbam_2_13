...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpXMsgSchemaFormattersHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpXMsgSchemaFormattersHandler" );
	const std::string CFBamCustXmlLoaderCSharpXMsgSchemaFormattersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpXMsgSchemaFormattersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpXMsgSchemaFormattersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpXMsgSchemaFormattersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpXMsgSchemaFormattersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpXMsgSchemaFormattersHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpXMsgSchemaFormattersHandler::CFBamCustXmlLoaderCSharpXMsgSchemaFormattersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpXMsgSchemaFormattersHandler::~CFBamCustXmlLoaderCSharpXMsgSchemaFormattersHandler() {
	}

	void CFBamCustXmlLoaderCSharpXMsgSchemaFormattersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpXMsgSchemaFormatters" ) {
				static const std::string Msg( "Expected QName to be 'CSharpXMsgSchemaFormatters'" );
	...
	void CFBamCustXmlLoaderCSharpXMsgSchemaFormattersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsXMsgSchemaFormattersNull() || schemaDefObj->getOptionalCsXMsgSchemaFormattersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsXMsgSchemaFormattersValue( text );
