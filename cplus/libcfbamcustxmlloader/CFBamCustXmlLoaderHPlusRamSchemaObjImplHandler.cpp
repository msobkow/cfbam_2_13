...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusRamSchemaObjImplHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusRamSchemaObjImplHandler" );
	const std::string CFBamCustXmlLoaderHPlusRamSchemaObjImplHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusRamSchemaObjImplHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusRamSchemaObjImplHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusRamSchemaObjImplHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusRamSchemaObjImplHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusRamSchemaObjImplHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusRamSchemaObjImplHandler::CFBamCustXmlLoaderHPlusRamSchemaObjImplHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusRamSchemaObjImplHandler::~CFBamCustXmlLoaderHPlusRamSchemaObjImplHandler() {
	}

	void CFBamCustXmlLoaderHPlusRamSchemaObjImplHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusRamSchemaObjImpl" ) {
				static const std::string Msg( "Expected QName to be 'HPlusRamSchemaObjImpl'" );
	...
	void CFBamCustXmlLoaderHPlusRamSchemaObjImplHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppRamSchemaObjImplNull() || schemaDefObj->getOptionalHppRamSchemaObjImplValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppRamSchemaObjImplValue( text );
