...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusXMsgClientSchemaBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusXMsgClientSchemaBodyHandler" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientSchemaBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientSchemaBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientSchemaBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientSchemaBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientSchemaBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientSchemaBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusXMsgClientSchemaBodyHandler::CFBamCustXmlLoaderCPlusXMsgClientSchemaBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusXMsgClientSchemaBodyHandler::~CFBamCustXmlLoaderCPlusXMsgClientSchemaBodyHandler() {
	}

	void CFBamCustXmlLoaderCPlusXMsgClientSchemaBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusXMsgClientSchemaBody" ) {
				static const std::string Msg( "Expected QName to be 'CPlusXMsgClientSchemaBody'" );
	...
	void CFBamCustXmlLoaderCPlusXMsgClientSchemaBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppXMsgClientSchemaBodyNull() || schemaDefObj->getOptionalCppXMsgClientSchemaBodyValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppXMsgClientSchemaBodyValue( text );
