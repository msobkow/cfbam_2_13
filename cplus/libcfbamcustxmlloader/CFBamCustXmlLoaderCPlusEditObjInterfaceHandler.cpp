...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusEditObjInterfaceHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusEditObjInterfaceHandler" );
	const std::string CFBamCustXmlLoaderCPlusEditObjInterfaceHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusEditObjInterfaceHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusEditObjInterfaceHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusEditObjInterfaceHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusEditObjInterfaceHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusEditObjInterfaceHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusEditObjInterfaceHandler::CFBamCustXmlLoaderCPlusEditObjInterfaceHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusEditObjInterfaceHandler::~CFBamCustXmlLoaderCPlusEditObjInterfaceHandler() {
	}

	void CFBamCustXmlLoaderCPlusEditObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusEditObjInterface" ) {
				static const std::string Msg( "Expected QName to be 'CPlusEditObjInterface'" );
	...
	void CFBamCustXmlLoaderCPlusEditObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppEditObjInterfaceNull() || tableObj->getOptionalCppEditObjInterfaceValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppEditObjInterfaceValue( text );
