...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeDb2LUWTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeDb2LUWTableMembersHandler" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeDb2LUWTableMembersHandler::CFBamCustXmlLoaderCafeDb2LUWTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeDb2LUWTableMembersHandler::~CFBamCustXmlLoaderCafeDb2LUWTableMembersHandler() {
	}

	void CFBamCustXmlLoaderCafeDb2LUWTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeDb2LUWTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'CafeDb2LUWTableMembers'" );
	...
	void CFBamCustXmlLoaderCafeDb2LUWTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJDb2LUWTableMembersNull() || tableObj->getOptionalJDb2LUWTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJDb2LUWTableMembersValue( text );
