...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderTZTimeColHandler::CLASS_NAME( "CFBamCustXmlLoaderTZTimeColHandler" );
	const std::string CFBamCustXmlLoaderTZTimeColHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderTZTimeColHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderTZTimeColHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderTZTimeColHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderTZTimeColHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderTZTimeColHandler::S_1( "1" );

	CFBamCustXmlLoaderTZTimeColHandler::CFBamCustXmlLoaderTZTimeColHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderTZTimeColHandler::~CFBamCustXmlLoaderTZTimeColHandler() {
	}

	void CFBamCustXmlLoaderTZTimeColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "TZTimeCol" ) {
				static const std::string Msg( "Expected QName to be 'TZTimeCol'" );
			...
			origTZTimeCol = dynamic_cast<cfbam::ICFBamTZTimeColObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderTZTimeColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
