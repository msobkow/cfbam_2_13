...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusObjInterfaceHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusObjInterfaceHandler" );
	const std::string CFBamCustXmlLoaderHPlusObjInterfaceHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusObjInterfaceHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusObjInterfaceHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusObjInterfaceHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusObjInterfaceHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusObjInterfaceHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusObjInterfaceHandler::CFBamCustXmlLoaderHPlusObjInterfaceHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusObjInterfaceHandler::~CFBamCustXmlLoaderHPlusObjInterfaceHandler() {
	}

	void CFBamCustXmlLoaderHPlusObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusObjInterface" ) {
				static const std::string Msg( "Expected QName to be 'HPlusObjInterface'" );
	...
	void CFBamCustXmlLoaderHPlusObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppObjInterfaceNull() || tableObj->getOptionalHppObjInterfaceValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppObjInterfaceValue( text );
