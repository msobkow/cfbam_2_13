...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusMSSqlTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusMSSqlTableMembersHandler" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusMSSqlTableMembersHandler::CFBamCustXmlLoaderHPlusMSSqlTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusMSSqlTableMembersHandler::~CFBamCustXmlLoaderHPlusMSSqlTableMembersHandler() {
	}

	void CFBamCustXmlLoaderHPlusMSSqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusMSSqlTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'HPlusMSSqlTableMembers'" );
	...
	void CFBamCustXmlLoaderHPlusMSSqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppMSSqlTableMembersNull() || tableObj->getOptionalHppMSSqlTableMembersValue().empty() ) {
				std::string text = curContext->getElementText();
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppMSSqlTableMembersValue( text );
