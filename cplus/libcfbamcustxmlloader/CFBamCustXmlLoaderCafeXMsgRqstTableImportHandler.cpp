...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeXMsgRqstTableImportHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeXMsgRqstTableImportHandler" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstTableImportHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstTableImportHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstTableImportHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstTableImportHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstTableImportHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstTableImportHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeXMsgRqstTableImportHandler::CFBamCustXmlLoaderCafeXMsgRqstTableImportHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeXMsgRqstTableImportHandler::~CFBamCustXmlLoaderCafeXMsgRqstTableImportHandler() {
	}

	void CFBamCustXmlLoaderCafeXMsgRqstTableImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeXMsgRqstTableImport" ) {
				static const std::string Msg( "Expected QName to be 'CafeXMsgRqstTableImport'" );
	...
	void CFBamCustXmlLoaderCafeXMsgRqstTableImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJXMsgRqstTableImportNull() || tableObj->getOptionalJXMsgRqstTableImportValue().empty() ) {
				std::string text = curContext->getElementText();
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJXMsgRqstTableImportValue( text );
