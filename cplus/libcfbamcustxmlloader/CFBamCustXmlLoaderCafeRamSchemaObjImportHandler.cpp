...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeRamSchemaObjImportHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeRamSchemaObjImportHandler" );
	const std::string CFBamCustXmlLoaderCafeRamSchemaObjImportHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeRamSchemaObjImportHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeRamSchemaObjImportHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeRamSchemaObjImportHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeRamSchemaObjImportHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeRamSchemaObjImportHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeRamSchemaObjImportHandler::CFBamCustXmlLoaderCafeRamSchemaObjImportHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeRamSchemaObjImportHandler::~CFBamCustXmlLoaderCafeRamSchemaObjImportHandler() {
	}

	void CFBamCustXmlLoaderCafeRamSchemaObjImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeRamSchemaObjImport" ) {
				static const std::string Msg( "Expected QName to be 'CafeRamSchemaObjImport'" );
	...
	void CFBamCustXmlLoaderCafeRamSchemaObjImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJRamSchemaObjImportNull() || schemaDefObj->getOptionalJRamSchemaObjImportValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJRamSchemaObjImportValue( text );
