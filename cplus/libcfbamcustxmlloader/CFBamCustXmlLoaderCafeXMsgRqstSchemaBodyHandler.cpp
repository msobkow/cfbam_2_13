...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeXMsgRqstSchemaBodyHandler" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeXMsgRqstSchemaBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeXMsgRqstSchemaBodyHandler::CFBamCustXmlLoaderCafeXMsgRqstSchemaBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeXMsgRqstSchemaBodyHandler::~CFBamCustXmlLoaderCafeXMsgRqstSchemaBodyHandler() {
	}

	void CFBamCustXmlLoaderCafeXMsgRqstSchemaBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeXMsgRqstSchemaBody" ) {
				static const std::string Msg( "Expected QName to be 'CafeXMsgRqstSchemaBody'" );
	...
	void CFBamCustXmlLoaderCafeXMsgRqstSchemaBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJXMsgRqstSchemaBodyNull() || schemaDefObj->getOptionalJXMsgRqstSchemaBodyValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJXMsgRqstSchemaBodyValue( text );
