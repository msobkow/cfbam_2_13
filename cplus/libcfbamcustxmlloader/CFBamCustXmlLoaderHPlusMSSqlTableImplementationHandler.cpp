...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusMSSqlTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusMSSqlTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusMSSqlTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusMSSqlTableImplementationHandler::CFBamCustXmlLoaderHPlusMSSqlTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusMSSqlTableImplementationHandler::~CFBamCustXmlLoaderHPlusMSSqlTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderHPlusMSSqlTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusMSSqlTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'HPlusMSSqlTableImplementation'" );
	...
	void CFBamCustXmlLoaderHPlusMSSqlTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppMSSqlTableImplementationNull() || tableObj->getOptionalHppMSSqlTableImplementationValue().empty() ) {
				std::string text = curContext->getElementText();
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppMSSqlTableImplementationValue( text );
