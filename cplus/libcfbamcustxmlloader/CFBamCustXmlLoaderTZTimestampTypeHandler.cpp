...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderTZTimestampTypeHandler::CLASS_NAME( "CFBamCustXmlLoaderTZTimestampTypeHandler" );
	const std::string CFBamCustXmlLoaderTZTimestampTypeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderTZTimestampTypeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderTZTimestampTypeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderTZTimestampTypeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderTZTimestampTypeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderTZTimestampTypeHandler::S_1( "1" );

	CFBamCustXmlLoaderTZTimestampTypeHandler::CFBamCustXmlLoaderTZTimestampTypeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderTZTimestampTypeHandler::~CFBamCustXmlLoaderTZTimestampTypeHandler() {
	}

	void CFBamCustXmlLoaderTZTimestampTypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "TZTimestampType" ) {
				static const std::string Msg( "Expected QName to be 'TZTimestampType'" );
			...
			origTZTimestampType = dynamic_cast<cfbam::ICFBamTZTimestampTypeObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderTZTimestampTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
