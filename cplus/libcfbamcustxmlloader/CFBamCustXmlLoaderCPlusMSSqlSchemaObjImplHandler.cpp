...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusMSSqlSchemaObjImplHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusMSSqlSchemaObjImplHandler" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlSchemaObjImplHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlSchemaObjImplHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlSchemaObjImplHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlSchemaObjImplHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlSchemaObjImplHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlSchemaObjImplHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusMSSqlSchemaObjImplHandler::CFBamCustXmlLoaderCPlusMSSqlSchemaObjImplHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusMSSqlSchemaObjImplHandler::~CFBamCustXmlLoaderCPlusMSSqlSchemaObjImplHandler() {
	}

	void CFBamCustXmlLoaderCPlusMSSqlSchemaObjImplHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusMSSqlSchemaObjImpl" ) {
				static const std::string Msg( "Expected QName to be 'CPlusMSSqlSchemaObjImpl'" );
	...
	void CFBamCustXmlLoaderCPlusMSSqlSchemaObjImplHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppMSSqlSchemaObjImplNull() || schemaDefObj->getOptionalCppMSSqlSchemaObjImplValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppMSSqlSchemaObjImplValue( text );
