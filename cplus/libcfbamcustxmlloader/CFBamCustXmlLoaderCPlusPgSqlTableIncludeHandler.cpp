...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusPgSqlTableIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusPgSqlTableIncludeHandler" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlTableIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlTableIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlTableIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlTableIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlTableIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusPgSqlTableIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusPgSqlTableIncludeHandler::CFBamCustXmlLoaderCPlusPgSqlTableIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusPgSqlTableIncludeHandler::~CFBamCustXmlLoaderCPlusPgSqlTableIncludeHandler() {
	}

	void CFBamCustXmlLoaderCPlusPgSqlTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusPgSqlTableInclude" ) {
				static const std::string Msg( "Expected QName to be 'CPlusPgSqlTableInclude'" );
	...
	void CFBamCustXmlLoaderCPlusPgSqlTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppPgSqlTableIncludeNull() || tableObj->getOptionalCppPgSqlTableIncludeValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppPgSqlTableIncludeValue( text );
