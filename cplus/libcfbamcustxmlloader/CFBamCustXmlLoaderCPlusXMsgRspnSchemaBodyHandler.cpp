...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusXMsgRspnSchemaBodyHandler" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusXMsgRspnSchemaBodyHandler::CFBamCustXmlLoaderCPlusXMsgRspnSchemaBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusXMsgRspnSchemaBodyHandler::~CFBamCustXmlLoaderCPlusXMsgRspnSchemaBodyHandler() {
	}

	void CFBamCustXmlLoaderCPlusXMsgRspnSchemaBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusXMsgRspnSchemaBody" ) {
				static const std::string Msg( "Expected QName to be 'CPlusXMsgRspnSchemaBody'" );
	...
	void CFBamCustXmlLoaderCPlusXMsgRspnSchemaBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppXMsgRspnSchemaBodyNull() || schemaDefObj->getOptionalCppXMsgRspnSchemaBodyValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppXMsgRspnSchemaBodyValue( text );
