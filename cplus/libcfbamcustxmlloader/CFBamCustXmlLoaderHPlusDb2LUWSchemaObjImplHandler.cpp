...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusDb2LUWSchemaObjImplHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusDb2LUWSchemaObjImplHandler" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWSchemaObjImplHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWSchemaObjImplHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWSchemaObjImplHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWSchemaObjImplHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWSchemaObjImplHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWSchemaObjImplHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusDb2LUWSchemaObjImplHandler::CFBamCustXmlLoaderHPlusDb2LUWSchemaObjImplHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusDb2LUWSchemaObjImplHandler::~CFBamCustXmlLoaderHPlusDb2LUWSchemaObjImplHandler() {
	}

	void CFBamCustXmlLoaderHPlusDb2LUWSchemaObjImplHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusDb2LUWSchemaObjImpl" ) {
				static const std::string Msg( "Expected QName to be 'HPlusDb2LUWSchemaObjImpl'" );
	...
	void CFBamCustXmlLoaderHPlusDb2LUWSchemaObjImplHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppDb2LUWSchemaObjImplNull() || schemaDefObj->getOptionalHppDb2LUWSchemaObjImplValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppDb2LUWSchemaObjImplValue( text );
