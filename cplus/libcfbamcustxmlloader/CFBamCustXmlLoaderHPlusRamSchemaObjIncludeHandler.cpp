...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusRamSchemaObjIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusRamSchemaObjIncludeHandler" );
	const std::string CFBamCustXmlLoaderHPlusRamSchemaObjIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusRamSchemaObjIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusRamSchemaObjIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusRamSchemaObjIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusRamSchemaObjIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusRamSchemaObjIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusRamSchemaObjIncludeHandler::CFBamCustXmlLoaderHPlusRamSchemaObjIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusRamSchemaObjIncludeHandler::~CFBamCustXmlLoaderHPlusRamSchemaObjIncludeHandler() {
	}

	void CFBamCustXmlLoaderHPlusRamSchemaObjIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusRamSchemaObjInclude" ) {
				static const std::string Msg( "Expected QName to be 'HPlusRamSchemaObjInclude'" );
	...
	void CFBamCustXmlLoaderHPlusRamSchemaObjIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppRamSchemaObjIncludeNull() || schemaDefObj->getOptionalHppRamSchemaObjIncludeValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppRamSchemaObjIncludeValue( text );
