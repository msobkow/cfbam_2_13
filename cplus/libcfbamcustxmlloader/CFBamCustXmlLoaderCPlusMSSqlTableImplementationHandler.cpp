...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusMSSqlTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusMSSqlTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusMSSqlTableImplementationHandler::CFBamCustXmlLoaderCPlusMSSqlTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusMSSqlTableImplementationHandler::~CFBamCustXmlLoaderCPlusMSSqlTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderCPlusMSSqlTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusMSSqlTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CPlusMSSqlTableImplementation'" );
	...
	void CFBamCustXmlLoaderCPlusMSSqlTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppMSSqlTableImplementationNull() || tableObj->getOptionalCppMSSqlTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppMSSqlTableImplementationValue( text );
