...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstTableIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusXMsgRqstTableIncludeHandler" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstTableIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstTableIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstTableIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstTableIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstTableIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstTableIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusXMsgRqstTableIncludeHandler::CFBamCustXmlLoaderCPlusXMsgRqstTableIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusXMsgRqstTableIncludeHandler::~CFBamCustXmlLoaderCPlusXMsgRqstTableIncludeHandler() {
	}

	void CFBamCustXmlLoaderCPlusXMsgRqstTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusXMsgRqstTableInclude" ) {
				static const std::string Msg( "Expected QName to be 'CPlusXMsgRqstTableInclude'" );
	...
	void CFBamCustXmlLoaderCPlusXMsgRqstTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppXMsgRqstTableIncludeNull() || tableObj->getOptionalCppXMsgRqstTableIncludeValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppXMsgRqstTableIncludeValue( text );
