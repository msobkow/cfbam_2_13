...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusMSSqlSchemaObjIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusMSSqlSchemaObjIncludeHandler" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlSchemaObjIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlSchemaObjIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlSchemaObjIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlSchemaObjIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlSchemaObjIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusMSSqlSchemaObjIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusMSSqlSchemaObjIncludeHandler::CFBamCustXmlLoaderCPlusMSSqlSchemaObjIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusMSSqlSchemaObjIncludeHandler::~CFBamCustXmlLoaderCPlusMSSqlSchemaObjIncludeHandler() {
	}

	void CFBamCustXmlLoaderCPlusMSSqlSchemaObjIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusMSSqlSchemaObjInclude" ) {
				static const std::string Msg( "Expected QName to be 'CPlusMSSqlSchemaObjInclude'" );
	...
	void CFBamCustXmlLoaderCPlusMSSqlSchemaObjIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppMSSqlSchemaObjIncludeNull() || schemaDefObj->getOptionalCppMSSqlSchemaObjIncludeValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppMSSqlSchemaObjIncludeValue( text );
