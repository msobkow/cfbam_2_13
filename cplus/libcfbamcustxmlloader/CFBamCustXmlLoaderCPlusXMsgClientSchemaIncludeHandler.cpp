...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusXMsgClientSchemaIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusXMsgClientSchemaIncludeHandler" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientSchemaIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientSchemaIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientSchemaIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientSchemaIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientSchemaIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusXMsgClientSchemaIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusXMsgClientSchemaIncludeHandler::CFBamCustXmlLoaderCPlusXMsgClientSchemaIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusXMsgClientSchemaIncludeHandler::~CFBamCustXmlLoaderCPlusXMsgClientSchemaIncludeHandler() {
	}

	void CFBamCustXmlLoaderCPlusXMsgClientSchemaIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusXMsgClientSchemaInclude" ) {
				static const std::string Msg( "Expected QName to be 'CPlusXMsgClientSchemaInclude'" );
	...
	void CFBamCustXmlLoaderCPlusXMsgClientSchemaIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppXMsgClientSchemaIncludeNull() || schemaDefObj->getOptionalCppXMsgClientSchemaIncludeValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppXMsgClientSchemaIncludeValue( text );
