...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusSchemaObjImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusSchemaObjImplementationHandler" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusSchemaObjImplementationHandler::CFBamCustXmlLoaderCPlusSchemaObjImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusSchemaObjImplementationHandler::~CFBamCustXmlLoaderCPlusSchemaObjImplementationHandler() {
	}

	void CFBamCustXmlLoaderCPlusSchemaObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusSchemaObjImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CPlusSchemaObjImplementation'" );
	...
	void CFBamCustXmlLoaderCPlusSchemaObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppSchemaObjImplementationNull() || schemaDefObj->getOptionalCppSchemaObjImplementationValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppSchemaObjImplementationValue( text );
