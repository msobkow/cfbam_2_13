...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusRamTableIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusRamTableIncludeHandler" );
	const std::string CFBamCustXmlLoaderCPlusRamTableIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusRamTableIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusRamTableIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusRamTableIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusRamTableIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusRamTableIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusRamTableIncludeHandler::CFBamCustXmlLoaderCPlusRamTableIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusRamTableIncludeHandler::~CFBamCustXmlLoaderCPlusRamTableIncludeHandler() {
	}

	void CFBamCustXmlLoaderCPlusRamTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusRamTableInclude" ) {
				static const std::string Msg( "Expected QName to be 'CPlusRamTableInclude'" );
	...
	void CFBamCustXmlLoaderCPlusRamTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppRamTableIncludeNull() || tableObj->getOptionalCppRamTableIncludeValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppRamTableIncludeValue( text );
