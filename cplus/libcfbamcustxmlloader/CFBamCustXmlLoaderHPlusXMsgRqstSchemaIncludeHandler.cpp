...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusXMsgRqstSchemaIncludeHandler" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstSchemaIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusXMsgRqstSchemaIncludeHandler::CFBamCustXmlLoaderHPlusXMsgRqstSchemaIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusXMsgRqstSchemaIncludeHandler::~CFBamCustXmlLoaderHPlusXMsgRqstSchemaIncludeHandler() {
	}

	void CFBamCustXmlLoaderHPlusXMsgRqstSchemaIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusXMsgRqstSchemaInclude" ) {
				static const std::string Msg( "Expected QName to be 'HPlusXMsgRqstSchemaInclude'" );
	...
	void CFBamCustXmlLoaderHPlusXMsgRqstSchemaIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppXMsgRqstSchemaIncludeNull() || schemaDefObj->getOptionalHppXMsgRqstSchemaIncludeValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppXMsgRqstSchemaIncludeValue( text );
