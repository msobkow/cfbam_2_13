...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpMSSqlTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpMSSqlTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpMSSqlTableImplementationHandler::CFBamCustXmlLoaderCSharpMSSqlTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpMSSqlTableImplementationHandler::~CFBamCustXmlLoaderCSharpMSSqlTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderCSharpMSSqlTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpMSSqlTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CSharpMSSqlTableImplementation'" );
	...
	void CFBamCustXmlLoaderCSharpMSSqlTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsMSSqlTableImplementationNull() || tableObj->getOptionalCsMSSqlTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsMSSqlTableImplementationValue( text );
