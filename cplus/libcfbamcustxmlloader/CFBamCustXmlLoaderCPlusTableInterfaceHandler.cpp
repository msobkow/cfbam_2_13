...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusTableInterfaceHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusTableInterfaceHandler" );
	const std::string CFBamCustXmlLoaderCPlusTableInterfaceHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusTableInterfaceHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusTableInterfaceHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusTableInterfaceHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusTableInterfaceHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusTableInterfaceHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusTableInterfaceHandler::CFBamCustXmlLoaderCPlusTableInterfaceHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusTableInterfaceHandler::~CFBamCustXmlLoaderCPlusTableInterfaceHandler() {
	}

	void CFBamCustXmlLoaderCPlusTableInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusTableInterface" ) {
				static const std::string Msg( "Expected QName to be 'CPlusTableInterface'" );
	...
	void CFBamCustXmlLoaderCPlusTableInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppTableInterfaceNull() || tableObj->getOptionalCppTableInterfaceValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppTableInterfaceValue( text );
