...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaUsingHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpXMsgRqstSchemaUsingHandler" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaUsingHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaUsingHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaUsingHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaUsingHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaUsingHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaUsingHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpXMsgRqstSchemaUsingHandler::CFBamCustXmlLoaderCSharpXMsgRqstSchemaUsingHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpXMsgRqstSchemaUsingHandler::~CFBamCustXmlLoaderCSharpXMsgRqstSchemaUsingHandler() {
	}

	void CFBamCustXmlLoaderCSharpXMsgRqstSchemaUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpXMsgRqstSchemaUsing" ) {
				static const std::string Msg( "Expected QName to be 'CSharpXMsgRqstSchemaUsing'" );
	...
	void CFBamCustXmlLoaderCSharpXMsgRqstSchemaUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsXMsgRqstSchemaUsingNull() || schemaDefObj->getOptionalCsXMsgRqstSchemaUsingValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsXMsgRqstSchemaUsingValue( text );
