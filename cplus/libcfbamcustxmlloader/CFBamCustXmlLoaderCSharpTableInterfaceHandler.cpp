...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpTableInterfaceHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpTableInterfaceHandler" );
	const std::string CFBamCustXmlLoaderCSharpTableInterfaceHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpTableInterfaceHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpTableInterfaceHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpTableInterfaceHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpTableInterfaceHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpTableInterfaceHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpTableInterfaceHandler::CFBamCustXmlLoaderCSharpTableInterfaceHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpTableInterfaceHandler::~CFBamCustXmlLoaderCSharpTableInterfaceHandler() {
	}

	void CFBamCustXmlLoaderCSharpTableInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpTableInterface" ) {
				static const std::string Msg( "Expected QName to be 'CSharpTableInterface'" );
	...
	void CFBamCustXmlLoaderCSharpTableInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsTableInterfaceNull() || tableObj->getOptionalCsTableInterfaceValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsTableInterfaceValue( text );
