...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeObjInterfaceHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeObjInterfaceHandler" );
	const std::string CFBamCustXmlLoaderCafeObjInterfaceHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeObjInterfaceHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeObjInterfaceHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeObjInterfaceHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeObjInterfaceHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeObjInterfaceHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeObjInterfaceHandler::CFBamCustXmlLoaderCafeObjInterfaceHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeObjInterfaceHandler::~CFBamCustXmlLoaderCafeObjInterfaceHandler() {
	}

	void CFBamCustXmlLoaderCafeObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeObjInterface" ) {
				static const std::string Msg( "Expected QName to be 'CafeObjInterface'" );
	...
	void CFBamCustXmlLoaderCafeObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJObjInterfaceNull() || tableObj->getOptionalJObjInterfaceValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJObjInterfaceValue( text );
