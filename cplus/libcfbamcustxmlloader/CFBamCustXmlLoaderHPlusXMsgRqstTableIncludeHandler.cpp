...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstTableIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusXMsgRqstTableIncludeHandler" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstTableIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstTableIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstTableIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstTableIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstTableIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstTableIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusXMsgRqstTableIncludeHandler::CFBamCustXmlLoaderHPlusXMsgRqstTableIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusXMsgRqstTableIncludeHandler::~CFBamCustXmlLoaderHPlusXMsgRqstTableIncludeHandler() {
	}

	void CFBamCustXmlLoaderHPlusXMsgRqstTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusXMsgRqstTableInclude" ) {
				static const std::string Msg( "Expected QName to be 'HPlusXMsgRqstTableInclude'" );
	...
	void CFBamCustXmlLoaderHPlusXMsgRqstTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppXMsgRqstTableIncludeNull() || tableObj->getOptionalHppXMsgRqstTableIncludeValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppXMsgRqstTableIncludeValue( text );
