...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpObjInterfaceHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpObjInterfaceHandler" );
	const std::string CFBamCustXmlLoaderCSharpObjInterfaceHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpObjInterfaceHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpObjInterfaceHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpObjInterfaceHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpObjInterfaceHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpObjInterfaceHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpObjInterfaceHandler::CFBamCustXmlLoaderCSharpObjInterfaceHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpObjInterfaceHandler::~CFBamCustXmlLoaderCSharpObjInterfaceHandler() {
	}

	void CFBamCustXmlLoaderCSharpObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpObjInterface" ) {
				static const std::string Msg( "Expected QName to be 'CSharpObjInterface'" );
	...
	void CFBamCustXmlLoaderCSharpObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsObjInterfaceNull() || tableObj->getOptionalCsObjInterfaceValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsObjInterfaceValue( text );
