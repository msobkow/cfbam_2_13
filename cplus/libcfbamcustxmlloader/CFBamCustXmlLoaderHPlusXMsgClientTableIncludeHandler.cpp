...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusXMsgClientTableIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusXMsgClientTableIncludeHandler" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientTableIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientTableIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientTableIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientTableIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientTableIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusXMsgClientTableIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusXMsgClientTableIncludeHandler::CFBamCustXmlLoaderHPlusXMsgClientTableIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusXMsgClientTableIncludeHandler::~CFBamCustXmlLoaderHPlusXMsgClientTableIncludeHandler() {
	}

	void CFBamCustXmlLoaderHPlusXMsgClientTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusXMsgClientTableInclude" ) {
				static const std::string Msg( "Expected QName to be 'HPlusXMsgClientTableInclude'" );
	...
	void CFBamCustXmlLoaderHPlusXMsgClientTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppXMsgClientTableIncludeNull() || tableObj->getOptionalHppXMsgClientTableIncludeValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppXMsgClientTableIncludeValue( text );
