...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusTableIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusTableIncludeHandler" );
	const std::string CFBamCustXmlLoaderHPlusTableIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusTableIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusTableIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusTableIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusTableIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusTableIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusTableIncludeHandler::CFBamCustXmlLoaderHPlusTableIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusTableIncludeHandler::~CFBamCustXmlLoaderHPlusTableIncludeHandler() {
	}

	void CFBamCustXmlLoaderHPlusTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusTableInclude" ) {
				static const std::string Msg( "Expected QName to be 'HPlusTableInclude'" );
	...
	void CFBamCustXmlLoaderHPlusTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppTableIncludeNull() || tableObj->getOptionalHppTableIncludeValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppTableIncludeValue( text );
