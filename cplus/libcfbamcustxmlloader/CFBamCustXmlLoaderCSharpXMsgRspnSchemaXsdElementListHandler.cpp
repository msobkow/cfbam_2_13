...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdElementListHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdElementListHandler" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdElementListHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdElementListHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdElementListHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdElementListHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdElementListHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdElementListHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdElementListHandler::CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdElementListHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdElementListHandler::~CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdElementListHandler() {
	}

	void CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdElementListHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpXMsgRspnSchemaXsdElementList" ) {
				static const std::string Msg( "Expected QName to be 'CSharpXMsgRspnSchemaXsdElementList'" );
	...
	void CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdElementListHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsXMsgRspnSchemaXsdElementListNull() || schemaDefObj->getOptionalCsXMsgRspnSchemaXsdElementListValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsXMsgRspnSchemaXsdElementListValue( text );
