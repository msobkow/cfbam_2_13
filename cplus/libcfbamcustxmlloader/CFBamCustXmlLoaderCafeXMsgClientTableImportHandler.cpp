...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeXMsgClientTableImportHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeXMsgClientTableImportHandler" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientTableImportHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientTableImportHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientTableImportHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientTableImportHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientTableImportHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientTableImportHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeXMsgClientTableImportHandler::CFBamCustXmlLoaderCafeXMsgClientTableImportHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeXMsgClientTableImportHandler::~CFBamCustXmlLoaderCafeXMsgClientTableImportHandler() {
	}

	void CFBamCustXmlLoaderCafeXMsgClientTableImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeXMsgClientTableImport" ) {
				static const std::string Msg( "Expected QName to be 'CafeXMsgClientTableImport'" );
	...
	void CFBamCustXmlLoaderCafeXMsgClientTableImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJXMsgClientTableImportNull() || tableObj->getOptionalJXMsgClientTableImportValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJXMsgClientTableImportValue( text );
