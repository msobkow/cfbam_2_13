...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdSpecHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdSpecHandler" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdSpecHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdSpecHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdSpecHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdSpecHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdSpecHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdSpecHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdSpecHandler::CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdSpecHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdSpecHandler::~CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdSpecHandler() {
	}

	void CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdSpecHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusXMsgRqstSchemaXsdSpec" ) {
				static const std::string Msg( "Expected QName to be 'CPlusXMsgRqstSchemaXsdSpec'" );
	...
	void CFBamCustXmlLoaderCPlusXMsgRqstSchemaXsdSpecHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppXMsgRqstSchemaXsdSpecNull() || schemaDefObj->getOptionalCppXMsgRqstSchemaXsdSpecValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppXMsgRqstSchemaXsdSpecValue( text );
