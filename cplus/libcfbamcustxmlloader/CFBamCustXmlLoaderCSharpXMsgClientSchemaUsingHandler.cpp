...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpXMsgClientSchemaUsingHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpXMsgClientSchemaUsingHandler" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientSchemaUsingHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientSchemaUsingHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientSchemaUsingHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientSchemaUsingHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientSchemaUsingHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientSchemaUsingHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpXMsgClientSchemaUsingHandler::CFBamCustXmlLoaderCSharpXMsgClientSchemaUsingHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpXMsgClientSchemaUsingHandler::~CFBamCustXmlLoaderCSharpXMsgClientSchemaUsingHandler() {
	}

	void CFBamCustXmlLoaderCSharpXMsgClientSchemaUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpXMsgClientSchemaUsing" ) {
				static const std::string Msg( "Expected QName to be 'CSharpXMsgClientSchemaUsing'" );
	...
	void CFBamCustXmlLoaderCSharpXMsgClientSchemaUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsXMsgClientSchemaUsingNull() || schemaDefObj->getOptionalCsXMsgClientSchemaUsingValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsXMsgClientSchemaUsingValue( text );
