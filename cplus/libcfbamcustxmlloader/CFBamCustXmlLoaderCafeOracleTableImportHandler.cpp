...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeOracleTableImportHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeOracleTableImportHandler" );
	const std::string CFBamCustXmlLoaderCafeOracleTableImportHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeOracleTableImportHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeOracleTableImportHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeOracleTableImportHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeOracleTableImportHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeOracleTableImportHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeOracleTableImportHandler::CFBamCustXmlLoaderCafeOracleTableImportHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeOracleTableImportHandler::~CFBamCustXmlLoaderCafeOracleTableImportHandler() {
	}

	void CFBamCustXmlLoaderCafeOracleTableImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeOracleTableImport" ) {
				static const std::string Msg( "Expected QName to be 'CafeOracleTableImport'" );
	...
	void CFBamCustXmlLoaderCafeOracleTableImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJOracleTableImportNull() || tableObj->getOptionalJOracleTableImportValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJOracleTableImportValue( text );
