...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderInt16ColHandler::CLASS_NAME( "CFBamCustXmlLoaderInt16ColHandler" );
	const std::string CFBamCustXmlLoaderInt16ColHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderInt16ColHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderInt16ColHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderInt16ColHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderInt16ColHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderInt16ColHandler::S_1( "1" );

	CFBamCustXmlLoaderInt16ColHandler::CFBamCustXmlLoaderInt16ColHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderInt16ColHandler::~CFBamCustXmlLoaderInt16ColHandler() {
	}

	void CFBamCustXmlLoaderInt16ColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "Int16Col" ) {
				static const std::string Msg( "Expected QName to be 'Int16Col'" );
			...
			origInt16Col = dynamic_cast<cfbam::ICFBamInt16ColObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderInt16ColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
