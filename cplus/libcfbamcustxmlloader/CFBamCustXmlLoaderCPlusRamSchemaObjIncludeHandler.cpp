...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusRamSchemaObjIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusRamSchemaObjIncludeHandler" );
	const std::string CFBamCustXmlLoaderCPlusRamSchemaObjIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusRamSchemaObjIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusRamSchemaObjIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusRamSchemaObjIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusRamSchemaObjIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusRamSchemaObjIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusRamSchemaObjIncludeHandler::CFBamCustXmlLoaderCPlusRamSchemaObjIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusRamSchemaObjIncludeHandler::~CFBamCustXmlLoaderCPlusRamSchemaObjIncludeHandler() {
	}

	void CFBamCustXmlLoaderCPlusRamSchemaObjIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusRamSchemaObjInclude" ) {
				static const std::string Msg( "Expected QName to be 'CPlusRamSchemaObjInclude'" );
	...
	void CFBamCustXmlLoaderCPlusRamSchemaObjIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppRamSchemaObjIncludeNull() || schemaDefObj->getOptionalCppRamSchemaObjIncludeValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppRamSchemaObjIncludeValue( text );
