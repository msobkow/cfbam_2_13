...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderEnumTypeHandler::CLASS_NAME( "CFBamCustXmlLoaderEnumTypeHandler" );
	const std::string CFBamCustXmlLoaderEnumTypeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderEnumTypeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderEnumTypeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderEnumTypeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderEnumTypeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderEnumTypeHandler::S_1( "1" );

	CFBamCustXmlLoaderEnumTypeHandler::CFBamCustXmlLoaderEnumTypeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderEnumTypeHandler::~CFBamCustXmlLoaderEnumTypeHandler() {
	}

	void CFBamCustXmlLoaderEnumTypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "EnumType" ) {
				static const std::string Msg( "Expected QName to be 'EnumType'" );
			...
			origEnumType = dynamic_cast<cfbam::ICFBamEnumTypeObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderEnumTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
