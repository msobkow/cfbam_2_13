...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeTableInterfaceHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeTableInterfaceHandler" );
	const std::string CFBamCustXmlLoaderCafeTableInterfaceHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeTableInterfaceHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeTableInterfaceHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeTableInterfaceHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeTableInterfaceHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeTableInterfaceHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeTableInterfaceHandler::CFBamCustXmlLoaderCafeTableInterfaceHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeTableInterfaceHandler::~CFBamCustXmlLoaderCafeTableInterfaceHandler() {
	}

	void CFBamCustXmlLoaderCafeTableInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeTableInterface" ) {
				static const std::string Msg( "Expected QName to be 'CafeTableInterface'" );
	...
	void CFBamCustXmlLoaderCafeTableInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJTableInterfaceNull() || tableObj->getOptionalJTableInterfaceValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJTableInterfaceValue( text );
