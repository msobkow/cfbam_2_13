...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnTableIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusXMsgRspnTableIncludeHandler" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnTableIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnTableIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnTableIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnTableIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnTableIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnTableIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusXMsgRspnTableIncludeHandler::CFBamCustXmlLoaderHPlusXMsgRspnTableIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusXMsgRspnTableIncludeHandler::~CFBamCustXmlLoaderHPlusXMsgRspnTableIncludeHandler() {
	}

	void CFBamCustXmlLoaderHPlusXMsgRspnTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusXMsgRspnTableInclude" ) {
				static const std::string Msg( "Expected QName to be 'HPlusXMsgRspnTableInclude'" );
	...
	void CFBamCustXmlLoaderHPlusXMsgRspnTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppXMsgRspnTableIncludeNull() || tableObj->getOptionalHppXMsgRspnTableIncludeValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppXMsgRspnTableIncludeValue( text );
