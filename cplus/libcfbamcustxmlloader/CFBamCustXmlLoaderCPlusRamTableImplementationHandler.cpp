...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusRamTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusRamTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderCPlusRamTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusRamTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusRamTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusRamTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusRamTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusRamTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusRamTableImplementationHandler::CFBamCustXmlLoaderCPlusRamTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusRamTableImplementationHandler::~CFBamCustXmlLoaderCPlusRamTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderCPlusRamTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusRamTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CPlusRamTableImplementation'" );
	...
	void CFBamCustXmlLoaderCPlusRamTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppRamTableImplementationNull() || tableObj->getOptionalCppRamTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppRamTableImplementationValue( text );
