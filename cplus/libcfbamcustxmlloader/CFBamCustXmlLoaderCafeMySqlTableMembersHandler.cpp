...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeMySqlTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeMySqlTableMembersHandler" );
	const std::string CFBamCustXmlLoaderCafeMySqlTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeMySqlTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeMySqlTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeMySqlTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeMySqlTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeMySqlTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeMySqlTableMembersHandler::CFBamCustXmlLoaderCafeMySqlTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeMySqlTableMembersHandler::~CFBamCustXmlLoaderCafeMySqlTableMembersHandler() {
	}

	void CFBamCustXmlLoaderCafeMySqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeMySqlTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'CafeMySqlTableMembers'" );
	...
	void CFBamCustXmlLoaderCafeMySqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJMySqlTableMembersNull() || tableObj->getOptionalJMySqlTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJMySqlTableMembersValue( text );
