...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpMySqlTableUsingHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpMySqlTableUsingHandler" );
	const std::string CFBamCustXmlLoaderCSharpMySqlTableUsingHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpMySqlTableUsingHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpMySqlTableUsingHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpMySqlTableUsingHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpMySqlTableUsingHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpMySqlTableUsingHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpMySqlTableUsingHandler::CFBamCustXmlLoaderCSharpMySqlTableUsingHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpMySqlTableUsingHandler::~CFBamCustXmlLoaderCSharpMySqlTableUsingHandler() {
	}

	void CFBamCustXmlLoaderCSharpMySqlTableUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpMySqlTableUsing" ) {
				static const std::string Msg( "Expected QName to be 'CSharpMySqlTableUsing'" );
	...
	void CFBamCustXmlLoaderCSharpMySqlTableUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsMySqlTableUsingNull() || tableObj->getOptionalCsMySqlTableUsingValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsMySqlTableUsingValue( text );
