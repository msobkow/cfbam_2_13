...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusOracleSchemaObjImplHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusOracleSchemaObjImplHandler" );
	const std::string CFBamCustXmlLoaderHPlusOracleSchemaObjImplHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusOracleSchemaObjImplHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusOracleSchemaObjImplHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusOracleSchemaObjImplHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusOracleSchemaObjImplHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusOracleSchemaObjImplHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusOracleSchemaObjImplHandler::CFBamCustXmlLoaderHPlusOracleSchemaObjImplHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusOracleSchemaObjImplHandler::~CFBamCustXmlLoaderHPlusOracleSchemaObjImplHandler() {
	}

	void CFBamCustXmlLoaderHPlusOracleSchemaObjImplHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusOracleSchemaObjImpl" ) {
				static const std::string Msg( "Expected QName to be 'HPlusOracleSchemaObjImpl'" );
	...
	void CFBamCustXmlLoaderHPlusOracleSchemaObjImplHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppOracleSchemaObjImplNull() || schemaDefObj->getOptionalHppOracleSchemaObjImplValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppOracleSchemaObjImplValue( text );
