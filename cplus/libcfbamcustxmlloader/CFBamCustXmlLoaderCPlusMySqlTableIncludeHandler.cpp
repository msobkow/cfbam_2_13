...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusMySqlTableIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusMySqlTableIncludeHandler" );
	const std::string CFBamCustXmlLoaderCPlusMySqlTableIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusMySqlTableIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusMySqlTableIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusMySqlTableIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusMySqlTableIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusMySqlTableIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusMySqlTableIncludeHandler::CFBamCustXmlLoaderCPlusMySqlTableIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusMySqlTableIncludeHandler::~CFBamCustXmlLoaderCPlusMySqlTableIncludeHandler() {
	}

	void CFBamCustXmlLoaderCPlusMySqlTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusMySqlTableInclude" ) {
				static const std::string Msg( "Expected QName to be 'CPlusMySqlTableInclude'" );
	...
	void CFBamCustXmlLoaderCPlusMySqlTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppMySqlTableIncludeNull() || tableObj->getOptionalCppMySqlTableIncludeValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppMySqlTableIncludeValue( text );
