...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaWireParsersHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusXMsgRqstSchemaWireParsersHandler" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaWireParsersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaWireParsersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaWireParsersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaWireParsersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaWireParsersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaWireParsersHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusXMsgRqstSchemaWireParsersHandler::CFBamCustXmlLoaderCPlusXMsgRqstSchemaWireParsersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusXMsgRqstSchemaWireParsersHandler::~CFBamCustXmlLoaderCPlusXMsgRqstSchemaWireParsersHandler() {
	}

	void CFBamCustXmlLoaderCPlusXMsgRqstSchemaWireParsersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusXMsgRqstSchemaWireParsers" ) {
				static const std::string Msg( "Expected QName to be 'CPlusXMsgRqstSchemaWireParsers'" );
	...
	void CFBamCustXmlLoaderCPlusXMsgRqstSchemaWireParsersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppXMsgRqstSchemaWireParsersNull() || schemaDefObj->getOptionalCppXMsgRqstSchemaWireParsersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppXMsgRqstSchemaWireParsersValue( text );
