...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusRamSchemaObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusRamSchemaObjMembersHandler" );
	const std::string CFBamCustXmlLoaderCPlusRamSchemaObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusRamSchemaObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusRamSchemaObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusRamSchemaObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusRamSchemaObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusRamSchemaObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusRamSchemaObjMembersHandler::CFBamCustXmlLoaderCPlusRamSchemaObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusRamSchemaObjMembersHandler::~CFBamCustXmlLoaderCPlusRamSchemaObjMembersHandler() {
	}

	void CFBamCustXmlLoaderCPlusRamSchemaObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusRamSchemaObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'CPlusRamSchemaObjMembers'" );
	...
	void CFBamCustXmlLoaderCPlusRamSchemaObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppRamSchemaObjMembersNull() || schemaDefObj->getOptionalCppRamSchemaObjMembersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppRamSchemaObjMembersValue( text );
