...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpMySqlTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpMySqlTableMembersHandler" );
	const std::string CFBamCustXmlLoaderCSharpMySqlTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpMySqlTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpMySqlTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpMySqlTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpMySqlTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpMySqlTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpMySqlTableMembersHandler::CFBamCustXmlLoaderCSharpMySqlTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpMySqlTableMembersHandler::~CFBamCustXmlLoaderCSharpMySqlTableMembersHandler() {
	}

	void CFBamCustXmlLoaderCSharpMySqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpMySqlTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'CSharpMySqlTableMembers'" );
	...
	void CFBamCustXmlLoaderCSharpMySqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsMySqlTableMembersNull() || tableObj->getOptionalCsMySqlTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsMySqlTableMembersValue( text );
