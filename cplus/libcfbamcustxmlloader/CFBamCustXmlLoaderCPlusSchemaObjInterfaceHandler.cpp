...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusSchemaObjInterfaceHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusSchemaObjInterfaceHandler" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjInterfaceHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjInterfaceHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjInterfaceHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjInterfaceHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjInterfaceHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusSchemaObjInterfaceHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusSchemaObjInterfaceHandler::CFBamCustXmlLoaderCPlusSchemaObjInterfaceHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusSchemaObjInterfaceHandler::~CFBamCustXmlLoaderCPlusSchemaObjInterfaceHandler() {
	}

	void CFBamCustXmlLoaderCPlusSchemaObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusSchemaObjInterface" ) {
				static const std::string Msg( "Expected QName to be 'CPlusSchemaObjInterface'" );
	...
	void CFBamCustXmlLoaderCPlusSchemaObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppSchemaObjInterfaceNull() || schemaDefObj->getOptionalCppSchemaObjInterfaceValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppSchemaObjInterfaceValue( text );
