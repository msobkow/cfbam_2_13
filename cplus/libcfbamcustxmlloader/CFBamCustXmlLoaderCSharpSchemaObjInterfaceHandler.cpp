...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpSchemaObjInterfaceHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpSchemaObjInterfaceHandler" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjInterfaceHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjInterfaceHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjInterfaceHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjInterfaceHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjInterfaceHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjInterfaceHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpSchemaObjInterfaceHandler::CFBamCustXmlLoaderCSharpSchemaObjInterfaceHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpSchemaObjInterfaceHandler::~CFBamCustXmlLoaderCSharpSchemaObjInterfaceHandler() {
	}

	void CFBamCustXmlLoaderCSharpSchemaObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpSchemaObjInterface" ) {
				static const std::string Msg( "Expected QName to be 'CSharpSchemaObjInterface'" );
	...
	void CFBamCustXmlLoaderCSharpSchemaObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsSchemaObjInterfaceNull() || schemaDefObj->getOptionalCsSchemaObjInterfaceValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsSchemaObjInterfaceValue( text );
