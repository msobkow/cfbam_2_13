...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaWireParsersHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusXMsgRspnSchemaWireParsersHandler" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaWireParsersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaWireParsersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaWireParsersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaWireParsersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaWireParsersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaWireParsersHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusXMsgRspnSchemaWireParsersHandler::CFBamCustXmlLoaderCPlusXMsgRspnSchemaWireParsersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusXMsgRspnSchemaWireParsersHandler::~CFBamCustXmlLoaderCPlusXMsgRspnSchemaWireParsersHandler() {
	}

	void CFBamCustXmlLoaderCPlusXMsgRspnSchemaWireParsersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusXMsgRspnSchemaWireParsers" ) {
				static const std::string Msg( "Expected QName to be 'CPlusXMsgRspnSchemaWireParsers'" );
	...
	void CFBamCustXmlLoaderCPlusXMsgRspnSchemaWireParsersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppXMsgRspnSchemaWireParsersNull() || schemaDefObj->getOptionalCppXMsgRspnSchemaWireParsersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppXMsgRspnSchemaWireParsersValue( text );
