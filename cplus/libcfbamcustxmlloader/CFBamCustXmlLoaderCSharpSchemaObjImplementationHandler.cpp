...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpSchemaObjImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpSchemaObjImplementationHandler" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpSchemaObjImplementationHandler::CFBamCustXmlLoaderCSharpSchemaObjImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpSchemaObjImplementationHandler::~CFBamCustXmlLoaderCSharpSchemaObjImplementationHandler() {
	}

	void CFBamCustXmlLoaderCSharpSchemaObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpSchemaObjImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CSharpSchemaObjImplementation'" );
	...
	void CFBamCustXmlLoaderCSharpSchemaObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsSchemaObjImplementationNull() || schemaDefObj->getOptionalCsSchemaObjImplementationValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsSchemaObjImplementationValue( text );
