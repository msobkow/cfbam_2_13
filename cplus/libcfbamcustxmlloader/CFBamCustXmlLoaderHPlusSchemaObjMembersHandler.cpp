...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusSchemaObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusSchemaObjMembersHandler" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusSchemaObjMembersHandler::CFBamCustXmlLoaderHPlusSchemaObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusSchemaObjMembersHandler::~CFBamCustXmlLoaderHPlusSchemaObjMembersHandler() {
	}

	void CFBamCustXmlLoaderHPlusSchemaObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusSchemaObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'HPlusSchemaObjMembers'" );
	...
	void CFBamCustXmlLoaderHPlusSchemaObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppSchemaObjMembersNull() || schemaDefObj->getOptionalHppSchemaObjMembersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppSchemaObjMembersValue( text );
