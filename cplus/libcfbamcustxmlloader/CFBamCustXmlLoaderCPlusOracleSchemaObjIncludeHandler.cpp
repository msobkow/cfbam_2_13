...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusOracleSchemaObjIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusOracleSchemaObjIncludeHandler" );
	const std::string CFBamCustXmlLoaderCPlusOracleSchemaObjIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusOracleSchemaObjIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusOracleSchemaObjIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusOracleSchemaObjIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusOracleSchemaObjIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusOracleSchemaObjIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusOracleSchemaObjIncludeHandler::CFBamCustXmlLoaderCPlusOracleSchemaObjIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusOracleSchemaObjIncludeHandler::~CFBamCustXmlLoaderCPlusOracleSchemaObjIncludeHandler() {
	}

	void CFBamCustXmlLoaderCPlusOracleSchemaObjIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusOracleSchemaObjInclude" ) {
				static const std::string Msg( "Expected QName to be 'CPlusOracleSchemaObjInclude'" );
	...
	void CFBamCustXmlLoaderCPlusOracleSchemaObjIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppOracleSchemaObjIncludeNull() || schemaDefObj->getOptionalCppOracleSchemaObjIncludeValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppOracleSchemaObjIncludeValue( text );
