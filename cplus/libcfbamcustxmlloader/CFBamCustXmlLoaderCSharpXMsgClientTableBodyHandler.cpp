...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpXMsgClientTableBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpXMsgClientTableBodyHandler" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientTableBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientTableBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientTableBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientTableBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientTableBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientTableBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpXMsgClientTableBodyHandler::CFBamCustXmlLoaderCSharpXMsgClientTableBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpXMsgClientTableBodyHandler::~CFBamCustXmlLoaderCSharpXMsgClientTableBodyHandler() {
	}

	void CFBamCustXmlLoaderCSharpXMsgClientTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpXMsgClientTableBody" ) {
				static const std::string Msg( "Expected QName to be 'CSharpXMsgClientTableBody'" );
	...
	void CFBamCustXmlLoaderCSharpXMsgClientTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsXMsgClientTableBodyNull() || tableObj->getOptionalCsXMsgClientTableBodyValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsXMsgClientTableBodyValue( text );
