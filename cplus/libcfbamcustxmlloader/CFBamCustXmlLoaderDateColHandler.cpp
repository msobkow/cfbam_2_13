...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderDateColHandler::CLASS_NAME( "CFBamCustXmlLoaderDateColHandler" );
	const std::string CFBamCustXmlLoaderDateColHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderDateColHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderDateColHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderDateColHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderDateColHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderDateColHandler::S_1( "1" );

	CFBamCustXmlLoaderDateColHandler::CFBamCustXmlLoaderDateColHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderDateColHandler::~CFBamCustXmlLoaderDateColHandler() {
	}

	void CFBamCustXmlLoaderDateColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "DateCol" ) {
				static const std::string Msg( "Expected QName to be 'DateCol'" );
			...
			origDateCol = dynamic_cast<cfbam::ICFBamDateColObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderDateColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
