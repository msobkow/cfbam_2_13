...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderFloatColHandler::CLASS_NAME( "CFBamCustXmlLoaderFloatColHandler" );
	const std::string CFBamCustXmlLoaderFloatColHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderFloatColHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderFloatColHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderFloatColHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderFloatColHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderFloatColHandler::S_1( "1" );

	CFBamCustXmlLoaderFloatColHandler::CFBamCustXmlLoaderFloatColHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderFloatColHandler::~CFBamCustXmlLoaderFloatColHandler() {
	}

	void CFBamCustXmlLoaderFloatColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "FloatCol" ) {
				static const std::string Msg( "Expected QName to be 'FloatCol'" );
			...
			origFloatCol = dynamic_cast<cfbam::ICFBamFloatColObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderFloatColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
