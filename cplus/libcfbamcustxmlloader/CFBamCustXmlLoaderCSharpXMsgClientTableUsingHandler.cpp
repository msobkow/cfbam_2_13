...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpXMsgClientTableUsingHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpXMsgClientTableUsingHandler" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientTableUsingHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientTableUsingHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientTableUsingHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientTableUsingHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientTableUsingHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpXMsgClientTableUsingHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpXMsgClientTableUsingHandler::CFBamCustXmlLoaderCSharpXMsgClientTableUsingHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpXMsgClientTableUsingHandler::~CFBamCustXmlLoaderCSharpXMsgClientTableUsingHandler() {
	}

	void CFBamCustXmlLoaderCSharpXMsgClientTableUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpXMsgClientTableUsing" ) {
				static const std::string Msg( "Expected QName to be 'CSharpXMsgClientTableUsing'" );
	...
	void CFBamCustXmlLoaderCSharpXMsgClientTableUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsXMsgClientTableUsingNull() || tableObj->getOptionalCsXMsgClientTableUsingValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsXMsgClientTableUsingValue( text );
