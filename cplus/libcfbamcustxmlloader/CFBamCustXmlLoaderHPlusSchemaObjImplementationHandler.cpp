...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusSchemaObjImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusSchemaObjImplementationHandler" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusSchemaObjImplementationHandler::CFBamCustXmlLoaderHPlusSchemaObjImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusSchemaObjImplementationHandler::~CFBamCustXmlLoaderHPlusSchemaObjImplementationHandler() {
	}

	void CFBamCustXmlLoaderHPlusSchemaObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusSchemaObjImplementation" ) {
				static const std::string Msg( "Expected QName to be 'HPlusSchemaObjImplementation'" );
	...
	void CFBamCustXmlLoaderHPlusSchemaObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppSchemaObjImplementationNull() || schemaDefObj->getOptionalHppSchemaObjImplementationValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppSchemaObjImplementationValue( text );
