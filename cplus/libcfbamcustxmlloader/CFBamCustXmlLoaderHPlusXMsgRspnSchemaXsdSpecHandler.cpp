...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdSpecHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdSpecHandler" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdSpecHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdSpecHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdSpecHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdSpecHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdSpecHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdSpecHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdSpecHandler::CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdSpecHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdSpecHandler::~CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdSpecHandler() {
	}

	void CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdSpecHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusXMsgRspnSchemaXsdSpec" ) {
				static const std::string Msg( "Expected QName to be 'HPlusXMsgRspnSchemaXsdSpec'" );
	...
	void CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdSpecHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppXMsgRspnSchemaXsdSpecNull() || schemaDefObj->getOptionalHppXMsgRspnSchemaXsdSpecValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppXMsgRspnSchemaXsdSpecValue( text );
