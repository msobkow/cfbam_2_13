...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderSuperClassRelationHandler::CLASS_NAME( "CFBamCustXmlLoaderSuperClassRelationHandler" );
	const std::string CFBamCustXmlLoaderSuperClassRelationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderSuperClassRelationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderSuperClassRelationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderSuperClassRelationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderSuperClassRelationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderSuperClassRelationHandler::S_1( "1" );

	CFBamCustXmlLoaderSuperClassRelationHandler::CFBamCustXmlLoaderSuperClassRelationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderSuperClassRelationHandler::~CFBamCustXmlLoaderSuperClassRelationHandler() {
	}

	void CFBamCustXmlLoaderSuperClassRelationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "SuperClassRelation" ) {
				static const std::string Msg( "Expected QName to be 'SuperClassRelation'" );
			...
			natRelationType = cfbam::ICFBamSchema::RelationTypeEnum::Superclass;
...
cleanup:
	...
	cfbam::ICFBamRelationObj* CFBamCustXmlLoaderSuperClassRelationHandler::resolveInheritedRelation( cfbam::ICFBamRelationTableObj* relationTable, cfbam::ICFBamTableObj* tbl, const std::string& relName ) {
	...
	void CFBamCustXmlLoaderSuperClassRelationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
