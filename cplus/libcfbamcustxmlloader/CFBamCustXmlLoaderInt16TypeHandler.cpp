...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderInt16TypeHandler::CLASS_NAME( "CFBamCustXmlLoaderInt16TypeHandler" );
	const std::string CFBamCustXmlLoaderInt16TypeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderInt16TypeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderInt16TypeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderInt16TypeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderInt16TypeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderInt16TypeHandler::S_1( "1" );

	CFBamCustXmlLoaderInt16TypeHandler::CFBamCustXmlLoaderInt16TypeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderInt16TypeHandler::~CFBamCustXmlLoaderInt16TypeHandler() {
	}

	void CFBamCustXmlLoaderInt16TypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "Int16Type" ) {
				static const std::string Msg( "Expected QName to be 'Int16Type'" );
			...
			origInt16Type = dynamic_cast<cfbam::ICFBamInt16TypeObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderInt16TypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
