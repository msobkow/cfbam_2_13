...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpMySqlTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpMySqlTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderCSharpMySqlTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpMySqlTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpMySqlTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpMySqlTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpMySqlTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpMySqlTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpMySqlTableImplementationHandler::CFBamCustXmlLoaderCSharpMySqlTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpMySqlTableImplementationHandler::~CFBamCustXmlLoaderCSharpMySqlTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderCSharpMySqlTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpMySqlTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CSharpMySqlTableImplementation'" );
	...
	void CFBamCustXmlLoaderCSharpMySqlTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsMySqlTableImplementationNull() || tableObj->getOptionalCsMySqlTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsMySqlTableImplementationValue( text );
