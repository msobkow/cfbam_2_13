...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusXMsgRqstSchemaBodyHandler" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRqstSchemaBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusXMsgRqstSchemaBodyHandler::CFBamCustXmlLoaderCPlusXMsgRqstSchemaBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusXMsgRqstSchemaBodyHandler::~CFBamCustXmlLoaderCPlusXMsgRqstSchemaBodyHandler() {
	}

	void CFBamCustXmlLoaderCPlusXMsgRqstSchemaBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusXMsgRqstSchemaBody" ) {
				static const std::string Msg( "Expected QName to be 'CPlusXMsgRqstSchemaBody'" );
	...
	void CFBamCustXmlLoaderCPlusXMsgRqstSchemaBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppXMsgRqstSchemaBodyNull() || schemaDefObj->getOptionalCppXMsgRqstSchemaBodyValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppXMsgRqstSchemaBodyValue( text );
