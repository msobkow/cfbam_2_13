...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusTableInterfaceHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusTableInterfaceHandler" );
	const std::string CFBamCustXmlLoaderHPlusTableInterfaceHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusTableInterfaceHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusTableInterfaceHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusTableInterfaceHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusTableInterfaceHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusTableInterfaceHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusTableInterfaceHandler::CFBamCustXmlLoaderHPlusTableInterfaceHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusTableInterfaceHandler::~CFBamCustXmlLoaderHPlusTableInterfaceHandler() {
	}

	void CFBamCustXmlLoaderHPlusTableInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusTableInterface" ) {
				static const std::string Msg( "Expected QName to be 'HPlusTableInterface'" );
	...
	void CFBamCustXmlLoaderHPlusTableInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppTableInterfaceNull() || tableObj->getOptionalHppTableInterfaceValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppTableInterfaceValue( text );
