...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeEditObjInterfaceHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeEditObjInterfaceHandler" );
	const std::string CFBamCustXmlLoaderCafeEditObjInterfaceHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeEditObjInterfaceHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeEditObjInterfaceHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeEditObjInterfaceHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeEditObjInterfaceHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeEditObjInterfaceHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeEditObjInterfaceHandler::CFBamCustXmlLoaderCafeEditObjInterfaceHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeEditObjInterfaceHandler::~CFBamCustXmlLoaderCafeEditObjInterfaceHandler() {
	}

	void CFBamCustXmlLoaderCafeEditObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeEditObjInterface" ) {
				static const std::string Msg( "Expected QName to be 'CafeEditObjInterface'" );
	...
	void CFBamCustXmlLoaderCafeEditObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJEditObjInterfaceNull() || tableObj->getOptionalJEditObjInterfaceValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJEditObjInterfaceValue( text );
