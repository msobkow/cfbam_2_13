...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderUInt64ColHandler::CLASS_NAME( "CFBamCustXmlLoaderUInt64ColHandler" );
	const std::string CFBamCustXmlLoaderUInt64ColHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderUInt64ColHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderUInt64ColHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderUInt64ColHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderUInt64ColHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderUInt64ColHandler::S_1( "1" );

	CFBamCustXmlLoaderUInt64ColHandler::CFBamCustXmlLoaderUInt64ColHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderUInt64ColHandler::~CFBamCustXmlLoaderUInt64ColHandler() {
	}

	void CFBamCustXmlLoaderUInt64ColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "UInt64Col" ) {
				static const std::string Msg( "Expected QName to be 'UInt64Col'" );
			...
			origUInt64Col = dynamic_cast<cfbam::ICFBamUInt64ColObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderUInt64ColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
