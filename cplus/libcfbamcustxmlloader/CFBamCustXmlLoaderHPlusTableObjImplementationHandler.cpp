...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusTableObjImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusTableObjImplementationHandler" );
	const std::string CFBamCustXmlLoaderHPlusTableObjImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusTableObjImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusTableObjImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusTableObjImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusTableObjImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusTableObjImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusTableObjImplementationHandler::CFBamCustXmlLoaderHPlusTableObjImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusTableObjImplementationHandler::~CFBamCustXmlLoaderHPlusTableObjImplementationHandler() {
	}

	void CFBamCustXmlLoaderHPlusTableObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusTableObjImplementation" ) {
				static const std::string Msg( "Expected QName to be 'HPlusTableObjImplementation'" );
	...
	void CFBamCustXmlLoaderHPlusTableObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppTableObjImplementationNull() || tableObj->getOptionalHppTableObjImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppTableObjImplementationValue( text );
