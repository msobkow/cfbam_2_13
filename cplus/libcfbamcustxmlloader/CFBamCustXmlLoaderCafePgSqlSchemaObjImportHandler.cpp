...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafePgSqlSchemaObjImportHandler::CLASS_NAME( "CFBamCustXmlLoaderCafePgSqlSchemaObjImportHandler" );
	const std::string CFBamCustXmlLoaderCafePgSqlSchemaObjImportHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafePgSqlSchemaObjImportHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafePgSqlSchemaObjImportHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafePgSqlSchemaObjImportHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafePgSqlSchemaObjImportHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafePgSqlSchemaObjImportHandler::S_1( "1" );

	CFBamCustXmlLoaderCafePgSqlSchemaObjImportHandler::CFBamCustXmlLoaderCafePgSqlSchemaObjImportHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafePgSqlSchemaObjImportHandler::~CFBamCustXmlLoaderCafePgSqlSchemaObjImportHandler() {
	}

	void CFBamCustXmlLoaderCafePgSqlSchemaObjImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafePgSqlSchemaObjImport" ) {
				static const std::string Msg( "Expected QName to be 'CafePgSqlSchemaObjImport'" );
	...
	void CFBamCustXmlLoaderCafePgSqlSchemaObjImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJPgSqlSchemaObjImportNull() || schemaDefObj->getOptionalJPgSqlSchemaObjImportValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJPgSqlSchemaObjImportValue( text );
