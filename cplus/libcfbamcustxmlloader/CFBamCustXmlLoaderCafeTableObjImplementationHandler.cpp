...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeTableObjImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeTableObjImplementationHandler" );
	const std::string CFBamCustXmlLoaderCafeTableObjImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeTableObjImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeTableObjImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeTableObjImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeTableObjImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeTableObjImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeTableObjImplementationHandler::CFBamCustXmlLoaderCafeTableObjImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeTableObjImplementationHandler::~CFBamCustXmlLoaderCafeTableObjImplementationHandler() {
	}

	void CFBamCustXmlLoaderCafeTableObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeTableObjImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CafeTableObjImplementation'" );
	...
	void CFBamCustXmlLoaderCafeTableObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJTableObjImplementationNull() || tableObj->getOptionalJTableObjImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJTableObjImplementationValue( text );
