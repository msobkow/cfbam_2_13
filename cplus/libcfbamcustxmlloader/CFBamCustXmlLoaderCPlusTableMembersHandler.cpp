...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusTableMembersHandler" );
	const std::string CFBamCustXmlLoaderCPlusTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusTableMembersHandler::CFBamCustXmlLoaderCPlusTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusTableMembersHandler::~CFBamCustXmlLoaderCPlusTableMembersHandler() {
	}

	void CFBamCustXmlLoaderCPlusTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'CPlusTableMembers'" );
	...
	void CFBamCustXmlLoaderCPlusTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppTableMembersNull() || tableObj->getOptionalCppTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppTableMembersValue( text );
