...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdSpecHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdSpecHandler" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdSpecHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdSpecHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdSpecHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdSpecHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdSpecHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdSpecHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdSpecHandler::CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdSpecHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdSpecHandler::~CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdSpecHandler() {
	}

	void CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdSpecHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpXMsgRqstSchemaXsdSpec" ) {
				static const std::string Msg( "Expected QName to be 'CSharpXMsgRqstSchemaXsdSpec'" );
	...
	void CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdSpecHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsXMsgRqstSchemaXsdSpecNull() || schemaDefObj->getOptionalCsXMsgRqstSchemaXsdSpecValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsXMsgRqstSchemaXsdSpecValue( text );
