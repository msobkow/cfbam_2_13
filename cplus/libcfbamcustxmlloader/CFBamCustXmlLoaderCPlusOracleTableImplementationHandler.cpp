...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusOracleTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusOracleTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderCPlusOracleTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusOracleTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusOracleTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusOracleTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusOracleTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusOracleTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusOracleTableImplementationHandler::CFBamCustXmlLoaderCPlusOracleTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusOracleTableImplementationHandler::~CFBamCustXmlLoaderCPlusOracleTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderCPlusOracleTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusOracleTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CPlusOracleTableImplementation'" );
	...
	void CFBamCustXmlLoaderCPlusOracleTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppOracleTableImplementationNull() || tableObj->getOptionalCppOracleTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppOracleTableImplementationValue( text );
