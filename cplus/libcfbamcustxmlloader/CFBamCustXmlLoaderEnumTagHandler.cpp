...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderEnumTagHandler::CLASS_NAME( "CFBamCustXmlLoaderEnumTagHandler" );
	const std::string CFBamCustXmlLoaderEnumTagHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderEnumTagHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderEnumTagHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderEnumTagHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderEnumTagHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderEnumTagHandler::S_1( "1" );

	CFBamCustXmlLoaderEnumTagHandler::CFBamCustXmlLoaderEnumTagHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderEnumTagHandler::~CFBamCustXmlLoaderEnumTagHandler() {
	}

	void CFBamCustXmlLoaderEnumTagHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamEnumTypeObj* refEnumType = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "EnumTag" ) {
				static const std::string Msg( "Expected QName to be 'EnumTag'" );
			...
			else if( scopeObj->implementsClassCode( cfbam::CFBamEnumTypeBuff::CLASS_CODE ) ) {
				refEnumType = dynamic_cast<cfbam::ICFBamEnumTypeObj*>( scopeObj );
				editBuff->setRequiredContainerEnumDef( refEnumType );
			...
			origEnumTag = dynamic_cast<cfbam::ICFBamEnumTagObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderEnumTagHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
