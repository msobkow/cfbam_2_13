...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusOracleSchemaObjIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusOracleSchemaObjIncludeHandler" );
	const std::string CFBamCustXmlLoaderHPlusOracleSchemaObjIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusOracleSchemaObjIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusOracleSchemaObjIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusOracleSchemaObjIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusOracleSchemaObjIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusOracleSchemaObjIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusOracleSchemaObjIncludeHandler::CFBamCustXmlLoaderHPlusOracleSchemaObjIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusOracleSchemaObjIncludeHandler::~CFBamCustXmlLoaderHPlusOracleSchemaObjIncludeHandler() {
	}

	void CFBamCustXmlLoaderHPlusOracleSchemaObjIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusOracleSchemaObjInclude" ) {
				static const std::string Msg( "Expected QName to be 'HPlusOracleSchemaObjInclude'" );
	...
	void CFBamCustXmlLoaderHPlusOracleSchemaObjIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppOracleSchemaObjIncludeNull() || schemaDefObj->getOptionalHppOracleSchemaObjIncludeValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppOracleSchemaObjIncludeValue( text );
