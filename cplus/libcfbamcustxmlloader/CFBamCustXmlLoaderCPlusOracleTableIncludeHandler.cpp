...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusOracleTableIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusOracleTableIncludeHandler" );
	const std::string CFBamCustXmlLoaderCPlusOracleTableIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusOracleTableIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusOracleTableIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusOracleTableIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusOracleTableIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusOracleTableIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusOracleTableIncludeHandler::CFBamCustXmlLoaderCPlusOracleTableIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusOracleTableIncludeHandler::~CFBamCustXmlLoaderCPlusOracleTableIncludeHandler() {
	}

	void CFBamCustXmlLoaderCPlusOracleTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusOracleTableInclude" ) {
				static const std::string Msg( "Expected QName to be 'CPlusOracleTableInclude'" );
	...
	void CFBamCustXmlLoaderCPlusOracleTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppOracleTableIncludeNull() || tableObj->getOptionalCppOracleTableIncludeValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppOracleTableIncludeValue( text );
