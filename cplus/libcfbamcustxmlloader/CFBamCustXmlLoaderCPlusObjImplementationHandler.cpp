...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusObjImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusObjImplementationHandler" );
	const std::string CFBamCustXmlLoaderCPlusObjImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusObjImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusObjImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusObjImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusObjImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusObjImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusObjImplementationHandler::CFBamCustXmlLoaderCPlusObjImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusObjImplementationHandler::~CFBamCustXmlLoaderCPlusObjImplementationHandler() {
	}

	void CFBamCustXmlLoaderCPlusObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusObjImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CPlusObjImplementation'" );
	...
	void CFBamCustXmlLoaderCPlusObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppObjImplementationNull() || tableObj->getOptionalCppObjImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppObjImplementationValue( text );
