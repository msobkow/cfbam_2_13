...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpEditObjUsingHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpEditObjUsingHandler" );
	const std::string CFBamCustXmlLoaderCSharpEditObjUsingHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpEditObjUsingHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpEditObjUsingHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpEditObjUsingHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpEditObjUsingHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpEditObjUsingHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpEditObjUsingHandler::CFBamCustXmlLoaderCSharpEditObjUsingHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpEditObjUsingHandler::~CFBamCustXmlLoaderCSharpEditObjUsingHandler() {
	}

	void CFBamCustXmlLoaderCSharpEditObjUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpEditObjUsing" ) {
				static const std::string Msg( "Expected QName to be 'CSharpEditObjUsing'" );
	...
	void CFBamCustXmlLoaderCSharpEditObjUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsEditObjUsingNull() || tableObj->getOptionalCsEditObjUsingValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsEditObjUsingValue( text );
