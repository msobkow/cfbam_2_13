...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderTZDateTypeHandler::CLASS_NAME( "CFBamCustXmlLoaderTZDateTypeHandler" );
	const std::string CFBamCustXmlLoaderTZDateTypeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderTZDateTypeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderTZDateTypeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderTZDateTypeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderTZDateTypeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderTZDateTypeHandler::S_1( "1" );

	CFBamCustXmlLoaderTZDateTypeHandler::CFBamCustXmlLoaderTZDateTypeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderTZDateTypeHandler::~CFBamCustXmlLoaderTZDateTypeHandler() {
	}

	void CFBamCustXmlLoaderTZDateTypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "TZDateType" ) {
				static const std::string Msg( "Expected QName to be 'TZDateType'" );
			...
			origTZDateType = dynamic_cast<cfbam::ICFBamTZDateTypeObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderTZDateTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
