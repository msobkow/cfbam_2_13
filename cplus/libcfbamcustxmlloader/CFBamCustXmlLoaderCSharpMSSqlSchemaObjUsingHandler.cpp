...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpMSSqlSchemaObjUsingHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpMSSqlSchemaObjUsingHandler" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlSchemaObjUsingHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlSchemaObjUsingHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlSchemaObjUsingHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlSchemaObjUsingHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlSchemaObjUsingHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlSchemaObjUsingHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpMSSqlSchemaObjUsingHandler::CFBamCustXmlLoaderCSharpMSSqlSchemaObjUsingHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpMSSqlSchemaObjUsingHandler::~CFBamCustXmlLoaderCSharpMSSqlSchemaObjUsingHandler() {
	}

	void CFBamCustXmlLoaderCSharpMSSqlSchemaObjUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpMSSqlSchemaObjUsing" ) {
				static const std::string Msg( "Expected QName to be 'CSharpMSSqlSchemaObjUsing'" );
	...
	void CFBamCustXmlLoaderCSharpMSSqlSchemaObjUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsMSSqlSchemaObjUsingNull() || schemaDefObj->getOptionalCsMSSqlSchemaObjUsingValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsMSSqlSchemaObjUsingValue( text );
