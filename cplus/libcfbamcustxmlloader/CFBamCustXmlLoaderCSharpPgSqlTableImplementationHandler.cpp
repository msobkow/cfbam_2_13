...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpPgSqlTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpPgSqlTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpPgSqlTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpPgSqlTableImplementationHandler::CFBamCustXmlLoaderCSharpPgSqlTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpPgSqlTableImplementationHandler::~CFBamCustXmlLoaderCSharpPgSqlTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderCSharpPgSqlTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpPgSqlTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CSharpPgSqlTableImplementation'" );
	...
	void CFBamCustXmlLoaderCSharpPgSqlTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsPgSqlTableImplementationNull() || tableObj->getOptionalCsPgSqlTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsPgSqlTableImplementationValue( text );
