...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusOracleTableIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusOracleTableIncludeHandler" );
	const std::string CFBamCustXmlLoaderHPlusOracleTableIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusOracleTableIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusOracleTableIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusOracleTableIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusOracleTableIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusOracleTableIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusOracleTableIncludeHandler::CFBamCustXmlLoaderHPlusOracleTableIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusOracleTableIncludeHandler::~CFBamCustXmlLoaderHPlusOracleTableIncludeHandler() {
	}

	void CFBamCustXmlLoaderHPlusOracleTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusOracleTableInclude" ) {
				static const std::string Msg( "Expected QName to be 'HPlusOracleTableInclude'" );
	...
	void CFBamCustXmlLoaderHPlusOracleTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppOracleTableIncludeNull() || tableObj->getOptionalHppOracleTableIncludeValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppOracleTableIncludeValue( text );
