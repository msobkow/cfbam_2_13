...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusDb2LUWTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusDb2LUWTableMembersHandler" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusDb2LUWTableMembersHandler::CFBamCustXmlLoaderCPlusDb2LUWTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusDb2LUWTableMembersHandler::~CFBamCustXmlLoaderCPlusDb2LUWTableMembersHandler() {
	}

	void CFBamCustXmlLoaderCPlusDb2LUWTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusDb2LUWTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'CPlusDb2LUWTableMembers'" );
	...
	void CFBamCustXmlLoaderCPlusDb2LUWTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppDb2LUWTableMembersNull() || tableObj->getOptionalCppDb2LUWTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppDb2LUWTableMembersValue( text );
