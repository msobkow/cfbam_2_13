...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusMySqlTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusMySqlTableMembersHandler" );
	const std::string CFBamCustXmlLoaderHPlusMySqlTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusMySqlTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusMySqlTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusMySqlTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusMySqlTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusMySqlTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusMySqlTableMembersHandler::CFBamCustXmlLoaderHPlusMySqlTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusMySqlTableMembersHandler::~CFBamCustXmlLoaderHPlusMySqlTableMembersHandler() {
	}

	void CFBamCustXmlLoaderHPlusMySqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusMySqlTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'HPlusMySqlTableMembers'" );
	...
	void CFBamCustXmlLoaderHPlusMySqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppMySqlTableMembersNull() || tableObj->getOptionalHppMySqlTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppMySqlTableMembersValue( text );
