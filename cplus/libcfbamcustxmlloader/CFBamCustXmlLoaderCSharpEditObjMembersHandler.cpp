...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpEditObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpEditObjMembersHandler" );
	const std::string CFBamCustXmlLoaderCSharpEditObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpEditObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpEditObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpEditObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpEditObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpEditObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpEditObjMembersHandler::CFBamCustXmlLoaderCSharpEditObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpEditObjMembersHandler::~CFBamCustXmlLoaderCSharpEditObjMembersHandler() {
	}

	void CFBamCustXmlLoaderCSharpEditObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpEditObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'CSharpEditObjMembers'" );
	...
	void CFBamCustXmlLoaderCSharpEditObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsEditObjMembersNull() || tableObj->getOptionalCsEditObjMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsEditObjMembersValue( text );
