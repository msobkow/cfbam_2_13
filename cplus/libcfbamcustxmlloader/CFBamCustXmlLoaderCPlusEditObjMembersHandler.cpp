...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusEditObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusEditObjMembersHandler" );
	const std::string CFBamCustXmlLoaderCPlusEditObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusEditObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusEditObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusEditObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusEditObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusEditObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusEditObjMembersHandler::CFBamCustXmlLoaderCPlusEditObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusEditObjMembersHandler::~CFBamCustXmlLoaderCPlusEditObjMembersHandler() {
	}

	void CFBamCustXmlLoaderCPlusEditObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusEditObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'CPlusEditObjMembers'" );
	...
	void CFBamCustXmlLoaderCPlusEditObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppEditObjMembersNull() || tableObj->getOptionalCppEditObjMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppEditObjMembersValue( text );
