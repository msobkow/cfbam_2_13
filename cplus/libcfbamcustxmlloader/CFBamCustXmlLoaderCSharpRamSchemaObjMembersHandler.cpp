...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpRamSchemaObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpRamSchemaObjMembersHandler" );
	const std::string CFBamCustXmlLoaderCSharpRamSchemaObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpRamSchemaObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpRamSchemaObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpRamSchemaObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpRamSchemaObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpRamSchemaObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpRamSchemaObjMembersHandler::CFBamCustXmlLoaderCSharpRamSchemaObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpRamSchemaObjMembersHandler::~CFBamCustXmlLoaderCSharpRamSchemaObjMembersHandler() {
	}

	void CFBamCustXmlLoaderCSharpRamSchemaObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpRamSchemaObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'CSharpRamSchemaObjMembers'" );
	...
	void CFBamCustXmlLoaderCSharpRamSchemaObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsRamSchemaObjMembersNull() || schemaDefObj->getOptionalCsRamSchemaObjMembersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsRamSchemaObjMembersValue( text );
