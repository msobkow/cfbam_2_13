...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderTokenColHandler::CLASS_NAME( "CFBamCustXmlLoaderTokenColHandler" );
	const std::string CFBamCustXmlLoaderTokenColHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderTokenColHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderTokenColHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderTokenColHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderTokenColHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderTokenColHandler::S_1( "1" );

	CFBamCustXmlLoaderTokenColHandler::CFBamCustXmlLoaderTokenColHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderTokenColHandler::~CFBamCustXmlLoaderTokenColHandler() {
	}

	void CFBamCustXmlLoaderTokenColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "TokenCol" ) {
				static const std::string Msg( "Expected QName to be 'TokenCol'" );
			...
			origTokenCol = dynamic_cast<cfbam::ICFBamTokenColObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderTokenColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
