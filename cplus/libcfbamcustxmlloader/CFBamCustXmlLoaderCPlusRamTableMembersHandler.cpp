...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusRamTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusRamTableMembersHandler" );
	const std::string CFBamCustXmlLoaderCPlusRamTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusRamTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusRamTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusRamTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusRamTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusRamTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusRamTableMembersHandler::CFBamCustXmlLoaderCPlusRamTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusRamTableMembersHandler::~CFBamCustXmlLoaderCPlusRamTableMembersHandler() {
	}

	void CFBamCustXmlLoaderCPlusRamTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusRamTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'CPlusRamTableMembers'" );
	...
	void CFBamCustXmlLoaderCPlusRamTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppRamTableMembersNull() || tableObj->getOptionalCppRamTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppRamTableMembersValue( text );
