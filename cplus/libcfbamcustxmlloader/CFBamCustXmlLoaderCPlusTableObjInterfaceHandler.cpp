...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusTableObjInterfaceHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusTableObjInterfaceHandler" );
	const std::string CFBamCustXmlLoaderCPlusTableObjInterfaceHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusTableObjInterfaceHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusTableObjInterfaceHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusTableObjInterfaceHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusTableObjInterfaceHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusTableObjInterfaceHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusTableObjInterfaceHandler::CFBamCustXmlLoaderCPlusTableObjInterfaceHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusTableObjInterfaceHandler::~CFBamCustXmlLoaderCPlusTableObjInterfaceHandler() {
	}

	void CFBamCustXmlLoaderCPlusTableObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusTableObjInterface" ) {
				static const std::string Msg( "Expected QName to be 'CPlusTableObjInterface'" );
	...
	void CFBamCustXmlLoaderCPlusTableObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppTableObjInterfaceNull() || tableObj->getOptionalCppTableObjInterfaceValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppTableObjInterfaceValue( text );
