...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderSubProjectHandler::CLASS_NAME( "CFBamCustXmlLoaderSubProjectHandler" );
	const std::string CFBamCustXmlLoaderSubProjectHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderSubProjectHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderSubProjectHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderSubProjectHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderSubProjectHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderSubProjectHandler::S_1( "1" );

	CFBamCustXmlLoaderSubProjectHandler::CFBamCustXmlLoaderSubProjectHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderSubProjectHandler::~CFBamCustXmlLoaderSubProjectHandler() {
	}

	void CFBamCustXmlLoaderSubProjectHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "SubProject" ) {
				static const std::string Msg( "Expected QName to be 'SubProject'" );
...
cleanup:
	...
	void CFBamCustXmlLoaderSubProjectHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
