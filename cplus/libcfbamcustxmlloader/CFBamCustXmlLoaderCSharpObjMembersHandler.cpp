...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpObjMembersHandler" );
	const std::string CFBamCustXmlLoaderCSharpObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpObjMembersHandler::CFBamCustXmlLoaderCSharpObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpObjMembersHandler::~CFBamCustXmlLoaderCSharpObjMembersHandler() {
	}

	void CFBamCustXmlLoaderCSharpObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'CSharpObjMembers'" );
	...
	void CFBamCustXmlLoaderCSharpObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsObjMembersNull() || tableObj->getOptionalCsObjMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsObjMembersValue( text );
