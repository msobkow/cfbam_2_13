...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderNmTokensColHandler::CLASS_NAME( "CFBamCustXmlLoaderNmTokensColHandler" );
	const std::string CFBamCustXmlLoaderNmTokensColHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderNmTokensColHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderNmTokensColHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderNmTokensColHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderNmTokensColHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderNmTokensColHandler::S_1( "1" );

	CFBamCustXmlLoaderNmTokensColHandler::CFBamCustXmlLoaderNmTokensColHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderNmTokensColHandler::~CFBamCustXmlLoaderNmTokensColHandler() {
	}

	void CFBamCustXmlLoaderNmTokensColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "NmTokensCol" ) {
				static const std::string Msg( "Expected QName to be 'NmTokensCol'" );
			...
			origNmTokensCol = dynamic_cast<cfbam::ICFBamNmTokensColObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderNmTokensColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
