...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusTableObjImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusTableObjImplementationHandler" );
	const std::string CFBamCustXmlLoaderCPlusTableObjImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusTableObjImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusTableObjImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusTableObjImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusTableObjImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusTableObjImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusTableObjImplementationHandler::CFBamCustXmlLoaderCPlusTableObjImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusTableObjImplementationHandler::~CFBamCustXmlLoaderCPlusTableObjImplementationHandler() {
	}

	void CFBamCustXmlLoaderCPlusTableObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusTableObjImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CPlusTableObjImplementation'" );
	...
	void CFBamCustXmlLoaderCPlusTableObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppTableObjImplementationNull() || tableObj->getOptionalCppTableObjImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppTableObjImplementationValue( text );
