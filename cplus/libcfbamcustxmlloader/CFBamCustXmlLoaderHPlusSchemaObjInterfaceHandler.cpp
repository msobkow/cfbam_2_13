...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusSchemaObjInterfaceHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusSchemaObjInterfaceHandler" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjInterfaceHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjInterfaceHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjInterfaceHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjInterfaceHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjInterfaceHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusSchemaObjInterfaceHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusSchemaObjInterfaceHandler::CFBamCustXmlLoaderHPlusSchemaObjInterfaceHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusSchemaObjInterfaceHandler::~CFBamCustXmlLoaderHPlusSchemaObjInterfaceHandler() {
	}

	void CFBamCustXmlLoaderHPlusSchemaObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusSchemaObjInterface" ) {
				static const std::string Msg( "Expected QName to be 'HPlusSchemaObjInterface'" );
	...
	void CFBamCustXmlLoaderHPlusSchemaObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppSchemaObjInterfaceNull() || schemaDefObj->getOptionalHppSchemaObjInterfaceValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppSchemaObjInterfaceValue( text );
