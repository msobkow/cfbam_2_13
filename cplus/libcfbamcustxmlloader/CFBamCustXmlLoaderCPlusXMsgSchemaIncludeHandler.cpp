...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusXMsgSchemaIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusXMsgSchemaIncludeHandler" );
	const std::string CFBamCustXmlLoaderCPlusXMsgSchemaIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusXMsgSchemaIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusXMsgSchemaIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusXMsgSchemaIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusXMsgSchemaIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusXMsgSchemaIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusXMsgSchemaIncludeHandler::CFBamCustXmlLoaderCPlusXMsgSchemaIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusXMsgSchemaIncludeHandler::~CFBamCustXmlLoaderCPlusXMsgSchemaIncludeHandler() {
	}

	void CFBamCustXmlLoaderCPlusXMsgSchemaIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusXMsgSchemaInclude" ) {
				static const std::string Msg( "Expected QName to be 'CPlusXMsgSchemaInclude'" );
	...
	void CFBamCustXmlLoaderCPlusXMsgSchemaIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppXMsgSchemaIncludeNull() || schemaDefObj->getOptionalCppXMsgSchemaIncludeValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppXMsgSchemaIncludeValue( text );
