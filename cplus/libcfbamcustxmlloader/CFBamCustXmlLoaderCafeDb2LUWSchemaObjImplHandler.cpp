...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeDb2LUWSchemaObjImplHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeDb2LUWSchemaObjImplHandler" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWSchemaObjImplHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWSchemaObjImplHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWSchemaObjImplHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWSchemaObjImplHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWSchemaObjImplHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWSchemaObjImplHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeDb2LUWSchemaObjImplHandler::CFBamCustXmlLoaderCafeDb2LUWSchemaObjImplHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeDb2LUWSchemaObjImplHandler::~CFBamCustXmlLoaderCafeDb2LUWSchemaObjImplHandler() {
	}

	void CFBamCustXmlLoaderCafeDb2LUWSchemaObjImplHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeDb2LUWSchemaObjImpl" ) {
				static const std::string Msg( "Expected QName to be 'CafeDb2LUWSchemaObjImpl'" );
	...
	void CFBamCustXmlLoaderCafeDb2LUWSchemaObjImplHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJDb2LUWSchemaObjImplNull() || schemaDefObj->getOptionalJDb2LUWSchemaObjImplValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJDb2LUWSchemaObjImplValue( text );
