...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdElementListHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdElementListHandler" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdElementListHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdElementListHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdElementListHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdElementListHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdElementListHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdElementListHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdElementListHandler::CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdElementListHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdElementListHandler::~CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdElementListHandler() {
	}

	void CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdElementListHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusXMsgRspnSchemaXsdElementList" ) {
				static const std::string Msg( "Expected QName to be 'HPlusXMsgRspnSchemaXsdElementList'" );
	...
	void CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdElementListHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppXMsgRspnSchemaXsdElementListNull() || schemaDefObj->getOptionalHppXMsgRspnSchemaXsdElementListValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppXMsgRspnSchemaXsdElementListValue( text );
