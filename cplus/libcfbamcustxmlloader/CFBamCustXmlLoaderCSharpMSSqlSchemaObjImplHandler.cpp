...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpMSSqlSchemaObjImplHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpMSSqlSchemaObjImplHandler" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlSchemaObjImplHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlSchemaObjImplHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlSchemaObjImplHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlSchemaObjImplHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlSchemaObjImplHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlSchemaObjImplHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpMSSqlSchemaObjImplHandler::CFBamCustXmlLoaderCSharpMSSqlSchemaObjImplHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpMSSqlSchemaObjImplHandler::~CFBamCustXmlLoaderCSharpMSSqlSchemaObjImplHandler() {
	}

	void CFBamCustXmlLoaderCSharpMSSqlSchemaObjImplHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpMSSqlSchemaObjImpl" ) {
				static const std::string Msg( "Expected QName to be 'CSharpMSSqlSchemaObjImpl'" );
	...
	void CFBamCustXmlLoaderCSharpMSSqlSchemaObjImplHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsMSSqlSchemaObjImplNull() || schemaDefObj->getOptionalCsMSSqlSchemaObjImplValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsMSSqlSchemaObjImplValue( text );
