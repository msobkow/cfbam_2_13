...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdSpecHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdSpecHandler" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdSpecHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdSpecHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdSpecHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdSpecHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdSpecHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdSpecHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdSpecHandler::CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdSpecHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdSpecHandler::~CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdSpecHandler() {
	}

	void CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdSpecHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeXMsgRspnSchemaXsdSpec" ) {
				static const std::string Msg( "Expected QName to be 'CafeXMsgRspnSchemaXsdSpec'" );
	...
	void CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdSpecHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJXMsgRspnSchemaXsdSpecNull() || schemaDefObj->getOptionalJXMsgRspnSchemaXsdSpecValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJXMsgRspnSchemaXsdSpecValue( text );
