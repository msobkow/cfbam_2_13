...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafePgSqlSchemaObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCafePgSqlSchemaObjMembersHandler" );
	const std::string CFBamCustXmlLoaderCafePgSqlSchemaObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafePgSqlSchemaObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafePgSqlSchemaObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafePgSqlSchemaObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafePgSqlSchemaObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafePgSqlSchemaObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCafePgSqlSchemaObjMembersHandler::CFBamCustXmlLoaderCafePgSqlSchemaObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafePgSqlSchemaObjMembersHandler::~CFBamCustXmlLoaderCafePgSqlSchemaObjMembersHandler() {
	}

	void CFBamCustXmlLoaderCafePgSqlSchemaObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafePgSqlSchemaObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'CafePgSqlSchemaObjMembers'" );
	...
	void CFBamCustXmlLoaderCafePgSqlSchemaObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJPgSqlSchemaObjMembersNull() || schemaDefObj->getOptionalJPgSqlSchemaObjMembersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJPgSqlSchemaObjMembersValue( text );
