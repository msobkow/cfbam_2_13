...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusXMsgSchemaFormattersHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusXMsgSchemaFormattersHandler" );
	const std::string CFBamCustXmlLoaderCPlusXMsgSchemaFormattersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusXMsgSchemaFormattersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusXMsgSchemaFormattersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusXMsgSchemaFormattersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusXMsgSchemaFormattersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusXMsgSchemaFormattersHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusXMsgSchemaFormattersHandler::CFBamCustXmlLoaderCPlusXMsgSchemaFormattersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusXMsgSchemaFormattersHandler::~CFBamCustXmlLoaderCPlusXMsgSchemaFormattersHandler() {
	}

	void CFBamCustXmlLoaderCPlusXMsgSchemaFormattersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusXMsgSchemaFormatters" ) {
				static const std::string Msg( "Expected QName to be 'CPlusXMsgSchemaFormatters'" );
	...
	void CFBamCustXmlLoaderCPlusXMsgSchemaFormattersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppXMsgSchemaFormattersNull() || schemaDefObj->getOptionalCppXMsgSchemaFormattersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppXMsgSchemaFormattersValue( text );
