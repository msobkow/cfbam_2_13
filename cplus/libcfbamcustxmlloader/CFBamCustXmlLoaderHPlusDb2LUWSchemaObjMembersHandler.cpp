...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusDb2LUWSchemaObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusDb2LUWSchemaObjMembersHandler" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWSchemaObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWSchemaObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWSchemaObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWSchemaObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWSchemaObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWSchemaObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusDb2LUWSchemaObjMembersHandler::CFBamCustXmlLoaderHPlusDb2LUWSchemaObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusDb2LUWSchemaObjMembersHandler::~CFBamCustXmlLoaderHPlusDb2LUWSchemaObjMembersHandler() {
	}

	void CFBamCustXmlLoaderHPlusDb2LUWSchemaObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusDb2LUWSchemaObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'HPlusDb2LUWSchemaObjMembers'" );
	...
	void CFBamCustXmlLoaderHPlusDb2LUWSchemaObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppDb2LUWSchemaObjMembersNull() || schemaDefObj->getOptionalHppDb2LUWSchemaObjMembersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppDb2LUWSchemaObjMembersValue( text );
