...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpSchemaObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpSchemaObjMembersHandler" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpSchemaObjMembersHandler::CFBamCustXmlLoaderCSharpSchemaObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpSchemaObjMembersHandler::~CFBamCustXmlLoaderCSharpSchemaObjMembersHandler() {
	}

	void CFBamCustXmlLoaderCSharpSchemaObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpSchemaObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'CSharpSchemaObjMembers'" );
	...
	void CFBamCustXmlLoaderCSharpSchemaObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsSchemaObjMembersNull() || schemaDefObj->getOptionalCsSchemaObjMembersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsSchemaObjMembersValue( text );
