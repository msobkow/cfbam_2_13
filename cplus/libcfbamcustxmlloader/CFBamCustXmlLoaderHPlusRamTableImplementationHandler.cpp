...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusRamTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusRamTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderHPlusRamTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusRamTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusRamTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusRamTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusRamTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusRamTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusRamTableImplementationHandler::CFBamCustXmlLoaderHPlusRamTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusRamTableImplementationHandler::~CFBamCustXmlLoaderHPlusRamTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderHPlusRamTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusRamTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'HPlusRamTableImplementation'" );
	...
	void CFBamCustXmlLoaderHPlusRamTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppRamTableImplementationNull() || tableObj->getOptionalHppRamTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppRamTableImplementationValue( text );
