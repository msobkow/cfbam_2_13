...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeOracleTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeOracleTableMembersHandler" );
	const std::string CFBamCustXmlLoaderCafeOracleTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeOracleTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeOracleTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeOracleTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeOracleTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeOracleTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeOracleTableMembersHandler::CFBamCustXmlLoaderCafeOracleTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeOracleTableMembersHandler::~CFBamCustXmlLoaderCafeOracleTableMembersHandler() {
	}

	void CFBamCustXmlLoaderCafeOracleTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeOracleTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'CafeOracleTableMembers'" );
	...
	void CFBamCustXmlLoaderCafeOracleTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJOracleTableMembersNull() || tableObj->getOptionalJOracleTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJOracleTableMembersValue( text );
