...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeMySqlSchemaObjImplHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeMySqlSchemaObjImplHandler" );
	const std::string CFBamCustXmlLoaderCafeMySqlSchemaObjImplHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeMySqlSchemaObjImplHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeMySqlSchemaObjImplHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeMySqlSchemaObjImplHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeMySqlSchemaObjImplHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeMySqlSchemaObjImplHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeMySqlSchemaObjImplHandler::CFBamCustXmlLoaderCafeMySqlSchemaObjImplHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeMySqlSchemaObjImplHandler::~CFBamCustXmlLoaderCafeMySqlSchemaObjImplHandler() {
	}

	void CFBamCustXmlLoaderCafeMySqlSchemaObjImplHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeMySqlSchemaObjImpl" ) {
				static const std::string Msg( "Expected QName to be 'CafeMySqlSchemaObjImpl'" );
	...
	void CFBamCustXmlLoaderCafeMySqlSchemaObjImplHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJMySqlSchemaObjImplNull() || schemaDefObj->getOptionalJMySqlSchemaObjImplValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJMySqlSchemaObjImplValue( text );
