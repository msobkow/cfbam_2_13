...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeSchemaObjImportHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeSchemaObjImportHandler" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjImportHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjImportHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjImportHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjImportHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjImportHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjImportHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeSchemaObjImportHandler::CFBamCustXmlLoaderCafeSchemaObjImportHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeSchemaObjImportHandler::~CFBamCustXmlLoaderCafeSchemaObjImportHandler() {
	}

	void CFBamCustXmlLoaderCafeSchemaObjImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeSchemaObjImport" ) {
				static const std::string Msg( "Expected QName to be 'CafeSchemaObjImport'" );
	...
	void CFBamCustXmlLoaderCafeSchemaObjImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJSchemaObjImportNull() || schemaDefObj->getOptionalJSchemaObjImportValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJSchemaObjImportValue( text );
