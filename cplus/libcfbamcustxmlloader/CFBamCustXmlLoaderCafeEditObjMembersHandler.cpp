...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeEditObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeEditObjMembersHandler" );
	const std::string CFBamCustXmlLoaderCafeEditObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeEditObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeEditObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeEditObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeEditObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeEditObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeEditObjMembersHandler::CFBamCustXmlLoaderCafeEditObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeEditObjMembersHandler::~CFBamCustXmlLoaderCafeEditObjMembersHandler() {
	}

	void CFBamCustXmlLoaderCafeEditObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeEditObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'CafeEditObjMembers'" );
	...
	void CFBamCustXmlLoaderCafeEditObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJEditObjMembersNull() || tableObj->getOptionalJEditObjMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJEditObjMembersValue( text );
