...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusXMsgRspnSchemaIncludeHandler" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRspnSchemaIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusXMsgRspnSchemaIncludeHandler::CFBamCustXmlLoaderHPlusXMsgRspnSchemaIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusXMsgRspnSchemaIncludeHandler::~CFBamCustXmlLoaderHPlusXMsgRspnSchemaIncludeHandler() {
	}

	void CFBamCustXmlLoaderHPlusXMsgRspnSchemaIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusXMsgRspnSchemaInclude" ) {
				static const std::string Msg( "Expected QName to be 'HPlusXMsgRspnSchemaInclude'" );
	...
	void CFBamCustXmlLoaderHPlusXMsgRspnSchemaIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppXMsgRspnSchemaIncludeNull() || schemaDefObj->getOptionalHppXMsgRspnSchemaIncludeValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppXMsgRspnSchemaIncludeValue( text );
