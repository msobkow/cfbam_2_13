...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusEditObjImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusEditObjImplementationHandler" );
	const std::string CFBamCustXmlLoaderCPlusEditObjImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusEditObjImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusEditObjImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusEditObjImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusEditObjImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusEditObjImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusEditObjImplementationHandler::CFBamCustXmlLoaderCPlusEditObjImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusEditObjImplementationHandler::~CFBamCustXmlLoaderCPlusEditObjImplementationHandler() {
	}

	void CFBamCustXmlLoaderCPlusEditObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusEditObjImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CPlusEditObjImplementation'" );
	...
	void CFBamCustXmlLoaderCPlusEditObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppEditObjImplementationNull() || tableObj->getOptionalCppEditObjImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppEditObjImplementationValue( text );
