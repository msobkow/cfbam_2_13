...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusRamTableIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusRamTableIncludeHandler" );
	const std::string CFBamCustXmlLoaderHPlusRamTableIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusRamTableIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusRamTableIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusRamTableIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusRamTableIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusRamTableIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusRamTableIncludeHandler::CFBamCustXmlLoaderHPlusRamTableIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusRamTableIncludeHandler::~CFBamCustXmlLoaderHPlusRamTableIncludeHandler() {
	}

	void CFBamCustXmlLoaderHPlusRamTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusRamTableInclude" ) {
				static const std::string Msg( "Expected QName to be 'HPlusRamTableInclude'" );
	...
	void CFBamCustXmlLoaderHPlusRamTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppRamTableIncludeNull() || tableObj->getOptionalHppRamTableIncludeValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppRamTableIncludeValue( text );
