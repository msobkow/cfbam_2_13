...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaWireParsersHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeXMsgRspnSchemaWireParsersHandler" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaWireParsersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaWireParsersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaWireParsersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaWireParsersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaWireParsersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeXMsgRspnSchemaWireParsersHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeXMsgRspnSchemaWireParsersHandler::CFBamCustXmlLoaderCafeXMsgRspnSchemaWireParsersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeXMsgRspnSchemaWireParsersHandler::~CFBamCustXmlLoaderCafeXMsgRspnSchemaWireParsersHandler() {
	}

	void CFBamCustXmlLoaderCafeXMsgRspnSchemaWireParsersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeXMsgRspnSchemaWireParsers" ) {
				static const std::string Msg( "Expected QName to be 'CafeXMsgRspnSchemaWireParsers'" );
	...
	void CFBamCustXmlLoaderCafeXMsgRspnSchemaWireParsersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJXMsgRspnSchemaWireParsersNull() || schemaDefObj->getOptionalJXMsgRspnSchemaWireParsersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJXMsgRspnSchemaWireParsersValue( text );
