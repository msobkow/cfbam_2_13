...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusDb2LUWSchemaObjIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusDb2LUWSchemaObjIncludeHandler" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWSchemaObjIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWSchemaObjIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWSchemaObjIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWSchemaObjIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWSchemaObjIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWSchemaObjIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusDb2LUWSchemaObjIncludeHandler::CFBamCustXmlLoaderCPlusDb2LUWSchemaObjIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusDb2LUWSchemaObjIncludeHandler::~CFBamCustXmlLoaderCPlusDb2LUWSchemaObjIncludeHandler() {
	}

	void CFBamCustXmlLoaderCPlusDb2LUWSchemaObjIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusDb2LUWSchemaObjInclude" ) {
				static const std::string Msg( "Expected QName to be 'CPlusDb2LUWSchemaObjInclude'" );
	...
	void CFBamCustXmlLoaderCPlusDb2LUWSchemaObjIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppDb2LUWSchemaObjIncludeNull() || schemaDefObj->getOptionalCppDb2LUWSchemaObjIncludeValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppDb2LUWSchemaObjIncludeValue( text );
