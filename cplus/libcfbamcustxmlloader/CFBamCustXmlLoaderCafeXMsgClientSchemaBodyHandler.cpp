...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeXMsgClientSchemaBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeXMsgClientSchemaBodyHandler" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientSchemaBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientSchemaBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientSchemaBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientSchemaBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientSchemaBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeXMsgClientSchemaBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeXMsgClientSchemaBodyHandler::CFBamCustXmlLoaderCafeXMsgClientSchemaBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeXMsgClientSchemaBodyHandler::~CFBamCustXmlLoaderCafeXMsgClientSchemaBodyHandler() {
	}

	void CFBamCustXmlLoaderCafeXMsgClientSchemaBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeXMsgClientSchemaBody" ) {
				static const std::string Msg( "Expected QName to be 'CafeXMsgClientSchemaBody'" );
	...
	void CFBamCustXmlLoaderCafeXMsgClientSchemaBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJXMsgClientSchemaBodyNull() || schemaDefObj->getOptionalJXMsgClientSchemaBodyValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJXMsgClientSchemaBodyValue( text );
