...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderUInt16ColHandler::CLASS_NAME( "CFBamCustXmlLoaderUInt16ColHandler" );
	const std::string CFBamCustXmlLoaderUInt16ColHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderUInt16ColHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderUInt16ColHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderUInt16ColHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderUInt16ColHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderUInt16ColHandler::S_1( "1" );

	CFBamCustXmlLoaderUInt16ColHandler::CFBamCustXmlLoaderUInt16ColHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderUInt16ColHandler::~CFBamCustXmlLoaderUInt16ColHandler() {
	}

	void CFBamCustXmlLoaderUInt16ColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "UInt16Col" ) {
				static const std::string Msg( "Expected QName to be 'UInt16Col'" );
			...
			origUInt16Col = dynamic_cast<cfbam::ICFBamUInt16ColObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderUInt16ColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
