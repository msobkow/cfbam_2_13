...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeDb2LUWTableImportHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeDb2LUWTableImportHandler" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWTableImportHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWTableImportHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWTableImportHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWTableImportHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWTableImportHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeDb2LUWTableImportHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeDb2LUWTableImportHandler::CFBamCustXmlLoaderCafeDb2LUWTableImportHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeDb2LUWTableImportHandler::~CFBamCustXmlLoaderCafeDb2LUWTableImportHandler() {
	}

	void CFBamCustXmlLoaderCafeDb2LUWTableImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeDb2LUWTableImport" ) {
				static const std::string Msg( "Expected QName to be 'CafeDb2LUWTableImport'" );
	...
	void CFBamCustXmlLoaderCafeDb2LUWTableImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJDb2LUWTableImportNull() || tableObj->getOptionalJDb2LUWTableImportValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJDb2LUWTableImportValue( text );
