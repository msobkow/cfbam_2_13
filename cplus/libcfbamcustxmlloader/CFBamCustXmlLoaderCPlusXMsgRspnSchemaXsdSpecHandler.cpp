...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdSpecHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdSpecHandler" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdSpecHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdSpecHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdSpecHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdSpecHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdSpecHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdSpecHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdSpecHandler::CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdSpecHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdSpecHandler::~CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdSpecHandler() {
	}

	void CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdSpecHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusXMsgRspnSchemaXsdSpec" ) {
				static const std::string Msg( "Expected QName to be 'CPlusXMsgRspnSchemaXsdSpec'" );
	...
	void CFBamCustXmlLoaderCPlusXMsgRspnSchemaXsdSpecHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppXMsgRspnSchemaXsdSpecNull() || schemaDefObj->getOptionalCppXMsgRspnSchemaXsdSpecValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppXMsgRspnSchemaXsdSpecValue( text );
