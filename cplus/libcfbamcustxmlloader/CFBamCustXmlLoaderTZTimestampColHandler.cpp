...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderTZTimestampColHandler::CLASS_NAME( "CFBamCustXmlLoaderTZTimestampColHandler" );
	const std::string CFBamCustXmlLoaderTZTimestampColHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderTZTimestampColHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderTZTimestampColHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderTZTimestampColHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderTZTimestampColHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderTZTimestampColHandler::S_1( "1" );

	CFBamCustXmlLoaderTZTimestampColHandler::CFBamCustXmlLoaderTZTimestampColHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderTZTimestampColHandler::~CFBamCustXmlLoaderTZTimestampColHandler() {
	}

	void CFBamCustXmlLoaderTZTimestampColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "TZTimestampCol" ) {
				static const std::string Msg( "Expected QName to be 'TZTimestampCol'" );
			...
			origTZTimestampCol = dynamic_cast<cfbam::ICFBamTZTimestampColObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderTZTimestampColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
