...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeXMsgTableFormattersHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeXMsgTableFormattersHandler" );
	const std::string CFBamCustXmlLoaderCafeXMsgTableFormattersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeXMsgTableFormattersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeXMsgTableFormattersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeXMsgTableFormattersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeXMsgTableFormattersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeXMsgTableFormattersHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeXMsgTableFormattersHandler::CFBamCustXmlLoaderCafeXMsgTableFormattersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeXMsgTableFormattersHandler::~CFBamCustXmlLoaderCafeXMsgTableFormattersHandler() {
	}

	void CFBamCustXmlLoaderCafeXMsgTableFormattersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeXMsgTableFormatters" ) {
				static const std::string Msg( "Expected QName to be 'CafeXMsgTableFormatters'" );
	...
	void CFBamCustXmlLoaderCafeXMsgTableFormattersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJXMsgTableFormattersNull() || tableObj->getOptionalJXMsgTableFormattersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJXMsgTableFormattersValue( text );
