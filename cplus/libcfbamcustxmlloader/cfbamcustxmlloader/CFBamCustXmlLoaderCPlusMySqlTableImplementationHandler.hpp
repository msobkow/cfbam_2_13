...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderCPlusMySqlTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderCPlusMySqlTableImplementationHandler();
