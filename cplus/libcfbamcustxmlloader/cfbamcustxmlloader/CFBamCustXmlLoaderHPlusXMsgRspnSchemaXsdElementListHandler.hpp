...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdElementListHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderHPlusXMsgRspnSchemaXsdElementListHandler();
