...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderCSharpXMsgRqstSchemaWireParsersHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderCSharpXMsgRqstSchemaWireParsersHandler();
