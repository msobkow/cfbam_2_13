...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderSuperClassRelationHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderSuperClassRelationHandler();
	...
	protected:
		cfbam::ICFBamRelationObj* resolveInheritedRelation( cfbam::ICFBamRelationTableObj* relationTable, cfbam::ICFBamTableObj* tbl, const std::string& relName );
	};
}
