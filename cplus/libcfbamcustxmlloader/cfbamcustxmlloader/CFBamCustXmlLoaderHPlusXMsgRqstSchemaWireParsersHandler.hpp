...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderHPlusXMsgRqstSchemaWireParsersHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderHPlusXMsgRqstSchemaWireParsersHandler();
