...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderCPlusPgSqlTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderCPlusPgSqlTableImplementationHandler();
