...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderCSharpMSSqlTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderCSharpMSSqlTableImplementationHandler();
