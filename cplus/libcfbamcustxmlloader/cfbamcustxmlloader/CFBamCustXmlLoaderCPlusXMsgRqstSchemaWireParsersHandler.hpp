...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderCPlusXMsgRqstSchemaWireParsersHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderCPlusXMsgRqstSchemaWireParsersHandler();
