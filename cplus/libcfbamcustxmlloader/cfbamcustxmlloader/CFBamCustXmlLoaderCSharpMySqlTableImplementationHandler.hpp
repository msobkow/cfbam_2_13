...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderCSharpMySqlTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderCSharpMySqlTableImplementationHandler();
