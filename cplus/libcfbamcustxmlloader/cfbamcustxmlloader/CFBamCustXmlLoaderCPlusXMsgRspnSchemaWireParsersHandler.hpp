...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderCPlusXMsgRspnSchemaWireParsersHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderCPlusXMsgRspnSchemaWireParsersHandler();
