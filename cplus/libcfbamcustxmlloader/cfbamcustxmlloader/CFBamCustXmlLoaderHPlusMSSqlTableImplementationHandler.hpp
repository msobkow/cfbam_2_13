...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderHPlusMSSqlTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderHPlusMSSqlTableImplementationHandler();
