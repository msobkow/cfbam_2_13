...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderCSharpDb2LUWTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderCSharpDb2LUWTableImplementationHandler();
