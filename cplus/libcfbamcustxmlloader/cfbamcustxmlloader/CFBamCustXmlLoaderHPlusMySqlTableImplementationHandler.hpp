...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderHPlusMySqlTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderHPlusMySqlTableImplementationHandler();
