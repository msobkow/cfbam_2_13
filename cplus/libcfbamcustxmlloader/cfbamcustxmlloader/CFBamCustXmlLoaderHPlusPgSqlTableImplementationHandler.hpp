...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderHPlusPgSqlTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderHPlusPgSqlTableImplementationHandler();
