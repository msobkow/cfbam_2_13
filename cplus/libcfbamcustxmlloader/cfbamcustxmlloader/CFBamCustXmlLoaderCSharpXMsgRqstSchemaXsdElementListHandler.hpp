...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdElementListHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdElementListHandler();
