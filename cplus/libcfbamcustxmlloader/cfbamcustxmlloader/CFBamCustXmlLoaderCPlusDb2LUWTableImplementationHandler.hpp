...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderCPlusDb2LUWTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderCPlusDb2LUWTableImplementationHandler();
