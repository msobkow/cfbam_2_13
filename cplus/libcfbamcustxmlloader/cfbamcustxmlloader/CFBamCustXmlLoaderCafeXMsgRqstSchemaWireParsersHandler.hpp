...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderCafeXMsgRqstSchemaWireParsersHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderCafeXMsgRqstSchemaWireParsersHandler();
