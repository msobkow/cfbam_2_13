...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderCSharpOracleTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderCSharpOracleTableImplementationHandler();
