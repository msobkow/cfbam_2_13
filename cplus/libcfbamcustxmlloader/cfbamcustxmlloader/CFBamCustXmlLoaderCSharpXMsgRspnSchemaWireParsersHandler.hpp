...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderCSharpXMsgRspnSchemaWireParsersHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderCSharpXMsgRspnSchemaWireParsersHandler();
