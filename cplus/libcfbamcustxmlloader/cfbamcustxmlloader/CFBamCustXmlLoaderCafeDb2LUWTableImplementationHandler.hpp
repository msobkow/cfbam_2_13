...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderCafeDb2LUWTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderCafeDb2LUWTableImplementationHandler();
