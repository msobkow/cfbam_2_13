...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdElementListHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderCSharpXMsgRspnSchemaXsdElementListHandler();
