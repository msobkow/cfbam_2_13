...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderHPlusXMsgRspnSchemaWireParsersHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderHPlusXMsgRspnSchemaWireParsersHandler();
