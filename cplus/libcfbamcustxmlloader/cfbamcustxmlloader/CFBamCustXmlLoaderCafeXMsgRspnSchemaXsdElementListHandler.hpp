...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdElementListHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderCafeXMsgRspnSchemaXsdElementListHandler();
