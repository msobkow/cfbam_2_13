...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdElementListHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderHPlusXMsgRqstSchemaXsdElementListHandler();
