...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderHPlusOracleTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderHPlusOracleTableImplementationHandler();
