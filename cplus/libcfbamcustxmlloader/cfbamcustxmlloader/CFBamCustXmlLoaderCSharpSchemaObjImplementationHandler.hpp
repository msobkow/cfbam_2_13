...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderCSharpSchemaObjImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderCSharpSchemaObjImplementationHandler();
