...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderCafeOracleTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderCafeOracleTableImplementationHandler();
