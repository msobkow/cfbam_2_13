...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderHPlusDb2LUWTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderHPlusDb2LUWTableImplementationHandler();
