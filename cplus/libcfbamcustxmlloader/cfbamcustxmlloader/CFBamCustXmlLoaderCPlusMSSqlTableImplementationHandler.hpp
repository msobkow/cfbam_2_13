...
namespace cfbam {
	...
	public:
		...
		CFBamCustXmlLoaderCPlusMSSqlTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader );
		virtual ~CFBamCustXmlLoaderCPlusMSSqlTableImplementationHandler();
