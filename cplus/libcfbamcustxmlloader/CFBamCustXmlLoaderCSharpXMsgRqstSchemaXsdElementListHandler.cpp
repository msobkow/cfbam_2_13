...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdElementListHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdElementListHandler" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdElementListHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdElementListHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdElementListHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdElementListHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdElementListHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdElementListHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdElementListHandler::CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdElementListHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdElementListHandler::~CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdElementListHandler() {
	}

	void CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdElementListHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpXMsgRqstSchemaXsdElementList" ) {
				static const std::string Msg( "Expected QName to be 'CSharpXMsgRqstSchemaXsdElementList'" );
	...
	void CFBamCustXmlLoaderCSharpXMsgRqstSchemaXsdElementListHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsXMsgRqstSchemaXsdElementListNull() || schemaDefObj->getOptionalCsXMsgRqstSchemaXsdElementListValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsXMsgRqstSchemaXsdElementListValue( text );
