...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderTZTimeTypeHandler::CLASS_NAME( "CFBamCustXmlLoaderTZTimeTypeHandler" );
	const std::string CFBamCustXmlLoaderTZTimeTypeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderTZTimeTypeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderTZTimeTypeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderTZTimeTypeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderTZTimeTypeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderTZTimeTypeHandler::S_1( "1" );

	CFBamCustXmlLoaderTZTimeTypeHandler::CFBamCustXmlLoaderTZTimeTypeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderTZTimeTypeHandler::~CFBamCustXmlLoaderTZTimeTypeHandler() {
	}

	void CFBamCustXmlLoaderTZTimeTypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "TZTimeType" ) {
				static const std::string Msg( "Expected QName to be 'TZTimeType'" );
			...
			origTZTimeType = dynamic_cast<cfbam::ICFBamTZTimeTypeObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderTZTimeTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
