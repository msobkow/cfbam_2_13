...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeRamTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeRamTableMembersHandler" );
	const std::string CFBamCustXmlLoaderCafeRamTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeRamTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeRamTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeRamTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeRamTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeRamTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeRamTableMembersHandler::CFBamCustXmlLoaderCafeRamTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeRamTableMembersHandler::~CFBamCustXmlLoaderCafeRamTableMembersHandler() {
	}

	void CFBamCustXmlLoaderCafeRamTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeRamTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'CafeRamTableMembers'" );
	...
	void CFBamCustXmlLoaderCafeRamTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJRamTableMembersNull() || tableObj->getOptionalJRamTableMembersValue().empty() ) {
				std::string text = curContext->getElementText();
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJRamTableMembersValue( text );
