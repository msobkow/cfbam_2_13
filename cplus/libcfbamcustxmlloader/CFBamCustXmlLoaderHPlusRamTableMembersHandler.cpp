...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusRamTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusRamTableMembersHandler" );
	const std::string CFBamCustXmlLoaderHPlusRamTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusRamTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusRamTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusRamTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusRamTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusRamTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusRamTableMembersHandler::CFBamCustXmlLoaderHPlusRamTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusRamTableMembersHandler::~CFBamCustXmlLoaderHPlusRamTableMembersHandler() {
	}

	void CFBamCustXmlLoaderHPlusRamTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusRamTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'HPlusRamTableMembers'" );
	...
	void CFBamCustXmlLoaderHPlusRamTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppRamTableMembersNull() || tableObj->getOptionalHppRamTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppRamTableMembersValue( text );
