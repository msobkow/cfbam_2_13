...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderTZDateColHandler::CLASS_NAME( "CFBamCustXmlLoaderTZDateColHandler" );
	const std::string CFBamCustXmlLoaderTZDateColHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderTZDateColHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderTZDateColHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderTZDateColHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderTZDateColHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderTZDateColHandler::S_1( "1" );

	CFBamCustXmlLoaderTZDateColHandler::CFBamCustXmlLoaderTZDateColHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderTZDateColHandler::~CFBamCustXmlLoaderTZDateColHandler() {
	}

	void CFBamCustXmlLoaderTZDateColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "TZDateCol" ) {
				static const std::string Msg( "Expected QName to be 'TZDateCol'" );
			...
			origTZDateCol = dynamic_cast<cfbam::ICFBamTZDateColObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderTZDateColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
