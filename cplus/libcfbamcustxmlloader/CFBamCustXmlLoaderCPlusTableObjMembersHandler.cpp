...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusTableObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusTableObjMembersHandler" );
	const std::string CFBamCustXmlLoaderCPlusTableObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusTableObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusTableObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusTableObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusTableObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusTableObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusTableObjMembersHandler::CFBamCustXmlLoaderCPlusTableObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusTableObjMembersHandler::~CFBamCustXmlLoaderCPlusTableObjMembersHandler() {
	}

	void CFBamCustXmlLoaderCPlusTableObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusTableObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'CPlusTableObjMembers'" );
	...
	void CFBamCustXmlLoaderCPlusTableObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppTableObjMembersNull() || tableObj->getOptionalCppTableObjMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppTableObjMembersValue( text );
