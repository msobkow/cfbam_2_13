...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusPgSqlSchemaObjImplHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusPgSqlSchemaObjImplHandler" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlSchemaObjImplHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlSchemaObjImplHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlSchemaObjImplHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlSchemaObjImplHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlSchemaObjImplHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusPgSqlSchemaObjImplHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusPgSqlSchemaObjImplHandler::CFBamCustXmlLoaderHPlusPgSqlSchemaObjImplHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusPgSqlSchemaObjImplHandler::~CFBamCustXmlLoaderHPlusPgSqlSchemaObjImplHandler() {
	}

	void CFBamCustXmlLoaderHPlusPgSqlSchemaObjImplHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusPgSqlSchemaObjImpl" ) {
				static const std::string Msg( "Expected QName to be 'HPlusPgSqlSchemaObjImpl'" );
	...
	void CFBamCustXmlLoaderHPlusPgSqlSchemaObjImplHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppPgSqlSchemaObjImplNull() || schemaDefObj->getOptionalHppPgSqlSchemaObjImplValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppPgSqlSchemaObjImplValue( text );
