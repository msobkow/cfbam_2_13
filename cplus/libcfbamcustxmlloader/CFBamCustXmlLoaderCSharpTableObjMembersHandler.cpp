...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpTableObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpTableObjMembersHandler" );
	const std::string CFBamCustXmlLoaderCSharpTableObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpTableObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpTableObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpTableObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpTableObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpTableObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpTableObjMembersHandler::CFBamCustXmlLoaderCSharpTableObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpTableObjMembersHandler::~CFBamCustXmlLoaderCSharpTableObjMembersHandler() {
	}

	void CFBamCustXmlLoaderCSharpTableObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpTableObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'CSharpTableObjMembers'" );
	...
	void CFBamCustXmlLoaderCSharpTableObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsTableObjMembersNull() || tableObj->getOptionalCsTableObjMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsTableObjMembersValue( text );
