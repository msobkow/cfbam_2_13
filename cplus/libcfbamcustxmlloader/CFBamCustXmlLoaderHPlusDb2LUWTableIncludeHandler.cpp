...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusDb2LUWTableIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusDb2LUWTableIncludeHandler" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWTableIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWTableIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWTableIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWTableIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWTableIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusDb2LUWTableIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusDb2LUWTableIncludeHandler::CFBamCustXmlLoaderHPlusDb2LUWTableIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusDb2LUWTableIncludeHandler::~CFBamCustXmlLoaderHPlusDb2LUWTableIncludeHandler() {
	}

	void CFBamCustXmlLoaderHPlusDb2LUWTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusDb2LUWTableInclude" ) {
				static const std::string Msg( "Expected QName to be 'HPlusDb2LUWTableInclude'" );
	...
	void CFBamCustXmlLoaderHPlusDb2LUWTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppDb2LUWTableIncludeNull() || tableObj->getOptionalHppDb2LUWTableIncludeValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppDb2LUWTableIncludeValue( text );
