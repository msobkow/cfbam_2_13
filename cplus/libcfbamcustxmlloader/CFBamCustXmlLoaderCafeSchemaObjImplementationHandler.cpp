...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeSchemaObjImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeSchemaObjImplementationHandler" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeSchemaObjImplementationHandler::CFBamCustXmlLoaderCafeSchemaObjImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeSchemaObjImplementationHandler::~CFBamCustXmlLoaderCafeSchemaObjImplementationHandler() {
	}

	void CFBamCustXmlLoaderCafeSchemaObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeSchemaObjImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CafeSchemaObjImplementation'" );
	...
	void CFBamCustXmlLoaderCafeSchemaObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJSchemaObjImplementationNull() || schemaDefObj->getOptionalJSchemaObjImplementationValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJSchemaObjImplementationValue( text );
