...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeSchemaObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeSchemaObjMembersHandler" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeSchemaObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeSchemaObjMembersHandler::CFBamCustXmlLoaderCafeSchemaObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeSchemaObjMembersHandler::~CFBamCustXmlLoaderCafeSchemaObjMembersHandler() {
	}

	void CFBamCustXmlLoaderCafeSchemaObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeSchemaObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'CafeSchemaObjMembers'" );
	...
	void CFBamCustXmlLoaderCafeSchemaObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJSchemaObjMembersNull() || schemaDefObj->getOptionalJSchemaObjMembersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJSchemaObjMembersValue( text );
