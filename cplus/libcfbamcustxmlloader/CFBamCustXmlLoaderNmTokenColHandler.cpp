...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderNmTokenColHandler::CLASS_NAME( "CFBamCustXmlLoaderNmTokenColHandler" );
	const std::string CFBamCustXmlLoaderNmTokenColHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderNmTokenColHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderNmTokenColHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderNmTokenColHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderNmTokenColHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderNmTokenColHandler::S_1( "1" );

	CFBamCustXmlLoaderNmTokenColHandler::CFBamCustXmlLoaderNmTokenColHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderNmTokenColHandler::~CFBamCustXmlLoaderNmTokenColHandler() {
	}

	void CFBamCustXmlLoaderNmTokenColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "NmTokenCol" ) {
				static const std::string Msg( "Expected QName to be 'NmTokenCol'" );
			...
			origNmTokenCol = dynamic_cast<cfbam::ICFBamNmTokenColObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderNmTokenColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
