...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderHPlusTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusTableImplementationHandler::CFBamCustXmlLoaderHPlusTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusTableImplementationHandler::~CFBamCustXmlLoaderHPlusTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderHPlusTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'HPlusTableImplementation'" );
	...
	void CFBamCustXmlLoaderHPlusTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppTableImplementationNull() || tableObj->getOptionalHppTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppTableImplementationValue( text );
