...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusEditObjIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusEditObjIncludeHandler" );
	const std::string CFBamCustXmlLoaderHPlusEditObjIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusEditObjIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusEditObjIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusEditObjIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusEditObjIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusEditObjIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusEditObjIncludeHandler::CFBamCustXmlLoaderHPlusEditObjIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusEditObjIncludeHandler::~CFBamCustXmlLoaderHPlusEditObjIncludeHandler() {
	}

	void CFBamCustXmlLoaderHPlusEditObjIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusEditObjInclude" ) {
				static const std::string Msg( "Expected QName to be 'HPlusEditObjInclude'" );
	...
	void CFBamCustXmlLoaderHPlusEditObjIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppEditObjIncludeNull() || tableObj->getOptionalHppEditObjIncludeValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppEditObjIncludeValue( text );
