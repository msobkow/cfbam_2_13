...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusMySqlTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusMySqlTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderCPlusMySqlTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusMySqlTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusMySqlTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusMySqlTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusMySqlTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusMySqlTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusMySqlTableImplementationHandler::CFBamCustXmlLoaderCPlusMySqlTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusMySqlTableImplementationHandler::~CFBamCustXmlLoaderCPlusMySqlTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderCPlusMySqlTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusMySqlTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CPlusMySqlTableImplementation'" );
	...
	void CFBamCustXmlLoaderCPlusMySqlTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppMySqlTableImplementationNull() || tableObj->getOptionalCppMySqlTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppMySqlTableImplementationValue( text );
