...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusDb2LUWTableImplementationHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusDb2LUWTableImplementationHandler" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWTableImplementationHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWTableImplementationHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWTableImplementationHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWTableImplementationHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWTableImplementationHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusDb2LUWTableImplementationHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusDb2LUWTableImplementationHandler::CFBamCustXmlLoaderCPlusDb2LUWTableImplementationHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusDb2LUWTableImplementationHandler::~CFBamCustXmlLoaderCPlusDb2LUWTableImplementationHandler() {
	}

	void CFBamCustXmlLoaderCPlusDb2LUWTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusDb2LUWTableImplementation" ) {
				static const std::string Msg( "Expected QName to be 'CPlusDb2LUWTableImplementation'" );
	...
	void CFBamCustXmlLoaderCPlusDb2LUWTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCppDb2LUWTableImplementationNull() || tableObj->getOptionalCppDb2LUWTableImplementationValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCppDb2LUWTableImplementationValue( text );
