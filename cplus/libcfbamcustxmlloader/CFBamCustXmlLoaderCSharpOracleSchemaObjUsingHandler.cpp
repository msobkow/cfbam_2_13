...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpOracleSchemaObjUsingHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpOracleSchemaObjUsingHandler" );
	const std::string CFBamCustXmlLoaderCSharpOracleSchemaObjUsingHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpOracleSchemaObjUsingHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpOracleSchemaObjUsingHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpOracleSchemaObjUsingHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpOracleSchemaObjUsingHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpOracleSchemaObjUsingHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpOracleSchemaObjUsingHandler::CFBamCustXmlLoaderCSharpOracleSchemaObjUsingHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpOracleSchemaObjUsingHandler::~CFBamCustXmlLoaderCSharpOracleSchemaObjUsingHandler() {
	}

	void CFBamCustXmlLoaderCSharpOracleSchemaObjUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpOracleSchemaObjUsing" ) {
				static const std::string Msg( "Expected QName to be 'CSharpOracleSchemaObjUsing'" );
	...
	void CFBamCustXmlLoaderCSharpOracleSchemaObjUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsOracleSchemaObjUsingNull() || schemaDefObj->getOptionalCsOracleSchemaObjUsingValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsOracleSchemaObjUsingValue( text );
