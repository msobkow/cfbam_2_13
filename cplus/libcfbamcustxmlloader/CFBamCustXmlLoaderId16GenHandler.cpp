...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderId16GenHandler::CLASS_NAME( "CFBamCustXmlLoaderId16GenHandler" );
	const std::string CFBamCustXmlLoaderId16GenHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderId16GenHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderId16GenHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderId16GenHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderId16GenHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderId16GenHandler::S_1( "1" );

	CFBamCustXmlLoaderId16GenHandler::CFBamCustXmlLoaderId16GenHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderId16GenHandler::~CFBamCustXmlLoaderId16GenHandler() {
	}

	void CFBamCustXmlLoaderId16GenHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "Id16Gen" ) {
				static const std::string Msg( "Expected QName to be 'Id16Gen'" );
			...
			int16_t* pBlockSize = cflib::CFLibXmlUtil::parseInt16( *attrBlockSize );
			if( pBlockSize != NULL ) {
			...
			origId16Gen = dynamic_cast<cfbam::ICFBamId16GenObj*>( editBuff->create() );
			editBuff = NULL;
			tmpBuff = NULL;
...
cleanup:
	...
	void CFBamCustXmlLoaderId16GenHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
