...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCPlusOracleSchemaObjMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCPlusOracleSchemaObjMembersHandler" );
	const std::string CFBamCustXmlLoaderCPlusOracleSchemaObjMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCPlusOracleSchemaObjMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCPlusOracleSchemaObjMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCPlusOracleSchemaObjMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCPlusOracleSchemaObjMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCPlusOracleSchemaObjMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCPlusOracleSchemaObjMembersHandler::CFBamCustXmlLoaderCPlusOracleSchemaObjMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCPlusOracleSchemaObjMembersHandler::~CFBamCustXmlLoaderCPlusOracleSchemaObjMembersHandler() {
	}

	void CFBamCustXmlLoaderCPlusOracleSchemaObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CPlusOracleSchemaObjMembers" ) {
				static const std::string Msg( "Expected QName to be 'CPlusOracleSchemaObjMembers'" );
	...
	void CFBamCustXmlLoaderCPlusOracleSchemaObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCppOracleSchemaObjMembersNull() || schemaDefObj->getOptionalCppOracleSchemaObjMembersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCppOracleSchemaObjMembersValue( text );
