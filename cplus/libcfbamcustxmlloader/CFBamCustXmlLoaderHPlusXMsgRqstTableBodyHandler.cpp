...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstTableBodyHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusXMsgRqstTableBodyHandler" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstTableBodyHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstTableBodyHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstTableBodyHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstTableBodyHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstTableBodyHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusXMsgRqstTableBodyHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusXMsgRqstTableBodyHandler::CFBamCustXmlLoaderHPlusXMsgRqstTableBodyHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusXMsgRqstTableBodyHandler::~CFBamCustXmlLoaderHPlusXMsgRqstTableBodyHandler() {
	}

	void CFBamCustXmlLoaderHPlusXMsgRqstTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusXMsgRqstTableBody" ) {
				static const std::string Msg( "Expected QName to be 'HPlusXMsgRqstTableBody'" );
	...
	void CFBamCustXmlLoaderHPlusXMsgRqstTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalHppXMsgRqstTableBodyNull() || tableObj->getOptionalHppXMsgRqstTableBodyValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalHppXMsgRqstTableBodyValue( text );
