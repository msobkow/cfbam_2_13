...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeMSSqlSchemaObjImportHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeMSSqlSchemaObjImportHandler" );
	const std::string CFBamCustXmlLoaderCafeMSSqlSchemaObjImportHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeMSSqlSchemaObjImportHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeMSSqlSchemaObjImportHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeMSSqlSchemaObjImportHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeMSSqlSchemaObjImportHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeMSSqlSchemaObjImportHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeMSSqlSchemaObjImportHandler::CFBamCustXmlLoaderCafeMSSqlSchemaObjImportHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeMSSqlSchemaObjImportHandler::~CFBamCustXmlLoaderCafeMSSqlSchemaObjImportHandler() {
	}

	void CFBamCustXmlLoaderCafeMSSqlSchemaObjImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeMSSqlSchemaObjImport" ) {
				static const std::string Msg( "Expected QName to be 'CafeMSSqlSchemaObjImport'" );
	...
	void CFBamCustXmlLoaderCafeMSSqlSchemaObjImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJMSSqlSchemaObjImportNull() || schemaDefObj->getOptionalJMSSqlSchemaObjImportValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJMSSqlSchemaObjImportValue( text );
