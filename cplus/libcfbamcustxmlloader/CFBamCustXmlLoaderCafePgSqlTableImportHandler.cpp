...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafePgSqlTableImportHandler::CLASS_NAME( "CFBamCustXmlLoaderCafePgSqlTableImportHandler" );
	const std::string CFBamCustXmlLoaderCafePgSqlTableImportHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafePgSqlTableImportHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafePgSqlTableImportHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafePgSqlTableImportHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafePgSqlTableImportHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafePgSqlTableImportHandler::S_1( "1" );

	CFBamCustXmlLoaderCafePgSqlTableImportHandler::CFBamCustXmlLoaderCafePgSqlTableImportHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafePgSqlTableImportHandler::~CFBamCustXmlLoaderCafePgSqlTableImportHandler() {
	}

	void CFBamCustXmlLoaderCafePgSqlTableImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafePgSqlTableImport" ) {
				static const std::string Msg( "Expected QName to be 'CafePgSqlTableImport'" );
	...
	void CFBamCustXmlLoaderCafePgSqlTableImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalJPgSqlTableImportNull() || tableObj->getOptionalJPgSqlTableImportValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalJPgSqlTableImportValue( text );
