...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpMSSqlTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpMSSqlTableMembersHandler" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpMSSqlTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpMSSqlTableMembersHandler::CFBamCustXmlLoaderCSharpMSSqlTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpMSSqlTableMembersHandler::~CFBamCustXmlLoaderCSharpMSSqlTableMembersHandler() {
	}

	void CFBamCustXmlLoaderCSharpMSSqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpMSSqlTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'CSharpMSSqlTableMembers'" );
	...
	void CFBamCustXmlLoaderCSharpMSSqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsMSSqlTableMembersNull() || tableObj->getOptionalCsMSSqlTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsMSSqlTableMembersValue( text );
