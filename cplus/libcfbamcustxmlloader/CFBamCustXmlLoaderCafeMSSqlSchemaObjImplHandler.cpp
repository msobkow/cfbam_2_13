...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeMSSqlSchemaObjImplHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeMSSqlSchemaObjImplHandler" );
	const std::string CFBamCustXmlLoaderCafeMSSqlSchemaObjImplHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeMSSqlSchemaObjImplHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeMSSqlSchemaObjImplHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeMSSqlSchemaObjImplHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeMSSqlSchemaObjImplHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeMSSqlSchemaObjImplHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeMSSqlSchemaObjImplHandler::CFBamCustXmlLoaderCafeMSSqlSchemaObjImplHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeMSSqlSchemaObjImplHandler::~CFBamCustXmlLoaderCafeMSSqlSchemaObjImplHandler() {
	}

	void CFBamCustXmlLoaderCafeMSSqlSchemaObjImplHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeMSSqlSchemaObjImpl" ) {
				static const std::string Msg( "Expected QName to be 'CafeMSSqlSchemaObjImpl'" );
	...
	void CFBamCustXmlLoaderCafeMSSqlSchemaObjImplHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJMSSqlSchemaObjImplNull() || schemaDefObj->getOptionalJMSSqlSchemaObjImplValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJMSSqlSchemaObjImplValue( text );
