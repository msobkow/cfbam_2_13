...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpSchemaObjUsingHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpSchemaObjUsingHandler" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjUsingHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjUsingHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjUsingHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjUsingHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjUsingHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpSchemaObjUsingHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpSchemaObjUsingHandler::CFBamCustXmlLoaderCSharpSchemaObjUsingHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpSchemaObjUsingHandler::~CFBamCustXmlLoaderCSharpSchemaObjUsingHandler() {
	}

	void CFBamCustXmlLoaderCSharpSchemaObjUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpSchemaObjUsing" ) {
				static const std::string Msg( "Expected QName to be 'CSharpSchemaObjUsing'" );
	...
	void CFBamCustXmlLoaderCSharpSchemaObjUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalCsSchemaObjUsingNull() || schemaDefObj->getOptionalCsSchemaObjUsingValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalCsSchemaObjUsingValue( text );
