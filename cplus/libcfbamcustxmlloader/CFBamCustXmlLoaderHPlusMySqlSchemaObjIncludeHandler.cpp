...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderHPlusMySqlSchemaObjIncludeHandler::CLASS_NAME( "CFBamCustXmlLoaderHPlusMySqlSchemaObjIncludeHandler" );
	const std::string CFBamCustXmlLoaderHPlusMySqlSchemaObjIncludeHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderHPlusMySqlSchemaObjIncludeHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderHPlusMySqlSchemaObjIncludeHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderHPlusMySqlSchemaObjIncludeHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderHPlusMySqlSchemaObjIncludeHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderHPlusMySqlSchemaObjIncludeHandler::S_1( "1" );

	CFBamCustXmlLoaderHPlusMySqlSchemaObjIncludeHandler::CFBamCustXmlLoaderHPlusMySqlSchemaObjIncludeHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderHPlusMySqlSchemaObjIncludeHandler::~CFBamCustXmlLoaderHPlusMySqlSchemaObjIncludeHandler() {
	}

	void CFBamCustXmlLoaderHPlusMySqlSchemaObjIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "HPlusMySqlSchemaObjInclude" ) {
				static const std::string Msg( "Expected QName to be 'HPlusMySqlSchemaObjInclude'" );
	...
	void CFBamCustXmlLoaderHPlusMySqlSchemaObjIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalHppMySqlSchemaObjIncludeNull() || schemaDefObj->getOptionalHppMySqlSchemaObjIncludeValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalHppMySqlSchemaObjIncludeValue( text );
