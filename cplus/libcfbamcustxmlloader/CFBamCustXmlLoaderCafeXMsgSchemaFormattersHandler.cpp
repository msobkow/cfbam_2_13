...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCafeXMsgSchemaFormattersHandler::CLASS_NAME( "CFBamCustXmlLoaderCafeXMsgSchemaFormattersHandler" );
	const std::string CFBamCustXmlLoaderCafeXMsgSchemaFormattersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCafeXMsgSchemaFormattersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCafeXMsgSchemaFormattersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCafeXMsgSchemaFormattersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCafeXMsgSchemaFormattersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCafeXMsgSchemaFormattersHandler::S_1( "1" );

	CFBamCustXmlLoaderCafeXMsgSchemaFormattersHandler::CFBamCustXmlLoaderCafeXMsgSchemaFormattersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCafeXMsgSchemaFormattersHandler::~CFBamCustXmlLoaderCafeXMsgSchemaFormattersHandler() {
	}

	void CFBamCustXmlLoaderCafeXMsgSchemaFormattersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CafeXMsgSchemaFormatters" ) {
				static const std::string Msg( "Expected QName to be 'CafeXMsgSchemaFormatters'" );
	...
	void CFBamCustXmlLoaderCafeXMsgSchemaFormattersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( schemaDefObj->isOptionalJXMsgSchemaFormattersNull() || schemaDefObj->getOptionalJXMsgSchemaFormattersValue().empty() ) {
				editSchemaDefObj = dynamic_cast<cfbam::ICFBamSchemaDefEditObj*>( schemaDefObj->beginEdit() );
				editSchemaDefObj->setOptionalJXMsgSchemaFormattersValue( text );
