...
namespace cfbam {
	...
	const std::string CFBamCustXmlLoaderCSharpDb2LUWTableMembersHandler::CLASS_NAME( "CFBamCustXmlLoaderCSharpDb2LUWTableMembersHandler" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWTableMembersHandler::S_True( "true" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWTableMembersHandler::S_False( "false" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWTableMembersHandler::S_Yes( "yes" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWTableMembersHandler::S_No( "no" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWTableMembersHandler::S_0( "0" );
	const std::string CFBamCustXmlLoaderCSharpDb2LUWTableMembersHandler::S_1( "1" );

	CFBamCustXmlLoaderCSharpDb2LUWTableMembersHandler::CFBamCustXmlLoaderCSharpDb2LUWTableMembersHandler( cfbam::CFBamCustXmlLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamCustXmlLoaderCSharpDb2LUWTableMembersHandler::~CFBamCustXmlLoaderCSharpDb2LUWTableMembersHandler() {
	}

	void CFBamCustXmlLoaderCSharpDb2LUWTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		try {
			...
			cQName = NULL;
			if( cppQName != "CSharpDb2LUWTableMembers" ) {
				static const std::string Msg( "Expected QName to be 'CSharpDb2LUWTableMembers'" );
	...
	void CFBamCustXmlLoaderCSharpDb2LUWTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		try {
			...
			if( tableObj->isOptionalCsDb2LUWTableMembersNull() || tableObj->getOptionalCsDb2LUWTableMembersValue().empty() ) {
				editTableObj = dynamic_cast<cfbam::ICFBamTableEditObj*>( tableObj->beginEdit() );
				editTableObj->setOptionalCsDb2LUWTableMembersValue( text );
