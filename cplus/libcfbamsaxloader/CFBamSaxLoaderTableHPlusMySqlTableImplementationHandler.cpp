...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusMySqlTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusMySqlTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusMySqlTableImplementationHandler::CFBamSaxLoaderTableHPlusMySqlTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusMySqlTableImplementationHandler::~CFBamSaxLoaderTableHPlusMySqlTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableHPlusMySqlTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusMySqlTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusMySqlTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusMySqlTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppMySqlTableImplementationNull() || origBuff->getOptionalHppMySqlTableImplementationValue().empty() ) {
			editBuff->setOptionalHppMySqlTableImplementationValue( attrText );
		}
		else {
