...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusDb2LUWTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusDb2LUWTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusDb2LUWTableMembersHandler::CFBamSaxLoaderTableCPlusDb2LUWTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusDb2LUWTableMembersHandler::~CFBamSaxLoaderTableCPlusDb2LUWTableMembersHandler() {
	}

	void CFBamSaxLoaderTableCPlusDb2LUWTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusDb2LUWTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusDb2LUWTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusDb2LUWTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppDb2LUWTableMembersNull() || origBuff->getOptionalCppDb2LUWTableMembersValue().empty() ) {
			editBuff->setOptionalCppDb2LUWTableMembersValue( attrText );
		}
		else {
