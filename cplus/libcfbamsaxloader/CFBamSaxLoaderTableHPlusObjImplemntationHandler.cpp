...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusObjImplemntation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusObjImplemntationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusObjImplemntationHandler::CFBamSaxLoaderTableHPlusObjImplemntationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusObjImplemntationHandler::~CFBamSaxLoaderTableHPlusObjImplemntationHandler() {
	}

	void CFBamSaxLoaderTableHPlusObjImplemntationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusObjImplemntation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusObjImplemntationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusObjImplemntation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppObjImplementationNull() || origBuff->getOptionalHppObjImplementationValue().empty() ) {
			editBuff->setOptionalHppObjImplementationValue( attrText );
		}
		else {
