...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusMSSqlTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusMSSqlTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusMSSqlTableImplementationHandler::CFBamSaxLoaderTableHPlusMSSqlTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusMSSqlTableImplementationHandler::~CFBamSaxLoaderTableHPlusMSSqlTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableHPlusMSSqlTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusMSSqlTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusMSSqlTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusMSSqlTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppMSSqlTableImplementationNull() || origBuff->getOptionalHppMSSqlTableImplementationValue().empty() ) {
			editBuff->setOptionalHppMSSqlTableImplementationValue( attrText );
		}
		else {
