...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusEditObjInterface
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusEditObjInterfaceHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusEditObjInterfaceHandler::CFBamSaxLoaderTableHPlusEditObjInterfaceHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusEditObjInterfaceHandler::~CFBamSaxLoaderTableHPlusEditObjInterfaceHandler() {
	}

	void CFBamSaxLoaderTableHPlusEditObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusEditObjInterface" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusEditObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusEditObjInterface more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppEditObjInterfaceNull() || origBuff->getOptionalHppEditObjInterfaceValue().empty() ) {
			editBuff->setOptionalHppEditObjInterfaceValue( attrText );
		}
		else {
