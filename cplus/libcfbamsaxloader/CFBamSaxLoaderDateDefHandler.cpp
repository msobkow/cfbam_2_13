...
// Description: C++18 XML SAX2 Element Handler implementation for DateDef
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderDateDefHandler::CLASS_NAME( "CFBamSaxLoaderDateDefHandler" );
	const std::string CFBamSaxLoaderDateDefHandler::S_True( "true" );
	const std::string CFBamSaxLoaderDateDefHandler::S_False( "false" );
	const std::string CFBamSaxLoaderDateDefHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderDateDefHandler::S_No( "no" );
	const std::string CFBamSaxLoaderDateDefHandler::S_0( "0" );
	const std::string CFBamSaxLoaderDateDefHandler::S_1( "1" );

	CFBamSaxLoaderDateDefHandler::CFBamSaxLoaderDateDefHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderDateDefHandler::~CFBamSaxLoaderDateDefHandler() {
	}

	void CFBamSaxLoaderDateDefHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamDateDefObj* tmpBuff = NULL;
		cfbam::ICFBamDateDefEditObj* editBuff = NULL;
		cfbam::ICFBamDateDefEditObj* editDateDef = NULL;
		cfbam::ICFBamDateDefObj* origDateDef = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamDateDefBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamDateDefBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getDateDefTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamDateDefEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getDateDefLoaderBehaviour();
			origDateDef = dynamic_cast<cfbam::ICFBamDateDefObj*>( schemaObj->getDateDefTableObj()->readDateDefByUNameIdx( refTenant->getRequiredId(),
			...
			if( origDateDef == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editDateDef = dynamic_cast<cfbam::ICFBamDateDefEditObj*>( origDateDef->beginEdit() );
						editDateDef->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editDateDef->setOptionalShortNameNull();
						}
						else {
							editDateDef->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editDateDef->setOptionalLabelNull();
						}
						else {
							editDateDef->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editDateDef->setOptionalShortDescriptionNull();
						}
						else {
							editDateDef->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editDateDef->setOptionalDescriptionNull();
						}
						else {
							editDateDef->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editDateDef->setOptionalDefaultXmlValueNull();
						}
						else {
							editDateDef->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editDateDef->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editDateDef->setOptionalGenerateIdNull();
						}
						else {
							editDateDef->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editDateDef->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editDateDef->setOptionalDbNameNull();
						}
						else {
							editDateDef->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalDummyNull() ) {
							editDateDef->setOptionalDummyNull();
						}
						else {
							editDateDef->setOptionalDummyValue( editBuff->getOptionalDummyValue() );
						}
			...
			if( editDateDef != NULL ) {
				if( origDateDef != NULL ) {
					...
					origDateDef = dynamic_cast<cfbam::ICFBamDateDefObj*>( editDateDef->create() );
				}
				editDateDef = NULL;
			}
...
cleanup:
	...
	void CFBamSaxLoaderDateDefHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
