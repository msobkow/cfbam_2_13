...
// Description: C++18 XML SAX2 Element Handler implementation for ClearTopDep
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderClearTopDepHandler::CLASS_NAME( "CFBamSaxLoaderClearTopDepHandler" );
	const std::string CFBamSaxLoaderClearTopDepHandler::S_True( "true" );
	const std::string CFBamSaxLoaderClearTopDepHandler::S_False( "false" );
	const std::string CFBamSaxLoaderClearTopDepHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderClearTopDepHandler::S_No( "no" );
	const std::string CFBamSaxLoaderClearTopDepHandler::S_0( "0" );
	const std::string CFBamSaxLoaderClearTopDepHandler::S_1( "1" );

	CFBamSaxLoaderClearTopDepHandler::CFBamSaxLoaderClearTopDepHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderClearTopDepHandler::~CFBamSaxLoaderClearTopDepHandler() {
	}

	void CFBamSaxLoaderClearTopDepHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamClearTopDepObj* tmpBuff = NULL;
		cfbam::ICFBamClearTopDepEditObj* editBuff = NULL;
		cfbam::ICFBamClearTopDepEditObj* editClearTopDep = NULL;
		cfbam::ICFBamClearTopDepObj* origClearTopDep = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamClearTopDepBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamClearTopDepBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getClearTopDepTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamClearTopDepEditObj*>( tmpBuff->beginEdit() );
			...
			editClearTopDep = editBuff;
			editBuff = NULL;
			origClearTopDep = dynamic_cast<cfbam::ICFBamClearTopDepObj*>( editClearTopDep->create() );
			editClearTopDep = NULL;
			tmpBuff = NULL;

			curContext->setObj( origClearTopDep );
...
cleanup:
	...
	void CFBamSaxLoaderClearTopDepHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
