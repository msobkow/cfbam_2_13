...
// Description: C++18 XML SAX2 Element Handler implementation for Int16Col
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderInt16ColHandler::CLASS_NAME( "CFBamSaxLoaderInt16ColHandler" );
	const std::string CFBamSaxLoaderInt16ColHandler::S_True( "true" );
	const std::string CFBamSaxLoaderInt16ColHandler::S_False( "false" );
	const std::string CFBamSaxLoaderInt16ColHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderInt16ColHandler::S_No( "no" );
	const std::string CFBamSaxLoaderInt16ColHandler::S_0( "0" );
	const std::string CFBamSaxLoaderInt16ColHandler::S_1( "1" );

	CFBamSaxLoaderInt16ColHandler::CFBamSaxLoaderInt16ColHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderInt16ColHandler::~CFBamSaxLoaderInt16ColHandler() {
	}

	void CFBamSaxLoaderInt16ColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamInt16ColObj* tmpBuff = NULL;
		cfbam::ICFBamInt16ColEditObj* editBuff = NULL;
		cfbam::ICFBamInt16ColEditObj* editInt16Col = NULL;
		cfbam::ICFBamInt16ColObj* origInt16Col = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamInt16ColBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamInt16ColBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getInt16ColTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamInt16ColEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getInt16ColLoaderBehaviour();
			origInt16Col = dynamic_cast<cfbam::ICFBamInt16ColObj*>( schemaObj->getInt16ColTableObj()->readInt16ColByUNameIdx( refTenant->getRequiredId(),
			...
			if( origInt16Col == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editInt16Col = dynamic_cast<cfbam::ICFBamInt16ColEditObj*>( origInt16Col->beginEdit() );
						editInt16Col->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editInt16Col->setOptionalShortNameNull();
						}
						else {
							editInt16Col->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editInt16Col->setOptionalLabelNull();
						}
						else {
							editInt16Col->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editInt16Col->setOptionalShortDescriptionNull();
						}
						else {
							editInt16Col->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editInt16Col->setOptionalDescriptionNull();
						}
						else {
							editInt16Col->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editInt16Col->setOptionalDefaultXmlValueNull();
						}
						else {
							editInt16Col->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editInt16Col->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editInt16Col->setOptionalGenerateIdNull();
						}
						else {
							editInt16Col->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editInt16Col->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editInt16Col->setOptionalDbNameNull();
						}
						else {
							editInt16Col->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editInt16Col->setOptionalInitValueNull();
						}
						else {
							editInt16Col->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editInt16Col->setOptionalMinValueNull();
						}
						else {
							editInt16Col->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editInt16Col->setOptionalMaxValueNull();
						}
						else {
							editInt16Col->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editInt16Col != NULL ) {
				if( origInt16Col != NULL ) {
					...
					origInt16Col = dynamic_cast<cfbam::ICFBamInt16ColObj*>( editInt16Col->create() );
				}
				editInt16Col = NULL;
			}
			...
			curContext->setObj( origInt16Col );
...
cleanup:
	...
	void CFBamSaxLoaderInt16ColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
