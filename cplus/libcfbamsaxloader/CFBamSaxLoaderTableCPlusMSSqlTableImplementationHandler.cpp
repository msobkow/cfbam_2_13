...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusMSSqlTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusMSSqlTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusMSSqlTableImplementationHandler::CFBamSaxLoaderTableCPlusMSSqlTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusMSSqlTableImplementationHandler::~CFBamSaxLoaderTableCPlusMSSqlTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableCPlusMSSqlTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusMSSqlTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusMSSqlTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusMSSqlTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppMSSqlTableImplementationNull() || origBuff->getOptionalCppMSSqlTableImplementationValue().empty() ) {
			editBuff->setOptionalCppMSSqlTableImplementationValue( attrText );
		}
		else {
