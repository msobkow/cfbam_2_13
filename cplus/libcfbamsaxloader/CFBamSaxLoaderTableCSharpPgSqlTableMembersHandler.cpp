...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpPgSqlTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpPgSqlTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpPgSqlTableMembersHandler::CFBamSaxLoaderTableCSharpPgSqlTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpPgSqlTableMembersHandler::~CFBamSaxLoaderTableCSharpPgSqlTableMembersHandler() {
	}

	void CFBamSaxLoaderTableCSharpPgSqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpPgSqlTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpPgSqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpPgSqlTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsPgSqlTableMembersNull() || origBuff->getOptionalCsPgSqlTableMembersValue().empty() ) {
			editBuff->setOptionalCsPgSqlTableMembersValue( attrText );
		}
		else {
