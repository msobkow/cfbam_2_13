...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusXMsgRqstTableInclude
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusXMsgRqstTableIncludeHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusXMsgRqstTableIncludeHandler::CFBamSaxLoaderTableCPlusXMsgRqstTableIncludeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusXMsgRqstTableIncludeHandler::~CFBamSaxLoaderTableCPlusXMsgRqstTableIncludeHandler() {
	}

	void CFBamSaxLoaderTableCPlusXMsgRqstTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusXMsgRqstTableInclude" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusXMsgRqstTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusXMsgRqstTableInclude more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppXMsgRqstTableIncludeNull() || origBuff->getOptionalCppXMsgRqstTableIncludeValue().empty() ) {
			editBuff->setOptionalCppXMsgRqstTableIncludeValue( attrText );
		}
		else {
