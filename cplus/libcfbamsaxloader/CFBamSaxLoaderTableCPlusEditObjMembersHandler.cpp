...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusEditObjMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusEditObjMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusEditObjMembersHandler::CFBamSaxLoaderTableCPlusEditObjMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusEditObjMembersHandler::~CFBamSaxLoaderTableCPlusEditObjMembersHandler() {
	}

	void CFBamSaxLoaderTableCPlusEditObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusEditObjMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusEditObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusEditObjMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppEditObjMembersNull() || origBuff->getOptionalCppEditObjMembersValue().empty() ) {
			editBuff->setOptionalCppEditObjMembersValue( attrText );
		}
		else {
