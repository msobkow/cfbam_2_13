...
// Description: C++18 XML SAX2 Element Handler implementation for BoolCol
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderBoolColHandler::CLASS_NAME( "CFBamSaxLoaderBoolColHandler" );
	const std::string CFBamSaxLoaderBoolColHandler::S_True( "true" );
	const std::string CFBamSaxLoaderBoolColHandler::S_False( "false" );
	const std::string CFBamSaxLoaderBoolColHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderBoolColHandler::S_No( "no" );
	const std::string CFBamSaxLoaderBoolColHandler::S_0( "0" );
	const std::string CFBamSaxLoaderBoolColHandler::S_1( "1" );

	CFBamSaxLoaderBoolColHandler::CFBamSaxLoaderBoolColHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderBoolColHandler::~CFBamSaxLoaderBoolColHandler() {
	}

	void CFBamSaxLoaderBoolColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamBoolColObj* tmpBuff = NULL;
		cfbam::ICFBamBoolColEditObj* editBuff = NULL;
		cfbam::ICFBamBoolColEditObj* editBoolCol = NULL;
		cfbam::ICFBamBoolColObj* origBoolCol = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamBoolColBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamBoolColBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getBoolColTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamBoolColEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getBoolColLoaderBehaviour();
			origBoolCol = dynamic_cast<cfbam::ICFBamBoolColObj*>( schemaObj->getBoolColTableObj()->readBoolColByUNameIdx( refTenant->getRequiredId(),
			...
			if( origBoolCol == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editBoolCol = dynamic_cast<cfbam::ICFBamBoolColEditObj*>( origBoolCol->beginEdit() );
						editBoolCol->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editBoolCol->setOptionalShortNameNull();
						}
						else {
							editBoolCol->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editBoolCol->setOptionalLabelNull();
						}
						else {
							editBoolCol->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editBoolCol->setOptionalShortDescriptionNull();
						}
						else {
							editBoolCol->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editBoolCol->setOptionalDescriptionNull();
						}
						else {
							editBoolCol->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editBoolCol->setOptionalDefaultXmlValueNull();
						}
						else {
							editBoolCol->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editBoolCol->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editBoolCol->setOptionalGenerateIdNull();
						}
						else {
							editBoolCol->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editBoolCol->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editBoolCol->setOptionalDbNameNull();
						}
						else {
							editBoolCol->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editBoolCol->setOptionalInitValueNull();
						}
						else {
							editBoolCol->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalFalseStringNull() ) {
							editBoolCol->setOptionalFalseStringNull();
						}
						else {
							editBoolCol->setOptionalFalseStringValue( editBuff->getOptionalFalseStringValue() );
						}
						if( editBuff->isOptionalTrueStringNull() ) {
							editBoolCol->setOptionalTrueStringNull();
						}
						else {
							editBoolCol->setOptionalTrueStringValue( editBuff->getOptionalTrueStringValue() );
						}
						if( editBuff->isOptionalNullStringNull() ) {
							editBoolCol->setOptionalNullStringNull();
						}
						else {
							editBoolCol->setOptionalNullStringValue( editBuff->getOptionalNullStringValue() );
						}
			...
			if( editBoolCol != NULL ) {
				if( origBoolCol != NULL ) {
					...
					origBoolCol = dynamic_cast<cfbam::ICFBamBoolColObj*>( editBoolCol->create() );
				}
				editBoolCol = NULL;
			}
...
cleanup:
	...
	void CFBamSaxLoaderBoolColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
