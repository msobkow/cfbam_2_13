...
// Description: C++18 XML SAX2 Element Handler implementation for DelSubDep3
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderDelSubDep3Handler::CLASS_NAME( "CFBamSaxLoaderDelSubDep3Handler" );
	const std::string CFBamSaxLoaderDelSubDep3Handler::S_True( "true" );
	const std::string CFBamSaxLoaderDelSubDep3Handler::S_False( "false" );
	const std::string CFBamSaxLoaderDelSubDep3Handler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderDelSubDep3Handler::S_No( "no" );
	const std::string CFBamSaxLoaderDelSubDep3Handler::S_0( "0" );
	const std::string CFBamSaxLoaderDelSubDep3Handler::S_1( "1" );

	CFBamSaxLoaderDelSubDep3Handler::CFBamSaxLoaderDelSubDep3Handler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderDelSubDep3Handler::~CFBamSaxLoaderDelSubDep3Handler() {
	}

	void CFBamSaxLoaderDelSubDep3Handler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		static const std::string S_DelSubDep2( "DelSubDep2" );
		...
		cfbam::ICFBamDelSubDep3Obj* tmpBuff = NULL;
		cfbam::ICFBamDelSubDep3EditObj* editBuff = NULL;
		cfbam::ICFBamDelSubDep3EditObj* editDelSubDep3 = NULL;
		cfbam::ICFBamDelSubDep3Obj* origDelSubDep3 = NULL;
		...
		cfbam::ICFBamDelSubDep2Obj* refDelSubDep2 = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamDelSubDep3Buff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamDelSubDep3Buff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getDelSubDep3TableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamDelSubDep3EditObj*>( tmpBuff->beginEdit() );
			...
			else if( scopeObj->implementsClassCode( cfbam::CFBamDelSubDep2Buff::CLASS_CODE ) ) {
				refDelSubDep2 = dynamic_cast<cfbam::ICFBamDelSubDep2Obj*>( scopeObj );
			...
			editDelSubDep3 = editBuff;
			editBuff = NULL;
			origDelSubDep3 = dynamic_cast<cfbam::ICFBamDelSubDep3Obj*>( editDelSubDep3->create() );
			editDelSubDep3 = NULL;
			tmpBuff = NULL;

			curContext->setObj( origDelSubDep3 );
...
cleanup:
	...
	void CFBamSaxLoaderDelSubDep3Handler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
