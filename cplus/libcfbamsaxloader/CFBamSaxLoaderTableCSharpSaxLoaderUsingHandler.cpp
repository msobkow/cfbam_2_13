...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpSaxLoaderUsing
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpSaxLoaderUsingHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpSaxLoaderUsingHandler::CFBamSaxLoaderTableCSharpSaxLoaderUsingHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpSaxLoaderUsingHandler::~CFBamSaxLoaderTableCSharpSaxLoaderUsingHandler() {
	}

	void CFBamSaxLoaderTableCSharpSaxLoaderUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpSaxLoaderUsing" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpSaxLoaderUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpSaxLoaderUsing more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsSaxLoaderUsingNull() || origBuff->getOptionalCsSaxLoaderUsingValue().empty() ) {
			editBuff->setOptionalCsSaxLoaderUsingValue( attrText );
		}
		else {
