...
// Description: C++18 XML SAX2 Element Handler implementation for TimeType
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTimeTypeHandler::CLASS_NAME( "CFBamSaxLoaderTimeTypeHandler" );
	const std::string CFBamSaxLoaderTimeTypeHandler::S_True( "true" );
	const std::string CFBamSaxLoaderTimeTypeHandler::S_False( "false" );
	const std::string CFBamSaxLoaderTimeTypeHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderTimeTypeHandler::S_No( "no" );
	const std::string CFBamSaxLoaderTimeTypeHandler::S_0( "0" );
	const std::string CFBamSaxLoaderTimeTypeHandler::S_1( "1" );

	CFBamSaxLoaderTimeTypeHandler::CFBamSaxLoaderTimeTypeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTimeTypeHandler::~CFBamSaxLoaderTimeTypeHandler() {
	}

	void CFBamSaxLoaderTimeTypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamTimeTypeObj* tmpBuff = NULL;
		cfbam::ICFBamTimeTypeEditObj* editBuff = NULL;
		cfbam::ICFBamTimeTypeEditObj* editTimeType = NULL;
		cfbam::ICFBamTimeTypeObj* origTimeType = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamTimeTypeBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamTimeTypeBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getTimeTypeTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamTimeTypeEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getTimeTypeLoaderBehaviour();
			origTimeType = dynamic_cast<cfbam::ICFBamTimeTypeObj*>( schemaObj->getTimeTypeTableObj()->readTimeTypeByUNameIdx( refTenant->getRequiredId(),
			...
			if( origTimeType == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editTimeType = dynamic_cast<cfbam::ICFBamTimeTypeEditObj*>( origTimeType->beginEdit() );
						editTimeType->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editTimeType->setOptionalShortNameNull();
						}
						else {
							editTimeType->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editTimeType->setOptionalLabelNull();
						}
						else {
							editTimeType->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editTimeType->setOptionalShortDescriptionNull();
						}
						else {
							editTimeType->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editTimeType->setOptionalDescriptionNull();
						}
						else {
							editTimeType->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editTimeType->setOptionalDefaultXmlValueNull();
						}
						else {
							editTimeType->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editTimeType->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editTimeType->setOptionalGenerateIdNull();
						}
						else {
							editTimeType->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editTimeType->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editTimeType->setOptionalDbNameNull();
						}
						else {
							editTimeType->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalDummyNull() ) {
							editTimeType->setOptionalDummyNull();
						}
						else {
							editTimeType->setOptionalDummyValue( editBuff->getOptionalDummyValue() );
						}
			...
			if( editTimeType != NULL ) {
				if( origTimeType != NULL ) {
					...
					origTimeType = dynamic_cast<cfbam::ICFBamTimeTypeObj*>( editTimeType->create() );
				}
				editTimeType = NULL;
			}
			...
			curContext->setObj( origTimeType );
...
cleanup:
	...
	void CFBamSaxLoaderTimeTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
