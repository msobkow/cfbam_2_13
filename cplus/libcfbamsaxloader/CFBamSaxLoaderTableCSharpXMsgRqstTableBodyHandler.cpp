...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpXMsgRqstTableBody
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpXMsgRqstTableBodyHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpXMsgRqstTableBodyHandler::CFBamSaxLoaderTableCSharpXMsgRqstTableBodyHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpXMsgRqstTableBodyHandler::~CFBamSaxLoaderTableCSharpXMsgRqstTableBodyHandler() {
	}

	void CFBamSaxLoaderTableCSharpXMsgRqstTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpXMsgRqstTableBody" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpXMsgRqstTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpXMsgRqstTableBody more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsXMsgRqstTableBodyNull() || origBuff->getOptionalCsXMsgRqstTableBodyValue().empty() ) {
			editBuff->setOptionalCsXMsgRqstTableBodyValue( attrText );
		}
		else {
