...
// Description: C++18 XML SAX2 Element Handler implementation for ServerListFunc
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderServerListFuncHandler::CLASS_NAME( "CFBamSaxLoaderServerListFuncHandler" );
	const std::string CFBamSaxLoaderServerListFuncHandler::S_True( "true" );
	const std::string CFBamSaxLoaderServerListFuncHandler::S_False( "false" );
	const std::string CFBamSaxLoaderServerListFuncHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderServerListFuncHandler::S_No( "no" );
	const std::string CFBamSaxLoaderServerListFuncHandler::S_0( "0" );
	const std::string CFBamSaxLoaderServerListFuncHandler::S_1( "1" );

	CFBamSaxLoaderServerListFuncHandler::CFBamSaxLoaderServerListFuncHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderServerListFuncHandler::~CFBamSaxLoaderServerListFuncHandler() {
	}

	void CFBamSaxLoaderServerListFuncHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamServerListFuncEditObj* editServerListFunc = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamServerListFuncBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamServerListFuncBuff::GENDEFNAME + "'" );
			...
			loaderBehaviour = saxLoader->getServerListFuncLoaderBehaviour();
			origServerListFunc = dynamic_cast<cfbam::ICFBamServerListFuncObj*>( schemaObj->getServerListFuncTableObj()->readServerListFuncByUNameIdx( refForTable->getRequiredTenantId(),
			...
			if( origServerListFunc == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editServerListFunc = dynamic_cast<cfbam::ICFBamServerListFuncEditObj*>( origServerListFunc->beginEdit() );
						editServerListFunc->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editServerListFunc->setOptionalShortNameNull();
						}
						else {
							editServerListFunc->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editServerListFunc->setOptionalLabelNull();
						}
						else {
							editServerListFunc->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editServerListFunc->setOptionalShortDescriptionNull();
						}
						else {
							editServerListFunc->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editServerListFunc->setOptionalDescriptionNull();
						}
						else {
							editServerListFunc->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalSuffixNull() ) {
							editServerListFunc->setOptionalSuffixNull();
						}
						else {
							editServerListFunc->setOptionalSuffixValue( editBuff->getOptionalSuffixValue() );
						}
			...
			if( editServerListFunc != NULL ) {
				if( origServerListFunc != NULL ) {
					...
					origServerListFunc = dynamic_cast<cfbam::ICFBamServerListFuncObj*>( editServerListFunc->create() );
				}
				editServerListFunc = NULL;
			}
...
cleanup:
	...
	void CFBamSaxLoaderServerListFuncHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
