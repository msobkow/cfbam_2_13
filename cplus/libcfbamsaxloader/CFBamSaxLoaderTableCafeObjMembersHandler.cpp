...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeObjMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeObjMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeObjMembersHandler::CFBamSaxLoaderTableCafeObjMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeObjMembersHandler::~CFBamSaxLoaderTableCafeObjMembersHandler() {
	}

	void CFBamSaxLoaderTableCafeObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeObjMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeObjMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJObjMembersNull() || origBuff->getOptionalJObjMembersValue().empty() ) {
			editBuff->setOptionalJObjMembersValue( attrText );
		}
		else {
