...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusMySqlTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusMySqlTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusMySqlTableImplementationHandler::CFBamSaxLoaderTableCPlusMySqlTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusMySqlTableImplementationHandler::~CFBamSaxLoaderTableCPlusMySqlTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableCPlusMySqlTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusMySqlTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusMySqlTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusMySqlTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppMySqlTableImplementationNull() || origBuff->getOptionalCppMySqlTableImplementationValue().empty() ) {
			editBuff->setOptionalCppMySqlTableImplementationValue( attrText );
		}
		else {
