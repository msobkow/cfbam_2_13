...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderURLProtocolHandler::CLASS_NAME( "CFBamSaxLoaderURLProtocolHandler" );
	const std::string CFBamSaxLoaderURLProtocolHandler::S_True( "true" );
	const std::string CFBamSaxLoaderURLProtocolHandler::S_False( "false" );
	const std::string CFBamSaxLoaderURLProtocolHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderURLProtocolHandler::S_No( "no" );
	const std::string CFBamSaxLoaderURLProtocolHandler::S_0( "0" );
	const std::string CFBamSaxLoaderURLProtocolHandler::S_1( "1" );

	CFBamSaxLoaderURLProtocolHandler::CFBamSaxLoaderURLProtocolHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderURLProtocolHandler::~CFBamSaxLoaderURLProtocolHandler() {
	}

	void CFBamSaxLoaderURLProtocolHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderURLProtocolHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
