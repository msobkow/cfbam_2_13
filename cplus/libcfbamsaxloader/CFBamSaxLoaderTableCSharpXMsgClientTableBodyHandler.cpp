...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpXMsgClientTableBody
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpXMsgClientTableBodyHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpXMsgClientTableBodyHandler::CFBamSaxLoaderTableCSharpXMsgClientTableBodyHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpXMsgClientTableBodyHandler::~CFBamSaxLoaderTableCSharpXMsgClientTableBodyHandler() {
	}

	void CFBamSaxLoaderTableCSharpXMsgClientTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpXMsgClientTableBody" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpXMsgClientTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpXMsgClientTableBody more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsXMsgClientTableBodyNull() || origBuff->getOptionalCsXMsgClientTableBodyValue().empty() ) {
			editBuff->setOptionalCsXMsgClientTableBodyValue( attrText );
		}
		else {
