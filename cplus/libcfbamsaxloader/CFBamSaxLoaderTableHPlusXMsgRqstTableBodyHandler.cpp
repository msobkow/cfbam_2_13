...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusXMsgRqstTableBody
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusXMsgRqstTableBodyHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusXMsgRqstTableBodyHandler::CFBamSaxLoaderTableHPlusXMsgRqstTableBodyHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusXMsgRqstTableBodyHandler::~CFBamSaxLoaderTableHPlusXMsgRqstTableBodyHandler() {
	}

	void CFBamSaxLoaderTableHPlusXMsgRqstTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusXMsgRqstTableBody" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusXMsgRqstTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusXMsgRqstTableBody more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppXMsgRqstTableBodyNull() || origBuff->getOptionalHppXMsgRqstTableBodyValue().empty() ) {
			editBuff->setOptionalHppXMsgRqstTableBodyValue( attrText );
		}
		else {
