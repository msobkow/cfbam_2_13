...
// Description: C++18 XML SAX2 Element Handler implementation for DoubleType
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderDoubleTypeHandler::CLASS_NAME( "CFBamSaxLoaderDoubleTypeHandler" );
	const std::string CFBamSaxLoaderDoubleTypeHandler::S_True( "true" );
	const std::string CFBamSaxLoaderDoubleTypeHandler::S_False( "false" );
	const std::string CFBamSaxLoaderDoubleTypeHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderDoubleTypeHandler::S_No( "no" );
	const std::string CFBamSaxLoaderDoubleTypeHandler::S_0( "0" );
	const std::string CFBamSaxLoaderDoubleTypeHandler::S_1( "1" );

	CFBamSaxLoaderDoubleTypeHandler::CFBamSaxLoaderDoubleTypeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderDoubleTypeHandler::~CFBamSaxLoaderDoubleTypeHandler() {
	}

	void CFBamSaxLoaderDoubleTypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamDoubleTypeObj* tmpBuff = NULL;
		cfbam::ICFBamDoubleTypeEditObj* editBuff = NULL;
		cfbam::ICFBamDoubleTypeEditObj* editDoubleType = NULL;
		cfbam::ICFBamDoubleTypeObj* origDoubleType = NULL;
		...
		cflib::CFLibNullableDouble natInitValue;
		cflib::CFLibNullableDouble natMinValue;
		cflib::CFLibNullableDouble natMaxValue;
		try {
			if( ( uri == NULL ) || ( *uri == 0 ) ) {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamDoubleTypeBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamDoubleTypeBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getDoubleTypeTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamDoubleTypeEditObj*>( tmpBuff->beginEdit() );
			...
			if( ( attrInitValue == NULL ) || ( attrInitValue->length() == 0 ) ) {
				...
				double* value = cflib::CFLibXmlUtil::parseDouble( *attrInitValue );
				if( value != NULL ) {
			...
			if( ( attrMinValue == NULL ) || ( attrMinValue->length() == 0 ) ) {
				...
				double* value = cflib::CFLibXmlUtil::parseDouble( *attrMinValue );
				if( value != NULL ) {
			...
			if( ( attrMaxValue == NULL ) || ( attrMaxValue->length() == 0 ) ) {
				...
				double* value = cflib::CFLibXmlUtil::parseDouble( *attrMaxValue );
				if( value != NULL ) {
			...
			loaderBehaviour = saxLoader->getDoubleTypeLoaderBehaviour();
			origDoubleType = dynamic_cast<cfbam::ICFBamDoubleTypeObj*>( schemaObj->getDoubleTypeTableObj()->readDoubleTypeByUNameIdx( refTenant->getRequiredId(),
			...
			if( origDoubleType == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editDoubleType = dynamic_cast<cfbam::ICFBamDoubleTypeEditObj*>( origDoubleType->beginEdit() );
						editDoubleType->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editDoubleType->setOptionalShortNameNull();
						}
						else {
							editDoubleType->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editDoubleType->setOptionalLabelNull();
						}
						else {
							editDoubleType->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editDoubleType->setOptionalShortDescriptionNull();
						}
						else {
							editDoubleType->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editDoubleType->setOptionalDescriptionNull();
						}
						else {
							editDoubleType->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editDoubleType->setOptionalDefaultXmlValueNull();
						}
						else {
							editDoubleType->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editDoubleType->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editDoubleType->setOptionalGenerateIdNull();
						}
						else {
							editDoubleType->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editDoubleType->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editDoubleType->setOptionalDbNameNull();
						}
						else {
							editDoubleType->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editDoubleType->setOptionalInitValueNull();
						}
						else {
							editDoubleType->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editDoubleType->setOptionalMinValueNull();
						}
						else {
							editDoubleType->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editDoubleType->setOptionalMaxValueNull();
						}
						else {
							editDoubleType->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editDoubleType != NULL ) {
				if( origDoubleType != NULL ) {
					...
					origDoubleType = dynamic_cast<cfbam::ICFBamDoubleTypeObj*>( editDoubleType->create() );
				}
				editDoubleType = NULL;
			}
			...
			curContext->setObj( origDoubleType );
...
cleanup:
	...
	void CFBamSaxLoaderDoubleTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
