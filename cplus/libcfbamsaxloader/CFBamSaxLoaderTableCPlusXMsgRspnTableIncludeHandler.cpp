...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusXMsgRspnTableInclude
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusXMsgRspnTableIncludeHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusXMsgRspnTableIncludeHandler::CFBamSaxLoaderTableCPlusXMsgRspnTableIncludeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusXMsgRspnTableIncludeHandler::~CFBamSaxLoaderTableCPlusXMsgRspnTableIncludeHandler() {
	}

	void CFBamSaxLoaderTableCPlusXMsgRspnTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusXMsgRspnTableInclude" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusXMsgRspnTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusXMsgRspnTableInclude more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppXMsgRspnTableIncludeNull() || origBuff->getOptionalCppXMsgRspnTableIncludeValue().empty() ) {
			editBuff->setOptionalCppXMsgRspnTableIncludeValue( attrText );
		}
		else {
