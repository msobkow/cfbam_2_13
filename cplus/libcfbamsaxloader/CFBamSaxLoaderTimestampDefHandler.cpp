...
// Description: C++18 XML SAX2 Element Handler implementation for TimestampDef
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTimestampDefHandler::CLASS_NAME( "CFBamSaxLoaderTimestampDefHandler" );
	const std::string CFBamSaxLoaderTimestampDefHandler::S_True( "true" );
	const std::string CFBamSaxLoaderTimestampDefHandler::S_False( "false" );
	const std::string CFBamSaxLoaderTimestampDefHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderTimestampDefHandler::S_No( "no" );
	const std::string CFBamSaxLoaderTimestampDefHandler::S_0( "0" );
	const std::string CFBamSaxLoaderTimestampDefHandler::S_1( "1" );

	CFBamSaxLoaderTimestampDefHandler::CFBamSaxLoaderTimestampDefHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTimestampDefHandler::~CFBamSaxLoaderTimestampDefHandler() {
	}

	void CFBamSaxLoaderTimestampDefHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamTimestampDefObj* tmpBuff = NULL;
		cfbam::ICFBamTimestampDefEditObj* editBuff = NULL;
		cfbam::ICFBamTimestampDefEditObj* editTimestampDef = NULL;
		cfbam::ICFBamTimestampDefObj* origTimestampDef = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamTimestampDefBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamTimestampDefBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getTimestampDefTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamTimestampDefEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getTimestampDefLoaderBehaviour();
			origTimestampDef = dynamic_cast<cfbam::ICFBamTimestampDefObj*>( schemaObj->getTimestampDefTableObj()->readTimestampDefByUNameIdx( refTenant->getRequiredId(),
			...
			if( origTimestampDef == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editTimestampDef = dynamic_cast<cfbam::ICFBamTimestampDefEditObj*>( origTimestampDef->beginEdit() );
						editTimestampDef->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editTimestampDef->setOptionalShortNameNull();
						}
						else {
							editTimestampDef->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editTimestampDef->setOptionalLabelNull();
						}
						else {
							editTimestampDef->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editTimestampDef->setOptionalShortDescriptionNull();
						}
						else {
							editTimestampDef->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editTimestampDef->setOptionalDescriptionNull();
						}
						else {
							editTimestampDef->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editTimestampDef->setOptionalDefaultXmlValueNull();
						}
						else {
							editTimestampDef->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editTimestampDef->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editTimestampDef->setOptionalGenerateIdNull();
						}
						else {
							editTimestampDef->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editTimestampDef->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editTimestampDef->setOptionalDbNameNull();
						}
						else {
							editTimestampDef->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalDummyNull() ) {
							editTimestampDef->setOptionalDummyNull();
						}
						else {
							editTimestampDef->setOptionalDummyValue( editBuff->getOptionalDummyValue() );
						}
			...
			if( editTimestampDef != NULL ) {
				if( origTimestampDef != NULL ) {
					...
					origTimestampDef = dynamic_cast<cfbam::ICFBamTimestampDefObj*>( editTimestampDef->create() );
				}
				editTimestampDef = NULL;
			}
			...
			curContext->setObj( origTimestampDef );
...
cleanup:
	...
	void CFBamSaxLoaderTimestampDefHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
