...
// Description: C++18 XML SAX2 Element Handler implementation for DelTopDep
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderDelTopDepHandler::CLASS_NAME( "CFBamSaxLoaderDelTopDepHandler" );
	const std::string CFBamSaxLoaderDelTopDepHandler::S_True( "true" );
	const std::string CFBamSaxLoaderDelTopDepHandler::S_False( "false" );
	const std::string CFBamSaxLoaderDelTopDepHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderDelTopDepHandler::S_No( "no" );
	const std::string CFBamSaxLoaderDelTopDepHandler::S_0( "0" );
	const std::string CFBamSaxLoaderDelTopDepHandler::S_1( "1" );

	CFBamSaxLoaderDelTopDepHandler::CFBamSaxLoaderDelTopDepHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderDelTopDepHandler::~CFBamSaxLoaderDelTopDepHandler() {
	}

	void CFBamSaxLoaderDelTopDepHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamDelTopDepObj* tmpBuff = NULL;
		cfbam::ICFBamDelTopDepEditObj* editBuff = NULL;
		cfbam::ICFBamDelTopDepEditObj* editDelTopDep = NULL;
		cfbam::ICFBamDelTopDepObj* origDelTopDep = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamDelTopDepBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamDelTopDepBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getDelTopDepTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamDelTopDepEditObj*>( tmpBuff->beginEdit() );
			...
			editDelTopDep = editBuff;
			editBuff = NULL;
			origDelTopDep = dynamic_cast<cfbam::ICFBamDelTopDepObj*>( editDelTopDep->create() );
			editDelTopDep = NULL;
			tmpBuff = NULL;

			curContext->setObj( origDelTopDep );
...
cleanup:
	...
	void CFBamSaxLoaderDelTopDepHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
