...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderSecAppHandler::CLASS_NAME( "CFBamSaxLoaderSecAppHandler" );
	const std::string CFBamSaxLoaderSecAppHandler::S_True( "true" );
	const std::string CFBamSaxLoaderSecAppHandler::S_False( "false" );
	const std::string CFBamSaxLoaderSecAppHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderSecAppHandler::S_No( "no" );
	const std::string CFBamSaxLoaderSecAppHandler::S_0( "0" );
	const std::string CFBamSaxLoaderSecAppHandler::S_1( "1" );

	CFBamSaxLoaderSecAppHandler::CFBamSaxLoaderSecAppHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderSecAppHandler::~CFBamSaxLoaderSecAppHandler() {
	}

	void CFBamSaxLoaderSecAppHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderSecAppHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
