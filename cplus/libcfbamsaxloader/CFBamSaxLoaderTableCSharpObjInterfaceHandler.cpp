...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpObjInterface
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpObjInterfaceHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpObjInterfaceHandler::CFBamSaxLoaderTableCSharpObjInterfaceHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpObjInterfaceHandler::~CFBamSaxLoaderTableCSharpObjInterfaceHandler() {
	}

	void CFBamSaxLoaderTableCSharpObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpObjInterface" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpObjInterface more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsObjInterfaceNull() || origBuff->getOptionalCsObjInterfaceValue().empty() ) {
			editBuff->setOptionalCsObjInterfaceValue( attrText );
		}
		else {
