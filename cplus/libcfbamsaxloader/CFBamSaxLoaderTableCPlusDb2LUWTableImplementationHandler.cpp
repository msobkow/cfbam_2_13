...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusDb2LUWTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusDb2LUWTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusDb2LUWTableImplementationHandler::CFBamSaxLoaderTableCPlusDb2LUWTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusDb2LUWTableImplementationHandler::~CFBamSaxLoaderTableCPlusDb2LUWTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableCPlusDb2LUWTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusDb2LUWTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusDb2LUWTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusDb2LUWTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppDb2LUWTableImplementationNull() || origBuff->getOptionalCppDb2LUWTableImplementationValue().empty() ) {
			editBuff->setOptionalCppDb2LUWTableImplementationValue( attrText );
		}
		else {
