...
// Description: C++18 XML SAX2 Element Handler implementation for PopSubDep3
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderPopSubDep3Handler::CLASS_NAME( "CFBamSaxLoaderPopSubDep3Handler" );
	const std::string CFBamSaxLoaderPopSubDep3Handler::S_True( "true" );
	const std::string CFBamSaxLoaderPopSubDep3Handler::S_False( "false" );
	const std::string CFBamSaxLoaderPopSubDep3Handler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderPopSubDep3Handler::S_No( "no" );
	const std::string CFBamSaxLoaderPopSubDep3Handler::S_0( "0" );
	const std::string CFBamSaxLoaderPopSubDep3Handler::S_1( "1" );

	CFBamSaxLoaderPopSubDep3Handler::CFBamSaxLoaderPopSubDep3Handler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderPopSubDep3Handler::~CFBamSaxLoaderPopSubDep3Handler() {
	}

	void CFBamSaxLoaderPopSubDep3Handler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		static const std::string S_PopSubDep2( "PopSubDep2" );
		...
		cfbam::ICFBamPopSubDep3Obj* tmpBuff = NULL;
		cfbam::ICFBamPopSubDep3EditObj* editBuff = NULL;
		cfbam::ICFBamPopSubDep3EditObj* editPopSubDep3 = NULL;
		cfbam::ICFBamPopSubDep3Obj* origPopSubDep3 = NULL;
		...
		cfbam::ICFBamPopSubDep2Obj* refPopSubDep2 = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamPopSubDep3Buff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamPopSubDep3Buff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getPopSubDep3TableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamPopSubDep3EditObj*>( tmpBuff->beginEdit() );
			...
			else if( scopeObj->implementsClassCode( cfbam::CFBamPopSubDep2Buff::CLASS_CODE ) ) {
				refPopSubDep2 = dynamic_cast<cfbam::ICFBamPopSubDep2Obj*>( scopeObj );
			...
			editPopSubDep3 = editBuff;
			editBuff = NULL;
			origPopSubDep3 = dynamic_cast<cfbam::ICFBamPopSubDep3Obj*>( editPopSubDep3->create() );
			editPopSubDep3 = NULL;
			tmpBuff = NULL;

			curContext->setObj( origPopSubDep3 );
...
cleanup:
	...
	void CFBamSaxLoaderPopSubDep3Handler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
