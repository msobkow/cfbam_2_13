...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpOracleTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpOracleTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpOracleTableMembersHandler::CFBamSaxLoaderTableCSharpOracleTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpOracleTableMembersHandler::~CFBamSaxLoaderTableCSharpOracleTableMembersHandler() {
	}

	void CFBamSaxLoaderTableCSharpOracleTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpOracleTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpOracleTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpOracleTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsOracleTableMembersNull() || origBuff->getOptionalCsOracleTableMembersValue().empty() ) {
			editBuff->setOptionalCsOracleTableMembersValue( attrText );
		}
		else {
