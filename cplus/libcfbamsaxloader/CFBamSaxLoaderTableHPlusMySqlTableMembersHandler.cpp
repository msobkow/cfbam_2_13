...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusMySqlTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusMySqlTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusMySqlTableMembersHandler::CFBamSaxLoaderTableHPlusMySqlTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusMySqlTableMembersHandler::~CFBamSaxLoaderTableHPlusMySqlTableMembersHandler() {
	}

	void CFBamSaxLoaderTableHPlusMySqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusMySqlTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusMySqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusMySqlTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppMySqlTableMembersNull() || origBuff->getOptionalHppMySqlTableMembersValue().empty() ) {
			editBuff->setOptionalHppMySqlTableMembersValue( attrText );
		}
		else {
