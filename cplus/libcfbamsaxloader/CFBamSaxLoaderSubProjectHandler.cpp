...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderSubProjectHandler::CLASS_NAME( "CFBamSaxLoaderSubProjectHandler" );
	const std::string CFBamSaxLoaderSubProjectHandler::S_True( "true" );
	const std::string CFBamSaxLoaderSubProjectHandler::S_False( "false" );
	const std::string CFBamSaxLoaderSubProjectHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderSubProjectHandler::S_No( "no" );
	const std::string CFBamSaxLoaderSubProjectHandler::S_0( "0" );
	const std::string CFBamSaxLoaderSubProjectHandler::S_1( "1" );

	CFBamSaxLoaderSubProjectHandler::CFBamSaxLoaderSubProjectHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderSubProjectHandler::~CFBamSaxLoaderSubProjectHandler() {
	}

	void CFBamSaxLoaderSubProjectHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderSubProjectHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
