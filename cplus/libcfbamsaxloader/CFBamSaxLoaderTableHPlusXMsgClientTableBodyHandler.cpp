...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusXMsgClientTableBody
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusXMsgClientTableBodyHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusXMsgClientTableBodyHandler::CFBamSaxLoaderTableHPlusXMsgClientTableBodyHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusXMsgClientTableBodyHandler::~CFBamSaxLoaderTableHPlusXMsgClientTableBodyHandler() {
	}

	void CFBamSaxLoaderTableHPlusXMsgClientTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusXMsgClientTableBody" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusXMsgClientTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusXMsgClientTableBody more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppXMsgClientTableBodyNull() || origBuff->getOptionalHppXMsgClientTableBodyValue().empty() ) {
			editBuff->setOptionalHppXMsgClientTableBodyValue( attrText );
		}
		else {
