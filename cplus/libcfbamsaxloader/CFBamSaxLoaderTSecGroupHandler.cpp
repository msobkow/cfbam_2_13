...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTSecGroupHandler::CLASS_NAME( "CFBamSaxLoaderTSecGroupHandler" );
	const std::string CFBamSaxLoaderTSecGroupHandler::S_True( "true" );
	const std::string CFBamSaxLoaderTSecGroupHandler::S_False( "false" );
	const std::string CFBamSaxLoaderTSecGroupHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderTSecGroupHandler::S_No( "no" );
	const std::string CFBamSaxLoaderTSecGroupHandler::S_0( "0" );
	const std::string CFBamSaxLoaderTSecGroupHandler::S_1( "1" );

	CFBamSaxLoaderTSecGroupHandler::CFBamSaxLoaderTSecGroupHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTSecGroupHandler::~CFBamSaxLoaderTSecGroupHandler() {
	}

	void CFBamSaxLoaderTSecGroupHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderTSecGroupHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
