...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpTableObjMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpTableObjMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpTableObjMembersHandler::CFBamSaxLoaderTableCSharpTableObjMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpTableObjMembersHandler::~CFBamSaxLoaderTableCSharpTableObjMembersHandler() {
	}

	void CFBamSaxLoaderTableCSharpTableObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpTableObjMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpTableObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpTableObjMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsTableObjMembersNull() || origBuff->getOptionalCsTableObjMembersValue().empty() ) {
			editBuff->setOptionalCsTableObjMembersValue( attrText );
		}
		else {
