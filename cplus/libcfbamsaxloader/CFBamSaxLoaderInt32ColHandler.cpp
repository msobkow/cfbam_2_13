...
// Description: C++18 XML SAX2 Element Handler implementation for Int32Col
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderInt32ColHandler::CLASS_NAME( "CFBamSaxLoaderInt32ColHandler" );
	const std::string CFBamSaxLoaderInt32ColHandler::S_True( "true" );
	const std::string CFBamSaxLoaderInt32ColHandler::S_False( "false" );
	const std::string CFBamSaxLoaderInt32ColHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderInt32ColHandler::S_No( "no" );
	const std::string CFBamSaxLoaderInt32ColHandler::S_0( "0" );
	const std::string CFBamSaxLoaderInt32ColHandler::S_1( "1" );

	CFBamSaxLoaderInt32ColHandler::CFBamSaxLoaderInt32ColHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderInt32ColHandler::~CFBamSaxLoaderInt32ColHandler() {
	}

	void CFBamSaxLoaderInt32ColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamInt32ColObj* tmpBuff = NULL;
		cfbam::ICFBamInt32ColEditObj* editBuff = NULL;
		cfbam::ICFBamInt32ColEditObj* editInt32Col = NULL;
		cfbam::ICFBamInt32ColObj* origInt32Col = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamInt32ColBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamInt32ColBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getInt32ColTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamInt32ColEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getInt32ColLoaderBehaviour();
			origInt32Col = dynamic_cast<cfbam::ICFBamInt32ColObj*>( schemaObj->getInt32ColTableObj()->readInt32ColByUNameIdx( refTenant->getRequiredId(),
			...
			if( origInt32Col == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editInt32Col = dynamic_cast<cfbam::ICFBamInt32ColEditObj*>( origInt32Col->beginEdit() );
						editInt32Col->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editInt32Col->setOptionalShortNameNull();
						}
						else {
							editInt32Col->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editInt32Col->setOptionalLabelNull();
						}
						else {
							editInt32Col->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editInt32Col->setOptionalShortDescriptionNull();
						}
						else {
							editInt32Col->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editInt32Col->setOptionalDescriptionNull();
						}
						else {
							editInt32Col->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editInt32Col->setOptionalDefaultXmlValueNull();
						}
						else {
							editInt32Col->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editInt32Col->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editInt32Col->setOptionalGenerateIdNull();
						}
						else {
							editInt32Col->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editInt32Col->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editInt32Col->setOptionalDbNameNull();
						}
						else {
							editInt32Col->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editInt32Col->setOptionalInitValueNull();
						}
						else {
							editInt32Col->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editInt32Col->setOptionalMinValueNull();
						}
						else {
							editInt32Col->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editInt32Col->setOptionalMaxValueNull();
						}
						else {
							editInt32Col->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editInt32Col != NULL ) {
				if( origInt32Col != NULL ) {
					...
					origInt32Col = dynamic_cast<cfbam::ICFBamInt32ColObj*>( editInt32Col->create() );
				}
				editInt32Col = NULL;
			}
			...
			curContext->setObj( origInt32Col );
...
cleanup:
	...
	void CFBamSaxLoaderInt32ColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
