...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderSecGrpMembHandler::CLASS_NAME( "CFBamSaxLoaderSecGrpMembHandler" );
	const std::string CFBamSaxLoaderSecGrpMembHandler::S_True( "true" );
	const std::string CFBamSaxLoaderSecGrpMembHandler::S_False( "false" );
	const std::string CFBamSaxLoaderSecGrpMembHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderSecGrpMembHandler::S_No( "no" );
	const std::string CFBamSaxLoaderSecGrpMembHandler::S_0( "0" );
	const std::string CFBamSaxLoaderSecGrpMembHandler::S_1( "1" );

	CFBamSaxLoaderSecGrpMembHandler::CFBamSaxLoaderSecGrpMembHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderSecGrpMembHandler::~CFBamSaxLoaderSecGrpMembHandler() {
	}

	void CFBamSaxLoaderSecGrpMembHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderSecGrpMembHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
