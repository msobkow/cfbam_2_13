...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusXMsgRspnTableBody
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusXMsgRspnTableBodyHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusXMsgRspnTableBodyHandler::CFBamSaxLoaderTableHPlusXMsgRspnTableBodyHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusXMsgRspnTableBodyHandler::~CFBamSaxLoaderTableHPlusXMsgRspnTableBodyHandler() {
	}

	void CFBamSaxLoaderTableHPlusXMsgRspnTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusXMsgRspnTableBody" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusXMsgRspnTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusXMsgRspnTableBody more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppXMsgRspnTableBodyNull() || origBuff->getOptionalHppXMsgRspnTableBodyValue().empty() ) {
			editBuff->setOptionalHppXMsgRspnTableBodyValue( attrText );
		}
		else {
