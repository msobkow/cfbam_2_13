...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusTableObjInclude
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusTableObjIncludeHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusTableObjIncludeHandler::CFBamSaxLoaderTableCPlusTableObjIncludeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusTableObjIncludeHandler::~CFBamSaxLoaderTableCPlusTableObjIncludeHandler() {
	}

	void CFBamSaxLoaderTableCPlusTableObjIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusTableObjInclude" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusTableObjIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusTableObjInclude more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppTableObjIncludeNull() || origBuff->getOptionalCppTableObjIncludeValue().empty() ) {
			editBuff->setOptionalCppTableObjIncludeValue( attrText );
		}
		else {
