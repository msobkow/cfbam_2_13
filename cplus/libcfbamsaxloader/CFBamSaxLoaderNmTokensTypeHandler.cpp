...
// Description: C++18 XML SAX2 Element Handler implementation for NmTokensType
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderNmTokensTypeHandler::CLASS_NAME( "CFBamSaxLoaderNmTokensTypeHandler" );
	const std::string CFBamSaxLoaderNmTokensTypeHandler::S_True( "true" );
	const std::string CFBamSaxLoaderNmTokensTypeHandler::S_False( "false" );
	const std::string CFBamSaxLoaderNmTokensTypeHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderNmTokensTypeHandler::S_No( "no" );
	const std::string CFBamSaxLoaderNmTokensTypeHandler::S_0( "0" );
	const std::string CFBamSaxLoaderNmTokensTypeHandler::S_1( "1" );

	CFBamSaxLoaderNmTokensTypeHandler::CFBamSaxLoaderNmTokensTypeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderNmTokensTypeHandler::~CFBamSaxLoaderNmTokensTypeHandler() {
	}

	void CFBamSaxLoaderNmTokensTypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamNmTokensTypeObj* tmpBuff = NULL;
		cfbam::ICFBamNmTokensTypeEditObj* editBuff = NULL;
		cfbam::ICFBamNmTokensTypeEditObj* editNmTokensType = NULL;
		cfbam::ICFBamNmTokensTypeObj* origNmTokensType = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamNmTokensTypeBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamNmTokensTypeBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getNmTokensTypeTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamNmTokensTypeEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getNmTokensTypeLoaderBehaviour();
			origNmTokensType = dynamic_cast<cfbam::ICFBamNmTokensTypeObj*>( schemaObj->getNmTokensTypeTableObj()->readNmTokensTypeByUNameIdx( refTenant->getRequiredId(),
			...
			if( origNmTokensType == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editNmTokensType = dynamic_cast<cfbam::ICFBamNmTokensTypeEditObj*>( origNmTokensType->beginEdit() );
						editNmTokensType->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editNmTokensType->setOptionalShortNameNull();
						}
						else {
							editNmTokensType->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editNmTokensType->setOptionalLabelNull();
						}
						else {
							editNmTokensType->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editNmTokensType->setOptionalShortDescriptionNull();
						}
						else {
							editNmTokensType->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editNmTokensType->setOptionalDescriptionNull();
						}
						else {
							editNmTokensType->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editNmTokensType->setOptionalDefaultXmlValueNull();
						}
						else {
							editNmTokensType->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editNmTokensType->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editNmTokensType->setOptionalGenerateIdNull();
						}
						else {
							editNmTokensType->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editNmTokensType->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editNmTokensType->setOptionalDbNameNull();
						}
						else {
							editNmTokensType->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						editNmTokensType->setRequiredMaxLen( editBuff->getRequiredMaxLen() );
						if( editBuff->isOptionalInitValueNull() ) {
							editNmTokensType->setOptionalInitValueNull();
						}
						else {
							editNmTokensType->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
			...
			if( editNmTokensType != NULL ) {
				if( origNmTokensType != NULL ) {
					...
					origNmTokensType = dynamic_cast<cfbam::ICFBamNmTokensTypeObj*>( editNmTokensType->create() );
				}
				editNmTokensType = NULL;
			}
			...
			curContext->setObj( origNmTokensType );
...
cleanup:
	...
	void CFBamSaxLoaderNmTokensTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
