...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpSaxLoaderStartElement
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpSaxLoaderStartElementHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpSaxLoaderStartElementHandler::CFBamSaxLoaderTableCSharpSaxLoaderStartElementHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpSaxLoaderStartElementHandler::~CFBamSaxLoaderTableCSharpSaxLoaderStartElementHandler() {
	}

	void CFBamSaxLoaderTableCSharpSaxLoaderStartElementHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpSaxLoaderStartElement" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpSaxLoaderStartElementHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpSaxLoaderStartElement more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsSaxLoaderStartElementNull() || origBuff->getOptionalCsSaxLoaderStartElementValue().empty() ) {
			editBuff->setOptionalCsSaxLoaderStartElementValue( attrText );
		}
		else {
