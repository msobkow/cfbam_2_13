...
// Description: C++18 XML SAX2 Element Handler implementation for PopSubDep1
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderPopSubDep1Handler::CLASS_NAME( "CFBamSaxLoaderPopSubDep1Handler" );
	const std::string CFBamSaxLoaderPopSubDep1Handler::S_True( "true" );
	const std::string CFBamSaxLoaderPopSubDep1Handler::S_False( "false" );
	const std::string CFBamSaxLoaderPopSubDep1Handler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderPopSubDep1Handler::S_No( "no" );
	const std::string CFBamSaxLoaderPopSubDep1Handler::S_0( "0" );
	const std::string CFBamSaxLoaderPopSubDep1Handler::S_1( "1" );

	CFBamSaxLoaderPopSubDep1Handler::CFBamSaxLoaderPopSubDep1Handler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderPopSubDep1Handler::~CFBamSaxLoaderPopSubDep1Handler() {
	}

	void CFBamSaxLoaderPopSubDep1Handler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		static const std::string S_ContPopTopDep( "ContPopTopDep" );
		...
		cfbam::ICFBamPopSubDep1Obj* tmpBuff = NULL;
		cfbam::ICFBamPopSubDep1EditObj* editBuff = NULL;
		cfbam::ICFBamPopSubDep1EditObj* editPopSubDep1 = NULL;
		cfbam::ICFBamPopSubDep1Obj* origPopSubDep1 = NULL;
		...
		cfbam::ICFBamPopTopDepObj* refContPopTopDep = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamPopSubDep1Buff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamPopSubDep1Buff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getPopSubDep1TableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamPopSubDep1EditObj*>( tmpBuff->beginEdit() );
			...
			else if( scopeObj->implementsClassCode( cfbam::CFBamPopTopDepBuff::CLASS_CODE ) ) {
				refContPopTopDep = dynamic_cast<cfbam::ICFBamPopTopDepObj*>( scopeObj );
			...
			editPopSubDep1 = editBuff;
			editBuff = NULL;
			origPopSubDep1 = dynamic_cast<cfbam::ICFBamPopSubDep1Obj*>( editPopSubDep1->create() );
			editPopSubDep1 = NULL;
			tmpBuff = NULL;

			curContext->setObj( origPopSubDep1 );
...
cleanup:
	...
	void CFBamSaxLoaderPopSubDep1Handler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
