...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpEditObjInterface
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpEditObjInterfaceHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpEditObjInterfaceHandler::CFBamSaxLoaderTableCSharpEditObjInterfaceHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpEditObjInterfaceHandler::~CFBamSaxLoaderTableCSharpEditObjInterfaceHandler() {
	}

	void CFBamSaxLoaderTableCSharpEditObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpEditObjInterface" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpEditObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpEditObjInterface more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsEditObjInterfaceNull() || origBuff->getOptionalCsEditObjInterfaceValue().empty() ) {
			editBuff->setOptionalCsEditObjInterfaceValue( attrText );
		}
		else {
