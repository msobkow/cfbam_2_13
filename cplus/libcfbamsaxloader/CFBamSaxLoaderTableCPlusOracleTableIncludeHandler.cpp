...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusOracleTableInclude
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusOracleTableIncludeHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusOracleTableIncludeHandler::CFBamSaxLoaderTableCPlusOracleTableIncludeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusOracleTableIncludeHandler::~CFBamSaxLoaderTableCPlusOracleTableIncludeHandler() {
	}

	void CFBamSaxLoaderTableCPlusOracleTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusOracleTableInclude" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusOracleTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusOracleTableInclude more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppOracleTableIncludeNull() || origBuff->getOptionalCppOracleTableIncludeValue().empty() ) {
			editBuff->setOptionalCppOracleTableIncludeValue( attrText );
		}
		else {
