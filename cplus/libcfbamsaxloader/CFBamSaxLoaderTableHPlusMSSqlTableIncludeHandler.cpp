...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusMSSqlTableInclude
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusMSSqlTableIncludeHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusMSSqlTableIncludeHandler::CFBamSaxLoaderTableHPlusMSSqlTableIncludeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusMSSqlTableIncludeHandler::~CFBamSaxLoaderTableHPlusMSSqlTableIncludeHandler() {
	}

	void CFBamSaxLoaderTableHPlusMSSqlTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusMSSqlTableInclude" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusMSSqlTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusMSSqlTableInclude more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppMSSqlTableIncludeNull() || origBuff->getOptionalHppMSSqlTableIncludeValue().empty() ) {
			editBuff->setOptionalHppMSSqlTableIncludeValue( attrText );
		}
		else {
