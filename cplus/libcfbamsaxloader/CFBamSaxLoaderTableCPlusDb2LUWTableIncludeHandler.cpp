...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusDb2LUWTableInclude
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusDb2LUWTableIncludeHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusDb2LUWTableIncludeHandler::CFBamSaxLoaderTableCPlusDb2LUWTableIncludeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusDb2LUWTableIncludeHandler::~CFBamSaxLoaderTableCPlusDb2LUWTableIncludeHandler() {
	}

	void CFBamSaxLoaderTableCPlusDb2LUWTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusDb2LUWTableInclude" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusDb2LUWTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusDb2LUWTableInclude more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppDb2LUWTableIncludeNull() || origBuff->getOptionalCppDb2LUWTableIncludeValue().empty() ) {
			editBuff->setOptionalCppDb2LUWTableIncludeValue( attrText );
		}
		else {
