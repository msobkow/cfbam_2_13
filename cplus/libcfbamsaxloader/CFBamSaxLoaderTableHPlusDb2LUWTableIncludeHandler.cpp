...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusDb2LUWTableInclude
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusDb2LUWTableIncludeHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusDb2LUWTableIncludeHandler::CFBamSaxLoaderTableHPlusDb2LUWTableIncludeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusDb2LUWTableIncludeHandler::~CFBamSaxLoaderTableHPlusDb2LUWTableIncludeHandler() {
	}

	void CFBamSaxLoaderTableHPlusDb2LUWTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusDb2LUWTableInclude" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusDb2LUWTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusDb2LUWTableInclude more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppDb2LUWTableIncludeNull() || origBuff->getOptionalHppDb2LUWTableIncludeValue().empty() ) {
			editBuff->setOptionalHppDb2LUWTableIncludeValue( attrText );
		}
		else {
