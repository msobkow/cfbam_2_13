...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpTableObjUsing
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpTableObjUsingHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpTableObjUsingHandler::CFBamSaxLoaderTableCSharpTableObjUsingHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpTableObjUsingHandler::~CFBamSaxLoaderTableCSharpTableObjUsingHandler() {
	}

	void CFBamSaxLoaderTableCSharpTableObjUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpTableObjUsing" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpTableObjUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpTableObjUsing more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsTableObjUsingNull() || origBuff->getOptionalCsTableObjUsingValue().empty() ) {
			editBuff->setOptionalCsTableObjUsingValue( attrText );
		}
		else {
