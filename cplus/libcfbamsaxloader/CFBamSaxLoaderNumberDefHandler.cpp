...
// Description: C++18 XML SAX2 Element Handler implementation for NumberDef
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderNumberDefHandler::CLASS_NAME( "CFBamSaxLoaderNumberDefHandler" );
	const std::string CFBamSaxLoaderNumberDefHandler::S_True( "true" );
	const std::string CFBamSaxLoaderNumberDefHandler::S_False( "false" );
	const std::string CFBamSaxLoaderNumberDefHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderNumberDefHandler::S_No( "no" );
	const std::string CFBamSaxLoaderNumberDefHandler::S_0( "0" );
	const std::string CFBamSaxLoaderNumberDefHandler::S_1( "1" );

	CFBamSaxLoaderNumberDefHandler::CFBamSaxLoaderNumberDefHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderNumberDefHandler::~CFBamSaxLoaderNumberDefHandler() {
	}

	void CFBamSaxLoaderNumberDefHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamNumberDefObj* tmpBuff = NULL;
		cfbam::ICFBamNumberDefEditObj* editBuff = NULL;
		cfbam::ICFBamNumberDefEditObj* editNumberDef = NULL;
		cfbam::ICFBamNumberDefObj* origNumberDef = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamNumberDefBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamNumberDefBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getNumberDefTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamNumberDefEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getNumberDefLoaderBehaviour();
			origNumberDef = dynamic_cast<cfbam::ICFBamNumberDefObj*>( schemaObj->getNumberDefTableObj()->readNumberDefByUNameIdx( refTenant->getRequiredId(),
			...
			if( origNumberDef == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editNumberDef = dynamic_cast<cfbam::ICFBamNumberDefEditObj*>( origNumberDef->beginEdit() );
						editNumberDef->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editNumberDef->setOptionalShortNameNull();
						}
						else {
							editNumberDef->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editNumberDef->setOptionalLabelNull();
						}
						else {
							editNumberDef->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editNumberDef->setOptionalShortDescriptionNull();
						}
						else {
							editNumberDef->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editNumberDef->setOptionalDescriptionNull();
						}
						else {
							editNumberDef->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editNumberDef->setOptionalDefaultXmlValueNull();
						}
						else {
							editNumberDef->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editNumberDef->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editNumberDef->setOptionalGenerateIdNull();
						}
						else {
							editNumberDef->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editNumberDef->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editNumberDef->setOptionalDbNameNull();
						}
						else {
							editNumberDef->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						...
						if( editBuff->isOptionalInitValueNull() ) {
							editNumberDef->setOptionalInitValueNull();
						}
						else {
							editNumberDef->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editNumberDef->setOptionalMinValueNull();
						}
						else {
							editNumberDef->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editNumberDef->setOptionalMaxValueNull();
						}
						else {
							editNumberDef->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editNumberDef != NULL ) {
				if( origNumberDef != NULL ) {
					...
					origNumberDef = dynamic_cast<cfbam::ICFBamNumberDefObj*>( editNumberDef->create() );
				}
				editNumberDef = NULL;
			}
			...
			curContext->setObj( origNumberDef );
...
cleanup:
	...
	void CFBamSaxLoaderNumberDefHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
