...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpOracleTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpOracleTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpOracleTableImplementationHandler::CFBamSaxLoaderTableCSharpOracleTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpOracleTableImplementationHandler::~CFBamSaxLoaderTableCSharpOracleTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableCSharpOracleTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpOracleTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpOracleTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpOracleTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsOracleTableImplementationNull() || origBuff->getOptionalCsOracleTableImplementationValue().empty() ) {
			editBuff->setOptionalCsOracleTableImplementationValue( attrText );
		}
		else {
