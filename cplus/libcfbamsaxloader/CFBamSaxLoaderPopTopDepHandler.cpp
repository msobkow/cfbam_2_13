...
// Description: C++18 XML SAX2 Element Handler implementation for PopTopDep
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderPopTopDepHandler::CLASS_NAME( "CFBamSaxLoaderPopTopDepHandler" );
	const std::string CFBamSaxLoaderPopTopDepHandler::S_True( "true" );
	const std::string CFBamSaxLoaderPopTopDepHandler::S_False( "false" );
	const std::string CFBamSaxLoaderPopTopDepHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderPopTopDepHandler::S_No( "no" );
	const std::string CFBamSaxLoaderPopTopDepHandler::S_0( "0" );
	const std::string CFBamSaxLoaderPopTopDepHandler::S_1( "1" );

	CFBamSaxLoaderPopTopDepHandler::CFBamSaxLoaderPopTopDepHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderPopTopDepHandler::~CFBamSaxLoaderPopTopDepHandler() {
	}

	void CFBamSaxLoaderPopTopDepHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		static const std::string S_ContRelation( "ContRelation" );
		...
		cfbam::ICFBamPopTopDepObj* tmpBuff = NULL;
		cfbam::ICFBamPopTopDepEditObj* editBuff = NULL;
		cfbam::ICFBamPopTopDepEditObj* editPopTopDep = NULL;
		cfbam::ICFBamPopTopDepObj* origPopTopDep = NULL;
		...
		cfbam::ICFBamRelationObj* refContRelation = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamPopTopDepBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamPopTopDepBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getPopTopDepTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamPopTopDepEditObj*>( tmpBuff->beginEdit() );
			...
			if( scopeObj == NULL ) {
				...
				refContRelation = dynamic_cast<cfbam::ICFBamRelationObj*>( scopeObj );
			...
			editPopTopDep = editBuff;
			editBuff = NULL;
			origPopTopDep = dynamic_cast<cfbam::ICFBamPopTopDepObj*>( editPopTopDep->create() );
			editPopTopDep = NULL;
			tmpBuff = NULL;

			curContext->setObj( origPopTopDep );
...
cleanup:
	...
	void CFBamSaxLoaderPopTopDepHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
