...
// Description: C++18 XML SAX2 Element Handler implementation for TZDateType
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTZDateTypeHandler::CLASS_NAME( "CFBamSaxLoaderTZDateTypeHandler" );
	const std::string CFBamSaxLoaderTZDateTypeHandler::S_True( "true" );
	const std::string CFBamSaxLoaderTZDateTypeHandler::S_False( "false" );
	const std::string CFBamSaxLoaderTZDateTypeHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderTZDateTypeHandler::S_No( "no" );
	const std::string CFBamSaxLoaderTZDateTypeHandler::S_0( "0" );
	const std::string CFBamSaxLoaderTZDateTypeHandler::S_1( "1" );

	CFBamSaxLoaderTZDateTypeHandler::CFBamSaxLoaderTZDateTypeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTZDateTypeHandler::~CFBamSaxLoaderTZDateTypeHandler() {
	}

	void CFBamSaxLoaderTZDateTypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamTZDateTypeObj* tmpBuff = NULL;
		cfbam::ICFBamTZDateTypeEditObj* editBuff = NULL;
		cfbam::ICFBamTZDateTypeEditObj* editTZDateType = NULL;
		cfbam::ICFBamTZDateTypeObj* origTZDateType = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamTZDateTypeBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamTZDateTypeBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getTZDateTypeTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamTZDateTypeEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getTZDateTypeLoaderBehaviour();
			origTZDateType = dynamic_cast<cfbam::ICFBamTZDateTypeObj*>( schemaObj->getTZDateTypeTableObj()->readTZDateTypeByUNameIdx( refTenant->getRequiredId(),
			...
			if( origTZDateType == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editTZDateType = dynamic_cast<cfbam::ICFBamTZDateTypeEditObj*>( origTZDateType->beginEdit() );
						editTZDateType->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editTZDateType->setOptionalShortNameNull();
						}
						else {
							editTZDateType->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editTZDateType->setOptionalLabelNull();
						}
						else {
							editTZDateType->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editTZDateType->setOptionalShortDescriptionNull();
						}
						else {
							editTZDateType->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editTZDateType->setOptionalDescriptionNull();
						}
						else {
							editTZDateType->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editTZDateType->setOptionalDefaultXmlValueNull();
						}
						else {
							editTZDateType->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editTZDateType->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editTZDateType->setOptionalGenerateIdNull();
						}
						else {
							editTZDateType->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editTZDateType->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editTZDateType->setOptionalDbNameNull();
						}
						else {
							editTZDateType->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalDummyNull() ) {
							editTZDateType->setOptionalDummyNull();
						}
						else {
							editTZDateType->setOptionalDummyValue( editBuff->getOptionalDummyValue() );
						}
			...
			if( editTZDateType != NULL ) {
				if( origTZDateType != NULL ) {
					...
					origTZDateType = dynamic_cast<cfbam::ICFBamTZDateTypeObj*>( editTZDateType->create() );
				}
				editTZDateType = NULL;
			}
			...
			curContext->setObj( origTZDateType );
...
cleanup:
	...
	void CFBamSaxLoaderTZDateTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
