...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTenantHandler::CLASS_NAME( "CFBamSaxLoaderTenantHandler" );
	const std::string CFBamSaxLoaderTenantHandler::S_True( "true" );
	const std::string CFBamSaxLoaderTenantHandler::S_False( "false" );
	const std::string CFBamSaxLoaderTenantHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderTenantHandler::S_No( "no" );
	const std::string CFBamSaxLoaderTenantHandler::S_0( "0" );
	const std::string CFBamSaxLoaderTenantHandler::S_1( "1" );

	CFBamSaxLoaderTenantHandler::CFBamSaxLoaderTenantHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTenantHandler::~CFBamSaxLoaderTenantHandler() {
	}

	void CFBamSaxLoaderTenantHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderTenantHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
