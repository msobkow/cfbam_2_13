...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusDb2LUWTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusDb2LUWTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusDb2LUWTableMembersHandler::CFBamSaxLoaderTableHPlusDb2LUWTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusDb2LUWTableMembersHandler::~CFBamSaxLoaderTableHPlusDb2LUWTableMembersHandler() {
	}

	void CFBamSaxLoaderTableHPlusDb2LUWTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusDb2LUWTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusDb2LUWTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusDb2LUWTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppDb2LUWTableMembersNull() || origBuff->getOptionalHppDb2LUWTableMembersValue().empty() ) {
			editBuff->setOptionalHppDb2LUWTableMembersValue( attrText );
		}
		else {
