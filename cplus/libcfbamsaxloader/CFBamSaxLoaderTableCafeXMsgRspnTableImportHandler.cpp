...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeXMsgRspnTableImport
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeXMsgRspnTableImportHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeXMsgRspnTableImportHandler::CFBamSaxLoaderTableCafeXMsgRspnTableImportHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeXMsgRspnTableImportHandler::~CFBamSaxLoaderTableCafeXMsgRspnTableImportHandler() {
	}

	void CFBamSaxLoaderTableCafeXMsgRspnTableImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeXMsgRspnTableImport" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeXMsgRspnTableImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeXMsgRspnTableImport more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJXMsgRspnTableImportNull() || origBuff->getOptionalJXMsgRspnTableImportValue().empty() ) {
			editBuff->setOptionalJXMsgRspnTableImportValue( attrText );
		}
		else {
