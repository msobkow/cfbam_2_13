...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeDb2LUWTableImport
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeDb2LUWTableImportHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeDb2LUWTableImportHandler::CFBamSaxLoaderTableCafeDb2LUWTableImportHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeDb2LUWTableImportHandler::~CFBamSaxLoaderTableCafeDb2LUWTableImportHandler() {
	}

	void CFBamSaxLoaderTableCafeDb2LUWTableImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeDb2LUWTableImport" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeDb2LUWTableImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeDb2LUWTableImport more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJDb2LUWTableImportNull() || origBuff->getOptionalJDb2LUWTableImportValue().empty() ) {
			editBuff->setOptionalJDb2LUWTableImportValue( attrText );
		}
		else {
