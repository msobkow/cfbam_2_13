...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusPgSqlTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusPgSqlTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusPgSqlTableImplementationHandler::CFBamSaxLoaderTableHPlusPgSqlTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusPgSqlTableImplementationHandler::~CFBamSaxLoaderTableHPlusPgSqlTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableHPlusPgSqlTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusPgSqlTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusPgSqlTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusPgSqlTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppPgSqlTableImplementationNull() || origBuff->getOptionalHppPgSqlTableImplementationValue().empty() ) {
			editBuff->setOptionalHppPgSqlTableImplementationValue( attrText );
		}
		else {
