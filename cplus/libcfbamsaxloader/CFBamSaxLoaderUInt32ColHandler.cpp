...
// Description: C++18 XML SAX2 Element Handler implementation for UInt32Col
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderUInt32ColHandler::CLASS_NAME( "CFBamSaxLoaderUInt32ColHandler" );
	const std::string CFBamSaxLoaderUInt32ColHandler::S_True( "true" );
	const std::string CFBamSaxLoaderUInt32ColHandler::S_False( "false" );
	const std::string CFBamSaxLoaderUInt32ColHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderUInt32ColHandler::S_No( "no" );
	const std::string CFBamSaxLoaderUInt32ColHandler::S_0( "0" );
	const std::string CFBamSaxLoaderUInt32ColHandler::S_1( "1" );

	CFBamSaxLoaderUInt32ColHandler::CFBamSaxLoaderUInt32ColHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderUInt32ColHandler::~CFBamSaxLoaderUInt32ColHandler() {
	}

	void CFBamSaxLoaderUInt32ColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamUInt32ColObj* tmpBuff = NULL;
		cfbam::ICFBamUInt32ColEditObj* editBuff = NULL;
		cfbam::ICFBamUInt32ColEditObj* editUInt32Col = NULL;
		cfbam::ICFBamUInt32ColObj* origUInt32Col = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamUInt32ColBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamUInt32ColBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getUInt32ColTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamUInt32ColEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getUInt32ColLoaderBehaviour();
			origUInt32Col = dynamic_cast<cfbam::ICFBamUInt32ColObj*>( schemaObj->getUInt32ColTableObj()->readUInt32ColByUNameIdx( refTenant->getRequiredId(),
			...
			if( origUInt32Col == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editUInt32Col = dynamic_cast<cfbam::ICFBamUInt32ColEditObj*>( origUInt32Col->beginEdit() );
						editUInt32Col->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editUInt32Col->setOptionalShortNameNull();
						}
						else {
							editUInt32Col->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editUInt32Col->setOptionalLabelNull();
						}
						else {
							editUInt32Col->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editUInt32Col->setOptionalShortDescriptionNull();
						}
						else {
							editUInt32Col->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editUInt32Col->setOptionalDescriptionNull();
						}
						else {
							editUInt32Col->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editUInt32Col->setOptionalDefaultXmlValueNull();
						}
						else {
							editUInt32Col->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editUInt32Col->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editUInt32Col->setOptionalGenerateIdNull();
						}
						else {
							editUInt32Col->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editUInt32Col->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editUInt32Col->setOptionalDbNameNull();
						}
						else {
							editUInt32Col->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editUInt32Col->setOptionalInitValueNull();
						}
						else {
							editUInt32Col->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editUInt32Col->setOptionalMinValueNull();
						}
						else {
							editUInt32Col->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editUInt32Col->setOptionalMaxValueNull();
						}
						else {
							editUInt32Col->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editUInt32Col != NULL ) {
				if( origUInt32Col != NULL ) {
					...
					origUInt32Col = dynamic_cast<cfbam::ICFBamUInt32ColObj*>( editUInt32Col->create() );
				}
				editUInt32Col = NULL;
			}
			...
			curContext->setObj( origUInt32Col );
...
cleanup:
	...
	void CFBamSaxLoaderUInt32ColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
