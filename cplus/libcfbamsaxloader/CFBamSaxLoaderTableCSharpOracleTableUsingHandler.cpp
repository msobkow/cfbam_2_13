...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpOracleTableUsing
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpOracleTableUsingHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpOracleTableUsingHandler::CFBamSaxLoaderTableCSharpOracleTableUsingHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpOracleTableUsingHandler::~CFBamSaxLoaderTableCSharpOracleTableUsingHandler() {
	}

	void CFBamSaxLoaderTableCSharpOracleTableUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpOracleTableUsing" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpOracleTableUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpOracleTableUsing more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsOracleTableUsingNull() || origBuff->getOptionalCsOracleTableUsingValue().empty() ) {
			editBuff->setOptionalCsOracleTableUsingValue( attrText );
		}
		else {
