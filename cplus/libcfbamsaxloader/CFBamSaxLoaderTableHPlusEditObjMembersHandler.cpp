...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusEditObjMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusEditObjMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusEditObjMembersHandler::CFBamSaxLoaderTableHPlusEditObjMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusEditObjMembersHandler::~CFBamSaxLoaderTableHPlusEditObjMembersHandler() {
	}

	void CFBamSaxLoaderTableHPlusEditObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusEditObjMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusEditObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusEditObjMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppEditObjMembersNull() || origBuff->getOptionalHppEditObjMembersValue().empty() ) {
			editBuff->setOptionalHppEditObjMembersValue( attrText );
		}
		else {
