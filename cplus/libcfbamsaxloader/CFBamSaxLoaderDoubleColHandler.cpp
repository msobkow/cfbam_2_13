...
// Description: C++18 XML SAX2 Element Handler implementation for DoubleCol
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderDoubleColHandler::CLASS_NAME( "CFBamSaxLoaderDoubleColHandler" );
	const std::string CFBamSaxLoaderDoubleColHandler::S_True( "true" );
	const std::string CFBamSaxLoaderDoubleColHandler::S_False( "false" );
	const std::string CFBamSaxLoaderDoubleColHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderDoubleColHandler::S_No( "no" );
	const std::string CFBamSaxLoaderDoubleColHandler::S_0( "0" );
	const std::string CFBamSaxLoaderDoubleColHandler::S_1( "1" );

	CFBamSaxLoaderDoubleColHandler::CFBamSaxLoaderDoubleColHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderDoubleColHandler::~CFBamSaxLoaderDoubleColHandler() {
	}

	void CFBamSaxLoaderDoubleColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamDoubleColObj* tmpBuff = NULL;
		cfbam::ICFBamDoubleColEditObj* editBuff = NULL;
		cfbam::ICFBamDoubleColEditObj* editDoubleCol = NULL;
		cfbam::ICFBamDoubleColObj* origDoubleCol = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamDoubleColBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamDoubleColBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getDoubleColTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamDoubleColEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getDoubleColLoaderBehaviour();
			origDoubleCol = dynamic_cast<cfbam::ICFBamDoubleColObj*>( schemaObj->getDoubleColTableObj()->readDoubleColByUNameIdx( refTenant->getRequiredId(),
			...
			if( origDoubleCol == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editDoubleCol = dynamic_cast<cfbam::ICFBamDoubleColEditObj*>( origDoubleCol->beginEdit() );
						editDoubleCol->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editDoubleCol->setOptionalShortNameNull();
						}
						else {
							editDoubleCol->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editDoubleCol->setOptionalLabelNull();
						}
						else {
							editDoubleCol->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editDoubleCol->setOptionalShortDescriptionNull();
						}
						else {
							editDoubleCol->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editDoubleCol->setOptionalDescriptionNull();
						}
						else {
							editDoubleCol->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editDoubleCol->setOptionalDefaultXmlValueNull();
						}
						else {
							editDoubleCol->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editDoubleCol->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editDoubleCol->setOptionalGenerateIdNull();
						}
						else {
							editDoubleCol->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editDoubleCol->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editDoubleCol->setOptionalDbNameNull();
						}
						else {
							editDoubleCol->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editDoubleCol->setOptionalInitValueNull();
						}
						else {
							editDoubleCol->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editDoubleCol->setOptionalMinValueNull();
						}
						else {
							editDoubleCol->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editDoubleCol->setOptionalMaxValueNull();
						}
						else {
							editDoubleCol->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editDoubleCol != NULL ) {
				if( origDoubleCol != NULL ) {
					...
					origDoubleCol = dynamic_cast<cfbam::ICFBamDoubleColObj*>( editDoubleCol->create() );
				}
				editDoubleCol = NULL;
			}
			...
			curContext->setObj( origDoubleCol );
...
cleanup:
	...
	void CFBamSaxLoaderDoubleColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
