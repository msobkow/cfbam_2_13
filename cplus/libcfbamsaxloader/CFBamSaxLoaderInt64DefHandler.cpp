...
// Description: C++18 XML SAX2 Element Handler implementation for Int64Def
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderInt64DefHandler::CLASS_NAME( "CFBamSaxLoaderInt64DefHandler" );
	const std::string CFBamSaxLoaderInt64DefHandler::S_True( "true" );
	const std::string CFBamSaxLoaderInt64DefHandler::S_False( "false" );
	const std::string CFBamSaxLoaderInt64DefHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderInt64DefHandler::S_No( "no" );
	const std::string CFBamSaxLoaderInt64DefHandler::S_0( "0" );
	const std::string CFBamSaxLoaderInt64DefHandler::S_1( "1" );

	CFBamSaxLoaderInt64DefHandler::CFBamSaxLoaderInt64DefHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderInt64DefHandler::~CFBamSaxLoaderInt64DefHandler() {
	}

	void CFBamSaxLoaderInt64DefHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamInt64DefObj* tmpBuff = NULL;
		cfbam::ICFBamInt64DefEditObj* editBuff = NULL;
		cfbam::ICFBamInt64DefEditObj* editInt64Def = NULL;
		cfbam::ICFBamInt64DefObj* origInt64Def = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamInt64DefBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamInt64DefBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getInt64DefTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamInt64DefEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getInt64DefLoaderBehaviour();
			origInt64Def = dynamic_cast<cfbam::ICFBamInt64DefObj*>( schemaObj->getInt64DefTableObj()->readInt64DefByUNameIdx( refTenant->getRequiredId(),
			...
			if( origInt64Def == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editInt64Def = dynamic_cast<cfbam::ICFBamInt64DefEditObj*>( origInt64Def->beginEdit() );
						editInt64Def->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editInt64Def->setOptionalShortNameNull();
						}
						else {
							editInt64Def->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editInt64Def->setOptionalLabelNull();
						}
						else {
							editInt64Def->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editInt64Def->setOptionalShortDescriptionNull();
						}
						else {
							editInt64Def->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editInt64Def->setOptionalDescriptionNull();
						}
						else {
							editInt64Def->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editInt64Def->setOptionalDefaultXmlValueNull();
						}
						else {
							editInt64Def->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editInt64Def->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editInt64Def->setOptionalGenerateIdNull();
						}
						else {
							editInt64Def->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editInt64Def->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editInt64Def->setOptionalDbNameNull();
						}
						else {
							editInt64Def->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editInt64Def->setOptionalInitValueNull();
						}
						else {
							editInt64Def->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editInt64Def->setOptionalMinValueNull();
						}
						else {
							editInt64Def->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editInt64Def->setOptionalMaxValueNull();
						}
						else {
							editInt64Def->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editInt64Def != NULL ) {
				if( origInt64Def != NULL ) {
					...
					origInt64Def = dynamic_cast<cfbam::ICFBamInt64DefObj*>( editInt64Def->create() );
				}
				editInt64Def = NULL;
			}
			...
			curContext->setObj( origInt64Def );
...
cleanup:
	...
	void CFBamSaxLoaderInt64DefHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
