...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpXMsgRspnTableUsing
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpXMsgRspnTableUsingHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpXMsgRspnTableUsingHandler::CFBamSaxLoaderTableCSharpXMsgRspnTableUsingHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpXMsgRspnTableUsingHandler::~CFBamSaxLoaderTableCSharpXMsgRspnTableUsingHandler() {
	}

	void CFBamSaxLoaderTableCSharpXMsgRspnTableUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpXMsgRspnTableUsing" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpXMsgRspnTableUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpXMsgRspnTableUsing more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsXMsgRspnTableUsingNull() || origBuff->getOptionalCsXMsgRspnTableUsingValue().empty() ) {
			editBuff->setOptionalCsXMsgRspnTableUsingValue( attrText );
		}
		else {
