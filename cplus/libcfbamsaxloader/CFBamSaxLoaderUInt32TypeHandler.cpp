...
// Description: C++18 XML SAX2 Element Handler implementation for UInt32Type
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderUInt32TypeHandler::CLASS_NAME( "CFBamSaxLoaderUInt32TypeHandler" );
	const std::string CFBamSaxLoaderUInt32TypeHandler::S_True( "true" );
	const std::string CFBamSaxLoaderUInt32TypeHandler::S_False( "false" );
	const std::string CFBamSaxLoaderUInt32TypeHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderUInt32TypeHandler::S_No( "no" );
	const std::string CFBamSaxLoaderUInt32TypeHandler::S_0( "0" );
	const std::string CFBamSaxLoaderUInt32TypeHandler::S_1( "1" );

	CFBamSaxLoaderUInt32TypeHandler::CFBamSaxLoaderUInt32TypeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderUInt32TypeHandler::~CFBamSaxLoaderUInt32TypeHandler() {
	}

	void CFBamSaxLoaderUInt32TypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamUInt32TypeObj* tmpBuff = NULL;
		cfbam::ICFBamUInt32TypeEditObj* editBuff = NULL;
		cfbam::ICFBamUInt32TypeEditObj* editUInt32Type = NULL;
		cfbam::ICFBamUInt32TypeObj* origUInt32Type = NULL;
		...
		cflib::CFLibNullableUInt32 natInitValue;
		cflib::CFLibNullableUInt32 natMinValue;
		cflib::CFLibNullableUInt32 natMaxValue;
		try {
			if( ( uri == NULL ) || ( *uri == 0 ) ) {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamUInt32TypeBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamUInt32TypeBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getUInt32TypeTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamUInt32TypeEditObj*>( tmpBuff->beginEdit() );
			...
			if( ( attrInitValue == NULL ) || ( attrInitValue->length() == 0 ) ) {
				...
				uint32_t* value = cflib::CFLibXmlUtil::parseUInt32( *attrInitValue );
				if( value != NULL ) {
			...
			if( ( attrMinValue == NULL ) || ( attrMinValue->length() == 0 ) ) {
				...
				uint32_t* value = cflib::CFLibXmlUtil::parseUInt32( *attrMinValue );
				if( value != NULL ) {
			...
			if( ( attrMaxValue == NULL ) || ( attrMaxValue->length() == 0 ) ) {
				...
				uint32_t* value = cflib::CFLibXmlUtil::parseUInt32( *attrMaxValue );
				if( value != NULL ) {
			...
			loaderBehaviour = saxLoader->getUInt32TypeLoaderBehaviour();
			origUInt32Type = dynamic_cast<cfbam::ICFBamUInt32TypeObj*>( schemaObj->getUInt32TypeTableObj()->readUInt32TypeByUNameIdx( refTenant->getRequiredId(),
			...
			if( origUInt32Type == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editUInt32Type = dynamic_cast<cfbam::ICFBamUInt32TypeEditObj*>( origUInt32Type->beginEdit() );
						editUInt32Type->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editUInt32Type->setOptionalShortNameNull();
						}
						else {
							editUInt32Type->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editUInt32Type->setOptionalLabelNull();
						}
						else {
							editUInt32Type->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editUInt32Type->setOptionalShortDescriptionNull();
						}
						else {
							editUInt32Type->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editUInt32Type->setOptionalDescriptionNull();
						}
						else {
							editUInt32Type->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editUInt32Type->setOptionalDefaultXmlValueNull();
						}
						else {
							editUInt32Type->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editUInt32Type->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editUInt32Type->setOptionalGenerateIdNull();
						}
						else {
							editUInt32Type->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editUInt32Type->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editUInt32Type->setOptionalDbNameNull();
						}
						else {
							editUInt32Type->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editUInt32Type->setOptionalInitValueNull();
						}
						else {
							editUInt32Type->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editUInt32Type->setOptionalMinValueNull();
						}
						else {
							editUInt32Type->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editUInt32Type->setOptionalMaxValueNull();
						}
						else {
							editUInt32Type->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editUInt32Type != NULL ) {
				if( origUInt32Type != NULL ) {
					...
					origUInt32Type = dynamic_cast<cfbam::ICFBamUInt32TypeObj*>( editUInt32Type->create() );
				}
				editUInt32Type = NULL;
			}
			...
			curContext->setObj( origUInt32Type );
...
cleanup:
	...
	void CFBamSaxLoaderUInt32TypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
