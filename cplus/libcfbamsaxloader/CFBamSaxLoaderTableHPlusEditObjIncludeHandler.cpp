...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusEditObjInclude
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusEditObjIncludeHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusEditObjIncludeHandler::CFBamSaxLoaderTableHPlusEditObjIncludeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusEditObjIncludeHandler::~CFBamSaxLoaderTableHPlusEditObjIncludeHandler() {
	}

	void CFBamSaxLoaderTableHPlusEditObjIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusEditObjInclude" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusEditObjIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusEditObjInclude more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppEditObjIncludeNull() || origBuff->getOptionalHppEditObjIncludeValue().empty() ) {
			editBuff->setOptionalHppEditObjIncludeValue( attrText );
		}
		else {
