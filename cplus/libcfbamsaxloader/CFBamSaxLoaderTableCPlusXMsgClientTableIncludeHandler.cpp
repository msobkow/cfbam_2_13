...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusXMsgClientTableInclude
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusXMsgClientTableIncludeHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusXMsgClientTableIncludeHandler::CFBamSaxLoaderTableCPlusXMsgClientTableIncludeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusXMsgClientTableIncludeHandler::~CFBamSaxLoaderTableCPlusXMsgClientTableIncludeHandler() {
	}

	void CFBamSaxLoaderTableCPlusXMsgClientTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusXMsgClientTableInclude" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusXMsgClientTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusXMsgClientTableInclude more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppXMsgClientTableIncludeNull() || origBuff->getOptionalCppXMsgClientTableIncludeValue().empty() ) {
			editBuff->setOptionalCppXMsgClientTableIncludeValue( attrText );
		}
		else {
