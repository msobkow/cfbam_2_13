...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpEditObjImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpEditObjImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpEditObjImplementationHandler::CFBamSaxLoaderTableCSharpEditObjImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpEditObjImplementationHandler::~CFBamSaxLoaderTableCSharpEditObjImplementationHandler() {
	}

	void CFBamSaxLoaderTableCSharpEditObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpEditObjImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpEditObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpEditObjImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsEditObjImplementationNull() || origBuff->getOptionalCsEditObjImplementationValue().empty() ) {
			editBuff->setOptionalCsEditObjImplementationValue( attrText );
		}
		else {
