...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderMinorVersionHandler::CLASS_NAME( "CFBamSaxLoaderMinorVersionHandler" );
	const std::string CFBamSaxLoaderMinorVersionHandler::S_True( "true" );
	const std::string CFBamSaxLoaderMinorVersionHandler::S_False( "false" );
	const std::string CFBamSaxLoaderMinorVersionHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderMinorVersionHandler::S_No( "no" );
	const std::string CFBamSaxLoaderMinorVersionHandler::S_0( "0" );
	const std::string CFBamSaxLoaderMinorVersionHandler::S_1( "1" );

	CFBamSaxLoaderMinorVersionHandler::CFBamSaxLoaderMinorVersionHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderMinorVersionHandler::~CFBamSaxLoaderMinorVersionHandler() {
	}

	void CFBamSaxLoaderMinorVersionHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderMinorVersionHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
