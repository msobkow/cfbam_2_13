...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTSecGrpIncHandler::CLASS_NAME( "CFBamSaxLoaderTSecGrpIncHandler" );
	const std::string CFBamSaxLoaderTSecGrpIncHandler::S_True( "true" );
	const std::string CFBamSaxLoaderTSecGrpIncHandler::S_False( "false" );
	const std::string CFBamSaxLoaderTSecGrpIncHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderTSecGrpIncHandler::S_No( "no" );
	const std::string CFBamSaxLoaderTSecGrpIncHandler::S_0( "0" );
	const std::string CFBamSaxLoaderTSecGrpIncHandler::S_1( "1" );

	CFBamSaxLoaderTSecGrpIncHandler::CFBamSaxLoaderTSecGrpIncHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTSecGrpIncHandler::~CFBamSaxLoaderTSecGrpIncHandler() {
	}

	void CFBamSaxLoaderTSecGrpIncHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderTSecGrpIncHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
