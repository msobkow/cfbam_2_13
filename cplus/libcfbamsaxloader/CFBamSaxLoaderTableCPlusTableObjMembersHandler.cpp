...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusTableObjMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusTableObjMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusTableObjMembersHandler::CFBamSaxLoaderTableCPlusTableObjMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusTableObjMembersHandler::~CFBamSaxLoaderTableCPlusTableObjMembersHandler() {
	}

	void CFBamSaxLoaderTableCPlusTableObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusTableObjMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusTableObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusTableObjMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppTableObjMembersNull() || origBuff->getOptionalCppTableObjMembersValue().empty() ) {
			editBuff->setOptionalCppTableObjMembersValue( attrText );
		}
		else {
