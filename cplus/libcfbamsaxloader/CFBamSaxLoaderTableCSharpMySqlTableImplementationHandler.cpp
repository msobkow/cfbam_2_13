...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpMySqlTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpMySqlTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpMySqlTableImplementationHandler::CFBamSaxLoaderTableCSharpMySqlTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpMySqlTableImplementationHandler::~CFBamSaxLoaderTableCSharpMySqlTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableCSharpMySqlTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpMySqlTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpMySqlTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpMySqlTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsMySqlTableImplementationNull() || origBuff->getOptionalCsMySqlTableImplementationValue().empty() ) {
			editBuff->setOptionalCsMySqlTableImplementationValue( attrText );
		}
		else {
