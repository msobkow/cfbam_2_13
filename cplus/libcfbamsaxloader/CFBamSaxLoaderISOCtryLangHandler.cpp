...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderISOCtryLangHandler::CLASS_NAME( "CFBamSaxLoaderISOCtryLangHandler" );
	const std::string CFBamSaxLoaderISOCtryLangHandler::S_True( "true" );
	const std::string CFBamSaxLoaderISOCtryLangHandler::S_False( "false" );
	const std::string CFBamSaxLoaderISOCtryLangHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderISOCtryLangHandler::S_No( "no" );
	const std::string CFBamSaxLoaderISOCtryLangHandler::S_0( "0" );
	const std::string CFBamSaxLoaderISOCtryLangHandler::S_1( "1" );

	CFBamSaxLoaderISOCtryLangHandler::CFBamSaxLoaderISOCtryLangHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderISOCtryLangHandler::~CFBamSaxLoaderISOCtryLangHandler() {
	}

	void CFBamSaxLoaderISOCtryLangHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderISOCtryLangHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
