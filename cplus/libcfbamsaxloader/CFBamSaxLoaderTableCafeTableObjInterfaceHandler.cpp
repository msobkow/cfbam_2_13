...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeTableObjInterface
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeTableObjInterfaceHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeTableObjInterfaceHandler::CFBamSaxLoaderTableCafeTableObjInterfaceHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeTableObjInterfaceHandler::~CFBamSaxLoaderTableCafeTableObjInterfaceHandler() {
	}

	void CFBamSaxLoaderTableCafeTableObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeTableObjInterface" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeTableObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeTableObjInterface more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJTableObjInterfaceNull() || origBuff->getOptionalJTableObjInterfaceValue().empty() ) {
			editBuff->setOptionalJTableObjInterfaceValue( attrText );
		}
		else {
