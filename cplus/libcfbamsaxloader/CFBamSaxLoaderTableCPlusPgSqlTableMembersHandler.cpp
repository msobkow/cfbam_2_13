...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusPgSqlTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusPgSqlTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusPgSqlTableMembersHandler::CFBamSaxLoaderTableCPlusPgSqlTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusPgSqlTableMembersHandler::~CFBamSaxLoaderTableCPlusPgSqlTableMembersHandler() {
	}

	void CFBamSaxLoaderTableCPlusPgSqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusPgSqlTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusPgSqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusPgSqlTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppPgSqlTableMembersNull() || origBuff->getOptionalCppPgSqlTableMembersValue().empty() ) {
			editBuff->setOptionalCppPgSqlTableMembersValue( attrText );
		}
		else {
