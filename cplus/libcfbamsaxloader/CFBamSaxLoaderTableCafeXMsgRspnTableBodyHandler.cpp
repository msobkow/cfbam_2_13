...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeXMsgRspnTableBody
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeXMsgRspnTableBodyHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeXMsgRspnTableBodyHandler::CFBamSaxLoaderTableCafeXMsgRspnTableBodyHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeXMsgRspnTableBodyHandler::~CFBamSaxLoaderTableCafeXMsgRspnTableBodyHandler() {
	}

	void CFBamSaxLoaderTableCafeXMsgRspnTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeXMsgRspnTableBody" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeXMsgRspnTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeXMsgRspnTableBody more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJXMsgRspnTableBodyNull() || origBuff->getOptionalJXMsgRspnTableBodyValue().empty() ) {
			editBuff->setOptionalJXMsgRspnTableBodyValue( attrText );
		}
		else {
