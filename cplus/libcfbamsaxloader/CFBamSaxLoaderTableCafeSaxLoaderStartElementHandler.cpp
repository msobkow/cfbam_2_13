...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeSaxLoaderStartElement
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeSaxLoaderStartElementHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeSaxLoaderStartElementHandler::CFBamSaxLoaderTableCafeSaxLoaderStartElementHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeSaxLoaderStartElementHandler::~CFBamSaxLoaderTableCafeSaxLoaderStartElementHandler() {
	}

	void CFBamSaxLoaderTableCafeSaxLoaderStartElementHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeSaxLoaderStartElement" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeSaxLoaderStartElementHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeSaxLoaderStartElement more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJSaxLoaderStartElementNull() || origBuff->getOptionalJSaxLoaderStartElementValue().empty() ) {
			editBuff->setOptionalJSaxLoaderStartElementValue( attrText );
		}
		else {
