...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusOracleTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusOracleTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusOracleTableImplementationHandler::CFBamSaxLoaderTableHPlusOracleTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusOracleTableImplementationHandler::~CFBamSaxLoaderTableHPlusOracleTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableHPlusOracleTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusOracleTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusOracleTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusOracleTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppOracleTableImplementationNull() || origBuff->getOptionalHppOracleTableImplementationValue().empty() ) {
			editBuff->setOptionalHppOracleTableImplementationValue( attrText );
		}
		else {
