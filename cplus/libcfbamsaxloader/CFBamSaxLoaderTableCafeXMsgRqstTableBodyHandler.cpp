...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeXMsgRqstTableBody
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeXMsgRqstTableBodyHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeXMsgRqstTableBodyHandler::CFBamSaxLoaderTableCafeXMsgRqstTableBodyHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeXMsgRqstTableBodyHandler::~CFBamSaxLoaderTableCafeXMsgRqstTableBodyHandler() {
	}

	void CFBamSaxLoaderTableCafeXMsgRqstTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeXMsgRqstTableBody" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeXMsgRqstTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeXMsgRqstTableBody more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJXMsgRqstTableBodyNull() || origBuff->getOptionalJXMsgRqstTableBodyValue().empty() ) {
			editBuff->setOptionalJXMsgRqstTableBodyValue( attrText );
		}
		else {
