...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusTableImplementationHandler::CFBamSaxLoaderTableHPlusTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusTableImplementationHandler::~CFBamSaxLoaderTableHPlusTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableHPlusTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppTableImplementationNull() || origBuff->getOptionalHppTableImplementationValue().empty() ) {
			editBuff->setOptionalHppTableImplementationValue( attrText );
		}
		else {
