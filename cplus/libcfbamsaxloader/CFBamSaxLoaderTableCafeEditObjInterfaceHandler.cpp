...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeEditObjInterface
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeEditObjInterfaceHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeEditObjInterfaceHandler::CFBamSaxLoaderTableCafeEditObjInterfaceHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeEditObjInterfaceHandler::~CFBamSaxLoaderTableCafeEditObjInterfaceHandler() {
	}

	void CFBamSaxLoaderTableCafeEditObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeEditObjInterface" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeEditObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeEditObjInterface more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJEditObjInterfaceNull() || origBuff->getOptionalJEditObjInterfaceValue().empty() ) {
			editBuff->setOptionalJEditObjInterfaceValue( attrText );
		}
		else {
