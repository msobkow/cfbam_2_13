...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeSaxLoaderImport
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeSaxLoaderImportHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeSaxLoaderImportHandler::CFBamSaxLoaderTableCafeSaxLoaderImportHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeSaxLoaderImportHandler::~CFBamSaxLoaderTableCafeSaxLoaderImportHandler() {
	}

	void CFBamSaxLoaderTableCafeSaxLoaderImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeSaxLoaderImport" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeSaxLoaderImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeSaxLoaderImport more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJSaxLoaderImportNull() || origBuff->getOptionalJSaxLoaderImportValue().empty() ) {
			editBuff->setOptionalJSaxLoaderImportValue( attrText );
		}
		else {
