...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTSecGrpMembHandler::CLASS_NAME( "CFBamSaxLoaderTSecGrpMembHandler" );
	const std::string CFBamSaxLoaderTSecGrpMembHandler::S_True( "true" );
	const std::string CFBamSaxLoaderTSecGrpMembHandler::S_False( "false" );
	const std::string CFBamSaxLoaderTSecGrpMembHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderTSecGrpMembHandler::S_No( "no" );
	const std::string CFBamSaxLoaderTSecGrpMembHandler::S_0( "0" );
	const std::string CFBamSaxLoaderTSecGrpMembHandler::S_1( "1" );

	CFBamSaxLoaderTSecGrpMembHandler::CFBamSaxLoaderTSecGrpMembHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTSecGrpMembHandler::~CFBamSaxLoaderTSecGrpMembHandler() {
	}

	void CFBamSaxLoaderTSecGrpMembHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderTSecGrpMembHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
