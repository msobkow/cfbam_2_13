...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTldHandler::CLASS_NAME( "CFBamSaxLoaderTldHandler" );
	const std::string CFBamSaxLoaderTldHandler::S_True( "true" );
	const std::string CFBamSaxLoaderTldHandler::S_False( "false" );
	const std::string CFBamSaxLoaderTldHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderTldHandler::S_No( "no" );
	const std::string CFBamSaxLoaderTldHandler::S_0( "0" );
	const std::string CFBamSaxLoaderTldHandler::S_1( "1" );

	CFBamSaxLoaderTldHandler::CFBamSaxLoaderTldHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTldHandler::~CFBamSaxLoaderTldHandler() {
	}

	void CFBamSaxLoaderTldHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderTldHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
