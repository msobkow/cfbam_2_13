...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpXMsgTableUsing
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpXMsgTableUsingHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpXMsgTableUsingHandler::CFBamSaxLoaderTableCSharpXMsgTableUsingHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpXMsgTableUsingHandler::~CFBamSaxLoaderTableCSharpXMsgTableUsingHandler() {
	}

	void CFBamSaxLoaderTableCSharpXMsgTableUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpXMsgTableUsing" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpXMsgTableUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpXMsgTableUsing more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsXMsgTableUsingNull() || origBuff->getOptionalCsXMsgTableUsingValue().empty() ) {
			editBuff->setOptionalCsXMsgTableUsingValue( attrText );
		}
		else {
