...
// Description: C++18 XML SAX2 Element Handler implementation for ClearSubDep2
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderClearSubDep2Handler::CLASS_NAME( "CFBamSaxLoaderClearSubDep2Handler" );
	const std::string CFBamSaxLoaderClearSubDep2Handler::S_True( "true" );
	const std::string CFBamSaxLoaderClearSubDep2Handler::S_False( "false" );
	const std::string CFBamSaxLoaderClearSubDep2Handler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderClearSubDep2Handler::S_No( "no" );
	const std::string CFBamSaxLoaderClearSubDep2Handler::S_0( "0" );
	const std::string CFBamSaxLoaderClearSubDep2Handler::S_1( "1" );

	CFBamSaxLoaderClearSubDep2Handler::CFBamSaxLoaderClearSubDep2Handler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderClearSubDep2Handler::~CFBamSaxLoaderClearSubDep2Handler() {
	}

	void CFBamSaxLoaderClearSubDep2Handler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		static const std::string S_ClearSubDep1( "ClearSubDep1" );
		...
		cfbam::ICFBamClearSubDep2Obj* tmpBuff = NULL;
		cfbam::ICFBamClearSubDep2EditObj* editBuff = NULL;
		cfbam::ICFBamClearSubDep2EditObj* editClearSubDep2 = NULL;
		cfbam::ICFBamClearSubDep2Obj* origClearSubDep2 = NULL;
		...
		cfbam::ICFBamClearSubDep1Obj* refClearSubDep1 = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamClearSubDep2Buff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamClearSubDep2Buff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getClearSubDep2TableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamClearSubDep2EditObj*>( tmpBuff->beginEdit() );
			...
			else if( scopeObj->implementsClassCode( cfbam::CFBamClearSubDep1Buff::CLASS_CODE ) ) {
				refClearSubDep1 = dynamic_cast<cfbam::ICFBamClearSubDep1Obj*>( scopeObj );
			...
			editClearSubDep2 = editBuff;
			editBuff = NULL;
			origClearSubDep2 = dynamic_cast<cfbam::ICFBamClearSubDep2Obj*>( editClearSubDep2->create() );
			editClearSubDep2 = NULL;
			tmpBuff = NULL;

			curContext->setObj( origClearSubDep2 );
...
cleanup:
	...
	void CFBamSaxLoaderClearSubDep2Handler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
