...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusRamTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusRamTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusRamTableMembersHandler::CFBamSaxLoaderTableCPlusRamTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusRamTableMembersHandler::~CFBamSaxLoaderTableCPlusRamTableMembersHandler() {
	}

	void CFBamSaxLoaderTableCPlusRamTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusRamTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusRamTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusRamTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppRamTableMembersNull() || origBuff->getOptionalCppRamTableMembersValue().empty() ) {
			editBuff->setOptionalCppRamTableMembersValue( attrText );
		}
		else {
