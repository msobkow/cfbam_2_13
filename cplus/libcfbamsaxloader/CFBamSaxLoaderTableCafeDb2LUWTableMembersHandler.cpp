...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeDb2LUWTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeDb2LUWTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeDb2LUWTableMembersHandler::CFBamSaxLoaderTableCafeDb2LUWTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeDb2LUWTableMembersHandler::~CFBamSaxLoaderTableCafeDb2LUWTableMembersHandler() {
	}

	void CFBamSaxLoaderTableCafeDb2LUWTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeDb2LUWTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeDb2LUWTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeDb2LUWTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJDb2LUWTableMembersNull() || origBuff->getOptionalJDb2LUWTableMembersValue().empty() ) {
			editBuff->setOptionalJDb2LUWTableMembersValue( attrText );
		}
		else {
