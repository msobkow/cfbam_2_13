...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeEditObjImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeEditObjImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeEditObjImplementationHandler::CFBamSaxLoaderTableCafeEditObjImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeEditObjImplementationHandler::~CFBamSaxLoaderTableCafeEditObjImplementationHandler() {
	}

	void CFBamSaxLoaderTableCafeEditObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeEditObjImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeEditObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeEditObjImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJEditObjImplementationNull() || origBuff->getOptionalJEditObjImplementationValue().empty() ) {
			editBuff->setOptionalJEditObjImplementationValue( attrText );
		}
		else {
