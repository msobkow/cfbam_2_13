...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderSecFormHandler::CLASS_NAME( "CFBamSaxLoaderSecFormHandler" );
	const std::string CFBamSaxLoaderSecFormHandler::S_True( "true" );
	const std::string CFBamSaxLoaderSecFormHandler::S_False( "false" );
	const std::string CFBamSaxLoaderSecFormHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderSecFormHandler::S_No( "no" );
	const std::string CFBamSaxLoaderSecFormHandler::S_0( "0" );
	const std::string CFBamSaxLoaderSecFormHandler::S_1( "1" );

	CFBamSaxLoaderSecFormHandler::CFBamSaxLoaderSecFormHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderSecFormHandler::~CFBamSaxLoaderSecFormHandler() {
	}

	void CFBamSaxLoaderSecFormHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderSecFormHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
