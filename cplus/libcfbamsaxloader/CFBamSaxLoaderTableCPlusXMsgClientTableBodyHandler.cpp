...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusXMsgClientTableBody
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusXMsgClientTableBodyHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusXMsgClientTableBodyHandler::CFBamSaxLoaderTableCPlusXMsgClientTableBodyHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusXMsgClientTableBodyHandler::~CFBamSaxLoaderTableCPlusXMsgClientTableBodyHandler() {
	}

	void CFBamSaxLoaderTableCPlusXMsgClientTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusXMsgClientTableBody" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusXMsgClientTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusXMsgClientTableBody more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppXMsgClientTableBodyNull() || origBuff->getOptionalCppXMsgClientTableBodyValue().empty() ) {
			editBuff->setOptionalCppXMsgClientTableBodyValue( attrText );
		}
		else {
