...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpMSSqlTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpMSSqlTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpMSSqlTableMembersHandler::CFBamSaxLoaderTableCSharpMSSqlTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpMSSqlTableMembersHandler::~CFBamSaxLoaderTableCSharpMSSqlTableMembersHandler() {
	}

	void CFBamSaxLoaderTableCSharpMSSqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpMSSqlTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpMSSqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpMSSqlTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsMSSqlTableMembersNull() || origBuff->getOptionalCsMSSqlTableMembersValue().empty() ) {
			editBuff->setOptionalCsMSSqlTableMembersValue( attrText );
		}
		else {
