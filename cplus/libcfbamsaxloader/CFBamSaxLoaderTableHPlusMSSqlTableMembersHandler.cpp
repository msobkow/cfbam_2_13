...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusMSSqlTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusMSSqlTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusMSSqlTableMembersHandler::CFBamSaxLoaderTableHPlusMSSqlTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusMSSqlTableMembersHandler::~CFBamSaxLoaderTableHPlusMSSqlTableMembersHandler() {
	}

	void CFBamSaxLoaderTableHPlusMSSqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusMSSqlTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusMSSqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusMSSqlTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppMSSqlTableMembersNull() || origBuff->getOptionalHppMSSqlTableMembersValue().empty() ) {
			editBuff->setOptionalHppMSSqlTableMembersValue( attrText );
		}
		else {
