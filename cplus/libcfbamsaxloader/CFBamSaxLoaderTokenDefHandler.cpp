...
// Description: C++18 XML SAX2 Element Handler implementation for TokenDef
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTokenDefHandler::CLASS_NAME( "CFBamSaxLoaderTokenDefHandler" );
	const std::string CFBamSaxLoaderTokenDefHandler::S_True( "true" );
	const std::string CFBamSaxLoaderTokenDefHandler::S_False( "false" );
	const std::string CFBamSaxLoaderTokenDefHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderTokenDefHandler::S_No( "no" );
	const std::string CFBamSaxLoaderTokenDefHandler::S_0( "0" );
	const std::string CFBamSaxLoaderTokenDefHandler::S_1( "1" );

	CFBamSaxLoaderTokenDefHandler::CFBamSaxLoaderTokenDefHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTokenDefHandler::~CFBamSaxLoaderTokenDefHandler() {
	}

	void CFBamSaxLoaderTokenDefHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamTokenDefObj* tmpBuff = NULL;
		cfbam::ICFBamTokenDefEditObj* editBuff = NULL;
		cfbam::ICFBamTokenDefEditObj* editTokenDef = NULL;
		cfbam::ICFBamTokenDefObj* origTokenDef = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamTokenDefBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamTokenDefBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getTokenDefTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamTokenDefEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getTokenDefLoaderBehaviour();
			origTokenDef = dynamic_cast<cfbam::ICFBamTokenDefObj*>( schemaObj->getTokenDefTableObj()->readTokenDefByUNameIdx( refTenant->getRequiredId(),
			...
			if( origTokenDef == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editTokenDef = dynamic_cast<cfbam::ICFBamTokenDefEditObj*>( origTokenDef->beginEdit() );
						editTokenDef->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editTokenDef->setOptionalShortNameNull();
						}
						else {
							editTokenDef->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editTokenDef->setOptionalLabelNull();
						}
						else {
							editTokenDef->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editTokenDef->setOptionalShortDescriptionNull();
						}
						else {
							editTokenDef->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editTokenDef->setOptionalDescriptionNull();
						}
						else {
							editTokenDef->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editTokenDef->setOptionalDefaultXmlValueNull();
						}
						else {
							editTokenDef->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editTokenDef->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editTokenDef->setOptionalGenerateIdNull();
						}
						else {
							editTokenDef->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editTokenDef->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editTokenDef->setOptionalDbNameNull();
						}
						else {
							editTokenDef->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						editTokenDef->setRequiredMaxLen( editBuff->getRequiredMaxLen() );
						if( editBuff->isOptionalInitValueNull() ) {
							editTokenDef->setOptionalInitValueNull();
						}
						else {
							editTokenDef->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
			...
			if( editTokenDef != NULL ) {
				if( origTokenDef != NULL ) {
					...
					origTokenDef = dynamic_cast<cfbam::ICFBamTokenDefObj*>( editTokenDef->create() );
				}
				editTokenDef = NULL;
			}
			...
			curContext->setObj( origTokenDef );
...
cleanup:
	...
	void CFBamSaxLoaderTokenDefHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
