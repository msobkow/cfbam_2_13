...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusSaxLoaderStartElement
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusSaxLoaderStartElementHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusSaxLoaderStartElementHandler::CFBamSaxLoaderTableCPlusSaxLoaderStartElementHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusSaxLoaderStartElementHandler::~CFBamSaxLoaderTableCPlusSaxLoaderStartElementHandler() {
	}

	void CFBamSaxLoaderTableCPlusSaxLoaderStartElementHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusSaxLoaderStartElement" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusSaxLoaderStartElementHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusSaxLoaderStartElement more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppSaxLoaderStartElementNull() || origBuff->getOptionalCppSaxLoaderStartElementValue().empty() ) {
			editBuff->setOptionalCppSaxLoaderStartElementValue( attrText );
		}
		else {
