...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusOracleTableInclude
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusOracleTableIncludeHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusOracleTableIncludeHandler::CFBamSaxLoaderTableHPlusOracleTableIncludeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusOracleTableIncludeHandler::~CFBamSaxLoaderTableHPlusOracleTableIncludeHandler() {
	}

	void CFBamSaxLoaderTableHPlusOracleTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusOracleTableInclude" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusOracleTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusOracleTableInclude more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppOracleTableIncludeNull() || origBuff->getOptionalHppOracleTableIncludeValue().empty() ) {
			editBuff->setOptionalHppOracleTableIncludeValue( attrText );
		}
		else {
