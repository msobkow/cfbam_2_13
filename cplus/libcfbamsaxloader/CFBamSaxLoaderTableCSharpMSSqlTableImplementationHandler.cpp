...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpMSSqlTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpMSSqlTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpMSSqlTableImplementationHandler::CFBamSaxLoaderTableCSharpMSSqlTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpMSSqlTableImplementationHandler::~CFBamSaxLoaderTableCSharpMSSqlTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableCSharpMSSqlTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpMSSqlTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpMSSqlTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpMSSqlTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsMSSqlTableImplementationNull() || origBuff->getOptionalCsMSSqlTableImplementationValue().empty() ) {
			editBuff->setOptionalCsMSSqlTableImplementationValue( attrText );
		}
		else {
