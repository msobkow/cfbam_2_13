...
// Description: C++18 XML SAX2 Element Handler implementation for EnumDef
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderEnumDefHandler::CLASS_NAME( "CFBamSaxLoaderEnumDefHandler" );
	const std::string CFBamSaxLoaderEnumDefHandler::S_True( "true" );
	const std::string CFBamSaxLoaderEnumDefHandler::S_False( "false" );
	const std::string CFBamSaxLoaderEnumDefHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderEnumDefHandler::S_No( "no" );
	const std::string CFBamSaxLoaderEnumDefHandler::S_0( "0" );
	const std::string CFBamSaxLoaderEnumDefHandler::S_1( "1" );

	CFBamSaxLoaderEnumDefHandler::CFBamSaxLoaderEnumDefHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderEnumDefHandler::~CFBamSaxLoaderEnumDefHandler() {
	}

	void CFBamSaxLoaderEnumDefHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamEnumDefObj* tmpBuff = NULL;
		cfbam::ICFBamEnumDefEditObj* editBuff = NULL;
		cfbam::ICFBamEnumDefEditObj* editEnumDef = NULL;
		cfbam::ICFBamEnumDefObj* origEnumDef = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamEnumDefBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamEnumDefBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getEnumDefTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamEnumDefEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getEnumDefLoaderBehaviour();
			origEnumDef = dynamic_cast<cfbam::ICFBamEnumDefObj*>( schemaObj->getEnumDefTableObj()->readEnumDefByUNameIdx( refTenant->getRequiredId(),
			...
			if( origEnumDef == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editEnumDef = dynamic_cast<cfbam::ICFBamEnumDefEditObj*>( origEnumDef->beginEdit() );
						editEnumDef->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editEnumDef->setOptionalShortNameNull();
						}
						else {
							editEnumDef->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editEnumDef->setOptionalLabelNull();
						}
						else {
							editEnumDef->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editEnumDef->setOptionalShortDescriptionNull();
						}
						else {
							editEnumDef->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editEnumDef->setOptionalDescriptionNull();
						}
						else {
							editEnumDef->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editEnumDef->setOptionalDefaultXmlValueNull();
						}
						else {
							editEnumDef->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editEnumDef->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editEnumDef->setOptionalGenerateIdNull();
						}
						else {
							editEnumDef->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editEnumDef->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editEnumDef->setOptionalDbNameNull();
						}
						else {
							editEnumDef->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editEnumDef->setOptionalInitValueNull();
						}
						else {
							editEnumDef->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editEnumDef->setOptionalMinValueNull();
						}
						else {
							editEnumDef->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editEnumDef->setOptionalMaxValueNull();
						}
						else {
							editEnumDef->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editEnumDef != NULL ) {
				if( origEnumDef != NULL ) {
					...
					origEnumDef = dynamic_cast<cfbam::ICFBamEnumDefObj*>( editEnumDef->create() );
				}
				editEnumDef = NULL;
			}
...
cleanup:
	...
	void CFBamSaxLoaderEnumDefHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
