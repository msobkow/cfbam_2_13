...
// Description: C++18 XML SAX2 Element Handler implementation for TZTimestampType
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTZTimestampTypeHandler::CLASS_NAME( "CFBamSaxLoaderTZTimestampTypeHandler" );
	const std::string CFBamSaxLoaderTZTimestampTypeHandler::S_True( "true" );
	const std::string CFBamSaxLoaderTZTimestampTypeHandler::S_False( "false" );
	const std::string CFBamSaxLoaderTZTimestampTypeHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderTZTimestampTypeHandler::S_No( "no" );
	const std::string CFBamSaxLoaderTZTimestampTypeHandler::S_0( "0" );
	const std::string CFBamSaxLoaderTZTimestampTypeHandler::S_1( "1" );

	CFBamSaxLoaderTZTimestampTypeHandler::CFBamSaxLoaderTZTimestampTypeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTZTimestampTypeHandler::~CFBamSaxLoaderTZTimestampTypeHandler() {
	}

	void CFBamSaxLoaderTZTimestampTypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamTZTimestampTypeObj* tmpBuff = NULL;
		cfbam::ICFBamTZTimestampTypeEditObj* editBuff = NULL;
		cfbam::ICFBamTZTimestampTypeEditObj* editTZTimestampType = NULL;
		cfbam::ICFBamTZTimestampTypeObj* origTZTimestampType = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamTZTimestampTypeBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamTZTimestampTypeBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getTZTimestampTypeTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamTZTimestampTypeEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getTZTimestampTypeLoaderBehaviour();
			origTZTimestampType = dynamic_cast<cfbam::ICFBamTZTimestampTypeObj*>( schemaObj->getTZTimestampTypeTableObj()->readTZTimestampTypeByUNameIdx( refTenant->getRequiredId(),
			...
			if( origTZTimestampType == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editTZTimestampType = dynamic_cast<cfbam::ICFBamTZTimestampTypeEditObj*>( origTZTimestampType->beginEdit() );
						editTZTimestampType->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editTZTimestampType->setOptionalShortNameNull();
						}
						else {
							editTZTimestampType->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editTZTimestampType->setOptionalLabelNull();
						}
						else {
							editTZTimestampType->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editTZTimestampType->setOptionalShortDescriptionNull();
						}
						else {
							editTZTimestampType->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editTZTimestampType->setOptionalDescriptionNull();
						}
						else {
							editTZTimestampType->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editTZTimestampType->setOptionalDefaultXmlValueNull();
						}
						else {
							editTZTimestampType->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editTZTimestampType->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editTZTimestampType->setOptionalGenerateIdNull();
						}
						else {
							editTZTimestampType->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						...
						if( editBuff->isOptionalDbNameNull() ) {
							editTZTimestampType->setOptionalDbNameNull();
						}
						else {
							editTZTimestampType->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalDummyNull() ) {
							editTZTimestampType->setOptionalDummyNull();
						}
						else {
							editTZTimestampType->setOptionalDummyValue( editBuff->getOptionalDummyValue() );
						}
			...
			if( editTZTimestampType != NULL ) {
				if( origTZTimestampType != NULL ) {
					...
					origTZTimestampType = dynamic_cast<cfbam::ICFBamTZTimestampTypeObj*>( editTZTimestampType->create() );
				}
				editTZTimestampType = NULL;
			}
			...
			curContext->setObj( origTZTimestampType );
...
cleanup:
	...
	void CFBamSaxLoaderTZTimestampTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
