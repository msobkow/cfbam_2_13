...
// Description: C++18 XML SAX2 Element Handler implementation for PopSubDep2
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderPopSubDep2Handler::CLASS_NAME( "CFBamSaxLoaderPopSubDep2Handler" );
	const std::string CFBamSaxLoaderPopSubDep2Handler::S_True( "true" );
	const std::string CFBamSaxLoaderPopSubDep2Handler::S_False( "false" );
	const std::string CFBamSaxLoaderPopSubDep2Handler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderPopSubDep2Handler::S_No( "no" );
	const std::string CFBamSaxLoaderPopSubDep2Handler::S_0( "0" );
	const std::string CFBamSaxLoaderPopSubDep2Handler::S_1( "1" );

	CFBamSaxLoaderPopSubDep2Handler::CFBamSaxLoaderPopSubDep2Handler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderPopSubDep2Handler::~CFBamSaxLoaderPopSubDep2Handler() {
	}

	void CFBamSaxLoaderPopSubDep2Handler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		static const std::string S_PopSubDep1( "PopSubDep1" );
		...
		cfbam::ICFBamPopSubDep2Obj* tmpBuff = NULL;
		cfbam::ICFBamPopSubDep2EditObj* editBuff = NULL;
		cfbam::ICFBamPopSubDep2EditObj* editPopSubDep2 = NULL;
		cfbam::ICFBamPopSubDep2Obj* origPopSubDep2 = NULL;
		...
		cfbam::ICFBamPopSubDep1Obj* refPopSubDep1 = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamPopSubDep2Buff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamPopSubDep2Buff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getPopSubDep2TableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamPopSubDep2EditObj*>( tmpBuff->beginEdit() );
			...
			else if( scopeObj->implementsClassCode( cfbam::CFBamPopSubDep1Buff::CLASS_CODE ) ) {
				refPopSubDep1 = dynamic_cast<cfbam::ICFBamPopSubDep1Obj*>( scopeObj );
			...
			editPopSubDep2 = editBuff;
			editBuff = NULL;
			origPopSubDep2 = dynamic_cast<cfbam::ICFBamPopSubDep2Obj*>( editPopSubDep2->create() );
			editPopSubDep2 = NULL;
			tmpBuff = NULL;

			curContext->setObj( origPopSubDep2 );
...
cleanup:
	...
	void CFBamSaxLoaderPopSubDep2Handler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
