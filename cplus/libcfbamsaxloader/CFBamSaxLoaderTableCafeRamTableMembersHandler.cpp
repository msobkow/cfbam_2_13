...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeRamTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeRamTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeRamTableMembersHandler::CFBamSaxLoaderTableCafeRamTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeRamTableMembersHandler::~CFBamSaxLoaderTableCafeRamTableMembersHandler() {
	}

	void CFBamSaxLoaderTableCafeRamTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeRamTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeRamTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeRamTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJRamTableMembersNull() || origBuff->getOptionalJRamTableMembersValue().empty() ) {
			editBuff->setOptionalJRamTableMembersValue( attrText );
		}
		else {
