...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeMySqlTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeMySqlTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeMySqlTableImplementationHandler::CFBamSaxLoaderTableCafeMySqlTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeMySqlTableImplementationHandler::~CFBamSaxLoaderTableCafeMySqlTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableCafeMySqlTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeMySqlTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeMySqlTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeMySqlTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJMySqlTableImplementationNull() || origBuff->getOptionalJMySqlTableImplementationValue().empty() ) {
			editBuff->setOptionalJMySqlTableImplementationValue( attrText );
		}
		else {
