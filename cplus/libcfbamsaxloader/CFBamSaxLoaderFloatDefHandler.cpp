...
// Description: C++18 XML SAX2 Element Handler implementation for FloatDef
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderFloatDefHandler::CLASS_NAME( "CFBamSaxLoaderFloatDefHandler" );
	const std::string CFBamSaxLoaderFloatDefHandler::S_True( "true" );
	const std::string CFBamSaxLoaderFloatDefHandler::S_False( "false" );
	const std::string CFBamSaxLoaderFloatDefHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderFloatDefHandler::S_No( "no" );
	const std::string CFBamSaxLoaderFloatDefHandler::S_0( "0" );
	const std::string CFBamSaxLoaderFloatDefHandler::S_1( "1" );

	CFBamSaxLoaderFloatDefHandler::CFBamSaxLoaderFloatDefHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderFloatDefHandler::~CFBamSaxLoaderFloatDefHandler() {
	}

	void CFBamSaxLoaderFloatDefHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamFloatDefObj* tmpBuff = NULL;
		cfbam::ICFBamFloatDefEditObj* editBuff = NULL;
		cfbam::ICFBamFloatDefEditObj* editFloatDef = NULL;
		cfbam::ICFBamFloatDefObj* origFloatDef = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamFloatDefBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamFloatDefBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getFloatDefTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamFloatDefEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getFloatDefLoaderBehaviour();
			origFloatDef = dynamic_cast<cfbam::ICFBamFloatDefObj*>( schemaObj->getFloatDefTableObj()->readFloatDefByUNameIdx( refTenant->getRequiredId(),
			...
			if( origFloatDef == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editFloatDef = dynamic_cast<cfbam::ICFBamFloatDefEditObj*>( origFloatDef->beginEdit() );
						editFloatDef->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editFloatDef->setOptionalShortNameNull();
						}
						else {
							editFloatDef->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editFloatDef->setOptionalLabelNull();
						}
						else {
							editFloatDef->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editFloatDef->setOptionalShortDescriptionNull();
						}
						else {
							editFloatDef->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editFloatDef->setOptionalDescriptionNull();
						}
						else {
							editFloatDef->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editFloatDef->setOptionalDefaultXmlValueNull();
						}
						else {
							editFloatDef->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editFloatDef->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editFloatDef->setOptionalGenerateIdNull();
						}
						else {
							editFloatDef->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editFloatDef->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editFloatDef->setOptionalDbNameNull();
						}
						else {
							editFloatDef->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editFloatDef->setOptionalInitValueNull();
						}
						else {
							editFloatDef->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editFloatDef->setOptionalMinValueNull();
						}
						else {
							editFloatDef->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editFloatDef->setOptionalMaxValueNull();
						}
						else {
							editFloatDef->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editFloatDef != NULL ) {
				if( origFloatDef != NULL ) {
					...
					origFloatDef = dynamic_cast<cfbam::ICFBamFloatDefObj*>( editFloatDef->create() );
				}
				editFloatDef = NULL;
			}
			...
			curContext->setObj( origFloatDef );
...
cleanup:
	...
	void CFBamSaxLoaderFloatDefHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
