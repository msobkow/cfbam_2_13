...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusOracleTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusOracleTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusOracleTableMembersHandler::CFBamSaxLoaderTableCPlusOracleTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusOracleTableMembersHandler::~CFBamSaxLoaderTableCPlusOracleTableMembersHandler() {
	}

	void CFBamSaxLoaderTableCPlusOracleTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusOracleTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusOracleTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusOracleTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppOracleTableMembersNull() || origBuff->getOptionalCppOracleTableMembersValue().empty() ) {
			editBuff->setOptionalCppOracleTableMembersValue( attrText );
		}
		else {
