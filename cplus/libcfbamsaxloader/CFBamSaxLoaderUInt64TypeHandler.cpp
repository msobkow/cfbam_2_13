...
// Description: C++18 XML SAX2 Element Handler implementation for UInt64Type
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderUInt64TypeHandler::CLASS_NAME( "CFBamSaxLoaderUInt64TypeHandler" );
	const std::string CFBamSaxLoaderUInt64TypeHandler::S_True( "true" );
	const std::string CFBamSaxLoaderUInt64TypeHandler::S_False( "false" );
	const std::string CFBamSaxLoaderUInt64TypeHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderUInt64TypeHandler::S_No( "no" );
	const std::string CFBamSaxLoaderUInt64TypeHandler::S_0( "0" );
	const std::string CFBamSaxLoaderUInt64TypeHandler::S_1( "1" );

	CFBamSaxLoaderUInt64TypeHandler::CFBamSaxLoaderUInt64TypeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderUInt64TypeHandler::~CFBamSaxLoaderUInt64TypeHandler() {
	}

	void CFBamSaxLoaderUInt64TypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamUInt64TypeObj* tmpBuff = NULL;
		cfbam::ICFBamUInt64TypeEditObj* editBuff = NULL;
		cfbam::ICFBamUInt64TypeEditObj* editUInt64Type = NULL;
		cfbam::ICFBamUInt64TypeObj* origUInt64Type = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamUInt64TypeBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamUInt64TypeBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getUInt64TypeTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamUInt64TypeEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getUInt64TypeLoaderBehaviour();
			origUInt64Type = dynamic_cast<cfbam::ICFBamUInt64TypeObj*>( schemaObj->getUInt64TypeTableObj()->readUInt64TypeByUNameIdx( refTenant->getRequiredId(),
			...
			if( origUInt64Type == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editUInt64Type = dynamic_cast<cfbam::ICFBamUInt64TypeEditObj*>( origUInt64Type->beginEdit() );
						editUInt64Type->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editUInt64Type->setOptionalShortNameNull();
						}
						else {
							editUInt64Type->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editUInt64Type->setOptionalLabelNull();
						}
						else {
							editUInt64Type->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editUInt64Type->setOptionalShortDescriptionNull();
						}
						else {
							editUInt64Type->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editUInt64Type->setOptionalDescriptionNull();
						}
						else {
							editUInt64Type->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editUInt64Type->setOptionalDefaultXmlValueNull();
						}
						else {
							editUInt64Type->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editUInt64Type->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editUInt64Type->setOptionalGenerateIdNull();
						}
						else {
							editUInt64Type->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editUInt64Type->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editUInt64Type->setOptionalDbNameNull();
						}
						else {
							editUInt64Type->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editUInt64Type->setOptionalInitValueNull();
						}
						else {
							editUInt64Type->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editUInt64Type->setOptionalMinValueNull();
						}
						else {
							editUInt64Type->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editUInt64Type->setOptionalMaxValueNull();
						}
						else {
							editUInt64Type->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editUInt64Type != NULL ) {
				if( origUInt64Type != NULL ) {
					...
					origUInt64Type = dynamic_cast<cfbam::ICFBamUInt64TypeObj*>( editUInt64Type->create() );
				}
				editUInt64Type = NULL;
			}
			...
			curContext->setObj( origUInt64Type );
...
cleanup:
	...
	void CFBamSaxLoaderUInt64TypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
