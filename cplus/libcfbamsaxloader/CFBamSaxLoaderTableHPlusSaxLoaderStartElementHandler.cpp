...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusSaxLoaderStartElement
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusSaxLoaderStartElementHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusSaxLoaderStartElementHandler::CFBamSaxLoaderTableHPlusSaxLoaderStartElementHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusSaxLoaderStartElementHandler::~CFBamSaxLoaderTableHPlusSaxLoaderStartElementHandler() {
	}

	void CFBamSaxLoaderTableHPlusSaxLoaderStartElementHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusSaxLoaderStartElement" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusSaxLoaderStartElementHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusSaxLoaderStartElement more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppSaxLoaderStartElementNull() || origBuff->getOptionalHppSaxLoaderStartElementValue().empty() ) {
			editBuff->setOptionalHppSaxLoaderStartElementValue( attrText );
		}
		else {
