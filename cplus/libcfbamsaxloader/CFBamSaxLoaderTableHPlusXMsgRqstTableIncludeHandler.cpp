...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusXMsgRqstTableInclude
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusXMsgRqstTableIncludeHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusXMsgRqstTableIncludeHandler::CFBamSaxLoaderTableHPlusXMsgRqstTableIncludeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusXMsgRqstTableIncludeHandler::~CFBamSaxLoaderTableHPlusXMsgRqstTableIncludeHandler() {
	}

	void CFBamSaxLoaderTableHPlusXMsgRqstTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusXMsgRqstTableInclude" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusXMsgRqstTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusXMsgRqstTableInclude more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppXMsgRqstTableIncludeNull() || origBuff->getOptionalHppXMsgRqstTableIncludeValue().empty() ) {
			editBuff->setOptionalHppXMsgRqstTableIncludeValue( attrText );
		}
		else {
