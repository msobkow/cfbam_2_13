...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusTableObjImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusTableObjImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusTableObjImplementationHandler::CFBamSaxLoaderTableCPlusTableObjImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusTableObjImplementationHandler::~CFBamSaxLoaderTableCPlusTableObjImplementationHandler() {
	}

	void CFBamSaxLoaderTableCPlusTableObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusTableObjImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusTableObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusTableObjImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppTableObjImplementationNull() || origBuff->getOptionalCppTableObjImplementationValue().empty() ) {
			editBuff->setOptionalCppTableObjImplementationValue( attrText );
		}
		else {
