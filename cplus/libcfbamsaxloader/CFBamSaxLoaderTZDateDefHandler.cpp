...
// Description: C++18 XML SAX2 Element Handler implementation for TZDateDef
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTZDateDefHandler::CLASS_NAME( "CFBamSaxLoaderTZDateDefHandler" );
	const std::string CFBamSaxLoaderTZDateDefHandler::S_True( "true" );
	const std::string CFBamSaxLoaderTZDateDefHandler::S_False( "false" );
	const std::string CFBamSaxLoaderTZDateDefHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderTZDateDefHandler::S_No( "no" );
	const std::string CFBamSaxLoaderTZDateDefHandler::S_0( "0" );
	const std::string CFBamSaxLoaderTZDateDefHandler::S_1( "1" );

	CFBamSaxLoaderTZDateDefHandler::CFBamSaxLoaderTZDateDefHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTZDateDefHandler::~CFBamSaxLoaderTZDateDefHandler() {
	}

	void CFBamSaxLoaderTZDateDefHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamTZDateDefObj* tmpBuff = NULL;
		cfbam::ICFBamTZDateDefEditObj* editBuff = NULL;
		cfbam::ICFBamTZDateDefEditObj* editTZDateDef = NULL;
		cfbam::ICFBamTZDateDefObj* origTZDateDef = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamTZDateDefBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamTZDateDefBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getTZDateDefTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamTZDateDefEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getTZDateDefLoaderBehaviour();
			origTZDateDef = dynamic_cast<cfbam::ICFBamTZDateDefObj*>( schemaObj->getTZDateDefTableObj()->readTZDateDefByUNameIdx( refTenant->getRequiredId(),
			...
			if( origTZDateDef == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editTZDateDef = dynamic_cast<cfbam::ICFBamTZDateDefEditObj*>( origTZDateDef->beginEdit() );
						editTZDateDef->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editTZDateDef->setOptionalShortNameNull();
						}
						else {
							editTZDateDef->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editTZDateDef->setOptionalLabelNull();
						}
						else {
							editTZDateDef->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editTZDateDef->setOptionalShortDescriptionNull();
						}
						else {
							editTZDateDef->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editTZDateDef->setOptionalDescriptionNull();
						}
						else {
							editTZDateDef->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editTZDateDef->setOptionalDefaultXmlValueNull();
						}
						else {
							editTZDateDef->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editTZDateDef->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editTZDateDef->setOptionalGenerateIdNull();
						}
						else {
							editTZDateDef->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editTZDateDef->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editTZDateDef->setOptionalDbNameNull();
						}
						else {
							editTZDateDef->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalDummyNull() ) {
							editTZDateDef->setOptionalDummyNull();
						}
						else {
							editTZDateDef->setOptionalDummyValue( editBuff->getOptionalDummyValue() );
						}
			...
			if( editTZDateDef != NULL ) {
				if( origTZDateDef != NULL ) {
					...
					origTZDateDef = dynamic_cast<cfbam::ICFBamTZDateDefObj*>( editTZDateDef->create() );
				}
				editTZDateDef = NULL;
			}
			...
			curContext->setObj( origTZDateDef );
...
cleanup:
	...
	void CFBamSaxLoaderTZDateDefHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
