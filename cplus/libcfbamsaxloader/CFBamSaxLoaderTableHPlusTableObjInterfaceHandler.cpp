...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusTableObjInterface
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusTableObjInterfaceHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusTableObjInterfaceHandler::CFBamSaxLoaderTableHPlusTableObjInterfaceHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusTableObjInterfaceHandler::~CFBamSaxLoaderTableHPlusTableObjInterfaceHandler() {
	}

	void CFBamSaxLoaderTableHPlusTableObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusTableObjInterface" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusTableObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusTableObjInterface more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppTableObjInterfaceNull() || origBuff->getOptionalHppTableObjInterfaceValue().empty() ) {
			editBuff->setOptionalHppTableObjInterfaceValue( attrText );
		}
		else {
