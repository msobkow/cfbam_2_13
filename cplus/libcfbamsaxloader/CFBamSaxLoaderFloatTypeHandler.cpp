...
// Description: C++18 XML SAX2 Element Handler implementation for FloatType
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderFloatTypeHandler::CLASS_NAME( "CFBamSaxLoaderFloatTypeHandler" );
	const std::string CFBamSaxLoaderFloatTypeHandler::S_True( "true" );
	const std::string CFBamSaxLoaderFloatTypeHandler::S_False( "false" );
	const std::string CFBamSaxLoaderFloatTypeHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderFloatTypeHandler::S_No( "no" );
	const std::string CFBamSaxLoaderFloatTypeHandler::S_0( "0" );
	const std::string CFBamSaxLoaderFloatTypeHandler::S_1( "1" );

	CFBamSaxLoaderFloatTypeHandler::CFBamSaxLoaderFloatTypeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderFloatTypeHandler::~CFBamSaxLoaderFloatTypeHandler() {
	}

	void CFBamSaxLoaderFloatTypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamFloatTypeObj* tmpBuff = NULL;
		cfbam::ICFBamFloatTypeEditObj* editBuff = NULL;
		cfbam::ICFBamFloatTypeEditObj* editFloatType = NULL;
		cfbam::ICFBamFloatTypeObj* origFloatType = NULL;
		...
		cflib::CFLibNullableFloat natInitValue;
		cflib::CFLibNullableFloat natMinValue;
		cflib::CFLibNullableFloat natMaxValue;
		try {
			if( ( uri == NULL ) || ( *uri == 0 ) ) {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamFloatTypeBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamFloatTypeBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getFloatTypeTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamFloatTypeEditObj*>( tmpBuff->beginEdit() );
			...
			if( ( attrInitValue == NULL ) || ( attrInitValue->length() == 0 ) ) {
				...
				float* value = cflib::CFLibXmlUtil::parseFloat( *attrInitValue );
				if( value != NULL ) {
			...
			if( ( attrMinValue == NULL ) || ( attrMinValue->length() == 0 ) ) {
				...
				float* value = cflib::CFLibXmlUtil::parseFloat( *attrMinValue );
				if( value != NULL ) {
			...
			if( ( attrMaxValue == NULL ) || ( attrMaxValue->length() == 0 ) ) {
				...
				float* value = cflib::CFLibXmlUtil::parseFloat( *attrMaxValue );
				if( value != NULL ) {
			...
			loaderBehaviour = saxLoader->getFloatTypeLoaderBehaviour();
			origFloatType = dynamic_cast<cfbam::ICFBamFloatTypeObj*>( schemaObj->getFloatTypeTableObj()->readFloatTypeByUNameIdx( refTenant->getRequiredId(),
			...
			if( origFloatType == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editFloatType = dynamic_cast<cfbam::ICFBamFloatTypeEditObj*>( origFloatType->beginEdit() );
						editFloatType->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editFloatType->setOptionalShortNameNull();
						}
						else {
							editFloatType->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editFloatType->setOptionalLabelNull();
						}
						else {
							editFloatType->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editFloatType->setOptionalShortDescriptionNull();
						}
						else {
							editFloatType->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editFloatType->setOptionalDescriptionNull();
						}
						else {
							editFloatType->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editFloatType->setOptionalDefaultXmlValueNull();
						}
						else {
							editFloatType->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editFloatType->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editFloatType->setOptionalGenerateIdNull();
						}
						else {
							editFloatType->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editFloatType->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editFloatType->setOptionalDbNameNull();
						}
						else {
							editFloatType->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editFloatType->setOptionalInitValueNull();
						}
						else {
							editFloatType->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editFloatType->setOptionalMinValueNull();
						}
						else {
							editFloatType->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editFloatType->setOptionalMaxValueNull();
						}
						else {
							editFloatType->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editFloatType != NULL ) {
				if( origFloatType != NULL ) {
					...
					origFloatType = dynamic_cast<cfbam::ICFBamFloatTypeObj*>( editFloatType->create() );
				}
				editFloatType = NULL;
			}
			...
			curContext->setObj( origFloatType );
...
cleanup:
	...
	void CFBamSaxLoaderFloatTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
