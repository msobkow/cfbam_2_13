...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusMySqlTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusMySqlTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusMySqlTableMembersHandler::CFBamSaxLoaderTableCPlusMySqlTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusMySqlTableMembersHandler::~CFBamSaxLoaderTableCPlusMySqlTableMembersHandler() {
	}

	void CFBamSaxLoaderTableCPlusMySqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusMySqlTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusMySqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusMySqlTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppMySqlTableMembersNull() || origBuff->getOptionalCppMySqlTableMembersValue().empty() ) {
			editBuff->setOptionalCppMySqlTableMembersValue( attrText );
		}
		else {
