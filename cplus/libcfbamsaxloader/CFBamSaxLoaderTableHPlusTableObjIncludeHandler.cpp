...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusTableObjInclude
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusTableObjIncludeHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusTableObjIncludeHandler::CFBamSaxLoaderTableHPlusTableObjIncludeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusTableObjIncludeHandler::~CFBamSaxLoaderTableHPlusTableObjIncludeHandler() {
	}

	void CFBamSaxLoaderTableHPlusTableObjIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusTableObjInclude" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusTableObjIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusTableObjInclude more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppTableObjIncludeNull() || origBuff->getOptionalHppTableObjIncludeValue().empty() ) {
			editBuff->setOptionalHppTableObjIncludeValue( attrText );
		}
		else {
