...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderISOCcyHandler::CLASS_NAME( "CFBamSaxLoaderISOCcyHandler" );
	const std::string CFBamSaxLoaderISOCcyHandler::S_True( "true" );
	const std::string CFBamSaxLoaderISOCcyHandler::S_False( "false" );
	const std::string CFBamSaxLoaderISOCcyHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderISOCcyHandler::S_No( "no" );
	const std::string CFBamSaxLoaderISOCcyHandler::S_0( "0" );
	const std::string CFBamSaxLoaderISOCcyHandler::S_1( "1" );

	CFBamSaxLoaderISOCcyHandler::CFBamSaxLoaderISOCcyHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderISOCcyHandler::~CFBamSaxLoaderISOCcyHandler() {
	}

	void CFBamSaxLoaderISOCcyHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderISOCcyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
