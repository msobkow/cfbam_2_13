...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusXMsgRspnTableBody
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusXMsgRspnTableBodyHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusXMsgRspnTableBodyHandler::CFBamSaxLoaderTableCPlusXMsgRspnTableBodyHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusXMsgRspnTableBodyHandler::~CFBamSaxLoaderTableCPlusXMsgRspnTableBodyHandler() {
	}

	void CFBamSaxLoaderTableCPlusXMsgRspnTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusXMsgRspnTableBody" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusXMsgRspnTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusXMsgRspnTableBody more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppXMsgRspnTableBodyNull() || origBuff->getOptionalCppXMsgRspnTableBodyValue().empty() ) {
			editBuff->setOptionalCppXMsgRspnTableBodyValue( attrText );
		}
		else {
