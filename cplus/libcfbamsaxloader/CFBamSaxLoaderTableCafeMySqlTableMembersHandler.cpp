...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeMySqlTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeMySqlTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeMySqlTableMembersHandler::CFBamSaxLoaderTableCafeMySqlTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeMySqlTableMembersHandler::~CFBamSaxLoaderTableCafeMySqlTableMembersHandler() {
	}

	void CFBamSaxLoaderTableCafeMySqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeMySqlTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeMySqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeMySqlTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJMySqlTableMembersNull() || origBuff->getOptionalJMySqlTableMembersValue().empty() ) {
			editBuff->setOptionalJMySqlTableMembersValue( attrText );
		}
		else {
