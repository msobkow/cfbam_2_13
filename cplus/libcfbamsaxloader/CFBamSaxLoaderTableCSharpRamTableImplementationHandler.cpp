...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpRamTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpRamTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpRamTableImplementationHandler::CFBamSaxLoaderTableCSharpRamTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpRamTableImplementationHandler::~CFBamSaxLoaderTableCSharpRamTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableCSharpRamTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpRamTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpRamTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpRamTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsRamTableImplementationNull() || origBuff->getOptionalCsRamTableImplementationValue().empty() ) {
			editBuff->setOptionalCsRamTableImplementationValue( attrText );
		}
		else {
