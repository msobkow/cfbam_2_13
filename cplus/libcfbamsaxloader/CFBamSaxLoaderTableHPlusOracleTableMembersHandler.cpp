...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusOracleTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusOracleTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusOracleTableMembersHandler::CFBamSaxLoaderTableHPlusOracleTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusOracleTableMembersHandler::~CFBamSaxLoaderTableHPlusOracleTableMembersHandler() {
	}

	void CFBamSaxLoaderTableHPlusOracleTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusOracleTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusOracleTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusOracleTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppOracleTableMembersNull() || origBuff->getOptionalHppOracleTableMembersValue().empty() ) {
			editBuff->setOptionalHppOracleTableMembersValue( attrText );
		}
		else {
