...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusXMsgTableFormatters
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusXMsgTableFormattersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusXMsgTableFormattersHandler::CFBamSaxLoaderTableCPlusXMsgTableFormattersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusXMsgTableFormattersHandler::~CFBamSaxLoaderTableCPlusXMsgTableFormattersHandler() {
	}

	void CFBamSaxLoaderTableCPlusXMsgTableFormattersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusXMsgTableFormatters" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusXMsgTableFormattersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusXMsgTableFormatters more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppXMsgTableFormattersNull() || origBuff->getOptionalCppXMsgTableFormattersValue().empty() ) {
			editBuff->setOptionalCppXMsgTableFormattersValue( attrText );
		}
		else {
