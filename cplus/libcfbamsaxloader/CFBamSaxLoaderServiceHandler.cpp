...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderServiceHandler::CLASS_NAME( "CFBamSaxLoaderServiceHandler" );
	const std::string CFBamSaxLoaderServiceHandler::S_True( "true" );
	const std::string CFBamSaxLoaderServiceHandler::S_False( "false" );
	const std::string CFBamSaxLoaderServiceHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderServiceHandler::S_No( "no" );
	const std::string CFBamSaxLoaderServiceHandler::S_0( "0" );
	const std::string CFBamSaxLoaderServiceHandler::S_1( "1" );

	CFBamSaxLoaderServiceHandler::CFBamSaxLoaderServiceHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderServiceHandler::~CFBamSaxLoaderServiceHandler() {
	}

	void CFBamSaxLoaderServiceHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderServiceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
