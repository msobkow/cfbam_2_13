...
// Description: C++18 XML SAX2 Element Handler implementation for Id64Gen
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderId64GenHandler::CLASS_NAME( "CFBamSaxLoaderId64GenHandler" );
	const std::string CFBamSaxLoaderId64GenHandler::S_True( "true" );
	const std::string CFBamSaxLoaderId64GenHandler::S_False( "false" );
	const std::string CFBamSaxLoaderId64GenHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderId64GenHandler::S_No( "no" );
	const std::string CFBamSaxLoaderId64GenHandler::S_0( "0" );
	const std::string CFBamSaxLoaderId64GenHandler::S_1( "1" );

	CFBamSaxLoaderId64GenHandler::CFBamSaxLoaderId64GenHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderId64GenHandler::~CFBamSaxLoaderId64GenHandler() {
	}

	void CFBamSaxLoaderId64GenHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamId64GenObj* tmpBuff = NULL;
		cfbam::ICFBamId64GenEditObj* editBuff = NULL;
		cfbam::ICFBamId64GenEditObj* editId64Gen = NULL;
		cfbam::ICFBamId64GenObj* origId64Gen = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamId64GenBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamId64GenBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getId64GenTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamId64GenEditObj*>( tmpBuff->beginEdit() );
			...
			natBlockSize = cflib::CFLibXmlUtil::evalInt64( *attrBlockSize );
			...
			loaderBehaviour = saxLoader->getId64GenLoaderBehaviour();
			origId64Gen = dynamic_cast<cfbam::ICFBamId64GenObj*>( schemaObj->getId64GenTableObj()->readId64GenByUNameIdx( refTenant->getRequiredId(),
			...
			if( origId64Gen == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editId64Gen = dynamic_cast<cfbam::ICFBamId64GenEditObj*>( origId64Gen->beginEdit() );
						editId64Gen->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editId64Gen->setOptionalShortNameNull();
						}
						else {
							editId64Gen->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editId64Gen->setOptionalLabelNull();
						}
						else {
							editId64Gen->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editId64Gen->setOptionalShortDescriptionNull();
						}
						else {
							editId64Gen->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editId64Gen->setOptionalDescriptionNull();
						}
						else {
							editId64Gen->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editId64Gen->setOptionalDefaultXmlValueNull();
						}
						else {
							editId64Gen->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editId64Gen->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editId64Gen->setOptionalGenerateIdNull();
						}
						else {
							editId64Gen->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editId64Gen->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editId64Gen->setOptionalDbNameNull();
						}
						else {
							editId64Gen->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editId64Gen->setOptionalInitValueNull();
						}
						else {
							editId64Gen->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editId64Gen->setOptionalMinValueNull();
						}
						else {
							editId64Gen->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editId64Gen->setOptionalMaxValueNull();
						}
						else {
							editId64Gen->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editId64Gen != NULL ) {
				if( origId64Gen != NULL ) {
					...
					origId64Gen = dynamic_cast<cfbam::ICFBamId64GenObj*>( editId64Gen->create() );
				}
				editId64Gen = NULL;
			}
...
cleanup:
	...
	void CFBamSaxLoaderId64GenHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
