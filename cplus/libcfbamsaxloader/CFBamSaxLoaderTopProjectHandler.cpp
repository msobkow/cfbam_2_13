...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTopProjectHandler::CLASS_NAME( "CFBamSaxLoaderTopProjectHandler" );
	const std::string CFBamSaxLoaderTopProjectHandler::S_True( "true" );
	const std::string CFBamSaxLoaderTopProjectHandler::S_False( "false" );
	const std::string CFBamSaxLoaderTopProjectHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderTopProjectHandler::S_No( "no" );
	const std::string CFBamSaxLoaderTopProjectHandler::S_0( "0" );
	const std::string CFBamSaxLoaderTopProjectHandler::S_1( "1" );

	CFBamSaxLoaderTopProjectHandler::CFBamSaxLoaderTopProjectHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTopProjectHandler::~CFBamSaxLoaderTopProjectHandler() {
	}

	void CFBamSaxLoaderTopProjectHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderTopProjectHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
