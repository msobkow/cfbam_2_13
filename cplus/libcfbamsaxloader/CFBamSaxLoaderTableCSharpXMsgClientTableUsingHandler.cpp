...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpXMsgClientTableUsing
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpXMsgClientTableUsingHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpXMsgClientTableUsingHandler::CFBamSaxLoaderTableCSharpXMsgClientTableUsingHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpXMsgClientTableUsingHandler::~CFBamSaxLoaderTableCSharpXMsgClientTableUsingHandler() {
	}

	void CFBamSaxLoaderTableCSharpXMsgClientTableUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpXMsgClientTableUsing" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpXMsgClientTableUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpXMsgClientTableUsing more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsXMsgClientTableUsingNull() || origBuff->getOptionalCsXMsgClientTableUsingValue().empty() ) {
			editBuff->setOptionalCsXMsgClientTableUsingValue( attrText );
		}
		else {
