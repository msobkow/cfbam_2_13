...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpTableImplementationHandler::CFBamSaxLoaderTableCSharpTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpTableImplementationHandler::~CFBamSaxLoaderTableCSharpTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableCSharpTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsTableImplementationNull() || origBuff->getOptionalCsTableImplementationValue().empty() ) {
			editBuff->setOptionalCsTableImplementationValue( attrText );
		}
		else {
