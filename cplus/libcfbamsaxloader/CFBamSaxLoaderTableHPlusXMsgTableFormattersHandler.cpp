...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusXMsgTableFormatters
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusXMsgTableFormattersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusXMsgTableFormattersHandler::CFBamSaxLoaderTableHPlusXMsgTableFormattersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusXMsgTableFormattersHandler::~CFBamSaxLoaderTableHPlusXMsgTableFormattersHandler() {
	}

	void CFBamSaxLoaderTableHPlusXMsgTableFormattersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusXMsgTableFormatters" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusXMsgTableFormattersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusXMsgTableFormatters more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppXMsgTableFormattersNull() || origBuff->getOptionalHppXMsgTableFormattersValue().empty() ) {
			editBuff->setOptionalHppXMsgTableFormattersValue( attrText );
		}
		else {
