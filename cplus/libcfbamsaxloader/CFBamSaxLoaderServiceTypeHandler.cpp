...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderServiceTypeHandler::CLASS_NAME( "CFBamSaxLoaderServiceTypeHandler" );
	const std::string CFBamSaxLoaderServiceTypeHandler::S_True( "true" );
	const std::string CFBamSaxLoaderServiceTypeHandler::S_False( "false" );
	const std::string CFBamSaxLoaderServiceTypeHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderServiceTypeHandler::S_No( "no" );
	const std::string CFBamSaxLoaderServiceTypeHandler::S_0( "0" );
	const std::string CFBamSaxLoaderServiceTypeHandler::S_1( "1" );

	CFBamSaxLoaderServiceTypeHandler::CFBamSaxLoaderServiceTypeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderServiceTypeHandler::~CFBamSaxLoaderServiceTypeHandler() {
	}

	void CFBamSaxLoaderServiceTypeHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderServiceTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
