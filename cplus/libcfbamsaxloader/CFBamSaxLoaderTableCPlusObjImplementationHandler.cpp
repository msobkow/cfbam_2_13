...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusObjImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusObjImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusObjImplementationHandler::CFBamSaxLoaderTableCPlusObjImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusObjImplementationHandler::~CFBamSaxLoaderTableCPlusObjImplementationHandler() {
	}

	void CFBamSaxLoaderTableCPlusObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusObjImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusObjImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppObjImplementationNull() || origBuff->getOptionalCppObjImplementationValue().empty() ) {
			editBuff->setOptionalCppObjImplementationValue( attrText );
		}
		else {
