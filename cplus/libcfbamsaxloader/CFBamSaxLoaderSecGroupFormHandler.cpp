...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderSecGroupFormHandler::CLASS_NAME( "CFBamSaxLoaderSecGroupFormHandler" );
	const std::string CFBamSaxLoaderSecGroupFormHandler::S_True( "true" );
	const std::string CFBamSaxLoaderSecGroupFormHandler::S_False( "false" );
	const std::string CFBamSaxLoaderSecGroupFormHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderSecGroupFormHandler::S_No( "no" );
	const std::string CFBamSaxLoaderSecGroupFormHandler::S_0( "0" );
	const std::string CFBamSaxLoaderSecGroupFormHandler::S_1( "1" );

	CFBamSaxLoaderSecGroupFormHandler::CFBamSaxLoaderSecGroupFormHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderSecGroupFormHandler::~CFBamSaxLoaderSecGroupFormHandler() {
	}

	void CFBamSaxLoaderSecGroupFormHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderSecGroupFormHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
