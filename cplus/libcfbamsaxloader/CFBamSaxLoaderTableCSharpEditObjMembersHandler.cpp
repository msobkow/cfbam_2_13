...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpEditObjMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpEditObjMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpEditObjMembersHandler::CFBamSaxLoaderTableCSharpEditObjMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpEditObjMembersHandler::~CFBamSaxLoaderTableCSharpEditObjMembersHandler() {
	}

	void CFBamSaxLoaderTableCSharpEditObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpEditObjMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpEditObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpEditObjMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsEditObjMembersNull() || origBuff->getOptionalCsEditObjMembersValue().empty() ) {
			editBuff->setOptionalCsEditObjMembersValue( attrText );
		}
		else {
