...
// Description: C++18 XML SAX2 Element Handler implementation for NmTokensCol
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderNmTokensColHandler::CLASS_NAME( "CFBamSaxLoaderNmTokensColHandler" );
	const std::string CFBamSaxLoaderNmTokensColHandler::S_True( "true" );
	const std::string CFBamSaxLoaderNmTokensColHandler::S_False( "false" );
	const std::string CFBamSaxLoaderNmTokensColHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderNmTokensColHandler::S_No( "no" );
	const std::string CFBamSaxLoaderNmTokensColHandler::S_0( "0" );
	const std::string CFBamSaxLoaderNmTokensColHandler::S_1( "1" );

	CFBamSaxLoaderNmTokensColHandler::CFBamSaxLoaderNmTokensColHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderNmTokensColHandler::~CFBamSaxLoaderNmTokensColHandler() {
	}

	void CFBamSaxLoaderNmTokensColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamNmTokensColObj* tmpBuff = NULL;
		cfbam::ICFBamNmTokensColEditObj* editBuff = NULL;
		cfbam::ICFBamNmTokensColEditObj* editNmTokensCol = NULL;
		cfbam::ICFBamNmTokensColObj* origNmTokensCol = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamNmTokensColBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamNmTokensColBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getNmTokensColTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamNmTokensColEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getNmTokensColLoaderBehaviour();
			origNmTokensCol = dynamic_cast<cfbam::ICFBamNmTokensColObj*>( schemaObj->getNmTokensColTableObj()->readNmTokensColByUNameIdx( refTenant->getRequiredId(),
			...
			if( origNmTokensCol == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editNmTokensCol = dynamic_cast<cfbam::ICFBamNmTokensColEditObj*>( origNmTokensCol->beginEdit() );
						editNmTokensCol->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editNmTokensCol->setOptionalShortNameNull();
						}
						else {
							editNmTokensCol->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editNmTokensCol->setOptionalLabelNull();
						}
						else {
							editNmTokensCol->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editNmTokensCol->setOptionalShortDescriptionNull();
						}
						else {
							editNmTokensCol->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editNmTokensCol->setOptionalDescriptionNull();
						}
						else {
							editNmTokensCol->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editNmTokensCol->setOptionalDefaultXmlValueNull();
						}
						else {
							editNmTokensCol->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editNmTokensCol->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editNmTokensCol->setOptionalGenerateIdNull();
						}
						else {
							editNmTokensCol->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editNmTokensCol->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editNmTokensCol->setOptionalDbNameNull();
						}
						else {
							editNmTokensCol->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						editNmTokensCol->setRequiredMaxLen( editBuff->getRequiredMaxLen() );
						if( editBuff->isOptionalInitValueNull() ) {
							editNmTokensCol->setOptionalInitValueNull();
						}
						else {
							editNmTokensCol->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
			...
			if( editNmTokensCol != NULL ) {
				if( origNmTokensCol != NULL ) {
					...
					origNmTokensCol = dynamic_cast<cfbam::ICFBamNmTokensColObj*>( editNmTokensCol->create() );
				}
				editNmTokensCol = NULL;
			}
			...
			curContext->setObj( origNmTokensCol );
...
cleanup:
	...
	void CFBamSaxLoaderNmTokensColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
