...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeTableInterface
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeTableInterfaceHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeTableInterfaceHandler::CFBamSaxLoaderTableCafeTableInterfaceHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeTableInterfaceHandler::~CFBamSaxLoaderTableCafeTableInterfaceHandler() {
	}

	void CFBamSaxLoaderTableCafeTableInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeTableInterface" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeTableInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeTableInterface more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJTableInterfaceNull() || origBuff->getOptionalJTableInterfaceValue().empty() ) {
			editBuff->setOptionalJTableInterfaceValue( attrText );
		}
		else {
