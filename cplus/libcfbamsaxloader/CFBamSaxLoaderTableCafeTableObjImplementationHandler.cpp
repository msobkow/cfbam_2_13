...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeTableObjImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeTableObjImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeTableObjImplementationHandler::CFBamSaxLoaderTableCafeTableObjImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeTableObjImplementationHandler::~CFBamSaxLoaderTableCafeTableObjImplementationHandler() {
	}

	void CFBamSaxLoaderTableCafeTableObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeTableObjImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeTableObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeTableObjImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJTableObjImplementationNull() || origBuff->getOptionalJTableObjImplementationValue().empty() ) {
			editBuff->setOptionalJTableObjImplementationValue( attrText );
		}
		else {
