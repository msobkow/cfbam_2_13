...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderISOTZoneHandler::CLASS_NAME( "CFBamSaxLoaderISOTZoneHandler" );
	const std::string CFBamSaxLoaderISOTZoneHandler::S_True( "true" );
	const std::string CFBamSaxLoaderISOTZoneHandler::S_False( "false" );
	const std::string CFBamSaxLoaderISOTZoneHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderISOTZoneHandler::S_No( "no" );
	const std::string CFBamSaxLoaderISOTZoneHandler::S_0( "0" );
	const std::string CFBamSaxLoaderISOTZoneHandler::S_1( "1" );

	CFBamSaxLoaderISOTZoneHandler::CFBamSaxLoaderISOTZoneHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderISOTZoneHandler::~CFBamSaxLoaderISOTZoneHandler() {
	}

	void CFBamSaxLoaderISOTZoneHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderISOTZoneHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
