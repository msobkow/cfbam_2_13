...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusMSSqlTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusMSSqlTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusMSSqlTableMembersHandler::CFBamSaxLoaderTableCPlusMSSqlTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusMSSqlTableMembersHandler::~CFBamSaxLoaderTableCPlusMSSqlTableMembersHandler() {
	}

	void CFBamSaxLoaderTableCPlusMSSqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusMSSqlTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusMSSqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusMSSqlTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppMSSqlTableMembersNull() || origBuff->getOptionalCppMSSqlTableMembersValue().empty() ) {
			editBuff->setOptionalCppMSSqlTableMembersValue( attrText );
		}
		else {
