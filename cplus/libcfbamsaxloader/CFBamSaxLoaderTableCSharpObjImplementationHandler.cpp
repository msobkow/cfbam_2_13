...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpObjImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpObjImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpObjImplementationHandler::CFBamSaxLoaderTableCSharpObjImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpObjImplementationHandler::~CFBamSaxLoaderTableCSharpObjImplementationHandler() {
	}

	void CFBamSaxLoaderTableCSharpObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpObjImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpObjImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsObjImplementationNull() || origBuff->getOptionalCsObjImplementationValue().empty() ) {
			editBuff->setOptionalCsObjImplementationValue( attrText );
		}
		else {
