...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafePgSqlTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafePgSqlTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafePgSqlTableMembersHandler::CFBamSaxLoaderTableCafePgSqlTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafePgSqlTableMembersHandler::~CFBamSaxLoaderTableCafePgSqlTableMembersHandler() {
	}

	void CFBamSaxLoaderTableCafePgSqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafePgSqlTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafePgSqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafePgSqlTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJPgSqlTableMembersNull() || origBuff->getOptionalJPgSqlTableMembersValue().empty() ) {
			editBuff->setOptionalJPgSqlTableMembersValue( attrText );
		}
		else {
