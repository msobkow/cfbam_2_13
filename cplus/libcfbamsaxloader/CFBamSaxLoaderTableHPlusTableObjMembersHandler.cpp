...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusTableObjMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusTableObjMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusTableObjMembersHandler::CFBamSaxLoaderTableHPlusTableObjMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusTableObjMembersHandler::~CFBamSaxLoaderTableHPlusTableObjMembersHandler() {
	}

	void CFBamSaxLoaderTableHPlusTableObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusTableObjMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusTableObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusTableObjMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppTableObjMembersNull() || origBuff->getOptionalHppTableObjMembersValue().empty() ) {
			editBuff->setOptionalHppTableObjMembersValue( attrText );
		}
		else {
