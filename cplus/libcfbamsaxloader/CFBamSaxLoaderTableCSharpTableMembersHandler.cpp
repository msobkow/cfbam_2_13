...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpTableMembersHandler::CFBamSaxLoaderTableCSharpTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpTableMembersHandler::~CFBamSaxLoaderTableCSharpTableMembersHandler() {
	}

	void CFBamSaxLoaderTableCSharpTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsTableMembersNull() || origBuff->getOptionalCsTableMembersValue().empty() ) {
			editBuff->setOptionalCsTableMembersValue( attrText );
		}
		else {
