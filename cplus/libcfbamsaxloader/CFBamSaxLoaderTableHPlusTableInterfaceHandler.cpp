...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusTableInterface
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusTableInterfaceHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusTableInterfaceHandler::CFBamSaxLoaderTableHPlusTableInterfaceHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusTableInterfaceHandler::~CFBamSaxLoaderTableHPlusTableInterfaceHandler() {
	}

	void CFBamSaxLoaderTableHPlusTableInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusTableInterface" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusTableInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusTableInterface more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppTableInterfaceNull() || origBuff->getOptionalHppTableInterfaceValue().empty() ) {
			editBuff->setOptionalHppTableInterfaceValue( attrText );
		}
		else {
