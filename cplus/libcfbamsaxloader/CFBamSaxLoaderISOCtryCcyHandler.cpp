...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderISOCtryCcyHandler::CLASS_NAME( "CFBamSaxLoaderISOCtryCcyHandler" );
	const std::string CFBamSaxLoaderISOCtryCcyHandler::S_True( "true" );
	const std::string CFBamSaxLoaderISOCtryCcyHandler::S_False( "false" );
	const std::string CFBamSaxLoaderISOCtryCcyHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderISOCtryCcyHandler::S_No( "no" );
	const std::string CFBamSaxLoaderISOCtryCcyHandler::S_0( "0" );
	const std::string CFBamSaxLoaderISOCtryCcyHandler::S_1( "1" );

	CFBamSaxLoaderISOCtryCcyHandler::CFBamSaxLoaderISOCtryCcyHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderISOCtryCcyHandler::~CFBamSaxLoaderISOCtryCcyHandler() {
	}

	void CFBamSaxLoaderISOCtryCcyHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderISOCtryCcyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
