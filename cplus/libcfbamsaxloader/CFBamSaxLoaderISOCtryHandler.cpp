...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderISOCtryHandler::CLASS_NAME( "CFBamSaxLoaderISOCtryHandler" );
	const std::string CFBamSaxLoaderISOCtryHandler::S_True( "true" );
	const std::string CFBamSaxLoaderISOCtryHandler::S_False( "false" );
	const std::string CFBamSaxLoaderISOCtryHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderISOCtryHandler::S_No( "no" );
	const std::string CFBamSaxLoaderISOCtryHandler::S_0( "0" );
	const std::string CFBamSaxLoaderISOCtryHandler::S_1( "1" );

	CFBamSaxLoaderISOCtryHandler::CFBamSaxLoaderISOCtryHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderISOCtryHandler::~CFBamSaxLoaderISOCtryHandler() {
	}

	void CFBamSaxLoaderISOCtryHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderISOCtryHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
