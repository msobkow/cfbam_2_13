...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeEditObjMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeEditObjMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeEditObjMembersHandler::CFBamSaxLoaderTableCafeEditObjMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeEditObjMembersHandler::~CFBamSaxLoaderTableCafeEditObjMembersHandler() {
	}

	void CFBamSaxLoaderTableCafeEditObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeEditObjMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeEditObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeEditObjMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJEditObjMembersNull() || origBuff->getOptionalJEditObjMembersValue().empty() ) {
			editBuff->setOptionalJEditObjMembersValue( attrText );
		}
		else {
