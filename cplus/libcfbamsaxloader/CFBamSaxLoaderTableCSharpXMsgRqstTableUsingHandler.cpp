...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpXMsgRqstTableUsing
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpXMsgRqstTableUsingHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpXMsgRqstTableUsingHandler::CFBamSaxLoaderTableCSharpXMsgRqstTableUsingHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpXMsgRqstTableUsingHandler::~CFBamSaxLoaderTableCSharpXMsgRqstTableUsingHandler() {
	}

	void CFBamSaxLoaderTableCSharpXMsgRqstTableUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpXMsgRqstTableUsing" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpXMsgRqstTableUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpXMsgRqstTableUsing more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsXMsgRqstTableUsingNull() || origBuff->getOptionalCsXMsgRqstTableUsingValue().empty() ) {
			editBuff->setOptionalCsXMsgRqstTableUsingValue( attrText );
		}
		else {
