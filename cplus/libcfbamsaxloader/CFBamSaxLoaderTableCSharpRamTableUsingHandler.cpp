...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpRamTableUsing
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpRamTableUsingHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpRamTableUsingHandler::CFBamSaxLoaderTableCSharpRamTableUsingHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpRamTableUsingHandler::~CFBamSaxLoaderTableCSharpRamTableUsingHandler() {
	}

	void CFBamSaxLoaderTableCSharpRamTableUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpRamTableUsing" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpRamTableUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpRamTableUsing more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsRamTableUsingNull() || origBuff->getOptionalCsRamTableUsingValue().empty() ) {
			editBuff->setOptionalCsRamTableUsingValue( attrText );
		}
		else {
