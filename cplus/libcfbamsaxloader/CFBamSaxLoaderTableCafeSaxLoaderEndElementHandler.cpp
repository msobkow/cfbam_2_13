...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeSaxLoaderEndElement
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeSaxLoaderEndElementHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeSaxLoaderEndElementHandler::CFBamSaxLoaderTableCafeSaxLoaderEndElementHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeSaxLoaderEndElementHandler::~CFBamSaxLoaderTableCafeSaxLoaderEndElementHandler() {
	}

	void CFBamSaxLoaderTableCafeSaxLoaderEndElementHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeSaxLoaderEndElement" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeSaxLoaderEndElementHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeSaxLoaderEndElement more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJSaxLoaderEndElementNull() || origBuff->getOptionalJSaxLoaderEndElementValue().empty() ) {
			editBuff->setOptionalJSaxLoaderEndElementValue( attrText );
		}
		else {
