...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeOracleTableImport
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeOracleTableImportHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeOracleTableImportHandler::CFBamSaxLoaderTableCafeOracleTableImportHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeOracleTableImportHandler::~CFBamSaxLoaderTableCafeOracleTableImportHandler() {
	}

	void CFBamSaxLoaderTableCafeOracleTableImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeOracleTableImport" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeOracleTableImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeOracleTableImport more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJOracleTableImportNull() || origBuff->getOptionalJOracleTableImportValue().empty() ) {
			editBuff->setOptionalJOracleTableImportValue( attrText );
		}
		else {
