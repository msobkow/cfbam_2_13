...
// Description: C++18 XML SAX2 Element Handler implementation for UInt16Col
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderUInt16ColHandler::CLASS_NAME( "CFBamSaxLoaderUInt16ColHandler" );
	const std::string CFBamSaxLoaderUInt16ColHandler::S_True( "true" );
	const std::string CFBamSaxLoaderUInt16ColHandler::S_False( "false" );
	const std::string CFBamSaxLoaderUInt16ColHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderUInt16ColHandler::S_No( "no" );
	const std::string CFBamSaxLoaderUInt16ColHandler::S_0( "0" );
	const std::string CFBamSaxLoaderUInt16ColHandler::S_1( "1" );

	CFBamSaxLoaderUInt16ColHandler::CFBamSaxLoaderUInt16ColHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderUInt16ColHandler::~CFBamSaxLoaderUInt16ColHandler() {
	}

	void CFBamSaxLoaderUInt16ColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamUInt16ColObj* tmpBuff = NULL;
		cfbam::ICFBamUInt16ColEditObj* editBuff = NULL;
		cfbam::ICFBamUInt16ColEditObj* editUInt16Col = NULL;
		cfbam::ICFBamUInt16ColObj* origUInt16Col = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamUInt16ColBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamUInt16ColBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getUInt16ColTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamUInt16ColEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getUInt16ColLoaderBehaviour();
			origUInt16Col = dynamic_cast<cfbam::ICFBamUInt16ColObj*>( schemaObj->getUInt16ColTableObj()->readUInt16ColByUNameIdx( refTenant->getRequiredId(),
			...
			if( origUInt16Col == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editUInt16Col = dynamic_cast<cfbam::ICFBamUInt16ColEditObj*>( origUInt16Col->beginEdit() );
						editUInt16Col->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editUInt16Col->setOptionalShortNameNull();
						}
						else {
							editUInt16Col->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editUInt16Col->setOptionalLabelNull();
						}
						else {
							editUInt16Col->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editUInt16Col->setOptionalShortDescriptionNull();
						}
						else {
							editUInt16Col->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editUInt16Col->setOptionalDescriptionNull();
						}
						else {
							editUInt16Col->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editUInt16Col->setOptionalDefaultXmlValueNull();
						}
						else {
							editUInt16Col->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editUInt16Col->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editUInt16Col->setOptionalGenerateIdNull();
						}
						else {
							editUInt16Col->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editUInt16Col->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editUInt16Col->setOptionalDbNameNull();
						}
						else {
							editUInt16Col->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editUInt16Col->setOptionalInitValueNull();
						}
						else {
							editUInt16Col->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editUInt16Col->setOptionalMinValueNull();
						}
						else {
							editUInt16Col->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editUInt16Col->setOptionalMaxValueNull();
						}
						else {
							editUInt16Col->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editUInt16Col != NULL ) {
				if( origUInt16Col != NULL ) {
					...
					origUInt16Col = dynamic_cast<cfbam::ICFBamUInt16ColObj*>( editUInt16Col->create() );
				}
				editUInt16Col = NULL;
			}
			...
			curContext->setObj( origUInt16Col );
...
cleanup:
	...
	void CFBamSaxLoaderUInt16ColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
