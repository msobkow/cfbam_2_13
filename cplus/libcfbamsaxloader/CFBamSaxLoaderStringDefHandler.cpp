...
// Description: C++18 XML SAX2 Element Handler implementation for StringDef
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderStringDefHandler::CLASS_NAME( "CFBamSaxLoaderStringDefHandler" );
	const std::string CFBamSaxLoaderStringDefHandler::S_True( "true" );
	const std::string CFBamSaxLoaderStringDefHandler::S_False( "false" );
	const std::string CFBamSaxLoaderStringDefHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderStringDefHandler::S_No( "no" );
	const std::string CFBamSaxLoaderStringDefHandler::S_0( "0" );
	const std::string CFBamSaxLoaderStringDefHandler::S_1( "1" );

	CFBamSaxLoaderStringDefHandler::CFBamSaxLoaderStringDefHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderStringDefHandler::~CFBamSaxLoaderStringDefHandler() {
	}

	void CFBamSaxLoaderStringDefHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamStringDefObj* tmpBuff = NULL;
		cfbam::ICFBamStringDefEditObj* editBuff = NULL;
		cfbam::ICFBamStringDefEditObj* editStringDef = NULL;
		cfbam::ICFBamStringDefObj* origStringDef = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamStringDefBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamStringDefBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getStringDefTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamStringDefEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getStringDefLoaderBehaviour();
			origStringDef = dynamic_cast<cfbam::ICFBamStringDefObj*>( schemaObj->getStringDefTableObj()->readStringDefByUNameIdx( refTenant->getRequiredId(),
			...
			if( origStringDef == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editStringDef = dynamic_cast<cfbam::ICFBamStringDefEditObj*>( origStringDef->beginEdit() );
						editStringDef->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editStringDef->setOptionalShortNameNull();
						}
						else {
							editStringDef->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editStringDef->setOptionalLabelNull();
						}
						else {
							editStringDef->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editStringDef->setOptionalShortDescriptionNull();
						}
						else {
							editStringDef->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editStringDef->setOptionalDescriptionNull();
						}
						else {
							editStringDef->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editStringDef->setOptionalDefaultXmlValueNull();
						}
						else {
							editStringDef->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editStringDef->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editStringDef->setOptionalGenerateIdNull();
						}
						else {
							editStringDef->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editStringDef->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editStringDef->setOptionalDbNameNull();
						}
						else {
							editStringDef->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						...
						if( editBuff->isOptionalInitValueNull() ) {
							editStringDef->setOptionalInitValueNull();
						}
						else {
							editStringDef->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
			...
			if( editStringDef != NULL ) {
				if( origStringDef != NULL ) {
					...
					origStringDef = dynamic_cast<cfbam::ICFBamStringDefObj*>( editStringDef->create() );
				}
				editStringDef = NULL;
			}
			...
			curContext->setObj( origStringDef );
...
cleanup:
	...
	void CFBamSaxLoaderStringDefHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
