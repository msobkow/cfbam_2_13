...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusMySqlTableInclude
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusMySqlTableIncludeHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusMySqlTableIncludeHandler::CFBamSaxLoaderTableCPlusMySqlTableIncludeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusMySqlTableIncludeHandler::~CFBamSaxLoaderTableCPlusMySqlTableIncludeHandler() {
	}

	void CFBamSaxLoaderTableCPlusMySqlTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusMySqlTableInclude" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusMySqlTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusMySqlTableInclude more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppMySqlTableIncludeNull() || origBuff->getOptionalCppMySqlTableIncludeValue().empty() ) {
			editBuff->setOptionalCppMySqlTableIncludeValue( attrText );
		}
		else {
