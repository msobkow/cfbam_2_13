...
// Description: C++18 XML SAX2 Element Handler implementation for UInt32Def
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderUInt32DefHandler::CLASS_NAME( "CFBamSaxLoaderUInt32DefHandler" );
	const std::string CFBamSaxLoaderUInt32DefHandler::S_True( "true" );
	const std::string CFBamSaxLoaderUInt32DefHandler::S_False( "false" );
	const std::string CFBamSaxLoaderUInt32DefHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderUInt32DefHandler::S_No( "no" );
	const std::string CFBamSaxLoaderUInt32DefHandler::S_0( "0" );
	const std::string CFBamSaxLoaderUInt32DefHandler::S_1( "1" );

	CFBamSaxLoaderUInt32DefHandler::CFBamSaxLoaderUInt32DefHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderUInt32DefHandler::~CFBamSaxLoaderUInt32DefHandler() {
	}

	void CFBamSaxLoaderUInt32DefHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamUInt32DefObj* tmpBuff = NULL;
		cfbam::ICFBamUInt32DefEditObj* editBuff = NULL;
		cfbam::ICFBamUInt32DefEditObj* editUInt32Def = NULL;
		cfbam::ICFBamUInt32DefObj* origUInt32Def = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamUInt32DefBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamUInt32DefBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getUInt32DefTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamUInt32DefEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getUInt32DefLoaderBehaviour();
			origUInt32Def = dynamic_cast<cfbam::ICFBamUInt32DefObj*>( schemaObj->getUInt32DefTableObj()->readUInt32DefByUNameIdx( refTenant->getRequiredId(),
			...
			if( origUInt32Def == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editUInt32Def = dynamic_cast<cfbam::ICFBamUInt32DefEditObj*>( origUInt32Def->beginEdit() );
						editUInt32Def->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editUInt32Def->setOptionalShortNameNull();
						}
						else {
							editUInt32Def->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editUInt32Def->setOptionalLabelNull();
						}
						else {
							editUInt32Def->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editUInt32Def->setOptionalShortDescriptionNull();
						}
						else {
							editUInt32Def->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editUInt32Def->setOptionalDescriptionNull();
						}
						else {
							editUInt32Def->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editUInt32Def->setOptionalDefaultXmlValueNull();
						}
						else {
							editUInt32Def->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editUInt32Def->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editUInt32Def->setOptionalGenerateIdNull();
						}
						else {
							editUInt32Def->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editUInt32Def->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editUInt32Def->setOptionalDbNameNull();
						}
						else {
							editUInt32Def->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editUInt32Def->setOptionalInitValueNull();
						}
						else {
							editUInt32Def->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editUInt32Def->setOptionalMinValueNull();
						}
						else {
							editUInt32Def->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editUInt32Def->setOptionalMaxValueNull();
						}
						else {
							editUInt32Def->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editUInt32Def != NULL ) {
				if( origUInt32Def != NULL ) {
					...
					origUInt32Def = dynamic_cast<cfbam::ICFBamUInt32DefObj*>( editUInt32Def->create() );
				}
				editUInt32Def = NULL;
			}
			...
			curContext->setObj( origUInt32Def );
...
cleanup:
	...
	void CFBamSaxLoaderUInt32DefHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
