...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusDb2LUWTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusDb2LUWTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusDb2LUWTableImplementationHandler::CFBamSaxLoaderTableHPlusDb2LUWTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusDb2LUWTableImplementationHandler::~CFBamSaxLoaderTableHPlusDb2LUWTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableHPlusDb2LUWTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusDb2LUWTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusDb2LUWTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusDb2LUWTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppDb2LUWTableImplementationNull() || origBuff->getOptionalHppDb2LUWTableImplementationValue().empty() ) {
			editBuff->setOptionalHppDb2LUWTableImplementationValue( attrText );
		}
		else {
