...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeMSSqlTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeMSSqlTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeMSSqlTableImplementationHandler::CFBamSaxLoaderTableCafeMSSqlTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeMSSqlTableImplementationHandler::~CFBamSaxLoaderTableCafeMSSqlTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableCafeMSSqlTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeMSSqlTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeMSSqlTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeMSSqlTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJMSSqlTableImplementationNull() || origBuff->getOptionalJMSSqlTableImplementationValue().empty() ) {
			editBuff->setOptionalJMSSqlTableImplementationValue( attrText );
		}
		else {
