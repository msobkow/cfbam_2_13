...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpEditObjUsing
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpEditObjUsingHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpEditObjUsingHandler::CFBamSaxLoaderTableCSharpEditObjUsingHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpEditObjUsingHandler::~CFBamSaxLoaderTableCSharpEditObjUsingHandler() {
	}

	void CFBamSaxLoaderTableCSharpEditObjUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpEditObjUsing" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpEditObjUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpEditObjUsing more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsEditObjUsingNull() || origBuff->getOptionalCsEditObjUsingValue().empty() ) {
			editBuff->setOptionalCsEditObjUsingValue( attrText );
		}
		else {
