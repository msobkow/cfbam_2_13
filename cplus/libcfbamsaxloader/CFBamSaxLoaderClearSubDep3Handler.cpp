...
// Description: C++18 XML SAX2 Element Handler implementation for ClearSubDep3
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderClearSubDep3Handler::CLASS_NAME( "CFBamSaxLoaderClearSubDep3Handler" );
	const std::string CFBamSaxLoaderClearSubDep3Handler::S_True( "true" );
	const std::string CFBamSaxLoaderClearSubDep3Handler::S_False( "false" );
	const std::string CFBamSaxLoaderClearSubDep3Handler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderClearSubDep3Handler::S_No( "no" );
	const std::string CFBamSaxLoaderClearSubDep3Handler::S_0( "0" );
	const std::string CFBamSaxLoaderClearSubDep3Handler::S_1( "1" );

	CFBamSaxLoaderClearSubDep3Handler::CFBamSaxLoaderClearSubDep3Handler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderClearSubDep3Handler::~CFBamSaxLoaderClearSubDep3Handler() {
	}

	void CFBamSaxLoaderClearSubDep3Handler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		static const std::string S_ClearSubDep2( "ClearSubDep2" );
		...
		cfbam::ICFBamClearSubDep3Obj* tmpBuff = NULL;
		cfbam::ICFBamClearSubDep3EditObj* editBuff = NULL;
		cfbam::ICFBamClearSubDep3EditObj* editClearSubDep3 = NULL;
		cfbam::ICFBamClearSubDep3Obj* origClearSubDep3 = NULL;
		...
		cfbam::ICFBamClearSubDep2Obj* refClearSubDep2 = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamClearSubDep3Buff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamClearSubDep3Buff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getClearSubDep3TableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamClearSubDep3EditObj*>( tmpBuff->beginEdit() );
			...
			else if( scopeObj->implementsClassCode( cfbam::CFBamClearSubDep2Buff::CLASS_CODE ) ) {
				refClearSubDep2 = dynamic_cast<cfbam::ICFBamClearSubDep2Obj*>( scopeObj );
			...
			editClearSubDep3 = editBuff;
			editBuff = NULL;
			origClearSubDep3 = dynamic_cast<cfbam::ICFBamClearSubDep3Obj*>( editClearSubDep3->create() );
			editClearSubDep3 = NULL;
			tmpBuff = NULL;

			curContext->setObj( origClearSubDep3 );
...
cleanup:
	...
	void CFBamSaxLoaderClearSubDep3Handler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
