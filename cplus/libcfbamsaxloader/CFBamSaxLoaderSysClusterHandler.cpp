...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderSysClusterHandler::CLASS_NAME( "CFBamSaxLoaderSysClusterHandler" );
	const std::string CFBamSaxLoaderSysClusterHandler::S_True( "true" );
	const std::string CFBamSaxLoaderSysClusterHandler::S_False( "false" );
	const std::string CFBamSaxLoaderSysClusterHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderSysClusterHandler::S_No( "no" );
	const std::string CFBamSaxLoaderSysClusterHandler::S_0( "0" );
	const std::string CFBamSaxLoaderSysClusterHandler::S_1( "1" );

	CFBamSaxLoaderSysClusterHandler::CFBamSaxLoaderSysClusterHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderSysClusterHandler::~CFBamSaxLoaderSysClusterHandler() {
	}

	void CFBamSaxLoaderSysClusterHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderSysClusterHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
