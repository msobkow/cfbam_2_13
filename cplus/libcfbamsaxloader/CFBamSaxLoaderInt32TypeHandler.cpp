...
// Description: C++18 XML SAX2 Element Handler implementation for Int32Type
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderInt32TypeHandler::CLASS_NAME( "CFBamSaxLoaderInt32TypeHandler" );
	const std::string CFBamSaxLoaderInt32TypeHandler::S_True( "true" );
	const std::string CFBamSaxLoaderInt32TypeHandler::S_False( "false" );
	const std::string CFBamSaxLoaderInt32TypeHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderInt32TypeHandler::S_No( "no" );
	const std::string CFBamSaxLoaderInt32TypeHandler::S_0( "0" );
	const std::string CFBamSaxLoaderInt32TypeHandler::S_1( "1" );

	CFBamSaxLoaderInt32TypeHandler::CFBamSaxLoaderInt32TypeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderInt32TypeHandler::~CFBamSaxLoaderInt32TypeHandler() {
	}

	void CFBamSaxLoaderInt32TypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamInt32TypeObj* tmpBuff = NULL;
		cfbam::ICFBamInt32TypeEditObj* editBuff = NULL;
		cfbam::ICFBamInt32TypeEditObj* editInt32Type = NULL;
		cfbam::ICFBamInt32TypeObj* origInt32Type = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamInt32TypeBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamInt32TypeBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getInt32TypeTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamInt32TypeEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getInt32TypeLoaderBehaviour();
			origInt32Type = dynamic_cast<cfbam::ICFBamInt32TypeObj*>( schemaObj->getInt32TypeTableObj()->readInt32TypeByUNameIdx( refTenant->getRequiredId(),
			...
			if( origInt32Type == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editInt32Type = dynamic_cast<cfbam::ICFBamInt32TypeEditObj*>( origInt32Type->beginEdit() );
						editInt32Type->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editInt32Type->setOptionalShortNameNull();
						}
						else {
							editInt32Type->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editInt32Type->setOptionalLabelNull();
						}
						else {
							editInt32Type->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editInt32Type->setOptionalShortDescriptionNull();
						}
						else {
							editInt32Type->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editInt32Type->setOptionalDescriptionNull();
						}
						else {
							editInt32Type->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editInt32Type->setOptionalDefaultXmlValueNull();
						}
						else {
							editInt32Type->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editInt32Type->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editInt32Type->setOptionalGenerateIdNull();
						}
						else {
							editInt32Type->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editInt32Type->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editInt32Type->setOptionalDbNameNull();
						}
						else {
							editInt32Type->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editInt32Type->setOptionalInitValueNull();
						}
						else {
							editInt32Type->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editInt32Type->setOptionalMinValueNull();
						}
						else {
							editInt32Type->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editInt32Type->setOptionalMaxValueNull();
						}
						else {
							editInt32Type->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editInt32Type != NULL ) {
				if( origInt32Type != NULL ) {
					...
					origInt32Type = dynamic_cast<cfbam::ICFBamInt32TypeObj*>( editInt32Type->create() );
				}
				editInt32Type = NULL;
			}
			...
			curContext->setObj( origInt32Type );
...
cleanup:
	...
	void CFBamSaxLoaderInt32TypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
