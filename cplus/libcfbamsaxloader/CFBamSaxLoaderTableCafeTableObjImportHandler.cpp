...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeTableObjImport
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeTableObjImportHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeTableObjImportHandler::CFBamSaxLoaderTableCafeTableObjImportHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeTableObjImportHandler::~CFBamSaxLoaderTableCafeTableObjImportHandler() {
	}

	void CFBamSaxLoaderTableCafeTableObjImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeTableObjImport" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeTableObjImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeTableObjImport more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJTableObjImportNull() || origBuff->getOptionalJTableObjImportValue().empty() ) {
			editBuff->setOptionalJTableObjImportValue( attrText );
		}
		else {
