...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeXMsgTableformatters
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeXMsgTableformattersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeXMsgTableformattersHandler::CFBamSaxLoaderTableCafeXMsgTableformattersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeXMsgTableformattersHandler::~CFBamSaxLoaderTableCafeXMsgTableformattersHandler() {
	}

	void CFBamSaxLoaderTableCafeXMsgTableformattersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeXMsgTableformatters" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeXMsgTableformattersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeXMsgTableformatters more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJXMsgTableFormattersNull() || origBuff->getOptionalJXMsgTableFormattersValue().empty() ) {
			editBuff->setOptionalJXMsgTableFormattersValue( attrText );
		}
		else {
