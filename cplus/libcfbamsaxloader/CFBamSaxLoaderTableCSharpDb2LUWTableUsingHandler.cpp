...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpDb2LUWTableUsing
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpDb2LUWTableUsingHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpDb2LUWTableUsingHandler::CFBamSaxLoaderTableCSharpDb2LUWTableUsingHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpDb2LUWTableUsingHandler::~CFBamSaxLoaderTableCSharpDb2LUWTableUsingHandler() {
	}

	void CFBamSaxLoaderTableCSharpDb2LUWTableUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpDb2LUWTableUsing" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpDb2LUWTableUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpDb2LUWTableUsing more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsDb2LUWTableUsingNull() || origBuff->getOptionalCsDb2LUWTableUsingValue().empty() ) {
			editBuff->setOptionalCsDb2LUWTableUsingValue( attrText );
		}
		else {
