...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusRamTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusRamTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusRamTableImplementationHandler::CFBamSaxLoaderTableHPlusRamTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusRamTableImplementationHandler::~CFBamSaxLoaderTableHPlusRamTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableHPlusRamTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusRamTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusRamTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusRamTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppRamTableImplementationNull() || origBuff->getOptionalHppRamTableImplementationValue().empty() ) {
			editBuff->setOptionalHppRamTableImplementationValue( attrText );
		}
		else {
