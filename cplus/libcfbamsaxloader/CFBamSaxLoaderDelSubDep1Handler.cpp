...
// Description: C++18 XML SAX2 Element Handler implementation for DelSubDep1
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderDelSubDep1Handler::CLASS_NAME( "CFBamSaxLoaderDelSubDep1Handler" );
	const std::string CFBamSaxLoaderDelSubDep1Handler::S_True( "true" );
	const std::string CFBamSaxLoaderDelSubDep1Handler::S_False( "false" );
	const std::string CFBamSaxLoaderDelSubDep1Handler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderDelSubDep1Handler::S_No( "no" );
	const std::string CFBamSaxLoaderDelSubDep1Handler::S_0( "0" );
	const std::string CFBamSaxLoaderDelSubDep1Handler::S_1( "1" );

	CFBamSaxLoaderDelSubDep1Handler::CFBamSaxLoaderDelSubDep1Handler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderDelSubDep1Handler::~CFBamSaxLoaderDelSubDep1Handler() {
	}

	void CFBamSaxLoaderDelSubDep1Handler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		static const std::string S_DelTopDep( "DelTopDep" );
		...
		cfbam::ICFBamDelSubDep1Obj* tmpBuff = NULL;
		cfbam::ICFBamDelSubDep1EditObj* editBuff = NULL;
		cfbam::ICFBamDelSubDep1EditObj* editDelSubDep1 = NULL;
		cfbam::ICFBamDelSubDep1Obj* origDelSubDep1 = NULL;
		...
		cfbam::ICFBamDelTopDepObj* refDelTopDep = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamDelSubDep1Buff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamDelSubDep1Buff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getDelSubDep1TableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamDelSubDep1EditObj*>( tmpBuff->beginEdit() );
			...
			else if( scopeObj->implementsClassCode( cfbam::CFBamDelTopDepBuff::CLASS_CODE ) ) {
				refDelTopDep = dynamic_cast<cfbam::ICFBamDelTopDepObj*>( scopeObj );
			...
			editDelSubDep1 = editBuff;
			editBuff = NULL;
			origDelSubDep1 = dynamic_cast<cfbam::ICFBamDelSubDep1Obj*>( editDelSubDep1->create() );
			editDelSubDep1 = NULL;
			tmpBuff = NULL;

			curContext->setObj( origDelSubDep1 );
...
cleanup:
	...
	void CFBamSaxLoaderDelSubDep1Handler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
