...
// Description: C++18 XML SAX2 Element Handler specification for TimestampDef
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderTimestampDefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderTimestampDefHandler();
