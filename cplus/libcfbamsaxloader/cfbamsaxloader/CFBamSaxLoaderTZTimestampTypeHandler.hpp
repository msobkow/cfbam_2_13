...
// Description: C++18 XML SAX2 Element Handler specification for TZTimestampType
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderTZTimestampTypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderTZTimestampTypeHandler();
