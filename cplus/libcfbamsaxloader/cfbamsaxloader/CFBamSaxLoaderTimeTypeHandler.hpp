...
// Description: C++18 XML SAX2 Element Handler specification for TimeType
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderTimeTypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderTimeTypeHandler();
