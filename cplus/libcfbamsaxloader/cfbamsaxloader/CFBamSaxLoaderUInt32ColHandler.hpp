...
// Description: C++18 XML SAX2 Element Handler specification for UInt32Col
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderUInt32ColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderUInt32ColHandler();
