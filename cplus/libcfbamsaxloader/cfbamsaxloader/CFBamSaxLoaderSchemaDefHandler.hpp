...
// Description: C++18 XML SAX2 Element Handler specification for SchemaDef
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderSchemaDefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderSchemaDefHandler();
