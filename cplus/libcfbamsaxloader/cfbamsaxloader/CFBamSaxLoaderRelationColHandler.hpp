...
// Description: C++18 XML SAX2 Element Handler specification for RelationCol
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderRelationColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderRelationColHandler();
