...
// Description: C++18 XML SAX2 Element Handler specification for PopSubDep2
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderPopSubDep2Handler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderPopSubDep2Handler();
