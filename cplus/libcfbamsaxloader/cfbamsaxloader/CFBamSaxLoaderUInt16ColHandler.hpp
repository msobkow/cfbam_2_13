...
// Description: C++18 XML SAX2 Element Handler specification for UInt16Col
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderUInt16ColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderUInt16ColHandler();
