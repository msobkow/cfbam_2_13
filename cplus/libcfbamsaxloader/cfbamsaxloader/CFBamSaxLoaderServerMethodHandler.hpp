...
// Description: C++18 XML SAX2 Element Handler specification for ServerMethod
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderServerMethodHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderServerMethodHandler();
