...
// Description: C++18 XML SAX2 Element Handler specification for TokenDef
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderTokenDefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderTokenDefHandler();
