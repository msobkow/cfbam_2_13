...
// Description: C++18 XML SAX2 Element Handler specification for Index
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderIndexHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderIndexHandler();
