...
// Description: C++18 XML SAX2 Element Handler specification for ClearSubDep1
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderClearSubDep1Handler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderClearSubDep1Handler();
