...
// Description: C++18 XML SAX2 Element Handler specification for NmTokensDef
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderNmTokensDefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderNmTokensDefHandler();
