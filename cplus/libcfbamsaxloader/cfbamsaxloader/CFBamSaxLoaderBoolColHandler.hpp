...
// Description: C++18 XML SAX2 Element Handler specification for BoolCol
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderBoolColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderBoolColHandler();
