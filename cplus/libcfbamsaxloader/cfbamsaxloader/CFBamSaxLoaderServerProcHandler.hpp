...
// Description: C++18 XML SAX2 Element Handler specification for ServerProc
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderServerProcHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderServerProcHandler();
