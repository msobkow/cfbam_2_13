...
// Description: C++18 XML SAX2 Element Handler specification for BlobCol
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderBlobColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderBlobColHandler();
