...
// Description: C++18 XML SAX2 Element Handler specification for TZTimestampCol
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderTZTimestampColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderTZTimestampColHandler();
