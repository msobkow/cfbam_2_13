...
// Description: C++18 XML SAX2 Element Handler specification for NumberType
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderNumberTypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderNumberTypeHandler();
