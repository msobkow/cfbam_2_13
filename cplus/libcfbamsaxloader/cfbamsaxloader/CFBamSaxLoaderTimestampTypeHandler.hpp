...
// Description: C++18 XML SAX2 Element Handler specification for TimestampType
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderTimestampTypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderTimestampTypeHandler();
