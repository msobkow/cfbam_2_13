...
// Description: C++18 XML SAX2 Element Handler specification for Table
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderTableHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderTableHandler();
