...
// Description: C++18 XML SAX2 Element Handler specification for DelSubDep3
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderDelSubDep3Handler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderDelSubDep3Handler();
