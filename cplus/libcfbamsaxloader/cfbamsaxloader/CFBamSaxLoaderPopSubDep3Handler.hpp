...
// Description: C++18 XML SAX2 Element Handler specification for PopSubDep3
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderPopSubDep3Handler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderPopSubDep3Handler();
