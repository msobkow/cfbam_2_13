...
// Description: C++18 XML SAX2 Element Handler specification for NmTokensCol
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderNmTokensColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderNmTokensColHandler();
