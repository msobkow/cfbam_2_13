...
// Description: C++18 XML SAX2 Element Handler specification for UInt32Type
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderUInt32TypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderUInt32TypeHandler();
