...
// Description: C++18 XML SAX2 Element Handler specification for UInt64Def
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderUInt64DefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderUInt64DefHandler();
