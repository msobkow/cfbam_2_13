...
// Description: C++18 XML SAX2 Element Handler specification for NmTokenDef
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderNmTokenDefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderNmTokenDefHandler();
