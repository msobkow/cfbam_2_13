...
// Description: C++18 XML SAX2 Element Handler specification for BlobType
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderBlobTypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderBlobTypeHandler();
