...
// Description: C++18 XML SAX2 Element Handler specification for DateDef
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderDateDefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderDateDefHandler();
