...
// Description: C++18 XML SAX2 Element Handler specification for DateType
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderDateTypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderDateTypeHandler();
