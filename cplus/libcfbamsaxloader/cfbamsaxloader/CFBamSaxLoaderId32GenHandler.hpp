...
// Description: C++18 XML SAX2 Element Handler specification for Id32Gen
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderId32GenHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderId32GenHandler();
