...
// Description: C++18 XML SAX2 Element Handler specification for Atom
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderAtomHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderAtomHandler();
