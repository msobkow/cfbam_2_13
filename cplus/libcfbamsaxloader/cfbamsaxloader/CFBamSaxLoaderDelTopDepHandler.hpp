...
// Description: C++18 XML SAX2 Element Handler specification for DelTopDep
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderDelTopDepHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderDelTopDepHandler();
