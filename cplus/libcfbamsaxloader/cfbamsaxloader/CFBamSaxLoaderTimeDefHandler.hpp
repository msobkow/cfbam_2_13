...
// Description: C++18 XML SAX2 Element Handler specification for TimeDef
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderTimeDefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderTimeDefHandler();
