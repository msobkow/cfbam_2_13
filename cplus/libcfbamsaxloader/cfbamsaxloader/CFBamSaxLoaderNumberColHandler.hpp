...
// Description: C++18 XML SAX2 Element Handler specification for NumberCol
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderNumberColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderNumberColHandler();
