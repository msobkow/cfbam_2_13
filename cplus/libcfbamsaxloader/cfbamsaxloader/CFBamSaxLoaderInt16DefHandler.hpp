...
// Description: C++18 XML SAX2 Element Handler specification for Int16Def
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderInt16DefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderInt16DefHandler();
