...
// Description: C++18 XML SAX2 Element Handler specification for ClearTopDep
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderClearTopDepHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderClearTopDepHandler();
