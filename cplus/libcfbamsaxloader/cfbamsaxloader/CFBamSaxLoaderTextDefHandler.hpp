...
// Description: C++18 XML SAX2 Element Handler specification for TextDef
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderTextDefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderTextDefHandler();
