...
// Description: C++18 XML SAX2 Element Handler specification for StringType
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderStringTypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderStringTypeHandler();
