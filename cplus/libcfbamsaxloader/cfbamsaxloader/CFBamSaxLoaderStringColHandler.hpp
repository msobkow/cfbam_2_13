...
// Description: C++18 XML SAX2 Element Handler specification for StringCol
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderStringColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderStringColHandler();
