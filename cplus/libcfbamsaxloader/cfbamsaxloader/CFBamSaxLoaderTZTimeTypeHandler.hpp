...
// Description: C++18 XML SAX2 Element Handler specification for TZTimeType
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderTZTimeTypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderTZTimeTypeHandler();
