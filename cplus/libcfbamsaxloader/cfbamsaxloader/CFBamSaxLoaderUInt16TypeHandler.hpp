...
// Description: C++18 XML SAX2 Element Handler specification for UInt16Type
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderUInt16TypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderUInt16TypeHandler();
