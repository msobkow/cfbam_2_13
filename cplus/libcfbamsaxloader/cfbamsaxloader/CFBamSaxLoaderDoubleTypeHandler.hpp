...
// Description: C++18 XML SAX2 Element Handler specification for DoubleType
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderDoubleTypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderDoubleTypeHandler();
