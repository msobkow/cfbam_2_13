...
// Description: C++18 XML SAX2 Element Handler specification for UInt64Col
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderUInt64ColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderUInt64ColHandler();
