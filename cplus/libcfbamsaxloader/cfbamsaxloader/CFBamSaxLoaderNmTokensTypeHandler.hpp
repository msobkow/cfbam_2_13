...
// Description: C++18 XML SAX2 Element Handler specification for NmTokensType
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderNmTokensTypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderNmTokensTypeHandler();
