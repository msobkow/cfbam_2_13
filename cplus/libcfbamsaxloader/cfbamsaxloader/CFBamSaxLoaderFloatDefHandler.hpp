...
// Description: C++18 XML SAX2 Element Handler specification for FloatDef
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderFloatDefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderFloatDefHandler();
