...
// Description: C++18 XML SAX2 Element Handler specification for Int16Type
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderInt16TypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderInt16TypeHandler();
