...
// Description: C++18 XML SAX2 Element Handler specification for TZTimeDef
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderTZTimeDefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderTZTimeDefHandler();
