...
// Description: C++18 XML SAX2 Element Handler specification for ServerObjFunc
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderServerObjFuncHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderServerObjFuncHandler();
