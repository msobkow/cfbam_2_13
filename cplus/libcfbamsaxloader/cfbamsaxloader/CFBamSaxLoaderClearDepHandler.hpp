...
// Description: C++18 XML SAX2 Element Handler specification for ClearDep
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderClearDepHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderClearDepHandler();
