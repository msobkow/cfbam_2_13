...
// Description: C++18 XML SAX2 Element Handler specification for DateCol
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderDateColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderDateColHandler();
