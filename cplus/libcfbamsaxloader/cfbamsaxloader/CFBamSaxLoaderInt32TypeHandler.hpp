...
// Description: C++18 XML SAX2 Element Handler specification for Int32Type
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderInt32TypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderInt32TypeHandler();
