...
// Description: C++18 XML SAX2 Element Handler specification for Int32Col
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderInt32ColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderInt32ColHandler();
