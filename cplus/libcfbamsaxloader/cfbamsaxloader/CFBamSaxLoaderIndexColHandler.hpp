...
// Description: C++18 XML SAX2 Element Handler specification for IndexCol
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderIndexColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderIndexColHandler();
