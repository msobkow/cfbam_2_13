...
// Description: C++18 XML SAX2 Element Handler specification for UuidGen
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderUuidGenHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderUuidGenHandler();
