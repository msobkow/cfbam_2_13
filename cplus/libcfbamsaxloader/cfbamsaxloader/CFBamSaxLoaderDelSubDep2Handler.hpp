...
// Description: C++18 XML SAX2 Element Handler specification for DelSubDep2
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderDelSubDep2Handler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderDelSubDep2Handler();
