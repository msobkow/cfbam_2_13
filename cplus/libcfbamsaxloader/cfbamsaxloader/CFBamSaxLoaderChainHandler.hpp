...
// Description: C++18 XML SAX2 Element Handler specification for Chain
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderChainHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderChainHandler();
