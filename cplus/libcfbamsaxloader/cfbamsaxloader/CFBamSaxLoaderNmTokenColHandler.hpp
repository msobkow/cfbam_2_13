...
// Description: C++18 XML SAX2 Element Handler specification for NmTokenCol
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderNmTokenColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderNmTokenColHandler();
