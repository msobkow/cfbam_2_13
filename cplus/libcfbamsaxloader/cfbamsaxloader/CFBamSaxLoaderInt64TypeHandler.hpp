...
// Description: C++18 XML SAX2 Element Handler specification for Int64Type
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderInt64TypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderInt64TypeHandler();
