...
// Description: C++18 XML SAX2 Element Handler specification for Int16Col
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderInt16ColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderInt16ColHandler();
