...
// Description: C++18 XML SAX2 Element Handler specification for NmTokenType
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderNmTokenTypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderNmTokenTypeHandler();
