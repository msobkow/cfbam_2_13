...
// Description: C++18 XML SAX2 Element Handler specification for Scope
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderScopeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderScopeHandler();
