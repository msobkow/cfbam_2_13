...
// Description: C++18 XML SAX2 Element Handler specification for DoubleDef
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderDoubleDefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderDoubleDefHandler();
