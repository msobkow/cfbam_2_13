...
// Description: C++18 XML SAX2 Element Handler specification for DelSubDep1
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderDelSubDep1Handler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderDelSubDep1Handler();
