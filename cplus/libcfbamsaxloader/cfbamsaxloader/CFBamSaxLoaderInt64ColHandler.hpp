...
// Description: C++18 XML SAX2 Element Handler specification for Int64Col
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderInt64ColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderInt64ColHandler();
