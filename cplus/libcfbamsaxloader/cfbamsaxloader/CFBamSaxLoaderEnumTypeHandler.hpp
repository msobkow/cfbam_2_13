...
// Description: C++18 XML SAX2 Element Handler specification for EnumType
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderEnumTypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderEnumTypeHandler();
