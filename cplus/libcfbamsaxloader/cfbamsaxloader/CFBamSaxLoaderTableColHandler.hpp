...
// Description: C++18 XML SAX2 Element Handler specification for TableCol
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderTableColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderTableColHandler();
