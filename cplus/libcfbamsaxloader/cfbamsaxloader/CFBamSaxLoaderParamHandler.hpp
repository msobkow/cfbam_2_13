...
// Description: C++18 XML SAX2 Element Handler specification for Param
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderParamHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderParamHandler();
