...
// Description: C++18 XML SAX2 Element Handler specification for TimestampCol
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderTimestampColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderTimestampColHandler();
