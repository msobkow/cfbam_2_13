...
// Description: C++18 XML SAX2 Element Handler specification for UInt32Def
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderUInt32DefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderUInt32DefHandler();
