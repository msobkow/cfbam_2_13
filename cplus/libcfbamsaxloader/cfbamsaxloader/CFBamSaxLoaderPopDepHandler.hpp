...
// Description: C++18 XML SAX2 Element Handler specification for PopDep
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderPopDepHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderPopDepHandler();
