...
// Description: C++18 XML SAX2 Element Handler specification for TZDateCol
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderTZDateColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderTZDateColHandler();
