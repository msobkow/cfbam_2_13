...
// Description: C++18 XML SAX2 Element Handler specification for DelDep
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderDelDepHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderDelDepHandler();
