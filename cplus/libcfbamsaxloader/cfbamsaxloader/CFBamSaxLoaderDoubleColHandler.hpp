...
// Description: C++18 XML SAX2 Element Handler specification for DoubleCol
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderDoubleColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderDoubleColHandler();
