...
// Description: C++18 XML SAX2 Element Handler specification for FloatCol
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderFloatColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderFloatColHandler();
