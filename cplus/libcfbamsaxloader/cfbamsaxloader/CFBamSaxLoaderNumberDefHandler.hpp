...
// Description: C++18 XML SAX2 Element Handler specification for NumberDef
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderNumberDefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderNumberDefHandler();
