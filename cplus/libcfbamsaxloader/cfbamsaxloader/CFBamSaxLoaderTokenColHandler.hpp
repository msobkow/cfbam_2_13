...
// Description: C++18 XML SAX2 Element Handler specification for TokenCol
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderTokenColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderTokenColHandler();
