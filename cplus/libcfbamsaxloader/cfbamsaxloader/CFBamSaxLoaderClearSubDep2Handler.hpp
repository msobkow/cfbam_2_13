...
// Description: C++18 XML SAX2 Element Handler specification for ClearSubDep2
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderClearSubDep2Handler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderClearSubDep2Handler();
