...
// Description: C++18 XML SAX2 Element Handler specification for FloatType
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderFloatTypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderFloatTypeHandler();
