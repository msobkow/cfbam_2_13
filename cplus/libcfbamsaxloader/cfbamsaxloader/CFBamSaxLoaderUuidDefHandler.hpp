...
// Description: C++18 XML SAX2 Element Handler specification for UuidDef
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderUuidDefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderUuidDefHandler();
