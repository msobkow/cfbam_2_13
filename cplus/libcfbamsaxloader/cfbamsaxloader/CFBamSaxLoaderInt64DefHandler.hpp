...
// Description: C++18 XML SAX2 Element Handler specification for Int64Def
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderInt64DefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderInt64DefHandler();
