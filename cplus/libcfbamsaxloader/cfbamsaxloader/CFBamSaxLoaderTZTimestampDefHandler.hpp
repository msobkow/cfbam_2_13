...
// Description: C++18 XML SAX2 Element Handler specification for TZTimestampDef
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderTZTimestampDefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderTZTimestampDefHandler();
