...
// Description: C++18 XML SAX2 Element Handler specification for Id16Gen
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderId16GenHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderId16GenHandler();
