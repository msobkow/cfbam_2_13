...
// Description: C++18 XML SAX2 Element Handler specification for PopSubDep1
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderPopSubDep1Handler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderPopSubDep1Handler();
