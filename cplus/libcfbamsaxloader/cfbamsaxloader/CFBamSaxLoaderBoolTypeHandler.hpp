...
// Description: C++18 XML SAX2 Element Handler specification for BoolType
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderBoolTypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderBoolTypeHandler();
