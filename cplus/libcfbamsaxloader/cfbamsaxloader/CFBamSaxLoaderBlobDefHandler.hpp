...
// Description: C++18 XML SAX2 Element Handler specification for BlobDef
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderBlobDefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderBlobDefHandler();
