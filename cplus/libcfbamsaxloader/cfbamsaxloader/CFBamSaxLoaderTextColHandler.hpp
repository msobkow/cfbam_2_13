...
// Description: C++18 XML SAX2 Element Handler specification for TextCol
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderTextColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderTextColHandler();
