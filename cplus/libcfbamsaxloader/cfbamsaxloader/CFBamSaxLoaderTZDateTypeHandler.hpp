...
// Description: C++18 XML SAX2 Element Handler specification for TZDateType
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderTZDateTypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderTZDateTypeHandler();
