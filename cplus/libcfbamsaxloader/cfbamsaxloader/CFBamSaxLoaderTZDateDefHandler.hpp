...
// Description: C++18 XML SAX2 Element Handler specification for TZDateDef
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderTZDateDefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderTZDateDefHandler();
