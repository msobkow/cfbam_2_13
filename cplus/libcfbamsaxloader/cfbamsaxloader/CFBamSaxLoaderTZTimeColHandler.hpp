...
// Description: C++18 XML SAX2 Element Handler specification for TZTimeCol
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderTZTimeColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderTZTimeColHandler();
