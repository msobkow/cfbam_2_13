...
// Description: C++18 XML SAX2 Element Handler specification for UInt16Def
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderUInt16DefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderUInt16DefHandler();
