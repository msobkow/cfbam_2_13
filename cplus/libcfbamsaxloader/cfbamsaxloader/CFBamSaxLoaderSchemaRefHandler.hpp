...
// Description: C++18 XML SAX2 Element Handler specification for SchemaRef
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderSchemaRefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderSchemaRefHandler();
