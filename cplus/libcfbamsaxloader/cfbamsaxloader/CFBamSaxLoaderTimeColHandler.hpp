...
// Description: C++18 XML SAX2 Element Handler specification for TimeCol
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderTimeColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderTimeColHandler();
