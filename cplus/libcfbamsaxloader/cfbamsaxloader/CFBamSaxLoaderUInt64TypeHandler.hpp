...
// Description: C++18 XML SAX2 Element Handler specification for UInt64Type
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderUInt64TypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderUInt64TypeHandler();
