...
// Description: C++18 XML SAX2 Element Handler specification for Id64Gen
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderId64GenHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderId64GenHandler();
