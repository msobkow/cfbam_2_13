...
// Description: C++18 XML SAX2 Element Handler specification for EnumTag
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderEnumTagHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderEnumTagHandler();
