...
// Description: C++18 XML SAX2 Element Handler specification for Relation
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderRelationHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderRelationHandler();
