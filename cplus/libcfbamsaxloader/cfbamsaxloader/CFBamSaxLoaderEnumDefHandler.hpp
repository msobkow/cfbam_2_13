...
// Description: C++18 XML SAX2 Element Handler specification for EnumDef
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderEnumDefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderEnumDefHandler();
