...
// Description: C++18 XML SAX2 Element Handler specification for TokenType
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderTokenTypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderTokenTypeHandler();
