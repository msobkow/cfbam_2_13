...
// Description: C++18 XML SAX2 Element Handler specification for BoolDef
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderBoolDefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderBoolDefHandler();
