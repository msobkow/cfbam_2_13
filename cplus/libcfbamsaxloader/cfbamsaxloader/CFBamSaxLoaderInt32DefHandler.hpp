...
// Description: C++18 XML SAX2 Element Handler specification for Int32Def
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderInt32DefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderInt32DefHandler();
