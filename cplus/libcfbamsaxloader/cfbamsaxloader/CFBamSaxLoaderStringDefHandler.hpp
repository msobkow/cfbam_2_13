...
// Description: C++18 XML SAX2 Element Handler specification for StringDef
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderStringDefHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderStringDefHandler();
