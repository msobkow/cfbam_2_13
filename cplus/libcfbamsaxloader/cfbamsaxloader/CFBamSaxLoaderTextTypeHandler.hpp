...
// Description: C++18 XML SAX2 Element Handler specification for TextType
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderTextTypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderTextTypeHandler();
