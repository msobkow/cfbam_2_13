...
// Description: C++18 XML SAX2 Element Handler specification for Value
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderValueHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderValueHandler();
