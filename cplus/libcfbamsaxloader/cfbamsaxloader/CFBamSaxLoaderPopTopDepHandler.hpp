...
// Description: C++18 XML SAX2 Element Handler specification for PopTopDep
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderPopTopDepHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderPopTopDepHandler();
