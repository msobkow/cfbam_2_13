...
// Description: C++18 XML SAX2 Element Handler specification for ClearSubDep3
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderClearSubDep3Handler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderClearSubDep3Handler();
