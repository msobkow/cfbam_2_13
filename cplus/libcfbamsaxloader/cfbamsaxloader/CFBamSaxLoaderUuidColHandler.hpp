...
// Description: C++18 XML SAX2 Element Handler specification for UuidCol
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderUuidColHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderUuidColHandler();
