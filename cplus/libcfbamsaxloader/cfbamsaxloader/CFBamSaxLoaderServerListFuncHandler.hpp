...
// Description: C++18 XML SAX2 Element Handler specification for ServerListFunc
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderServerListFuncHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderServerListFuncHandler();
