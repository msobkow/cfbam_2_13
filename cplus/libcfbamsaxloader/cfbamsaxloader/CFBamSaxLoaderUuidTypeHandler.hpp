...
// Description: C++18 XML SAX2 Element Handler specification for UuidType
...
namespace cfbam {
	...
	public:
		...
		CFBamSaxLoaderUuidTypeHandler( cfbam::CFBamSaxLoader* saxLoader );
		virtual ~CFBamSaxLoaderUuidTypeHandler();
