...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusPgSqlTableInclude
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusPgSqlTableIncludeHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusPgSqlTableIncludeHandler::CFBamSaxLoaderTableHPlusPgSqlTableIncludeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusPgSqlTableIncludeHandler::~CFBamSaxLoaderTableHPlusPgSqlTableIncludeHandler() {
	}

	void CFBamSaxLoaderTableHPlusPgSqlTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusPgSqlTableInclude" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusPgSqlTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusPgSqlTableInclude more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppPgSqlTableIncludeNull() || origBuff->getOptionalHppPgSqlTableIncludeValue().empty() ) {
			editBuff->setOptionalHppPgSqlTableIncludeValue( attrText );
		}
		else {
