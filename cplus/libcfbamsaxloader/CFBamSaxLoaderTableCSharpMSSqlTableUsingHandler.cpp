...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpMSSqlTableUsing
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpMSSqlTableUsingHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpMSSqlTableUsingHandler::CFBamSaxLoaderTableCSharpMSSqlTableUsingHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpMSSqlTableUsingHandler::~CFBamSaxLoaderTableCSharpMSSqlTableUsingHandler() {
	}

	void CFBamSaxLoaderTableCSharpMSSqlTableUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpMSSqlTableUsing" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpMSSqlTableUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpMSSqlTableUsing more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsMSSqlTableUsingNull() || origBuff->getOptionalCsMSSqlTableUsingValue().empty() ) {
			editBuff->setOptionalCsMSSqlTableUsingValue( attrText );
		}
		else {
