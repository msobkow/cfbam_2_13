...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeMySqlTableImport
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeMySqlTableImportHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeMySqlTableImportHandler::CFBamSaxLoaderTableCafeMySqlTableImportHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeMySqlTableImportHandler::~CFBamSaxLoaderTableCafeMySqlTableImportHandler() {
	}

	void CFBamSaxLoaderTableCafeMySqlTableImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeMySqlTableImport" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeMySqlTableImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeMySqlTableImport more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJMySqlTableImportNull() || origBuff->getOptionalJMySqlTableImportValue().empty() ) {
			editBuff->setOptionalJMySqlTableImportValue( attrText );
		}
		else {
