...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeOracleTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeOracleTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeOracleTableMembersHandler::CFBamSaxLoaderTableCafeOracleTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeOracleTableMembersHandler::~CFBamSaxLoaderTableCafeOracleTableMembersHandler() {
	}

	void CFBamSaxLoaderTableCafeOracleTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeOracleTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeOracleTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeOracleTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJOracleTableMembersNull() || origBuff->getOptionalJOracleTableMembersValue().empty() ) {
			editBuff->setOptionalJOracleTableMembersValue( attrText );
		}
		else {
