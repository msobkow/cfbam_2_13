...
// Description: C++18 XML SAX2 Element Handler implementation for BlobDef
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderBlobDefHandler::CLASS_NAME( "CFBamSaxLoaderBlobDefHandler" );
	const std::string CFBamSaxLoaderBlobDefHandler::S_True( "true" );
	const std::string CFBamSaxLoaderBlobDefHandler::S_False( "false" );
	const std::string CFBamSaxLoaderBlobDefHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderBlobDefHandler::S_No( "no" );
	const std::string CFBamSaxLoaderBlobDefHandler::S_0( "0" );
	const std::string CFBamSaxLoaderBlobDefHandler::S_1( "1" );

	CFBamSaxLoaderBlobDefHandler::CFBamSaxLoaderBlobDefHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderBlobDefHandler::~CFBamSaxLoaderBlobDefHandler() {
	}

	void CFBamSaxLoaderBlobDefHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamBlobDefObj* tmpBuff = NULL;
		cfbam::ICFBamBlobDefEditObj* editBuff = NULL;
		cfbam::ICFBamBlobDefEditObj* editBlobDef = NULL;
		cfbam::ICFBamBlobDefObj* origBlobDef = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamBlobDefBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamBlobDefBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getBlobDefTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamBlobDefEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getBlobDefLoaderBehaviour();
			origBlobDef = dynamic_cast<cfbam::ICFBamBlobDefObj*>( schemaObj->getBlobDefTableObj()->readBlobDefByUNameIdx( refTenant->getRequiredId(),
			...
			if( origBlobDef == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editBlobDef = dynamic_cast<cfbam::ICFBamBlobDefEditObj*>( origBlobDef->beginEdit() );
						editBlobDef->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editBlobDef->setOptionalShortNameNull();
						}
						else {
							editBlobDef->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editBlobDef->setOptionalLabelNull();
						}
						else {
							editBlobDef->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editBlobDef->setOptionalShortDescriptionNull();
						}
						else {
							editBlobDef->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editBlobDef->setOptionalDescriptionNull();
						}
						else {
							editBlobDef->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editBlobDef->setOptionalDefaultXmlValueNull();
						}
						else {
							editBlobDef->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editBlobDef->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editBlobDef->setOptionalGenerateIdNull();
						}
						else {
							editBlobDef->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editBlobDef->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editBlobDef->setOptionalDbNameNull();
						}
						else {
							editBlobDef->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						editBlobDef->setRequiredMaxLen( editBuff->getRequiredMaxLen() );
						if( editBuff->isOptionalInitValueNull() ) {
							editBlobDef->setOptionalInitValueNull();
						}
						else {
							editBlobDef->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
			...
			if( editBlobDef != NULL ) {
				if( origBlobDef != NULL ) {
					...
					origBlobDef = dynamic_cast<cfbam::ICFBamBlobDefObj*>( editBlobDef->create() );
				}
				editBlobDef = NULL;
			}
...
cleanup:
	...
	void CFBamSaxLoaderBlobDefHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
