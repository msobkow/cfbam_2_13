...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderHostNodeHandler::CLASS_NAME( "CFBamSaxLoaderHostNodeHandler" );
	const std::string CFBamSaxLoaderHostNodeHandler::S_True( "true" );
	const std::string CFBamSaxLoaderHostNodeHandler::S_False( "false" );
	const std::string CFBamSaxLoaderHostNodeHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderHostNodeHandler::S_No( "no" );
	const std::string CFBamSaxLoaderHostNodeHandler::S_0( "0" );
	const std::string CFBamSaxLoaderHostNodeHandler::S_1( "1" );

	CFBamSaxLoaderHostNodeHandler::CFBamSaxLoaderHostNodeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderHostNodeHandler::~CFBamSaxLoaderHostNodeHandler() {
	}

	void CFBamSaxLoaderHostNodeHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderHostNodeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
