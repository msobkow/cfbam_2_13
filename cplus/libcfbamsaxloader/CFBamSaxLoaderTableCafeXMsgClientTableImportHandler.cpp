...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeXMsgClientTableImport
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeXMsgClientTableImportHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeXMsgClientTableImportHandler::CFBamSaxLoaderTableCafeXMsgClientTableImportHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeXMsgClientTableImportHandler::~CFBamSaxLoaderTableCafeXMsgClientTableImportHandler() {
	}

	void CFBamSaxLoaderTableCafeXMsgClientTableImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeXMsgClientTableImport" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeXMsgClientTableImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeXMsgClientTableImport more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJXMsgClientTableImportNull() || origBuff->getOptionalJXMsgClientTableImportValue().empty() ) {
			editBuff->setOptionalJXMsgClientTableImportValue( attrText );
		}
		else {
