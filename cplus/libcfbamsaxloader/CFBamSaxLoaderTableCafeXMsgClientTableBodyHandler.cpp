...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeXMsgClientTableBody
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeXMsgClientTableBodyHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeXMsgClientTableBodyHandler::CFBamSaxLoaderTableCafeXMsgClientTableBodyHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeXMsgClientTableBodyHandler::~CFBamSaxLoaderTableCafeXMsgClientTableBodyHandler() {
	}

	void CFBamSaxLoaderTableCafeXMsgClientTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeXMsgClientTableBody" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeXMsgClientTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeXMsgClientTableBody more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJXMsgClientTableBodyNull() || origBuff->getOptionalJXMsgClientTableBodyValue().empty() ) {
			editBuff->setOptionalJXMsgClientTableBodyValue( attrText );
		}
		else {
