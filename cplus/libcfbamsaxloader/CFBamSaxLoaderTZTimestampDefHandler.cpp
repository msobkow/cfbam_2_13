...
// Description: C++18 XML SAX2 Element Handler implementation for TZTimestampDef
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTZTimestampDefHandler::CLASS_NAME( "CFBamSaxLoaderTZTimestampDefHandler" );
	const std::string CFBamSaxLoaderTZTimestampDefHandler::S_True( "true" );
	const std::string CFBamSaxLoaderTZTimestampDefHandler::S_False( "false" );
	const std::string CFBamSaxLoaderTZTimestampDefHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderTZTimestampDefHandler::S_No( "no" );
	const std::string CFBamSaxLoaderTZTimestampDefHandler::S_0( "0" );
	const std::string CFBamSaxLoaderTZTimestampDefHandler::S_1( "1" );

	CFBamSaxLoaderTZTimestampDefHandler::CFBamSaxLoaderTZTimestampDefHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTZTimestampDefHandler::~CFBamSaxLoaderTZTimestampDefHandler() {
	}

	void CFBamSaxLoaderTZTimestampDefHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamTZTimestampDefObj* tmpBuff = NULL;
		cfbam::ICFBamTZTimestampDefEditObj* editBuff = NULL;
		cfbam::ICFBamTZTimestampDefEditObj* editTZTimestampDef = NULL;
		cfbam::ICFBamTZTimestampDefObj* origTZTimestampDef = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamTZTimestampDefBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamTZTimestampDefBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getTZTimestampDefTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamTZTimestampDefEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getTZTimestampDefLoaderBehaviour();
			origTZTimestampDef = dynamic_cast<cfbam::ICFBamTZTimestampDefObj*>( schemaObj->getTZTimestampDefTableObj()->readTZTimestampDefByUNameIdx( refTenant->getRequiredId(),
			...
			if( origTZTimestampDef == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editTZTimestampDef = dynamic_cast<cfbam::ICFBamTZTimestampDefEditObj*>( origTZTimestampDef->beginEdit() );
						editTZTimestampDef->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editTZTimestampDef->setOptionalShortNameNull();
						}
						else {
							editTZTimestampDef->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editTZTimestampDef->setOptionalLabelNull();
						}
						else {
							editTZTimestampDef->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editTZTimestampDef->setOptionalShortDescriptionNull();
						}
						else {
							editTZTimestampDef->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editTZTimestampDef->setOptionalDescriptionNull();
						}
						else {
							editTZTimestampDef->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editTZTimestampDef->setOptionalDefaultXmlValueNull();
						}
						else {
							editTZTimestampDef->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editTZTimestampDef->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editTZTimestampDef->setOptionalGenerateIdNull();
						}
						else {
							editTZTimestampDef->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						...
						if( editBuff->isOptionalDbNameNull() ) {
							editTZTimestampDef->setOptionalDbNameNull();
						}
						else {
							editTZTimestampDef->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalDummyNull() ) {
							editTZTimestampDef->setOptionalDummyNull();
						}
						else {
							editTZTimestampDef->setOptionalDummyValue( editBuff->getOptionalDummyValue() );
						}
			...
			if( editTZTimestampDef != NULL ) {
				if( origTZTimestampDef != NULL ) {
					...
					origTZTimestampDef = dynamic_cast<cfbam::ICFBamTZTimestampDefObj*>( editTZTimestampDef->create() );
				}
				editTZTimestampDef = NULL;
			}
			...
			curContext->setObj( origTZTimestampDef );
...
cleanup:
	...
	void CFBamSaxLoaderTZTimestampDefHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
