...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusSaxLoaderEndElement
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusSaxLoaderEndElementHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusSaxLoaderEndElementHandler::CFBamSaxLoaderTableCPlusSaxLoaderEndElementHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusSaxLoaderEndElementHandler::~CFBamSaxLoaderTableCPlusSaxLoaderEndElementHandler() {
	}

	void CFBamSaxLoaderTableCPlusSaxLoaderEndElementHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusSaxLoaderEndElement" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusSaxLoaderEndElementHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusSaxLoaderEndElement more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppSaxLoaderEndElementNull() || origBuff->getOptionalCppSaxLoaderEndElementValue().empty() ) {
			editBuff->setOptionalCppSaxLoaderEndElementValue( attrText );
		}
		else {
