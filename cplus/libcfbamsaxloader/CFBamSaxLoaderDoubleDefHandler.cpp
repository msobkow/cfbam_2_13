...
// Description: C++18 XML SAX2 Element Handler implementation for DoubleDef
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderDoubleDefHandler::CLASS_NAME( "CFBamSaxLoaderDoubleDefHandler" );
	const std::string CFBamSaxLoaderDoubleDefHandler::S_True( "true" );
	const std::string CFBamSaxLoaderDoubleDefHandler::S_False( "false" );
	const std::string CFBamSaxLoaderDoubleDefHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderDoubleDefHandler::S_No( "no" );
	const std::string CFBamSaxLoaderDoubleDefHandler::S_0( "0" );
	const std::string CFBamSaxLoaderDoubleDefHandler::S_1( "1" );

	CFBamSaxLoaderDoubleDefHandler::CFBamSaxLoaderDoubleDefHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderDoubleDefHandler::~CFBamSaxLoaderDoubleDefHandler() {
	}

	void CFBamSaxLoaderDoubleDefHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamDoubleDefObj* tmpBuff = NULL;
		cfbam::ICFBamDoubleDefEditObj* editBuff = NULL;
		cfbam::ICFBamDoubleDefEditObj* editDoubleDef = NULL;
		cfbam::ICFBamDoubleDefObj* origDoubleDef = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamDoubleDefBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamDoubleDefBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getDoubleDefTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamDoubleDefEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getDoubleDefLoaderBehaviour();
			origDoubleDef = dynamic_cast<cfbam::ICFBamDoubleDefObj*>( schemaObj->getDoubleDefTableObj()->readDoubleDefByUNameIdx( refTenant->getRequiredId(),
			...
			if( origDoubleDef == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editDoubleDef = dynamic_cast<cfbam::ICFBamDoubleDefEditObj*>( origDoubleDef->beginEdit() );
						editDoubleDef->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editDoubleDef->setOptionalShortNameNull();
						}
						else {
							editDoubleDef->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editDoubleDef->setOptionalLabelNull();
						}
						else {
							editDoubleDef->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editDoubleDef->setOptionalShortDescriptionNull();
						}
						else {
							editDoubleDef->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editDoubleDef->setOptionalDescriptionNull();
						}
						else {
							editDoubleDef->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editDoubleDef->setOptionalDefaultXmlValueNull();
						}
						else {
							editDoubleDef->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editDoubleDef->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editDoubleDef->setOptionalGenerateIdNull();
						}
						else {
							editDoubleDef->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editDoubleDef->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editDoubleDef->setOptionalDbNameNull();
						}
						else {
							editDoubleDef->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editDoubleDef->setOptionalInitValueNull();
						}
						else {
							editDoubleDef->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editDoubleDef->setOptionalMinValueNull();
						}
						else {
							editDoubleDef->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editDoubleDef->setOptionalMaxValueNull();
						}
						else {
							editDoubleDef->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editDoubleDef != NULL ) {
				if( origDoubleDef != NULL ) {
					...
					origDoubleDef = dynamic_cast<cfbam::ICFBamDoubleDefObj*>( editDoubleDef->create() );
				}
				editDoubleDef = NULL;
			}
			...
			curContext->setObj( origDoubleDef );
...
cleanup:
	...
	void CFBamSaxLoaderDoubleDefHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
