...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusOracleTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusOracleTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusOracleTableImplementationHandler::CFBamSaxLoaderTableCPlusOracleTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusOracleTableImplementationHandler::~CFBamSaxLoaderTableCPlusOracleTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableCPlusOracleTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusOracleTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusOracleTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusOracleTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppOracleTableImplementationNull() || origBuff->getOptionalCppOracleTableImplementationValue().empty() ) {
			editBuff->setOptionalCppOracleTableImplementationValue( attrText );
		}
		else {
