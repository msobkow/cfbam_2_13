...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusSaxLoaderInclude
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusSaxLoaderIncludeHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusSaxLoaderIncludeHandler::CFBamSaxLoaderTableHPlusSaxLoaderIncludeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusSaxLoaderIncludeHandler::~CFBamSaxLoaderTableHPlusSaxLoaderIncludeHandler() {
	}

	void CFBamSaxLoaderTableHPlusSaxLoaderIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusSaxLoaderInclude" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusSaxLoaderIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusSaxLoaderInclude more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppSaxLoaderIncludeNull() || origBuff->getOptionalHppSaxLoaderIncludeValue().empty() ) {
			editBuff->setOptionalHppSaxLoaderIncludeValue( attrText );
		}
		else {
