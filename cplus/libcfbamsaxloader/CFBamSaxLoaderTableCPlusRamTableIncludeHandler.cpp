...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusRamTableInclude
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusRamTableIncludeHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusRamTableIncludeHandler::CFBamSaxLoaderTableCPlusRamTableIncludeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusRamTableIncludeHandler::~CFBamSaxLoaderTableCPlusRamTableIncludeHandler() {
	}

	void CFBamSaxLoaderTableCPlusRamTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusRamTableInclude" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusRamTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusRamTableInclude more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppRamTableIncludeNull() || origBuff->getOptionalCppRamTableIncludeValue().empty() ) {
			editBuff->setOptionalCppRamTableIncludeValue( attrText );
		}
		else {
