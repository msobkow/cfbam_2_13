...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusTableObjImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusTableObjImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusTableObjImplementationHandler::CFBamSaxLoaderTableHPlusTableObjImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusTableObjImplementationHandler::~CFBamSaxLoaderTableHPlusTableObjImplementationHandler() {
	}

	void CFBamSaxLoaderTableHPlusTableObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusTableObjImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusTableObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusTableObjImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppTableObjImplementationNull() || origBuff->getOptionalHppTableObjImplementationValue().empty() ) {
			editBuff->setOptionalHppTableObjImplementationValue( attrText );
		}
		else {
