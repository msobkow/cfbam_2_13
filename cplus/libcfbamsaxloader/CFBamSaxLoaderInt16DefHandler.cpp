...
// Description: C++18 XML SAX2 Element Handler implementation for Int16Def
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderInt16DefHandler::CLASS_NAME( "CFBamSaxLoaderInt16DefHandler" );
	const std::string CFBamSaxLoaderInt16DefHandler::S_True( "true" );
	const std::string CFBamSaxLoaderInt16DefHandler::S_False( "false" );
	const std::string CFBamSaxLoaderInt16DefHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderInt16DefHandler::S_No( "no" );
	const std::string CFBamSaxLoaderInt16DefHandler::S_0( "0" );
	const std::string CFBamSaxLoaderInt16DefHandler::S_1( "1" );

	CFBamSaxLoaderInt16DefHandler::CFBamSaxLoaderInt16DefHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderInt16DefHandler::~CFBamSaxLoaderInt16DefHandler() {
	}

	void CFBamSaxLoaderInt16DefHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamInt16DefObj* tmpBuff = NULL;
		cfbam::ICFBamInt16DefEditObj* editBuff = NULL;
		cfbam::ICFBamInt16DefEditObj* editInt16Def = NULL;
		cfbam::ICFBamInt16DefObj* origInt16Def = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamInt16DefBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamInt16DefBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getInt16DefTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamInt16DefEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getInt16DefLoaderBehaviour();
			origInt16Def = dynamic_cast<cfbam::ICFBamInt16DefObj*>( schemaObj->getInt16DefTableObj()->readInt16DefByUNameIdx( refTenant->getRequiredId(),
			...
			if( origInt16Def == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editInt16Def = dynamic_cast<cfbam::ICFBamInt16DefEditObj*>( origInt16Def->beginEdit() );
						editInt16Def->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editInt16Def->setOptionalShortNameNull();
						}
						else {
							editInt16Def->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editInt16Def->setOptionalLabelNull();
						}
						else {
							editInt16Def->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editInt16Def->setOptionalShortDescriptionNull();
						}
						else {
							editInt16Def->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editInt16Def->setOptionalDescriptionNull();
						}
						else {
							editInt16Def->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editInt16Def->setOptionalDefaultXmlValueNull();
						}
						else {
							editInt16Def->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editInt16Def->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editInt16Def->setOptionalGenerateIdNull();
						}
						else {
							editInt16Def->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editInt16Def->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editInt16Def->setOptionalDbNameNull();
						}
						else {
							editInt16Def->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editInt16Def->setOptionalInitValueNull();
						}
						else {
							editInt16Def->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editInt16Def->setOptionalMinValueNull();
						}
						else {
							editInt16Def->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editInt16Def->setOptionalMaxValueNull();
						}
						else {
							editInt16Def->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editInt16Def != NULL ) {
				if( origInt16Def != NULL ) {
					...
					origInt16Def = dynamic_cast<cfbam::ICFBamInt16DefObj*>( editInt16Def->create() );
				}
				editInt16Def = NULL;
			}
			...
			curContext->setObj( origInt16Def );
...
cleanup:
	...
	void CFBamSaxLoaderInt16DefHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
