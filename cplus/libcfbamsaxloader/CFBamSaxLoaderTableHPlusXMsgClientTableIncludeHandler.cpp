...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusXMsgClientTableInclude
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusXMsgClientTableIncludeHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusXMsgClientTableIncludeHandler::CFBamSaxLoaderTableHPlusXMsgClientTableIncludeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusXMsgClientTableIncludeHandler::~CFBamSaxLoaderTableHPlusXMsgClientTableIncludeHandler() {
	}

	void CFBamSaxLoaderTableHPlusXMsgClientTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusXMsgClientTableInclude" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusXMsgClientTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusXMsgClientTableInclude more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppXMsgClientTableIncludeNull() || origBuff->getOptionalHppXMsgClientTableIncludeValue().empty() ) {
			editBuff->setOptionalHppXMsgClientTableIncludeValue( attrText );
		}
		else {
