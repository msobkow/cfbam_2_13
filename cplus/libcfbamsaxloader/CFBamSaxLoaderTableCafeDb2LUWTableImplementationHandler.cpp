...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeDb2LUWTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeDb2LUWTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeDb2LUWTableImplementationHandler::CFBamSaxLoaderTableCafeDb2LUWTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeDb2LUWTableImplementationHandler::~CFBamSaxLoaderTableCafeDb2LUWTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableCafeDb2LUWTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeDb2LUWTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeDb2LUWTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeDb2LUWTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJDb2LUWTableImplementationNull() || origBuff->getOptionalJDb2LUWTableImplementationValue().empty() ) {
			editBuff->setOptionalJDb2LUWTableImplementationValue( attrText );
		}
		else {
