...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderSecSessionHandler::CLASS_NAME( "CFBamSaxLoaderSecSessionHandler" );
	const std::string CFBamSaxLoaderSecSessionHandler::S_True( "true" );
	const std::string CFBamSaxLoaderSecSessionHandler::S_False( "false" );
	const std::string CFBamSaxLoaderSecSessionHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderSecSessionHandler::S_No( "no" );
	const std::string CFBamSaxLoaderSecSessionHandler::S_0( "0" );
	const std::string CFBamSaxLoaderSecSessionHandler::S_1( "1" );

	CFBamSaxLoaderSecSessionHandler::CFBamSaxLoaderSecSessionHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderSecSessionHandler::~CFBamSaxLoaderSecSessionHandler() {
	}

	void CFBamSaxLoaderSecSessionHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderSecSessionHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
