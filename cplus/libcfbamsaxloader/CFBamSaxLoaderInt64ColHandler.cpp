...
// Description: C++18 XML SAX2 Element Handler implementation for Int64Col
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderInt64ColHandler::CLASS_NAME( "CFBamSaxLoaderInt64ColHandler" );
	const std::string CFBamSaxLoaderInt64ColHandler::S_True( "true" );
	const std::string CFBamSaxLoaderInt64ColHandler::S_False( "false" );
	const std::string CFBamSaxLoaderInt64ColHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderInt64ColHandler::S_No( "no" );
	const std::string CFBamSaxLoaderInt64ColHandler::S_0( "0" );
	const std::string CFBamSaxLoaderInt64ColHandler::S_1( "1" );

	CFBamSaxLoaderInt64ColHandler::CFBamSaxLoaderInt64ColHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderInt64ColHandler::~CFBamSaxLoaderInt64ColHandler() {
	}

	void CFBamSaxLoaderInt64ColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamInt64ColObj* tmpBuff = NULL;
		cfbam::ICFBamInt64ColEditObj* editBuff = NULL;
		cfbam::ICFBamInt64ColEditObj* editInt64Col = NULL;
		cfbam::ICFBamInt64ColObj* origInt64Col = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamInt64ColBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamInt64ColBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getInt64ColTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamInt64ColEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getInt64ColLoaderBehaviour();
			origInt64Col = dynamic_cast<cfbam::ICFBamInt64ColObj*>( schemaObj->getInt64ColTableObj()->readInt64ColByUNameIdx( refTenant->getRequiredId(),
			...
			if( origInt64Col == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editInt64Col = dynamic_cast<cfbam::ICFBamInt64ColEditObj*>( origInt64Col->beginEdit() );
						editInt64Col->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editInt64Col->setOptionalShortNameNull();
						}
						else {
							editInt64Col->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editInt64Col->setOptionalLabelNull();
						}
						else {
							editInt64Col->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editInt64Col->setOptionalShortDescriptionNull();
						}
						else {
							editInt64Col->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editInt64Col->setOptionalDescriptionNull();
						}
						else {
							editInt64Col->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editInt64Col->setOptionalDefaultXmlValueNull();
						}
						else {
							editInt64Col->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editInt64Col->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editInt64Col->setOptionalGenerateIdNull();
						}
						else {
							editInt64Col->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editInt64Col->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editInt64Col->setOptionalDbNameNull();
						}
						else {
							editInt64Col->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editInt64Col->setOptionalInitValueNull();
						}
						else {
							editInt64Col->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editInt64Col->setOptionalMinValueNull();
						}
						else {
							editInt64Col->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editInt64Col->setOptionalMaxValueNull();
						}
						else {
							editInt64Col->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editInt64Col != NULL ) {
				if( origInt64Col != NULL ) {
					...
					origInt64Col = dynamic_cast<cfbam::ICFBamInt64ColObj*>( editInt64Col->create() );
				}
				editInt64Col = NULL;
			}
			...
			curContext->setObj( origInt64Col );
...
cleanup:
	...
	void CFBamSaxLoaderInt64ColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
