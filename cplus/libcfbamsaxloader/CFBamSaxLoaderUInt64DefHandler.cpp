...
// Description: C++18 XML SAX2 Element Handler implementation for UInt64Def
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderUInt64DefHandler::CLASS_NAME( "CFBamSaxLoaderUInt64DefHandler" );
	const std::string CFBamSaxLoaderUInt64DefHandler::S_True( "true" );
	const std::string CFBamSaxLoaderUInt64DefHandler::S_False( "false" );
	const std::string CFBamSaxLoaderUInt64DefHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderUInt64DefHandler::S_No( "no" );
	const std::string CFBamSaxLoaderUInt64DefHandler::S_0( "0" );
	const std::string CFBamSaxLoaderUInt64DefHandler::S_1( "1" );

	CFBamSaxLoaderUInt64DefHandler::CFBamSaxLoaderUInt64DefHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderUInt64DefHandler::~CFBamSaxLoaderUInt64DefHandler() {
	}

	void CFBamSaxLoaderUInt64DefHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamUInt64DefObj* tmpBuff = NULL;
		cfbam::ICFBamUInt64DefEditObj* editBuff = NULL;
		cfbam::ICFBamUInt64DefEditObj* editUInt64Def = NULL;
		cfbam::ICFBamUInt64DefObj* origUInt64Def = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamUInt64DefBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamUInt64DefBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getUInt64DefTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamUInt64DefEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getUInt64DefLoaderBehaviour();
			origUInt64Def = dynamic_cast<cfbam::ICFBamUInt64DefObj*>( schemaObj->getUInt64DefTableObj()->readUInt64DefByUNameIdx( refTenant->getRequiredId(),
			...
			if( origUInt64Def == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editUInt64Def = dynamic_cast<cfbam::ICFBamUInt64DefEditObj*>( origUInt64Def->beginEdit() );
						editUInt64Def->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editUInt64Def->setOptionalShortNameNull();
						}
						else {
							editUInt64Def->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editUInt64Def->setOptionalLabelNull();
						}
						else {
							editUInt64Def->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editUInt64Def->setOptionalShortDescriptionNull();
						}
						else {
							editUInt64Def->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editUInt64Def->setOptionalDescriptionNull();
						}
						else {
							editUInt64Def->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editUInt64Def->setOptionalDefaultXmlValueNull();
						}
						else {
							editUInt64Def->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editUInt64Def->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editUInt64Def->setOptionalGenerateIdNull();
						}
						else {
							editUInt64Def->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editUInt64Def->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editUInt64Def->setOptionalDbNameNull();
						}
						else {
							editUInt64Def->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editUInt64Def->setOptionalInitValueNull();
						}
						else {
							editUInt64Def->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editUInt64Def->setOptionalMinValueNull();
						}
						else {
							editUInt64Def->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editUInt64Def->setOptionalMaxValueNull();
						}
						else {
							editUInt64Def->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editUInt64Def != NULL ) {
				if( origUInt64Def != NULL ) {
					...
					origUInt64Def = dynamic_cast<cfbam::ICFBamUInt64DefObj*>( editUInt64Def->create() );
				}
				editUInt64Def = NULL;
			}
			...
			curContext->setObj( origUInt64Def );
...
cleanup:
	...
	void CFBamSaxLoaderUInt64DefHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
