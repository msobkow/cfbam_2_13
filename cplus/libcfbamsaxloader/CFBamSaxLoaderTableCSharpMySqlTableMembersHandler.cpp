...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpMySqlTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpMySqlTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpMySqlTableMembersHandler::CFBamSaxLoaderTableCSharpMySqlTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpMySqlTableMembersHandler::~CFBamSaxLoaderTableCSharpMySqlTableMembersHandler() {
	}

	void CFBamSaxLoaderTableCSharpMySqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpMySqlTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpMySqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpMySqlTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsMySqlTableMembersNull() || origBuff->getOptionalCsMySqlTableMembersValue().empty() ) {
			editBuff->setOptionalCsMySqlTableMembersValue( attrText );
		}
		else {
