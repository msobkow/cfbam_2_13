...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeMSSqlTableImport
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeMSSqlTableImportHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeMSSqlTableImportHandler::CFBamSaxLoaderTableCafeMSSqlTableImportHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeMSSqlTableImportHandler::~CFBamSaxLoaderTableCafeMSSqlTableImportHandler() {
	}

	void CFBamSaxLoaderTableCafeMSSqlTableImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeMSSqlTableImport" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeMSSqlTableImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeMSSqlTableImport more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJMSSqlTableImportNull() || origBuff->getOptionalJMSSqlTableImportValue().empty() ) {
			editBuff->setOptionalJMSSqlTableImportValue( attrText );
		}
		else {
