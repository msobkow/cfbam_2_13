...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusXMsgRspnTableInclude
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusXMsgRspnTableIncludeHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusXMsgRspnTableIncludeHandler::CFBamSaxLoaderTableHPlusXMsgRspnTableIncludeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusXMsgRspnTableIncludeHandler::~CFBamSaxLoaderTableHPlusXMsgRspnTableIncludeHandler() {
	}

	void CFBamSaxLoaderTableHPlusXMsgRspnTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusXMsgRspnTableInclude" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusXMsgRspnTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusXMsgRspnTableInclude more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppXMsgRspnTableIncludeNull() || origBuff->getOptionalHppXMsgRspnTableIncludeValue().empty() ) {
			editBuff->setOptionalHppXMsgRspnTableIncludeValue( attrText );
		}
		else {
