...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusMySqlTableInclude
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusMySqlTableIncludeHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusMySqlTableIncludeHandler::CFBamSaxLoaderTableHPlusMySqlTableIncludeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusMySqlTableIncludeHandler::~CFBamSaxLoaderTableHPlusMySqlTableIncludeHandler() {
	}

	void CFBamSaxLoaderTableHPlusMySqlTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusMySqlTableInclude" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusMySqlTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusMySqlTableInclude more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppMySqlTableIncludeNull() || origBuff->getOptionalHppMySqlTableIncludeValue().empty() ) {
			editBuff->setOptionalHppMySqlTableIncludeValue( attrText );
		}
		else {
