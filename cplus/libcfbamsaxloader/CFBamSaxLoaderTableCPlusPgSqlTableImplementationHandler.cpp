...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusPgSqlTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusPgSqlTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusPgSqlTableImplementationHandler::CFBamSaxLoaderTableCPlusPgSqlTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusPgSqlTableImplementationHandler::~CFBamSaxLoaderTableCPlusPgSqlTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableCPlusPgSqlTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusPgSqlTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusPgSqlTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusPgSqlTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppPgSqlTableImplementationNull() || origBuff->getOptionalCppPgSqlTableImplementationValue().empty() ) {
			editBuff->setOptionalCppPgSqlTableImplementationValue( attrText );
		}
		else {
