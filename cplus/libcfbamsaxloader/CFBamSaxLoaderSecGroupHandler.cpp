...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderSecGroupHandler::CLASS_NAME( "CFBamSaxLoaderSecGroupHandler" );
	const std::string CFBamSaxLoaderSecGroupHandler::S_True( "true" );
	const std::string CFBamSaxLoaderSecGroupHandler::S_False( "false" );
	const std::string CFBamSaxLoaderSecGroupHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderSecGroupHandler::S_No( "no" );
	const std::string CFBamSaxLoaderSecGroupHandler::S_0( "0" );
	const std::string CFBamSaxLoaderSecGroupHandler::S_1( "1" );

	CFBamSaxLoaderSecGroupHandler::CFBamSaxLoaderSecGroupHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderSecGroupHandler::~CFBamSaxLoaderSecGroupHandler() {
	}

	void CFBamSaxLoaderSecGroupHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderSecGroupHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
