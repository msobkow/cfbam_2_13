...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderSecUserHandler::CLASS_NAME( "CFBamSaxLoaderSecUserHandler" );
	const std::string CFBamSaxLoaderSecUserHandler::S_True( "true" );
	const std::string CFBamSaxLoaderSecUserHandler::S_False( "false" );
	const std::string CFBamSaxLoaderSecUserHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderSecUserHandler::S_No( "no" );
	const std::string CFBamSaxLoaderSecUserHandler::S_0( "0" );
	const std::string CFBamSaxLoaderSecUserHandler::S_1( "1" );

	CFBamSaxLoaderSecUserHandler::CFBamSaxLoaderSecUserHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderSecUserHandler::~CFBamSaxLoaderSecUserHandler() {
	}

	void CFBamSaxLoaderSecUserHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderSecUserHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
