...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderClusterHandler::CLASS_NAME( "CFBamSaxLoaderClusterHandler" );
	const std::string CFBamSaxLoaderClusterHandler::S_True( "true" );
	const std::string CFBamSaxLoaderClusterHandler::S_False( "false" );
	const std::string CFBamSaxLoaderClusterHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderClusterHandler::S_No( "no" );
	const std::string CFBamSaxLoaderClusterHandler::S_0( "0" );
	const std::string CFBamSaxLoaderClusterHandler::S_1( "1" );

	CFBamSaxLoaderClusterHandler::CFBamSaxLoaderClusterHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderClusterHandler::~CFBamSaxLoaderClusterHandler() {
	}

	void CFBamSaxLoaderClusterHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderClusterHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
