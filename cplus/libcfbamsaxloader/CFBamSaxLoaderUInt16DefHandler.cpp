...
// Description: C++18 XML SAX2 Element Handler implementation for UInt16Def
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderUInt16DefHandler::CLASS_NAME( "CFBamSaxLoaderUInt16DefHandler" );
	const std::string CFBamSaxLoaderUInt16DefHandler::S_True( "true" );
	const std::string CFBamSaxLoaderUInt16DefHandler::S_False( "false" );
	const std::string CFBamSaxLoaderUInt16DefHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderUInt16DefHandler::S_No( "no" );
	const std::string CFBamSaxLoaderUInt16DefHandler::S_0( "0" );
	const std::string CFBamSaxLoaderUInt16DefHandler::S_1( "1" );

	CFBamSaxLoaderUInt16DefHandler::CFBamSaxLoaderUInt16DefHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderUInt16DefHandler::~CFBamSaxLoaderUInt16DefHandler() {
	}

	void CFBamSaxLoaderUInt16DefHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamUInt16DefObj* tmpBuff = NULL;
		cfbam::ICFBamUInt16DefEditObj* editBuff = NULL;
		cfbam::ICFBamUInt16DefEditObj* editUInt16Def = NULL;
		cfbam::ICFBamUInt16DefObj* origUInt16Def = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamUInt16DefBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamUInt16DefBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getUInt16DefTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamUInt16DefEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getUInt16DefLoaderBehaviour();
			origUInt16Def = dynamic_cast<cfbam::ICFBamUInt16DefObj*>( schemaObj->getUInt16DefTableObj()->readUInt16DefByUNameIdx( refTenant->getRequiredId(),
			...
			if( origUInt16Def == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editUInt16Def = dynamic_cast<cfbam::ICFBamUInt16DefEditObj*>( origUInt16Def->beginEdit() );
						editUInt16Def->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editUInt16Def->setOptionalShortNameNull();
						}
						else {
							editUInt16Def->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editUInt16Def->setOptionalLabelNull();
						}
						else {
							editUInt16Def->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editUInt16Def->setOptionalShortDescriptionNull();
						}
						else {
							editUInt16Def->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editUInt16Def->setOptionalDescriptionNull();
						}
						else {
							editUInt16Def->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editUInt16Def->setOptionalDefaultXmlValueNull();
						}
						else {
							editUInt16Def->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editUInt16Def->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editUInt16Def->setOptionalGenerateIdNull();
						}
						else {
							editUInt16Def->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editUInt16Def->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editUInt16Def->setOptionalDbNameNull();
						}
						else {
							editUInt16Def->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editUInt16Def->setOptionalInitValueNull();
						}
						else {
							editUInt16Def->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editUInt16Def->setOptionalMinValueNull();
						}
						else {
							editUInt16Def->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editUInt16Def->setOptionalMaxValueNull();
						}
						else {
							editUInt16Def->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editUInt16Def != NULL ) {
				if( origUInt16Def != NULL ) {
					...
					origUInt16Def = dynamic_cast<cfbam::ICFBamUInt16DefObj*>( editUInt16Def->create() );
				}
				editUInt16Def = NULL;
			}
			...
			curContext->setObj( origUInt16Def );
...
cleanup:
	...
	void CFBamSaxLoaderUInt16DefHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
