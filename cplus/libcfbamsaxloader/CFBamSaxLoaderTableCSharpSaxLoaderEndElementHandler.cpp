...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpSaxLoaderEndElement
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpSaxLoaderEndElementHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpSaxLoaderEndElementHandler::CFBamSaxLoaderTableCSharpSaxLoaderEndElementHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpSaxLoaderEndElementHandler::~CFBamSaxLoaderTableCSharpSaxLoaderEndElementHandler() {
	}

	void CFBamSaxLoaderTableCSharpSaxLoaderEndElementHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpSaxLoaderEndElement" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpSaxLoaderEndElementHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpSaxLoaderEndElement more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsSaxLoaderEndElementNull() || origBuff->getOptionalCsSaxLoaderEndElementValue().empty() ) {
			editBuff->setOptionalCsSaxLoaderEndElementValue( attrText );
		}
		else {
