...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusSaxLoaderInclude
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusSaxLoaderIncludeHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusSaxLoaderIncludeHandler::CFBamSaxLoaderTableCPlusSaxLoaderIncludeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusSaxLoaderIncludeHandler::~CFBamSaxLoaderTableCPlusSaxLoaderIncludeHandler() {
	}

	void CFBamSaxLoaderTableCPlusSaxLoaderIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusSaxLoaderInclude" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusSaxLoaderIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusSaxLoaderInclude more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppSaxLoaderIncludeNull() || origBuff->getOptionalCppSaxLoaderIncludeValue().empty() ) {
			editBuff->setOptionalCppSaxLoaderIncludeValue( attrText );
		}
		else {
