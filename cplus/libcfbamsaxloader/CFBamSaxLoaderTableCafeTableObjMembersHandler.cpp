...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeTableObjMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeTableObjMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeTableObjMembersHandler::CFBamSaxLoaderTableCafeTableObjMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeTableObjMembersHandler::~CFBamSaxLoaderTableCafeTableObjMembersHandler() {
	}

	void CFBamSaxLoaderTableCafeTableObjMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeTableObjMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeTableObjMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeTableObjMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJTableObjMembersNull() || origBuff->getOptionalJTableObjMembersValue().empty() ) {
			editBuff->setOptionalJTableObjMembersValue( attrText );
		}
		else {
