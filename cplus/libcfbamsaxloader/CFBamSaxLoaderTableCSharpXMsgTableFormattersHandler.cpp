...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpXMsgTableFormatters
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpXMsgTableFormattersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpXMsgTableFormattersHandler::CFBamSaxLoaderTableCSharpXMsgTableFormattersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpXMsgTableFormattersHandler::~CFBamSaxLoaderTableCSharpXMsgTableFormattersHandler() {
	}

	void CFBamSaxLoaderTableCSharpXMsgTableFormattersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpXMsgTableFormatters" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpXMsgTableFormattersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpXMsgTableFormatters more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsXMsgTableFormattersNull() || origBuff->getOptionalCsXMsgTableFormattersValue().empty() ) {
			editBuff->setOptionalCsXMsgTableFormattersValue( attrText );
		}
		else {
