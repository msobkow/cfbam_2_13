...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeObjInterface
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeObjInterfaceHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeObjInterfaceHandler::CFBamSaxLoaderTableCafeObjInterfaceHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeObjInterfaceHandler::~CFBamSaxLoaderTableCafeObjInterfaceHandler() {
	}

	void CFBamSaxLoaderTableCafeObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeObjInterface" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeObjInterface more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJObjInterfaceNull() || origBuff->getOptionalJObjInterfaceValue().empty() ) {
			editBuff->setOptionalJObjInterfaceValue( attrText );
		}
		else {
