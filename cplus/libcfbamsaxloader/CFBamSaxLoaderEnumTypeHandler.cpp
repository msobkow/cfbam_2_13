...
// Description: C++18 XML SAX2 Element Handler implementation for EnumType
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderEnumTypeHandler::CLASS_NAME( "CFBamSaxLoaderEnumTypeHandler" );
	const std::string CFBamSaxLoaderEnumTypeHandler::S_True( "true" );
	const std::string CFBamSaxLoaderEnumTypeHandler::S_False( "false" );
	const std::string CFBamSaxLoaderEnumTypeHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderEnumTypeHandler::S_No( "no" );
	const std::string CFBamSaxLoaderEnumTypeHandler::S_0( "0" );
	const std::string CFBamSaxLoaderEnumTypeHandler::S_1( "1" );

	CFBamSaxLoaderEnumTypeHandler::CFBamSaxLoaderEnumTypeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderEnumTypeHandler::~CFBamSaxLoaderEnumTypeHandler() {
	}

	void CFBamSaxLoaderEnumTypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		static const std::string S_Tag( "Tag" );
		...
		cfbam::ICFBamEnumTypeObj* tmpBuff = NULL;
		cfbam::ICFBamEnumTypeEditObj* editBuff = NULL;
		cfbam::ICFBamEnumTypeEditObj* editEnumType = NULL;
		cfbam::ICFBamEnumTypeObj* origEnumType = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamEnumTypeBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamEnumTypeBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getEnumTypeTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamEnumTypeEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getEnumTypeLoaderBehaviour();
			origEnumType = dynamic_cast<cfbam::ICFBamEnumTypeObj*>( schemaObj->getEnumTypeTableObj()->readEnumTypeByUNameIdx( refTenant->getRequiredId(),
			...
			if( origEnumType == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editEnumType = dynamic_cast<cfbam::ICFBamEnumTypeEditObj*>( origEnumType->beginEdit() );
						editEnumType->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editEnumType->setOptionalShortNameNull();
						}
						else {
							editEnumType->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editEnumType->setOptionalLabelNull();
						}
						else {
							editEnumType->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editEnumType->setOptionalShortDescriptionNull();
						}
						else {
							editEnumType->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editEnumType->setOptionalDescriptionNull();
						}
						else {
							editEnumType->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editEnumType->setOptionalDefaultXmlValueNull();
						}
						else {
							editEnumType->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editEnumType->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editEnumType->setOptionalGenerateIdNull();
						}
						else {
							editEnumType->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editEnumType->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editEnumType->setOptionalDbNameNull();
						}
						else {
							editEnumType->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editEnumType->setOptionalInitValueNull();
						}
						else {
							editEnumType->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editEnumType->setOptionalMinValueNull();
						}
						else {
							editEnumType->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editEnumType->setOptionalMaxValueNull();
						}
						else {
							editEnumType->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editEnumType != NULL ) {
				if( origEnumType != NULL ) {
					...
					origEnumType = dynamic_cast<cfbam::ICFBamEnumTypeObj*>( editEnumType->create() );
				}
				editEnumType = NULL;
			}
			...
			curContext->setObj( origEnumType );
...
cleanup:
	...
	void CFBamSaxLoaderEnumTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
