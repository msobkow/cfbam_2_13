...
// Description: C++18 XML SAX2 Element Handler implementation for BoolDef
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderBoolDefHandler::CLASS_NAME( "CFBamSaxLoaderBoolDefHandler" );
	const std::string CFBamSaxLoaderBoolDefHandler::S_True( "true" );
	const std::string CFBamSaxLoaderBoolDefHandler::S_False( "false" );
	const std::string CFBamSaxLoaderBoolDefHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderBoolDefHandler::S_No( "no" );
	const std::string CFBamSaxLoaderBoolDefHandler::S_0( "0" );
	const std::string CFBamSaxLoaderBoolDefHandler::S_1( "1" );

	CFBamSaxLoaderBoolDefHandler::CFBamSaxLoaderBoolDefHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderBoolDefHandler::~CFBamSaxLoaderBoolDefHandler() {
	}

	void CFBamSaxLoaderBoolDefHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamBoolDefObj* tmpBuff = NULL;
		cfbam::ICFBamBoolDefEditObj* editBuff = NULL;
		cfbam::ICFBamBoolDefEditObj* editBoolDef = NULL;
		cfbam::ICFBamBoolDefObj* origBoolDef = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamBoolDefBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamBoolDefBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getBoolDefTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamBoolDefEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getBoolDefLoaderBehaviour();
			origBoolDef = dynamic_cast<cfbam::ICFBamBoolDefObj*>( schemaObj->getBoolDefTableObj()->readBoolDefByUNameIdx( refTenant->getRequiredId(),
			...
			if( origBoolDef == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editBoolDef = dynamic_cast<cfbam::ICFBamBoolDefEditObj*>( origBoolDef->beginEdit() );
						editBoolDef->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editBoolDef->setOptionalShortNameNull();
						}
						else {
							editBoolDef->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editBoolDef->setOptionalLabelNull();
						}
						else {
							editBoolDef->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editBoolDef->setOptionalShortDescriptionNull();
						}
						else {
							editBoolDef->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editBoolDef->setOptionalDescriptionNull();
						}
						else {
							editBoolDef->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editBoolDef->setOptionalDefaultXmlValueNull();
						}
						else {
							editBoolDef->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editBoolDef->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editBoolDef->setOptionalGenerateIdNull();
						}
						else {
							editBoolDef->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editBoolDef->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editBoolDef->setOptionalDbNameNull();
						}
						else {
							editBoolDef->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editBoolDef->setOptionalInitValueNull();
						}
						else {
							editBoolDef->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalFalseStringNull() ) {
							editBoolDef->setOptionalFalseStringNull();
						}
						else {
							editBoolDef->setOptionalFalseStringValue( editBuff->getOptionalFalseStringValue() );
						}
						if( editBuff->isOptionalTrueStringNull() ) {
							editBoolDef->setOptionalTrueStringNull();
						}
						else {
							editBoolDef->setOptionalTrueStringValue( editBuff->getOptionalTrueStringValue() );
						}
						if( editBuff->isOptionalNullStringNull() ) {
							editBoolDef->setOptionalNullStringNull();
						}
						else {
							editBoolDef->setOptionalNullStringValue( editBuff->getOptionalNullStringValue() );
						}
			...
			if( editBoolDef != NULL ) {
				if( origBoolDef != NULL ) {
					...
					origBoolDef = dynamic_cast<cfbam::ICFBamBoolDefObj*>( editBoolDef->create() );
				}
				editBoolDef = NULL;
			}
...
cleanup:
	...
	void CFBamSaxLoaderBoolDefHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
