...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusTableMembersHandler::CFBamSaxLoaderTableHPlusTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusTableMembersHandler::~CFBamSaxLoaderTableHPlusTableMembersHandler() {
	}

	void CFBamSaxLoaderTableHPlusTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppTableMembersNull() || origBuff->getOptionalHppTableMembersValue().empty() ) {
			editBuff->setOptionalHppTableMembersValue( attrText );
		}
		else {
