...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusTableObjInterface
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusTableObjInterfaceHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusTableObjInterfaceHandler::CFBamSaxLoaderTableCPlusTableObjInterfaceHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusTableObjInterfaceHandler::~CFBamSaxLoaderTableCPlusTableObjInterfaceHandler() {
	}

	void CFBamSaxLoaderTableCPlusTableObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusTableObjInterface" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusTableObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusTableObjInterface more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppTableObjInterfaceNull() || origBuff->getOptionalCppTableObjInterfaceValue().empty() ) {
			editBuff->setOptionalCppTableObjInterfaceValue( attrText );
		}
		else {
