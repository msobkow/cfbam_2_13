...
// Description: C++18 XML SAX2 Element Handler implementation for Int64Type
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderInt64TypeHandler::CLASS_NAME( "CFBamSaxLoaderInt64TypeHandler" );
	const std::string CFBamSaxLoaderInt64TypeHandler::S_True( "true" );
	const std::string CFBamSaxLoaderInt64TypeHandler::S_False( "false" );
	const std::string CFBamSaxLoaderInt64TypeHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderInt64TypeHandler::S_No( "no" );
	const std::string CFBamSaxLoaderInt64TypeHandler::S_0( "0" );
	const std::string CFBamSaxLoaderInt64TypeHandler::S_1( "1" );

	CFBamSaxLoaderInt64TypeHandler::CFBamSaxLoaderInt64TypeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderInt64TypeHandler::~CFBamSaxLoaderInt64TypeHandler() {
	}

	void CFBamSaxLoaderInt64TypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamInt64TypeObj* tmpBuff = NULL;
		cfbam::ICFBamInt64TypeEditObj* editBuff = NULL;
		cfbam::ICFBamInt64TypeEditObj* editInt64Type = NULL;
		cfbam::ICFBamInt64TypeObj* origInt64Type = NULL;
		...
		cflib::CFLibNullableInt64 natInitValue;
		cflib::CFLibNullableInt64 natMinValue;
		cflib::CFLibNullableInt64 natMaxValue;
		try {
			if( ( uri == NULL ) || ( *uri == 0 ) ) {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamInt64TypeBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamInt64TypeBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getInt64TypeTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamInt64TypeEditObj*>( tmpBuff->beginEdit() );
			...
			if( ( attrInitValue == NULL ) || ( attrInitValue->length() == 0 ) ) {
				...
				int64_t* value = cflib::CFLibXmlUtil::parseInt64( *attrInitValue );
				if( value != NULL ) {
			...
			if( ( attrMinValue == NULL ) || ( attrMinValue->length() == 0 ) ) {
				...
				int64_t* value = cflib::CFLibXmlUtil::parseInt64( *attrMinValue );
				if( value != NULL ) {
			...
			if( ( attrMaxValue == NULL ) || ( attrMaxValue->length() == 0 ) ) {
				...
				int64_t* value = cflib::CFLibXmlUtil::parseInt64( *attrMaxValue );
				if( value != NULL ) {
			...
			loaderBehaviour = saxLoader->getInt64TypeLoaderBehaviour();
			origInt64Type = dynamic_cast<cfbam::ICFBamInt64TypeObj*>( schemaObj->getInt64TypeTableObj()->readInt64TypeByUNameIdx( refTenant->getRequiredId(),
			...
			if( origInt64Type == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editInt64Type = dynamic_cast<cfbam::ICFBamInt64TypeEditObj*>( origInt64Type->beginEdit() );
						editInt64Type->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editInt64Type->setOptionalShortNameNull();
						}
						else {
							editInt64Type->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editInt64Type->setOptionalLabelNull();
						}
						else {
							editInt64Type->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editInt64Type->setOptionalShortDescriptionNull();
						}
						else {
							editInt64Type->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editInt64Type->setOptionalDescriptionNull();
						}
						else {
							editInt64Type->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editInt64Type->setOptionalDefaultXmlValueNull();
						}
						else {
							editInt64Type->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editInt64Type->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editInt64Type->setOptionalGenerateIdNull();
						}
						else {
							editInt64Type->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editInt64Type->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editInt64Type->setOptionalDbNameNull();
						}
						else {
							editInt64Type->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editInt64Type->setOptionalInitValueNull();
						}
						else {
							editInt64Type->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editInt64Type->setOptionalMinValueNull();
						}
						else {
							editInt64Type->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editInt64Type->setOptionalMaxValueNull();
						}
						else {
							editInt64Type->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editInt64Type != NULL ) {
				if( origInt64Type != NULL ) {
					...
					origInt64Type = dynamic_cast<cfbam::ICFBamInt64TypeObj*>( editInt64Type->create() );
				}
				editInt64Type = NULL;
			}
			...
			curContext->setObj( origInt64Type );
...
cleanup:
	...
	void CFBamSaxLoaderInt64TypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
