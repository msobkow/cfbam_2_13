...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpMySqlTableUsing
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpMySqlTableUsingHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpMySqlTableUsingHandler::CFBamSaxLoaderTableCSharpMySqlTableUsingHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpMySqlTableUsingHandler::~CFBamSaxLoaderTableCSharpMySqlTableUsingHandler() {
	}

	void CFBamSaxLoaderTableCSharpMySqlTableUsingHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpMySqlTableUsing" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpMySqlTableUsingHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpMySqlTableUsing more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsMySqlTableUsingNull() || origBuff->getOptionalCsMySqlTableUsingValue().empty() ) {
			editBuff->setOptionalCsMySqlTableUsingValue( attrText );
		}
		else {
