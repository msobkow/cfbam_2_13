...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusEditObjImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusEditObjImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusEditObjImplementationHandler::CFBamSaxLoaderTableHPlusEditObjImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusEditObjImplementationHandler::~CFBamSaxLoaderTableHPlusEditObjImplementationHandler() {
	}

	void CFBamSaxLoaderTableHPlusEditObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusEditObjImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusEditObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusEditObjImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppEditObjImplementationNull() || origBuff->getOptionalHppEditObjImplementationValue().empty() ) {
			editBuff->setOptionalHppEditObjImplementationValue( attrText );
		}
		else {
