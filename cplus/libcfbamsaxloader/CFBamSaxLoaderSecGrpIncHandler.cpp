...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderSecGrpIncHandler::CLASS_NAME( "CFBamSaxLoaderSecGrpIncHandler" );
	const std::string CFBamSaxLoaderSecGrpIncHandler::S_True( "true" );
	const std::string CFBamSaxLoaderSecGrpIncHandler::S_False( "false" );
	const std::string CFBamSaxLoaderSecGrpIncHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderSecGrpIncHandler::S_No( "no" );
	const std::string CFBamSaxLoaderSecGrpIncHandler::S_0( "0" );
	const std::string CFBamSaxLoaderSecGrpIncHandler::S_1( "1" );

	CFBamSaxLoaderSecGrpIncHandler::CFBamSaxLoaderSecGrpIncHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderSecGrpIncHandler::~CFBamSaxLoaderSecGrpIncHandler() {
	}

	void CFBamSaxLoaderSecGrpIncHandler::startElement (
...
cleanup:
	...
	void CFBamSaxLoaderSecGrpIncHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
