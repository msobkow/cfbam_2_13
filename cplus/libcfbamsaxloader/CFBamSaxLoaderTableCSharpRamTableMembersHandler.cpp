...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpRamTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpRamTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpRamTableMembersHandler::CFBamSaxLoaderTableCSharpRamTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpRamTableMembersHandler::~CFBamSaxLoaderTableCSharpRamTableMembersHandler() {
	}

	void CFBamSaxLoaderTableCSharpRamTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpRamTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpRamTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpRamTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsRamTableMembersNull() || origBuff->getOptionalCsRamTableMembersValue().empty() ) {
			editBuff->setOptionalCsRamTableMembersValue( attrText );
		}
		else {
