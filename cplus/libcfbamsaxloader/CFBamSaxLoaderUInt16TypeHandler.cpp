...
// Description: C++18 XML SAX2 Element Handler implementation for UInt16Type
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderUInt16TypeHandler::CLASS_NAME( "CFBamSaxLoaderUInt16TypeHandler" );
	const std::string CFBamSaxLoaderUInt16TypeHandler::S_True( "true" );
	const std::string CFBamSaxLoaderUInt16TypeHandler::S_False( "false" );
	const std::string CFBamSaxLoaderUInt16TypeHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderUInt16TypeHandler::S_No( "no" );
	const std::string CFBamSaxLoaderUInt16TypeHandler::S_0( "0" );
	const std::string CFBamSaxLoaderUInt16TypeHandler::S_1( "1" );

	CFBamSaxLoaderUInt16TypeHandler::CFBamSaxLoaderUInt16TypeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderUInt16TypeHandler::~CFBamSaxLoaderUInt16TypeHandler() {
	}

	void CFBamSaxLoaderUInt16TypeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamUInt16TypeObj* tmpBuff = NULL;
		cfbam::ICFBamUInt16TypeEditObj* editBuff = NULL;
		cfbam::ICFBamUInt16TypeEditObj* editUInt16Type = NULL;
		cfbam::ICFBamUInt16TypeObj* origUInt16Type = NULL;
		...
		cflib::CFLibNullableUInt16 natInitValue;
		cflib::CFLibNullableUInt16 natMinValue;
		cflib::CFLibNullableUInt16 natMaxValue;
		try {
			if( ( uri == NULL ) || ( *uri == 0 ) ) {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamUInt16TypeBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamUInt16TypeBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getUInt16TypeTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamUInt16TypeEditObj*>( tmpBuff->beginEdit() );
			...
			if( ( attrInitValue == NULL ) || ( attrInitValue->length() == 0 ) ) {
				...
				uint16_t* value = cflib::CFLibXmlUtil::parseUInt16( *attrInitValue );
				if( value != NULL ) {
			...
			if( ( attrMinValue == NULL ) || ( attrMinValue->length() == 0 ) ) {
				...
				uint16_t* value = cflib::CFLibXmlUtil::parseUInt16( *attrMinValue );
				if( value != NULL ) {
			...
			if( ( attrMaxValue == NULL ) || ( attrMaxValue->length() == 0 ) ) {
				...
				uint16_t* value = cflib::CFLibXmlUtil::parseUInt16( *attrMaxValue );
				if( value != NULL ) {
			...
			loaderBehaviour = saxLoader->getUInt16TypeLoaderBehaviour();
			origUInt16Type = dynamic_cast<cfbam::ICFBamUInt16TypeObj*>( schemaObj->getUInt16TypeTableObj()->readUInt16TypeByUNameIdx( refTenant->getRequiredId(),
			...
			if( origUInt16Type == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editUInt16Type = dynamic_cast<cfbam::ICFBamUInt16TypeEditObj*>( origUInt16Type->beginEdit() );
						editUInt16Type->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editUInt16Type->setOptionalShortNameNull();
						}
						else {
							editUInt16Type->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editUInt16Type->setOptionalLabelNull();
						}
						else {
							editUInt16Type->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editUInt16Type->setOptionalShortDescriptionNull();
						}
						else {
							editUInt16Type->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editUInt16Type->setOptionalDescriptionNull();
						}
						else {
							editUInt16Type->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editUInt16Type->setOptionalDefaultXmlValueNull();
						}
						else {
							editUInt16Type->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editUInt16Type->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editUInt16Type->setOptionalGenerateIdNull();
						}
						else {
							editUInt16Type->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editUInt16Type->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editUInt16Type->setOptionalDbNameNull();
						}
						else {
							editUInt16Type->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editUInt16Type->setOptionalInitValueNull();
						}
						else {
							editUInt16Type->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editUInt16Type->setOptionalMinValueNull();
						}
						else {
							editUInt16Type->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editUInt16Type->setOptionalMaxValueNull();
						}
						else {
							editUInt16Type->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editUInt16Type != NULL ) {
				if( origUInt16Type != NULL ) {
					...
					origUInt16Type = dynamic_cast<cfbam::ICFBamUInt16TypeObj*>( editUInt16Type->create() );
				}
				editUInt16Type = NULL;
			}
			...
			curContext->setObj( origUInt16Type );
...
cleanup:
	...
	void CFBamSaxLoaderUInt16TypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
