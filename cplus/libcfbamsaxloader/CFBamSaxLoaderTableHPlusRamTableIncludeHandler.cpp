...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusRamTableInclude
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusRamTableIncludeHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusRamTableIncludeHandler::CFBamSaxLoaderTableHPlusRamTableIncludeHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusRamTableIncludeHandler::~CFBamSaxLoaderTableHPlusRamTableIncludeHandler() {
	}

	void CFBamSaxLoaderTableHPlusRamTableIncludeHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusRamTableInclude" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusRamTableIncludeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusRamTableInclude more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppRamTableIncludeNull() || origBuff->getOptionalHppRamTableIncludeValue().empty() ) {
			editBuff->setOptionalHppRamTableIncludeValue( attrText );
		}
		else {
