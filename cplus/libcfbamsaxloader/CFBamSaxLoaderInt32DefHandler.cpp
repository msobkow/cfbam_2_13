...
// Description: C++18 XML SAX2 Element Handler implementation for Int32Def
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderInt32DefHandler::CLASS_NAME( "CFBamSaxLoaderInt32DefHandler" );
	const std::string CFBamSaxLoaderInt32DefHandler::S_True( "true" );
	const std::string CFBamSaxLoaderInt32DefHandler::S_False( "false" );
	const std::string CFBamSaxLoaderInt32DefHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderInt32DefHandler::S_No( "no" );
	const std::string CFBamSaxLoaderInt32DefHandler::S_0( "0" );
	const std::string CFBamSaxLoaderInt32DefHandler::S_1( "1" );

	CFBamSaxLoaderInt32DefHandler::CFBamSaxLoaderInt32DefHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderInt32DefHandler::~CFBamSaxLoaderInt32DefHandler() {
	}

	void CFBamSaxLoaderInt32DefHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamInt32DefObj* tmpBuff = NULL;
		cfbam::ICFBamInt32DefEditObj* editBuff = NULL;
		cfbam::ICFBamInt32DefEditObj* editInt32Def = NULL;
		cfbam::ICFBamInt32DefObj* origInt32Def = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamInt32DefBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamInt32DefBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getInt32DefTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamInt32DefEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getInt32DefLoaderBehaviour();
			origInt32Def = dynamic_cast<cfbam::ICFBamInt32DefObj*>( schemaObj->getInt32DefTableObj()->readInt32DefByUNameIdx( refTenant->getRequiredId(),
			...
			if( origInt32Def == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editInt32Def = dynamic_cast<cfbam::ICFBamInt32DefEditObj*>( origInt32Def->beginEdit() );
						editInt32Def->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editInt32Def->setOptionalShortNameNull();
						}
						else {
							editInt32Def->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editInt32Def->setOptionalLabelNull();
						}
						else {
							editInt32Def->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editInt32Def->setOptionalShortDescriptionNull();
						}
						else {
							editInt32Def->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editInt32Def->setOptionalDescriptionNull();
						}
						else {
							editInt32Def->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editInt32Def->setOptionalDefaultXmlValueNull();
						}
						else {
							editInt32Def->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editInt32Def->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editInt32Def->setOptionalGenerateIdNull();
						}
						else {
							editInt32Def->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editInt32Def->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editInt32Def->setOptionalDbNameNull();
						}
						else {
							editInt32Def->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editInt32Def->setOptionalInitValueNull();
						}
						else {
							editInt32Def->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editInt32Def->setOptionalMinValueNull();
						}
						else {
							editInt32Def->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editInt32Def->setOptionalMaxValueNull();
						}
						else {
							editInt32Def->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editInt32Def != NULL ) {
				if( origInt32Def != NULL ) {
					...
					origInt32Def = dynamic_cast<cfbam::ICFBamInt32DefObj*>( editInt32Def->create() );
				}
				editInt32Def = NULL;
			}
			...
			curContext->setObj( origInt32Def );
...
cleanup:
	...
	void CFBamSaxLoaderInt32DefHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
