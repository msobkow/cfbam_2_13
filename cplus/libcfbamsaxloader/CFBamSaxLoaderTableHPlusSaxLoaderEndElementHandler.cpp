...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusSaxLoaderEndElement
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusSaxLoaderEndElementHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusSaxLoaderEndElementHandler::CFBamSaxLoaderTableHPlusSaxLoaderEndElementHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusSaxLoaderEndElementHandler::~CFBamSaxLoaderTableHPlusSaxLoaderEndElementHandler() {
	}

	void CFBamSaxLoaderTableHPlusSaxLoaderEndElementHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusSaxLoaderEndElement" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusSaxLoaderEndElementHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusSaxLoaderEndElement more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppSaxLoaderEndElementNull() || origBuff->getOptionalHppSaxLoaderEndElementValue().empty() ) {
			editBuff->setOptionalHppSaxLoaderEndElementValue( attrText );
		}
		else {
