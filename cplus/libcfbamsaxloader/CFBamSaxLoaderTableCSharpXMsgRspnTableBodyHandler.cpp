...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpXMsgRspnTableBody
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpXMsgRspnTableBodyHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpXMsgRspnTableBodyHandler::CFBamSaxLoaderTableCSharpXMsgRspnTableBodyHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpXMsgRspnTableBodyHandler::~CFBamSaxLoaderTableCSharpXMsgRspnTableBodyHandler() {
	}

	void CFBamSaxLoaderTableCSharpXMsgRspnTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpXMsgRspnTableBody" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpXMsgRspnTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpXMsgRspnTableBody more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsXMsgRspnTableBodyNull() || origBuff->getOptionalCsXMsgRspnTableBodyValue().empty() ) {
			editBuff->setOptionalCsXMsgRspnTableBodyValue( attrText );
		}
		else {
