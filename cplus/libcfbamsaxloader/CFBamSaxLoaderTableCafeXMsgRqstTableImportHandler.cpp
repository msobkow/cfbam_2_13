...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeXMsgRqstTableImport
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeXMsgRqstTableImportHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeXMsgRqstTableImportHandler::CFBamSaxLoaderTableCafeXMsgRqstTableImportHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeXMsgRqstTableImportHandler::~CFBamSaxLoaderTableCafeXMsgRqstTableImportHandler() {
	}

	void CFBamSaxLoaderTableCafeXMsgRqstTableImportHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeXMsgRqstTableImport" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeXMsgRqstTableImportHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeXMsgRqstTableImport more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJXMsgRqstTableImportNull() || origBuff->getOptionalJXMsgRqstTableImportValue().empty() ) {
			editBuff->setOptionalJXMsgRqstTableImportValue( attrText );
		}
		else {
