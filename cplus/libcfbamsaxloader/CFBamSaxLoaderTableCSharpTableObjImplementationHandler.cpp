...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpTableObjImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpTableObjImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpTableObjImplementationHandler::CFBamSaxLoaderTableCSharpTableObjImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpTableObjImplementationHandler::~CFBamSaxLoaderTableCSharpTableObjImplementationHandler() {
	}

	void CFBamSaxLoaderTableCSharpTableObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpTableObjImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpTableObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpTableObjImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsTableObjImplementationNull() || origBuff->getOptionalCsTableObjImplementationValue().empty() ) {
			editBuff->setOptionalCsTableObjImplementationValue( attrText );
		}
		else {
