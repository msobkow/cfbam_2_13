...
// Description: C++18 XML SAX2 Element Handler implementation for UuidDef
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderUuidDefHandler::CLASS_NAME( "CFBamSaxLoaderUuidDefHandler" );
	const std::string CFBamSaxLoaderUuidDefHandler::S_True( "true" );
	const std::string CFBamSaxLoaderUuidDefHandler::S_False( "false" );
	const std::string CFBamSaxLoaderUuidDefHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderUuidDefHandler::S_No( "no" );
	const std::string CFBamSaxLoaderUuidDefHandler::S_0( "0" );
	const std::string CFBamSaxLoaderUuidDefHandler::S_1( "1" );

	CFBamSaxLoaderUuidDefHandler::CFBamSaxLoaderUuidDefHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderUuidDefHandler::~CFBamSaxLoaderUuidDefHandler() {
	}

	void CFBamSaxLoaderUuidDefHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamUuidDefObj* tmpBuff = NULL;
		cfbam::ICFBamUuidDefEditObj* editBuff = NULL;
		cfbam::ICFBamUuidDefEditObj* editUuidDef = NULL;
		cfbam::ICFBamUuidDefObj* origUuidDef = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamUuidDefBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamUuidDefBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getUuidDefTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamUuidDefEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getUuidDefLoaderBehaviour();
			origUuidDef = dynamic_cast<cfbam::ICFBamUuidDefObj*>( schemaObj->getUuidDefTableObj()->readUuidDefByUNameIdx( refTenant->getRequiredId(),
			...
			if( origUuidDef == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editUuidDef = dynamic_cast<cfbam::ICFBamUuidDefEditObj*>( origUuidDef->beginEdit() );
						editUuidDef->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editUuidDef->setOptionalShortNameNull();
						}
						else {
							editUuidDef->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editUuidDef->setOptionalLabelNull();
						}
						else {
							editUuidDef->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editUuidDef->setOptionalShortDescriptionNull();
						}
						else {
							editUuidDef->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editUuidDef->setOptionalDescriptionNull();
						}
						else {
							editUuidDef->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editUuidDef->setOptionalDefaultXmlValueNull();
						}
						else {
							editUuidDef->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editUuidDef->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editUuidDef->setOptionalGenerateIdNull();
						}
						else {
							editUuidDef->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editUuidDef->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editUuidDef->setOptionalDbNameNull();
						}
						else {
							editUuidDef->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						if( editBuff->isOptionalInitValueNull() ) {
							editUuidDef->setOptionalInitValueNull();
						}
						else {
							editUuidDef->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
			...
			if( editUuidDef != NULL ) {
				if( origUuidDef != NULL ) {
					...
					origUuidDef = dynamic_cast<cfbam::ICFBamUuidDefObj*>( editUuidDef->create() );
				}
				editUuidDef = NULL;
			}
...
cleanup:
	...
	void CFBamSaxLoaderUuidDefHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
