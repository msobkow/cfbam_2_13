...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpTableObjInterface
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpTableObjInterfaceHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpTableObjInterfaceHandler::CFBamSaxLoaderTableCSharpTableObjInterfaceHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpTableObjInterfaceHandler::~CFBamSaxLoaderTableCSharpTableObjInterfaceHandler() {
	}

	void CFBamSaxLoaderTableCSharpTableObjInterfaceHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpTableObjInterface" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpTableObjInterfaceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpTableObjInterface more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsTableObjInterfaceNull() || origBuff->getOptionalCsTableObjInterfaceValue().empty() ) {
			editBuff->setOptionalCsTableObjInterfaceValue( attrText );
		}
		else {
