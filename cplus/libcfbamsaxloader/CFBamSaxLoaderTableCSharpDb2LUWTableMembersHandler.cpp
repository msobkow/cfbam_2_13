...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpDb2LUWTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpDb2LUWTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpDb2LUWTableMembersHandler::CFBamSaxLoaderTableCSharpDb2LUWTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpDb2LUWTableMembersHandler::~CFBamSaxLoaderTableCSharpDb2LUWTableMembersHandler() {
	}

	void CFBamSaxLoaderTableCSharpDb2LUWTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpDb2LUWTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpDb2LUWTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpDb2LUWTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsDb2LUWTableMembersNull() || origBuff->getOptionalCsDb2LUWTableMembersValue().empty() ) {
			editBuff->setOptionalCsDb2LUWTableMembersValue( attrText );
		}
		else {
