...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeOracleTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeOracleTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeOracleTableImplementationHandler::CFBamSaxLoaderTableCafeOracleTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeOracleTableImplementationHandler::~CFBamSaxLoaderTableCafeOracleTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableCafeOracleTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeOracleTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeOracleTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeOracleTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJOracleTableImplementationNull() || origBuff->getOptionalJOracleTableImplementationValue().empty() ) {
			editBuff->setOptionalJOracleTableImplementationValue( attrText );
		}
		else {
