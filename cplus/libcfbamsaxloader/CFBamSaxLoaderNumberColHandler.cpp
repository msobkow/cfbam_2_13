...
// Description: C++18 XML SAX2 Element Handler implementation for NumberCol
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderNumberColHandler::CLASS_NAME( "CFBamSaxLoaderNumberColHandler" );
	const std::string CFBamSaxLoaderNumberColHandler::S_True( "true" );
	const std::string CFBamSaxLoaderNumberColHandler::S_False( "false" );
	const std::string CFBamSaxLoaderNumberColHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderNumberColHandler::S_No( "no" );
	const std::string CFBamSaxLoaderNumberColHandler::S_0( "0" );
	const std::string CFBamSaxLoaderNumberColHandler::S_1( "1" );

	CFBamSaxLoaderNumberColHandler::CFBamSaxLoaderNumberColHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderNumberColHandler::~CFBamSaxLoaderNumberColHandler() {
	}

	void CFBamSaxLoaderNumberColHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamNumberColObj* tmpBuff = NULL;
		cfbam::ICFBamNumberColEditObj* editBuff = NULL;
		cfbam::ICFBamNumberColEditObj* editNumberCol = NULL;
		cfbam::ICFBamNumberColObj* origNumberCol = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamNumberColBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamNumberColBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getNumberColTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamNumberColEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getNumberColLoaderBehaviour();
			origNumberCol = dynamic_cast<cfbam::ICFBamNumberColObj*>( schemaObj->getNumberColTableObj()->readNumberColByUNameIdx( refTenant->getRequiredId(),
			...
			if( origNumberCol == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editNumberCol = dynamic_cast<cfbam::ICFBamNumberColEditObj*>( origNumberCol->beginEdit() );
						editNumberCol->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editNumberCol->setOptionalShortNameNull();
						}
						else {
							editNumberCol->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editNumberCol->setOptionalLabelNull();
						}
						else {
							editNumberCol->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editNumberCol->setOptionalShortDescriptionNull();
						}
						else {
							editNumberCol->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editNumberCol->setOptionalDescriptionNull();
						}
						else {
							editNumberCol->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editNumberCol->setOptionalDefaultXmlValueNull();
						}
						else {
							editNumberCol->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editNumberCol->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editNumberCol->setOptionalGenerateIdNull();
						}
						else {
							editNumberCol->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editNumberCol->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editNumberCol->setOptionalDbNameNull();
						}
						else {
							editNumberCol->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						...
						if( editBuff->isOptionalInitValueNull() ) {
							editNumberCol->setOptionalInitValueNull();
						}
						else {
							editNumberCol->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
						if( editBuff->isOptionalMinValueNull() ) {
							editNumberCol->setOptionalMinValueNull();
						}
						else {
							editNumberCol->setOptionalMinValueValue( editBuff->getOptionalMinValueValue() );
						}
						if( editBuff->isOptionalMaxValueNull() ) {
							editNumberCol->setOptionalMaxValueNull();
						}
						else {
							editNumberCol->setOptionalMaxValueValue( editBuff->getOptionalMaxValueValue() );
						}
			...
			if( editNumberCol != NULL ) {
				if( origNumberCol != NULL ) {
					...
					origNumberCol = dynamic_cast<cfbam::ICFBamNumberColObj*>( editNumberCol->create() );
				}
				editNumberCol = NULL;
			}
			...
			curContext->setObj( origNumberCol );
...
cleanup:
	...
	void CFBamSaxLoaderNumberColHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
