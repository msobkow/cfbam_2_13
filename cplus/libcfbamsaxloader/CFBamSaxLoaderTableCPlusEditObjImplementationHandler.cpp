...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusEditObjImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusEditObjImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusEditObjImplementationHandler::CFBamSaxLoaderTableCPlusEditObjImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusEditObjImplementationHandler::~CFBamSaxLoaderTableCPlusEditObjImplementationHandler() {
	}

	void CFBamSaxLoaderTableCPlusEditObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusEditObjImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusEditObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusEditObjImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppEditObjImplementationNull() || origBuff->getOptionalCppEditObjImplementationValue().empty() ) {
			editBuff->setOptionalCppEditObjImplementationValue( attrText );
		}
		else {
