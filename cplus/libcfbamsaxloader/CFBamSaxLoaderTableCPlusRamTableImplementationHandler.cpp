...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusRamTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusRamTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusRamTableImplementationHandler::CFBamSaxLoaderTableCPlusRamTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusRamTableImplementationHandler::~CFBamSaxLoaderTableCPlusRamTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableCPlusRamTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusRamTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusRamTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusRamTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppRamTableImplementationNull() || origBuff->getOptionalCppRamTableImplementationValue().empty() ) {
			editBuff->setOptionalCppRamTableImplementationValue( attrText );
		}
		else {
