...
// Description: C++18 XML SAX2 Element Handler implementation for NmTokenDef
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderNmTokenDefHandler::CLASS_NAME( "CFBamSaxLoaderNmTokenDefHandler" );
	const std::string CFBamSaxLoaderNmTokenDefHandler::S_True( "true" );
	const std::string CFBamSaxLoaderNmTokenDefHandler::S_False( "false" );
	const std::string CFBamSaxLoaderNmTokenDefHandler::S_Yes( "yes" );
	const std::string CFBamSaxLoaderNmTokenDefHandler::S_No( "no" );
	const std::string CFBamSaxLoaderNmTokenDefHandler::S_0( "0" );
	const std::string CFBamSaxLoaderNmTokenDefHandler::S_1( "1" );

	CFBamSaxLoaderNmTokenDefHandler::CFBamSaxLoaderNmTokenDefHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderNmTokenDefHandler::~CFBamSaxLoaderNmTokenDefHandler() {
	}

	void CFBamSaxLoaderNmTokenDefHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		cfbam::ICFBamNmTokenDefObj* tmpBuff = NULL;
		cfbam::ICFBamNmTokenDefEditObj* editBuff = NULL;
		cfbam::ICFBamNmTokenDefEditObj* editNmTokenDef = NULL;
		cfbam::ICFBamNmTokenDefObj* origNmTokenDef = NULL;
		...
		try {
			...
			cQName = NULL;
			if( cppQName != cfbam::CFBamNmTokenDefBuff::GENDEFNAME ) {
				std::string Msg( "Expected QName to be '" + cfbam::CFBamNmTokenDefBuff::GENDEFNAME + "'" );
			...
			tmpBuff = schemaObj->getNmTokenDefTableObj()->newInstance();
			editBuff = dynamic_cast<cfbam::ICFBamNmTokenDefEditObj*>( tmpBuff->beginEdit() );
			...
			loaderBehaviour = saxLoader->getNmTokenDefLoaderBehaviour();
			origNmTokenDef = dynamic_cast<cfbam::ICFBamNmTokenDefObj*>( schemaObj->getNmTokenDefTableObj()->readNmTokenDefByUNameIdx( refTenant->getRequiredId(),
			...
			if( origNmTokenDef == NULL ) {
				...
				switch( loaderBehaviour ) {
					...
					case cfbam::CFBamSaxLoader::LoaderBehaviourEnum::Update:
						editNmTokenDef = dynamic_cast<cfbam::ICFBamNmTokenDefEditObj*>( origNmTokenDef->beginEdit() );
						editNmTokenDef->setRequiredName( editBuff->getRequiredName() );
						if( editBuff->isOptionalShortNameNull() ) {
							editNmTokenDef->setOptionalShortNameNull();
						}
						else {
							editNmTokenDef->setOptionalShortNameValue( editBuff->getOptionalShortNameValue() );
						}
						if( editBuff->isOptionalLabelNull() ) {
							editNmTokenDef->setOptionalLabelNull();
						}
						else {
							editNmTokenDef->setOptionalLabelValue( editBuff->getOptionalLabelValue() );
						}
						if( editBuff->isOptionalShortDescriptionNull() ) {
							editNmTokenDef->setOptionalShortDescriptionNull();
						}
						else {
							editNmTokenDef->setOptionalShortDescriptionValue( editBuff->getOptionalShortDescriptionValue() );
						}
						if( editBuff->isOptionalDescriptionNull() ) {
							editNmTokenDef->setOptionalDescriptionNull();
						}
						else {
							editNmTokenDef->setOptionalDescriptionValue( editBuff->getOptionalDescriptionValue() );
						}
						if( editBuff->isOptionalDefaultXmlValueNull() ) {
							editNmTokenDef->setOptionalDefaultXmlValueNull();
						}
						else {
							editNmTokenDef->setOptionalDefaultXmlValueValue( editBuff->getOptionalDefaultXmlValueValue() );
						}
						editNmTokenDef->setRequiredIsNullable( editBuff->getRequiredIsNullable() );
						if( editBuff->isOptionalGenerateIdNull() ) {
							editNmTokenDef->setOptionalGenerateIdNull();
						}
						else {
							editNmTokenDef->setOptionalGenerateIdValue( editBuff->getOptionalGenerateIdValue() );
						}
						editNmTokenDef->setRequiredImplementsPolymorph( editBuff->getRequiredImplementsPolymorph() );
						if( editBuff->isOptionalDbNameNull() ) {
							editNmTokenDef->setOptionalDbNameNull();
						}
						else {
							editNmTokenDef->setOptionalDbNameValue( editBuff->getOptionalDbNameValue() );
						}
						editNmTokenDef->setRequiredMaxLen( editBuff->getRequiredMaxLen() );
						if( editBuff->isOptionalInitValueNull() ) {
							editNmTokenDef->setOptionalInitValueNull();
						}
						else {
							editNmTokenDef->setOptionalInitValueValue( editBuff->getOptionalInitValueValue() );
						}
			...
			if( editNmTokenDef != NULL ) {
				if( origNmTokenDef != NULL ) {
					...
					origNmTokenDef = dynamic_cast<cfbam::ICFBamNmTokenDefObj*>( editNmTokenDef->create() );
				}
				editNmTokenDef = NULL;
			}
			...
			curContext->setObj( origNmTokenDef );
...
cleanup:
	...
	void CFBamSaxLoaderNmTokenDefHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
