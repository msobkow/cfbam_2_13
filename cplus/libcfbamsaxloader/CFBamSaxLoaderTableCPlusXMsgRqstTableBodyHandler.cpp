...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CPlusXMsgRqstTableBody
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCPlusXMsgRqstTableBodyHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCPlusXMsgRqstTableBodyHandler::CFBamSaxLoaderTableCPlusXMsgRqstTableBodyHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCPlusXMsgRqstTableBodyHandler::~CFBamSaxLoaderTableCPlusXMsgRqstTableBodyHandler() {
	}

	void CFBamSaxLoaderTableCPlusXMsgRqstTableBodyHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CPlusXMsgRqstTableBody" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCPlusXMsgRqstTableBodyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CPlusXMsgRqstTableBody more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCppXMsgRqstTableBodyNull() || origBuff->getOptionalCppXMsgRqstTableBodyValue().empty() ) {
			editBuff->setOptionalCppXMsgRqstTableBodyValue( attrText );
		}
		else {
