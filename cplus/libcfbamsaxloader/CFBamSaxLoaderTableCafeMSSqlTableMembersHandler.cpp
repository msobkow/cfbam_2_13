...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeMSSqlTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeMSSqlTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeMSSqlTableMembersHandler::CFBamSaxLoaderTableCafeMSSqlTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeMSSqlTableMembersHandler::~CFBamSaxLoaderTableCafeMSSqlTableMembersHandler() {
	}

	void CFBamSaxLoaderTableCafeMSSqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeMSSqlTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeMSSqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeMSSqlTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJMSSqlTableMembersNull() || origBuff->getOptionalJMSSqlTableMembersValue().empty() ) {
			editBuff->setOptionalJMSSqlTableMembersValue( attrText );
		}
		else {
