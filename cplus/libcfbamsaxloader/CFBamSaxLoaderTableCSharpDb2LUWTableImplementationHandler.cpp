...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CSharpDb2LUWTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCSharpDb2LUWTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCSharpDb2LUWTableImplementationHandler::CFBamSaxLoaderTableCSharpDb2LUWTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCSharpDb2LUWTableImplementationHandler::~CFBamSaxLoaderTableCSharpDb2LUWTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableCSharpDb2LUWTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CSharpDb2LUWTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCSharpDb2LUWTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CSharpDb2LUWTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalCsDb2LUWTableImplementationNull() || origBuff->getOptionalCsDb2LUWTableImplementationValue().empty() ) {
			editBuff->setOptionalCsDb2LUWTableImplementationValue( attrText );
		}
		else {
