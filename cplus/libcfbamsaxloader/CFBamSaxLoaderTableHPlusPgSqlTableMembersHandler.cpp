...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusPgSqlTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusPgSqlTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusPgSqlTableMembersHandler::CFBamSaxLoaderTableHPlusPgSqlTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusPgSqlTableMembersHandler::~CFBamSaxLoaderTableHPlusPgSqlTableMembersHandler() {
	}

	void CFBamSaxLoaderTableHPlusPgSqlTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusPgSqlTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusPgSqlTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusPgSqlTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppPgSqlTableMembersNull() || origBuff->getOptionalHppPgSqlTableMembersValue().empty() ) {
			editBuff->setOptionalHppPgSqlTableMembersValue( attrText );
		}
		else {
