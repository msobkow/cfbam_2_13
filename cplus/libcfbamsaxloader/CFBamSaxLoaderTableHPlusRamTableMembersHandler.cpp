...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element HPlusRamTableMembers
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableHPlusRamTableMembersHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableHPlusRamTableMembersHandler::CFBamSaxLoaderTableHPlusRamTableMembersHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableHPlusRamTableMembersHandler::~CFBamSaxLoaderTableHPlusRamTableMembersHandler() {
	}

	void CFBamSaxLoaderTableHPlusRamTableMembersHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "HPlusRamTableMembers" );
...
cleanup:
	...
	void CFBamSaxLoaderTableHPlusRamTableMembersHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element HPlusRamTableMembers more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalHppRamTableMembersNull() || origBuff->getOptionalHppRamTableMembersValue().empty() ) {
			editBuff->setOptionalHppRamTableMembersValue( attrText );
		}
		else {
