...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafeObjImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafeObjImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafeObjImplementationHandler::CFBamSaxLoaderTableCafeObjImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafeObjImplementationHandler::~CFBamSaxLoaderTableCafeObjImplementationHandler() {
	}

	void CFBamSaxLoaderTableCafeObjImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafeObjImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafeObjImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafeObjImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJObjImplementationNull() || origBuff->getOptionalJObjImplementationValue().empty() ) {
			editBuff->setOptionalJObjImplementationValue( attrText );
		}
		else {
