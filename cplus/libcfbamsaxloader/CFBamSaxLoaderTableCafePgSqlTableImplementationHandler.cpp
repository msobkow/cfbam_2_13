...
// Description: C++18 XML SAX2 Element Handler implementation for Table sub-element CafePgSqlTableImplementation
...
namespace cfbam {
	...
	const std::string CFBamSaxLoaderTableCafePgSqlTableImplementationHandler::CLASS_NAME( "CFBamSaxLoaderTableHandler" );

	CFBamSaxLoaderTableCafePgSqlTableImplementationHandler::CFBamSaxLoaderTableCafePgSqlTableImplementationHandler( cfbam::CFBamSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFBamSaxLoaderTableCafePgSqlTableImplementationHandler::~CFBamSaxLoaderTableCafePgSqlTableImplementationHandler() {
	}

	void CFBamSaxLoaderTableCafePgSqlTableImplementationHandler::startElement (
		...
		const xercesc::Attributes& attrs )
	{
		...
		const static std::string S_XmlElementName( "CafePgSqlTableImplementation" );
...
cleanup:
	...
	void CFBamSaxLoaderTableCafePgSqlTableImplementationHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
		...
		static const std::string S_OnlySetOnceMsg( "Cannot specify Table sub-element CafePgSqlTableImplementation more than once per object" );
		CFLIB_EXCEPTION_DECLINFO
		cflib::CFLibXmlCoreContext* curContext = NULL;
		cfbam::CFBamSaxLoader* saxLoader = NULL;
		cfbam::ICFBamSchemaObj* schemaObj = NULL;
		...
		if( origBuff->isOptionalJPgSqlTableImplementationNull() || origBuff->getOptionalJPgSqlTableImplementationValue().empty() ) {
			editBuff->setOptionalJPgSqlTableImplementationValue( attrText );
		}
		else {
