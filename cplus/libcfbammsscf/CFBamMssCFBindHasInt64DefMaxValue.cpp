...
namespace cfbam {
	...
	const std::string CFBamMssCFBindHasInt64DefMaxValue::CLASS_NAME( "CFBamMssCFBindHasInt64DefMaxValue" );

	CFBamMssCFBindHasInt64DefMaxValue::CFBamMssCFBindHasInt64DefMaxValue()
	: cfcore::MssCFGenBindObj()
	{
	}

	CFBamMssCFBindHasInt64DefMaxValue::CFBamMssCFBindHasInt64DefMaxValue( cfcore::MssCFEngine* argEngine )
	: cfcore::MssCFGenBindObj( argEngine, "any", NULL, "Int64Def", "HasMaxValue" )
	{
	}
	...
	std::string CFBamMssCFBindHasInt64DefMaxValue::expandBody( cfcore::MssCFGenContext* genContext ) {
