...
namespace cfbam {
	...
	const std::string CFBamMssCFBindHasTableCppDb2LUWTableMembers::CLASS_NAME( "CFBamMssCFBindHasTableCppDb2LUWTableMembers" );

	CFBamMssCFBindHasTableCppDb2LUWTableMembers::CFBamMssCFBindHasTableCppDb2LUWTableMembers()
	: cfcore::MssCFGenBindObj()
	{
	}

	CFBamMssCFBindHasTableCppDb2LUWTableMembers::CFBamMssCFBindHasTableCppDb2LUWTableMembers( cfcore::MssCFEngine* argEngine )
	: cfcore::MssCFGenBindObj( argEngine, "any", NULL, "Table", "HasCppDb2LUWTableMembers" )
	{
	}
	...
	std::string CFBamMssCFBindHasTableCppDb2LUWTableMembers::expandBody( cfcore::MssCFGenContext* genContext ) {
