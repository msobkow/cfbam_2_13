...
namespace cfbam {
	...
	const std::string CFBamMssCFBindHasDelDepDefSchemaTenantId::CLASS_NAME( "CFBamMssCFBindHasDelDepDefSchemaTenantId" );

	CFBamMssCFBindHasDelDepDefSchemaTenantId::CFBamMssCFBindHasDelDepDefSchemaTenantId()
	: cfcore::MssCFGenBindObj()
	{
	}

	CFBamMssCFBindHasDelDepDefSchemaTenantId::CFBamMssCFBindHasDelDepDefSchemaTenantId( cfcore::MssCFEngine* argEngine )
	: cfcore::MssCFGenBindObj( argEngine, "any", NULL, "DelDep", "HasDefSchemaTenantId" )
	{
	}
	...
	std::string CFBamMssCFBindHasDelDepDefSchemaTenantId::expandBody( cfcore::MssCFGenContext* genContext ) {
