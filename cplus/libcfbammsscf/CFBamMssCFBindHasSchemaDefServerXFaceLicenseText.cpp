...
namespace cfbam {
	...
	const std::string CFBamMssCFBindHasSchemaDefServerXFaceLicenseText::CLASS_NAME( "CFBamMssCFBindHasSchemaDefServerXFaceLicenseText" );

	CFBamMssCFBindHasSchemaDefServerXFaceLicenseText::CFBamMssCFBindHasSchemaDefServerXFaceLicenseText()
	: cfcore::MssCFGenBindObj()
	{
	}

	CFBamMssCFBindHasSchemaDefServerXFaceLicenseText::CFBamMssCFBindHasSchemaDefServerXFaceLicenseText( cfcore::MssCFEngine* argEngine )
	: cfcore::MssCFGenBindObj( argEngine, "any", NULL, "SchemaDef", "HasServerXFaceLicenseText" )
	{
	}
	...
	std::string CFBamMssCFBindHasSchemaDefServerXFaceLicenseText::expandBody( cfcore::MssCFGenContext* genContext ) {
