...
namespace cfbam {
	 ...
	 */
	class CFBamMssCFBindParamDefSchemaTenantId : public cfcore::MssCFGenBindObj
	{
		public:
			static const std::string CLASS_NAME;

			CFBamMssCFBindParamDefSchemaTenantId();
			CFBamMssCFBindParamDefSchemaTenantId( cfcore::MssCFEngine* argEngine );
			virtual ~CFBamMssCFBindParamDefSchemaTenantId();
