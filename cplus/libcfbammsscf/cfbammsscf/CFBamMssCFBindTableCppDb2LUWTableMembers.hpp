...
namespace cfbam {
	 ...
	 */
	class CFBamMssCFBindTableCppDb2LUWTableMembers : public cfcore::MssCFGenBindObj
	{
		public:
			static const std::string CLASS_NAME;

			CFBamMssCFBindTableCppDb2LUWTableMembers();
			CFBamMssCFBindTableCppDb2LUWTableMembers( cfcore::MssCFEngine* argEngine );
			virtual ~CFBamMssCFBindTableCppDb2LUWTableMembers();
