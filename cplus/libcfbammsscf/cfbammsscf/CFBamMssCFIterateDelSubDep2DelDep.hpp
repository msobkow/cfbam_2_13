...
namespace cfbam {
	 ...
	 */
	class CFBamMssCFIterateDelSubDep2DelDep : public cfcore::MssCFGenIteratorObj
	{
		public:
			static const std::string CLASS_NAME;

			CFBamMssCFIterateDelSubDep2DelDep();
			CFBamMssCFIterateDelSubDep2DelDep( cfcore::MssCFEngine* argEngine );
			virtual ~CFBamMssCFIterateDelSubDep2DelDep();
