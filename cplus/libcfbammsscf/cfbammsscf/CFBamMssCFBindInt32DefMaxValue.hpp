...
namespace cfbam {
	 ...
	 */
	class CFBamMssCFBindInt32DefMaxValue : public cfcore::MssCFGenBindObj
	{
		public:
			static const std::string CLASS_NAME;

			CFBamMssCFBindInt32DefMaxValue();
			CFBamMssCFBindInt32DefMaxValue( cfcore::MssCFEngine* argEngine );
			virtual ~CFBamMssCFBindInt32DefMaxValue();
