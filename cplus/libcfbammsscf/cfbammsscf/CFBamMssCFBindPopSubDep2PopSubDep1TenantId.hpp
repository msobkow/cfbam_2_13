...
namespace cfbam {
	 ...
	 */
	class CFBamMssCFBindPopSubDep2PopSubDep1TenantId : public cfcore::MssCFGenBindObj
	{
		public:
			static const std::string CLASS_NAME;

			CFBamMssCFBindPopSubDep2PopSubDep1TenantId();
			CFBamMssCFBindPopSubDep2PopSubDep1TenantId( cfcore::MssCFEngine* argEngine );
			virtual ~CFBamMssCFBindPopSubDep2PopSubDep1TenantId();
