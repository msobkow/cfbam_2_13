...
namespace cfbam {
	 ...
	 */
	class CFBamMssCFBindSecSessionSecProxyId : public cfcore::MssCFGenBindObj
	{
		public:
			static const std::string CLASS_NAME;

			CFBamMssCFBindSecSessionSecProxyId();
			CFBamMssCFBindSecSessionSecProxyId( cfcore::MssCFEngine* argEngine );
			virtual ~CFBamMssCFBindSecSessionSecProxyId();
