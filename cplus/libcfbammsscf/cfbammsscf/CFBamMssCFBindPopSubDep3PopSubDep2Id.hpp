...
namespace cfbam {
	 ...
	 */
	class CFBamMssCFBindPopSubDep3PopSubDep2Id : public cfcore::MssCFGenBindObj
	{
		public:
			static const std::string CLASS_NAME;

			CFBamMssCFBindPopSubDep3PopSubDep2Id();
			CFBamMssCFBindPopSubDep3PopSubDep2Id( cfcore::MssCFEngine* argEngine );
			virtual ~CFBamMssCFBindPopSubDep3PopSubDep2Id();
