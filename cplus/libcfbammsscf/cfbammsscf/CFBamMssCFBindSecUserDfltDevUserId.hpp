...
namespace cfbam {
	 ...
	 */
	class CFBamMssCFBindSecUserDfltDevUserId : public cfcore::MssCFGenBindObj
	{
		public:
			static const std::string CLASS_NAME;

			CFBamMssCFBindSecUserDfltDevUserId();
			CFBamMssCFBindSecUserDfltDevUserId( cfcore::MssCFEngine* argEngine );
			virtual ~CFBamMssCFBindSecUserDfltDevUserId();
