...
namespace cfbam {
	...
	const std::string CFBamMssCFBindHasSchemaDefHppRamSchemaObjInclude::CLASS_NAME( "CFBamMssCFBindHasSchemaDefHppRamSchemaObjInclude" );

	CFBamMssCFBindHasSchemaDefHppRamSchemaObjInclude::CFBamMssCFBindHasSchemaDefHppRamSchemaObjInclude()
	: cfcore::MssCFGenBindObj()
	{
	}

	CFBamMssCFBindHasSchemaDefHppRamSchemaObjInclude::CFBamMssCFBindHasSchemaDefHppRamSchemaObjInclude( cfcore::MssCFEngine* argEngine )
	: cfcore::MssCFGenBindObj( argEngine, "any", NULL, "SchemaDef", "HasHppRamSchemaObjInclude" )
	{
	}
	...
	std::string CFBamMssCFBindHasSchemaDefHppRamSchemaObjInclude::expandBody( cfcore::MssCFGenContext* genContext ) {
