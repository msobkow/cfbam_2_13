...
namespace cfbam {
	...
	const std::string CFBamMssCFBindHasFloatDefMaxValue::CLASS_NAME( "CFBamMssCFBindHasFloatDefMaxValue" );

	CFBamMssCFBindHasFloatDefMaxValue::CFBamMssCFBindHasFloatDefMaxValue()
	: cfcore::MssCFGenBindObj()
	{
	}

	CFBamMssCFBindHasFloatDefMaxValue::CFBamMssCFBindHasFloatDefMaxValue( cfcore::MssCFEngine* argEngine )
	: cfcore::MssCFGenBindObj( argEngine, "any", NULL, "FloatDef", "HasMaxValue" )
	{
	}
	...
	std::string CFBamMssCFBindHasFloatDefMaxValue::expandBody( cfcore::MssCFGenContext* genContext ) {
