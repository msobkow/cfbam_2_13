...
namespace cfbam {
	...
	const std::string CFBamMssCFBindHasInt32DefMaxValue::CLASS_NAME( "CFBamMssCFBindHasInt32DefMaxValue" );

	CFBamMssCFBindHasInt32DefMaxValue::CFBamMssCFBindHasInt32DefMaxValue()
	: cfcore::MssCFGenBindObj()
	{
	}

	CFBamMssCFBindHasInt32DefMaxValue::CFBamMssCFBindHasInt32DefMaxValue( cfcore::MssCFEngine* argEngine )
	: cfcore::MssCFGenBindObj( argEngine, "any", NULL, "Int32Def", "HasMaxValue" )
	{
	}
	...
	std::string CFBamMssCFBindHasInt32DefMaxValue::expandBody( cfcore::MssCFGenContext* genContext ) {
