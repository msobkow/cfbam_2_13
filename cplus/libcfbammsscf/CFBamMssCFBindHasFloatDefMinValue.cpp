...
namespace cfbam {
	...
	const std::string CFBamMssCFBindHasFloatDefMinValue::CLASS_NAME( "CFBamMssCFBindHasFloatDefMinValue" );

	CFBamMssCFBindHasFloatDefMinValue::CFBamMssCFBindHasFloatDefMinValue()
	: cfcore::MssCFGenBindObj()
	{
	}

	CFBamMssCFBindHasFloatDefMinValue::CFBamMssCFBindHasFloatDefMinValue( cfcore::MssCFEngine* argEngine )
	: cfcore::MssCFGenBindObj( argEngine, "any", NULL, "FloatDef", "HasMinValue" )
	{
	}
	...
	std::string CFBamMssCFBindHasFloatDefMinValue::expandBody( cfcore::MssCFGenContext* genContext ) {
