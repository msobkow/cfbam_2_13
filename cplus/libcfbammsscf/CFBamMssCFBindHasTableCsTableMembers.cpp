...
namespace cfbam {
	...
	const std::string CFBamMssCFBindHasTableCsTableMembers::CLASS_NAME( "CFBamMssCFBindHasTableCsTableMembers" );

	CFBamMssCFBindHasTableCsTableMembers::CFBamMssCFBindHasTableCsTableMembers()
	: cfcore::MssCFGenBindObj()
	{
	}

	CFBamMssCFBindHasTableCsTableMembers::CFBamMssCFBindHasTableCsTableMembers( cfcore::MssCFEngine* argEngine )
	: cfcore::MssCFGenBindObj( argEngine, "any", NULL, "Table", "HasCsTableMembers" )
	{
	}
	...
	std::string CFBamMssCFBindHasTableCsTableMembers::expandBody( cfcore::MssCFGenContext* genContext ) {
