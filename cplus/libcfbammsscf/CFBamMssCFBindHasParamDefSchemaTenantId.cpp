...
namespace cfbam {
	...
	const std::string CFBamMssCFBindHasParamDefSchemaTenantId::CLASS_NAME( "CFBamMssCFBindHasParamDefSchemaTenantId" );

	CFBamMssCFBindHasParamDefSchemaTenantId::CFBamMssCFBindHasParamDefSchemaTenantId()
	: cfcore::MssCFGenBindObj()
	{
	}

	CFBamMssCFBindHasParamDefSchemaTenantId::CFBamMssCFBindHasParamDefSchemaTenantId( cfcore::MssCFEngine* argEngine )
	: cfcore::MssCFGenBindObj( argEngine, "any", NULL, "Param", "HasDefSchemaTenantId" )
	{
	}
	...
	std::string CFBamMssCFBindHasParamDefSchemaTenantId::expandBody( cfcore::MssCFGenContext* genContext ) {
