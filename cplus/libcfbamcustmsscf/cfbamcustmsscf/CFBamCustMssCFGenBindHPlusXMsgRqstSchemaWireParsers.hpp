...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusXMsgRqstSchemaWireParsers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusXMsgRqstSchemaWireParsers();
			...
			virtual ~CFBamCustMssCFGenBindHPlusXMsgRqstSchemaWireParsers();
