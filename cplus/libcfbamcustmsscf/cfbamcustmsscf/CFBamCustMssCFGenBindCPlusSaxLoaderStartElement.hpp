...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusSaxLoaderStartElement
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusSaxLoaderStartElement();
			...
			virtual ~CFBamCustMssCFGenBindCPlusSaxLoaderStartElement();
