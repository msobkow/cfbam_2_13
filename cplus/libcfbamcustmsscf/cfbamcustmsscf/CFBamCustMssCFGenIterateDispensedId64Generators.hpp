...
namespace cfbam {
	...
	class CFBamCustMssCFGenIterateDispensedId64Generators
	: public cfcore::MssCFGenIteratorObj
	{
		public:
			...
			CFBamCustMssCFGenIterateDispensedId64Generators();
			...
			virtual ~CFBamCustMssCFGenIterateDispensedId64Generators();
