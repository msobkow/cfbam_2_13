...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusMSSqlTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusMSSqlTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindHPlusMSSqlTableImplementation();
