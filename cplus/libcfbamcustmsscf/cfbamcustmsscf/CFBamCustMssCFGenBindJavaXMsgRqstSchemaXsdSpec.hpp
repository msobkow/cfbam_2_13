...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaXMsgRqstSchemaXsdSpec
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaXMsgRqstSchemaXsdSpec();
			...
			virtual ~CFBamCustMssCFGenBindJavaXMsgRqstSchemaXsdSpec();
