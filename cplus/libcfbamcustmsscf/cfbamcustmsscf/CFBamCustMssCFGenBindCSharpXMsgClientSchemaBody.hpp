...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpXMsgClientSchemaBody
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpXMsgClientSchemaBody();
			...
			virtual ~CFBamCustMssCFGenBindCSharpXMsgClientSchemaBody();
