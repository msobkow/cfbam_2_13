...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaMySqlTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaMySqlTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindJavaMySqlTableImplementation();
