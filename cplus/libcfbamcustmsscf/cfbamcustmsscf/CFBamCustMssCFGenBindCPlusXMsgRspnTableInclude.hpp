...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusXMsgRspnTableInclude
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusXMsgRspnTableInclude();
			...
			virtual ~CFBamCustMssCFGenBindCPlusXMsgRspnTableInclude();
