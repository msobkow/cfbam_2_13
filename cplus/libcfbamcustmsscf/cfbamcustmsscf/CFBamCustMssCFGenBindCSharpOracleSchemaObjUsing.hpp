...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpOracleSchemaObjUsing
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpOracleSchemaObjUsing();
			...
			virtual ~CFBamCustMssCFGenBindCSharpOracleSchemaObjUsing();
