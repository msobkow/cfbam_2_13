...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpDb2LUWSchemaObjMembers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpDb2LUWSchemaObjMembers();
			...
			virtual ~CFBamCustMssCFGenBindCSharpDb2LUWSchemaObjMembers();
