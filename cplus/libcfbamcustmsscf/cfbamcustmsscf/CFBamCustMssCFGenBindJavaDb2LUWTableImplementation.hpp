...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaDb2LUWTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaDb2LUWTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindJavaDb2LUWTableImplementation();
