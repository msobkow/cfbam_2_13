...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpXMsgRqstSchemaXsdElementList
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			static const std::string S_ICFBamSchemaDefObj;

			CFBamCustMssCFGenBindCSharpXMsgRqstSchemaXsdElementList();
			...
			virtual ~CFBamCustMssCFGenBindCSharpXMsgRqstSchemaXsdElementList();
