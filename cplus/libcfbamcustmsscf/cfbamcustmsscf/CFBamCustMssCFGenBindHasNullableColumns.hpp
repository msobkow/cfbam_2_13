...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHasNullableColumns
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			static const std::string S_ICFBamIndexObj;
			static const std::string S_Yes;
			static const std::string S_No;

			CFBamCustMssCFGenBindHasNullableColumns();
			...
			virtual ~CFBamCustMssCFGenBindHasNullableColumns();
