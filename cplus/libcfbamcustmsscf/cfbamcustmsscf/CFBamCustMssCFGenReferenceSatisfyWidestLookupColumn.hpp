...
namespace cfbam {
	...
	class CFBamCustMssCFGenReferenceSatisfyWidestLookupColumn
	: public cfcore::MssCFGenReferenceObj
	{
		public:
			...
			static const std::string S_ICFBamIndexColObj;

			CFBamCustMssCFGenReferenceSatisfyWidestLookupColumn();
			...
			virtual ~CFBamCustMssCFGenReferenceSatisfyWidestLookupColumn();
