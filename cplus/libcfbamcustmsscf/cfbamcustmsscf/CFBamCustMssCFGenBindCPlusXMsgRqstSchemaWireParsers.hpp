...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusXMsgRqstSchemaWireParsers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusXMsgRqstSchemaWireParsers();
			...
			virtual ~CFBamCustMssCFGenBindCPlusXMsgRqstSchemaWireParsers();
