...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpXMsgRspnSchemaUsing
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpXMsgRspnSchemaUsing();
			...
			virtual ~CFBamCustMssCFGenBindCSharpXMsgRspnSchemaUsing();
