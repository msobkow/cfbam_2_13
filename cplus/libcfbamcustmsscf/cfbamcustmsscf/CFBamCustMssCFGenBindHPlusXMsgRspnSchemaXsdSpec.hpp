...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusXMsgRspnSchemaXsdSpec
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusXMsgRspnSchemaXsdSpec();
			...
			virtual ~CFBamCustMssCFGenBindHPlusXMsgRspnSchemaXsdSpec();
