...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusXMsgRspnSchemaInclude
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusXMsgRspnSchemaInclude();
			...
			virtual ~CFBamCustMssCFGenBindHPlusXMsgRspnSchemaInclude();
