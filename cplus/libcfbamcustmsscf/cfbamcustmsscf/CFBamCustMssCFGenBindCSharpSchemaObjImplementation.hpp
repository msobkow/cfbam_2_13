...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpSchemaObjImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpSchemaObjImplementation();
			...
			virtual ~CFBamCustMssCFGenBindCSharpSchemaObjImplementation();
