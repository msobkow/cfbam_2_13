...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpSaxLoaderStartElement
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpSaxLoaderStartElement();
			...
			virtual ~CFBamCustMssCFGenBindCSharpSaxLoaderStartElement();
