...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpMySqlSchemaObjMembers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpMySqlSchemaObjMembers();
			...
			virtual ~CFBamCustMssCFGenBindCSharpMySqlSchemaObjMembers();
