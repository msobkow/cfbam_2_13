...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusPgSqlTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusPgSqlTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindHPlusPgSqlTableImplementation();
