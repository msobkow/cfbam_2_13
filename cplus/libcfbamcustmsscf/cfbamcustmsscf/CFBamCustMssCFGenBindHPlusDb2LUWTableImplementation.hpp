...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusDb2LUWTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusDb2LUWTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindHPlusDb2LUWTableImplementation();
