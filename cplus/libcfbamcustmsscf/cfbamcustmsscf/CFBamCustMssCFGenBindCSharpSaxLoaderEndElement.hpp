...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpSaxLoaderEndElement
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpSaxLoaderEndElement();
			...
			virtual ~CFBamCustMssCFGenBindCSharpSaxLoaderEndElement();
