...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusXMsgRqstSchemaInclude
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusXMsgRqstSchemaInclude();
			...
			virtual ~CFBamCustMssCFGenBindHPlusXMsgRqstSchemaInclude();
