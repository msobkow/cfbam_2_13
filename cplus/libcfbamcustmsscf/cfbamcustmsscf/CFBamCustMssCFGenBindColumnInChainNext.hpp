...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindColumnInChainNext
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			static const std::string S_GenContextGenDefScope;
			static const std::string S_ICFBamTableObj;
			static const std::string S_ICFBamValueObj;
			static const std::string S_Yes;
			static const std::string S_No;

			CFBamCustMssCFGenBindColumnInChainNext();
			...
			virtual ~CFBamCustMssCFGenBindColumnInChainNext();
