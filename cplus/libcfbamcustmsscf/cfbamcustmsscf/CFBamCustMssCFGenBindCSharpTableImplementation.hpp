...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindCSharpTableImplementation();
