...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpMSSqlSchemaObjUsing
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpMSSqlSchemaObjUsing();
			...
			virtual ~CFBamCustMssCFGenBindCSharpMSSqlSchemaObjUsing();
