...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaDb2LUWSchemaObjMembers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaDb2LUWSchemaObjMembers();
			...
			virtual ~CFBamCustMssCFGenBindJavaDb2LUWSchemaObjMembers();
