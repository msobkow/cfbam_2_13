...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpPgSqlSchemaObjUsing
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpPgSqlSchemaObjUsing();
			...
			virtual ~CFBamCustMssCFGenBindCSharpPgSqlSchemaObjUsing();
