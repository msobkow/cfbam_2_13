...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpXMsgRspnSchemaWireParsers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpXMsgRspnSchemaWireParsers();
			...
			virtual ~CFBamCustMssCFGenBindCSharpXMsgRspnSchemaWireParsers();
