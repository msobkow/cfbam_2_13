...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusOracleSchemaObjMembers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusOracleSchemaObjMembers();
			...
			virtual ~CFBamCustMssCFGenBindCPlusOracleSchemaObjMembers();
