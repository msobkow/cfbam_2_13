...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpPgSqlSchemaObjMembers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpPgSqlSchemaObjMembers();
			...
			virtual ~CFBamCustMssCFGenBindCSharpPgSqlSchemaObjMembers();
