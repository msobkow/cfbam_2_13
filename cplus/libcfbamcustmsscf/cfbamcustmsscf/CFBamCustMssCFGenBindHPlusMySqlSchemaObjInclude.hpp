...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusMySqlSchemaObjInclude
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusMySqlSchemaObjInclude();
			...
			virtual ~CFBamCustMssCFGenBindHPlusMySqlSchemaObjInclude();
