...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaEditObjImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaEditObjImplementation();
			...
			virtual ~CFBamCustMssCFGenBindJavaEditObjImplementation();
