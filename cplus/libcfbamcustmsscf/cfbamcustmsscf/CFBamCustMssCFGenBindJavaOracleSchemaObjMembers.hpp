...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaOracleSchemaObjMembers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaOracleSchemaObjMembers();
			...
			virtual ~CFBamCustMssCFGenBindJavaOracleSchemaObjMembers();
