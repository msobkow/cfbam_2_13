...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaTableObjImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaTableObjImplementation();
			...
			virtual ~CFBamCustMssCFGenBindJavaTableObjImplementation();
