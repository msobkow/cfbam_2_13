...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpXMsgClientTableBody
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpXMsgClientTableBody();
			...
			virtual ~CFBamCustMssCFGenBindCSharpXMsgClientTableBody();
