...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusDb2LUWTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusDb2LUWTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindCPlusDb2LUWTableImplementation();
