...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpMySqlSchemaObjUsing
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpMySqlSchemaObjUsing();
			...
			virtual ~CFBamCustMssCFGenBindCSharpMySqlSchemaObjUsing();
