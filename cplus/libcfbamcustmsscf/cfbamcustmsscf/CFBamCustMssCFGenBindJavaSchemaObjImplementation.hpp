...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaSchemaObjImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaSchemaObjImplementation();
			...
			virtual ~CFBamCustMssCFGenBindJavaSchemaObjImplementation();
