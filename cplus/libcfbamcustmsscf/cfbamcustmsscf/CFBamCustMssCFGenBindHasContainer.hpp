...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHasContainer
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			static const std::string S_CouldNotResolveTable;
			static const std::string S_Yes;
			static const std::string S_No;

			CFBamCustMssCFGenBindHasContainer();
			...
			virtual ~CFBamCustMssCFGenBindHasContainer();
