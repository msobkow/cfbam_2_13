...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaXMsgRspnSchemaXsdSpec
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaXMsgRspnSchemaXsdSpec();
			...
			virtual ~CFBamCustMssCFGenBindJavaXMsgRspnSchemaXsdSpec();
