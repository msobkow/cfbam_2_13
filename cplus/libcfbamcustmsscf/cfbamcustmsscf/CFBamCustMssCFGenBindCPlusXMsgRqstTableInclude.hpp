...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusXMsgRqstTableInclude
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusXMsgRqstTableInclude();
			...
			virtual ~CFBamCustMssCFGenBindCPlusXMsgRqstTableInclude();
