...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaOracleTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaOracleTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindJavaOracleTableImplementation();
