...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusXMsgRspnSchemaXsdElementList
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusXMsgRspnSchemaXsdElementList();
			...
			virtual ~CFBamCustMssCFGenBindCPlusXMsgRspnSchemaXsdElementList();
