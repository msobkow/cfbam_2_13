...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusSchemaObjImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusSchemaObjImplementation();
			...
			virtual ~CFBamCustMssCFGenBindCPlusSchemaObjImplementation();
