...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusDb2LUWSchemaObjMembers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusDb2LUWSchemaObjMembers();
			...
			virtual ~CFBamCustMssCFGenBindCPlusDb2LUWSchemaObjMembers();
