...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindProjectDescription
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			static const std::string S_GenContextGenDefGetProject;
			static const std::string S_ICFBamTableObj;

			CFBamCustMssCFGenBindProjectDescription();
			...
			virtual ~CFBamCustMssCFGenBindProjectDescription();
