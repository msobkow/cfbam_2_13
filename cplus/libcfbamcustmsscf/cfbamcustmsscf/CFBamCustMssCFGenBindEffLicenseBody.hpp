...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindEffLicenseBody
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			static const std::string S_ICFIntLicenseObj;

			CFBamCustMssCFGenBindEffLicenseBody();
			...
			virtual ~CFBamCustMssCFGenBindEffLicenseBody();
