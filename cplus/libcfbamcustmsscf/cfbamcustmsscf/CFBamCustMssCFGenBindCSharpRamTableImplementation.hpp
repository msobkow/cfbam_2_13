...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpRamTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpRamTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindCSharpRamTableImplementation();
