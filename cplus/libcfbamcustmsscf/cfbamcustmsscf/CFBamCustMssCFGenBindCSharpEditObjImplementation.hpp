...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpEditObjImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpEditObjImplementation();
			...
			virtual ~CFBamCustMssCFGenBindCSharpEditObjImplementation();
