...
namespace cfbam {
	...
	class CFBamCustMssCFGenIterateTableDeepSubClasses
	: public cfcore::MssCFGenIteratorObj
	{
		public:
			...
			CFBamCustMssCFGenIterateTableDeepSubClasses();
			...
			virtual ~CFBamCustMssCFGenIterateTableDeepSubClasses();

		protected:
			void walkSubClasses( std::vector<cflib::ICFLibAnyObj*>* list, cfbam::ICFBamTableObj* tableObj );
