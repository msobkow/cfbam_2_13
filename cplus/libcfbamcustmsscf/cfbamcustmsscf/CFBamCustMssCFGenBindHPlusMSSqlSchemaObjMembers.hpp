...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusMSSqlSchemaObjMembers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusMSSqlSchemaObjMembers();
			...
			virtual ~CFBamCustMssCFGenBindHPlusMSSqlSchemaObjMembers();
