...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaXMsgClientSchemaImport
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaXMsgClientSchemaImport();
			...
			virtual ~CFBamCustMssCFGenBindJavaXMsgClientSchemaImport();
