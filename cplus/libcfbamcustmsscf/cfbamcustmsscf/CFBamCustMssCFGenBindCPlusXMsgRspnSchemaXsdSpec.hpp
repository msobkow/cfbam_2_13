...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusXMsgRspnSchemaXsdSpec
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusXMsgRspnSchemaXsdSpec();
			...
			virtual ~CFBamCustMssCFGenBindCPlusXMsgRspnSchemaXsdSpec();
