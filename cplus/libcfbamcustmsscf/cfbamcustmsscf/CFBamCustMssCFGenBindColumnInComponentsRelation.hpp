...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindColumnInComponentsRelation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindColumnInComponentsRelation();
			...
			virtual ~CFBamCustMssCFGenBindColumnInComponentsRelation();
