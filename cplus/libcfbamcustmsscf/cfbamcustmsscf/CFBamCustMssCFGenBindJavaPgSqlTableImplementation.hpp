...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaPgSqlTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaPgSqlTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindJavaPgSqlTableImplementation();
