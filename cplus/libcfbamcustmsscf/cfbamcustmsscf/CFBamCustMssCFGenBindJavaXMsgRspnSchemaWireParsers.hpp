...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaXMsgRspnSchemaWireParsers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaXMsgRspnSchemaWireParsers();
			...
			virtual ~CFBamCustMssCFGenBindJavaXMsgRspnSchemaWireParsers();
