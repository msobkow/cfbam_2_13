...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindIsSelfReferencingRelation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindIsSelfReferencingRelation();
			...
			virtual ~CFBamCustMssCFGenBindIsSelfReferencingRelation();
