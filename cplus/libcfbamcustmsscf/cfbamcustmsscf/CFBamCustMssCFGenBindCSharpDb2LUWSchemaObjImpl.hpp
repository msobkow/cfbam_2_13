...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpDb2LUWSchemaObjImpl
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpDb2LUWSchemaObjImpl();
			...
			virtual ~CFBamCustMssCFGenBindCSharpDb2LUWSchemaObjImpl();
