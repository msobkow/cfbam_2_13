...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaSaxLoaderStartElement
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaSaxLoaderStartElement();
			...
			virtual ~CFBamCustMssCFGenBindJavaSaxLoaderStartElement();
