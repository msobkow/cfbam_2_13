...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusPgSqlSchemaObjInclude
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusPgSqlSchemaObjInclude();
			...
			virtual ~CFBamCustMssCFGenBindCPlusPgSqlSchemaObjInclude();
