...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusXMsgRqstSchemaXsdElementList
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusXMsgRqstSchemaXsdElementList();
			...
			virtual ~CFBamCustMssCFGenBindHPlusXMsgRqstSchemaXsdElementList();
