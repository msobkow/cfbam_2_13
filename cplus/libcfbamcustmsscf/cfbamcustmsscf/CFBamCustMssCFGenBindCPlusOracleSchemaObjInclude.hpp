...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusOracleSchemaObjInclude
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusOracleSchemaObjInclude();
			...
			virtual ~CFBamCustMssCFGenBindCPlusOracleSchemaObjInclude();
