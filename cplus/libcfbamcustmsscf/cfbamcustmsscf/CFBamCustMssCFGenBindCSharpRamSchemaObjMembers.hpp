...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpRamSchemaObjMembers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpRamSchemaObjMembers();
			...
			virtual ~CFBamCustMssCFGenBindCSharpRamSchemaObjMembers();
