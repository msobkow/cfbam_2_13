...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusDb2LUWSchemaObjMembers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusDb2LUWSchemaObjMembers();
			...
			virtual ~CFBamCustMssCFGenBindHPlusDb2LUWSchemaObjMembers();
