...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusMySqlSchemaObjMembers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusMySqlSchemaObjMembers();
			...
			virtual ~CFBamCustMssCFGenBindHPlusMySqlSchemaObjMembers();
