...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusOracleTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusOracleTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindCPlusOracleTableImplementation();
