...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusXMsgRqstSchemaXsdSpec
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusXMsgRqstSchemaXsdSpec();
			...
			virtual ~CFBamCustMssCFGenBindHPlusXMsgRqstSchemaXsdSpec();
