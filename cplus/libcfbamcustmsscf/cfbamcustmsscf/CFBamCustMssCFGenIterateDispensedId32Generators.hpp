...
namespace cfbam {
	...
	class CFBamCustMssCFGenIterateDispensedId32Generators
	: public cfcore::MssCFGenIteratorObj
	{
		public:
			...
			CFBamCustMssCFGenIterateDispensedId32Generators();
			...
			virtual ~CFBamCustMssCFGenIterateDispensedId32Generators();
