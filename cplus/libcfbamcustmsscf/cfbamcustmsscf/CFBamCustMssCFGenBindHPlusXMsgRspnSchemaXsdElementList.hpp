...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusXMsgRspnSchemaXsdElementList
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusXMsgRspnSchemaXsdElementList();
			...
			virtual ~CFBamCustMssCFGenBindHPlusXMsgRspnSchemaXsdElementList();
