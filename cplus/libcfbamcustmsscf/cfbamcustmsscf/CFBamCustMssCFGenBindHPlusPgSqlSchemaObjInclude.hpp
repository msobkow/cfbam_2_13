...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusPgSqlSchemaObjInclude
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusPgSqlSchemaObjInclude();
			...
			virtual ~CFBamCustMssCFGenBindHPlusPgSqlSchemaObjInclude();
