...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusDb2LUWSchemaObjInclude
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusDb2LUWSchemaObjInclude();
			...
			virtual ~CFBamCustMssCFGenBindCPlusDb2LUWSchemaObjInclude();
