...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusXMsgRspnSchemaWireParsers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusXMsgRspnSchemaWireParsers();
			...
			virtual ~CFBamCustMssCFGenBindHPlusXMsgRspnSchemaWireParsers();
