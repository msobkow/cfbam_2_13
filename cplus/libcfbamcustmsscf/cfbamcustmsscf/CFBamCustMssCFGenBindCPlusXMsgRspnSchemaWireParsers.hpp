...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusXMsgRspnSchemaWireParsers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusXMsgRspnSchemaWireParsers();
			...
			virtual ~CFBamCustMssCFGenBindCPlusXMsgRspnSchemaWireParsers();
