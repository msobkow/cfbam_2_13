...
namespace cfbam {
	...
	class CFBamCustMssCFGenReferenceInheritedLookupIndex
	: public cfcore::MssCFGenReferenceObj
	{
		public:
			...
			CFBamCustMssCFGenReferenceInheritedLookupIndex();
			...
			virtual ~CFBamCustMssCFGenReferenceInheritedLookupIndex();
