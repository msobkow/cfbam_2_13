...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusPgSqlSchemaObjMembers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusPgSqlSchemaObjMembers();
			...
			virtual ~CFBamCustMssCFGenBindHPlusPgSqlSchemaObjMembers();
