...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpOracleSchemaObjImpl
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpOracleSchemaObjImpl();
			...
			virtual ~CFBamCustMssCFGenBindCSharpOracleSchemaObjImpl();
