...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaDb2LUWSchemaObjImport
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaDb2LUWSchemaObjImport();
			...
			virtual ~CFBamCustMssCFGenBindJavaDb2LUWSchemaObjImport();
