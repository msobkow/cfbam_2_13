...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusEditObjImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusEditObjImplementation();
			...
			virtual ~CFBamCustMssCFGenBindCPlusEditObjImplementation();
