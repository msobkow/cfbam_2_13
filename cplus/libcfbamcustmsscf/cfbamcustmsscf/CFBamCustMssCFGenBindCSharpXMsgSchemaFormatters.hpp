...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpXMsgSchemaFormatters
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpXMsgSchemaFormatters();
			...
			virtual ~CFBamCustMssCFGenBindCSharpXMsgSchemaFormatters();
