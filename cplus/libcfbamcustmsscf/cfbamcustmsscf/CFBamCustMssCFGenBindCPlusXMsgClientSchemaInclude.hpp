...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusXMsgClientSchemaInclude
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusXMsgClientSchemaInclude();
			...
			virtual ~CFBamCustMssCFGenBindCPlusXMsgClientSchemaInclude();
