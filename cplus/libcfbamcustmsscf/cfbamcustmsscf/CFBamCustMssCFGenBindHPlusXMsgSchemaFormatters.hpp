...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusXMsgSchemaFormatters
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusXMsgSchemaFormatters();
			...
			virtual ~CFBamCustMssCFGenBindHPlusXMsgSchemaFormatters();
