...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusMySqlTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusMySqlTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindCPlusMySqlTableImplementation();
