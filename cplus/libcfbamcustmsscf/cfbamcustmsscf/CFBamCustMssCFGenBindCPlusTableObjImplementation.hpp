...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusTableObjImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusTableObjImplementation();
			...
			virtual ~CFBamCustMssCFGenBindCPlusTableObjImplementation();
