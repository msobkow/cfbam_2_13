...
namespace cfbam {
	...
	class CFBamCustMssCFGenIterateDispensedId16Generators
	: public cfcore::MssCFGenIteratorObj
	{
		public:
			...
			CFBamCustMssCFGenIterateDispensedId16Generators();
			...
			virtual ~CFBamCustMssCFGenIterateDispensedId16Generators();
