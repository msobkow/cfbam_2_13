...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusOracleSchemaObjMembers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusOracleSchemaObjMembers();
			...
			virtual ~CFBamCustMssCFGenBindHPlusOracleSchemaObjMembers();
