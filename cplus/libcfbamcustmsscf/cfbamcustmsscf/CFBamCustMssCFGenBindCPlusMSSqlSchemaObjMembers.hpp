...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusMSSqlSchemaObjMembers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusMSSqlSchemaObjMembers();
			...
			virtual ~CFBamCustMssCFGenBindCPlusMSSqlSchemaObjMembers();
