...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaXMsgRqstSchemaWireParsers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaXMsgRqstSchemaWireParsers();
			...
			virtual ~CFBamCustMssCFGenBindJavaXMsgRqstSchemaWireParsers();
