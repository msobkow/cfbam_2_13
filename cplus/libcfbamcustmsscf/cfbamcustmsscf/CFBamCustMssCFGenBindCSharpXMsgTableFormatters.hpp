...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpXMsgTableFormatters
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpXMsgTableFormatters();
			...
			virtual ~CFBamCustMssCFGenBindCSharpXMsgTableFormatters();
