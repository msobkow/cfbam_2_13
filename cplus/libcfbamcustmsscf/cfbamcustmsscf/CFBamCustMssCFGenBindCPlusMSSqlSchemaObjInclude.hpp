...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusMSSqlSchemaObjInclude
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusMSSqlSchemaObjInclude();
			...
			virtual ~CFBamCustMssCFGenBindCPlusMSSqlSchemaObjInclude();
