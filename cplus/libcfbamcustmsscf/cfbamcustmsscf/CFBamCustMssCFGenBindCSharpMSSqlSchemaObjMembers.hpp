...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpMSSqlSchemaObjMembers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpMSSqlSchemaObjMembers();
			...
			virtual ~CFBamCustMssCFGenBindCSharpMSSqlSchemaObjMembers();
