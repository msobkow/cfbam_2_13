...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusSchemaObjImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusSchemaObjImplementation();
			...
			virtual ~CFBamCustMssCFGenBindHPlusSchemaObjImplementation();
