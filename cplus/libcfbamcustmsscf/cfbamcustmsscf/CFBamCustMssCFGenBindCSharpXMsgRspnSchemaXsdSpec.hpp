...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpXMsgRspnSchemaXsdSpec
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpXMsgRspnSchemaXsdSpec();
			...
			virtual ~CFBamCustMssCFGenBindCSharpXMsgRspnSchemaXsdSpec();
