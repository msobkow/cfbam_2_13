...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaMSSqlTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaMSSqlTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindJavaMSSqlTableImplementation();
