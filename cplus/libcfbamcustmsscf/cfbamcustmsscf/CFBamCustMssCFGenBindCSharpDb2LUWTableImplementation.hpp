...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpDb2LUWTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpDb2LUWTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindCSharpDb2LUWTableImplementation();
