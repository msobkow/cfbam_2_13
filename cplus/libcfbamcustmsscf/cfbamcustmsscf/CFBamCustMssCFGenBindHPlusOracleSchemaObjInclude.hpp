...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusOracleSchemaObjInclude
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusOracleSchemaObjInclude();
			...
			virtual ~CFBamCustMssCFGenBindHPlusOracleSchemaObjInclude();
