...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusXMsgClientSchemaBody
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusXMsgClientSchemaBody();
			...
			virtual ~CFBamCustMssCFGenBindHPlusXMsgClientSchemaBody();
