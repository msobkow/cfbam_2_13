...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusOracleTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusOracleTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindHPlusOracleTableImplementation();
