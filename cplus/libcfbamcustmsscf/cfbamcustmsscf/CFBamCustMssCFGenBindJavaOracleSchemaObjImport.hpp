...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaOracleSchemaObjImport
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaOracleSchemaObjImport();
			...
			virtual ~CFBamCustMssCFGenBindJavaOracleSchemaObjImport();
