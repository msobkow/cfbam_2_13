...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusPgSqlTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusPgSqlTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindCPlusPgSqlTableImplementation();
