...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusMySqlTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusMySqlTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindHPlusMySqlTableImplementation();
