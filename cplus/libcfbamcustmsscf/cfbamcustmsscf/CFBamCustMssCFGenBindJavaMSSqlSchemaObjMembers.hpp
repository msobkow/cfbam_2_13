...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaMSSqlSchemaObjMembers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaMSSqlSchemaObjMembers();
			...
			virtual ~CFBamCustMssCFGenBindJavaMSSqlSchemaObjMembers();
