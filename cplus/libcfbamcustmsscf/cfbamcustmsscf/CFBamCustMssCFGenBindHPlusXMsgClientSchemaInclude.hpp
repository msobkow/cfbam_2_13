...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusXMsgClientSchemaInclude
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusXMsgClientSchemaInclude();
			...
			virtual ~CFBamCustMssCFGenBindHPlusXMsgClientSchemaInclude();
