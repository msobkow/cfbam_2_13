...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusXMsgClientTableInclude
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusXMsgClientTableInclude();
			...
			virtual ~CFBamCustMssCFGenBindHPlusXMsgClientTableInclude();
