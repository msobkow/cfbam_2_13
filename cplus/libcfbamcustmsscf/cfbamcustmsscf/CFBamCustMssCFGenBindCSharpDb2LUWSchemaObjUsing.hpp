...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpDb2LUWSchemaObjUsing
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpDb2LUWSchemaObjUsing();
			...
			virtual ~CFBamCustMssCFGenBindCSharpDb2LUWSchemaObjUsing();
