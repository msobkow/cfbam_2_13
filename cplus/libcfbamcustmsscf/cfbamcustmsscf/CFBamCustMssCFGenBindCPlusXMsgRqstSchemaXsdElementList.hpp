...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusXMsgRqstSchemaXsdElementList
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusXMsgRqstSchemaXsdElementList();
			...
			virtual ~CFBamCustMssCFGenBindCPlusXMsgRqstSchemaXsdElementList();
