...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusXMsgClientSchemaBody
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusXMsgClientSchemaBody();
			...
			virtual ~CFBamCustMssCFGenBindCPlusXMsgClientSchemaBody();
