...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaMySqlSchemaObjMembers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaMySqlSchemaObjMembers();
			...
			virtual ~CFBamCustMssCFGenBindJavaMySqlSchemaObjMembers();
