...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusRamTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusRamTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindHPlusRamTableImplementation();
