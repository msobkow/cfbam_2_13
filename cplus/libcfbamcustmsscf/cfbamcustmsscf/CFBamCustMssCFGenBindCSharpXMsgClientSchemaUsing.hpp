...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpXMsgClientSchemaUsing
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpXMsgClientSchemaUsing();
			...
			virtual ~CFBamCustMssCFGenBindCSharpXMsgClientSchemaUsing();
