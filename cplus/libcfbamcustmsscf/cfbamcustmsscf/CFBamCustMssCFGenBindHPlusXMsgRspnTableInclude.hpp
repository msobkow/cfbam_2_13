...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusXMsgRspnTableInclude
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusXMsgRspnTableInclude();
			...
			virtual ~CFBamCustMssCFGenBindHPlusXMsgRspnTableInclude();
