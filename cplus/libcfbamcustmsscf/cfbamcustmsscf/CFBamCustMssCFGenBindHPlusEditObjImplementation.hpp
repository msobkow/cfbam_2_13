...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusEditObjImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusEditObjImplementation();
			...
			virtual ~CFBamCustMssCFGenBindHPlusEditObjImplementation();
