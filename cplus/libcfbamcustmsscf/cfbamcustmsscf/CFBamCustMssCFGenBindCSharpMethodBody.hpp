...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpMethodBody
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			static const std::string S_ICFBamServerMethodObj;

			CFBamCustMssCFGenBindCSharpMethodBody();
			...
			virtual ~CFBamCustMssCFGenBindCSharpMethodBody();
