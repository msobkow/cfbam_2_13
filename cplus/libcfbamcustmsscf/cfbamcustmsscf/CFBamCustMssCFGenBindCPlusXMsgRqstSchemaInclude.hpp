...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusXMsgRqstSchemaInclude
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusXMsgRqstSchemaInclude();
			...
			virtual ~CFBamCustMssCFGenBindCPlusXMsgRqstSchemaInclude();
