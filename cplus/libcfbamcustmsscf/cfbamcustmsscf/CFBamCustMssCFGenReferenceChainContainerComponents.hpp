...
namespace cfbam {
	...
	class CFBamCustMssCFGenReferenceChainContainerComponents
	: public cfcore::MssCFGenReferenceObj
	{
		public:
			...
			static const std::string S_GenDefChain;
			static const std::string S_ContainerComponentsRelation;

			CFBamCustMssCFGenReferenceChainContainerComponents();
			...
			virtual ~CFBamCustMssCFGenReferenceChainContainerComponents();
