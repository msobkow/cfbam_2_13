...
namespace cfbam {
	...
	class CFBamCustMssCFGenReferenceClearSubDep
	: public cfcore::MssCFGenReferenceObj
	{
		public:
			...
			static const std::string S_ClearDepObjs;

			CFBamCustMssCFGenReferenceClearSubDep();
			...
			virtual ~CFBamCustMssCFGenReferenceClearSubDep();
