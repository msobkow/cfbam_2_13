...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusDb2LUWSchemaObjInclude
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusDb2LUWSchemaObjInclude();
			...
			virtual ~CFBamCustMssCFGenBindHPlusDb2LUWSchemaObjInclude();
