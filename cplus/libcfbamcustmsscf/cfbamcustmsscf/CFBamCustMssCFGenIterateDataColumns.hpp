...
namespace cfbam {
	...
	class CFBamCustMssCFGenIterateDataColumns
	: public cfcore::MssCFGenIteratorObj
	{
		public:
			...
			static const std::string S_GenContextGenDefPrimaryIndex;

			CFBamCustMssCFGenIterateDataColumns();
			...
			virtual ~CFBamCustMssCFGenIterateDataColumns();
