...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusXMsgClientTableInclude
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusXMsgClientTableInclude();
			...
			virtual ~CFBamCustMssCFGenBindCPlusXMsgClientTableInclude();
