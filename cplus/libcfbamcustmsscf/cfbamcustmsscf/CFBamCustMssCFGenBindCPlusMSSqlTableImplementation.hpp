...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusMSSqlTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusMSSqlTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindCPlusMSSqlTableImplementation();
