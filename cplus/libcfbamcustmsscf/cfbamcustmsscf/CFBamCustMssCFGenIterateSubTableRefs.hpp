...
namespace cfbam {
	...
	class CFBamCustMssCFGenIterateSubTableRefs
	: public cfcore::MssCFGenIteratorObj
	{
		public:
			...
			static const std::string S_SchemaRefObjReferencedSchemaObj;

			CFBamCustMssCFGenIterateSubTableRefs();
			...
			virtual ~CFBamCustMssCFGenIterateSubTableRefs();
