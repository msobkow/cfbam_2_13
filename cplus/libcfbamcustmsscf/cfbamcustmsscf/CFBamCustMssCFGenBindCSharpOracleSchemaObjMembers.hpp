...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpOracleSchemaObjMembers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpOracleSchemaObjMembers();
			...
			virtual ~CFBamCustMssCFGenBindCSharpOracleSchemaObjMembers();
