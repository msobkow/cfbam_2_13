...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpXMsgRqstSchemaUsing
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpXMsgRqstSchemaUsing();
			...
			virtual ~CFBamCustMssCFGenBindCSharpXMsgRqstSchemaUsing();
