...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusTableObjImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusTableObjImplementation();
			...
			virtual ~CFBamCustMssCFGenBindHPlusTableObjImplementation();
