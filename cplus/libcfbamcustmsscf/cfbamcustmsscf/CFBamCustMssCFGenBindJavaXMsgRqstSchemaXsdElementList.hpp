...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaXMsgRqstSchemaXsdElementList
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaXMsgRqstSchemaXsdElementList();
			...
			virtual ~CFBamCustMssCFGenBindJavaXMsgRqstSchemaXsdElementList();
