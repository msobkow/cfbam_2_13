...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpXMsgRqstSchemaWireParsers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpXMsgRqstSchemaWireParsers();
			...
			virtual ~CFBamCustMssCFGenBindCSharpXMsgRqstSchemaWireParsers();
