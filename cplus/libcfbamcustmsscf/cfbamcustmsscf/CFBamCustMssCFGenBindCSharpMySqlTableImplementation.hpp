...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpMySqlTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpMySqlTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindCSharpMySqlTableImplementation();
