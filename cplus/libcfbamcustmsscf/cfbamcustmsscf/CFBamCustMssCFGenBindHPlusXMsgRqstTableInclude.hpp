...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusXMsgRqstTableInclude
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusXMsgRqstTableInclude();
			...
			virtual ~CFBamCustMssCFGenBindHPlusXMsgRqstTableInclude();
