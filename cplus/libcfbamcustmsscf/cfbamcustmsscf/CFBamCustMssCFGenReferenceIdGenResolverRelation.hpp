...
namespace cfbam {
	...
	class CFBamCustMssCFGenReferenceIdGenResolverRelation
	: public cfcore::MssCFGenReferenceObj
	{
		public:
			...
			static const std::string S_ICFBamTableColObj;

			CFBamCustMssCFGenReferenceIdGenResolverRelation();
			...
			virtual ~CFBamCustMssCFGenReferenceIdGenResolverRelation();
