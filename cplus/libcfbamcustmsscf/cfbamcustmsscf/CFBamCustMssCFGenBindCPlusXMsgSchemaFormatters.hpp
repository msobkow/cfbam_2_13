...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusXMsgSchemaFormatters
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusXMsgSchemaFormatters();
			...
			virtual ~CFBamCustMssCFGenBindCPlusXMsgSchemaFormatters();
