...
namespace cfbam {
	...
	class CFBamCustMssCFGenReferenceDelSubDep
	: public cfcore::MssCFGenReferenceObj
	{
		public:
			...
			static const std::string S_DelDepObjs;

			CFBamCustMssCFGenReferenceDelSubDep();
			...
			virtual ~CFBamCustMssCFGenReferenceDelSubDep();
