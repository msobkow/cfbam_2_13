...
namespace cfbam {
	...
	class CFBamCustMssCFGenReferenceManufacturingSchema
	: public cfcore::MssCFGenReferenceObj
	{
		public:
			static const std::string CLASS_NAME;
			static const std::string S_GenContext;
			static const std::string S_GenContextManufacturingSchema;

			CFBamCustMssCFGenReferenceManufacturingSchema();
			...
			virtual ~CFBamCustMssCFGenReferenceManufacturingSchema();
