...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusXMsgRspnSchemaInclude
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusXMsgRspnSchemaInclude();
			...
			virtual ~CFBamCustMssCFGenBindCPlusXMsgRspnSchemaInclude();
