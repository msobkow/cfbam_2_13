...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusXMsgRqstSchemaXsdSpec
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusXMsgRqstSchemaXsdSpec();
			...
			virtual ~CFBamCustMssCFGenBindCPlusXMsgRqstSchemaXsdSpec();
