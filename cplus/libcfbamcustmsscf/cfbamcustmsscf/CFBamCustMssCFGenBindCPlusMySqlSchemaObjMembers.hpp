...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusMySqlSchemaObjMembers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusMySqlSchemaObjMembers();
			...
			virtual ~CFBamCustMssCFGenBindCPlusMySqlSchemaObjMembers();
