...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusRamTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusRamTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindCPlusRamTableImplementation();
