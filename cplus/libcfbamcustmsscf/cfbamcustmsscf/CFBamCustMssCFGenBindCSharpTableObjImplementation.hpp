...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpTableObjImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpTableObjImplementation();
			...
			virtual ~CFBamCustMssCFGenBindCSharpTableObjImplementation();
