...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpXMsgClientTableUsing
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpXMsgClientTableUsing();
			...
			virtual ~CFBamCustMssCFGenBindCSharpXMsgClientTableUsing();
