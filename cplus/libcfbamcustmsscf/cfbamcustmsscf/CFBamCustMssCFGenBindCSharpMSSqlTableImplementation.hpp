...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpMSSqlTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpMSSqlTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindCSharpMSSqlTableImplementation();
