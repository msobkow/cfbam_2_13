...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpXMsgRqstSchemaXsdSpec
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpXMsgRqstSchemaXsdSpec();
			...
			virtual ~CFBamCustMssCFGenBindCSharpXMsgRqstSchemaXsdSpec();
