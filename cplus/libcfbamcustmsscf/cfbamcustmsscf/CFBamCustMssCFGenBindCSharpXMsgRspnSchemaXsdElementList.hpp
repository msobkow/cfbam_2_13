...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpXMsgRspnSchemaXsdElementList
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpXMsgRspnSchemaXsdElementList();
			...
			virtual ~CFBamCustMssCFGenBindCSharpXMsgRspnSchemaXsdElementList();
