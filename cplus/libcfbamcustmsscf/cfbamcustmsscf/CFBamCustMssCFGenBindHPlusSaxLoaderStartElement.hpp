...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusSaxLoaderStartElement
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusSaxLoaderStartElement();
			...
			virtual ~CFBamCustMssCFGenBindHPlusSaxLoaderStartElement();
