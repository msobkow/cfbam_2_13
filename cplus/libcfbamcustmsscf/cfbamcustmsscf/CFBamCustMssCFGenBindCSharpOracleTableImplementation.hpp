...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpOracleTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpOracleTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindCSharpOracleTableImplementation();
