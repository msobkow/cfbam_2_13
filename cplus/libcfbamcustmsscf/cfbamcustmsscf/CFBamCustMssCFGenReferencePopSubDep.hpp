...
namespace cfbam {
	...
	class CFBamCustMssCFGenReferencePopSubDep
	: public cfcore::MssCFGenReferenceObj
	{
		public:
			...
			static const std::string S_PopDepObjs;

			CFBamCustMssCFGenReferencePopSubDep();
			...
			virtual ~CFBamCustMssCFGenReferencePopSubDep();
