...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaPgSqlSchemaObjMembers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaPgSqlSchemaObjMembers();
			...
			virtual ~CFBamCustMssCFGenBindJavaPgSqlSchemaObjMembers();
