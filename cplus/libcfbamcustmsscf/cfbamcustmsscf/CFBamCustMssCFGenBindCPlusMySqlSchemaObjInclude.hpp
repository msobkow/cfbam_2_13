...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusMySqlSchemaObjInclude
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusMySqlSchemaObjInclude();
			...
			virtual ~CFBamCustMssCFGenBindCPlusMySqlSchemaObjInclude();
