...
namespace cfbam {
	...
	class CFBamCustMssCFGenReferenceScope
	: public cfcore::MssCFGenReferenceObj
	{
		public:
			...
			static const std::string S_GenContextGenDefObjScope;

			CFBamCustMssCFGenReferenceScope();
			...
			virtual ~CFBamCustMssCFGenReferenceScope();
