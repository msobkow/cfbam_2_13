...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaXMsgRspnSchemaXsdElementList
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaXMsgRspnSchemaXsdElementList();
			...
			virtual ~CFBamCustMssCFGenBindJavaXMsgRspnSchemaXsdElementList();
