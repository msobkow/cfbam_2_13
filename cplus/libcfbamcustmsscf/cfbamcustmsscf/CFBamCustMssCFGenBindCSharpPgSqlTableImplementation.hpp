...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCSharpPgSqlTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCSharpPgSqlTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindCSharpPgSqlTableImplementation();
