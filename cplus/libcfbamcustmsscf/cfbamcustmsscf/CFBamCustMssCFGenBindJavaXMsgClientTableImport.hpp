...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaXMsgClientTableImport
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaXMsgClientTableImport();
			...
			virtual ~CFBamCustMssCFGenBindJavaXMsgClientTableImport();
