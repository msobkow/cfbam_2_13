...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindHPlusMSSqlSchemaObjInclude
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindHPlusMSSqlSchemaObjInclude();
			...
			virtual ~CFBamCustMssCFGenBindHPlusMSSqlSchemaObjInclude();
