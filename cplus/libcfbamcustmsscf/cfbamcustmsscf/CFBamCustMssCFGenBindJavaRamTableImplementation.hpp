...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindJavaRamTableImplementation
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindJavaRamTableImplementation();
			...
			virtual ~CFBamCustMssCFGenBindJavaRamTableImplementation();
