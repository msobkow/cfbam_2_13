...
namespace cfbam {
	...
	class CFBamCustMssCFGenBindCPlusPgSqlSchemaObjMembers
	: public cfcore::MssCFGenBindObj
	{
		public:
			...
			CFBamCustMssCFGenBindCPlusPgSqlSchemaObjMembers();
			...
			virtual ~CFBamCustMssCFGenBindCPlusPgSqlSchemaObjMembers();
