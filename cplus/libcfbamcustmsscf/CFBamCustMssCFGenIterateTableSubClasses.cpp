...
namespace cfbam {
	...
	const std::string CFBamCustMssCFGenIterateTableSubClasses::CLASS_NAME( "CFBamCustMssCFGenIterateTableSubClasses" );
	const std::string CFBamCustMssCFGenIterateTableSubClasses::S_GenContext( "genContext" );
	const std::string CFBamCustMssCFGenIterateTableSubClasses::S_GenContextGenDef( "genContext.GenDef" );
	const std::string CFBamCustMssCFGenIterateTableSubClasses::S_ICFBamTableObj( "ICFBamTableObj" );

	CFBamCustMssCFGenIterateTableSubClasses::CFBamCustMssCFGenIterateTableSubClasses()
	...
	std::vector<cflib::ICFLibAnyObj*>* CFBamCustMssCFGenIterateTableSubClasses::enumerateDetails( cfcore::MssCFGenContext* genContext ) {
