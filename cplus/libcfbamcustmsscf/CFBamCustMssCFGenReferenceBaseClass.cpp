...
namespace cfbam {
	...
	const std::string CFBamCustMssCFGenReferenceBaseClass::CLASS_NAME( "CFBamCustMssCFGenReferenceBaseClass" );
	const std::string CFBamCustMssCFGenReferenceBaseClass::S_GenContext( "genContext" );
	const std::string CFBamCustMssCFGenReferenceBaseClass::S_GenContextGenDef( "genContext.GenDef" );
	const std::string CFBamCustMssCFGenReferenceBaseClass::S_ICFBamTableObj( "ICFBamTableObj" );

	CFBamCustMssCFGenReferenceBaseClass::CFBamCustMssCFGenReferenceBaseClass()
	...
	cflib::ICFLibAnyObj* CFBamCustMssCFGenReferenceBaseClass::dereference( cfcore::MssCFGenContext* genContext ) {
		...
		for( cfbam::ICFBamRelationObj* superClassRelation = cfbam::CFBamCustMssCFTableObj::getSuperClassRelation( curTable );
