...
namespace cfbam {
	...
	const std::string CFBamCustMssCFGenBindColumnInChainNext::CLASS_NAME( "CFBamMssCFBindColumnInChainNext" );
	const std::string CFBamCustMssCFGenBindColumnInChainNext::S_GenContext( "genContext" );
	const std::string CFBamCustMssCFGenBindColumnInChainNext::S_GenContextGenDef( "genContext.GenDef" );
	const std::string CFBamCustMssCFGenBindColumnInChainNext::S_GenContextGenDefScope( "genContext.GenDef.Scope" );
	const std::string CFBamCustMssCFGenBindColumnInChainNext::S_ICFBamTableObj( "ICFBamTableObj" );
	const std::string CFBamCustMssCFGenBindColumnInChainNext::S_ICFBamValueObj( "ICFBamValueObj" );
	const std::string CFBamCustMssCFGenBindColumnInChainNext::S_Yes( "yes" );
	const std::string CFBamCustMssCFGenBindColumnInChainNext::S_No( "no" );

	CFBamCustMssCFGenBindColumnInChainNext::CFBamCustMssCFGenBindColumnInChainNext()
	...
	std::string CFBamCustMssCFGenBindColumnInChainNext::expandBody( cfcore::MssCFGenContext* genContext ) {
		...
		if( chain != NULL ) {
			cfbam::ICFBamRelationObj* prevRelation = chain->getRequiredLookupNextRel();
