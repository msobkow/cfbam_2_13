...
namespace cfbam {
	...
	const std::string CFBamCustMssCFGenIterateOnlyOwnerRelations::CLASS_NAME( "CFBamCustMssCFGenIterateOnlyOwnerRelations" );
	const std::string CFBamCustMssCFGenIterateOnlyOwnerRelations::S_GenContext( "genContext" );
	const std::string CFBamCustMssCFGenIterateOnlyOwnerRelations::S_GenContextGenDef( "genContext.GenDef" );
	const std::string CFBamCustMssCFGenIterateOnlyOwnerRelations::S_ICFBamTableObj( "ICFBamTableObj" );

	CFBamCustMssCFGenIterateOnlyOwnerRelations::CFBamCustMssCFGenIterateOnlyOwnerRelations()
	...
	std::vector<cflib::ICFLibAnyObj*>* CFBamCustMssCFGenIterateOnlyOwnerRelations::enumerateDetails( cfcore::MssCFGenContext* genContext ) {
		...
		std::vector<cfbam::ICFBamRelationObj*> ownerRelations = cfbam::CFBamCustMssCFTableObj::getOnlyOwnerRelations( tableObj );
