...
namespace cfbam {
	...
	const std::string CFBamCustMssCFGenIterateId64Generators::CLASS_NAME( "CFBamCustMssCFGenIterateId64Generators" );
	const std::string CFBamCustMssCFGenIterateId64Generators::S_GenContext( "genContext" );
	const std::string CFBamCustMssCFGenIterateId64Generators::S_GenContextGenDef( "genContext.GenDef" );
	const std::string CFBamCustMssCFGenIterateId64Generators::S_ICFBamSchemaDefObj( "ICFBamSchemaDefObj" );

	CFBamCustMssCFGenIterateId64Generators::CFBamCustMssCFGenIterateId64Generators()
	...
	std::vector<cflib::ICFLibAnyObj*>* CFBamCustMssCFGenIterateId64Generators::enumerateDetails( cfcore::MssCFGenContext* genContext ) {
		...
		for( auto iterSchemaTypes = schemaTypes.begin(); iterSchemaTypes != schemaTypes.end(); iterSchemaTypes ++ ) {
			...
			if( valueObj->implementsClassCode( cfbam::CFBamId64GenBuff::CLASS_CODE ) ) {
				genObj = dynamic_cast<cfbam::ICFBamId64GenObj*>( valueObj );
