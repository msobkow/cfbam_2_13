...
namespace cfbam {
	...
	const std::string CFBamCustMssCFGenReferencePrimaryKeyIndex::CLASS_NAME( "CFBamCustMssCFGenReferencePrimaryKeyIndex" );
	const std::string CFBamCustMssCFGenReferencePrimaryKeyIndex::S_GenContext( "genContext" );
	const std::string CFBamCustMssCFGenReferencePrimaryKeyIndex::S_GenContextGenDef( "genContext.GenDef" );
	const std::string CFBamCustMssCFGenReferencePrimaryKeyIndex::S_ICFBamTableObj( "ICFBamTableObj" );

	CFBamCustMssCFGenReferencePrimaryKeyIndex::CFBamCustMssCFGenReferencePrimaryKeyIndex()
	...
	cflib::ICFLibAnyObj* CFBamCustMssCFGenReferencePrimaryKeyIndex::dereference( cfcore::MssCFGenContext* genContext ) {
