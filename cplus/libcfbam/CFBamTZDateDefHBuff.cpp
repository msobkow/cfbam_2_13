// Description: C++18 implementation of a TZDateDef history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTZDateDefHBuff::CLASS_NAME( "CFBamTZDateDefHBuff" );
	CFBamTZDateDefHBuff::CFBamTZDateDefHBuff()
	: cfbam::CFBamAtomHBuff() {
		optionalDummy = NULL;
	}

	CFBamTZDateDefHBuff::CFBamTZDateDefHBuff( const CFBamTZDateDefHBuff& src )
	: cfbam::CFBamAtomHBuff() {
		optionalDummy = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamTZDateDefHBuff::clone() {
		CFBamTZDateDefHBuff* copy = new CFBamTZDateDefHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTZDateDefHBuff::getOptionalDummyValue() const {
	...
	const std::string* CFBamTZDateDefHBuff::getOptionalDummyReference() const {
		return( optionalDummy );
	}

	const bool CFBamTZDateDefHBuff::isOptionalDummyNull() const {
		return( optionalDummy == NULL );
	}

	void CFBamTZDateDefHBuff::setOptionalDummyNull() {
		if( optionalDummy != NULL ) {
			delete optionalDummy;
			optionalDummy = NULL;
		}
	...
	void CFBamTZDateDefHBuff::setOptionalDummyValue( const std::string& value ) {
	...
	size_t CFBamTZDateDefHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamTZDateDefHBuff::hashCode();
	...
	CFBamTZDateDefHBuff CFBamTZDateDefHBuff::operator =( cfbam::CFBamTZDateDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamTZDateDefHBuff CFBamTZDateDefHBuff::operator =( cfbam::CFBamTZDateDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTZDateDefHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamTZDateDefHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamTZDateDefHBuff::operator <( const CFBamTZDateDefHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamTZDateDefHBuff::operator <( const CFBamTZDateDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTZDateDefHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZDateDefHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamTZDateDefHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTZDateDefHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTZDateDefHBuff& lhs, const cfbam::CFBamTZDateDefHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamTZDateDefHBuff& lhs, const cfbam::CFBamTZDateDefBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
