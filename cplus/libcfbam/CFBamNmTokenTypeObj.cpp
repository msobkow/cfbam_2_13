// Description: C++18 base object instance implementation for CFBam NmTokenType.
...
namespace cfbam {
	...
	const std::string CFBamNmTokenTypeObj::CLASS_NAME( "CFBamNmTokenTypeObj" );
	const classcode_t CFBamNmTokenTypeObj::CLASS_CODE = 0xa82aL;

	const int64_t CFBamNmTokenTypeObj::getRequiredSchemaDefId() {
		return( getNmTokenTypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamNmTokenTypeObj::getRequiredSchemaDefIdReference() {
		return( getNmTokenTypeBuff()->getRequiredSchemaDefIdReference() );
	}


	cfbam::ICFBamSchemaDefObj* CFBamNmTokenTypeObj::getRequiredContainerSchemaDef( bool forceRead ) {
	...
	CFBamNmTokenTypeObj::CFBamNmTokenTypeObj()
	: ICFBamNmTokenTypeObj(),
	  CFBamNmTokenDefObj()
	{
	}

	CFBamNmTokenTypeObj::CFBamNmTokenTypeObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamNmTokenTypeObj(),
	...
	cfbam::CFBamValueBuff* CFBamNmTokenTypeObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamNmTokenTypeBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableNmTokenType()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamNmTokenTypeObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamNmTokenTypeObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamNmTokenTypeObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamNmTokenTypeObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamNmTokenTypeObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNmTokenTypeObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamNmTokenTypeObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamNmTokenTypeObj::getObjName() {
	...
	const std::string CFBamNmTokenTypeObj::getGenDefName() {
		return( cfbam::CFBamNmTokenTypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamNmTokenTypeObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamNmTokenTypeObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamNmTokenTypeObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamNmTokenTypeObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamNmTokenTypeObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamNmTokenTypeObj::getObjQualifiedName() {
	...
	std::string CFBamNmTokenTypeObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamNmTokenTypeObj::realize() {
		cfbam::ICFBamNmTokenTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokenTypeTableObj()->realizeNmTokenType(
			(cfbam::ICFBamNmTokenTypeObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamNmTokenTypeObj::read( bool forceRead ) {
		cfbam::ICFBamNmTokenTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokenTypeTableObj()->readNmTokenTypeByIdIdx( getNmTokenTypeBuff()->getRequiredTenantId(),
		getNmTokenTypeBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamNmTokenTypeObj::moveUp() {
		cfbam::ICFBamNmTokenTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokenTypeTableObj()->moveUpNmTokenType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamNmTokenTypeObj::moveDown() {
		cfbam::ICFBamNmTokenTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokenTypeTableObj()->moveDownNmTokenType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamNmTokenTypeObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamNmTokenTypeObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokenTypeTableObj()->lockNmTokenType( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokenTypeTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamNmTokenTypeEditObj* CFBamNmTokenTypeObj::getNmTokenTypeEdit() {
		return( dynamic_cast<cfbam::ICFBamNmTokenTypeEditObj*>( edit ) );
	}
