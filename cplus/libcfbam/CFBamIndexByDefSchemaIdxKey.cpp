// Description: C++18 implementation for a Index by DefSchemaIdx index key object.
...
namespace cfbam {
	const std::string CFBamIndexByDefSchemaIdxKey::CLASS_NAME( "CFBamIndexByDefSchemaIdxKey" );
	const std::string CFBamIndexByDefSchemaIdxKey::S_VALUE( "value" );
	const std::string CFBamIndexByDefSchemaIdxKey::S_VALUE_LENGTH( "value.length()" );


	CFBamIndexByDefSchemaIdxKey::CFBamIndexByDefSchemaIdxKey() {
		optionalDefSchemaTenantId.setNull();
		optionalDefSchemaId.setNull();
	}

	CFBamIndexByDefSchemaIdxKey::CFBamIndexByDefSchemaIdxKey( const CFBamIndexByDefSchemaIdxKey& src ) {
		optionalDefSchemaTenantId.setNull();
		optionalDefSchemaId.setNull();
	...
	const int64_t CFBamIndexByDefSchemaIdxKey::getOptionalDefSchemaTenantIdValue() const {
		return( optionalDefSchemaTenantId.getValue() );
	}

	const int64_t* CFBamIndexByDefSchemaIdxKey::getOptionalDefSchemaTenantIdReference() const {
		return( optionalDefSchemaTenantId.getReference() );
	}

	const bool CFBamIndexByDefSchemaIdxKey::isOptionalDefSchemaTenantIdNull() const {
		return( optionalDefSchemaTenantId.isNull() );
	}

	void CFBamIndexByDefSchemaIdxKey::setOptionalDefSchemaTenantIdNull() {
		optionalDefSchemaTenantId.setNull();
	}

	void CFBamIndexByDefSchemaIdxKey::setOptionalDefSchemaTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamIndexByDefSchemaIdxKey::getOptionalDefSchemaIdValue() const {
		return( optionalDefSchemaId.getValue() );
	}

	const int64_t* CFBamIndexByDefSchemaIdxKey::getOptionalDefSchemaIdReference() const {
		return( optionalDefSchemaId.getReference() );
	}

	const bool CFBamIndexByDefSchemaIdxKey::isOptionalDefSchemaIdNull() const {
		return( optionalDefSchemaId.isNull() );
	}

	void CFBamIndexByDefSchemaIdxKey::setOptionalDefSchemaIdNull() {
		optionalDefSchemaId.setNull();
	}

	void CFBamIndexByDefSchemaIdxKey::setOptionalDefSchemaIdValue( const int64_t value ) {
	...
	size_t CFBamIndexByDefSchemaIdxKey::hashCode() const {
		size_t hashCode = 0;
	...
	std::string CFBamIndexByDefSchemaIdxKey::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamIndexByDefSchemaIdxKey" );
	...
	bool CFBamIndexByDefSchemaIdxKey::operator <( const CFBamIndexByDefSchemaIdxKey& rhs ) {
		if( ! isOptionalDefSchemaTenantIdNull() ) {
	...
	bool CFBamIndexByDefSchemaIdxKey::operator <( const CFBamIndexHBuff& rhs ) {
		if( ! isOptionalDefSchemaTenantIdNull() ) {
			if( rhs.isOptionalDefSchemaTenantIdNull() ) {
				return( false );
			}
	...
	bool CFBamIndexByDefSchemaIdxKey::operator <( const CFBamIndexBuff& rhs ) {
		if( ! isOptionalDefSchemaTenantIdNull() ) {
			if( rhs.isOptionalDefSchemaTenantIdNull() ) {
				return( false );
			}
	...
	CFBamIndexByDefSchemaIdxKey CFBamIndexByDefSchemaIdxKey::operator =( cfbam::CFBamIndexByDefSchemaIdxKey& src ) {
		if( src.isOptionalDefSchemaTenantIdNull() ) {
			setOptionalDefSchemaTenantIdNull();
		}
		else {
	...
	CFBamIndexByDefSchemaIdxKey CFBamIndexByDefSchemaIdxKey::operator =( cfbam::CFBamIndexBuff& src ) {
		if( src.isOptionalDefSchemaTenantIdNull() ) {
			setOptionalDefSchemaTenantIdNull();
		}
		else {
	...
	CFBamIndexByDefSchemaIdxKey CFBamIndexByDefSchemaIdxKey::operator =( cfbam::CFBamIndexHBuff& src ) {
		if( src.isOptionalDefSchemaTenantIdNull() ) {
			setOptionalDefSchemaTenantIdNull();
		}
		else {
