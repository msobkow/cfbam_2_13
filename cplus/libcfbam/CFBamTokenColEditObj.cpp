// Description: C++18 edit object instance implementation for CFBam TokenCol.
...
namespace cfbam {
	...
	const std::string CFBamTokenColEditObj::CLASS_NAME( "CFBamTokenColEditObj" );

	CFBamTokenColEditObj::CFBamTokenColEditObj( cfbam::ICFBamTokenColObj* argOrig )
	: ICFBamTokenColEditObj(),
	  CFBamTokenDefEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamTokenColEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamTokenColEditObj::~CFBamTokenColEditObj() {
	}

	const std::string& CFBamTokenColEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTokenColEditObj::getClassCode() const {
		return( cfbam::CFBamTokenColBuff::CLASS_CODE );
	}

	bool CFBamTokenColEditObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamTokenColBuff::CLASS_CODE ) {
			return( true );
		}
		else {
	...
	std::string CFBamTokenColEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTokenColEditObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamTokenColEditObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	const std::string CFBamTokenColEditObj::getGenDefName() {
		return( cfbam::CFBamTokenColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTokenColEditObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTokenColEditObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTokenColEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTokenColEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTokenColEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTokenColEditObj::getObjQualifiedName() {
	...
	std::string CFBamTokenColEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTokenColEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamTokenColObj* retobj = getSchema()->getTokenColTableObj()->realizeTokenCol( dynamic_cast<cfbam::ICFBamTokenColObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamTokenColEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamTokenColEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamTokenColEditObj::create() {
		cfbam::ICFBamTokenColObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsTokenCol()->getSchema() )->getTokenColTableObj()->createTokenCol( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamTokenColEditObj::update() {
		getSchema()->getTokenColTableObj()->updateTokenCol( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamTokenColEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getTokenColTableObj()->deleteTokenCol( this );
		return( NULL );
	}

	cfbam::ICFBamTokenColTableObj* CFBamTokenColEditObj::getTokenColTable() {
		return( orig->getSchema()->getTokenColTableObj() );
	}

	cfbam::ICFBamTokenColEditObj* CFBamTokenColEditObj::getTokenColEdit() {
		return( (cfbam::ICFBamTokenColEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamTokenColEditObj::beginEdit() {
	...
	cfbam::ICFBamTokenColObj* CFBamTokenColEditObj::getOrigAsTokenCol() {
		return( dynamic_cast<cfbam::ICFBamTokenColObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamTokenColEditObj::getBuff() {
		return( buff );
	}

	void CFBamTokenColEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamTokenDefEditObj::setBuff( value );
		}
	}

	const int64_t CFBamTokenColEditObj::getRequiredTableId() {
		return( getTokenColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamTokenColEditObj::getRequiredTableIdReference() {
		return( getTokenColBuff()->getRequiredTableIdReference() );
	}

	void CFBamTokenColEditObj::setRequiredContainerScope( cfbam::ICFBamScopeObj* value ) {
		if( value == NULL ) {
	...
	cfbam::ICFBamTableObj* CFBamTokenColEditObj::getRequiredContainerTable( bool forceRead ) {
		cfbam::ICFBamTableObj* retobj = NULL;
		bool anyMissing = false;
		if( ! anyMissing ) {
			retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsTokenCol()->getSchema() )->getTableTableObj()->readTableByIdIdx( getPKey()->getRequiredTenantId(),
					getTokenColBuff()->getRequiredTableId() );
		}
		return( retobj );
	}

	void CFBamTokenColEditObj::setRequiredContainerTable( cfbam::ICFBamTableObj* value ) {
			
			if( value != NULL ) {
				getPKey()->setRequiredTenantId
( value->getRequiredTenantId() );
				getTokenColEditBuff()->setRequiredTenantId( value->getRequiredTenantId() );
				getTokenColEditBuff()->setRequiredTableId( value->getRequiredId() );
			}

			CFBamTokenDefEditObj::setRequiredContainerScope( value );		}

	void CFBamTokenColEditObj::copyBuffToOrig() {
		cfbam::CFBamTokenColBuff* origBuff = getOrigAsTokenCol()->getTokenColEditBuff();
		cfbam::CFBamTokenColBuff* myBuff = getTokenColBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamTokenColEditObj::copyOrigToBuff() {
		cfbam::CFBamTokenColBuff* origBuff = getOrigAsTokenCol()->getTokenColBuff();
		cfbam::CFBamTokenColBuff* myBuff = getTokenColEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
