// Description: C++18 implementation for a TZTimestampCol buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTZTimestampColBuff::GENDEFNAME( "TZTimestampCol" );
	const classcode_t CFBamTZTimestampColBuff::CLASS_CODE = 0xa865L;
	const std::string CFBamTZTimestampColBuff::CLASS_NAME( "CFBamTZTimestampColBuff" );
		const std::string CFBamTZTimestampColBuff::COLNAME_TABLEID( "TableId" );
	const int64_t CFBamTZTimestampColBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamTZTimestampColBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamTZTimestampColBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamTZTimestampColBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamTZTimestampColBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamTZTimestampColBuff::TABLEID_MIN_VALUE = 0LL;

	CFBamTZTimestampColBuff::CFBamTZTimestampColBuff()
	: CFBamTZTimestampDefBuff()
	{
		requiredTableId = cfbam::CFBamTZTimestampColBuff::TABLEID_INIT_VALUE;
	}

	CFBamTZTimestampColBuff::CFBamTZTimestampColBuff( const CFBamTZTimestampColBuff& src )
	: CFBamTZTimestampDefBuff()
	{
		requiredTableId = cfbam::CFBamTZTimestampColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTZTimestampColBuff::clone() {
		CFBamTZTimestampColBuff* copy = new CFBamTZTimestampColBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTZTimestampColBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTZTimestampColBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTZTimestampColBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFBamTZTimestampColBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamTZTimestampColBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamTZTimestampColBuff::setRequiredTableId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredTableId" );
		if( value < cfbam::CFBamTZTimestampColBuff::TABLEID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamTZTimestampColBuff::TABLEID_MIN_VALUE );
		}
		requiredTableId = value;
	}

	size_t CFBamTZTimestampColBuff::hashCode() const {
		size_t hashCode = CFBamTZTimestampDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamTZTimestampColBuff CFBamTZTimestampColBuff::operator =( cfbam::CFBamTZTimestampColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamTZTimestampColBuff CFBamTZTimestampColBuff::operator =( cfbam::CFBamTZTimestampColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTZTimestampColBuff::operator <( const CFBamTZTimestampColByTableIdxKey& rhs ) {
	...
	bool CFBamTZTimestampColBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZTimestampColBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZTimestampColBuff::operator <( const CFBamTZTimestampColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZTimestampColBuff::operator <( const CFBamTZTimestampColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTZTimestampColBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZTimestampColBuff" );
