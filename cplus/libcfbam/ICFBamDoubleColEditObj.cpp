// Description: C++18 Instance Edit Object interface implementation for CFBam DoubleCol.
...
namespace cfbam {
	...
	const std::string ICFBamDoubleColEditObj::CLASS_NAME( "ICFBamDoubleColEditObj" );

	ICFBamDoubleColEditObj::ICFBamDoubleColEditObj()
