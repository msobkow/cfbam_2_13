// Description: C++18 implementation of a Int64Type history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamInt64TypeHBuff::CLASS_NAME( "CFBamInt64TypeHBuff" );
	CFBamInt64TypeHBuff::CFBamInt64TypeHBuff()
	: cfbam::CFBamInt64DefHBuff() {
		requiredSchemaDefId = cfbam::CFBamInt64TypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamInt64TypeHBuff::CFBamInt64TypeHBuff( const CFBamInt64TypeHBuff& src )
	: cfbam::CFBamInt64DefHBuff() {
		requiredSchemaDefId = cfbam::CFBamInt64TypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamInt64TypeHBuff::clone() {
		CFBamInt64TypeHBuff* copy = new CFBamInt64TypeHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamInt64TypeHBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamInt64TypeHBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamInt64TypeHBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamInt64TypeHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamInt64TypeHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamInt64TypeHBuff CFBamInt64TypeHBuff::operator =( cfbam::CFBamInt64TypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamInt64TypeHBuff CFBamInt64TypeHBuff::operator =( cfbam::CFBamInt64TypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamInt64TypeHBuff::operator <( const CFBamInt64TypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamInt64TypeHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt64TypeHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamInt64TypeHBuff::operator <( const CFBamInt64TypeHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamInt64TypeHBuff::operator <( const CFBamInt64TypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamInt64TypeHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt64TypeHBuff" );
