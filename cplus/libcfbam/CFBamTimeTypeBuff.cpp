// Description: C++18 implementation for a TimeType buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTimeTypeBuff::GENDEFNAME( "TimeType" );
	const classcode_t CFBamTimeTypeBuff::CLASS_CODE = 0xa845L;
	const std::string CFBamTimeTypeBuff::CLASS_NAME( "CFBamTimeTypeBuff" );
		const std::string CFBamTimeTypeBuff::COLNAME_SCHEMADEFID( "SchemaDefId" );
	const int64_t CFBamTimeTypeBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamTimeTypeBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamTimeTypeBuff::SCHEMADEFID_INIT_VALUE = 0LL;
	const int64_t CFBamTimeTypeBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamTimeTypeBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamTimeTypeBuff::SCHEMADEFID_MIN_VALUE = 0LL;

	CFBamTimeTypeBuff::CFBamTimeTypeBuff()
	: CFBamTimeDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamTimeTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamTimeTypeBuff::CFBamTimeTypeBuff( const CFBamTimeTypeBuff& src )
	: CFBamTimeDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamTimeTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTimeTypeBuff::clone() {
		CFBamTimeTypeBuff* copy = new CFBamTimeTypeBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTimeTypeBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTimeTypeBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTimeTypeBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamTimeDefBuff::implementsClassCode( argClassCode ) );
		}
	}

	const int64_t CFBamTimeTypeBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamTimeTypeBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamTimeTypeBuff::setRequiredSchemaDefId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredSchemaDefId" );
		if( value < cfbam::CFBamTimeTypeBuff::SCHEMADEFID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamTimeTypeBuff::SCHEMADEFID_MIN_VALUE );
		}
		requiredSchemaDefId = value;
	}

	size_t CFBamTimeTypeBuff::hashCode() const {
		size_t hashCode = CFBamTimeDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamTimeTypeBuff CFBamTimeTypeBuff::operator =( cfbam::CFBamTimeTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamTimeTypeBuff CFBamTimeTypeBuff::operator =( cfbam::CFBamTimeTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTimeTypeBuff::operator <( const CFBamTimeTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamTimeTypeBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTimeTypeBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTimeTypeBuff::operator <( const CFBamTimeTypeHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTimeTypeBuff::operator <( const CFBamTimeTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTimeTypeBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTimeTypeBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamTimeTypeBuff& lhs, const cfbam::CFBamTimeTypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTimeTypeBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTimeTypeBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTimeTypeBuff& lhs, const cfbam::CFBamTimeTypeHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTimeTypeBuff& lhs, const cfbam::CFBamTimeTypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
