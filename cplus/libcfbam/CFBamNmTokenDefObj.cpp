// Description: C++18 base object instance implementation for CFBam NmTokenDef.
...
namespace cfbam {
	...
	const std::string CFBamNmTokenDefObj::CLASS_NAME( "CFBamNmTokenDefObj" );
	const classcode_t CFBamNmTokenDefObj::CLASS_CODE = 0xa829L;

	const int32_t CFBamNmTokenDefObj::getRequiredMaxLen() {
		return( getNmTokenDefBuff()->getRequiredMaxLen() );
	}

	const int32_t* CFBamNmTokenDefObj::getRequiredMaxLenReference() {
		return( getNmTokenDefBuff()->getRequiredMaxLenReference() );
	}

	bool CFBamNmTokenDefObj::isOptionalInitValueNull() {
		return( getNmTokenDefBuff()->isOptionalInitValueNull() );
	}

	const std::string& CFBamNmTokenDefObj::getOptionalInitValueValue() {
		return( getNmTokenDefBuff()->getOptionalInitValueValue() );
	}

	const std::string* CFBamNmTokenDefObj::getOptionalInitValueReference() {
		return( getNmTokenDefBuff()->getOptionalInitValueReference() );
	}


	CFBamNmTokenDefObj::CFBamNmTokenDefObj()
	: ICFBamNmTokenDefObj(),
	  CFBamAtomObj()
	{
	}

	CFBamNmTokenDefObj::CFBamNmTokenDefObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamNmTokenDefObj(),
	...
	cfbam::CFBamValueBuff* CFBamNmTokenDefObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamNmTokenDefBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableNmTokenDef()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamNmTokenDefObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamNmTokenDefObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamNmTokenDefObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamNmTokenDefObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamNmTokenDefObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNmTokenDefObj" );
	...
	std::string CFBamNmTokenDefObj::getObjName() {
	...
	const std::string CFBamNmTokenDefObj::getGenDefName() {
		return( cfbam::CFBamNmTokenDefBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamNmTokenDefObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamNmTokenDefObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamNmTokenDefObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamNmTokenDefObj::getObjQualifiedName() {
	...
	std::string CFBamNmTokenDefObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamNmTokenDefObj::realize() {
		cfbam::ICFBamNmTokenDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokenDefTableObj()->realizeNmTokenDef(
			(cfbam::ICFBamNmTokenDefObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamNmTokenDefObj::read( bool forceRead ) {
		cfbam::ICFBamNmTokenDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokenDefTableObj()->readNmTokenDefByIdIdx( getNmTokenDefBuff()->getRequiredTenantId(),
		getNmTokenDefBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamNmTokenDefObj::moveUp() {
		cfbam::ICFBamNmTokenDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokenDefTableObj()->moveUpNmTokenDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamNmTokenDefObj::moveDown() {
		cfbam::ICFBamNmTokenDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokenDefTableObj()->moveDownNmTokenDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamNmTokenDefObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamNmTokenDefObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokenDefTableObj()->lockNmTokenDef( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokenDefTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamNmTokenDefEditObj* CFBamNmTokenDefObj::getNmTokenDefEdit() {
		return( dynamic_cast<cfbam::ICFBamNmTokenDefEditObj*>( edit ) );
	}
