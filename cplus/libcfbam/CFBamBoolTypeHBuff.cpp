// Description: C++18 implementation of a BoolType history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamBoolTypeHBuff::CLASS_NAME( "CFBamBoolTypeHBuff" );
	CFBamBoolTypeHBuff::CFBamBoolTypeHBuff()
	: cfbam::CFBamBoolDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamBoolTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamBoolTypeHBuff::CFBamBoolTypeHBuff( const CFBamBoolTypeHBuff& src )
	: cfbam::CFBamBoolDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamBoolTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamBoolTypeHBuff::clone() {
		CFBamBoolTypeHBuff* copy = new CFBamBoolTypeHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamBoolTypeHBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamBoolTypeHBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamBoolTypeHBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamBoolTypeHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamBoolTypeHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamBoolTypeHBuff CFBamBoolTypeHBuff::operator =( cfbam::CFBamBoolTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamBoolTypeHBuff CFBamBoolTypeHBuff::operator =( cfbam::CFBamBoolTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamBoolTypeHBuff::operator <( const CFBamBoolTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamBoolTypeHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamBoolTypeHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamBoolTypeHBuff::operator <( const CFBamBoolTypeHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamBoolTypeHBuff::operator <( const CFBamBoolTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamBoolTypeHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamBoolTypeHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamBoolTypeHBuff& lhs, const cfbam::CFBamBoolTypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamBoolTypeHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamBoolTypeHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamBoolTypeHBuff& lhs, const cfbam::CFBamBoolTypeHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamBoolTypeHBuff& lhs, const cfbam::CFBamBoolTypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
