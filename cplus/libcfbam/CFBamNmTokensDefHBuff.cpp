// Description: C++18 implementation of a NmTokensDef history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamNmTokensDefHBuff::CLASS_NAME( "CFBamNmTokensDefHBuff" );
	CFBamNmTokensDefHBuff::CFBamNmTokensDefHBuff()
	: cfbam::CFBamAtomHBuff() {
		requiredMaxLen = cfbam::CFBamNmTokensDefBuff::MAXLEN_INIT_VALUE;
		optionalInitValue = NULL;
	}

	CFBamNmTokensDefHBuff::CFBamNmTokensDefHBuff( const CFBamNmTokensDefHBuff& src )
	: cfbam::CFBamAtomHBuff() {
		requiredMaxLen = cfbam::CFBamNmTokensDefBuff::MAXLEN_INIT_VALUE;
		optionalInitValue = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamNmTokensDefHBuff::clone() {
		CFBamNmTokensDefHBuff* copy = new CFBamNmTokensDefHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int32_t CFBamNmTokensDefHBuff::getRequiredMaxLen() const {
		return( requiredMaxLen );
	}

	const int32_t* CFBamNmTokensDefHBuff::getRequiredMaxLenReference() const {
		return( &requiredMaxLen );
	}

	void CFBamNmTokensDefHBuff::setRequiredMaxLen( const int32_t value ) {
	...
	const std::string& CFBamNmTokensDefHBuff::getOptionalInitValueValue() const {
	...
	const std::string* CFBamNmTokensDefHBuff::getOptionalInitValueReference() const {
		return( optionalInitValue );
	}

	const bool CFBamNmTokensDefHBuff::isOptionalInitValueNull() const {
		return( optionalInitValue == NULL );
	}

	void CFBamNmTokensDefHBuff::setOptionalInitValueNull() {
		if( optionalInitValue != NULL ) {
			delete optionalInitValue;
			optionalInitValue = NULL;
		}
	...
	void CFBamNmTokensDefHBuff::setOptionalInitValueValue( const std::string& value ) {
	...
	size_t CFBamNmTokensDefHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamNmTokensDefHBuff::hashCode();
	...
	CFBamNmTokensDefHBuff CFBamNmTokensDefHBuff::operator =( cfbam::CFBamNmTokensDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamNmTokensDefHBuff CFBamNmTokensDefHBuff::operator =( cfbam::CFBamNmTokensDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamNmTokensDefHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamNmTokensDefHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamNmTokensDefHBuff::operator <( const CFBamNmTokensDefHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamNmTokensDefHBuff::operator <( const CFBamNmTokensDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamNmTokensDefHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNmTokensDefHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamNmTokensDefHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamNmTokensDefHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamNmTokensDefHBuff& lhs, const cfbam::CFBamNmTokensDefHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamNmTokensDefHBuff& lhs, const cfbam::CFBamNmTokensDefBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
