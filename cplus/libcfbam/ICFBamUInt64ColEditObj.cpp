// Description: C++18 Instance Edit Object interface implementation for CFBam UInt64Col.
...
namespace cfbam {
	...
	const std::string ICFBamUInt64ColEditObj::CLASS_NAME( "ICFBamUInt64ColEditObj" );

	ICFBamUInt64ColEditObj::ICFBamUInt64ColEditObj()
