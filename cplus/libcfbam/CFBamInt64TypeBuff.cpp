// Description: C++18 implementation for a Int64Type buffer object.
...
namespace cfbam {
	...
	const std::string CFBamInt64TypeBuff::GENDEFNAME( "Int64Type" );
	const classcode_t CFBamInt64TypeBuff::CLASS_CODE = 0xa828L;
	const std::string CFBamInt64TypeBuff::CLASS_NAME( "CFBamInt64TypeBuff" );
		const std::string CFBamInt64TypeBuff::COLNAME_SCHEMADEFID( "SchemaDefId" );
	const int64_t CFBamInt64TypeBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamInt64TypeBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamInt64TypeBuff::SCHEMADEFID_INIT_VALUE = 0LL;
	const int64_t CFBamInt64TypeBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamInt64TypeBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamInt64TypeBuff::SCHEMADEFID_MIN_VALUE = 0LL;

	CFBamInt64TypeBuff::CFBamInt64TypeBuff()
	: CFBamInt64DefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamInt64TypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamInt64TypeBuff::CFBamInt64TypeBuff( const CFBamInt64TypeBuff& src )
	: CFBamInt64DefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamInt64TypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamInt64TypeBuff::clone() {
		CFBamInt64TypeBuff* copy = new CFBamInt64TypeBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamInt64TypeBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamInt64TypeBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamInt64TypeBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamInt64DefBuff::implementsClassCode( argClassCode ) );
		}
	}

	const int64_t CFBamInt64TypeBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamInt64TypeBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamInt64TypeBuff::setRequiredSchemaDefId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredSchemaDefId" );
		if( value < cfbam::CFBamInt64TypeBuff::SCHEMADEFID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamInt64TypeBuff::SCHEMADEFID_MIN_VALUE );
		}
		requiredSchemaDefId = value;
	}

	size_t CFBamInt64TypeBuff::hashCode() const {
		size_t hashCode = CFBamInt64DefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamInt64TypeBuff CFBamInt64TypeBuff::operator =( cfbam::CFBamInt64TypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamInt64TypeBuff CFBamInt64TypeBuff::operator =( cfbam::CFBamInt64TypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamInt64TypeBuff::operator <( const CFBamInt64TypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamInt64TypeBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt64TypeBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt64TypeBuff::operator <( const CFBamInt64TypeHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt64TypeBuff::operator <( const CFBamInt64TypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamInt64TypeBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt64TypeBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamInt64TypeBuff& lhs, const cfbam::CFBamInt64TypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamInt64TypeBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamInt64TypeBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamInt64TypeBuff& lhs, const cfbam::CFBamInt64TypeHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamInt64TypeBuff& lhs, const cfbam::CFBamInt64TypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
