// Description: C++18 Instance Edit Object interface implementation for CFBam UInt32Type.
...
namespace cfbam {
	...
	const std::string ICFBamUInt32TypeEditObj::CLASS_NAME( "ICFBamUInt32TypeEditObj" );

	ICFBamUInt32TypeEditObj::ICFBamUInt32TypeEditObj()
