// Description: C++18 edit object instance implementation for CFBam BlobCol.
...
namespace cfbam {
	...
	const std::string CFBamBlobColEditObj::CLASS_NAME( "CFBamBlobColEditObj" );

	CFBamBlobColEditObj::CFBamBlobColEditObj( cfbam::ICFBamBlobColObj* argOrig )
	: ICFBamBlobColEditObj(),
	  CFBamBlobDefEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamBlobColEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamBlobColEditObj::~CFBamBlobColEditObj() {
	}

	const std::string& CFBamBlobColEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamBlobColEditObj::getClassCode() const {
		return( cfbam::CFBamBlobColBuff::CLASS_CODE );
	}

	bool CFBamBlobColEditObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamBlobColBuff::CLASS_CODE ) {
			return( true );
		}
		else {
	...
	std::string CFBamBlobColEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamBlobColEditObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamBlobColEditObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	const std::string CFBamBlobColEditObj::getGenDefName() {
		return( cfbam::CFBamBlobColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamBlobColEditObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamBlobColEditObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamBlobColEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamBlobColEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamBlobColEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamBlobColEditObj::getObjQualifiedName() {
	...
	std::string CFBamBlobColEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamBlobColEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamBlobColObj* retobj = getSchema()->getBlobColTableObj()->realizeBlobCol( dynamic_cast<cfbam::ICFBamBlobColObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamBlobColEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamBlobColEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamBlobColEditObj::create() {
		cfbam::ICFBamBlobColObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsBlobCol()->getSchema() )->getBlobColTableObj()->createBlobCol( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamBlobColEditObj::update() {
		getSchema()->getBlobColTableObj()->updateBlobCol( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamBlobColEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getBlobColTableObj()->deleteBlobCol( this );
		return( NULL );
	}

	cfbam::ICFBamBlobColTableObj* CFBamBlobColEditObj::getBlobColTable() {
		return( orig->getSchema()->getBlobColTableObj() );
	}

	cfbam::ICFBamBlobColEditObj* CFBamBlobColEditObj::getBlobColEdit() {
		return( (cfbam::ICFBamBlobColEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamBlobColEditObj::beginEdit() {
	...
	cfbam::ICFBamBlobColObj* CFBamBlobColEditObj::getOrigAsBlobCol() {
		return( dynamic_cast<cfbam::ICFBamBlobColObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamBlobColEditObj::getBuff() {
		return( buff );
	}

	void CFBamBlobColEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamBlobDefEditObj::setBuff( value );
		}
	}

	const int64_t CFBamBlobColEditObj::getRequiredTableId() {
		return( getBlobColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamBlobColEditObj::getRequiredTableIdReference() {
		return( getBlobColBuff()->getRequiredTableIdReference() );
	}

	void CFBamBlobColEditObj::setRequiredContainerScope( cfbam::ICFBamScopeObj* value ) {
		if( value == NULL ) {
	...
	cfbam::ICFBamTableObj* CFBamBlobColEditObj::getRequiredContainerTable( bool forceRead ) {
		cfbam::ICFBamTableObj* retobj = NULL;
		bool anyMissing = false;
		if( ! anyMissing ) {
			retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsBlobCol()->getSchema() )->getTableTableObj()->readTableByIdIdx( getPKey()->getRequiredTenantId(),
					getBlobColBuff()->getRequiredTableId() );
		}
		return( retobj );
	}

	void CFBamBlobColEditObj::setRequiredContainerTable( cfbam::ICFBamTableObj* value ) {
			
			if( value != NULL ) {
				getPKey()->setRequiredTenantId
( value->getRequiredTenantId() );
				getBlobColEditBuff()->setRequiredTenantId( value->getRequiredTenantId() );
				getBlobColEditBuff()->setRequiredTableId( value->getRequiredId() );
			}

			CFBamBlobDefEditObj::setRequiredContainerScope( value );		}

	void CFBamBlobColEditObj::copyBuffToOrig() {
		cfbam::CFBamBlobColBuff* origBuff = getOrigAsBlobCol()->getBlobColEditBuff();
		cfbam::CFBamBlobColBuff* myBuff = getBlobColBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamBlobColEditObj::copyOrigToBuff() {
		cfbam::CFBamBlobColBuff* origBuff = getOrigAsBlobCol()->getBlobColBuff();
		cfbam::CFBamBlobColBuff* myBuff = getBlobColEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
