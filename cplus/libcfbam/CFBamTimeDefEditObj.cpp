// Description: C++18 edit object instance implementation for CFBam TimeDef.
...
namespace cfbam {
	...
	const std::string CFBamTimeDefEditObj::CLASS_NAME( "CFBamTimeDefEditObj" );

	CFBamTimeDefEditObj::CFBamTimeDefEditObj( cfbam::ICFBamTimeDefObj* argOrig )
	: ICFBamTimeDefEditObj(),
	  CFBamAtomEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamTimeDefEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamTimeDefEditObj::~CFBamTimeDefEditObj() {
	}

	const std::string& CFBamTimeDefEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTimeDefEditObj::getClassCode() const {
		return( cfbam::CFBamTimeDefBuff::CLASS_CODE );
	}

	bool CFBamTimeDefEditObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamTimeDefBuff::CLASS_CODE ) {
			return( true );
		}
		else {
	...
	std::string CFBamTimeDefEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTimeDefEditObj" );
	...
	const std::string CFBamTimeDefEditObj::getGenDefName() {
		return( cfbam::CFBamTimeDefBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTimeDefEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTimeDefEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTimeDefEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTimeDefEditObj::getObjQualifiedName() {
	...
	std::string CFBamTimeDefEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTimeDefEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamTimeDefObj* retobj = getSchema()->getTimeDefTableObj()->realizeTimeDef( dynamic_cast<cfbam::ICFBamTimeDefObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamTimeDefEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamTimeDefEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamTimeDefEditObj::create() {
		cfbam::ICFBamTimeDefObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsTimeDef()->getSchema() )->getTimeDefTableObj()->createTimeDef( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamTimeDefEditObj::update() {
		getSchema()->getTimeDefTableObj()->updateTimeDef( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamTimeDefEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getTimeDefTableObj()->deleteTimeDef( this );
		return( NULL );
	}

	cfbam::ICFBamTimeDefTableObj* CFBamTimeDefEditObj::getTimeDefTable() {
		return( orig->getSchema()->getTimeDefTableObj() );
	}

	cfbam::ICFBamTimeDefEditObj* CFBamTimeDefEditObj::getTimeDefEdit() {
		return( (cfbam::ICFBamTimeDefEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamTimeDefEditObj::beginEdit() {
	...
	cfbam::ICFBamTimeDefObj* CFBamTimeDefEditObj::getOrigAsTimeDef() {
		return( dynamic_cast<cfbam::ICFBamTimeDefObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamTimeDefEditObj::getBuff() {
		return( buff );
	}

	void CFBamTimeDefEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamAtomEditObj::setBuff( value );
		}
	}

	bool CFBamTimeDefEditObj::isOptionalDummyNull() {
		return( getTimeDefBuff()->isOptionalDummyNull() );
	}

	const std::string& CFBamTimeDefEditObj::getOptionalDummyValue() {
		return( getTimeDefBuff()->getOptionalDummyValue() );
	}

	const std::string* CFBamTimeDefEditObj::getOptionalDummyReference() {
		return( getTimeDefBuff()->getOptionalDummyReference() );
	}

	void CFBamTimeDefEditObj::setOptionalDummyNull() {
		if( ! getTimeDefBuff()->isOptionalDummyNull() ) {
			getTimeDefEditBuff()->setOptionalDummyNull();
		}
	}

	void CFBamTimeDefEditObj::setOptionalDummyValue( const std::string& value ) {
		if( getTimeDefBuff()->isOptionalDummyNull() ) {
			getTimeDefEditBuff()->setOptionalDummyValue( value );
		}
		else if( getTimeDefBuff()->getOptionalDummyValue() != value ) {
			getTimeDefEditBuff()->setOptionalDummyValue( value );
		}
	}

	void CFBamTimeDefEditObj::copyBuffToOrig() {
		cfbam::CFBamTimeDefBuff* origBuff = getOrigAsTimeDef()->getTimeDefEditBuff();
		cfbam::CFBamTimeDefBuff* myBuff = getTimeDefBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamTimeDefEditObj::copyOrigToBuff() {
		cfbam::CFBamTimeDefBuff* origBuff = getOrigAsTimeDef()->getTimeDefBuff();
		cfbam::CFBamTimeDefBuff* myBuff = getTimeDefEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
