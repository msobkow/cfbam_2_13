// Description: C++18 implementation of a EnumDef history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamEnumDefHBuff::CLASS_NAME( "CFBamEnumDefHBuff" );
	CFBamEnumDefHBuff::CFBamEnumDefHBuff()
	: cfbam::CFBamInt16DefHBuff() {
	}

	CFBamEnumDefHBuff::CFBamEnumDefHBuff( const CFBamEnumDefHBuff& src )
	: cfbam::CFBamInt16DefHBuff() {
	...
	cflib::ICFLibCloneableObj* CFBamEnumDefHBuff::clone() {
		CFBamEnumDefHBuff* copy = new CFBamEnumDefHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	size_t CFBamEnumDefHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamEnumDefHBuff::hashCode();
		return( hashCode );
	}

	CFBamEnumDefHBuff CFBamEnumDefHBuff::operator =( cfbam::CFBamEnumDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamEnumDefHBuff CFBamEnumDefHBuff::operator =( cfbam::CFBamEnumDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamEnumDefHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamEnumDefHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamEnumDefHBuff::operator <( const CFBamEnumDefHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamEnumDefHBuff::operator <( const CFBamEnumDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamEnumDefHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamEnumDefHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamEnumDefHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamEnumDefHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamEnumDefHBuff& lhs, const cfbam::CFBamEnumDefHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamEnumDefHBuff& lhs, const cfbam::CFBamEnumDefBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
