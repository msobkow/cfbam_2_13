// Description: C++18 Instance Edit Object interface implementation for CFBam Int64Type.
...
namespace cfbam {
	...
	const std::string ICFBamInt64TypeEditObj::CLASS_NAME( "ICFBamInt64TypeEditObj" );

	ICFBamInt64TypeEditObj::ICFBamInt64TypeEditObj()
