// Description: C++18 implementation for a IndexCol by IdxNextIdx index key object.
...
namespace cfbam {
	const std::string CFBamIndexColByIdxNextIdxKey::CLASS_NAME( "CFBamIndexColByIdxNextIdxKey" );
	const std::string CFBamIndexColByIdxNextIdxKey::S_VALUE( "value" );
	const std::string CFBamIndexColByIdxNextIdxKey::S_VALUE_LENGTH( "value.length()" );


	CFBamIndexColByIdxNextIdxKey::CFBamIndexColByIdxNextIdxKey() {
	...
	CFBamIndexColByIdxNextIdxKey::CFBamIndexColByIdxNextIdxKey( const CFBamIndexColByIdxNextIdxKey& src ) {
		requiredTenantId = cfbam::CFBamIndexColBuff::TENANTID_INIT_VALUE;
		requiredIndexId = cfbam::CFBamIndexColBuff::INDEXID_INIT_VALUE;
		optionalNextId.setNull();
	...
	const int64_t CFBamIndexColByIdxNextIdxKey::getRequiredTenantId() const {
		return( requiredTenantId );
	}

	const int64_t* CFBamIndexColByIdxNextIdxKey::getRequiredTenantIdReference() const {
		return( &requiredTenantId );
	}

	void CFBamIndexColByIdxNextIdxKey::setRequiredTenantId( const int64_t value ) {
	...
	const int64_t CFBamIndexColByIdxNextIdxKey::getRequiredIndexId() const {
		return( requiredIndexId );
	}

	const int64_t* CFBamIndexColByIdxNextIdxKey::getRequiredIndexIdReference() const {
		return( &requiredIndexId );
	}

	void CFBamIndexColByIdxNextIdxKey::setRequiredIndexId( const int64_t value ) {
	...
	const int64_t CFBamIndexColByIdxNextIdxKey::getOptionalNextIdValue() const {
		return( optionalNextId.getValue() );
	}

	const int64_t* CFBamIndexColByIdxNextIdxKey::getOptionalNextIdReference() const {
		return( optionalNextId.getReference() );
	}

	const bool CFBamIndexColByIdxNextIdxKey::isOptionalNextIdNull() const {
		return( optionalNextId.isNull() );
	}

	void CFBamIndexColByIdxNextIdxKey::setOptionalNextIdNull() {
		optionalNextId.setNull();
	}

	void CFBamIndexColByIdxNextIdxKey::setOptionalNextIdValue( const int64_t value ) {
	...
	size_t CFBamIndexColByIdxNextIdxKey::hashCode() const {
		size_t hashCode = 0;
	...
	std::string CFBamIndexColByIdxNextIdxKey::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamIndexColByIdxNextIdxKey" );
	...
	bool CFBamIndexColByIdxNextIdxKey::operator <( const CFBamIndexColByIdxNextIdxKey& rhs ) {
	...
	bool CFBamIndexColByIdxNextIdxKey::operator <( const CFBamIndexColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamIndexColByIdxNextIdxKey::operator <( const CFBamIndexColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	CFBamIndexColByIdxNextIdxKey CFBamIndexColByIdxNextIdxKey::operator =( cfbam::CFBamIndexColByIdxNextIdxKey& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredIndexId( src.getRequiredIndexId() );
		if( src.isOptionalNextIdNull() ) {
			setOptionalNextIdNull();
	...
	CFBamIndexColByIdxNextIdxKey CFBamIndexColByIdxNextIdxKey::operator =( cfbam::CFBamIndexColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredIndexId( src.getRequiredIndexId() );
		if( src.isOptionalNextIdNull() ) {
			setOptionalNextIdNull();
	...
	CFBamIndexColByIdxNextIdxKey CFBamIndexColByIdxNextIdxKey::operator =( cfbam::CFBamIndexColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredIndexId( src.getRequiredIndexId() );
		if( src.isOptionalNextIdNull() ) {
			setOptionalNextIdNull();
