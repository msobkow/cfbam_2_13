// Description: C++18 implementation of a TZDateCol history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTZDateColHBuff::CLASS_NAME( "CFBamTZDateColHBuff" );
	CFBamTZDateColHBuff::CFBamTZDateColHBuff()
	: cfbam::CFBamTZDateDefHBuff() {
		requiredTableId = cfbam::CFBamTZDateColBuff::TABLEID_INIT_VALUE;
	}

	CFBamTZDateColHBuff::CFBamTZDateColHBuff( const CFBamTZDateColHBuff& src )
	: cfbam::CFBamTZDateDefHBuff() {
		requiredTableId = cfbam::CFBamTZDateColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTZDateColHBuff::clone() {
		CFBamTZDateColHBuff* copy = new CFBamTZDateColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamTZDateColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamTZDateColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamTZDateColHBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamTZDateColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamTZDateColHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamTZDateColHBuff CFBamTZDateColHBuff::operator =( cfbam::CFBamTZDateColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamTZDateColHBuff CFBamTZDateColHBuff::operator =( cfbam::CFBamTZDateColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTZDateColHBuff::operator <( const CFBamTZDateColByTableIdxKey& rhs ) {
	...
	bool CFBamTZDateColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZDateColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamTZDateColHBuff::operator <( const CFBamTZDateColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamTZDateColHBuff::operator <( const CFBamTZDateColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTZDateColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZDateColHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamTZDateColHBuff& lhs, const cfbam::CFBamTZDateColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTZDateColHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTZDateColHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTZDateColHBuff& lhs, const cfbam::CFBamTZDateColHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamTZDateColHBuff& lhs, const cfbam::CFBamTZDateColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
