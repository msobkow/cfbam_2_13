// Description: C++18 implementation for a UInt64Def buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUInt64DefBuff::GENDEFNAME( "UInt64Def" );
	const classcode_t CFBamUInt64DefBuff::CLASS_CODE = 0xa84eL;
	const std::string CFBamUInt64DefBuff::CLASS_NAME( "CFBamUInt64DefBuff" );
		const std::string CFBamUInt64DefBuff::COLNAME_INITVALUE( "InitValue" );
		const std::string CFBamUInt64DefBuff::COLNAME_MINVALUE( "MinValue" );
		const std::string CFBamUInt64DefBuff::COLNAME_MAXVALUE( "MaxValue" );
	const int64_t CFBamUInt64DefBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamUInt64DefBuff::ID_INIT_VALUE = 0LL;
	const uint64_t CFBamUInt64DefBuff::INITVALUE_INIT_VALUE = 0ULL;
	const uint64_t CFBamUInt64DefBuff::MINVALUE_INIT_VALUE = 0ULL;
	const uint64_t CFBamUInt64DefBuff::MAXVALUE_INIT_VALUE = 0ULL;
	const int64_t CFBamUInt64DefBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamUInt64DefBuff::ID_MIN_VALUE = 0LL;
	const uint64_t CFBamUInt64DefBuff::INITVALUE_MIN_VALUE = 0ULL;
	const uint64_t CFBamUInt64DefBuff::MINVALUE_MIN_VALUE = 0ULL;
	const uint64_t CFBamUInt64DefBuff::MAXVALUE_MIN_VALUE = 0ULL;

	CFBamUInt64DefBuff::CFBamUInt64DefBuff()
	: CFBamAtomBuff()
	{
	...
	CFBamUInt64DefBuff::CFBamUInt64DefBuff( const CFBamUInt64DefBuff& src )
	: CFBamAtomBuff()
	{
		optionalInitValue.setNull();
		optionalMinValue.setNull();
	...
	cflib::ICFLibCloneableObj* CFBamUInt64DefBuff::clone() {
		CFBamUInt64DefBuff* copy = new CFBamUInt64DefBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamUInt64DefBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUInt64DefBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamUInt64DefBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const bool CFBamUInt64DefBuff::isOptionalInitValueNull() const {
		return( optionalInitValue.isNull() );
	}

	const uint64_t CFBamUInt64DefBuff::getOptionalInitValueValue() const {
		return( optionalInitValue.getValue() );
	}

	const uint64_t* CFBamUInt64DefBuff::getOptionalInitValueReference() const {
		return( optionalInitValue.getReference() );
	}

	void CFBamUInt64DefBuff::setOptionalInitValueNull() {
		optionalInitValue.setNull();
	}

	void CFBamUInt64DefBuff::setOptionalInitValueValue( const uint64_t value ) {
		static const std::string S_ProcName( "setOptionalInitValueValue" );
		if( value < cfbam::CFBamUInt64DefBuff::INITVALUE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamUInt64DefBuff::INITVALUE_MIN_VALUE );
		}
		optionalInitValue.setValue( value );
	}

	const bool CFBamUInt64DefBuff::isOptionalMinValueNull() const {
		return( optionalMinValue.isNull() );
	}

	const uint64_t CFBamUInt64DefBuff::getOptionalMinValueValue() const {
		return( optionalMinValue.getValue() );
	}

	const uint64_t* CFBamUInt64DefBuff::getOptionalMinValueReference() const {
		return( optionalMinValue.getReference() );
	}

	void CFBamUInt64DefBuff::setOptionalMinValueNull() {
		optionalMinValue.setNull();
	}

	void CFBamUInt64DefBuff::setOptionalMinValueValue( const uint64_t value ) {
		static const std::string S_ProcName( "setOptionalMinValueValue" );
		if( value < cfbam::CFBamUInt64DefBuff::MINVALUE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamUInt64DefBuff::MINVALUE_MIN_VALUE );
		}
		optionalMinValue.setValue( value );
	}

	const bool CFBamUInt64DefBuff::isOptionalMaxValueNull() const {
		return( optionalMaxValue.isNull() );
	}

	const uint64_t CFBamUInt64DefBuff::getOptionalMaxValueValue() const {
		return( optionalMaxValue.getValue() );
	}

	const uint64_t* CFBamUInt64DefBuff::getOptionalMaxValueReference() const {
		return( optionalMaxValue.getReference() );
	}

	void CFBamUInt64DefBuff::setOptionalMaxValueNull() {
		optionalMaxValue.setNull();
	}

	void CFBamUInt64DefBuff::setOptionalMaxValueValue( const uint64_t value ) {
		static const std::string S_ProcName( "setOptionalMaxValueValue" );
		if( value < cfbam::CFBamUInt64DefBuff::MAXVALUE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamUInt64DefBuff::MAXVALUE_MIN_VALUE );
		}
		optionalMaxValue.setValue( value );
	}

	size_t CFBamUInt64DefBuff::hashCode() const {
	...
	CFBamUInt64DefBuff CFBamUInt64DefBuff::operator =( cfbam::CFBamUInt64DefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamUInt64DefBuff CFBamUInt64DefBuff::operator =( cfbam::CFBamUInt64DefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUInt64DefBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamUInt64DefBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt64DefBuff::operator <( const CFBamUInt64DefHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt64DefBuff::operator <( const CFBamUInt64DefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUInt64DefBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt64DefBuff" );
