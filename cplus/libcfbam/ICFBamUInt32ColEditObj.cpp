// Description: C++18 Instance Edit Object interface implementation for CFBam UInt32Col.
...
namespace cfbam {
	...
	const std::string ICFBamUInt32ColEditObj::CLASS_NAME( "ICFBamUInt32ColEditObj" );

	ICFBamUInt32ColEditObj::ICFBamUInt32ColEditObj()
