// Description: C++18 edit object instance implementation for CFBam UInt16Col.
...
namespace cfbam {
	...
	const std::string CFBamUInt16ColEditObj::CLASS_NAME( "CFBamUInt16ColEditObj" );

	CFBamUInt16ColEditObj::CFBamUInt16ColEditObj( cfbam::ICFBamUInt16ColObj* argOrig )
	: ICFBamUInt16ColEditObj(),
	  CFBamUInt16DefEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamUInt16ColEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamUInt16ColEditObj::~CFBamUInt16ColEditObj() {
	}

	const std::string& CFBamUInt16ColEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUInt16ColEditObj::getClassCode() const {
		return( cfbam::CFBamUInt16ColBuff::CLASS_CODE );
	}

	bool CFBamUInt16ColEditObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamUInt16ColEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt16ColEditObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamUInt16ColEditObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	const std::string CFBamUInt16ColEditObj::getGenDefName() {
		return( cfbam::CFBamUInt16ColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamUInt16ColEditObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamUInt16ColEditObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamUInt16ColEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamUInt16ColEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamUInt16ColEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamUInt16ColEditObj::getObjQualifiedName() {
	...
	std::string CFBamUInt16ColEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamUInt16ColEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamUInt16ColObj* retobj = getSchema()->getUInt16ColTableObj()->realizeUInt16Col( dynamic_cast<cfbam::ICFBamUInt16ColObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamUInt16ColEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamUInt16ColEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamUInt16ColEditObj::create() {
		cfbam::ICFBamUInt16ColObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsUInt16Col()->getSchema() )->getUInt16ColTableObj()->createUInt16Col( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamUInt16ColEditObj::update() {
		getSchema()->getUInt16ColTableObj()->updateUInt16Col( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamUInt16ColEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getUInt16ColTableObj()->deleteUInt16Col( this );
		return( NULL );
	}

	cfbam::ICFBamUInt16ColTableObj* CFBamUInt16ColEditObj::getUInt16ColTable() {
		return( orig->getSchema()->getUInt16ColTableObj() );
	}

	cfbam::ICFBamUInt16ColEditObj* CFBamUInt16ColEditObj::getUInt16ColEdit() {
		return( (cfbam::ICFBamUInt16ColEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamUInt16ColEditObj::beginEdit() {
	...
	cfbam::ICFBamUInt16ColObj* CFBamUInt16ColEditObj::getOrigAsUInt16Col() {
		return( dynamic_cast<cfbam::ICFBamUInt16ColObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamUInt16ColEditObj::getBuff() {
		return( buff );
	}

	void CFBamUInt16ColEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamUInt16DefEditObj::setBuff( value );
		}
	}

	const int64_t CFBamUInt16ColEditObj::getRequiredTableId() {
		return( getUInt16ColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamUInt16ColEditObj::getRequiredTableIdReference() {
		return( getUInt16ColBuff()->getRequiredTableIdReference() );
	}

	void CFBamUInt16ColEditObj::setRequiredContainerScope( cfbam::ICFBamScopeObj* value ) {
		if( value == NULL ) {
	...
	cfbam::ICFBamTableObj* CFBamUInt16ColEditObj::getRequiredContainerTable( bool forceRead ) {
		cfbam::ICFBamTableObj* retobj = NULL;
		bool anyMissing = false;
		if( ! anyMissing ) {
			retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsUInt16Col()->getSchema() )->getTableTableObj()->readTableByIdIdx( getPKey()->getRequiredTenantId(),
					getUInt16ColBuff()->getRequiredTableId() );
		}
		return( retobj );
	}

	void CFBamUInt16ColEditObj::setRequiredContainerTable( cfbam::ICFBamTableObj* value ) {
			
			if( value != NULL ) {
				getPKey()->setRequiredTenantId
( value->getRequiredTenantId() );
				getUInt16ColEditBuff()->setRequiredTenantId( value->getRequiredTenantId() );
				getUInt16ColEditBuff()->setRequiredTableId( value->getRequiredId() );
			}

			CFBamUInt16DefEditObj::setRequiredContainerScope( value );		}

	void CFBamUInt16ColEditObj::copyBuffToOrig() {
		cfbam::CFBamUInt16ColBuff* origBuff = getOrigAsUInt16Col()->getUInt16ColEditBuff();
		cfbam::CFBamUInt16ColBuff* myBuff = getUInt16ColBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamUInt16ColEditObj::copyOrigToBuff() {
		cfbam::CFBamUInt16ColBuff* origBuff = getOrigAsUInt16Col()->getUInt16ColBuff();
		cfbam::CFBamUInt16ColBuff* myBuff = getUInt16ColEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
