// Description: C++18 edit object instance implementation for CFBam BlobType.
...
namespace cfbam {
	...
	const std::string CFBamBlobTypeEditObj::CLASS_NAME( "CFBamBlobTypeEditObj" );

	CFBamBlobTypeEditObj::CFBamBlobTypeEditObj( cfbam::ICFBamBlobTypeObj* argOrig )
	: ICFBamBlobTypeEditObj(),
	  CFBamBlobDefEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamBlobTypeEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamBlobTypeEditObj::~CFBamBlobTypeEditObj() {
	}

	const std::string& CFBamBlobTypeEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamBlobTypeEditObj::getClassCode() const {
		return( cfbam::CFBamBlobTypeBuff::CLASS_CODE );
	}

	bool CFBamBlobTypeEditObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamBlobTypeBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamBlobDefEditObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamBlobTypeEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamBlobTypeEditObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamBlobTypeEditObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	const std::string CFBamBlobTypeEditObj::getGenDefName() {
		return( cfbam::CFBamBlobTypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamBlobTypeEditObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamBlobTypeEditObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamBlobTypeEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamBlobTypeEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamBlobTypeEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamBlobTypeEditObj::getObjQualifiedName() {
	...
	std::string CFBamBlobTypeEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamBlobTypeEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamBlobTypeObj* retobj = getSchema()->getBlobTypeTableObj()->realizeBlobType( dynamic_cast<cfbam::ICFBamBlobTypeObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamBlobTypeEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamBlobTypeEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamBlobTypeEditObj::create() {
		cfbam::ICFBamBlobTypeObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsBlobType()->getSchema() )->getBlobTypeTableObj()->createBlobType( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamBlobTypeEditObj::update() {
		getSchema()->getBlobTypeTableObj()->updateBlobType( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamBlobTypeEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getBlobTypeTableObj()->deleteBlobType( this );
		return( NULL );
	}

	cfbam::ICFBamBlobTypeTableObj* CFBamBlobTypeEditObj::getBlobTypeTable() {
		return( orig->getSchema()->getBlobTypeTableObj() );
	}

	cfbam::ICFBamBlobTypeEditObj* CFBamBlobTypeEditObj::getBlobTypeEdit() {
		return( (cfbam::ICFBamBlobTypeEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamBlobTypeEditObj::beginEdit() {
	...
	cfbam::ICFBamBlobTypeObj* CFBamBlobTypeEditObj::getOrigAsBlobType() {
		return( dynamic_cast<cfbam::ICFBamBlobTypeObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamBlobTypeEditObj::getBuff() {
		return( buff );
	}

	void CFBamBlobTypeEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamBlobDefEditObj::setBuff( value );
		}
	}

	const int64_t CFBamBlobTypeEditObj::getRequiredSchemaDefId() {
		return( getBlobTypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamBlobTypeEditObj::getRequiredSchemaDefIdReference() {
		return( getBlobTypeBuff()->getRequiredSchemaDefIdReference() );
	}

	void CFBamBlobTypeEditObj::setRequiredContainerScope( cfbam::ICFBamScopeObj* value ) {
		if( value == NULL ) {
	...
	cfbam::ICFBamSchemaDefObj* CFBamBlobTypeEditObj::getRequiredContainerSchemaDef( bool forceRead ) {
		cfbam::ICFBamSchemaDefObj* retobj = NULL;
		bool anyMissing = false;
		if( ! anyMissing ) {
			retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsBlobType()->getSchema() )->getSchemaDefTableObj()->readSchemaDefByIdIdx( getPKey()->getRequiredTenantId(),
					getBlobTypeBuff()->getRequiredSchemaDefId() );
		}
		return( retobj );
	}

	void CFBamBlobTypeEditObj::setRequiredContainerSchemaDef( cfbam::ICFBamSchemaDefObj* value ) {
			
			if( value != NULL ) {
				getPKey()->setRequiredTenantId
( value->getRequiredTenantId() );
				getBlobTypeEditBuff()->setRequiredTenantId( value->getRequiredTenantId() );
				getBlobTypeEditBuff()->setRequiredSchemaDefId( value->getRequiredId() );
			}

			CFBamBlobDefEditObj::setRequiredContainerScope( value );		}

	void CFBamBlobTypeEditObj::copyBuffToOrig() {
		cfbam::CFBamBlobTypeBuff* origBuff = getOrigAsBlobType()->getBlobTypeEditBuff();
		cfbam::CFBamBlobTypeBuff* myBuff = getBlobTypeBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamBlobTypeEditObj::copyOrigToBuff() {
		cfbam::CFBamBlobTypeBuff* origBuff = getOrigAsBlobType()->getBlobTypeBuff();
		cfbam::CFBamBlobTypeBuff* myBuff = getBlobTypeEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
