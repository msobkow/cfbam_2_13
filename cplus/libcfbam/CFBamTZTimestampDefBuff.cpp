// Description: C++18 implementation for a TZTimestampDef buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTZTimestampDefBuff::GENDEFNAME( "TZTimestampDef" );
	const classcode_t CFBamTZTimestampDefBuff::CLASS_CODE = 0xa83eL;
	const std::string CFBamTZTimestampDefBuff::CLASS_NAME( "CFBamTZTimestampDefBuff" );
		const std::string CFBamTZTimestampDefBuff::COLNAME_DUMMY( "Dummy" );
	const int64_t CFBamTZTimestampDefBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamTZTimestampDefBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamTZTimestampDefBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamTZTimestampDefBuff::ID_MIN_VALUE = 0LL;
	const std::string::size_type CFBamTZTimestampDefBuff::DUMMY_MAX_LEN = 4;

	CFBamTZTimestampDefBuff::CFBamTZTimestampDefBuff()
	: CFBamAtomBuff()
	{
		optionalDummy = NULL;
	}

	CFBamTZTimestampDefBuff::CFBamTZTimestampDefBuff( const CFBamTZTimestampDefBuff& src )
	: CFBamAtomBuff()
	{
		optionalDummy = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamTZTimestampDefBuff::clone() {
		CFBamTZTimestampDefBuff* copy = new CFBamTZTimestampDefBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTZTimestampDefBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTZTimestampDefBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTZTimestampDefBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const bool CFBamTZTimestampDefBuff::isOptionalDummyNull() const {
		return( optionalDummy == NULL );
	}

	const std::string& CFBamTZTimestampDefBuff::getOptionalDummyValue() const {
	...
	const std::string* CFBamTZTimestampDefBuff::getOptionalDummyReference() const {
		return( optionalDummy );
	}

	void CFBamTZTimestampDefBuff::setOptionalDummyNull() {
		if( optionalDummy != NULL ) {
			delete optionalDummy;
			optionalDummy = NULL;
		}
	...
	void CFBamTZTimestampDefBuff::setOptionalDummyValue( const std::string& value ) {
		static const std::string S_ProcName( "setOptionalDummyValue" );
		if( value.length() > CFBamTZTimestampDefBuff::DUMMY_MAX_LEN ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE_LENGTH,
				value.length(),
				CFBamTZTimestampDefBuff::DUMMY_MAX_LEN );
		}
		if( optionalDummy != NULL ) {
			delete optionalDummy;
			optionalDummy = NULL;
	...
	size_t CFBamTZTimestampDefBuff::hashCode() const {
	...
	CFBamTZTimestampDefBuff CFBamTZTimestampDefBuff::operator =( cfbam::CFBamTZTimestampDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamTZTimestampDefBuff CFBamTZTimestampDefBuff::operator =( cfbam::CFBamTZTimestampDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTZTimestampDefBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamTZTimestampDefBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZTimestampDefBuff::operator <( const CFBamTZTimestampDefHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZTimestampDefBuff::operator <( const CFBamTZTimestampDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTZTimestampDefBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZTimestampDefBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamTZTimestampDefBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTZTimestampDefBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTZTimestampDefBuff& lhs, const cfbam::CFBamTZTimestampDefHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTZTimestampDefBuff& lhs, const cfbam::CFBamTZTimestampDefBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
