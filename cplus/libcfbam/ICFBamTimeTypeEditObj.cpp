// Description: C++18 Instance Edit Object interface implementation for CFBam TimeType.
...
namespace cfbam {
	...
	const std::string ICFBamTimeTypeEditObj::CLASS_NAME( "ICFBamTimeTypeEditObj" );

	ICFBamTimeTypeEditObj::ICFBamTimeTypeEditObj()
