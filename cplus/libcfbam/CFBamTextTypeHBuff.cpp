// Description: C++18 implementation of a TextType history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTextTypeHBuff::CLASS_NAME( "CFBamTextTypeHBuff" );
	CFBamTextTypeHBuff::CFBamTextTypeHBuff()
	: cfbam::CFBamTextDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamTextTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamTextTypeHBuff::CFBamTextTypeHBuff( const CFBamTextTypeHBuff& src )
	: cfbam::CFBamTextDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamTextTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTextTypeHBuff::clone() {
		CFBamTextTypeHBuff* copy = new CFBamTextTypeHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamTextTypeHBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamTextTypeHBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamTextTypeHBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamTextTypeHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamTextTypeHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamTextTypeHBuff CFBamTextTypeHBuff::operator =( cfbam::CFBamTextTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamTextTypeHBuff CFBamTextTypeHBuff::operator =( cfbam::CFBamTextTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTextTypeHBuff::operator <( const CFBamTextTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamTextTypeHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTextTypeHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamTextTypeHBuff::operator <( const CFBamTextTypeHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamTextTypeHBuff::operator <( const CFBamTextTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTextTypeHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTextTypeHBuff" );
