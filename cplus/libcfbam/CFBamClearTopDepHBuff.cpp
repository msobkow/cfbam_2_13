// Description: C++18 implementation of a ClearTopDep history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamClearTopDepHBuff::CLASS_NAME( "CFBamClearTopDepHBuff" );
	CFBamClearTopDepHBuff::CFBamClearTopDepHBuff()
	...
	CFBamClearTopDepHBuff::CFBamClearTopDepHBuff( const CFBamClearTopDepHBuff& src )
	: cfbam::CFBamClearDepHBuff() {
		requiredTableTenantId = cfbam::CFBamClearTopDepBuff::TABLETENANTID_INIT_VALUE;
		requiredTableId = cfbam::CFBamClearTopDepBuff::TABLEID_INIT_VALUE;
		requiredName = new std::string( cfbam::CFBamClearTopDepBuff::NAME_INIT_VALUE );
	...
	cflib::ICFLibCloneableObj* CFBamClearTopDepHBuff::clone() {
		CFBamClearTopDepHBuff* copy = new CFBamClearTopDepHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamClearTopDepHBuff::getRequiredTableTenantId() const {
		return( requiredTableTenantId );
	}

	const int64_t* CFBamClearTopDepHBuff::getRequiredTableTenantIdReference() const {
		return( &requiredTableTenantId );
	}

	void CFBamClearTopDepHBuff::setRequiredTableTenantId( const int64_t value ) {
	...
	const int64_t CFBamClearTopDepHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamClearTopDepHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamClearTopDepHBuff::setRequiredTableId( const int64_t value ) {
	...
	const std::string& CFBamClearTopDepHBuff::getRequiredName() const {
		return( *requiredName );
	}

	const std::string* CFBamClearTopDepHBuff::getRequiredNameReference() const {
		return( requiredName );
	}

	void CFBamClearTopDepHBuff::setRequiredName( const std::string& value ) {
	...
	const int64_t CFBamClearTopDepHBuff::getOptionalPrevTenantIdValue() const {
		return( optionalPrevTenantId.getValue() );
	}

	const int64_t* CFBamClearTopDepHBuff::getOptionalPrevTenantIdReference() const {
		return( optionalPrevTenantId.getReference() );
	}

	const bool CFBamClearTopDepHBuff::isOptionalPrevTenantIdNull() const {
		return( optionalPrevTenantId.isNull() );
	}

	void CFBamClearTopDepHBuff::setOptionalPrevTenantIdNull() {
		optionalPrevTenantId.setNull();
	}

	void CFBamClearTopDepHBuff::setOptionalPrevTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamClearTopDepHBuff::getOptionalPrevIdValue() const {
		return( optionalPrevId.getValue() );
	}

	const int64_t* CFBamClearTopDepHBuff::getOptionalPrevIdReference() const {
		return( optionalPrevId.getReference() );
	}

	const bool CFBamClearTopDepHBuff::isOptionalPrevIdNull() const {
		return( optionalPrevId.isNull() );
	}

	void CFBamClearTopDepHBuff::setOptionalPrevIdNull() {
		optionalPrevId.setNull();
	}

	void CFBamClearTopDepHBuff::setOptionalPrevIdValue( const int64_t value ) {
	...
	const int64_t CFBamClearTopDepHBuff::getOptionalNextTenantIdValue() const {
		return( optionalNextTenantId.getValue() );
	}

	const int64_t* CFBamClearTopDepHBuff::getOptionalNextTenantIdReference() const {
		return( optionalNextTenantId.getReference() );
	}

	const bool CFBamClearTopDepHBuff::isOptionalNextTenantIdNull() const {
		return( optionalNextTenantId.isNull() );
	}

	void CFBamClearTopDepHBuff::setOptionalNextTenantIdNull() {
		optionalNextTenantId.setNull();
	}

	void CFBamClearTopDepHBuff::setOptionalNextTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamClearTopDepHBuff::getOptionalNextIdValue() const {
		return( optionalNextId.getValue() );
	}

	const int64_t* CFBamClearTopDepHBuff::getOptionalNextIdReference() const {
		return( optionalNextId.getReference() );
	}

	const bool CFBamClearTopDepHBuff::isOptionalNextIdNull() const {
		return( optionalNextId.isNull() );
	}

	void CFBamClearTopDepHBuff::setOptionalNextIdNull() {
		optionalNextId.setNull();
	}

	void CFBamClearTopDepHBuff::setOptionalNextIdValue( const int64_t value ) {
	...
	size_t CFBamClearTopDepHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamClearTopDepHBuff::hashCode();
	...
	CFBamClearTopDepHBuff CFBamClearTopDepHBuff::operator =( cfbam::CFBamClearTopDepBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredRelationId( src.getRequiredRelationId() );
	...
	CFBamClearTopDepHBuff CFBamClearTopDepHBuff::operator =( cfbam::CFBamClearTopDepHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredRelationId( src.getRequiredRelationId() );
	...
	bool CFBamClearTopDepHBuff::operator <( const CFBamClearTopDepByClrTopDepTblIdxKey& rhs ) {
	...
	bool CFBamClearTopDepHBuff::operator <( const CFBamClearTopDepByUNameIdxKey& rhs ) {
		if( getRequiredTableTenantId() > rhs.getRequiredTableTenantId() ) {
			return( false );
		}
		else if( getRequiredTableTenantId() < rhs.getRequiredTableTenantId() ) {
	...
	bool CFBamClearTopDepHBuff::operator <( const CFBamClearTopDepByPrevIdxKey& rhs ) {
		if( ! isOptionalPrevTenantIdNull() ) {
	...
	bool CFBamClearTopDepHBuff::operator <( const CFBamClearTopDepByNextIdxKey& rhs ) {
		if( ! isOptionalNextTenantIdNull() ) {
	...
	bool CFBamClearTopDepHBuff::operator <( const CFBamScopePKey& rhs ) {
	...
	bool CFBamClearTopDepHBuff::operator <( const CFBamScopeHPKey& rhs ) {
	...
	bool CFBamClearTopDepHBuff::operator <( const CFBamClearTopDepHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamClearTopDepHBuff::operator <( const CFBamClearTopDepBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamClearTopDepHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamClearTopDepHBuff" );
