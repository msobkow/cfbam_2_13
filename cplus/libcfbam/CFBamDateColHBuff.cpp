// Description: C++18 implementation of a DateCol history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamDateColHBuff::CLASS_NAME( "CFBamDateColHBuff" );
	CFBamDateColHBuff::CFBamDateColHBuff()
	: cfbam::CFBamDateDefHBuff() {
		requiredTableId = cfbam::CFBamDateColBuff::TABLEID_INIT_VALUE;
	}

	CFBamDateColHBuff::CFBamDateColHBuff( const CFBamDateColHBuff& src )
	: cfbam::CFBamDateDefHBuff() {
		requiredTableId = cfbam::CFBamDateColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamDateColHBuff::clone() {
		CFBamDateColHBuff* copy = new CFBamDateColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamDateColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamDateColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamDateColHBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamDateColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamDateColHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamDateColHBuff CFBamDateColHBuff::operator =( cfbam::CFBamDateColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamDateColHBuff CFBamDateColHBuff::operator =( cfbam::CFBamDateColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamDateColHBuff::operator <( const CFBamDateColByTableIdxKey& rhs ) {
	...
	bool CFBamDateColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamDateColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamDateColHBuff::operator <( const CFBamDateColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamDateColHBuff::operator <( const CFBamDateColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamDateColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamDateColHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamDateColHBuff& lhs, const cfbam::CFBamDateColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamDateColHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamDateColHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamDateColHBuff& lhs, const cfbam::CFBamDateColHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamDateColHBuff& lhs, const cfbam::CFBamDateColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
