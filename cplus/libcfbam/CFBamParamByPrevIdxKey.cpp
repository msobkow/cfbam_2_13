// Description: C++18 implementation for a Param by PrevIdx index key object.
...
namespace cfbam {
	const std::string CFBamParamByPrevIdxKey::CLASS_NAME( "CFBamParamByPrevIdxKey" );
	const std::string CFBamParamByPrevIdxKey::S_VALUE( "value" );
	const std::string CFBamParamByPrevIdxKey::S_VALUE_LENGTH( "value.length()" );


	CFBamParamByPrevIdxKey::CFBamParamByPrevIdxKey() {
		optionalPrevTenantId.setNull();
		optionalPrevId.setNull();
	}

	CFBamParamByPrevIdxKey::CFBamParamByPrevIdxKey( const CFBamParamByPrevIdxKey& src ) {
		optionalPrevTenantId.setNull();
		optionalPrevId.setNull();
	...
	const int64_t CFBamParamByPrevIdxKey::getOptionalPrevTenantIdValue() const {
		return( optionalPrevTenantId.getValue() );
	}

	const int64_t* CFBamParamByPrevIdxKey::getOptionalPrevTenantIdReference() const {
		return( optionalPrevTenantId.getReference() );
	}

	const bool CFBamParamByPrevIdxKey::isOptionalPrevTenantIdNull() const {
		return( optionalPrevTenantId.isNull() );
	}

	void CFBamParamByPrevIdxKey::setOptionalPrevTenantIdNull() {
		optionalPrevTenantId.setNull();
	}

	void CFBamParamByPrevIdxKey::setOptionalPrevTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamParamByPrevIdxKey::getOptionalPrevIdValue() const {
		return( optionalPrevId.getValue() );
	}

	const int64_t* CFBamParamByPrevIdxKey::getOptionalPrevIdReference() const {
		return( optionalPrevId.getReference() );
	}

	const bool CFBamParamByPrevIdxKey::isOptionalPrevIdNull() const {
		return( optionalPrevId.isNull() );
	}

	void CFBamParamByPrevIdxKey::setOptionalPrevIdNull() {
		optionalPrevId.setNull();
	}

	void CFBamParamByPrevIdxKey::setOptionalPrevIdValue( const int64_t value ) {
	...
	size_t CFBamParamByPrevIdxKey::hashCode() const {
		size_t hashCode = 0;
	...
	std::string CFBamParamByPrevIdxKey::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamParamByPrevIdxKey" );
	...
	bool CFBamParamByPrevIdxKey::operator <( const CFBamParamByPrevIdxKey& rhs ) {
		if( ! isOptionalPrevTenantIdNull() ) {
	...
	bool CFBamParamByPrevIdxKey::operator <( const CFBamParamHBuff& rhs ) {
		if( ! isOptionalPrevTenantIdNull() ) {
			if( rhs.isOptionalPrevTenantIdNull() ) {
				return( false );
			}
	...
	bool CFBamParamByPrevIdxKey::operator <( const CFBamParamBuff& rhs ) {
		if( ! isOptionalPrevTenantIdNull() ) {
			if( rhs.isOptionalPrevTenantIdNull() ) {
				return( false );
			}
	...
	CFBamParamByPrevIdxKey CFBamParamByPrevIdxKey::operator =( cfbam::CFBamParamByPrevIdxKey& src ) {
		if( src.isOptionalPrevTenantIdNull() ) {
			setOptionalPrevTenantIdNull();
		}
		else {
	...
	CFBamParamByPrevIdxKey CFBamParamByPrevIdxKey::operator =( cfbam::CFBamParamBuff& src ) {
		if( src.isOptionalPrevTenantIdNull() ) {
			setOptionalPrevTenantIdNull();
		}
		else {
	...
	CFBamParamByPrevIdxKey CFBamParamByPrevIdxKey::operator =( cfbam::CFBamParamHBuff& src ) {
		if( src.isOptionalPrevTenantIdNull() ) {
			setOptionalPrevTenantIdNull();
		}
		else {
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamParamByPrevIdxKey& lhs, const cfbam::CFBamParamByPrevIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamParamByPrevIdxKey& lhs, const cfbam::CFBamParamHBuff& rhs ) {
		if( ! lhs.isOptionalPrevTenantIdNull() ) {
			if( rhs.isOptionalPrevTenantIdNull() ) {
				return( false );
			}
	...
	bool operator <(const  cfbam::CFBamParamByPrevIdxKey& lhs, const cfbam::CFBamParamBuff& rhs ) {
		if( ! lhs.isOptionalPrevTenantIdNull() ) {
			if( rhs.isOptionalPrevTenantIdNull() ) {
				return( false );
			}
