// Description: C++18 implementation for a Int64Col buffer object.
...
namespace cfbam {
	...
	const std::string CFBamInt64ColBuff::GENDEFNAME( "Int64Col" );
	const classcode_t CFBamInt64ColBuff::CLASS_CODE = 0xa85eL;
	const std::string CFBamInt64ColBuff::CLASS_NAME( "CFBamInt64ColBuff" );
		const std::string CFBamInt64ColBuff::COLNAME_TABLEID( "TableId" );
	const int64_t CFBamInt64ColBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamInt64ColBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamInt64ColBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamInt64ColBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamInt64ColBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamInt64ColBuff::TABLEID_MIN_VALUE = 0LL;

	CFBamInt64ColBuff::CFBamInt64ColBuff()
	: CFBamInt64DefBuff()
	{
		requiredTableId = cfbam::CFBamInt64ColBuff::TABLEID_INIT_VALUE;
	}

	CFBamInt64ColBuff::CFBamInt64ColBuff( const CFBamInt64ColBuff& src )
	: CFBamInt64DefBuff()
	{
		requiredTableId = cfbam::CFBamInt64ColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamInt64ColBuff::clone() {
		CFBamInt64ColBuff* copy = new CFBamInt64ColBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamInt64ColBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamInt64ColBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamInt64ColBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFBamInt64ColBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamInt64ColBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamInt64ColBuff::setRequiredTableId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredTableId" );
		if( value < cfbam::CFBamInt64ColBuff::TABLEID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamInt64ColBuff::TABLEID_MIN_VALUE );
		}
		requiredTableId = value;
	}

	size_t CFBamInt64ColBuff::hashCode() const {
		size_t hashCode = CFBamInt64DefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamInt64ColBuff CFBamInt64ColBuff::operator =( cfbam::CFBamInt64ColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamInt64ColBuff CFBamInt64ColBuff::operator =( cfbam::CFBamInt64ColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamInt64ColBuff::operator <( const CFBamInt64ColByTableIdxKey& rhs ) {
	...
	bool CFBamInt64ColBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt64ColBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt64ColBuff::operator <( const CFBamInt64ColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt64ColBuff::operator <( const CFBamInt64ColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamInt64ColBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt64ColBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamInt64ColBuff& lhs, const cfbam::CFBamInt64ColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamInt64ColBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamInt64ColBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamInt64ColBuff& lhs, const cfbam::CFBamInt64ColHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamInt64ColBuff& lhs, const cfbam::CFBamInt64ColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
