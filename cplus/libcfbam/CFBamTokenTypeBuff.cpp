// Description: C++18 implementation for a TokenType buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTokenTypeBuff::GENDEFNAME( "TokenType" );
	const classcode_t CFBamTokenTypeBuff::CLASS_CODE = 0xa849L;
	const std::string CFBamTokenTypeBuff::CLASS_NAME( "CFBamTokenTypeBuff" );
		const std::string CFBamTokenTypeBuff::COLNAME_SCHEMADEFID( "SchemaDefId" );
	const int64_t CFBamTokenTypeBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamTokenTypeBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamTokenTypeBuff::SCHEMADEFID_INIT_VALUE = 0LL;
	const int64_t CFBamTokenTypeBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamTokenTypeBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamTokenTypeBuff::SCHEMADEFID_MIN_VALUE = 0LL;

	CFBamTokenTypeBuff::CFBamTokenTypeBuff()
	: CFBamTokenDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamTokenTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamTokenTypeBuff::CFBamTokenTypeBuff( const CFBamTokenTypeBuff& src )
	: CFBamTokenDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamTokenTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTokenTypeBuff::clone() {
		CFBamTokenTypeBuff* copy = new CFBamTokenTypeBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTokenTypeBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTokenTypeBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTokenTypeBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamTokenDefBuff::implementsClassCode( argClassCode ) );
		}
	}

	const int64_t CFBamTokenTypeBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamTokenTypeBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamTokenTypeBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamTokenTypeBuff::hashCode() const {
		size_t hashCode = CFBamTokenDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamTokenTypeBuff CFBamTokenTypeBuff::operator =( cfbam::CFBamTokenTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamTokenTypeBuff CFBamTokenTypeBuff::operator =( cfbam::CFBamTokenTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTokenTypeBuff::operator <( const CFBamTokenTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamTokenTypeBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTokenTypeBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTokenTypeBuff::operator <( const CFBamTokenTypeHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTokenTypeBuff::operator <( const CFBamTokenTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTokenTypeBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTokenTypeBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamTokenTypeBuff& lhs, const cfbam::CFBamTokenTypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTokenTypeBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTokenTypeBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTokenTypeBuff& lhs, const cfbam::CFBamTokenTypeHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTokenTypeBuff& lhs, const cfbam::CFBamTokenTypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
