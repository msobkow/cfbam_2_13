// Description: C++18 implementation for a NmTokensType buffer object.
...
namespace cfbam {
	...
	const std::string CFBamNmTokensTypeBuff::GENDEFNAME( "NmTokensType" );
	const classcode_t CFBamNmTokensTypeBuff::CLASS_CODE = 0xa82cL;
	const std::string CFBamNmTokensTypeBuff::CLASS_NAME( "CFBamNmTokensTypeBuff" );
		const std::string CFBamNmTokensTypeBuff::COLNAME_SCHEMADEFID( "SchemaDefId" );
	const int64_t CFBamNmTokensTypeBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamNmTokensTypeBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamNmTokensTypeBuff::SCHEMADEFID_INIT_VALUE = 0LL;
	const int64_t CFBamNmTokensTypeBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamNmTokensTypeBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamNmTokensTypeBuff::SCHEMADEFID_MIN_VALUE = 0LL;

	CFBamNmTokensTypeBuff::CFBamNmTokensTypeBuff()
	: CFBamNmTokensDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamNmTokensTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamNmTokensTypeBuff::CFBamNmTokensTypeBuff( const CFBamNmTokensTypeBuff& src )
	: CFBamNmTokensDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamNmTokensTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamNmTokensTypeBuff::clone() {
		CFBamNmTokensTypeBuff* copy = new CFBamNmTokensTypeBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamNmTokensTypeBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamNmTokensTypeBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamNmTokensTypeBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFBamNmTokensTypeBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamNmTokensTypeBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamNmTokensTypeBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamNmTokensTypeBuff::hashCode() const {
		size_t hashCode = CFBamNmTokensDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamNmTokensTypeBuff CFBamNmTokensTypeBuff::operator =( cfbam::CFBamNmTokensTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamNmTokensTypeBuff CFBamNmTokensTypeBuff::operator =( cfbam::CFBamNmTokensTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamNmTokensTypeBuff::operator <( const CFBamNmTokensTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamNmTokensTypeBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNmTokensTypeBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNmTokensTypeBuff::operator <( const CFBamNmTokensTypeHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNmTokensTypeBuff::operator <( const CFBamNmTokensTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamNmTokensTypeBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNmTokensTypeBuff" );
