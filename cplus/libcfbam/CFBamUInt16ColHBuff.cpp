// Description: C++18 implementation of a UInt16Col history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUInt16ColHBuff::CLASS_NAME( "CFBamUInt16ColHBuff" );
	CFBamUInt16ColHBuff::CFBamUInt16ColHBuff()
	: cfbam::CFBamUInt16DefHBuff() {
		requiredTableId = cfbam::CFBamUInt16ColBuff::TABLEID_INIT_VALUE;
	}

	CFBamUInt16ColHBuff::CFBamUInt16ColHBuff( const CFBamUInt16ColHBuff& src )
	: cfbam::CFBamUInt16DefHBuff() {
		requiredTableId = cfbam::CFBamUInt16ColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamUInt16ColHBuff::clone() {
		CFBamUInt16ColHBuff* copy = new CFBamUInt16ColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamUInt16ColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamUInt16ColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamUInt16ColHBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamUInt16ColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamUInt16ColHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamUInt16ColHBuff CFBamUInt16ColHBuff::operator =( cfbam::CFBamUInt16ColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamUInt16ColHBuff CFBamUInt16ColHBuff::operator =( cfbam::CFBamUInt16ColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUInt16ColHBuff::operator <( const CFBamUInt16ColByTableIdxKey& rhs ) {
	...
	bool CFBamUInt16ColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt16ColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamUInt16ColHBuff::operator <( const CFBamUInt16ColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamUInt16ColHBuff::operator <( const CFBamUInt16ColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUInt16ColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt16ColHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamUInt16ColHBuff& lhs, const cfbam::CFBamUInt16ColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamUInt16ColHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamUInt16ColHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamUInt16ColHBuff& lhs, const cfbam::CFBamUInt16ColHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamUInt16ColHBuff& lhs, const cfbam::CFBamUInt16ColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
