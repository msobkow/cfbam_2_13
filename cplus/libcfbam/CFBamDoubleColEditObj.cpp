// Description: C++18 edit object instance implementation for CFBam DoubleCol.
...
namespace cfbam {
	...
	const std::string CFBamDoubleColEditObj::CLASS_NAME( "CFBamDoubleColEditObj" );

	CFBamDoubleColEditObj::CFBamDoubleColEditObj( cfbam::ICFBamDoubleColObj* argOrig )
	: ICFBamDoubleColEditObj(),
	  CFBamDoubleDefEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamDoubleColEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamDoubleColEditObj::~CFBamDoubleColEditObj() {
	}

	const std::string& CFBamDoubleColEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamDoubleColEditObj::getClassCode() const {
		return( cfbam::CFBamDoubleColBuff::CLASS_CODE );
	}

	bool CFBamDoubleColEditObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamDoubleColBuff::CLASS_CODE ) {
			return( true );
		}
		else {
	...
	std::string CFBamDoubleColEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamDoubleColEditObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamDoubleColEditObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	const std::string CFBamDoubleColEditObj::getGenDefName() {
		return( cfbam::CFBamDoubleColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamDoubleColEditObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamDoubleColEditObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamDoubleColEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamDoubleColEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamDoubleColEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamDoubleColEditObj::getObjQualifiedName() {
	...
	std::string CFBamDoubleColEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamDoubleColEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamDoubleColObj* retobj = getSchema()->getDoubleColTableObj()->realizeDoubleCol( dynamic_cast<cfbam::ICFBamDoubleColObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamDoubleColEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamDoubleColEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamDoubleColEditObj::create() {
		cfbam::ICFBamDoubleColObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsDoubleCol()->getSchema() )->getDoubleColTableObj()->createDoubleCol( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamDoubleColEditObj::update() {
		getSchema()->getDoubleColTableObj()->updateDoubleCol( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamDoubleColEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getDoubleColTableObj()->deleteDoubleCol( this );
		return( NULL );
	}

	cfbam::ICFBamDoubleColTableObj* CFBamDoubleColEditObj::getDoubleColTable() {
		return( orig->getSchema()->getDoubleColTableObj() );
	}

	cfbam::ICFBamDoubleColEditObj* CFBamDoubleColEditObj::getDoubleColEdit() {
		return( (cfbam::ICFBamDoubleColEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamDoubleColEditObj::beginEdit() {
	...
	cfbam::ICFBamDoubleColObj* CFBamDoubleColEditObj::getOrigAsDoubleCol() {
		return( dynamic_cast<cfbam::ICFBamDoubleColObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamDoubleColEditObj::getBuff() {
		return( buff );
	}

	void CFBamDoubleColEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamDoubleDefEditObj::setBuff( value );
		}
	}

	const int64_t CFBamDoubleColEditObj::getRequiredTableId() {
		return( getDoubleColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamDoubleColEditObj::getRequiredTableIdReference() {
		return( getDoubleColBuff()->getRequiredTableIdReference() );
	}

	void CFBamDoubleColEditObj::setRequiredContainerScope( cfbam::ICFBamScopeObj* value ) {
		if( value == NULL ) {
	...
	cfbam::ICFBamTableObj* CFBamDoubleColEditObj::getRequiredContainerTable( bool forceRead ) {
		cfbam::ICFBamTableObj* retobj = NULL;
		bool anyMissing = false;
		if( ! anyMissing ) {
			retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsDoubleCol()->getSchema() )->getTableTableObj()->readTableByIdIdx( getPKey()->getRequiredTenantId(),
					getDoubleColBuff()->getRequiredTableId() );
		}
		return( retobj );
	}

	void CFBamDoubleColEditObj::setRequiredContainerTable( cfbam::ICFBamTableObj* value ) {
			
			if( value != NULL ) {
				getPKey()->setRequiredTenantId
( value->getRequiredTenantId() );
				getDoubleColEditBuff()->setRequiredTenantId( value->getRequiredTenantId() );
				getDoubleColEditBuff()->setRequiredTableId( value->getRequiredId() );
			}

			CFBamDoubleDefEditObj::setRequiredContainerScope( value );		}

	void CFBamDoubleColEditObj::copyBuffToOrig() {
		cfbam::CFBamDoubleColBuff* origBuff = getOrigAsDoubleCol()->getDoubleColEditBuff();
		cfbam::CFBamDoubleColBuff* myBuff = getDoubleColBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamDoubleColEditObj::copyOrigToBuff() {
		cfbam::CFBamDoubleColBuff* origBuff = getOrigAsDoubleCol()->getDoubleColBuff();
		cfbam::CFBamDoubleColBuff* myBuff = getDoubleColEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
