// Description: C++18 Instance Edit Object interface implementation for CFBam UInt64Type.
...
namespace cfbam {
	...
	const std::string ICFBamUInt64TypeEditObj::CLASS_NAME( "ICFBamUInt64TypeEditObj" );

	ICFBamUInt64TypeEditObj::ICFBamUInt64TypeEditObj()
