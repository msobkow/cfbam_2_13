// Description: C++18 implementation of a TokenDef history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTokenDefHBuff::CLASS_NAME( "CFBamTokenDefHBuff" );
	CFBamTokenDefHBuff::CFBamTokenDefHBuff()
	: cfbam::CFBamAtomHBuff() {
		requiredMaxLen = cfbam::CFBamTokenDefBuff::MAXLEN_INIT_VALUE;
		optionalInitValue = NULL;
	}

	CFBamTokenDefHBuff::CFBamTokenDefHBuff( const CFBamTokenDefHBuff& src )
	: cfbam::CFBamAtomHBuff() {
		requiredMaxLen = cfbam::CFBamTokenDefBuff::MAXLEN_INIT_VALUE;
		optionalInitValue = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamTokenDefHBuff::clone() {
		CFBamTokenDefHBuff* copy = new CFBamTokenDefHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int32_t CFBamTokenDefHBuff::getRequiredMaxLen() const {
		return( requiredMaxLen );
	}

	const int32_t* CFBamTokenDefHBuff::getRequiredMaxLenReference() const {
		return( &requiredMaxLen );
	}

	void CFBamTokenDefHBuff::setRequiredMaxLen( const int32_t value ) {
	...
	const std::string& CFBamTokenDefHBuff::getOptionalInitValueValue() const {
	...
	const std::string* CFBamTokenDefHBuff::getOptionalInitValueReference() const {
		return( optionalInitValue );
	}

	const bool CFBamTokenDefHBuff::isOptionalInitValueNull() const {
		return( optionalInitValue == NULL );
	}

	void CFBamTokenDefHBuff::setOptionalInitValueNull() {
		if( optionalInitValue != NULL ) {
			delete optionalInitValue;
			optionalInitValue = NULL;
		}
	...
	void CFBamTokenDefHBuff::setOptionalInitValueValue( const std::string& value ) {
	...
	size_t CFBamTokenDefHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamTokenDefHBuff::hashCode();
	...
	CFBamTokenDefHBuff CFBamTokenDefHBuff::operator =( cfbam::CFBamTokenDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamTokenDefHBuff CFBamTokenDefHBuff::operator =( cfbam::CFBamTokenDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTokenDefHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamTokenDefHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamTokenDefHBuff::operator <( const CFBamTokenDefHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamTokenDefHBuff::operator <( const CFBamTokenDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTokenDefHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTokenDefHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamTokenDefHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTokenDefHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTokenDefHBuff& lhs, const cfbam::CFBamTokenDefHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamTokenDefHBuff& lhs, const cfbam::CFBamTokenDefBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
