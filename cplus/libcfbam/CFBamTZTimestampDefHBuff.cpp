// Description: C++18 implementation of a TZTimestampDef history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTZTimestampDefHBuff::CLASS_NAME( "CFBamTZTimestampDefHBuff" );
	CFBamTZTimestampDefHBuff::CFBamTZTimestampDefHBuff()
	: cfbam::CFBamAtomHBuff() {
		optionalDummy = NULL;
	}

	CFBamTZTimestampDefHBuff::CFBamTZTimestampDefHBuff( const CFBamTZTimestampDefHBuff& src )
	: cfbam::CFBamAtomHBuff() {
		optionalDummy = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamTZTimestampDefHBuff::clone() {
		CFBamTZTimestampDefHBuff* copy = new CFBamTZTimestampDefHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTZTimestampDefHBuff::getOptionalDummyValue() const {
	...
	const std::string* CFBamTZTimestampDefHBuff::getOptionalDummyReference() const {
		return( optionalDummy );
	}

	const bool CFBamTZTimestampDefHBuff::isOptionalDummyNull() const {
		return( optionalDummy == NULL );
	}

	void CFBamTZTimestampDefHBuff::setOptionalDummyNull() {
		if( optionalDummy != NULL ) {
			delete optionalDummy;
			optionalDummy = NULL;
		}
	...
	void CFBamTZTimestampDefHBuff::setOptionalDummyValue( const std::string& value ) {
	...
	size_t CFBamTZTimestampDefHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamTZTimestampDefHBuff::hashCode();
	...
	CFBamTZTimestampDefHBuff CFBamTZTimestampDefHBuff::operator =( cfbam::CFBamTZTimestampDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamTZTimestampDefHBuff CFBamTZTimestampDefHBuff::operator =( cfbam::CFBamTZTimestampDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTZTimestampDefHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamTZTimestampDefHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamTZTimestampDefHBuff::operator <( const CFBamTZTimestampDefHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamTZTimestampDefHBuff::operator <( const CFBamTZTimestampDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTZTimestampDefHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZTimestampDefHBuff" );
