// Description: C++18 implementation for a TZTimestampType buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTZTimestampTypeBuff::GENDEFNAME( "TZTimestampType" );
	const classcode_t CFBamTZTimestampTypeBuff::CLASS_CODE = 0xa83fL;
	const std::string CFBamTZTimestampTypeBuff::CLASS_NAME( "CFBamTZTimestampTypeBuff" );
		const std::string CFBamTZTimestampTypeBuff::COLNAME_SCHEMADEFID( "SchemaDefId" );
	const int64_t CFBamTZTimestampTypeBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamTZTimestampTypeBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamTZTimestampTypeBuff::SCHEMADEFID_INIT_VALUE = 0LL;
	const int64_t CFBamTZTimestampTypeBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamTZTimestampTypeBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamTZTimestampTypeBuff::SCHEMADEFID_MIN_VALUE = 0LL;

	CFBamTZTimestampTypeBuff::CFBamTZTimestampTypeBuff()
	: CFBamTZTimestampDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamTZTimestampTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamTZTimestampTypeBuff::CFBamTZTimestampTypeBuff( const CFBamTZTimestampTypeBuff& src )
	: CFBamTZTimestampDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamTZTimestampTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTZTimestampTypeBuff::clone() {
		CFBamTZTimestampTypeBuff* copy = new CFBamTZTimestampTypeBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTZTimestampTypeBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTZTimestampTypeBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTZTimestampTypeBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamTZTimestampDefBuff::implementsClassCode( argClassCode ) );
		}
	}

	const int64_t CFBamTZTimestampTypeBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamTZTimestampTypeBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamTZTimestampTypeBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamTZTimestampTypeBuff::hashCode() const {
		size_t hashCode = CFBamTZTimestampDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamTZTimestampTypeBuff CFBamTZTimestampTypeBuff::operator =( cfbam::CFBamTZTimestampTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamTZTimestampTypeBuff CFBamTZTimestampTypeBuff::operator =( cfbam::CFBamTZTimestampTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTZTimestampTypeBuff::operator <( const CFBamTZTimestampTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamTZTimestampTypeBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZTimestampTypeBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZTimestampTypeBuff::operator <( const CFBamTZTimestampTypeHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZTimestampTypeBuff::operator <( const CFBamTZTimestampTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTZTimestampTypeBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZTimestampTypeBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamTZTimestampTypeBuff& lhs, const cfbam::CFBamTZTimestampTypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTZTimestampTypeBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTZTimestampTypeBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTZTimestampTypeBuff& lhs, const cfbam::CFBamTZTimestampTypeHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTZTimestampTypeBuff& lhs, const cfbam::CFBamTZTimestampTypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
