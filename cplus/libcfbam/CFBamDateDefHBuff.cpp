// Description: C++18 implementation of a DateDef history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamDateDefHBuff::CLASS_NAME( "CFBamDateDefHBuff" );
	CFBamDateDefHBuff::CFBamDateDefHBuff()
	: cfbam::CFBamAtomHBuff() {
		optionalDummy = NULL;
	}

	CFBamDateDefHBuff::CFBamDateDefHBuff( const CFBamDateDefHBuff& src )
	: cfbam::CFBamAtomHBuff() {
		optionalDummy = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamDateDefHBuff::clone() {
		CFBamDateDefHBuff* copy = new CFBamDateDefHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamDateDefHBuff::getOptionalDummyValue() const {
	...
	const std::string* CFBamDateDefHBuff::getOptionalDummyReference() const {
		return( optionalDummy );
	}

	const bool CFBamDateDefHBuff::isOptionalDummyNull() const {
		return( optionalDummy == NULL );
	}

	void CFBamDateDefHBuff::setOptionalDummyNull() {
		if( optionalDummy != NULL ) {
			delete optionalDummy;
			optionalDummy = NULL;
		}
	...
	void CFBamDateDefHBuff::setOptionalDummyValue( const std::string& value ) {
	...
	size_t CFBamDateDefHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamDateDefHBuff::hashCode();
	...
	CFBamDateDefHBuff CFBamDateDefHBuff::operator =( cfbam::CFBamDateDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamDateDefHBuff CFBamDateDefHBuff::operator =( cfbam::CFBamDateDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamDateDefHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamDateDefHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamDateDefHBuff::operator <( const CFBamDateDefHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamDateDefHBuff::operator <( const CFBamDateDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamDateDefHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamDateDefHBuff" );
