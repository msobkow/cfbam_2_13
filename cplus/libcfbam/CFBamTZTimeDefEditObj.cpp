// Description: C++18 edit object instance implementation for CFBam TZTimeDef.
...
namespace cfbam {
	...
	const std::string CFBamTZTimeDefEditObj::CLASS_NAME( "CFBamTZTimeDefEditObj" );

	CFBamTZTimeDefEditObj::CFBamTZTimeDefEditObj( cfbam::ICFBamTZTimeDefObj* argOrig )
	: ICFBamTZTimeDefEditObj(),
	  CFBamAtomEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamTZTimeDefEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamTZTimeDefEditObj::~CFBamTZTimeDefEditObj() {
	}

	const std::string& CFBamTZTimeDefEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTZTimeDefEditObj::getClassCode() const {
		return( cfbam::CFBamTZTimeDefBuff::CLASS_CODE );
	}

	bool CFBamTZTimeDefEditObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamTZTimeDefBuff::CLASS_CODE ) {
			return( true );
		}
		else {
	...
	std::string CFBamTZTimeDefEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZTimeDefEditObj" );
	...
	const std::string CFBamTZTimeDefEditObj::getGenDefName() {
		return( cfbam::CFBamTZTimeDefBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTZTimeDefEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTZTimeDefEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTZTimeDefEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTZTimeDefEditObj::getObjQualifiedName() {
	...
	std::string CFBamTZTimeDefEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTZTimeDefEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamTZTimeDefObj* retobj = getSchema()->getTZTimeDefTableObj()->realizeTZTimeDef( dynamic_cast<cfbam::ICFBamTZTimeDefObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamTZTimeDefEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamTZTimeDefEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamTZTimeDefEditObj::create() {
		cfbam::ICFBamTZTimeDefObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsTZTimeDef()->getSchema() )->getTZTimeDefTableObj()->createTZTimeDef( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamTZTimeDefEditObj::update() {
		getSchema()->getTZTimeDefTableObj()->updateTZTimeDef( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamTZTimeDefEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getTZTimeDefTableObj()->deleteTZTimeDef( this );
		return( NULL );
	}

	cfbam::ICFBamTZTimeDefTableObj* CFBamTZTimeDefEditObj::getTZTimeDefTable() {
		return( orig->getSchema()->getTZTimeDefTableObj() );
	}

	cfbam::ICFBamTZTimeDefEditObj* CFBamTZTimeDefEditObj::getTZTimeDefEdit() {
		return( (cfbam::ICFBamTZTimeDefEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamTZTimeDefEditObj::beginEdit() {
	...
	cfbam::ICFBamTZTimeDefObj* CFBamTZTimeDefEditObj::getOrigAsTZTimeDef() {
		return( dynamic_cast<cfbam::ICFBamTZTimeDefObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamTZTimeDefEditObj::getBuff() {
		return( buff );
	}

	void CFBamTZTimeDefEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamAtomEditObj::setBuff( value );
		}
	}

	bool CFBamTZTimeDefEditObj::isOptionalDummyNull() {
		return( getTZTimeDefBuff()->isOptionalDummyNull() );
	}

	const std::string& CFBamTZTimeDefEditObj::getOptionalDummyValue() {
		return( getTZTimeDefBuff()->getOptionalDummyValue() );
	}

	const std::string* CFBamTZTimeDefEditObj::getOptionalDummyReference() {
		return( getTZTimeDefBuff()->getOptionalDummyReference() );
	}

	void CFBamTZTimeDefEditObj::setOptionalDummyNull() {
		if( ! getTZTimeDefBuff()->isOptionalDummyNull() ) {
			getTZTimeDefEditBuff()->setOptionalDummyNull();
		}
	}

	void CFBamTZTimeDefEditObj::setOptionalDummyValue( const std::string& value ) {
		if( getTZTimeDefBuff()->isOptionalDummyNull() ) {
			getTZTimeDefEditBuff()->setOptionalDummyValue( value );
		}
		else if( getTZTimeDefBuff()->getOptionalDummyValue() != value ) {
			getTZTimeDefEditBuff()->setOptionalDummyValue( value );
		}
	}

	void CFBamTZTimeDefEditObj::copyBuffToOrig() {
		cfbam::CFBamTZTimeDefBuff* origBuff = getOrigAsTZTimeDef()->getTZTimeDefEditBuff();
		cfbam::CFBamTZTimeDefBuff* myBuff = getTZTimeDefBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamTZTimeDefEditObj::copyOrigToBuff() {
		cfbam::CFBamTZTimeDefBuff* origBuff = getOrigAsTZTimeDef()->getTZTimeDefBuff();
		cfbam::CFBamTZTimeDefBuff* myBuff = getTZTimeDefEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
