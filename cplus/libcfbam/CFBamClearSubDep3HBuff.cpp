// Description: C++18 implementation of a ClearSubDep3 history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamClearSubDep3HBuff::CLASS_NAME( "CFBamClearSubDep3HBuff" );
	CFBamClearSubDep3HBuff::CFBamClearSubDep3HBuff()
	...
	CFBamClearSubDep3HBuff::CFBamClearSubDep3HBuff( const CFBamClearSubDep3HBuff& src )
	: cfbam::CFBamClearDepHBuff() {
		requiredClearSubDep2TenantId = cfbam::CFBamClearSubDep3Buff::CLEARSUBDEP2TENANTID_INIT_VALUE;
		requiredClearSubDep2Id = cfbam::CFBamClearSubDep3Buff::CLEARSUBDEP2ID_INIT_VALUE;
		requiredName = new std::string( cfbam::CFBamClearSubDep3Buff::NAME_INIT_VALUE );
	...
	cflib::ICFLibCloneableObj* CFBamClearSubDep3HBuff::clone() {
		CFBamClearSubDep3HBuff* copy = new CFBamClearSubDep3HBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamClearSubDep3HBuff::getRequiredClearSubDep2TenantId() const {
		return( requiredClearSubDep2TenantId );
	}

	const int64_t* CFBamClearSubDep3HBuff::getRequiredClearSubDep2TenantIdReference() const {
		return( &requiredClearSubDep2TenantId );
	}

	void CFBamClearSubDep3HBuff::setRequiredClearSubDep2TenantId( const int64_t value ) {
	...
	const int64_t CFBamClearSubDep3HBuff::getRequiredClearSubDep2Id() const {
		return( requiredClearSubDep2Id );
	}

	const int64_t* CFBamClearSubDep3HBuff::getRequiredClearSubDep2IdReference() const {
		return( &requiredClearSubDep2Id );
	}

	void CFBamClearSubDep3HBuff::setRequiredClearSubDep2Id( const int64_t value ) {
	...
	const std::string& CFBamClearSubDep3HBuff::getRequiredName() const {
		return( *requiredName );
	}

	const std::string* CFBamClearSubDep3HBuff::getRequiredNameReference() const {
		return( requiredName );
	}

	void CFBamClearSubDep3HBuff::setRequiredName( const std::string& value ) {
	...
	size_t CFBamClearSubDep3HBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamClearSubDep3HBuff::hashCode();
	...
	CFBamClearSubDep3HBuff CFBamClearSubDep3HBuff::operator =( cfbam::CFBamClearSubDep3Buff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredRelationId( src.getRequiredRelationId() );
	...
	CFBamClearSubDep3HBuff CFBamClearSubDep3HBuff::operator =( cfbam::CFBamClearSubDep3HBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredRelationId( src.getRequiredRelationId() );
	...
	bool CFBamClearSubDep3HBuff::operator <( const CFBamClearSubDep3ByClearSubDep2IdxKey& rhs ) {
	...
	bool CFBamClearSubDep3HBuff::operator <( const CFBamClearSubDep3ByUNameIdxKey& rhs ) {
		if( getRequiredClearSubDep2TenantId() > rhs.getRequiredClearSubDep2TenantId() ) {
			return( false );
		}
		else if( getRequiredClearSubDep2TenantId() < rhs.getRequiredClearSubDep2TenantId() ) {
	...
	bool CFBamClearSubDep3HBuff::operator <( const CFBamScopePKey& rhs ) {
	...
	bool CFBamClearSubDep3HBuff::operator <( const CFBamScopeHPKey& rhs ) {
	...
	bool CFBamClearSubDep3HBuff::operator <( const CFBamClearSubDep3HBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamClearSubDep3HBuff::operator <( const CFBamClearSubDep3Buff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamClearSubDep3HBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamClearSubDep3HBuff" );
