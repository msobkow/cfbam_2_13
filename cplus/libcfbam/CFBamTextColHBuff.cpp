// Description: C++18 implementation of a TextCol history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTextColHBuff::CLASS_NAME( "CFBamTextColHBuff" );
	CFBamTextColHBuff::CFBamTextColHBuff()
	: cfbam::CFBamTextDefHBuff() {
		requiredTableId = cfbam::CFBamTextColBuff::TABLEID_INIT_VALUE;
	}

	CFBamTextColHBuff::CFBamTextColHBuff( const CFBamTextColHBuff& src )
	: cfbam::CFBamTextDefHBuff() {
		requiredTableId = cfbam::CFBamTextColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTextColHBuff::clone() {
		CFBamTextColHBuff* copy = new CFBamTextColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamTextColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamTextColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamTextColHBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamTextColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamTextColHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamTextColHBuff CFBamTextColHBuff::operator =( cfbam::CFBamTextColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamTextColHBuff CFBamTextColHBuff::operator =( cfbam::CFBamTextColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTextColHBuff::operator <( const CFBamTextColByTableIdxKey& rhs ) {
	...
	bool CFBamTextColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTextColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamTextColHBuff::operator <( const CFBamTextColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamTextColHBuff::operator <( const CFBamTextColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTextColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTextColHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamTextColHBuff& lhs, const cfbam::CFBamTextColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTextColHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTextColHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTextColHBuff& lhs, const cfbam::CFBamTextColHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamTextColHBuff& lhs, const cfbam::CFBamTextColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
