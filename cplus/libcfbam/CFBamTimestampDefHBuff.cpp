// Description: C++18 implementation of a TimestampDef history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTimestampDefHBuff::CLASS_NAME( "CFBamTimestampDefHBuff" );
	CFBamTimestampDefHBuff::CFBamTimestampDefHBuff()
	: cfbam::CFBamAtomHBuff() {
		optionalDummy = NULL;
	}

	CFBamTimestampDefHBuff::CFBamTimestampDefHBuff( const CFBamTimestampDefHBuff& src )
	: cfbam::CFBamAtomHBuff() {
		optionalDummy = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamTimestampDefHBuff::clone() {
		CFBamTimestampDefHBuff* copy = new CFBamTimestampDefHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTimestampDefHBuff::getOptionalDummyValue() const {
	...
	const std::string* CFBamTimestampDefHBuff::getOptionalDummyReference() const {
		return( optionalDummy );
	}

	const bool CFBamTimestampDefHBuff::isOptionalDummyNull() const {
		return( optionalDummy == NULL );
	}

	void CFBamTimestampDefHBuff::setOptionalDummyNull() {
		if( optionalDummy != NULL ) {
			delete optionalDummy;
			optionalDummy = NULL;
		}
	...
	void CFBamTimestampDefHBuff::setOptionalDummyValue( const std::string& value ) {
	...
	size_t CFBamTimestampDefHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamTimestampDefHBuff::hashCode();
	...
	CFBamTimestampDefHBuff CFBamTimestampDefHBuff::operator =( cfbam::CFBamTimestampDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamTimestampDefHBuff CFBamTimestampDefHBuff::operator =( cfbam::CFBamTimestampDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTimestampDefHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamTimestampDefHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamTimestampDefHBuff::operator <( const CFBamTimestampDefHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamTimestampDefHBuff::operator <( const CFBamTimestampDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTimestampDefHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTimestampDefHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamTimestampDefHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTimestampDefHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTimestampDefHBuff& lhs, const cfbam::CFBamTimestampDefHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamTimestampDefHBuff& lhs, const cfbam::CFBamTimestampDefBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
