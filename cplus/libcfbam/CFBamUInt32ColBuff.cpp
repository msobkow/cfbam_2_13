// Description: C++18 implementation for a UInt32Col buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUInt32ColBuff::GENDEFNAME( "UInt32Col" );
	const classcode_t CFBamUInt32ColBuff::CLASS_CODE = 0xa86bL;
	const std::string CFBamUInt32ColBuff::CLASS_NAME( "CFBamUInt32ColBuff" );
		const std::string CFBamUInt32ColBuff::COLNAME_TABLEID( "TableId" );
	const int64_t CFBamUInt32ColBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamUInt32ColBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamUInt32ColBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamUInt32ColBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamUInt32ColBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamUInt32ColBuff::TABLEID_MIN_VALUE = 0LL;

	CFBamUInt32ColBuff::CFBamUInt32ColBuff()
	: CFBamUInt32DefBuff()
	{
		requiredTableId = cfbam::CFBamUInt32ColBuff::TABLEID_INIT_VALUE;
	}

	CFBamUInt32ColBuff::CFBamUInt32ColBuff( const CFBamUInt32ColBuff& src )
	: CFBamUInt32DefBuff()
	{
		requiredTableId = cfbam::CFBamUInt32ColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamUInt32ColBuff::clone() {
		CFBamUInt32ColBuff* copy = new CFBamUInt32ColBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamUInt32ColBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUInt32ColBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamUInt32ColBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFBamUInt32ColBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamUInt32ColBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamUInt32ColBuff::setRequiredTableId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredTableId" );
		if( value < cfbam::CFBamUInt32ColBuff::TABLEID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamUInt32ColBuff::TABLEID_MIN_VALUE );
		}
		requiredTableId = value;
	}

	size_t CFBamUInt32ColBuff::hashCode() const {
		size_t hashCode = CFBamUInt32DefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamUInt32ColBuff CFBamUInt32ColBuff::operator =( cfbam::CFBamUInt32ColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamUInt32ColBuff CFBamUInt32ColBuff::operator =( cfbam::CFBamUInt32ColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUInt32ColBuff::operator <( const CFBamUInt32ColByTableIdxKey& rhs ) {
	...
	bool CFBamUInt32ColBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt32ColBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt32ColBuff::operator <( const CFBamUInt32ColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt32ColBuff::operator <( const CFBamUInt32ColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUInt32ColBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt32ColBuff" );
