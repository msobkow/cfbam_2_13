// Description: C++18 base object instance implementation for CFBam UInt32Col.
...
namespace cfbam {
	...
	const std::string CFBamUInt32ColObj::CLASS_NAME( "CFBamUInt32ColObj" );
	const classcode_t CFBamUInt32ColObj::CLASS_CODE = 0xa86bL;

	const int64_t CFBamUInt32ColObj::getRequiredTableId() {
		return( getUInt32ColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamUInt32ColObj::getRequiredTableIdReference() {
		return( getUInt32ColBuff()->getRequiredTableIdReference() );
	}


	cfbam::ICFBamTableObj* CFBamUInt32ColObj::getRequiredContainerTable( bool forceRead ) {
	...
	CFBamUInt32ColObj::CFBamUInt32ColObj()
	: ICFBamUInt32ColObj(),
	  CFBamUInt32DefObj()
	{
	}

	CFBamUInt32ColObj::CFBamUInt32ColObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamUInt32ColObj(),
	...
	cfbam::CFBamValueBuff* CFBamUInt32ColObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamUInt32ColBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableUInt32Col()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamUInt32ColObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamUInt32ColObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUInt32ColObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamUInt32ColObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamUInt32ColObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt32ColObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamUInt32ColObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamUInt32ColObj::getObjName() {
	...
	const std::string CFBamUInt32ColObj::getGenDefName() {
		return( cfbam::CFBamUInt32ColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamUInt32ColObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamUInt32ColObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamUInt32ColObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamUInt32ColObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamUInt32ColObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamUInt32ColObj::getObjQualifiedName() {
	...
	std::string CFBamUInt32ColObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamUInt32ColObj::realize() {
		cfbam::ICFBamUInt32ColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt32ColTableObj()->realizeUInt32Col(
			(cfbam::ICFBamUInt32ColObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUInt32ColObj::read( bool forceRead ) {
		cfbam::ICFBamUInt32ColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt32ColTableObj()->readUInt32ColByIdIdx( getUInt32ColBuff()->getRequiredTenantId(),
		getUInt32ColBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUInt32ColObj::moveUp() {
		cfbam::ICFBamUInt32ColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt32ColTableObj()->moveUpUInt32Col( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUInt32ColObj::moveDown() {
		cfbam::ICFBamUInt32ColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt32ColTableObj()->moveDownUInt32Col( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamUInt32ColObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamUInt32ColObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt32ColTableObj()->lockUInt32Col( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt32ColTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamUInt32ColEditObj* CFBamUInt32ColObj::getUInt32ColEdit() {
		return( dynamic_cast<cfbam::ICFBamUInt32ColEditObj*>( edit ) );
	}
