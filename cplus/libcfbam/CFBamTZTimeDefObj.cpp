// Description: C++18 base object instance implementation for CFBam TZTimeDef.
...
namespace cfbam {
	...
	const std::string CFBamTZTimeDefObj::CLASS_NAME( "CFBamTZTimeDefObj" );
	const classcode_t CFBamTZTimeDefObj::CLASS_CODE = 0xa83cL;

	bool CFBamTZTimeDefObj::isOptionalDummyNull() {
		return( getTZTimeDefBuff()->isOptionalDummyNull() );
	}

	const std::string& CFBamTZTimeDefObj::getOptionalDummyValue() {
		return( getTZTimeDefBuff()->getOptionalDummyValue() );
	}

	const std::string* CFBamTZTimeDefObj::getOptionalDummyReference() {
		return( getTZTimeDefBuff()->getOptionalDummyReference() );
	}


	CFBamTZTimeDefObj::CFBamTZTimeDefObj()
	: ICFBamTZTimeDefObj(),
	  CFBamAtomObj()
	{
	}

	CFBamTZTimeDefObj::CFBamTZTimeDefObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamTZTimeDefObj(),
	...
	cfbam::CFBamValueBuff* CFBamTZTimeDefObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamTZTimeDefBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableTZTimeDef()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamTZTimeDefObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamTZTimeDefObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTZTimeDefObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTZTimeDefObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamTZTimeDefObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZTimeDefObj" );
	...
	std::string CFBamTZTimeDefObj::getObjName() {
	...
	const std::string CFBamTZTimeDefObj::getGenDefName() {
		return( cfbam::CFBamTZTimeDefBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTZTimeDefObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTZTimeDefObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTZTimeDefObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTZTimeDefObj::getObjQualifiedName() {
	...
	std::string CFBamTZTimeDefObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTZTimeDefObj::realize() {
		cfbam::ICFBamTZTimeDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimeDefTableObj()->realizeTZTimeDef(
			(cfbam::ICFBamTZTimeDefObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTZTimeDefObj::read( bool forceRead ) {
		cfbam::ICFBamTZTimeDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimeDefTableObj()->readTZTimeDefByIdIdx( getTZTimeDefBuff()->getRequiredTenantId(),
		getTZTimeDefBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTZTimeDefObj::moveUp() {
		cfbam::ICFBamTZTimeDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimeDefTableObj()->moveUpTZTimeDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTZTimeDefObj::moveDown() {
		cfbam::ICFBamTZTimeDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimeDefTableObj()->moveDownTZTimeDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamTZTimeDefObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamTZTimeDefObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimeDefTableObj()->lockTZTimeDef( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimeDefTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamTZTimeDefEditObj* CFBamTZTimeDefObj::getTZTimeDefEdit() {
		return( dynamic_cast<cfbam::ICFBamTZTimeDefEditObj*>( edit ) );
	}
