// Description: C++18 implementation for a FloatCol buffer object.
...
namespace cfbam {
	...
	const std::string CFBamFloatColBuff::GENDEFNAME( "FloatCol" );
	const classcode_t CFBamFloatColBuff::CLASS_CODE = 0xa858L;
	const std::string CFBamFloatColBuff::CLASS_NAME( "CFBamFloatColBuff" );
		const std::string CFBamFloatColBuff::COLNAME_TABLEID( "TableId" );
	const int64_t CFBamFloatColBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamFloatColBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamFloatColBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamFloatColBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamFloatColBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamFloatColBuff::TABLEID_MIN_VALUE = 0LL;

	CFBamFloatColBuff::CFBamFloatColBuff()
	: CFBamFloatDefBuff()
	{
		requiredTableId = cfbam::CFBamFloatColBuff::TABLEID_INIT_VALUE;
	}

	CFBamFloatColBuff::CFBamFloatColBuff( const CFBamFloatColBuff& src )
	: CFBamFloatDefBuff()
	{
		requiredTableId = cfbam::CFBamFloatColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamFloatColBuff::clone() {
		CFBamFloatColBuff* copy = new CFBamFloatColBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamFloatColBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamFloatColBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamFloatColBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFBamFloatColBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamFloatColBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamFloatColBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamFloatColBuff::hashCode() const {
		size_t hashCode = CFBamFloatDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamFloatColBuff CFBamFloatColBuff::operator =( cfbam::CFBamFloatColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamFloatColBuff CFBamFloatColBuff::operator =( cfbam::CFBamFloatColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamFloatColBuff::operator <( const CFBamFloatColByTableIdxKey& rhs ) {
	...
	bool CFBamFloatColBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamFloatColBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamFloatColBuff::operator <( const CFBamFloatColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamFloatColBuff::operator <( const CFBamFloatColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamFloatColBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamFloatColBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamFloatColBuff& lhs, const cfbam::CFBamFloatColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamFloatColBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamFloatColBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamFloatColBuff& lhs, const cfbam::CFBamFloatColHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamFloatColBuff& lhs, const cfbam::CFBamFloatColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
