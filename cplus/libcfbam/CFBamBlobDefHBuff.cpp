// Description: C++18 implementation of a BlobDef history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamBlobDefHBuff::CLASS_NAME( "CFBamBlobDefHBuff" );
	CFBamBlobDefHBuff::CFBamBlobDefHBuff()
	: cfbam::CFBamAtomHBuff() {
		requiredMaxLen = cfbam::CFBamBlobDefBuff::MAXLEN_INIT_VALUE;
		optionalInitValue = NULL;
	}

	CFBamBlobDefHBuff::CFBamBlobDefHBuff( const CFBamBlobDefHBuff& src )
	: cfbam::CFBamAtomHBuff() {
		requiredMaxLen = cfbam::CFBamBlobDefBuff::MAXLEN_INIT_VALUE;
		optionalInitValue = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamBlobDefHBuff::clone() {
		CFBamBlobDefHBuff* copy = new CFBamBlobDefHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int32_t CFBamBlobDefHBuff::getRequiredMaxLen() const {
		return( requiredMaxLen );
	}

	const int32_t* CFBamBlobDefHBuff::getRequiredMaxLenReference() const {
		return( &requiredMaxLen );
	}

	void CFBamBlobDefHBuff::setRequiredMaxLen( const int32_t value ) {
	...
	const std::vector<cflib::BYTE>& CFBamBlobDefHBuff::getOptionalInitValueValue() const {
	...
	const std::vector<cflib::BYTE>* CFBamBlobDefHBuff::getOptionalInitValueReference() const {
		static const std::string S_ProcName( "getOptionalInitValueValue" );
		return( optionalInitValue );
	}

	const bool CFBamBlobDefHBuff::isOptionalInitValueNull() const {
		return( optionalInitValue == NULL );
	}

	void CFBamBlobDefHBuff::setOptionalInitValueNull() {
		if( optionalInitValue != NULL ) {
			delete optionalInitValue;
			optionalInitValue = NULL;
		}
	...
	void CFBamBlobDefHBuff::setOptionalInitValueValue( const std::vector<cflib::BYTE>& value ) {
	...
	size_t CFBamBlobDefHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamBlobDefHBuff::hashCode();
		hashCode = hashCode + getRequiredMaxLen();
		hashCode = hashCode + cflib::CFLib::hash( getOptionalInitValueValue() );
		return( hashCode );
	}

	CFBamBlobDefHBuff CFBamBlobDefHBuff::operator =( cfbam::CFBamBlobDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamBlobDefHBuff CFBamBlobDefHBuff::operator =( cfbam::CFBamBlobDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamBlobDefHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamBlobDefHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamBlobDefHBuff::operator <( const CFBamBlobDefHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamBlobDefHBuff::operator <( const CFBamBlobDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamBlobDefHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamBlobDefHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamBlobDefHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamBlobDefHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamBlobDefHBuff& lhs, const cfbam::CFBamBlobDefHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamBlobDefHBuff& lhs, const cfbam::CFBamBlobDefBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
