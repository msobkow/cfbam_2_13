// Description: C++18 implementation of a UInt16Type history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUInt16TypeHBuff::CLASS_NAME( "CFBamUInt16TypeHBuff" );
	CFBamUInt16TypeHBuff::CFBamUInt16TypeHBuff()
	: cfbam::CFBamUInt16DefHBuff() {
		requiredSchemaDefId = cfbam::CFBamUInt16TypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamUInt16TypeHBuff::CFBamUInt16TypeHBuff( const CFBamUInt16TypeHBuff& src )
	: cfbam::CFBamUInt16DefHBuff() {
		requiredSchemaDefId = cfbam::CFBamUInt16TypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamUInt16TypeHBuff::clone() {
		CFBamUInt16TypeHBuff* copy = new CFBamUInt16TypeHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamUInt16TypeHBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamUInt16TypeHBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamUInt16TypeHBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamUInt16TypeHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamUInt16TypeHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamUInt16TypeHBuff CFBamUInt16TypeHBuff::operator =( cfbam::CFBamUInt16TypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamUInt16TypeHBuff CFBamUInt16TypeHBuff::operator =( cfbam::CFBamUInt16TypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUInt16TypeHBuff::operator <( const CFBamUInt16TypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamUInt16TypeHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt16TypeHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamUInt16TypeHBuff::operator <( const CFBamUInt16TypeHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamUInt16TypeHBuff::operator <( const CFBamUInt16TypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUInt16TypeHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt16TypeHBuff" );
