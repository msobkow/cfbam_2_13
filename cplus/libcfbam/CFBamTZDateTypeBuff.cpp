// Description: C++18 implementation for a TZDateType buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTZDateTypeBuff::GENDEFNAME( "TZDateType" );
	const classcode_t CFBamTZDateTypeBuff::CLASS_CODE = 0xa83bL;
	const std::string CFBamTZDateTypeBuff::CLASS_NAME( "CFBamTZDateTypeBuff" );
		const std::string CFBamTZDateTypeBuff::COLNAME_SCHEMADEFID( "SchemaDefId" );
	const int64_t CFBamTZDateTypeBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamTZDateTypeBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamTZDateTypeBuff::SCHEMADEFID_INIT_VALUE = 0LL;
	const int64_t CFBamTZDateTypeBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamTZDateTypeBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamTZDateTypeBuff::SCHEMADEFID_MIN_VALUE = 0LL;

	CFBamTZDateTypeBuff::CFBamTZDateTypeBuff()
	: CFBamTZDateDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamTZDateTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamTZDateTypeBuff::CFBamTZDateTypeBuff( const CFBamTZDateTypeBuff& src )
	: CFBamTZDateDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamTZDateTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTZDateTypeBuff::clone() {
		CFBamTZDateTypeBuff* copy = new CFBamTZDateTypeBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTZDateTypeBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTZDateTypeBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTZDateTypeBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamTZDateDefBuff::implementsClassCode( argClassCode ) );
		}
	}

	const int64_t CFBamTZDateTypeBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamTZDateTypeBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamTZDateTypeBuff::setRequiredSchemaDefId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredSchemaDefId" );
		if( value < cfbam::CFBamTZDateTypeBuff::SCHEMADEFID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamTZDateTypeBuff::SCHEMADEFID_MIN_VALUE );
		}
		requiredSchemaDefId = value;
	}

	size_t CFBamTZDateTypeBuff::hashCode() const {
		size_t hashCode = CFBamTZDateDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamTZDateTypeBuff CFBamTZDateTypeBuff::operator =( cfbam::CFBamTZDateTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamTZDateTypeBuff CFBamTZDateTypeBuff::operator =( cfbam::CFBamTZDateTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTZDateTypeBuff::operator <( const CFBamTZDateTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamTZDateTypeBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZDateTypeBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZDateTypeBuff::operator <( const CFBamTZDateTypeHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZDateTypeBuff::operator <( const CFBamTZDateTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTZDateTypeBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZDateTypeBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamTZDateTypeBuff& lhs, const cfbam::CFBamTZDateTypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTZDateTypeBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTZDateTypeBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTZDateTypeBuff& lhs, const cfbam::CFBamTZDateTypeHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTZDateTypeBuff& lhs, const cfbam::CFBamTZDateTypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
