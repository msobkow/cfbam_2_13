// Description: C++18 implementation of a DelSubDep2 history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamDelSubDep2HBuff::CLASS_NAME( "CFBamDelSubDep2HBuff" );
	CFBamDelSubDep2HBuff::CFBamDelSubDep2HBuff()
	...
	CFBamDelSubDep2HBuff::CFBamDelSubDep2HBuff( const CFBamDelSubDep2HBuff& src )
	: cfbam::CFBamDelDepHBuff() {
		requiredDelSubDep1TenantId = cfbam::CFBamDelSubDep2Buff::DELSUBDEP1TENANTID_INIT_VALUE;
		requiredDelSubDep1Id = cfbam::CFBamDelSubDep2Buff::DELSUBDEP1ID_INIT_VALUE;
		requiredName = new std::string( cfbam::CFBamDelSubDep2Buff::NAME_INIT_VALUE );
	...
	cflib::ICFLibCloneableObj* CFBamDelSubDep2HBuff::clone() {
		CFBamDelSubDep2HBuff* copy = new CFBamDelSubDep2HBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamDelSubDep2HBuff::getRequiredDelSubDep1TenantId() const {
		return( requiredDelSubDep1TenantId );
	}

	const int64_t* CFBamDelSubDep2HBuff::getRequiredDelSubDep1TenantIdReference() const {
		return( &requiredDelSubDep1TenantId );
	}

	void CFBamDelSubDep2HBuff::setRequiredDelSubDep1TenantId( const int64_t value ) {
	...
	const int64_t CFBamDelSubDep2HBuff::getRequiredDelSubDep1Id() const {
		return( requiredDelSubDep1Id );
	}

	const int64_t* CFBamDelSubDep2HBuff::getRequiredDelSubDep1IdReference() const {
		return( &requiredDelSubDep1Id );
	}

	void CFBamDelSubDep2HBuff::setRequiredDelSubDep1Id( const int64_t value ) {
	...
	const std::string& CFBamDelSubDep2HBuff::getRequiredName() const {
		return( *requiredName );
	}

	const std::string* CFBamDelSubDep2HBuff::getRequiredNameReference() const {
		return( requiredName );
	}

	void CFBamDelSubDep2HBuff::setRequiredName( const std::string& value ) {
	...
	size_t CFBamDelSubDep2HBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamDelSubDep2HBuff::hashCode();
	...
	CFBamDelSubDep2HBuff CFBamDelSubDep2HBuff::operator =( cfbam::CFBamDelSubDep2Buff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		if( src.isOptionalDefSchemaTenantIdNull() ) {
	...
	CFBamDelSubDep2HBuff CFBamDelSubDep2HBuff::operator =( cfbam::CFBamDelSubDep2HBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		if( src.isOptionalDefSchemaTenantIdNull() ) {
	...
	bool CFBamDelSubDep2HBuff::operator <( const CFBamDelSubDep2ByContDelDep1IdxKey& rhs ) {
	...
	bool CFBamDelSubDep2HBuff::operator <( const CFBamDelSubDep2ByUNameIdxKey& rhs ) {
		if( getRequiredDelSubDep1TenantId() > rhs.getRequiredDelSubDep1TenantId() ) {
			return( false );
		}
		else if( getRequiredDelSubDep1TenantId() < rhs.getRequiredDelSubDep1TenantId() ) {
	...
	bool CFBamDelSubDep2HBuff::operator <( const CFBamScopePKey& rhs ) {
	...
	bool CFBamDelSubDep2HBuff::operator <( const CFBamScopeHPKey& rhs ) {
	...
	bool CFBamDelSubDep2HBuff::operator <( const CFBamDelSubDep2HBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamDelSubDep2HBuff::operator <( const CFBamDelSubDep2Buff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamDelSubDep2HBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamDelSubDep2HBuff" );
