// Description: C++18 implementation for a TZDateCol buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTZDateColBuff::GENDEFNAME( "TZDateCol" );
	const classcode_t CFBamTZDateColBuff::CLASS_CODE = 0xa863L;
	const std::string CFBamTZDateColBuff::CLASS_NAME( "CFBamTZDateColBuff" );
		const std::string CFBamTZDateColBuff::COLNAME_TABLEID( "TableId" );
	const int64_t CFBamTZDateColBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamTZDateColBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamTZDateColBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamTZDateColBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamTZDateColBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamTZDateColBuff::TABLEID_MIN_VALUE = 0LL;

	CFBamTZDateColBuff::CFBamTZDateColBuff()
	: CFBamTZDateDefBuff()
	{
		requiredTableId = cfbam::CFBamTZDateColBuff::TABLEID_INIT_VALUE;
	}

	CFBamTZDateColBuff::CFBamTZDateColBuff( const CFBamTZDateColBuff& src )
	: CFBamTZDateDefBuff()
	{
		requiredTableId = cfbam::CFBamTZDateColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTZDateColBuff::clone() {
		CFBamTZDateColBuff* copy = new CFBamTZDateColBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTZDateColBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTZDateColBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTZDateColBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFBamTZDateColBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamTZDateColBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamTZDateColBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamTZDateColBuff::hashCode() const {
		size_t hashCode = CFBamTZDateDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamTZDateColBuff CFBamTZDateColBuff::operator =( cfbam::CFBamTZDateColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamTZDateColBuff CFBamTZDateColBuff::operator =( cfbam::CFBamTZDateColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTZDateColBuff::operator <( const CFBamTZDateColByTableIdxKey& rhs ) {
	...
	bool CFBamTZDateColBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZDateColBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZDateColBuff::operator <( const CFBamTZDateColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZDateColBuff::operator <( const CFBamTZDateColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTZDateColBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZDateColBuff" );
