// Description: C++18 implementation of a UuidDef history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUuidDefHBuff::CLASS_NAME( "CFBamUuidDefHBuff" );
	CFBamUuidDefHBuff::CFBamUuidDefHBuff()
	...
	CFBamUuidDefHBuff::CFBamUuidDefHBuff( const CFBamUuidDefHBuff& src )
	: cfbam::CFBamAtomHBuff() {
		for( int i = 0; i < 16; i ++ ) {
			optionalInitValue[i] = 0;
		}
	...
	cflib::ICFLibCloneableObj* CFBamUuidDefHBuff::clone() {
		CFBamUuidDefHBuff* copy = new CFBamUuidDefHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const uuid_ptr_t CFBamUuidDefHBuff::getOptionalInitValueValue() const {
	...
	const uuid_ptr_t CFBamUuidDefHBuff::getOptionalInitValueReference() const {
		if( isOptionalInitValueNull() ) {
			return( NULL );
		}
		else {
	...
	const bool CFBamUuidDefHBuff::isOptionalInitValueNull() const {
		for( int i = 0; i < 16; i ++ ) {
	...
	void CFBamUuidDefHBuff::setOptionalInitValueNull() {
		for( int i = 0; i < 16; i ++ ) {
			optionalInitValue[i] = 0;
		}
	}

	void CFBamUuidDefHBuff::setOptionalInitValueValue( const uuid_ptr_t value ) {
		uuid_copy( optionalInitValue, value );
	}

	void CFBamUuidDefHBuff::generateOptionalInitValue() {
		uuid_generate_random( optionalInitValue );
	}

	size_t CFBamUuidDefHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamUuidDefHBuff::hashCode();
		if( ! isOptionalInitValueNull() ) {
	...
	CFBamUuidDefHBuff CFBamUuidDefHBuff::operator =( cfbam::CFBamUuidDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamUuidDefHBuff CFBamUuidDefHBuff::operator =( cfbam::CFBamUuidDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUuidDefHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamUuidDefHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamUuidDefHBuff::operator <( const CFBamUuidDefHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamUuidDefHBuff::operator <( const CFBamUuidDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUuidDefHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUuidDefHBuff" );
