// Description: C++18 implementation for a NumberType buffer object.
...
namespace cfbam {
	...
	const std::string CFBamNumberTypeBuff::GENDEFNAME( "NumberType" );
	const classcode_t CFBamNumberTypeBuff::CLASS_CODE = 0xa82eL;
	const std::string CFBamNumberTypeBuff::CLASS_NAME( "CFBamNumberTypeBuff" );
		const std::string CFBamNumberTypeBuff::COLNAME_SCHEMADEFID( "SchemaDefId" );
	const int64_t CFBamNumberTypeBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamNumberTypeBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamNumberTypeBuff::SCHEMADEFID_INIT_VALUE = 0LL;
	const int64_t CFBamNumberTypeBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamNumberTypeBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamNumberTypeBuff::SCHEMADEFID_MIN_VALUE = 0LL;

	CFBamNumberTypeBuff::CFBamNumberTypeBuff()
	: CFBamNumberDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamNumberTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamNumberTypeBuff::CFBamNumberTypeBuff( const CFBamNumberTypeBuff& src )
	: CFBamNumberDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamNumberTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamNumberTypeBuff::clone() {
		CFBamNumberTypeBuff* copy = new CFBamNumberTypeBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamNumberTypeBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamNumberTypeBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamNumberTypeBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamNumberDefBuff::implementsClassCode( argClassCode ) );
		}
	}

	const int64_t CFBamNumberTypeBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamNumberTypeBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamNumberTypeBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamNumberTypeBuff::hashCode() const {
		size_t hashCode = CFBamNumberDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamNumberTypeBuff CFBamNumberTypeBuff::operator =( cfbam::CFBamNumberTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamNumberTypeBuff CFBamNumberTypeBuff::operator =( cfbam::CFBamNumberTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamNumberTypeBuff::operator <( const CFBamNumberTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamNumberTypeBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNumberTypeBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNumberTypeBuff::operator <( const CFBamNumberTypeHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNumberTypeBuff::operator <( const CFBamNumberTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamNumberTypeBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNumberTypeBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamNumberTypeBuff& lhs, const cfbam::CFBamNumberTypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamNumberTypeBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamNumberTypeBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamNumberTypeBuff& lhs, const cfbam::CFBamNumberTypeHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamNumberTypeBuff& lhs, const cfbam::CFBamNumberTypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
