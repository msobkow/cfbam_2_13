// Description: C++18 edit object instance implementation for CFBam TokenDef.
...
namespace cfbam {
	...
	const std::string CFBamTokenDefEditObj::CLASS_NAME( "CFBamTokenDefEditObj" );

	CFBamTokenDefEditObj::CFBamTokenDefEditObj( cfbam::ICFBamTokenDefObj* argOrig )
	: ICFBamTokenDefEditObj(),
	  CFBamAtomEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamTokenDefEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamTokenDefEditObj::~CFBamTokenDefEditObj() {
	}

	const std::string& CFBamTokenDefEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTokenDefEditObj::getClassCode() const {
		return( cfbam::CFBamTokenDefBuff::CLASS_CODE );
	}

	bool CFBamTokenDefEditObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamTokenDefBuff::CLASS_CODE ) {
			return( true );
		}
		else {
	...
	std::string CFBamTokenDefEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTokenDefEditObj" );
	...
	const std::string CFBamTokenDefEditObj::getGenDefName() {
		return( cfbam::CFBamTokenDefBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTokenDefEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTokenDefEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTokenDefEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTokenDefEditObj::getObjQualifiedName() {
	...
	std::string CFBamTokenDefEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTokenDefEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamTokenDefObj* retobj = getSchema()->getTokenDefTableObj()->realizeTokenDef( dynamic_cast<cfbam::ICFBamTokenDefObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamTokenDefEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamTokenDefEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamTokenDefEditObj::create() {
		cfbam::ICFBamTokenDefObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsTokenDef()->getSchema() )->getTokenDefTableObj()->createTokenDef( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamTokenDefEditObj::update() {
		getSchema()->getTokenDefTableObj()->updateTokenDef( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamTokenDefEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getTokenDefTableObj()->deleteTokenDef( this );
		return( NULL );
	}

	cfbam::ICFBamTokenDefTableObj* CFBamTokenDefEditObj::getTokenDefTable() {
		return( orig->getSchema()->getTokenDefTableObj() );
	}

	cfbam::ICFBamTokenDefEditObj* CFBamTokenDefEditObj::getTokenDefEdit() {
		return( (cfbam::ICFBamTokenDefEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamTokenDefEditObj::beginEdit() {
	...
	cfbam::ICFBamTokenDefObj* CFBamTokenDefEditObj::getOrigAsTokenDef() {
		return( dynamic_cast<cfbam::ICFBamTokenDefObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamTokenDefEditObj::getBuff() {
		return( buff );
	}

	void CFBamTokenDefEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamAtomEditObj::setBuff( value );
		}
	}

	const int32_t CFBamTokenDefEditObj::getRequiredMaxLen() {
		return( getTokenDefBuff()->getRequiredMaxLen() );
	}

	const int32_t* CFBamTokenDefEditObj::getRequiredMaxLenReference() {
		return( getTokenDefBuff()->getRequiredMaxLenReference() );
	}

	void CFBamTokenDefEditObj::setRequiredMaxLen( const int32_t value ) {
		if( getTokenDefBuff()->getRequiredMaxLen() != value ) {
			getTokenDefEditBuff()->setRequiredMaxLen( value );
		}
	}

	bool CFBamTokenDefEditObj::isOptionalInitValueNull() {
		return( getTokenDefBuff()->isOptionalInitValueNull() );
	}

	const std::string& CFBamTokenDefEditObj::getOptionalInitValueValue() {
		return( getTokenDefBuff()->getOptionalInitValueValue() );
	}

	const std::string* CFBamTokenDefEditObj::getOptionalInitValueReference() {
		return( getTokenDefBuff()->getOptionalInitValueReference() );
	}

	void CFBamTokenDefEditObj::setOptionalInitValueNull() {
		if( ! getTokenDefBuff()->isOptionalInitValueNull() ) {
			getTokenDefEditBuff()->setOptionalInitValueNull();
		}
	}

	void CFBamTokenDefEditObj::setOptionalInitValueValue( const std::string& value ) {
		if( getTokenDefBuff()->isOptionalInitValueNull() ) {
			getTokenDefEditBuff()->setOptionalInitValueValue( value );
		}
		else if( getTokenDefBuff()->getOptionalInitValueValue() != value ) {
			getTokenDefEditBuff()->setOptionalInitValueValue( value );
		}
	}

	void CFBamTokenDefEditObj::copyBuffToOrig() {
		cfbam::CFBamTokenDefBuff* origBuff = getOrigAsTokenDef()->getTokenDefEditBuff();
		cfbam::CFBamTokenDefBuff* myBuff = getTokenDefBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamTokenDefEditObj::copyOrigToBuff() {
		cfbam::CFBamTokenDefBuff* origBuff = getOrigAsTokenDef()->getTokenDefBuff();
		cfbam::CFBamTokenDefBuff* myBuff = getTokenDefEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
