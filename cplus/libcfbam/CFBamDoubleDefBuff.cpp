// Description: C++18 implementation for a DoubleDef buffer object.
...
namespace cfbam {
	...
	const std::string CFBamDoubleDefBuff::GENDEFNAME( "DoubleDef" );
	const classcode_t CFBamDoubleDefBuff::CLASS_CODE = 0xa81cL;
	const std::string CFBamDoubleDefBuff::CLASS_NAME( "CFBamDoubleDefBuff" );
		const std::string CFBamDoubleDefBuff::COLNAME_INITVALUE( "InitValue" );
		const std::string CFBamDoubleDefBuff::COLNAME_MINVALUE( "MinValue" );
		const std::string CFBamDoubleDefBuff::COLNAME_MAXVALUE( "MaxValue" );
	const int64_t CFBamDoubleDefBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamDoubleDefBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamDoubleDefBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamDoubleDefBuff::ID_MIN_VALUE = 0LL;
	const double CFBamDoubleDefBuff::INITVALUE_MIN_VALUE = -2.225E307;
	const double CFBamDoubleDefBuff::MINVALUE_MIN_VALUE = -2.225E307;
	const double CFBamDoubleDefBuff::MAXVALUE_MIN_VALUE = -2.225E307;
	const double CFBamDoubleDefBuff::INITVALUE_MAX_VALUE = 2.225E307;
	const double CFBamDoubleDefBuff::MINVALUE_MAX_VALUE = 2.225E307;
	const double CFBamDoubleDefBuff::MAXVALUE_MAX_VALUE = 2.225E307;

	CFBamDoubleDefBuff::CFBamDoubleDefBuff()
	: CFBamAtomBuff()
	{
	...
	CFBamDoubleDefBuff::CFBamDoubleDefBuff( const CFBamDoubleDefBuff& src )
	: CFBamAtomBuff()
	{
		optionalInitValue.setNull();
		optionalMinValue.setNull();
	...
	cflib::ICFLibCloneableObj* CFBamDoubleDefBuff::clone() {
		CFBamDoubleDefBuff* copy = new CFBamDoubleDefBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamDoubleDefBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamDoubleDefBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamDoubleDefBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const bool CFBamDoubleDefBuff::isOptionalInitValueNull() const {
		return( optionalInitValue.isNull() );
	}

	const double CFBamDoubleDefBuff::getOptionalInitValueValue() const {
		return( optionalInitValue.getValue() );
	}

	const double* CFBamDoubleDefBuff::getOptionalInitValueReference() const {
		return( optionalInitValue.getReference() );
	}

	void CFBamDoubleDefBuff::setOptionalInitValueNull() {
		optionalInitValue.setNull();
	}

	void CFBamDoubleDefBuff::setOptionalInitValueValue( const double value ) {
		static const std::string S_ProcName( "setOptionalInitValueValue" );
		if( value < cfbam::CFBamDoubleDefBuff::INITVALUE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamDoubleDefBuff::INITVALUE_MIN_VALUE );
		}
		if( value > cfbam::CFBamDoubleDefBuff::INITVALUE_MAX_VALUE ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamDoubleDefBuff::INITVALUE_MAX_VALUE );
		}
		optionalInitValue.setValue( value );
	}

	const bool CFBamDoubleDefBuff::isOptionalMinValueNull() const {
		return( optionalMinValue.isNull() );
	}

	const double CFBamDoubleDefBuff::getOptionalMinValueValue() const {
		return( optionalMinValue.getValue() );
	}

	const double* CFBamDoubleDefBuff::getOptionalMinValueReference() const {
		return( optionalMinValue.getReference() );
	}

	void CFBamDoubleDefBuff::setOptionalMinValueNull() {
		optionalMinValue.setNull();
	}

	void CFBamDoubleDefBuff::setOptionalMinValueValue( const double value ) {
		static const std::string S_ProcName( "setOptionalMinValueValue" );
		if( value < cfbam::CFBamDoubleDefBuff::MINVALUE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamDoubleDefBuff::MINVALUE_MIN_VALUE );
		}
		if( value > cfbam::CFBamDoubleDefBuff::MINVALUE_MAX_VALUE ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamDoubleDefBuff::MINVALUE_MAX_VALUE );
		}
		optionalMinValue.setValue( value );
	}

	const bool CFBamDoubleDefBuff::isOptionalMaxValueNull() const {
		return( optionalMaxValue.isNull() );
	}

	const double CFBamDoubleDefBuff::getOptionalMaxValueValue() const {
		return( optionalMaxValue.getValue() );
	}

	const double* CFBamDoubleDefBuff::getOptionalMaxValueReference() const {
		return( optionalMaxValue.getReference() );
	}

	void CFBamDoubleDefBuff::setOptionalMaxValueNull() {
		optionalMaxValue.setNull();
	}

	void CFBamDoubleDefBuff::setOptionalMaxValueValue( const double value ) {
		static const std::string S_ProcName( "setOptionalMaxValueValue" );
		if( value < cfbam::CFBamDoubleDefBuff::MAXVALUE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamDoubleDefBuff::MAXVALUE_MIN_VALUE );
		}
		if( value > cfbam::CFBamDoubleDefBuff::MAXVALUE_MAX_VALUE ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamDoubleDefBuff::MAXVALUE_MAX_VALUE );
		}
		optionalMaxValue.setValue( value );
	}

	size_t CFBamDoubleDefBuff::hashCode() const {
	...
	CFBamDoubleDefBuff CFBamDoubleDefBuff::operator =( cfbam::CFBamDoubleDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamDoubleDefBuff CFBamDoubleDefBuff::operator =( cfbam::CFBamDoubleDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamDoubleDefBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamDoubleDefBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamDoubleDefBuff::operator <( const CFBamDoubleDefHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamDoubleDefBuff::operator <( const CFBamDoubleDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamDoubleDefBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamDoubleDefBuff" );
		...
		if( ! isOptionalInitValueNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredDouble( &S_Space, S_InitValue, getOptionalInitValueValue() ) );
		}
		if( ! isOptionalMinValueNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredDouble( &S_Space, S_MinValue, getOptionalMinValueValue() ) );
		}
		if( ! isOptionalMaxValueNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredDouble( &S_Space, S_MaxValue, getOptionalMaxValueValue() ) );
		}
