// Description: C++18 implementation for a DateDef buffer object.
...
namespace cfbam {
	...
	const std::string CFBamDateDefBuff::GENDEFNAME( "DateDef" );
	const classcode_t CFBamDateDefBuff::CLASS_CODE = 0xa815L;
	const std::string CFBamDateDefBuff::CLASS_NAME( "CFBamDateDefBuff" );
		const std::string CFBamDateDefBuff::COLNAME_DUMMY( "Dummy" );
	const int64_t CFBamDateDefBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamDateDefBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamDateDefBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamDateDefBuff::ID_MIN_VALUE = 0LL;
	const std::string::size_type CFBamDateDefBuff::DUMMY_MAX_LEN = 4;

	CFBamDateDefBuff::CFBamDateDefBuff()
	: CFBamAtomBuff()
	{
		optionalDummy = NULL;
	}

	CFBamDateDefBuff::CFBamDateDefBuff( const CFBamDateDefBuff& src )
	: CFBamAtomBuff()
	{
		optionalDummy = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamDateDefBuff::clone() {
		CFBamDateDefBuff* copy = new CFBamDateDefBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamDateDefBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamDateDefBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamDateDefBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const bool CFBamDateDefBuff::isOptionalDummyNull() const {
		return( optionalDummy == NULL );
	}

	const std::string& CFBamDateDefBuff::getOptionalDummyValue() const {
	...
	const std::string* CFBamDateDefBuff::getOptionalDummyReference() const {
		return( optionalDummy );
	}

	void CFBamDateDefBuff::setOptionalDummyNull() {
		if( optionalDummy != NULL ) {
			delete optionalDummy;
			optionalDummy = NULL;
		}
	...
	void CFBamDateDefBuff::setOptionalDummyValue( const std::string& value ) {
		static const std::string S_ProcName( "setOptionalDummyValue" );
		if( value.length() > CFBamDateDefBuff::DUMMY_MAX_LEN ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE_LENGTH,
				value.length(),
				CFBamDateDefBuff::DUMMY_MAX_LEN );
		}
		if( optionalDummy != NULL ) {
			delete optionalDummy;
			optionalDummy = NULL;
	...
	size_t CFBamDateDefBuff::hashCode() const {
	...
	CFBamDateDefBuff CFBamDateDefBuff::operator =( cfbam::CFBamDateDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamDateDefBuff CFBamDateDefBuff::operator =( cfbam::CFBamDateDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamDateDefBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamDateDefBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamDateDefBuff::operator <( const CFBamDateDefHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamDateDefBuff::operator <( const CFBamDateDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamDateDefBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamDateDefBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamDateDefBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamDateDefBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamDateDefBuff& lhs, const cfbam::CFBamDateDefHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamDateDefBuff& lhs, const cfbam::CFBamDateDefBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
