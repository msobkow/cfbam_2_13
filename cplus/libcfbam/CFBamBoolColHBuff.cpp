// Description: C++18 implementation of a BoolCol history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamBoolColHBuff::CLASS_NAME( "CFBamBoolColHBuff" );
	CFBamBoolColHBuff::CFBamBoolColHBuff()
	: cfbam::CFBamBoolDefHBuff() {
		requiredTableId = cfbam::CFBamBoolColBuff::TABLEID_INIT_VALUE;
	}

	CFBamBoolColHBuff::CFBamBoolColHBuff( const CFBamBoolColHBuff& src )
	: cfbam::CFBamBoolDefHBuff() {
		requiredTableId = cfbam::CFBamBoolColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamBoolColHBuff::clone() {
		CFBamBoolColHBuff* copy = new CFBamBoolColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamBoolColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamBoolColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamBoolColHBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamBoolColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamBoolColHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamBoolColHBuff CFBamBoolColHBuff::operator =( cfbam::CFBamBoolColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamBoolColHBuff CFBamBoolColHBuff::operator =( cfbam::CFBamBoolColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamBoolColHBuff::operator <( const CFBamBoolColByTableIdxKey& rhs ) {
	...
	bool CFBamBoolColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamBoolColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamBoolColHBuff::operator <( const CFBamBoolColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamBoolColHBuff::operator <( const CFBamBoolColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamBoolColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamBoolColHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamBoolColHBuff& lhs, const cfbam::CFBamBoolColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamBoolColHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamBoolColHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamBoolColHBuff& lhs, const cfbam::CFBamBoolColHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamBoolColHBuff& lhs, const cfbam::CFBamBoolColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
