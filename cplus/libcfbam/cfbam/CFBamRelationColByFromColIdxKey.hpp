...
// Description: C++18 specification for a RelationCol by FromColIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamRelationColByFromColIdxKey();
		CFBamRelationColByFromColIdxKey( const CFBamRelationColByFromColIdxKey& src );
		virtual ~CFBamRelationColByFromColIdxKey();
		...
		bool operator >( const CFBamRelationColHBuff& rhs );
		bool operator >( const CFBamRelationColBuff& rhs );
		cfbam::CFBamRelationColByFromColIdxKey operator =( cfbam::CFBamRelationColByFromColIdxKey& src );
		cfbam::CFBamRelationColByFromColIdxKey operator =( cfbam::CFBamRelationColBuff& src );
		cfbam::CFBamRelationColByFromColIdxKey operator =( cfbam::CFBamRelationColHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamRelationColByFromColIdxKey> {
		typedef cfbam::CFBamRelationColByFromColIdxKey argument_type;
