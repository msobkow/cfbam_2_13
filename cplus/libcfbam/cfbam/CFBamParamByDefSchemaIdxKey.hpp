...
// Description: C++18 specification for a Param by DefSchemaIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamParamByDefSchemaIdxKey();
		CFBamParamByDefSchemaIdxKey( const CFBamParamByDefSchemaIdxKey& src );
		virtual ~CFBamParamByDefSchemaIdxKey();
		...
		bool operator >( const CFBamParamHBuff& rhs );
		bool operator >( const CFBamParamBuff& rhs );
		cfbam::CFBamParamByDefSchemaIdxKey operator =( cfbam::CFBamParamByDefSchemaIdxKey& src );
		cfbam::CFBamParamByDefSchemaIdxKey operator =( cfbam::CFBamParamBuff& src );
		cfbam::CFBamParamByDefSchemaIdxKey operator =( cfbam::CFBamParamHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamParamByDefSchemaIdxKey> {
		typedef cfbam::CFBamParamByDefSchemaIdxKey argument_type;
