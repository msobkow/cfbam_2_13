...
// Description: C++18 specification for a DelSubDep3 by DelSubDep2Idx index key object.
...
namespace cfbam {
	...
	public:
		CFBamDelSubDep3ByDelSubDep2IdxKey();
		CFBamDelSubDep3ByDelSubDep2IdxKey( const CFBamDelSubDep3ByDelSubDep2IdxKey& src );
		virtual ~CFBamDelSubDep3ByDelSubDep2IdxKey();
		...
		bool operator >( const CFBamDelSubDep3HBuff& rhs );
		bool operator >( const CFBamDelSubDep3Buff& rhs );
		cfbam::CFBamDelSubDep3ByDelSubDep2IdxKey operator =( cfbam::CFBamDelSubDep3ByDelSubDep2IdxKey& src );
		cfbam::CFBamDelSubDep3ByDelSubDep2IdxKey operator =( cfbam::CFBamDelSubDep3Buff& src );
		cfbam::CFBamDelSubDep3ByDelSubDep2IdxKey operator =( cfbam::CFBamDelSubDep3HBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamDelSubDep3ByDelSubDep2IdxKey> {
		typedef cfbam::CFBamDelSubDep3ByDelSubDep2IdxKey argument_type;
