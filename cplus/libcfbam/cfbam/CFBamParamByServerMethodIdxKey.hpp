...
// Description: C++18 specification for a Param by ServerMethodIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamParamByServerMethodIdxKey();
		CFBamParamByServerMethodIdxKey( const CFBamParamByServerMethodIdxKey& src );
		virtual ~CFBamParamByServerMethodIdxKey();
		...
		bool operator >( const CFBamParamHBuff& rhs );
		bool operator >( const CFBamParamBuff& rhs );
		cfbam::CFBamParamByServerMethodIdxKey operator =( cfbam::CFBamParamByServerMethodIdxKey& src );
		cfbam::CFBamParamByServerMethodIdxKey operator =( cfbam::CFBamParamBuff& src );
		cfbam::CFBamParamByServerMethodIdxKey operator =( cfbam::CFBamParamHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamParamByServerMethodIdxKey> {
		typedef cfbam::CFBamParamByServerMethodIdxKey argument_type;
