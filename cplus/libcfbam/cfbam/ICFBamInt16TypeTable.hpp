...
// Description: C++18 DbIO interface for Int16Type.
...
namespace cfbam {
	...
	public:
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamInt16TypeBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
