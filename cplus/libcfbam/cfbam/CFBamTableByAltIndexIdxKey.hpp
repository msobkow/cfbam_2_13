...
// Description: C++18 specification for a Table by AltIndexIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamTableByAltIndexIdxKey();
		CFBamTableByAltIndexIdxKey( const CFBamTableByAltIndexIdxKey& src );
		virtual ~CFBamTableByAltIndexIdxKey();
		...
		bool operator >( const CFBamTableHBuff& rhs );
		bool operator >( const CFBamTableBuff& rhs );
		cfbam::CFBamTableByAltIndexIdxKey operator =( cfbam::CFBamTableByAltIndexIdxKey& src );
		cfbam::CFBamTableByAltIndexIdxKey operator =( cfbam::CFBamTableBuff& src );
		cfbam::CFBamTableByAltIndexIdxKey operator =( cfbam::CFBamTableHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamTableByAltIndexIdxKey> {
		typedef cfbam::CFBamTableByAltIndexIdxKey argument_type;
