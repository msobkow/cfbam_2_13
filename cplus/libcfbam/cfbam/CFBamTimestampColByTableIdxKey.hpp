...
// Description: C++18 specification for a TimestampCol by TableIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamTimestampColByTableIdxKey();
		CFBamTimestampColByTableIdxKey( const CFBamTimestampColByTableIdxKey& src );
		virtual ~CFBamTimestampColByTableIdxKey();
		...
		bool operator >( const CFBamTimestampColHBuff& rhs );
		bool operator >( const CFBamTimestampColBuff& rhs );
		cfbam::CFBamTimestampColByTableIdxKey operator =( cfbam::CFBamTimestampColByTableIdxKey& src );
		cfbam::CFBamTimestampColByTableIdxKey operator =( cfbam::CFBamTimestampColBuff& src );
		cfbam::CFBamTimestampColByTableIdxKey operator =( cfbam::CFBamTimestampColHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamTimestampColByTableIdxKey> {
		typedef cfbam::CFBamTimestampColByTableIdxKey argument_type;
