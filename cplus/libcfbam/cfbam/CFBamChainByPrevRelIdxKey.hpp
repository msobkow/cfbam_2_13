...
// Description: C++18 specification for a Chain by PrevRelIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamChainByPrevRelIdxKey();
		CFBamChainByPrevRelIdxKey( const CFBamChainByPrevRelIdxKey& src );
		virtual ~CFBamChainByPrevRelIdxKey();
		...
		bool operator >( const CFBamChainHBuff& rhs );
		bool operator >( const CFBamChainBuff& rhs );
		cfbam::CFBamChainByPrevRelIdxKey operator =( cfbam::CFBamChainByPrevRelIdxKey& src );
		cfbam::CFBamChainByPrevRelIdxKey operator =( cfbam::CFBamChainBuff& src );
		cfbam::CFBamChainByPrevRelIdxKey operator =( cfbam::CFBamChainHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamChainByPrevRelIdxKey> {
		typedef cfbam::CFBamChainByPrevRelIdxKey argument_type;
