...
// Description: C++18 DbIO interface for UInt32Col.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteUInt32ColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamUInt32ColByTableIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamUInt32ColBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
