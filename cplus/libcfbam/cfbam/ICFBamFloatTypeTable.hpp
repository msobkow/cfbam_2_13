...
// Description: C++18 DbIO interface for FloatType.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteFloatTypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamFloatTypeBySchemaIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamFloatTypeBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamFloatTypeBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
