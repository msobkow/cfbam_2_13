...
// Description: C++18 specification for a EnumTag by NextIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamEnumTagByNextIdxKey();
		CFBamEnumTagByNextIdxKey( const CFBamEnumTagByNextIdxKey& src );
		virtual ~CFBamEnumTagByNextIdxKey();
		...
		bool operator >( const CFBamEnumTagHBuff& rhs );
		bool operator >( const CFBamEnumTagBuff& rhs );
		cfbam::CFBamEnumTagByNextIdxKey operator =( cfbam::CFBamEnumTagByNextIdxKey& src );
		cfbam::CFBamEnumTagByNextIdxKey operator =( cfbam::CFBamEnumTagBuff& src );
		cfbam::CFBamEnumTagByNextIdxKey operator =( cfbam::CFBamEnumTagHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamEnumTagByNextIdxKey> {
		typedef cfbam::CFBamEnumTagByNextIdxKey argument_type;
