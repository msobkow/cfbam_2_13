...
// Description: C++18 DbIO interface for StringCol.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteStringColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamStringColByTableIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamStringColBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
