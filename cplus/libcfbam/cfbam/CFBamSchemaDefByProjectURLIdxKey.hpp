...
// Description: C++18 specification for a SchemaDef by ProjectURLIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamSchemaDefByProjectURLIdxKey();
		CFBamSchemaDefByProjectURLIdxKey( const CFBamSchemaDefByProjectURLIdxKey& src );
		virtual ~CFBamSchemaDefByProjectURLIdxKey();
		...
		bool operator >( const CFBamSchemaDefHBuff& rhs );
		bool operator >( const CFBamSchemaDefBuff& rhs );
		cfbam::CFBamSchemaDefByProjectURLIdxKey operator =( cfbam::CFBamSchemaDefByProjectURLIdxKey& src );
		cfbam::CFBamSchemaDefByProjectURLIdxKey operator =( cfbam::CFBamSchemaDefBuff& src );
		cfbam::CFBamSchemaDefByProjectURLIdxKey operator =( cfbam::CFBamSchemaDefHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamSchemaDefByProjectURLIdxKey> {
		typedef cfbam::CFBamSchemaDefByProjectURLIdxKey argument_type;
