...
// Description: C++18 DbIO interface for UInt16Col.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteUInt16ColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamUInt16ColByTableIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamUInt16ColBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamUInt16ColBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
