...
// Description: C++18 specification for a StringType by SchemaIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamStringTypeBySchemaIdxKey();
		CFBamStringTypeBySchemaIdxKey( const CFBamStringTypeBySchemaIdxKey& src );
		virtual ~CFBamStringTypeBySchemaIdxKey();
		...
		bool operator >( const CFBamStringTypeHBuff& rhs );
		bool operator >( const CFBamStringTypeBuff& rhs );
		cfbam::CFBamStringTypeBySchemaIdxKey operator =( cfbam::CFBamStringTypeBySchemaIdxKey& src );
		cfbam::CFBamStringTypeBySchemaIdxKey operator =( cfbam::CFBamStringTypeBuff& src );
		cfbam::CFBamStringTypeBySchemaIdxKey operator =( cfbam::CFBamStringTypeHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamStringTypeBySchemaIdxKey> {
		typedef cfbam::CFBamStringTypeBySchemaIdxKey argument_type;
