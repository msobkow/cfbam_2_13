...
// Description: C++18 DbIO interface for TimeType.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteTimeTypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamTimeTypeBySchemaIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamTimeTypeBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamTimeTypeBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
