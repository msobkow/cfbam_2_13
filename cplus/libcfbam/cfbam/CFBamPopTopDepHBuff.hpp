...
// Description: C++18 specification of a PopTopDep history buffer object.
...
namespace cfbam {
	...
	class CFBamPopTopDepHBuff : public CFBamPopDepHBuff
	...
	public:
		CFBamPopTopDepHBuff();
		CFBamPopTopDepHBuff( const CFBamPopTopDepHBuff& src );
		virtual ~CFBamPopTopDepHBuff();
		...
		bool operator >( const CFBamPopTopDepHBuff& rhs );
		bool operator >( const CFBamPopTopDepBuff& rhs );
		cfbam::CFBamPopTopDepHBuff operator =( cfbam::CFBamPopTopDepBuff& src );
		cfbam::CFBamPopTopDepHBuff operator =( cfbam::CFBamPopTopDepHBuff& src );
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamPopTopDepHBuff> {
		typedef cfbam::CFBamPopTopDepHBuff argument_type;
