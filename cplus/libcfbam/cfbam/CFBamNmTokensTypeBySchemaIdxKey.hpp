...
// Description: C++18 specification for a NmTokensType by SchemaIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamNmTokensTypeBySchemaIdxKey();
		CFBamNmTokensTypeBySchemaIdxKey( const CFBamNmTokensTypeBySchemaIdxKey& src );
		virtual ~CFBamNmTokensTypeBySchemaIdxKey();
		...
		bool operator >( const CFBamNmTokensTypeHBuff& rhs );
		bool operator >( const CFBamNmTokensTypeBuff& rhs );
		cfbam::CFBamNmTokensTypeBySchemaIdxKey operator =( cfbam::CFBamNmTokensTypeBySchemaIdxKey& src );
		cfbam::CFBamNmTokensTypeBySchemaIdxKey operator =( cfbam::CFBamNmTokensTypeBuff& src );
		cfbam::CFBamNmTokensTypeBySchemaIdxKey operator =( cfbam::CFBamNmTokensTypeHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamNmTokensTypeBySchemaIdxKey> {
		typedef cfbam::CFBamNmTokensTypeBySchemaIdxKey argument_type;
