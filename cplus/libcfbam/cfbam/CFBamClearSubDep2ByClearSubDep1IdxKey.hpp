...
// Description: C++18 specification for a ClearSubDep2 by ClearSubDep1Idx index key object.
...
namespace cfbam {
	...
	public:
		CFBamClearSubDep2ByClearSubDep1IdxKey();
		CFBamClearSubDep2ByClearSubDep1IdxKey( const CFBamClearSubDep2ByClearSubDep1IdxKey& src );
		virtual ~CFBamClearSubDep2ByClearSubDep1IdxKey();
		...
		bool operator >( const CFBamClearSubDep2HBuff& rhs );
		bool operator >( const CFBamClearSubDep2Buff& rhs );
		cfbam::CFBamClearSubDep2ByClearSubDep1IdxKey operator =( cfbam::CFBamClearSubDep2ByClearSubDep1IdxKey& src );
		cfbam::CFBamClearSubDep2ByClearSubDep1IdxKey operator =( cfbam::CFBamClearSubDep2Buff& src );
		cfbam::CFBamClearSubDep2ByClearSubDep1IdxKey operator =( cfbam::CFBamClearSubDep2HBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamClearSubDep2ByClearSubDep1IdxKey> {
		typedef cfbam::CFBamClearSubDep2ByClearSubDep1IdxKey argument_type;
