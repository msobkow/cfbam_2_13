...
// Description: C++18 specification for a ClearDep by ClearDepIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamClearDepByClearDepIdxKey();
		CFBamClearDepByClearDepIdxKey( const CFBamClearDepByClearDepIdxKey& src );
		virtual ~CFBamClearDepByClearDepIdxKey();
		...
		bool operator >( const CFBamClearDepHBuff& rhs );
		bool operator >( const CFBamClearDepBuff& rhs );
		cfbam::CFBamClearDepByClearDepIdxKey operator =( cfbam::CFBamClearDepByClearDepIdxKey& src );
		cfbam::CFBamClearDepByClearDepIdxKey operator =( cfbam::CFBamClearDepBuff& src );
		cfbam::CFBamClearDepByClearDepIdxKey operator =( cfbam::CFBamClearDepHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamClearDepByClearDepIdxKey> {
		typedef cfbam::CFBamClearDepByClearDepIdxKey argument_type;
