...
// Description: C++18 specification for a Id32Gen by DispIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamId32GenByDispIdxKey();
		CFBamId32GenByDispIdxKey( const CFBamId32GenByDispIdxKey& src );
		virtual ~CFBamId32GenByDispIdxKey();
		...
		bool operator >( const CFBamId32GenHBuff& rhs );
		bool operator >( const CFBamId32GenBuff& rhs );
		cfbam::CFBamId32GenByDispIdxKey operator =( cfbam::CFBamId32GenByDispIdxKey& src );
		cfbam::CFBamId32GenByDispIdxKey operator =( cfbam::CFBamId32GenBuff& src );
		cfbam::CFBamId32GenByDispIdxKey operator =( cfbam::CFBamId32GenHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamId32GenByDispIdxKey> {
		typedef cfbam::CFBamId32GenByDispIdxKey argument_type;
