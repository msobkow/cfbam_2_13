...
// Description: C++18 specification for a SchemaDef by AuthEMailIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamSchemaDefByAuthEMailIdxKey();
		CFBamSchemaDefByAuthEMailIdxKey( const CFBamSchemaDefByAuthEMailIdxKey& src );
		virtual ~CFBamSchemaDefByAuthEMailIdxKey();
		...
		bool operator >( const CFBamSchemaDefHBuff& rhs );
		bool operator >( const CFBamSchemaDefBuff& rhs );
		cfbam::CFBamSchemaDefByAuthEMailIdxKey operator =( cfbam::CFBamSchemaDefByAuthEMailIdxKey& src );
		cfbam::CFBamSchemaDefByAuthEMailIdxKey operator =( cfbam::CFBamSchemaDefBuff& src );
		cfbam::CFBamSchemaDefByAuthEMailIdxKey operator =( cfbam::CFBamSchemaDefHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamSchemaDefByAuthEMailIdxKey> {
		typedef cfbam::CFBamSchemaDefByAuthEMailIdxKey argument_type;
