...
// Description: C++18 DbIO interface for TZDateCol.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteTZDateColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamTZDateColByTableIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamTZDateColBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
