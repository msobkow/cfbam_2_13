...
// Description: C++18 DbIO interface for TZTimeCol.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteTZTimeColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamTZTimeColByTableIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamTZTimeColBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
