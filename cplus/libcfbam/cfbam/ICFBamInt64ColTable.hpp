...
// Description: C++18 DbIO interface for Int64Col.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteInt64ColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamInt64ColByTableIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamInt64ColBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
