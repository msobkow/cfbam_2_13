...
// Description: C++18 specification for a UInt64Type by SchemaIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamUInt64TypeBySchemaIdxKey();
		CFBamUInt64TypeBySchemaIdxKey( const CFBamUInt64TypeBySchemaIdxKey& src );
		virtual ~CFBamUInt64TypeBySchemaIdxKey();
		...
		bool operator >( const CFBamUInt64TypeHBuff& rhs );
		bool operator >( const CFBamUInt64TypeBuff& rhs );
		cfbam::CFBamUInt64TypeBySchemaIdxKey operator =( cfbam::CFBamUInt64TypeBySchemaIdxKey& src );
		cfbam::CFBamUInt64TypeBySchemaIdxKey operator =( cfbam::CFBamUInt64TypeBuff& src );
		cfbam::CFBamUInt64TypeBySchemaIdxKey operator =( cfbam::CFBamUInt64TypeHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamUInt64TypeBySchemaIdxKey> {
		typedef cfbam::CFBamUInt64TypeBySchemaIdxKey argument_type;
