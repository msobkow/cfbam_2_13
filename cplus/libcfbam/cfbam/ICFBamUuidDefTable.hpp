...
// Description: C++18 DbIO interface for UuidDef.
...
namespace cfbam {
	...
	public:
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamUuidDefBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
