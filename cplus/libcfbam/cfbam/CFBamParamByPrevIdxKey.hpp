...
// Description: C++18 specification for a Param by PrevIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamParamByPrevIdxKey();
		CFBamParamByPrevIdxKey( const CFBamParamByPrevIdxKey& src );
		virtual ~CFBamParamByPrevIdxKey();
		...
		bool operator >( const CFBamParamHBuff& rhs );
		bool operator >( const CFBamParamBuff& rhs );
		cfbam::CFBamParamByPrevIdxKey operator =( cfbam::CFBamParamByPrevIdxKey& src );
		cfbam::CFBamParamByPrevIdxKey operator =( cfbam::CFBamParamBuff& src );
		cfbam::CFBamParamByPrevIdxKey operator =( cfbam::CFBamParamHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamParamByPrevIdxKey> {
		typedef cfbam::CFBamParamByPrevIdxKey argument_type;
