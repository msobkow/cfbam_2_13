...
// Description: C++18 specification for a UInt64Type buffer object.
...
namespace cfbam {
	...
	class CFBamUInt64TypeBuff : public CFBamUInt64DefBuff
	{
	public:
	...
	public:
		CFBamUInt64TypeBuff();
		CFBamUInt64TypeBuff( const CFBamUInt64TypeBuff& src );
		virtual ~CFBamUInt64TypeBuff();
		...
		bool operator >( const CFBamUInt64TypeHBuff& rhs );
		bool operator >( const CFBamUInt64TypeBuff& rhs );
		cfbam::CFBamUInt64TypeBuff operator =( cfbam::CFBamUInt64TypeBuff& src );
		cfbam::CFBamUInt64TypeBuff operator =( cfbam::CFBamUInt64TypeHBuff& src );
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamUInt64TypeBuff> {
		typedef cfbam::CFBamUInt64TypeBuff argument_type;
