...
// Description: C++18 DbIO interface for TimeDef.
...
namespace cfbam {
	...
	public:
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamTimeDefBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
