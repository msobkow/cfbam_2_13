...
// Description: C++18 DbIO interface for FloatCol.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteFloatColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamFloatColByTableIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamFloatColBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
