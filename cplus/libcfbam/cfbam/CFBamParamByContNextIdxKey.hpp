...
// Description: C++18 specification for a Param by ContNextIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamParamByContNextIdxKey();
		CFBamParamByContNextIdxKey( const CFBamParamByContNextIdxKey& src );
		virtual ~CFBamParamByContNextIdxKey();
		...
		bool operator >( const CFBamParamHBuff& rhs );
		bool operator >( const CFBamParamBuff& rhs );
		cfbam::CFBamParamByContNextIdxKey operator =( cfbam::CFBamParamByContNextIdxKey& src );
		cfbam::CFBamParamByContNextIdxKey operator =( cfbam::CFBamParamBuff& src );
		cfbam::CFBamParamByContNextIdxKey operator =( cfbam::CFBamParamHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamParamByContNextIdxKey> {
		typedef cfbam::CFBamParamByContNextIdxKey argument_type;
