...
// Description: C++18 specification of a ClearSubDep1 history buffer object.
...
namespace cfbam {
	...
	class CFBamClearSubDep1HBuff : public CFBamClearDepHBuff
	...
	public:
		...
		CFBamClearSubDep1HBuff( const CFBamClearSubDep1HBuff& src );
		virtual ~CFBamClearSubDep1HBuff();
		...
		bool operator >( const CFBamClearSubDep1HBuff& rhs );
		bool operator >( const CFBamClearSubDep1Buff& rhs );
		cfbam::CFBamClearSubDep1HBuff operator =( cfbam::CFBamClearSubDep1Buff& src );
		cfbam::CFBamClearSubDep1HBuff operator =( cfbam::CFBamClearSubDep1HBuff& src );
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamClearSubDep1HBuff> {
		typedef cfbam::CFBamClearSubDep1HBuff argument_type;
