...
// Description: C++18 specification for a DelDep by DefSchemaIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamDelDepByDefSchemaIdxKey();
		CFBamDelDepByDefSchemaIdxKey( const CFBamDelDepByDefSchemaIdxKey& src );
		virtual ~CFBamDelDepByDefSchemaIdxKey();
		...
		bool operator >( const CFBamDelDepHBuff& rhs );
		bool operator >( const CFBamDelDepBuff& rhs );
		cfbam::CFBamDelDepByDefSchemaIdxKey operator =( cfbam::CFBamDelDepByDefSchemaIdxKey& src );
		cfbam::CFBamDelDepByDefSchemaIdxKey operator =( cfbam::CFBamDelDepBuff& src );
		cfbam::CFBamDelDepByDefSchemaIdxKey operator =( cfbam::CFBamDelDepHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamDelDepByDefSchemaIdxKey> {
		typedef cfbam::CFBamDelDepByDefSchemaIdxKey argument_type;
