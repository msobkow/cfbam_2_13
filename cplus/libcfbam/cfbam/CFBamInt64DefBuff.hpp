...
// Description: C++18 specification for a Int64Def buffer object.
...
namespace cfbam {
	...
	class CFBamInt64DefBuff : public CFBamAtomBuff
	{
	public:
		...
		static const int64_t INITVALUE_INIT_VALUE;
		static const int64_t MINVALUE_INIT_VALUE;
		static const int64_t MAXVALUE_INIT_VALUE;
		static const int64_t TENANTID_MIN_VALUE;
		static const int64_t ID_MIN_VALUE;
		static const int64_t INITVALUE_MIN_VALUE;
		static const int64_t MINVALUE_MIN_VALUE;
		static const int64_t MAXVALUE_MIN_VALUE;
		static const int64_t INITVALUE_MAX_VALUE;
		static const int64_t MINVALUE_MAX_VALUE;
		static const int64_t MAXVALUE_MAX_VALUE;
	protected:
	...
	public:
		CFBamInt64DefBuff();
		CFBamInt64DefBuff( const CFBamInt64DefBuff& src );
		virtual ~CFBamInt64DefBuff();
		...
		bool operator >( const CFBamInt64DefHBuff& rhs );
		bool operator >( const CFBamInt64DefBuff& rhs );
		cfbam::CFBamInt64DefBuff operator =( cfbam::CFBamInt64DefBuff& src );
		cfbam::CFBamInt64DefBuff operator =( cfbam::CFBamInt64DefHBuff& src );
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamInt64DefBuff> {
		typedef cfbam::CFBamInt64DefBuff argument_type;
