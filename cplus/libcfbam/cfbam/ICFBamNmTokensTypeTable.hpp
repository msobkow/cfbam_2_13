...
// Description: C++18 DbIO interface for NmTokensType.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteNmTokensTypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamNmTokensTypeBySchemaIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamNmTokensTypeBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
