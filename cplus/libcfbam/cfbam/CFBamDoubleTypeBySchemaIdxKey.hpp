...
// Description: C++18 specification for a DoubleType by SchemaIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamDoubleTypeBySchemaIdxKey();
		CFBamDoubleTypeBySchemaIdxKey( const CFBamDoubleTypeBySchemaIdxKey& src );
		virtual ~CFBamDoubleTypeBySchemaIdxKey();
		...
		bool operator >( const CFBamDoubleTypeHBuff& rhs );
		bool operator >( const CFBamDoubleTypeBuff& rhs );
		cfbam::CFBamDoubleTypeBySchemaIdxKey operator =( cfbam::CFBamDoubleTypeBySchemaIdxKey& src );
		cfbam::CFBamDoubleTypeBySchemaIdxKey operator =( cfbam::CFBamDoubleTypeBuff& src );
		cfbam::CFBamDoubleTypeBySchemaIdxKey operator =( cfbam::CFBamDoubleTypeHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamDoubleTypeBySchemaIdxKey> {
		typedef cfbam::CFBamDoubleTypeBySchemaIdxKey argument_type;
