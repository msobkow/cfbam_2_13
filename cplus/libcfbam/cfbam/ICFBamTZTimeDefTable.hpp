...
// Description: C++18 DbIO interface for TZTimeDef.
...
namespace cfbam {
	...
	public:
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamTZTimeDefBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
