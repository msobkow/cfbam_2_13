...
// Description: C++18 specification for a SchemaDef by PubURIIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamSchemaDefByPubURIIdxKey();
		CFBamSchemaDefByPubURIIdxKey( const CFBamSchemaDefByPubURIIdxKey& src );
		virtual ~CFBamSchemaDefByPubURIIdxKey();
		...
		bool operator >( const CFBamSchemaDefHBuff& rhs );
		bool operator >( const CFBamSchemaDefBuff& rhs );
		cfbam::CFBamSchemaDefByPubURIIdxKey operator =( cfbam::CFBamSchemaDefByPubURIIdxKey& src );
		cfbam::CFBamSchemaDefByPubURIIdxKey operator =( cfbam::CFBamSchemaDefBuff& src );
		cfbam::CFBamSchemaDefByPubURIIdxKey operator =( cfbam::CFBamSchemaDefHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamSchemaDefByPubURIIdxKey> {
		typedef cfbam::CFBamSchemaDefByPubURIIdxKey argument_type;
