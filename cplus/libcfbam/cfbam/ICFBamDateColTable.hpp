...
// Description: C++18 DbIO interface for DateCol.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteDateColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamDateColByTableIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamDateColBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamDateColBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
