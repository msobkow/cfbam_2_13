...
// Description: C++18 specification for a TextDef buffer object.
...
namespace cfbam {
	...
	class CFBamTextDefBuff : public CFBamAtomBuff
	{
	public:
	...
	public:
		CFBamTextDefBuff();
		CFBamTextDefBuff( const CFBamTextDefBuff& src );
		virtual ~CFBamTextDefBuff();
		...
		bool operator >( const CFBamTextDefHBuff& rhs );
		bool operator >( const CFBamTextDefBuff& rhs );
		cfbam::CFBamTextDefBuff operator =( cfbam::CFBamTextDefBuff& src );
		cfbam::CFBamTextDefBuff operator =( cfbam::CFBamTextDefHBuff& src );
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamTextDefBuff> {
		typedef cfbam::CFBamTextDefBuff argument_type;
