...
// Description: C++18 DbIO interface for Int16Col.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteInt16ColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamInt16ColByTableIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamInt16ColBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
