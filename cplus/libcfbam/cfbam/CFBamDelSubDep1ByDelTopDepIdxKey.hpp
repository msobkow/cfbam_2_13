...
// Description: C++18 specification for a DelSubDep1 by DelTopDepIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamDelSubDep1ByDelTopDepIdxKey();
		CFBamDelSubDep1ByDelTopDepIdxKey( const CFBamDelSubDep1ByDelTopDepIdxKey& src );
		virtual ~CFBamDelSubDep1ByDelTopDepIdxKey();
		...
		bool operator >( const CFBamDelSubDep1HBuff& rhs );
		bool operator >( const CFBamDelSubDep1Buff& rhs );
		cfbam::CFBamDelSubDep1ByDelTopDepIdxKey operator =( cfbam::CFBamDelSubDep1ByDelTopDepIdxKey& src );
		cfbam::CFBamDelSubDep1ByDelTopDepIdxKey operator =( cfbam::CFBamDelSubDep1Buff& src );
		cfbam::CFBamDelSubDep1ByDelTopDepIdxKey operator =( cfbam::CFBamDelSubDep1HBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamDelSubDep1ByDelTopDepIdxKey> {
		typedef cfbam::CFBamDelSubDep1ByDelTopDepIdxKey argument_type;
