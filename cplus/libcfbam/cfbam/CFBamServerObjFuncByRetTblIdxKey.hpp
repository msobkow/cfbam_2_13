...
// Description: C++18 specification for a ServerObjFunc by RetTblIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamServerObjFuncByRetTblIdxKey();
		CFBamServerObjFuncByRetTblIdxKey( const CFBamServerObjFuncByRetTblIdxKey& src );
		virtual ~CFBamServerObjFuncByRetTblIdxKey();
		...
		bool operator >( const CFBamServerObjFuncHBuff& rhs );
		bool operator >( const CFBamServerObjFuncBuff& rhs );
		cfbam::CFBamServerObjFuncByRetTblIdxKey operator =( cfbam::CFBamServerObjFuncByRetTblIdxKey& src );
		cfbam::CFBamServerObjFuncByRetTblIdxKey operator =( cfbam::CFBamServerObjFuncBuff& src );
		cfbam::CFBamServerObjFuncByRetTblIdxKey operator =( cfbam::CFBamServerObjFuncHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamServerObjFuncByRetTblIdxKey> {
		typedef cfbam::CFBamServerObjFuncByRetTblIdxKey argument_type;
