...
// Description: C++18 DbIO interface for Id32Gen.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteId32GenByDispIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const int64_t* argDispenserId ) = 0;

		virtual void deleteId32GenByDispIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamId32GenByDispIdxKey* argKey ) = 0;
		virtual void deleteId32GenBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int64_t argSchemaDefId ) = 0;

		virtual void deleteId32GenBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamInt32TypeBySchemaIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamId32GenBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
