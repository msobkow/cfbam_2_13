...
// Description: C++18 specification for a TableCol by DataIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamTableColByDataIdxKey();
		CFBamTableColByDataIdxKey( const CFBamTableColByDataIdxKey& src );
		virtual ~CFBamTableColByDataIdxKey();
		...
		bool operator >( const CFBamTableColHBuff& rhs );
		bool operator >( const CFBamTableColBuff& rhs );
		cfbam::CFBamTableColByDataIdxKey operator =( cfbam::CFBamTableColByDataIdxKey& src );
		cfbam::CFBamTableColByDataIdxKey operator =( cfbam::CFBamTableColBuff& src );
		cfbam::CFBamTableColByDataIdxKey operator =( cfbam::CFBamTableColHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamTableColByDataIdxKey> {
		typedef cfbam::CFBamTableColByDataIdxKey argument_type;
