...
// Description: C++18 DbIO interface for DoubleCol.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteDoubleColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamDoubleColByTableIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamDoubleColBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
