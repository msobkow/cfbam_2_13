...
// Description: C++18 DbIO interface for ClearTopDep.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteClearTopDepByClrTopDepTblIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamClearTopDepByClrTopDepTblIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamClearTopDepBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamClearTopDepBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
