...
// Description: C++18 specification for a ClearDep by DefSchemaIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamClearDepByDefSchemaIdxKey();
		CFBamClearDepByDefSchemaIdxKey( const CFBamClearDepByDefSchemaIdxKey& src );
		virtual ~CFBamClearDepByDefSchemaIdxKey();
		...
		bool operator >( const CFBamClearDepHBuff& rhs );
		bool operator >( const CFBamClearDepBuff& rhs );
		cfbam::CFBamClearDepByDefSchemaIdxKey operator =( cfbam::CFBamClearDepByDefSchemaIdxKey& src );
		cfbam::CFBamClearDepByDefSchemaIdxKey operator =( cfbam::CFBamClearDepBuff& src );
		cfbam::CFBamClearDepByDefSchemaIdxKey operator =( cfbam::CFBamClearDepHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamClearDepByDefSchemaIdxKey> {
		typedef cfbam::CFBamClearDepByDefSchemaIdxKey argument_type;
