...
// Description: C++18 specification for a TokenType by SchemaIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamTokenTypeBySchemaIdxKey();
		CFBamTokenTypeBySchemaIdxKey( const CFBamTokenTypeBySchemaIdxKey& src );
		virtual ~CFBamTokenTypeBySchemaIdxKey();
		...
		bool operator >( const CFBamTokenTypeHBuff& rhs );
		bool operator >( const CFBamTokenTypeBuff& rhs );
		cfbam::CFBamTokenTypeBySchemaIdxKey operator =( cfbam::CFBamTokenTypeBySchemaIdxKey& src );
		cfbam::CFBamTokenTypeBySchemaIdxKey operator =( cfbam::CFBamTokenTypeBuff& src );
		cfbam::CFBamTokenTypeBySchemaIdxKey operator =( cfbam::CFBamTokenTypeHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamTokenTypeBySchemaIdxKey> {
		typedef cfbam::CFBamTokenTypeBySchemaIdxKey argument_type;
