...
// Description: C++18 specification for a SchemaRef by PrevIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamSchemaRefByPrevIdxKey();
		CFBamSchemaRefByPrevIdxKey( const CFBamSchemaRefByPrevIdxKey& src );
		virtual ~CFBamSchemaRefByPrevIdxKey();
		...
		bool operator >( const CFBamSchemaRefHBuff& rhs );
		bool operator >( const CFBamSchemaRefBuff& rhs );
		cfbam::CFBamSchemaRefByPrevIdxKey operator =( cfbam::CFBamSchemaRefByPrevIdxKey& src );
		cfbam::CFBamSchemaRefByPrevIdxKey operator =( cfbam::CFBamSchemaRefBuff& src );
		cfbam::CFBamSchemaRefByPrevIdxKey operator =( cfbam::CFBamSchemaRefHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamSchemaRefByPrevIdxKey> {
		typedef cfbam::CFBamSchemaRefByPrevIdxKey argument_type;
