...
// Description: C++18 DbIO interface for UInt16Type.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteUInt16TypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamUInt16TypeBySchemaIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamUInt16TypeBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamUInt16TypeBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
