...
// Description: C++18 specification for a IndexCol by DefSchemaIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamIndexColByDefSchemaIdxKey();
		CFBamIndexColByDefSchemaIdxKey( const CFBamIndexColByDefSchemaIdxKey& src );
		virtual ~CFBamIndexColByDefSchemaIdxKey();
		...
		bool operator >( const CFBamIndexColHBuff& rhs );
		bool operator >( const CFBamIndexColBuff& rhs );
		cfbam::CFBamIndexColByDefSchemaIdxKey operator =( cfbam::CFBamIndexColByDefSchemaIdxKey& src );
		cfbam::CFBamIndexColByDefSchemaIdxKey operator =( cfbam::CFBamIndexColBuff& src );
		cfbam::CFBamIndexColByDefSchemaIdxKey operator =( cfbam::CFBamIndexColHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamIndexColByDefSchemaIdxKey> {
		typedef cfbam::CFBamIndexColByDefSchemaIdxKey argument_type;
