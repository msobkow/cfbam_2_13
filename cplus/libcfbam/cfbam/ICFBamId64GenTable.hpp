...
// Description: C++18 DbIO interface for Id64Gen.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteId64GenByDispIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamId64GenByDispIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamId64GenBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
