...
// Description: C++18 specification for a DelDep buffer object.
...
namespace cfbam {
	...
	class CFBamDelDepBuff : public CFBamScopeBuff
	{
	public:
	...
	public:
		CFBamDelDepBuff();
		CFBamDelDepBuff( const CFBamDelDepBuff& src );
		virtual ~CFBamDelDepBuff();
		...
		bool operator >( const CFBamDelDepHBuff& rhs );
		bool operator >( const CFBamDelDepBuff& rhs );
		cfbam::CFBamDelDepBuff operator =( cfbam::CFBamDelDepBuff& src );
		cfbam::CFBamDelDepBuff operator =( cfbam::CFBamDelDepHBuff& src );
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamDelDepBuff> {
		typedef cfbam::CFBamDelDepBuff argument_type;
