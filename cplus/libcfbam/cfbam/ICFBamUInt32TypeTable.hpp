...
// Description: C++18 DbIO interface for UInt32Type.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteUInt32TypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamUInt32TypeBySchemaIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamUInt32TypeBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
