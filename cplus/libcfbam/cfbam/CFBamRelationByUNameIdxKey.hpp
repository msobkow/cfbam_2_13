...
// Description: C++18 specification for a Relation by UNameIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamRelationByUNameIdxKey();
		CFBamRelationByUNameIdxKey( const CFBamRelationByUNameIdxKey& src );
		virtual ~CFBamRelationByUNameIdxKey();
		...
		bool operator >( const CFBamRelationHBuff& rhs );
		bool operator >( const CFBamRelationBuff& rhs );
		cfbam::CFBamRelationByUNameIdxKey operator =( cfbam::CFBamRelationByUNameIdxKey& src );
		cfbam::CFBamRelationByUNameIdxKey operator =( cfbam::CFBamRelationBuff& src );
		cfbam::CFBamRelationByUNameIdxKey operator =( cfbam::CFBamRelationHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamRelationByUNameIdxKey> {
		typedef cfbam::CFBamRelationByUNameIdxKey argument_type;
