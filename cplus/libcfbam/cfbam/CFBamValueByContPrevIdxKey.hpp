...
// Description: C++18 specification for a Value by ContPrevIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamValueByContPrevIdxKey();
		CFBamValueByContPrevIdxKey( const CFBamValueByContPrevIdxKey& src );
		virtual ~CFBamValueByContPrevIdxKey();
		...
		bool operator >( const CFBamValueHBuff& rhs );
		bool operator >( const CFBamValueBuff& rhs );
		cfbam::CFBamValueByContPrevIdxKey operator =( cfbam::CFBamValueByContPrevIdxKey& src );
		cfbam::CFBamValueByContPrevIdxKey operator =( cfbam::CFBamValueBuff& src );
		cfbam::CFBamValueByContPrevIdxKey operator =( cfbam::CFBamValueHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamValueByContPrevIdxKey> {
		typedef cfbam::CFBamValueByContPrevIdxKey argument_type;
