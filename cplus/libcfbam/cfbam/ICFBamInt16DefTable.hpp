...
// Description: C++18 DbIO interface for Int16Def.
...
namespace cfbam {
	...
	public:
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamInt16DefBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
