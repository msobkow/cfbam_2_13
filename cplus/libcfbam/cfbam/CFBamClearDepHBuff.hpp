...
// Description: C++18 specification of a ClearDep history buffer object.
...
namespace cfbam {
	...
	class CFBamClearDepHBuff : public CFBamScopeHBuff
	...
	public:
		CFBamClearDepHBuff();
		CFBamClearDepHBuff( const CFBamClearDepHBuff& src );
		virtual ~CFBamClearDepHBuff();
		...
		bool operator >( const CFBamClearDepHBuff& rhs );
		bool operator >( const CFBamClearDepBuff& rhs );
		cfbam::CFBamClearDepHBuff operator =( cfbam::CFBamClearDepBuff& src );
		cfbam::CFBamClearDepHBuff operator =( cfbam::CFBamClearDepHBuff& src );
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamClearDepHBuff> {
		typedef cfbam::CFBamClearDepHBuff argument_type;
