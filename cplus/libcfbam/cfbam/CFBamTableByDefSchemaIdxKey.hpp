...
// Description: C++18 specification for a Table by DefSchemaIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamTableByDefSchemaIdxKey();
		CFBamTableByDefSchemaIdxKey( const CFBamTableByDefSchemaIdxKey& src );
		virtual ~CFBamTableByDefSchemaIdxKey();
		...
		bool operator >( const CFBamTableHBuff& rhs );
		bool operator >( const CFBamTableBuff& rhs );
		cfbam::CFBamTableByDefSchemaIdxKey operator =( cfbam::CFBamTableByDefSchemaIdxKey& src );
		cfbam::CFBamTableByDefSchemaIdxKey operator =( cfbam::CFBamTableBuff& src );
		cfbam::CFBamTableByDefSchemaIdxKey operator =( cfbam::CFBamTableHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamTableByDefSchemaIdxKey> {
		typedef cfbam::CFBamTableByDefSchemaIdxKey argument_type;
