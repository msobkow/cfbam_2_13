...
// Description: C++18 specification for a Int32Col by TableIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamInt32ColByTableIdxKey();
		CFBamInt32ColByTableIdxKey( const CFBamInt32ColByTableIdxKey& src );
		virtual ~CFBamInt32ColByTableIdxKey();
		...
		bool operator >( const CFBamInt32ColHBuff& rhs );
		bool operator >( const CFBamInt32ColBuff& rhs );
		cfbam::CFBamInt32ColByTableIdxKey operator =( cfbam::CFBamInt32ColByTableIdxKey& src );
		cfbam::CFBamInt32ColByTableIdxKey operator =( cfbam::CFBamInt32ColBuff& src );
		cfbam::CFBamInt32ColByTableIdxKey operator =( cfbam::CFBamInt32ColHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamInt32ColByTableIdxKey> {
		typedef cfbam::CFBamInt32ColByTableIdxKey argument_type;
