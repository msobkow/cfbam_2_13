...
// Description: C++18 specification of a ServerListFunc history buffer object.
...
namespace cfbam {
	...
	class CFBamServerListFuncHBuff : public CFBamServerMethodHBuff
	...
	public:
		...
		CFBamServerListFuncHBuff( const CFBamServerListFuncHBuff& src );
		virtual ~CFBamServerListFuncHBuff();
		...
		bool operator >( const CFBamServerListFuncHBuff& rhs );
		bool operator >( const CFBamServerListFuncBuff& rhs );
		cfbam::CFBamServerListFuncHBuff operator =( cfbam::CFBamServerListFuncBuff& src );
		cfbam::CFBamServerListFuncHBuff operator =( cfbam::CFBamServerListFuncHBuff& src );
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamServerListFuncHBuff> {
		typedef cfbam::CFBamServerListFuncHBuff argument_type;
