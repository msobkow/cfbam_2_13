...
// Description: C++18 specification of a NumberDef history buffer object.
...
namespace cfbam {
	...
	class CFBamNumberDefHBuff : public CFBamAtomHBuff
	...
	public:
		CFBamNumberDefHBuff();
		CFBamNumberDefHBuff( const CFBamNumberDefHBuff& src );
		virtual ~CFBamNumberDefHBuff();
		...
		bool operator >( const CFBamNumberDefHBuff& rhs );
		bool operator >( const CFBamNumberDefBuff& rhs );
		cfbam::CFBamNumberDefHBuff operator =( cfbam::CFBamNumberDefBuff& src );
		cfbam::CFBamNumberDefHBuff operator =( cfbam::CFBamNumberDefHBuff& src );
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamNumberDefHBuff> {
		typedef cfbam::CFBamNumberDefHBuff argument_type;
