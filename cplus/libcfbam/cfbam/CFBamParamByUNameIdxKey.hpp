...
// Description: C++18 specification for a Param by UNameIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamParamByUNameIdxKey();
		CFBamParamByUNameIdxKey( const CFBamParamByUNameIdxKey& src );
		virtual ~CFBamParamByUNameIdxKey();
		...
		bool operator >( const CFBamParamHBuff& rhs );
		bool operator >( const CFBamParamBuff& rhs );
		cfbam::CFBamParamByUNameIdxKey operator =( cfbam::CFBamParamByUNameIdxKey& src );
		cfbam::CFBamParamByUNameIdxKey operator =( cfbam::CFBamParamBuff& src );
		cfbam::CFBamParamByUNameIdxKey operator =( cfbam::CFBamParamHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamParamByUNameIdxKey> {
		typedef cfbam::CFBamParamByUNameIdxKey argument_type;
