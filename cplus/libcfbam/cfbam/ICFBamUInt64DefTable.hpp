...
// Description: C++18 DbIO interface for UInt64Def.
...
namespace cfbam {
	...
	public:
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamUInt64DefBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamUInt64DefBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
