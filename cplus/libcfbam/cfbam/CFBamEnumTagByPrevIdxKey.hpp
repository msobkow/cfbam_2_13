...
// Description: C++18 specification for a EnumTag by PrevIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamEnumTagByPrevIdxKey();
		CFBamEnumTagByPrevIdxKey( const CFBamEnumTagByPrevIdxKey& src );
		virtual ~CFBamEnumTagByPrevIdxKey();
		...
		bool operator >( const CFBamEnumTagHBuff& rhs );
		bool operator >( const CFBamEnumTagBuff& rhs );
		cfbam::CFBamEnumTagByPrevIdxKey operator =( cfbam::CFBamEnumTagByPrevIdxKey& src );
		cfbam::CFBamEnumTagByPrevIdxKey operator =( cfbam::CFBamEnumTagBuff& src );
		cfbam::CFBamEnumTagByPrevIdxKey operator =( cfbam::CFBamEnumTagHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamEnumTagByPrevIdxKey> {
		typedef cfbam::CFBamEnumTagByPrevIdxKey argument_type;
