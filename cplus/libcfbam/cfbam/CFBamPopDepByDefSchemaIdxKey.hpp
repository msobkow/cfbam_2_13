...
// Description: C++18 specification for a PopDep by DefSchemaIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamPopDepByDefSchemaIdxKey();
		CFBamPopDepByDefSchemaIdxKey( const CFBamPopDepByDefSchemaIdxKey& src );
		virtual ~CFBamPopDepByDefSchemaIdxKey();
		...
		bool operator >( const CFBamPopDepHBuff& rhs );
		bool operator >( const CFBamPopDepBuff& rhs );
		cfbam::CFBamPopDepByDefSchemaIdxKey operator =( cfbam::CFBamPopDepByDefSchemaIdxKey& src );
		cfbam::CFBamPopDepByDefSchemaIdxKey operator =( cfbam::CFBamPopDepBuff& src );
		cfbam::CFBamPopDepByDefSchemaIdxKey operator =( cfbam::CFBamPopDepHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamPopDepByDefSchemaIdxKey> {
		typedef cfbam::CFBamPopDepByDefSchemaIdxKey argument_type;
