...
// Description: C++18 DbIO interface for Int32Type.
...
namespace cfbam {
	...
	public:
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamInt32TypeBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
