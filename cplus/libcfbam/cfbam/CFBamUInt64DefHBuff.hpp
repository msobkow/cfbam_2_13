...
// Description: C++18 specification of a UInt64Def history buffer object.
...
namespace cfbam {
	...
	class CFBamUInt64DefHBuff : public CFBamAtomHBuff
	...
	public:
		CFBamUInt64DefHBuff();
		CFBamUInt64DefHBuff( const CFBamUInt64DefHBuff& src );
		virtual ~CFBamUInt64DefHBuff();
		...
		bool operator >( const CFBamUInt64DefHBuff& rhs );
		bool operator >( const CFBamUInt64DefBuff& rhs );
		cfbam::CFBamUInt64DefHBuff operator =( cfbam::CFBamUInt64DefBuff& src );
		cfbam::CFBamUInt64DefHBuff operator =( cfbam::CFBamUInt64DefHBuff& src );
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamUInt64DefHBuff> {
		typedef cfbam::CFBamUInt64DefHBuff argument_type;
