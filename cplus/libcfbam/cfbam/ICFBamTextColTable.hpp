...
// Description: C++18 DbIO interface for TextCol.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteTextColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamTextColByTableIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamTextColBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamTextColBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
