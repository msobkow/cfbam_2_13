...
// Description: C++18 DbIO interface for UuidCol.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteUuidColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamUuidColByTableIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamUuidColBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
