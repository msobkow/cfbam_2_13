...
// Description: C++18 specification for a RelationCol by NextIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamRelationColByNextIdxKey();
		CFBamRelationColByNextIdxKey( const CFBamRelationColByNextIdxKey& src );
		virtual ~CFBamRelationColByNextIdxKey();
		...
		bool operator >( const CFBamRelationColHBuff& rhs );
		bool operator >( const CFBamRelationColBuff& rhs );
		cfbam::CFBamRelationColByNextIdxKey operator =( cfbam::CFBamRelationColByNextIdxKey& src );
		cfbam::CFBamRelationColByNextIdxKey operator =( cfbam::CFBamRelationColBuff& src );
		cfbam::CFBamRelationColByNextIdxKey operator =( cfbam::CFBamRelationColHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamRelationColByNextIdxKey> {
		typedef cfbam::CFBamRelationColByNextIdxKey argument_type;
