...
// Description: C++18 specification for a PopSubDep1 by PopTopDepIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamPopSubDep1ByPopTopDepIdxKey();
		CFBamPopSubDep1ByPopTopDepIdxKey( const CFBamPopSubDep1ByPopTopDepIdxKey& src );
		virtual ~CFBamPopSubDep1ByPopTopDepIdxKey();
		...
		bool operator >( const CFBamPopSubDep1HBuff& rhs );
		bool operator >( const CFBamPopSubDep1Buff& rhs );
		cfbam::CFBamPopSubDep1ByPopTopDepIdxKey operator =( cfbam::CFBamPopSubDep1ByPopTopDepIdxKey& src );
		cfbam::CFBamPopSubDep1ByPopTopDepIdxKey operator =( cfbam::CFBamPopSubDep1Buff& src );
		cfbam::CFBamPopSubDep1ByPopTopDepIdxKey operator =( cfbam::CFBamPopSubDep1HBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamPopSubDep1ByPopTopDepIdxKey> {
		typedef cfbam::CFBamPopSubDep1ByPopTopDepIdxKey argument_type;
