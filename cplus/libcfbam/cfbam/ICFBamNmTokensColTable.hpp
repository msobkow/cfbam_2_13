...
// Description: C++18 DbIO interface for NmTokensCol.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteNmTokensColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamNmTokensColByTableIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamNmTokensColBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamNmTokensColBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
