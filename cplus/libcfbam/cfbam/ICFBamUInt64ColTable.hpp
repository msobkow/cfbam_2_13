...
// Description: C++18 DbIO interface for UInt64Col.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteUInt64ColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamUInt64ColByTableIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamUInt64ColBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
