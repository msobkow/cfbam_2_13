...
// Description: C++18 specification of a Id64Gen history buffer object.
...
namespace cfbam {
	...
	class CFBamId64GenHBuff : public CFBamInt64TypeHBuff
	...
	public:
		CFBamId64GenHBuff();
		CFBamId64GenHBuff( const CFBamId64GenHBuff& src );
		virtual ~CFBamId64GenHBuff();
		...
		bool operator >( const CFBamId64GenHBuff& rhs );
		bool operator >( const CFBamId64GenBuff& rhs );
		cfbam::CFBamId64GenHBuff operator =( cfbam::CFBamId64GenBuff& src );
		cfbam::CFBamId64GenHBuff operator =( cfbam::CFBamId64GenHBuff& src );
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamId64GenHBuff> {
		typedef cfbam::CFBamId64GenHBuff argument_type;
