...
// Description: C++18 specification for a EnumTag by DefSchemaIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamEnumTagByDefSchemaIdxKey();
		CFBamEnumTagByDefSchemaIdxKey( const CFBamEnumTagByDefSchemaIdxKey& src );
		virtual ~CFBamEnumTagByDefSchemaIdxKey();
		...
		bool operator >( const CFBamEnumTagHBuff& rhs );
		bool operator >( const CFBamEnumTagBuff& rhs );
		cfbam::CFBamEnumTagByDefSchemaIdxKey operator =( cfbam::CFBamEnumTagByDefSchemaIdxKey& src );
		cfbam::CFBamEnumTagByDefSchemaIdxKey operator =( cfbam::CFBamEnumTagBuff& src );
		cfbam::CFBamEnumTagByDefSchemaIdxKey operator =( cfbam::CFBamEnumTagHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamEnumTagByDefSchemaIdxKey> {
		typedef cfbam::CFBamEnumTagByDefSchemaIdxKey argument_type;
