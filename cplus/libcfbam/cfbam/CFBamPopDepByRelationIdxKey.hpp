...
// Description: C++18 specification for a PopDep by RelationIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamPopDepByRelationIdxKey();
		CFBamPopDepByRelationIdxKey( const CFBamPopDepByRelationIdxKey& src );
		virtual ~CFBamPopDepByRelationIdxKey();
		...
		bool operator >( const CFBamPopDepHBuff& rhs );
		bool operator >( const CFBamPopDepBuff& rhs );
		cfbam::CFBamPopDepByRelationIdxKey operator =( cfbam::CFBamPopDepByRelationIdxKey& src );
		cfbam::CFBamPopDepByRelationIdxKey operator =( cfbam::CFBamPopDepBuff& src );
		cfbam::CFBamPopDepByRelationIdxKey operator =( cfbam::CFBamPopDepHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamPopDepByRelationIdxKey> {
		typedef cfbam::CFBamPopDepByRelationIdxKey argument_type;
