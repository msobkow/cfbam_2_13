...
// Description: C++18 DbIO interface for DoubleType.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteDoubleTypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamDoubleTypeBySchemaIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamDoubleTypeBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
