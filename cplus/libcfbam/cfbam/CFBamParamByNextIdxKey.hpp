...
// Description: C++18 specification for a Param by NextIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamParamByNextIdxKey();
		CFBamParamByNextIdxKey( const CFBamParamByNextIdxKey& src );
		virtual ~CFBamParamByNextIdxKey();
		...
		bool operator >( const CFBamParamHBuff& rhs );
		bool operator >( const CFBamParamBuff& rhs );
		cfbam::CFBamParamByNextIdxKey operator =( cfbam::CFBamParamByNextIdxKey& src );
		cfbam::CFBamParamByNextIdxKey operator =( cfbam::CFBamParamBuff& src );
		cfbam::CFBamParamByNextIdxKey operator =( cfbam::CFBamParamHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamParamByNextIdxKey> {
		typedef cfbam::CFBamParamByNextIdxKey argument_type;
