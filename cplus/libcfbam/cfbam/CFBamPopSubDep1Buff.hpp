...
// Description: C++18 specification for a PopSubDep1 buffer object.
...
namespace cfbam {
	...
	class CFBamPopSubDep1Buff : public CFBamPopDepBuff
	{
	public:
		static const std::string GENDEFNAME;
		static const classcode_t CLASS_CODE;
		static const std::string CLASS_NAME;
		static const std::string COLNAME_POPTOPDEPTENANTID;
		static const std::string COLNAME_POPTOPDEPID;
		static const std::string COLNAME_NAME;
		static const int64_t TENANTID_INIT_VALUE;
		static const int64_t ID_INIT_VALUE;
		static const int64_t POPTOPDEPTENANTID_INIT_VALUE;
		static const int64_t POPTOPDEPID_INIT_VALUE;
		static const std::string NAME_INIT_VALUE;
		static const int64_t TENANTID_MIN_VALUE;
		static const int64_t ID_MIN_VALUE;
		static const int64_t POPTOPDEPTENANTID_MIN_VALUE;
		static const int64_t POPTOPDEPID_MIN_VALUE;
	...
	public:
		CFBamPopSubDep1Buff();
		CFBamPopSubDep1Buff( const CFBamPopSubDep1Buff& src );
		virtual ~CFBamPopSubDep1Buff();
		...
		bool operator <( const CFBamPopSubDep1ByPopTopDepIdxKey& rhs );
		...
		bool operator >( const CFBamPopSubDep1HBuff& rhs );
		bool operator >( const CFBamPopSubDep1Buff& rhs );
		cfbam::CFBamPopSubDep1Buff operator =( cfbam::CFBamPopSubDep1Buff& src );
		cfbam::CFBamPopSubDep1Buff operator =( cfbam::CFBamPopSubDep1HBuff& src );
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamPopSubDep1Buff> {
		typedef cfbam::CFBamPopSubDep1Buff argument_type;
