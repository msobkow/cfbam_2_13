...
// Description: C++18 specification for a IndexCol by ColIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamIndexColByColIdxKey();
		CFBamIndexColByColIdxKey( const CFBamIndexColByColIdxKey& src );
		virtual ~CFBamIndexColByColIdxKey();
		...
		bool operator >( const CFBamIndexColHBuff& rhs );
		bool operator >( const CFBamIndexColBuff& rhs );
		cfbam::CFBamIndexColByColIdxKey operator =( cfbam::CFBamIndexColByColIdxKey& src );
		cfbam::CFBamIndexColByColIdxKey operator =( cfbam::CFBamIndexColBuff& src );
		cfbam::CFBamIndexColByColIdxKey operator =( cfbam::CFBamIndexColHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamIndexColByColIdxKey> {
		typedef cfbam::CFBamIndexColByColIdxKey argument_type;
