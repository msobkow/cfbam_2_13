...
// Description: C++18 DbIO interface for DateType.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteDateTypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamDateTypeBySchemaIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamDateTypeBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamDateTypeBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
