...
// Description: C++18 specification for a DateType buffer object.
...
namespace cfbam {
	...
	class CFBamDateTypeBuff : public CFBamDateDefBuff
	{
	public:
	...
	public:
		CFBamDateTypeBuff();
		CFBamDateTypeBuff( const CFBamDateTypeBuff& src );
		virtual ~CFBamDateTypeBuff();
		...
		bool operator >( const CFBamDateTypeHBuff& rhs );
		bool operator >( const CFBamDateTypeBuff& rhs );
		cfbam::CFBamDateTypeBuff operator =( cfbam::CFBamDateTypeBuff& src );
		cfbam::CFBamDateTypeBuff operator =( cfbam::CFBamDateTypeHBuff& src );
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamDateTypeBuff> {
		typedef cfbam::CFBamDateTypeBuff argument_type;
