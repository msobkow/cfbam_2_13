...
// Description: C++18 DbIO interface for Int32Col.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteInt32ColByTableIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamInt32ColByTableIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamInt32ColBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
