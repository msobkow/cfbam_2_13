...
// Description: C++18 DbIO interface for NmTokensDef.
...
namespace cfbam {
	...
	public:
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamNmTokensDefBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
