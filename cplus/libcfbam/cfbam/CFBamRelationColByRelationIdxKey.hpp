...
// Description: C++18 specification for a RelationCol by RelationIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamRelationColByRelationIdxKey();
		CFBamRelationColByRelationIdxKey( const CFBamRelationColByRelationIdxKey& src );
		virtual ~CFBamRelationColByRelationIdxKey();
		...
		bool operator >( const CFBamRelationColHBuff& rhs );
		bool operator >( const CFBamRelationColBuff& rhs );
		cfbam::CFBamRelationColByRelationIdxKey operator =( cfbam::CFBamRelationColByRelationIdxKey& src );
		cfbam::CFBamRelationColByRelationIdxKey operator =( cfbam::CFBamRelationColBuff& src );
		cfbam::CFBamRelationColByRelationIdxKey operator =( cfbam::CFBamRelationColHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamRelationColByRelationIdxKey> {
		typedef cfbam::CFBamRelationColByRelationIdxKey argument_type;
