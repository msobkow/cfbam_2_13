...
// Description: C++18 specification for a RelationCol by ToColIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamRelationColByToColIdxKey();
		CFBamRelationColByToColIdxKey( const CFBamRelationColByToColIdxKey& src );
		virtual ~CFBamRelationColByToColIdxKey();
		...
		bool operator >( const CFBamRelationColHBuff& rhs );
		bool operator >( const CFBamRelationColBuff& rhs );
		cfbam::CFBamRelationColByToColIdxKey operator =( cfbam::CFBamRelationColByToColIdxKey& src );
		cfbam::CFBamRelationColByToColIdxKey operator =( cfbam::CFBamRelationColBuff& src );
		cfbam::CFBamRelationColByToColIdxKey operator =( cfbam::CFBamRelationColHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamRelationColByToColIdxKey> {
		typedef cfbam::CFBamRelationColByToColIdxKey argument_type;
