...
// Description: C++18 specification for a ClearSubDep2 by UNameIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamClearSubDep2ByUNameIdxKey();
		CFBamClearSubDep2ByUNameIdxKey( const CFBamClearSubDep2ByUNameIdxKey& src );
		virtual ~CFBamClearSubDep2ByUNameIdxKey();
		...
		bool operator >( const CFBamClearSubDep2HBuff& rhs );
		bool operator >( const CFBamClearSubDep2Buff& rhs );
		cfbam::CFBamClearSubDep2ByUNameIdxKey operator =( cfbam::CFBamClearSubDep2ByUNameIdxKey& src );
		cfbam::CFBamClearSubDep2ByUNameIdxKey operator =( cfbam::CFBamClearSubDep2Buff& src );
		cfbam::CFBamClearSubDep2ByUNameIdxKey operator =( cfbam::CFBamClearSubDep2HBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamClearSubDep2ByUNameIdxKey> {
		typedef cfbam::CFBamClearSubDep2ByUNameIdxKey argument_type;
