...
// Description: C++18 DbIO interface for PopSubDep1.
...
namespace cfbam {
	...
	public:
		...
		virtual void deletePopSubDep1ByPopTopDepIdx( const cfsec::CFSecAuthorization* Authorization,
			...
			const int64_t argPopTopDepId ) = 0;

		virtual void deletePopSubDep1ByPopTopDepIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamPopSubDep1ByPopTopDepIdxKey* argKey ) = 0;
		...
		virtual void deletePopSubDep1ByUNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamPopSubDep1ByUNameIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamPopSubDep1Buff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamPopSubDep1Buff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
