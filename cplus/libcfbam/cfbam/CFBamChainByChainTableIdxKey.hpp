...
// Description: C++18 specification for a Chain by ChainTableIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamChainByChainTableIdxKey();
		CFBamChainByChainTableIdxKey( const CFBamChainByChainTableIdxKey& src );
		virtual ~CFBamChainByChainTableIdxKey();
		...
		bool operator >( const CFBamChainHBuff& rhs );
		bool operator >( const CFBamChainBuff& rhs );
		cfbam::CFBamChainByChainTableIdxKey operator =( cfbam::CFBamChainByChainTableIdxKey& src );
		cfbam::CFBamChainByChainTableIdxKey operator =( cfbam::CFBamChainBuff& src );
		cfbam::CFBamChainByChainTableIdxKey operator =( cfbam::CFBamChainHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamChainByChainTableIdxKey> {
		typedef cfbam::CFBamChainByChainTableIdxKey argument_type;
