...
// Description: C++18 specification for a SchemaDef by MinorVersionIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamSchemaDefByMinorVersionIdxKey();
		CFBamSchemaDefByMinorVersionIdxKey( const CFBamSchemaDefByMinorVersionIdxKey& src );
		virtual ~CFBamSchemaDefByMinorVersionIdxKey();
		...
		bool operator >( const CFBamSchemaDefHBuff& rhs );
		bool operator >( const CFBamSchemaDefBuff& rhs );
		cfbam::CFBamSchemaDefByMinorVersionIdxKey operator =( cfbam::CFBamSchemaDefByMinorVersionIdxKey& src );
		cfbam::CFBamSchemaDefByMinorVersionIdxKey operator =( cfbam::CFBamSchemaDefBuff& src );
		cfbam::CFBamSchemaDefByMinorVersionIdxKey operator =( cfbam::CFBamSchemaDefHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamSchemaDefByMinorVersionIdxKey> {
		typedef cfbam::CFBamSchemaDefByMinorVersionIdxKey argument_type;
