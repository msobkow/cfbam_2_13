...
// Description: C++18 DbIO interface for Int32Def.
...
namespace cfbam {
	...
	public:
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamInt32DefBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
