...
// Description: C++18 specification for a IndexCol by NextIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamIndexColByNextIdxKey();
		CFBamIndexColByNextIdxKey( const CFBamIndexColByNextIdxKey& src );
		virtual ~CFBamIndexColByNextIdxKey();
		...
		bool operator >( const CFBamIndexColHBuff& rhs );
		bool operator >( const CFBamIndexColBuff& rhs );
		cfbam::CFBamIndexColByNextIdxKey operator =( cfbam::CFBamIndexColByNextIdxKey& src );
		cfbam::CFBamIndexColByNextIdxKey operator =( cfbam::CFBamIndexColBuff& src );
		cfbam::CFBamIndexColByNextIdxKey operator =( cfbam::CFBamIndexColHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamIndexColByNextIdxKey> {
		typedef cfbam::CFBamIndexColByNextIdxKey argument_type;
