...
// Description: C++18 DbIO interface for Int64Def.
...
namespace cfbam {
	...
	public:
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamInt64DefBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
