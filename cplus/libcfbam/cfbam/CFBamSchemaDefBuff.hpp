...
// Description: C++18 specification for a SchemaDef buffer object.
...
namespace cfbam {
	...
	class CFBamSchemaDefBuff : public CFBamScopeBuff
	{
	public:
		static const std::string GENDEFNAME;
		static const classcode_t CLASS_CODE;
		static const std::string CLASS_NAME;
		static const std::string COLNAME_MINORVERSIONID;
		...
		static const std::string COLNAME_COPYRIGHTPERIOD;
		static const std::string COLNAME_COPYRIGHTHOLDER;
		static const std::string COLNAME_AUTHOREMAIL;
		static const std::string COLNAME_PROJECTURL;
		static const std::string COLNAME_PUBLISHURI;
		static const std::string COLNAME_COMMONLICENSECODE;
		static const std::string COLNAME_COMMONLICENSENAME;
		static const std::string COLNAME_COMMONLICENSETEXT;
		static const std::string COLNAME_CLIENTXFACELICENSECODE;
		static const std::string COLNAME_CLIENTXFACELICENSENAME;
		static const std::string COLNAME_CLIENTXFACELICENSETEXT;
		static const std::string COLNAME_CLIENTIMPLLICENSECODE;
		static const std::string COLNAME_CLIENTIMPLLICENSENAME;
		static const std::string COLNAME_CLIENTIMPLLICENSETEXT;
		static const std::string COLNAME_SERVERXFACELICENSECODE;
		static const std::string COLNAME_SERVERXFACELICENSENAME;
		static const std::string COLNAME_SERVERXFACELICENSETEXT;
		static const std::string COLNAME_SERVERIMPLLICENSECODE;
		static const std::string COLNAME_SERVERIMPLLICENSENAME;
		static const std::string COLNAME_SERVERIMPLLICENSETEXT;
		static const std::string COLNAME_JSCHEMAOBJIMPORT;
		static const std::string COLNAME_JSCHEMAOBJINTERFACE;
		static const std::string COLNAME_JSCHEMAOBJMEMBERS;
		static const std::string COLNAME_JSCHEMAOBJIMPLEMENTATION;
		static const std::string COLNAME_JDB2LUWSCHEMAOBJMEMBERS;
		static const std::string COLNAME_JDB2LUWSCHEMAOBJIMPL;
		static const std::string COLNAME_JDB2LUWSCHEMAOBJIMPORT;
		static const std::string COLNAME_JMSSQLSCHEMAOBJMEMBERS;
		static const std::string COLNAME_JMSSQLSCHEMAOBJIMPL;
		static const std::string COLNAME_JMSSQLSCHEMAOBJIMPORT;
		static const std::string COLNAME_JMYSQLSCHEMAOBJMEMBERS;
		static const std::string COLNAME_JMYSQLSCHEMAOBJIMPL;
		static const std::string COLNAME_JMYSQLSCHEMAOBJIMPORT;
		static const std::string COLNAME_JORACLESCHEMAOBJMEMBERS;
		static const std::string COLNAME_JORACLESCHEMAOBJIMPL;
		static const std::string COLNAME_JORACLESCHEMAOBJIMPORT;
		static const std::string COLNAME_JPGSQLSCHEMAOBJMEMBERS;
		static const std::string COLNAME_JPGSQLSCHEMAOBJIMPL;
		static const std::string COLNAME_JPGSQLSCHEMAOBJIMPORT;
		static const std::string COLNAME_JRAMSCHEMAOBJMEMBERS;
		static const std::string COLNAME_JRAMSCHEMAOBJIMPL;
		static const std::string COLNAME_JRAMSCHEMAOBJIMPORT;
		static const std::string COLNAME_JXMSGSCHEMAIMPORT;
		static const std::string COLNAME_JXMSGSCHEMAFORMATTERS;
		static const std::string COLNAME_JXMSGCLIENTSCHEMAIMPORT;
		static const std::string COLNAME_JXMSGCLIENTSCHEMABODY;
		static const std::string COLNAME_JXMSGRQSTSCHEMABODY;
		static const std::string COLNAME_JXMSGRQSTSCHEMAIMPORT;
		static const std::string COLNAME_JXMSGRQSTSCHEMAWIREPARSERS;
		static const std::string COLNAME_JXMSGRQSTSCHEMAXSDSPEC;
		static const std::string COLNAME_JXMSGRQSTSCHEMAXSDELEMENTLIST;
		static const std::string COLNAME_JXMSGRSPNSCHEMABODY;
		static const std::string COLNAME_JXMSGRSPNSCHEMAIMPORT;
		static const std::string COLNAME_JXMSGRSPNSCHEMAWIREPARSERS;
		static const std::string COLNAME_JXMSGRSPNSCHEMAXSDELEMENTLIST;
		static const std::string COLNAME_JXMSGRSPNSCHEMAXSDSPEC;
		static const std::string COLNAME_CPPSCHEMAOBJINCLUDE;
		static const std::string COLNAME_CPPSCHEMAOBJINTERFACE;
		static const std::string COLNAME_CPPSCHEMAOBJMEMBERS;
		static const std::string COLNAME_CPPSCHEMAOBJIMPLEMENTATION;
		static const std::string COLNAME_CPPDB2LUWSCHEMAOBJMEMBERS;
		static const std::string COLNAME_CPPDB2LUWSCHEMAOBJIMPL;
		static const std::string COLNAME_CPPDB2LUWSCHEMAOBJINCLUDE;
		static const std::string COLNAME_CPPMSSQLSCHEMAOBJMEMBERS;
		static const std::string COLNAME_CPPMSSQLSCHEMAOBJIMPL;
		static const std::string COLNAME_CPPMSSQLSCHEMAOBJINCLUDE;
		static const std::string COLNAME_CPPMYSQLSCHEMAOBJMEMBERS;
		static const std::string COLNAME_CPPMYSQLSCHEMAOBJIMPL;
		static const std::string COLNAME_CPPMYSQLSCHEMAOBJINCLUDE;
		static const std::string COLNAME_CPPORACLESCHEMAOBJMEMBERS;
		static const std::string COLNAME_CPPORACLESCHEMAOBJIMPL;
		static const std::string COLNAME_CPPORACLESCHEMAOBJINCLUDE;
		static const std::string COLNAME_CPPPGSQLSCHEMAOBJMEMBERS;
		static const std::string COLNAME_CPPPGSQLSCHEMAOBJIMPL;
		static const std::string COLNAME_CPPPGSQLSCHEMAOBJINCLUDE;
		static const std::string COLNAME_CPPRAMSCHEMAOBJMEMBERS;
		static const std::string COLNAME_CPPRAMSCHEMAOBJIMPL;
		static const std::string COLNAME_CPPRAMSCHEMAOBJINCLUDE;
		static const std::string COLNAME_CPPXMSGSCHEMAINCLUDE;
		static const std::string COLNAME_CPPXMSGSCHEMAFORMATTERS;
		static const std::string COLNAME_CPPXMSGCLIENTSCHEMAINCLUDE;
		static const std::string COLNAME_CPPXMSGCLIENTSCHEMABODY;
		static const std::string COLNAME_CPPXMSGRQSTSCHEMABODY;
		static const std::string COLNAME_CPPXMSGRQSTSCHEMAINCLUDE;
		static const std::string COLNAME_CPPXMSGRQSTSCHEMAWIREPARSERS;
		static const std::string COLNAME_CPPXMSGRQSTSCHEMAXSDSPEC;
		static const std::string COLNAME_CPPXMSGRQSTSCHEMAXSDELEMENTLIST;
		static const std::string COLNAME_CPPXMSGRSPNSCHEMABODY;
		static const std::string COLNAME_CPPXMSGRSPNSCHEMAINCLUDE;
		static const std::string COLNAME_CPPXMSGRSPNSCHEMAWIREPARSERS;
		static const std::string COLNAME_CPPXMSGRSPNSCHEMAXSDELEMENTLIST;
		static const std::string COLNAME_CPPXMSGRSPNSCHEMAXSDSPEC;
		static const std::string COLNAME_HPPSCHEMAOBJINCLUDE;
		static const std::string COLNAME_HPPSCHEMAOBJINTERFACE;
		static const std::string COLNAME_HPPSCHEMAOBJMEMBERS;
		static const std::string COLNAME_HPPSCHEMAOBJIMPLEMENTATION;
		static const std::string COLNAME_HPPDB2LUWSCHEMAOBJMEMBERS;
		static const std::string COLNAME_HPPDB2LUWSCHEMAOBJIMPL;
		static const std::string COLNAME_HPPDB2LUWSCHEMAOBJINCLUDE;
		static const std::string COLNAME_HPPMSSQLSCHEMAOBJMEMBERS;
		static const std::string COLNAME_HPPMSSQLSCHEMAOBJIMPL;
		static const std::string COLNAME_HPPMSSQLSCHEMAOBJINCLUDE;
		static const std::string COLNAME_HPPMYSQLSCHEMAOBJMEMBERS;
		static const std::string COLNAME_HPPMYSQLSCHEMAOBJIMPL;
		static const std::string COLNAME_HPPMYSQLSCHEMAOBJINCLUDE;
		static const std::string COLNAME_HPPORACLESCHEMAOBJMEMBERS;
		static const std::string COLNAME_HPPORACLESCHEMAOBJIMPL;
		static const std::string COLNAME_HPPORACLESCHEMAOBJINCLUDE;
		static const std::string COLNAME_HPPPGSQLSCHEMAOBJMEMBERS;
		static const std::string COLNAME_HPPPGSQLSCHEMAOBJIMPL;
		static const std::string COLNAME_HPPPGSQLSCHEMAOBJINCLUDE;
		static const std::string COLNAME_HPPRAMSCHEMAOBJMEMBERS;
		static const std::string COLNAME_HPPRAMSCHEMAOBJIMPL;
		static const std::string COLNAME_HPPRAMSCHEMAOBJINCLUDE;
		static const std::string COLNAME_HPPXMSGSCHEMAINCLUDE;
		static const std::string COLNAME_HPPXMSGSCHEMAFORMATTERS;
		static const std::string COLNAME_HPPXMSGCLIENTSCHEMAINCLUDE;
		static const std::string COLNAME_HPPXMSGCLIENTSCHEMABODY;
		static const std::string COLNAME_HPPXMSGRQSTSCHEMABODY;
		static const std::string COLNAME_HPPXMSGRQSTSCHEMAINCLUDE;
		static const std::string COLNAME_HPPXMSGRQSTSCHEMAWIREPARSERS;
		static const std::string COLNAME_HPPXMSGRQSTSCHEMAXSDSPEC;
		static const std::string COLNAME_HPPXMSGRQSTSCHEMAXSDELEMENTLIST;
		static const std::string COLNAME_HPPXMSGRSPNSCHEMABODY;
		static const std::string COLNAME_HPPXMSGRSPNSCHEMAINCLUDE;
		static const std::string COLNAME_HPPXMSGRSPNSCHEMAWIREPARSERS;
		static const std::string COLNAME_HPPXMSGRSPNSCHEMAXSDELEMENTLIST;
		static const std::string COLNAME_HPPXMSGRSPNSCHEMAXSDSPEC;
		static const std::string COLNAME_CSSCHEMAOBJUSING;
		static const std::string COLNAME_CSSCHEMAOBJINTERFACE;
		static const std::string COLNAME_CSSCHEMAOBJMEMBERS;
		static const std::string COLNAME_CSSCHEMAOBJIMPLEMENTATION;
		static const std::string COLNAME_CSDB2LUWSCHEMAOBJMEMBERS;
		static const std::string COLNAME_CSDB2LUWSCHEMAOBJIMPL;
		static const std::string COLNAME_CSDB2LUWSCHEMAOBJUSING;
		static const std::string COLNAME_CSMSSQLSCHEMAOBJMEMBERS;
		static const std::string COLNAME_CSMSSQLSCHEMAOBJIMPL;
		static const std::string COLNAME_CSMSSQLSCHEMAOBJUSING;
		static const std::string COLNAME_CSMYSQLSCHEMAOBJMEMBERS;
		static const std::string COLNAME_CSMYSQLSCHEMAOBJIMPL;
		static const std::string COLNAME_CSMYSQLSCHEMAOBJUSING;
		static const std::string COLNAME_CSORACLESCHEMAOBJMEMBERS;
		static const std::string COLNAME_CSORACLESCHEMAOBJIMPL;
		static const std::string COLNAME_CSORACLESCHEMAOBJUSING;
		static const std::string COLNAME_CSPGSQLSCHEMAOBJMEMBERS;
		static const std::string COLNAME_CSPGSQLSCHEMAOBJIMPL;
		static const std::string COLNAME_CSPGSQLSCHEMAOBJUSING;
		static const std::string COLNAME_CSRAMSCHEMAOBJMEMBERS;
		static const std::string COLNAME_CSRAMSCHEMAOBJIMPL;
		static const std::string COLNAME_CSRAMSCHEMAOBJUSING;
		static const std::string COLNAME_CSXMSGSCHEMAUSING;
		static const std::string COLNAME_CSXMSGSCHEMAFORMATTERS;
		static const std::string COLNAME_CSXMSGCLIENTSCHEMAUSING;
		static const std::string COLNAME_CSXMSGCLIENTSCHEMABODY;
		static const std::string COLNAME_CSXMSGRQSTSCHEMABODY;
		static const std::string COLNAME_CSXMSGRQSTSCHEMAUSING;
		static const std::string COLNAME_CSXMSGRQSTSCHEMAWIREPARSERS;
		static const std::string COLNAME_CSXMSGRQSTSCHEMAXSDSPEC;
		static const std::string COLNAME_CSXMSGRQSTSCHEMAXSDELEMENTLIST;
		static const std::string COLNAME_CSXMSGRSPNSCHEMABODY;
		static const std::string COLNAME_CSXMSGRSPNSCHEMAUSING;
		static const std::string COLNAME_CSXMSGRSPNSCHEMAWIREPARSERS;
		static const std::string COLNAME_CSXMSGRSPNSCHEMAXSDELEMENTLIST;
		static const std::string COLNAME_CSXMSGRSPNSCHEMAXSDSPEC;
		static const int64_t TENANTID_INIT_VALUE;
		static const int64_t ID_INIT_VALUE;
		static const int64_t MINORVERSIONID_INIT_VALUE;
		static const std::string NAME_INIT_VALUE;
		static const std::string COPYRIGHTPERIOD_INIT_VALUE;
		static const std::string COPYRIGHTHOLDER_INIT_VALUE;
		static const std::string AUTHOREMAIL_INIT_VALUE;
		static const std::string PROJECTURL_INIT_VALUE;
		static const std::string PUBLISHURI_INIT_VALUE;
		static const std::string COMMONLICENSECODE_INIT_VALUE;
		static const std::string COMMONLICENSENAME_INIT_VALUE;
		static const std::string COMMONLICENSETEXT_INIT_VALUE;
		static const std::string CLIENTXFACELICENSECODE_INIT_VALUE;
		static const std::string CLIENTXFACELICENSENAME_INIT_VALUE;
		static const std::string CLIENTXFACELICENSETEXT_INIT_VALUE;
		static const std::string CLIENTIMPLLICENSECODE_INIT_VALUE;
		static const std::string CLIENTIMPLLICENSENAME_INIT_VALUE;
		static const std::string CLIENTIMPLLICENSETEXT_INIT_VALUE;
		static const std::string SERVERXFACELICENSECODE_INIT_VALUE;
		static const std::string SERVERXFACELICENSENAME_INIT_VALUE;
		static const std::string SERVERXFACELICENSETEXT_INIT_VALUE;
		static const std::string SERVERIMPLLICENSECODE_INIT_VALUE;
		static const std::string SERVERIMPLLICENSENAME_INIT_VALUE;
		static const std::string SERVERIMPLLICENSETEXT_INIT_VALUE;
		static const std::string JSCHEMAOBJIMPORT_INIT_VALUE;
		static const std::string JSCHEMAOBJINTERFACE_INIT_VALUE;
		static const std::string JSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string JSCHEMAOBJIMPLEMENTATION_INIT_VALUE;
		static const std::string JDB2LUWSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string JDB2LUWSCHEMAOBJIMPL_INIT_VALUE;
		static const std::string JDB2LUWSCHEMAOBJIMPORT_INIT_VALUE;
		static const std::string JMSSQLSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string JMSSQLSCHEMAOBJIMPL_INIT_VALUE;
		static const std::string JMSSQLSCHEMAOBJIMPORT_INIT_VALUE;
		static const std::string JMYSQLSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string JMYSQLSCHEMAOBJIMPL_INIT_VALUE;
		static const std::string JMYSQLSCHEMAOBJIMPORT_INIT_VALUE;
		static const std::string JORACLESCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string JORACLESCHEMAOBJIMPL_INIT_VALUE;
		static const std::string JORACLESCHEMAOBJIMPORT_INIT_VALUE;
		static const std::string JPGSQLSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string JPGSQLSCHEMAOBJIMPL_INIT_VALUE;
		static const std::string JPGSQLSCHEMAOBJIMPORT_INIT_VALUE;
		static const std::string JRAMSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string JRAMSCHEMAOBJIMPL_INIT_VALUE;
		static const std::string JRAMSCHEMAOBJIMPORT_INIT_VALUE;
		static const std::string JXMSGSCHEMAIMPORT_INIT_VALUE;
		static const std::string JXMSGSCHEMAFORMATTERS_INIT_VALUE;
		static const std::string JXMSGCLIENTSCHEMAIMPORT_INIT_VALUE;
		static const std::string JXMSGCLIENTSCHEMABODY_INIT_VALUE;
		static const std::string JXMSGRQSTSCHEMABODY_INIT_VALUE;
		static const std::string JXMSGRQSTSCHEMAIMPORT_INIT_VALUE;
		static const std::string JXMSGRQSTSCHEMAWIREPARSERS_INIT_VALUE;
		static const std::string JXMSGRQSTSCHEMAXSDSPEC_INIT_VALUE;
		static const std::string JXMSGRQSTSCHEMAXSDELEMENTLIST_INIT_VALUE;
		static const std::string JXMSGRSPNSCHEMABODY_INIT_VALUE;
		static const std::string JXMSGRSPNSCHEMAIMPORT_INIT_VALUE;
		static const std::string JXMSGRSPNSCHEMAWIREPARSERS_INIT_VALUE;
		static const std::string JXMSGRSPNSCHEMAXSDELEMENTLIST_INIT_VALUE;
		static const std::string JXMSGRSPNSCHEMAXSDSPEC_INIT_VALUE;
		static const std::string CPPSCHEMAOBJINCLUDE_INIT_VALUE;
		static const std::string CPPSCHEMAOBJINTERFACE_INIT_VALUE;
		static const std::string CPPSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string CPPSCHEMAOBJIMPLEMENTATION_INIT_VALUE;
		static const std::string CPPDB2LUWSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string CPPDB2LUWSCHEMAOBJIMPL_INIT_VALUE;
		static const std::string CPPDB2LUWSCHEMAOBJINCLUDE_INIT_VALUE;
		static const std::string CPPMSSQLSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string CPPMSSQLSCHEMAOBJIMPL_INIT_VALUE;
		static const std::string CPPMSSQLSCHEMAOBJINCLUDE_INIT_VALUE;
		static const std::string CPPMYSQLSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string CPPMYSQLSCHEMAOBJIMPL_INIT_VALUE;
		static const std::string CPPMYSQLSCHEMAOBJINCLUDE_INIT_VALUE;
		static const std::string CPPORACLESCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string CPPORACLESCHEMAOBJIMPL_INIT_VALUE;
		static const std::string CPPORACLESCHEMAOBJINCLUDE_INIT_VALUE;
		static const std::string CPPPGSQLSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string CPPPGSQLSCHEMAOBJIMPL_INIT_VALUE;
		static const std::string CPPPGSQLSCHEMAOBJINCLUDE_INIT_VALUE;
		static const std::string CPPRAMSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string CPPRAMSCHEMAOBJIMPL_INIT_VALUE;
		static const std::string CPPRAMSCHEMAOBJINCLUDE_INIT_VALUE;
		static const std::string CPPXMSGSCHEMAINCLUDE_INIT_VALUE;
		static const std::string CPPXMSGSCHEMAFORMATTERS_INIT_VALUE;
		static const std::string CPPXMSGCLIENTSCHEMAINCLUDE_INIT_VALUE;
		static const std::string CPPXMSGCLIENTSCHEMABODY_INIT_VALUE;
		static const std::string CPPXMSGRQSTSCHEMABODY_INIT_VALUE;
		static const std::string CPPXMSGRQSTSCHEMAINCLUDE_INIT_VALUE;
		static const std::string CPPXMSGRQSTSCHEMAWIREPARSERS_INIT_VALUE;
		static const std::string CPPXMSGRQSTSCHEMAXSDSPEC_INIT_VALUE;
		static const std::string CPPXMSGRQSTSCHEMAXSDELEMENTLIST_INIT_VALUE;
		static const std::string CPPXMSGRSPNSCHEMABODY_INIT_VALUE;
		static const std::string CPPXMSGRSPNSCHEMAINCLUDE_INIT_VALUE;
		static const std::string CPPXMSGRSPNSCHEMAWIREPARSERS_INIT_VALUE;
		static const std::string CPPXMSGRSPNSCHEMAXSDELEMENTLIST_INIT_VALUE;
		static const std::string CPPXMSGRSPNSCHEMAXSDSPEC_INIT_VALUE;
		static const std::string HPPSCHEMAOBJINCLUDE_INIT_VALUE;
		static const std::string HPPSCHEMAOBJINTERFACE_INIT_VALUE;
		static const std::string HPPSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string HPPSCHEMAOBJIMPLEMENTATION_INIT_VALUE;
		static const std::string HPPDB2LUWSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string HPPDB2LUWSCHEMAOBJIMPL_INIT_VALUE;
		static const std::string HPPDB2LUWSCHEMAOBJINCLUDE_INIT_VALUE;
		static const std::string HPPMSSQLSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string HPPMSSQLSCHEMAOBJIMPL_INIT_VALUE;
		static const std::string HPPMSSQLSCHEMAOBJINCLUDE_INIT_VALUE;
		static const std::string HPPMYSQLSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string HPPMYSQLSCHEMAOBJIMPL_INIT_VALUE;
		static const std::string HPPMYSQLSCHEMAOBJINCLUDE_INIT_VALUE;
		static const std::string HPPORACLESCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string HPPORACLESCHEMAOBJIMPL_INIT_VALUE;
		static const std::string HPPORACLESCHEMAOBJINCLUDE_INIT_VALUE;
		static const std::string HPPPGSQLSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string HPPPGSQLSCHEMAOBJIMPL_INIT_VALUE;
		static const std::string HPPPGSQLSCHEMAOBJINCLUDE_INIT_VALUE;
		static const std::string HPPRAMSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string HPPRAMSCHEMAOBJIMPL_INIT_VALUE;
		static const std::string HPPRAMSCHEMAOBJINCLUDE_INIT_VALUE;
		static const std::string HPPXMSGSCHEMAINCLUDE_INIT_VALUE;
		static const std::string HPPXMSGSCHEMAFORMATTERS_INIT_VALUE;
		static const std::string HPPXMSGCLIENTSCHEMAINCLUDE_INIT_VALUE;
		static const std::string HPPXMSGCLIENTSCHEMABODY_INIT_VALUE;
		static const std::string HPPXMSGRQSTSCHEMABODY_INIT_VALUE;
		static const std::string HPPXMSGRQSTSCHEMAINCLUDE_INIT_VALUE;
		static const std::string HPPXMSGRQSTSCHEMAWIREPARSERS_INIT_VALUE;
		static const std::string HPPXMSGRQSTSCHEMAXSDSPEC_INIT_VALUE;
		static const std::string HPPXMSGRQSTSCHEMAXSDELEMENTLIST_INIT_VALUE;
		static const std::string HPPXMSGRSPNSCHEMABODY_INIT_VALUE;
		static const std::string HPPXMSGRSPNSCHEMAINCLUDE_INIT_VALUE;
		static const std::string HPPXMSGRSPNSCHEMAWIREPARSERS_INIT_VALUE;
		static const std::string HPPXMSGRSPNSCHEMAXSDELEMENTLIST_INIT_VALUE;
		static const std::string HPPXMSGRSPNSCHEMAXSDSPEC_INIT_VALUE;
		static const std::string CSSCHEMAOBJUSING_INIT_VALUE;
		static const std::string CSSCHEMAOBJINTERFACE_INIT_VALUE;
		static const std::string CSSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string CSSCHEMAOBJIMPLEMENTATION_INIT_VALUE;
		static const std::string CSDB2LUWSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string CSDB2LUWSCHEMAOBJIMPL_INIT_VALUE;
		static const std::string CSDB2LUWSCHEMAOBJUSING_INIT_VALUE;
		static const std::string CSMSSQLSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string CSMSSQLSCHEMAOBJIMPL_INIT_VALUE;
		static const std::string CSMSSQLSCHEMAOBJUSING_INIT_VALUE;
		static const std::string CSMYSQLSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string CSMYSQLSCHEMAOBJIMPL_INIT_VALUE;
		static const std::string CSMYSQLSCHEMAOBJUSING_INIT_VALUE;
		static const std::string CSORACLESCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string CSORACLESCHEMAOBJIMPL_INIT_VALUE;
		static const std::string CSORACLESCHEMAOBJUSING_INIT_VALUE;
		static const std::string CSPGSQLSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string CSPGSQLSCHEMAOBJIMPL_INIT_VALUE;
		static const std::string CSPGSQLSCHEMAOBJUSING_INIT_VALUE;
		static const std::string CSRAMSCHEMAOBJMEMBERS_INIT_VALUE;
		static const std::string CSRAMSCHEMAOBJIMPL_INIT_VALUE;
		static const std::string CSRAMSCHEMAOBJUSING_INIT_VALUE;
		static const std::string CSXMSGSCHEMAUSING_INIT_VALUE;
		static const std::string CSXMSGSCHEMAFORMATTERS_INIT_VALUE;
		static const std::string CSXMSGCLIENTSCHEMAUSING_INIT_VALUE;
		static const std::string CSXMSGCLIENTSCHEMABODY_INIT_VALUE;
		static const std::string CSXMSGRQSTSCHEMABODY_INIT_VALUE;
		static const std::string CSXMSGRQSTSCHEMAUSING_INIT_VALUE;
		static const std::string CSXMSGRQSTSCHEMAWIREPARSERS_INIT_VALUE;
		static const std::string CSXMSGRQSTSCHEMAXSDSPEC_INIT_VALUE;
		static const std::string CSXMSGRQSTSCHEMAXSDELEMENTLIST_INIT_VALUE;
		static const std::string CSXMSGRSPNSCHEMABODY_INIT_VALUE;
		static const std::string CSXMSGRSPNSCHEMAUSING_INIT_VALUE;
		static const std::string CSXMSGRSPNSCHEMAWIREPARSERS_INIT_VALUE;
		static const std::string CSXMSGRSPNSCHEMAXSDELEMENTLIST_INIT_VALUE;
		static const std::string CSXMSGRSPNSCHEMAXSDSPEC_INIT_VALUE;
		static const int64_t TENANTID_MIN_VALUE;
		static const int64_t ID_MIN_VALUE;
		static const int64_t MINORVERSIONID_MIN_VALUE;
		...
		static const std::string::size_type COPYRIGHTPERIOD_MAX_LEN;
		static const std::string::size_type COPYRIGHTHOLDER_MAX_LEN;
		static const std::string::size_type AUTHOREMAIL_MAX_LEN;
		static const std::string::size_type PROJECTURL_MAX_LEN;
		static const std::string::size_type PUBLISHURI_MAX_LEN;
		static const std::string::size_type COMMONLICENSECODE_MAX_LEN;
		static const std::string::size_type COMMONLICENSENAME_MAX_LEN;
		static const std::string::size_type COMMONLICENSETEXT_MAX_LEN;
		static const std::string::size_type CLIENTXFACELICENSECODE_MAX_LEN;
		static const std::string::size_type CLIENTXFACELICENSENAME_MAX_LEN;
		static const std::string::size_type CLIENTXFACELICENSETEXT_MAX_LEN;
		static const std::string::size_type CLIENTIMPLLICENSECODE_MAX_LEN;
		static const std::string::size_type CLIENTIMPLLICENSENAME_MAX_LEN;
		static const std::string::size_type CLIENTIMPLLICENSETEXT_MAX_LEN;
		static const std::string::size_type SERVERXFACELICENSECODE_MAX_LEN;
		static const std::string::size_type SERVERXFACELICENSENAME_MAX_LEN;
		static const std::string::size_type SERVERXFACELICENSETEXT_MAX_LEN;
		static const std::string::size_type SERVERIMPLLICENSECODE_MAX_LEN;
		static const std::string::size_type SERVERIMPLLICENSENAME_MAX_LEN;
		static const std::string::size_type SERVERIMPLLICENSETEXT_MAX_LEN;
		static const std::string::size_type JSCHEMAOBJIMPORT_MAX_LEN;
		static const std::string::size_type JSCHEMAOBJINTERFACE_MAX_LEN;
		static const std::string::size_type JSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type JSCHEMAOBJIMPLEMENTATION_MAX_LEN;
		static const std::string::size_type JDB2LUWSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type JDB2LUWSCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type JDB2LUWSCHEMAOBJIMPORT_MAX_LEN;
		static const std::string::size_type JMSSQLSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type JMSSQLSCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type JMSSQLSCHEMAOBJIMPORT_MAX_LEN;
		static const std::string::size_type JMYSQLSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type JMYSQLSCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type JMYSQLSCHEMAOBJIMPORT_MAX_LEN;
		static const std::string::size_type JORACLESCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type JORACLESCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type JORACLESCHEMAOBJIMPORT_MAX_LEN;
		static const std::string::size_type JPGSQLSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type JPGSQLSCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type JPGSQLSCHEMAOBJIMPORT_MAX_LEN;
		static const std::string::size_type JRAMSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type JRAMSCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type JRAMSCHEMAOBJIMPORT_MAX_LEN;
		static const std::string::size_type JXMSGSCHEMAIMPORT_MAX_LEN;
		static const std::string::size_type JXMSGSCHEMAFORMATTERS_MAX_LEN;
		static const std::string::size_type JXMSGCLIENTSCHEMAIMPORT_MAX_LEN;
		static const std::string::size_type JXMSGCLIENTSCHEMABODY_MAX_LEN;
		static const std::string::size_type JXMSGRQSTSCHEMABODY_MAX_LEN;
		static const std::string::size_type JXMSGRQSTSCHEMAIMPORT_MAX_LEN;
		static const std::string::size_type JXMSGRQSTSCHEMAWIREPARSERS_MAX_LEN;
		static const std::string::size_type JXMSGRQSTSCHEMAXSDSPEC_MAX_LEN;
		static const std::string::size_type JXMSGRQSTSCHEMAXSDELEMENTLIST_MAX_LEN;
		static const std::string::size_type JXMSGRSPNSCHEMABODY_MAX_LEN;
		static const std::string::size_type JXMSGRSPNSCHEMAIMPORT_MAX_LEN;
		static const std::string::size_type JXMSGRSPNSCHEMAWIREPARSERS_MAX_LEN;
		static const std::string::size_type JXMSGRSPNSCHEMAXSDELEMENTLIST_MAX_LEN;
		static const std::string::size_type JXMSGRSPNSCHEMAXSDSPEC_MAX_LEN;
		static const std::string::size_type CPPSCHEMAOBJINCLUDE_MAX_LEN;
		static const std::string::size_type CPPSCHEMAOBJINTERFACE_MAX_LEN;
		static const std::string::size_type CPPSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type CPPSCHEMAOBJIMPLEMENTATION_MAX_LEN;
		static const std::string::size_type CPPDB2LUWSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type CPPDB2LUWSCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type CPPDB2LUWSCHEMAOBJINCLUDE_MAX_LEN;
		static const std::string::size_type CPPMSSQLSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type CPPMSSQLSCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type CPPMSSQLSCHEMAOBJINCLUDE_MAX_LEN;
		static const std::string::size_type CPPMYSQLSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type CPPMYSQLSCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type CPPMYSQLSCHEMAOBJINCLUDE_MAX_LEN;
		static const std::string::size_type CPPORACLESCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type CPPORACLESCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type CPPORACLESCHEMAOBJINCLUDE_MAX_LEN;
		static const std::string::size_type CPPPGSQLSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type CPPPGSQLSCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type CPPPGSQLSCHEMAOBJINCLUDE_MAX_LEN;
		static const std::string::size_type CPPRAMSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type CPPRAMSCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type CPPRAMSCHEMAOBJINCLUDE_MAX_LEN;
		static const std::string::size_type CPPXMSGSCHEMAINCLUDE_MAX_LEN;
		static const std::string::size_type CPPXMSGSCHEMAFORMATTERS_MAX_LEN;
		static const std::string::size_type CPPXMSGCLIENTSCHEMAINCLUDE_MAX_LEN;
		static const std::string::size_type CPPXMSGCLIENTSCHEMABODY_MAX_LEN;
		static const std::string::size_type CPPXMSGRQSTSCHEMABODY_MAX_LEN;
		static const std::string::size_type CPPXMSGRQSTSCHEMAINCLUDE_MAX_LEN;
		static const std::string::size_type CPPXMSGRQSTSCHEMAWIREPARSERS_MAX_LEN;
		static const std::string::size_type CPPXMSGRQSTSCHEMAXSDSPEC_MAX_LEN;
		static const std::string::size_type CPPXMSGRQSTSCHEMAXSDELEMENTLIST_MAX_LEN;
		static const std::string::size_type CPPXMSGRSPNSCHEMABODY_MAX_LEN;
		static const std::string::size_type CPPXMSGRSPNSCHEMAINCLUDE_MAX_LEN;
		static const std::string::size_type CPPXMSGRSPNSCHEMAWIREPARSERS_MAX_LEN;
		static const std::string::size_type CPPXMSGRSPNSCHEMAXSDELEMENTLIST_MAX_LEN;
		static const std::string::size_type CPPXMSGRSPNSCHEMAXSDSPEC_MAX_LEN;
		static const std::string::size_type HPPSCHEMAOBJINCLUDE_MAX_LEN;
		static const std::string::size_type HPPSCHEMAOBJINTERFACE_MAX_LEN;
		static const std::string::size_type HPPSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type HPPSCHEMAOBJIMPLEMENTATION_MAX_LEN;
		static const std::string::size_type HPPDB2LUWSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type HPPDB2LUWSCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type HPPDB2LUWSCHEMAOBJINCLUDE_MAX_LEN;
		static const std::string::size_type HPPMSSQLSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type HPPMSSQLSCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type HPPMSSQLSCHEMAOBJINCLUDE_MAX_LEN;
		static const std::string::size_type HPPMYSQLSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type HPPMYSQLSCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type HPPMYSQLSCHEMAOBJINCLUDE_MAX_LEN;
		static const std::string::size_type HPPORACLESCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type HPPORACLESCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type HPPORACLESCHEMAOBJINCLUDE_MAX_LEN;
		static const std::string::size_type HPPPGSQLSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type HPPPGSQLSCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type HPPPGSQLSCHEMAOBJINCLUDE_MAX_LEN;
		static const std::string::size_type HPPRAMSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type HPPRAMSCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type HPPRAMSCHEMAOBJINCLUDE_MAX_LEN;
		static const std::string::size_type HPPXMSGSCHEMAINCLUDE_MAX_LEN;
		static const std::string::size_type HPPXMSGSCHEMAFORMATTERS_MAX_LEN;
		static const std::string::size_type HPPXMSGCLIENTSCHEMAINCLUDE_MAX_LEN;
		static const std::string::size_type HPPXMSGCLIENTSCHEMABODY_MAX_LEN;
		static const std::string::size_type HPPXMSGRQSTSCHEMABODY_MAX_LEN;
		static const std::string::size_type HPPXMSGRQSTSCHEMAINCLUDE_MAX_LEN;
		static const std::string::size_type HPPXMSGRQSTSCHEMAWIREPARSERS_MAX_LEN;
		static const std::string::size_type HPPXMSGRQSTSCHEMAXSDSPEC_MAX_LEN;
		static const std::string::size_type HPPXMSGRQSTSCHEMAXSDELEMENTLIST_MAX_LEN;
		static const std::string::size_type HPPXMSGRSPNSCHEMABODY_MAX_LEN;
		static const std::string::size_type HPPXMSGRSPNSCHEMAINCLUDE_MAX_LEN;
		static const std::string::size_type HPPXMSGRSPNSCHEMAWIREPARSERS_MAX_LEN;
		static const std::string::size_type HPPXMSGRSPNSCHEMAXSDELEMENTLIST_MAX_LEN;
		static const std::string::size_type HPPXMSGRSPNSCHEMAXSDSPEC_MAX_LEN;
		static const std::string::size_type CSSCHEMAOBJUSING_MAX_LEN;
		static const std::string::size_type CSSCHEMAOBJINTERFACE_MAX_LEN;
		static const std::string::size_type CSSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type CSSCHEMAOBJIMPLEMENTATION_MAX_LEN;
		static const std::string::size_type CSDB2LUWSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type CSDB2LUWSCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type CSDB2LUWSCHEMAOBJUSING_MAX_LEN;
		static const std::string::size_type CSMSSQLSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type CSMSSQLSCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type CSMSSQLSCHEMAOBJUSING_MAX_LEN;
		static const std::string::size_type CSMYSQLSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type CSMYSQLSCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type CSMYSQLSCHEMAOBJUSING_MAX_LEN;
		static const std::string::size_type CSORACLESCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type CSORACLESCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type CSORACLESCHEMAOBJUSING_MAX_LEN;
		static const std::string::size_type CSPGSQLSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type CSPGSQLSCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type CSPGSQLSCHEMAOBJUSING_MAX_LEN;
		static const std::string::size_type CSRAMSCHEMAOBJMEMBERS_MAX_LEN;
		static const std::string::size_type CSRAMSCHEMAOBJIMPL_MAX_LEN;
		static const std::string::size_type CSRAMSCHEMAOBJUSING_MAX_LEN;
		static const std::string::size_type CSXMSGSCHEMAUSING_MAX_LEN;
		static const std::string::size_type CSXMSGSCHEMAFORMATTERS_MAX_LEN;
		static const std::string::size_type CSXMSGCLIENTSCHEMAUSING_MAX_LEN;
		static const std::string::size_type CSXMSGCLIENTSCHEMABODY_MAX_LEN;
		static const std::string::size_type CSXMSGRQSTSCHEMABODY_MAX_LEN;
		static const std::string::size_type CSXMSGRQSTSCHEMAUSING_MAX_LEN;
		static const std::string::size_type CSXMSGRQSTSCHEMAWIREPARSERS_MAX_LEN;
		static const std::string::size_type CSXMSGRQSTSCHEMAXSDSPEC_MAX_LEN;
		static const std::string::size_type CSXMSGRQSTSCHEMAXSDELEMENTLIST_MAX_LEN;
		static const std::string::size_type CSXMSGRSPNSCHEMABODY_MAX_LEN;
		static const std::string::size_type CSXMSGRSPNSCHEMAUSING_MAX_LEN;
		static const std::string::size_type CSXMSGRSPNSCHEMAWIREPARSERS_MAX_LEN;
		static const std::string::size_type CSXMSGRSPNSCHEMAXSDELEMENTLIST_MAX_LEN;
		static const std::string::size_type CSXMSGRSPNSCHEMAXSDSPEC_MAX_LEN;
	protected:
	...
	public:
		CFBamSchemaDefBuff();
		CFBamSchemaDefBuff( const CFBamSchemaDefBuff& src );
		virtual ~CFBamSchemaDefBuff();
		...
		bool operator >( const CFBamSchemaDefHBuff& rhs );
		bool operator >( const CFBamSchemaDefBuff& rhs );
		cfbam::CFBamSchemaDefBuff operator =( cfbam::CFBamSchemaDefBuff& src );
		cfbam::CFBamSchemaDefBuff operator =( cfbam::CFBamSchemaDefHBuff& src );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamSchemaDefBuff& lhs, const cfbam::CFBamSchemaDefByCTenantIdxKey& rhs );
	bool operator <(const  cfbam::CFBamSchemaDefBuff& lhs, const cfbam::CFBamSchemaDefByMinorVersionIdxKey& rhs );
	bool operator <(const  cfbam::CFBamSchemaDefBuff& lhs, const cfbam::CFBamSchemaDefByUNameIdxKey& rhs );
	bool operator <(const  cfbam::CFBamSchemaDefBuff& lhs, const cfbam::CFBamSchemaDefByAuthEMailIdxKey& rhs );
	bool operator <(const  cfbam::CFBamSchemaDefBuff& lhs, const cfbam::CFBamSchemaDefByProjectURLIdxKey& rhs );
	bool operator <(const  cfbam::CFBamSchemaDefBuff& lhs, const cfbam::CFBamSchemaDefByPubURIIdxKey& rhs );
	bool operator <(const  cfbam::CFBamSchemaDefBuff& lhs, const cfbam::CFBamScopePKey& rhs );
	bool operator <(const  cfbam::CFBamSchemaDefBuff& lhs, const cfbam::CFBamScopeHPKey& rhs );
	bool operator <(const  cfbam::CFBamSchemaDefBuff& lhs, const cfbam::CFBamSchemaDefHBuff& rhs );
	bool operator <(const  cfbam::CFBamSchemaDefBuff& lhs, const cfbam::CFBamSchemaDefBuff& rhs );
	...
	template<> struct hash<cfbam::CFBamSchemaDefBuff> {
		typedef cfbam::CFBamSchemaDefBuff argument_type;
