...
// Description: C++18 specification for a PopTopDep by UNameIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamPopTopDepByUNameIdxKey();
		CFBamPopTopDepByUNameIdxKey( const CFBamPopTopDepByUNameIdxKey& src );
		virtual ~CFBamPopTopDepByUNameIdxKey();
		...
		bool operator >( const CFBamPopTopDepHBuff& rhs );
		bool operator >( const CFBamPopTopDepBuff& rhs );
		cfbam::CFBamPopTopDepByUNameIdxKey operator =( cfbam::CFBamPopTopDepByUNameIdxKey& src );
		cfbam::CFBamPopTopDepByUNameIdxKey operator =( cfbam::CFBamPopTopDepBuff& src );
		cfbam::CFBamPopTopDepByUNameIdxKey operator =( cfbam::CFBamPopTopDepHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamPopTopDepByUNameIdxKey> {
		typedef cfbam::CFBamPopTopDepByUNameIdxKey argument_type;
