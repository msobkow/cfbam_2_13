...
// Description: C++18 DbIO interface for Atom.
...
namespace cfbam {
	...
	public:
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamAtomBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamAtomBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
