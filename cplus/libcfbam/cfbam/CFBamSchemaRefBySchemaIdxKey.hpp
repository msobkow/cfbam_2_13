...
// Description: C++18 specification for a SchemaRef by SchemaIdx index key object.
...
namespace cfbam {
	...
	public:
		CFBamSchemaRefBySchemaIdxKey();
		CFBamSchemaRefBySchemaIdxKey( const CFBamSchemaRefBySchemaIdxKey& src );
		virtual ~CFBamSchemaRefBySchemaIdxKey();
		...
		bool operator >( const CFBamSchemaRefHBuff& rhs );
		bool operator >( const CFBamSchemaRefBuff& rhs );
		cfbam::CFBamSchemaRefBySchemaIdxKey operator =( cfbam::CFBamSchemaRefBySchemaIdxKey& src );
		cfbam::CFBamSchemaRefBySchemaIdxKey operator =( cfbam::CFBamSchemaRefBuff& src );
		cfbam::CFBamSchemaRefBySchemaIdxKey operator =( cfbam::CFBamSchemaRefHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamSchemaRefBySchemaIdxKey> {
		typedef cfbam::CFBamSchemaRefBySchemaIdxKey argument_type;
