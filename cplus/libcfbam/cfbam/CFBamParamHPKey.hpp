...
// Description: C++18 specification of a Param history primary key object.
...
namespace cfbam {
	...
	class CFBamParamHPKey : public CFBamHPKey
	{
	protected:
	...
	public:
		...
		CFBamParamHPKey();
		CFBamParamHPKey( const CFBamParamHPKey& src );
		virtual ~CFBamParamHPKey();
		...
		cfbam::CFBamParamHPKey operator =( cfbam::CFBamParamPKey& src );
		cfbam::CFBamParamHPKey operator =( cfbam::CFBamParamHPKey& src );
		cfbam::CFBamParamHPKey operator =( cfbam::CFBamParamBuff& src );
		cfbam::CFBamParamHPKey operator =( cfbam::CFBamParamHBuff& src );
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamParamHPKey> {
		typedef cfbam::CFBamParamHPKey argument_type;
