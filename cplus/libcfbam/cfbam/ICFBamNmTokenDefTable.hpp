...
// Description: C++18 DbIO interface for NmTokenDef.
...
namespace cfbam {
	...
	public:
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamNmTokenDefBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
