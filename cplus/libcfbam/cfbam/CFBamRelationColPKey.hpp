...
// Description: C++18 specification of a RelationCol primary key object.
...
namespace cfbam {
	...
	public:
		...
		CFBamRelationColPKey();
		CFBamRelationColPKey( const CFBamRelationColPKey& src );
		virtual ~CFBamRelationColPKey();
		...
		cfbam::CFBamRelationColPKey operator =( cfbam::CFBamRelationColPKey& src );
		cfbam::CFBamRelationColPKey operator =( cfbam::CFBamRelationColHPKey& src );
		cfbam::CFBamRelationColPKey operator =( cfbam::CFBamRelationColBuff& src );
		cfbam::CFBamRelationColPKey operator =( cfbam::CFBamRelationColHBuff& src );
	};
}
...
namespace std {
	...
	template<> struct hash<cfbam::CFBamRelationColPKey> {
		typedef cfbam::CFBamRelationColPKey argument_type;
