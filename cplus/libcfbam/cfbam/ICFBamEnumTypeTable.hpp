...
// Description: C++18 DbIO interface for EnumType.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteEnumTypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamEnumTypeBySchemaIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamEnumTypeBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
