...
// Description: C++18 DbIO interface for Id16Gen.
...
namespace cfbam {
	...
	public:
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamId16GenBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamId16GenBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
