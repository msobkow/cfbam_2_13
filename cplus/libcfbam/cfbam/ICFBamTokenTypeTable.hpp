...
// Description: C++18 DbIO interface for TokenType.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteTokenTypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamTokenTypeBySchemaIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamTokenTypeBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamTokenTypeBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
