...
// Description: C++18 DbIO interface for NmTokenType.
...
namespace cfbam {
	...
	public:
		...
		virtual void deleteNmTokenTypeBySchemaIdx( const cfsec::CFSecAuthorization* Authorization,
			const cfbam::CFBamNmTokenTypeBySchemaIdxKey* argKey ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamNmTokenTypeBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
