...
// Description: C++18 DbIO interface for UInt16Def.
...
namespace cfbam {
	...
	public:
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> readAllDerived( const cfsec::CFSecAuthorization* Authorization ) = 0;
		...
		virtual std::TCFLibOwningVector<cfbam::CFBamUInt16DefBuff*> readAllBuff( const cfsec::CFSecAuthorization* Authorization ) = 0;
