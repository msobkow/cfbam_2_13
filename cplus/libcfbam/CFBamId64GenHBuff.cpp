// Description: C++18 implementation of a Id64Gen history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamId64GenHBuff::CLASS_NAME( "CFBamId64GenHBuff" );
	CFBamId64GenHBuff::CFBamId64GenHBuff()
	: cfbam::CFBamInt64TypeHBuff() {
	...
	CFBamId64GenHBuff::CFBamId64GenHBuff( const CFBamId64GenHBuff& src )
	: cfbam::CFBamInt64TypeHBuff() {
		optionalDispenserTenantId.setNull();
		optionalDispenserId.setNull();
		requiredSlice = cfbam::CFBamId64GenBuff::SLICE_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamId64GenHBuff::clone() {
		CFBamId64GenHBuff* copy = new CFBamId64GenHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamId64GenHBuff::getOptionalDispenserTenantIdValue() const {
		return( optionalDispenserTenantId.getValue() );
	}

	const int64_t* CFBamId64GenHBuff::getOptionalDispenserTenantIdReference() const {
		return( optionalDispenserTenantId.getReference() );
	}

	const bool CFBamId64GenHBuff::isOptionalDispenserTenantIdNull() const {
		return( optionalDispenserTenantId.isNull() );
	}

	void CFBamId64GenHBuff::setOptionalDispenserTenantIdNull() {
		optionalDispenserTenantId.setNull();
	}

	void CFBamId64GenHBuff::setOptionalDispenserTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamId64GenHBuff::getOptionalDispenserIdValue() const {
		return( optionalDispenserId.getValue() );
	}

	const int64_t* CFBamId64GenHBuff::getOptionalDispenserIdReference() const {
		return( optionalDispenserId.getReference() );
	}

	const bool CFBamId64GenHBuff::isOptionalDispenserIdNull() const {
		return( optionalDispenserId.isNull() );
	}

	void CFBamId64GenHBuff::setOptionalDispenserIdNull() {
		optionalDispenserId.setNull();
	}

	void CFBamId64GenHBuff::setOptionalDispenserIdValue( const int64_t value ) {
	...
	const int16_t CFBamId64GenHBuff::getRequiredSlice() const {
		return( requiredSlice );
	}

	const int16_t* CFBamId64GenHBuff::getRequiredSliceReference() const {
		return( &requiredSlice );
	}

	void CFBamId64GenHBuff::setRequiredSlice( const int16_t value ) {
	...
	const int64_t CFBamId64GenHBuff::getRequiredBlockSize() const {
		return( requiredBlockSize );
	}

	const int64_t* CFBamId64GenHBuff::getRequiredBlockSizeReference() const {
		return( &requiredBlockSize );
	}

	void CFBamId64GenHBuff::setRequiredBlockSize( const int64_t value ) {
	...
	size_t CFBamId64GenHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamId64GenHBuff::hashCode();
	...
	CFBamId64GenHBuff CFBamId64GenHBuff::operator =( cfbam::CFBamId64GenBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamId64GenHBuff CFBamId64GenHBuff::operator =( cfbam::CFBamId64GenHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamId64GenHBuff::operator <( const CFBamId64GenByDispIdxKey& rhs ) {
		if( ! isOptionalDispenserTenantIdNull() ) {
	...
	bool CFBamId64GenHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamId64GenHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamId64GenHBuff::operator <( const CFBamId64GenHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamId64GenHBuff::operator <( const CFBamId64GenBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamId64GenHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamId64GenHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamId64GenHBuff& lhs, const cfbam::CFBamId64GenByDispIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamId64GenHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamId64GenHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamId64GenHBuff& lhs, const cfbam::CFBamId64GenHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamId64GenHBuff& lhs, const cfbam::CFBamId64GenBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
