// Description: C++18 implementation of a PopDep history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamPopDepHBuff::CLASS_NAME( "CFBamPopDepHBuff" );
	CFBamPopDepHBuff::CFBamPopDepHBuff()
	...
	CFBamPopDepHBuff::CFBamPopDepHBuff( const CFBamPopDepHBuff& src )
	: cfbam::CFBamScopeHBuff() {
		optionalDefSchemaTenantId.setNull();
		optionalDefSchemaId.setNull();
		requiredRelationTenantId = cfbam::CFBamPopDepBuff::RELATIONTENANTID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamPopDepHBuff::clone() {
		CFBamPopDepHBuff* copy = new CFBamPopDepHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamPopDepHBuff::getOptionalDefSchemaTenantIdValue() const {
		return( optionalDefSchemaTenantId.getValue() );
	}

	const int64_t* CFBamPopDepHBuff::getOptionalDefSchemaTenantIdReference() const {
		return( optionalDefSchemaTenantId.getReference() );
	}

	const bool CFBamPopDepHBuff::isOptionalDefSchemaTenantIdNull() const {
		return( optionalDefSchemaTenantId.isNull() );
	}

	void CFBamPopDepHBuff::setOptionalDefSchemaTenantIdNull() {
		optionalDefSchemaTenantId.setNull();
	}

	void CFBamPopDepHBuff::setOptionalDefSchemaTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamPopDepHBuff::getOptionalDefSchemaIdValue() const {
		return( optionalDefSchemaId.getValue() );
	}

	const int64_t* CFBamPopDepHBuff::getOptionalDefSchemaIdReference() const {
		return( optionalDefSchemaId.getReference() );
	}

	const bool CFBamPopDepHBuff::isOptionalDefSchemaIdNull() const {
		return( optionalDefSchemaId.isNull() );
	}

	void CFBamPopDepHBuff::setOptionalDefSchemaIdNull() {
		optionalDefSchemaId.setNull();
	}

	void CFBamPopDepHBuff::setOptionalDefSchemaIdValue( const int64_t value ) {
	...
	const int64_t CFBamPopDepHBuff::getRequiredRelationTenantId() const {
		return( requiredRelationTenantId );
	}

	const int64_t* CFBamPopDepHBuff::getRequiredRelationTenantIdReference() const {
		return( &requiredRelationTenantId );
	}

	void CFBamPopDepHBuff::setRequiredRelationTenantId( const int64_t value ) {
	...
	const int64_t CFBamPopDepHBuff::getRequiredRelationId() const {
		return( requiredRelationId );
	}

	const int64_t* CFBamPopDepHBuff::getRequiredRelationIdReference() const {
		return( &requiredRelationId );
	}

	void CFBamPopDepHBuff::setRequiredRelationId( const int64_t value ) {
	...
	size_t CFBamPopDepHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamPopDepHBuff::hashCode();
	...
	CFBamPopDepHBuff CFBamPopDepHBuff::operator =( cfbam::CFBamPopDepBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		if( src.isOptionalDefSchemaTenantIdNull() ) {
	...
	CFBamPopDepHBuff CFBamPopDepHBuff::operator =( cfbam::CFBamPopDepHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		if( src.isOptionalDefSchemaTenantIdNull() ) {
	...
	bool CFBamPopDepHBuff::operator <( const CFBamPopDepByRelationIdxKey& rhs ) {
	...
	bool CFBamPopDepHBuff::operator <( const CFBamPopDepByDefSchemaIdxKey& rhs ) {
		if( ! isOptionalDefSchemaTenantIdNull() ) {
	...
	bool CFBamPopDepHBuff::operator <( const CFBamScopePKey& rhs ) {
	...
	bool CFBamPopDepHBuff::operator <( const CFBamScopeHPKey& rhs ) {
	...
	bool CFBamPopDepHBuff::operator <( const CFBamPopDepHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamPopDepHBuff::operator <( const CFBamPopDepBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamPopDepHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamPopDepHBuff" );
