// Description: C++18 implementation for a PopDep buffer object.
...
namespace cfbam {
	...
	const std::string CFBamPopDepBuff::GENDEFNAME( "PopDep" );
	const classcode_t CFBamPopDepBuff::CLASS_CODE = 0xa830L;
	const std::string CFBamPopDepBuff::CLASS_NAME( "CFBamPopDepBuff" );
		const std::string CFBamPopDepBuff::COLNAME_DEFSCHEMATENANTID( "DefSchemaTenantId" );
		const std::string CFBamPopDepBuff::COLNAME_DEFSCHEMAID( "DefSchemaId" );
		const std::string CFBamPopDepBuff::COLNAME_RELATIONTENANTID( "RelationTenantId" );
		const std::string CFBamPopDepBuff::COLNAME_RELATIONID( "RelationId" );
	const int64_t CFBamPopDepBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamPopDepBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamPopDepBuff::DEFSCHEMATENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamPopDepBuff::DEFSCHEMAID_INIT_VALUE = 0LL;
	const int64_t CFBamPopDepBuff::RELATIONTENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamPopDepBuff::RELATIONID_INIT_VALUE = 0LL;
	const int64_t CFBamPopDepBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamPopDepBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamPopDepBuff::DEFSCHEMATENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamPopDepBuff::DEFSCHEMAID_MIN_VALUE = 0LL;
	const int64_t CFBamPopDepBuff::RELATIONTENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamPopDepBuff::RELATIONID_MIN_VALUE = 0LL;

	CFBamPopDepBuff::CFBamPopDepBuff()
	: CFBamScopeBuff()
	{
	...
	CFBamPopDepBuff::CFBamPopDepBuff( const CFBamPopDepBuff& src )
	: CFBamScopeBuff()
	{
		optionalDefSchemaTenantId.setNull();
		optionalDefSchemaId.setNull();
	...
	cflib::ICFLibCloneableObj* CFBamPopDepBuff::clone() {
		CFBamPopDepBuff* copy = new CFBamPopDepBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamPopDepBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamPopDepBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamPopDepBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const bool CFBamPopDepBuff::isOptionalDefSchemaTenantIdNull() const {
		return( optionalDefSchemaTenantId.isNull() );
	}

	const int64_t CFBamPopDepBuff::getOptionalDefSchemaTenantIdValue() const {
		return( optionalDefSchemaTenantId.getValue() );
	}

	const int64_t* CFBamPopDepBuff::getOptionalDefSchemaTenantIdReference() const {
		return( optionalDefSchemaTenantId.getReference() );
	}

	void CFBamPopDepBuff::setOptionalDefSchemaTenantIdNull() {
		optionalDefSchemaTenantId.setNull();
	}

	void CFBamPopDepBuff::setOptionalDefSchemaTenantIdValue( const int64_t value ) {
		static const std::string S_ProcName( "setOptionalDefSchemaTenantIdValue" );
		if( value < cfbam::CFBamPopDepBuff::DEFSCHEMATENANTID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamPopDepBuff::DEFSCHEMATENANTID_MIN_VALUE );
		}
		optionalDefSchemaTenantId.setValue( value );
	}

	const bool CFBamPopDepBuff::isOptionalDefSchemaIdNull() const {
		return( optionalDefSchemaId.isNull() );
	}

	const int64_t CFBamPopDepBuff::getOptionalDefSchemaIdValue() const {
		return( optionalDefSchemaId.getValue() );
	}

	const int64_t* CFBamPopDepBuff::getOptionalDefSchemaIdReference() const {
		return( optionalDefSchemaId.getReference() );
	}

	void CFBamPopDepBuff::setOptionalDefSchemaIdNull() {
		optionalDefSchemaId.setNull();
	}

	void CFBamPopDepBuff::setOptionalDefSchemaIdValue( const int64_t value ) {
		static const std::string S_ProcName( "setOptionalDefSchemaIdValue" );
		if( value < cfbam::CFBamPopDepBuff::DEFSCHEMAID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamPopDepBuff::DEFSCHEMAID_MIN_VALUE );
		}
		optionalDefSchemaId.setValue( value );
	}

	const int64_t CFBamPopDepBuff::getRequiredRelationTenantId() const {
		return( requiredRelationTenantId );
	}

	const int64_t* CFBamPopDepBuff::getRequiredRelationTenantIdReference() const {
		return( &requiredRelationTenantId );
	}

	void CFBamPopDepBuff::setRequiredRelationTenantId( const int64_t value ) {
	...
	const int64_t CFBamPopDepBuff::getRequiredRelationId() const {
		return( requiredRelationId );
	}

	const int64_t* CFBamPopDepBuff::getRequiredRelationIdReference() const {
		return( &requiredRelationId );
	}

	void CFBamPopDepBuff::setRequiredRelationId( const int64_t value ) {
	...
	size_t CFBamPopDepBuff::hashCode() const {
	...
	CFBamPopDepBuff CFBamPopDepBuff::operator =( cfbam::CFBamPopDepBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamPopDepBuff CFBamPopDepBuff::operator =( cfbam::CFBamPopDepHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		if( src.isOptionalDefSchemaTenantIdNull() ) {
	...
	bool CFBamPopDepBuff::operator <( const CFBamPopDepByRelationIdxKey& rhs ) {
	...
	bool CFBamPopDepBuff::operator <( const CFBamPopDepByDefSchemaIdxKey& rhs ) {
		if( ! isOptionalDefSchemaTenantIdNull() ) {
	...
	bool CFBamPopDepBuff::operator <( const CFBamScopePKey& rhs ) {
	...
	bool CFBamPopDepBuff::operator <( const CFBamScopeHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamPopDepBuff::operator <( const CFBamPopDepHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamPopDepBuff::operator <( const CFBamPopDepBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamPopDepBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamPopDepBuff" );
