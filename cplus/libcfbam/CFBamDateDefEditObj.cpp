// Description: C++18 edit object instance implementation for CFBam DateDef.
...
namespace cfbam {
	...
	const std::string CFBamDateDefEditObj::CLASS_NAME( "CFBamDateDefEditObj" );

	CFBamDateDefEditObj::CFBamDateDefEditObj( cfbam::ICFBamDateDefObj* argOrig )
	: ICFBamDateDefEditObj(),
	  CFBamAtomEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamDateDefEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamDateDefEditObj::~CFBamDateDefEditObj() {
	}

	const std::string& CFBamDateDefEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamDateDefEditObj::getClassCode() const {
		return( cfbam::CFBamDateDefBuff::CLASS_CODE );
	}

	bool CFBamDateDefEditObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamDateDefBuff::CLASS_CODE ) {
			return( true );
		}
		else {
	...
	std::string CFBamDateDefEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamDateDefEditObj" );
	...
	const std::string CFBamDateDefEditObj::getGenDefName() {
		return( cfbam::CFBamDateDefBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamDateDefEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamDateDefEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamDateDefEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamDateDefEditObj::getObjQualifiedName() {
	...
	std::string CFBamDateDefEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamDateDefEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamDateDefObj* retobj = getSchema()->getDateDefTableObj()->realizeDateDef( dynamic_cast<cfbam::ICFBamDateDefObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamDateDefEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamDateDefEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamDateDefEditObj::create() {
		cfbam::ICFBamDateDefObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsDateDef()->getSchema() )->getDateDefTableObj()->createDateDef( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamDateDefEditObj::update() {
		getSchema()->getDateDefTableObj()->updateDateDef( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamDateDefEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getDateDefTableObj()->deleteDateDef( this );
		return( NULL );
	}

	cfbam::ICFBamDateDefTableObj* CFBamDateDefEditObj::getDateDefTable() {
		return( orig->getSchema()->getDateDefTableObj() );
	}

	cfbam::ICFBamDateDefEditObj* CFBamDateDefEditObj::getDateDefEdit() {
		return( (cfbam::ICFBamDateDefEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamDateDefEditObj::beginEdit() {
	...
	cfbam::ICFBamDateDefObj* CFBamDateDefEditObj::getOrigAsDateDef() {
		return( dynamic_cast<cfbam::ICFBamDateDefObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamDateDefEditObj::getBuff() {
		return( buff );
	}

	void CFBamDateDefEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamAtomEditObj::setBuff( value );
		}
	}

	bool CFBamDateDefEditObj::isOptionalDummyNull() {
		return( getDateDefBuff()->isOptionalDummyNull() );
	}

	const std::string& CFBamDateDefEditObj::getOptionalDummyValue() {
		return( getDateDefBuff()->getOptionalDummyValue() );
	}

	const std::string* CFBamDateDefEditObj::getOptionalDummyReference() {
		return( getDateDefBuff()->getOptionalDummyReference() );
	}

	void CFBamDateDefEditObj::setOptionalDummyNull() {
		if( ! getDateDefBuff()->isOptionalDummyNull() ) {
			getDateDefEditBuff()->setOptionalDummyNull();
		}
	}

	void CFBamDateDefEditObj::setOptionalDummyValue( const std::string& value ) {
		if( getDateDefBuff()->isOptionalDummyNull() ) {
			getDateDefEditBuff()->setOptionalDummyValue( value );
		}
		else if( getDateDefBuff()->getOptionalDummyValue() != value ) {
			getDateDefEditBuff()->setOptionalDummyValue( value );
		}
	}

	void CFBamDateDefEditObj::copyBuffToOrig() {
		cfbam::CFBamDateDefBuff* origBuff = getOrigAsDateDef()->getDateDefEditBuff();
		cfbam::CFBamDateDefBuff* myBuff = getDateDefBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamDateDefEditObj::copyOrigToBuff() {
		cfbam::CFBamDateDefBuff* origBuff = getOrigAsDateDef()->getDateDefBuff();
		cfbam::CFBamDateDefBuff* myBuff = getDateDefEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
