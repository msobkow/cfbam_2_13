// Description: C++18 implementation of a DoubleCol history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamDoubleColHBuff::CLASS_NAME( "CFBamDoubleColHBuff" );
	CFBamDoubleColHBuff::CFBamDoubleColHBuff()
	: cfbam::CFBamDoubleDefHBuff() {
		requiredTableId = cfbam::CFBamDoubleColBuff::TABLEID_INIT_VALUE;
	}

	CFBamDoubleColHBuff::CFBamDoubleColHBuff( const CFBamDoubleColHBuff& src )
	: cfbam::CFBamDoubleDefHBuff() {
		requiredTableId = cfbam::CFBamDoubleColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamDoubleColHBuff::clone() {
		CFBamDoubleColHBuff* copy = new CFBamDoubleColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamDoubleColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamDoubleColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamDoubleColHBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamDoubleColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamDoubleColHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamDoubleColHBuff CFBamDoubleColHBuff::operator =( cfbam::CFBamDoubleColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamDoubleColHBuff CFBamDoubleColHBuff::operator =( cfbam::CFBamDoubleColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamDoubleColHBuff::operator <( const CFBamDoubleColByTableIdxKey& rhs ) {
	...
	bool CFBamDoubleColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamDoubleColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamDoubleColHBuff::operator <( const CFBamDoubleColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamDoubleColHBuff::operator <( const CFBamDoubleColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamDoubleColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamDoubleColHBuff" );
