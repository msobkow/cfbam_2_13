// Description: C++18 Instance Edit Object interface implementation for CFBam EnumType.
...
namespace cfbam {
	...
	const std::string ICFBamEnumTypeEditObj::CLASS_NAME( "ICFBamEnumTypeEditObj" );

	ICFBamEnumTypeEditObj::ICFBamEnumTypeEditObj()
