// Description: C++18 implementation for a ClearTopDep by PrevIdx index key object.
...
namespace cfbam {
	const std::string CFBamClearTopDepByPrevIdxKey::CLASS_NAME( "CFBamClearTopDepByPrevIdxKey" );
	const std::string CFBamClearTopDepByPrevIdxKey::S_VALUE( "value" );
	const std::string CFBamClearTopDepByPrevIdxKey::S_VALUE_LENGTH( "value.length()" );


	CFBamClearTopDepByPrevIdxKey::CFBamClearTopDepByPrevIdxKey() {
		optionalPrevTenantId.setNull();
		optionalPrevId.setNull();
	}

	CFBamClearTopDepByPrevIdxKey::CFBamClearTopDepByPrevIdxKey( const CFBamClearTopDepByPrevIdxKey& src ) {
		optionalPrevTenantId.setNull();
		optionalPrevId.setNull();
	...
	const int64_t CFBamClearTopDepByPrevIdxKey::getOptionalPrevTenantIdValue() const {
		return( optionalPrevTenantId.getValue() );
	}

	const int64_t* CFBamClearTopDepByPrevIdxKey::getOptionalPrevTenantIdReference() const {
		return( optionalPrevTenantId.getReference() );
	}

	const bool CFBamClearTopDepByPrevIdxKey::isOptionalPrevTenantIdNull() const {
		return( optionalPrevTenantId.isNull() );
	}

	void CFBamClearTopDepByPrevIdxKey::setOptionalPrevTenantIdNull() {
		optionalPrevTenantId.setNull();
	}

	void CFBamClearTopDepByPrevIdxKey::setOptionalPrevTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamClearTopDepByPrevIdxKey::getOptionalPrevIdValue() const {
		return( optionalPrevId.getValue() );
	}

	const int64_t* CFBamClearTopDepByPrevIdxKey::getOptionalPrevIdReference() const {
		return( optionalPrevId.getReference() );
	}

	const bool CFBamClearTopDepByPrevIdxKey::isOptionalPrevIdNull() const {
		return( optionalPrevId.isNull() );
	}

	void CFBamClearTopDepByPrevIdxKey::setOptionalPrevIdNull() {
		optionalPrevId.setNull();
	}

	void CFBamClearTopDepByPrevIdxKey::setOptionalPrevIdValue( const int64_t value ) {
	...
	size_t CFBamClearTopDepByPrevIdxKey::hashCode() const {
		size_t hashCode = 0;
	...
	std::string CFBamClearTopDepByPrevIdxKey::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamClearTopDepByPrevIdxKey" );
	...
	bool CFBamClearTopDepByPrevIdxKey::operator <( const CFBamClearTopDepByPrevIdxKey& rhs ) {
		if( ! isOptionalPrevTenantIdNull() ) {
	...
	bool CFBamClearTopDepByPrevIdxKey::operator <( const CFBamClearTopDepHBuff& rhs ) {
		if( ! isOptionalPrevTenantIdNull() ) {
			if( rhs.isOptionalPrevTenantIdNull() ) {
				return( false );
			}
	...
	bool CFBamClearTopDepByPrevIdxKey::operator <( const CFBamClearTopDepBuff& rhs ) {
		if( ! isOptionalPrevTenantIdNull() ) {
			if( rhs.isOptionalPrevTenantIdNull() ) {
				return( false );
			}
	...
	CFBamClearTopDepByPrevIdxKey CFBamClearTopDepByPrevIdxKey::operator =( cfbam::CFBamClearTopDepByPrevIdxKey& src ) {
		if( src.isOptionalPrevTenantIdNull() ) {
			setOptionalPrevTenantIdNull();
		}
		else {
	...
	CFBamClearTopDepByPrevIdxKey CFBamClearTopDepByPrevIdxKey::operator =( cfbam::CFBamClearTopDepBuff& src ) {
		if( src.isOptionalPrevTenantIdNull() ) {
			setOptionalPrevTenantIdNull();
		}
		else {
	...
	CFBamClearTopDepByPrevIdxKey CFBamClearTopDepByPrevIdxKey::operator =( cfbam::CFBamClearTopDepHBuff& src ) {
		if( src.isOptionalPrevTenantIdNull() ) {
			setOptionalPrevTenantIdNull();
		}
		else {
