// Description: C++18 Instance Edit Object interface implementation for CFBam BoolCol.
...
namespace cfbam {
	...
	const std::string ICFBamBoolColEditObj::CLASS_NAME( "ICFBamBoolColEditObj" );

	ICFBamBoolColEditObj::ICFBamBoolColEditObj()
