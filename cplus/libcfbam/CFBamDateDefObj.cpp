// Description: C++18 base object instance implementation for CFBam DateDef.
...
namespace cfbam {
	...
	const std::string CFBamDateDefObj::CLASS_NAME( "CFBamDateDefObj" );
	const classcode_t CFBamDateDefObj::CLASS_CODE = 0xa815L;

	bool CFBamDateDefObj::isOptionalDummyNull() {
		return( getDateDefBuff()->isOptionalDummyNull() );
	}

	const std::string& CFBamDateDefObj::getOptionalDummyValue() {
		return( getDateDefBuff()->getOptionalDummyValue() );
	}

	const std::string* CFBamDateDefObj::getOptionalDummyReference() {
		return( getDateDefBuff()->getOptionalDummyReference() );
	}


	CFBamDateDefObj::CFBamDateDefObj()
	: ICFBamDateDefObj(),
	  CFBamAtomObj()
	{
	}

	CFBamDateDefObj::CFBamDateDefObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamDateDefObj(),
	...
	cfbam::CFBamValueBuff* CFBamDateDefObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamDateDefBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableDateDef()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamDateDefObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamDateDefObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamDateDefObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamDateDefObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamDateDefObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamDateDefObj" );
	...
	std::string CFBamDateDefObj::getObjName() {
	...
	const std::string CFBamDateDefObj::getGenDefName() {
		return( cfbam::CFBamDateDefBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamDateDefObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamDateDefObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamDateDefObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamDateDefObj::getObjQualifiedName() {
	...
	std::string CFBamDateDefObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamDateDefObj::realize() {
		cfbam::ICFBamDateDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDateDefTableObj()->realizeDateDef(
			(cfbam::ICFBamDateDefObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamDateDefObj::read( bool forceRead ) {
		cfbam::ICFBamDateDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDateDefTableObj()->readDateDefByIdIdx( getDateDefBuff()->getRequiredTenantId(),
		getDateDefBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamDateDefObj::moveUp() {
		cfbam::ICFBamDateDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDateDefTableObj()->moveUpDateDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamDateDefObj::moveDown() {
		cfbam::ICFBamDateDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDateDefTableObj()->moveDownDateDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamDateDefObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamDateDefObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDateDefTableObj()->lockDateDef( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDateDefTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamDateDefEditObj* CFBamDateDefObj::getDateDefEdit() {
		return( dynamic_cast<cfbam::ICFBamDateDefEditObj*>( edit ) );
	}
