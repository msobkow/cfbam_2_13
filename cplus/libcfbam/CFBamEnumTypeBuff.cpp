// Description: C++18 implementation for a EnumType buffer object.
...
namespace cfbam {
	...
	const std::string CFBamEnumTypeBuff::GENDEFNAME( "EnumType" );
	const classcode_t CFBamEnumTypeBuff::CLASS_CODE = 0xa857L;
	const std::string CFBamEnumTypeBuff::CLASS_NAME( "CFBamEnumTypeBuff" );
		const std::string CFBamEnumTypeBuff::COLNAME_SCHEMADEFID( "SchemaDefId" );
	const int64_t CFBamEnumTypeBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamEnumTypeBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamEnumTypeBuff::SCHEMADEFID_INIT_VALUE = 0LL;
	const int64_t CFBamEnumTypeBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamEnumTypeBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamEnumTypeBuff::SCHEMADEFID_MIN_VALUE = 0LL;

	CFBamEnumTypeBuff::CFBamEnumTypeBuff()
	: CFBamEnumDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamEnumTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamEnumTypeBuff::CFBamEnumTypeBuff( const CFBamEnumTypeBuff& src )
	: CFBamEnumDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamEnumTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamEnumTypeBuff::clone() {
		CFBamEnumTypeBuff* copy = new CFBamEnumTypeBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamEnumTypeBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamEnumTypeBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamEnumTypeBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamEnumDefBuff::implementsClassCode( argClassCode ) );
		}
	}

	const int64_t CFBamEnumTypeBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamEnumTypeBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamEnumTypeBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamEnumTypeBuff::hashCode() const {
		size_t hashCode = CFBamEnumDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamEnumTypeBuff CFBamEnumTypeBuff::operator =( cfbam::CFBamEnumTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamEnumTypeBuff CFBamEnumTypeBuff::operator =( cfbam::CFBamEnumTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamEnumTypeBuff::operator <( const CFBamEnumTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamEnumTypeBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamEnumTypeBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamEnumTypeBuff::operator <( const CFBamEnumTypeHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamEnumTypeBuff::operator <( const CFBamEnumTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamEnumTypeBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamEnumTypeBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamEnumTypeBuff& lhs, const cfbam::CFBamEnumTypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamEnumTypeBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamEnumTypeBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamEnumTypeBuff& lhs, const cfbam::CFBamEnumTypeHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamEnumTypeBuff& lhs, const cfbam::CFBamEnumTypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
