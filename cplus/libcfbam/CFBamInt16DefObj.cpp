// Description: C++18 base object instance implementation for CFBam Int16Def.
...
namespace cfbam {
	...
	const std::string CFBamInt16DefObj::CLASS_NAME( "CFBamInt16DefObj" );
	const classcode_t CFBamInt16DefObj::CLASS_CODE = 0xa823L;

	bool CFBamInt16DefObj::isOptionalInitValueNull() {
		return( getInt16DefBuff()->isOptionalInitValueNull() );
	}

	const int16_t CFBamInt16DefObj::getOptionalInitValueValue() {
		return( getInt16DefBuff()->getOptionalInitValueValue() );
	}

	const int16_t* CFBamInt16DefObj::getOptionalInitValueReference() {
		return( getInt16DefBuff()->getOptionalInitValueReference() );
	}

	bool CFBamInt16DefObj::isOptionalMinValueNull() {
		return( getInt16DefBuff()->isOptionalMinValueNull() );
	}

	const int16_t CFBamInt16DefObj::getOptionalMinValueValue() {
		return( getInt16DefBuff()->getOptionalMinValueValue() );
	}

	const int16_t* CFBamInt16DefObj::getOptionalMinValueReference() {
		return( getInt16DefBuff()->getOptionalMinValueReference() );
	}

	bool CFBamInt16DefObj::isOptionalMaxValueNull() {
		return( getInt16DefBuff()->isOptionalMaxValueNull() );
	}

	const int16_t CFBamInt16DefObj::getOptionalMaxValueValue() {
		return( getInt16DefBuff()->getOptionalMaxValueValue() );
	}

	const int16_t* CFBamInt16DefObj::getOptionalMaxValueReference() {
		return( getInt16DefBuff()->getOptionalMaxValueReference() );
	}


	CFBamInt16DefObj::CFBamInt16DefObj()
	: ICFBamInt16DefObj(),
	  CFBamAtomObj()
	{
	}

	CFBamInt16DefObj::CFBamInt16DefObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamInt16DefObj(),
	...
	cfbam::CFBamValueBuff* CFBamInt16DefObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamInt16DefBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableInt16Def()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamInt16DefObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamInt16DefObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamInt16DefObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamInt16DefObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamInt16DefObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt16DefObj" );
	...
	std::string CFBamInt16DefObj::getObjName() {
	...
	const std::string CFBamInt16DefObj::getGenDefName() {
		return( cfbam::CFBamInt16DefBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamInt16DefObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamInt16DefObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamInt16DefObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamInt16DefObj::getObjQualifiedName() {
	...
	std::string CFBamInt16DefObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamInt16DefObj::realize() {
		cfbam::ICFBamInt16DefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt16DefTableObj()->realizeInt16Def(
			(cfbam::ICFBamInt16DefObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamInt16DefObj::read( bool forceRead ) {
		cfbam::ICFBamInt16DefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt16DefTableObj()->readInt16DefByIdIdx( getInt16DefBuff()->getRequiredTenantId(),
		getInt16DefBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamInt16DefObj::moveUp() {
		cfbam::ICFBamInt16DefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt16DefTableObj()->moveUpInt16Def( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamInt16DefObj::moveDown() {
		cfbam::ICFBamInt16DefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt16DefTableObj()->moveDownInt16Def( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamInt16DefObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamInt16DefObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt16DefTableObj()->lockInt16Def( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt16DefTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamInt16DefEditObj* CFBamInt16DefObj::getInt16DefEdit() {
		return( dynamic_cast<cfbam::ICFBamInt16DefEditObj*>( edit ) );
	}
