// Description: C++18 base object instance implementation for CFBam NumberCol.
...
namespace cfbam {
	...
	const std::string CFBamNumberColObj::CLASS_NAME( "CFBamNumberColObj" );
	const classcode_t CFBamNumberColObj::CLASS_CODE = 0xa861L;

	const int64_t CFBamNumberColObj::getRequiredTableId() {
		return( getNumberColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamNumberColObj::getRequiredTableIdReference() {
		return( getNumberColBuff()->getRequiredTableIdReference() );
	}


	cfbam::ICFBamTableObj* CFBamNumberColObj::getRequiredContainerTable( bool forceRead ) {
	...
	CFBamNumberColObj::CFBamNumberColObj()
	: ICFBamNumberColObj(),
	  CFBamNumberDefObj()
	{
	}

	CFBamNumberColObj::CFBamNumberColObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamNumberColObj(),
	...
	cfbam::CFBamValueBuff* CFBamNumberColObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamNumberColBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableNumberCol()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamNumberColObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamNumberColObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamNumberColObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamNumberColObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamNumberColObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNumberColObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamNumberColObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamNumberColObj::getObjName() {
	...
	const std::string CFBamNumberColObj::getGenDefName() {
		return( cfbam::CFBamNumberColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamNumberColObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamNumberColObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamNumberColObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamNumberColObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamNumberColObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamNumberColObj::getObjQualifiedName() {
	...
	std::string CFBamNumberColObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamNumberColObj::realize() {
		cfbam::ICFBamNumberColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNumberColTableObj()->realizeNumberCol(
			(cfbam::ICFBamNumberColObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamNumberColObj::read( bool forceRead ) {
		cfbam::ICFBamNumberColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNumberColTableObj()->readNumberColByIdIdx( getNumberColBuff()->getRequiredTenantId(),
		getNumberColBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamNumberColObj::moveUp() {
		cfbam::ICFBamNumberColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNumberColTableObj()->moveUpNumberCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamNumberColObj::moveDown() {
		cfbam::ICFBamNumberColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNumberColTableObj()->moveDownNumberCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamNumberColObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamNumberColObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNumberColTableObj()->lockNumberCol( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNumberColTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamNumberColEditObj* CFBamNumberColObj::getNumberColEdit() {
		return( dynamic_cast<cfbam::ICFBamNumberColEditObj*>( edit ) );
	}
