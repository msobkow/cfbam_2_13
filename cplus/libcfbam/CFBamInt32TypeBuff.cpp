// Description: C++18 implementation for a Int32Type buffer object.
...
namespace cfbam {
	...
	const std::string CFBamInt32TypeBuff::GENDEFNAME( "Int32Type" );
	const classcode_t CFBamInt32TypeBuff::CLASS_CODE = 0xa826L;
	const std::string CFBamInt32TypeBuff::CLASS_NAME( "CFBamInt32TypeBuff" );
		const std::string CFBamInt32TypeBuff::COLNAME_SCHEMADEFID( "SchemaDefId" );
	const int64_t CFBamInt32TypeBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamInt32TypeBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamInt32TypeBuff::SCHEMADEFID_INIT_VALUE = 0LL;
	const int64_t CFBamInt32TypeBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamInt32TypeBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamInt32TypeBuff::SCHEMADEFID_MIN_VALUE = 0LL;

	CFBamInt32TypeBuff::CFBamInt32TypeBuff()
	: CFBamInt32DefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamInt32TypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamInt32TypeBuff::CFBamInt32TypeBuff( const CFBamInt32TypeBuff& src )
	: CFBamInt32DefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamInt32TypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamInt32TypeBuff::clone() {
		CFBamInt32TypeBuff* copy = new CFBamInt32TypeBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamInt32TypeBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamInt32TypeBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamInt32TypeBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamInt32DefBuff::implementsClassCode( argClassCode ) );
		}
	}

	const int64_t CFBamInt32TypeBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamInt32TypeBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamInt32TypeBuff::setRequiredSchemaDefId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredSchemaDefId" );
		if( value < cfbam::CFBamInt32TypeBuff::SCHEMADEFID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamInt32TypeBuff::SCHEMADEFID_MIN_VALUE );
		}
		requiredSchemaDefId = value;
	}

	size_t CFBamInt32TypeBuff::hashCode() const {
		size_t hashCode = CFBamInt32DefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamInt32TypeBuff CFBamInt32TypeBuff::operator =( cfbam::CFBamInt32TypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamInt32TypeBuff CFBamInt32TypeBuff::operator =( cfbam::CFBamInt32TypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamInt32TypeBuff::operator <( const CFBamInt32TypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamInt32TypeBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt32TypeBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt32TypeBuff::operator <( const CFBamInt32TypeHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt32TypeBuff::operator <( const CFBamInt32TypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamInt32TypeBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt32TypeBuff" );
