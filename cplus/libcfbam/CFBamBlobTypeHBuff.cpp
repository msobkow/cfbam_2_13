// Description: C++18 implementation of a BlobType history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamBlobTypeHBuff::CLASS_NAME( "CFBamBlobTypeHBuff" );
	CFBamBlobTypeHBuff::CFBamBlobTypeHBuff()
	: cfbam::CFBamBlobDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamBlobTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamBlobTypeHBuff::CFBamBlobTypeHBuff( const CFBamBlobTypeHBuff& src )
	: cfbam::CFBamBlobDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamBlobTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamBlobTypeHBuff::clone() {
		CFBamBlobTypeHBuff* copy = new CFBamBlobTypeHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamBlobTypeHBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamBlobTypeHBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamBlobTypeHBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamBlobTypeHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamBlobTypeHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamBlobTypeHBuff CFBamBlobTypeHBuff::operator =( cfbam::CFBamBlobTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamBlobTypeHBuff CFBamBlobTypeHBuff::operator =( cfbam::CFBamBlobTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamBlobTypeHBuff::operator <( const CFBamBlobTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamBlobTypeHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamBlobTypeHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamBlobTypeHBuff::operator <( const CFBamBlobTypeHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamBlobTypeHBuff::operator <( const CFBamBlobTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamBlobTypeHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamBlobTypeHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamBlobTypeHBuff& lhs, const cfbam::CFBamBlobTypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamBlobTypeHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamBlobTypeHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamBlobTypeHBuff& lhs, const cfbam::CFBamBlobTypeHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamBlobTypeHBuff& lhs, const cfbam::CFBamBlobTypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
