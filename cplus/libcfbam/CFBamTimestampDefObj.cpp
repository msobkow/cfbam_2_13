// Description: C++18 base object instance implementation for CFBam TimestampDef.
...
namespace cfbam {
	...
	const std::string CFBamTimestampDefObj::CLASS_NAME( "CFBamTimestampDefObj" );
	const classcode_t CFBamTimestampDefObj::CLASS_CODE = 0xa846L;

	bool CFBamTimestampDefObj::isOptionalDummyNull() {
		return( getTimestampDefBuff()->isOptionalDummyNull() );
	}

	const std::string& CFBamTimestampDefObj::getOptionalDummyValue() {
		return( getTimestampDefBuff()->getOptionalDummyValue() );
	}

	const std::string* CFBamTimestampDefObj::getOptionalDummyReference() {
		return( getTimestampDefBuff()->getOptionalDummyReference() );
	}


	CFBamTimestampDefObj::CFBamTimestampDefObj()
	: ICFBamTimestampDefObj(),
	  CFBamAtomObj()
	{
	}

	CFBamTimestampDefObj::CFBamTimestampDefObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamTimestampDefObj(),
	...
	cfbam::CFBamValueBuff* CFBamTimestampDefObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamTimestampDefBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableTimestampDef()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamTimestampDefObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamTimestampDefObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTimestampDefObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTimestampDefObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamTimestampDefObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTimestampDefObj" );
	...
	std::string CFBamTimestampDefObj::getObjName() {
	...
	const std::string CFBamTimestampDefObj::getGenDefName() {
		return( cfbam::CFBamTimestampDefBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTimestampDefObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTimestampDefObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTimestampDefObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTimestampDefObj::getObjQualifiedName() {
	...
	std::string CFBamTimestampDefObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTimestampDefObj::realize() {
		cfbam::ICFBamTimestampDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimestampDefTableObj()->realizeTimestampDef(
			(cfbam::ICFBamTimestampDefObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTimestampDefObj::read( bool forceRead ) {
		cfbam::ICFBamTimestampDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimestampDefTableObj()->readTimestampDefByIdIdx( getTimestampDefBuff()->getRequiredTenantId(),
		getTimestampDefBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTimestampDefObj::moveUp() {
		cfbam::ICFBamTimestampDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimestampDefTableObj()->moveUpTimestampDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTimestampDefObj::moveDown() {
		cfbam::ICFBamTimestampDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimestampDefTableObj()->moveDownTimestampDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamTimestampDefObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamTimestampDefObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimestampDefTableObj()->lockTimestampDef( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimestampDefTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamTimestampDefEditObj* CFBamTimestampDefObj::getTimestampDefEdit() {
		return( dynamic_cast<cfbam::ICFBamTimestampDefEditObj*>( edit ) );
	}
