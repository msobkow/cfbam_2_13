// Description: C++18 Instance Edit Object interface implementation for CFBam DateCol.
...
namespace cfbam {
	...
	const std::string ICFBamDateColEditObj::CLASS_NAME( "ICFBamDateColEditObj" );

	ICFBamDateColEditObj::ICFBamDateColEditObj()
