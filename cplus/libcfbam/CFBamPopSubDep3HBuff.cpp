// Description: C++18 implementation of a PopSubDep3 history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamPopSubDep3HBuff::CLASS_NAME( "CFBamPopSubDep3HBuff" );
	CFBamPopSubDep3HBuff::CFBamPopSubDep3HBuff()
	...
	CFBamPopSubDep3HBuff::CFBamPopSubDep3HBuff( const CFBamPopSubDep3HBuff& src )
	: cfbam::CFBamPopDepHBuff() {
		requiredPopSubDep2TenantId = cfbam::CFBamPopSubDep3Buff::POPSUBDEP2TENANTID_INIT_VALUE;
		requiredPopSubDep2Id = cfbam::CFBamPopSubDep3Buff::POPSUBDEP2ID_INIT_VALUE;
		requiredName = new std::string( cfbam::CFBamPopSubDep3Buff::NAME_INIT_VALUE );
	...
	cflib::ICFLibCloneableObj* CFBamPopSubDep3HBuff::clone() {
		CFBamPopSubDep3HBuff* copy = new CFBamPopSubDep3HBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamPopSubDep3HBuff::getRequiredPopSubDep2TenantId() const {
		return( requiredPopSubDep2TenantId );
	}

	const int64_t* CFBamPopSubDep3HBuff::getRequiredPopSubDep2TenantIdReference() const {
		return( &requiredPopSubDep2TenantId );
	}

	void CFBamPopSubDep3HBuff::setRequiredPopSubDep2TenantId( const int64_t value ) {
	...
	const int64_t CFBamPopSubDep3HBuff::getRequiredPopSubDep2Id() const {
		return( requiredPopSubDep2Id );
	}

	const int64_t* CFBamPopSubDep3HBuff::getRequiredPopSubDep2IdReference() const {
		return( &requiredPopSubDep2Id );
	}

	void CFBamPopSubDep3HBuff::setRequiredPopSubDep2Id( const int64_t value ) {
	...
	const std::string& CFBamPopSubDep3HBuff::getRequiredName() const {
		return( *requiredName );
	}

	const std::string* CFBamPopSubDep3HBuff::getRequiredNameReference() const {
		return( requiredName );
	}

	void CFBamPopSubDep3HBuff::setRequiredName( const std::string& value ) {
	...
	size_t CFBamPopSubDep3HBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamPopSubDep3HBuff::hashCode();
	...
	CFBamPopSubDep3HBuff CFBamPopSubDep3HBuff::operator =( cfbam::CFBamPopSubDep3Buff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		if( src.isOptionalDefSchemaTenantIdNull() ) {
	...
	CFBamPopSubDep3HBuff CFBamPopSubDep3HBuff::operator =( cfbam::CFBamPopSubDep3HBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		if( src.isOptionalDefSchemaTenantIdNull() ) {
	...
	bool CFBamPopSubDep3HBuff::operator <( const CFBamPopSubDep3ByPopSubDep2IdxKey& rhs ) {
	...
	bool CFBamPopSubDep3HBuff::operator <( const CFBamPopSubDep3ByUNameIdxKey& rhs ) {
		if( getRequiredPopSubDep2TenantId() > rhs.getRequiredPopSubDep2TenantId() ) {
			return( false );
		}
		else if( getRequiredPopSubDep2TenantId() < rhs.getRequiredPopSubDep2TenantId() ) {
	...
	bool CFBamPopSubDep3HBuff::operator <( const CFBamScopePKey& rhs ) {
	...
	bool CFBamPopSubDep3HBuff::operator <( const CFBamScopeHPKey& rhs ) {
	...
	bool CFBamPopSubDep3HBuff::operator <( const CFBamPopSubDep3HBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamPopSubDep3HBuff::operator <( const CFBamPopSubDep3Buff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamPopSubDep3HBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamPopSubDep3HBuff" );
