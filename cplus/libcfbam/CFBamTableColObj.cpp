// Description: C++18 base object instance implementation for CFBam TableCol.
...
namespace cfbam {
	...
	const std::string CFBamTableColObj::CLASS_NAME( "CFBamTableColObj" );
	const classcode_t CFBamTableColObj::CLASS_CODE = 0xa840L;

	const int64_t CFBamTableColObj::getRequiredTableId() {
		return( getTableColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamTableColObj::getRequiredTableIdReference() {
		return( getTableColBuff()->getRequiredTableIdReference() );
	}

	bool CFBamTableColObj::isOptionalDbNameNull() {
		return( getTableColBuff()->isOptionalDbNameNull() );
	}

	const std::string& CFBamTableColObj::getOptionalDbNameValue() {
		return( getTableColBuff()->getOptionalDbNameValue() );
	}

	const std::string* CFBamTableColObj::getOptionalDbNameReference() {
		return( getTableColBuff()->getOptionalDbNameReference() );
	}

	bool CFBamTableColObj::isOptionalDataTenantIdNull() {
		return( getTableColBuff()->isOptionalDataTenantIdNull() );
	}

	const int64_t CFBamTableColObj::getOptionalDataTenantIdValue() {
		return( getTableColBuff()->getOptionalDataTenantIdValue() );
	}

	const int64_t* CFBamTableColObj::getOptionalDataTenantIdReference() {
		return( getTableColBuff()->getOptionalDataTenantIdReference() );
	}

	bool CFBamTableColObj::isOptionalDataIdNull() {
		return( getTableColBuff()->isOptionalDataIdNull() );
	}

	const int64_t CFBamTableColObj::getOptionalDataIdValue() {
		return( getTableColBuff()->getOptionalDataIdValue() );
	}

	const int64_t* CFBamTableColObj::getOptionalDataIdReference() {
		return( getTableColBuff()->getOptionalDataIdReference() );
	}

	bool CFBamTableColObj::isOptionalXmlElementNameNull() {
		return( getTableColBuff()->isOptionalXmlElementNameNull() );
	}

	const std::string& CFBamTableColObj::getOptionalXmlElementNameValue() {
		return( getTableColBuff()->getOptionalXmlElementNameValue() );
	}

	const std::string* CFBamTableColObj::getOptionalXmlElementNameReference() {
		return( getTableColBuff()->getOptionalXmlElementNameReference() );
	}


	cfbam::ICFBamTableObj* CFBamTableColObj::getRequiredContainerTable( bool forceRead ) {
	...
	cfbam::ICFBamValueObj* CFBamTableColObj::getRequiredParentDataType( bool forceRead ) {
		...
		if( ! anyMissing ) {
			retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getValueTableObj()->readValueByIdIdx( getTableColBuff()->getOptionalDataTenantIdValue(),
					getTableColBuff()->getOptionalDataIdValue(), forceRead );
		}
		return( retobj );
	}

	CFBamTableColObj::CFBamTableColObj()
	: ICFBamTableColObj(),
	  CFBamValueObj()
	{
	}

	CFBamTableColObj::CFBamTableColObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamTableColObj(),
	  CFBamValueObj( argSchema )
	{
	}
	...
	cfbam::CFBamValueBuff* CFBamTableColObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamTableColBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableTableCol()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamTableColObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamTableColObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTableColObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTableColObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamTableColBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamValueObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamTableColObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTableColObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamTableColObj::getRequiredTableId() ) );
		if( ! CFBamTableColObj::isOptionalDbNameNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredXmlString( &S_Space, S_DbName, CFBamTableColObj::getOptionalDbNameValue() ) );
		}
		if( ! CFBamTableColObj::isOptionalDataTenantIdNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_DataTenantId, CFBamTableColObj::getOptionalDataTenantIdValue() ) );
		}
		if( ! CFBamTableColObj::isOptionalDataIdNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_DataId, CFBamTableColObj::getOptionalDataIdValue() ) );
		}
		if( ! CFBamTableColObj::isOptionalXmlElementNameNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredXmlString( &S_Space, S_XmlElementName, CFBamTableColObj::getOptionalXmlElementNameValue() ) );
		}
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamTableColObj::getObjName() {
	...
	const std::string CFBamTableColObj::getGenDefName() {
		return( cfbam::CFBamTableColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTableColObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTableColObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTableColObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTableColObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTableColObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTableColObj::getObjQualifiedName() {
	...
	std::string CFBamTableColObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTableColObj::realize() {
		cfbam::ICFBamTableColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTableColTableObj()->realizeTableCol(
			(cfbam::ICFBamTableColObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTableColObj::read( bool forceRead ) {
		cfbam::ICFBamTableColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTableColTableObj()->readTableColByIdIdx( getTableColBuff()->getRequiredTenantId(),
		getTableColBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTableColObj::moveUp() {
		cfbam::ICFBamTableColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTableColTableObj()->moveUpTableCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTableColObj::moveDown() {
		cfbam::ICFBamTableColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTableColTableObj()->moveDownTableCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamTableColObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamTableColObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTableColTableObj()->lockTableCol( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTableColTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamTableColEditObj* CFBamTableColObj::getTableColEdit() {
		return( dynamic_cast<cfbam::ICFBamTableColEditObj*>( edit ) );
	}
