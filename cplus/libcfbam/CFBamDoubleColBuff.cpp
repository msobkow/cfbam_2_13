// Description: C++18 implementation for a DoubleCol buffer object.
...
namespace cfbam {
	...
	const std::string CFBamDoubleColBuff::GENDEFNAME( "DoubleCol" );
	const classcode_t CFBamDoubleColBuff::CLASS_CODE = 0xa855L;
	const std::string CFBamDoubleColBuff::CLASS_NAME( "CFBamDoubleColBuff" );
		const std::string CFBamDoubleColBuff::COLNAME_TABLEID( "TableId" );
	const int64_t CFBamDoubleColBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamDoubleColBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamDoubleColBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamDoubleColBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamDoubleColBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamDoubleColBuff::TABLEID_MIN_VALUE = 0LL;

	CFBamDoubleColBuff::CFBamDoubleColBuff()
	: CFBamDoubleDefBuff()
	{
		requiredTableId = cfbam::CFBamDoubleColBuff::TABLEID_INIT_VALUE;
	}

	CFBamDoubleColBuff::CFBamDoubleColBuff( const CFBamDoubleColBuff& src )
	: CFBamDoubleDefBuff()
	{
		requiredTableId = cfbam::CFBamDoubleColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamDoubleColBuff::clone() {
		CFBamDoubleColBuff* copy = new CFBamDoubleColBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamDoubleColBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamDoubleColBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamDoubleColBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamDoubleDefBuff::implementsClassCode( argClassCode ) );
		}
	}

	const int64_t CFBamDoubleColBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamDoubleColBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamDoubleColBuff::setRequiredTableId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredTableId" );
		if( value < cfbam::CFBamDoubleColBuff::TABLEID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamDoubleColBuff::TABLEID_MIN_VALUE );
		}
		requiredTableId = value;
	}

	size_t CFBamDoubleColBuff::hashCode() const {
		size_t hashCode = CFBamDoubleDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamDoubleColBuff CFBamDoubleColBuff::operator =( cfbam::CFBamDoubleColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamDoubleColBuff CFBamDoubleColBuff::operator =( cfbam::CFBamDoubleColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamDoubleColBuff::operator <( const CFBamDoubleColByTableIdxKey& rhs ) {
	...
	bool CFBamDoubleColBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamDoubleColBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamDoubleColBuff::operator <( const CFBamDoubleColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamDoubleColBuff::operator <( const CFBamDoubleColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamDoubleColBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamDoubleColBuff" );
