// Description: C++18 implementation of a TZTimeDef history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTZTimeDefHBuff::CLASS_NAME( "CFBamTZTimeDefHBuff" );
	CFBamTZTimeDefHBuff::CFBamTZTimeDefHBuff()
	: cfbam::CFBamAtomHBuff() {
		optionalDummy = NULL;
	}

	CFBamTZTimeDefHBuff::CFBamTZTimeDefHBuff( const CFBamTZTimeDefHBuff& src )
	: cfbam::CFBamAtomHBuff() {
		optionalDummy = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamTZTimeDefHBuff::clone() {
		CFBamTZTimeDefHBuff* copy = new CFBamTZTimeDefHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTZTimeDefHBuff::getOptionalDummyValue() const {
	...
	const std::string* CFBamTZTimeDefHBuff::getOptionalDummyReference() const {
		return( optionalDummy );
	}

	const bool CFBamTZTimeDefHBuff::isOptionalDummyNull() const {
		return( optionalDummy == NULL );
	}

	void CFBamTZTimeDefHBuff::setOptionalDummyNull() {
		if( optionalDummy != NULL ) {
			delete optionalDummy;
			optionalDummy = NULL;
		}
	...
	void CFBamTZTimeDefHBuff::setOptionalDummyValue( const std::string& value ) {
	...
	size_t CFBamTZTimeDefHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamTZTimeDefHBuff::hashCode();
	...
	CFBamTZTimeDefHBuff CFBamTZTimeDefHBuff::operator =( cfbam::CFBamTZTimeDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamTZTimeDefHBuff CFBamTZTimeDefHBuff::operator =( cfbam::CFBamTZTimeDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTZTimeDefHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamTZTimeDefHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamTZTimeDefHBuff::operator <( const CFBamTZTimeDefHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamTZTimeDefHBuff::operator <( const CFBamTZTimeDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTZTimeDefHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZTimeDefHBuff" );
