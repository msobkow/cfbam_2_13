// Description: C++18 base object instance implementation for CFBam TextCol.
...
namespace cfbam {
	...
	const std::string CFBamTextColObj::CLASS_NAME( "CFBamTextColObj" );
	const classcode_t CFBamTextColObj::CLASS_CODE = 0xa866L;

	const int64_t CFBamTextColObj::getRequiredTableId() {
		return( getTextColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamTextColObj::getRequiredTableIdReference() {
		return( getTextColBuff()->getRequiredTableIdReference() );
	}


	cfbam::ICFBamTableObj* CFBamTextColObj::getRequiredContainerTable( bool forceRead ) {
	...
	CFBamTextColObj::CFBamTextColObj()
	: ICFBamTextColObj(),
	  CFBamTextDefObj()
	{
	}

	CFBamTextColObj::CFBamTextColObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamTextColObj(),
	...
	cfbam::CFBamValueBuff* CFBamTextColObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamTextColBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableTextCol()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamTextColObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamTextColObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTextColObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTextColObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamTextColObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTextColObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamTextColObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamTextColObj::getObjName() {
	...
	const std::string CFBamTextColObj::getGenDefName() {
		return( cfbam::CFBamTextColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTextColObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTextColObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTextColObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTextColObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTextColObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTextColObj::getObjQualifiedName() {
	...
	std::string CFBamTextColObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTextColObj::realize() {
		cfbam::ICFBamTextColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTextColTableObj()->realizeTextCol(
			(cfbam::ICFBamTextColObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTextColObj::read( bool forceRead ) {
		cfbam::ICFBamTextColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTextColTableObj()->readTextColByIdIdx( getTextColBuff()->getRequiredTenantId(),
		getTextColBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTextColObj::moveUp() {
		cfbam::ICFBamTextColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTextColTableObj()->moveUpTextCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTextColObj::moveDown() {
		cfbam::ICFBamTextColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTextColTableObj()->moveDownTextCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamTextColObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamTextColObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTextColTableObj()->lockTextCol( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTextColTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamTextColEditObj* CFBamTextColObj::getTextColEdit() {
		return( dynamic_cast<cfbam::ICFBamTextColEditObj*>( edit ) );
	}
