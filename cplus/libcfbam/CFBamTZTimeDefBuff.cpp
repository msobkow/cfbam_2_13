// Description: C++18 implementation for a TZTimeDef buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTZTimeDefBuff::GENDEFNAME( "TZTimeDef" );
	const classcode_t CFBamTZTimeDefBuff::CLASS_CODE = 0xa83cL;
	const std::string CFBamTZTimeDefBuff::CLASS_NAME( "CFBamTZTimeDefBuff" );
		const std::string CFBamTZTimeDefBuff::COLNAME_DUMMY( "Dummy" );
	const int64_t CFBamTZTimeDefBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamTZTimeDefBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamTZTimeDefBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamTZTimeDefBuff::ID_MIN_VALUE = 0LL;
	const std::string::size_type CFBamTZTimeDefBuff::DUMMY_MAX_LEN = 4;

	CFBamTZTimeDefBuff::CFBamTZTimeDefBuff()
	: CFBamAtomBuff()
	{
		optionalDummy = NULL;
	}

	CFBamTZTimeDefBuff::CFBamTZTimeDefBuff( const CFBamTZTimeDefBuff& src )
	: CFBamAtomBuff()
	{
		optionalDummy = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamTZTimeDefBuff::clone() {
		CFBamTZTimeDefBuff* copy = new CFBamTZTimeDefBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTZTimeDefBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTZTimeDefBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTZTimeDefBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const bool CFBamTZTimeDefBuff::isOptionalDummyNull() const {
		return( optionalDummy == NULL );
	}

	const std::string& CFBamTZTimeDefBuff::getOptionalDummyValue() const {
	...
	const std::string* CFBamTZTimeDefBuff::getOptionalDummyReference() const {
		return( optionalDummy );
	}

	void CFBamTZTimeDefBuff::setOptionalDummyNull() {
		if( optionalDummy != NULL ) {
			delete optionalDummy;
			optionalDummy = NULL;
		}
	...
	void CFBamTZTimeDefBuff::setOptionalDummyValue( const std::string& value ) {
		static const std::string S_ProcName( "setOptionalDummyValue" );
		if( value.length() > CFBamTZTimeDefBuff::DUMMY_MAX_LEN ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE_LENGTH,
				value.length(),
				CFBamTZTimeDefBuff::DUMMY_MAX_LEN );
		}
		if( optionalDummy != NULL ) {
			delete optionalDummy;
			optionalDummy = NULL;
	...
	size_t CFBamTZTimeDefBuff::hashCode() const {
	...
	CFBamTZTimeDefBuff CFBamTZTimeDefBuff::operator =( cfbam::CFBamTZTimeDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamTZTimeDefBuff CFBamTZTimeDefBuff::operator =( cfbam::CFBamTZTimeDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTZTimeDefBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamTZTimeDefBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZTimeDefBuff::operator <( const CFBamTZTimeDefHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZTimeDefBuff::operator <( const CFBamTZTimeDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTZTimeDefBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZTimeDefBuff" );
