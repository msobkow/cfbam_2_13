// Description: C++18 edit object instance implementation for CFBam TZDateCol.
...
namespace cfbam {
	...
	const std::string CFBamTZDateColEditObj::CLASS_NAME( "CFBamTZDateColEditObj" );

	CFBamTZDateColEditObj::CFBamTZDateColEditObj( cfbam::ICFBamTZDateColObj* argOrig )
	: ICFBamTZDateColEditObj(),
	  CFBamTZDateDefEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamTZDateColEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamTZDateColEditObj::~CFBamTZDateColEditObj() {
	}

	const std::string& CFBamTZDateColEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTZDateColEditObj::getClassCode() const {
		return( cfbam::CFBamTZDateColBuff::CLASS_CODE );
	}

	bool CFBamTZDateColEditObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamTZDateColBuff::CLASS_CODE ) {
			return( true );
		}
		else {
	...
	std::string CFBamTZDateColEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZDateColEditObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamTZDateColEditObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	const std::string CFBamTZDateColEditObj::getGenDefName() {
		return( cfbam::CFBamTZDateColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTZDateColEditObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTZDateColEditObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTZDateColEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTZDateColEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTZDateColEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTZDateColEditObj::getObjQualifiedName() {
	...
	std::string CFBamTZDateColEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTZDateColEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamTZDateColObj* retobj = getSchema()->getTZDateColTableObj()->realizeTZDateCol( dynamic_cast<cfbam::ICFBamTZDateColObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamTZDateColEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamTZDateColEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamTZDateColEditObj::create() {
		cfbam::ICFBamTZDateColObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsTZDateCol()->getSchema() )->getTZDateColTableObj()->createTZDateCol( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamTZDateColEditObj::update() {
		getSchema()->getTZDateColTableObj()->updateTZDateCol( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamTZDateColEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getTZDateColTableObj()->deleteTZDateCol( this );
		return( NULL );
	}

	cfbam::ICFBamTZDateColTableObj* CFBamTZDateColEditObj::getTZDateColTable() {
		return( orig->getSchema()->getTZDateColTableObj() );
	}

	cfbam::ICFBamTZDateColEditObj* CFBamTZDateColEditObj::getTZDateColEdit() {
		return( (cfbam::ICFBamTZDateColEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamTZDateColEditObj::beginEdit() {
	...
	cfbam::ICFBamTZDateColObj* CFBamTZDateColEditObj::getOrigAsTZDateCol() {
		return( dynamic_cast<cfbam::ICFBamTZDateColObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamTZDateColEditObj::getBuff() {
		return( buff );
	}

	void CFBamTZDateColEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamTZDateDefEditObj::setBuff( value );
		}
	}

	const int64_t CFBamTZDateColEditObj::getRequiredTableId() {
		return( getTZDateColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamTZDateColEditObj::getRequiredTableIdReference() {
		return( getTZDateColBuff()->getRequiredTableIdReference() );
	}

	void CFBamTZDateColEditObj::setRequiredContainerScope( cfbam::ICFBamScopeObj* value ) {
		if( value == NULL ) {
	...
	cfbam::ICFBamTableObj* CFBamTZDateColEditObj::getRequiredContainerTable( bool forceRead ) {
		cfbam::ICFBamTableObj* retobj = NULL;
		bool anyMissing = false;
		if( ! anyMissing ) {
			retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsTZDateCol()->getSchema() )->getTableTableObj()->readTableByIdIdx( getPKey()->getRequiredTenantId(),
					getTZDateColBuff()->getRequiredTableId() );
		}
		return( retobj );
	}

	void CFBamTZDateColEditObj::setRequiredContainerTable( cfbam::ICFBamTableObj* value ) {
			
			if( value != NULL ) {
				getPKey()->setRequiredTenantId
( value->getRequiredTenantId() );
				getTZDateColEditBuff()->setRequiredTenantId( value->getRequiredTenantId() );
				getTZDateColEditBuff()->setRequiredTableId( value->getRequiredId() );
			}

			CFBamTZDateDefEditObj::setRequiredContainerScope( value );		}

	void CFBamTZDateColEditObj::copyBuffToOrig() {
		cfbam::CFBamTZDateColBuff* origBuff = getOrigAsTZDateCol()->getTZDateColEditBuff();
		cfbam::CFBamTZDateColBuff* myBuff = getTZDateColBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamTZDateColEditObj::copyOrigToBuff() {
		cfbam::CFBamTZDateColBuff* origBuff = getOrigAsTZDateCol()->getTZDateColBuff();
		cfbam::CFBamTZDateColBuff* myBuff = getTZDateColEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
