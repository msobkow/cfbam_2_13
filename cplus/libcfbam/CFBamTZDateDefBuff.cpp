// Description: C++18 implementation for a TZDateDef buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTZDateDefBuff::GENDEFNAME( "TZDateDef" );
	const classcode_t CFBamTZDateDefBuff::CLASS_CODE = 0xa83aL;
	const std::string CFBamTZDateDefBuff::CLASS_NAME( "CFBamTZDateDefBuff" );
		const std::string CFBamTZDateDefBuff::COLNAME_DUMMY( "Dummy" );
	const int64_t CFBamTZDateDefBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamTZDateDefBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamTZDateDefBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamTZDateDefBuff::ID_MIN_VALUE = 0LL;
	const std::string::size_type CFBamTZDateDefBuff::DUMMY_MAX_LEN = 4;

	CFBamTZDateDefBuff::CFBamTZDateDefBuff()
	: CFBamAtomBuff()
	{
		optionalDummy = NULL;
	}

	CFBamTZDateDefBuff::CFBamTZDateDefBuff( const CFBamTZDateDefBuff& src )
	: CFBamAtomBuff()
	{
		optionalDummy = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamTZDateDefBuff::clone() {
		CFBamTZDateDefBuff* copy = new CFBamTZDateDefBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTZDateDefBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTZDateDefBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTZDateDefBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const bool CFBamTZDateDefBuff::isOptionalDummyNull() const {
		return( optionalDummy == NULL );
	}

	const std::string& CFBamTZDateDefBuff::getOptionalDummyValue() const {
	...
	const std::string* CFBamTZDateDefBuff::getOptionalDummyReference() const {
		return( optionalDummy );
	}

	void CFBamTZDateDefBuff::setOptionalDummyNull() {
		if( optionalDummy != NULL ) {
			delete optionalDummy;
			optionalDummy = NULL;
		}
	...
	void CFBamTZDateDefBuff::setOptionalDummyValue( const std::string& value ) {
		static const std::string S_ProcName( "setOptionalDummyValue" );
		if( value.length() > CFBamTZDateDefBuff::DUMMY_MAX_LEN ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE_LENGTH,
				value.length(),
				CFBamTZDateDefBuff::DUMMY_MAX_LEN );
		}
		if( optionalDummy != NULL ) {
			delete optionalDummy;
			optionalDummy = NULL;
	...
	size_t CFBamTZDateDefBuff::hashCode() const {
	...
	CFBamTZDateDefBuff CFBamTZDateDefBuff::operator =( cfbam::CFBamTZDateDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamTZDateDefBuff CFBamTZDateDefBuff::operator =( cfbam::CFBamTZDateDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTZDateDefBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamTZDateDefBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZDateDefBuff::operator <( const CFBamTZDateDefHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZDateDefBuff::operator <( const CFBamTZDateDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTZDateDefBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZDateDefBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamTZDateDefBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTZDateDefBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTZDateDefBuff& lhs, const cfbam::CFBamTZDateDefHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTZDateDefBuff& lhs, const cfbam::CFBamTZDateDefBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
