// Description: C++18 Instance Edit Object interface implementation for CFBam UInt16Type.
...
namespace cfbam {
	...
	const std::string ICFBamUInt16TypeEditObj::CLASS_NAME( "ICFBamUInt16TypeEditObj" );

	ICFBamUInt16TypeEditObj::ICFBamUInt16TypeEditObj()
