// Description: C++18 implementation of a Int16Col history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamInt16ColHBuff::CLASS_NAME( "CFBamInt16ColHBuff" );
	CFBamInt16ColHBuff::CFBamInt16ColHBuff()
	: cfbam::CFBamInt16DefHBuff() {
		requiredTableId = cfbam::CFBamInt16ColBuff::TABLEID_INIT_VALUE;
	}

	CFBamInt16ColHBuff::CFBamInt16ColHBuff( const CFBamInt16ColHBuff& src )
	: cfbam::CFBamInt16DefHBuff() {
		requiredTableId = cfbam::CFBamInt16ColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamInt16ColHBuff::clone() {
		CFBamInt16ColHBuff* copy = new CFBamInt16ColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamInt16ColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamInt16ColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamInt16ColHBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamInt16ColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamInt16ColHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamInt16ColHBuff CFBamInt16ColHBuff::operator =( cfbam::CFBamInt16ColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamInt16ColHBuff CFBamInt16ColHBuff::operator =( cfbam::CFBamInt16ColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamInt16ColHBuff::operator <( const CFBamInt16ColByTableIdxKey& rhs ) {
	...
	bool CFBamInt16ColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt16ColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamInt16ColHBuff::operator <( const CFBamInt16ColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamInt16ColHBuff::operator <( const CFBamInt16ColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamInt16ColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt16ColHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamInt16ColHBuff& lhs, const cfbam::CFBamInt16ColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamInt16ColHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamInt16ColHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamInt16ColHBuff& lhs, const cfbam::CFBamInt16ColHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamInt16ColHBuff& lhs, const cfbam::CFBamInt16ColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
