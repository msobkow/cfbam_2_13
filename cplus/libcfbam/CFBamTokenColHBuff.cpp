// Description: C++18 implementation of a TokenCol history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTokenColHBuff::CLASS_NAME( "CFBamTokenColHBuff" );
	CFBamTokenColHBuff::CFBamTokenColHBuff()
	: cfbam::CFBamTokenDefHBuff() {
		requiredTableId = cfbam::CFBamTokenColBuff::TABLEID_INIT_VALUE;
	}

	CFBamTokenColHBuff::CFBamTokenColHBuff( const CFBamTokenColHBuff& src )
	: cfbam::CFBamTokenDefHBuff() {
		requiredTableId = cfbam::CFBamTokenColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTokenColHBuff::clone() {
		CFBamTokenColHBuff* copy = new CFBamTokenColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamTokenColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamTokenColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamTokenColHBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamTokenColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamTokenColHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamTokenColHBuff CFBamTokenColHBuff::operator =( cfbam::CFBamTokenColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamTokenColHBuff CFBamTokenColHBuff::operator =( cfbam::CFBamTokenColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTokenColHBuff::operator <( const CFBamTokenColByTableIdxKey& rhs ) {
	...
	bool CFBamTokenColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTokenColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamTokenColHBuff::operator <( const CFBamTokenColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamTokenColHBuff::operator <( const CFBamTokenColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTokenColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTokenColHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamTokenColHBuff& lhs, const cfbam::CFBamTokenColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTokenColHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTokenColHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTokenColHBuff& lhs, const cfbam::CFBamTokenColHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamTokenColHBuff& lhs, const cfbam::CFBamTokenColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
