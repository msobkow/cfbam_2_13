// Description: C++18 implementation for a UuidCol buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUuidColBuff::GENDEFNAME( "UuidCol" );
	const classcode_t CFBamUuidColBuff::CLASS_CODE = 0xa86dL;
	const std::string CFBamUuidColBuff::CLASS_NAME( "CFBamUuidColBuff" );
		const std::string CFBamUuidColBuff::COLNAME_TABLEID( "TableId" );
	const int64_t CFBamUuidColBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamUuidColBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamUuidColBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamUuidColBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamUuidColBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamUuidColBuff::TABLEID_MIN_VALUE = 0LL;

	CFBamUuidColBuff::CFBamUuidColBuff()
	: CFBamUuidDefBuff()
	{
		requiredTableId = cfbam::CFBamUuidColBuff::TABLEID_INIT_VALUE;
	}

	CFBamUuidColBuff::CFBamUuidColBuff( const CFBamUuidColBuff& src )
	: CFBamUuidDefBuff()
	{
		requiredTableId = cfbam::CFBamUuidColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamUuidColBuff::clone() {
		CFBamUuidColBuff* copy = new CFBamUuidColBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamUuidColBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUuidColBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamUuidColBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamUuidDefBuff::implementsClassCode( argClassCode ) );
		}
	}

	const int64_t CFBamUuidColBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamUuidColBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamUuidColBuff::setRequiredTableId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredTableId" );
		if( value < cfbam::CFBamUuidColBuff::TABLEID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamUuidColBuff::TABLEID_MIN_VALUE );
		}
		requiredTableId = value;
	}

	size_t CFBamUuidColBuff::hashCode() const {
		size_t hashCode = CFBamUuidDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamUuidColBuff CFBamUuidColBuff::operator =( cfbam::CFBamUuidColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamUuidColBuff CFBamUuidColBuff::operator =( cfbam::CFBamUuidColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUuidColBuff::operator <( const CFBamUuidColByTableIdxKey& rhs ) {
	...
	bool CFBamUuidColBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUuidColBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUuidColBuff::operator <( const CFBamUuidColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUuidColBuff::operator <( const CFBamUuidColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUuidColBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUuidColBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamUuidColBuff& lhs, const cfbam::CFBamUuidColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamUuidColBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamUuidColBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamUuidColBuff& lhs, const cfbam::CFBamUuidColHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamUuidColBuff& lhs, const cfbam::CFBamUuidColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
