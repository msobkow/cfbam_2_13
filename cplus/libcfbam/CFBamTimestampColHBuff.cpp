// Description: C++18 implementation of a TimestampCol history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTimestampColHBuff::CLASS_NAME( "CFBamTimestampColHBuff" );
	CFBamTimestampColHBuff::CFBamTimestampColHBuff()
	: cfbam::CFBamTimestampDefHBuff() {
		requiredTableId = cfbam::CFBamTimestampColBuff::TABLEID_INIT_VALUE;
	}

	CFBamTimestampColHBuff::CFBamTimestampColHBuff( const CFBamTimestampColHBuff& src )
	: cfbam::CFBamTimestampDefHBuff() {
		requiredTableId = cfbam::CFBamTimestampColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTimestampColHBuff::clone() {
		CFBamTimestampColHBuff* copy = new CFBamTimestampColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamTimestampColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamTimestampColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamTimestampColHBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamTimestampColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamTimestampColHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamTimestampColHBuff CFBamTimestampColHBuff::operator =( cfbam::CFBamTimestampColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamTimestampColHBuff CFBamTimestampColHBuff::operator =( cfbam::CFBamTimestampColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTimestampColHBuff::operator <( const CFBamTimestampColByTableIdxKey& rhs ) {
	...
	bool CFBamTimestampColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTimestampColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamTimestampColHBuff::operator <( const CFBamTimestampColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamTimestampColHBuff::operator <( const CFBamTimestampColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTimestampColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTimestampColHBuff" );
