// Description: C++18 edit object instance implementation for CFBam UInt32Type.
...
namespace cfbam {
	...
	const std::string CFBamUInt32TypeEditObj::CLASS_NAME( "CFBamUInt32TypeEditObj" );

	CFBamUInt32TypeEditObj::CFBamUInt32TypeEditObj( cfbam::ICFBamUInt32TypeObj* argOrig )
	: ICFBamUInt32TypeEditObj(),
	  CFBamUInt32DefEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamUInt32TypeEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamUInt32TypeEditObj::~CFBamUInt32TypeEditObj() {
	}

	const std::string& CFBamUInt32TypeEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUInt32TypeEditObj::getClassCode() const {
		return( cfbam::CFBamUInt32TypeBuff::CLASS_CODE );
	}

	bool CFBamUInt32TypeEditObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamUInt32TypeBuff::CLASS_CODE ) {
			return( true );
		}
		else {
	...
	std::string CFBamUInt32TypeEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt32TypeEditObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamUInt32TypeEditObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	const std::string CFBamUInt32TypeEditObj::getGenDefName() {
		return( cfbam::CFBamUInt32TypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamUInt32TypeEditObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamUInt32TypeEditObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamUInt32TypeEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamUInt32TypeEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamUInt32TypeEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamUInt32TypeEditObj::getObjQualifiedName() {
	...
	std::string CFBamUInt32TypeEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamUInt32TypeEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamUInt32TypeObj* retobj = getSchema()->getUInt32TypeTableObj()->realizeUInt32Type( dynamic_cast<cfbam::ICFBamUInt32TypeObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamUInt32TypeEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamUInt32TypeEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamUInt32TypeEditObj::create() {
		cfbam::ICFBamUInt32TypeObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsUInt32Type()->getSchema() )->getUInt32TypeTableObj()->createUInt32Type( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamUInt32TypeEditObj::update() {
		getSchema()->getUInt32TypeTableObj()->updateUInt32Type( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamUInt32TypeEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getUInt32TypeTableObj()->deleteUInt32Type( this );
		return( NULL );
	}

	cfbam::ICFBamUInt32TypeTableObj* CFBamUInt32TypeEditObj::getUInt32TypeTable() {
		return( orig->getSchema()->getUInt32TypeTableObj() );
	}

	cfbam::ICFBamUInt32TypeEditObj* CFBamUInt32TypeEditObj::getUInt32TypeEdit() {
		return( (cfbam::ICFBamUInt32TypeEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamUInt32TypeEditObj::beginEdit() {
	...
	cfbam::ICFBamUInt32TypeObj* CFBamUInt32TypeEditObj::getOrigAsUInt32Type() {
		return( dynamic_cast<cfbam::ICFBamUInt32TypeObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamUInt32TypeEditObj::getBuff() {
		return( buff );
	}

	void CFBamUInt32TypeEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamUInt32DefEditObj::setBuff( value );
		}
	}

	const int64_t CFBamUInt32TypeEditObj::getRequiredSchemaDefId() {
		return( getUInt32TypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamUInt32TypeEditObj::getRequiredSchemaDefIdReference() {
		return( getUInt32TypeBuff()->getRequiredSchemaDefIdReference() );
	}

	void CFBamUInt32TypeEditObj::setRequiredContainerScope( cfbam::ICFBamScopeObj* value ) {
		if( value == NULL ) {
	...
	cfbam::ICFBamSchemaDefObj* CFBamUInt32TypeEditObj::getRequiredContainerSchemaDef( bool forceRead ) {
		cfbam::ICFBamSchemaDefObj* retobj = NULL;
		bool anyMissing = false;
		if( ! anyMissing ) {
			retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsUInt32Type()->getSchema() )->getSchemaDefTableObj()->readSchemaDefByIdIdx( getPKey()->getRequiredTenantId(),
					getUInt32TypeBuff()->getRequiredSchemaDefId() );
		}
		return( retobj );
	}

	void CFBamUInt32TypeEditObj::setRequiredContainerSchemaDef( cfbam::ICFBamSchemaDefObj* value ) {
			
			if( value != NULL ) {
				getPKey()->setRequiredTenantId
( value->getRequiredTenantId() );
				getUInt32TypeEditBuff()->setRequiredTenantId( value->getRequiredTenantId() );
				getUInt32TypeEditBuff()->setRequiredSchemaDefId( value->getRequiredId() );
			}

			CFBamUInt32DefEditObj::setRequiredContainerScope( value );		}

	void CFBamUInt32TypeEditObj::copyBuffToOrig() {
		cfbam::CFBamUInt32TypeBuff* origBuff = getOrigAsUInt32Type()->getUInt32TypeEditBuff();
		cfbam::CFBamUInt32TypeBuff* myBuff = getUInt32TypeBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamUInt32TypeEditObj::copyOrigToBuff() {
		cfbam::CFBamUInt32TypeBuff* origBuff = getOrigAsUInt32Type()->getUInt32TypeBuff();
		cfbam::CFBamUInt32TypeBuff* myBuff = getUInt32TypeEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
