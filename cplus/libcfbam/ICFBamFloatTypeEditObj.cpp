// Description: C++18 Instance Edit Object interface implementation for CFBam FloatType.
...
namespace cfbam {
	...
	const std::string ICFBamFloatTypeEditObj::CLASS_NAME( "ICFBamFloatTypeEditObj" );

	ICFBamFloatTypeEditObj::ICFBamFloatTypeEditObj()
