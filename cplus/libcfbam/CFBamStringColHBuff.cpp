// Description: C++18 implementation of a StringCol history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamStringColHBuff::CLASS_NAME( "CFBamStringColHBuff" );
	CFBamStringColHBuff::CFBamStringColHBuff()
	: cfbam::CFBamStringDefHBuff() {
		requiredTableId = cfbam::CFBamStringColBuff::TABLEID_INIT_VALUE;
	}

	CFBamStringColHBuff::CFBamStringColHBuff( const CFBamStringColHBuff& src )
	: cfbam::CFBamStringDefHBuff() {
		requiredTableId = cfbam::CFBamStringColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamStringColHBuff::clone() {
		CFBamStringColHBuff* copy = new CFBamStringColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamStringColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamStringColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamStringColHBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamStringColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamStringColHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamStringColHBuff CFBamStringColHBuff::operator =( cfbam::CFBamStringColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamStringColHBuff CFBamStringColHBuff::operator =( cfbam::CFBamStringColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamStringColHBuff::operator <( const CFBamStringColByTableIdxKey& rhs ) {
	...
	bool CFBamStringColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamStringColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamStringColHBuff::operator <( const CFBamStringColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamStringColHBuff::operator <( const CFBamStringColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamStringColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamStringColHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamStringColHBuff& lhs, const cfbam::CFBamStringColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamStringColHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamStringColHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamStringColHBuff& lhs, const cfbam::CFBamStringColHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamStringColHBuff& lhs, const cfbam::CFBamStringColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
