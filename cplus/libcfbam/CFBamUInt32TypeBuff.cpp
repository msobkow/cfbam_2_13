// Description: C++18 implementation for a UInt32Type buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUInt32TypeBuff::GENDEFNAME( "UInt32Type" );
	const classcode_t CFBamUInt32TypeBuff::CLASS_CODE = 0xa84dL;
	const std::string CFBamUInt32TypeBuff::CLASS_NAME( "CFBamUInt32TypeBuff" );
		const std::string CFBamUInt32TypeBuff::COLNAME_SCHEMADEFID( "SchemaDefId" );
	const int64_t CFBamUInt32TypeBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamUInt32TypeBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamUInt32TypeBuff::SCHEMADEFID_INIT_VALUE = 0LL;
	const int64_t CFBamUInt32TypeBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamUInt32TypeBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamUInt32TypeBuff::SCHEMADEFID_MIN_VALUE = 0LL;

	CFBamUInt32TypeBuff::CFBamUInt32TypeBuff()
	: CFBamUInt32DefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamUInt32TypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamUInt32TypeBuff::CFBamUInt32TypeBuff( const CFBamUInt32TypeBuff& src )
	: CFBamUInt32DefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamUInt32TypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamUInt32TypeBuff::clone() {
		CFBamUInt32TypeBuff* copy = new CFBamUInt32TypeBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamUInt32TypeBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUInt32TypeBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamUInt32TypeBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamUInt32DefBuff::implementsClassCode( argClassCode ) );
		}
	}

	const int64_t CFBamUInt32TypeBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamUInt32TypeBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamUInt32TypeBuff::setRequiredSchemaDefId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredSchemaDefId" );
		if( value < cfbam::CFBamUInt32TypeBuff::SCHEMADEFID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamUInt32TypeBuff::SCHEMADEFID_MIN_VALUE );
		}
		requiredSchemaDefId = value;
	}

	size_t CFBamUInt32TypeBuff::hashCode() const {
		size_t hashCode = CFBamUInt32DefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamUInt32TypeBuff CFBamUInt32TypeBuff::operator =( cfbam::CFBamUInt32TypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamUInt32TypeBuff CFBamUInt32TypeBuff::operator =( cfbam::CFBamUInt32TypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUInt32TypeBuff::operator <( const CFBamUInt32TypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamUInt32TypeBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt32TypeBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt32TypeBuff::operator <( const CFBamUInt32TypeHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt32TypeBuff::operator <( const CFBamUInt32TypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUInt32TypeBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt32TypeBuff" );
