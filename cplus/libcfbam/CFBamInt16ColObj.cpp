// Description: C++18 base object instance implementation for CFBam Int16Col.
...
namespace cfbam {
	...
	const std::string CFBamInt16ColObj::CLASS_NAME( "CFBamInt16ColObj" );
	const classcode_t CFBamInt16ColObj::CLASS_CODE = 0xa85cL;

	const int64_t CFBamInt16ColObj::getRequiredTableId() {
		return( getInt16ColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamInt16ColObj::getRequiredTableIdReference() {
		return( getInt16ColBuff()->getRequiredTableIdReference() );
	}


	cfbam::ICFBamTableObj* CFBamInt16ColObj::getRequiredContainerTable( bool forceRead ) {
	...
	CFBamInt16ColObj::CFBamInt16ColObj()
	: ICFBamInt16ColObj(),
	  CFBamInt16DefObj()
	{
	}

	CFBamInt16ColObj::CFBamInt16ColObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamInt16ColObj(),
	  CFBamInt16DefObj( argSchema )
	{
	}
	...
	cfbam::CFBamValueBuff* CFBamInt16ColObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamInt16ColBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableInt16Col()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamInt16ColObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamInt16ColObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamInt16ColObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamInt16ColObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamInt16ColBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamInt16DefObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamInt16ColObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt16ColObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamInt16ColObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamInt16ColObj::getObjName() {
	...
	const std::string CFBamInt16ColObj::getGenDefName() {
		return( cfbam::CFBamInt16ColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamInt16ColObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamInt16ColObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamInt16ColObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamInt16ColObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamInt16ColObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamInt16ColObj::getObjQualifiedName() {
	...
	std::string CFBamInt16ColObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamInt16ColObj::realize() {
		cfbam::ICFBamInt16ColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt16ColTableObj()->realizeInt16Col(
			(cfbam::ICFBamInt16ColObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamInt16ColObj::read( bool forceRead ) {
		cfbam::ICFBamInt16ColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt16ColTableObj()->readInt16ColByIdIdx( getInt16ColBuff()->getRequiredTenantId(),
		getInt16ColBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamInt16ColObj::moveUp() {
		cfbam::ICFBamInt16ColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt16ColTableObj()->moveUpInt16Col( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamInt16ColObj::moveDown() {
		cfbam::ICFBamInt16ColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt16ColTableObj()->moveDownInt16Col( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamInt16ColObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamInt16ColObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt16ColTableObj()->lockInt16Col( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt16ColTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamInt16ColEditObj* CFBamInt16ColObj::getInt16ColEdit() {
		return( dynamic_cast<cfbam::ICFBamInt16ColEditObj*>( edit ) );
	}
