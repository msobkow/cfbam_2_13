// Description: C++18 base object instance implementation for CFBam TokenType.
...
namespace cfbam {
	...
	const std::string CFBamTokenTypeObj::CLASS_NAME( "CFBamTokenTypeObj" );
	const classcode_t CFBamTokenTypeObj::CLASS_CODE = 0xa849L;

	const int64_t CFBamTokenTypeObj::getRequiredSchemaDefId() {
		return( getTokenTypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamTokenTypeObj::getRequiredSchemaDefIdReference() {
		return( getTokenTypeBuff()->getRequiredSchemaDefIdReference() );
	}


	cfbam::ICFBamSchemaDefObj* CFBamTokenTypeObj::getRequiredContainerSchemaDef( bool forceRead ) {
	...
	CFBamTokenTypeObj::CFBamTokenTypeObj()
	: ICFBamTokenTypeObj(),
	  CFBamTokenDefObj()
	{
	}

	CFBamTokenTypeObj::CFBamTokenTypeObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamTokenTypeObj(),
	  CFBamTokenDefObj( argSchema )
	{
	}
	...
	cfbam::CFBamValueBuff* CFBamTokenTypeObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamTokenTypeBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableTokenType()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamTokenTypeObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamTokenTypeObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTokenTypeObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTokenTypeObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamTokenTypeBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamTokenDefObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamTokenTypeObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTokenTypeObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt32( &S_Space, S_MaxLen, CFBamTokenDefObj::getRequiredMaxLen() ) );
		if( ! CFBamTokenDefObj::isOptionalInitValueNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredXmlString( &S_Space, S_InitValue, CFBamTokenDefObj::getOptionalInitValueValue() ) );
		}
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamTokenTypeObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamTokenTypeObj::getObjName() {
	...
	const std::string CFBamTokenTypeObj::getGenDefName() {
		return( cfbam::CFBamTokenTypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTokenTypeObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTokenTypeObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTokenTypeObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTokenTypeObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTokenTypeObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTokenTypeObj::getObjQualifiedName() {
	...
	std::string CFBamTokenTypeObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTokenTypeObj::realize() {
		cfbam::ICFBamTokenTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTokenTypeTableObj()->realizeTokenType(
			(cfbam::ICFBamTokenTypeObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTokenTypeObj::read( bool forceRead ) {
		cfbam::ICFBamTokenTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTokenTypeTableObj()->readTokenTypeByIdIdx( getTokenTypeBuff()->getRequiredTenantId(),
		getTokenTypeBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTokenTypeObj::moveUp() {
		cfbam::ICFBamTokenTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTokenTypeTableObj()->moveUpTokenType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTokenTypeObj::moveDown() {
		cfbam::ICFBamTokenTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTokenTypeTableObj()->moveDownTokenType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamTokenTypeObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamTokenTypeObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTokenTypeTableObj()->lockTokenType( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTokenTypeTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamTokenTypeEditObj* CFBamTokenTypeObj::getTokenTypeEdit() {
		return( dynamic_cast<cfbam::ICFBamTokenTypeEditObj*>( edit ) );
	}
