// Description: C++18 implementation for a BlobType buffer object.
...
namespace cfbam {
	...
	const std::string CFBamBlobTypeBuff::GENDEFNAME( "BlobType" );
	const classcode_t CFBamBlobTypeBuff::CLASS_CODE = 0xa80cL;
	const std::string CFBamBlobTypeBuff::CLASS_NAME( "CFBamBlobTypeBuff" );
		const std::string CFBamBlobTypeBuff::COLNAME_SCHEMADEFID( "SchemaDefId" );
	const int64_t CFBamBlobTypeBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamBlobTypeBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamBlobTypeBuff::SCHEMADEFID_INIT_VALUE = 0LL;
	const int64_t CFBamBlobTypeBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamBlobTypeBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamBlobTypeBuff::SCHEMADEFID_MIN_VALUE = 0LL;

	CFBamBlobTypeBuff::CFBamBlobTypeBuff()
	: CFBamBlobDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamBlobTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamBlobTypeBuff::CFBamBlobTypeBuff( const CFBamBlobTypeBuff& src )
	: CFBamBlobDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamBlobTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamBlobTypeBuff::clone() {
		CFBamBlobTypeBuff* copy = new CFBamBlobTypeBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamBlobTypeBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamBlobTypeBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamBlobTypeBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamBlobDefBuff::implementsClassCode( argClassCode ) );
		}
	}

	const int64_t CFBamBlobTypeBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamBlobTypeBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamBlobTypeBuff::setRequiredSchemaDefId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredSchemaDefId" );
		if( value < cfbam::CFBamBlobTypeBuff::SCHEMADEFID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamBlobTypeBuff::SCHEMADEFID_MIN_VALUE );
		}
		requiredSchemaDefId = value;
	}

	size_t CFBamBlobTypeBuff::hashCode() const {
		size_t hashCode = CFBamBlobDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamBlobTypeBuff CFBamBlobTypeBuff::operator =( cfbam::CFBamBlobTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamBlobTypeBuff CFBamBlobTypeBuff::operator =( cfbam::CFBamBlobTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamBlobTypeBuff::operator <( const CFBamBlobTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamBlobTypeBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamBlobTypeBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamBlobTypeBuff::operator <( const CFBamBlobTypeHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamBlobTypeBuff::operator <( const CFBamBlobTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamBlobTypeBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamBlobTypeBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamBlobTypeBuff& lhs, const cfbam::CFBamBlobTypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamBlobTypeBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamBlobTypeBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamBlobTypeBuff& lhs, const cfbam::CFBamBlobTypeHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamBlobTypeBuff& lhs, const cfbam::CFBamBlobTypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
