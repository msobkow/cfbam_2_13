// Description: C++18 implementation for a TokenDef buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTokenDefBuff::GENDEFNAME( "TokenDef" );
	const classcode_t CFBamTokenDefBuff::CLASS_CODE = 0xa848L;
	const std::string CFBamTokenDefBuff::CLASS_NAME( "CFBamTokenDefBuff" );
		const std::string CFBamTokenDefBuff::COLNAME_MAXLEN( "MaxLen" );
		const std::string CFBamTokenDefBuff::COLNAME_INITVALUE( "InitValue" );
	const int64_t CFBamTokenDefBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamTokenDefBuff::ID_INIT_VALUE = 0LL;
	const int CFBamTokenDefBuff::MAXLEN_INIT_VALUE = 0L;
	const int64_t CFBamTokenDefBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamTokenDefBuff::ID_MIN_VALUE = 0LL;
	const int CFBamTokenDefBuff::MAXLEN_MIN_VALUE = 0L;
	const int CFBamTokenDefBuff::MAXLEN_MAX_VALUE = 2147483647L;
	const std::string::size_type CFBamTokenDefBuff::INITVALUE_MAX_LEN = 64;

	CFBamTokenDefBuff::CFBamTokenDefBuff()
	: CFBamAtomBuff()
	{
		requiredMaxLen = cfbam::CFBamTokenDefBuff::MAXLEN_INIT_VALUE;
		optionalInitValue = NULL;
	}

	CFBamTokenDefBuff::CFBamTokenDefBuff( const CFBamTokenDefBuff& src )
	: CFBamAtomBuff()
	{
		requiredMaxLen = cfbam::CFBamTokenDefBuff::MAXLEN_INIT_VALUE;
		optionalInitValue = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamTokenDefBuff::clone() {
		CFBamTokenDefBuff* copy = new CFBamTokenDefBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTokenDefBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTokenDefBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTokenDefBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int32_t CFBamTokenDefBuff::getRequiredMaxLen() const {
		return( requiredMaxLen );
	}

	const int32_t* CFBamTokenDefBuff::getRequiredMaxLenReference() const {
		return( &requiredMaxLen );
	}

	void CFBamTokenDefBuff::setRequiredMaxLen( const int32_t value ) {
		static const std::string S_ProcName( "setRequiredMaxLen" );
		if( value < cfbam::CFBamTokenDefBuff::MAXLEN_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamTokenDefBuff::MAXLEN_MIN_VALUE );
		}
		if( value > cfbam::CFBamTokenDefBuff::MAXLEN_MAX_VALUE ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamTokenDefBuff::MAXLEN_MAX_VALUE );
		}
		requiredMaxLen = value;
	}

	const bool CFBamTokenDefBuff::isOptionalInitValueNull() const {
		return( optionalInitValue == NULL );
	}

	const std::string& CFBamTokenDefBuff::getOptionalInitValueValue() const {
	...
	const std::string* CFBamTokenDefBuff::getOptionalInitValueReference() const {
		return( optionalInitValue );
	}

	void CFBamTokenDefBuff::setOptionalInitValueNull() {
		if( optionalInitValue != NULL ) {
			delete optionalInitValue;
			optionalInitValue = NULL;
		}
	...
	void CFBamTokenDefBuff::setOptionalInitValueValue( const std::string& value ) {
		static const std::string S_ProcName( "setOptionalInitValueValue" );
		if( value.length() > CFBamTokenDefBuff::INITVALUE_MAX_LEN ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE_LENGTH,
				value.length(),
				CFBamTokenDefBuff::INITVALUE_MAX_LEN );
		}
		if( optionalInitValue != NULL ) {
			delete optionalInitValue;
			optionalInitValue = NULL;
	...
	size_t CFBamTokenDefBuff::hashCode() const {
	...
	CFBamTokenDefBuff CFBamTokenDefBuff::operator =( cfbam::CFBamTokenDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamTokenDefBuff CFBamTokenDefBuff::operator =( cfbam::CFBamTokenDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTokenDefBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamTokenDefBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTokenDefBuff::operator <( const CFBamTokenDefHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTokenDefBuff::operator <( const CFBamTokenDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTokenDefBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTokenDefBuff" );
