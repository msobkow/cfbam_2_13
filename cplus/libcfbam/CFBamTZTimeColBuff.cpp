// Description: C++18 implementation for a TZTimeCol buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTZTimeColBuff::GENDEFNAME( "TZTimeCol" );
	const classcode_t CFBamTZTimeColBuff::CLASS_CODE = 0xa864L;
	const std::string CFBamTZTimeColBuff::CLASS_NAME( "CFBamTZTimeColBuff" );
		const std::string CFBamTZTimeColBuff::COLNAME_TABLEID( "TableId" );
	const int64_t CFBamTZTimeColBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamTZTimeColBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamTZTimeColBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamTZTimeColBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamTZTimeColBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamTZTimeColBuff::TABLEID_MIN_VALUE = 0LL;

	CFBamTZTimeColBuff::CFBamTZTimeColBuff()
	: CFBamTZTimeDefBuff()
	{
		requiredTableId = cfbam::CFBamTZTimeColBuff::TABLEID_INIT_VALUE;
	}

	CFBamTZTimeColBuff::CFBamTZTimeColBuff( const CFBamTZTimeColBuff& src )
	: CFBamTZTimeDefBuff()
	{
		requiredTableId = cfbam::CFBamTZTimeColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTZTimeColBuff::clone() {
		CFBamTZTimeColBuff* copy = new CFBamTZTimeColBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTZTimeColBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTZTimeColBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTZTimeColBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFBamTZTimeColBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamTZTimeColBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamTZTimeColBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamTZTimeColBuff::hashCode() const {
		size_t hashCode = CFBamTZTimeDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamTZTimeColBuff CFBamTZTimeColBuff::operator =( cfbam::CFBamTZTimeColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamTZTimeColBuff CFBamTZTimeColBuff::operator =( cfbam::CFBamTZTimeColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTZTimeColBuff::operator <( const CFBamTZTimeColByTableIdxKey& rhs ) {
	...
	bool CFBamTZTimeColBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZTimeColBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZTimeColBuff::operator <( const CFBamTZTimeColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZTimeColBuff::operator <( const CFBamTZTimeColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTZTimeColBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZTimeColBuff" );
