// Description: C++18 implementation for a IndexCol by PrevIdx index key object.
...
namespace cfbam {
	const std::string CFBamIndexColByPrevIdxKey::CLASS_NAME( "CFBamIndexColByPrevIdxKey" );
	const std::string CFBamIndexColByPrevIdxKey::S_VALUE( "value" );
	const std::string CFBamIndexColByPrevIdxKey::S_VALUE_LENGTH( "value.length()" );


	CFBamIndexColByPrevIdxKey::CFBamIndexColByPrevIdxKey() {
		optionalPrevTenantId.setNull();
		optionalPrevId.setNull();
	}

	CFBamIndexColByPrevIdxKey::CFBamIndexColByPrevIdxKey( const CFBamIndexColByPrevIdxKey& src ) {
		optionalPrevTenantId.setNull();
		optionalPrevId.setNull();
	...
	const int64_t CFBamIndexColByPrevIdxKey::getOptionalPrevTenantIdValue() const {
		return( optionalPrevTenantId.getValue() );
	}

	const int64_t* CFBamIndexColByPrevIdxKey::getOptionalPrevTenantIdReference() const {
		return( optionalPrevTenantId.getReference() );
	}

	const bool CFBamIndexColByPrevIdxKey::isOptionalPrevTenantIdNull() const {
		return( optionalPrevTenantId.isNull() );
	}

	void CFBamIndexColByPrevIdxKey::setOptionalPrevTenantIdNull() {
		optionalPrevTenantId.setNull();
	}

	void CFBamIndexColByPrevIdxKey::setOptionalPrevTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamIndexColByPrevIdxKey::getOptionalPrevIdValue() const {
		return( optionalPrevId.getValue() );
	}

	const int64_t* CFBamIndexColByPrevIdxKey::getOptionalPrevIdReference() const {
		return( optionalPrevId.getReference() );
	}

	const bool CFBamIndexColByPrevIdxKey::isOptionalPrevIdNull() const {
		return( optionalPrevId.isNull() );
	}

	void CFBamIndexColByPrevIdxKey::setOptionalPrevIdNull() {
		optionalPrevId.setNull();
	}

	void CFBamIndexColByPrevIdxKey::setOptionalPrevIdValue( const int64_t value ) {
	...
	size_t CFBamIndexColByPrevIdxKey::hashCode() const {
		size_t hashCode = 0;
	...
	std::string CFBamIndexColByPrevIdxKey::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamIndexColByPrevIdxKey" );
	...
	bool CFBamIndexColByPrevIdxKey::operator <( const CFBamIndexColByPrevIdxKey& rhs ) {
		if( ! isOptionalPrevTenantIdNull() ) {
	...
	bool CFBamIndexColByPrevIdxKey::operator <( const CFBamIndexColHBuff& rhs ) {
		if( ! isOptionalPrevTenantIdNull() ) {
			if( rhs.isOptionalPrevTenantIdNull() ) {
				return( false );
			}
	...
	bool CFBamIndexColByPrevIdxKey::operator <( const CFBamIndexColBuff& rhs ) {
		if( ! isOptionalPrevTenantIdNull() ) {
			if( rhs.isOptionalPrevTenantIdNull() ) {
				return( false );
			}
	...
	CFBamIndexColByPrevIdxKey CFBamIndexColByPrevIdxKey::operator =( cfbam::CFBamIndexColByPrevIdxKey& src ) {
		if( src.isOptionalPrevTenantIdNull() ) {
			setOptionalPrevTenantIdNull();
		}
		else {
	...
	CFBamIndexColByPrevIdxKey CFBamIndexColByPrevIdxKey::operator =( cfbam::CFBamIndexColBuff& src ) {
		if( src.isOptionalPrevTenantIdNull() ) {
			setOptionalPrevTenantIdNull();
		}
		else {
	...
	CFBamIndexColByPrevIdxKey CFBamIndexColByPrevIdxKey::operator =( cfbam::CFBamIndexColHBuff& src ) {
		if( src.isOptionalPrevTenantIdNull() ) {
			setOptionalPrevTenantIdNull();
		}
		else {
