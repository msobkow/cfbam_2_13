// Description: C++18 Instance Edit Object interface implementation for CFBam UuidType.
...
namespace cfbam {
	...
	const std::string ICFBamUuidTypeEditObj::CLASS_NAME( "ICFBamUuidTypeEditObj" );

	ICFBamUuidTypeEditObj::ICFBamUuidTypeEditObj()
