// Description: C++18 base object instance implementation for CFBam TZTimestampDef.
...
namespace cfbam {
	...
	const std::string CFBamTZTimestampDefObj::CLASS_NAME( "CFBamTZTimestampDefObj" );
	const classcode_t CFBamTZTimestampDefObj::CLASS_CODE = 0xa83eL;

	bool CFBamTZTimestampDefObj::isOptionalDummyNull() {
		return( getTZTimestampDefBuff()->isOptionalDummyNull() );
	}

	const std::string& CFBamTZTimestampDefObj::getOptionalDummyValue() {
		return( getTZTimestampDefBuff()->getOptionalDummyValue() );
	}

	const std::string* CFBamTZTimestampDefObj::getOptionalDummyReference() {
		return( getTZTimestampDefBuff()->getOptionalDummyReference() );
	}


	CFBamTZTimestampDefObj::CFBamTZTimestampDefObj()
	: ICFBamTZTimestampDefObj(),
	  CFBamAtomObj()
	{
	}

	CFBamTZTimestampDefObj::CFBamTZTimestampDefObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamTZTimestampDefObj(),
	...
	cfbam::CFBamValueBuff* CFBamTZTimestampDefObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamTZTimestampDefBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableTZTimestampDef()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamTZTimestampDefObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamTZTimestampDefObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTZTimestampDefObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTZTimestampDefObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamTZTimestampDefObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZTimestampDefObj" );
	...
	std::string CFBamTZTimestampDefObj::getObjName() {
	...
	const std::string CFBamTZTimestampDefObj::getGenDefName() {
		return( cfbam::CFBamTZTimestampDefBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTZTimestampDefObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTZTimestampDefObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTZTimestampDefObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTZTimestampDefObj::getObjQualifiedName() {
	...
	std::string CFBamTZTimestampDefObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTZTimestampDefObj::realize() {
		cfbam::ICFBamTZTimestampDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimestampDefTableObj()->realizeTZTimestampDef(
			(cfbam::ICFBamTZTimestampDefObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTZTimestampDefObj::read( bool forceRead ) {
		cfbam::ICFBamTZTimestampDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimestampDefTableObj()->readTZTimestampDefByIdIdx( getTZTimestampDefBuff()->getRequiredTenantId(),
		getTZTimestampDefBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTZTimestampDefObj::moveUp() {
		cfbam::ICFBamTZTimestampDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimestampDefTableObj()->moveUpTZTimestampDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTZTimestampDefObj::moveDown() {
		cfbam::ICFBamTZTimestampDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimestampDefTableObj()->moveDownTZTimestampDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamTZTimestampDefObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamTZTimestampDefObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimestampDefTableObj()->lockTZTimestampDef( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimestampDefTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamTZTimestampDefEditObj* CFBamTZTimestampDefObj::getTZTimestampDefEdit() {
		return( dynamic_cast<cfbam::ICFBamTZTimestampDefEditObj*>( edit ) );
	}
