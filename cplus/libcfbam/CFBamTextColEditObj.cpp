// Description: C++18 edit object instance implementation for CFBam TextCol.
...
namespace cfbam {
	...
	const std::string CFBamTextColEditObj::CLASS_NAME( "CFBamTextColEditObj" );

	CFBamTextColEditObj::CFBamTextColEditObj( cfbam::ICFBamTextColObj* argOrig )
	: ICFBamTextColEditObj(),
	  CFBamTextDefEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamTextColEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamTextColEditObj::~CFBamTextColEditObj() {
	}

	const std::string& CFBamTextColEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTextColEditObj::getClassCode() const {
		return( cfbam::CFBamTextColBuff::CLASS_CODE );
	}

	bool CFBamTextColEditObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamTextColBuff::CLASS_CODE ) {
			return( true );
		}
		else {
	...
	std::string CFBamTextColEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTextColEditObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamTextColEditObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	const std::string CFBamTextColEditObj::getGenDefName() {
		return( cfbam::CFBamTextColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTextColEditObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTextColEditObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTextColEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTextColEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTextColEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTextColEditObj::getObjQualifiedName() {
	...
	std::string CFBamTextColEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTextColEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamTextColObj* retobj = getSchema()->getTextColTableObj()->realizeTextCol( dynamic_cast<cfbam::ICFBamTextColObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamTextColEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamTextColEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamTextColEditObj::create() {
		cfbam::ICFBamTextColObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsTextCol()->getSchema() )->getTextColTableObj()->createTextCol( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamTextColEditObj::update() {
		getSchema()->getTextColTableObj()->updateTextCol( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamTextColEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getTextColTableObj()->deleteTextCol( this );
		return( NULL );
	}

	cfbam::ICFBamTextColTableObj* CFBamTextColEditObj::getTextColTable() {
		return( orig->getSchema()->getTextColTableObj() );
	}

	cfbam::ICFBamTextColEditObj* CFBamTextColEditObj::getTextColEdit() {
		return( (cfbam::ICFBamTextColEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamTextColEditObj::beginEdit() {
	...
	cfbam::ICFBamTextColObj* CFBamTextColEditObj::getOrigAsTextCol() {
		return( dynamic_cast<cfbam::ICFBamTextColObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamTextColEditObj::getBuff() {
		return( buff );
	}

	void CFBamTextColEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamTextDefEditObj::setBuff( value );
		}
	}

	const int64_t CFBamTextColEditObj::getRequiredTableId() {
		return( getTextColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamTextColEditObj::getRequiredTableIdReference() {
		return( getTextColBuff()->getRequiredTableIdReference() );
	}

	void CFBamTextColEditObj::setRequiredContainerScope( cfbam::ICFBamScopeObj* value ) {
		if( value == NULL ) {
	...
	cfbam::ICFBamTableObj* CFBamTextColEditObj::getRequiredContainerTable( bool forceRead ) {
		cfbam::ICFBamTableObj* retobj = NULL;
		bool anyMissing = false;
		if( ! anyMissing ) {
			retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsTextCol()->getSchema() )->getTableTableObj()->readTableByIdIdx( getPKey()->getRequiredTenantId(),
					getTextColBuff()->getRequiredTableId() );
		}
		return( retobj );
	}

	void CFBamTextColEditObj::setRequiredContainerTable( cfbam::ICFBamTableObj* value ) {
			
			if( value != NULL ) {
				getPKey()->setRequiredTenantId
( value->getRequiredTenantId() );
				getTextColEditBuff()->setRequiredTenantId( value->getRequiredTenantId() );
				getTextColEditBuff()->setRequiredTableId( value->getRequiredId() );
			}

			CFBamTextDefEditObj::setRequiredContainerScope( value );		}

	void CFBamTextColEditObj::copyBuffToOrig() {
		cfbam::CFBamTextColBuff* origBuff = getOrigAsTextCol()->getTextColEditBuff();
		cfbam::CFBamTextColBuff* myBuff = getTextColBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamTextColEditObj::copyOrigToBuff() {
		cfbam::CFBamTextColBuff* origBuff = getOrigAsTextCol()->getTextColBuff();
		cfbam::CFBamTextColBuff* myBuff = getTextColEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
