// Description: C++18 implementation for a Param by NextIdx index key object.
...
namespace cfbam {
	const std::string CFBamParamByNextIdxKey::CLASS_NAME( "CFBamParamByNextIdxKey" );
	const std::string CFBamParamByNextIdxKey::S_VALUE( "value" );
	const std::string CFBamParamByNextIdxKey::S_VALUE_LENGTH( "value.length()" );


	CFBamParamByNextIdxKey::CFBamParamByNextIdxKey() {
		optionalNextTenantId.setNull();
		optionalNextId.setNull();
	}

	CFBamParamByNextIdxKey::CFBamParamByNextIdxKey( const CFBamParamByNextIdxKey& src ) {
		optionalNextTenantId.setNull();
		optionalNextId.setNull();
	...
	const int64_t CFBamParamByNextIdxKey::getOptionalNextTenantIdValue() const {
		return( optionalNextTenantId.getValue() );
	}

	const int64_t* CFBamParamByNextIdxKey::getOptionalNextTenantIdReference() const {
		return( optionalNextTenantId.getReference() );
	}

	const bool CFBamParamByNextIdxKey::isOptionalNextTenantIdNull() const {
		return( optionalNextTenantId.isNull() );
	}

	void CFBamParamByNextIdxKey::setOptionalNextTenantIdNull() {
		optionalNextTenantId.setNull();
	}

	void CFBamParamByNextIdxKey::setOptionalNextTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamParamByNextIdxKey::getOptionalNextIdValue() const {
		return( optionalNextId.getValue() );
	}

	const int64_t* CFBamParamByNextIdxKey::getOptionalNextIdReference() const {
		return( optionalNextId.getReference() );
	}

	const bool CFBamParamByNextIdxKey::isOptionalNextIdNull() const {
		return( optionalNextId.isNull() );
	}

	void CFBamParamByNextIdxKey::setOptionalNextIdNull() {
		optionalNextId.setNull();
	}

	void CFBamParamByNextIdxKey::setOptionalNextIdValue( const int64_t value ) {
	...
	size_t CFBamParamByNextIdxKey::hashCode() const {
		size_t hashCode = 0;
	...
	std::string CFBamParamByNextIdxKey::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamParamByNextIdxKey" );
	...
	bool CFBamParamByNextIdxKey::operator <( const CFBamParamByNextIdxKey& rhs ) {
		if( ! isOptionalNextTenantIdNull() ) {
	...
	bool CFBamParamByNextIdxKey::operator <( const CFBamParamHBuff& rhs ) {
		if( ! isOptionalNextTenantIdNull() ) {
			if( rhs.isOptionalNextTenantIdNull() ) {
				return( false );
			}
	...
	bool CFBamParamByNextIdxKey::operator <( const CFBamParamBuff& rhs ) {
		if( ! isOptionalNextTenantIdNull() ) {
			if( rhs.isOptionalNextTenantIdNull() ) {
				return( false );
			}
	...
	CFBamParamByNextIdxKey CFBamParamByNextIdxKey::operator =( cfbam::CFBamParamByNextIdxKey& src ) {
		if( src.isOptionalNextTenantIdNull() ) {
			setOptionalNextTenantIdNull();
		}
		else {
	...
	CFBamParamByNextIdxKey CFBamParamByNextIdxKey::operator =( cfbam::CFBamParamBuff& src ) {
		if( src.isOptionalNextTenantIdNull() ) {
			setOptionalNextTenantIdNull();
		}
		else {
	...
	CFBamParamByNextIdxKey CFBamParamByNextIdxKey::operator =( cfbam::CFBamParamHBuff& src ) {
		if( src.isOptionalNextTenantIdNull() ) {
			setOptionalNextTenantIdNull();
		}
		else {
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamParamByNextIdxKey& lhs, const cfbam::CFBamParamByNextIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamParamByNextIdxKey& lhs, const cfbam::CFBamParamHBuff& rhs ) {
		if( ! lhs.isOptionalNextTenantIdNull() ) {
			if( rhs.isOptionalNextTenantIdNull() ) {
				return( false );
			}
	...
	bool operator <(const  cfbam::CFBamParamByNextIdxKey& lhs, const cfbam::CFBamParamBuff& rhs ) {
		if( ! lhs.isOptionalNextTenantIdNull() ) {
			if( rhs.isOptionalNextTenantIdNull() ) {
				return( false );
			}
