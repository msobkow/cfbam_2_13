// Description: C++18 implementation for a BoolCol buffer object.
...
namespace cfbam {
	...
	const std::string CFBamBoolColBuff::GENDEFNAME( "BoolCol" );
	const classcode_t CFBamBoolColBuff::CLASS_CODE = 0xa853L;
	const std::string CFBamBoolColBuff::CLASS_NAME( "CFBamBoolColBuff" );
		const std::string CFBamBoolColBuff::COLNAME_TABLEID( "TableId" );
	const int64_t CFBamBoolColBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamBoolColBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamBoolColBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamBoolColBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamBoolColBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamBoolColBuff::TABLEID_MIN_VALUE = 0LL;

	CFBamBoolColBuff::CFBamBoolColBuff()
	: CFBamBoolDefBuff()
	{
		requiredTableId = cfbam::CFBamBoolColBuff::TABLEID_INIT_VALUE;
	}

	CFBamBoolColBuff::CFBamBoolColBuff( const CFBamBoolColBuff& src )
	: CFBamBoolDefBuff()
	{
		requiredTableId = cfbam::CFBamBoolColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamBoolColBuff::clone() {
		CFBamBoolColBuff* copy = new CFBamBoolColBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamBoolColBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamBoolColBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamBoolColBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFBamBoolColBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamBoolColBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamBoolColBuff::setRequiredTableId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredTableId" );
		if( value < cfbam::CFBamBoolColBuff::TABLEID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamBoolColBuff::TABLEID_MIN_VALUE );
		}
		requiredTableId = value;
	}

	size_t CFBamBoolColBuff::hashCode() const {
		size_t hashCode = CFBamBoolDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamBoolColBuff CFBamBoolColBuff::operator =( cfbam::CFBamBoolColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamBoolColBuff CFBamBoolColBuff::operator =( cfbam::CFBamBoolColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamBoolColBuff::operator <( const CFBamBoolColByTableIdxKey& rhs ) {
	...
	bool CFBamBoolColBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamBoolColBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamBoolColBuff::operator <( const CFBamBoolColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamBoolColBuff::operator <( const CFBamBoolColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamBoolColBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamBoolColBuff" );
