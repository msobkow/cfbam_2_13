// Description: C++18 base object instance implementation for CFBam TZDateCol.
...
namespace cfbam {
	...
	const std::string CFBamTZDateColObj::CLASS_NAME( "CFBamTZDateColObj" );
	const classcode_t CFBamTZDateColObj::CLASS_CODE = 0xa863L;

	const int64_t CFBamTZDateColObj::getRequiredTableId() {
		return( getTZDateColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamTZDateColObj::getRequiredTableIdReference() {
		return( getTZDateColBuff()->getRequiredTableIdReference() );
	}


	cfbam::ICFBamTableObj* CFBamTZDateColObj::getRequiredContainerTable( bool forceRead ) {
	...
	CFBamTZDateColObj::CFBamTZDateColObj()
	: ICFBamTZDateColObj(),
	  CFBamTZDateDefObj()
	{
	}

	CFBamTZDateColObj::CFBamTZDateColObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamTZDateColObj(),
	  CFBamTZDateDefObj( argSchema )
	{
	}
	...
	cfbam::CFBamValueBuff* CFBamTZDateColObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamTZDateColBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableTZDateCol()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamTZDateColObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamTZDateColObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTZDateColObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTZDateColObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamTZDateColBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamTZDateDefObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamTZDateColObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZDateColObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamTZDateColObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamTZDateColObj::getObjName() {
	...
	const std::string CFBamTZDateColObj::getGenDefName() {
		return( cfbam::CFBamTZDateColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTZDateColObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTZDateColObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTZDateColObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTZDateColObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTZDateColObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTZDateColObj::getObjQualifiedName() {
	...
	std::string CFBamTZDateColObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTZDateColObj::realize() {
		cfbam::ICFBamTZDateColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZDateColTableObj()->realizeTZDateCol(
			(cfbam::ICFBamTZDateColObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTZDateColObj::read( bool forceRead ) {
		cfbam::ICFBamTZDateColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZDateColTableObj()->readTZDateColByIdIdx( getTZDateColBuff()->getRequiredTenantId(),
		getTZDateColBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTZDateColObj::moveUp() {
		cfbam::ICFBamTZDateColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZDateColTableObj()->moveUpTZDateCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTZDateColObj::moveDown() {
		cfbam::ICFBamTZDateColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZDateColTableObj()->moveDownTZDateCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamTZDateColObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamTZDateColObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZDateColTableObj()->lockTZDateCol( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZDateColTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamTZDateColEditObj* CFBamTZDateColObj::getTZDateColEdit() {
		return( dynamic_cast<cfbam::ICFBamTZDateColEditObj*>( edit ) );
	}
