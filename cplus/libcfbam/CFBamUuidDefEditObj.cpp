// Description: C++18 edit object instance implementation for CFBam UuidDef.
...
namespace cfbam {
	...
	const std::string CFBamUuidDefEditObj::CLASS_NAME( "CFBamUuidDefEditObj" );

	CFBamUuidDefEditObj::CFBamUuidDefEditObj( cfbam::ICFBamUuidDefObj* argOrig )
	: ICFBamUuidDefEditObj(),
	  CFBamAtomEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamUuidDefEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamUuidDefEditObj::~CFBamUuidDefEditObj() {
	}

	const std::string& CFBamUuidDefEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUuidDefEditObj::getClassCode() const {
		return( cfbam::CFBamUuidDefBuff::CLASS_CODE );
	}

	bool CFBamUuidDefEditObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamUuidDefBuff::CLASS_CODE ) {
			return( true );
		}
		else {
	...
	std::string CFBamUuidDefEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUuidDefEditObj" );
	...
	const std::string CFBamUuidDefEditObj::getGenDefName() {
		return( cfbam::CFBamUuidDefBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamUuidDefEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamUuidDefEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamUuidDefEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamUuidDefEditObj::getObjQualifiedName() {
	...
	std::string CFBamUuidDefEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamUuidDefEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamUuidDefObj* retobj = getSchema()->getUuidDefTableObj()->realizeUuidDef( dynamic_cast<cfbam::ICFBamUuidDefObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamUuidDefEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamUuidDefEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamUuidDefEditObj::create() {
		cfbam::ICFBamUuidDefObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsUuidDef()->getSchema() )->getUuidDefTableObj()->createUuidDef( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamUuidDefEditObj::update() {
		getSchema()->getUuidDefTableObj()->updateUuidDef( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamUuidDefEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getUuidDefTableObj()->deleteUuidDef( this );
		return( NULL );
	}

	cfbam::ICFBamUuidDefTableObj* CFBamUuidDefEditObj::getUuidDefTable() {
		return( orig->getSchema()->getUuidDefTableObj() );
	}

	cfbam::ICFBamUuidDefEditObj* CFBamUuidDefEditObj::getUuidDefEdit() {
		return( (cfbam::ICFBamUuidDefEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamUuidDefEditObj::beginEdit() {
	...
	cfbam::ICFBamUuidDefObj* CFBamUuidDefEditObj::getOrigAsUuidDef() {
		return( dynamic_cast<cfbam::ICFBamUuidDefObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamUuidDefEditObj::getBuff() {
		return( buff );
	}

	void CFBamUuidDefEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamAtomEditObj::setBuff( value );
		}
	}

	bool CFBamUuidDefEditObj::isOptionalInitValueNull() {
		return( getUuidDefBuff()->isOptionalInitValueNull() );
	}

	const uuid_ptr_t CFBamUuidDefEditObj::getOptionalInitValueValue() {
		return( getUuidDefBuff()->getOptionalInitValueValue() );
	}

	const uuid_ptr_t CFBamUuidDefEditObj::getOptionalInitValueReference() {
		return( getUuidDefBuff()->getOptionalInitValueReference() );
	}

	void CFBamUuidDefEditObj::setOptionalInitValueNull() {
		if( ! getUuidDefBuff()->isOptionalInitValueNull() ) {
			getUuidDefEditBuff()->setOptionalInitValueNull();
		}
	}

	void CFBamUuidDefEditObj::setOptionalInitValueValue( const uuid_ptr_t value ) {
		if( getUuidDefBuff()->isOptionalInitValueNull() ) {
			getUuidDefEditBuff()->setOptionalInitValueValue( value );
		}
		else if( getUuidDefBuff()->getOptionalInitValueValue() != value ) {
			getUuidDefEditBuff()->setOptionalInitValueValue( value );
		}
	}

	void CFBamUuidDefEditObj::copyBuffToOrig() {
		cfbam::CFBamUuidDefBuff* origBuff = getOrigAsUuidDef()->getUuidDefEditBuff();
		cfbam::CFBamUuidDefBuff* myBuff = getUuidDefBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamUuidDefEditObj::copyOrigToBuff() {
		cfbam::CFBamUuidDefBuff* origBuff = getOrigAsUuidDef()->getUuidDefBuff();
		cfbam::CFBamUuidDefBuff* myBuff = getUuidDefEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
