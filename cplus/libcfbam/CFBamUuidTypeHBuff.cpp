// Description: C++18 implementation of a UuidType history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUuidTypeHBuff::CLASS_NAME( "CFBamUuidTypeHBuff" );
	CFBamUuidTypeHBuff::CFBamUuidTypeHBuff()
	: cfbam::CFBamUuidDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamUuidTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamUuidTypeHBuff::CFBamUuidTypeHBuff( const CFBamUuidTypeHBuff& src )
	: cfbam::CFBamUuidDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamUuidTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamUuidTypeHBuff::clone() {
		CFBamUuidTypeHBuff* copy = new CFBamUuidTypeHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamUuidTypeHBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamUuidTypeHBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamUuidTypeHBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamUuidTypeHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamUuidTypeHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamUuidTypeHBuff CFBamUuidTypeHBuff::operator =( cfbam::CFBamUuidTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamUuidTypeHBuff CFBamUuidTypeHBuff::operator =( cfbam::CFBamUuidTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUuidTypeHBuff::operator <( const CFBamUuidTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamUuidTypeHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUuidTypeHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamUuidTypeHBuff::operator <( const CFBamUuidTypeHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamUuidTypeHBuff::operator <( const CFBamUuidTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUuidTypeHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUuidTypeHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamUuidTypeHBuff& lhs, const cfbam::CFBamUuidTypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamUuidTypeHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamUuidTypeHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamUuidTypeHBuff& lhs, const cfbam::CFBamUuidTypeHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamUuidTypeHBuff& lhs, const cfbam::CFBamUuidTypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
