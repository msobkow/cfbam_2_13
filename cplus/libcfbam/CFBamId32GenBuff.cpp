// Description: C++18 implementation for a Id32Gen buffer object.
...
namespace cfbam {
	...
	const std::string CFBamId32GenBuff::GENDEFNAME( "Id32Gen" );
	const classcode_t CFBamId32GenBuff::CLASS_CODE = 0xa85aL;
	const std::string CFBamId32GenBuff::CLASS_NAME( "CFBamId32GenBuff" );
		const std::string CFBamId32GenBuff::COLNAME_DISPENSERTENANTID( "DispenserTenantId" );
		const std::string CFBamId32GenBuff::COLNAME_DISPENSERID( "DispenserId" );
		const std::string CFBamId32GenBuff::COLNAME_SLICE( "Slice" );
		const std::string CFBamId32GenBuff::COLNAME_BLOCKSIZE( "BlockSize" );
	const int64_t CFBamId32GenBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamId32GenBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamId32GenBuff::DISPENSERTENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamId32GenBuff::DISPENSERID_INIT_VALUE = 0LL;
	const int16_t CFBamId32GenBuff::SLICE_INIT_VALUE = (int16_t)0;
	const int CFBamId32GenBuff::BLOCKSIZE_INIT_VALUE = 1L;
	const int64_t CFBamId32GenBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamId32GenBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamId32GenBuff::DISPENSERTENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamId32GenBuff::DISPENSERID_MIN_VALUE = 0LL;
	const int16_t CFBamId32GenBuff::SLICE_MIN_VALUE = (int16_t)0;
	const int CFBamId32GenBuff::BLOCKSIZE_MIN_VALUE = 1L;
	const int16_t CFBamId32GenBuff::SLICE_MAX_VALUE = (int16_t)32767;
	const int CFBamId32GenBuff::BLOCKSIZE_MAX_VALUE = 2147483647L;

	CFBamId32GenBuff::CFBamId32GenBuff()
	: CFBamInt32TypeBuff()
	{
		optionalDispenserTenantId.setNull();
		optionalDispenserId.setNull();
		requiredSlice = cfbam::CFBamId32GenBuff::SLICE_INIT_VALUE;
		requiredBlockSize = cfbam::CFBamId32GenBuff::BLOCKSIZE_INIT_VALUE;
	}

	CFBamId32GenBuff::CFBamId32GenBuff( const CFBamId32GenBuff& src )
	: CFBamInt32TypeBuff()
	{
		optionalDispenserTenantId.setNull();
		optionalDispenserId.setNull();
	...
	cflib::ICFLibCloneableObj* CFBamId32GenBuff::clone() {
		CFBamId32GenBuff* copy = new CFBamId32GenBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamId32GenBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamId32GenBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamId32GenBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamInt32TypeBuff::implementsClassCode( argClassCode ) );
		}
	}

	const bool CFBamId32GenBuff::isOptionalDispenserTenantIdNull() const {
		return( optionalDispenserTenantId.isNull() );
	}

	const int64_t CFBamId32GenBuff::getOptionalDispenserTenantIdValue() const {
		return( optionalDispenserTenantId.getValue() );
	}

	const int64_t* CFBamId32GenBuff::getOptionalDispenserTenantIdReference() const {
		return( optionalDispenserTenantId.getReference() );
	}

	void CFBamId32GenBuff::setOptionalDispenserTenantIdNull() {
		optionalDispenserTenantId.setNull();
	}

	void CFBamId32GenBuff::setOptionalDispenserTenantIdValue( const int64_t value ) {
	...
	const bool CFBamId32GenBuff::isOptionalDispenserIdNull() const {
		return( optionalDispenserId.isNull() );
	}

	const int64_t CFBamId32GenBuff::getOptionalDispenserIdValue() const {
		return( optionalDispenserId.getValue() );
	}

	const int64_t* CFBamId32GenBuff::getOptionalDispenserIdReference() const {
		return( optionalDispenserId.getReference() );
	}

	void CFBamId32GenBuff::setOptionalDispenserIdNull() {
		optionalDispenserId.setNull();
	}

	void CFBamId32GenBuff::setOptionalDispenserIdValue( const int64_t value ) {
	...
	const int16_t CFBamId32GenBuff::getRequiredSlice() const {
		return( requiredSlice );
	}

	const int16_t* CFBamId32GenBuff::getRequiredSliceReference() const {
		return( &requiredSlice );
	}

	void CFBamId32GenBuff::setRequiredSlice( const int16_t value ) {
		static const std::string S_ProcName( "setRequiredSlice" );
		if( value < cfbam::CFBamId32GenBuff::SLICE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamId32GenBuff::SLICE_MIN_VALUE );
		}
		if( value > cfbam::CFBamId32GenBuff::SLICE_MAX_VALUE ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamId32GenBuff::SLICE_MAX_VALUE );
		}
		requiredSlice = value;
	}

	const int32_t CFBamId32GenBuff::getRequiredBlockSize() const {
		return( requiredBlockSize );
	}

	const int32_t* CFBamId32GenBuff::getRequiredBlockSizeReference() const {
		return( &requiredBlockSize );
	}

	void CFBamId32GenBuff::setRequiredBlockSize( const int32_t value ) {
		static const std::string S_ProcName( "setRequiredBlockSize" );
		if( value < cfbam::CFBamId32GenBuff::BLOCKSIZE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamId32GenBuff::BLOCKSIZE_MIN_VALUE );
		}
		if( value > cfbam::CFBamId32GenBuff::BLOCKSIZE_MAX_VALUE ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamId32GenBuff::BLOCKSIZE_MAX_VALUE );
		}
		requiredBlockSize = value;
	}

	size_t CFBamId32GenBuff::hashCode() const {
		size_t hashCode = CFBamInt32TypeBuff::hashCode();
	...
	CFBamId32GenBuff CFBamId32GenBuff::operator =( cfbam::CFBamId32GenBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamId32GenBuff CFBamId32GenBuff::operator =( cfbam::CFBamId32GenHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamId32GenBuff::operator <( const CFBamId32GenByDispIdxKey& rhs ) {
		if( ! isOptionalDispenserTenantIdNull() ) {
	...
	bool CFBamId32GenBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamId32GenBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamId32GenBuff::operator <( const CFBamId32GenHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamId32GenBuff::operator <( const CFBamId32GenBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamId32GenBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamId32GenBuff" );
		...
		if( ! isOptionalInitValueNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredInt32( &S_Space, S_InitValue, getOptionalInitValueValue() ) );
		}
		if( ! isOptionalMinValueNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredInt32( &S_Space, S_MinValue, getOptionalMinValueValue() ) );
		}
		if( ! isOptionalMaxValueNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredInt32( &S_Space, S_MaxValue, getOptionalMaxValueValue() ) );
		}
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt32( &S_Space, S_BlockSize, getRequiredBlockSize() ) );
