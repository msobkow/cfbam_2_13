// Description: C++18 Instance Edit Object interface implementation for CFBam NmTokenCol.
...
namespace cfbam {
	...
	const std::string ICFBamNmTokenColEditObj::CLASS_NAME( "ICFBamNmTokenColEditObj" );

	ICFBamNmTokenColEditObj::ICFBamNmTokenColEditObj()
