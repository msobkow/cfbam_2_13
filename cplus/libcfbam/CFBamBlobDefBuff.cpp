// Description: C++18 implementation for a BlobDef buffer object.
...
namespace cfbam {
	...
	const std::string CFBamBlobDefBuff::GENDEFNAME( "BlobDef" );
	const classcode_t CFBamBlobDefBuff::CLASS_CODE = 0xa80bL;
	const std::string CFBamBlobDefBuff::CLASS_NAME( "CFBamBlobDefBuff" );
		const std::string CFBamBlobDefBuff::COLNAME_MAXLEN( "MaxLen" );
		const std::string CFBamBlobDefBuff::COLNAME_INITVALUE( "InitValue" );
	const int64_t CFBamBlobDefBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamBlobDefBuff::ID_INIT_VALUE = 0LL;
	const int CFBamBlobDefBuff::MAXLEN_INIT_VALUE = 100000000L;
	const int64_t CFBamBlobDefBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamBlobDefBuff::ID_MIN_VALUE = 0LL;
	const int CFBamBlobDefBuff::MAXLEN_MIN_VALUE = 1L;
	const int CFBamBlobDefBuff::MAXLEN_MAX_VALUE = 2147483647L;
	const std::vector<cflib::BYTE>::size_type CFBamBlobDefBuff::INITVALUE_MAX_LEN = 16384;

	CFBamBlobDefBuff::CFBamBlobDefBuff()
	: CFBamAtomBuff()
	{
		requiredMaxLen = cfbam::CFBamBlobDefBuff::MAXLEN_INIT_VALUE;
		optionalInitValue = NULL;
	}

	CFBamBlobDefBuff::CFBamBlobDefBuff( const CFBamBlobDefBuff& src )
	: CFBamAtomBuff()
	{
		requiredMaxLen = cfbam::CFBamBlobDefBuff::MAXLEN_INIT_VALUE;
		optionalInitValue = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamBlobDefBuff::clone() {
		CFBamBlobDefBuff* copy = new CFBamBlobDefBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamBlobDefBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamBlobDefBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamBlobDefBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int32_t CFBamBlobDefBuff::getRequiredMaxLen() const {
		return( requiredMaxLen );
	}

	const int32_t* CFBamBlobDefBuff::getRequiredMaxLenReference() const {
		return( &requiredMaxLen );
	}

	void CFBamBlobDefBuff::setRequiredMaxLen( const int32_t value ) {
		static const std::string S_ProcName( "setRequiredMaxLen" );
		if( value < cfbam::CFBamBlobDefBuff::MAXLEN_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamBlobDefBuff::MAXLEN_MIN_VALUE );
		}
		if( value > cfbam::CFBamBlobDefBuff::MAXLEN_MAX_VALUE ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamBlobDefBuff::MAXLEN_MAX_VALUE );
		}
		requiredMaxLen = value;
	}

	const bool CFBamBlobDefBuff::isOptionalInitValueNull() const {
		return( optionalInitValue == NULL );
	}

	const std::vector<cflib::BYTE>& CFBamBlobDefBuff::getOptionalInitValueValue() const {
	...
	const std::vector<cflib::BYTE>* CFBamBlobDefBuff::getOptionalInitValueReference() const {
		return( optionalInitValue );
	}

	void CFBamBlobDefBuff::setOptionalInitValueNull() {
		if( optionalInitValue != NULL ) {
			delete optionalInitValue;
			optionalInitValue = NULL;
		}
	...
	void CFBamBlobDefBuff::setOptionalInitValueValue( const std::vector<cflib::BYTE>& value ) {
		static const std::string S_ProcName( "setOptionalInitValueValue" );
		static const std::string S_Size( "value->size()" );
		if( value.size() > CFBamBlobDefBuff::INITVALUE_MAX_LEN ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_Size,
				value.size(),
				CFBamBlobDefBuff::INITVALUE_MAX_LEN );
		}
		if( optionalInitValue != NULL ) {
			delete optionalInitValue;
			optionalInitValue = NULL;
		}
		optionalInitValue = new std::vector<cflib::BYTE>( value );
	}

	size_t CFBamBlobDefBuff::hashCode() const {
	...
	CFBamBlobDefBuff CFBamBlobDefBuff::operator =( cfbam::CFBamBlobDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamBlobDefBuff CFBamBlobDefBuff::operator =( cfbam::CFBamBlobDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamBlobDefBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamBlobDefBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamBlobDefBuff::operator <( const CFBamBlobDefHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamBlobDefBuff::operator <( const CFBamBlobDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamBlobDefBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamBlobDefBuff" );
		...
		if( ! isOptionalInitValueNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredBlob( &S_Space, S_InitValue, getOptionalInitValueValue() ) );
		}
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamBlobDefBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamBlobDefBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamBlobDefBuff& lhs, const cfbam::CFBamBlobDefHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamBlobDefBuff& lhs, const cfbam::CFBamBlobDefBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
