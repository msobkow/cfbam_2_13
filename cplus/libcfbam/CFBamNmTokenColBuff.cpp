// Description: C++18 implementation for a NmTokenCol buffer object.
...
namespace cfbam {
	...
	const std::string CFBamNmTokenColBuff::GENDEFNAME( "NmTokenCol" );
	const classcode_t CFBamNmTokenColBuff::CLASS_CODE = 0xa85fL;
	const std::string CFBamNmTokenColBuff::CLASS_NAME( "CFBamNmTokenColBuff" );
		const std::string CFBamNmTokenColBuff::COLNAME_TABLEID( "TableId" );
	const int64_t CFBamNmTokenColBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamNmTokenColBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamNmTokenColBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamNmTokenColBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamNmTokenColBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamNmTokenColBuff::TABLEID_MIN_VALUE = 0LL;

	CFBamNmTokenColBuff::CFBamNmTokenColBuff()
	: CFBamNmTokenDefBuff()
	{
		requiredTableId = cfbam::CFBamNmTokenColBuff::TABLEID_INIT_VALUE;
	}

	CFBamNmTokenColBuff::CFBamNmTokenColBuff( const CFBamNmTokenColBuff& src )
	: CFBamNmTokenDefBuff()
	{
		requiredTableId = cfbam::CFBamNmTokenColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamNmTokenColBuff::clone() {
		CFBamNmTokenColBuff* copy = new CFBamNmTokenColBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamNmTokenColBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamNmTokenColBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamNmTokenColBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFBamNmTokenColBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamNmTokenColBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamNmTokenColBuff::setRequiredTableId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredTableId" );
		if( value < cfbam::CFBamNmTokenColBuff::TABLEID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamNmTokenColBuff::TABLEID_MIN_VALUE );
		}
		requiredTableId = value;
	}

	size_t CFBamNmTokenColBuff::hashCode() const {
		size_t hashCode = CFBamNmTokenDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamNmTokenColBuff CFBamNmTokenColBuff::operator =( cfbam::CFBamNmTokenColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamNmTokenColBuff CFBamNmTokenColBuff::operator =( cfbam::CFBamNmTokenColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamNmTokenColBuff::operator <( const CFBamNmTokenColByTableIdxKey& rhs ) {
	...
	bool CFBamNmTokenColBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNmTokenColBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNmTokenColBuff::operator <( const CFBamNmTokenColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNmTokenColBuff::operator <( const CFBamNmTokenColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamNmTokenColBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNmTokenColBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamNmTokenColBuff& lhs, const cfbam::CFBamNmTokenColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamNmTokenColBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamNmTokenColBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamNmTokenColBuff& lhs, const cfbam::CFBamNmTokenColHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamNmTokenColBuff& lhs, const cfbam::CFBamNmTokenColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
