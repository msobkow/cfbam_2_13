// Description: C++18 Instance Edit Object interface implementation for CFBam TZTimestampCol.
...
namespace cfbam {
	...
	const std::string ICFBamTZTimestampColEditObj::CLASS_NAME( "ICFBamTZTimestampColEditObj" );

	ICFBamTZTimestampColEditObj::ICFBamTZTimestampColEditObj()
