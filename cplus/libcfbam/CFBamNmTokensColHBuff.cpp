// Description: C++18 implementation of a NmTokensCol history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamNmTokensColHBuff::CLASS_NAME( "CFBamNmTokensColHBuff" );
	CFBamNmTokensColHBuff::CFBamNmTokensColHBuff()
	: cfbam::CFBamNmTokensDefHBuff() {
		requiredTableId = cfbam::CFBamNmTokensColBuff::TABLEID_INIT_VALUE;
	}

	CFBamNmTokensColHBuff::CFBamNmTokensColHBuff( const CFBamNmTokensColHBuff& src )
	: cfbam::CFBamNmTokensDefHBuff() {
		requiredTableId = cfbam::CFBamNmTokensColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamNmTokensColHBuff::clone() {
		CFBamNmTokensColHBuff* copy = new CFBamNmTokensColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamNmTokensColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamNmTokensColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamNmTokensColHBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamNmTokensColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamNmTokensColHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamNmTokensColHBuff CFBamNmTokensColHBuff::operator =( cfbam::CFBamNmTokensColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamNmTokensColHBuff CFBamNmTokensColHBuff::operator =( cfbam::CFBamNmTokensColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamNmTokensColHBuff::operator <( const CFBamNmTokensColByTableIdxKey& rhs ) {
	...
	bool CFBamNmTokensColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNmTokensColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamNmTokensColHBuff::operator <( const CFBamNmTokensColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamNmTokensColHBuff::operator <( const CFBamNmTokensColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamNmTokensColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNmTokensColHBuff" );
