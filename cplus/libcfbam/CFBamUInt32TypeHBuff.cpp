// Description: C++18 implementation of a UInt32Type history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUInt32TypeHBuff::CLASS_NAME( "CFBamUInt32TypeHBuff" );
	CFBamUInt32TypeHBuff::CFBamUInt32TypeHBuff()
	: cfbam::CFBamUInt32DefHBuff() {
		requiredSchemaDefId = cfbam::CFBamUInt32TypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamUInt32TypeHBuff::CFBamUInt32TypeHBuff( const CFBamUInt32TypeHBuff& src )
	: cfbam::CFBamUInt32DefHBuff() {
		requiredSchemaDefId = cfbam::CFBamUInt32TypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamUInt32TypeHBuff::clone() {
		CFBamUInt32TypeHBuff* copy = new CFBamUInt32TypeHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamUInt32TypeHBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamUInt32TypeHBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamUInt32TypeHBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamUInt32TypeHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamUInt32TypeHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamUInt32TypeHBuff CFBamUInt32TypeHBuff::operator =( cfbam::CFBamUInt32TypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamUInt32TypeHBuff CFBamUInt32TypeHBuff::operator =( cfbam::CFBamUInt32TypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUInt32TypeHBuff::operator <( const CFBamUInt32TypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamUInt32TypeHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt32TypeHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamUInt32TypeHBuff::operator <( const CFBamUInt32TypeHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamUInt32TypeHBuff::operator <( const CFBamUInt32TypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUInt32TypeHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt32TypeHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamUInt32TypeHBuff& lhs, const cfbam::CFBamUInt32TypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamUInt32TypeHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamUInt32TypeHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamUInt32TypeHBuff& lhs, const cfbam::CFBamUInt32TypeHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamUInt32TypeHBuff& lhs, const cfbam::CFBamUInt32TypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
