// Description: C++18 implementation for a UuidGen buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUuidGenBuff::GENDEFNAME( "UuidGen" );
	const classcode_t CFBamUuidGenBuff::CLASS_CODE = 0xa86eL;
	const std::string CFBamUuidGenBuff::CLASS_NAME( "CFBamUuidGenBuff" );
		const std::string CFBamUuidGenBuff::COLNAME_SLICE( "Slice" );
		const std::string CFBamUuidGenBuff::COLNAME_BLOCKSIZE( "BlockSize" );
	const int64_t CFBamUuidGenBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamUuidGenBuff::ID_INIT_VALUE = 0LL;
	const int16_t CFBamUuidGenBuff::SLICE_INIT_VALUE = (int16_t)0;
	const int CFBamUuidGenBuff::BLOCKSIZE_INIT_VALUE = 1L;
	const int64_t CFBamUuidGenBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamUuidGenBuff::ID_MIN_VALUE = 0LL;
	const int16_t CFBamUuidGenBuff::SLICE_MIN_VALUE = (int16_t)0;
	const int CFBamUuidGenBuff::BLOCKSIZE_MIN_VALUE = 1L;
	const int16_t CFBamUuidGenBuff::SLICE_MAX_VALUE = (int16_t)32767;
	const int CFBamUuidGenBuff::BLOCKSIZE_MAX_VALUE = 2147483647L;

	CFBamUuidGenBuff::CFBamUuidGenBuff()
	: CFBamUuidTypeBuff()
	{
		requiredSlice = cfbam::CFBamUuidGenBuff::SLICE_INIT_VALUE;
		requiredBlockSize = cfbam::CFBamUuidGenBuff::BLOCKSIZE_INIT_VALUE;
	}

	CFBamUuidGenBuff::CFBamUuidGenBuff( const CFBamUuidGenBuff& src )
	: CFBamUuidTypeBuff()
	{
		requiredSlice = cfbam::CFBamUuidGenBuff::SLICE_INIT_VALUE;
		requiredBlockSize = cfbam::CFBamUuidGenBuff::BLOCKSIZE_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamUuidGenBuff::clone() {
		CFBamUuidGenBuff* copy = new CFBamUuidGenBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamUuidGenBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUuidGenBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamUuidGenBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamUuidTypeBuff::implementsClassCode( argClassCode ) );
		}
	}

	const int16_t CFBamUuidGenBuff::getRequiredSlice() const {
		return( requiredSlice );
	}

	const int16_t* CFBamUuidGenBuff::getRequiredSliceReference() const {
		return( &requiredSlice );
	}

	void CFBamUuidGenBuff::setRequiredSlice( const int16_t value ) {
		static const std::string S_ProcName( "setRequiredSlice" );
		if( value < cfbam::CFBamUuidGenBuff::SLICE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamUuidGenBuff::SLICE_MIN_VALUE );
		}
		if( value > cfbam::CFBamUuidGenBuff::SLICE_MAX_VALUE ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamUuidGenBuff::SLICE_MAX_VALUE );
		}
		requiredSlice = value;
	}

	const int32_t CFBamUuidGenBuff::getRequiredBlockSize() const {
		return( requiredBlockSize );
	}

	const int32_t* CFBamUuidGenBuff::getRequiredBlockSizeReference() const {
		return( &requiredBlockSize );
	}

	void CFBamUuidGenBuff::setRequiredBlockSize( const int32_t value ) {
		static const std::string S_ProcName( "setRequiredBlockSize" );
		if( value < cfbam::CFBamUuidGenBuff::BLOCKSIZE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamUuidGenBuff::BLOCKSIZE_MIN_VALUE );
		}
		if( value > cfbam::CFBamUuidGenBuff::BLOCKSIZE_MAX_VALUE ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamUuidGenBuff::BLOCKSIZE_MAX_VALUE );
		}
		requiredBlockSize = value;
	}

	size_t CFBamUuidGenBuff::hashCode() const {
		size_t hashCode = CFBamUuidTypeBuff::hashCode();
		hashCode = ( hashCode * 0x10000 ) + getRequiredSlice();
		hashCode = hashCode + getRequiredBlockSize();
		return( hashCode );
	}

	CFBamUuidGenBuff CFBamUuidGenBuff::operator =( cfbam::CFBamUuidGenBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamUuidGenBuff CFBamUuidGenBuff::operator =( cfbam::CFBamUuidGenHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUuidGenBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamUuidGenBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUuidGenBuff::operator <( const CFBamUuidGenHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
		...
		if( ! isOptionalInitValueNull() ) {
			...
			if( 0 > uuid_compare( getOptionalInitValueValue(), rhs.getOptionalInitValueValue() ) ) {
				return( false );
			}
			else if( 0 < uuid_compare( getOptionalInitValueValue(), rhs.getOptionalInitValueValue() ) ) {
				return( true );
			}
		}
		else {
	...
	bool CFBamUuidGenBuff::operator <( const CFBamUuidGenBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUuidGenBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUuidGenBuff" );
		...
		if( ! isOptionalInitValueNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredUuid( &S_Space, S_InitValue, getOptionalInitValueValue() ) );
		}
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamUuidGenBuff& lhs, const cfbam::CFBamUuidGenHBuff& rhs ) {
		...
		if( ! lhs.isOptionalInitValueNull() ) {
			...
			if( 0 > uuid_compare( lhs.getOptionalInitValueValue(), rhs.getOptionalInitValueValue() ) ) {
				return( false );
			}
			else if( 0 < uuid_compare( lhs.getOptionalInitValueValue(), rhs.getOptionalInitValueValue() ) ) {
				return( true );
			}
		}
		else {
