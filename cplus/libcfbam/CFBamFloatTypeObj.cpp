// Description: C++18 base object instance implementation for CFBam FloatType.
...
namespace cfbam {
	...
	const std::string CFBamFloatTypeObj::CLASS_NAME( "CFBamFloatTypeObj" );
	const classcode_t CFBamFloatTypeObj::CLASS_CODE = 0xa820L;

	const int64_t CFBamFloatTypeObj::getRequiredSchemaDefId() {
		return( getFloatTypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamFloatTypeObj::getRequiredSchemaDefIdReference() {
		return( getFloatTypeBuff()->getRequiredSchemaDefIdReference() );
	}


	cfbam::ICFBamSchemaDefObj* CFBamFloatTypeObj::getRequiredContainerSchemaDef( bool forceRead ) {
	...
	CFBamFloatTypeObj::CFBamFloatTypeObj()
	: ICFBamFloatTypeObj(),
	  CFBamFloatDefObj()
	{
	}

	CFBamFloatTypeObj::CFBamFloatTypeObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamFloatTypeObj(),
	  CFBamFloatDefObj( argSchema )
	{
	}
	...
	cfbam::CFBamValueBuff* CFBamFloatTypeObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamFloatTypeBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableFloatType()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamFloatTypeObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamFloatTypeObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamFloatTypeObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamFloatTypeObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamFloatTypeBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamFloatDefObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamFloatTypeObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamFloatTypeObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamFloatTypeObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamFloatTypeObj::getObjName() {
	...
	const std::string CFBamFloatTypeObj::getGenDefName() {
		return( cfbam::CFBamFloatTypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamFloatTypeObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamFloatTypeObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamFloatTypeObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamFloatTypeObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamFloatTypeObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamFloatTypeObj::getObjQualifiedName() {
	...
	std::string CFBamFloatTypeObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamFloatTypeObj::realize() {
		cfbam::ICFBamFloatTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getFloatTypeTableObj()->realizeFloatType(
			(cfbam::ICFBamFloatTypeObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamFloatTypeObj::read( bool forceRead ) {
		cfbam::ICFBamFloatTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getFloatTypeTableObj()->readFloatTypeByIdIdx( getFloatTypeBuff()->getRequiredTenantId(),
		getFloatTypeBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamFloatTypeObj::moveUp() {
		cfbam::ICFBamFloatTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getFloatTypeTableObj()->moveUpFloatType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamFloatTypeObj::moveDown() {
		cfbam::ICFBamFloatTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getFloatTypeTableObj()->moveDownFloatType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamFloatTypeObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamFloatTypeObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getFloatTypeTableObj()->lockFloatType( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getFloatTypeTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamFloatTypeEditObj* CFBamFloatTypeObj::getFloatTypeEdit() {
		return( dynamic_cast<cfbam::ICFBamFloatTypeEditObj*>( edit ) );
	}
