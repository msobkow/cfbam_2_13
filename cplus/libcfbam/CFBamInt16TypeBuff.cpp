// Description: C++18 implementation for a Int16Type buffer object.
...
namespace cfbam {
	...
	const std::string CFBamInt16TypeBuff::GENDEFNAME( "Int16Type" );
	const classcode_t CFBamInt16TypeBuff::CLASS_CODE = 0xa824L;
	const std::string CFBamInt16TypeBuff::CLASS_NAME( "CFBamInt16TypeBuff" );
		const std::string CFBamInt16TypeBuff::COLNAME_SCHEMADEFID( "SchemaDefId" );
	const int64_t CFBamInt16TypeBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamInt16TypeBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamInt16TypeBuff::SCHEMADEFID_INIT_VALUE = 0LL;
	const int64_t CFBamInt16TypeBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamInt16TypeBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamInt16TypeBuff::SCHEMADEFID_MIN_VALUE = 0LL;

	CFBamInt16TypeBuff::CFBamInt16TypeBuff()
	: CFBamInt16DefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamInt16TypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamInt16TypeBuff::CFBamInt16TypeBuff( const CFBamInt16TypeBuff& src )
	: CFBamInt16DefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamInt16TypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamInt16TypeBuff::clone() {
		CFBamInt16TypeBuff* copy = new CFBamInt16TypeBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamInt16TypeBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamInt16TypeBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamInt16TypeBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamInt16DefBuff::implementsClassCode( argClassCode ) );
		}
	}

	const int64_t CFBamInt16TypeBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamInt16TypeBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamInt16TypeBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamInt16TypeBuff::hashCode() const {
		size_t hashCode = CFBamInt16DefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamInt16TypeBuff CFBamInt16TypeBuff::operator =( cfbam::CFBamInt16TypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamInt16TypeBuff CFBamInt16TypeBuff::operator =( cfbam::CFBamInt16TypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamInt16TypeBuff::operator <( const CFBamInt16TypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamInt16TypeBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt16TypeBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt16TypeBuff::operator <( const CFBamInt16TypeHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt16TypeBuff::operator <( const CFBamInt16TypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamInt16TypeBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt16TypeBuff" );
