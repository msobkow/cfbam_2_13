// Description: C++18 implementation of a UInt64Def history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUInt64DefHBuff::CLASS_NAME( "CFBamUInt64DefHBuff" );
	CFBamUInt64DefHBuff::CFBamUInt64DefHBuff()
	...
	CFBamUInt64DefHBuff::CFBamUInt64DefHBuff( const CFBamUInt64DefHBuff& src )
	: cfbam::CFBamAtomHBuff() {
		optionalInitValue.setNull();
		optionalMinValue.setNull();
		optionalMaxValue.setNull();
	...
	cflib::ICFLibCloneableObj* CFBamUInt64DefHBuff::clone() {
		CFBamUInt64DefHBuff* copy = new CFBamUInt64DefHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const uint64_t CFBamUInt64DefHBuff::getOptionalInitValueValue() const {
		return( optionalInitValue.getValue() );
	}

	const uint64_t* CFBamUInt64DefHBuff::getOptionalInitValueReference() const {
		return( optionalInitValue.getReference() );
	}

	const bool CFBamUInt64DefHBuff::isOptionalInitValueNull() const {
		return( optionalInitValue.isNull() );
	}

	void CFBamUInt64DefHBuff::setOptionalInitValueNull() {
		optionalInitValue.setNull();
	}

	void CFBamUInt64DefHBuff::setOptionalInitValueValue( const uint64_t value ) {
	...
	const uint64_t CFBamUInt64DefHBuff::getOptionalMinValueValue() const {
		return( optionalMinValue.getValue() );
	}

	const uint64_t* CFBamUInt64DefHBuff::getOptionalMinValueReference() const {
		return( optionalMinValue.getReference() );
	}

	const bool CFBamUInt64DefHBuff::isOptionalMinValueNull() const {
		return( optionalMinValue.isNull() );
	}

	void CFBamUInt64DefHBuff::setOptionalMinValueNull() {
		optionalMinValue.setNull();
	}

	void CFBamUInt64DefHBuff::setOptionalMinValueValue( const uint64_t value ) {
	...
	const uint64_t CFBamUInt64DefHBuff::getOptionalMaxValueValue() const {
		return( optionalMaxValue.getValue() );
	}

	const uint64_t* CFBamUInt64DefHBuff::getOptionalMaxValueReference() const {
		return( optionalMaxValue.getReference() );
	}

	const bool CFBamUInt64DefHBuff::isOptionalMaxValueNull() const {
		return( optionalMaxValue.isNull() );
	}

	void CFBamUInt64DefHBuff::setOptionalMaxValueNull() {
		optionalMaxValue.setNull();
	}

	void CFBamUInt64DefHBuff::setOptionalMaxValueValue( const uint64_t value ) {
	...
	size_t CFBamUInt64DefHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamUInt64DefHBuff::hashCode();
	...
	CFBamUInt64DefHBuff CFBamUInt64DefHBuff::operator =( cfbam::CFBamUInt64DefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamUInt64DefHBuff CFBamUInt64DefHBuff::operator =( cfbam::CFBamUInt64DefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUInt64DefHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamUInt64DefHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamUInt64DefHBuff::operator <( const CFBamUInt64DefHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamUInt64DefHBuff::operator <( const CFBamUInt64DefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUInt64DefHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt64DefHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamUInt64DefHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamUInt64DefHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamUInt64DefHBuff& lhs, const cfbam::CFBamUInt64DefHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamUInt64DefHBuff& lhs, const cfbam::CFBamUInt64DefBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
