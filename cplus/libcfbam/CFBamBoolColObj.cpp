// Description: C++18 base object instance implementation for CFBam BoolCol.
...
namespace cfbam {
	...
	const std::string CFBamBoolColObj::CLASS_NAME( "CFBamBoolColObj" );
	const classcode_t CFBamBoolColObj::CLASS_CODE = 0xa853L;

	const int64_t CFBamBoolColObj::getRequiredTableId() {
		return( getBoolColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamBoolColObj::getRequiredTableIdReference() {
		return( getBoolColBuff()->getRequiredTableIdReference() );
	}


	cfbam::ICFBamTableObj* CFBamBoolColObj::getRequiredContainerTable( bool forceRead ) {
	...
	CFBamBoolColObj::CFBamBoolColObj()
	: ICFBamBoolColObj(),
	  CFBamBoolDefObj()
	{
	}

	CFBamBoolColObj::CFBamBoolColObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamBoolColObj(),
	...
	cfbam::CFBamValueBuff* CFBamBoolColObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamBoolColBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableBoolCol()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamBoolColObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamBoolColObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamBoolColObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamBoolColObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamBoolColObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamBoolColObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamBoolColObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamBoolColObj::getObjName() {
	...
	const std::string CFBamBoolColObj::getGenDefName() {
		return( cfbam::CFBamBoolColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamBoolColObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamBoolColObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamBoolColObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamBoolColObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamBoolColObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamBoolColObj::getObjQualifiedName() {
	...
	std::string CFBamBoolColObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamBoolColObj::realize() {
		cfbam::ICFBamBoolColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getBoolColTableObj()->realizeBoolCol(
			(cfbam::ICFBamBoolColObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamBoolColObj::read( bool forceRead ) {
		cfbam::ICFBamBoolColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getBoolColTableObj()->readBoolColByIdIdx( getBoolColBuff()->getRequiredTenantId(),
		getBoolColBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamBoolColObj::moveUp() {
		cfbam::ICFBamBoolColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getBoolColTableObj()->moveUpBoolCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamBoolColObj::moveDown() {
		cfbam::ICFBamBoolColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getBoolColTableObj()->moveDownBoolCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamBoolColObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamBoolColObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getBoolColTableObj()->lockBoolCol( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getBoolColTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamBoolColEditObj* CFBamBoolColObj::getBoolColEdit() {
		return( dynamic_cast<cfbam::ICFBamBoolColEditObj*>( edit ) );
	}
