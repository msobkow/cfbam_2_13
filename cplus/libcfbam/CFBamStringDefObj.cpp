// Description: C++18 base object instance implementation for CFBam StringDef.
...
namespace cfbam {
	...
	const std::string CFBamStringDefObj::CLASS_NAME( "CFBamStringDefObj" );
	const classcode_t CFBamStringDefObj::CLASS_CODE = 0xa838L;

	const int32_t CFBamStringDefObj::getRequiredMaxLen() {
		return( getStringDefBuff()->getRequiredMaxLen() );
	}

	const int32_t* CFBamStringDefObj::getRequiredMaxLenReference() {
		return( getStringDefBuff()->getRequiredMaxLenReference() );
	}

	const bool CFBamStringDefObj::getRequiredIsPolymorph() {
		return( getStringDefBuff()->getRequiredIsPolymorph() );
	}

	const bool* CFBamStringDefObj::getRequiredIsPolymorphReference() {
		return( getStringDefBuff()->getRequiredIsPolymorphReference() );
	}

	bool CFBamStringDefObj::isOptionalInitValueNull() {
		return( getStringDefBuff()->isOptionalInitValueNull() );
	}

	const std::string& CFBamStringDefObj::getOptionalInitValueValue() {
		return( getStringDefBuff()->getOptionalInitValueValue() );
	}

	const std::string* CFBamStringDefObj::getOptionalInitValueReference() {
		return( getStringDefBuff()->getOptionalInitValueReference() );
	}


	CFBamStringDefObj::CFBamStringDefObj()
	: ICFBamStringDefObj(),
	  CFBamAtomObj()
	{
	}

	CFBamStringDefObj::CFBamStringDefObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamStringDefObj(),
	...
	cfbam::CFBamValueBuff* CFBamStringDefObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamStringDefBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableStringDef()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamStringDefObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamStringDefObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamStringDefObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamStringDefObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamStringDefObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamStringDefObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt32( &S_Space, S_MaxLen, CFBamStringDefObj::getRequiredMaxLen() ) );
		ret.append( cflib::CFLibXmlUtil::formatRequiredBoolean( &S_Space, S_IsPolymorph, CFBamStringDefObj::getRequiredIsPolymorph() ) );
		if( ! CFBamStringDefObj::isOptionalInitValueNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredXmlString( &S_Space, S_InitValue, CFBamStringDefObj::getOptionalInitValueValue() ) );
		}
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamStringDefObj::getObjName() {
	...
	const std::string CFBamStringDefObj::getGenDefName() {
		return( cfbam::CFBamStringDefBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamStringDefObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamStringDefObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamStringDefObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamStringDefObj::getObjQualifiedName() {
	...
	std::string CFBamStringDefObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamStringDefObj::realize() {
		cfbam::ICFBamStringDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getStringDefTableObj()->realizeStringDef(
			(cfbam::ICFBamStringDefObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamStringDefObj::read( bool forceRead ) {
		cfbam::ICFBamStringDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getStringDefTableObj()->readStringDefByIdIdx( getStringDefBuff()->getRequiredTenantId(),
		getStringDefBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamStringDefObj::moveUp() {
		cfbam::ICFBamStringDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getStringDefTableObj()->moveUpStringDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamStringDefObj::moveDown() {
		cfbam::ICFBamStringDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getStringDefTableObj()->moveDownStringDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamStringDefObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamStringDefObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getStringDefTableObj()->lockStringDef( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getStringDefTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamStringDefEditObj* CFBamStringDefObj::getStringDefEdit() {
		return( dynamic_cast<cfbam::ICFBamStringDefEditObj*>( edit ) );
	}
