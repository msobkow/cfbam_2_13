// Description: C++18 implementation of a ServerObjFunc history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamServerObjFuncHBuff::CLASS_NAME( "CFBamServerObjFuncHBuff" );
	CFBamServerObjFuncHBuff::CFBamServerObjFuncHBuff()
	: cfbam::CFBamServerMethodHBuff() {
		optionalRetTenantId.setNull();
		optionalRetTableId.setNull();
	}

	CFBamServerObjFuncHBuff::CFBamServerObjFuncHBuff( const CFBamServerObjFuncHBuff& src )
	: cfbam::CFBamServerMethodHBuff() {
		optionalRetTenantId.setNull();
		optionalRetTableId.setNull();
	...
	cflib::ICFLibCloneableObj* CFBamServerObjFuncHBuff::clone() {
		CFBamServerObjFuncHBuff* copy = new CFBamServerObjFuncHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamServerObjFuncHBuff::getOptionalRetTenantIdValue() const {
		return( optionalRetTenantId.getValue() );
	}

	const int64_t* CFBamServerObjFuncHBuff::getOptionalRetTenantIdReference() const {
		return( optionalRetTenantId.getReference() );
	}

	const bool CFBamServerObjFuncHBuff::isOptionalRetTenantIdNull() const {
		return( optionalRetTenantId.isNull() );
	}

	void CFBamServerObjFuncHBuff::setOptionalRetTenantIdNull() {
		optionalRetTenantId.setNull();
	}

	void CFBamServerObjFuncHBuff::setOptionalRetTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamServerObjFuncHBuff::getOptionalRetTableIdValue() const {
		return( optionalRetTableId.getValue() );
	}

	const int64_t* CFBamServerObjFuncHBuff::getOptionalRetTableIdReference() const {
		return( optionalRetTableId.getReference() );
	}

	const bool CFBamServerObjFuncHBuff::isOptionalRetTableIdNull() const {
		return( optionalRetTableId.isNull() );
	}

	void CFBamServerObjFuncHBuff::setOptionalRetTableIdNull() {
		optionalRetTableId.setNull();
	}

	void CFBamServerObjFuncHBuff::setOptionalRetTableIdValue( const int64_t value ) {
	...
	size_t CFBamServerObjFuncHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamServerObjFuncHBuff::hashCode();
	...
	CFBamServerObjFuncHBuff CFBamServerObjFuncHBuff::operator =( cfbam::CFBamServerObjFuncBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredTableId( src.getRequiredTableId() );
	...
	CFBamServerObjFuncHBuff CFBamServerObjFuncHBuff::operator =( cfbam::CFBamServerObjFuncHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredTableId( src.getRequiredTableId() );
	...
	bool CFBamServerObjFuncHBuff::operator <( const CFBamServerObjFuncByRetTblIdxKey& rhs ) {
		if( ! isOptionalRetTenantIdNull() ) {
	...
	bool CFBamServerObjFuncHBuff::operator <( const CFBamScopePKey& rhs ) {
	...
	bool CFBamServerObjFuncHBuff::operator <( const CFBamScopeHPKey& rhs ) {
	...
	bool CFBamServerObjFuncHBuff::operator <( const CFBamServerObjFuncHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamServerObjFuncHBuff::operator <( const CFBamServerObjFuncBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamServerObjFuncHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamServerObjFuncHBuff" );
