// Description: C++18 implementation of a Id16Gen history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamId16GenHBuff::CLASS_NAME( "CFBamId16GenHBuff" );
	CFBamId16GenHBuff::CFBamId16GenHBuff()
	: cfbam::CFBamInt16TypeHBuff() {
	...
	CFBamId16GenHBuff::CFBamId16GenHBuff( const CFBamId16GenHBuff& src )
	: cfbam::CFBamInt16TypeHBuff() {
		optionalDispenserTenantId.setNull();
		optionalDispenserId.setNull();
		requiredSlice = cfbam::CFBamId16GenBuff::SLICE_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamId16GenHBuff::clone() {
		CFBamId16GenHBuff* copy = new CFBamId16GenHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamId16GenHBuff::getOptionalDispenserTenantIdValue() const {
		return( optionalDispenserTenantId.getValue() );
	}

	const int64_t* CFBamId16GenHBuff::getOptionalDispenserTenantIdReference() const {
		return( optionalDispenserTenantId.getReference() );
	}

	const bool CFBamId16GenHBuff::isOptionalDispenserTenantIdNull() const {
		return( optionalDispenserTenantId.isNull() );
	}

	void CFBamId16GenHBuff::setOptionalDispenserTenantIdNull() {
		optionalDispenserTenantId.setNull();
	}

	void CFBamId16GenHBuff::setOptionalDispenserTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamId16GenHBuff::getOptionalDispenserIdValue() const {
		return( optionalDispenserId.getValue() );
	}

	const int64_t* CFBamId16GenHBuff::getOptionalDispenserIdReference() const {
		return( optionalDispenserId.getReference() );
	}

	const bool CFBamId16GenHBuff::isOptionalDispenserIdNull() const {
		return( optionalDispenserId.isNull() );
	}

	void CFBamId16GenHBuff::setOptionalDispenserIdNull() {
		optionalDispenserId.setNull();
	}

	void CFBamId16GenHBuff::setOptionalDispenserIdValue( const int64_t value ) {
	...
	const int16_t CFBamId16GenHBuff::getRequiredSlice() const {
		return( requiredSlice );
	}

	const int16_t* CFBamId16GenHBuff::getRequiredSliceReference() const {
		return( &requiredSlice );
	}

	void CFBamId16GenHBuff::setRequiredSlice( const int16_t value ) {
	...
	const int16_t CFBamId16GenHBuff::getRequiredBlockSize() const {
		return( requiredBlockSize );
	}

	const int16_t* CFBamId16GenHBuff::getRequiredBlockSizeReference() const {
		return( &requiredBlockSize );
	}

	void CFBamId16GenHBuff::setRequiredBlockSize( const int16_t value ) {
	...
	size_t CFBamId16GenHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamId16GenHBuff::hashCode();
	...
	CFBamId16GenHBuff CFBamId16GenHBuff::operator =( cfbam::CFBamId16GenBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamId16GenHBuff CFBamId16GenHBuff::operator =( cfbam::CFBamId16GenHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamId16GenHBuff::operator <( const CFBamId16GenByDispIdxKey& rhs ) {
		if( ! isOptionalDispenserTenantIdNull() ) {
	...
	bool CFBamId16GenHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamId16GenHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamId16GenHBuff::operator <( const CFBamId16GenHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamId16GenHBuff::operator <( const CFBamId16GenBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamId16GenHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamId16GenHBuff" );
