// Description: C++18 Instance Edit Object interface implementation for CFBam EnumDef.
...
namespace cfbam {
	...
	const std::string ICFBamEnumDefEditObj::CLASS_NAME( "ICFBamEnumDefEditObj" );

	ICFBamEnumDefEditObj::ICFBamEnumDefEditObj()
