// Description: C++18 implementation of a ServerMethod history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamServerMethodHBuff::CLASS_NAME( "CFBamServerMethodHBuff" );
	CFBamServerMethodHBuff::CFBamServerMethodHBuff()
	...
	CFBamServerMethodHBuff::CFBamServerMethodHBuff( const CFBamServerMethodHBuff& src )
	: cfbam::CFBamScopeHBuff() {
		requiredTableId = cfbam::CFBamServerMethodBuff::TABLEID_INIT_VALUE;
		optionalDefSchemaTenantId.setNull();
		optionalDefSchemaId.setNull();
	...
	cflib::ICFLibCloneableObj* CFBamServerMethodHBuff::clone() {
		CFBamServerMethodHBuff* copy = new CFBamServerMethodHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamServerMethodHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamServerMethodHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamServerMethodHBuff::setRequiredTableId( const int64_t value ) {
	...
	const int64_t CFBamServerMethodHBuff::getOptionalDefSchemaTenantIdValue() const {
		return( optionalDefSchemaTenantId.getValue() );
	}

	const int64_t* CFBamServerMethodHBuff::getOptionalDefSchemaTenantIdReference() const {
		return( optionalDefSchemaTenantId.getReference() );
	}

	const bool CFBamServerMethodHBuff::isOptionalDefSchemaTenantIdNull() const {
		return( optionalDefSchemaTenantId.isNull() );
	}

	void CFBamServerMethodHBuff::setOptionalDefSchemaTenantIdNull() {
		optionalDefSchemaTenantId.setNull();
	}

	void CFBamServerMethodHBuff::setOptionalDefSchemaTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamServerMethodHBuff::getOptionalDefSchemaIdValue() const {
		return( optionalDefSchemaId.getValue() );
	}

	const int64_t* CFBamServerMethodHBuff::getOptionalDefSchemaIdReference() const {
		return( optionalDefSchemaId.getReference() );
	}

	const bool CFBamServerMethodHBuff::isOptionalDefSchemaIdNull() const {
		return( optionalDefSchemaId.isNull() );
	}

	void CFBamServerMethodHBuff::setOptionalDefSchemaIdNull() {
		optionalDefSchemaId.setNull();
	}

	void CFBamServerMethodHBuff::setOptionalDefSchemaIdValue( const int64_t value ) {
	...
	const std::string& CFBamServerMethodHBuff::getRequiredName() const {
		return( *requiredName );
	}

	const std::string* CFBamServerMethodHBuff::getRequiredNameReference() const {
		return( requiredName );
	}

	void CFBamServerMethodHBuff::setRequiredName( const std::string& value ) {
	...
	const std::string& CFBamServerMethodHBuff::getOptionalShortNameValue() const {
	...
	const std::string* CFBamServerMethodHBuff::getOptionalShortNameReference() const {
		return( optionalShortName );
	}

	const bool CFBamServerMethodHBuff::isOptionalShortNameNull() const {
		return( optionalShortName == NULL );
	}

	void CFBamServerMethodHBuff::setOptionalShortNameNull() {
		if( optionalShortName != NULL ) {
			delete optionalShortName;
			optionalShortName = NULL;
		}
	...
	void CFBamServerMethodHBuff::setOptionalShortNameValue( const std::string& value ) {
	...
	const std::string& CFBamServerMethodHBuff::getOptionalLabelValue() const {
	...
	const std::string* CFBamServerMethodHBuff::getOptionalLabelReference() const {
		return( optionalLabel );
	}

	const bool CFBamServerMethodHBuff::isOptionalLabelNull() const {
		return( optionalLabel == NULL );
	}

	void CFBamServerMethodHBuff::setOptionalLabelNull() {
		if( optionalLabel != NULL ) {
			delete optionalLabel;
			optionalLabel = NULL;
		}
	...
	void CFBamServerMethodHBuff::setOptionalLabelValue( const std::string& value ) {
	...
	const std::string& CFBamServerMethodHBuff::getOptionalShortDescriptionValue() const {
	...
	const std::string* CFBamServerMethodHBuff::getOptionalShortDescriptionReference() const {
		return( optionalShortDescription );
	}

	const bool CFBamServerMethodHBuff::isOptionalShortDescriptionNull() const {
		return( optionalShortDescription == NULL );
	}

	void CFBamServerMethodHBuff::setOptionalShortDescriptionNull() {
		if( optionalShortDescription != NULL ) {
			delete optionalShortDescription;
			optionalShortDescription = NULL;
		}
	...
	void CFBamServerMethodHBuff::setOptionalShortDescriptionValue( const std::string& value ) {
	...
	const std::string& CFBamServerMethodHBuff::getOptionalDescriptionValue() const {
	...
	const std::string* CFBamServerMethodHBuff::getOptionalDescriptionReference() const {
		return( optionalDescription );
	}

	const bool CFBamServerMethodHBuff::isOptionalDescriptionNull() const {
		return( optionalDescription == NULL );
	}

	void CFBamServerMethodHBuff::setOptionalDescriptionNull() {
		if( optionalDescription != NULL ) {
			delete optionalDescription;
			optionalDescription = NULL;
		}
	...
	void CFBamServerMethodHBuff::setOptionalDescriptionValue( const std::string& value ) {
	...
	const std::string& CFBamServerMethodHBuff::getOptionalSuffixValue() const {
	...
	const std::string* CFBamServerMethodHBuff::getOptionalSuffixReference() const {
		return( optionalSuffix );
	}

	const bool CFBamServerMethodHBuff::isOptionalSuffixNull() const {
		return( optionalSuffix == NULL );
	}

	void CFBamServerMethodHBuff::setOptionalSuffixNull() {
		if( optionalSuffix != NULL ) {
			delete optionalSuffix;
			optionalSuffix = NULL;
		}
	...
	void CFBamServerMethodHBuff::setOptionalSuffixValue( const std::string& value ) {
	...
	const bool CFBamServerMethodHBuff::getRequiredIsInstanceMethod() const {
		return( requiredIsInstanceMethod );
	}

	const bool* CFBamServerMethodHBuff::getRequiredIsInstanceMethodReference() const {
		return( &requiredIsInstanceMethod );
	}

	void CFBamServerMethodHBuff::setRequiredIsInstanceMethod( const bool value ) {
		requiredIsInstanceMethod = value;
	}

	const bool CFBamServerMethodHBuff::getRequiredIsServerOnly() const {
		return( requiredIsServerOnly );
	}

	const bool* CFBamServerMethodHBuff::getRequiredIsServerOnlyReference() const {
		return( &requiredIsServerOnly );
	}

	void CFBamServerMethodHBuff::setRequiredIsServerOnly( const bool value ) {
		requiredIsServerOnly = value;
	}

	const std::string& CFBamServerMethodHBuff::getRequiredJMethodBody() const {
		return( *requiredJMethodBody );
	}

	const std::string* CFBamServerMethodHBuff::getRequiredJMethodBodyReference() const {
		return( requiredJMethodBody );
	}

	void CFBamServerMethodHBuff::setRequiredJMethodBody( const std::string& value ) {
	...
	const std::string& CFBamServerMethodHBuff::getRequiredCppMethodBody() const {
		return( *requiredCppMethodBody );
	}

	const std::string* CFBamServerMethodHBuff::getRequiredCppMethodBodyReference() const {
		return( requiredCppMethodBody );
	}

	void CFBamServerMethodHBuff::setRequiredCppMethodBody( const std::string& value ) {
	...
	const std::string& CFBamServerMethodHBuff::getRequiredCsMethodBody() const {
		return( *requiredCsMethodBody );
	}

	const std::string* CFBamServerMethodHBuff::getRequiredCsMethodBodyReference() const {
		return( requiredCsMethodBody );
	}

	void CFBamServerMethodHBuff::setRequiredCsMethodBody( const std::string& value ) {
	...
	size_t CFBamServerMethodHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamServerMethodHBuff::hashCode();
	...
	CFBamServerMethodHBuff CFBamServerMethodHBuff::operator =( cfbam::CFBamServerMethodBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredTableId( src.getRequiredTableId() );
	...
	CFBamServerMethodHBuff CFBamServerMethodHBuff::operator =( cfbam::CFBamServerMethodHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredTableId( src.getRequiredTableId() );
	...
	bool CFBamServerMethodHBuff::operator <( const CFBamServerMethodByUNameIdxKey& rhs ) {
	...
	bool CFBamServerMethodHBuff::operator <( const CFBamServerMethodByMethTableIdxKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamServerMethodHBuff::operator <( const CFBamServerMethodByDefSchemaIdxKey& rhs ) {
		if( ! isOptionalDefSchemaTenantIdNull() ) {
	...
	bool CFBamServerMethodHBuff::operator <( const CFBamScopePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamServerMethodHBuff::operator <( const CFBamScopeHPKey& rhs ) {
	...
	bool CFBamServerMethodHBuff::operator <( const CFBamServerMethodHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamServerMethodHBuff::operator <( const CFBamServerMethodBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamServerMethodHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamServerMethodHBuff" );
