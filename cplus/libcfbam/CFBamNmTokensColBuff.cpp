// Description: C++18 implementation for a NmTokensCol buffer object.
...
namespace cfbam {
	...
	const std::string CFBamNmTokensColBuff::GENDEFNAME( "NmTokensCol" );
	const classcode_t CFBamNmTokensColBuff::CLASS_CODE = 0xa860L;
	const std::string CFBamNmTokensColBuff::CLASS_NAME( "CFBamNmTokensColBuff" );
		const std::string CFBamNmTokensColBuff::COLNAME_TABLEID( "TableId" );
	const int64_t CFBamNmTokensColBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamNmTokensColBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamNmTokensColBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamNmTokensColBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamNmTokensColBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamNmTokensColBuff::TABLEID_MIN_VALUE = 0LL;

	CFBamNmTokensColBuff::CFBamNmTokensColBuff()
	: CFBamNmTokensDefBuff()
	{
		requiredTableId = cfbam::CFBamNmTokensColBuff::TABLEID_INIT_VALUE;
	}

	CFBamNmTokensColBuff::CFBamNmTokensColBuff( const CFBamNmTokensColBuff& src )
	: CFBamNmTokensDefBuff()
	{
		requiredTableId = cfbam::CFBamNmTokensColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamNmTokensColBuff::clone() {
		CFBamNmTokensColBuff* copy = new CFBamNmTokensColBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamNmTokensColBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamNmTokensColBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamNmTokensColBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamNmTokensDefBuff::implementsClassCode( argClassCode ) );
		}
	}

	const int64_t CFBamNmTokensColBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamNmTokensColBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamNmTokensColBuff::setRequiredTableId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredTableId" );
		if( value < cfbam::CFBamNmTokensColBuff::TABLEID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamNmTokensColBuff::TABLEID_MIN_VALUE );
		}
		requiredTableId = value;
	}

	size_t CFBamNmTokensColBuff::hashCode() const {
		size_t hashCode = CFBamNmTokensDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamNmTokensColBuff CFBamNmTokensColBuff::operator =( cfbam::CFBamNmTokensColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamNmTokensColBuff CFBamNmTokensColBuff::operator =( cfbam::CFBamNmTokensColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamNmTokensColBuff::operator <( const CFBamNmTokensColByTableIdxKey& rhs ) {
	...
	bool CFBamNmTokensColBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNmTokensColBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNmTokensColBuff::operator <( const CFBamNmTokensColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNmTokensColBuff::operator <( const CFBamNmTokensColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamNmTokensColBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNmTokensColBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamNmTokensColBuff& lhs, const cfbam::CFBamNmTokensColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamNmTokensColBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamNmTokensColBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamNmTokensColBuff& lhs, const cfbam::CFBamNmTokensColHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamNmTokensColBuff& lhs, const cfbam::CFBamNmTokensColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
