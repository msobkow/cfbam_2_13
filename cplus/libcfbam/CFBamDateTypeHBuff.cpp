// Description: C++18 implementation of a DateType history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamDateTypeHBuff::CLASS_NAME( "CFBamDateTypeHBuff" );
	CFBamDateTypeHBuff::CFBamDateTypeHBuff()
	: cfbam::CFBamDateDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamDateTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamDateTypeHBuff::CFBamDateTypeHBuff( const CFBamDateTypeHBuff& src )
	: cfbam::CFBamDateDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamDateTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamDateTypeHBuff::clone() {
		CFBamDateTypeHBuff* copy = new CFBamDateTypeHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamDateTypeHBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamDateTypeHBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamDateTypeHBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamDateTypeHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamDateTypeHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamDateTypeHBuff CFBamDateTypeHBuff::operator =( cfbam::CFBamDateTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamDateTypeHBuff CFBamDateTypeHBuff::operator =( cfbam::CFBamDateTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamDateTypeHBuff::operator <( const CFBamDateTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamDateTypeHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamDateTypeHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamDateTypeHBuff::operator <( const CFBamDateTypeHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamDateTypeHBuff::operator <( const CFBamDateTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamDateTypeHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamDateTypeHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamDateTypeHBuff& lhs, const cfbam::CFBamDateTypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamDateTypeHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamDateTypeHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamDateTypeHBuff& lhs, const cfbam::CFBamDateTypeHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamDateTypeHBuff& lhs, const cfbam::CFBamDateTypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
