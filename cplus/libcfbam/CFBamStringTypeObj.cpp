// Description: C++18 base object instance implementation for CFBam StringType.
...
namespace cfbam {
	...
	const std::string CFBamStringTypeObj::CLASS_NAME( "CFBamStringTypeObj" );
	const classcode_t CFBamStringTypeObj::CLASS_CODE = 0xa839L;

	const int64_t CFBamStringTypeObj::getRequiredSchemaDefId() {
		return( getStringTypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamStringTypeObj::getRequiredSchemaDefIdReference() {
		return( getStringTypeBuff()->getRequiredSchemaDefIdReference() );
	}


	cfbam::ICFBamSchemaDefObj* CFBamStringTypeObj::getRequiredContainerSchemaDef( bool forceRead ) {
	...
	CFBamStringTypeObj::CFBamStringTypeObj()
	: ICFBamStringTypeObj(),
	  CFBamStringDefObj()
	{
	}

	CFBamStringTypeObj::CFBamStringTypeObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamStringTypeObj(),
	  CFBamStringDefObj( argSchema )
	{
	}
	...
	cfbam::CFBamValueBuff* CFBamStringTypeObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamStringTypeBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableStringType()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamStringTypeObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamStringTypeObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamStringTypeObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamStringTypeObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamStringTypeBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamStringDefObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamStringTypeObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamStringTypeObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamStringTypeObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamStringTypeObj::getObjName() {
	...
	const std::string CFBamStringTypeObj::getGenDefName() {
		return( cfbam::CFBamStringTypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamStringTypeObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamStringTypeObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamStringTypeObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamStringTypeObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamStringTypeObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamStringTypeObj::getObjQualifiedName() {
	...
	std::string CFBamStringTypeObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamStringTypeObj::realize() {
		cfbam::ICFBamStringTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getStringTypeTableObj()->realizeStringType(
			(cfbam::ICFBamStringTypeObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamStringTypeObj::read( bool forceRead ) {
		cfbam::ICFBamStringTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getStringTypeTableObj()->readStringTypeByIdIdx( getStringTypeBuff()->getRequiredTenantId(),
		getStringTypeBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamStringTypeObj::moveUp() {
		cfbam::ICFBamStringTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getStringTypeTableObj()->moveUpStringType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamStringTypeObj::moveDown() {
		cfbam::ICFBamStringTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getStringTypeTableObj()->moveDownStringType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamStringTypeObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamStringTypeObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getStringTypeTableObj()->lockStringType( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getStringTypeTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamStringTypeEditObj* CFBamStringTypeObj::getStringTypeEdit() {
		return( dynamic_cast<cfbam::ICFBamStringTypeEditObj*>( edit ) );
	}
