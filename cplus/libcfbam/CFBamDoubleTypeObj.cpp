// Description: C++18 base object instance implementation for CFBam DoubleType.
...
namespace cfbam {
	...
	const std::string CFBamDoubleTypeObj::CLASS_NAME( "CFBamDoubleTypeObj" );
	const classcode_t CFBamDoubleTypeObj::CLASS_CODE = 0xa81dL;

	const int64_t CFBamDoubleTypeObj::getRequiredSchemaDefId() {
		return( getDoubleTypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamDoubleTypeObj::getRequiredSchemaDefIdReference() {
		return( getDoubleTypeBuff()->getRequiredSchemaDefIdReference() );
	}


	cfbam::ICFBamSchemaDefObj* CFBamDoubleTypeObj::getRequiredContainerSchemaDef( bool forceRead ) {
	...
	CFBamDoubleTypeObj::CFBamDoubleTypeObj()
	: ICFBamDoubleTypeObj(),
	  CFBamDoubleDefObj()
	{
	}

	CFBamDoubleTypeObj::CFBamDoubleTypeObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamDoubleTypeObj(),
	...
	cfbam::CFBamValueBuff* CFBamDoubleTypeObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamDoubleTypeBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableDoubleType()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamDoubleTypeObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamDoubleTypeObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamDoubleTypeObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamDoubleTypeObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamDoubleTypeObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamDoubleTypeObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamDoubleTypeObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamDoubleTypeObj::getObjName() {
	...
	const std::string CFBamDoubleTypeObj::getGenDefName() {
		return( cfbam::CFBamDoubleTypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamDoubleTypeObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamDoubleTypeObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamDoubleTypeObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamDoubleTypeObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamDoubleTypeObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamDoubleTypeObj::getObjQualifiedName() {
	...
	std::string CFBamDoubleTypeObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamDoubleTypeObj::realize() {
		cfbam::ICFBamDoubleTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDoubleTypeTableObj()->realizeDoubleType(
			(cfbam::ICFBamDoubleTypeObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamDoubleTypeObj::read( bool forceRead ) {
		cfbam::ICFBamDoubleTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDoubleTypeTableObj()->readDoubleTypeByIdIdx( getDoubleTypeBuff()->getRequiredTenantId(),
		getDoubleTypeBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamDoubleTypeObj::moveUp() {
		cfbam::ICFBamDoubleTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDoubleTypeTableObj()->moveUpDoubleType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamDoubleTypeObj::moveDown() {
		cfbam::ICFBamDoubleTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDoubleTypeTableObj()->moveDownDoubleType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamDoubleTypeObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamDoubleTypeObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDoubleTypeTableObj()->lockDoubleType( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDoubleTypeTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamDoubleTypeEditObj* CFBamDoubleTypeObj::getDoubleTypeEdit() {
		return( dynamic_cast<cfbam::ICFBamDoubleTypeEditObj*>( edit ) );
	}
