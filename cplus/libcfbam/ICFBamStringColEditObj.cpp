// Description: C++18 Instance Edit Object interface implementation for CFBam StringCol.
...
namespace cfbam {
	...
	const std::string ICFBamStringColEditObj::CLASS_NAME( "ICFBamStringColEditObj" );

	ICFBamStringColEditObj::ICFBamStringColEditObj()
