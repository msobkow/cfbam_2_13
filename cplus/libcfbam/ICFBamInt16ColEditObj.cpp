// Description: C++18 Instance Edit Object interface implementation for CFBam Int16Col.
...
namespace cfbam {
	...
	const std::string ICFBamInt16ColEditObj::CLASS_NAME( "ICFBamInt16ColEditObj" );

	ICFBamInt16ColEditObj::ICFBamInt16ColEditObj()
