// Description: C++18 edit object instance implementation for CFBam StringType.
...
namespace cfbam {
	...
	const std::string CFBamStringTypeEditObj::CLASS_NAME( "CFBamStringTypeEditObj" );

	CFBamStringTypeEditObj::CFBamStringTypeEditObj( cfbam::ICFBamStringTypeObj* argOrig )
	: ICFBamStringTypeEditObj(),
	  CFBamStringDefEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamStringTypeEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamStringTypeEditObj::~CFBamStringTypeEditObj() {
	}

	const std::string& CFBamStringTypeEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamStringTypeEditObj::getClassCode() const {
		return( cfbam::CFBamStringTypeBuff::CLASS_CODE );
	}

	bool CFBamStringTypeEditObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamStringTypeBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamStringDefEditObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamStringTypeEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamStringTypeEditObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamStringTypeEditObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	const std::string CFBamStringTypeEditObj::getGenDefName() {
		return( cfbam::CFBamStringTypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamStringTypeEditObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamStringTypeEditObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamStringTypeEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamStringTypeEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamStringTypeEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamStringTypeEditObj::getObjQualifiedName() {
	...
	std::string CFBamStringTypeEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamStringTypeEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamStringTypeObj* retobj = getSchema()->getStringTypeTableObj()->realizeStringType( dynamic_cast<cfbam::ICFBamStringTypeObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamStringTypeEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamStringTypeEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamStringTypeEditObj::create() {
		cfbam::ICFBamStringTypeObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsStringType()->getSchema() )->getStringTypeTableObj()->createStringType( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamStringTypeEditObj::update() {
		getSchema()->getStringTypeTableObj()->updateStringType( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamStringTypeEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getStringTypeTableObj()->deleteStringType( this );
		return( NULL );
	}

	cfbam::ICFBamStringTypeTableObj* CFBamStringTypeEditObj::getStringTypeTable() {
		return( orig->getSchema()->getStringTypeTableObj() );
	}

	cfbam::ICFBamStringTypeEditObj* CFBamStringTypeEditObj::getStringTypeEdit() {
		return( (cfbam::ICFBamStringTypeEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamStringTypeEditObj::beginEdit() {
	...
	cfbam::ICFBamStringTypeObj* CFBamStringTypeEditObj::getOrigAsStringType() {
		return( dynamic_cast<cfbam::ICFBamStringTypeObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamStringTypeEditObj::getBuff() {
		return( buff );
	}

	void CFBamStringTypeEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamStringDefEditObj::setBuff( value );
		}
	}

	const int64_t CFBamStringTypeEditObj::getRequiredSchemaDefId() {
		return( getStringTypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamStringTypeEditObj::getRequiredSchemaDefIdReference() {
		return( getStringTypeBuff()->getRequiredSchemaDefIdReference() );
	}

	void CFBamStringTypeEditObj::setRequiredContainerScope( cfbam::ICFBamScopeObj* value ) {
		if( value == NULL ) {
	...
	cfbam::ICFBamSchemaDefObj* CFBamStringTypeEditObj::getRequiredContainerSchemaDef( bool forceRead ) {
		cfbam::ICFBamSchemaDefObj* retobj = NULL;
		bool anyMissing = false;
		if( ! anyMissing ) {
			retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsStringType()->getSchema() )->getSchemaDefTableObj()->readSchemaDefByIdIdx( getPKey()->getRequiredTenantId(),
					getStringTypeBuff()->getRequiredSchemaDefId() );
		}
		return( retobj );
	}

	void CFBamStringTypeEditObj::setRequiredContainerSchemaDef( cfbam::ICFBamSchemaDefObj* value ) {
			
			if( value != NULL ) {
				getPKey()->setRequiredTenantId
( value->getRequiredTenantId() );
				getStringTypeEditBuff()->setRequiredTenantId( value->getRequiredTenantId() );
				getStringTypeEditBuff()->setRequiredSchemaDefId( value->getRequiredId() );
			}

			CFBamStringDefEditObj::setRequiredContainerScope( value );		}

	void CFBamStringTypeEditObj::copyBuffToOrig() {
		cfbam::CFBamStringTypeBuff* origBuff = getOrigAsStringType()->getStringTypeEditBuff();
		cfbam::CFBamStringTypeBuff* myBuff = getStringTypeBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamStringTypeEditObj::copyOrigToBuff() {
		cfbam::CFBamStringTypeBuff* origBuff = getOrigAsStringType()->getStringTypeBuff();
		cfbam::CFBamStringTypeBuff* myBuff = getStringTypeEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
