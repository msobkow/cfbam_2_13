// Description: C++18 implementation of a TimestampType history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTimestampTypeHBuff::CLASS_NAME( "CFBamTimestampTypeHBuff" );
	CFBamTimestampTypeHBuff::CFBamTimestampTypeHBuff()
	: cfbam::CFBamTimestampDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamTimestampTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamTimestampTypeHBuff::CFBamTimestampTypeHBuff( const CFBamTimestampTypeHBuff& src )
	: cfbam::CFBamTimestampDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamTimestampTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTimestampTypeHBuff::clone() {
		CFBamTimestampTypeHBuff* copy = new CFBamTimestampTypeHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamTimestampTypeHBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamTimestampTypeHBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamTimestampTypeHBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamTimestampTypeHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamTimestampTypeHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamTimestampTypeHBuff CFBamTimestampTypeHBuff::operator =( cfbam::CFBamTimestampTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamTimestampTypeHBuff CFBamTimestampTypeHBuff::operator =( cfbam::CFBamTimestampTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTimestampTypeHBuff::operator <( const CFBamTimestampTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamTimestampTypeHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTimestampTypeHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamTimestampTypeHBuff::operator <( const CFBamTimestampTypeHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamTimestampTypeHBuff::operator <( const CFBamTimestampTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTimestampTypeHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTimestampTypeHBuff" );
