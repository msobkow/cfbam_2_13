// Description: C++18 implementation for a TextType buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTextTypeBuff::GENDEFNAME( "TextType" );
	const classcode_t CFBamTextTypeBuff::CLASS_CODE = 0xa842L;
	const std::string CFBamTextTypeBuff::CLASS_NAME( "CFBamTextTypeBuff" );
		const std::string CFBamTextTypeBuff::COLNAME_SCHEMADEFID( "SchemaDefId" );
	const int64_t CFBamTextTypeBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamTextTypeBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamTextTypeBuff::SCHEMADEFID_INIT_VALUE = 0LL;
	const int64_t CFBamTextTypeBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamTextTypeBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamTextTypeBuff::SCHEMADEFID_MIN_VALUE = 0LL;

	CFBamTextTypeBuff::CFBamTextTypeBuff()
	: CFBamTextDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamTextTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamTextTypeBuff::CFBamTextTypeBuff( const CFBamTextTypeBuff& src )
	: CFBamTextDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamTextTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTextTypeBuff::clone() {
		CFBamTextTypeBuff* copy = new CFBamTextTypeBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTextTypeBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTextTypeBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTextTypeBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFBamTextTypeBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamTextTypeBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamTextTypeBuff::setRequiredSchemaDefId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredSchemaDefId" );
		if( value < cfbam::CFBamTextTypeBuff::SCHEMADEFID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamTextTypeBuff::SCHEMADEFID_MIN_VALUE );
		}
		requiredSchemaDefId = value;
	}

	size_t CFBamTextTypeBuff::hashCode() const {
		size_t hashCode = CFBamTextDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamTextTypeBuff CFBamTextTypeBuff::operator =( cfbam::CFBamTextTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamTextTypeBuff CFBamTextTypeBuff::operator =( cfbam::CFBamTextTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTextTypeBuff::operator <( const CFBamTextTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamTextTypeBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTextTypeBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTextTypeBuff::operator <( const CFBamTextTypeHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTextTypeBuff::operator <( const CFBamTextTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTextTypeBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTextTypeBuff" );
