// Description: C++18 implementation for a TextCol buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTextColBuff::GENDEFNAME( "TextCol" );
	const classcode_t CFBamTextColBuff::CLASS_CODE = 0xa866L;
	const std::string CFBamTextColBuff::CLASS_NAME( "CFBamTextColBuff" );
		const std::string CFBamTextColBuff::COLNAME_TABLEID( "TableId" );
	const int64_t CFBamTextColBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamTextColBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamTextColBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamTextColBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamTextColBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamTextColBuff::TABLEID_MIN_VALUE = 0LL;

	CFBamTextColBuff::CFBamTextColBuff()
	: CFBamTextDefBuff()
	{
		requiredTableId = cfbam::CFBamTextColBuff::TABLEID_INIT_VALUE;
	}

	CFBamTextColBuff::CFBamTextColBuff( const CFBamTextColBuff& src )
	: CFBamTextDefBuff()
	{
		requiredTableId = cfbam::CFBamTextColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTextColBuff::clone() {
		CFBamTextColBuff* copy = new CFBamTextColBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTextColBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTextColBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTextColBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamTextDefBuff::implementsClassCode( argClassCode ) );
		}
	}

	const int64_t CFBamTextColBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamTextColBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamTextColBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamTextColBuff::hashCode() const {
		size_t hashCode = CFBamTextDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamTextColBuff CFBamTextColBuff::operator =( cfbam::CFBamTextColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamTextColBuff CFBamTextColBuff::operator =( cfbam::CFBamTextColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTextColBuff::operator <( const CFBamTextColByTableIdxKey& rhs ) {
	...
	bool CFBamTextColBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTextColBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTextColBuff::operator <( const CFBamTextColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTextColBuff::operator <( const CFBamTextColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTextColBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTextColBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamTextColBuff& lhs, const cfbam::CFBamTextColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTextColBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTextColBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTextColBuff& lhs, const cfbam::CFBamTextColHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTextColBuff& lhs, const cfbam::CFBamTextColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
