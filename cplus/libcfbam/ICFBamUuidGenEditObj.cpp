// Description: C++18 Instance Edit Object interface implementation for CFBam UuidGen.
...
namespace cfbam {
	...
	const std::string ICFBamUuidGenEditObj::CLASS_NAME( "ICFBamUuidGenEditObj" );

	ICFBamUuidGenEditObj::ICFBamUuidGenEditObj()
