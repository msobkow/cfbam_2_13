// Description: C++18 base object instance implementation for CFBam Int32Type.
...
namespace cfbam {
	...
	const std::string CFBamInt32TypeObj::CLASS_NAME( "CFBamInt32TypeObj" );
	const classcode_t CFBamInt32TypeObj::CLASS_CODE = 0xa826L;

	const int64_t CFBamInt32TypeObj::getRequiredSchemaDefId() {
		return( getInt32TypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamInt32TypeObj::getRequiredSchemaDefIdReference() {
		return( getInt32TypeBuff()->getRequiredSchemaDefIdReference() );
	}


	cfbam::ICFBamSchemaDefObj* CFBamInt32TypeObj::getRequiredContainerSchemaDef( bool forceRead ) {
	...
	CFBamInt32TypeObj::CFBamInt32TypeObj()
	: ICFBamInt32TypeObj(),
	  CFBamInt32DefObj()
	{
	}

	CFBamInt32TypeObj::CFBamInt32TypeObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamInt32TypeObj(),
	  CFBamInt32DefObj( argSchema )
	{
	}
	...
	cfbam::CFBamValueBuff* CFBamInt32TypeObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamInt32TypeBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableInt32Type()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamInt32TypeObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamInt32TypeObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamInt32TypeObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamInt32TypeObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamInt32TypeBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamInt32DefObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamInt32TypeObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt32TypeObj" );
	...
	std::string CFBamInt32TypeObj::getObjName() {
	...
	const std::string CFBamInt32TypeObj::getGenDefName() {
		return( cfbam::CFBamInt32TypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamInt32TypeObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamInt32TypeObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamInt32TypeObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamInt32TypeObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamInt32TypeObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamInt32TypeObj::getObjQualifiedName() {
	...
	std::string CFBamInt32TypeObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamInt32TypeObj::realize() {
		cfbam::ICFBamInt32TypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt32TypeTableObj()->realizeInt32Type(
			(cfbam::ICFBamInt32TypeObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamInt32TypeObj::read( bool forceRead ) {
		cfbam::ICFBamInt32TypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt32TypeTableObj()->readInt32TypeByIdIdx( getInt32TypeBuff()->getRequiredTenantId(),
		getInt32TypeBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamInt32TypeObj::moveUp() {
		cfbam::ICFBamInt32TypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt32TypeTableObj()->moveUpInt32Type( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamInt32TypeObj::moveDown() {
		cfbam::ICFBamInt32TypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt32TypeTableObj()->moveDownInt32Type( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamInt32TypeObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamInt32TypeObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt32TypeTableObj()->lockInt32Type( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt32TypeTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamInt32TypeEditObj* CFBamInt32TypeObj::getInt32TypeEdit() {
		return( dynamic_cast<cfbam::ICFBamInt32TypeEditObj*>( edit ) );
	}
