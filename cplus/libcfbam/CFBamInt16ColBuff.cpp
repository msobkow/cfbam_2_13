// Description: C++18 implementation for a Int16Col buffer object.
...
namespace cfbam {
	...
	const std::string CFBamInt16ColBuff::GENDEFNAME( "Int16Col" );
	const classcode_t CFBamInt16ColBuff::CLASS_CODE = 0xa85cL;
	const std::string CFBamInt16ColBuff::CLASS_NAME( "CFBamInt16ColBuff" );
		const std::string CFBamInt16ColBuff::COLNAME_TABLEID( "TableId" );
	const int64_t CFBamInt16ColBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamInt16ColBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamInt16ColBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamInt16ColBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamInt16ColBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamInt16ColBuff::TABLEID_MIN_VALUE = 0LL;

	CFBamInt16ColBuff::CFBamInt16ColBuff()
	: CFBamInt16DefBuff()
	{
		requiredTableId = cfbam::CFBamInt16ColBuff::TABLEID_INIT_VALUE;
	}

	CFBamInt16ColBuff::CFBamInt16ColBuff( const CFBamInt16ColBuff& src )
	: CFBamInt16DefBuff()
	{
		requiredTableId = cfbam::CFBamInt16ColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamInt16ColBuff::clone() {
		CFBamInt16ColBuff* copy = new CFBamInt16ColBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamInt16ColBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamInt16ColBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamInt16ColBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFBamInt16ColBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamInt16ColBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamInt16ColBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamInt16ColBuff::hashCode() const {
		size_t hashCode = CFBamInt16DefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamInt16ColBuff CFBamInt16ColBuff::operator =( cfbam::CFBamInt16ColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamInt16ColBuff CFBamInt16ColBuff::operator =( cfbam::CFBamInt16ColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamInt16ColBuff::operator <( const CFBamInt16ColByTableIdxKey& rhs ) {
	...
	bool CFBamInt16ColBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt16ColBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt16ColBuff::operator <( const CFBamInt16ColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt16ColBuff::operator <( const CFBamInt16ColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamInt16ColBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt16ColBuff" );
