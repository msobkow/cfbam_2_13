// Description: C++18 implementation for a Relation by DefSchemaIdx index key object.
...
namespace cfbam {
	const std::string CFBamRelationByDefSchemaIdxKey::CLASS_NAME( "CFBamRelationByDefSchemaIdxKey" );
	const std::string CFBamRelationByDefSchemaIdxKey::S_VALUE( "value" );
	const std::string CFBamRelationByDefSchemaIdxKey::S_VALUE_LENGTH( "value.length()" );


	CFBamRelationByDefSchemaIdxKey::CFBamRelationByDefSchemaIdxKey() {
		optionalDefSchemaTenantId.setNull();
		optionalDefSchemaId.setNull();
	}

	CFBamRelationByDefSchemaIdxKey::CFBamRelationByDefSchemaIdxKey( const CFBamRelationByDefSchemaIdxKey& src ) {
		optionalDefSchemaTenantId.setNull();
		optionalDefSchemaId.setNull();
	...
	const int64_t CFBamRelationByDefSchemaIdxKey::getOptionalDefSchemaTenantIdValue() const {
		return( optionalDefSchemaTenantId.getValue() );
	}

	const int64_t* CFBamRelationByDefSchemaIdxKey::getOptionalDefSchemaTenantIdReference() const {
		return( optionalDefSchemaTenantId.getReference() );
	}

	const bool CFBamRelationByDefSchemaIdxKey::isOptionalDefSchemaTenantIdNull() const {
		return( optionalDefSchemaTenantId.isNull() );
	}

	void CFBamRelationByDefSchemaIdxKey::setOptionalDefSchemaTenantIdNull() {
		optionalDefSchemaTenantId.setNull();
	}

	void CFBamRelationByDefSchemaIdxKey::setOptionalDefSchemaTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamRelationByDefSchemaIdxKey::getOptionalDefSchemaIdValue() const {
		return( optionalDefSchemaId.getValue() );
	}

	const int64_t* CFBamRelationByDefSchemaIdxKey::getOptionalDefSchemaIdReference() const {
		return( optionalDefSchemaId.getReference() );
	}

	const bool CFBamRelationByDefSchemaIdxKey::isOptionalDefSchemaIdNull() const {
		return( optionalDefSchemaId.isNull() );
	}

	void CFBamRelationByDefSchemaIdxKey::setOptionalDefSchemaIdNull() {
		optionalDefSchemaId.setNull();
	}

	void CFBamRelationByDefSchemaIdxKey::setOptionalDefSchemaIdValue( const int64_t value ) {
	...
	size_t CFBamRelationByDefSchemaIdxKey::hashCode() const {
		size_t hashCode = 0;
	...
	std::string CFBamRelationByDefSchemaIdxKey::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamRelationByDefSchemaIdxKey" );
	...
	bool CFBamRelationByDefSchemaIdxKey::operator <( const CFBamRelationByDefSchemaIdxKey& rhs ) {
		if( ! isOptionalDefSchemaTenantIdNull() ) {
	...
	bool CFBamRelationByDefSchemaIdxKey::operator <( const CFBamRelationHBuff& rhs ) {
		if( ! isOptionalDefSchemaTenantIdNull() ) {
			if( rhs.isOptionalDefSchemaTenantIdNull() ) {
				return( false );
			}
	...
	bool CFBamRelationByDefSchemaIdxKey::operator <( const CFBamRelationBuff& rhs ) {
		if( ! isOptionalDefSchemaTenantIdNull() ) {
			if( rhs.isOptionalDefSchemaTenantIdNull() ) {
				return( false );
			}
	...
	CFBamRelationByDefSchemaIdxKey CFBamRelationByDefSchemaIdxKey::operator =( cfbam::CFBamRelationByDefSchemaIdxKey& src ) {
		if( src.isOptionalDefSchemaTenantIdNull() ) {
			setOptionalDefSchemaTenantIdNull();
		}
		else {
	...
	CFBamRelationByDefSchemaIdxKey CFBamRelationByDefSchemaIdxKey::operator =( cfbam::CFBamRelationBuff& src ) {
		if( src.isOptionalDefSchemaTenantIdNull() ) {
			setOptionalDefSchemaTenantIdNull();
		}
		else {
	...
	CFBamRelationByDefSchemaIdxKey CFBamRelationByDefSchemaIdxKey::operator =( cfbam::CFBamRelationHBuff& src ) {
		if( src.isOptionalDefSchemaTenantIdNull() ) {
			setOptionalDefSchemaTenantIdNull();
		}
		else {
