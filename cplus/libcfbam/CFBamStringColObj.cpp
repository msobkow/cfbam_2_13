// Description: C++18 base object instance implementation for CFBam StringCol.
...
namespace cfbam {
	...
	const std::string CFBamStringColObj::CLASS_NAME( "CFBamStringColObj" );
	const classcode_t CFBamStringColObj::CLASS_CODE = 0xa862L;

	const int64_t CFBamStringColObj::getRequiredTableId() {
		return( getStringColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamStringColObj::getRequiredTableIdReference() {
		return( getStringColBuff()->getRequiredTableIdReference() );
	}


	cfbam::ICFBamTableObj* CFBamStringColObj::getRequiredContainerTable( bool forceRead ) {
	...
	CFBamStringColObj::CFBamStringColObj()
	: ICFBamStringColObj(),
	  CFBamStringDefObj()
	{
	}

	CFBamStringColObj::CFBamStringColObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamStringColObj(),
	...
	cfbam::CFBamValueBuff* CFBamStringColObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamStringColBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableStringCol()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamStringColObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamStringColObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamStringColObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamStringColObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamStringColObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamStringColObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamStringColObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamStringColObj::getObjName() {
	...
	const std::string CFBamStringColObj::getGenDefName() {
		return( cfbam::CFBamStringColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamStringColObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamStringColObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamStringColObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamStringColObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamStringColObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamStringColObj::getObjQualifiedName() {
	...
	std::string CFBamStringColObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamStringColObj::realize() {
		cfbam::ICFBamStringColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getStringColTableObj()->realizeStringCol(
			(cfbam::ICFBamStringColObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamStringColObj::read( bool forceRead ) {
		cfbam::ICFBamStringColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getStringColTableObj()->readStringColByIdIdx( getStringColBuff()->getRequiredTenantId(),
		getStringColBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamStringColObj::moveUp() {
		cfbam::ICFBamStringColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getStringColTableObj()->moveUpStringCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamStringColObj::moveDown() {
		cfbam::ICFBamStringColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getStringColTableObj()->moveDownStringCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamStringColObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamStringColObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getStringColTableObj()->lockStringCol( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getStringColTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamStringColEditObj* CFBamStringColObj::getStringColEdit() {
		return( dynamic_cast<cfbam::ICFBamStringColEditObj*>( edit ) );
	}
