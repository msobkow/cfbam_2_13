// Description: C++18 base object instance implementation for CFBam TimestampCol.
...
namespace cfbam {
	...
	const std::string CFBamTimestampColObj::CLASS_NAME( "CFBamTimestampColObj" );
	const classcode_t CFBamTimestampColObj::CLASS_CODE = 0xa868L;

	const int64_t CFBamTimestampColObj::getRequiredTableId() {
		return( getTimestampColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamTimestampColObj::getRequiredTableIdReference() {
		return( getTimestampColBuff()->getRequiredTableIdReference() );
	}


	cfbam::ICFBamTableObj* CFBamTimestampColObj::getRequiredContainerTable( bool forceRead ) {
	...
	CFBamTimestampColObj::CFBamTimestampColObj()
	: ICFBamTimestampColObj(),
	  CFBamTimestampDefObj()
	{
	}

	CFBamTimestampColObj::CFBamTimestampColObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamTimestampColObj(),
	...
	cfbam::CFBamValueBuff* CFBamTimestampColObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamTimestampColBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableTimestampCol()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamTimestampColObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamTimestampColObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTimestampColObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTimestampColObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamTimestampColObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTimestampColObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamTimestampColObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamTimestampColObj::getObjName() {
	...
	const std::string CFBamTimestampColObj::getGenDefName() {
		return( cfbam::CFBamTimestampColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTimestampColObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTimestampColObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTimestampColObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTimestampColObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTimestampColObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTimestampColObj::getObjQualifiedName() {
	...
	std::string CFBamTimestampColObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTimestampColObj::realize() {
		cfbam::ICFBamTimestampColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimestampColTableObj()->realizeTimestampCol(
			(cfbam::ICFBamTimestampColObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTimestampColObj::read( bool forceRead ) {
		cfbam::ICFBamTimestampColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimestampColTableObj()->readTimestampColByIdIdx( getTimestampColBuff()->getRequiredTenantId(),
		getTimestampColBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTimestampColObj::moveUp() {
		cfbam::ICFBamTimestampColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimestampColTableObj()->moveUpTimestampCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTimestampColObj::moveDown() {
		cfbam::ICFBamTimestampColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimestampColTableObj()->moveDownTimestampCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamTimestampColObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamTimestampColObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimestampColTableObj()->lockTimestampCol( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimestampColTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamTimestampColEditObj* CFBamTimestampColObj::getTimestampColEdit() {
		return( dynamic_cast<cfbam::ICFBamTimestampColEditObj*>( edit ) );
	}
