// Description: C++18 implementation for a EnumDef buffer object.
...
namespace cfbam {
	...
	const std::string CFBamEnumDefBuff::GENDEFNAME( "EnumDef" );
	const classcode_t CFBamEnumDefBuff::CLASS_CODE = 0xa856L;
	const std::string CFBamEnumDefBuff::CLASS_NAME( "CFBamEnumDefBuff" );
	const int64_t CFBamEnumDefBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamEnumDefBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamEnumDefBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamEnumDefBuff::ID_MIN_VALUE = 0LL;

	CFBamEnumDefBuff::CFBamEnumDefBuff()
	: CFBamInt16DefBuff()
	{
	}

	CFBamEnumDefBuff::CFBamEnumDefBuff( const CFBamEnumDefBuff& src )
	: CFBamInt16DefBuff()
	{
	...
	cflib::ICFLibCloneableObj* CFBamEnumDefBuff::clone() {
		CFBamEnumDefBuff* copy = new CFBamEnumDefBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamEnumDefBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamEnumDefBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamEnumDefBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	size_t CFBamEnumDefBuff::hashCode() const {
		size_t hashCode = CFBamInt16DefBuff::hashCode();
		return( hashCode );
	}

	CFBamEnumDefBuff CFBamEnumDefBuff::operator =( cfbam::CFBamEnumDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamEnumDefBuff CFBamEnumDefBuff::operator =( cfbam::CFBamEnumDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamEnumDefBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamEnumDefBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamEnumDefBuff::operator <( const CFBamEnumDefHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamEnumDefBuff::operator <( const CFBamEnumDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamEnumDefBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamEnumDefBuff" );
