// Description: C++18 implementation of a TimeCol history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTimeColHBuff::CLASS_NAME( "CFBamTimeColHBuff" );
	CFBamTimeColHBuff::CFBamTimeColHBuff()
	: cfbam::CFBamTimeDefHBuff() {
		requiredTableId = cfbam::CFBamTimeColBuff::TABLEID_INIT_VALUE;
	}

	CFBamTimeColHBuff::CFBamTimeColHBuff( const CFBamTimeColHBuff& src )
	: cfbam::CFBamTimeDefHBuff() {
		requiredTableId = cfbam::CFBamTimeColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTimeColHBuff::clone() {
		CFBamTimeColHBuff* copy = new CFBamTimeColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamTimeColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamTimeColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamTimeColHBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamTimeColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamTimeColHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamTimeColHBuff CFBamTimeColHBuff::operator =( cfbam::CFBamTimeColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamTimeColHBuff CFBamTimeColHBuff::operator =( cfbam::CFBamTimeColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTimeColHBuff::operator <( const CFBamTimeColByTableIdxKey& rhs ) {
	...
	bool CFBamTimeColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTimeColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamTimeColHBuff::operator <( const CFBamTimeColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamTimeColHBuff::operator <( const CFBamTimeColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTimeColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTimeColHBuff" );
