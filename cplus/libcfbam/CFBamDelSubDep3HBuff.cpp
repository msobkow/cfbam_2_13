// Description: C++18 implementation of a DelSubDep3 history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamDelSubDep3HBuff::CLASS_NAME( "CFBamDelSubDep3HBuff" );
	CFBamDelSubDep3HBuff::CFBamDelSubDep3HBuff()
	...
	CFBamDelSubDep3HBuff::CFBamDelSubDep3HBuff( const CFBamDelSubDep3HBuff& src )
	: cfbam::CFBamDelDepHBuff() {
		requiredDelSubDep2TenantId = cfbam::CFBamDelSubDep3Buff::DELSUBDEP2TENANTID_INIT_VALUE;
		requiredDelSubDep2Id = cfbam::CFBamDelSubDep3Buff::DELSUBDEP2ID_INIT_VALUE;
		requiredName = new std::string( cfbam::CFBamDelSubDep3Buff::NAME_INIT_VALUE );
	...
	cflib::ICFLibCloneableObj* CFBamDelSubDep3HBuff::clone() {
		CFBamDelSubDep3HBuff* copy = new CFBamDelSubDep3HBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamDelSubDep3HBuff::getRequiredDelSubDep2TenantId() const {
		return( requiredDelSubDep2TenantId );
	}

	const int64_t* CFBamDelSubDep3HBuff::getRequiredDelSubDep2TenantIdReference() const {
		return( &requiredDelSubDep2TenantId );
	}

	void CFBamDelSubDep3HBuff::setRequiredDelSubDep2TenantId( const int64_t value ) {
	...
	const int64_t CFBamDelSubDep3HBuff::getRequiredDelSubDep2Id() const {
		return( requiredDelSubDep2Id );
	}

	const int64_t* CFBamDelSubDep3HBuff::getRequiredDelSubDep2IdReference() const {
		return( &requiredDelSubDep2Id );
	}

	void CFBamDelSubDep3HBuff::setRequiredDelSubDep2Id( const int64_t value ) {
	...
	const std::string& CFBamDelSubDep3HBuff::getRequiredName() const {
		return( *requiredName );
	}

	const std::string* CFBamDelSubDep3HBuff::getRequiredNameReference() const {
		return( requiredName );
	}

	void CFBamDelSubDep3HBuff::setRequiredName( const std::string& value ) {
	...
	size_t CFBamDelSubDep3HBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamDelSubDep3HBuff::hashCode();
	...
	CFBamDelSubDep3HBuff CFBamDelSubDep3HBuff::operator =( cfbam::CFBamDelSubDep3Buff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		if( src.isOptionalDefSchemaTenantIdNull() ) {
	...
	CFBamDelSubDep3HBuff CFBamDelSubDep3HBuff::operator =( cfbam::CFBamDelSubDep3HBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		if( src.isOptionalDefSchemaTenantIdNull() ) {
	...
	bool CFBamDelSubDep3HBuff::operator <( const CFBamDelSubDep3ByDelSubDep2IdxKey& rhs ) {
	...
	bool CFBamDelSubDep3HBuff::operator <( const CFBamDelSubDep3ByUNameIdxKey& rhs ) {
		if( getRequiredDelSubDep2TenantId() > rhs.getRequiredDelSubDep2TenantId() ) {
			return( false );
		}
		else if( getRequiredDelSubDep2TenantId() < rhs.getRequiredDelSubDep2TenantId() ) {
	...
	bool CFBamDelSubDep3HBuff::operator <( const CFBamScopePKey& rhs ) {
	...
	bool CFBamDelSubDep3HBuff::operator <( const CFBamScopeHPKey& rhs ) {
	...
	bool CFBamDelSubDep3HBuff::operator <( const CFBamDelSubDep3HBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamDelSubDep3HBuff::operator <( const CFBamDelSubDep3Buff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamDelSubDep3HBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamDelSubDep3HBuff" );
