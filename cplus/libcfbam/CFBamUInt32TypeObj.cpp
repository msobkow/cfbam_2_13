// Description: C++18 base object instance implementation for CFBam UInt32Type.
...
namespace cfbam {
	...
	const std::string CFBamUInt32TypeObj::CLASS_NAME( "CFBamUInt32TypeObj" );
	const classcode_t CFBamUInt32TypeObj::CLASS_CODE = 0xa84dL;

	const int64_t CFBamUInt32TypeObj::getRequiredSchemaDefId() {
		return( getUInt32TypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamUInt32TypeObj::getRequiredSchemaDefIdReference() {
		return( getUInt32TypeBuff()->getRequiredSchemaDefIdReference() );
	}


	cfbam::ICFBamSchemaDefObj* CFBamUInt32TypeObj::getRequiredContainerSchemaDef( bool forceRead ) {
	...
	CFBamUInt32TypeObj::CFBamUInt32TypeObj()
	: ICFBamUInt32TypeObj(),
	  CFBamUInt32DefObj()
	{
	}

	CFBamUInt32TypeObj::CFBamUInt32TypeObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamUInt32TypeObj(),
	  CFBamUInt32DefObj( argSchema )
	{
	}
	...
	cfbam::CFBamValueBuff* CFBamUInt32TypeObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamUInt32TypeBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableUInt32Type()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamUInt32TypeObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamUInt32TypeObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUInt32TypeObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamUInt32TypeObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamUInt32TypeBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamUInt32DefObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamUInt32TypeObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt32TypeObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamUInt32TypeObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamUInt32TypeObj::getObjName() {
	...
	const std::string CFBamUInt32TypeObj::getGenDefName() {
		return( cfbam::CFBamUInt32TypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamUInt32TypeObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamUInt32TypeObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamUInt32TypeObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamUInt32TypeObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamUInt32TypeObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamUInt32TypeObj::getObjQualifiedName() {
	...
	std::string CFBamUInt32TypeObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamUInt32TypeObj::realize() {
		cfbam::ICFBamUInt32TypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt32TypeTableObj()->realizeUInt32Type(
			(cfbam::ICFBamUInt32TypeObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUInt32TypeObj::read( bool forceRead ) {
		cfbam::ICFBamUInt32TypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt32TypeTableObj()->readUInt32TypeByIdIdx( getUInt32TypeBuff()->getRequiredTenantId(),
		getUInt32TypeBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUInt32TypeObj::moveUp() {
		cfbam::ICFBamUInt32TypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt32TypeTableObj()->moveUpUInt32Type( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUInt32TypeObj::moveDown() {
		cfbam::ICFBamUInt32TypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt32TypeTableObj()->moveDownUInt32Type( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamUInt32TypeObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamUInt32TypeObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt32TypeTableObj()->lockUInt32Type( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt32TypeTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamUInt32TypeEditObj* CFBamUInt32TypeObj::getUInt32TypeEdit() {
		return( dynamic_cast<cfbam::ICFBamUInt32TypeEditObj*>( edit ) );
	}
