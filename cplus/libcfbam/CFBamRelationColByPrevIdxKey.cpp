// Description: C++18 implementation for a RelationCol by PrevIdx index key object.
...
namespace cfbam {
	const std::string CFBamRelationColByPrevIdxKey::CLASS_NAME( "CFBamRelationColByPrevIdxKey" );
	const std::string CFBamRelationColByPrevIdxKey::S_VALUE( "value" );
	const std::string CFBamRelationColByPrevIdxKey::S_VALUE_LENGTH( "value.length()" );


	CFBamRelationColByPrevIdxKey::CFBamRelationColByPrevIdxKey() {
		optionalPrevTenantId.setNull();
		optionalPrevId.setNull();
	}

	CFBamRelationColByPrevIdxKey::CFBamRelationColByPrevIdxKey( const CFBamRelationColByPrevIdxKey& src ) {
		optionalPrevTenantId.setNull();
		optionalPrevId.setNull();
	...
	const int64_t CFBamRelationColByPrevIdxKey::getOptionalPrevTenantIdValue() const {
		return( optionalPrevTenantId.getValue() );
	}

	const int64_t* CFBamRelationColByPrevIdxKey::getOptionalPrevTenantIdReference() const {
		return( optionalPrevTenantId.getReference() );
	}

	const bool CFBamRelationColByPrevIdxKey::isOptionalPrevTenantIdNull() const {
		return( optionalPrevTenantId.isNull() );
	}

	void CFBamRelationColByPrevIdxKey::setOptionalPrevTenantIdNull() {
		optionalPrevTenantId.setNull();
	}

	void CFBamRelationColByPrevIdxKey::setOptionalPrevTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamRelationColByPrevIdxKey::getOptionalPrevIdValue() const {
		return( optionalPrevId.getValue() );
	}

	const int64_t* CFBamRelationColByPrevIdxKey::getOptionalPrevIdReference() const {
		return( optionalPrevId.getReference() );
	}

	const bool CFBamRelationColByPrevIdxKey::isOptionalPrevIdNull() const {
		return( optionalPrevId.isNull() );
	}

	void CFBamRelationColByPrevIdxKey::setOptionalPrevIdNull() {
		optionalPrevId.setNull();
	}

	void CFBamRelationColByPrevIdxKey::setOptionalPrevIdValue( const int64_t value ) {
	...
	size_t CFBamRelationColByPrevIdxKey::hashCode() const {
		size_t hashCode = 0;
	...
	std::string CFBamRelationColByPrevIdxKey::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamRelationColByPrevIdxKey" );
	...
	bool CFBamRelationColByPrevIdxKey::operator <( const CFBamRelationColByPrevIdxKey& rhs ) {
		if( ! isOptionalPrevTenantIdNull() ) {
	...
	bool CFBamRelationColByPrevIdxKey::operator <( const CFBamRelationColHBuff& rhs ) {
		if( ! isOptionalPrevTenantIdNull() ) {
			if( rhs.isOptionalPrevTenantIdNull() ) {
				return( false );
			}
	...
	bool CFBamRelationColByPrevIdxKey::operator <( const CFBamRelationColBuff& rhs ) {
		if( ! isOptionalPrevTenantIdNull() ) {
			if( rhs.isOptionalPrevTenantIdNull() ) {
				return( false );
			}
	...
	CFBamRelationColByPrevIdxKey CFBamRelationColByPrevIdxKey::operator =( cfbam::CFBamRelationColByPrevIdxKey& src ) {
		if( src.isOptionalPrevTenantIdNull() ) {
			setOptionalPrevTenantIdNull();
		}
		else {
	...
	CFBamRelationColByPrevIdxKey CFBamRelationColByPrevIdxKey::operator =( cfbam::CFBamRelationColBuff& src ) {
		if( src.isOptionalPrevTenantIdNull() ) {
			setOptionalPrevTenantIdNull();
		}
		else {
	...
	CFBamRelationColByPrevIdxKey CFBamRelationColByPrevIdxKey::operator =( cfbam::CFBamRelationColHBuff& src ) {
		if( src.isOptionalPrevTenantIdNull() ) {
			setOptionalPrevTenantIdNull();
		}
		else {
