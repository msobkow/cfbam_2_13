// Description: C++18 implementation for a ClearTopDep by NextIdx index key object.
...
namespace cfbam {
	const std::string CFBamClearTopDepByNextIdxKey::CLASS_NAME( "CFBamClearTopDepByNextIdxKey" );
	const std::string CFBamClearTopDepByNextIdxKey::S_VALUE( "value" );
	const std::string CFBamClearTopDepByNextIdxKey::S_VALUE_LENGTH( "value.length()" );


	CFBamClearTopDepByNextIdxKey::CFBamClearTopDepByNextIdxKey() {
		optionalNextTenantId.setNull();
		optionalNextId.setNull();
	}

	CFBamClearTopDepByNextIdxKey::CFBamClearTopDepByNextIdxKey( const CFBamClearTopDepByNextIdxKey& src ) {
		optionalNextTenantId.setNull();
		optionalNextId.setNull();
	...
	const int64_t CFBamClearTopDepByNextIdxKey::getOptionalNextTenantIdValue() const {
		return( optionalNextTenantId.getValue() );
	}

	const int64_t* CFBamClearTopDepByNextIdxKey::getOptionalNextTenantIdReference() const {
		return( optionalNextTenantId.getReference() );
	}

	const bool CFBamClearTopDepByNextIdxKey::isOptionalNextTenantIdNull() const {
		return( optionalNextTenantId.isNull() );
	}

	void CFBamClearTopDepByNextIdxKey::setOptionalNextTenantIdNull() {
		optionalNextTenantId.setNull();
	}

	void CFBamClearTopDepByNextIdxKey::setOptionalNextTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamClearTopDepByNextIdxKey::getOptionalNextIdValue() const {
		return( optionalNextId.getValue() );
	}

	const int64_t* CFBamClearTopDepByNextIdxKey::getOptionalNextIdReference() const {
		return( optionalNextId.getReference() );
	}

	const bool CFBamClearTopDepByNextIdxKey::isOptionalNextIdNull() const {
		return( optionalNextId.isNull() );
	}

	void CFBamClearTopDepByNextIdxKey::setOptionalNextIdNull() {
		optionalNextId.setNull();
	}

	void CFBamClearTopDepByNextIdxKey::setOptionalNextIdValue( const int64_t value ) {
	...
	size_t CFBamClearTopDepByNextIdxKey::hashCode() const {
		size_t hashCode = 0;
	...
	std::string CFBamClearTopDepByNextIdxKey::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamClearTopDepByNextIdxKey" );
	...
	bool CFBamClearTopDepByNextIdxKey::operator <( const CFBamClearTopDepByNextIdxKey& rhs ) {
		if( ! isOptionalNextTenantIdNull() ) {
	...
	bool CFBamClearTopDepByNextIdxKey::operator <( const CFBamClearTopDepHBuff& rhs ) {
		if( ! isOptionalNextTenantIdNull() ) {
			if( rhs.isOptionalNextTenantIdNull() ) {
				return( false );
			}
	...
	bool CFBamClearTopDepByNextIdxKey::operator <( const CFBamClearTopDepBuff& rhs ) {
		if( ! isOptionalNextTenantIdNull() ) {
			if( rhs.isOptionalNextTenantIdNull() ) {
				return( false );
			}
	...
	CFBamClearTopDepByNextIdxKey CFBamClearTopDepByNextIdxKey::operator =( cfbam::CFBamClearTopDepByNextIdxKey& src ) {
		if( src.isOptionalNextTenantIdNull() ) {
			setOptionalNextTenantIdNull();
		}
		else {
	...
	CFBamClearTopDepByNextIdxKey CFBamClearTopDepByNextIdxKey::operator =( cfbam::CFBamClearTopDepBuff& src ) {
		if( src.isOptionalNextTenantIdNull() ) {
			setOptionalNextTenantIdNull();
		}
		else {
	...
	CFBamClearTopDepByNextIdxKey CFBamClearTopDepByNextIdxKey::operator =( cfbam::CFBamClearTopDepHBuff& src ) {
		if( src.isOptionalNextTenantIdNull() ) {
			setOptionalNextTenantIdNull();
		}
		else {
