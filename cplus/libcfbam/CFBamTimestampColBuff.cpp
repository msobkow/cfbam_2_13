// Description: C++18 implementation for a TimestampCol buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTimestampColBuff::GENDEFNAME( "TimestampCol" );
	const classcode_t CFBamTimestampColBuff::CLASS_CODE = 0xa868L;
	const std::string CFBamTimestampColBuff::CLASS_NAME( "CFBamTimestampColBuff" );
		const std::string CFBamTimestampColBuff::COLNAME_TABLEID( "TableId" );
	const int64_t CFBamTimestampColBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamTimestampColBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamTimestampColBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamTimestampColBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamTimestampColBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamTimestampColBuff::TABLEID_MIN_VALUE = 0LL;

	CFBamTimestampColBuff::CFBamTimestampColBuff()
	: CFBamTimestampDefBuff()
	{
		requiredTableId = cfbam::CFBamTimestampColBuff::TABLEID_INIT_VALUE;
	}

	CFBamTimestampColBuff::CFBamTimestampColBuff( const CFBamTimestampColBuff& src )
	: CFBamTimestampDefBuff()
	{
		requiredTableId = cfbam::CFBamTimestampColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTimestampColBuff::clone() {
		CFBamTimestampColBuff* copy = new CFBamTimestampColBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTimestampColBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTimestampColBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTimestampColBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFBamTimestampColBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamTimestampColBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamTimestampColBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamTimestampColBuff::hashCode() const {
		size_t hashCode = CFBamTimestampDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamTimestampColBuff CFBamTimestampColBuff::operator =( cfbam::CFBamTimestampColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamTimestampColBuff CFBamTimestampColBuff::operator =( cfbam::CFBamTimestampColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTimestampColBuff::operator <( const CFBamTimestampColByTableIdxKey& rhs ) {
	...
	bool CFBamTimestampColBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTimestampColBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTimestampColBuff::operator <( const CFBamTimestampColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTimestampColBuff::operator <( const CFBamTimestampColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTimestampColBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTimestampColBuff" );
