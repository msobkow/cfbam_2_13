// Description: C++18 implementation for a Id64Gen buffer object.
...
namespace cfbam {
	...
	const std::string CFBamId64GenBuff::GENDEFNAME( "Id64Gen" );
	const classcode_t CFBamId64GenBuff::CLASS_CODE = 0xa85bL;
	const std::string CFBamId64GenBuff::CLASS_NAME( "CFBamId64GenBuff" );
		const std::string CFBamId64GenBuff::COLNAME_DISPENSERTENANTID( "DispenserTenantId" );
		const std::string CFBamId64GenBuff::COLNAME_DISPENSERID( "DispenserId" );
		const std::string CFBamId64GenBuff::COLNAME_SLICE( "Slice" );
		const std::string CFBamId64GenBuff::COLNAME_BLOCKSIZE( "BlockSize" );
	const int64_t CFBamId64GenBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamId64GenBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamId64GenBuff::DISPENSERTENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamId64GenBuff::DISPENSERID_INIT_VALUE = 0LL;
	const int16_t CFBamId64GenBuff::SLICE_INIT_VALUE = (int16_t)0;
	const int64_t CFBamId64GenBuff::BLOCKSIZE_INIT_VALUE = 1LL;
	const int64_t CFBamId64GenBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamId64GenBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamId64GenBuff::DISPENSERTENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamId64GenBuff::DISPENSERID_MIN_VALUE = 0LL;
	const int16_t CFBamId64GenBuff::SLICE_MIN_VALUE = (int16_t)0;
	const int64_t CFBamId64GenBuff::BLOCKSIZE_MIN_VALUE = 1LL;
	const int16_t CFBamId64GenBuff::SLICE_MAX_VALUE = (int16_t)32767;
	const int64_t CFBamId64GenBuff::BLOCKSIZE_MAX_VALUE = 9223372036854775807LL;

	CFBamId64GenBuff::CFBamId64GenBuff()
	: CFBamInt64TypeBuff()
	{
		optionalDispenserTenantId.setNull();
		optionalDispenserId.setNull();
		requiredSlice = cfbam::CFBamId64GenBuff::SLICE_INIT_VALUE;
		requiredBlockSize = cfbam::CFBamId64GenBuff::BLOCKSIZE_INIT_VALUE;
	}

	CFBamId64GenBuff::CFBamId64GenBuff( const CFBamId64GenBuff& src )
	: CFBamInt64TypeBuff()
	{
		optionalDispenserTenantId.setNull();
		optionalDispenserId.setNull();
	...
	cflib::ICFLibCloneableObj* CFBamId64GenBuff::clone() {
		CFBamId64GenBuff* copy = new CFBamId64GenBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamId64GenBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamId64GenBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamId64GenBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamInt64TypeBuff::implementsClassCode( argClassCode ) );
		}
	}

	const bool CFBamId64GenBuff::isOptionalDispenserTenantIdNull() const {
		return( optionalDispenserTenantId.isNull() );
	}

	const int64_t CFBamId64GenBuff::getOptionalDispenserTenantIdValue() const {
		return( optionalDispenserTenantId.getValue() );
	}

	const int64_t* CFBamId64GenBuff::getOptionalDispenserTenantIdReference() const {
		return( optionalDispenserTenantId.getReference() );
	}

	void CFBamId64GenBuff::setOptionalDispenserTenantIdNull() {
		optionalDispenserTenantId.setNull();
	}

	void CFBamId64GenBuff::setOptionalDispenserTenantIdValue( const int64_t value ) {
	...
	const bool CFBamId64GenBuff::isOptionalDispenserIdNull() const {
		return( optionalDispenserId.isNull() );
	}

	const int64_t CFBamId64GenBuff::getOptionalDispenserIdValue() const {
		return( optionalDispenserId.getValue() );
	}

	const int64_t* CFBamId64GenBuff::getOptionalDispenserIdReference() const {
		return( optionalDispenserId.getReference() );
	}

	void CFBamId64GenBuff::setOptionalDispenserIdNull() {
		optionalDispenserId.setNull();
	}

	void CFBamId64GenBuff::setOptionalDispenserIdValue( const int64_t value ) {
	...
	const int16_t CFBamId64GenBuff::getRequiredSlice() const {
		return( requiredSlice );
	}

	const int16_t* CFBamId64GenBuff::getRequiredSliceReference() const {
		return( &requiredSlice );
	}

	void CFBamId64GenBuff::setRequiredSlice( const int16_t value ) {
		static const std::string S_ProcName( "setRequiredSlice" );
		if( value < cfbam::CFBamId64GenBuff::SLICE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamId64GenBuff::SLICE_MIN_VALUE );
		}
		if( value > cfbam::CFBamId64GenBuff::SLICE_MAX_VALUE ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamId64GenBuff::SLICE_MAX_VALUE );
		}
		requiredSlice = value;
	}

	const int64_t CFBamId64GenBuff::getRequiredBlockSize() const {
		return( requiredBlockSize );
	}

	const int64_t* CFBamId64GenBuff::getRequiredBlockSizeReference() const {
		return( &requiredBlockSize );
	}

	void CFBamId64GenBuff::setRequiredBlockSize( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredBlockSize" );
		if( value < cfbam::CFBamId64GenBuff::BLOCKSIZE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamId64GenBuff::BLOCKSIZE_MIN_VALUE );
		}
		if( value > cfbam::CFBamId64GenBuff::BLOCKSIZE_MAX_VALUE ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamId64GenBuff::BLOCKSIZE_MAX_VALUE );
		}
		requiredBlockSize = value;
	}

	size_t CFBamId64GenBuff::hashCode() const {
		size_t hashCode = CFBamInt64TypeBuff::hashCode();
	...
	CFBamId64GenBuff CFBamId64GenBuff::operator =( cfbam::CFBamId64GenBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamId64GenBuff CFBamId64GenBuff::operator =( cfbam::CFBamId64GenHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamId64GenBuff::operator <( const CFBamId64GenByDispIdxKey& rhs ) {
		if( ! isOptionalDispenserTenantIdNull() ) {
	...
	bool CFBamId64GenBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamId64GenBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamId64GenBuff::operator <( const CFBamId64GenHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamId64GenBuff::operator <( const CFBamId64GenBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamId64GenBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamId64GenBuff" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_BlockSize, getRequiredBlockSize() ) );
