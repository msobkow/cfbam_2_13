// Description: C++18 implementation for a DelDep buffer object.
...
namespace cfbam {
	...
	const std::string CFBamDelDepBuff::GENDEFNAME( "DelDep" );
	const classcode_t CFBamDelDepBuff::CLASS_CODE = 0xa817L;
	const std::string CFBamDelDepBuff::CLASS_NAME( "CFBamDelDepBuff" );
		const std::string CFBamDelDepBuff::COLNAME_DEFSCHEMATENANTID( "DefSchemaTenantId" );
		const std::string CFBamDelDepBuff::COLNAME_DEFSCHEMAID( "DefSchemaId" );
		const std::string CFBamDelDepBuff::COLNAME_RELATIONTENANTID( "RelationTenantId" );
		const std::string CFBamDelDepBuff::COLNAME_RELATIONID( "RelationId" );
	const int64_t CFBamDelDepBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamDelDepBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamDelDepBuff::DEFSCHEMATENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamDelDepBuff::DEFSCHEMAID_INIT_VALUE = 0LL;
	const int64_t CFBamDelDepBuff::RELATIONTENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamDelDepBuff::RELATIONID_INIT_VALUE = 0LL;
	const int64_t CFBamDelDepBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamDelDepBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamDelDepBuff::DEFSCHEMATENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamDelDepBuff::DEFSCHEMAID_MIN_VALUE = 0LL;
	const int64_t CFBamDelDepBuff::RELATIONTENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamDelDepBuff::RELATIONID_MIN_VALUE = 0LL;

	CFBamDelDepBuff::CFBamDelDepBuff()
	: CFBamScopeBuff()
	{
	...
	CFBamDelDepBuff::CFBamDelDepBuff( const CFBamDelDepBuff& src )
	: CFBamScopeBuff()
	{
		optionalDefSchemaTenantId.setNull();
		optionalDefSchemaId.setNull();
	...
	cflib::ICFLibCloneableObj* CFBamDelDepBuff::clone() {
		CFBamDelDepBuff* copy = new CFBamDelDepBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamDelDepBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamDelDepBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamDelDepBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const bool CFBamDelDepBuff::isOptionalDefSchemaTenantIdNull() const {
		return( optionalDefSchemaTenantId.isNull() );
	}

	const int64_t CFBamDelDepBuff::getOptionalDefSchemaTenantIdValue() const {
		return( optionalDefSchemaTenantId.getValue() );
	}

	const int64_t* CFBamDelDepBuff::getOptionalDefSchemaTenantIdReference() const {
		return( optionalDefSchemaTenantId.getReference() );
	}

	void CFBamDelDepBuff::setOptionalDefSchemaTenantIdNull() {
		optionalDefSchemaTenantId.setNull();
	}

	void CFBamDelDepBuff::setOptionalDefSchemaTenantIdValue( const int64_t value ) {
	...
	const bool CFBamDelDepBuff::isOptionalDefSchemaIdNull() const {
		return( optionalDefSchemaId.isNull() );
	}

	const int64_t CFBamDelDepBuff::getOptionalDefSchemaIdValue() const {
		return( optionalDefSchemaId.getValue() );
	}

	const int64_t* CFBamDelDepBuff::getOptionalDefSchemaIdReference() const {
		return( optionalDefSchemaId.getReference() );
	}

	void CFBamDelDepBuff::setOptionalDefSchemaIdNull() {
		optionalDefSchemaId.setNull();
	}

	void CFBamDelDepBuff::setOptionalDefSchemaIdValue( const int64_t value ) {
	...
	const int64_t CFBamDelDepBuff::getRequiredRelationTenantId() const {
		return( requiredRelationTenantId );
	}

	const int64_t* CFBamDelDepBuff::getRequiredRelationTenantIdReference() const {
		return( &requiredRelationTenantId );
	}

	void CFBamDelDepBuff::setRequiredRelationTenantId( const int64_t value ) {
	...
	const int64_t CFBamDelDepBuff::getRequiredRelationId() const {
		return( requiredRelationId );
	}

	const int64_t* CFBamDelDepBuff::getRequiredRelationIdReference() const {
		return( &requiredRelationId );
	}

	void CFBamDelDepBuff::setRequiredRelationId( const int64_t value ) {
	...
	size_t CFBamDelDepBuff::hashCode() const {
	...
	CFBamDelDepBuff CFBamDelDepBuff::operator =( cfbam::CFBamDelDepBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamDelDepBuff CFBamDelDepBuff::operator =( cfbam::CFBamDelDepHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		if( src.isOptionalDefSchemaTenantIdNull() ) {
	...
	bool CFBamDelDepBuff::operator <( const CFBamDelDepByDefSchemaIdxKey& rhs ) {
		if( ! isOptionalDefSchemaTenantIdNull() ) {
	...
	bool CFBamDelDepBuff::operator <( const CFBamDelDepByDelDepIdxKey& rhs ) {
	...
	bool CFBamDelDepBuff::operator <( const CFBamScopePKey& rhs ) {
	...
	bool CFBamDelDepBuff::operator <( const CFBamScopeHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamDelDepBuff::operator <( const CFBamDelDepHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamDelDepBuff::operator <( const CFBamDelDepBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamDelDepBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamDelDepBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamDelDepBuff& lhs, const cfbam::CFBamDelDepByDefSchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamDelDepBuff& lhs, const cfbam::CFBamDelDepByDelDepIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamDelDepBuff& lhs, const cfbam::CFBamScopePKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamDelDepBuff& lhs, const cfbam::CFBamScopeHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamDelDepBuff& lhs, const cfbam::CFBamDelDepHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamDelDepBuff& lhs, const cfbam::CFBamDelDepBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
