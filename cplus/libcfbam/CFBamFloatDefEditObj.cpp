// Description: C++18 edit object instance implementation for CFBam FloatDef.
...
namespace cfbam {
	...
	const std::string CFBamFloatDefEditObj::CLASS_NAME( "CFBamFloatDefEditObj" );

	CFBamFloatDefEditObj::CFBamFloatDefEditObj( cfbam::ICFBamFloatDefObj* argOrig )
	: ICFBamFloatDefEditObj(),
	  CFBamAtomEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamFloatDefEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamFloatDefEditObj::~CFBamFloatDefEditObj() {
	}

	const std::string& CFBamFloatDefEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamFloatDefEditObj::getClassCode() const {
		return( cfbam::CFBamFloatDefBuff::CLASS_CODE );
	}

	bool CFBamFloatDefEditObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamFloatDefEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamFloatDefEditObj" );
	...
	const std::string CFBamFloatDefEditObj::getGenDefName() {
		return( cfbam::CFBamFloatDefBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamFloatDefEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamFloatDefEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamFloatDefEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamFloatDefEditObj::getObjQualifiedName() {
	...
	std::string CFBamFloatDefEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamFloatDefEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamFloatDefObj* retobj = getSchema()->getFloatDefTableObj()->realizeFloatDef( dynamic_cast<cfbam::ICFBamFloatDefObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamFloatDefEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamFloatDefEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamFloatDefEditObj::create() {
		cfbam::ICFBamFloatDefObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsFloatDef()->getSchema() )->getFloatDefTableObj()->createFloatDef( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamFloatDefEditObj::update() {
		getSchema()->getFloatDefTableObj()->updateFloatDef( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamFloatDefEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getFloatDefTableObj()->deleteFloatDef( this );
		return( NULL );
	}

	cfbam::ICFBamFloatDefTableObj* CFBamFloatDefEditObj::getFloatDefTable() {
		return( orig->getSchema()->getFloatDefTableObj() );
	}

	cfbam::ICFBamFloatDefEditObj* CFBamFloatDefEditObj::getFloatDefEdit() {
		return( (cfbam::ICFBamFloatDefEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamFloatDefEditObj::beginEdit() {
	...
	cfbam::ICFBamFloatDefObj* CFBamFloatDefEditObj::getOrigAsFloatDef() {
		return( dynamic_cast<cfbam::ICFBamFloatDefObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamFloatDefEditObj::getBuff() {
		return( buff );
	}

	void CFBamFloatDefEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamAtomEditObj::setBuff( value );
		}
	}

	bool CFBamFloatDefEditObj::isOptionalInitValueNull() {
		return( getFloatDefBuff()->isOptionalInitValueNull() );
	}

	const float CFBamFloatDefEditObj::getOptionalInitValueValue() {
		return( getFloatDefBuff()->getOptionalInitValueValue() );
	}

	const float* CFBamFloatDefEditObj::getOptionalInitValueReference() {
		return( getFloatDefBuff()->getOptionalInitValueReference() );
	}

	void CFBamFloatDefEditObj::setOptionalInitValueNull() {
		if( ! getFloatDefBuff()->isOptionalInitValueNull() ) {
			getFloatDefEditBuff()->setOptionalInitValueNull();
		}
	}

	void CFBamFloatDefEditObj::setOptionalInitValueValue( const float value ) {
		if( getFloatDefBuff()->isOptionalInitValueNull() ) {
			getFloatDefEditBuff()->setOptionalInitValueValue( value );
		}
		else if( getFloatDefBuff()->getOptionalInitValueValue() != value ) {
			getFloatDefEditBuff()->setOptionalInitValueValue( value );
		}
	}

	bool CFBamFloatDefEditObj::isOptionalMinValueNull() {
		return( getFloatDefBuff()->isOptionalMinValueNull() );
	}

	const float CFBamFloatDefEditObj::getOptionalMinValueValue() {
		return( getFloatDefBuff()->getOptionalMinValueValue() );
	}

	const float* CFBamFloatDefEditObj::getOptionalMinValueReference() {
		return( getFloatDefBuff()->getOptionalMinValueReference() );
	}

	void CFBamFloatDefEditObj::setOptionalMinValueNull() {
		if( ! getFloatDefBuff()->isOptionalMinValueNull() ) {
			getFloatDefEditBuff()->setOptionalMinValueNull();
		}
	}

	void CFBamFloatDefEditObj::setOptionalMinValueValue( const float value ) {
		if( getFloatDefBuff()->isOptionalMinValueNull() ) {
			getFloatDefEditBuff()->setOptionalMinValueValue( value );
		}
		else if( getFloatDefBuff()->getOptionalMinValueValue() != value ) {
			getFloatDefEditBuff()->setOptionalMinValueValue( value );
		}
	}

	bool CFBamFloatDefEditObj::isOptionalMaxValueNull() {
		return( getFloatDefBuff()->isOptionalMaxValueNull() );
	}

	const float CFBamFloatDefEditObj::getOptionalMaxValueValue() {
		return( getFloatDefBuff()->getOptionalMaxValueValue() );
	}

	const float* CFBamFloatDefEditObj::getOptionalMaxValueReference() {
		return( getFloatDefBuff()->getOptionalMaxValueReference() );
	}

	void CFBamFloatDefEditObj::setOptionalMaxValueNull() {
		if( ! getFloatDefBuff()->isOptionalMaxValueNull() ) {
			getFloatDefEditBuff()->setOptionalMaxValueNull();
		}
	}

	void CFBamFloatDefEditObj::setOptionalMaxValueValue( const float value ) {
		if( getFloatDefBuff()->isOptionalMaxValueNull() ) {
			getFloatDefEditBuff()->setOptionalMaxValueValue( value );
		}
		else if( getFloatDefBuff()->getOptionalMaxValueValue() != value ) {
			getFloatDefEditBuff()->setOptionalMaxValueValue( value );
		}
	}

	void CFBamFloatDefEditObj::copyBuffToOrig() {
		cfbam::CFBamFloatDefBuff* origBuff = getOrigAsFloatDef()->getFloatDefEditBuff();
		cfbam::CFBamFloatDefBuff* myBuff = getFloatDefBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamFloatDefEditObj::copyOrigToBuff() {
		cfbam::CFBamFloatDefBuff* origBuff = getOrigAsFloatDef()->getFloatDefBuff();
		cfbam::CFBamFloatDefBuff* myBuff = getFloatDefEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
