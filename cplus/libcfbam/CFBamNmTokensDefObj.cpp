// Description: C++18 base object instance implementation for CFBam NmTokensDef.
...
namespace cfbam {
	...
	const std::string CFBamNmTokensDefObj::CLASS_NAME( "CFBamNmTokensDefObj" );
	const classcode_t CFBamNmTokensDefObj::CLASS_CODE = 0xa82bL;

	const int32_t CFBamNmTokensDefObj::getRequiredMaxLen() {
		return( getNmTokensDefBuff()->getRequiredMaxLen() );
	}

	const int32_t* CFBamNmTokensDefObj::getRequiredMaxLenReference() {
		return( getNmTokensDefBuff()->getRequiredMaxLenReference() );
	}

	bool CFBamNmTokensDefObj::isOptionalInitValueNull() {
		return( getNmTokensDefBuff()->isOptionalInitValueNull() );
	}

	const std::string& CFBamNmTokensDefObj::getOptionalInitValueValue() {
		return( getNmTokensDefBuff()->getOptionalInitValueValue() );
	}

	const std::string* CFBamNmTokensDefObj::getOptionalInitValueReference() {
		return( getNmTokensDefBuff()->getOptionalInitValueReference() );
	}


	CFBamNmTokensDefObj::CFBamNmTokensDefObj()
	: ICFBamNmTokensDefObj(),
	  CFBamAtomObj()
	{
	}

	CFBamNmTokensDefObj::CFBamNmTokensDefObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamNmTokensDefObj(),
	...
	cfbam::CFBamValueBuff* CFBamNmTokensDefObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamNmTokensDefBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableNmTokensDef()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamNmTokensDefObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamNmTokensDefObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamNmTokensDefObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamNmTokensDefObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamNmTokensDefObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNmTokensDefObj" );
	...
	std::string CFBamNmTokensDefObj::getObjName() {
	...
	const std::string CFBamNmTokensDefObj::getGenDefName() {
		return( cfbam::CFBamNmTokensDefBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamNmTokensDefObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamNmTokensDefObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamNmTokensDefObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamNmTokensDefObj::getObjQualifiedName() {
	...
	std::string CFBamNmTokensDefObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamNmTokensDefObj::realize() {
		cfbam::ICFBamNmTokensDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokensDefTableObj()->realizeNmTokensDef(
			(cfbam::ICFBamNmTokensDefObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamNmTokensDefObj::read( bool forceRead ) {
		cfbam::ICFBamNmTokensDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokensDefTableObj()->readNmTokensDefByIdIdx( getNmTokensDefBuff()->getRequiredTenantId(),
		getNmTokensDefBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamNmTokensDefObj::moveUp() {
		cfbam::ICFBamNmTokensDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokensDefTableObj()->moveUpNmTokensDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamNmTokensDefObj::moveDown() {
		cfbam::ICFBamNmTokensDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokensDefTableObj()->moveDownNmTokensDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamNmTokensDefObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamNmTokensDefObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokensDefTableObj()->lockNmTokensDef( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokensDefTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamNmTokensDefEditObj* CFBamNmTokensDefObj::getNmTokensDefEdit() {
		return( dynamic_cast<cfbam::ICFBamNmTokensDefEditObj*>( edit ) );
	}
