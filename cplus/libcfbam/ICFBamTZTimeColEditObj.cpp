// Description: C++18 Instance Edit Object interface implementation for CFBam TZTimeCol.
...
namespace cfbam {
	...
	const std::string ICFBamTZTimeColEditObj::CLASS_NAME( "ICFBamTZTimeColEditObj" );

	ICFBamTZTimeColEditObj::ICFBamTZTimeColEditObj()
