// Description: C++18 Instance Edit Object interface implementation for CFBam NumberCol.
...
namespace cfbam {
	...
	const std::string ICFBamNumberColEditObj::CLASS_NAME( "ICFBamNumberColEditObj" );

	ICFBamNumberColEditObj::ICFBamNumberColEditObj()
