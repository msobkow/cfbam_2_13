// Description: C++18 implementation for a UuidType buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUuidTypeBuff::GENDEFNAME( "UuidType" );
	const classcode_t CFBamUuidTypeBuff::CLASS_CODE = 0xa851L;
	const std::string CFBamUuidTypeBuff::CLASS_NAME( "CFBamUuidTypeBuff" );
		const std::string CFBamUuidTypeBuff::COLNAME_SCHEMADEFID( "SchemaDefId" );
	const int64_t CFBamUuidTypeBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamUuidTypeBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamUuidTypeBuff::SCHEMADEFID_INIT_VALUE = 0LL;
	const int64_t CFBamUuidTypeBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamUuidTypeBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamUuidTypeBuff::SCHEMADEFID_MIN_VALUE = 0LL;

	CFBamUuidTypeBuff::CFBamUuidTypeBuff()
	: CFBamUuidDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamUuidTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamUuidTypeBuff::CFBamUuidTypeBuff( const CFBamUuidTypeBuff& src )
	: CFBamUuidDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamUuidTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamUuidTypeBuff::clone() {
		CFBamUuidTypeBuff* copy = new CFBamUuidTypeBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamUuidTypeBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUuidTypeBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamUuidTypeBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFBamUuidTypeBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamUuidTypeBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamUuidTypeBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamUuidTypeBuff::hashCode() const {
		size_t hashCode = CFBamUuidDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamUuidTypeBuff CFBamUuidTypeBuff::operator =( cfbam::CFBamUuidTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamUuidTypeBuff CFBamUuidTypeBuff::operator =( cfbam::CFBamUuidTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUuidTypeBuff::operator <( const CFBamUuidTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamUuidTypeBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUuidTypeBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUuidTypeBuff::operator <( const CFBamUuidTypeHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUuidTypeBuff::operator <( const CFBamUuidTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUuidTypeBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUuidTypeBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamUuidTypeBuff& lhs, const cfbam::CFBamUuidTypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamUuidTypeBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamUuidTypeBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamUuidTypeBuff& lhs, const cfbam::CFBamUuidTypeHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamUuidTypeBuff& lhs, const cfbam::CFBamUuidTypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
