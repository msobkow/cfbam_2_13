// Description: C++18 implementation of a Int16Def history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamInt16DefHBuff::CLASS_NAME( "CFBamInt16DefHBuff" );
	CFBamInt16DefHBuff::CFBamInt16DefHBuff()
	...
	CFBamInt16DefHBuff::CFBamInt16DefHBuff( const CFBamInt16DefHBuff& src )
	: cfbam::CFBamAtomHBuff() {
		optionalInitValue.setNull();
		optionalMinValue.setNull();
		optionalMaxValue.setNull();
	...
	cflib::ICFLibCloneableObj* CFBamInt16DefHBuff::clone() {
		CFBamInt16DefHBuff* copy = new CFBamInt16DefHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int16_t CFBamInt16DefHBuff::getOptionalInitValueValue() const {
		return( optionalInitValue.getValue() );
	}

	const int16_t* CFBamInt16DefHBuff::getOptionalInitValueReference() const {
		return( optionalInitValue.getReference() );
	}

	const bool CFBamInt16DefHBuff::isOptionalInitValueNull() const {
		return( optionalInitValue.isNull() );
	}

	void CFBamInt16DefHBuff::setOptionalInitValueNull() {
		optionalInitValue.setNull();
	}

	void CFBamInt16DefHBuff::setOptionalInitValueValue( const int16_t value ) {
	...
	const int16_t CFBamInt16DefHBuff::getOptionalMinValueValue() const {
		return( optionalMinValue.getValue() );
	}

	const int16_t* CFBamInt16DefHBuff::getOptionalMinValueReference() const {
		return( optionalMinValue.getReference() );
	}

	const bool CFBamInt16DefHBuff::isOptionalMinValueNull() const {
		return( optionalMinValue.isNull() );
	}

	void CFBamInt16DefHBuff::setOptionalMinValueNull() {
		optionalMinValue.setNull();
	}

	void CFBamInt16DefHBuff::setOptionalMinValueValue( const int16_t value ) {
	...
	const int16_t CFBamInt16DefHBuff::getOptionalMaxValueValue() const {
		return( optionalMaxValue.getValue() );
	}

	const int16_t* CFBamInt16DefHBuff::getOptionalMaxValueReference() const {
		return( optionalMaxValue.getReference() );
	}

	const bool CFBamInt16DefHBuff::isOptionalMaxValueNull() const {
		return( optionalMaxValue.isNull() );
	}

	void CFBamInt16DefHBuff::setOptionalMaxValueNull() {
		optionalMaxValue.setNull();
	}

	void CFBamInt16DefHBuff::setOptionalMaxValueValue( const int16_t value ) {
	...
	size_t CFBamInt16DefHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamInt16DefHBuff::hashCode();
	...
	CFBamInt16DefHBuff CFBamInt16DefHBuff::operator =( cfbam::CFBamInt16DefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamInt16DefHBuff CFBamInt16DefHBuff::operator =( cfbam::CFBamInt16DefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamInt16DefHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamInt16DefHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamInt16DefHBuff::operator <( const CFBamInt16DefHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamInt16DefHBuff::operator <( const CFBamInt16DefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamInt16DefHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt16DefHBuff" );
