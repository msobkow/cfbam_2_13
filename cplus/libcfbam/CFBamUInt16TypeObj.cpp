// Description: C++18 base object instance implementation for CFBam UInt16Type.
...
namespace cfbam {
	...
	const std::string CFBamUInt16TypeObj::CLASS_NAME( "CFBamUInt16TypeObj" );
	const classcode_t CFBamUInt16TypeObj::CLASS_CODE = 0xa84bL;

	const int64_t CFBamUInt16TypeObj::getRequiredSchemaDefId() {
		return( getUInt16TypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamUInt16TypeObj::getRequiredSchemaDefIdReference() {
		return( getUInt16TypeBuff()->getRequiredSchemaDefIdReference() );
	}


	cfbam::ICFBamSchemaDefObj* CFBamUInt16TypeObj::getRequiredContainerSchemaDef( bool forceRead ) {
	...
	CFBamUInt16TypeObj::CFBamUInt16TypeObj()
	: ICFBamUInt16TypeObj(),
	  CFBamUInt16DefObj()
	{
	}

	CFBamUInt16TypeObj::CFBamUInt16TypeObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamUInt16TypeObj(),
	...
	cfbam::CFBamValueBuff* CFBamUInt16TypeObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamUInt16TypeBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableUInt16Type()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamUInt16TypeObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamUInt16TypeObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUInt16TypeObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamUInt16TypeObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamUInt16TypeObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt16TypeObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamUInt16TypeObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamUInt16TypeObj::getObjName() {
	...
	const std::string CFBamUInt16TypeObj::getGenDefName() {
		return( cfbam::CFBamUInt16TypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamUInt16TypeObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamUInt16TypeObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamUInt16TypeObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamUInt16TypeObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamUInt16TypeObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamUInt16TypeObj::getObjQualifiedName() {
	...
	std::string CFBamUInt16TypeObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamUInt16TypeObj::realize() {
		cfbam::ICFBamUInt16TypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt16TypeTableObj()->realizeUInt16Type(
			(cfbam::ICFBamUInt16TypeObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUInt16TypeObj::read( bool forceRead ) {
		cfbam::ICFBamUInt16TypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt16TypeTableObj()->readUInt16TypeByIdIdx( getUInt16TypeBuff()->getRequiredTenantId(),
		getUInt16TypeBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUInt16TypeObj::moveUp() {
		cfbam::ICFBamUInt16TypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt16TypeTableObj()->moveUpUInt16Type( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUInt16TypeObj::moveDown() {
		cfbam::ICFBamUInt16TypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt16TypeTableObj()->moveDownUInt16Type( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamUInt16TypeObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamUInt16TypeObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt16TypeTableObj()->lockUInt16Type( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt16TypeTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamUInt16TypeEditObj* CFBamUInt16TypeObj::getUInt16TypeEdit() {
		return( dynamic_cast<cfbam::ICFBamUInt16TypeEditObj*>( edit ) );
	}
