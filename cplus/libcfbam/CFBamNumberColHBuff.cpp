// Description: C++18 implementation of a NumberCol history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamNumberColHBuff::CLASS_NAME( "CFBamNumberColHBuff" );
	CFBamNumberColHBuff::CFBamNumberColHBuff()
	: cfbam::CFBamNumberDefHBuff() {
		requiredTableId = cfbam::CFBamNumberColBuff::TABLEID_INIT_VALUE;
	}

	CFBamNumberColHBuff::CFBamNumberColHBuff( const CFBamNumberColHBuff& src )
	: cfbam::CFBamNumberDefHBuff() {
		requiredTableId = cfbam::CFBamNumberColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamNumberColHBuff::clone() {
		CFBamNumberColHBuff* copy = new CFBamNumberColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamNumberColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamNumberColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamNumberColHBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamNumberColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamNumberColHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamNumberColHBuff CFBamNumberColHBuff::operator =( cfbam::CFBamNumberColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamNumberColHBuff CFBamNumberColHBuff::operator =( cfbam::CFBamNumberColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamNumberColHBuff::operator <( const CFBamNumberColByTableIdxKey& rhs ) {
	...
	bool CFBamNumberColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNumberColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamNumberColHBuff::operator <( const CFBamNumberColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamNumberColHBuff::operator <( const CFBamNumberColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamNumberColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNumberColHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamNumberColHBuff& lhs, const cfbam::CFBamNumberColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamNumberColHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamNumberColHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamNumberColHBuff& lhs, const cfbam::CFBamNumberColHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamNumberColHBuff& lhs, const cfbam::CFBamNumberColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
