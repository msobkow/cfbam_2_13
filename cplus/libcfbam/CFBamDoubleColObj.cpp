// Description: C++18 base object instance implementation for CFBam DoubleCol.
...
namespace cfbam {
	...
	const std::string CFBamDoubleColObj::CLASS_NAME( "CFBamDoubleColObj" );
	const classcode_t CFBamDoubleColObj::CLASS_CODE = 0xa855L;

	const int64_t CFBamDoubleColObj::getRequiredTableId() {
		return( getDoubleColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamDoubleColObj::getRequiredTableIdReference() {
		return( getDoubleColBuff()->getRequiredTableIdReference() );
	}


	cfbam::ICFBamTableObj* CFBamDoubleColObj::getRequiredContainerTable( bool forceRead ) {
	...
	CFBamDoubleColObj::CFBamDoubleColObj()
	: ICFBamDoubleColObj(),
	  CFBamDoubleDefObj()
	{
	}

	CFBamDoubleColObj::CFBamDoubleColObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamDoubleColObj(),
	  CFBamDoubleDefObj( argSchema )
	{
	}
	...
	cfbam::CFBamValueBuff* CFBamDoubleColObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamDoubleColBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableDoubleCol()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamDoubleColObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamDoubleColObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamDoubleColObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamDoubleColObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamDoubleColBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamDoubleDefObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamDoubleColObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamDoubleColObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamDoubleColObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamDoubleColObj::getObjName() {
	...
	const std::string CFBamDoubleColObj::getGenDefName() {
		return( cfbam::CFBamDoubleColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamDoubleColObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamDoubleColObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamDoubleColObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamDoubleColObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamDoubleColObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamDoubleColObj::getObjQualifiedName() {
	...
	std::string CFBamDoubleColObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamDoubleColObj::realize() {
		cfbam::ICFBamDoubleColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDoubleColTableObj()->realizeDoubleCol(
			(cfbam::ICFBamDoubleColObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamDoubleColObj::read( bool forceRead ) {
		cfbam::ICFBamDoubleColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDoubleColTableObj()->readDoubleColByIdIdx( getDoubleColBuff()->getRequiredTenantId(),
		getDoubleColBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamDoubleColObj::moveUp() {
		cfbam::ICFBamDoubleColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDoubleColTableObj()->moveUpDoubleCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamDoubleColObj::moveDown() {
		cfbam::ICFBamDoubleColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDoubleColTableObj()->moveDownDoubleCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamDoubleColObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamDoubleColObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDoubleColTableObj()->lockDoubleCol( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDoubleColTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamDoubleColEditObj* CFBamDoubleColObj::getDoubleColEdit() {
		return( dynamic_cast<cfbam::ICFBamDoubleColEditObj*>( edit ) );
	}
