// Description: C++18 implementation of a TextDef history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTextDefHBuff::CLASS_NAME( "CFBamTextDefHBuff" );
	CFBamTextDefHBuff::CFBamTextDefHBuff()
	...
	CFBamTextDefHBuff::CFBamTextDefHBuff( const CFBamTextDefHBuff& src )
	: cfbam::CFBamAtomHBuff() {
		requiredMaxLen = cfbam::CFBamTextDefBuff::MAXLEN_INIT_VALUE;
		optionalInitValue = NULL;
		optionalXmlElementName = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamTextDefHBuff::clone() {
		CFBamTextDefHBuff* copy = new CFBamTextDefHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int32_t CFBamTextDefHBuff::getRequiredMaxLen() const {
		return( requiredMaxLen );
	}

	const int32_t* CFBamTextDefHBuff::getRequiredMaxLenReference() const {
		return( &requiredMaxLen );
	}

	void CFBamTextDefHBuff::setRequiredMaxLen( const int32_t value ) {
	...
	const std::string& CFBamTextDefHBuff::getOptionalInitValueValue() const {
	...
	const std::string* CFBamTextDefHBuff::getOptionalInitValueReference() const {
		return( optionalInitValue );
	}

	const bool CFBamTextDefHBuff::isOptionalInitValueNull() const {
		return( optionalInitValue == NULL );
	}

	void CFBamTextDefHBuff::setOptionalInitValueNull() {
		if( optionalInitValue != NULL ) {
			delete optionalInitValue;
			optionalInitValue = NULL;
		}
	...
	void CFBamTextDefHBuff::setOptionalInitValueValue( const std::string& value ) {
	...
	const std::string& CFBamTextDefHBuff::getOptionalXmlElementNameValue() const {
	...
	const std::string* CFBamTextDefHBuff::getOptionalXmlElementNameReference() const {
		return( optionalXmlElementName );
	}

	const bool CFBamTextDefHBuff::isOptionalXmlElementNameNull() const {
		return( optionalXmlElementName == NULL );
	}

	void CFBamTextDefHBuff::setOptionalXmlElementNameNull() {
		if( optionalXmlElementName != NULL ) {
			delete optionalXmlElementName;
			optionalXmlElementName = NULL;
		}
	...
	void CFBamTextDefHBuff::setOptionalXmlElementNameValue( const std::string& value ) {
	...
	size_t CFBamTextDefHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamTextDefHBuff::hashCode();
	...
	CFBamTextDefHBuff CFBamTextDefHBuff::operator =( cfbam::CFBamTextDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamTextDefHBuff CFBamTextDefHBuff::operator =( cfbam::CFBamTextDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTextDefHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamTextDefHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamTextDefHBuff::operator <( const CFBamTextDefHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamTextDefHBuff::operator <( const CFBamTextDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTextDefHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTextDefHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamTextDefHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTextDefHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTextDefHBuff& lhs, const cfbam::CFBamTextDefHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamTextDefHBuff& lhs, const cfbam::CFBamTextDefBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
