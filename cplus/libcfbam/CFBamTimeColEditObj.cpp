// Description: C++18 edit object instance implementation for CFBam TimeCol.
...
namespace cfbam {
	...
	const std::string CFBamTimeColEditObj::CLASS_NAME( "CFBamTimeColEditObj" );

	CFBamTimeColEditObj::CFBamTimeColEditObj( cfbam::ICFBamTimeColObj* argOrig )
	: ICFBamTimeColEditObj(),
	  CFBamTimeDefEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamTimeColEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamTimeColEditObj::~CFBamTimeColEditObj() {
	}

	const std::string& CFBamTimeColEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTimeColEditObj::getClassCode() const {
		return( cfbam::CFBamTimeColBuff::CLASS_CODE );
	}

	bool CFBamTimeColEditObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamTimeColBuff::CLASS_CODE ) {
			return( true );
		}
		else {
	...
	std::string CFBamTimeColEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTimeColEditObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamTimeColEditObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	const std::string CFBamTimeColEditObj::getGenDefName() {
		return( cfbam::CFBamTimeColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTimeColEditObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTimeColEditObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTimeColEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTimeColEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTimeColEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTimeColEditObj::getObjQualifiedName() {
	...
	std::string CFBamTimeColEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTimeColEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamTimeColObj* retobj = getSchema()->getTimeColTableObj()->realizeTimeCol( dynamic_cast<cfbam::ICFBamTimeColObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamTimeColEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamTimeColEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamTimeColEditObj::create() {
		cfbam::ICFBamTimeColObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsTimeCol()->getSchema() )->getTimeColTableObj()->createTimeCol( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamTimeColEditObj::update() {
		getSchema()->getTimeColTableObj()->updateTimeCol( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamTimeColEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getTimeColTableObj()->deleteTimeCol( this );
		return( NULL );
	}

	cfbam::ICFBamTimeColTableObj* CFBamTimeColEditObj::getTimeColTable() {
		return( orig->getSchema()->getTimeColTableObj() );
	}

	cfbam::ICFBamTimeColEditObj* CFBamTimeColEditObj::getTimeColEdit() {
		return( (cfbam::ICFBamTimeColEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamTimeColEditObj::beginEdit() {
	...
	cfbam::ICFBamTimeColObj* CFBamTimeColEditObj::getOrigAsTimeCol() {
		return( dynamic_cast<cfbam::ICFBamTimeColObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamTimeColEditObj::getBuff() {
		return( buff );
	}

	void CFBamTimeColEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamTimeDefEditObj::setBuff( value );
		}
	}

	const int64_t CFBamTimeColEditObj::getRequiredTableId() {
		return( getTimeColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamTimeColEditObj::getRequiredTableIdReference() {
		return( getTimeColBuff()->getRequiredTableIdReference() );
	}

	void CFBamTimeColEditObj::setRequiredContainerScope( cfbam::ICFBamScopeObj* value ) {
		if( value == NULL ) {
	...
	cfbam::ICFBamTableObj* CFBamTimeColEditObj::getRequiredContainerTable( bool forceRead ) {
		cfbam::ICFBamTableObj* retobj = NULL;
		bool anyMissing = false;
		if( ! anyMissing ) {
			retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsTimeCol()->getSchema() )->getTableTableObj()->readTableByIdIdx( getPKey()->getRequiredTenantId(),
					getTimeColBuff()->getRequiredTableId() );
		}
		return( retobj );
	}

	void CFBamTimeColEditObj::setRequiredContainerTable( cfbam::ICFBamTableObj* value ) {
			
			if( value != NULL ) {
				getPKey()->setRequiredTenantId
( value->getRequiredTenantId() );
				getTimeColEditBuff()->setRequiredTenantId( value->getRequiredTenantId() );
				getTimeColEditBuff()->setRequiredTableId( value->getRequiredId() );
			}

			CFBamTimeDefEditObj::setRequiredContainerScope( value );		}

	void CFBamTimeColEditObj::copyBuffToOrig() {
		cfbam::CFBamTimeColBuff* origBuff = getOrigAsTimeCol()->getTimeColEditBuff();
		cfbam::CFBamTimeColBuff* myBuff = getTimeColBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamTimeColEditObj::copyOrigToBuff() {
		cfbam::CFBamTimeColBuff* origBuff = getOrigAsTimeCol()->getTimeColBuff();
		cfbam::CFBamTimeColBuff* myBuff = getTimeColEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
