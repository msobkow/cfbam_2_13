// Description: C++18 implementation for a Int16Def buffer object.
...
namespace cfbam {
	...
	const std::string CFBamInt16DefBuff::GENDEFNAME( "Int16Def" );
	const classcode_t CFBamInt16DefBuff::CLASS_CODE = 0xa823L;
	const std::string CFBamInt16DefBuff::CLASS_NAME( "CFBamInt16DefBuff" );
		const std::string CFBamInt16DefBuff::COLNAME_INITVALUE( "InitValue" );
		const std::string CFBamInt16DefBuff::COLNAME_MINVALUE( "MinValue" );
		const std::string CFBamInt16DefBuff::COLNAME_MAXVALUE( "MaxValue" );
	const int64_t CFBamInt16DefBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamInt16DefBuff::ID_INIT_VALUE = 0LL;
	const int16_t CFBamInt16DefBuff::INITVALUE_INIT_VALUE = (int16_t)0;
	const int16_t CFBamInt16DefBuff::MINVALUE_INIT_VALUE = (int16_t)0;
	const int16_t CFBamInt16DefBuff::MAXVALUE_INIT_VALUE = (int16_t)0;
	const int64_t CFBamInt16DefBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamInt16DefBuff::ID_MIN_VALUE = 0LL;
	const int16_t CFBamInt16DefBuff::INITVALUE_MIN_VALUE = (int16_t)-32768;
	const int16_t CFBamInt16DefBuff::MINVALUE_MIN_VALUE = (int16_t)-32768;
	const int16_t CFBamInt16DefBuff::MAXVALUE_MIN_VALUE = (int16_t)-32768;
	const int16_t CFBamInt16DefBuff::INITVALUE_MAX_VALUE = (int16_t)32767;
	const int16_t CFBamInt16DefBuff::MINVALUE_MAX_VALUE = (int16_t)32767;
	const int16_t CFBamInt16DefBuff::MAXVALUE_MAX_VALUE = (int16_t)32767;

	CFBamInt16DefBuff::CFBamInt16DefBuff()
	: CFBamAtomBuff()
	{
	...
	CFBamInt16DefBuff::CFBamInt16DefBuff( const CFBamInt16DefBuff& src )
	: CFBamAtomBuff()
	{
		optionalInitValue.setNull();
		optionalMinValue.setNull();
	...
	cflib::ICFLibCloneableObj* CFBamInt16DefBuff::clone() {
		CFBamInt16DefBuff* copy = new CFBamInt16DefBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamInt16DefBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamInt16DefBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamInt16DefBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const bool CFBamInt16DefBuff::isOptionalInitValueNull() const {
		return( optionalInitValue.isNull() );
	}

	const int16_t CFBamInt16DefBuff::getOptionalInitValueValue() const {
		return( optionalInitValue.getValue() );
	}

	const int16_t* CFBamInt16DefBuff::getOptionalInitValueReference() const {
		return( optionalInitValue.getReference() );
	}

	void CFBamInt16DefBuff::setOptionalInitValueNull() {
		optionalInitValue.setNull();
	}

	void CFBamInt16DefBuff::setOptionalInitValueValue( const int16_t value ) {
		static const std::string S_ProcName( "setOptionalInitValueValue" );
		if( value < cfbam::CFBamInt16DefBuff::INITVALUE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamInt16DefBuff::INITVALUE_MIN_VALUE );
		}
		if( value > cfbam::CFBamInt16DefBuff::INITVALUE_MAX_VALUE ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamInt16DefBuff::INITVALUE_MAX_VALUE );
		}
		optionalInitValue.setValue( value );
	}

	const bool CFBamInt16DefBuff::isOptionalMinValueNull() const {
		return( optionalMinValue.isNull() );
	}

	const int16_t CFBamInt16DefBuff::getOptionalMinValueValue() const {
		return( optionalMinValue.getValue() );
	}

	const int16_t* CFBamInt16DefBuff::getOptionalMinValueReference() const {
		return( optionalMinValue.getReference() );
	}

	void CFBamInt16DefBuff::setOptionalMinValueNull() {
		optionalMinValue.setNull();
	}

	void CFBamInt16DefBuff::setOptionalMinValueValue( const int16_t value ) {
		static const std::string S_ProcName( "setOptionalMinValueValue" );
		if( value < cfbam::CFBamInt16DefBuff::MINVALUE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamInt16DefBuff::MINVALUE_MIN_VALUE );
		}
		if( value > cfbam::CFBamInt16DefBuff::MINVALUE_MAX_VALUE ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamInt16DefBuff::MINVALUE_MAX_VALUE );
		}
		optionalMinValue.setValue( value );
	}

	const bool CFBamInt16DefBuff::isOptionalMaxValueNull() const {
		return( optionalMaxValue.isNull() );
	}

	const int16_t CFBamInt16DefBuff::getOptionalMaxValueValue() const {
		return( optionalMaxValue.getValue() );
	}

	const int16_t* CFBamInt16DefBuff::getOptionalMaxValueReference() const {
		return( optionalMaxValue.getReference() );
	}

	void CFBamInt16DefBuff::setOptionalMaxValueNull() {
		optionalMaxValue.setNull();
	}

	void CFBamInt16DefBuff::setOptionalMaxValueValue( const int16_t value ) {
		static const std::string S_ProcName( "setOptionalMaxValueValue" );
		if( value < cfbam::CFBamInt16DefBuff::MAXVALUE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamInt16DefBuff::MAXVALUE_MIN_VALUE );
		}
		if( value > cfbam::CFBamInt16DefBuff::MAXVALUE_MAX_VALUE ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamInt16DefBuff::MAXVALUE_MAX_VALUE );
		}
		optionalMaxValue.setValue( value );
	}

	size_t CFBamInt16DefBuff::hashCode() const {
	...
	CFBamInt16DefBuff CFBamInt16DefBuff::operator =( cfbam::CFBamInt16DefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamInt16DefBuff CFBamInt16DefBuff::operator =( cfbam::CFBamInt16DefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamInt16DefBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamInt16DefBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt16DefBuff::operator <( const CFBamInt16DefHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt16DefBuff::operator <( const CFBamInt16DefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamInt16DefBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt16DefBuff" );
