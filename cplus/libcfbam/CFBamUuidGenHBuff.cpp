// Description: C++18 implementation of a UuidGen history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUuidGenHBuff::CLASS_NAME( "CFBamUuidGenHBuff" );
	CFBamUuidGenHBuff::CFBamUuidGenHBuff()
	: cfbam::CFBamUuidTypeHBuff() {
		requiredSlice = cfbam::CFBamUuidGenBuff::SLICE_INIT_VALUE;
		requiredBlockSize = cfbam::CFBamUuidGenBuff::BLOCKSIZE_INIT_VALUE;
	}

	CFBamUuidGenHBuff::CFBamUuidGenHBuff( const CFBamUuidGenHBuff& src )
	: cfbam::CFBamUuidTypeHBuff() {
		requiredSlice = cfbam::CFBamUuidGenBuff::SLICE_INIT_VALUE;
		requiredBlockSize = cfbam::CFBamUuidGenBuff::BLOCKSIZE_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamUuidGenHBuff::clone() {
		CFBamUuidGenHBuff* copy = new CFBamUuidGenHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int16_t CFBamUuidGenHBuff::getRequiredSlice() const {
		return( requiredSlice );
	}

	const int16_t* CFBamUuidGenHBuff::getRequiredSliceReference() const {
		return( &requiredSlice );
	}

	void CFBamUuidGenHBuff::setRequiredSlice( const int16_t value ) {
	...
	const int32_t CFBamUuidGenHBuff::getRequiredBlockSize() const {
		return( requiredBlockSize );
	}

	const int32_t* CFBamUuidGenHBuff::getRequiredBlockSizeReference() const {
		return( &requiredBlockSize );
	}

	void CFBamUuidGenHBuff::setRequiredBlockSize( const int32_t value ) {
	...
	size_t CFBamUuidGenHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamUuidGenHBuff::hashCode();
		hashCode = ( hashCode * 0x10000 ) + getRequiredSlice();
		hashCode = hashCode + getRequiredBlockSize();
		return( hashCode );
	}

	CFBamUuidGenHBuff CFBamUuidGenHBuff::operator =( cfbam::CFBamUuidGenBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamUuidGenHBuff CFBamUuidGenHBuff::operator =( cfbam::CFBamUuidGenHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUuidGenHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamUuidGenHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamUuidGenHBuff::operator <( const CFBamUuidGenHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamUuidGenHBuff::operator <( const CFBamUuidGenBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUuidGenHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUuidGenHBuff" );
