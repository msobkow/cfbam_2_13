// Description: C++18 implementation of a UInt32Col history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUInt32ColHBuff::CLASS_NAME( "CFBamUInt32ColHBuff" );
	CFBamUInt32ColHBuff::CFBamUInt32ColHBuff()
	: cfbam::CFBamUInt32DefHBuff() {
		requiredTableId = cfbam::CFBamUInt32ColBuff::TABLEID_INIT_VALUE;
	}

	CFBamUInt32ColHBuff::CFBamUInt32ColHBuff( const CFBamUInt32ColHBuff& src )
	: cfbam::CFBamUInt32DefHBuff() {
		requiredTableId = cfbam::CFBamUInt32ColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamUInt32ColHBuff::clone() {
		CFBamUInt32ColHBuff* copy = new CFBamUInt32ColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamUInt32ColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamUInt32ColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamUInt32ColHBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamUInt32ColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamUInt32ColHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamUInt32ColHBuff CFBamUInt32ColHBuff::operator =( cfbam::CFBamUInt32ColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamUInt32ColHBuff CFBamUInt32ColHBuff::operator =( cfbam::CFBamUInt32ColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUInt32ColHBuff::operator <( const CFBamUInt32ColByTableIdxKey& rhs ) {
	...
	bool CFBamUInt32ColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt32ColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamUInt32ColHBuff::operator <( const CFBamUInt32ColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamUInt32ColHBuff::operator <( const CFBamUInt32ColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUInt32ColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt32ColHBuff" );
