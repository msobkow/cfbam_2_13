// Description: C++18 implementation for a TimestampDef buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTimestampDefBuff::GENDEFNAME( "TimestampDef" );
	const classcode_t CFBamTimestampDefBuff::CLASS_CODE = 0xa846L;
	const std::string CFBamTimestampDefBuff::CLASS_NAME( "CFBamTimestampDefBuff" );
		const std::string CFBamTimestampDefBuff::COLNAME_DUMMY( "Dummy" );
	const int64_t CFBamTimestampDefBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamTimestampDefBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamTimestampDefBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamTimestampDefBuff::ID_MIN_VALUE = 0LL;
	const std::string::size_type CFBamTimestampDefBuff::DUMMY_MAX_LEN = 4;

	CFBamTimestampDefBuff::CFBamTimestampDefBuff()
	: CFBamAtomBuff()
	{
		optionalDummy = NULL;
	}

	CFBamTimestampDefBuff::CFBamTimestampDefBuff( const CFBamTimestampDefBuff& src )
	: CFBamAtomBuff()
	{
		optionalDummy = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamTimestampDefBuff::clone() {
		CFBamTimestampDefBuff* copy = new CFBamTimestampDefBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTimestampDefBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTimestampDefBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTimestampDefBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const bool CFBamTimestampDefBuff::isOptionalDummyNull() const {
		return( optionalDummy == NULL );
	}

	const std::string& CFBamTimestampDefBuff::getOptionalDummyValue() const {
	...
	const std::string* CFBamTimestampDefBuff::getOptionalDummyReference() const {
		return( optionalDummy );
	}

	void CFBamTimestampDefBuff::setOptionalDummyNull() {
		if( optionalDummy != NULL ) {
			delete optionalDummy;
			optionalDummy = NULL;
		}
	...
	void CFBamTimestampDefBuff::setOptionalDummyValue( const std::string& value ) {
		static const std::string S_ProcName( "setOptionalDummyValue" );
		if( value.length() > CFBamTimestampDefBuff::DUMMY_MAX_LEN ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE_LENGTH,
				value.length(),
				CFBamTimestampDefBuff::DUMMY_MAX_LEN );
		}
		if( optionalDummy != NULL ) {
			delete optionalDummy;
			optionalDummy = NULL;
	...
	size_t CFBamTimestampDefBuff::hashCode() const {
	...
	CFBamTimestampDefBuff CFBamTimestampDefBuff::operator =( cfbam::CFBamTimestampDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamTimestampDefBuff CFBamTimestampDefBuff::operator =( cfbam::CFBamTimestampDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTimestampDefBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamTimestampDefBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTimestampDefBuff::operator <( const CFBamTimestampDefHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTimestampDefBuff::operator <( const CFBamTimestampDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTimestampDefBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTimestampDefBuff" );
