// Description: C++18 implementation for a UInt64Col buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUInt64ColBuff::GENDEFNAME( "UInt64Col" );
	const classcode_t CFBamUInt64ColBuff::CLASS_CODE = 0xa86cL;
	const std::string CFBamUInt64ColBuff::CLASS_NAME( "CFBamUInt64ColBuff" );
		const std::string CFBamUInt64ColBuff::COLNAME_TABLEID( "TableId" );
	const int64_t CFBamUInt64ColBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamUInt64ColBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamUInt64ColBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamUInt64ColBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamUInt64ColBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamUInt64ColBuff::TABLEID_MIN_VALUE = 0LL;

	CFBamUInt64ColBuff::CFBamUInt64ColBuff()
	: CFBamUInt64DefBuff()
	{
		requiredTableId = cfbam::CFBamUInt64ColBuff::TABLEID_INIT_VALUE;
	}

	CFBamUInt64ColBuff::CFBamUInt64ColBuff( const CFBamUInt64ColBuff& src )
	: CFBamUInt64DefBuff()
	{
		requiredTableId = cfbam::CFBamUInt64ColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamUInt64ColBuff::clone() {
		CFBamUInt64ColBuff* copy = new CFBamUInt64ColBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamUInt64ColBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUInt64ColBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamUInt64ColBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFBamUInt64ColBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamUInt64ColBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamUInt64ColBuff::setRequiredTableId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredTableId" );
		if( value < cfbam::CFBamUInt64ColBuff::TABLEID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamUInt64ColBuff::TABLEID_MIN_VALUE );
		}
		requiredTableId = value;
	}

	size_t CFBamUInt64ColBuff::hashCode() const {
		size_t hashCode = CFBamUInt64DefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamUInt64ColBuff CFBamUInt64ColBuff::operator =( cfbam::CFBamUInt64ColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamUInt64ColBuff CFBamUInt64ColBuff::operator =( cfbam::CFBamUInt64ColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUInt64ColBuff::operator <( const CFBamUInt64ColByTableIdxKey& rhs ) {
	...
	bool CFBamUInt64ColBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt64ColBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt64ColBuff::operator <( const CFBamUInt64ColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt64ColBuff::operator <( const CFBamUInt64ColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUInt64ColBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt64ColBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamUInt64ColBuff& lhs, const cfbam::CFBamUInt64ColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamUInt64ColBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamUInt64ColBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamUInt64ColBuff& lhs, const cfbam::CFBamUInt64ColHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamUInt64ColBuff& lhs, const cfbam::CFBamUInt64ColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
