// Description: C++18 Instance Edit Object interface implementation for CFBam TZTimeType.
...
namespace cfbam {
	...
	const std::string ICFBamTZTimeTypeEditObj::CLASS_NAME( "ICFBamTZTimeTypeEditObj" );

	ICFBamTZTimeTypeEditObj::ICFBamTZTimeTypeEditObj()
