// Description: C++18 implementation for a Value by NextIdx index key object.
...
namespace cfbam {
	const std::string CFBamValueByNextIdxKey::CLASS_NAME( "CFBamValueByNextIdxKey" );
	const std::string CFBamValueByNextIdxKey::S_VALUE( "value" );
	const std::string CFBamValueByNextIdxKey::S_VALUE_LENGTH( "value.length()" );


	CFBamValueByNextIdxKey::CFBamValueByNextIdxKey() {
		optionalNextTenantId.setNull();
		optionalNextId.setNull();
	}

	CFBamValueByNextIdxKey::CFBamValueByNextIdxKey( const CFBamValueByNextIdxKey& src ) {
		optionalNextTenantId.setNull();
		optionalNextId.setNull();
	...
	const int64_t CFBamValueByNextIdxKey::getOptionalNextTenantIdValue() const {
		return( optionalNextTenantId.getValue() );
	}

	const int64_t* CFBamValueByNextIdxKey::getOptionalNextTenantIdReference() const {
		return( optionalNextTenantId.getReference() );
	}

	const bool CFBamValueByNextIdxKey::isOptionalNextTenantIdNull() const {
		return( optionalNextTenantId.isNull() );
	}

	void CFBamValueByNextIdxKey::setOptionalNextTenantIdNull() {
		optionalNextTenantId.setNull();
	}

	void CFBamValueByNextIdxKey::setOptionalNextTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamValueByNextIdxKey::getOptionalNextIdValue() const {
		return( optionalNextId.getValue() );
	}

	const int64_t* CFBamValueByNextIdxKey::getOptionalNextIdReference() const {
		return( optionalNextId.getReference() );
	}

	const bool CFBamValueByNextIdxKey::isOptionalNextIdNull() const {
		return( optionalNextId.isNull() );
	}

	void CFBamValueByNextIdxKey::setOptionalNextIdNull() {
		optionalNextId.setNull();
	}

	void CFBamValueByNextIdxKey::setOptionalNextIdValue( const int64_t value ) {
	...
	size_t CFBamValueByNextIdxKey::hashCode() const {
		size_t hashCode = 0;
	...
	std::string CFBamValueByNextIdxKey::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamValueByNextIdxKey" );
	...
	bool CFBamValueByNextIdxKey::operator <( const CFBamValueByNextIdxKey& rhs ) {
		if( ! isOptionalNextTenantIdNull() ) {
	...
	bool CFBamValueByNextIdxKey::operator <( const CFBamValueHBuff& rhs ) {
		if( ! isOptionalNextTenantIdNull() ) {
			if( rhs.isOptionalNextTenantIdNull() ) {
				return( false );
			}
	...
	bool CFBamValueByNextIdxKey::operator <( const CFBamValueBuff& rhs ) {
		if( ! isOptionalNextTenantIdNull() ) {
			if( rhs.isOptionalNextTenantIdNull() ) {
				return( false );
			}
	...
	CFBamValueByNextIdxKey CFBamValueByNextIdxKey::operator =( cfbam::CFBamValueByNextIdxKey& src ) {
		if( src.isOptionalNextTenantIdNull() ) {
			setOptionalNextTenantIdNull();
		}
		else {
	...
	CFBamValueByNextIdxKey CFBamValueByNextIdxKey::operator =( cfbam::CFBamValueBuff& src ) {
		if( src.isOptionalNextTenantIdNull() ) {
			setOptionalNextTenantIdNull();
		}
		else {
	...
	CFBamValueByNextIdxKey CFBamValueByNextIdxKey::operator =( cfbam::CFBamValueHBuff& src ) {
		if( src.isOptionalNextTenantIdNull() ) {
			setOptionalNextTenantIdNull();
		}
		else {
