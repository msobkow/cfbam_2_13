// Description: C++18 base object instance implementation for CFBam TimeType.
...
namespace cfbam {
	...
	const std::string CFBamTimeTypeObj::CLASS_NAME( "CFBamTimeTypeObj" );
	const classcode_t CFBamTimeTypeObj::CLASS_CODE = 0xa845L;

	const int64_t CFBamTimeTypeObj::getRequiredSchemaDefId() {
		return( getTimeTypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamTimeTypeObj::getRequiredSchemaDefIdReference() {
		return( getTimeTypeBuff()->getRequiredSchemaDefIdReference() );
	}


	cfbam::ICFBamSchemaDefObj* CFBamTimeTypeObj::getRequiredContainerSchemaDef( bool forceRead ) {
	...
	CFBamTimeTypeObj::CFBamTimeTypeObj()
	: ICFBamTimeTypeObj(),
	  CFBamTimeDefObj()
	{
	}

	CFBamTimeTypeObj::CFBamTimeTypeObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamTimeTypeObj(),
	  CFBamTimeDefObj( argSchema )
	{
	}
	...
	cfbam::CFBamValueBuff* CFBamTimeTypeObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamTimeTypeBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableTimeType()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamTimeTypeObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamTimeTypeObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTimeTypeObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTimeTypeObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamTimeTypeBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamTimeDefObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamTimeTypeObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTimeTypeObj" );
		...
		if( ! CFBamTimeDefObj::isOptionalDummyNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredXmlString( &S_Space, S_Dummy, CFBamTimeDefObj::getOptionalDummyValue() ) );
		}
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamTimeTypeObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamTimeTypeObj::getObjName() {
	...
	const std::string CFBamTimeTypeObj::getGenDefName() {
		return( cfbam::CFBamTimeTypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTimeTypeObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTimeTypeObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTimeTypeObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTimeTypeObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTimeTypeObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTimeTypeObj::getObjQualifiedName() {
	...
	std::string CFBamTimeTypeObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTimeTypeObj::realize() {
		cfbam::ICFBamTimeTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimeTypeTableObj()->realizeTimeType(
			(cfbam::ICFBamTimeTypeObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTimeTypeObj::read( bool forceRead ) {
		cfbam::ICFBamTimeTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimeTypeTableObj()->readTimeTypeByIdIdx( getTimeTypeBuff()->getRequiredTenantId(),
		getTimeTypeBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTimeTypeObj::moveUp() {
		cfbam::ICFBamTimeTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimeTypeTableObj()->moveUpTimeType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTimeTypeObj::moveDown() {
		cfbam::ICFBamTimeTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimeTypeTableObj()->moveDownTimeType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamTimeTypeObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamTimeTypeObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimeTypeTableObj()->lockTimeType( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimeTypeTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamTimeTypeEditObj* CFBamTimeTypeObj::getTimeTypeEdit() {
		return( dynamic_cast<cfbam::ICFBamTimeTypeEditObj*>( edit ) );
	}
