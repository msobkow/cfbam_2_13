// Description: C++18 base object instance implementation for CFBam NmTokenCol.
...
namespace cfbam {
	...
	const std::string CFBamNmTokenColObj::CLASS_NAME( "CFBamNmTokenColObj" );
	const classcode_t CFBamNmTokenColObj::CLASS_CODE = 0xa85fL;

	const int64_t CFBamNmTokenColObj::getRequiredTableId() {
		return( getNmTokenColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamNmTokenColObj::getRequiredTableIdReference() {
		return( getNmTokenColBuff()->getRequiredTableIdReference() );
	}


	cfbam::ICFBamTableObj* CFBamNmTokenColObj::getRequiredContainerTable( bool forceRead ) {
	...
	CFBamNmTokenColObj::CFBamNmTokenColObj()
	: ICFBamNmTokenColObj(),
	  CFBamNmTokenDefObj()
	{
	}

	CFBamNmTokenColObj::CFBamNmTokenColObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamNmTokenColObj(),
	  CFBamNmTokenDefObj( argSchema )
	{
	}
	...
	cfbam::CFBamValueBuff* CFBamNmTokenColObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamNmTokenColBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableNmTokenCol()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamNmTokenColObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamNmTokenColObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamNmTokenColObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamNmTokenColObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamNmTokenColBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamNmTokenDefObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamNmTokenColObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNmTokenColObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt32( &S_Space, S_MaxLen, CFBamNmTokenDefObj::getRequiredMaxLen() ) );
		if( ! CFBamNmTokenDefObj::isOptionalInitValueNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredXmlString( &S_Space, S_InitValue, CFBamNmTokenDefObj::getOptionalInitValueValue() ) );
		}
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamNmTokenColObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamNmTokenColObj::getObjName() {
	...
	const std::string CFBamNmTokenColObj::getGenDefName() {
		return( cfbam::CFBamNmTokenColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamNmTokenColObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamNmTokenColObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamNmTokenColObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamNmTokenColObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamNmTokenColObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamNmTokenColObj::getObjQualifiedName() {
	...
	std::string CFBamNmTokenColObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamNmTokenColObj::realize() {
		cfbam::ICFBamNmTokenColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokenColTableObj()->realizeNmTokenCol(
			(cfbam::ICFBamNmTokenColObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamNmTokenColObj::read( bool forceRead ) {
		cfbam::ICFBamNmTokenColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokenColTableObj()->readNmTokenColByIdIdx( getNmTokenColBuff()->getRequiredTenantId(),
		getNmTokenColBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamNmTokenColObj::moveUp() {
		cfbam::ICFBamNmTokenColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokenColTableObj()->moveUpNmTokenCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamNmTokenColObj::moveDown() {
		cfbam::ICFBamNmTokenColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokenColTableObj()->moveDownNmTokenCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamNmTokenColObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamNmTokenColObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokenColTableObj()->lockNmTokenCol( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokenColTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamNmTokenColEditObj* CFBamNmTokenColObj::getNmTokenColEdit() {
		return( dynamic_cast<cfbam::ICFBamNmTokenColEditObj*>( edit ) );
	}
