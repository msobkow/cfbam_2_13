...
namespace cfbam {
	...
	const std::string CFBamClusterTableObj::CLASS_NAME( "CFBamClusterTableObj" );
	const std::string CFBamClusterTableObj::TABLE_NAME( "Cluster" );
	const std::string CFBamClusterTableObj::TABLE_DBNAME( "clus" );

	CFBamClusterTableObj::CFBamClusterTableObj() {
		schema = NULL;
	...
	CFBamClusterTableObj::CFBamClusterTableObj( cfsec::ICFSecSchemaObj* argSchema ) {
	...
	cfsec::ICFSecSchemaObj* CFBamClusterTableObj::getSchema() {
		return( schema );
	}

	void CFBamClusterTableObj::setSchema( cfsec::ICFSecSchemaObj* value ) {
		schema = dynamic_cast<cfbam::ICFBamSchemaObj*>( value );
	}

	const std::string CFBamClusterTableObj::getTableName() {
		return( TABLE_NAME );
	}

	const std::string CFBamClusterTableObj::getTableDbName() {
		return( TABLE_DBNAME );
	}
	const classcode_t* CFBamClusterTableObj::getObjQualifyingClassCode() {
		return( NULL );
	}


	void CFBamClusterTableObj::minimizeMemory() {
		if( allCluster != NULL ) {
			allCluster->clear();
			delete allCluster;
			allCluster = NULL;
	...
	cfsec::ICFSecClusterObj* CFBamClusterTableObj::newInstance() {
		cfsec::ICFSecClusterObj* inst = dynamic_cast<cfsec::ICFSecClusterObj*>( new CFBamClusterObj( schema ) );
		return( inst );
	}

	cfsec::ICFSecClusterEditObj* CFBamClusterTableObj::newEditInstance( cfsec::ICFSecClusterObj* orig ) {
		cfsec::ICFSecClusterEditObj* edit = dynamic_cast<cfsec::ICFSecClusterEditObj*>( new CFBamClusterEditObj( orig ));
		return( edit );
	}

	cfsec::ICFSecClusterObj* CFBamClusterTableObj::realizeCluster( cfsec::ICFSecClusterObj* Obj ) {
	...
	void CFBamClusterTableObj::deepDisposeByIdIdx( const int64_t Id ) {
		...
		while( listIter != listEnd ) {
			...
			if( cur != NULL ) {
				...
				if( classCode == cfsec::CFSecClusterBuff::CLASS_CODE ) {
					dynamic_cast<cfbam::CFBamClusterTableObj*>( schema->getClusterTableObj() )->reallyDeepDisposeCluster( dynamic_cast<cfsec::ICFSecClusterObj*>( cur ) );
				}
			}
			listIter ++;
		}
	...
	void CFBamClusterTableObj::deepDisposeByUDomNameIdx( const std::string& FullDomName ) {
	...
	void CFBamClusterTableObj::deepDisposeByUDescrIdx( const std::string& Description ) {
	...
	void CFBamClusterTableObj::reallyDeepDisposeCluster( cfsec::ICFSecClusterObj* Obj ) {
		...
		std::vector<cfsec::ICFSecSecGroupObj*> arrDelSecGroupForms = dynamic_cast<cfbam::CFBamSecGroupTableObj*>( schema->getSecGroupTableObj() )->readCachedSecGroupByClusterIdx( obj->getRequiredId() );
		...
		while( iterArrDelSecGroupForms != endArrDelSecGroupForms ) {
			...
			dynamic_cast<cfbam::CFBamSecGroupFormTableObj*>( schema->getSecGroupFormTableObj() )->deepDisposeByGroupIdx( objDelSecGroupForms->getRequiredClusterId(),
				objDelSecGroupForms->getRequiredSecGroupId() );
		}
		cfsec::ICFSecSecGroupObj* objDelSecGrpIncByGroup;
		std::vector<cfsec::ICFSecSecGroupObj*> arrDelSecGrpIncByGroup = dynamic_cast<cfbam::CFBamSecGroupTableObj*>( schema->getSecGroupTableObj() )->readCachedSecGroupByClusterIdx( obj->getRequiredId() );
		...
		while( iterArrDelSecGrpIncByGroup != endArrDelSecGrpIncByGroup ) {
			...
			dynamic_cast<cfbam::CFBamSecGrpIncTableObj*>( schema->getSecGrpIncTableObj() )->deepDisposeByIncludeIdx( objDelSecGrpIncByGroup->getRequiredClusterId(),
				objDelSecGrpIncByGroup->getRequiredSecGroupId() );
		}
		cfsec::ICFSecSecGroupObj* objDelSecGrpMembs;
		std::vector<cfsec::ICFSecSecGroupObj*> arrDelSecGrpMembs = dynamic_cast<cfbam::CFBamSecGroupTableObj*>( schema->getSecGroupTableObj() )->readCachedSecGroupByClusterIdx( obj->getRequiredId() );
		...
		while( iterArrDelSecGrpMembs != endArrDelSecGrpMembs ) {
			...
			dynamic_cast<cfbam::CFBamSecGrpMembTableObj*>( schema->getSecGrpMembTableObj() )->deepDisposeByGroupIdx( objDelSecGrpMembs->getRequiredClusterId(),
				objDelSecGrpMembs->getRequiredSecGroupId() );
		}
		cfsec::ICFSecSecGroupObj* objDelSecGrpIncs;
		std::vector<cfsec::ICFSecSecGroupObj*> arrDelSecGrpIncs = dynamic_cast<cfbam::CFBamSecGroupTableObj*>( schema->getSecGroupTableObj() )->readCachedSecGroupByClusterIdx( obj->getRequiredId() );
		...
		while( iterArrDelSecGrpIncs != endArrDelSecGrpIncs ) {
			...
			dynamic_cast<cfbam::CFBamSecGrpIncTableObj*>( schema->getSecGrpIncTableObj() )->deepDisposeByGroupIdx( objDelSecGrpIncs->getRequiredClusterId(),
				objDelSecGrpIncs->getRequiredSecGroupId() );
		}
		dynamic_cast<cfbam::CFBamSecGroupTableObj*>( schema->getSecGroupTableObj() )->deepDisposeByClusterIdx( obj->getRequiredId() );
		cfsec::ICFSecSecAppObj* objDelSecAppForms;
		std::vector<cfsec::ICFSecSecAppObj*> arrDelSecAppForms = dynamic_cast<cfbam::CFBamSecAppTableObj*>( schema->getSecAppTableObj() )->readCachedSecAppByClusterIdx( obj->getRequiredId() );
		...
		while( iterArrDelSecAppForms != endArrDelSecAppForms ) {
			...
			dynamic_cast<cfbam::CFBamSecFormTableObj*>( schema->getSecFormTableObj() )->deepDisposeBySecAppIdx( objDelSecAppForms->getRequiredClusterId(),
				objDelSecAppForms->getRequiredSecAppId() );
		}
		dynamic_cast<cfbam::CFBamSecAppTableObj*>( schema->getSecAppTableObj() )->deepDisposeByClusterIdx( obj->getRequiredId() );
		dynamic_cast<cfbam::CFBamTenantTableObj*>( schema->getTenantTableObj() )->deepDisposeByClusterIdx( obj->getRequiredId() );
		dynamic_cast<cfbam::CFBamHostNodeTableObj*>( schema->getHostNodeTableObj() )->deepDisposeByClusterIdx( obj->getRequiredId() );
		classcode_t classCode = obj->getClassCode();
		if( classCode == cfsec::CFSecClusterBuff::CLASS_CODE ) {
			dynamic_cast<cfbam::CFBamClusterTableObj*>( schema->getClusterTableObj() )->reallyDetachFromIndexesCluster( dynamic_cast<cfsec::ICFSecClusterObj*>( obj ) );
		}
	...
	cfsec::ICFSecClusterObj* CFBamClusterTableObj::createCluster( cfsec::ICFSecClusterEditObj* Obj ) {
		...
		try {
			...
			cflib::ICFLibCloneableObj* cloneable = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableCluster()->createCluster(
	...
	cfsec::ICFSecClusterObj* CFBamClusterTableObj::readCluster( cfsec::CFSecClusterPKey* pkey, bool forceRead ) {
		static const std::string S_Obj( "obj" );
		...
		if( forceRead || ( obj == NULL ) ) {
			cfsec::CFSecClusterBuff* readBuff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableCluster()->readDerivedByIdIdx( schema->getAuthorization(),
			pkey->getRequiredId() );
			if( readBuff != NULL ) {
			obj = dynamic_cast<cfbam::CFBamClusterTableObj*>( schema->getClusterTableObj() )->newInstance();
	...
	cfsec::ICFSecClusterObj* CFBamClusterTableObj::lockCluster( cfsec::CFSecClusterPKey* pkey ) {
		static const std::string S_ProcName( "lockCluster" );
		cfsec::ICFSecClusterObj* locked = NULL;
		cfsec::CFSecClusterBuff* lockBuff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableCluster()->lockDerived( schema->getAuthorization(), pkey );
		if( lockBuff != NULL ) {
			locked = dynamic_cast<cfbam::CFBamClusterTableObj*>( schema->getClusterTableObj() )->newInstance();
	...
	std::vector<cfsec::ICFSecClusterObj*> CFBamClusterTableObj::readAllCluster( bool forceRead ) {
		...
		if( forceRead || ( allCluster == NULL ) ) {
			...
			allCluster = map;
			std::TCFLibOwningVector<cfsec::CFSecClusterBuff*> buffList = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableCluster()->readAllDerived( schema->getAuthorization() );
	...
	std::vector<cfsec::ICFSecClusterObj*> CFBamClusterTableObj::pageAllCluster(const int64_t* priorId )
	{
		static const std::string S_Realized( "realized" );
		...
		try {
			...
			std::TCFLibOwningVector<cfsec::CFSecClusterBuff*> buffList = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableCluster()->pageAllBuff( schema->getAuthorization(),
				priorId );
	...
	cfsec::ICFSecClusterObj* CFBamClusterTableObj::readClusterByIdIdx( const int64_t Id, bool forceRead )
	{
	...
	cfsec::ICFSecClusterObj* CFBamClusterTableObj::readClusterByUDomNameIdx( const std::string& FullDomName, bool forceRead )
	{
		...
		if( forceRead || ( obj == NULL ) ) {
			cfsec::CFSecClusterBuff* buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableCluster()->readDerivedByUDomNameIdx( schema->getAuthorization(),
				FullDomName );
			if( buff != NULL ) {
				obj = dynamic_cast<cfbam::CFBamClusterTableObj*>( schema->getClusterTableObj() )->newInstance();
				obj->setBuff( buff );
	...
	cfsec::ICFSecClusterObj* CFBamClusterTableObj::readClusterByUDescrIdx( const std::string& Description, bool forceRead )
	{
		...
		if( forceRead || ( obj == NULL ) ) {
			cfsec::CFSecClusterBuff* buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableCluster()->readDerivedByUDescrIdx( schema->getAuthorization(),
				Description );
			if( buff != NULL ) {
				obj = dynamic_cast<cfbam::CFBamClusterTableObj*>( schema->getClusterTableObj() )->newInstance();
				obj->setBuff( buff );
	...
	cfsec::ICFSecClusterObj* CFBamClusterTableObj::readClusterByLookupUDomNameIdx( const std::string& FullDomName, bool forceRead )
	{
		static const std::string S_Realized( "realized" );
		static const std::string S_Obj( "obj" );
		...
		if( forceRead || ( obj == NULL ) ) {
			cfsec::CFSecClusterBuff* buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableCluster()->readDerivedByLookupUDomNameIdx( schema->getAuthorization(),
				FullDomName );
			if( buff != NULL ) {
				obj = dynamic_cast<cfsec::ICFSecClusterObj*>( dynamic_cast<cfbam::CFBamClusterTableObj*>( schema->getClusterTableObj() )->newInstance() );
				obj->setBuff( buff );
				realized = dynamic_cast<cfsec::ICFSecClusterObj*>( obj->realize() );
				if( realized == NULL ) {
					throw cflib::CFLibNullArgumentException( CLASS_NAME,
	...
	cfsec::ICFSecClusterObj* CFBamClusterTableObj::readCachedCluster( cfsec::CFSecClusterPKey* pkey ) {
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
		static const std::string S_ProcName( "readCluster" );
		cfsec::ICFSecClusterObj* obj = NULL;
	...
	cfsec::ICFSecClusterObj* CFBamClusterTableObj::readCachedClusterByIdIdx( const int64_t Id )
	{
	...
	cfsec::ICFSecClusterObj* CFBamClusterTableObj::readCachedClusterByUDomNameIdx( const std::string& FullDomName )
	{
	...
	cfsec::ICFSecClusterObj* CFBamClusterTableObj::readCachedClusterByUDescrIdx( const std::string& Description )
	{
	...
	cfsec::ICFSecClusterObj* CFBamClusterTableObj::readCachedClusterByLookupUDomNameIdx( const std::string& FullDomName )
	{
		static const std::string S_Realized( "realized" );
		static const std::string S_Obj( "obj" );
	...
	cfsec::ICFSecClusterObj* CFBamClusterTableObj::updateCluster( cfsec::ICFSecClusterEditObj* Obj ) {
		...
		cfsec::ICFSecClusterObj* obj = dynamic_cast<cfsec::ICFSecClusterObj*>( Obj->getOrig() );
		try {
			cfsec::CFSecClusterBuff* updated = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableCluster()->updateCluster( schema->getAuthorization(),
	...
	void CFBamClusterTableObj::deleteCluster( cfsec::ICFSecClusterEditObj* Obj ) {
		cfsec::ICFSecClusterObj* obj = Obj;
		dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableCluster()->deleteCluster( schema->getAuthorization(),
			obj->getClusterBuff() );
		deepDisposeByIdIdx( obj->getRequiredId() );
	}

	void CFBamClusterTableObj::deleteClusterByIdIdx( const int64_t Id )
	{
		cfsec::CFSecClusterPKey pkey;
		pkey.setRequiredId( Id );
	...
	void CFBamClusterTableObj::deleteClusterByUDomNameIdx( const std::string& FullDomName )
	{
		if( indexByUDomNameIdx == NULL ) {
			indexByUDomNameIdx = new std::map< cfsec::CFSecClusterByUDomNameIdxKey,
				cfsec::ICFSecClusterObj*>();
		...
		auto searchIndexByUDomNameIdx = indexByUDomNameIdx->find( key );
		if( searchIndexByUDomNameIdx != indexByUDomNameIdx->end() ) {
			dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableCluster()->deleteClusterByUDomNameIdx( schema->getAuthorization(),
				FullDomName );
		}
		else {
			dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableCluster()->deleteClusterByUDomNameIdx( schema->getAuthorization(),
	...
	void CFBamClusterTableObj::deleteClusterByUDescrIdx( const std::string& Description )
	{
		if( indexByUDescrIdx == NULL ) {
			indexByUDescrIdx = new std::map< cfsec::CFSecClusterByUDescrIdxKey,
				cfsec::ICFSecClusterObj*>();
		...
		auto searchIndexByUDescrIdx = indexByUDescrIdx->find( key );
		if( searchIndexByUDescrIdx != indexByUDescrIdx->end() ) {
			dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableCluster()->deleteClusterByUDescrIdx( schema->getAuthorization(),
				Description );
		}
		else {
			dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableCluster()->deleteClusterByUDescrIdx( schema->getAuthorization(),
	...
	void CFBamClusterTableObj::reallyDetachFromIndexesCluster( cfsec::ICFSecClusterObj* Obj ) {
	...
	cfsec::ICFSecClusterObj* CFBamClusterTableObj::getSystemCluster() {
