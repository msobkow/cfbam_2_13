// Description: C++18 edit object instance implementation for CFBam NumberType.
...
namespace cfbam {
	...
	const std::string CFBamNumberTypeEditObj::CLASS_NAME( "CFBamNumberTypeEditObj" );

	CFBamNumberTypeEditObj::CFBamNumberTypeEditObj( cfbam::ICFBamNumberTypeObj* argOrig )
	: ICFBamNumberTypeEditObj(),
	  CFBamNumberDefEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamNumberTypeEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamNumberTypeEditObj::~CFBamNumberTypeEditObj() {
	}

	const std::string& CFBamNumberTypeEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamNumberTypeEditObj::getClassCode() const {
		return( cfbam::CFBamNumberTypeBuff::CLASS_CODE );
	}

	bool CFBamNumberTypeEditObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamNumberTypeEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNumberTypeEditObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamNumberTypeEditObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	const std::string CFBamNumberTypeEditObj::getGenDefName() {
		return( cfbam::CFBamNumberTypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamNumberTypeEditObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamNumberTypeEditObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamNumberTypeEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamNumberTypeEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamNumberTypeEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamNumberTypeEditObj::getObjQualifiedName() {
	...
	std::string CFBamNumberTypeEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamNumberTypeEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamNumberTypeObj* retobj = getSchema()->getNumberTypeTableObj()->realizeNumberType( dynamic_cast<cfbam::ICFBamNumberTypeObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamNumberTypeEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamNumberTypeEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamNumberTypeEditObj::create() {
		cfbam::ICFBamNumberTypeObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsNumberType()->getSchema() )->getNumberTypeTableObj()->createNumberType( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamNumberTypeEditObj::update() {
		getSchema()->getNumberTypeTableObj()->updateNumberType( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamNumberTypeEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getNumberTypeTableObj()->deleteNumberType( this );
		return( NULL );
	}

	cfbam::ICFBamNumberTypeTableObj* CFBamNumberTypeEditObj::getNumberTypeTable() {
		return( orig->getSchema()->getNumberTypeTableObj() );
	}

	cfbam::ICFBamNumberTypeEditObj* CFBamNumberTypeEditObj::getNumberTypeEdit() {
		return( (cfbam::ICFBamNumberTypeEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamNumberTypeEditObj::beginEdit() {
	...
	cfbam::ICFBamNumberTypeObj* CFBamNumberTypeEditObj::getOrigAsNumberType() {
		return( dynamic_cast<cfbam::ICFBamNumberTypeObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamNumberTypeEditObj::getBuff() {
		return( buff );
	}

	void CFBamNumberTypeEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamNumberDefEditObj::setBuff( value );
		}
	}

	const int64_t CFBamNumberTypeEditObj::getRequiredSchemaDefId() {
		return( getNumberTypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamNumberTypeEditObj::getRequiredSchemaDefIdReference() {
		return( getNumberTypeBuff()->getRequiredSchemaDefIdReference() );
	}

	void CFBamNumberTypeEditObj::setRequiredContainerScope( cfbam::ICFBamScopeObj* value ) {
		if( value == NULL ) {
	...
	cfbam::ICFBamSchemaDefObj* CFBamNumberTypeEditObj::getRequiredContainerSchemaDef( bool forceRead ) {
		cfbam::ICFBamSchemaDefObj* retobj = NULL;
		bool anyMissing = false;
		if( ! anyMissing ) {
			retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsNumberType()->getSchema() )->getSchemaDefTableObj()->readSchemaDefByIdIdx( getPKey()->getRequiredTenantId(),
					getNumberTypeBuff()->getRequiredSchemaDefId() );
		}
		return( retobj );
	}

	void CFBamNumberTypeEditObj::setRequiredContainerSchemaDef( cfbam::ICFBamSchemaDefObj* value ) {
			
			if( value != NULL ) {
				getPKey()->setRequiredTenantId
( value->getRequiredTenantId() );
				getNumberTypeEditBuff()->setRequiredTenantId( value->getRequiredTenantId() );
				getNumberTypeEditBuff()->setRequiredSchemaDefId( value->getRequiredId() );
			}

			CFBamNumberDefEditObj::setRequiredContainerScope( value );		}

	void CFBamNumberTypeEditObj::copyBuffToOrig() {
		cfbam::CFBamNumberTypeBuff* origBuff = getOrigAsNumberType()->getNumberTypeEditBuff();
		cfbam::CFBamNumberTypeBuff* myBuff = getNumberTypeBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamNumberTypeEditObj::copyOrigToBuff() {
		cfbam::CFBamNumberTypeBuff* origBuff = getOrigAsNumberType()->getNumberTypeBuff();
		cfbam::CFBamNumberTypeBuff* myBuff = getNumberTypeEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
