// Description: C++18 implementation of a DoubleType history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamDoubleTypeHBuff::CLASS_NAME( "CFBamDoubleTypeHBuff" );
	CFBamDoubleTypeHBuff::CFBamDoubleTypeHBuff()
	: cfbam::CFBamDoubleDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamDoubleTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamDoubleTypeHBuff::CFBamDoubleTypeHBuff( const CFBamDoubleTypeHBuff& src )
	: cfbam::CFBamDoubleDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamDoubleTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamDoubleTypeHBuff::clone() {
		CFBamDoubleTypeHBuff* copy = new CFBamDoubleTypeHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamDoubleTypeHBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamDoubleTypeHBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamDoubleTypeHBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamDoubleTypeHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamDoubleTypeHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamDoubleTypeHBuff CFBamDoubleTypeHBuff::operator =( cfbam::CFBamDoubleTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamDoubleTypeHBuff CFBamDoubleTypeHBuff::operator =( cfbam::CFBamDoubleTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamDoubleTypeHBuff::operator <( const CFBamDoubleTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamDoubleTypeHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamDoubleTypeHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamDoubleTypeHBuff::operator <( const CFBamDoubleTypeHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamDoubleTypeHBuff::operator <( const CFBamDoubleTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamDoubleTypeHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamDoubleTypeHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamDoubleTypeHBuff& lhs, const cfbam::CFBamDoubleTypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamDoubleTypeHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamDoubleTypeHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamDoubleTypeHBuff& lhs, const cfbam::CFBamDoubleTypeHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamDoubleTypeHBuff& lhs, const cfbam::CFBamDoubleTypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
