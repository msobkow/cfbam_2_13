// Description: C++18 implementation for a UInt32Def buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUInt32DefBuff::GENDEFNAME( "UInt32Def" );
	const classcode_t CFBamUInt32DefBuff::CLASS_CODE = 0xa84cL;
	const std::string CFBamUInt32DefBuff::CLASS_NAME( "CFBamUInt32DefBuff" );
		const std::string CFBamUInt32DefBuff::COLNAME_INITVALUE( "InitValue" );
		const std::string CFBamUInt32DefBuff::COLNAME_MINVALUE( "MinValue" );
		const std::string CFBamUInt32DefBuff::COLNAME_MAXVALUE( "MaxValue" );
	const int64_t CFBamUInt32DefBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamUInt32DefBuff::ID_INIT_VALUE = 0LL;
	const uint32_t CFBamUInt32DefBuff::INITVALUE_INIT_VALUE = 0UL;
	const uint32_t CFBamUInt32DefBuff::MINVALUE_INIT_VALUE = 0UL;
	const uint32_t CFBamUInt32DefBuff::MAXVALUE_INIT_VALUE = 0UL;
	const int64_t CFBamUInt32DefBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamUInt32DefBuff::ID_MIN_VALUE = 0LL;
	const uint32_t CFBamUInt32DefBuff::INITVALUE_MIN_VALUE = 0UL;
	const uint32_t CFBamUInt32DefBuff::MINVALUE_MIN_VALUE = 0UL;
	const uint32_t CFBamUInt32DefBuff::MAXVALUE_MIN_VALUE = 0UL;

	CFBamUInt32DefBuff::CFBamUInt32DefBuff()
	: CFBamAtomBuff()
	{
	...
	CFBamUInt32DefBuff::CFBamUInt32DefBuff( const CFBamUInt32DefBuff& src )
	: CFBamAtomBuff()
	{
		optionalInitValue.setNull();
		optionalMinValue.setNull();
	...
	cflib::ICFLibCloneableObj* CFBamUInt32DefBuff::clone() {
		CFBamUInt32DefBuff* copy = new CFBamUInt32DefBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamUInt32DefBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUInt32DefBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamUInt32DefBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const bool CFBamUInt32DefBuff::isOptionalInitValueNull() const {
		return( optionalInitValue.isNull() );
	}

	const uint32_t CFBamUInt32DefBuff::getOptionalInitValueValue() const {
		return( optionalInitValue.getValue() );
	}

	const uint32_t* CFBamUInt32DefBuff::getOptionalInitValueReference() const {
		return( optionalInitValue.getReference() );
	}

	void CFBamUInt32DefBuff::setOptionalInitValueNull() {
		optionalInitValue.setNull();
	}

	void CFBamUInt32DefBuff::setOptionalInitValueValue( const uint32_t value ) {
		static const std::string S_ProcName( "setOptionalInitValueValue" );
		if( value < cfbam::CFBamUInt32DefBuff::INITVALUE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamUInt32DefBuff::INITVALUE_MIN_VALUE );
		}
		optionalInitValue.setValue( value );
	}

	const bool CFBamUInt32DefBuff::isOptionalMinValueNull() const {
		return( optionalMinValue.isNull() );
	}

	const uint32_t CFBamUInt32DefBuff::getOptionalMinValueValue() const {
		return( optionalMinValue.getValue() );
	}

	const uint32_t* CFBamUInt32DefBuff::getOptionalMinValueReference() const {
		return( optionalMinValue.getReference() );
	}

	void CFBamUInt32DefBuff::setOptionalMinValueNull() {
		optionalMinValue.setNull();
	}

	void CFBamUInt32DefBuff::setOptionalMinValueValue( const uint32_t value ) {
		static const std::string S_ProcName( "setOptionalMinValueValue" );
		if( value < cfbam::CFBamUInt32DefBuff::MINVALUE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamUInt32DefBuff::MINVALUE_MIN_VALUE );
		}
		optionalMinValue.setValue( value );
	}

	const bool CFBamUInt32DefBuff::isOptionalMaxValueNull() const {
		return( optionalMaxValue.isNull() );
	}

	const uint32_t CFBamUInt32DefBuff::getOptionalMaxValueValue() const {
		return( optionalMaxValue.getValue() );
	}

	const uint32_t* CFBamUInt32DefBuff::getOptionalMaxValueReference() const {
		return( optionalMaxValue.getReference() );
	}

	void CFBamUInt32DefBuff::setOptionalMaxValueNull() {
		optionalMaxValue.setNull();
	}

	void CFBamUInt32DefBuff::setOptionalMaxValueValue( const uint32_t value ) {
		static const std::string S_ProcName( "setOptionalMaxValueValue" );
		if( value < cfbam::CFBamUInt32DefBuff::MAXVALUE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamUInt32DefBuff::MAXVALUE_MIN_VALUE );
		}
		optionalMaxValue.setValue( value );
	}

	size_t CFBamUInt32DefBuff::hashCode() const {
	...
	CFBamUInt32DefBuff CFBamUInt32DefBuff::operator =( cfbam::CFBamUInt32DefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamUInt32DefBuff CFBamUInt32DefBuff::operator =( cfbam::CFBamUInt32DefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUInt32DefBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamUInt32DefBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt32DefBuff::operator <( const CFBamUInt32DefHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt32DefBuff::operator <( const CFBamUInt32DefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUInt32DefBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt32DefBuff" );
		...
		if( ! isOptionalInitValueNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredUInt32( &S_Space, S_InitValue, getOptionalInitValueValue() ) );
		}
		if( ! isOptionalMinValueNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredUInt32( &S_Space, S_MinValue, getOptionalMinValueValue() ) );
		}
		if( ! isOptionalMaxValueNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredUInt32( &S_Space, S_MaxValue, getOptionalMaxValueValue() ) );
		}
