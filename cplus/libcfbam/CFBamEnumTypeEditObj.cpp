// Description: C++18 edit object instance implementation for CFBam EnumType.
...
namespace cfbam {
	...
	const std::string CFBamEnumTypeEditObj::CLASS_NAME( "CFBamEnumTypeEditObj" );

	CFBamEnumTypeEditObj::CFBamEnumTypeEditObj( cfbam::ICFBamEnumTypeObj* argOrig )
	: ICFBamEnumTypeEditObj(),
	  CFBamEnumDefEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamEnumTypeEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamEnumTypeEditObj::~CFBamEnumTypeEditObj() {
	}

	const std::string& CFBamEnumTypeEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamEnumTypeEditObj::getClassCode() const {
		return( cfbam::CFBamEnumTypeBuff::CLASS_CODE );
	}

	bool CFBamEnumTypeEditObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamEnumTypeBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamEnumDefEditObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamEnumTypeEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamEnumTypeEditObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamEnumTypeEditObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	const std::string CFBamEnumTypeEditObj::getGenDefName() {
		return( cfbam::CFBamEnumTypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamEnumTypeEditObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamEnumTypeEditObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamEnumTypeEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamEnumTypeEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamEnumTypeEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamEnumTypeEditObj::getObjQualifiedName() {
	...
	std::string CFBamEnumTypeEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamEnumTypeEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamEnumTypeObj* retobj = getSchema()->getEnumTypeTableObj()->realizeEnumType( dynamic_cast<cfbam::ICFBamEnumTypeObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamEnumTypeEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamEnumTypeEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamEnumTypeEditObj::create() {
		cfbam::ICFBamEnumTypeObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsEnumType()->getSchema() )->getEnumTypeTableObj()->createEnumType( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamEnumTypeEditObj::update() {
		getSchema()->getEnumTypeTableObj()->updateEnumType( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamEnumTypeEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getEnumTypeTableObj()->deleteEnumType( this );
		return( NULL );
	}

	cfbam::ICFBamEnumTypeTableObj* CFBamEnumTypeEditObj::getEnumTypeTable() {
		return( orig->getSchema()->getEnumTypeTableObj() );
	}

	cfbam::ICFBamEnumTypeEditObj* CFBamEnumTypeEditObj::getEnumTypeEdit() {
		return( (cfbam::ICFBamEnumTypeEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamEnumTypeEditObj::beginEdit() {
	...
	cfbam::ICFBamEnumTypeObj* CFBamEnumTypeEditObj::getOrigAsEnumType() {
		return( dynamic_cast<cfbam::ICFBamEnumTypeObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamEnumTypeEditObj::getBuff() {
		return( buff );
	}

	void CFBamEnumTypeEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamEnumDefEditObj::setBuff( value );
		}
	}

	const int64_t CFBamEnumTypeEditObj::getRequiredSchemaDefId() {
		return( getEnumTypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamEnumTypeEditObj::getRequiredSchemaDefIdReference() {
		return( getEnumTypeBuff()->getRequiredSchemaDefIdReference() );
	}

	void CFBamEnumTypeEditObj::setRequiredContainerScope( cfbam::ICFBamScopeObj* value ) {
		if( value == NULL ) {
	...
	cfbam::ICFBamSchemaDefObj* CFBamEnumTypeEditObj::getRequiredContainerSchemaDef( bool forceRead ) {
		cfbam::ICFBamSchemaDefObj* retobj = NULL;
		bool anyMissing = false;
		if( ! anyMissing ) {
			retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsEnumType()->getSchema() )->getSchemaDefTableObj()->readSchemaDefByIdIdx( getPKey()->getRequiredTenantId(),
					getEnumTypeBuff()->getRequiredSchemaDefId() );
		}
		return( retobj );
	}

	void CFBamEnumTypeEditObj::setRequiredContainerSchemaDef( cfbam::ICFBamSchemaDefObj* value ) {
			
			if( value != NULL ) {
				getPKey()->setRequiredTenantId
( value->getRequiredTenantId() );
				getEnumTypeEditBuff()->setRequiredTenantId( value->getRequiredTenantId() );
				getEnumTypeEditBuff()->setRequiredSchemaDefId( value->getRequiredId() );
			}

			CFBamEnumDefEditObj::setRequiredContainerScope( value );		}

	void CFBamEnumTypeEditObj::copyBuffToOrig() {
		cfbam::CFBamEnumTypeBuff* origBuff = getOrigAsEnumType()->getEnumTypeEditBuff();
		cfbam::CFBamEnumTypeBuff* myBuff = getEnumTypeBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamEnumTypeEditObj::copyOrigToBuff() {
		cfbam::CFBamEnumTypeBuff* origBuff = getOrigAsEnumType()->getEnumTypeBuff();
		cfbam::CFBamEnumTypeBuff* myBuff = getEnumTypeEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
