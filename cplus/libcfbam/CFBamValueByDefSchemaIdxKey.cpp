// Description: C++18 implementation for a Value by DefSchemaIdx index key object.
...
namespace cfbam {
	const std::string CFBamValueByDefSchemaIdxKey::CLASS_NAME( "CFBamValueByDefSchemaIdxKey" );
	const std::string CFBamValueByDefSchemaIdxKey::S_VALUE( "value" );
	const std::string CFBamValueByDefSchemaIdxKey::S_VALUE_LENGTH( "value.length()" );


	CFBamValueByDefSchemaIdxKey::CFBamValueByDefSchemaIdxKey() {
		optionalDefSchemaTenantId.setNull();
		optionalDefSchemaId.setNull();
	}

	CFBamValueByDefSchemaIdxKey::CFBamValueByDefSchemaIdxKey( const CFBamValueByDefSchemaIdxKey& src ) {
		optionalDefSchemaTenantId.setNull();
		optionalDefSchemaId.setNull();
	...
	const int64_t CFBamValueByDefSchemaIdxKey::getOptionalDefSchemaTenantIdValue() const {
		return( optionalDefSchemaTenantId.getValue() );
	}

	const int64_t* CFBamValueByDefSchemaIdxKey::getOptionalDefSchemaTenantIdReference() const {
		return( optionalDefSchemaTenantId.getReference() );
	}

	const bool CFBamValueByDefSchemaIdxKey::isOptionalDefSchemaTenantIdNull() const {
		return( optionalDefSchemaTenantId.isNull() );
	}

	void CFBamValueByDefSchemaIdxKey::setOptionalDefSchemaTenantIdNull() {
		optionalDefSchemaTenantId.setNull();
	}

	void CFBamValueByDefSchemaIdxKey::setOptionalDefSchemaTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamValueByDefSchemaIdxKey::getOptionalDefSchemaIdValue() const {
		return( optionalDefSchemaId.getValue() );
	}

	const int64_t* CFBamValueByDefSchemaIdxKey::getOptionalDefSchemaIdReference() const {
		return( optionalDefSchemaId.getReference() );
	}

	const bool CFBamValueByDefSchemaIdxKey::isOptionalDefSchemaIdNull() const {
		return( optionalDefSchemaId.isNull() );
	}

	void CFBamValueByDefSchemaIdxKey::setOptionalDefSchemaIdNull() {
		optionalDefSchemaId.setNull();
	}

	void CFBamValueByDefSchemaIdxKey::setOptionalDefSchemaIdValue( const int64_t value ) {
	...
	size_t CFBamValueByDefSchemaIdxKey::hashCode() const {
		size_t hashCode = 0;
	...
	std::string CFBamValueByDefSchemaIdxKey::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamValueByDefSchemaIdxKey" );
	...
	bool CFBamValueByDefSchemaIdxKey::operator <( const CFBamValueByDefSchemaIdxKey& rhs ) {
		if( ! isOptionalDefSchemaTenantIdNull() ) {
	...
	bool CFBamValueByDefSchemaIdxKey::operator <( const CFBamValueHBuff& rhs ) {
		if( ! isOptionalDefSchemaTenantIdNull() ) {
			if( rhs.isOptionalDefSchemaTenantIdNull() ) {
				return( false );
			}
	...
	bool CFBamValueByDefSchemaIdxKey::operator <( const CFBamValueBuff& rhs ) {
		if( ! isOptionalDefSchemaTenantIdNull() ) {
			if( rhs.isOptionalDefSchemaTenantIdNull() ) {
				return( false );
			}
	...
	CFBamValueByDefSchemaIdxKey CFBamValueByDefSchemaIdxKey::operator =( cfbam::CFBamValueByDefSchemaIdxKey& src ) {
		if( src.isOptionalDefSchemaTenantIdNull() ) {
			setOptionalDefSchemaTenantIdNull();
		}
		else {
	...
	CFBamValueByDefSchemaIdxKey CFBamValueByDefSchemaIdxKey::operator =( cfbam::CFBamValueBuff& src ) {
		if( src.isOptionalDefSchemaTenantIdNull() ) {
			setOptionalDefSchemaTenantIdNull();
		}
		else {
	...
	CFBamValueByDefSchemaIdxKey CFBamValueByDefSchemaIdxKey::operator =( cfbam::CFBamValueHBuff& src ) {
		if( src.isOptionalDefSchemaTenantIdNull() ) {
			setOptionalDefSchemaTenantIdNull();
		}
		else {
