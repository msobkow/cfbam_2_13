// Description: C++18 implementation of a UuidCol history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUuidColHBuff::CLASS_NAME( "CFBamUuidColHBuff" );
	CFBamUuidColHBuff::CFBamUuidColHBuff()
	: cfbam::CFBamUuidDefHBuff() {
		requiredTableId = cfbam::CFBamUuidColBuff::TABLEID_INIT_VALUE;
	}

	CFBamUuidColHBuff::CFBamUuidColHBuff( const CFBamUuidColHBuff& src )
	: cfbam::CFBamUuidDefHBuff() {
		requiredTableId = cfbam::CFBamUuidColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamUuidColHBuff::clone() {
		CFBamUuidColHBuff* copy = new CFBamUuidColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamUuidColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamUuidColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamUuidColHBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamUuidColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamUuidColHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamUuidColHBuff CFBamUuidColHBuff::operator =( cfbam::CFBamUuidColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamUuidColHBuff CFBamUuidColHBuff::operator =( cfbam::CFBamUuidColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUuidColHBuff::operator <( const CFBamUuidColByTableIdxKey& rhs ) {
	...
	bool CFBamUuidColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUuidColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamUuidColHBuff::operator <( const CFBamUuidColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamUuidColHBuff::operator <( const CFBamUuidColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUuidColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUuidColHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamUuidColHBuff& lhs, const cfbam::CFBamUuidColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamUuidColHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamUuidColHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamUuidColHBuff& lhs, const cfbam::CFBamUuidColHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamUuidColHBuff& lhs, const cfbam::CFBamUuidColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
