// Description: C++18 implementation for a FloatDef buffer object.
...
namespace cfbam {
	...
	const std::string CFBamFloatDefBuff::GENDEFNAME( "FloatDef" );
	const classcode_t CFBamFloatDefBuff::CLASS_CODE = 0xa81fL;
	const std::string CFBamFloatDefBuff::CLASS_NAME( "CFBamFloatDefBuff" );
		const std::string CFBamFloatDefBuff::COLNAME_INITVALUE( "InitValue" );
		const std::string CFBamFloatDefBuff::COLNAME_MINVALUE( "MinValue" );
		const std::string CFBamFloatDefBuff::COLNAME_MAXVALUE( "MaxValue" );
	const int64_t CFBamFloatDefBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamFloatDefBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamFloatDefBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamFloatDefBuff::ID_MIN_VALUE = 0LL;
	const float CFBamFloatDefBuff::INITVALUE_MIN_VALUE = (float)-1.174E37;
	const float CFBamFloatDefBuff::MINVALUE_MIN_VALUE = (float)-1.174E37;
	const float CFBamFloatDefBuff::MAXVALUE_MIN_VALUE = (float)-1.174E37;
	const float CFBamFloatDefBuff::INITVALUE_MAX_VALUE = (float)1.174E37;
	const float CFBamFloatDefBuff::MINVALUE_MAX_VALUE = (float)1.174E37;
	const float CFBamFloatDefBuff::MAXVALUE_MAX_VALUE = (float)1.174E37;

	CFBamFloatDefBuff::CFBamFloatDefBuff()
	: CFBamAtomBuff()
	{
	...
	CFBamFloatDefBuff::CFBamFloatDefBuff( const CFBamFloatDefBuff& src )
	: CFBamAtomBuff()
	{
		optionalInitValue.setNull();
		optionalMinValue.setNull();
	...
	cflib::ICFLibCloneableObj* CFBamFloatDefBuff::clone() {
		CFBamFloatDefBuff* copy = new CFBamFloatDefBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamFloatDefBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamFloatDefBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamFloatDefBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const bool CFBamFloatDefBuff::isOptionalInitValueNull() const {
		return( optionalInitValue.isNull() );
	}

	const float CFBamFloatDefBuff::getOptionalInitValueValue() const {
		return( optionalInitValue.getValue() );
	}

	const float* CFBamFloatDefBuff::getOptionalInitValueReference() const {
		return( optionalInitValue.getReference() );
	}

	void CFBamFloatDefBuff::setOptionalInitValueNull() {
		optionalInitValue.setNull();
	}

	void CFBamFloatDefBuff::setOptionalInitValueValue( const float value ) {
		static const std::string S_ProcName( "setOptionalInitValueValue" );
		if( value < cfbam::CFBamFloatDefBuff::INITVALUE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamFloatDefBuff::INITVALUE_MIN_VALUE );
		}
		if( value > cfbam::CFBamFloatDefBuff::INITVALUE_MAX_VALUE ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamFloatDefBuff::INITVALUE_MAX_VALUE );
		}
		optionalInitValue.setValue( value );
	}

	const bool CFBamFloatDefBuff::isOptionalMinValueNull() const {
		return( optionalMinValue.isNull() );
	}

	const float CFBamFloatDefBuff::getOptionalMinValueValue() const {
		return( optionalMinValue.getValue() );
	}

	const float* CFBamFloatDefBuff::getOptionalMinValueReference() const {
		return( optionalMinValue.getReference() );
	}

	void CFBamFloatDefBuff::setOptionalMinValueNull() {
		optionalMinValue.setNull();
	}

	void CFBamFloatDefBuff::setOptionalMinValueValue( const float value ) {
		static const std::string S_ProcName( "setOptionalMinValueValue" );
		if( value < cfbam::CFBamFloatDefBuff::MINVALUE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamFloatDefBuff::MINVALUE_MIN_VALUE );
		}
		if( value > cfbam::CFBamFloatDefBuff::MINVALUE_MAX_VALUE ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamFloatDefBuff::MINVALUE_MAX_VALUE );
		}
		optionalMinValue.setValue( value );
	}

	const bool CFBamFloatDefBuff::isOptionalMaxValueNull() const {
		return( optionalMaxValue.isNull() );
	}

	const float CFBamFloatDefBuff::getOptionalMaxValueValue() const {
		return( optionalMaxValue.getValue() );
	}

	const float* CFBamFloatDefBuff::getOptionalMaxValueReference() const {
		return( optionalMaxValue.getReference() );
	}

	void CFBamFloatDefBuff::setOptionalMaxValueNull() {
		optionalMaxValue.setNull();
	}

	void CFBamFloatDefBuff::setOptionalMaxValueValue( const float value ) {
		static const std::string S_ProcName( "setOptionalMaxValueValue" );
		if( value < cfbam::CFBamFloatDefBuff::MAXVALUE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamFloatDefBuff::MAXVALUE_MIN_VALUE );
		}
		if( value > cfbam::CFBamFloatDefBuff::MAXVALUE_MAX_VALUE ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamFloatDefBuff::MAXVALUE_MAX_VALUE );
		}
		optionalMaxValue.setValue( value );
	}

	size_t CFBamFloatDefBuff::hashCode() const {
	...
	CFBamFloatDefBuff CFBamFloatDefBuff::operator =( cfbam::CFBamFloatDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamFloatDefBuff CFBamFloatDefBuff::operator =( cfbam::CFBamFloatDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamFloatDefBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamFloatDefBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamFloatDefBuff::operator <( const CFBamFloatDefHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamFloatDefBuff::operator <( const CFBamFloatDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamFloatDefBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamFloatDefBuff" );
		...
		if( ! isOptionalInitValueNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredFloat( &S_Space, S_InitValue, getOptionalInitValueValue() ) );
		}
		if( ! isOptionalMinValueNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredFloat( &S_Space, S_MinValue, getOptionalMinValueValue() ) );
		}
		if( ! isOptionalMaxValueNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredFloat( &S_Space, S_MaxValue, getOptionalMaxValueValue() ) );
		}
