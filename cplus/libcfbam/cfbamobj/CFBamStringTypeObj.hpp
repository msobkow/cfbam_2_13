...
// Description: C++18 base object instance specification for CFBam StringType.
...
namespace cfbam {
	...
	class CFBamStringTypeObj
	: public CFBamStringDefObj,
	  public virtual ICFBamStringTypeObj
	{
	protected:
	public:
		...
		CFBamStringTypeObj();
		CFBamStringTypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamStringTypeObj();
