...
// Description: C++18 edit object instance specification for CFBam ISOLang.
...
namespace cfbam {
	...
	class CFBamISOLangEditObj
	: public virtual ICFBamISOLangEditObj,
	  public virtual cfsec::ICFSecISOLangEditObj,
	  public virtual cfint::ICFIntISOLangEditObj
	{
	public:
	...
	public:
		CFBamISOLangEditObj( cfsec::ICFSecISOLangObj* argOrig );
		virtual ~CFBamISOLangEditObj();
