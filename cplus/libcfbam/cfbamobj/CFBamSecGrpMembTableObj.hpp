...
namespace cfbam {
	...
	class CFBamSecGrpMembTableObj
	: public virtual ICFBamSecGrpMembTableObj,
	  public virtual cfsec::ICFSecSecGrpMembTableObj,
	  public virtual cfint::ICFIntSecGrpMembTableObj
	{
	protected:
	...
	public:
		...
		CFBamSecGrpMembTableObj();
		CFBamSecGrpMembTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamSecGrpMembTableObj();
