...
namespace cfbam {
	...
	class CFBamClearSubDep3TableObj
	: public virtual ICFBamClearSubDep3TableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearSubDep3Obj*>* members;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearSubDep3Obj*>* allClearSubDep3;
		std::map< cfbam::CFBamScopeByTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearSubDep3Obj*>*>* indexByTenantIdx;
		std::map< cfbam::CFBamClearDepByClearDepIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearSubDep3Obj*>*>* indexByClearDepIdx;
		std::map< cfbam::CFBamClearDepByDefSchemaIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearSubDep3Obj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamClearSubDep3ByClearSubDep2IdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearSubDep3Obj*>*>* indexByClearSubDep2Idx;
		std::map< cfbam::CFBamClearSubDep3ByUNameIdxKey,
			cfbam::ICFBamClearSubDep3Obj*>* indexByUNameIdx;
	...
	public:
		...
		CFBamClearSubDep3TableObj();
		CFBamClearSubDep3TableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamClearSubDep3TableObj();
		...
		virtual cfbam::ICFBamClearSubDep3Obj* newInstance();

		virtual cfbam::ICFBamClearSubDep3EditObj* newEditInstance( cfbam::ICFBamClearSubDep3Obj* orig );

		virtual cfbam::ICFBamClearSubDep3Obj* realizeClearSubDep3( cfbam::ICFBamClearSubDep3Obj* Obj );

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id );
		virtual void deepDisposeByTenantIdx( const int64_t TenantId );
		virtual void reallyDeepDisposeClearSubDep3( cfbam::ICFBamClearSubDep3Obj* Obj );
		...
		virtual void deepDisposeByClearSubDep2Idx( const int64_t ClearSubDep2TenantId,
			const int64_t ClearSubDep2Id );
		virtual void deepDisposeByUNameIdx( const int64_t ClearSubDep2TenantId,
			const int64_t ClearSubDep2Id,
			const std::string& Name );
		virtual cfbam::ICFBamClearSubDep3Obj* createClearSubDep3( cfbam::ICFBamClearSubDep3EditObj* Obj );

		virtual cfbam::ICFBamClearSubDep3Obj* readClearSubDep3( cfbam::CFBamScopePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamClearSubDep3Obj* lockClearSubDep3( cfbam::CFBamScopePKey* pkey );

		virtual std::vector<cfbam::ICFBamClearSubDep3Obj*> readAllClearSubDep3( bool forceRead = false );

		virtual cfbam::ICFBamClearSubDep3Obj* readClearSubDep3ByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamClearSubDep3Obj*> readClearSubDep3ByTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamClearSubDep3Obj*> readClearSubDep3ByClearDepIdx( const int64_t TenantId,
			const int64_t RelationId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamClearSubDep3Obj*> readClearSubDep3ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamClearSubDep3Obj*> readClearSubDep3ByClearSubDep2Idx( const int64_t ClearSubDep2TenantId,
			const int64_t ClearSubDep2Id,
			bool forceRead = false );

		virtual cfbam::ICFBamClearSubDep3Obj* readClearSubDep3ByUNameIdx( const int64_t ClearSubDep2TenantId,
			const int64_t ClearSubDep2Id,
			const std::string& Name, bool forceRead = false );

		virtual cfbam::ICFBamClearSubDep3Obj* readCachedClearSubDep3( cfbam::CFBamScopePKey* pkey );

		virtual cfbam::ICFBamClearSubDep3Obj* readCachedClearSubDep3ByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual std::vector<cfbam::ICFBamClearSubDep3Obj*> readCachedClearSubDep3ByTenantIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamClearSubDep3Obj*> readCachedClearSubDep3ByClearDepIdx( const int64_t TenantId,
			const int64_t RelationId );

		virtual std::vector<cfbam::ICFBamClearSubDep3Obj*> readCachedClearSubDep3ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamClearSubDep3Obj*> readCachedClearSubDep3ByClearSubDep2Idx( const int64_t ClearSubDep2TenantId,
			const int64_t ClearSubDep2Id );

		virtual cfbam::ICFBamClearSubDep3Obj* readCachedClearSubDep3ByUNameIdx( const int64_t ClearSubDep2TenantId,
			const int64_t ClearSubDep2Id,
			const std::string& Name );

		virtual cfbam::ICFBamClearSubDep3Obj* updateClearSubDep3( cfbam::ICFBamClearSubDep3EditObj* Obj );

		virtual void deleteClearSubDep3( cfbam::ICFBamClearSubDep3EditObj* Obj );

		virtual void deleteClearSubDep3ByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteClearSubDep3ByTenantIdx( const int64_t TenantId );

		virtual void deleteClearSubDep3ByClearDepIdx( const int64_t TenantId,
			const int64_t RelationId );

		virtual void deleteClearSubDep3ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteClearSubDep3ByClearSubDep2Idx( const int64_t ClearSubDep2TenantId,
			const int64_t ClearSubDep2Id );

		virtual void deleteClearSubDep3ByUNameIdx( const int64_t ClearSubDep2TenantId,
			const int64_t ClearSubDep2Id,
			const std::string& Name );

		virtual void reallyDetachFromIndexesClearSubDep3( cfbam::ICFBamClearSubDep3Obj* Obj );
