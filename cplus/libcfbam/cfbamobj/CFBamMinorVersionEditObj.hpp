...
// Description: C++18 edit object instance specification for CFBam MinorVersion.
...
namespace cfbam {
	...
	class CFBamMinorVersionEditObj
	: public virtual ICFBamMinorVersionEditObj,
	  public virtual cfint::ICFIntMinorVersionEditObj
	{
	public:
	...
	public:
		CFBamMinorVersionEditObj( cfint::ICFIntMinorVersionObj* argOrig );
		virtual ~CFBamMinorVersionEditObj();
		...
		virtual std::vector<cfbam::ICFBamSchemaDefObj*> getOptionalComponentsSchemaDef( bool forceRead = false );
