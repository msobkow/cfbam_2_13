...
namespace cfbam {
	...
	class CFBamUInt64TypeTableObj
	: public virtual ICFBamUInt64TypeTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64TypeObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64TypeObj*>* allUInt64Type;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamUInt64TypeObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64TypeObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64TypeObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64TypeObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64TypeObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64TypeObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64TypeObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64TypeObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamUInt64TypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64TypeObj*>*>* indexBySchemaIdx;
	...
	public:
		...
		CFBamUInt64TypeTableObj();
		CFBamUInt64TypeTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamUInt64TypeTableObj();
		...
		virtual cfbam::ICFBamUInt64TypeObj* newInstance();

		virtual cfbam::ICFBamUInt64TypeEditObj* newEditInstance( cfbam::ICFBamUInt64TypeObj* orig );

		virtual cfbam::ICFBamUInt64TypeObj* realizeUInt64Type( cfbam::ICFBamUInt64TypeObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeUInt64Type( cfbam::ICFBamUInt64TypeObj* Obj );
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );
		virtual cfbam::ICFBamUInt64TypeObj* createUInt64Type( cfbam::ICFBamUInt64TypeEditObj* Obj );

		virtual cfbam::ICFBamUInt64TypeObj* readUInt64Type( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamUInt64TypeObj* lockUInt64Type( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamUInt64TypeObj*> readAllUInt64Type( bool forceRead = false );

		virtual cfbam::ICFBamUInt64TypeObj* readUInt64TypeByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamUInt64TypeObj* readUInt64TypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt64TypeObj*> readUInt64TypeByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt64TypeObj*> readUInt64TypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt64TypeObj*> readUInt64TypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt64TypeObj*> readUInt64TypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt64TypeObj*> readUInt64TypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt64TypeObj*> readUInt64TypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt64TypeObj*> readUInt64TypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt64TypeObj*> readUInt64TypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId,
			bool forceRead = false );

		virtual cfbam::ICFBamUInt64TypeObj* readCachedUInt64Type( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamUInt64TypeObj* readCachedUInt64TypeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamUInt64TypeObj* readCachedUInt64TypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamUInt64TypeObj*> readCachedUInt64TypeByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamUInt64TypeObj*> readCachedUInt64TypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamUInt64TypeObj*> readCachedUInt64TypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamUInt64TypeObj*> readCachedUInt64TypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamUInt64TypeObj*> readCachedUInt64TypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamUInt64TypeObj*> readCachedUInt64TypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamUInt64TypeObj*> readCachedUInt64TypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamUInt64TypeObj*> readCachedUInt64TypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual cfbam::ICFBamUInt64TypeObj* updateUInt64Type( cfbam::ICFBamUInt64TypeEditObj* Obj );

		virtual void deleteUInt64Type( cfbam::ICFBamUInt64TypeEditObj* Obj );

		virtual void deleteUInt64TypeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteUInt64TypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteUInt64TypeByValTentIdx( const int64_t TenantId );

		virtual void deleteUInt64TypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteUInt64TypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteUInt64TypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteUInt64TypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteUInt64TypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteUInt64TypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteUInt64TypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual cfbam::ICFBamUInt64TypeObj* moveUpUInt64Type( cfbam::ICFBamUInt64TypeObj* Obj );

		virtual cfbam::ICFBamUInt64TypeObj* moveDownUInt64Type( cfbam::ICFBamUInt64TypeObj* Obj );

		virtual void reallyDetachFromIndexesUInt64Type( cfbam::ICFBamUInt64TypeObj* Obj );
