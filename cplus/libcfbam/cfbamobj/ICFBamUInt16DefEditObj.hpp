...
// Description: C++18 Instance Edit Object interface for CFBam UInt16Def.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamAtomEditObj,
	  public virtual cfbam::ICFBamUInt16DefObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamUInt16DefEditObj();
		virtual ~ICFBamUInt16DefEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamUInt16DefBuff* getUInt16DefBuff() {
			return( static_cast<cfbam::CFBamUInt16DefBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamUInt16DefBuff* getUInt16DefEditBuff() {
			return( dynamic_cast<cfbam::CFBamUInt16DefBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamUInt16DefObj* getOrigAsUInt16Def() = 0;

		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual bool isOptionalInitValueNull() = 0;
		virtual const uint16_t getOptionalInitValueValue() = 0;
		virtual const uint16_t* getOptionalInitValueReference() = 0;
		virtual void setOptionalInitValueNull() = 0;
		virtual void setOptionalInitValueValue( const uint16_t value ) = 0;

		virtual bool isOptionalMinValueNull() = 0;
		virtual const uint16_t getOptionalMinValueValue() = 0;
		virtual const uint16_t* getOptionalMinValueReference() = 0;
		virtual void setOptionalMinValueNull() = 0;
		virtual void setOptionalMinValueValue( const uint16_t value ) = 0;

		virtual bool isOptionalMaxValueNull() = 0;
		virtual const uint16_t getOptionalMaxValueValue() = 0;
		virtual const uint16_t* getOptionalMaxValueReference() = 0;
		virtual void setOptionalMaxValueNull() = 0;
		virtual void setOptionalMaxValueValue( const uint16_t value ) = 0;
