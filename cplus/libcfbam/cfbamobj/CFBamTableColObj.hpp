...
// Description: C++18 base object instance specification for CFBam TableCol.
...
namespace cfbam {
	...
	class CFBamTableColObj
	: public CFBamValueObj,
	  public virtual ICFBamTableColObj
	{
	protected:
	public:
		...
		CFBamTableColObj();
		CFBamTableColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTableColObj();
