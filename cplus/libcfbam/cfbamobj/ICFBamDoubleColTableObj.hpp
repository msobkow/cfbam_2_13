...
namespace cfbam {
	...
	{
	public:
		ICFBamDoubleColTableObj();
		virtual ~ICFBamDoubleColTableObj();
		...
		virtual cfbam::ICFBamDoubleColObj* newInstance() = 0;

		virtual cfbam::ICFBamDoubleColEditObj* newEditInstance( cfbam::ICFBamDoubleColObj* orig ) = 0;

		virtual cfbam::ICFBamDoubleColObj* realizeDoubleCol( cfbam::ICFBamDoubleColObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeDoubleCol( cfbam::ICFBamDoubleColObj* Obj ) = 0;
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId ) = 0;
		virtual cfbam::ICFBamDoubleColObj* createDoubleCol( cfbam::ICFBamDoubleColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamDoubleColObj* readDoubleCol( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamDoubleColObj* lockDoubleCol( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamDoubleColObj*> readAllDoubleCol( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamDoubleColObj* readCachedDoubleCol( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamDoubleColObj*> readCachedDoubleColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamDoubleColObj* updateDoubleCol( cfbam::ICFBamDoubleColEditObj* Obj ) = 0;

		virtual void deleteDoubleCol( cfbam::ICFBamDoubleColEditObj* Obj ) = 0;
		...
		virtual void deleteDoubleColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamDoubleColObj* moveUpDoubleCol( cfbam::ICFBamDoubleColObj* Obj ) = 0;

		virtual cfbam::ICFBamDoubleColObj* moveDownDoubleCol( cfbam::ICFBamDoubleColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesDoubleCol( cfbam::ICFBamDoubleColObj* Obj ) = 0;
