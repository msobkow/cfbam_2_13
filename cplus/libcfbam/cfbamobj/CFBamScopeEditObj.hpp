...
// Description: C++18 edit object instance specification for CFBam Scope.
...
namespace cfbam {
	...
	class CFBamScopeEditObj
	: public virtual ICFBamScopeEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
		cfbam::ICFBamScopeObj* orig;
		cfbam::CFBamScopeBuff* buff;
		cfsec::ICFSecSecUserObj* createdBy = NULL;
		cfsec::ICFSecSecUserObj* updatedBy = NULL;
	public:
		CFBamScopeEditObj( cfbam::ICFBamScopeObj* argOrig );
		virtual ~CFBamScopeEditObj();
		...
		virtual cfbam::ICFBamScopeTableObj* getScopeTable();

		virtual cfbam::ICFBamScopeEditObj* getEdit();

		virtual cfbam::ICFBamScopeEditObj* getScopeEdit();

		virtual ICFBamScopeEditObj* beginEdit();

		virtual void endEdit();

		virtual cfbam::ICFBamScopeObj* getOrig();

		virtual cfbam::ICFBamScopeObj* getOrigAsScope();
		...
		inline cfbam::CFBamScopeBuff* getScopeBuff() {
			...
			return( static_cast<cfbam::CFBamScopeBuff*>( buff ) );
		};
		...
		virtual cfbam::CFBamScopePKey* getPKey();
		virtual void setPKey( cfbam::CFBamScopePKey* value );
