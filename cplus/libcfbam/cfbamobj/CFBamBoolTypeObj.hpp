...
// Description: C++18 base object instance specification for CFBam BoolType.
...
namespace cfbam {
	...
	class CFBamBoolTypeObj
	: public CFBamBoolDefObj,
	  public virtual ICFBamBoolTypeObj
	{
	protected:
	public:
		...
		CFBamBoolTypeObj();
		CFBamBoolTypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamBoolTypeObj();
