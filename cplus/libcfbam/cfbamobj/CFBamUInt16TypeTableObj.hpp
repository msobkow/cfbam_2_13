...
namespace cfbam {
	...
	class CFBamUInt16TypeTableObj
	: public virtual ICFBamUInt16TypeTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16TypeObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16TypeObj*>* allUInt16Type;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamUInt16TypeObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16TypeObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16TypeObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16TypeObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16TypeObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16TypeObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16TypeObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16TypeObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamUInt16TypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16TypeObj*>*>* indexBySchemaIdx;
	...
	public:
		...
		CFBamUInt16TypeTableObj();
		CFBamUInt16TypeTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamUInt16TypeTableObj();
		...
		virtual cfbam::ICFBamUInt16TypeObj* newInstance();

		virtual cfbam::ICFBamUInt16TypeEditObj* newEditInstance( cfbam::ICFBamUInt16TypeObj* orig );

		virtual cfbam::ICFBamUInt16TypeObj* realizeUInt16Type( cfbam::ICFBamUInt16TypeObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeUInt16Type( cfbam::ICFBamUInt16TypeObj* Obj );
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );
		virtual cfbam::ICFBamUInt16TypeObj* createUInt16Type( cfbam::ICFBamUInt16TypeEditObj* Obj );

		virtual cfbam::ICFBamUInt16TypeObj* readUInt16Type( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamUInt16TypeObj* lockUInt16Type( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamUInt16TypeObj*> readAllUInt16Type( bool forceRead = false );

		virtual cfbam::ICFBamUInt16TypeObj* readUInt16TypeByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamUInt16TypeObj* readUInt16TypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt16TypeObj*> readUInt16TypeByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt16TypeObj*> readUInt16TypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt16TypeObj*> readUInt16TypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt16TypeObj*> readUInt16TypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt16TypeObj*> readUInt16TypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt16TypeObj*> readUInt16TypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt16TypeObj*> readUInt16TypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt16TypeObj*> readUInt16TypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId,
			bool forceRead = false );

		virtual cfbam::ICFBamUInt16TypeObj* readCachedUInt16Type( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamUInt16TypeObj* readCachedUInt16TypeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamUInt16TypeObj* readCachedUInt16TypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamUInt16TypeObj*> readCachedUInt16TypeByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamUInt16TypeObj*> readCachedUInt16TypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamUInt16TypeObj*> readCachedUInt16TypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamUInt16TypeObj*> readCachedUInt16TypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamUInt16TypeObj*> readCachedUInt16TypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamUInt16TypeObj*> readCachedUInt16TypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamUInt16TypeObj*> readCachedUInt16TypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamUInt16TypeObj*> readCachedUInt16TypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual cfbam::ICFBamUInt16TypeObj* updateUInt16Type( cfbam::ICFBamUInt16TypeEditObj* Obj );

		virtual void deleteUInt16Type( cfbam::ICFBamUInt16TypeEditObj* Obj );

		virtual void deleteUInt16TypeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteUInt16TypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteUInt16TypeByValTentIdx( const int64_t TenantId );

		virtual void deleteUInt16TypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteUInt16TypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteUInt16TypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteUInt16TypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteUInt16TypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteUInt16TypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteUInt16TypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual cfbam::ICFBamUInt16TypeObj* moveUpUInt16Type( cfbam::ICFBamUInt16TypeObj* Obj );

		virtual cfbam::ICFBamUInt16TypeObj* moveDownUInt16Type( cfbam::ICFBamUInt16TypeObj* Obj );

		virtual void reallyDetachFromIndexesUInt16Type( cfbam::ICFBamUInt16TypeObj* Obj );
