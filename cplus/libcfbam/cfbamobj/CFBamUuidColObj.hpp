...
// Description: C++18 base object instance specification for CFBam UuidCol.
...
namespace cfbam {
	...
	class CFBamUuidColObj
	: public CFBamUuidDefObj,
	  public virtual ICFBamUuidColObj
	{
	protected:
	public:
		...
		CFBamUuidColObj();
		CFBamUuidColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamUuidColObj();
