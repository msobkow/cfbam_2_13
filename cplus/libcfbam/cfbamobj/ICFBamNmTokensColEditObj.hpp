...
// Description: C++18 Instance Edit Object interface for CFBam NmTokensCol.
...
namespace cfbam {
	...
	class ICFBamNmTokensColEditObj
	: public virtual cfbam::ICFBamNmTokensDefEditObj,
	  public virtual cfbam::ICFBamNmTokensColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamNmTokensColEditObj();
		virtual ~ICFBamNmTokensColEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamNmTokensColBuff* getNmTokensColBuff() {
			return( static_cast<cfbam::CFBamNmTokensColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamNmTokensColBuff* getNmTokensColEditBuff() {
			return( dynamic_cast<cfbam::CFBamNmTokensColBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamNmTokensColObj* getOrigAsNmTokensCol() = 0;
