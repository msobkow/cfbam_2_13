...
namespace cfbam {
	...
	{
	public:
		ICFBamServerMethodTableObj();
		virtual ~ICFBamServerMethodTableObj();
		...
		virtual cfbam::ICFBamServerMethodObj* newInstance() = 0;

		virtual cfbam::ICFBamServerMethodEditObj* newEditInstance( cfbam::ICFBamServerMethodObj* orig ) = 0;

		virtual cfbam::ICFBamServerMethodObj* realizeServerMethod( cfbam::ICFBamServerMethodObj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByTenantIdx( const int64_t TenantId ) = 0;
		virtual void reallyDeepDisposeServerMethod( cfbam::ICFBamServerMethodObj* Obj ) = 0;
		...
		virtual cfbam::ICFBamServerMethodObj* createServerMethod( cfbam::ICFBamServerMethodEditObj* Obj ) = 0;

		virtual cfbam::ICFBamServerMethodObj* readServerMethod( cfbam::CFBamScopePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamServerMethodObj* lockServerMethod( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamServerMethodObj*> readAllServerMethod( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamServerMethodObj* readCachedServerMethod( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual cfbam::ICFBamServerMethodObj* readCachedServerMethodByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamServerMethodObj*> readCachedServerMethodByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamServerMethodObj* updateServerMethod( cfbam::ICFBamServerMethodEditObj* Obj ) = 0;

		virtual void deleteServerMethod( cfbam::ICFBamServerMethodEditObj* Obj ) = 0;

		virtual void deleteServerMethodByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deleteServerMethodByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesServerMethod( cfbam::ICFBamServerMethodObj* Obj ) = 0;
