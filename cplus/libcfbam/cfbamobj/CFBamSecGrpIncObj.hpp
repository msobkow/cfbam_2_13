...
// Description: C++18 base object instance specification for CFBam SecGrpInc.
...
namespace cfbam {
	...
	class CFBamSecGrpIncObj
	: public virtual ICFBamSecGrpIncObj,
	...
	public:
		...
		CFBamSecGrpIncObj();
		CFBamSecGrpIncObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamSecGrpIncObj();
