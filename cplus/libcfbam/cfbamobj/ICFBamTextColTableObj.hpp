...
namespace cfbam {
	...
	{
	public:
		ICFBamTextColTableObj();
		virtual ~ICFBamTextColTableObj();
		...
		virtual cfbam::ICFBamTextColObj* newInstance() = 0;

		virtual cfbam::ICFBamTextColEditObj* newEditInstance( cfbam::ICFBamTextColObj* orig ) = 0;

		virtual cfbam::ICFBamTextColObj* realizeTextCol( cfbam::ICFBamTextColObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeTextCol( cfbam::ICFBamTextColObj* Obj ) = 0;
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId ) = 0;
		virtual cfbam::ICFBamTextColObj* createTextCol( cfbam::ICFBamTextColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamTextColObj* readTextCol( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTextColObj* lockTextCol( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamTextColObj*> readAllTextCol( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamTextColObj* readCachedTextCol( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamTextColObj*> readCachedTextColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTextColObj* updateTextCol( cfbam::ICFBamTextColEditObj* Obj ) = 0;

		virtual void deleteTextCol( cfbam::ICFBamTextColEditObj* Obj ) = 0;
		...
		virtual void deleteTextColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTextColObj* moveUpTextCol( cfbam::ICFBamTextColObj* Obj ) = 0;

		virtual cfbam::ICFBamTextColObj* moveDownTextCol( cfbam::ICFBamTextColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesTextCol( cfbam::ICFBamTextColObj* Obj ) = 0;
