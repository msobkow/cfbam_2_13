...
namespace cfbam {
	...
	{
	public:
		ICFBamTokenColTableObj();
		virtual ~ICFBamTokenColTableObj();
		...
		virtual cfbam::ICFBamTokenColObj* newInstance() = 0;

		virtual cfbam::ICFBamTokenColEditObj* newEditInstance( cfbam::ICFBamTokenColObj* orig ) = 0;

		virtual cfbam::ICFBamTokenColObj* realizeTokenCol( cfbam::ICFBamTokenColObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeTokenCol( cfbam::ICFBamTokenColObj* Obj ) = 0;
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId ) = 0;
		virtual cfbam::ICFBamTokenColObj* createTokenCol( cfbam::ICFBamTokenColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamTokenColObj* readTokenCol( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTokenColObj* lockTokenCol( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamTokenColObj*> readAllTokenCol( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamTokenColObj* readCachedTokenCol( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamTokenColObj*> readCachedTokenColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTokenColObj* updateTokenCol( cfbam::ICFBamTokenColEditObj* Obj ) = 0;

		virtual void deleteTokenCol( cfbam::ICFBamTokenColEditObj* Obj ) = 0;
		...
		virtual void deleteTokenColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTokenColObj* moveUpTokenCol( cfbam::ICFBamTokenColObj* Obj ) = 0;

		virtual cfbam::ICFBamTokenColObj* moveDownTokenCol( cfbam::ICFBamTokenColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesTokenCol( cfbam::ICFBamTokenColObj* Obj ) = 0;
