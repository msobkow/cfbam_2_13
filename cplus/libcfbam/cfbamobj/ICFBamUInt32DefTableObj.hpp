...
namespace cfbam {
	...
	{
	public:
		ICFBamUInt32DefTableObj();
		virtual ~ICFBamUInt32DefTableObj();
		...
		virtual cfbam::ICFBamUInt32DefObj* newInstance() = 0;

		virtual cfbam::ICFBamUInt32DefEditObj* newEditInstance( cfbam::ICFBamUInt32DefObj* orig ) = 0;

		virtual cfbam::ICFBamUInt32DefObj* realizeUInt32Def( cfbam::ICFBamUInt32DefObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeUInt32Def( cfbam::ICFBamUInt32DefObj* Obj ) = 0;
		virtual cfbam::ICFBamUInt32DefObj* createUInt32Def( cfbam::ICFBamUInt32DefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamUInt32DefObj* readUInt32Def( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamUInt32DefObj* lockUInt32Def( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamUInt32DefObj*> readAllUInt32Def( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamUInt32DefObj* readCachedUInt32Def( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamUInt32DefObj*> readCachedUInt32DefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUInt32DefObj* updateUInt32Def( cfbam::ICFBamUInt32DefEditObj* Obj ) = 0;

		virtual void deleteUInt32Def( cfbam::ICFBamUInt32DefEditObj* Obj ) = 0;
		...
		virtual void deleteUInt32DefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUInt32DefObj* moveUpUInt32Def( cfbam::ICFBamUInt32DefObj* Obj ) = 0;

		virtual cfbam::ICFBamUInt32DefObj* moveDownUInt32Def( cfbam::ICFBamUInt32DefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesUInt32Def( cfbam::ICFBamUInt32DefObj* Obj ) = 0;
