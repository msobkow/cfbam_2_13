...
namespace cfbam {
	...
	{
	public:
		ICFBamNmTokensDefTableObj();
		virtual ~ICFBamNmTokensDefTableObj();
		...
		virtual cfbam::ICFBamNmTokensDefObj* newInstance() = 0;

		virtual cfbam::ICFBamNmTokensDefEditObj* newEditInstance( cfbam::ICFBamNmTokensDefObj* orig ) = 0;

		virtual cfbam::ICFBamNmTokensDefObj* realizeNmTokensDef( cfbam::ICFBamNmTokensDefObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeNmTokensDef( cfbam::ICFBamNmTokensDefObj* Obj ) = 0;
		virtual cfbam::ICFBamNmTokensDefObj* createNmTokensDef( cfbam::ICFBamNmTokensDefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamNmTokensDefObj* readNmTokensDef( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamNmTokensDefObj* lockNmTokensDef( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamNmTokensDefObj*> readAllNmTokensDef( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamNmTokensDefObj* readCachedNmTokensDef( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamNmTokensDefObj*> readCachedNmTokensDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamNmTokensDefObj* updateNmTokensDef( cfbam::ICFBamNmTokensDefEditObj* Obj ) = 0;

		virtual void deleteNmTokensDef( cfbam::ICFBamNmTokensDefEditObj* Obj ) = 0;
		...
		virtual void deleteNmTokensDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamNmTokensDefObj* moveUpNmTokensDef( cfbam::ICFBamNmTokensDefObj* Obj ) = 0;

		virtual cfbam::ICFBamNmTokensDefObj* moveDownNmTokensDef( cfbam::ICFBamNmTokensDefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesNmTokensDef( cfbam::ICFBamNmTokensDefObj* Obj ) = 0;
