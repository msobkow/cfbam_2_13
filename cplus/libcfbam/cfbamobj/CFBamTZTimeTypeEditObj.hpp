...
// Description: C++18 edit object instance specification for CFBam TZTimeType.
...
namespace cfbam {
	...
	class CFBamTZTimeTypeEditObj
	: public CFBamTZTimeDefEditObj,
	  public virtual ICFBamTZTimeTypeEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamTZTimeTypeEditObj( cfbam::ICFBamTZTimeTypeObj* argOrig );
		virtual ~CFBamTZTimeTypeEditObj();
		...
		virtual cfbam::ICFBamTZTimeTypeTableObj* getTZTimeTypeTable();

		virtual cfbam::ICFBamTZTimeTypeEditObj* getTZTimeTypeEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamTZTimeTypeObj* getOrigAsTZTimeType();

		virtual cfbam::CFBamValueBuff* getBuff();
		virtual void setBuff( cfbam::CFBamValueBuff* value );

		inline cfbam::CFBamTZTimeTypeBuff* getTZTimeTypeBuff() {
			// Buff is always instantiated when constructed over an original object
			return( static_cast<cfbam::CFBamTZTimeTypeBuff*>( buff ) );
		};

		inline cfbam::CFBamTZTimeTypeBuff* getTZTimeTypeEditBuff() {
			// Buff is always instantiated when constructed over an original object
