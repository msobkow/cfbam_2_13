...
// Description: C++18 base object instance specification for CFBam EnumTag.
...
namespace cfbam {
	...
	class CFBamEnumTagObj
	: public virtual ICFBamEnumTagObj
	{
	protected:
		cfsec::ICFSecSecUserObj* createdBy = NULL;
		cfsec::ICFSecSecUserObj* updatedBy = NULL;
		bool isNew;
		cfbam::ICFBamEnumTagEditObj* edit;
	...
	public:
		...
		CFBamEnumTagObj();
		CFBamEnumTagObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamEnumTagObj();
		...
		virtual cfbam::ICFBamEnumTagObj* realize();
		...
		virtual cfbam::ICFBamEnumTagEditObj* beginEdit();
