...
// Description: C++18 edit object instance specification for CFBam UInt32Type.
...
namespace cfbam {
	...
	class CFBamUInt32TypeEditObj
	: public CFBamUInt32DefEditObj,
	  public virtual ICFBamUInt32TypeEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamUInt32TypeEditObj( cfbam::ICFBamUInt32TypeObj* argOrig );
		virtual ~CFBamUInt32TypeEditObj();
		...
		virtual cfbam::ICFBamUInt32TypeTableObj* getUInt32TypeTable();

		virtual cfbam::ICFBamUInt32TypeEditObj* getUInt32TypeEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamUInt32TypeObj* getOrigAsUInt32Type();

		virtual cfbam::CFBamValueBuff* getBuff();
		virtual void setBuff( cfbam::CFBamValueBuff* value );

		inline cfbam::CFBamUInt32TypeBuff* getUInt32TypeBuff() {
			// Buff is always instantiated when constructed over an original object
			return( static_cast<cfbam::CFBamUInt32TypeBuff*>( buff ) );
		};

		inline cfbam::CFBamUInt32TypeBuff* getUInt32TypeEditBuff() {
			// Buff is always instantiated when constructed over an original object
