...
namespace cfbam {
	...
	class CFBamBlobDefTableObj
	: public virtual ICFBamBlobDefTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBlobDefObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBlobDefObj*>* allBlobDef;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamBlobDefObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBlobDefObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBlobDefObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBlobDefObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBlobDefObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBlobDefObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBlobDefObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBlobDefObj*>*>* indexByContNextIdx;
	...
	public:
		...
		CFBamBlobDefTableObj();
		CFBamBlobDefTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamBlobDefTableObj();
		...
		virtual cfbam::ICFBamBlobDefObj* newInstance();

		virtual cfbam::ICFBamBlobDefEditObj* newEditInstance( cfbam::ICFBamBlobDefObj* orig );

		virtual cfbam::ICFBamBlobDefObj* realizeBlobDef( cfbam::ICFBamBlobDefObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeBlobDef( cfbam::ICFBamBlobDefObj* Obj );
		virtual cfbam::ICFBamBlobDefObj* createBlobDef( cfbam::ICFBamBlobDefEditObj* Obj );

		virtual cfbam::ICFBamBlobDefObj* readBlobDef( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamBlobDefObj* lockBlobDef( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamBlobDefObj*> readAllBlobDef( bool forceRead = false );

		virtual cfbam::ICFBamBlobDefObj* readBlobDefByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamBlobDefObj* readBlobDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamBlobDefObj*> readBlobDefByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamBlobDefObj*> readBlobDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamBlobDefObj*> readBlobDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamBlobDefObj*> readBlobDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamBlobDefObj*> readBlobDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamBlobDefObj*> readBlobDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamBlobDefObj*> readBlobDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual cfbam::ICFBamBlobDefObj* readCachedBlobDef( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamBlobDefObj* readCachedBlobDefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamBlobDefObj* readCachedBlobDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamBlobDefObj*> readCachedBlobDefByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamBlobDefObj*> readCachedBlobDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamBlobDefObj*> readCachedBlobDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamBlobDefObj*> readCachedBlobDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamBlobDefObj*> readCachedBlobDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamBlobDefObj*> readCachedBlobDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamBlobDefObj*> readCachedBlobDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamBlobDefObj* updateBlobDef( cfbam::ICFBamBlobDefEditObj* Obj );

		virtual void deleteBlobDef( cfbam::ICFBamBlobDefEditObj* Obj );

		virtual void deleteBlobDefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteBlobDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteBlobDefByValTentIdx( const int64_t TenantId );

		virtual void deleteBlobDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteBlobDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteBlobDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteBlobDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteBlobDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteBlobDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamBlobDefObj* moveUpBlobDef( cfbam::ICFBamBlobDefObj* Obj );

		virtual cfbam::ICFBamBlobDefObj* moveDownBlobDef( cfbam::ICFBamBlobDefObj* Obj );

		virtual void reallyDetachFromIndexesBlobDef( cfbam::ICFBamBlobDefObj* Obj );
