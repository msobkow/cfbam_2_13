...
// Description: C++18 edit object instance specification for CFBam Tld.
...
namespace cfbam {
	...
	class CFBamTldEditObj
	: public virtual ICFBamTldEditObj,
	  public virtual cfint::ICFIntTldEditObj
	{
	public:
	...
	public:
		CFBamTldEditObj( cfint::ICFIntTldObj* argOrig );
		virtual ~CFBamTldEditObj();
