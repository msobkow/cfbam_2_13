...
// Description: C++18 Instance Edit Object interface for CFBam ClearDep.
...
namespace cfbam {
	...
	public:
		...
		virtual ~ICFBamClearDepEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamClearDepBuff* getClearDepBuff() {
			return( static_cast<cfbam::CFBamClearDepBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamClearDepBuff* getClearDepEditBuff() {
			return( dynamic_cast<cfbam::CFBamClearDepBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamClearDepObj* getOrigAsClearDep() = 0;

		virtual cfbam::ICFBamScopeEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamRelationObj* getRequiredLookupRelation( bool forceRead = false ) = 0;
		virtual void setRequiredLookupRelation( cfbam::ICFBamRelationObj* value ) = 0;
