...
namespace cfbam {
	...
	class CFBamNmTokensColTableObj
	: public virtual ICFBamNmTokensColTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensColObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensColObj*>* allNmTokensCol;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamNmTokensColObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensColObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensColObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensColObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensColObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensColObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensColObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensColObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamNmTokensColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensColObj*>*>* indexByTableIdx;
	...
	public:
		...
		CFBamNmTokensColTableObj();
		CFBamNmTokensColTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamNmTokensColTableObj();
		...
		virtual cfbam::ICFBamNmTokensColObj* newInstance();

		virtual cfbam::ICFBamNmTokensColEditObj* newEditInstance( cfbam::ICFBamNmTokensColObj* orig );

		virtual cfbam::ICFBamNmTokensColObj* realizeNmTokensCol( cfbam::ICFBamNmTokensColObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeNmTokensCol( cfbam::ICFBamNmTokensColObj* Obj );
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId );
		virtual cfbam::ICFBamNmTokensColObj* createNmTokensCol( cfbam::ICFBamNmTokensColEditObj* Obj );

		virtual cfbam::ICFBamNmTokensColObj* readNmTokensCol( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamNmTokensColObj* lockNmTokensCol( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamNmTokensColObj*> readAllNmTokensCol( bool forceRead = false );

		virtual cfbam::ICFBamNmTokensColObj* readNmTokensColByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamNmTokensColObj* readNmTokensColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokensColObj*> readNmTokensColByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokensColObj*> readNmTokensColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokensColObj*> readNmTokensColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokensColObj*> readNmTokensColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokensColObj*> readNmTokensColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokensColObj*> readNmTokensColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokensColObj*> readNmTokensColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokensColObj*> readNmTokensColByTableIdx( const int64_t TenantId,
			const int64_t TableId,
			bool forceRead = false );

		virtual cfbam::ICFBamNmTokensColObj* readCachedNmTokensCol( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamNmTokensColObj* readCachedNmTokensColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamNmTokensColObj* readCachedNmTokensColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamNmTokensColObj*> readCachedNmTokensColByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamNmTokensColObj*> readCachedNmTokensColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamNmTokensColObj*> readCachedNmTokensColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamNmTokensColObj*> readCachedNmTokensColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamNmTokensColObj*> readCachedNmTokensColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamNmTokensColObj*> readCachedNmTokensColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamNmTokensColObj*> readCachedNmTokensColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamNmTokensColObj*> readCachedNmTokensColByTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual cfbam::ICFBamNmTokensColObj* updateNmTokensCol( cfbam::ICFBamNmTokensColEditObj* Obj );

		virtual void deleteNmTokensCol( cfbam::ICFBamNmTokensColEditObj* Obj );

		virtual void deleteNmTokensColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteNmTokensColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteNmTokensColByValTentIdx( const int64_t TenantId );

		virtual void deleteNmTokensColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteNmTokensColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteNmTokensColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteNmTokensColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteNmTokensColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteNmTokensColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteNmTokensColByTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual cfbam::ICFBamNmTokensColObj* moveUpNmTokensCol( cfbam::ICFBamNmTokensColObj* Obj );

		virtual cfbam::ICFBamNmTokensColObj* moveDownNmTokensCol( cfbam::ICFBamNmTokensColObj* Obj );

		virtual void reallyDetachFromIndexesNmTokensCol( cfbam::ICFBamNmTokensColObj* Obj );
