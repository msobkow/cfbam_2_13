...
// Description: C++18 Instance Edit Object interface for CFBam UInt64Def.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamAtomEditObj,
	  public virtual cfbam::ICFBamUInt64DefObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamUInt64DefEditObj();
		virtual ~ICFBamUInt64DefEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamUInt64DefBuff* getUInt64DefBuff() {
			return( static_cast<cfbam::CFBamUInt64DefBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamUInt64DefBuff* getUInt64DefEditBuff() {
			return( dynamic_cast<cfbam::CFBamUInt64DefBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamUInt64DefObj* getOrigAsUInt64Def() = 0;

		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual bool isOptionalInitValueNull() = 0;
		virtual const uint64_t getOptionalInitValueValue() = 0;
		virtual const uint64_t* getOptionalInitValueReference() = 0;
		virtual void setOptionalInitValueNull() = 0;
		virtual void setOptionalInitValueValue( const uint64_t value ) = 0;

		virtual bool isOptionalMinValueNull() = 0;
		virtual const uint64_t getOptionalMinValueValue() = 0;
		virtual const uint64_t* getOptionalMinValueReference() = 0;
		virtual void setOptionalMinValueNull() = 0;
		virtual void setOptionalMinValueValue( const uint64_t value ) = 0;

		virtual bool isOptionalMaxValueNull() = 0;
		virtual const uint64_t getOptionalMaxValueValue() = 0;
		virtual const uint64_t* getOptionalMaxValueReference() = 0;
		virtual void setOptionalMaxValueNull() = 0;
		virtual void setOptionalMaxValueValue( const uint64_t value ) = 0;
