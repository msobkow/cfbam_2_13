...
// Description: C++18 Instance Edit Object interface for CFBam BoolType.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamBoolDefEditObj,
	  public virtual cfbam::ICFBamBoolTypeObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamBoolTypeEditObj();
		virtual ~ICFBamBoolTypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamBoolTypeBuff* getBoolTypeBuff() {
			return( static_cast<cfbam::CFBamBoolTypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamBoolTypeBuff* getBoolTypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamBoolTypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamBoolTypeObj* getOrigAsBoolType() = 0;
