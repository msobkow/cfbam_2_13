...
// Description: C++18 base object instance specification for CFBam Int16Type.
...
namespace cfbam {
	...
	class CFBamInt16TypeObj
	: public CFBamInt16DefObj,
	  public virtual ICFBamInt16TypeObj
	{
	protected:
	public:
		...
		CFBamInt16TypeObj();
		CFBamInt16TypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamInt16TypeObj();
