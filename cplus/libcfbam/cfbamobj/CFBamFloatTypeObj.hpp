...
// Description: C++18 base object instance specification for CFBam FloatType.
...
namespace cfbam {
	...
	class CFBamFloatTypeObj
	: public CFBamFloatDefObj,
	  public virtual ICFBamFloatTypeObj
	{
	protected:
	public:
		...
		CFBamFloatTypeObj();
		CFBamFloatTypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamFloatTypeObj();
