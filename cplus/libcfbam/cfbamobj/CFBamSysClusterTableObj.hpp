...
namespace cfbam {
	...
	class CFBamSysClusterTableObj
	: public virtual ICFBamSysClusterTableObj,
	  public virtual cfsec::ICFSecSysClusterTableObj,
	  public virtual cfint::ICFIntSysClusterTableObj
	{
	protected:
	...
	public:
		...
		CFBamSysClusterTableObj();
		CFBamSysClusterTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamSysClusterTableObj();
