...
namespace cfbam {
	...
	class CFBamNmTokenDefTableObj
	: public virtual ICFBamNmTokenDefTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenDefObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenDefObj*>* allNmTokenDef;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamNmTokenDefObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenDefObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenDefObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenDefObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenDefObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenDefObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenDefObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenDefObj*>*>* indexByContNextIdx;
	...
	public:
		...
		CFBamNmTokenDefTableObj();
		CFBamNmTokenDefTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamNmTokenDefTableObj();
		...
		virtual cfbam::ICFBamNmTokenDefObj* newInstance();

		virtual cfbam::ICFBamNmTokenDefEditObj* newEditInstance( cfbam::ICFBamNmTokenDefObj* orig );

		virtual cfbam::ICFBamNmTokenDefObj* realizeNmTokenDef( cfbam::ICFBamNmTokenDefObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeNmTokenDef( cfbam::ICFBamNmTokenDefObj* Obj );
		virtual cfbam::ICFBamNmTokenDefObj* createNmTokenDef( cfbam::ICFBamNmTokenDefEditObj* Obj );

		virtual cfbam::ICFBamNmTokenDefObj* readNmTokenDef( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamNmTokenDefObj* lockNmTokenDef( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamNmTokenDefObj*> readAllNmTokenDef( bool forceRead = false );

		virtual cfbam::ICFBamNmTokenDefObj* readNmTokenDefByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamNmTokenDefObj* readNmTokenDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokenDefObj*> readNmTokenDefByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokenDefObj*> readNmTokenDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokenDefObj*> readNmTokenDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokenDefObj*> readNmTokenDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokenDefObj*> readNmTokenDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokenDefObj*> readNmTokenDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokenDefObj*> readNmTokenDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual cfbam::ICFBamNmTokenDefObj* readCachedNmTokenDef( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamNmTokenDefObj* readCachedNmTokenDefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamNmTokenDefObj* readCachedNmTokenDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamNmTokenDefObj*> readCachedNmTokenDefByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamNmTokenDefObj*> readCachedNmTokenDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamNmTokenDefObj*> readCachedNmTokenDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamNmTokenDefObj*> readCachedNmTokenDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamNmTokenDefObj*> readCachedNmTokenDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamNmTokenDefObj*> readCachedNmTokenDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamNmTokenDefObj*> readCachedNmTokenDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamNmTokenDefObj* updateNmTokenDef( cfbam::ICFBamNmTokenDefEditObj* Obj );

		virtual void deleteNmTokenDef( cfbam::ICFBamNmTokenDefEditObj* Obj );

		virtual void deleteNmTokenDefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteNmTokenDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteNmTokenDefByValTentIdx( const int64_t TenantId );

		virtual void deleteNmTokenDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteNmTokenDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteNmTokenDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteNmTokenDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteNmTokenDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteNmTokenDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamNmTokenDefObj* moveUpNmTokenDef( cfbam::ICFBamNmTokenDefObj* Obj );

		virtual cfbam::ICFBamNmTokenDefObj* moveDownNmTokenDef( cfbam::ICFBamNmTokenDefObj* Obj );

		virtual void reallyDetachFromIndexesNmTokenDef( cfbam::ICFBamNmTokenDefObj* Obj );
