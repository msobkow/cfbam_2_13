...
// Description: C++18 edit object instance specification for CFBam EnumType.
...
namespace cfbam {
	...
	class CFBamEnumTypeEditObj
	: public CFBamEnumDefEditObj,
	  public virtual ICFBamEnumTypeEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamEnumTypeEditObj( cfbam::ICFBamEnumTypeObj* argOrig );
		virtual ~CFBamEnumTypeEditObj();
		...
		virtual cfbam::ICFBamEnumTypeTableObj* getEnumTypeTable();

		virtual cfbam::ICFBamEnumTypeEditObj* getEnumTypeEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamEnumTypeObj* getOrigAsEnumType();

		virtual cfbam::CFBamValueBuff* getBuff();
		virtual void setBuff( cfbam::CFBamValueBuff* value );

		inline cfbam::CFBamEnumTypeBuff* getEnumTypeBuff() {
			// Buff is always instantiated when constructed over an original object
			return( static_cast<cfbam::CFBamEnumTypeBuff*>( buff ) );
		};

		inline cfbam::CFBamEnumTypeBuff* getEnumTypeEditBuff() {
			// Buff is always instantiated when constructed over an original object
