...
// Description: C++18 base object instance specification for CFBam TSecGroup.
...
namespace cfbam {
	...
	class CFBamTSecGroupObj
	: public virtual ICFBamTSecGroupObj,
	...
	public:
		...
		CFBamTSecGroupObj();
		CFBamTSecGroupObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTSecGroupObj();
