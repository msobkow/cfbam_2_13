...
// Description: C++18 Object interface for CFBam TZTimestampType.
...
namespace cfbam {
	...
	public:
		...
		virtual ~ICFBamTZTimestampTypeObj();
		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamTZTimestampTypeEditObj* getTZTimestampTypeEdit() = 0;
