...
// Description: C++18 Instance Edit Object interface for CFBam Int64Type.
...
namespace cfbam {
	...
	public:
		...
		virtual ~ICFBamInt64TypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamInt64TypeBuff* getInt64TypeBuff() {
			return( static_cast<cfbam::CFBamInt64TypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamInt64TypeBuff* getInt64TypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamInt64TypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamInt64TypeObj* getOrigAsInt64Type() = 0;
