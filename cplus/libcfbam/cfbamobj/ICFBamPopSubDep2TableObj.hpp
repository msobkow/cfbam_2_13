...
namespace cfbam {
	...
	{
	public:
		ICFBamPopSubDep2TableObj();
		virtual ~ICFBamPopSubDep2TableObj();
		...
		virtual cfbam::ICFBamPopSubDep2Obj* newInstance() = 0;

		virtual cfbam::ICFBamPopSubDep2EditObj* newEditInstance( cfbam::ICFBamPopSubDep2Obj* orig ) = 0;

		virtual cfbam::ICFBamPopSubDep2Obj* realizePopSubDep2( cfbam::ICFBamPopSubDep2Obj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByTenantIdx( const int64_t TenantId ) = 0;
		virtual void reallyDeepDisposePopSubDep2( cfbam::ICFBamPopSubDep2Obj* Obj ) = 0;
		...
		virtual cfbam::ICFBamPopSubDep2Obj* createPopSubDep2( cfbam::ICFBamPopSubDep2EditObj* Obj ) = 0;

		virtual cfbam::ICFBamPopSubDep2Obj* readPopSubDep2( cfbam::CFBamScopePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamPopSubDep2Obj* lockPopSubDep2( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamPopSubDep2Obj*> readAllPopSubDep2( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamPopSubDep2Obj* readCachedPopSubDep2( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual cfbam::ICFBamPopSubDep2Obj* readCachedPopSubDep2ByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamPopSubDep2Obj*> readCachedPopSubDep2ByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamPopSubDep2Obj* updatePopSubDep2( cfbam::ICFBamPopSubDep2EditObj* Obj ) = 0;

		virtual void deletePopSubDep2( cfbam::ICFBamPopSubDep2EditObj* Obj ) = 0;

		virtual void deletePopSubDep2ByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deletePopSubDep2ByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesPopSubDep2( cfbam::ICFBamPopSubDep2Obj* Obj ) = 0;
