...
// Description: C++18 edit object instance specification for CFBam TokenCol.
...
namespace cfbam {
	...
	class CFBamTokenColEditObj
	: public CFBamTokenDefEditObj,
	  public virtual ICFBamTokenColEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamTokenColEditObj( cfbam::ICFBamTokenColObj* argOrig );
		virtual ~CFBamTokenColEditObj();
		...
		virtual cfbam::ICFBamTokenColTableObj* getTokenColTable();

		virtual cfbam::ICFBamTokenColEditObj* getTokenColEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamTokenColObj* getOrigAsTokenCol();
		...
		inline cfbam::CFBamTokenColBuff* getTokenColBuff() {
			...
			return( static_cast<cfbam::CFBamTokenColBuff*>( buff ) );
		};
