...
// Description: C++18 edit object instance specification for CFBam Int16Type.
...
namespace cfbam {
	...
	class CFBamInt16TypeEditObj
	: public CFBamInt16DefEditObj,
	  public virtual ICFBamInt16TypeEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamInt16TypeEditObj( cfbam::ICFBamInt16TypeObj* argOrig );
		virtual ~CFBamInt16TypeEditObj();
		...
		virtual cfbam::ICFBamInt16TypeTableObj* getInt16TypeTable();

		virtual cfbam::ICFBamInt16TypeEditObj* getInt16TypeEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamInt16TypeObj* getOrigAsInt16Type();

		virtual cfbam::CFBamValueBuff* getBuff();
		virtual void setBuff( cfbam::CFBamValueBuff* value );

		inline cfbam::CFBamInt16TypeBuff* getInt16TypeBuff() {
			// Buff is always instantiated when constructed over an original object
			return( static_cast<cfbam::CFBamInt16TypeBuff*>( buff ) );
		};

		inline cfbam::CFBamInt16TypeBuff* getInt16TypeEditBuff() {
			// Buff is always instantiated when constructed over an original object
