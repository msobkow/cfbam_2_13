...
// Description: C++18 base object instance specification for CFBam TSecGrpInc.
...
namespace cfbam {
	...
	class CFBamTSecGrpIncObj
	: public virtual ICFBamTSecGrpIncObj,
	...
	public:
		...
		CFBamTSecGrpIncObj();
		CFBamTSecGrpIncObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTSecGrpIncObj();
