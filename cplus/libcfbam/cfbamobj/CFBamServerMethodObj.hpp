...
// Description: C++18 base object instance specification for CFBam ServerMethod.
...
namespace cfbam {
	...
	class CFBamServerMethodObj
	: public CFBamScopeObj,
	  public virtual ICFBamServerMethodObj
	{
	protected:
	public:
		...
		CFBamServerMethodObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamServerMethodObj();
