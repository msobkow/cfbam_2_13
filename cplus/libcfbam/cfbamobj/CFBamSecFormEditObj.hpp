...
// Description: C++18 edit object instance specification for CFBam SecForm.
...
namespace cfbam {
	...
	class CFBamSecFormEditObj
	: public virtual ICFBamSecFormEditObj,
	  public virtual cfsec::ICFSecSecFormEditObj,
	  public virtual cfint::ICFIntSecFormEditObj
	{
	public:
	...
	public:
		CFBamSecFormEditObj( cfsec::ICFSecSecFormObj* argOrig );
		virtual ~CFBamSecFormEditObj();
