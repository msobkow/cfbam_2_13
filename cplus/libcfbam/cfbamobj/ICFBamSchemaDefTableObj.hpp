...
namespace cfbam {
	...
	{
	public:
		ICFBamSchemaDefTableObj();
		virtual ~ICFBamSchemaDefTableObj();
		...
		virtual cfbam::ICFBamSchemaDefObj* newInstance() = 0;

		virtual cfbam::ICFBamSchemaDefEditObj* newEditInstance( cfbam::ICFBamSchemaDefObj* orig ) = 0;

		virtual cfbam::ICFBamSchemaDefObj* realizeSchemaDef( cfbam::ICFBamSchemaDefObj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByTenantIdx( const int64_t TenantId ) = 0;
		virtual void reallyDeepDisposeSchemaDef( cfbam::ICFBamSchemaDefObj* Obj ) = 0;
		virtual void deepDisposeByCTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamSchemaDefObj* createSchemaDef( cfbam::ICFBamSchemaDefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamSchemaDefObj* readSchemaDef( cfbam::CFBamScopePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamSchemaDefObj* lockSchemaDef( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamSchemaDefObj*> readAllSchemaDef( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamSchemaDefObj* readCachedSchemaDef( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual cfbam::ICFBamSchemaDefObj* readCachedSchemaDefByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamSchemaDefObj*> readCachedSchemaDefByTenantIdx( const int64_t TenantId ) = 0;

		virtual std::vector<cfbam::ICFBamSchemaDefObj*> readCachedSchemaDefByCTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamSchemaDefObj* updateSchemaDef( cfbam::ICFBamSchemaDefEditObj* Obj ) = 0;

		virtual void deleteSchemaDef( cfbam::ICFBamSchemaDefEditObj* Obj ) = 0;

		virtual void deleteSchemaDefByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deleteSchemaDefByTenantIdx( const int64_t TenantId ) = 0;

		virtual void deleteSchemaDefByCTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesSchemaDef( cfbam::ICFBamSchemaDefObj* Obj ) = 0;
