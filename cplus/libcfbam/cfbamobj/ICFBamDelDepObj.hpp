...
// Description: C++18 Object interface for CFBam DelDep.
...
namespace cfbam {
	...
	public:
		ICFBamDelDepObj();
		virtual ~ICFBamDelDepObj();
		virtual cfbam::ICFBamScopeEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamDelDepEditObj* getDelDepEdit() = 0;

		inline cfbam::CFBamDelDepBuff* getDelDepBuff() {
			return( static_cast<cfbam::CFBamDelDepBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamDelDepBuff* getDelDepEditBuff() {
			return( dynamic_cast<cfbam::CFBamDelDepBuff*>( getBuff() ) );
		};
		...
		virtual const int64_t getRequiredRelationTenantId() = 0;
		virtual const int64_t* getRequiredRelationTenantIdReference() = 0;
