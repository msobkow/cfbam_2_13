...
// Description: C++18 base object instance specification for CFBam UInt32Type.
...
namespace cfbam {
	...
	class CFBamUInt32TypeObj
	: public CFBamUInt32DefObj,
	  public virtual ICFBamUInt32TypeObj
	{
	protected:
	public:
		...
		CFBamUInt32TypeObj();
		CFBamUInt32TypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamUInt32TypeObj();
