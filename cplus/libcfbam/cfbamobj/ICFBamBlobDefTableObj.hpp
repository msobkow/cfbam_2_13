...
namespace cfbam {
	...
	{
	public:
		ICFBamBlobDefTableObj();
		virtual ~ICFBamBlobDefTableObj();
		...
		virtual cfbam::ICFBamBlobDefObj* newInstance() = 0;

		virtual cfbam::ICFBamBlobDefEditObj* newEditInstance( cfbam::ICFBamBlobDefObj* orig ) = 0;

		virtual cfbam::ICFBamBlobDefObj* realizeBlobDef( cfbam::ICFBamBlobDefObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeBlobDef( cfbam::ICFBamBlobDefObj* Obj ) = 0;
		virtual cfbam::ICFBamBlobDefObj* createBlobDef( cfbam::ICFBamBlobDefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamBlobDefObj* readBlobDef( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamBlobDefObj* lockBlobDef( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamBlobDefObj*> readAllBlobDef( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamBlobDefObj* readCachedBlobDef( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamBlobDefObj*> readCachedBlobDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamBlobDefObj* updateBlobDef( cfbam::ICFBamBlobDefEditObj* Obj ) = 0;

		virtual void deleteBlobDef( cfbam::ICFBamBlobDefEditObj* Obj ) = 0;
		...
		virtual void deleteBlobDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamBlobDefObj* moveUpBlobDef( cfbam::ICFBamBlobDefObj* Obj ) = 0;

		virtual cfbam::ICFBamBlobDefObj* moveDownBlobDef( cfbam::ICFBamBlobDefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesBlobDef( cfbam::ICFBamBlobDefObj* Obj ) = 0;
