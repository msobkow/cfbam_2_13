...
// Description: C++18 Instance Edit Object interface for CFBam TZTimeCol.
...
namespace cfbam {
	...
	class ICFBamTZTimeColEditObj
	: public virtual cfbam::ICFBamTZTimeDefEditObj,
	  public virtual cfbam::ICFBamTZTimeColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamTZTimeColEditObj();
		virtual ~ICFBamTZTimeColEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamTZTimeColBuff* getTZTimeColBuff() {
			return( static_cast<cfbam::CFBamTZTimeColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamTZTimeColBuff* getTZTimeColEditBuff() {
			return( dynamic_cast<cfbam::CFBamTZTimeColBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamTZTimeColObj* getOrigAsTZTimeCol() = 0;
