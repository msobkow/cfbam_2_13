...
namespace cfbam {
	...
	class CFBamTZTimeDefTableObj
	: public virtual ICFBamTZTimeDefTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimeDefObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimeDefObj*>* allTZTimeDef;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamTZTimeDefObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimeDefObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimeDefObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimeDefObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimeDefObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimeDefObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimeDefObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimeDefObj*>*>* indexByContNextIdx;
	...
	public:
		...
		CFBamTZTimeDefTableObj();
		CFBamTZTimeDefTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamTZTimeDefTableObj();
		...
		virtual cfbam::ICFBamTZTimeDefObj* newInstance();

		virtual cfbam::ICFBamTZTimeDefEditObj* newEditInstance( cfbam::ICFBamTZTimeDefObj* orig );

		virtual cfbam::ICFBamTZTimeDefObj* realizeTZTimeDef( cfbam::ICFBamTZTimeDefObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeTZTimeDef( cfbam::ICFBamTZTimeDefObj* Obj );
		virtual cfbam::ICFBamTZTimeDefObj* createTZTimeDef( cfbam::ICFBamTZTimeDefEditObj* Obj );

		virtual cfbam::ICFBamTZTimeDefObj* readTZTimeDef( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamTZTimeDefObj* lockTZTimeDef( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamTZTimeDefObj*> readAllTZTimeDef( bool forceRead = false );

		virtual cfbam::ICFBamTZTimeDefObj* readTZTimeDefByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamTZTimeDefObj* readTZTimeDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimeDefObj*> readTZTimeDefByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimeDefObj*> readTZTimeDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimeDefObj*> readTZTimeDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimeDefObj*> readTZTimeDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimeDefObj*> readTZTimeDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimeDefObj*> readTZTimeDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimeDefObj*> readTZTimeDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual cfbam::ICFBamTZTimeDefObj* readCachedTZTimeDef( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamTZTimeDefObj* readCachedTZTimeDefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamTZTimeDefObj* readCachedTZTimeDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamTZTimeDefObj*> readCachedTZTimeDefByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamTZTimeDefObj*> readCachedTZTimeDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamTZTimeDefObj*> readCachedTZTimeDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamTZTimeDefObj*> readCachedTZTimeDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamTZTimeDefObj*> readCachedTZTimeDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamTZTimeDefObj*> readCachedTZTimeDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamTZTimeDefObj*> readCachedTZTimeDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamTZTimeDefObj* updateTZTimeDef( cfbam::ICFBamTZTimeDefEditObj* Obj );

		virtual void deleteTZTimeDef( cfbam::ICFBamTZTimeDefEditObj* Obj );

		virtual void deleteTZTimeDefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteTZTimeDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteTZTimeDefByValTentIdx( const int64_t TenantId );

		virtual void deleteTZTimeDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteTZTimeDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteTZTimeDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteTZTimeDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteTZTimeDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteTZTimeDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamTZTimeDefObj* moveUpTZTimeDef( cfbam::ICFBamTZTimeDefObj* Obj );

		virtual cfbam::ICFBamTZTimeDefObj* moveDownTZTimeDef( cfbam::ICFBamTZTimeDefObj* Obj );

		virtual void reallyDetachFromIndexesTZTimeDef( cfbam::ICFBamTZTimeDefObj* Obj );
