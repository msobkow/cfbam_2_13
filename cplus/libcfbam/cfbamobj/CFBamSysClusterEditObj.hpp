...
// Description: C++18 edit object instance specification for CFBam SysCluster.
...
namespace cfbam {
	...
	class CFBamSysClusterEditObj
	: public virtual ICFBamSysClusterEditObj,
	  public virtual cfsec::ICFSecSysClusterEditObj,
	  public virtual cfint::ICFIntSysClusterEditObj
	{
	public:
	...
	public:
		CFBamSysClusterEditObj( cfsec::ICFSecSysClusterObj* argOrig );
		virtual ~CFBamSysClusterEditObj();
