...
// Description: C++18 Instance Edit Object interface for CFBam DelTopDep.
...
namespace cfbam {
	...
	class ICFBamDelTopDepEditObj
	: public virtual cfbam::ICFBamDelDepEditObj,
	  public virtual cfbam::ICFBamDelTopDepObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamDelTopDepEditObj();
		virtual ~ICFBamDelTopDepEditObj();
		...
		virtual cfbam::ICFBamDelTopDepObj* getOrigAsDelTopDep() = 0;
		...
		virtual void setOptionalLookupPrev( cfbam::ICFBamDelTopDepObj* value ) = 0;

		virtual cfbam::ICFBamDelTopDepObj* getOptionalLookupNext( bool forceRead = false ) = 0;
		virtual void setOptionalLookupNext( cfbam::ICFBamDelTopDepObj* value ) = 0;
