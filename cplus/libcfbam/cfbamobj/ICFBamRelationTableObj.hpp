...
namespace cfbam {
	...
	{
	public:
		ICFBamRelationTableObj();
		virtual ~ICFBamRelationTableObj();
		...
		virtual cfbam::ICFBamRelationObj* newInstance() = 0;

		virtual cfbam::ICFBamRelationEditObj* newEditInstance( cfbam::ICFBamRelationObj* orig ) = 0;

		virtual cfbam::ICFBamRelationObj* realizeRelation( cfbam::ICFBamRelationObj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByTenantIdx( const int64_t TenantId ) = 0;
		virtual void reallyDeepDisposeRelation( cfbam::ICFBamRelationObj* Obj ) = 0;
		virtual void deepDisposeByUNameIdx( const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name ) = 0;
		virtual void deepDisposeByRelnTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamRelationObj* createRelation( cfbam::ICFBamRelationEditObj* Obj ) = 0;

		virtual cfbam::ICFBamRelationObj* readRelation( cfbam::CFBamScopePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamRelationObj* lockRelation( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamRelationObj*> readAllRelation( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamRelationObj* readCachedRelation( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual cfbam::ICFBamRelationObj* readCachedRelationByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamRelationObj*> readCachedRelationByTenantIdx( const int64_t TenantId ) = 0;

		virtual cfbam::ICFBamRelationObj* readCachedRelationByUNameIdx(const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name ) = 0;

		virtual std::vector<cfbam::ICFBamRelationObj*> readCachedRelationByRelnTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamRelationObj* updateRelation( cfbam::ICFBamRelationEditObj* Obj ) = 0;

		virtual void deleteRelation( cfbam::ICFBamRelationEditObj* Obj ) = 0;

		virtual void deleteRelationByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deleteRelationByTenantIdx( const int64_t TenantId ) = 0;

		virtual void deleteRelationByUNameIdx(const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name ) = 0;

		virtual void deleteRelationByRelnTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesRelation( cfbam::ICFBamRelationObj* Obj ) = 0;
