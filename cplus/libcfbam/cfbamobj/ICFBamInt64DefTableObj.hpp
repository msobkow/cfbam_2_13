...
namespace cfbam {
	...
	{
	public:
		ICFBamInt64DefTableObj();
		virtual ~ICFBamInt64DefTableObj();
		...
		virtual cfbam::ICFBamInt64DefObj* newInstance() = 0;

		virtual cfbam::ICFBamInt64DefEditObj* newEditInstance( cfbam::ICFBamInt64DefObj* orig ) = 0;

		virtual cfbam::ICFBamInt64DefObj* realizeInt64Def( cfbam::ICFBamInt64DefObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeInt64Def( cfbam::ICFBamInt64DefObj* Obj ) = 0;
		virtual cfbam::ICFBamInt64DefObj* createInt64Def( cfbam::ICFBamInt64DefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamInt64DefObj* readInt64Def( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamInt64DefObj* lockInt64Def( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamInt64DefObj*> readAllInt64Def( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamInt64DefObj* readCachedInt64Def( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamInt64DefObj*> readCachedInt64DefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamInt64DefObj* updateInt64Def( cfbam::ICFBamInt64DefEditObj* Obj ) = 0;

		virtual void deleteInt64Def( cfbam::ICFBamInt64DefEditObj* Obj ) = 0;
		...
		virtual void deleteInt64DefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamInt64DefObj* moveUpInt64Def( cfbam::ICFBamInt64DefObj* Obj ) = 0;

		virtual cfbam::ICFBamInt64DefObj* moveDownInt64Def( cfbam::ICFBamInt64DefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesInt64Def( cfbam::ICFBamInt64DefObj* Obj ) = 0;
