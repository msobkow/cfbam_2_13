...
// Description: C++18 base object instance specification for CFBam Scope.
...
namespace cfbam {
	...
	class CFBamScopeObj
	: public virtual ICFBamScopeObj
	{
	protected:
		cfsec::ICFSecSecUserObj* createdBy = NULL;
		cfsec::ICFSecSecUserObj* updatedBy = NULL;
		bool isNew;
		cfbam::ICFBamScopeEditObj* edit;
	...
	public:
		...
		CFBamScopeObj();
		CFBamScopeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamScopeObj();
