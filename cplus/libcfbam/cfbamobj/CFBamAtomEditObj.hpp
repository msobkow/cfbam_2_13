...
// Description: C++18 edit object instance specification for CFBam Atom.
...
namespace cfbam {
	...
	class CFBamAtomEditObj
	: public CFBamValueEditObj,
	  public virtual ICFBamAtomEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamAtomEditObj( cfbam::ICFBamAtomObj* argOrig );
		virtual ~CFBamAtomEditObj();
		...
		virtual cfbam::ICFBamAtomTableObj* getAtomTable();

		virtual cfbam::ICFBamAtomEditObj* getAtomEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamAtomObj* getOrigAsAtom();

		virtual cfbam::CFBamValueBuff* getBuff();
		virtual void setBuff( cfbam::CFBamValueBuff* value );

		inline cfbam::CFBamAtomBuff* getAtomBuff() {
			// Buff is always instantiated when constructed over an original object
			return( static_cast<cfbam::CFBamAtomBuff*>( buff ) );
		};

		inline cfbam::CFBamAtomBuff* getAtomEditBuff() {
			// Buff is always instantiated when constructed over an original object
