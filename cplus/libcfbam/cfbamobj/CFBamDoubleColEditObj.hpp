...
// Description: C++18 edit object instance specification for CFBam DoubleCol.
...
namespace cfbam {
	...
	class CFBamDoubleColEditObj
	: public CFBamDoubleDefEditObj,
	  public virtual ICFBamDoubleColEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamDoubleColEditObj( cfbam::ICFBamDoubleColObj* argOrig );
		virtual ~CFBamDoubleColEditObj();
		...
		virtual cfbam::ICFBamDoubleColTableObj* getDoubleColTable();

		virtual cfbam::ICFBamDoubleColEditObj* getDoubleColEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamDoubleColObj* getOrigAsDoubleCol();
		...
		inline cfbam::CFBamDoubleColBuff* getDoubleColBuff() {
			...
			return( static_cast<cfbam::CFBamDoubleColBuff*>( buff ) );
		};
