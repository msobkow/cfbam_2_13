...
namespace cfbam {
	...
	{
	public:
		ICFBamTokenTypeTableObj();
		virtual ~ICFBamTokenTypeTableObj();
		...
		virtual cfbam::ICFBamTokenTypeObj* newInstance() = 0;

		virtual cfbam::ICFBamTokenTypeEditObj* newEditInstance( cfbam::ICFBamTokenTypeObj* orig ) = 0;

		virtual cfbam::ICFBamTokenTypeObj* realizeTokenType( cfbam::ICFBamTokenTypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeTokenType( cfbam::ICFBamTokenTypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamTokenTypeObj* createTokenType( cfbam::ICFBamTokenTypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamTokenTypeObj* readTokenType( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTokenTypeObj* lockTokenType( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamTokenTypeObj*> readAllTokenType( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamTokenTypeObj* readCachedTokenType( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamTokenTypeObj*> readCachedTokenTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTokenTypeObj* updateTokenType( cfbam::ICFBamTokenTypeEditObj* Obj ) = 0;

		virtual void deleteTokenType( cfbam::ICFBamTokenTypeEditObj* Obj ) = 0;
		...
		virtual void deleteTokenTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTokenTypeObj* moveUpTokenType( cfbam::ICFBamTokenTypeObj* Obj ) = 0;

		virtual cfbam::ICFBamTokenTypeObj* moveDownTokenType( cfbam::ICFBamTokenTypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesTokenType( cfbam::ICFBamTokenTypeObj* Obj ) = 0;
