...
namespace cfbam {
	...
	class CFBamIndexColTableObj
	: public virtual ICFBamIndexColTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamIndexColPKey, cfbam::ICFBamIndexColObj*>* members;
		std::map<cfbam::CFBamIndexColPKey, cfbam::ICFBamIndexColObj*>* allIndexCol;
		std::map< cfbam::CFBamIndexColByUNameIdxKey,
			cfbam::ICFBamIndexColObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamIndexColByIdxColTenantIdxKey,
			std::map<cfbam::CFBamIndexColPKey, cfbam::ICFBamIndexColObj*>*>* indexByIdxColTenantIdx;
		std::map< cfbam::CFBamIndexColByIndexIdxKey,
			std::map<cfbam::CFBamIndexColPKey, cfbam::ICFBamIndexColObj*>*>* indexByIndexIdx;
		std::map< cfbam::CFBamIndexColByDefSchemaIdxKey,
			std::map<cfbam::CFBamIndexColPKey, cfbam::ICFBamIndexColObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamIndexColByColIdxKey,
			std::map<cfbam::CFBamIndexColPKey, cfbam::ICFBamIndexColObj*>*>* indexByColIdx;
		std::map< cfbam::CFBamIndexColByPrevIdxKey,
			std::map<cfbam::CFBamIndexColPKey, cfbam::ICFBamIndexColObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamIndexColByNextIdxKey,
			std::map<cfbam::CFBamIndexColPKey, cfbam::ICFBamIndexColObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamIndexColByIdxPrevIdxKey,
			std::map<cfbam::CFBamIndexColPKey, cfbam::ICFBamIndexColObj*>*>* indexByIdxPrevIdx;
		std::map< cfbam::CFBamIndexColByIdxNextIdxKey,
			std::map<cfbam::CFBamIndexColPKey, cfbam::ICFBamIndexColObj*>*>* indexByIdxNextIdx;
	...
	public:
		...
		CFBamIndexColTableObj();
		CFBamIndexColTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamIndexColTableObj();
		...
		virtual cfbam::ICFBamIndexColObj* newInstance();

		virtual cfbam::ICFBamIndexColEditObj* newEditInstance( cfbam::ICFBamIndexColObj* orig );

		virtual cfbam::ICFBamIndexColObj* realizeIndexCol( cfbam::ICFBamIndexColObj* Obj );
		...
		virtual void deepDisposeByIdxColTenantIdx( const int64_t TenantId );
		virtual void deepDisposeByIndexIdx( const int64_t TenantId,
			const int64_t IndexId );
		virtual void deepDisposeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );
		virtual void deepDisposeByColIdx( const int64_t TenantId,
		...
		virtual void deepDisposeByIdxPrevIdx( const int64_t TenantId,
			const int64_t IndexId,
			const int64_t* PrevId );
		virtual void deepDisposeByIdxNextIdx( const int64_t TenantId,
			const int64_t IndexId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeIndexCol( cfbam::ICFBamIndexColObj* Obj );
		virtual cfbam::ICFBamIndexColObj* createIndexCol( cfbam::ICFBamIndexColEditObj* Obj );

		virtual cfbam::ICFBamIndexColObj* readIndexCol( cfbam::CFBamIndexColPKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamIndexColObj* lockIndexCol( cfbam::CFBamIndexColPKey* pkey );

		virtual std::vector<cfbam::ICFBamIndexColObj*> readAllIndexCol( bool forceRead = false );

		virtual cfbam::ICFBamIndexColObj* readIndexColByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamIndexColObj* readIndexColByUNameIdx( const int64_t TenantId,
			const int64_t IndexId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamIndexColObj*> readIndexColByIdxColTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamIndexColObj*> readIndexColByIndexIdx( const int64_t TenantId,
			const int64_t IndexId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamIndexColObj*> readIndexColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamIndexColObj*> readIndexColByColIdx( const int64_t TenantId,
			const int64_t ColumnId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamIndexColObj*> readIndexColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamIndexColObj*> readIndexColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamIndexColObj*> readIndexColByIdxPrevIdx( const int64_t TenantId,
			const int64_t IndexId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamIndexColObj*> readIndexColByIdxNextIdx( const int64_t TenantId,
			const int64_t IndexId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual cfbam::ICFBamIndexColObj* readCachedIndexCol( cfbam::CFBamIndexColPKey* pkey );

		virtual cfbam::ICFBamIndexColObj* readCachedIndexColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamIndexColObj* readCachedIndexColByUNameIdx( const int64_t TenantId,
			const int64_t IndexId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamIndexColObj*> readCachedIndexColByIdxColTenantIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamIndexColObj*> readCachedIndexColByIndexIdx( const int64_t TenantId,
			const int64_t IndexId );

		virtual std::vector<cfbam::ICFBamIndexColObj*> readCachedIndexColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamIndexColObj*> readCachedIndexColByColIdx( const int64_t TenantId,
			const int64_t ColumnId );

		virtual std::vector<cfbam::ICFBamIndexColObj*> readCachedIndexColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamIndexColObj*> readCachedIndexColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamIndexColObj*> readCachedIndexColByIdxPrevIdx( const int64_t TenantId,
			const int64_t IndexId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamIndexColObj*> readCachedIndexColByIdxNextIdx( const int64_t TenantId,
			const int64_t IndexId,
			const int64_t* NextId );

		virtual cfbam::ICFBamIndexColObj* readIndexColByLookupUNameIdx( const int64_t TenantId,
			const int64_t IndexId,
			const std::string& Name, bool forceRead = false );

		virtual cfbam::ICFBamIndexColObj* readCachedIndexColByLookupUNameIdx( const int64_t TenantId,
			const int64_t IndexId,
			const std::string& Name );

		virtual cfbam::ICFBamIndexColObj* updateIndexCol( cfbam::ICFBamIndexColEditObj* Obj );

		virtual void deleteIndexCol( cfbam::ICFBamIndexColEditObj* Obj );

		virtual void deleteIndexColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteIndexColByUNameIdx( const int64_t TenantId,
			const int64_t IndexId,
			const std::string& Name );

		virtual void deleteIndexColByIdxColTenantIdx( const int64_t TenantId );

		virtual void deleteIndexColByIndexIdx( const int64_t TenantId,
			const int64_t IndexId );

		virtual void deleteIndexColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteIndexColByColIdx( const int64_t TenantId,
			const int64_t ColumnId );

		virtual void deleteIndexColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteIndexColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteIndexColByIdxPrevIdx( const int64_t TenantId,
			const int64_t IndexId,
			const int64_t* PrevId );

		virtual void deleteIndexColByIdxNextIdx( const int64_t TenantId,
			const int64_t IndexId,
			const int64_t* NextId );

		virtual cfbam::ICFBamIndexColObj* moveUpIndexCol( cfbam::ICFBamIndexColObj* Obj );

		virtual cfbam::ICFBamIndexColObj* moveDownIndexCol( cfbam::ICFBamIndexColObj* Obj );

		virtual void reallyDetachFromIndexesIndexCol( cfbam::ICFBamIndexColObj* Obj );
