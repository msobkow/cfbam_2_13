...
// Description: C++18 Instance Edit Object interface for CFBam FloatType.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamFloatDefEditObj,
	  public virtual cfbam::ICFBamFloatTypeObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamFloatTypeEditObj();
		virtual ~ICFBamFloatTypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamFloatTypeBuff* getFloatTypeBuff() {
			return( static_cast<cfbam::CFBamFloatTypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamFloatTypeBuff* getFloatTypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamFloatTypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamFloatTypeObj* getOrigAsFloatType() = 0;
