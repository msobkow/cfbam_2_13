...
namespace cfbam {
	...
	class CFBamNumberDefTableObj
	: public virtual ICFBamNumberDefTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNumberDefObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNumberDefObj*>* allNumberDef;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamNumberDefObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNumberDefObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNumberDefObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNumberDefObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNumberDefObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNumberDefObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNumberDefObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNumberDefObj*>*>* indexByContNextIdx;
	...
	public:
		...
		CFBamNumberDefTableObj();
		CFBamNumberDefTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamNumberDefTableObj();
		...
		virtual cfbam::ICFBamNumberDefObj* newInstance();

		virtual cfbam::ICFBamNumberDefEditObj* newEditInstance( cfbam::ICFBamNumberDefObj* orig );

		virtual cfbam::ICFBamNumberDefObj* realizeNumberDef( cfbam::ICFBamNumberDefObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeNumberDef( cfbam::ICFBamNumberDefObj* Obj );
		virtual cfbam::ICFBamNumberDefObj* createNumberDef( cfbam::ICFBamNumberDefEditObj* Obj );

		virtual cfbam::ICFBamNumberDefObj* readNumberDef( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamNumberDefObj* lockNumberDef( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamNumberDefObj*> readAllNumberDef( bool forceRead = false );

		virtual cfbam::ICFBamNumberDefObj* readNumberDefByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamNumberDefObj* readNumberDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNumberDefObj*> readNumberDefByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNumberDefObj*> readNumberDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNumberDefObj*> readNumberDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNumberDefObj*> readNumberDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNumberDefObj*> readNumberDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNumberDefObj*> readNumberDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNumberDefObj*> readNumberDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual cfbam::ICFBamNumberDefObj* readCachedNumberDef( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamNumberDefObj* readCachedNumberDefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamNumberDefObj* readCachedNumberDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamNumberDefObj*> readCachedNumberDefByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamNumberDefObj*> readCachedNumberDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamNumberDefObj*> readCachedNumberDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamNumberDefObj*> readCachedNumberDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamNumberDefObj*> readCachedNumberDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamNumberDefObj*> readCachedNumberDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamNumberDefObj*> readCachedNumberDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamNumberDefObj* updateNumberDef( cfbam::ICFBamNumberDefEditObj* Obj );

		virtual void deleteNumberDef( cfbam::ICFBamNumberDefEditObj* Obj );

		virtual void deleteNumberDefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteNumberDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteNumberDefByValTentIdx( const int64_t TenantId );

		virtual void deleteNumberDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteNumberDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteNumberDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteNumberDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteNumberDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteNumberDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamNumberDefObj* moveUpNumberDef( cfbam::ICFBamNumberDefObj* Obj );

		virtual cfbam::ICFBamNumberDefObj* moveDownNumberDef( cfbam::ICFBamNumberDefObj* Obj );

		virtual void reallyDetachFromIndexesNumberDef( cfbam::ICFBamNumberDefObj* Obj );
