...
// Description: C++18 base object instance specification for CFBam Id32Gen.
...
namespace cfbam {
	...
	class CFBamId32GenObj
	: public CFBamInt32TypeObj,
	  public virtual ICFBamId32GenObj
	{
	protected:
	public:
		...
		CFBamId32GenObj();
		CFBamId32GenObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamId32GenObj();
