...
namespace cfbam {
	...
	{
	public:
		ICFBamStringDefTableObj();
		virtual ~ICFBamStringDefTableObj();
		...
		virtual cfbam::ICFBamStringDefObj* newInstance() = 0;

		virtual cfbam::ICFBamStringDefEditObj* newEditInstance( cfbam::ICFBamStringDefObj* orig ) = 0;

		virtual cfbam::ICFBamStringDefObj* realizeStringDef( cfbam::ICFBamStringDefObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeStringDef( cfbam::ICFBamStringDefObj* Obj ) = 0;
		virtual cfbam::ICFBamStringDefObj* createStringDef( cfbam::ICFBamStringDefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamStringDefObj* readStringDef( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamStringDefObj* lockStringDef( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamStringDefObj*> readAllStringDef( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamStringDefObj* readCachedStringDef( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamStringDefObj*> readCachedStringDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamStringDefObj* updateStringDef( cfbam::ICFBamStringDefEditObj* Obj ) = 0;

		virtual void deleteStringDef( cfbam::ICFBamStringDefEditObj* Obj ) = 0;
		...
		virtual void deleteStringDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamStringDefObj* moveUpStringDef( cfbam::ICFBamStringDefObj* Obj ) = 0;

		virtual cfbam::ICFBamStringDefObj* moveDownStringDef( cfbam::ICFBamStringDefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesStringDef( cfbam::ICFBamStringDefObj* Obj ) = 0;
