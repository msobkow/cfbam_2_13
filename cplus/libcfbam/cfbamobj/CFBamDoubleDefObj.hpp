...
// Description: C++18 base object instance specification for CFBam DoubleDef.
...
namespace cfbam {
	...
	class CFBamDoubleDefObj
	: public CFBamAtomObj,
	  public virtual ICFBamDoubleDefObj
	{
	protected:
	public:
		...
		CFBamDoubleDefObj();
		CFBamDoubleDefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamDoubleDefObj();
