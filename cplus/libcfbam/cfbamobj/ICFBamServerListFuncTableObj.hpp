...
namespace cfbam {
	...
	{
	public:
		ICFBamServerListFuncTableObj();
		virtual ~ICFBamServerListFuncTableObj();
		...
		virtual cfbam::ICFBamServerListFuncObj* newInstance() = 0;

		virtual cfbam::ICFBamServerListFuncEditObj* newEditInstance( cfbam::ICFBamServerListFuncObj* orig ) = 0;

		virtual cfbam::ICFBamServerListFuncObj* realizeServerListFunc( cfbam::ICFBamServerListFuncObj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByTenantIdx( const int64_t TenantId ) = 0;
		virtual void reallyDeepDisposeServerListFunc( cfbam::ICFBamServerListFuncObj* Obj ) = 0;
		...
		virtual cfbam::ICFBamServerListFuncObj* createServerListFunc( cfbam::ICFBamServerListFuncEditObj* Obj ) = 0;

		virtual cfbam::ICFBamServerListFuncObj* readServerListFunc( cfbam::CFBamScopePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamServerListFuncObj* lockServerListFunc( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamServerListFuncObj*> readAllServerListFunc( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamServerListFuncObj* readCachedServerListFunc( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual cfbam::ICFBamServerListFuncObj* readCachedServerListFuncByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamServerListFuncObj*> readCachedServerListFuncByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamServerListFuncObj* updateServerListFunc( cfbam::ICFBamServerListFuncEditObj* Obj ) = 0;

		virtual void deleteServerListFunc( cfbam::ICFBamServerListFuncEditObj* Obj ) = 0;

		virtual void deleteServerListFuncByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deleteServerListFuncByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesServerListFunc( cfbam::ICFBamServerListFuncObj* Obj ) = 0;
