...
namespace cfbam {
	...
	{
	public:
		ICFBamInt16TypeTableObj();
		virtual ~ICFBamInt16TypeTableObj();
		...
		virtual cfbam::ICFBamInt16TypeObj* newInstance() = 0;

		virtual cfbam::ICFBamInt16TypeEditObj* newEditInstance( cfbam::ICFBamInt16TypeObj* orig ) = 0;

		virtual cfbam::ICFBamInt16TypeObj* realizeInt16Type( cfbam::ICFBamInt16TypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeInt16Type( cfbam::ICFBamInt16TypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamInt16TypeObj* createInt16Type( cfbam::ICFBamInt16TypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamInt16TypeObj* readInt16Type( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamInt16TypeObj* lockInt16Type( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamInt16TypeObj*> readAllInt16Type( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamInt16TypeObj* readCachedInt16Type( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamInt16TypeObj*> readCachedInt16TypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamInt16TypeObj* updateInt16Type( cfbam::ICFBamInt16TypeEditObj* Obj ) = 0;

		virtual void deleteInt16Type( cfbam::ICFBamInt16TypeEditObj* Obj ) = 0;
		...
		virtual void deleteInt16TypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamInt16TypeObj* moveUpInt16Type( cfbam::ICFBamInt16TypeObj* Obj ) = 0;

		virtual cfbam::ICFBamInt16TypeObj* moveDownInt16Type( cfbam::ICFBamInt16TypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesInt16Type( cfbam::ICFBamInt16TypeObj* Obj ) = 0;
