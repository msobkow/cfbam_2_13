...
// Description: C++18 Instance Edit Object interface for CFBam Int64Col.
...
namespace cfbam {
	...
	class ICFBamInt64ColEditObj
	: public virtual cfbam::ICFBamInt64DefEditObj,
	  public virtual cfbam::ICFBamInt64ColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamInt64ColEditObj();
		virtual ~ICFBamInt64ColEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamInt64ColBuff* getInt64ColBuff() {
			return( static_cast<cfbam::CFBamInt64ColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamInt64ColBuff* getInt64ColEditBuff() {
			return( dynamic_cast<cfbam::CFBamInt64ColBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamInt64ColObj* getOrigAsInt64Col() = 0;
