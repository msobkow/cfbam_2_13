...
// Description: C++18 base object instance specification for CFBam Id64Gen.
...
namespace cfbam {
	...
	class CFBamId64GenObj
	: public CFBamInt64TypeObj,
	  public virtual ICFBamId64GenObj
	{
	protected:
	public:
		...
		CFBamId64GenObj();
		CFBamId64GenObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamId64GenObj();
