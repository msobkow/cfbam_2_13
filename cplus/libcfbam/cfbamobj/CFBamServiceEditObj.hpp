...
// Description: C++18 edit object instance specification for CFBam Service.
...
namespace cfbam {
	...
	class CFBamServiceEditObj
	: public virtual ICFBamServiceEditObj,
	  public virtual cfsec::ICFSecServiceEditObj,
	  public virtual cfint::ICFIntServiceEditObj
	{
	public:
	...
	public:
		CFBamServiceEditObj( cfsec::ICFSecServiceObj* argOrig );
		virtual ~CFBamServiceEditObj();
