...
// Description: C++18 base object instance specification for CFBam MinorVersion.
...
namespace cfbam {
	...
	class CFBamMinorVersionObj
	: public virtual ICFBamMinorVersionObj,
	...
	public:
		...
		CFBamMinorVersionObj( cfint::ICFIntSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamMinorVersionObj();
