...
// Description: C++18 edit object instance specification for CFBam TimeType.
...
namespace cfbam {
	...
	class CFBamTimeTypeEditObj
	: public CFBamTimeDefEditObj,
	  public virtual ICFBamTimeTypeEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamTimeTypeEditObj( cfbam::ICFBamTimeTypeObj* argOrig );
		virtual ~CFBamTimeTypeEditObj();
		...
		virtual cfbam::ICFBamTimeTypeTableObj* getTimeTypeTable();

		virtual cfbam::ICFBamTimeTypeEditObj* getTimeTypeEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamTimeTypeObj* getOrigAsTimeType();

		virtual cfbam::CFBamValueBuff* getBuff();
		virtual void setBuff( cfbam::CFBamValueBuff* value );

		inline cfbam::CFBamTimeTypeBuff* getTimeTypeBuff() {
			// Buff is always instantiated when constructed over an original object
			return( static_cast<cfbam::CFBamTimeTypeBuff*>( buff ) );
		};

		inline cfbam::CFBamTimeTypeBuff* getTimeTypeEditBuff() {
			// Buff is always instantiated when constructed over an original object
