...
namespace cfbam {
	...
	{
	public:
		ICFBamInt32ColTableObj();
		virtual ~ICFBamInt32ColTableObj();
		...
		virtual cfbam::ICFBamInt32ColObj* newInstance() = 0;

		virtual cfbam::ICFBamInt32ColEditObj* newEditInstance( cfbam::ICFBamInt32ColObj* orig ) = 0;

		virtual cfbam::ICFBamInt32ColObj* realizeInt32Col( cfbam::ICFBamInt32ColObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeInt32Col( cfbam::ICFBamInt32ColObj* Obj ) = 0;
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId ) = 0;
		virtual cfbam::ICFBamInt32ColObj* createInt32Col( cfbam::ICFBamInt32ColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamInt32ColObj* readInt32Col( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamInt32ColObj* lockInt32Col( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamInt32ColObj*> readAllInt32Col( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamInt32ColObj* readCachedInt32Col( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamInt32ColObj*> readCachedInt32ColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamInt32ColObj* updateInt32Col( cfbam::ICFBamInt32ColEditObj* Obj ) = 0;

		virtual void deleteInt32Col( cfbam::ICFBamInt32ColEditObj* Obj ) = 0;
		...
		virtual void deleteInt32ColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamInt32ColObj* moveUpInt32Col( cfbam::ICFBamInt32ColObj* Obj ) = 0;

		virtual cfbam::ICFBamInt32ColObj* moveDownInt32Col( cfbam::ICFBamInt32ColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesInt32Col( cfbam::ICFBamInt32ColObj* Obj ) = 0;
