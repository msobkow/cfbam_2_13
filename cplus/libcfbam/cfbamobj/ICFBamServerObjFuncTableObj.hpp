...
namespace cfbam {
	...
	{
	public:
		ICFBamServerObjFuncTableObj();
		virtual ~ICFBamServerObjFuncTableObj();
		...
		virtual cfbam::ICFBamServerObjFuncObj* newInstance() = 0;

		virtual cfbam::ICFBamServerObjFuncEditObj* newEditInstance( cfbam::ICFBamServerObjFuncObj* orig ) = 0;

		virtual cfbam::ICFBamServerObjFuncObj* realizeServerObjFunc( cfbam::ICFBamServerObjFuncObj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByTenantIdx( const int64_t TenantId ) = 0;
		virtual void reallyDeepDisposeServerObjFunc( cfbam::ICFBamServerObjFuncObj* Obj ) = 0;
		...
		virtual cfbam::ICFBamServerObjFuncObj* createServerObjFunc( cfbam::ICFBamServerObjFuncEditObj* Obj ) = 0;

		virtual cfbam::ICFBamServerObjFuncObj* readServerObjFunc( cfbam::CFBamScopePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamServerObjFuncObj* lockServerObjFunc( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamServerObjFuncObj*> readAllServerObjFunc( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamServerObjFuncObj* readCachedServerObjFunc( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual cfbam::ICFBamServerObjFuncObj* readCachedServerObjFuncByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamServerObjFuncObj*> readCachedServerObjFuncByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamServerObjFuncObj* updateServerObjFunc( cfbam::ICFBamServerObjFuncEditObj* Obj ) = 0;

		virtual void deleteServerObjFunc( cfbam::ICFBamServerObjFuncEditObj* Obj ) = 0;

		virtual void deleteServerObjFuncByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deleteServerObjFuncByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesServerObjFunc( cfbam::ICFBamServerObjFuncObj* Obj ) = 0;
