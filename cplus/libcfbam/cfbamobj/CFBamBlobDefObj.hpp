...
// Description: C++18 base object instance specification for CFBam BlobDef.
...
namespace cfbam {
	...
	class CFBamBlobDefObj
	: public CFBamAtomObj,
	  public virtual ICFBamBlobDefObj
	{
	protected:
	public:
		...
		CFBamBlobDefObj();
		CFBamBlobDefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamBlobDefObj();
