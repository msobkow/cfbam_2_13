...
// Description: C++18 base object instance specification for CFBam ClearTopDep.
...
namespace cfbam {
	...
	class CFBamClearTopDepObj
	: public CFBamClearDepObj,
	  public virtual ICFBamClearTopDepObj
	{
	protected:
	public:
		...
		CFBamClearTopDepObj();
		CFBamClearTopDepObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamClearTopDepObj();
