...
// Description: C++18 edit object instance specification for CFBam TSecGroup.
...
namespace cfbam {
	...
	class CFBamTSecGroupEditObj
	: public virtual ICFBamTSecGroupEditObj,
	  public virtual cfsec::ICFSecTSecGroupEditObj,
	  public virtual cfint::ICFIntTSecGroupEditObj
	{
	public:
	...
	public:
		CFBamTSecGroupEditObj( cfsec::ICFSecTSecGroupObj* argOrig );
		virtual ~CFBamTSecGroupEditObj();
