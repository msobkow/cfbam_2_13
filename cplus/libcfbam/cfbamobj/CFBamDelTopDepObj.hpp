...
// Description: C++18 base object instance specification for CFBam DelTopDep.
...
namespace cfbam {
	...
	class CFBamDelTopDepObj
	: public CFBamDelDepObj,
	  public virtual ICFBamDelTopDepObj
	{
	protected:
	public:
		...
		CFBamDelTopDepObj();
		CFBamDelTopDepObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamDelTopDepObj();
