...
// Description: C++18 base object instance specification for CFBam DoubleCol.
...
namespace cfbam {
	...
	class CFBamDoubleColObj
	: public CFBamDoubleDefObj,
	  public virtual ICFBamDoubleColObj
	{
	protected:
	public:
		...
		CFBamDoubleColObj();
		CFBamDoubleColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamDoubleColObj();
