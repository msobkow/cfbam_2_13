...
// Description: C++18 Object interface for CFBam DelTopDep.
...
namespace cfbam {
	...
	class ICFBamDelTopDepObj
	: public virtual cfbam::ICFBamDelDepObj
	{
	public:
		ICFBamDelTopDepObj();
		virtual ~ICFBamDelTopDepObj();
		virtual cfbam::ICFBamDelTopDepObj* moveUp() = 0;

		virtual cfbam::ICFBamDelTopDepObj* moveDown() = 0;

		virtual cfbam::ICFBamScopeEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamDelTopDepEditObj* getDelTopDepEdit() = 0;

		inline cfbam::CFBamDelTopDepBuff* getDelTopDepBuff() {
			return( static_cast<cfbam::CFBamDelTopDepBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamDelTopDepBuff* getDelTopDepEditBuff() {
			return( dynamic_cast<cfbam::CFBamDelTopDepBuff*>( getBuff() ) );
		};
		...
		virtual std::vector<cfbam::ICFBamDelSubDep1Obj*> getOptionalComponentsDelDep( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamDelTopDepObj* getOptionalLookupPrev( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamDelTopDepObj* getOptionalLookupNext( bool forceRead = false ) = 0;
