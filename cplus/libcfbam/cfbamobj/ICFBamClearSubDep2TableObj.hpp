...
namespace cfbam {
	...
	{
	public:
		ICFBamClearSubDep2TableObj();
		virtual ~ICFBamClearSubDep2TableObj();
		...
		virtual cfbam::ICFBamClearSubDep2Obj* newInstance() = 0;

		virtual cfbam::ICFBamClearSubDep2EditObj* newEditInstance( cfbam::ICFBamClearSubDep2Obj* orig ) = 0;

		virtual cfbam::ICFBamClearSubDep2Obj* realizeClearSubDep2( cfbam::ICFBamClearSubDep2Obj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByTenantIdx( const int64_t TenantId ) = 0;
		virtual void reallyDeepDisposeClearSubDep2( cfbam::ICFBamClearSubDep2Obj* Obj ) = 0;
		...
		virtual cfbam::ICFBamClearSubDep2Obj* createClearSubDep2( cfbam::ICFBamClearSubDep2EditObj* Obj ) = 0;

		virtual cfbam::ICFBamClearSubDep2Obj* readClearSubDep2( cfbam::CFBamScopePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamClearSubDep2Obj* lockClearSubDep2( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamClearSubDep2Obj*> readAllClearSubDep2( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamClearSubDep2Obj* readCachedClearSubDep2( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual cfbam::ICFBamClearSubDep2Obj* readCachedClearSubDep2ByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamClearSubDep2Obj*> readCachedClearSubDep2ByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamClearSubDep2Obj* updateClearSubDep2( cfbam::ICFBamClearSubDep2EditObj* Obj ) = 0;

		virtual void deleteClearSubDep2( cfbam::ICFBamClearSubDep2EditObj* Obj ) = 0;

		virtual void deleteClearSubDep2ByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deleteClearSubDep2ByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesClearSubDep2( cfbam::ICFBamClearSubDep2Obj* Obj ) = 0;
