...
namespace cfbam {
	...
	{
	public:
		ICFBamUuidTypeTableObj();
		virtual ~ICFBamUuidTypeTableObj();
		...
		virtual cfbam::ICFBamUuidTypeObj* newInstance() = 0;

		virtual cfbam::ICFBamUuidTypeEditObj* newEditInstance( cfbam::ICFBamUuidTypeObj* orig ) = 0;

		virtual cfbam::ICFBamUuidTypeObj* realizeUuidType( cfbam::ICFBamUuidTypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeUuidType( cfbam::ICFBamUuidTypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamUuidTypeObj* createUuidType( cfbam::ICFBamUuidTypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamUuidTypeObj* readUuidType( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamUuidTypeObj* lockUuidType( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamUuidTypeObj*> readAllUuidType( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamUuidTypeObj* readCachedUuidType( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamUuidTypeObj*> readCachedUuidTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUuidTypeObj* updateUuidType( cfbam::ICFBamUuidTypeEditObj* Obj ) = 0;

		virtual void deleteUuidType( cfbam::ICFBamUuidTypeEditObj* Obj ) = 0;
		...
		virtual void deleteUuidTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUuidTypeObj* moveUpUuidType( cfbam::ICFBamUuidTypeObj* Obj ) = 0;

		virtual cfbam::ICFBamUuidTypeObj* moveDownUuidType( cfbam::ICFBamUuidTypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesUuidType( cfbam::ICFBamUuidTypeObj* Obj ) = 0;
