...
// Description: C++18 base object instance specification for CFBam TZTimestampType.
...
namespace cfbam {
	...
	class CFBamTZTimestampTypeObj
	: public CFBamTZTimestampDefObj,
	  public virtual ICFBamTZTimestampTypeObj
	{
	protected:
	public:
		...
		CFBamTZTimestampTypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTZTimestampTypeObj();
