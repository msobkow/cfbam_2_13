...
// Description: C++18 Instance Edit Object interface for CFBam Int32Type.
...
namespace cfbam {
	...
	public:
		...
		virtual ~ICFBamInt32TypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamInt32TypeBuff* getInt32TypeBuff() {
			return( static_cast<cfbam::CFBamInt32TypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamInt32TypeBuff* getInt32TypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamInt32TypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamInt32TypeObj* getOrigAsInt32Type() = 0;
