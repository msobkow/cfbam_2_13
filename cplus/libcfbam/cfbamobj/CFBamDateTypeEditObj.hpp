...
// Description: C++18 edit object instance specification for CFBam DateType.
...
namespace cfbam {
	...
	class CFBamDateTypeEditObj
	: public CFBamDateDefEditObj,
	  public virtual ICFBamDateTypeEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamDateTypeEditObj( cfbam::ICFBamDateTypeObj* argOrig );
		virtual ~CFBamDateTypeEditObj();
		...
		virtual cfbam::ICFBamDateTypeTableObj* getDateTypeTable();

		virtual cfbam::ICFBamDateTypeEditObj* getDateTypeEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamDateTypeObj* getOrigAsDateType();

		virtual cfbam::CFBamValueBuff* getBuff();
		virtual void setBuff( cfbam::CFBamValueBuff* value );

		inline cfbam::CFBamDateTypeBuff* getDateTypeBuff() {
			// Buff is always instantiated when constructed over an original object
			return( static_cast<cfbam::CFBamDateTypeBuff*>( buff ) );
		};

		inline cfbam::CFBamDateTypeBuff* getDateTypeEditBuff() {
			// Buff is always instantiated when constructed over an original object
