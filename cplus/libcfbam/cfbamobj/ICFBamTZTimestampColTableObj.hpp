...
namespace cfbam {
	...
	{
	public:
		ICFBamTZTimestampColTableObj();
		virtual ~ICFBamTZTimestampColTableObj();
		...
		virtual cfbam::ICFBamTZTimestampColObj* newInstance() = 0;

		virtual cfbam::ICFBamTZTimestampColEditObj* newEditInstance( cfbam::ICFBamTZTimestampColObj* orig ) = 0;

		virtual cfbam::ICFBamTZTimestampColObj* realizeTZTimestampCol( cfbam::ICFBamTZTimestampColObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeTZTimestampCol( cfbam::ICFBamTZTimestampColObj* Obj ) = 0;
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId ) = 0;
		virtual cfbam::ICFBamTZTimestampColObj* createTZTimestampCol( cfbam::ICFBamTZTimestampColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamTZTimestampColObj* readTZTimestampCol( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTZTimestampColObj* lockTZTimestampCol( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamTZTimestampColObj*> readAllTZTimestampCol( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamTZTimestampColObj* readCachedTZTimestampCol( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamTZTimestampColObj*> readCachedTZTimestampColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTZTimestampColObj* updateTZTimestampCol( cfbam::ICFBamTZTimestampColEditObj* Obj ) = 0;

		virtual void deleteTZTimestampCol( cfbam::ICFBamTZTimestampColEditObj* Obj ) = 0;
		...
		virtual void deleteTZTimestampColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTZTimestampColObj* moveUpTZTimestampCol( cfbam::ICFBamTZTimestampColObj* Obj ) = 0;

		virtual cfbam::ICFBamTZTimestampColObj* moveDownTZTimestampCol( cfbam::ICFBamTZTimestampColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesTZTimestampCol( cfbam::ICFBamTZTimestampColObj* Obj ) = 0;
