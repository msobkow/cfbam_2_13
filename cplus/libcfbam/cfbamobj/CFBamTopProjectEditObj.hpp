...
// Description: C++18 edit object instance specification for CFBam TopProject.
...
namespace cfbam {
	...
	class CFBamTopProjectEditObj
	: public virtual ICFBamTopProjectEditObj,
	  public virtual cfint::ICFIntTopProjectEditObj
	{
	public:
	...
	public:
		CFBamTopProjectEditObj( cfint::ICFIntTopProjectObj* argOrig );
		virtual ~CFBamTopProjectEditObj();
