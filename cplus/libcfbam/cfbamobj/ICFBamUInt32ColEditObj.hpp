...
// Description: C++18 Instance Edit Object interface for CFBam UInt32Col.
...
namespace cfbam {
	...
	class ICFBamUInt32ColEditObj
	: public virtual cfbam::ICFBamUInt32DefEditObj,
	  public virtual cfbam::ICFBamUInt32ColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamUInt32ColEditObj();
		virtual ~ICFBamUInt32ColEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamUInt32ColBuff* getUInt32ColBuff() {
			return( static_cast<cfbam::CFBamUInt32ColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamUInt32ColBuff* getUInt32ColEditBuff() {
			return( dynamic_cast<cfbam::CFBamUInt32ColBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamUInt32ColObj* getOrigAsUInt32Col() = 0;
