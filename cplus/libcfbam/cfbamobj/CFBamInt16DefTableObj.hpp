...
namespace cfbam {
	...
	class CFBamInt16DefTableObj
	: public virtual ICFBamInt16DefTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16DefObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16DefObj*>* allInt16Def;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamInt16DefObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16DefObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16DefObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16DefObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16DefObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16DefObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16DefObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16DefObj*>*>* indexByContNextIdx;
	...
	public:
		...
		CFBamInt16DefTableObj();
		CFBamInt16DefTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamInt16DefTableObj();
		...
		virtual cfbam::ICFBamInt16DefObj* newInstance();

		virtual cfbam::ICFBamInt16DefEditObj* newEditInstance( cfbam::ICFBamInt16DefObj* orig );

		virtual cfbam::ICFBamInt16DefObj* realizeInt16Def( cfbam::ICFBamInt16DefObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeInt16Def( cfbam::ICFBamInt16DefObj* Obj );
		virtual cfbam::ICFBamInt16DefObj* createInt16Def( cfbam::ICFBamInt16DefEditObj* Obj );

		virtual cfbam::ICFBamInt16DefObj* readInt16Def( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamInt16DefObj* lockInt16Def( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamInt16DefObj*> readAllInt16Def( bool forceRead = false );

		virtual cfbam::ICFBamInt16DefObj* readInt16DefByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamInt16DefObj* readInt16DefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt16DefObj*> readInt16DefByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt16DefObj*> readInt16DefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt16DefObj*> readInt16DefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt16DefObj*> readInt16DefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt16DefObj*> readInt16DefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt16DefObj*> readInt16DefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt16DefObj*> readInt16DefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual cfbam::ICFBamInt16DefObj* readCachedInt16Def( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamInt16DefObj* readCachedInt16DefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamInt16DefObj* readCachedInt16DefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamInt16DefObj*> readCachedInt16DefByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamInt16DefObj*> readCachedInt16DefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamInt16DefObj*> readCachedInt16DefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamInt16DefObj*> readCachedInt16DefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamInt16DefObj*> readCachedInt16DefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamInt16DefObj*> readCachedInt16DefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamInt16DefObj*> readCachedInt16DefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamInt16DefObj* updateInt16Def( cfbam::ICFBamInt16DefEditObj* Obj );

		virtual void deleteInt16Def( cfbam::ICFBamInt16DefEditObj* Obj );

		virtual void deleteInt16DefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteInt16DefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteInt16DefByValTentIdx( const int64_t TenantId );

		virtual void deleteInt16DefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteInt16DefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteInt16DefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteInt16DefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteInt16DefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteInt16DefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamInt16DefObj* moveUpInt16Def( cfbam::ICFBamInt16DefObj* Obj );

		virtual cfbam::ICFBamInt16DefObj* moveDownInt16Def( cfbam::ICFBamInt16DefObj* Obj );

		virtual void reallyDetachFromIndexesInt16Def( cfbam::ICFBamInt16DefObj* Obj );
