...
// Description: C++18 Instance Edit Object interface for CFBam NmTokensDef.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamAtomEditObj,
	  public virtual cfbam::ICFBamNmTokensDefObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamNmTokensDefEditObj();
		virtual ~ICFBamNmTokensDefEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamNmTokensDefBuff* getNmTokensDefBuff() {
			return( static_cast<cfbam::CFBamNmTokensDefBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamNmTokensDefBuff* getNmTokensDefEditBuff() {
			return( dynamic_cast<cfbam::CFBamNmTokensDefBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamNmTokensDefObj* getOrigAsNmTokensDef() = 0;
