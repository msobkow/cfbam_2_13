...
// Description: C++18 base object instance specification for CFBam PopSubDep1.
...
namespace cfbam {
	...
	class CFBamPopSubDep1Obj
	: public CFBamPopDepObj,
	  public virtual ICFBamPopSubDep1Obj
	{
	protected:
	public:
		...
		CFBamPopSubDep1Obj();
		CFBamPopSubDep1Obj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamPopSubDep1Obj();
