...
// Description: C++18 base object instance specification for CFBam Int32Def.
...
namespace cfbam {
	...
	class CFBamInt32DefObj
	: public CFBamAtomObj,
	  public virtual ICFBamInt32DefObj
	{
	protected:
	public:
		...
		CFBamInt32DefObj();
		CFBamInt32DefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamInt32DefObj();
