...
// Description: C++18 edit object instance specification for CFBam ISOCtryCcy.
...
namespace cfbam {
	...
	class CFBamISOCtryCcyEditObj
	: public virtual ICFBamISOCtryCcyEditObj,
	  public virtual cfsec::ICFSecISOCtryCcyEditObj,
	  public virtual cfint::ICFIntISOCtryCcyEditObj
	{
	public:
	...
	public:
		CFBamISOCtryCcyEditObj( cfsec::ICFSecISOCtryCcyObj* argOrig );
		virtual ~CFBamISOCtryCcyEditObj();
