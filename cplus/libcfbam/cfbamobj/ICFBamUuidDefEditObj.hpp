...
// Description: C++18 Instance Edit Object interface for CFBam UuidDef.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamAtomEditObj,
	  public virtual cfbam::ICFBamUuidDefObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamUuidDefEditObj();
		virtual ~ICFBamUuidDefEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamUuidDefBuff* getUuidDefBuff() {
			return( static_cast<cfbam::CFBamUuidDefBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamUuidDefBuff* getUuidDefEditBuff() {
			return( dynamic_cast<cfbam::CFBamUuidDefBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamUuidDefObj* getOrigAsUuidDef() = 0;

		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual bool isOptionalInitValueNull() = 0;
		virtual const uuid_ptr_t getOptionalInitValueValue() = 0;
		virtual const uuid_ptr_t getOptionalInitValueReference() = 0;
		virtual void setOptionalInitValueNull() = 0;
		virtual void setOptionalInitValueValue( const uuid_ptr_t value ) = 0;
