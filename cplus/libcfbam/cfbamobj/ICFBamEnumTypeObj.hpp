...
// Description: C++18 Object interface for CFBam EnumType.
...
namespace cfbam {
	...
	class ICFBamEnumTypeObj
	: public virtual cfbam::ICFBamEnumDefObj
	{
	public:
		ICFBamEnumTypeObj();
		virtual ~ICFBamEnumTypeObj();
		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamEnumTypeEditObj* getEnumTypeEdit() = 0;
