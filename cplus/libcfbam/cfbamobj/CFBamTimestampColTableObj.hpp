...
namespace cfbam {
	...
	class CFBamTimestampColTableObj
	: public virtual ICFBamTimestampColTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTimestampColObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTimestampColObj*>* allTimestampCol;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamTimestampColObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTimestampColObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTimestampColObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTimestampColObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTimestampColObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTimestampColObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTimestampColObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTimestampColObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamTimestampColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTimestampColObj*>*>* indexByTableIdx;
	...
	public:
		...
		CFBamTimestampColTableObj();
		CFBamTimestampColTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamTimestampColTableObj();
		...
		virtual cfbam::ICFBamTimestampColObj* newInstance();

		virtual cfbam::ICFBamTimestampColEditObj* newEditInstance( cfbam::ICFBamTimestampColObj* orig );

		virtual cfbam::ICFBamTimestampColObj* realizeTimestampCol( cfbam::ICFBamTimestampColObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeTimestampCol( cfbam::ICFBamTimestampColObj* Obj );
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId );
		virtual cfbam::ICFBamTimestampColObj* createTimestampCol( cfbam::ICFBamTimestampColEditObj* Obj );

		virtual cfbam::ICFBamTimestampColObj* readTimestampCol( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamTimestampColObj* lockTimestampCol( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamTimestampColObj*> readAllTimestampCol( bool forceRead = false );

		virtual cfbam::ICFBamTimestampColObj* readTimestampColByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamTimestampColObj* readTimestampColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTimestampColObj*> readTimestampColByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTimestampColObj*> readTimestampColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTimestampColObj*> readTimestampColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTimestampColObj*> readTimestampColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTimestampColObj*> readTimestampColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTimestampColObj*> readTimestampColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTimestampColObj*> readTimestampColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTimestampColObj*> readTimestampColByTableIdx( const int64_t TenantId,
			const int64_t TableId,
			bool forceRead = false );

		virtual cfbam::ICFBamTimestampColObj* readCachedTimestampCol( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamTimestampColObj* readCachedTimestampColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamTimestampColObj* readCachedTimestampColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamTimestampColObj*> readCachedTimestampColByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamTimestampColObj*> readCachedTimestampColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamTimestampColObj*> readCachedTimestampColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamTimestampColObj*> readCachedTimestampColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamTimestampColObj*> readCachedTimestampColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamTimestampColObj*> readCachedTimestampColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamTimestampColObj*> readCachedTimestampColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamTimestampColObj*> readCachedTimestampColByTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual cfbam::ICFBamTimestampColObj* updateTimestampCol( cfbam::ICFBamTimestampColEditObj* Obj );

		virtual void deleteTimestampCol( cfbam::ICFBamTimestampColEditObj* Obj );

		virtual void deleteTimestampColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteTimestampColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteTimestampColByValTentIdx( const int64_t TenantId );

		virtual void deleteTimestampColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteTimestampColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteTimestampColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteTimestampColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteTimestampColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteTimestampColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteTimestampColByTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual cfbam::ICFBamTimestampColObj* moveUpTimestampCol( cfbam::ICFBamTimestampColObj* Obj );

		virtual cfbam::ICFBamTimestampColObj* moveDownTimestampCol( cfbam::ICFBamTimestampColObj* Obj );

		virtual void reallyDetachFromIndexesTimestampCol( cfbam::ICFBamTimestampColObj* Obj );
