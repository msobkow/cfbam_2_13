...
// Description: C++18 Instance Edit Object interface for CFBam NmTokenCol.
...
namespace cfbam {
	...
	class ICFBamNmTokenColEditObj
	: public virtual cfbam::ICFBamNmTokenDefEditObj,
	  public virtual cfbam::ICFBamNmTokenColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamNmTokenColEditObj();
		virtual ~ICFBamNmTokenColEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamNmTokenColBuff* getNmTokenColBuff() {
			return( static_cast<cfbam::CFBamNmTokenColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamNmTokenColBuff* getNmTokenColEditBuff() {
			return( dynamic_cast<cfbam::CFBamNmTokenColBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamNmTokenColObj* getOrigAsNmTokenCol() = 0;
