...
// Description: C++18 Instance Edit Object interface for CFBam TokenType.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamTokenDefEditObj,
	  public virtual cfbam::ICFBamTokenTypeObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamTokenTypeEditObj();
		virtual ~ICFBamTokenTypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamTokenTypeBuff* getTokenTypeBuff() {
			return( static_cast<cfbam::CFBamTokenTypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamTokenTypeBuff* getTokenTypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamTokenTypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamTokenTypeObj* getOrigAsTokenType() = 0;
