...
// Description: C++18 Instance Edit Object interface for CFBam StringDef.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamAtomEditObj,
	  public virtual cfbam::ICFBamStringDefObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamStringDefEditObj();
		virtual ~ICFBamStringDefEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamStringDefBuff* getStringDefBuff() {
			return( static_cast<cfbam::CFBamStringDefBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamStringDefBuff* getStringDefEditBuff() {
			return( dynamic_cast<cfbam::CFBamStringDefBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamStringDefObj* getOrigAsStringDef() = 0;
		...
		virtual const bool getRequiredIsPolymorph() = 0;
		virtual const bool* getRequiredIsPolymorphReference() = 0;
		virtual void setRequiredIsPolymorph( const bool value ) = 0;
