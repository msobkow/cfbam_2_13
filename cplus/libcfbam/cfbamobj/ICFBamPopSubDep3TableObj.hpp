...
namespace cfbam {
	...
	{
	public:
		ICFBamPopSubDep3TableObj();
		virtual ~ICFBamPopSubDep3TableObj();
		...
		virtual cfbam::ICFBamPopSubDep3Obj* newInstance() = 0;

		virtual cfbam::ICFBamPopSubDep3EditObj* newEditInstance( cfbam::ICFBamPopSubDep3Obj* orig ) = 0;

		virtual cfbam::ICFBamPopSubDep3Obj* realizePopSubDep3( cfbam::ICFBamPopSubDep3Obj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByTenantIdx( const int64_t TenantId ) = 0;
		virtual void reallyDeepDisposePopSubDep3( cfbam::ICFBamPopSubDep3Obj* Obj ) = 0;
		...
		virtual cfbam::ICFBamPopSubDep3Obj* createPopSubDep3( cfbam::ICFBamPopSubDep3EditObj* Obj ) = 0;

		virtual cfbam::ICFBamPopSubDep3Obj* readPopSubDep3( cfbam::CFBamScopePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamPopSubDep3Obj* lockPopSubDep3( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamPopSubDep3Obj*> readAllPopSubDep3( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamPopSubDep3Obj* readCachedPopSubDep3( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual cfbam::ICFBamPopSubDep3Obj* readCachedPopSubDep3ByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamPopSubDep3Obj*> readCachedPopSubDep3ByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamPopSubDep3Obj* updatePopSubDep3( cfbam::ICFBamPopSubDep3EditObj* Obj ) = 0;

		virtual void deletePopSubDep3( cfbam::ICFBamPopSubDep3EditObj* Obj ) = 0;

		virtual void deletePopSubDep3ByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deletePopSubDep3ByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesPopSubDep3( cfbam::ICFBamPopSubDep3Obj* Obj ) = 0;
