...
namespace cfbam {
	...
	class CFBamInt32ColTableObj
	: public virtual ICFBamInt32ColTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32ColObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32ColObj*>* allInt32Col;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamInt32ColObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32ColObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32ColObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32ColObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32ColObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32ColObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32ColObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32ColObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamInt32ColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32ColObj*>*>* indexByTableIdx;
	...
	public:
		...
		CFBamInt32ColTableObj();
		CFBamInt32ColTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamInt32ColTableObj();
		...
		virtual cfbam::ICFBamInt32ColObj* newInstance();

		virtual cfbam::ICFBamInt32ColEditObj* newEditInstance( cfbam::ICFBamInt32ColObj* orig );

		virtual cfbam::ICFBamInt32ColObj* realizeInt32Col( cfbam::ICFBamInt32ColObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeInt32Col( cfbam::ICFBamInt32ColObj* Obj );
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId );
		virtual cfbam::ICFBamInt32ColObj* createInt32Col( cfbam::ICFBamInt32ColEditObj* Obj );

		virtual cfbam::ICFBamInt32ColObj* readInt32Col( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamInt32ColObj* lockInt32Col( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamInt32ColObj*> readAllInt32Col( bool forceRead = false );

		virtual cfbam::ICFBamInt32ColObj* readInt32ColByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamInt32ColObj* readInt32ColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt32ColObj*> readInt32ColByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt32ColObj*> readInt32ColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt32ColObj*> readInt32ColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt32ColObj*> readInt32ColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt32ColObj*> readInt32ColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt32ColObj*> readInt32ColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt32ColObj*> readInt32ColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt32ColObj*> readInt32ColByTableIdx( const int64_t TenantId,
			const int64_t TableId,
			bool forceRead = false );

		virtual cfbam::ICFBamInt32ColObj* readCachedInt32Col( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamInt32ColObj* readCachedInt32ColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamInt32ColObj* readCachedInt32ColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamInt32ColObj*> readCachedInt32ColByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamInt32ColObj*> readCachedInt32ColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamInt32ColObj*> readCachedInt32ColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamInt32ColObj*> readCachedInt32ColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamInt32ColObj*> readCachedInt32ColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamInt32ColObj*> readCachedInt32ColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamInt32ColObj*> readCachedInt32ColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamInt32ColObj*> readCachedInt32ColByTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual cfbam::ICFBamInt32ColObj* updateInt32Col( cfbam::ICFBamInt32ColEditObj* Obj );

		virtual void deleteInt32Col( cfbam::ICFBamInt32ColEditObj* Obj );

		virtual void deleteInt32ColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteInt32ColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteInt32ColByValTentIdx( const int64_t TenantId );

		virtual void deleteInt32ColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteInt32ColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteInt32ColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteInt32ColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteInt32ColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteInt32ColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteInt32ColByTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual cfbam::ICFBamInt32ColObj* moveUpInt32Col( cfbam::ICFBamInt32ColObj* Obj );

		virtual cfbam::ICFBamInt32ColObj* moveDownInt32Col( cfbam::ICFBamInt32ColObj* Obj );

		virtual void reallyDetachFromIndexesInt32Col( cfbam::ICFBamInt32ColObj* Obj );
