...
// Description: C++18 base object instance specification for CFBam UuidGen.
...
namespace cfbam {
	...
	class CFBamUuidGenObj
	: public CFBamUuidTypeObj,
	  public virtual ICFBamUuidGenObj
	{
	protected:
	public:
		...
		CFBamUuidGenObj();
		CFBamUuidGenObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamUuidGenObj();
