...
namespace cfbam {
	...
	{
	public:
		ICFBamBlobTypeTableObj();
		virtual ~ICFBamBlobTypeTableObj();
		...
		virtual cfbam::ICFBamBlobTypeObj* newInstance() = 0;

		virtual cfbam::ICFBamBlobTypeEditObj* newEditInstance( cfbam::ICFBamBlobTypeObj* orig ) = 0;

		virtual cfbam::ICFBamBlobTypeObj* realizeBlobType( cfbam::ICFBamBlobTypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeBlobType( cfbam::ICFBamBlobTypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamBlobTypeObj* createBlobType( cfbam::ICFBamBlobTypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamBlobTypeObj* readBlobType( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamBlobTypeObj* lockBlobType( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamBlobTypeObj*> readAllBlobType( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamBlobTypeObj* readCachedBlobType( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamBlobTypeObj*> readCachedBlobTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamBlobTypeObj* updateBlobType( cfbam::ICFBamBlobTypeEditObj* Obj ) = 0;

		virtual void deleteBlobType( cfbam::ICFBamBlobTypeEditObj* Obj ) = 0;
		...
		virtual void deleteBlobTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamBlobTypeObj* moveUpBlobType( cfbam::ICFBamBlobTypeObj* Obj ) = 0;

		virtual cfbam::ICFBamBlobTypeObj* moveDownBlobType( cfbam::ICFBamBlobTypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesBlobType( cfbam::ICFBamBlobTypeObj* Obj ) = 0;
