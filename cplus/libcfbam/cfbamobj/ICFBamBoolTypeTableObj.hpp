...
namespace cfbam {
	...
	{
	public:
		ICFBamBoolTypeTableObj();
		virtual ~ICFBamBoolTypeTableObj();
		...
		virtual cfbam::ICFBamBoolTypeObj* newInstance() = 0;

		virtual cfbam::ICFBamBoolTypeEditObj* newEditInstance( cfbam::ICFBamBoolTypeObj* orig ) = 0;

		virtual cfbam::ICFBamBoolTypeObj* realizeBoolType( cfbam::ICFBamBoolTypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeBoolType( cfbam::ICFBamBoolTypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamBoolTypeObj* createBoolType( cfbam::ICFBamBoolTypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamBoolTypeObj* readBoolType( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamBoolTypeObj* lockBoolType( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamBoolTypeObj*> readAllBoolType( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamBoolTypeObj* readCachedBoolType( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamBoolTypeObj*> readCachedBoolTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamBoolTypeObj* updateBoolType( cfbam::ICFBamBoolTypeEditObj* Obj ) = 0;

		virtual void deleteBoolType( cfbam::ICFBamBoolTypeEditObj* Obj ) = 0;
		...
		virtual void deleteBoolTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamBoolTypeObj* moveUpBoolType( cfbam::ICFBamBoolTypeObj* Obj ) = 0;

		virtual cfbam::ICFBamBoolTypeObj* moveDownBoolType( cfbam::ICFBamBoolTypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesBoolType( cfbam::ICFBamBoolTypeObj* Obj ) = 0;
