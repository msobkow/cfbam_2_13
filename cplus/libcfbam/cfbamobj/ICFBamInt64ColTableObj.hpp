...
namespace cfbam {
	...
	{
	public:
		ICFBamInt64ColTableObj();
		virtual ~ICFBamInt64ColTableObj();
		...
		virtual cfbam::ICFBamInt64ColObj* newInstance() = 0;

		virtual cfbam::ICFBamInt64ColEditObj* newEditInstance( cfbam::ICFBamInt64ColObj* orig ) = 0;

		virtual cfbam::ICFBamInt64ColObj* realizeInt64Col( cfbam::ICFBamInt64ColObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeInt64Col( cfbam::ICFBamInt64ColObj* Obj ) = 0;
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId ) = 0;
		virtual cfbam::ICFBamInt64ColObj* createInt64Col( cfbam::ICFBamInt64ColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamInt64ColObj* readInt64Col( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamInt64ColObj* lockInt64Col( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamInt64ColObj*> readAllInt64Col( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamInt64ColObj* readCachedInt64Col( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamInt64ColObj*> readCachedInt64ColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamInt64ColObj* updateInt64Col( cfbam::ICFBamInt64ColEditObj* Obj ) = 0;

		virtual void deleteInt64Col( cfbam::ICFBamInt64ColEditObj* Obj ) = 0;
		...
		virtual void deleteInt64ColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamInt64ColObj* moveUpInt64Col( cfbam::ICFBamInt64ColObj* Obj ) = 0;

		virtual cfbam::ICFBamInt64ColObj* moveDownInt64Col( cfbam::ICFBamInt64ColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesInt64Col( cfbam::ICFBamInt64ColObj* Obj ) = 0;
