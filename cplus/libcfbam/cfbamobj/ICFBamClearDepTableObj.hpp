...
namespace cfbam {
	...
	{
	public:
		ICFBamClearDepTableObj();
		virtual ~ICFBamClearDepTableObj();
		...
		virtual cfbam::ICFBamClearDepObj* newInstance() = 0;

		virtual cfbam::ICFBamClearDepEditObj* newEditInstance( cfbam::ICFBamClearDepObj* orig ) = 0;

		virtual cfbam::ICFBamClearDepObj* realizeClearDep( cfbam::ICFBamClearDepObj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByTenantIdx( const int64_t TenantId ) = 0;
		virtual void reallyDeepDisposeClearDep( cfbam::ICFBamClearDepObj* Obj ) = 0;
		...
		virtual cfbam::ICFBamClearDepObj* createClearDep( cfbam::ICFBamClearDepEditObj* Obj ) = 0;

		virtual cfbam::ICFBamClearDepObj* readClearDep( cfbam::CFBamScopePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamClearDepObj* lockClearDep( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamClearDepObj*> readAllClearDep( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamClearDepObj* readCachedClearDep( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual cfbam::ICFBamClearDepObj* readCachedClearDepByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamClearDepObj*> readCachedClearDepByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamClearDepObj* updateClearDep( cfbam::ICFBamClearDepEditObj* Obj ) = 0;

		virtual void deleteClearDep( cfbam::ICFBamClearDepEditObj* Obj ) = 0;

		virtual void deleteClearDepByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deleteClearDepByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesClearDep( cfbam::ICFBamClearDepObj* Obj ) = 0;
