...
// Description: C++18 Instance Edit Object interface for CFBam TZTimeDef.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamAtomEditObj,
	  public virtual cfbam::ICFBamTZTimeDefObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamTZTimeDefEditObj();
		virtual ~ICFBamTZTimeDefEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamTZTimeDefBuff* getTZTimeDefBuff() {
			return( static_cast<cfbam::CFBamTZTimeDefBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamTZTimeDefBuff* getTZTimeDefEditBuff() {
			return( dynamic_cast<cfbam::CFBamTZTimeDefBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamTZTimeDefObj* getOrigAsTZTimeDef() = 0;
