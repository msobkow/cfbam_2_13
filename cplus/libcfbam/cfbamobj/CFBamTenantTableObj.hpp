...
namespace cfbam {
	...
	class CFBamTenantTableObj
	: public virtual ICFBamTenantTableObj,
	  public virtual cfsec::ICFSecTenantTableObj,
	  public virtual cfint::ICFIntTenantTableObj
	{
	protected:
	...
	public:
		...
		CFBamTenantTableObj();
		CFBamTenantTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamTenantTableObj();
