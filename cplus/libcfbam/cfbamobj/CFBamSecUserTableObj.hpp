...
namespace cfbam {
	...
	class CFBamSecUserTableObj
	: public virtual ICFBamSecUserTableObj,
	  public virtual cfsec::ICFSecSecUserTableObj,
	  public virtual cfint::ICFIntSecUserTableObj
	{
	protected:
	...
	public:
		...
		CFBamSecUserTableObj();
		CFBamSecUserTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamSecUserTableObj();
