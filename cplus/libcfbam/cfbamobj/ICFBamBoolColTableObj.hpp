...
namespace cfbam {
	...
	{
	public:
		ICFBamBoolColTableObj();
		virtual ~ICFBamBoolColTableObj();
		...
		virtual cfbam::ICFBamBoolColObj* newInstance() = 0;

		virtual cfbam::ICFBamBoolColEditObj* newEditInstance( cfbam::ICFBamBoolColObj* orig ) = 0;

		virtual cfbam::ICFBamBoolColObj* realizeBoolCol( cfbam::ICFBamBoolColObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeBoolCol( cfbam::ICFBamBoolColObj* Obj ) = 0;
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId ) = 0;
		virtual cfbam::ICFBamBoolColObj* createBoolCol( cfbam::ICFBamBoolColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamBoolColObj* readBoolCol( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamBoolColObj* lockBoolCol( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamBoolColObj*> readAllBoolCol( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamBoolColObj* readCachedBoolCol( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamBoolColObj*> readCachedBoolColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamBoolColObj* updateBoolCol( cfbam::ICFBamBoolColEditObj* Obj ) = 0;

		virtual void deleteBoolCol( cfbam::ICFBamBoolColEditObj* Obj ) = 0;
		...
		virtual void deleteBoolColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamBoolColObj* moveUpBoolCol( cfbam::ICFBamBoolColObj* Obj ) = 0;

		virtual cfbam::ICFBamBoolColObj* moveDownBoolCol( cfbam::ICFBamBoolColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesBoolCol( cfbam::ICFBamBoolColObj* Obj ) = 0;
