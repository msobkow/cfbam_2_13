...
// Description: C++18 base object instance specification for CFBam Tenant.
...
namespace cfbam {
	...
	class CFBamTenantObj
	: public virtual ICFBamTenantObj,
	...
	public:
		...
		CFBamTenantObj();
		CFBamTenantObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTenantObj();
