...
namespace cfbam {
	...
	class CFBamUInt16DefTableObj
	: public virtual ICFBamUInt16DefTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16DefObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16DefObj*>* allUInt16Def;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamUInt16DefObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16DefObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16DefObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16DefObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16DefObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16DefObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16DefObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16DefObj*>*>* indexByContNextIdx;
	...
	public:
		...
		CFBamUInt16DefTableObj();
		CFBamUInt16DefTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamUInt16DefTableObj();
		...
		virtual cfbam::ICFBamUInt16DefObj* newInstance();

		virtual cfbam::ICFBamUInt16DefEditObj* newEditInstance( cfbam::ICFBamUInt16DefObj* orig );

		virtual cfbam::ICFBamUInt16DefObj* realizeUInt16Def( cfbam::ICFBamUInt16DefObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeUInt16Def( cfbam::ICFBamUInt16DefObj* Obj );
		virtual cfbam::ICFBamUInt16DefObj* createUInt16Def( cfbam::ICFBamUInt16DefEditObj* Obj );

		virtual cfbam::ICFBamUInt16DefObj* readUInt16Def( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamUInt16DefObj* lockUInt16Def( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamUInt16DefObj*> readAllUInt16Def( bool forceRead = false );

		virtual cfbam::ICFBamUInt16DefObj* readUInt16DefByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamUInt16DefObj* readUInt16DefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt16DefObj*> readUInt16DefByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt16DefObj*> readUInt16DefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt16DefObj*> readUInt16DefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt16DefObj*> readUInt16DefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt16DefObj*> readUInt16DefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt16DefObj*> readUInt16DefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt16DefObj*> readUInt16DefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual cfbam::ICFBamUInt16DefObj* readCachedUInt16Def( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamUInt16DefObj* readCachedUInt16DefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamUInt16DefObj* readCachedUInt16DefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamUInt16DefObj*> readCachedUInt16DefByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamUInt16DefObj*> readCachedUInt16DefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamUInt16DefObj*> readCachedUInt16DefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamUInt16DefObj*> readCachedUInt16DefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamUInt16DefObj*> readCachedUInt16DefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamUInt16DefObj*> readCachedUInt16DefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamUInt16DefObj*> readCachedUInt16DefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamUInt16DefObj* updateUInt16Def( cfbam::ICFBamUInt16DefEditObj* Obj );

		virtual void deleteUInt16Def( cfbam::ICFBamUInt16DefEditObj* Obj );

		virtual void deleteUInt16DefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteUInt16DefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteUInt16DefByValTentIdx( const int64_t TenantId );

		virtual void deleteUInt16DefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteUInt16DefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteUInt16DefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteUInt16DefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteUInt16DefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteUInt16DefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamUInt16DefObj* moveUpUInt16Def( cfbam::ICFBamUInt16DefObj* Obj );

		virtual cfbam::ICFBamUInt16DefObj* moveDownUInt16Def( cfbam::ICFBamUInt16DefObj* Obj );

		virtual void reallyDetachFromIndexesUInt16Def( cfbam::ICFBamUInt16DefObj* Obj );
