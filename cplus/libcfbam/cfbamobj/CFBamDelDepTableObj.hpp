...
namespace cfbam {
	...
	class CFBamDelDepTableObj
	: public virtual ICFBamDelDepTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamDelDepObj*>* members;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamDelDepObj*>* allDelDep;
		std::map< cfbam::CFBamScopeByTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamDelDepObj*>*>* indexByTenantIdx;
		std::map< cfbam::CFBamDelDepByDefSchemaIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamDelDepObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamDelDepByDelDepIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamDelDepObj*>*>* indexByDelDepIdx;
	...
	public:
		...
		CFBamDelDepTableObj();
		CFBamDelDepTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamDelDepTableObj();
		...
		virtual cfbam::ICFBamDelDepObj* newInstance();

		virtual cfbam::ICFBamDelDepEditObj* newEditInstance( cfbam::ICFBamDelDepObj* orig );

		virtual cfbam::ICFBamDelDepObj* realizeDelDep( cfbam::ICFBamDelDepObj* Obj );

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id );
		virtual void deepDisposeByTenantIdx( const int64_t TenantId );
		virtual void reallyDeepDisposeDelDep( cfbam::ICFBamDelDepObj* Obj );
		...
		virtual cfbam::ICFBamDelDepObj* createDelDep( cfbam::ICFBamDelDepEditObj* Obj );

		virtual cfbam::ICFBamDelDepObj* readDelDep( cfbam::CFBamScopePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamDelDepObj* lockDelDep( cfbam::CFBamScopePKey* pkey );

		virtual std::vector<cfbam::ICFBamDelDepObj*> readAllDelDep( bool forceRead = false );

		virtual cfbam::ICFBamDelDepObj* readDelDepByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDelDepObj*> readDelDepByTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDelDepObj*> readDelDepByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDelDepObj*> readDelDepByDelDepIdx( const int64_t RelationTenantId,
			const int64_t RelationId,
			bool forceRead = false );

		virtual cfbam::ICFBamDelDepObj* readCachedDelDep( cfbam::CFBamScopePKey* pkey );

		virtual cfbam::ICFBamDelDepObj* readCachedDelDepByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual std::vector<cfbam::ICFBamDelDepObj*> readCachedDelDepByTenantIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamDelDepObj*> readCachedDelDepByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamDelDepObj*> readCachedDelDepByDelDepIdx( const int64_t RelationTenantId,
			const int64_t RelationId );

		virtual cfbam::ICFBamDelDepObj* updateDelDep( cfbam::ICFBamDelDepEditObj* Obj );

		virtual void deleteDelDep( cfbam::ICFBamDelDepEditObj* Obj );

		virtual void deleteDelDepByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteDelDepByTenantIdx( const int64_t TenantId );

		virtual void deleteDelDepByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteDelDepByDelDepIdx( const int64_t RelationTenantId,
			const int64_t RelationId );

		virtual void reallyDetachFromIndexesDelDep( cfbam::ICFBamDelDepObj* Obj );
