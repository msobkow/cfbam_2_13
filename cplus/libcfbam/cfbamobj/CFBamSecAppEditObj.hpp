...
// Description: C++18 edit object instance specification for CFBam SecApp.
...
namespace cfbam {
	...
	class CFBamSecAppEditObj
	: public virtual ICFBamSecAppEditObj,
	  public virtual cfsec::ICFSecSecAppEditObj,
	  public virtual cfint::ICFIntSecAppEditObj
	{
	public:
	...
	public:
		CFBamSecAppEditObj( cfsec::ICFSecSecAppObj* argOrig );
		virtual ~CFBamSecAppEditObj();
