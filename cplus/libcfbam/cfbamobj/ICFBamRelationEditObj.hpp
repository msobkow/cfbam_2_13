...
// Description: C++18 Instance Edit Object interface for CFBam Relation.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamScopeEditObj,
	  public virtual cfbam::ICFBamRelationObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamRelationEditObj();
		virtual ~ICFBamRelationEditObj();
		...
		virtual cfbam::ICFBamRelationObj* getOrigAsRelation() = 0;
		...
		virtual void setRequiredRelationType( const cfbam::ICFBamSchema::RelationTypeEnum value ) = 0;
		...
		virtual void setRequiredContainerFromTable( cfbam::ICFBamTableObj* value ) = 0;

		virtual cfsec::ICFSecTenantObj* getRequiredOwnerRelTenant( bool forceRead = false ) = 0;
		virtual void setRequiredOwnerRelTenant( cfsec::ICFSecTenantObj* value ) = 0;

		virtual cfbam::ICFBamIndexObj* getRequiredLookupFromIndex( bool forceRead = false ) = 0;
		virtual void setRequiredLookupFromIndex( cfbam::ICFBamIndexObj* value ) = 0;

		virtual cfbam::ICFBamTableObj* getRequiredLookupToTable( bool forceRead = false ) = 0;
		virtual void setRequiredLookupToTable( cfbam::ICFBamTableObj* value ) = 0;

		virtual cfbam::ICFBamIndexObj* getRequiredLookupToIndex( bool forceRead = false ) = 0;
		virtual void setRequiredLookupToIndex( cfbam::ICFBamIndexObj* value ) = 0;

		virtual cfbam::ICFBamRelationObj* getOptionalLookupNarrowed( bool forceRead = false ) = 0;
		virtual void setOptionalLookupNarrowed( cfbam::ICFBamRelationObj* value ) = 0;
