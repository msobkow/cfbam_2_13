...
namespace cfbam {
	...
	class CFBamId32GenTableObj
	: public virtual ICFBamId32GenTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId32GenObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId32GenObj*>* allId32Gen;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamId32GenObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId32GenObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId32GenObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId32GenObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId32GenObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId32GenObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId32GenObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId32GenObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamInt32TypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId32GenObj*>*>* indexBySchemaIdx;
		std::map< cfbam::CFBamId32GenByDispIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId32GenObj*>*>* indexByDispIdx;
	...
	public:
		...
		CFBamId32GenTableObj();
		CFBamId32GenTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamId32GenTableObj();
		...
		virtual cfbam::ICFBamId32GenObj* newInstance();

		virtual cfbam::ICFBamId32GenEditObj* newEditInstance( cfbam::ICFBamId32GenObj* orig );

		virtual cfbam::ICFBamId32GenObj* realizeId32Gen( cfbam::ICFBamId32GenObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeId32Gen( cfbam::ICFBamId32GenObj* Obj );
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );
		virtual void deepDisposeByDispIdx( const int64_t* DispenserTenantId,
			const int64_t* DispenserId );
		virtual cfbam::ICFBamId32GenObj* createId32Gen( cfbam::ICFBamId32GenEditObj* Obj );

		virtual cfbam::ICFBamId32GenObj* readId32Gen( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamId32GenObj* lockId32Gen( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamId32GenObj*> readAllId32Gen( bool forceRead = false );

		virtual cfbam::ICFBamId32GenObj* readId32GenByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamId32GenObj* readId32GenByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId32GenObj*> readId32GenByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId32GenObj*> readId32GenByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId32GenObj*> readId32GenByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId32GenObj*> readId32GenByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId32GenObj*> readId32GenByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId32GenObj*> readId32GenByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId32GenObj*> readId32GenByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId32GenObj*> readId32GenBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId32GenObj*> readId32GenByDispIdx( const int64_t* DispenserTenantId,
			const int64_t* DispenserId,
			bool forceRead = false );

		virtual cfbam::ICFBamId32GenObj* readCachedId32Gen( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamId32GenObj* readCachedId32GenByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamId32GenObj* readCachedId32GenByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamId32GenObj*> readCachedId32GenByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamId32GenObj*> readCachedId32GenByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamId32GenObj*> readCachedId32GenByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamId32GenObj*> readCachedId32GenByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamId32GenObj*> readCachedId32GenByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamId32GenObj*> readCachedId32GenByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamId32GenObj*> readCachedId32GenByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamId32GenObj*> readCachedId32GenBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual std::vector<cfbam::ICFBamId32GenObj*> readCachedId32GenByDispIdx( const int64_t* DispenserTenantId,
			const int64_t* DispenserId );

		virtual cfbam::ICFBamId32GenObj* updateId32Gen( cfbam::ICFBamId32GenEditObj* Obj );

		virtual void deleteId32Gen( cfbam::ICFBamId32GenEditObj* Obj );

		virtual void deleteId32GenByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteId32GenByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteId32GenByValTentIdx( const int64_t TenantId );

		virtual void deleteId32GenByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteId32GenByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteId32GenByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteId32GenByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteId32GenByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteId32GenByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteId32GenBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual void deleteId32GenByDispIdx( const int64_t* DispenserTenantId,
			const int64_t* DispenserId );

		virtual cfbam::ICFBamId32GenObj* moveUpId32Gen( cfbam::ICFBamId32GenObj* Obj );

		virtual cfbam::ICFBamId32GenObj* moveDownId32Gen( cfbam::ICFBamId32GenObj* Obj );

		virtual void reallyDetachFromIndexesId32Gen( cfbam::ICFBamId32GenObj* Obj );
