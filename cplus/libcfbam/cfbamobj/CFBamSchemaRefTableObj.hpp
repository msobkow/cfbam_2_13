...
namespace cfbam {
	...
	class CFBamSchemaRefTableObj
	: public virtual ICFBamSchemaRefTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamSchemaRefObj*>* members;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamSchemaRefObj*>* allSchemaRef;
		std::map< cfbam::CFBamScopeByTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamSchemaRefObj*>*>* indexByTenantIdx;
		std::map< cfbam::CFBamSchemaRefBySchemaIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamSchemaRefObj*>*>* indexBySchemaIdx;
		std::map< cfbam::CFBamSchemaRefByUNameIdxKey,
			cfbam::ICFBamSchemaRefObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamSchemaRefByRefSchemaIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamSchemaRefObj*>*>* indexByRefSchemaIdx;
		std::map< cfbam::CFBamSchemaRefByPrevIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamSchemaRefObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamSchemaRefByNextIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamSchemaRefObj*>*>* indexByNextIdx;
	...
	public:
		...
		CFBamSchemaRefTableObj();
		CFBamSchemaRefTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamSchemaRefTableObj();
		...
		virtual cfbam::ICFBamSchemaRefObj* newInstance();

		virtual cfbam::ICFBamSchemaRefEditObj* newEditInstance( cfbam::ICFBamSchemaRefObj* orig );

		virtual cfbam::ICFBamSchemaRefObj* realizeSchemaRef( cfbam::ICFBamSchemaRefObj* Obj );

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id );
		virtual void deepDisposeByTenantIdx( const int64_t TenantId );
		virtual void reallyDeepDisposeSchemaRef( cfbam::ICFBamSchemaRefObj* Obj );
		...
		virtual void deepDisposeByRefSchemaIdx( const int64_t* RefSchemaTenantId,
		...
		virtual cfbam::ICFBamSchemaRefObj* createSchemaRef( cfbam::ICFBamSchemaRefEditObj* Obj );

		virtual cfbam::ICFBamSchemaRefObj* readSchemaRef( cfbam::CFBamScopePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamSchemaRefObj* lockSchemaRef( cfbam::CFBamScopePKey* pkey );

		virtual std::vector<cfbam::ICFBamSchemaRefObj*> readAllSchemaRef( bool forceRead = false );

		virtual cfbam::ICFBamSchemaRefObj* readSchemaRefByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamSchemaRefObj*> readSchemaRefByTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamSchemaRefObj*> readSchemaRefBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaId,
			bool forceRead = false );

		virtual cfbam::ICFBamSchemaRefObj* readSchemaRefByUNameIdx( const int64_t TenantId,
			const int64_t SchemaId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamSchemaRefObj*> readSchemaRefByRefSchemaIdx( const int64_t* RefSchemaTenantId,
			const int64_t* RefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamSchemaRefObj*> readSchemaRefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamSchemaRefObj*> readSchemaRefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual cfbam::ICFBamSchemaRefObj* readCachedSchemaRef( cfbam::CFBamScopePKey* pkey );

		virtual cfbam::ICFBamSchemaRefObj* readCachedSchemaRefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual std::vector<cfbam::ICFBamSchemaRefObj*> readCachedSchemaRefByTenantIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamSchemaRefObj*> readCachedSchemaRefBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaId );

		virtual cfbam::ICFBamSchemaRefObj* readCachedSchemaRefByUNameIdx( const int64_t TenantId,
			const int64_t SchemaId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamSchemaRefObj*> readCachedSchemaRefByRefSchemaIdx( const int64_t* RefSchemaTenantId,
			const int64_t* RefSchemaId );

		virtual std::vector<cfbam::ICFBamSchemaRefObj*> readCachedSchemaRefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamSchemaRefObj*> readCachedSchemaRefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual cfbam::ICFBamSchemaRefObj* updateSchemaRef( cfbam::ICFBamSchemaRefEditObj* Obj );

		virtual void deleteSchemaRef( cfbam::ICFBamSchemaRefEditObj* Obj );

		virtual void deleteSchemaRefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteSchemaRefByTenantIdx( const int64_t TenantId );

		virtual void deleteSchemaRefBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaId );

		virtual void deleteSchemaRefByUNameIdx( const int64_t TenantId,
			const int64_t SchemaId,
			const std::string& Name );

		virtual void deleteSchemaRefByRefSchemaIdx( const int64_t* RefSchemaTenantId,
			const int64_t* RefSchemaId );

		virtual void deleteSchemaRefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteSchemaRefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual cfbam::ICFBamSchemaRefObj* moveUpSchemaRef( cfbam::ICFBamSchemaRefObj* Obj );

		virtual cfbam::ICFBamSchemaRefObj* moveDownSchemaRef( cfbam::ICFBamSchemaRefObj* Obj );

		virtual void reallyDetachFromIndexesSchemaRef( cfbam::ICFBamSchemaRefObj* Obj );
