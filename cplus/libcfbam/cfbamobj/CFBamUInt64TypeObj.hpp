...
// Description: C++18 base object instance specification for CFBam UInt64Type.
...
namespace cfbam {
	...
	class CFBamUInt64TypeObj
	: public CFBamUInt64DefObj,
	  public virtual ICFBamUInt64TypeObj
	{
	protected:
	public:
		...
		CFBamUInt64TypeObj();
		CFBamUInt64TypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamUInt64TypeObj();
