...
namespace cfbam {
	...
	class CFBamLicenseTableObj
	: public virtual ICFBamLicenseTableObj,
	  public virtual cfint::ICFIntLicenseTableObj
	{
	protected:
	...
	public:
		...
		CFBamLicenseTableObj();
		CFBamLicenseTableObj( cfint::ICFIntSchemaObj* argSchema );
		virtual ~CFBamLicenseTableObj();
