...
// Description: C++18 Object interface for CFBam PopSubDep2.
...
namespace cfbam {
	...
	public:
		ICFBamPopSubDep2Obj();
		virtual ~ICFBamPopSubDep2Obj();
		virtual cfbam::ICFBamScopeEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamPopSubDep2EditObj* getPopSubDep2Edit() = 0;

		inline cfbam::CFBamPopSubDep2Buff* getPopSubDep2Buff() {
			return( static_cast<cfbam::CFBamPopSubDep2Buff*>( getBuff() ) );
		};

		inline cfbam::CFBamPopSubDep2Buff* getPopSubDep2EditBuff() {
			return( dynamic_cast<cfbam::CFBamPopSubDep2Buff*>( getBuff() ) );
		};

		virtual const int64_t getRequiredPopSubDep1TenantId() = 0;
		virtual const int64_t* getRequiredPopSubDep1TenantIdReference() = 0;

		virtual const int64_t getRequiredPopSubDep1Id() = 0;
		virtual const int64_t* getRequiredPopSubDep1IdReference() = 0;

		virtual const std::string& getRequiredName() = 0;
		virtual const std::string* getRequiredNameReference() = 0;

		virtual cfbam::ICFBamPopSubDep1Obj* getRequiredContainerPopSubDep1( bool forceRead = false ) = 0;

		virtual std::vector<cfbam::ICFBamPopSubDep3Obj*> getOptionalComponentsPopDep( bool forceRead = false ) = 0;
