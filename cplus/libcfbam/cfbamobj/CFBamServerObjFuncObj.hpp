...
// Description: C++18 base object instance specification for CFBam ServerObjFunc.
...
namespace cfbam {
	...
	class CFBamServerObjFuncObj
	: public CFBamServerMethodObj,
	  public virtual ICFBamServerObjFuncObj
	{
	protected:
	public:
		...
		CFBamServerObjFuncObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamServerObjFuncObj();
