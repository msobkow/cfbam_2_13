...
// Description: C++18 edit object instance specification for CFBam FloatType.
...
namespace cfbam {
	...
	class CFBamFloatTypeEditObj
	: public CFBamFloatDefEditObj,
	  public virtual ICFBamFloatTypeEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamFloatTypeEditObj( cfbam::ICFBamFloatTypeObj* argOrig );
		virtual ~CFBamFloatTypeEditObj();
		...
		virtual cfbam::ICFBamFloatTypeTableObj* getFloatTypeTable();

		virtual cfbam::ICFBamFloatTypeEditObj* getFloatTypeEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamFloatTypeObj* getOrigAsFloatType();

		virtual cfbam::CFBamValueBuff* getBuff();
		virtual void setBuff( cfbam::CFBamValueBuff* value );

		inline cfbam::CFBamFloatTypeBuff* getFloatTypeBuff() {
			// Buff is always instantiated when constructed over an original object
			return( static_cast<cfbam::CFBamFloatTypeBuff*>( buff ) );
		};

		inline cfbam::CFBamFloatTypeBuff* getFloatTypeEditBuff() {
			// Buff is always instantiated when constructed over an original object
