...
// Description: C++18 edit object instance specification for CFBam FloatCol.
...
namespace cfbam {
	...
	class CFBamFloatColEditObj
	: public CFBamFloatDefEditObj,
	  public virtual ICFBamFloatColEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamFloatColEditObj( cfbam::ICFBamFloatColObj* argOrig );
		virtual ~CFBamFloatColEditObj();
		...
		virtual cfbam::ICFBamFloatColTableObj* getFloatColTable();

		virtual cfbam::ICFBamFloatColEditObj* getFloatColEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamFloatColObj* getOrigAsFloatCol();
		...
		inline cfbam::CFBamFloatColBuff* getFloatColBuff() {
			...
			return( static_cast<cfbam::CFBamFloatColBuff*>( buff ) );
		};
