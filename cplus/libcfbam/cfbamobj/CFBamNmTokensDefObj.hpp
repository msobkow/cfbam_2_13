...
// Description: C++18 base object instance specification for CFBam NmTokensDef.
...
namespace cfbam {
	...
	class CFBamNmTokensDefObj
	: public CFBamAtomObj,
	  public virtual ICFBamNmTokensDefObj
	{
	protected:
	public:
		...
		CFBamNmTokensDefObj();
		CFBamNmTokensDefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamNmTokensDefObj();
