...
namespace cfbam {
	...
	{
	public:
		ICFBamTextTypeTableObj();
		virtual ~ICFBamTextTypeTableObj();
		...
		virtual cfbam::ICFBamTextTypeObj* newInstance() = 0;

		virtual cfbam::ICFBamTextTypeEditObj* newEditInstance( cfbam::ICFBamTextTypeObj* orig ) = 0;

		virtual cfbam::ICFBamTextTypeObj* realizeTextType( cfbam::ICFBamTextTypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeTextType( cfbam::ICFBamTextTypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamTextTypeObj* createTextType( cfbam::ICFBamTextTypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamTextTypeObj* readTextType( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTextTypeObj* lockTextType( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamTextTypeObj*> readAllTextType( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamTextTypeObj* readCachedTextType( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamTextTypeObj*> readCachedTextTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTextTypeObj* updateTextType( cfbam::ICFBamTextTypeEditObj* Obj ) = 0;

		virtual void deleteTextType( cfbam::ICFBamTextTypeEditObj* Obj ) = 0;
		...
		virtual void deleteTextTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTextTypeObj* moveUpTextType( cfbam::ICFBamTextTypeObj* Obj ) = 0;

		virtual cfbam::ICFBamTextTypeObj* moveDownTextType( cfbam::ICFBamTextTypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesTextType( cfbam::ICFBamTextTypeObj* Obj ) = 0;
