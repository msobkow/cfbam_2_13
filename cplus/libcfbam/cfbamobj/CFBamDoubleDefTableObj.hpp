...
namespace cfbam {
	...
	class CFBamDoubleDefTableObj
	: public virtual ICFBamDoubleDefTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamDoubleDefObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamDoubleDefObj*>* allDoubleDef;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamDoubleDefObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamDoubleDefObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamDoubleDefObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamDoubleDefObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamDoubleDefObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamDoubleDefObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamDoubleDefObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamDoubleDefObj*>*>* indexByContNextIdx;
	...
	public:
		...
		CFBamDoubleDefTableObj();
		CFBamDoubleDefTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamDoubleDefTableObj();
		...
		virtual cfbam::ICFBamDoubleDefObj* newInstance();

		virtual cfbam::ICFBamDoubleDefEditObj* newEditInstance( cfbam::ICFBamDoubleDefObj* orig );

		virtual cfbam::ICFBamDoubleDefObj* realizeDoubleDef( cfbam::ICFBamDoubleDefObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeDoubleDef( cfbam::ICFBamDoubleDefObj* Obj );
		virtual cfbam::ICFBamDoubleDefObj* createDoubleDef( cfbam::ICFBamDoubleDefEditObj* Obj );

		virtual cfbam::ICFBamDoubleDefObj* readDoubleDef( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamDoubleDefObj* lockDoubleDef( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamDoubleDefObj*> readAllDoubleDef( bool forceRead = false );

		virtual cfbam::ICFBamDoubleDefObj* readDoubleDefByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamDoubleDefObj* readDoubleDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDoubleDefObj*> readDoubleDefByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDoubleDefObj*> readDoubleDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDoubleDefObj*> readDoubleDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDoubleDefObj*> readDoubleDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDoubleDefObj*> readDoubleDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDoubleDefObj*> readDoubleDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDoubleDefObj*> readDoubleDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual cfbam::ICFBamDoubleDefObj* readCachedDoubleDef( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamDoubleDefObj* readCachedDoubleDefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamDoubleDefObj* readCachedDoubleDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamDoubleDefObj*> readCachedDoubleDefByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamDoubleDefObj*> readCachedDoubleDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamDoubleDefObj*> readCachedDoubleDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamDoubleDefObj*> readCachedDoubleDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamDoubleDefObj*> readCachedDoubleDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamDoubleDefObj*> readCachedDoubleDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamDoubleDefObj*> readCachedDoubleDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamDoubleDefObj* updateDoubleDef( cfbam::ICFBamDoubleDefEditObj* Obj );

		virtual void deleteDoubleDef( cfbam::ICFBamDoubleDefEditObj* Obj );

		virtual void deleteDoubleDefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteDoubleDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteDoubleDefByValTentIdx( const int64_t TenantId );

		virtual void deleteDoubleDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteDoubleDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteDoubleDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteDoubleDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteDoubleDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteDoubleDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamDoubleDefObj* moveUpDoubleDef( cfbam::ICFBamDoubleDefObj* Obj );

		virtual cfbam::ICFBamDoubleDefObj* moveDownDoubleDef( cfbam::ICFBamDoubleDefObj* Obj );

		virtual void reallyDetachFromIndexesDoubleDef( cfbam::ICFBamDoubleDefObj* Obj );
