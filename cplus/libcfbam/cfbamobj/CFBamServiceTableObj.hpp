...
namespace cfbam {
	...
	class CFBamServiceTableObj
	: public virtual ICFBamServiceTableObj,
	  public virtual cfsec::ICFSecServiceTableObj,
	  public virtual cfint::ICFIntServiceTableObj
	{
	protected:
	...
	public:
		...
		CFBamServiceTableObj();
		CFBamServiceTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamServiceTableObj();
