...
namespace cfbam {
	...
	{
	public:
		ICFBamTZTimestampDefTableObj();
		virtual ~ICFBamTZTimestampDefTableObj();
		...
		virtual cfbam::ICFBamTZTimestampDefObj* newInstance() = 0;

		virtual cfbam::ICFBamTZTimestampDefEditObj* newEditInstance( cfbam::ICFBamTZTimestampDefObj* orig ) = 0;

		virtual cfbam::ICFBamTZTimestampDefObj* realizeTZTimestampDef( cfbam::ICFBamTZTimestampDefObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeTZTimestampDef( cfbam::ICFBamTZTimestampDefObj* Obj ) = 0;
		virtual cfbam::ICFBamTZTimestampDefObj* createTZTimestampDef( cfbam::ICFBamTZTimestampDefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamTZTimestampDefObj* readTZTimestampDef( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTZTimestampDefObj* lockTZTimestampDef( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamTZTimestampDefObj*> readAllTZTimestampDef( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamTZTimestampDefObj* readCachedTZTimestampDef( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamTZTimestampDefObj*> readCachedTZTimestampDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTZTimestampDefObj* updateTZTimestampDef( cfbam::ICFBamTZTimestampDefEditObj* Obj ) = 0;

		virtual void deleteTZTimestampDef( cfbam::ICFBamTZTimestampDefEditObj* Obj ) = 0;
		...
		virtual void deleteTZTimestampDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTZTimestampDefObj* moveUpTZTimestampDef( cfbam::ICFBamTZTimestampDefObj* Obj ) = 0;

		virtual cfbam::ICFBamTZTimestampDefObj* moveDownTZTimestampDef( cfbam::ICFBamTZTimestampDefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesTZTimestampDef( cfbam::ICFBamTZTimestampDefObj* Obj ) = 0;
