...
// Description: C++18 Object interface for CFBam ServerMethod.
...
namespace cfbam {
	...
	public:
		...
		virtual ~ICFBamServerMethodObj();
		virtual cfbam::ICFBamScopeEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamServerMethodEditObj* getServerMethodEdit() = 0;
		...
		virtual std::vector<cfbam::ICFBamParamObj*> getOptionalComponentsParams( bool forceRead = false ) = 0;
