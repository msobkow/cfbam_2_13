...
namespace cfbam {
	...
	{
	public:
		ICFBamDoubleDefTableObj();
		virtual ~ICFBamDoubleDefTableObj();
		...
		virtual cfbam::ICFBamDoubleDefObj* newInstance() = 0;

		virtual cfbam::ICFBamDoubleDefEditObj* newEditInstance( cfbam::ICFBamDoubleDefObj* orig ) = 0;

		virtual cfbam::ICFBamDoubleDefObj* realizeDoubleDef( cfbam::ICFBamDoubleDefObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeDoubleDef( cfbam::ICFBamDoubleDefObj* Obj ) = 0;
		virtual cfbam::ICFBamDoubleDefObj* createDoubleDef( cfbam::ICFBamDoubleDefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamDoubleDefObj* readDoubleDef( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamDoubleDefObj* lockDoubleDef( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamDoubleDefObj*> readAllDoubleDef( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamDoubleDefObj* readCachedDoubleDef( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamDoubleDefObj*> readCachedDoubleDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamDoubleDefObj* updateDoubleDef( cfbam::ICFBamDoubleDefEditObj* Obj ) = 0;

		virtual void deleteDoubleDef( cfbam::ICFBamDoubleDefEditObj* Obj ) = 0;
		...
		virtual void deleteDoubleDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamDoubleDefObj* moveUpDoubleDef( cfbam::ICFBamDoubleDefObj* Obj ) = 0;

		virtual cfbam::ICFBamDoubleDefObj* moveDownDoubleDef( cfbam::ICFBamDoubleDefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesDoubleDef( cfbam::ICFBamDoubleDefObj* Obj ) = 0;
