...
// Description: C++18 Object interface for CFBam Param.
...
namespace cfbam {
	...
	public:
		...
		virtual cfbam::ICFBamParamObj* realize() = 0;

		virtual cfbam::ICFBamParamObj* read( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamParamObj* moveUp() = 0;

		virtual cfbam::ICFBamParamObj* moveDown() = 0;

		virtual cfbam::ICFBamParamEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfbam::ICFBamParamEditObj* getEdit() = 0;

		virtual cfbam::ICFBamParamEditObj* getParamEdit() = 0;

		virtual cfbam::ICFBamParamTableObj* getParamTable() = 0;

		virtual cfbam::ICFBamSchemaObj* getSchema() = 0;

		virtual cfbam::CFBamParamBuff* getBuff() = 0;
		virtual void setBuff( cfbam::CFBamParamBuff* value ) = 0;

		inline cfbam::CFBamParamBuff* getParamBuff() {
			return( static_cast<cfbam::CFBamParamBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamParamBuff* getParamEditBuff() {
			return( dynamic_cast<cfbam::CFBamParamBuff*>( getBuff() ) );
		};

		virtual cfbam::CFBamParamPKey* getPKey() = 0;
		virtual void setPKey( cfbam::CFBamParamPKey* value ) = 0;
		...
		virtual const int64_t getRequiredServerMethodId() = 0;
		virtual const int64_t* getRequiredServerMethodIdReference() = 0;
		...
		virtual bool isOptionalTypeTenantIdNull() = 0;
		virtual const int64_t getOptionalTypeTenantIdValue() = 0;
		virtual const int64_t* getOptionalTypeTenantIdReference() = 0;

		virtual bool isOptionalTypeIdNull() = 0;
		virtual const int64_t getOptionalTypeIdValue() = 0;
		virtual const int64_t* getOptionalTypeIdReference() = 0;
		...
		virtual cfbam::ICFBamServerMethodObj* getRequiredContainerServerMeth( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamParamObj* getOptionalLookupPrev( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamParamObj* getOptionalLookupNext( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamValueObj* getRequiredLookupType( bool forceRead = false ) = 0;
