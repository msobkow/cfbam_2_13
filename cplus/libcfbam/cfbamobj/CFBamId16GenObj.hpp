...
// Description: C++18 base object instance specification for CFBam Id16Gen.
...
namespace cfbam {
	...
	class CFBamId16GenObj
	: public CFBamInt16TypeObj,
	  public virtual ICFBamId16GenObj
	{
	protected:
	public:
		...
		CFBamId16GenObj();
		CFBamId16GenObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamId16GenObj();
