...
// Description: C++18 Instance Edit Object interface for CFBam Int16Type.
...
namespace cfbam {
	...
	public:
		...
		virtual ~ICFBamInt16TypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamInt16TypeBuff* getInt16TypeBuff() {
			return( static_cast<cfbam::CFBamInt16TypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamInt16TypeBuff* getInt16TypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamInt16TypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamInt16TypeObj* getOrigAsInt16Type() = 0;
