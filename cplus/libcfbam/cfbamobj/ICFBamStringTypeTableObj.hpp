...
namespace cfbam {
	...
	{
	public:
		ICFBamStringTypeTableObj();
		virtual ~ICFBamStringTypeTableObj();
		...
		virtual cfbam::ICFBamStringTypeObj* newInstance() = 0;

		virtual cfbam::ICFBamStringTypeEditObj* newEditInstance( cfbam::ICFBamStringTypeObj* orig ) = 0;

		virtual cfbam::ICFBamStringTypeObj* realizeStringType( cfbam::ICFBamStringTypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeStringType( cfbam::ICFBamStringTypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamStringTypeObj* createStringType( cfbam::ICFBamStringTypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamStringTypeObj* readStringType( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamStringTypeObj* lockStringType( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamStringTypeObj*> readAllStringType( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamStringTypeObj* readCachedStringType( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamStringTypeObj*> readCachedStringTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamStringTypeObj* updateStringType( cfbam::ICFBamStringTypeEditObj* Obj ) = 0;

		virtual void deleteStringType( cfbam::ICFBamStringTypeEditObj* Obj ) = 0;
		...
		virtual void deleteStringTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamStringTypeObj* moveUpStringType( cfbam::ICFBamStringTypeObj* Obj ) = 0;

		virtual cfbam::ICFBamStringTypeObj* moveDownStringType( cfbam::ICFBamStringTypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesStringType( cfbam::ICFBamStringTypeObj* Obj ) = 0;
