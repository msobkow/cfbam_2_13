...
// Description: C++18 Instance Edit Object interface for CFBam ClearSubDep1.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamClearDepEditObj,
	  public virtual cfbam::ICFBamClearSubDep1Obj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamClearSubDep1EditObj();
		virtual ~ICFBamClearSubDep1EditObj();
		...
		virtual cfbam::ICFBamClearSubDep1Obj* getOrigAsClearSubDep1() = 0;
		...
		virtual void setRequiredContainerClearTopDep( cfbam::ICFBamClearTopDepObj* value ) = 0;
