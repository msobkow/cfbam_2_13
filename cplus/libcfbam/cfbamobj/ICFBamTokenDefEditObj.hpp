...
// Description: C++18 Instance Edit Object interface for CFBam TokenDef.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamAtomEditObj,
	  public virtual cfbam::ICFBamTokenDefObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamTokenDefEditObj();
		virtual ~ICFBamTokenDefEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamTokenDefBuff* getTokenDefBuff() {
			return( static_cast<cfbam::CFBamTokenDefBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamTokenDefBuff* getTokenDefEditBuff() {
			return( dynamic_cast<cfbam::CFBamTokenDefBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamTokenDefObj* getOrigAsTokenDef() = 0;
