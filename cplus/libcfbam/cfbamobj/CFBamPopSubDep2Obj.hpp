...
// Description: C++18 base object instance specification for CFBam PopSubDep2.
...
namespace cfbam {
	...
	class CFBamPopSubDep2Obj
	: public CFBamPopDepObj,
	  public virtual ICFBamPopSubDep2Obj
	{
	protected:
	public:
		...
		CFBamPopSubDep2Obj();
		CFBamPopSubDep2Obj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamPopSubDep2Obj();
