...
namespace cfbam {
	...
	{
	public:
		ICFBamDateDefTableObj();
		virtual ~ICFBamDateDefTableObj();
		...
		virtual cfbam::ICFBamDateDefObj* newInstance() = 0;

		virtual cfbam::ICFBamDateDefEditObj* newEditInstance( cfbam::ICFBamDateDefObj* orig ) = 0;

		virtual cfbam::ICFBamDateDefObj* realizeDateDef( cfbam::ICFBamDateDefObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeDateDef( cfbam::ICFBamDateDefObj* Obj ) = 0;
		virtual cfbam::ICFBamDateDefObj* createDateDef( cfbam::ICFBamDateDefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamDateDefObj* readDateDef( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamDateDefObj* lockDateDef( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamDateDefObj*> readAllDateDef( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamDateDefObj* readCachedDateDef( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamDateDefObj*> readCachedDateDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamDateDefObj* updateDateDef( cfbam::ICFBamDateDefEditObj* Obj ) = 0;

		virtual void deleteDateDef( cfbam::ICFBamDateDefEditObj* Obj ) = 0;
		...
		virtual void deleteDateDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamDateDefObj* moveUpDateDef( cfbam::ICFBamDateDefObj* Obj ) = 0;

		virtual cfbam::ICFBamDateDefObj* moveDownDateDef( cfbam::ICFBamDateDefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesDateDef( cfbam::ICFBamDateDefObj* Obj ) = 0;
