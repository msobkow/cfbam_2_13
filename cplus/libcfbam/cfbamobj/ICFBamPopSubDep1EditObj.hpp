...
// Description: C++18 Instance Edit Object interface for CFBam PopSubDep1.
...
namespace cfbam {
	...
	class ICFBamPopSubDep1EditObj
	: public virtual cfbam::ICFBamPopDepEditObj,
	  public virtual cfbam::ICFBamPopSubDep1Obj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamPopSubDep1EditObj();
		virtual ~ICFBamPopSubDep1EditObj();
		...
		virtual cfbam::ICFBamPopSubDep1Obj* getOrigAsPopSubDep1() = 0;
		...
		virtual void setRequiredContainerContPopTopDep( cfbam::ICFBamPopTopDepObj* value ) = 0;
