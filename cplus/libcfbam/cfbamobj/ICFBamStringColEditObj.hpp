...
// Description: C++18 Instance Edit Object interface for CFBam StringCol.
...
namespace cfbam {
	...
	class ICFBamStringColEditObj
	: public virtual cfbam::ICFBamStringDefEditObj,
	  public virtual cfbam::ICFBamStringColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamStringColEditObj();
		virtual ~ICFBamStringColEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamStringColBuff* getStringColBuff() {
			return( static_cast<cfbam::CFBamStringColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamStringColBuff* getStringColEditBuff() {
			return( dynamic_cast<cfbam::CFBamStringColBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamStringColObj* getOrigAsStringCol() = 0;
