...
namespace cfbam {
	...
	{
	public:
		ICFBamTZDateTypeTableObj();
		virtual ~ICFBamTZDateTypeTableObj();
		...
		virtual cfbam::ICFBamTZDateTypeObj* newInstance() = 0;

		virtual cfbam::ICFBamTZDateTypeEditObj* newEditInstance( cfbam::ICFBamTZDateTypeObj* orig ) = 0;

		virtual cfbam::ICFBamTZDateTypeObj* realizeTZDateType( cfbam::ICFBamTZDateTypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeTZDateType( cfbam::ICFBamTZDateTypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamTZDateTypeObj* createTZDateType( cfbam::ICFBamTZDateTypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamTZDateTypeObj* readTZDateType( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTZDateTypeObj* lockTZDateType( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamTZDateTypeObj*> readAllTZDateType( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamTZDateTypeObj* readCachedTZDateType( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamTZDateTypeObj*> readCachedTZDateTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTZDateTypeObj* updateTZDateType( cfbam::ICFBamTZDateTypeEditObj* Obj ) = 0;

		virtual void deleteTZDateType( cfbam::ICFBamTZDateTypeEditObj* Obj ) = 0;
		...
		virtual void deleteTZDateTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTZDateTypeObj* moveUpTZDateType( cfbam::ICFBamTZDateTypeObj* Obj ) = 0;

		virtual cfbam::ICFBamTZDateTypeObj* moveDownTZDateType( cfbam::ICFBamTZDateTypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesTZDateType( cfbam::ICFBamTZDateTypeObj* Obj ) = 0;
