...
// Description: C++18 base object instance specification for CFBam Int16Col.
...
namespace cfbam {
	...
	class CFBamInt16ColObj
	: public CFBamInt16DefObj,
	  public virtual ICFBamInt16ColObj
	{
	protected:
	public:
		...
		CFBamInt16ColObj();
		CFBamInt16ColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamInt16ColObj();
