...
namespace cfbam {
	...
	{
	public:
		ICFBamStringColTableObj();
		virtual ~ICFBamStringColTableObj();
		...
		virtual cfbam::ICFBamStringColObj* newInstance() = 0;

		virtual cfbam::ICFBamStringColEditObj* newEditInstance( cfbam::ICFBamStringColObj* orig ) = 0;

		virtual cfbam::ICFBamStringColObj* realizeStringCol( cfbam::ICFBamStringColObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeStringCol( cfbam::ICFBamStringColObj* Obj ) = 0;
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId ) = 0;
		virtual cfbam::ICFBamStringColObj* createStringCol( cfbam::ICFBamStringColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamStringColObj* readStringCol( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamStringColObj* lockStringCol( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamStringColObj*> readAllStringCol( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamStringColObj* readCachedStringCol( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamStringColObj*> readCachedStringColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamStringColObj* updateStringCol( cfbam::ICFBamStringColEditObj* Obj ) = 0;

		virtual void deleteStringCol( cfbam::ICFBamStringColEditObj* Obj ) = 0;
		...
		virtual void deleteStringColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamStringColObj* moveUpStringCol( cfbam::ICFBamStringColObj* Obj ) = 0;

		virtual cfbam::ICFBamStringColObj* moveDownStringCol( cfbam::ICFBamStringColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesStringCol( cfbam::ICFBamStringColObj* Obj ) = 0;
