...
namespace cfbam {
	...
	class CFBamDoubleTypeTableObj
	: public virtual ICFBamDoubleTypeTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamDoubleTypeObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamDoubleTypeObj*>* allDoubleType;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamDoubleTypeObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamDoubleTypeObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamDoubleTypeObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamDoubleTypeObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamDoubleTypeObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamDoubleTypeObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamDoubleTypeObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamDoubleTypeObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamDoubleTypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamDoubleTypeObj*>*>* indexBySchemaIdx;
	...
	public:
		...
		CFBamDoubleTypeTableObj();
		CFBamDoubleTypeTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamDoubleTypeTableObj();
		...
		virtual cfbam::ICFBamDoubleTypeObj* newInstance();

		virtual cfbam::ICFBamDoubleTypeEditObj* newEditInstance( cfbam::ICFBamDoubleTypeObj* orig );

		virtual cfbam::ICFBamDoubleTypeObj* realizeDoubleType( cfbam::ICFBamDoubleTypeObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeDoubleType( cfbam::ICFBamDoubleTypeObj* Obj );
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );
		virtual cfbam::ICFBamDoubleTypeObj* createDoubleType( cfbam::ICFBamDoubleTypeEditObj* Obj );

		virtual cfbam::ICFBamDoubleTypeObj* readDoubleType( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamDoubleTypeObj* lockDoubleType( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamDoubleTypeObj*> readAllDoubleType( bool forceRead = false );

		virtual cfbam::ICFBamDoubleTypeObj* readDoubleTypeByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamDoubleTypeObj* readDoubleTypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDoubleTypeObj*> readDoubleTypeByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDoubleTypeObj*> readDoubleTypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDoubleTypeObj*> readDoubleTypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDoubleTypeObj*> readDoubleTypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDoubleTypeObj*> readDoubleTypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDoubleTypeObj*> readDoubleTypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDoubleTypeObj*> readDoubleTypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDoubleTypeObj*> readDoubleTypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId,
			bool forceRead = false );

		virtual cfbam::ICFBamDoubleTypeObj* readCachedDoubleType( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamDoubleTypeObj* readCachedDoubleTypeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamDoubleTypeObj* readCachedDoubleTypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamDoubleTypeObj*> readCachedDoubleTypeByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamDoubleTypeObj*> readCachedDoubleTypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamDoubleTypeObj*> readCachedDoubleTypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamDoubleTypeObj*> readCachedDoubleTypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamDoubleTypeObj*> readCachedDoubleTypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamDoubleTypeObj*> readCachedDoubleTypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamDoubleTypeObj*> readCachedDoubleTypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamDoubleTypeObj*> readCachedDoubleTypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual cfbam::ICFBamDoubleTypeObj* updateDoubleType( cfbam::ICFBamDoubleTypeEditObj* Obj );

		virtual void deleteDoubleType( cfbam::ICFBamDoubleTypeEditObj* Obj );

		virtual void deleteDoubleTypeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteDoubleTypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteDoubleTypeByValTentIdx( const int64_t TenantId );

		virtual void deleteDoubleTypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteDoubleTypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteDoubleTypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteDoubleTypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteDoubleTypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteDoubleTypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteDoubleTypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual cfbam::ICFBamDoubleTypeObj* moveUpDoubleType( cfbam::ICFBamDoubleTypeObj* Obj );

		virtual cfbam::ICFBamDoubleTypeObj* moveDownDoubleType( cfbam::ICFBamDoubleTypeObj* Obj );

		virtual void reallyDetachFromIndexesDoubleType( cfbam::ICFBamDoubleTypeObj* Obj );
