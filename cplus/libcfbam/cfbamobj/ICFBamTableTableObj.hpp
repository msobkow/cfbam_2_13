...
namespace cfbam {
	...
	public:
		...
		virtual cfbam::ICFBamTableObj* newInstance() = 0;

		virtual cfbam::ICFBamTableEditObj* newEditInstance( cfbam::ICFBamTableObj* orig ) = 0;

		virtual cfbam::ICFBamTableObj* realizeTable( cfbam::ICFBamTableObj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByTenantIdx( const int64_t TenantId ) = 0;
		virtual void reallyDeepDisposeTable( cfbam::ICFBamTableObj* Obj ) = 0;
		...
		virtual cfbam::ICFBamTableObj* createTable( cfbam::ICFBamTableEditObj* Obj ) = 0;

		virtual cfbam::ICFBamTableObj* readTable( cfbam::CFBamScopePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTableObj* lockTable( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamTableObj*> readAllTable( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamTableObj* readCachedTable( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual cfbam::ICFBamTableObj* readCachedTableByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamTableObj*> readCachedTableByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTableObj* updateTable( cfbam::ICFBamTableEditObj* Obj ) = 0;

		virtual void deleteTable( cfbam::ICFBamTableEditObj* Obj ) = 0;

		virtual void deleteTableByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deleteTableByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesTable( cfbam::ICFBamTableObj* Obj ) = 0;
