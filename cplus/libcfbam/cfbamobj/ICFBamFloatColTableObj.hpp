...
namespace cfbam {
	...
	{
	public:
		ICFBamFloatColTableObj();
		virtual ~ICFBamFloatColTableObj();
		...
		virtual cfbam::ICFBamFloatColObj* newInstance() = 0;

		virtual cfbam::ICFBamFloatColEditObj* newEditInstance( cfbam::ICFBamFloatColObj* orig ) = 0;

		virtual cfbam::ICFBamFloatColObj* realizeFloatCol( cfbam::ICFBamFloatColObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeFloatCol( cfbam::ICFBamFloatColObj* Obj ) = 0;
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId ) = 0;
		virtual cfbam::ICFBamFloatColObj* createFloatCol( cfbam::ICFBamFloatColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamFloatColObj* readFloatCol( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamFloatColObj* lockFloatCol( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamFloatColObj*> readAllFloatCol( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamFloatColObj* readCachedFloatCol( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamFloatColObj*> readCachedFloatColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamFloatColObj* updateFloatCol( cfbam::ICFBamFloatColEditObj* Obj ) = 0;

		virtual void deleteFloatCol( cfbam::ICFBamFloatColEditObj* Obj ) = 0;
		...
		virtual void deleteFloatColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamFloatColObj* moveUpFloatCol( cfbam::ICFBamFloatColObj* Obj ) = 0;

		virtual cfbam::ICFBamFloatColObj* moveDownFloatCol( cfbam::ICFBamFloatColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesFloatCol( cfbam::ICFBamFloatColObj* Obj ) = 0;
