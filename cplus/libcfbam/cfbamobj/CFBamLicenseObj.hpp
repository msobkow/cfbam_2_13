...
// Description: C++18 base object instance specification for CFBam License.
...
namespace cfbam {
	...
	class CFBamLicenseObj
	: public virtual ICFBamLicenseObj,
	...
	public:
		...
		CFBamLicenseObj();
		CFBamLicenseObj( cfint::ICFIntSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamLicenseObj();
