...
// Description: C++18 Instance Edit Object interface for CFBam TimeType.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamTimeDefEditObj,
	  public virtual cfbam::ICFBamTimeTypeObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamTimeTypeEditObj();
		virtual ~ICFBamTimeTypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamTimeTypeBuff* getTimeTypeBuff() {
			return( static_cast<cfbam::CFBamTimeTypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamTimeTypeBuff* getTimeTypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamTimeTypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamTimeTypeObj* getOrigAsTimeType() = 0;
