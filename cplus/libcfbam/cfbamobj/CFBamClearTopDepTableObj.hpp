...
namespace cfbam {
	...
	class CFBamClearTopDepTableObj
	: public virtual ICFBamClearTopDepTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearTopDepObj*>* members;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearTopDepObj*>* allClearTopDep;
		std::map< cfbam::CFBamScopeByTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearTopDepObj*>*>* indexByTenantIdx;
		std::map< cfbam::CFBamClearDepByClearDepIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearTopDepObj*>*>* indexByClearDepIdx;
		std::map< cfbam::CFBamClearDepByDefSchemaIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearTopDepObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamClearTopDepByClrTopDepTblIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearTopDepObj*>*>* indexByClrTopDepTblIdx;
		std::map< cfbam::CFBamClearTopDepByUNameIdxKey,
			cfbam::ICFBamClearTopDepObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamClearTopDepByPrevIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearTopDepObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamClearTopDepByNextIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearTopDepObj*>*>* indexByNextIdx;
	...
	public:
		...
		CFBamClearTopDepTableObj();
		CFBamClearTopDepTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamClearTopDepTableObj();
		...
		virtual cfbam::ICFBamClearTopDepObj* newInstance();

		virtual cfbam::ICFBamClearTopDepEditObj* newEditInstance( cfbam::ICFBamClearTopDepObj* orig );

		virtual cfbam::ICFBamClearTopDepObj* realizeClearTopDep( cfbam::ICFBamClearTopDepObj* Obj );

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id );
		virtual void deepDisposeByTenantIdx( const int64_t TenantId );
		virtual void reallyDeepDisposeClearTopDep( cfbam::ICFBamClearTopDepObj* Obj );
		virtual void deepDisposeByClearDepIdx( const int64_t TenantId,
			const int64_t RelationId );
		virtual void deepDisposeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );
		virtual void deepDisposeByClrTopDepTblIdx( const int64_t TableTenantId,
		...
		virtual cfbam::ICFBamClearTopDepObj* createClearTopDep( cfbam::ICFBamClearTopDepEditObj* Obj );

		virtual cfbam::ICFBamClearTopDepObj* readClearTopDep( cfbam::CFBamScopePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamClearTopDepObj* lockClearTopDep( cfbam::CFBamScopePKey* pkey );

		virtual std::vector<cfbam::ICFBamClearTopDepObj*> readAllClearTopDep( bool forceRead = false );

		virtual cfbam::ICFBamClearTopDepObj* readClearTopDepByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamClearTopDepObj*> readClearTopDepByTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamClearTopDepObj*> readClearTopDepByClearDepIdx( const int64_t TenantId,
			const int64_t RelationId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamClearTopDepObj*> readClearTopDepByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamClearTopDepObj*> readClearTopDepByClrTopDepTblIdx( const int64_t TableTenantId,
			const int64_t TableId,
			bool forceRead = false );

		virtual cfbam::ICFBamClearTopDepObj* readClearTopDepByUNameIdx( const int64_t TableTenantId,
			const int64_t TableId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamClearTopDepObj*> readClearTopDepByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamClearTopDepObj*> readClearTopDepByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual cfbam::ICFBamClearTopDepObj* readCachedClearTopDep( cfbam::CFBamScopePKey* pkey );

		virtual cfbam::ICFBamClearTopDepObj* readCachedClearTopDepByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual std::vector<cfbam::ICFBamClearTopDepObj*> readCachedClearTopDepByTenantIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamClearTopDepObj*> readCachedClearTopDepByClearDepIdx( const int64_t TenantId,
			const int64_t RelationId );

		virtual std::vector<cfbam::ICFBamClearTopDepObj*> readCachedClearTopDepByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamClearTopDepObj*> readCachedClearTopDepByClrTopDepTblIdx( const int64_t TableTenantId,
			const int64_t TableId );

		virtual cfbam::ICFBamClearTopDepObj* readCachedClearTopDepByUNameIdx( const int64_t TableTenantId,
			const int64_t TableId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamClearTopDepObj*> readCachedClearTopDepByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamClearTopDepObj*> readCachedClearTopDepByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual cfbam::ICFBamClearTopDepObj* updateClearTopDep( cfbam::ICFBamClearTopDepEditObj* Obj );

		virtual void deleteClearTopDep( cfbam::ICFBamClearTopDepEditObj* Obj );

		virtual void deleteClearTopDepByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteClearTopDepByTenantIdx( const int64_t TenantId );

		virtual void deleteClearTopDepByClearDepIdx( const int64_t TenantId,
			const int64_t RelationId );

		virtual void deleteClearTopDepByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteClearTopDepByClrTopDepTblIdx( const int64_t TableTenantId,
			const int64_t TableId );

		virtual void deleteClearTopDepByUNameIdx( const int64_t TableTenantId,
			const int64_t TableId,
			const std::string& Name );

		virtual void deleteClearTopDepByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteClearTopDepByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual cfbam::ICFBamClearTopDepObj* moveUpClearTopDep( cfbam::ICFBamClearTopDepObj* Obj );

		virtual cfbam::ICFBamClearTopDepObj* moveDownClearTopDep( cfbam::ICFBamClearTopDepObj* Obj );

		virtual void reallyDetachFromIndexesClearTopDep( cfbam::ICFBamClearTopDepObj* Obj );
