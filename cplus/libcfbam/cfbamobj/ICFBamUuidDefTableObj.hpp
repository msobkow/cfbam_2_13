...
namespace cfbam {
	...
	{
	public:
		ICFBamUuidDefTableObj();
		virtual ~ICFBamUuidDefTableObj();
		...
		virtual cfbam::ICFBamUuidDefObj* newInstance() = 0;

		virtual cfbam::ICFBamUuidDefEditObj* newEditInstance( cfbam::ICFBamUuidDefObj* orig ) = 0;

		virtual cfbam::ICFBamUuidDefObj* realizeUuidDef( cfbam::ICFBamUuidDefObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeUuidDef( cfbam::ICFBamUuidDefObj* Obj ) = 0;
		virtual cfbam::ICFBamUuidDefObj* createUuidDef( cfbam::ICFBamUuidDefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamUuidDefObj* readUuidDef( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamUuidDefObj* lockUuidDef( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamUuidDefObj*> readAllUuidDef( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamUuidDefObj* readCachedUuidDef( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamUuidDefObj*> readCachedUuidDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUuidDefObj* updateUuidDef( cfbam::ICFBamUuidDefEditObj* Obj ) = 0;

		virtual void deleteUuidDef( cfbam::ICFBamUuidDefEditObj* Obj ) = 0;
		...
		virtual void deleteUuidDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUuidDefObj* moveUpUuidDef( cfbam::ICFBamUuidDefObj* Obj ) = 0;

		virtual cfbam::ICFBamUuidDefObj* moveDownUuidDef( cfbam::ICFBamUuidDefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesUuidDef( cfbam::ICFBamUuidDefObj* Obj ) = 0;
