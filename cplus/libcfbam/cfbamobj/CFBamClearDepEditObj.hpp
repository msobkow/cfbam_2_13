...
// Description: C++18 edit object instance specification for CFBam ClearDep.
...
namespace cfbam {
	...
	class CFBamClearDepEditObj
	: public CFBamScopeEditObj,
	  public virtual ICFBamClearDepEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamClearDepEditObj( cfbam::ICFBamClearDepObj* argOrig );
		virtual ~CFBamClearDepEditObj();
		...
		virtual cfbam::ICFBamClearDepTableObj* getClearDepTable();

		virtual cfbam::ICFBamClearDepEditObj* getClearDepEdit();

		virtual ICFBamScopeEditObj* beginEdit();

		virtual cfbam::ICFBamClearDepObj* getOrigAsClearDep();
		...
		inline cfbam::CFBamClearDepBuff* getClearDepBuff() {
			...
			return( static_cast<cfbam::CFBamClearDepBuff*>( buff ) );
		};
