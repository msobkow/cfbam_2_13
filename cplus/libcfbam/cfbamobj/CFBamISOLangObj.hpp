...
// Description: C++18 base object instance specification for CFBam ISOLang.
...
namespace cfbam {
	...
	class CFBamISOLangObj
	: public virtual ICFBamISOLangObj,
	...
	public:
		...
		CFBamISOLangObj();
		CFBamISOLangObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamISOLangObj();
