...
// Description: C++18 Instance Edit Object interface for CFBam TZDateCol.
...
namespace cfbam {
	...
	class ICFBamTZDateColEditObj
	: public virtual cfbam::ICFBamTZDateDefEditObj,
	  public virtual cfbam::ICFBamTZDateColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamTZDateColEditObj();
		virtual ~ICFBamTZDateColEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamTZDateColBuff* getTZDateColBuff() {
			return( static_cast<cfbam::CFBamTZDateColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamTZDateColBuff* getTZDateColEditBuff() {
			return( dynamic_cast<cfbam::CFBamTZDateColBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamTZDateColObj* getOrigAsTZDateCol() = 0;
