...
// Description: C++18 edit object instance specification for CFBam Int64Col.
...
namespace cfbam {
	...
	class CFBamInt64ColEditObj
	: public CFBamInt64DefEditObj,
	  public virtual ICFBamInt64ColEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamInt64ColEditObj( cfbam::ICFBamInt64ColObj* argOrig );
		virtual ~CFBamInt64ColEditObj();
		...
		virtual cfbam::ICFBamInt64ColTableObj* getInt64ColTable();

		virtual cfbam::ICFBamInt64ColEditObj* getInt64ColEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamInt64ColObj* getOrigAsInt64Col();
		...
		inline cfbam::CFBamInt64ColBuff* getInt64ColBuff() {
			...
			return( static_cast<cfbam::CFBamInt64ColBuff*>( buff ) );
		};
