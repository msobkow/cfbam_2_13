...
// Description: C++18 Object interface for CFBam Id64Gen.
...
namespace cfbam {
	...
	class ICFBamId64GenObj
	: public virtual cfbam::ICFBamInt64TypeObj
	{
	public:
		ICFBamId64GenObj();
		virtual ~ICFBamId64GenObj();
		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamId64GenEditObj* getId64GenEdit() = 0;

		inline cfbam::CFBamId64GenBuff* getId64GenBuff() {
			return( static_cast<cfbam::CFBamId64GenBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamId64GenBuff* getId64GenEditBuff() {
			return( dynamic_cast<cfbam::CFBamId64GenBuff*>( getBuff() ) );
		};

		virtual bool isOptionalDispenserTenantIdNull() = 0;
		virtual const int64_t getOptionalDispenserTenantIdValue() = 0;
		virtual const int64_t* getOptionalDispenserTenantIdReference() = 0;

		virtual bool isOptionalDispenserIdNull() = 0;
		virtual const int64_t getOptionalDispenserIdValue() = 0;
		virtual const int64_t* getOptionalDispenserIdReference() = 0;

		virtual const int16_t getRequiredSlice() = 0;
		virtual const int16_t* getRequiredSliceReference() = 0;

		virtual const int64_t getRequiredBlockSize() = 0;
		virtual const int64_t* getRequiredBlockSizeReference() = 0;

		virtual cfbam::ICFBamTableObj* getOptionalLookupDispenser( bool forceRead = false ) = 0;
