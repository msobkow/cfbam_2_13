...
// Description: C++18 base object instance specification for CFBam TZTimeCol.
...
namespace cfbam {
	...
	class CFBamTZTimeColObj
	: public CFBamTZTimeDefObj,
	  public virtual ICFBamTZTimeColObj
	{
	protected:
	public:
		...
		CFBamTZTimeColObj();
		CFBamTZTimeColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTZTimeColObj();
