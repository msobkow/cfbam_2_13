...
// Description: C++18 base object instance specification for CFBam Int64Col.
...
namespace cfbam {
	...
	class CFBamInt64ColObj
	: public CFBamInt64DefObj,
	  public virtual ICFBamInt64ColObj
	{
	protected:
	public:
		...
		CFBamInt64ColObj();
		CFBamInt64ColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamInt64ColObj();
