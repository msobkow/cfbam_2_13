...
namespace cfbam {
	...
	class CFBamNmTokensDefTableObj
	: public virtual ICFBamNmTokensDefTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensDefObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensDefObj*>* allNmTokensDef;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamNmTokensDefObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensDefObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensDefObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensDefObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensDefObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensDefObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensDefObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensDefObj*>*>* indexByContNextIdx;
	...
	public:
		...
		CFBamNmTokensDefTableObj();
		CFBamNmTokensDefTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamNmTokensDefTableObj();
		...
		virtual cfbam::ICFBamNmTokensDefObj* newInstance();

		virtual cfbam::ICFBamNmTokensDefEditObj* newEditInstance( cfbam::ICFBamNmTokensDefObj* orig );

		virtual cfbam::ICFBamNmTokensDefObj* realizeNmTokensDef( cfbam::ICFBamNmTokensDefObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeNmTokensDef( cfbam::ICFBamNmTokensDefObj* Obj );
		virtual cfbam::ICFBamNmTokensDefObj* createNmTokensDef( cfbam::ICFBamNmTokensDefEditObj* Obj );

		virtual cfbam::ICFBamNmTokensDefObj* readNmTokensDef( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamNmTokensDefObj* lockNmTokensDef( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamNmTokensDefObj*> readAllNmTokensDef( bool forceRead = false );

		virtual cfbam::ICFBamNmTokensDefObj* readNmTokensDefByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamNmTokensDefObj* readNmTokensDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokensDefObj*> readNmTokensDefByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokensDefObj*> readNmTokensDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokensDefObj*> readNmTokensDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokensDefObj*> readNmTokensDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokensDefObj*> readNmTokensDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokensDefObj*> readNmTokensDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokensDefObj*> readNmTokensDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual cfbam::ICFBamNmTokensDefObj* readCachedNmTokensDef( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamNmTokensDefObj* readCachedNmTokensDefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamNmTokensDefObj* readCachedNmTokensDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamNmTokensDefObj*> readCachedNmTokensDefByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamNmTokensDefObj*> readCachedNmTokensDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamNmTokensDefObj*> readCachedNmTokensDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamNmTokensDefObj*> readCachedNmTokensDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamNmTokensDefObj*> readCachedNmTokensDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamNmTokensDefObj*> readCachedNmTokensDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamNmTokensDefObj*> readCachedNmTokensDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamNmTokensDefObj* updateNmTokensDef( cfbam::ICFBamNmTokensDefEditObj* Obj );

		virtual void deleteNmTokensDef( cfbam::ICFBamNmTokensDefEditObj* Obj );

		virtual void deleteNmTokensDefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteNmTokensDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteNmTokensDefByValTentIdx( const int64_t TenantId );

		virtual void deleteNmTokensDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteNmTokensDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteNmTokensDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteNmTokensDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteNmTokensDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteNmTokensDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamNmTokensDefObj* moveUpNmTokensDef( cfbam::ICFBamNmTokensDefObj* Obj );

		virtual cfbam::ICFBamNmTokensDefObj* moveDownNmTokensDef( cfbam::ICFBamNmTokensDefObj* Obj );

		virtual void reallyDetachFromIndexesNmTokensDef( cfbam::ICFBamNmTokensDefObj* Obj );
