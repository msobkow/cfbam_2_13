...
// Description: C++18 Object interface for CFBam TZTimestampDef.
...
namespace cfbam {
	...
	public:
		...
		virtual ~ICFBamTZTimestampDefObj();
		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamTZTimestampDefEditObj* getTZTimestampDefEdit() = 0;
