...
// Description: C++18 base object instance specification for CFBam FloatDef.
...
namespace cfbam {
	...
	class CFBamFloatDefObj
	: public CFBamAtomObj,
	  public virtual ICFBamFloatDefObj
	{
	protected:
	public:
		...
		CFBamFloatDefObj();
		CFBamFloatDefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamFloatDefObj();
