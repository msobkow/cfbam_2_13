...
namespace cfbam {
	...
	class CFBamScopeTableObj
	: public virtual ICFBamScopeTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamScopeObj*>* members;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamScopeObj*>* allScope;
		std::map< cfbam::CFBamScopeByTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamScopeObj*>*>* indexByTenantIdx;
	...
	public:
		...
		CFBamScopeTableObj();
		CFBamScopeTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamScopeTableObj();
		...
		virtual cfbam::ICFBamScopeObj* newInstance();

		virtual cfbam::ICFBamScopeEditObj* newEditInstance( cfbam::ICFBamScopeObj* orig );

		virtual cfbam::ICFBamScopeObj* constructByClassCode( const classcode_t argClassCode );

		virtual cfbam::ICFBamScopeObj* realizeScope( cfbam::ICFBamScopeObj* Obj );

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id );
		virtual void deepDisposeByTenantIdx( const int64_t TenantId );
		virtual void reallyDeepDisposeScope( cfbam::ICFBamScopeObj* Obj );
		virtual cfbam::ICFBamScopeObj* createScope( cfbam::ICFBamScopeEditObj* Obj );

		virtual cfbam::ICFBamScopeObj* readScope( cfbam::CFBamScopePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamScopeObj* lockScope( cfbam::CFBamScopePKey* pkey );

		virtual std::vector<cfbam::ICFBamScopeObj*> readAllScope( bool forceRead = false );

		virtual cfbam::ICFBamScopeObj* readScopeByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamScopeObj*> readScopeByTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual cfbam::ICFBamScopeObj* readCachedScope( cfbam::CFBamScopePKey* pkey );

		virtual cfbam::ICFBamScopeObj* readCachedScopeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual std::vector<cfbam::ICFBamScopeObj*> readCachedScopeByTenantIdx( const int64_t TenantId );

		virtual cfbam::ICFBamScopeObj* updateScope( cfbam::ICFBamScopeEditObj* Obj );

		virtual void deleteScope( cfbam::ICFBamScopeEditObj* Obj );

		virtual void deleteScopeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteScopeByTenantIdx( const int64_t TenantId );

		virtual void reallyDetachFromIndexesScope( cfbam::ICFBamScopeObj* Obj );
