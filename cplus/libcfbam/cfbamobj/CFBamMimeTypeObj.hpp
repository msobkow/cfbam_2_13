...
// Description: C++18 base object instance specification for CFBam MimeType.
...
namespace cfbam {
	...
	class CFBamMimeTypeObj
	: public virtual ICFBamMimeTypeObj,
	...
	public:
		...
		CFBamMimeTypeObj();
		CFBamMimeTypeObj( cfint::ICFIntSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamMimeTypeObj();
