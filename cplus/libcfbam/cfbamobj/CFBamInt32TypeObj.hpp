...
// Description: C++18 base object instance specification for CFBam Int32Type.
...
namespace cfbam {
	...
	class CFBamInt32TypeObj
	: public CFBamInt32DefObj,
	  public virtual ICFBamInt32TypeObj
	{
	protected:
	public:
		...
		CFBamInt32TypeObj();
		CFBamInt32TypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamInt32TypeObj();
