...
// Description: C++18 base object instance specification for CFBam Relation.
...
namespace cfbam {
	...
	class CFBamRelationObj
	: public CFBamScopeObj,
	  public virtual ICFBamRelationObj
	{
	protected:
	public:
		...
		CFBamRelationObj();
		CFBamRelationObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamRelationObj();
