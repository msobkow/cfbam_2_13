...
// Description: C++18 base object instance specification for CFBam TZTimestampDef.
...
namespace cfbam {
	...
	class CFBamTZTimestampDefObj
	: public CFBamAtomObj,
	  public virtual ICFBamTZTimestampDefObj
	{
	protected:
	public:
		...
		CFBamTZTimestampDefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTZTimestampDefObj();
