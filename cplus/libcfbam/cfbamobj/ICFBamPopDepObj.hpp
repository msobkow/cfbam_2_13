...
// Description: C++18 Object interface for CFBam PopDep.
...
namespace cfbam {
	...
	public:
		ICFBamPopDepObj();
		virtual ~ICFBamPopDepObj();
		virtual cfbam::ICFBamScopeEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamPopDepEditObj* getPopDepEdit() = 0;

		inline cfbam::CFBamPopDepBuff* getPopDepBuff() {
			return( static_cast<cfbam::CFBamPopDepBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamPopDepBuff* getPopDepEditBuff() {
			return( dynamic_cast<cfbam::CFBamPopDepBuff*>( getBuff() ) );
		};
