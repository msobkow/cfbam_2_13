...
// Description: C++18 edit object instance specification for CFBam SecUser.
...
namespace cfbam {
	...
	class CFBamSecUserEditObj
	: public virtual ICFBamSecUserEditObj,
	  public virtual cfsec::ICFSecSecUserEditObj,
	  public virtual cfint::ICFIntSecUserEditObj
	{
	public:
	...
	public:
		CFBamSecUserEditObj( cfsec::ICFSecSecUserObj* argOrig );
		virtual ~CFBamSecUserEditObj();
