...
namespace cfbam {
	...
	class CFBamURLProtocolTableObj
	: public virtual ICFBamURLProtocolTableObj,
	...
	public:
		...
		CFBamURLProtocolTableObj();
		CFBamURLProtocolTableObj( cfint::ICFIntSchemaObj* argSchema );
		virtual ~CFBamURLProtocolTableObj();
