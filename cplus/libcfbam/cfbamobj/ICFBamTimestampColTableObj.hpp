...
namespace cfbam {
	...
	{
	public:
		ICFBamTimestampColTableObj();
		virtual ~ICFBamTimestampColTableObj();
		...
		virtual cfbam::ICFBamTimestampColObj* newInstance() = 0;

		virtual cfbam::ICFBamTimestampColEditObj* newEditInstance( cfbam::ICFBamTimestampColObj* orig ) = 0;

		virtual cfbam::ICFBamTimestampColObj* realizeTimestampCol( cfbam::ICFBamTimestampColObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeTimestampCol( cfbam::ICFBamTimestampColObj* Obj ) = 0;
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId ) = 0;
		virtual cfbam::ICFBamTimestampColObj* createTimestampCol( cfbam::ICFBamTimestampColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamTimestampColObj* readTimestampCol( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTimestampColObj* lockTimestampCol( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamTimestampColObj*> readAllTimestampCol( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamTimestampColObj* readCachedTimestampCol( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamTimestampColObj*> readCachedTimestampColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTimestampColObj* updateTimestampCol( cfbam::ICFBamTimestampColEditObj* Obj ) = 0;

		virtual void deleteTimestampCol( cfbam::ICFBamTimestampColEditObj* Obj ) = 0;
		...
		virtual void deleteTimestampColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTimestampColObj* moveUpTimestampCol( cfbam::ICFBamTimestampColObj* Obj ) = 0;

		virtual cfbam::ICFBamTimestampColObj* moveDownTimestampCol( cfbam::ICFBamTimestampColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesTimestampCol( cfbam::ICFBamTimestampColObj* Obj ) = 0;
