...
// Description: C++18 base object instance specification for CFBam MajorVersion.
...
namespace cfbam {
	...
	class CFBamMajorVersionObj
	: public virtual ICFBamMajorVersionObj,
	...
	public:
		...
		CFBamMajorVersionObj( cfint::ICFIntSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamMajorVersionObj();
