...
// Description: C++18 base object instance specification for CFBam TimestampType.
...
namespace cfbam {
	...
	class CFBamTimestampTypeObj
	: public CFBamTimestampDefObj,
	  public virtual ICFBamTimestampTypeObj
	{
	protected:
	public:
		...
		CFBamTimestampTypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTimestampTypeObj();
