...
namespace cfbam {
	...
	{
	public:
		ICFBamId16GenTableObj();
		virtual ~ICFBamId16GenTableObj();
		...
		virtual cfbam::ICFBamId16GenObj* newInstance() = 0;

		virtual cfbam::ICFBamId16GenEditObj* newEditInstance( cfbam::ICFBamId16GenObj* orig ) = 0;

		virtual cfbam::ICFBamId16GenObj* realizeId16Gen( cfbam::ICFBamId16GenObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeId16Gen( cfbam::ICFBamId16GenObj* Obj ) = 0;
		...
		virtual cfbam::ICFBamId16GenObj* createId16Gen( cfbam::ICFBamId16GenEditObj* Obj ) = 0;

		virtual cfbam::ICFBamId16GenObj* readId16Gen( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamId16GenObj* lockId16Gen( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamId16GenObj*> readAllId16Gen( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamId16GenObj* readCachedId16Gen( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamId16GenObj*> readCachedId16GenByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamId16GenObj* updateId16Gen( cfbam::ICFBamId16GenEditObj* Obj ) = 0;

		virtual void deleteId16Gen( cfbam::ICFBamId16GenEditObj* Obj ) = 0;
		...
		virtual void deleteId16GenByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamId16GenObj* moveUpId16Gen( cfbam::ICFBamId16GenObj* Obj ) = 0;

		virtual cfbam::ICFBamId16GenObj* moveDownId16Gen( cfbam::ICFBamId16GenObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesId16Gen( cfbam::ICFBamId16GenObj* Obj ) = 0;
