...
// Description: C++18 Instance Edit Object interface for CFBam ServerListFunc.
...
namespace cfbam {
	...
	class ICFBamServerListFuncEditObj
	: public virtual cfbam::ICFBamServerMethodEditObj,
	  public virtual cfbam::ICFBamServerListFuncObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamServerListFuncEditObj();
		virtual ~ICFBamServerListFuncEditObj();
		...
		virtual cfbam::ICFBamServerListFuncObj* getOrigAsServerListFunc() = 0;
		...
		virtual void setOptionalLookupRetTable( cfbam::ICFBamTableObj* value ) = 0;
