...
// Description: C++18 Instance Edit Object interface for CFBam DoubleType.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamDoubleDefEditObj,
	  public virtual cfbam::ICFBamDoubleTypeObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamDoubleTypeEditObj();
		virtual ~ICFBamDoubleTypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamDoubleTypeBuff* getDoubleTypeBuff() {
			return( static_cast<cfbam::CFBamDoubleTypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamDoubleTypeBuff* getDoubleTypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamDoubleTypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamDoubleTypeObj* getOrigAsDoubleType() = 0;
