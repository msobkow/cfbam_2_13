...
namespace cfbam {
	...
	class CFBamSecGroupFormTableObj
	: public virtual ICFBamSecGroupFormTableObj,
	  public virtual cfsec::ICFSecSecGroupFormTableObj,
	  public virtual cfint::ICFIntSecGroupFormTableObj
	{
	protected:
	...
	public:
		...
		CFBamSecGroupFormTableObj();
		CFBamSecGroupFormTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamSecGroupFormTableObj();
