...
namespace cfbam {
	...
	{
	public:
		ICFBamEnumDefTableObj();
		virtual ~ICFBamEnumDefTableObj();
		...
		virtual cfbam::ICFBamEnumDefObj* newInstance() = 0;

		virtual cfbam::ICFBamEnumDefEditObj* newEditInstance( cfbam::ICFBamEnumDefObj* orig ) = 0;

		virtual cfbam::ICFBamEnumDefObj* realizeEnumDef( cfbam::ICFBamEnumDefObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeEnumDef( cfbam::ICFBamEnumDefObj* Obj ) = 0;
		virtual cfbam::ICFBamEnumDefObj* createEnumDef( cfbam::ICFBamEnumDefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamEnumDefObj* readEnumDef( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamEnumDefObj* lockEnumDef( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamEnumDefObj*> readAllEnumDef( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamEnumDefObj* readCachedEnumDef( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamEnumDefObj*> readCachedEnumDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamEnumDefObj* updateEnumDef( cfbam::ICFBamEnumDefEditObj* Obj ) = 0;

		virtual void deleteEnumDef( cfbam::ICFBamEnumDefEditObj* Obj ) = 0;
		...
		virtual void deleteEnumDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamEnumDefObj* moveUpEnumDef( cfbam::ICFBamEnumDefObj* Obj ) = 0;

		virtual cfbam::ICFBamEnumDefObj* moveDownEnumDef( cfbam::ICFBamEnumDefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesEnumDef( cfbam::ICFBamEnumDefObj* Obj ) = 0;
