...
// Description: C++18 Object interface for CFBam EnumTag.
...
namespace cfbam {
	...
	public:
		...
		virtual cfbam::ICFBamEnumTagObj* realize() = 0;

		virtual cfbam::ICFBamEnumTagObj* read( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamEnumTagObj* moveUp() = 0;

		virtual cfbam::ICFBamEnumTagObj* moveDown() = 0;

		virtual cfbam::ICFBamEnumTagEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfbam::ICFBamEnumTagEditObj* getEdit() = 0;

		virtual cfbam::ICFBamEnumTagEditObj* getEnumTagEdit() = 0;

		virtual cfbam::ICFBamEnumTagTableObj* getEnumTagTable() = 0;

		virtual cfbam::ICFBamSchemaObj* getSchema() = 0;

		virtual cfbam::CFBamEnumTagBuff* getBuff() = 0;
		virtual void setBuff( cfbam::CFBamEnumTagBuff* value ) = 0;

		inline cfbam::CFBamEnumTagBuff* getEnumTagBuff() {
			return( static_cast<cfbam::CFBamEnumTagBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamEnumTagBuff* getEnumTagEditBuff() {
			return( dynamic_cast<cfbam::CFBamEnumTagBuff*>( getBuff() ) );
		};

		virtual cfbam::CFBamEnumTagPKey* getPKey() = 0;
		virtual void setPKey( cfbam::CFBamEnumTagPKey* value ) = 0;
		...
		virtual const int64_t getRequiredEnumId() = 0;
		virtual const int64_t* getRequiredEnumIdReference() = 0;

		virtual bool isOptionalEnumCodeNull() = 0;
		virtual const int16_t getOptionalEnumCodeValue() = 0;
		virtual const int16_t* getOptionalEnumCodeReference() = 0;
		...
		virtual cfbam::ICFBamEnumDefObj* getRequiredContainerEnumDef( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamSchemaDefObj* getOptionalLookupDefSchema( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamEnumTagObj* getOptionalLookupPrev( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamEnumTagObj* getOptionalLookupNext( bool forceRead = false ) = 0;
