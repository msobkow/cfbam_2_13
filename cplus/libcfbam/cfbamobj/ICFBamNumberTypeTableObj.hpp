...
namespace cfbam {
	...
	{
	public:
		ICFBamNumberTypeTableObj();
		virtual ~ICFBamNumberTypeTableObj();
		...
		virtual cfbam::ICFBamNumberTypeObj* newInstance() = 0;

		virtual cfbam::ICFBamNumberTypeEditObj* newEditInstance( cfbam::ICFBamNumberTypeObj* orig ) = 0;

		virtual cfbam::ICFBamNumberTypeObj* realizeNumberType( cfbam::ICFBamNumberTypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeNumberType( cfbam::ICFBamNumberTypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamNumberTypeObj* createNumberType( cfbam::ICFBamNumberTypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamNumberTypeObj* readNumberType( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamNumberTypeObj* lockNumberType( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamNumberTypeObj*> readAllNumberType( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamNumberTypeObj* readCachedNumberType( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamNumberTypeObj*> readCachedNumberTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamNumberTypeObj* updateNumberType( cfbam::ICFBamNumberTypeEditObj* Obj ) = 0;

		virtual void deleteNumberType( cfbam::ICFBamNumberTypeEditObj* Obj ) = 0;
		...
		virtual void deleteNumberTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamNumberTypeObj* moveUpNumberType( cfbam::ICFBamNumberTypeObj* Obj ) = 0;

		virtual cfbam::ICFBamNumberTypeObj* moveDownNumberType( cfbam::ICFBamNumberTypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesNumberType( cfbam::ICFBamNumberTypeObj* Obj ) = 0;
