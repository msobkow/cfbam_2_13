...
// Description: C++18 Instance Edit Object interface for CFBam UuidCol.
...
namespace cfbam {
	...
	class ICFBamUuidColEditObj
	: public virtual cfbam::ICFBamUuidDefEditObj,
	  public virtual cfbam::ICFBamUuidColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamUuidColEditObj();
		virtual ~ICFBamUuidColEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamUuidColBuff* getUuidColBuff() {
			return( static_cast<cfbam::CFBamUuidColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamUuidColBuff* getUuidColEditBuff() {
			return( dynamic_cast<cfbam::CFBamUuidColBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamUuidColObj* getOrigAsUuidCol() = 0;
