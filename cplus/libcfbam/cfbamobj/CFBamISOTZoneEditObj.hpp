...
// Description: C++18 edit object instance specification for CFBam ISOTZone.
...
namespace cfbam {
	...
	class CFBamISOTZoneEditObj
	: public virtual ICFBamISOTZoneEditObj,
	  public virtual cfsec::ICFSecISOTZoneEditObj,
	  public virtual cfint::ICFIntISOTZoneEditObj
	{
	public:
	...
	public:
		CFBamISOTZoneEditObj( cfsec::ICFSecISOTZoneObj* argOrig );
		virtual ~CFBamISOTZoneEditObj();
