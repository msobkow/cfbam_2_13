...
// Description: C++18 base object instance specification for CFBam UuidDef.
...
namespace cfbam {
	...
	class CFBamUuidDefObj
	: public CFBamAtomObj,
	  public virtual ICFBamUuidDefObj
	{
	protected:
	public:
		...
		CFBamUuidDefObj();
		CFBamUuidDefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamUuidDefObj();
