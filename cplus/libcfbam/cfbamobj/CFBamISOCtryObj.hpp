...
// Description: C++18 base object instance specification for CFBam ISOCtry.
...
namespace cfbam {
	...
	class CFBamISOCtryObj
	: public virtual ICFBamISOCtryObj,
	...
	public:
		...
		CFBamISOCtryObj();
		CFBamISOCtryObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamISOCtryObj();
