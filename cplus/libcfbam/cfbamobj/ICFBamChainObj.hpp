...
// Description: C++18 Object interface for CFBam Chain.
...
namespace cfbam {
	...
	public:
		...
		virtual cfbam::ICFBamChainObj* realize() = 0;

		virtual cfbam::ICFBamChainObj* read( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamChainEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfbam::ICFBamChainEditObj* getEdit() = 0;

		virtual cfbam::ICFBamChainEditObj* getChainEdit() = 0;

		virtual cfbam::ICFBamChainTableObj* getChainTable() = 0;

		virtual cfbam::ICFBamSchemaObj* getSchema() = 0;

		virtual cfbam::CFBamChainBuff* getBuff() = 0;
		virtual void setBuff( cfbam::CFBamChainBuff* value ) = 0;

		inline cfbam::CFBamChainBuff* getChainBuff() {
			return( static_cast<cfbam::CFBamChainBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamChainBuff* getChainEditBuff() {
			return( dynamic_cast<cfbam::CFBamChainBuff*>( getBuff() ) );
		};

		virtual cfbam::CFBamChainPKey* getPKey() = 0;
		virtual void setPKey( cfbam::CFBamChainPKey* value ) = 0;
		...
		virtual const int64_t getRequiredPrevRelationTenantId() = 0;
		virtual const int64_t* getRequiredPrevRelationTenantIdReference() = 0;

		virtual const int64_t getRequiredPrevRelationId() = 0;
		virtual const int64_t* getRequiredPrevRelationIdReference() = 0;

		virtual const int64_t getRequiredNextRelationTenantId() = 0;
		virtual const int64_t* getRequiredNextRelationTenantIdReference() = 0;

		virtual const int64_t getRequiredNextRelationId() = 0;
		virtual const int64_t* getRequiredNextRelationIdReference() = 0;

		virtual cfsec::ICFSecTenantObj* getRequiredOwnerTenant( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTableObj* getRequiredContainerTable( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamSchemaDefObj* getOptionalLookupDefSchema( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamRelationObj* getRequiredLookupPrevRel( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamRelationObj* getRequiredLookupNextRel( bool forceRead = false ) = 0;
