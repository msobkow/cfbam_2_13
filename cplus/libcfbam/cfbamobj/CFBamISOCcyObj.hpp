...
// Description: C++18 base object instance specification for CFBam ISOCcy.
...
namespace cfbam {
	...
	class CFBamISOCcyObj
	: public virtual ICFBamISOCcyObj,
	...
	public:
		...
		CFBamISOCcyObj();
		CFBamISOCcyObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamISOCcyObj();
