...
// Description: C++18 Instance Edit Object interface for CFBam BlobType.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamBlobDefEditObj,
	  public virtual cfbam::ICFBamBlobTypeObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamBlobTypeEditObj();
		virtual ~ICFBamBlobTypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamBlobTypeBuff* getBlobTypeBuff() {
			return( static_cast<cfbam::CFBamBlobTypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamBlobTypeBuff* getBlobTypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamBlobTypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamBlobTypeObj* getOrigAsBlobType() = 0;
