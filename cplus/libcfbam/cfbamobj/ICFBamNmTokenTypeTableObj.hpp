...
namespace cfbam {
	...
	{
	public:
		ICFBamNmTokenTypeTableObj();
		virtual ~ICFBamNmTokenTypeTableObj();
		...
		virtual cfbam::ICFBamNmTokenTypeObj* newInstance() = 0;

		virtual cfbam::ICFBamNmTokenTypeEditObj* newEditInstance( cfbam::ICFBamNmTokenTypeObj* orig ) = 0;

		virtual cfbam::ICFBamNmTokenTypeObj* realizeNmTokenType( cfbam::ICFBamNmTokenTypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeNmTokenType( cfbam::ICFBamNmTokenTypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamNmTokenTypeObj* createNmTokenType( cfbam::ICFBamNmTokenTypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamNmTokenTypeObj* readNmTokenType( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamNmTokenTypeObj* lockNmTokenType( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamNmTokenTypeObj*> readAllNmTokenType( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamNmTokenTypeObj* readCachedNmTokenType( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamNmTokenTypeObj*> readCachedNmTokenTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamNmTokenTypeObj* updateNmTokenType( cfbam::ICFBamNmTokenTypeEditObj* Obj ) = 0;

		virtual void deleteNmTokenType( cfbam::ICFBamNmTokenTypeEditObj* Obj ) = 0;
		...
		virtual void deleteNmTokenTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamNmTokenTypeObj* moveUpNmTokenType( cfbam::ICFBamNmTokenTypeObj* Obj ) = 0;

		virtual cfbam::ICFBamNmTokenTypeObj* moveDownNmTokenType( cfbam::ICFBamNmTokenTypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesNmTokenType( cfbam::ICFBamNmTokenTypeObj* Obj ) = 0;
