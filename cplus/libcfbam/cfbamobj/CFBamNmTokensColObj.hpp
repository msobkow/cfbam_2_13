...
// Description: C++18 base object instance specification for CFBam NmTokensCol.
...
namespace cfbam {
	...
	class CFBamNmTokensColObj
	: public CFBamNmTokensDefObj,
	  public virtual ICFBamNmTokensColObj
	{
	protected:
	public:
		...
		CFBamNmTokensColObj();
		CFBamNmTokensColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamNmTokensColObj();
