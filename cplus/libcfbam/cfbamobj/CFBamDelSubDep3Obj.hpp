...
// Description: C++18 base object instance specification for CFBam DelSubDep3.
...
namespace cfbam {
	...
	class CFBamDelSubDep3Obj
	: public CFBamDelDepObj,
	  public virtual ICFBamDelSubDep3Obj
	{
	protected:
	public:
		...
		CFBamDelSubDep3Obj();
		CFBamDelSubDep3Obj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamDelSubDep3Obj();
