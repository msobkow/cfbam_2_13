...
// Description: C++18 Instance Edit Object interface for CFBam ServerMethod.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamScopeEditObj,
	  public virtual cfbam::ICFBamServerMethodObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamServerMethodEditObj();
		virtual ~ICFBamServerMethodEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamServerMethodBuff* getServerMethodBuff() {
			return( static_cast<cfbam::CFBamServerMethodBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamServerMethodBuff* getServerMethodEditBuff() {
			return( dynamic_cast<cfbam::CFBamServerMethodBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamServerMethodObj* getOrigAsServerMethod() = 0;
		...
		virtual const bool getRequiredIsInstanceMethod() = 0;
		virtual const bool* getRequiredIsInstanceMethodReference() = 0;
		virtual void setRequiredIsInstanceMethod( const bool value ) = 0;
		...
		virtual const std::string& getRequiredJMethodBody() = 0;
		virtual const std::string* getRequiredJMethodBodyReference() = 0;
		virtual void setRequiredJMethodBody( const std::string& value ) = 0;

		virtual const std::string& getRequiredCppMethodBody() = 0;
		virtual const std::string* getRequiredCppMethodBodyReference() = 0;
		virtual void setRequiredCppMethodBody( const std::string& value ) = 0;

		virtual const std::string& getRequiredCsMethodBody() = 0;
		virtual const std::string* getRequiredCsMethodBodyReference() = 0;
		virtual void setRequiredCsMethodBody( const std::string& value ) = 0;
		...
		virtual cfbam::ICFBamTableObj* getRequiredContainerForTable( bool forceRead = false ) = 0;
		virtual void setRequiredContainerForTable( cfbam::ICFBamTableObj* value ) = 0;
