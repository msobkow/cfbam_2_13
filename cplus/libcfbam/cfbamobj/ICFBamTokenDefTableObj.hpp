...
namespace cfbam {
	...
	{
	public:
		ICFBamTokenDefTableObj();
		virtual ~ICFBamTokenDefTableObj();
		...
		virtual cfbam::ICFBamTokenDefObj* newInstance() = 0;

		virtual cfbam::ICFBamTokenDefEditObj* newEditInstance( cfbam::ICFBamTokenDefObj* orig ) = 0;

		virtual cfbam::ICFBamTokenDefObj* realizeTokenDef( cfbam::ICFBamTokenDefObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeTokenDef( cfbam::ICFBamTokenDefObj* Obj ) = 0;
		virtual cfbam::ICFBamTokenDefObj* createTokenDef( cfbam::ICFBamTokenDefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamTokenDefObj* readTokenDef( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTokenDefObj* lockTokenDef( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamTokenDefObj*> readAllTokenDef( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamTokenDefObj* readCachedTokenDef( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamTokenDefObj*> readCachedTokenDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTokenDefObj* updateTokenDef( cfbam::ICFBamTokenDefEditObj* Obj ) = 0;

		virtual void deleteTokenDef( cfbam::ICFBamTokenDefEditObj* Obj ) = 0;
		...
		virtual void deleteTokenDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTokenDefObj* moveUpTokenDef( cfbam::ICFBamTokenDefObj* Obj ) = 0;

		virtual cfbam::ICFBamTokenDefObj* moveDownTokenDef( cfbam::ICFBamTokenDefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesTokenDef( cfbam::ICFBamTokenDefObj* Obj ) = 0;
