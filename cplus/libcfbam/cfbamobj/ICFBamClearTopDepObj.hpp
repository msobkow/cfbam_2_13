...
// Description: C++18 Object interface for CFBam ClearTopDep.
...
namespace cfbam {
	...
	class ICFBamClearTopDepObj
	: public virtual cfbam::ICFBamClearDepObj
	{
	public:
		ICFBamClearTopDepObj();
		virtual ~ICFBamClearTopDepObj();
		virtual cfbam::ICFBamClearTopDepObj* moveUp() = 0;

		virtual cfbam::ICFBamClearTopDepObj* moveDown() = 0;

		virtual cfbam::ICFBamScopeEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamClearTopDepEditObj* getClearTopDepEdit() = 0;

		inline cfbam::CFBamClearTopDepBuff* getClearTopDepBuff() {
			return( static_cast<cfbam::CFBamClearTopDepBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamClearTopDepBuff* getClearTopDepEditBuff() {
			return( dynamic_cast<cfbam::CFBamClearTopDepBuff*>( getBuff() ) );
		};

		virtual const int64_t getRequiredTableTenantId() = 0;
		virtual const int64_t* getRequiredTableTenantIdReference() = 0;
		...
		virtual std::vector<cfbam::ICFBamClearSubDep1Obj*> getOptionalComponentsClearDep( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamClearTopDepObj* getOptionalLookupPrev( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamClearTopDepObj* getOptionalLookupNext( bool forceRead = false ) = 0;
