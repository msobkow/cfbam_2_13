...
// Description: C++18 Object interface for CFBam Value.
...
namespace cfbam {
	...
	public:
		...
		virtual cfbam::ICFBamValueObj* realize() = 0;

		virtual cfbam::ICFBamValueObj* read( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamValueObj* moveUp() = 0;

		virtual cfbam::ICFBamValueObj* moveDown() = 0;

		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfbam::ICFBamValueEditObj* getEdit() = 0;

		virtual cfbam::ICFBamValueEditObj* getValueEdit() = 0;

		virtual cfbam::ICFBamValueTableObj* getValueTable() = 0;

		virtual cfbam::ICFBamSchemaObj* getSchema() = 0;

		virtual cfbam::CFBamValueBuff* getBuff() = 0;
		virtual void setBuff( cfbam::CFBamValueBuff* value ) = 0;

		inline cfbam::CFBamValueBuff* getValueBuff() {
			return( static_cast<cfbam::CFBamValueBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamValueBuff* getValueEditBuff() {
			return( dynamic_cast<cfbam::CFBamValueBuff*>( getBuff() ) );
		};

		virtual cfbam::CFBamValuePKey* getPKey() = 0;
		virtual void setPKey( cfbam::CFBamValuePKey* value ) = 0;
		...
		virtual const int64_t getRequiredScopeId() = 0;
		virtual const int64_t* getRequiredScopeIdReference() = 0;
		...
		virtual bool isOptionalDefaultXmlValueNull() = 0;
		virtual const std::string& getOptionalDefaultXmlValueValue() = 0;
		virtual const std::string* getOptionalDefaultXmlValueReference() = 0;

		virtual const bool getRequiredIsNullable() = 0;
		virtual const bool* getRequiredIsNullableReference() = 0;

		virtual bool isOptionalGenerateIdNull() = 0;
		virtual const bool getOptionalGenerateIdValue() = 0;
		virtual const bool* getOptionalGenerateIdReference() = 0;

		virtual const bool getRequiredImplementsPolymorph() = 0;
		virtual const bool* getRequiredImplementsPolymorphReference() = 0;

		virtual bool isOptionalPrevTenantIdNull() = 0;
		virtual const int64_t getOptionalPrevTenantIdValue() = 0;
		virtual const int64_t* getOptionalPrevTenantIdReference() = 0;

		virtual bool isOptionalPrevIdNull() = 0;
		virtual const int64_t getOptionalPrevIdValue() = 0;
		virtual const int64_t* getOptionalPrevIdReference() = 0;

		virtual bool isOptionalNextTenantIdNull() = 0;
		virtual const int64_t getOptionalNextTenantIdValue() = 0;
		virtual const int64_t* getOptionalNextTenantIdReference() = 0;

		virtual bool isOptionalNextIdNull() = 0;
		virtual const int64_t getOptionalNextIdValue() = 0;
		virtual const int64_t* getOptionalNextIdReference() = 0;

		virtual cfsec::ICFSecTenantObj* getRequiredOwnerTenant( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamScopeObj* getRequiredContainerScope( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamSchemaDefObj* getOptionalLookupDefSchema( bool forceRead = false ) = 0;

		virtual std::vector<cfbam::ICFBamTableColObj*> getOptionalChildrenRefTableCol( bool forceRead = false ) = 0;

		virtual std::vector<cfbam::ICFBamIndexColObj*> getOptionalChildrenRefIndexCol( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamValueObj* getOptionalLookupPrev( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamValueObj* getOptionalLookupNext( bool forceRead = false ) = 0;
		...
		public:
			virtual std::vector<cfbam::ICFBamIndexObj*> getAffectedIndexes() = 0;
			virtual std::vector<cfbam::ICFBamRelationObj*> getAffectedRelations() = 0;
			virtual std::vector<cfbam::ICFBamIndexObj*> getAffectedUniqueIndexes() = 0;
			virtual std::vector<cfbam::ICFBamRelationObj*> getColumnInMemberRelations() = 0;
			virtual std::vector<cfbam::ICFBamRelationObj*> getColumnInComponentsRelations() = 0;
