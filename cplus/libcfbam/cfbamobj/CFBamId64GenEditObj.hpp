...
// Description: C++18 edit object instance specification for CFBam Id64Gen.
...
namespace cfbam {
	...
	class CFBamId64GenEditObj
	: public CFBamInt64TypeEditObj,
	  public virtual ICFBamId64GenEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamId64GenEditObj( cfbam::ICFBamId64GenObj* argOrig );
		virtual ~CFBamId64GenEditObj();
		...
		virtual cfbam::ICFBamId64GenTableObj* getId64GenTable();

		virtual cfbam::ICFBamId64GenEditObj* getId64GenEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamId64GenObj* getOrigAsId64Gen();
		...
		inline cfbam::CFBamId64GenBuff* getId64GenBuff() {
			...
			return( static_cast<cfbam::CFBamId64GenBuff*>( buff ) );
		};
		...
		virtual const int64_t getRequiredBlockSize();
		virtual const int64_t* getRequiredBlockSizeReference();
