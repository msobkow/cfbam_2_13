...
namespace cfbam {
	...
	{
	public:
		ICFBamTZTimeDefTableObj();
		virtual ~ICFBamTZTimeDefTableObj();
		...
		virtual cfbam::ICFBamTZTimeDefObj* newInstance() = 0;

		virtual cfbam::ICFBamTZTimeDefEditObj* newEditInstance( cfbam::ICFBamTZTimeDefObj* orig ) = 0;

		virtual cfbam::ICFBamTZTimeDefObj* realizeTZTimeDef( cfbam::ICFBamTZTimeDefObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeTZTimeDef( cfbam::ICFBamTZTimeDefObj* Obj ) = 0;
		virtual cfbam::ICFBamTZTimeDefObj* createTZTimeDef( cfbam::ICFBamTZTimeDefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamTZTimeDefObj* readTZTimeDef( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTZTimeDefObj* lockTZTimeDef( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamTZTimeDefObj*> readAllTZTimeDef( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamTZTimeDefObj* readCachedTZTimeDef( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamTZTimeDefObj*> readCachedTZTimeDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTZTimeDefObj* updateTZTimeDef( cfbam::ICFBamTZTimeDefEditObj* Obj ) = 0;

		virtual void deleteTZTimeDef( cfbam::ICFBamTZTimeDefEditObj* Obj ) = 0;
		...
		virtual void deleteTZTimeDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTZTimeDefObj* moveUpTZTimeDef( cfbam::ICFBamTZTimeDefObj* Obj ) = 0;

		virtual cfbam::ICFBamTZTimeDefObj* moveDownTZTimeDef( cfbam::ICFBamTZTimeDefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesTZTimeDef( cfbam::ICFBamTZTimeDefObj* Obj ) = 0;
