...
namespace cfbam {
	...
	class CFBamHostNodeTableObj
	: public virtual ICFBamHostNodeTableObj,
	  public virtual cfsec::ICFSecHostNodeTableObj,
	  public virtual cfint::ICFIntHostNodeTableObj
	{
	protected:
	...
	public:
		...
		CFBamHostNodeTableObj();
		CFBamHostNodeTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamHostNodeTableObj();
