...
// Description: C++18 Object interface for CFBam ServerObjFunc.
...
namespace cfbam {
	...
	public:
		...
		virtual ~ICFBamServerObjFuncObj();
		virtual cfbam::ICFBamScopeEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamServerObjFuncEditObj* getServerObjFuncEdit() = 0;

		inline cfbam::CFBamServerObjFuncBuff* getServerObjFuncBuff() {
			return( static_cast<cfbam::CFBamServerObjFuncBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamServerObjFuncBuff* getServerObjFuncEditBuff() {
			return( dynamic_cast<cfbam::CFBamServerObjFuncBuff*>( getBuff() ) );
		};
