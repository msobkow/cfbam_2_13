...
// Description: C++18 base object instance specification for CFBam TokenCol.
...
namespace cfbam {
	...
	class CFBamTokenColObj
	: public CFBamTokenDefObj,
	  public virtual ICFBamTokenColObj
	{
	protected:
	public:
		...
		CFBamTokenColObj();
		CFBamTokenColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTokenColObj();
