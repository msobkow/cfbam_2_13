...
namespace cfbam {
	...
	{
	public:
		ICFBamTimestampTypeTableObj();
		virtual ~ICFBamTimestampTypeTableObj();
		...
		virtual cfbam::ICFBamTimestampTypeObj* newInstance() = 0;

		virtual cfbam::ICFBamTimestampTypeEditObj* newEditInstance( cfbam::ICFBamTimestampTypeObj* orig ) = 0;

		virtual cfbam::ICFBamTimestampTypeObj* realizeTimestampType( cfbam::ICFBamTimestampTypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeTimestampType( cfbam::ICFBamTimestampTypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamTimestampTypeObj* createTimestampType( cfbam::ICFBamTimestampTypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamTimestampTypeObj* readTimestampType( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTimestampTypeObj* lockTimestampType( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamTimestampTypeObj*> readAllTimestampType( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamTimestampTypeObj* readCachedTimestampType( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamTimestampTypeObj*> readCachedTimestampTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTimestampTypeObj* updateTimestampType( cfbam::ICFBamTimestampTypeEditObj* Obj ) = 0;

		virtual void deleteTimestampType( cfbam::ICFBamTimestampTypeEditObj* Obj ) = 0;
		...
		virtual void deleteTimestampTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTimestampTypeObj* moveUpTimestampType( cfbam::ICFBamTimestampTypeObj* Obj ) = 0;

		virtual cfbam::ICFBamTimestampTypeObj* moveDownTimestampType( cfbam::ICFBamTimestampTypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesTimestampType( cfbam::ICFBamTimestampTypeObj* Obj ) = 0;
