...
// Description: C++18 base object instance specification for CFBam SchemaRef.
...
namespace cfbam {
	...
	class CFBamSchemaRefObj
	: public CFBamScopeObj,
	  public virtual ICFBamSchemaRefObj
	{
	protected:
	public:
		...
		CFBamSchemaRefObj();
		CFBamSchemaRefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamSchemaRefObj();
