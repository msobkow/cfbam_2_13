...
// Description: C++18 base object instance specification for CFBam TokenType.
...
namespace cfbam {
	...
	class CFBamTokenTypeObj
	: public CFBamTokenDefObj,
	  public virtual ICFBamTokenTypeObj
	{
	protected:
	public:
		...
		CFBamTokenTypeObj();
		CFBamTokenTypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTokenTypeObj();
