...
namespace cfbam {
	...
	class CFBamISOCtryTableObj
	: public virtual ICFBamISOCtryTableObj,
	  public virtual cfsec::ICFSecISOCtryTableObj,
	  public virtual cfint::ICFIntISOCtryTableObj
	{
	protected:
	...
	public:
		...
		CFBamISOCtryTableObj();
		CFBamISOCtryTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamISOCtryTableObj();
