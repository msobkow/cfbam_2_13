...
// Description: C++18 Instance Edit Object interface for CFBam DateDef.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamAtomEditObj,
	  public virtual cfbam::ICFBamDateDefObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamDateDefEditObj();
		virtual ~ICFBamDateDefEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamDateDefBuff* getDateDefBuff() {
			return( static_cast<cfbam::CFBamDateDefBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamDateDefBuff* getDateDefEditBuff() {
			return( dynamic_cast<cfbam::CFBamDateDefBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamDateDefObj* getOrigAsDateDef() = 0;
