...
namespace cfbam {
	...
	{
	public:
		ICFBamFloatDefTableObj();
		virtual ~ICFBamFloatDefTableObj();
		...
		virtual cfbam::ICFBamFloatDefObj* newInstance() = 0;

		virtual cfbam::ICFBamFloatDefEditObj* newEditInstance( cfbam::ICFBamFloatDefObj* orig ) = 0;

		virtual cfbam::ICFBamFloatDefObj* realizeFloatDef( cfbam::ICFBamFloatDefObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeFloatDef( cfbam::ICFBamFloatDefObj* Obj ) = 0;
		virtual cfbam::ICFBamFloatDefObj* createFloatDef( cfbam::ICFBamFloatDefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamFloatDefObj* readFloatDef( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamFloatDefObj* lockFloatDef( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamFloatDefObj*> readAllFloatDef( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamFloatDefObj* readCachedFloatDef( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamFloatDefObj*> readCachedFloatDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamFloatDefObj* updateFloatDef( cfbam::ICFBamFloatDefEditObj* Obj ) = 0;

		virtual void deleteFloatDef( cfbam::ICFBamFloatDefEditObj* Obj ) = 0;
		...
		virtual void deleteFloatDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamFloatDefObj* moveUpFloatDef( cfbam::ICFBamFloatDefObj* Obj ) = 0;

		virtual cfbam::ICFBamFloatDefObj* moveDownFloatDef( cfbam::ICFBamFloatDefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesFloatDef( cfbam::ICFBamFloatDefObj* Obj ) = 0;
