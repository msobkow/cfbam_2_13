...
namespace cfbam {
	...
	class CFBamFloatDefTableObj
	: public virtual ICFBamFloatDefTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamFloatDefObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamFloatDefObj*>* allFloatDef;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamFloatDefObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamFloatDefObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamFloatDefObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamFloatDefObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamFloatDefObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamFloatDefObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamFloatDefObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamFloatDefObj*>*>* indexByContNextIdx;
	...
	public:
		...
		CFBamFloatDefTableObj();
		CFBamFloatDefTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamFloatDefTableObj();
		...
		virtual cfbam::ICFBamFloatDefObj* newInstance();

		virtual cfbam::ICFBamFloatDefEditObj* newEditInstance( cfbam::ICFBamFloatDefObj* orig );

		virtual cfbam::ICFBamFloatDefObj* realizeFloatDef( cfbam::ICFBamFloatDefObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeFloatDef( cfbam::ICFBamFloatDefObj* Obj );
		virtual cfbam::ICFBamFloatDefObj* createFloatDef( cfbam::ICFBamFloatDefEditObj* Obj );

		virtual cfbam::ICFBamFloatDefObj* readFloatDef( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamFloatDefObj* lockFloatDef( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamFloatDefObj*> readAllFloatDef( bool forceRead = false );

		virtual cfbam::ICFBamFloatDefObj* readFloatDefByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamFloatDefObj* readFloatDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamFloatDefObj*> readFloatDefByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamFloatDefObj*> readFloatDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamFloatDefObj*> readFloatDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamFloatDefObj*> readFloatDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamFloatDefObj*> readFloatDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamFloatDefObj*> readFloatDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamFloatDefObj*> readFloatDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual cfbam::ICFBamFloatDefObj* readCachedFloatDef( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamFloatDefObj* readCachedFloatDefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamFloatDefObj* readCachedFloatDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamFloatDefObj*> readCachedFloatDefByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamFloatDefObj*> readCachedFloatDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamFloatDefObj*> readCachedFloatDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamFloatDefObj*> readCachedFloatDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamFloatDefObj*> readCachedFloatDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamFloatDefObj*> readCachedFloatDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamFloatDefObj*> readCachedFloatDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamFloatDefObj* updateFloatDef( cfbam::ICFBamFloatDefEditObj* Obj );

		virtual void deleteFloatDef( cfbam::ICFBamFloatDefEditObj* Obj );

		virtual void deleteFloatDefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteFloatDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteFloatDefByValTentIdx( const int64_t TenantId );

		virtual void deleteFloatDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteFloatDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteFloatDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteFloatDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteFloatDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteFloatDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamFloatDefObj* moveUpFloatDef( cfbam::ICFBamFloatDefObj* Obj );

		virtual cfbam::ICFBamFloatDefObj* moveDownFloatDef( cfbam::ICFBamFloatDefObj* Obj );

		virtual void reallyDetachFromIndexesFloatDef( cfbam::ICFBamFloatDefObj* Obj );
