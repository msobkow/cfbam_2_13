...
// Description: C++18 Instance Edit Object interface for CFBam NumberDef.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamAtomEditObj,
	  public virtual cfbam::ICFBamNumberDefObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamNumberDefEditObj();
		virtual ~ICFBamNumberDefEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamNumberDefBuff* getNumberDefBuff() {
			return( static_cast<cfbam::CFBamNumberDefBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamNumberDefBuff* getNumberDefEditBuff() {
			return( dynamic_cast<cfbam::CFBamNumberDefBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamNumberDefObj* getOrigAsNumberDef() = 0;

		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual const int16_t getRequiredDigits() = 0;
		virtual const int16_t* getRequiredDigitsReference() = 0;
		virtual void setRequiredDigits( const int16_t value ) = 0;
		...
		virtual const cflib::TCFLibBigDecimal<31,5>& getOptionalInitValueValue() = 0;
		virtual const cflib::TCFLibBigDecimal<31,5>* getOptionalInitValueReference() = 0;
		virtual void setOptionalInitValueNull() = 0;
		virtual void setOptionalInitValueValue( const cflib::TCFLibBigDecimal<31,5>& value ) = 0;

		virtual bool isOptionalMinValueNull() = 0;
		virtual const cflib::TCFLibBigDecimal<31,5>& getOptionalMinValueValue() = 0;
		virtual const cflib::TCFLibBigDecimal<31,5>* getOptionalMinValueReference() = 0;
		virtual void setOptionalMinValueNull() = 0;
		virtual void setOptionalMinValueValue( const cflib::TCFLibBigDecimal<31,5>& value ) = 0;

		virtual bool isOptionalMaxValueNull() = 0;
		virtual const cflib::TCFLibBigDecimal<31,5>& getOptionalMaxValueValue() = 0;
		virtual const cflib::TCFLibBigDecimal<31,5>* getOptionalMaxValueReference() = 0;
		virtual void setOptionalMaxValueNull() = 0;
		virtual void setOptionalMaxValueValue( const cflib::TCFLibBigDecimal<31,5>& value ) = 0;
