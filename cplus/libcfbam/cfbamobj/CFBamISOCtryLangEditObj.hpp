...
// Description: C++18 edit object instance specification for CFBam ISOCtryLang.
...
namespace cfbam {
	...
	class CFBamISOCtryLangEditObj
	: public virtual ICFBamISOCtryLangEditObj,
	  public virtual cfsec::ICFSecISOCtryLangEditObj,
	  public virtual cfint::ICFIntISOCtryLangEditObj
	{
	public:
	...
	public:
		CFBamISOCtryLangEditObj( cfsec::ICFSecISOCtryLangObj* argOrig );
		virtual ~CFBamISOCtryLangEditObj();
