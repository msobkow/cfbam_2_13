...
namespace cfbam {
	...
	{
	public:
		ICFBamInt64TypeTableObj();
		virtual ~ICFBamInt64TypeTableObj();
		...
		virtual cfbam::ICFBamInt64TypeObj* newInstance() = 0;

		virtual cfbam::ICFBamInt64TypeEditObj* newEditInstance( cfbam::ICFBamInt64TypeObj* orig ) = 0;

		virtual cfbam::ICFBamInt64TypeObj* realizeInt64Type( cfbam::ICFBamInt64TypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeInt64Type( cfbam::ICFBamInt64TypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamInt64TypeObj* createInt64Type( cfbam::ICFBamInt64TypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamInt64TypeObj* readInt64Type( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamInt64TypeObj* lockInt64Type( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamInt64TypeObj*> readAllInt64Type( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamInt64TypeObj* readCachedInt64Type( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamInt64TypeObj*> readCachedInt64TypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamInt64TypeObj* updateInt64Type( cfbam::ICFBamInt64TypeEditObj* Obj ) = 0;

		virtual void deleteInt64Type( cfbam::ICFBamInt64TypeEditObj* Obj ) = 0;
		...
		virtual void deleteInt64TypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamInt64TypeObj* moveUpInt64Type( cfbam::ICFBamInt64TypeObj* Obj ) = 0;

		virtual cfbam::ICFBamInt64TypeObj* moveDownInt64Type( cfbam::ICFBamInt64TypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesInt64Type( cfbam::ICFBamInt64TypeObj* Obj ) = 0;
