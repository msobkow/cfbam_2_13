...
namespace cfbam {
	...
	{
	public:
		ICFBamNmTokenDefTableObj();
		virtual ~ICFBamNmTokenDefTableObj();
		...
		virtual cfbam::ICFBamNmTokenDefObj* newInstance() = 0;

		virtual cfbam::ICFBamNmTokenDefEditObj* newEditInstance( cfbam::ICFBamNmTokenDefObj* orig ) = 0;

		virtual cfbam::ICFBamNmTokenDefObj* realizeNmTokenDef( cfbam::ICFBamNmTokenDefObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeNmTokenDef( cfbam::ICFBamNmTokenDefObj* Obj ) = 0;
		virtual cfbam::ICFBamNmTokenDefObj* createNmTokenDef( cfbam::ICFBamNmTokenDefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamNmTokenDefObj* readNmTokenDef( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamNmTokenDefObj* lockNmTokenDef( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamNmTokenDefObj*> readAllNmTokenDef( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamNmTokenDefObj* readCachedNmTokenDef( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamNmTokenDefObj*> readCachedNmTokenDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamNmTokenDefObj* updateNmTokenDef( cfbam::ICFBamNmTokenDefEditObj* Obj ) = 0;

		virtual void deleteNmTokenDef( cfbam::ICFBamNmTokenDefEditObj* Obj ) = 0;
		...
		virtual void deleteNmTokenDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamNmTokenDefObj* moveUpNmTokenDef( cfbam::ICFBamNmTokenDefObj* Obj ) = 0;

		virtual cfbam::ICFBamNmTokenDefObj* moveDownNmTokenDef( cfbam::ICFBamNmTokenDefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesNmTokenDef( cfbam::ICFBamNmTokenDefObj* Obj ) = 0;
