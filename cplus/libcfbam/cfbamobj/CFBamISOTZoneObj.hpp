...
// Description: C++18 base object instance specification for CFBam ISOTZone.
...
namespace cfbam {
	...
	class CFBamISOTZoneObj
	: public virtual ICFBamISOTZoneObj,
	...
	public:
		...
		CFBamISOTZoneObj();
		CFBamISOTZoneObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamISOTZoneObj();
