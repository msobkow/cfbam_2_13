...
// Description: C++18 base object instance specification for CFBam Int16Def.
...
namespace cfbam {
	...
	class CFBamInt16DefObj
	: public CFBamAtomObj,
	  public virtual ICFBamInt16DefObj
	{
	protected:
	public:
		...
		CFBamInt16DefObj();
		CFBamInt16DefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamInt16DefObj();
