...
namespace cfbam {
	...
	{
	public:
		ICFBamUInt64DefTableObj();
		virtual ~ICFBamUInt64DefTableObj();
		...
		virtual cfbam::ICFBamUInt64DefObj* newInstance() = 0;

		virtual cfbam::ICFBamUInt64DefEditObj* newEditInstance( cfbam::ICFBamUInt64DefObj* orig ) = 0;

		virtual cfbam::ICFBamUInt64DefObj* realizeUInt64Def( cfbam::ICFBamUInt64DefObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeUInt64Def( cfbam::ICFBamUInt64DefObj* Obj ) = 0;
		virtual cfbam::ICFBamUInt64DefObj* createUInt64Def( cfbam::ICFBamUInt64DefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamUInt64DefObj* readUInt64Def( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamUInt64DefObj* lockUInt64Def( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamUInt64DefObj*> readAllUInt64Def( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamUInt64DefObj* readCachedUInt64Def( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamUInt64DefObj*> readCachedUInt64DefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUInt64DefObj* updateUInt64Def( cfbam::ICFBamUInt64DefEditObj* Obj ) = 0;

		virtual void deleteUInt64Def( cfbam::ICFBamUInt64DefEditObj* Obj ) = 0;
		...
		virtual void deleteUInt64DefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUInt64DefObj* moveUpUInt64Def( cfbam::ICFBamUInt64DefObj* Obj ) = 0;

		virtual cfbam::ICFBamUInt64DefObj* moveDownUInt64Def( cfbam::ICFBamUInt64DefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesUInt64Def( cfbam::ICFBamUInt64DefObj* Obj ) = 0;
