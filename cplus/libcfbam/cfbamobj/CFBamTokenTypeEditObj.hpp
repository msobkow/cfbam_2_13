...
// Description: C++18 edit object instance specification for CFBam TokenType.
...
namespace cfbam {
	...
	class CFBamTokenTypeEditObj
	: public CFBamTokenDefEditObj,
	  public virtual ICFBamTokenTypeEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamTokenTypeEditObj( cfbam::ICFBamTokenTypeObj* argOrig );
		virtual ~CFBamTokenTypeEditObj();
		...
		virtual cfbam::ICFBamTokenTypeTableObj* getTokenTypeTable();

		virtual cfbam::ICFBamTokenTypeEditObj* getTokenTypeEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamTokenTypeObj* getOrigAsTokenType();

		virtual cfbam::CFBamValueBuff* getBuff();
		virtual void setBuff( cfbam::CFBamValueBuff* value );

		inline cfbam::CFBamTokenTypeBuff* getTokenTypeBuff() {
			// Buff is always instantiated when constructed over an original object
			return( static_cast<cfbam::CFBamTokenTypeBuff*>( buff ) );
		};

		inline cfbam::CFBamTokenTypeBuff* getTokenTypeEditBuff() {
			// Buff is always instantiated when constructed over an original object
