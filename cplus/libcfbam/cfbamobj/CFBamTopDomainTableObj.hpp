...
namespace cfbam {
	...
	class CFBamTopDomainTableObj
	: public virtual ICFBamTopDomainTableObj,
	  public virtual cfint::ICFIntTopDomainTableObj
	{
	protected:
	...
	public:
		...
		CFBamTopDomainTableObj();
		CFBamTopDomainTableObj( cfint::ICFIntSchemaObj* argSchema );
		virtual ~CFBamTopDomainTableObj();
