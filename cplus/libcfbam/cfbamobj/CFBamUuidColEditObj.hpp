...
// Description: C++18 edit object instance specification for CFBam UuidCol.
...
namespace cfbam {
	...
	class CFBamUuidColEditObj
	: public CFBamUuidDefEditObj,
	  public virtual ICFBamUuidColEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamUuidColEditObj( cfbam::ICFBamUuidColObj* argOrig );
		virtual ~CFBamUuidColEditObj();
		...
		virtual cfbam::ICFBamUuidColTableObj* getUuidColTable();

		virtual cfbam::ICFBamUuidColEditObj* getUuidColEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamUuidColObj* getOrigAsUuidCol();
		...
		inline cfbam::CFBamUuidColBuff* getUuidColBuff() {
			...
			return( static_cast<cfbam::CFBamUuidColBuff*>( buff ) );
		};
