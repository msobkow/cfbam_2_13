...
// Description: C++18 edit object instance specification for CFBam NmTokenType.
...
namespace cfbam {
	...
	class CFBamNmTokenTypeEditObj
	: public CFBamNmTokenDefEditObj,
	  public virtual ICFBamNmTokenTypeEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamNmTokenTypeEditObj( cfbam::ICFBamNmTokenTypeObj* argOrig );
		virtual ~CFBamNmTokenTypeEditObj();
		...
		virtual cfbam::ICFBamNmTokenTypeTableObj* getNmTokenTypeTable();

		virtual cfbam::ICFBamNmTokenTypeEditObj* getNmTokenTypeEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamNmTokenTypeObj* getOrigAsNmTokenType();

		virtual cfbam::CFBamValueBuff* getBuff();
		virtual void setBuff( cfbam::CFBamValueBuff* value );

		inline cfbam::CFBamNmTokenTypeBuff* getNmTokenTypeBuff() {
			// Buff is always instantiated when constructed over an original object
			return( static_cast<cfbam::CFBamNmTokenTypeBuff*>( buff ) );
		};

		inline cfbam::CFBamNmTokenTypeBuff* getNmTokenTypeEditBuff() {
			// Buff is always instantiated when constructed over an original object
