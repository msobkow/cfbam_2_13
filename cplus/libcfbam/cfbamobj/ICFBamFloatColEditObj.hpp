...
// Description: C++18 Instance Edit Object interface for CFBam FloatCol.
...
namespace cfbam {
	...
	class ICFBamFloatColEditObj
	: public virtual cfbam::ICFBamFloatDefEditObj,
	  public virtual cfbam::ICFBamFloatColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamFloatColEditObj();
		virtual ~ICFBamFloatColEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamFloatColBuff* getFloatColBuff() {
			return( static_cast<cfbam::CFBamFloatColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamFloatColBuff* getFloatColEditBuff() {
			return( dynamic_cast<cfbam::CFBamFloatColBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamFloatColObj* getOrigAsFloatCol() = 0;
