...
namespace cfbam {
	...
	class CFBamInt16ColTableObj
	: public virtual ICFBamInt16ColTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16ColObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16ColObj*>* allInt16Col;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamInt16ColObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16ColObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16ColObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16ColObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16ColObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16ColObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16ColObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16ColObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamInt16ColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16ColObj*>*>* indexByTableIdx;
	...
	public:
		...
		CFBamInt16ColTableObj();
		CFBamInt16ColTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamInt16ColTableObj();
		...
		virtual cfbam::ICFBamInt16ColObj* newInstance();

		virtual cfbam::ICFBamInt16ColEditObj* newEditInstance( cfbam::ICFBamInt16ColObj* orig );

		virtual cfbam::ICFBamInt16ColObj* realizeInt16Col( cfbam::ICFBamInt16ColObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeInt16Col( cfbam::ICFBamInt16ColObj* Obj );
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId );
		virtual cfbam::ICFBamInt16ColObj* createInt16Col( cfbam::ICFBamInt16ColEditObj* Obj );

		virtual cfbam::ICFBamInt16ColObj* readInt16Col( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamInt16ColObj* lockInt16Col( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamInt16ColObj*> readAllInt16Col( bool forceRead = false );

		virtual cfbam::ICFBamInt16ColObj* readInt16ColByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamInt16ColObj* readInt16ColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt16ColObj*> readInt16ColByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt16ColObj*> readInt16ColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt16ColObj*> readInt16ColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt16ColObj*> readInt16ColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt16ColObj*> readInt16ColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt16ColObj*> readInt16ColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt16ColObj*> readInt16ColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt16ColObj*> readInt16ColByTableIdx( const int64_t TenantId,
			const int64_t TableId,
			bool forceRead = false );

		virtual cfbam::ICFBamInt16ColObj* readCachedInt16Col( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamInt16ColObj* readCachedInt16ColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamInt16ColObj* readCachedInt16ColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamInt16ColObj*> readCachedInt16ColByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamInt16ColObj*> readCachedInt16ColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamInt16ColObj*> readCachedInt16ColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamInt16ColObj*> readCachedInt16ColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamInt16ColObj*> readCachedInt16ColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamInt16ColObj*> readCachedInt16ColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamInt16ColObj*> readCachedInt16ColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamInt16ColObj*> readCachedInt16ColByTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual cfbam::ICFBamInt16ColObj* updateInt16Col( cfbam::ICFBamInt16ColEditObj* Obj );

		virtual void deleteInt16Col( cfbam::ICFBamInt16ColEditObj* Obj );

		virtual void deleteInt16ColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteInt16ColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteInt16ColByValTentIdx( const int64_t TenantId );

		virtual void deleteInt16ColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteInt16ColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteInt16ColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteInt16ColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteInt16ColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteInt16ColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteInt16ColByTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual cfbam::ICFBamInt16ColObj* moveUpInt16Col( cfbam::ICFBamInt16ColObj* Obj );

		virtual cfbam::ICFBamInt16ColObj* moveDownInt16Col( cfbam::ICFBamInt16ColObj* Obj );

		virtual void reallyDetachFromIndexesInt16Col( cfbam::ICFBamInt16ColObj* Obj );
