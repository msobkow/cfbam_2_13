...
namespace cfbam {
	...
	{
	public:
		ICFBamBlobColTableObj();
		virtual ~ICFBamBlobColTableObj();
		...
		virtual cfbam::ICFBamBlobColObj* newInstance() = 0;

		virtual cfbam::ICFBamBlobColEditObj* newEditInstance( cfbam::ICFBamBlobColObj* orig ) = 0;

		virtual cfbam::ICFBamBlobColObj* realizeBlobCol( cfbam::ICFBamBlobColObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeBlobCol( cfbam::ICFBamBlobColObj* Obj ) = 0;
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId ) = 0;
		virtual cfbam::ICFBamBlobColObj* createBlobCol( cfbam::ICFBamBlobColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamBlobColObj* readBlobCol( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamBlobColObj* lockBlobCol( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamBlobColObj*> readAllBlobCol( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamBlobColObj* readCachedBlobCol( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamBlobColObj*> readCachedBlobColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamBlobColObj* updateBlobCol( cfbam::ICFBamBlobColEditObj* Obj ) = 0;

		virtual void deleteBlobCol( cfbam::ICFBamBlobColEditObj* Obj ) = 0;
		...
		virtual void deleteBlobColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamBlobColObj* moveUpBlobCol( cfbam::ICFBamBlobColObj* Obj ) = 0;

		virtual cfbam::ICFBamBlobColObj* moveDownBlobCol( cfbam::ICFBamBlobColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesBlobCol( cfbam::ICFBamBlobColObj* Obj ) = 0;
