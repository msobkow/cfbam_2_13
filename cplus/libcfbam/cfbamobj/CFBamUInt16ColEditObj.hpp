...
// Description: C++18 edit object instance specification for CFBam UInt16Col.
...
namespace cfbam {
	...
	class CFBamUInt16ColEditObj
	: public CFBamUInt16DefEditObj,
	  public virtual ICFBamUInt16ColEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamUInt16ColEditObj( cfbam::ICFBamUInt16ColObj* argOrig );
		virtual ~CFBamUInt16ColEditObj();
		...
		virtual cfbam::ICFBamUInt16ColTableObj* getUInt16ColTable();

		virtual cfbam::ICFBamUInt16ColEditObj* getUInt16ColEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamUInt16ColObj* getOrigAsUInt16Col();
		...
		inline cfbam::CFBamUInt16ColBuff* getUInt16ColBuff() {
			...
			return( static_cast<cfbam::CFBamUInt16ColBuff*>( buff ) );
		};
