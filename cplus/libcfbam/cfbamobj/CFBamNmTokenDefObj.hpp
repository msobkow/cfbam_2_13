...
// Description: C++18 base object instance specification for CFBam NmTokenDef.
...
namespace cfbam {
	...
	class CFBamNmTokenDefObj
	: public CFBamAtomObj,
	  public virtual ICFBamNmTokenDefObj
	{
	protected:
	public:
		...
		CFBamNmTokenDefObj();
		CFBamNmTokenDefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamNmTokenDefObj();
