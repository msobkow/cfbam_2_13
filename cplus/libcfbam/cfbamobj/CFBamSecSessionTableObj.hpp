...
namespace cfbam {
	...
	class CFBamSecSessionTableObj
	: public virtual ICFBamSecSessionTableObj,
	  public virtual cfsec::ICFSecSecSessionTableObj,
	  public virtual cfint::ICFIntSecSessionTableObj
	{
	protected:
	...
	public:
		...
		CFBamSecSessionTableObj();
		CFBamSecSessionTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamSecSessionTableObj();
