...
// Description: C++18 Instance Edit Object interface for CFBam NmTokensType.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamNmTokensDefEditObj,
	  public virtual cfbam::ICFBamNmTokensTypeObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamNmTokensTypeEditObj();
		virtual ~ICFBamNmTokensTypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamNmTokensTypeBuff* getNmTokensTypeBuff() {
			return( static_cast<cfbam::CFBamNmTokensTypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamNmTokensTypeBuff* getNmTokensTypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamNmTokensTypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamNmTokensTypeObj* getOrigAsNmTokensType() = 0;
