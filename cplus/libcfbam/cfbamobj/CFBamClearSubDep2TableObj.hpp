...
namespace cfbam {
	...
	class CFBamClearSubDep2TableObj
	: public virtual ICFBamClearSubDep2TableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearSubDep2Obj*>* members;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearSubDep2Obj*>* allClearSubDep2;
		std::map< cfbam::CFBamScopeByTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearSubDep2Obj*>*>* indexByTenantIdx;
		std::map< cfbam::CFBamClearDepByClearDepIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearSubDep2Obj*>*>* indexByClearDepIdx;
		std::map< cfbam::CFBamClearDepByDefSchemaIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearSubDep2Obj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamClearSubDep2ByClearSubDep1IdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearSubDep2Obj*>*>* indexByClearSubDep1Idx;
		std::map< cfbam::CFBamClearSubDep2ByUNameIdxKey,
			cfbam::ICFBamClearSubDep2Obj*>* indexByUNameIdx;
	...
	public:
		...
		CFBamClearSubDep2TableObj();
		CFBamClearSubDep2TableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamClearSubDep2TableObj();
		...
		virtual cfbam::ICFBamClearSubDep2Obj* newInstance();

		virtual cfbam::ICFBamClearSubDep2EditObj* newEditInstance( cfbam::ICFBamClearSubDep2Obj* orig );

		virtual cfbam::ICFBamClearSubDep2Obj* realizeClearSubDep2( cfbam::ICFBamClearSubDep2Obj* Obj );

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id );
		virtual void deepDisposeByTenantIdx( const int64_t TenantId );
		virtual void reallyDeepDisposeClearSubDep2( cfbam::ICFBamClearSubDep2Obj* Obj );
		...
		virtual void deepDisposeByClearSubDep1Idx( const int64_t ClearSubDep1TenantId,
			const int64_t ClearSubDep1Id );
		virtual void deepDisposeByUNameIdx( const int64_t ClearSubDep1TenantId,
			const int64_t ClearSubDep1Id,
			const std::string& Name );
		virtual cfbam::ICFBamClearSubDep2Obj* createClearSubDep2( cfbam::ICFBamClearSubDep2EditObj* Obj );

		virtual cfbam::ICFBamClearSubDep2Obj* readClearSubDep2( cfbam::CFBamScopePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamClearSubDep2Obj* lockClearSubDep2( cfbam::CFBamScopePKey* pkey );

		virtual std::vector<cfbam::ICFBamClearSubDep2Obj*> readAllClearSubDep2( bool forceRead = false );

		virtual cfbam::ICFBamClearSubDep2Obj* readClearSubDep2ByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamClearSubDep2Obj*> readClearSubDep2ByTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamClearSubDep2Obj*> readClearSubDep2ByClearDepIdx( const int64_t TenantId,
			const int64_t RelationId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamClearSubDep2Obj*> readClearSubDep2ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamClearSubDep2Obj*> readClearSubDep2ByClearSubDep1Idx( const int64_t ClearSubDep1TenantId,
			const int64_t ClearSubDep1Id,
			bool forceRead = false );

		virtual cfbam::ICFBamClearSubDep2Obj* readClearSubDep2ByUNameIdx( const int64_t ClearSubDep1TenantId,
			const int64_t ClearSubDep1Id,
			const std::string& Name, bool forceRead = false );

		virtual cfbam::ICFBamClearSubDep2Obj* readCachedClearSubDep2( cfbam::CFBamScopePKey* pkey );

		virtual cfbam::ICFBamClearSubDep2Obj* readCachedClearSubDep2ByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual std::vector<cfbam::ICFBamClearSubDep2Obj*> readCachedClearSubDep2ByTenantIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamClearSubDep2Obj*> readCachedClearSubDep2ByClearDepIdx( const int64_t TenantId,
			const int64_t RelationId );

		virtual std::vector<cfbam::ICFBamClearSubDep2Obj*> readCachedClearSubDep2ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamClearSubDep2Obj*> readCachedClearSubDep2ByClearSubDep1Idx( const int64_t ClearSubDep1TenantId,
			const int64_t ClearSubDep1Id );

		virtual cfbam::ICFBamClearSubDep2Obj* readCachedClearSubDep2ByUNameIdx( const int64_t ClearSubDep1TenantId,
			const int64_t ClearSubDep1Id,
			const std::string& Name );

		virtual cfbam::ICFBamClearSubDep2Obj* updateClearSubDep2( cfbam::ICFBamClearSubDep2EditObj* Obj );

		virtual void deleteClearSubDep2( cfbam::ICFBamClearSubDep2EditObj* Obj );

		virtual void deleteClearSubDep2ByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteClearSubDep2ByTenantIdx( const int64_t TenantId );

		virtual void deleteClearSubDep2ByClearDepIdx( const int64_t TenantId,
			const int64_t RelationId );

		virtual void deleteClearSubDep2ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteClearSubDep2ByClearSubDep1Idx( const int64_t ClearSubDep1TenantId,
			const int64_t ClearSubDep1Id );

		virtual void deleteClearSubDep2ByUNameIdx( const int64_t ClearSubDep1TenantId,
			const int64_t ClearSubDep1Id,
			const std::string& Name );

		virtual void reallyDetachFromIndexesClearSubDep2( cfbam::ICFBamClearSubDep2Obj* Obj );
