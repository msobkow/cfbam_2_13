...
namespace cfbam {
	...
	{
	public:
		ICFBamNmTokensColTableObj();
		virtual ~ICFBamNmTokensColTableObj();
		...
		virtual cfbam::ICFBamNmTokensColObj* newInstance() = 0;

		virtual cfbam::ICFBamNmTokensColEditObj* newEditInstance( cfbam::ICFBamNmTokensColObj* orig ) = 0;

		virtual cfbam::ICFBamNmTokensColObj* realizeNmTokensCol( cfbam::ICFBamNmTokensColObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeNmTokensCol( cfbam::ICFBamNmTokensColObj* Obj ) = 0;
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId ) = 0;
		virtual cfbam::ICFBamNmTokensColObj* createNmTokensCol( cfbam::ICFBamNmTokensColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamNmTokensColObj* readNmTokensCol( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamNmTokensColObj* lockNmTokensCol( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamNmTokensColObj*> readAllNmTokensCol( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamNmTokensColObj* readCachedNmTokensCol( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamNmTokensColObj*> readCachedNmTokensColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamNmTokensColObj* updateNmTokensCol( cfbam::ICFBamNmTokensColEditObj* Obj ) = 0;

		virtual void deleteNmTokensCol( cfbam::ICFBamNmTokensColEditObj* Obj ) = 0;
		...
		virtual void deleteNmTokensColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamNmTokensColObj* moveUpNmTokensCol( cfbam::ICFBamNmTokensColObj* Obj ) = 0;

		virtual cfbam::ICFBamNmTokensColObj* moveDownNmTokensCol( cfbam::ICFBamNmTokensColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesNmTokensCol( cfbam::ICFBamNmTokensColObj* Obj ) = 0;
