...
namespace cfbam {
	...
	{
	public:
		ICFBamEnumTypeTableObj();
		virtual ~ICFBamEnumTypeTableObj();
		...
		virtual cfbam::ICFBamEnumTypeObj* newInstance() = 0;

		virtual cfbam::ICFBamEnumTypeEditObj* newEditInstance( cfbam::ICFBamEnumTypeObj* orig ) = 0;

		virtual cfbam::ICFBamEnumTypeObj* realizeEnumType( cfbam::ICFBamEnumTypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeEnumType( cfbam::ICFBamEnumTypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamEnumTypeObj* createEnumType( cfbam::ICFBamEnumTypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamEnumTypeObj* readEnumType( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamEnumTypeObj* lockEnumType( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamEnumTypeObj*> readAllEnumType( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamEnumTypeObj* readCachedEnumType( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamEnumTypeObj*> readCachedEnumTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamEnumTypeObj* updateEnumType( cfbam::ICFBamEnumTypeEditObj* Obj ) = 0;

		virtual void deleteEnumType( cfbam::ICFBamEnumTypeEditObj* Obj ) = 0;
		...
		virtual void deleteEnumTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamEnumTypeObj* moveUpEnumType( cfbam::ICFBamEnumTypeObj* Obj ) = 0;

		virtual cfbam::ICFBamEnumTypeObj* moveDownEnumType( cfbam::ICFBamEnumTypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesEnumType( cfbam::ICFBamEnumTypeObj* Obj ) = 0;
