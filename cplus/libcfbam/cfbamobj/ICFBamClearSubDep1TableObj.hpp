...
namespace cfbam {
	...
	{
	public:
		ICFBamClearSubDep1TableObj();
		virtual ~ICFBamClearSubDep1TableObj();
		...
		virtual cfbam::ICFBamClearSubDep1Obj* newInstance() = 0;

		virtual cfbam::ICFBamClearSubDep1EditObj* newEditInstance( cfbam::ICFBamClearSubDep1Obj* orig ) = 0;

		virtual cfbam::ICFBamClearSubDep1Obj* realizeClearSubDep1( cfbam::ICFBamClearSubDep1Obj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByTenantIdx( const int64_t TenantId ) = 0;
		virtual void reallyDeepDisposeClearSubDep1( cfbam::ICFBamClearSubDep1Obj* Obj ) = 0;
		...
		virtual cfbam::ICFBamClearSubDep1Obj* createClearSubDep1( cfbam::ICFBamClearSubDep1EditObj* Obj ) = 0;

		virtual cfbam::ICFBamClearSubDep1Obj* readClearSubDep1( cfbam::CFBamScopePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamClearSubDep1Obj* lockClearSubDep1( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamClearSubDep1Obj*> readAllClearSubDep1( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamClearSubDep1Obj* readCachedClearSubDep1( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual cfbam::ICFBamClearSubDep1Obj* readCachedClearSubDep1ByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamClearSubDep1Obj*> readCachedClearSubDep1ByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamClearSubDep1Obj* updateClearSubDep1( cfbam::ICFBamClearSubDep1EditObj* Obj ) = 0;

		virtual void deleteClearSubDep1( cfbam::ICFBamClearSubDep1EditObj* Obj ) = 0;

		virtual void deleteClearSubDep1ByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deleteClearSubDep1ByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesClearSubDep1( cfbam::ICFBamClearSubDep1Obj* Obj ) = 0;
