...
// Description: C++18 base object instance specification for CFBam TSecGrpMemb.
...
namespace cfbam {
	...
	class CFBamTSecGrpMembObj
	: public virtual ICFBamTSecGrpMembObj,
	...
	public:
		...
		CFBamTSecGrpMembObj();
		CFBamTSecGrpMembObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTSecGrpMembObj();
