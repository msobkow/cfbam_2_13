...
// Description: C++18 Object interface for CFBam SchemaRef.
...
namespace cfbam {
	...
	public:
		ICFBamSchemaRefObj();
		virtual ~ICFBamSchemaRefObj();
		virtual cfbam::ICFBamSchemaRefObj* moveUp() = 0;

		virtual cfbam::ICFBamSchemaRefObj* moveDown() = 0;

		virtual cfbam::ICFBamScopeEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamSchemaRefEditObj* getSchemaRefEdit() = 0;

		inline cfbam::CFBamSchemaRefBuff* getSchemaRefBuff() {
			return( static_cast<cfbam::CFBamSchemaRefBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamSchemaRefBuff* getSchemaRefEditBuff() {
			return( dynamic_cast<cfbam::CFBamSchemaRefBuff*>( getBuff() ) );
		};

		virtual const int64_t getRequiredSchemaId() = 0;
		virtual const int64_t* getRequiredSchemaIdReference() = 0;

		virtual const std::string& getRequiredName() = 0;
		virtual const std::string* getRequiredNameReference() = 0;

		virtual const std::string& getRequiredRefModelName() = 0;
		virtual const std::string* getRequiredRefModelNameReference() = 0;

		virtual const std::string& getRequiredIncludeRoot() = 0;
		virtual const std::string* getRequiredIncludeRootReference() = 0;

		virtual bool isOptionalRefSchemaTenantIdNull() = 0;
		virtual const int64_t getOptionalRefSchemaTenantIdValue() = 0;
		virtual const int64_t* getOptionalRefSchemaTenantIdReference() = 0;

		virtual bool isOptionalRefSchemaIdNull() = 0;
		virtual const int64_t getOptionalRefSchemaIdValue() = 0;
		virtual const int64_t* getOptionalRefSchemaIdReference() = 0;
		...
		virtual cfbam::ICFBamSchemaDefObj* getRequiredContainerSchema( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamSchemaDefObj* getOptionalLookupRefSchema( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamSchemaRefObj* getOptionalLookupPrev( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamSchemaRefObj* getOptionalLookupNext( bool forceRead = false ) = 0;
