...
namespace cfbam {
	...
	class CFBamPopSubDep3TableObj
	: public virtual ICFBamPopSubDep3TableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopSubDep3Obj*>* members;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopSubDep3Obj*>* allPopSubDep3;
		std::map< cfbam::CFBamScopeByTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopSubDep3Obj*>*>* indexByTenantIdx;
		std::map< cfbam::CFBamPopDepByRelationIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopSubDep3Obj*>*>* indexByRelationIdx;
		std::map< cfbam::CFBamPopDepByDefSchemaIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopSubDep3Obj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamPopSubDep3ByPopSubDep2IdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopSubDep3Obj*>*>* indexByPopSubDep2Idx;
		std::map< cfbam::CFBamPopSubDep3ByUNameIdxKey,
			cfbam::ICFBamPopSubDep3Obj*>* indexByUNameIdx;
	...
	public:
		...
		CFBamPopSubDep3TableObj();
		CFBamPopSubDep3TableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamPopSubDep3TableObj();
		...
		virtual cfbam::ICFBamPopSubDep3Obj* newInstance();

		virtual cfbam::ICFBamPopSubDep3EditObj* newEditInstance( cfbam::ICFBamPopSubDep3Obj* orig );

		virtual cfbam::ICFBamPopSubDep3Obj* realizePopSubDep3( cfbam::ICFBamPopSubDep3Obj* Obj );

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id );
		virtual void deepDisposeByTenantIdx( const int64_t TenantId );
		virtual void reallyDeepDisposePopSubDep3( cfbam::ICFBamPopSubDep3Obj* Obj );
		...
		virtual void deepDisposeByPopSubDep2Idx( const int64_t PopSubDep2TenantId,
			const int64_t PopSubDep2Id );
		virtual void deepDisposeByUNameIdx( const int64_t PopSubDep2TenantId,
			const int64_t PopSubDep2Id,
			const std::string& Name );
		virtual cfbam::ICFBamPopSubDep3Obj* createPopSubDep3( cfbam::ICFBamPopSubDep3EditObj* Obj );

		virtual cfbam::ICFBamPopSubDep3Obj* readPopSubDep3( cfbam::CFBamScopePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamPopSubDep3Obj* lockPopSubDep3( cfbam::CFBamScopePKey* pkey );

		virtual std::vector<cfbam::ICFBamPopSubDep3Obj*> readAllPopSubDep3( bool forceRead = false );

		virtual cfbam::ICFBamPopSubDep3Obj* readPopSubDep3ByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamPopSubDep3Obj*> readPopSubDep3ByTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamPopSubDep3Obj*> readPopSubDep3ByRelationIdx( const int64_t RelationTenantId,
			const int64_t RelationId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamPopSubDep3Obj*> readPopSubDep3ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamPopSubDep3Obj*> readPopSubDep3ByPopSubDep2Idx( const int64_t PopSubDep2TenantId,
			const int64_t PopSubDep2Id,
			bool forceRead = false );

		virtual cfbam::ICFBamPopSubDep3Obj* readPopSubDep3ByUNameIdx( const int64_t PopSubDep2TenantId,
			const int64_t PopSubDep2Id,
			const std::string& Name, bool forceRead = false );

		virtual cfbam::ICFBamPopSubDep3Obj* readCachedPopSubDep3( cfbam::CFBamScopePKey* pkey );

		virtual cfbam::ICFBamPopSubDep3Obj* readCachedPopSubDep3ByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual std::vector<cfbam::ICFBamPopSubDep3Obj*> readCachedPopSubDep3ByTenantIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamPopSubDep3Obj*> readCachedPopSubDep3ByRelationIdx( const int64_t RelationTenantId,
			const int64_t RelationId );

		virtual std::vector<cfbam::ICFBamPopSubDep3Obj*> readCachedPopSubDep3ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamPopSubDep3Obj*> readCachedPopSubDep3ByPopSubDep2Idx( const int64_t PopSubDep2TenantId,
			const int64_t PopSubDep2Id );

		virtual cfbam::ICFBamPopSubDep3Obj* readCachedPopSubDep3ByUNameIdx( const int64_t PopSubDep2TenantId,
			const int64_t PopSubDep2Id,
			const std::string& Name );

		virtual cfbam::ICFBamPopSubDep3Obj* updatePopSubDep3( cfbam::ICFBamPopSubDep3EditObj* Obj );

		virtual void deletePopSubDep3( cfbam::ICFBamPopSubDep3EditObj* Obj );

		virtual void deletePopSubDep3ByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deletePopSubDep3ByTenantIdx( const int64_t TenantId );

		virtual void deletePopSubDep3ByRelationIdx( const int64_t RelationTenantId,
			const int64_t RelationId );

		virtual void deletePopSubDep3ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deletePopSubDep3ByPopSubDep2Idx( const int64_t PopSubDep2TenantId,
			const int64_t PopSubDep2Id );

		virtual void deletePopSubDep3ByUNameIdx( const int64_t PopSubDep2TenantId,
			const int64_t PopSubDep2Id,
			const std::string& Name );

		virtual void reallyDetachFromIndexesPopSubDep3( cfbam::ICFBamPopSubDep3Obj* Obj );
