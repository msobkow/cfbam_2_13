...
namespace cfbam {
	...
	class CFBamTSecGroupTableObj
	: public virtual ICFBamTSecGroupTableObj,
	  public virtual cfsec::ICFSecTSecGroupTableObj,
	  public virtual cfint::ICFIntTSecGroupTableObj
	{
	protected:
	...
	public:
		...
		CFBamTSecGroupTableObj();
		CFBamTSecGroupTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamTSecGroupTableObj();
