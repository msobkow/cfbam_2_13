...
// Description: C++18 Instance Edit Object interface for CFBam TextCol.
...
namespace cfbam {
	...
	class ICFBamTextColEditObj
	: public virtual cfbam::ICFBamTextDefEditObj,
	  public virtual cfbam::ICFBamTextColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamTextColEditObj();
		virtual ~ICFBamTextColEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamTextColBuff* getTextColBuff() {
			return( static_cast<cfbam::CFBamTextColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamTextColBuff* getTextColEditBuff() {
			return( dynamic_cast<cfbam::CFBamTextColBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamTextColObj* getOrigAsTextCol() = 0;
