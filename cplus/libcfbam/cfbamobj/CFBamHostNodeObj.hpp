...
// Description: C++18 base object instance specification for CFBam HostNode.
...
namespace cfbam {
	...
	class CFBamHostNodeObj
	: public virtual ICFBamHostNodeObj,
	...
	public:
		...
		CFBamHostNodeObj();
		CFBamHostNodeObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamHostNodeObj();
