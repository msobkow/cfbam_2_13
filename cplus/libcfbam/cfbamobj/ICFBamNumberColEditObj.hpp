...
// Description: C++18 Instance Edit Object interface for CFBam NumberCol.
...
namespace cfbam {
	...
	class ICFBamNumberColEditObj
	: public virtual cfbam::ICFBamNumberDefEditObj,
	  public virtual cfbam::ICFBamNumberColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamNumberColEditObj();
		virtual ~ICFBamNumberColEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamNumberColBuff* getNumberColBuff() {
			return( static_cast<cfbam::CFBamNumberColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamNumberColBuff* getNumberColEditBuff() {
			return( dynamic_cast<cfbam::CFBamNumberColBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamNumberColObj* getOrigAsNumberCol() = 0;
