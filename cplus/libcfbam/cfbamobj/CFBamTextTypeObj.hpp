...
// Description: C++18 base object instance specification for CFBam TextType.
...
namespace cfbam {
	...
	class CFBamTextTypeObj
	: public CFBamTextDefObj,
	  public virtual ICFBamTextTypeObj
	{
	protected:
	public:
		...
		CFBamTextTypeObj();
		CFBamTextTypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTextTypeObj();
