...
// Description: C++18 Instance Edit Object interface for CFBam EnumType.
...
namespace cfbam {
	...
	class ICFBamEnumTypeEditObj
	: public virtual cfbam::ICFBamEnumDefEditObj,
	  public virtual cfbam::ICFBamEnumTypeObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamEnumTypeEditObj();
		virtual ~ICFBamEnumTypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamEnumTypeBuff* getEnumTypeBuff() {
			return( static_cast<cfbam::CFBamEnumTypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamEnumTypeBuff* getEnumTypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamEnumTypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamEnumTypeObj* getOrigAsEnumType() = 0;
