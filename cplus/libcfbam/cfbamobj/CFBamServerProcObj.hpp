...
// Description: C++18 base object instance specification for CFBam ServerProc.
...
namespace cfbam {
	...
	class CFBamServerProcObj
	: public CFBamServerMethodObj,
	  public virtual ICFBamServerProcObj
	{
	protected:
	public:
		...
		CFBamServerProcObj();
		CFBamServerProcObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamServerProcObj();
