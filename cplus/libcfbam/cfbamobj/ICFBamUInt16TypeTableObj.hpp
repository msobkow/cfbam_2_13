...
namespace cfbam {
	...
	{
	public:
		ICFBamUInt16TypeTableObj();
		virtual ~ICFBamUInt16TypeTableObj();
		...
		virtual cfbam::ICFBamUInt16TypeObj* newInstance() = 0;

		virtual cfbam::ICFBamUInt16TypeEditObj* newEditInstance( cfbam::ICFBamUInt16TypeObj* orig ) = 0;

		virtual cfbam::ICFBamUInt16TypeObj* realizeUInt16Type( cfbam::ICFBamUInt16TypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeUInt16Type( cfbam::ICFBamUInt16TypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamUInt16TypeObj* createUInt16Type( cfbam::ICFBamUInt16TypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamUInt16TypeObj* readUInt16Type( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamUInt16TypeObj* lockUInt16Type( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamUInt16TypeObj*> readAllUInt16Type( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamUInt16TypeObj* readCachedUInt16Type( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamUInt16TypeObj*> readCachedUInt16TypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUInt16TypeObj* updateUInt16Type( cfbam::ICFBamUInt16TypeEditObj* Obj ) = 0;

		virtual void deleteUInt16Type( cfbam::ICFBamUInt16TypeEditObj* Obj ) = 0;
		...
		virtual void deleteUInt16TypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUInt16TypeObj* moveUpUInt16Type( cfbam::ICFBamUInt16TypeObj* Obj ) = 0;

		virtual cfbam::ICFBamUInt16TypeObj* moveDownUInt16Type( cfbam::ICFBamUInt16TypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesUInt16Type( cfbam::ICFBamUInt16TypeObj* Obj ) = 0;
