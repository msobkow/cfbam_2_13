...
// Description: C++18 edit object instance specification for CFBam NmTokensCol.
...
namespace cfbam {
	...
	class CFBamNmTokensColEditObj
	: public CFBamNmTokensDefEditObj,
	  public virtual ICFBamNmTokensColEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamNmTokensColEditObj( cfbam::ICFBamNmTokensColObj* argOrig );
		virtual ~CFBamNmTokensColEditObj();
		...
		virtual cfbam::ICFBamNmTokensColTableObj* getNmTokensColTable();

		virtual cfbam::ICFBamNmTokensColEditObj* getNmTokensColEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamNmTokensColObj* getOrigAsNmTokensCol();
		...
		inline cfbam::CFBamNmTokensColBuff* getNmTokensColBuff() {
			...
			return( static_cast<cfbam::CFBamNmTokensColBuff*>( buff ) );
		};
