...
// Description: C++18 Instance Edit Object interface for CFBam UuidType.
...
namespace cfbam {
	...
	public:
		...
		virtual ~ICFBamUuidTypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamUuidTypeBuff* getUuidTypeBuff() {
			return( static_cast<cfbam::CFBamUuidTypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamUuidTypeBuff* getUuidTypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamUuidTypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamUuidTypeObj* getOrigAsUuidType() = 0;
