...
// Description: C++18 base object instance specification for CFBam SecForm.
...
namespace cfbam {
	...
	class CFBamSecFormObj
	: public virtual ICFBamSecFormObj,
	...
	public:
		...
		CFBamSecFormObj();
		CFBamSecFormObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamSecFormObj();
