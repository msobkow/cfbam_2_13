...
// Description: C++18 edit object instance specification for CFBam TZDateType.
...
namespace cfbam {
	...
	class CFBamTZDateTypeEditObj
	: public CFBamTZDateDefEditObj,
	  public virtual ICFBamTZDateTypeEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamTZDateTypeEditObj( cfbam::ICFBamTZDateTypeObj* argOrig );
		virtual ~CFBamTZDateTypeEditObj();
		...
		virtual cfbam::ICFBamTZDateTypeTableObj* getTZDateTypeTable();

		virtual cfbam::ICFBamTZDateTypeEditObj* getTZDateTypeEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamTZDateTypeObj* getOrigAsTZDateType();

		virtual cfbam::CFBamValueBuff* getBuff();
		virtual void setBuff( cfbam::CFBamValueBuff* value );

		inline cfbam::CFBamTZDateTypeBuff* getTZDateTypeBuff() {
			// Buff is always instantiated when constructed over an original object
			return( static_cast<cfbam::CFBamTZDateTypeBuff*>( buff ) );
		};

		inline cfbam::CFBamTZDateTypeBuff* getTZDateTypeEditBuff() {
			// Buff is always instantiated when constructed over an original object
