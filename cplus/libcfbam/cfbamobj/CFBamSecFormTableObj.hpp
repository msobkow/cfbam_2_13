...
namespace cfbam {
	...
	class CFBamSecFormTableObj
	: public virtual ICFBamSecFormTableObj,
	  public virtual cfsec::ICFSecSecFormTableObj,
	  public virtual cfint::ICFIntSecFormTableObj
	{
	protected:
	...
	public:
		...
		CFBamSecFormTableObj();
		CFBamSecFormTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamSecFormTableObj();
