...
// Description: C++18 base object instance specification for CFBam Int64Type.
...
namespace cfbam {
	...
	class CFBamInt64TypeObj
	: public CFBamInt64DefObj,
	  public virtual ICFBamInt64TypeObj
	{
	protected:
	public:
		...
		CFBamInt64TypeObj();
		CFBamInt64TypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamInt64TypeObj();
