...
namespace cfbam {
	...
	{
	public:
		ICFBamUInt32ColTableObj();
		virtual ~ICFBamUInt32ColTableObj();
		...
		virtual cfbam::ICFBamUInt32ColObj* newInstance() = 0;

		virtual cfbam::ICFBamUInt32ColEditObj* newEditInstance( cfbam::ICFBamUInt32ColObj* orig ) = 0;

		virtual cfbam::ICFBamUInt32ColObj* realizeUInt32Col( cfbam::ICFBamUInt32ColObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeUInt32Col( cfbam::ICFBamUInt32ColObj* Obj ) = 0;
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId ) = 0;
		virtual cfbam::ICFBamUInt32ColObj* createUInt32Col( cfbam::ICFBamUInt32ColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamUInt32ColObj* readUInt32Col( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamUInt32ColObj* lockUInt32Col( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamUInt32ColObj*> readAllUInt32Col( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamUInt32ColObj* readCachedUInt32Col( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamUInt32ColObj*> readCachedUInt32ColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUInt32ColObj* updateUInt32Col( cfbam::ICFBamUInt32ColEditObj* Obj ) = 0;

		virtual void deleteUInt32Col( cfbam::ICFBamUInt32ColEditObj* Obj ) = 0;
		...
		virtual void deleteUInt32ColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUInt32ColObj* moveUpUInt32Col( cfbam::ICFBamUInt32ColObj* Obj ) = 0;

		virtual cfbam::ICFBamUInt32ColObj* moveDownUInt32Col( cfbam::ICFBamUInt32ColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesUInt32Col( cfbam::ICFBamUInt32ColObj* Obj ) = 0;
