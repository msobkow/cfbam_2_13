...
namespace cfbam {
	...
	class CFBamSecGrpIncTableObj
	: public virtual ICFBamSecGrpIncTableObj,
	  public virtual cfsec::ICFSecSecGrpIncTableObj,
	  public virtual cfint::ICFIntSecGrpIncTableObj
	{
	protected:
	...
	public:
		...
		CFBamSecGrpIncTableObj();
		CFBamSecGrpIncTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamSecGrpIncTableObj();
