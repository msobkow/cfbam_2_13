...
namespace cfbam {
	...
	{
	public:
		ICFBamNmTokenColTableObj();
		virtual ~ICFBamNmTokenColTableObj();
		...
		virtual cfbam::ICFBamNmTokenColObj* newInstance() = 0;

		virtual cfbam::ICFBamNmTokenColEditObj* newEditInstance( cfbam::ICFBamNmTokenColObj* orig ) = 0;

		virtual cfbam::ICFBamNmTokenColObj* realizeNmTokenCol( cfbam::ICFBamNmTokenColObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeNmTokenCol( cfbam::ICFBamNmTokenColObj* Obj ) = 0;
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId ) = 0;
		virtual cfbam::ICFBamNmTokenColObj* createNmTokenCol( cfbam::ICFBamNmTokenColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamNmTokenColObj* readNmTokenCol( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamNmTokenColObj* lockNmTokenCol( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamNmTokenColObj*> readAllNmTokenCol( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamNmTokenColObj* readCachedNmTokenCol( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamNmTokenColObj*> readCachedNmTokenColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamNmTokenColObj* updateNmTokenCol( cfbam::ICFBamNmTokenColEditObj* Obj ) = 0;

		virtual void deleteNmTokenCol( cfbam::ICFBamNmTokenColEditObj* Obj ) = 0;
		...
		virtual void deleteNmTokenColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamNmTokenColObj* moveUpNmTokenCol( cfbam::ICFBamNmTokenColObj* Obj ) = 0;

		virtual cfbam::ICFBamNmTokenColObj* moveDownNmTokenCol( cfbam::ICFBamNmTokenColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesNmTokenCol( cfbam::ICFBamNmTokenColObj* Obj ) = 0;
