...
// Description: C++18 base object instance specification for CFBam StringDef.
...
namespace cfbam {
	...
	class CFBamStringDefObj
	: public CFBamAtomObj,
	  public virtual ICFBamStringDefObj
	{
	protected:
	public:
		...
		CFBamStringDefObj();
		CFBamStringDefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamStringDefObj();
