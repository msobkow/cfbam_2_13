...
namespace cfbam {
	...
	class CFBamPopSubDep2TableObj
	: public virtual ICFBamPopSubDep2TableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopSubDep2Obj*>* members;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopSubDep2Obj*>* allPopSubDep2;
		std::map< cfbam::CFBamScopeByTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopSubDep2Obj*>*>* indexByTenantIdx;
		std::map< cfbam::CFBamPopDepByRelationIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopSubDep2Obj*>*>* indexByRelationIdx;
		std::map< cfbam::CFBamPopDepByDefSchemaIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopSubDep2Obj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamPopSubDep2ByPopSubDep1IdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopSubDep2Obj*>*>* indexByPopSubDep1Idx;
		std::map< cfbam::CFBamPopSubDep2ByUNameIdxKey,
			cfbam::ICFBamPopSubDep2Obj*>* indexByUNameIdx;
	...
	public:
		...
		CFBamPopSubDep2TableObj();
		CFBamPopSubDep2TableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamPopSubDep2TableObj();
		...
		virtual cfbam::ICFBamPopSubDep2Obj* newInstance();

		virtual cfbam::ICFBamPopSubDep2EditObj* newEditInstance( cfbam::ICFBamPopSubDep2Obj* orig );

		virtual cfbam::ICFBamPopSubDep2Obj* realizePopSubDep2( cfbam::ICFBamPopSubDep2Obj* Obj );

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id );
		virtual void deepDisposeByTenantIdx( const int64_t TenantId );
		virtual void reallyDeepDisposePopSubDep2( cfbam::ICFBamPopSubDep2Obj* Obj );
		virtual void deepDisposeByRelationIdx( const int64_t RelationTenantId,
			const int64_t RelationId );
		virtual void deepDisposeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );
		virtual void deepDisposeByPopSubDep1Idx( const int64_t PopSubDep1TenantId,
			const int64_t PopSubDep1Id );
		virtual void deepDisposeByUNameIdx( const int64_t PopSubDep1TenantId,
			const int64_t PopSubDep1Id,
			const std::string& Name );
		virtual cfbam::ICFBamPopSubDep2Obj* createPopSubDep2( cfbam::ICFBamPopSubDep2EditObj* Obj );

		virtual cfbam::ICFBamPopSubDep2Obj* readPopSubDep2( cfbam::CFBamScopePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamPopSubDep2Obj* lockPopSubDep2( cfbam::CFBamScopePKey* pkey );

		virtual std::vector<cfbam::ICFBamPopSubDep2Obj*> readAllPopSubDep2( bool forceRead = false );

		virtual cfbam::ICFBamPopSubDep2Obj* readPopSubDep2ByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamPopSubDep2Obj*> readPopSubDep2ByTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamPopSubDep2Obj*> readPopSubDep2ByRelationIdx( const int64_t RelationTenantId,
			const int64_t RelationId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamPopSubDep2Obj*> readPopSubDep2ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamPopSubDep2Obj*> readPopSubDep2ByPopSubDep1Idx( const int64_t PopSubDep1TenantId,
			const int64_t PopSubDep1Id,
			bool forceRead = false );

		virtual cfbam::ICFBamPopSubDep2Obj* readPopSubDep2ByUNameIdx( const int64_t PopSubDep1TenantId,
			const int64_t PopSubDep1Id,
			const std::string& Name, bool forceRead = false );

		virtual cfbam::ICFBamPopSubDep2Obj* readCachedPopSubDep2( cfbam::CFBamScopePKey* pkey );

		virtual cfbam::ICFBamPopSubDep2Obj* readCachedPopSubDep2ByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual std::vector<cfbam::ICFBamPopSubDep2Obj*> readCachedPopSubDep2ByTenantIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamPopSubDep2Obj*> readCachedPopSubDep2ByRelationIdx( const int64_t RelationTenantId,
			const int64_t RelationId );

		virtual std::vector<cfbam::ICFBamPopSubDep2Obj*> readCachedPopSubDep2ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamPopSubDep2Obj*> readCachedPopSubDep2ByPopSubDep1Idx( const int64_t PopSubDep1TenantId,
			const int64_t PopSubDep1Id );

		virtual cfbam::ICFBamPopSubDep2Obj* readCachedPopSubDep2ByUNameIdx( const int64_t PopSubDep1TenantId,
			const int64_t PopSubDep1Id,
			const std::string& Name );

		virtual cfbam::ICFBamPopSubDep2Obj* updatePopSubDep2( cfbam::ICFBamPopSubDep2EditObj* Obj );

		virtual void deletePopSubDep2( cfbam::ICFBamPopSubDep2EditObj* Obj );

		virtual void deletePopSubDep2ByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deletePopSubDep2ByTenantIdx( const int64_t TenantId );

		virtual void deletePopSubDep2ByRelationIdx( const int64_t RelationTenantId,
			const int64_t RelationId );

		virtual void deletePopSubDep2ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deletePopSubDep2ByPopSubDep1Idx( const int64_t PopSubDep1TenantId,
			const int64_t PopSubDep1Id );

		virtual void deletePopSubDep2ByUNameIdx( const int64_t PopSubDep1TenantId,
			const int64_t PopSubDep1Id,
			const std::string& Name );

		virtual void reallyDetachFromIndexesPopSubDep2( cfbam::ICFBamPopSubDep2Obj* Obj );
