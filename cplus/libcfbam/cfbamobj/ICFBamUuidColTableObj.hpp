...
namespace cfbam {
	...
	{
	public:
		ICFBamUuidColTableObj();
		virtual ~ICFBamUuidColTableObj();
		...
		virtual cfbam::ICFBamUuidColObj* newInstance() = 0;

		virtual cfbam::ICFBamUuidColEditObj* newEditInstance( cfbam::ICFBamUuidColObj* orig ) = 0;

		virtual cfbam::ICFBamUuidColObj* realizeUuidCol( cfbam::ICFBamUuidColObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeUuidCol( cfbam::ICFBamUuidColObj* Obj ) = 0;
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId ) = 0;
		virtual cfbam::ICFBamUuidColObj* createUuidCol( cfbam::ICFBamUuidColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamUuidColObj* readUuidCol( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamUuidColObj* lockUuidCol( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamUuidColObj*> readAllUuidCol( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamUuidColObj* readCachedUuidCol( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamUuidColObj*> readCachedUuidColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUuidColObj* updateUuidCol( cfbam::ICFBamUuidColEditObj* Obj ) = 0;

		virtual void deleteUuidCol( cfbam::ICFBamUuidColEditObj* Obj ) = 0;
		...
		virtual void deleteUuidColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUuidColObj* moveUpUuidCol( cfbam::ICFBamUuidColObj* Obj ) = 0;

		virtual cfbam::ICFBamUuidColObj* moveDownUuidCol( cfbam::ICFBamUuidColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesUuidCol( cfbam::ICFBamUuidColObj* Obj ) = 0;
