...
// Description: C++18 base object instance specification for CFBam TZTimeDef.
...
namespace cfbam {
	...
	class CFBamTZTimeDefObj
	: public CFBamAtomObj,
	  public virtual ICFBamTZTimeDefObj
	{
	protected:
	public:
		...
		CFBamTZTimeDefObj();
		CFBamTZTimeDefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTZTimeDefObj();
