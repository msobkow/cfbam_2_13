...
// Description: C++18 base object instance specification for CFBam NmTokensType.
...
namespace cfbam {
	...
	class CFBamNmTokensTypeObj
	: public CFBamNmTokensDefObj,
	  public virtual ICFBamNmTokensTypeObj
	{
	protected:
	public:
		...
		CFBamNmTokensTypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamNmTokensTypeObj();
