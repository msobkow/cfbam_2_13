...
namespace cfbam {
	...
	class CFBamMimeTypeTableObj
	: public virtual ICFBamMimeTypeTableObj,
	  public virtual cfint::ICFIntMimeTypeTableObj
	{
	protected:
	...
	public:
		...
		CFBamMimeTypeTableObj();
		CFBamMimeTypeTableObj( cfint::ICFIntSchemaObj* argSchema );
		virtual ~CFBamMimeTypeTableObj();
