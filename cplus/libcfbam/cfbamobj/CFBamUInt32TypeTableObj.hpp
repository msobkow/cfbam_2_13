...
namespace cfbam {
	...
	class CFBamUInt32TypeTableObj
	: public virtual ICFBamUInt32TypeTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32TypeObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32TypeObj*>* allUInt32Type;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamUInt32TypeObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32TypeObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32TypeObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32TypeObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32TypeObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32TypeObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32TypeObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32TypeObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamUInt32TypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32TypeObj*>*>* indexBySchemaIdx;
	...
	public:
		...
		CFBamUInt32TypeTableObj();
		CFBamUInt32TypeTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamUInt32TypeTableObj();
		...
		virtual cfbam::ICFBamUInt32TypeObj* newInstance();

		virtual cfbam::ICFBamUInt32TypeEditObj* newEditInstance( cfbam::ICFBamUInt32TypeObj* orig );

		virtual cfbam::ICFBamUInt32TypeObj* realizeUInt32Type( cfbam::ICFBamUInt32TypeObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeUInt32Type( cfbam::ICFBamUInt32TypeObj* Obj );
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );
		virtual cfbam::ICFBamUInt32TypeObj* createUInt32Type( cfbam::ICFBamUInt32TypeEditObj* Obj );

		virtual cfbam::ICFBamUInt32TypeObj* readUInt32Type( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamUInt32TypeObj* lockUInt32Type( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamUInt32TypeObj*> readAllUInt32Type( bool forceRead = false );

		virtual cfbam::ICFBamUInt32TypeObj* readUInt32TypeByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamUInt32TypeObj* readUInt32TypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt32TypeObj*> readUInt32TypeByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt32TypeObj*> readUInt32TypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt32TypeObj*> readUInt32TypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt32TypeObj*> readUInt32TypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt32TypeObj*> readUInt32TypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt32TypeObj*> readUInt32TypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt32TypeObj*> readUInt32TypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt32TypeObj*> readUInt32TypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId,
			bool forceRead = false );

		virtual cfbam::ICFBamUInt32TypeObj* readCachedUInt32Type( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamUInt32TypeObj* readCachedUInt32TypeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamUInt32TypeObj* readCachedUInt32TypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamUInt32TypeObj*> readCachedUInt32TypeByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamUInt32TypeObj*> readCachedUInt32TypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamUInt32TypeObj*> readCachedUInt32TypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamUInt32TypeObj*> readCachedUInt32TypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamUInt32TypeObj*> readCachedUInt32TypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamUInt32TypeObj*> readCachedUInt32TypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamUInt32TypeObj*> readCachedUInt32TypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamUInt32TypeObj*> readCachedUInt32TypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual cfbam::ICFBamUInt32TypeObj* updateUInt32Type( cfbam::ICFBamUInt32TypeEditObj* Obj );

		virtual void deleteUInt32Type( cfbam::ICFBamUInt32TypeEditObj* Obj );

		virtual void deleteUInt32TypeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteUInt32TypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteUInt32TypeByValTentIdx( const int64_t TenantId );

		virtual void deleteUInt32TypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteUInt32TypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteUInt32TypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteUInt32TypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteUInt32TypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteUInt32TypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteUInt32TypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual cfbam::ICFBamUInt32TypeObj* moveUpUInt32Type( cfbam::ICFBamUInt32TypeObj* Obj );

		virtual cfbam::ICFBamUInt32TypeObj* moveDownUInt32Type( cfbam::ICFBamUInt32TypeObj* Obj );

		virtual void reallyDetachFromIndexesUInt32Type( cfbam::ICFBamUInt32TypeObj* Obj );
