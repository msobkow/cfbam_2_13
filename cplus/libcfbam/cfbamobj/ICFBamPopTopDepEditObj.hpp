...
// Description: C++18 Instance Edit Object interface for CFBam PopTopDep.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamPopDepEditObj,
	  public virtual cfbam::ICFBamPopTopDepObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamPopTopDepEditObj();
		virtual ~ICFBamPopTopDepEditObj();
		...
		virtual cfbam::ICFBamPopTopDepObj* getOrigAsPopTopDep() = 0;
		...
		virtual void setRequiredContainerContRelation( cfbam::ICFBamRelationObj* value ) = 0;
