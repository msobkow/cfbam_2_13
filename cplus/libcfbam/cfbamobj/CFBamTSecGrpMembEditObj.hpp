...
// Description: C++18 edit object instance specification for CFBam TSecGrpMemb.
...
namespace cfbam {
	...
	class CFBamTSecGrpMembEditObj
	: public virtual ICFBamTSecGrpMembEditObj,
	  public virtual cfsec::ICFSecTSecGrpMembEditObj,
	  public virtual cfint::ICFIntTSecGrpMembEditObj
	{
	public:
	...
	public:
		CFBamTSecGrpMembEditObj( cfsec::ICFSecTSecGrpMembObj* argOrig );
		virtual ~CFBamTSecGrpMembEditObj();
