...
// Description: C++18 edit object instance specification for CFBam Int16Col.
...
namespace cfbam {
	...
	class CFBamInt16ColEditObj
	: public CFBamInt16DefEditObj,
	  public virtual ICFBamInt16ColEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamInt16ColEditObj( cfbam::ICFBamInt16ColObj* argOrig );
		virtual ~CFBamInt16ColEditObj();
		...
		virtual cfbam::ICFBamInt16ColTableObj* getInt16ColTable();

		virtual cfbam::ICFBamInt16ColEditObj* getInt16ColEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamInt16ColObj* getOrigAsInt16Col();
		...
		inline cfbam::CFBamInt16ColBuff* getInt16ColBuff() {
			...
			return( static_cast<cfbam::CFBamInt16ColBuff*>( buff ) );
		};
