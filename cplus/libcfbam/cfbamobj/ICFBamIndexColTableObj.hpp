...
namespace cfbam {
	...
	{
	public:
		ICFBamIndexColTableObj();
		virtual ~ICFBamIndexColTableObj();
		...
		virtual cfbam::ICFBamIndexColObj* newInstance() = 0;

		virtual cfbam::ICFBamIndexColEditObj* newEditInstance( cfbam::ICFBamIndexColObj* orig ) = 0;

		virtual cfbam::ICFBamIndexColObj* realizeIndexCol( cfbam::ICFBamIndexColObj* Obj ) = 0;
		...
		virtual void deepDisposeByIdxColTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void deepDisposeByIdxNextIdx( const int64_t TenantId,
			const int64_t IndexId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeIndexCol( cfbam::ICFBamIndexColObj* Obj ) = 0;
		virtual cfbam::ICFBamIndexColObj* createIndexCol( cfbam::ICFBamIndexColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamIndexColObj* readIndexCol( cfbam::CFBamIndexColPKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamIndexColObj* lockIndexCol( cfbam::CFBamIndexColPKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamIndexColObj*> readAllIndexCol( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamIndexColObj* readCachedIndexCol( cfbam::CFBamIndexColPKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamIndexColObj*> readCachedIndexColByIdxColTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamIndexColObj* updateIndexCol( cfbam::ICFBamIndexColEditObj* Obj ) = 0;

		virtual void deleteIndexCol( cfbam::ICFBamIndexColEditObj* Obj ) = 0;
		...
		virtual void deleteIndexColByIdxColTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamIndexColObj* moveUpIndexCol( cfbam::ICFBamIndexColObj* Obj ) = 0;

		virtual cfbam::ICFBamIndexColObj* moveDownIndexCol( cfbam::ICFBamIndexColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesIndexCol( cfbam::ICFBamIndexColObj* Obj ) = 0;
