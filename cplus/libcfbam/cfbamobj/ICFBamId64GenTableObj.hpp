...
namespace cfbam {
	...
	{
	public:
		ICFBamId64GenTableObj();
		virtual ~ICFBamId64GenTableObj();
		...
		virtual cfbam::ICFBamId64GenObj* newInstance() = 0;

		virtual cfbam::ICFBamId64GenEditObj* newEditInstance( cfbam::ICFBamId64GenObj* orig ) = 0;

		virtual cfbam::ICFBamId64GenObj* realizeId64Gen( cfbam::ICFBamId64GenObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeId64Gen( cfbam::ICFBamId64GenObj* Obj ) = 0;
		...
		virtual void deepDisposeByDispIdx( const int64_t* DispenserTenantId,
			const int64_t* DispenserId ) = 0;
		virtual cfbam::ICFBamId64GenObj* createId64Gen( cfbam::ICFBamId64GenEditObj* Obj ) = 0;

		virtual cfbam::ICFBamId64GenObj* readId64Gen( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamId64GenObj* lockId64Gen( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamId64GenObj*> readAllId64Gen( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamId64GenObj* readCachedId64Gen( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamId64GenObj*> readCachedId64GenByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamId64GenObj* updateId64Gen( cfbam::ICFBamId64GenEditObj* Obj ) = 0;

		virtual void deleteId64Gen( cfbam::ICFBamId64GenEditObj* Obj ) = 0;
		...
		virtual void deleteId64GenByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamId64GenObj* moveUpId64Gen( cfbam::ICFBamId64GenObj* Obj ) = 0;

		virtual cfbam::ICFBamId64GenObj* moveDownId64Gen( cfbam::ICFBamId64GenObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesId64Gen( cfbam::ICFBamId64GenObj* Obj ) = 0;
