...
// Description: C++18 base object instance specification for CFBam UInt16Def.
...
namespace cfbam {
	...
	class CFBamUInt16DefObj
	: public CFBamAtomObj,
	  public virtual ICFBamUInt16DefObj
	{
	protected:
	public:
		...
		CFBamUInt16DefObj();
		CFBamUInt16DefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamUInt16DefObj();
