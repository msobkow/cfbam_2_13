...
// Description: C++18 Instance Edit Object interface for CFBam TZTimestampType.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamTZTimestampDefEditObj,
	  public virtual cfbam::ICFBamTZTimestampTypeObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamTZTimestampTypeEditObj();
		virtual ~ICFBamTZTimestampTypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamTZTimestampTypeBuff* getTZTimestampTypeBuff() {
			return( static_cast<cfbam::CFBamTZTimestampTypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamTZTimestampTypeBuff* getTZTimestampTypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamTZTimestampTypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamTZTimestampTypeObj* getOrigAsTZTimestampType() = 0;
