...
// Description: C++18 base object instance specification for CFBam Index.
...
namespace cfbam {
	...
	public:
		...
		CFBamIndexObj();
		CFBamIndexObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamIndexObj();
