...
// Description: C++18 Instance Edit Object interface for CFBam BoolCol.
...
namespace cfbam {
	...
	class ICFBamBoolColEditObj
	: public virtual cfbam::ICFBamBoolDefEditObj,
	  public virtual cfbam::ICFBamBoolColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamBoolColEditObj();
		virtual ~ICFBamBoolColEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamBoolColBuff* getBoolColBuff() {
			return( static_cast<cfbam::CFBamBoolColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamBoolColBuff* getBoolColEditBuff() {
			return( dynamic_cast<cfbam::CFBamBoolColBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamBoolColObj* getOrigAsBoolCol() = 0;
