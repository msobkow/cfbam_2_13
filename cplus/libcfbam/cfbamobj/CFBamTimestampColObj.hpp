...
// Description: C++18 base object instance specification for CFBam TimestampCol.
...
namespace cfbam {
	...
	class CFBamTimestampColObj
	: public CFBamTimestampDefObj,
	  public virtual ICFBamTimestampColObj
	{
	protected:
	public:
		...
		CFBamTimestampColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTimestampColObj();
