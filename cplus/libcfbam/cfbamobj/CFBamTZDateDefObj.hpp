...
// Description: C++18 base object instance specification for CFBam TZDateDef.
...
namespace cfbam {
	...
	class CFBamTZDateDefObj
	: public CFBamAtomObj,
	  public virtual ICFBamTZDateDefObj
	{
	protected:
	public:
		...
		CFBamTZDateDefObj();
		CFBamTZDateDefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTZDateDefObj();
