...
namespace cfbam {
	...
	class CFBamDelSubDep1TableObj
	: public virtual ICFBamDelSubDep1TableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamDelSubDep1Obj*>* members;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamDelSubDep1Obj*>* allDelSubDep1;
		std::map< cfbam::CFBamScopeByTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamDelSubDep1Obj*>*>* indexByTenantIdx;
		std::map< cfbam::CFBamDelDepByDefSchemaIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamDelSubDep1Obj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamDelDepByDelDepIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamDelSubDep1Obj*>*>* indexByDelDepIdx;
		std::map< cfbam::CFBamDelSubDep1ByDelTopDepIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamDelSubDep1Obj*>*>* indexByDelTopDepIdx;
		std::map< cfbam::CFBamDelSubDep1ByUNameIdxKey,
			cfbam::ICFBamDelSubDep1Obj*>* indexByUNameIdx;
	...
	public:
		...
		CFBamDelSubDep1TableObj();
		CFBamDelSubDep1TableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamDelSubDep1TableObj();
		...
		virtual cfbam::ICFBamDelSubDep1Obj* newInstance();

		virtual cfbam::ICFBamDelSubDep1EditObj* newEditInstance( cfbam::ICFBamDelSubDep1Obj* orig );

		virtual cfbam::ICFBamDelSubDep1Obj* realizeDelSubDep1( cfbam::ICFBamDelSubDep1Obj* Obj );

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id );
		virtual void deepDisposeByTenantIdx( const int64_t TenantId );
		virtual void reallyDeepDisposeDelSubDep1( cfbam::ICFBamDelSubDep1Obj* Obj );
		...
		virtual void deepDisposeByDelTopDepIdx( const int64_t DelTopDepTenantId,
			const int64_t DelTopDepId );
		virtual void deepDisposeByUNameIdx( const int64_t DelTopDepTenantId,
			const int64_t DelTopDepId,
			const std::string& Name );
		virtual cfbam::ICFBamDelSubDep1Obj* createDelSubDep1( cfbam::ICFBamDelSubDep1EditObj* Obj );

		virtual cfbam::ICFBamDelSubDep1Obj* readDelSubDep1( cfbam::CFBamScopePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamDelSubDep1Obj* lockDelSubDep1( cfbam::CFBamScopePKey* pkey );

		virtual std::vector<cfbam::ICFBamDelSubDep1Obj*> readAllDelSubDep1( bool forceRead = false );

		virtual cfbam::ICFBamDelSubDep1Obj* readDelSubDep1ByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDelSubDep1Obj*> readDelSubDep1ByTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDelSubDep1Obj*> readDelSubDep1ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDelSubDep1Obj*> readDelSubDep1ByDelDepIdx( const int64_t RelationTenantId,
			const int64_t RelationId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDelSubDep1Obj*> readDelSubDep1ByDelTopDepIdx( const int64_t DelTopDepTenantId,
			const int64_t DelTopDepId,
			bool forceRead = false );

		virtual cfbam::ICFBamDelSubDep1Obj* readDelSubDep1ByUNameIdx( const int64_t DelTopDepTenantId,
			const int64_t DelTopDepId,
			const std::string& Name, bool forceRead = false );

		virtual cfbam::ICFBamDelSubDep1Obj* readCachedDelSubDep1( cfbam::CFBamScopePKey* pkey );

		virtual cfbam::ICFBamDelSubDep1Obj* readCachedDelSubDep1ByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual std::vector<cfbam::ICFBamDelSubDep1Obj*> readCachedDelSubDep1ByTenantIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamDelSubDep1Obj*> readCachedDelSubDep1ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamDelSubDep1Obj*> readCachedDelSubDep1ByDelDepIdx( const int64_t RelationTenantId,
			const int64_t RelationId );

		virtual std::vector<cfbam::ICFBamDelSubDep1Obj*> readCachedDelSubDep1ByDelTopDepIdx( const int64_t DelTopDepTenantId,
			const int64_t DelTopDepId );

		virtual cfbam::ICFBamDelSubDep1Obj* readCachedDelSubDep1ByUNameIdx( const int64_t DelTopDepTenantId,
			const int64_t DelTopDepId,
			const std::string& Name );

		virtual cfbam::ICFBamDelSubDep1Obj* updateDelSubDep1( cfbam::ICFBamDelSubDep1EditObj* Obj );

		virtual void deleteDelSubDep1( cfbam::ICFBamDelSubDep1EditObj* Obj );

		virtual void deleteDelSubDep1ByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteDelSubDep1ByTenantIdx( const int64_t TenantId );

		virtual void deleteDelSubDep1ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteDelSubDep1ByDelDepIdx( const int64_t RelationTenantId,
			const int64_t RelationId );

		virtual void deleteDelSubDep1ByDelTopDepIdx( const int64_t DelTopDepTenantId,
			const int64_t DelTopDepId );

		virtual void deleteDelSubDep1ByUNameIdx( const int64_t DelTopDepTenantId,
			const int64_t DelTopDepId,
			const std::string& Name );

		virtual void reallyDetachFromIndexesDelSubDep1( cfbam::ICFBamDelSubDep1Obj* Obj );
