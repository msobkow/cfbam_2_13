...
// Description: C++18 base object instance specification for CFBam SecGrpMemb.
...
namespace cfbam {
	...
	class CFBamSecGrpMembObj
	: public virtual ICFBamSecGrpMembObj,
	...
	public:
		...
		CFBamSecGrpMembObj();
		CFBamSecGrpMembObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamSecGrpMembObj();
