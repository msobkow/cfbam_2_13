...
// Description: C++18 base object instance specification for CFBam DoubleType.
...
namespace cfbam {
	...
	class CFBamDoubleTypeObj
	: public CFBamDoubleDefObj,
	  public virtual ICFBamDoubleTypeObj
	{
	protected:
	public:
		...
		CFBamDoubleTypeObj();
		CFBamDoubleTypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamDoubleTypeObj();
