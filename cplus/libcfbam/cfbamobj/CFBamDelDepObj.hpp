...
// Description: C++18 base object instance specification for CFBam DelDep.
...
namespace cfbam {
	...
	class CFBamDelDepObj
	: public CFBamScopeObj,
	  public virtual ICFBamDelDepObj
	{
	protected:
	public:
		...
		CFBamDelDepObj();
		CFBamDelDepObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamDelDepObj();
