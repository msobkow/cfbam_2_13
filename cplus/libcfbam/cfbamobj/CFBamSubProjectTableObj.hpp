...
namespace cfbam {
	...
	class CFBamSubProjectTableObj
	: public virtual ICFBamSubProjectTableObj,
	  public virtual cfint::ICFIntSubProjectTableObj
	{
	protected:
	...
	public:
		...
		CFBamSubProjectTableObj();
		CFBamSubProjectTableObj( cfint::ICFIntSchemaObj* argSchema );
		virtual ~CFBamSubProjectTableObj();
