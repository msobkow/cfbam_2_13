...
// Description: C++18 Instance Edit Object interface for CFBam RelationCol.
...
namespace cfbam {
	...
	class ICFBamRelationColEditObj
	: public virtual cfbam::ICFBamRelationColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamRelationColEditObj();
		virtual ~ICFBamRelationColEditObj();
		...
		virtual cfbam::ICFBamRelationColObj* getOrig() = 0;

		virtual cfbam::ICFBamRelationColObj* getOrigAsRelationCol() = 0;
		...
		virtual cfbam::ICFBamRelationColObj* create() = 0;

		virtual cfbam::ICFBamRelationColEditObj* update() = 0;

		virtual cfbam::ICFBamRelationColEditObj* deleteInstance() = 0;
		...
		virtual void setRequiredContainerRelation( cfbam::ICFBamRelationObj* value ) = 0;
		...
		virtual void setOptionalLookupPrev( cfbam::ICFBamRelationColObj* value ) = 0;

		virtual cfbam::ICFBamRelationColObj* getOptionalLookupNext( bool forceRead = false ) = 0;
		virtual void setOptionalLookupNext( cfbam::ICFBamRelationColObj* value ) = 0;

		virtual cfbam::ICFBamIndexColObj* getRequiredLookupFromCol( bool forceRead = false ) = 0;
		virtual void setRequiredLookupFromCol( cfbam::ICFBamIndexColObj* value ) = 0;

		virtual cfbam::ICFBamIndexColObj* getRequiredLookupToCol( bool forceRead = false ) = 0;
		virtual void setRequiredLookupToCol( cfbam::ICFBamIndexColObj* value ) = 0;
