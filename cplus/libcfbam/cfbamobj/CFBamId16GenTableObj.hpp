...
namespace cfbam {
	...
	class CFBamId16GenTableObj
	: public virtual ICFBamId16GenTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId16GenObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId16GenObj*>* allId16Gen;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamId16GenObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId16GenObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId16GenObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId16GenObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId16GenObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId16GenObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId16GenObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId16GenObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamInt16TypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId16GenObj*>*>* indexBySchemaIdx;
		std::map< cfbam::CFBamId16GenByDispIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId16GenObj*>*>* indexByDispIdx;
	...
	public:
		...
		CFBamId16GenTableObj();
		CFBamId16GenTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamId16GenTableObj();
		...
		virtual cfbam::ICFBamId16GenObj* newInstance();

		virtual cfbam::ICFBamId16GenEditObj* newEditInstance( cfbam::ICFBamId16GenObj* orig );

		virtual cfbam::ICFBamId16GenObj* realizeId16Gen( cfbam::ICFBamId16GenObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeId16Gen( cfbam::ICFBamId16GenObj* Obj );
		...
		virtual cfbam::ICFBamId16GenObj* createId16Gen( cfbam::ICFBamId16GenEditObj* Obj );

		virtual cfbam::ICFBamId16GenObj* readId16Gen( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamId16GenObj* lockId16Gen( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamId16GenObj*> readAllId16Gen( bool forceRead = false );

		virtual cfbam::ICFBamId16GenObj* readId16GenByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamId16GenObj* readId16GenByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId16GenObj*> readId16GenByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId16GenObj*> readId16GenByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId16GenObj*> readId16GenByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId16GenObj*> readId16GenByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId16GenObj*> readId16GenByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId16GenObj*> readId16GenByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId16GenObj*> readId16GenByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId16GenObj*> readId16GenBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId16GenObj*> readId16GenByDispIdx( const int64_t* DispenserTenantId,
			const int64_t* DispenserId,
			bool forceRead = false );

		virtual cfbam::ICFBamId16GenObj* readCachedId16Gen( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamId16GenObj* readCachedId16GenByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamId16GenObj* readCachedId16GenByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamId16GenObj*> readCachedId16GenByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamId16GenObj*> readCachedId16GenByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamId16GenObj*> readCachedId16GenByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamId16GenObj*> readCachedId16GenByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamId16GenObj*> readCachedId16GenByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamId16GenObj*> readCachedId16GenByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamId16GenObj*> readCachedId16GenByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamId16GenObj*> readCachedId16GenBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual std::vector<cfbam::ICFBamId16GenObj*> readCachedId16GenByDispIdx( const int64_t* DispenserTenantId,
			const int64_t* DispenserId );

		virtual cfbam::ICFBamId16GenObj* updateId16Gen( cfbam::ICFBamId16GenEditObj* Obj );

		virtual void deleteId16Gen( cfbam::ICFBamId16GenEditObj* Obj );

		virtual void deleteId16GenByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteId16GenByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteId16GenByValTentIdx( const int64_t TenantId );

		virtual void deleteId16GenByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteId16GenByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteId16GenByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteId16GenByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteId16GenByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteId16GenByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteId16GenBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual void deleteId16GenByDispIdx( const int64_t* DispenserTenantId,
			const int64_t* DispenserId );

		virtual cfbam::ICFBamId16GenObj* moveUpId16Gen( cfbam::ICFBamId16GenObj* Obj );

		virtual cfbam::ICFBamId16GenObj* moveDownId16Gen( cfbam::ICFBamId16GenObj* Obj );

		virtual void reallyDetachFromIndexesId16Gen( cfbam::ICFBamId16GenObj* Obj );
