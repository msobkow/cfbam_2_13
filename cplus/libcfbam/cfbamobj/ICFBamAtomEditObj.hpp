...
// Description: C++18 Instance Edit Object interface for CFBam Atom.
...
namespace cfbam {
	...
	public:
		...
		ICFBamAtomEditObj();
		virtual ~ICFBamAtomEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamAtomBuff* getAtomBuff() {
			return( static_cast<cfbam::CFBamAtomBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamAtomBuff* getAtomEditBuff() {
			return( dynamic_cast<cfbam::CFBamAtomBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamAtomObj* getOrigAsAtom() = 0;
