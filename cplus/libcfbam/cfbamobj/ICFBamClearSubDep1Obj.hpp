...
// Description: C++18 Object interface for CFBam ClearSubDep1.
...
namespace cfbam {
	...
	public:
		...
		virtual ~ICFBamClearSubDep1Obj();
		virtual cfbam::ICFBamScopeEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamClearSubDep1EditObj* getClearSubDep1Edit() = 0;

		inline cfbam::CFBamClearSubDep1Buff* getClearSubDep1Buff() {
			return( static_cast<cfbam::CFBamClearSubDep1Buff*>( getBuff() ) );
		};

		inline cfbam::CFBamClearSubDep1Buff* getClearSubDep1EditBuff() {
			return( dynamic_cast<cfbam::CFBamClearSubDep1Buff*>( getBuff() ) );
		};

		virtual const int64_t getRequiredClearTopDepTenantId() = 0;
		virtual const int64_t* getRequiredClearTopDepTenantIdReference() = 0;

		virtual const int64_t getRequiredClearTopDepId() = 0;
		virtual const int64_t* getRequiredClearTopDepIdReference() = 0;

		virtual const std::string& getRequiredName() = 0;
		virtual const std::string* getRequiredNameReference() = 0;

		virtual cfbam::ICFBamClearTopDepObj* getRequiredContainerClearTopDep( bool forceRead = false ) = 0;

		virtual std::vector<cfbam::ICFBamClearSubDep2Obj*> getOptionalComponentsClearDep( bool forceRead = false ) = 0;
