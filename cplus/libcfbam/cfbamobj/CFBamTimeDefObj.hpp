...
// Description: C++18 base object instance specification for CFBam TimeDef.
...
namespace cfbam {
	...
	class CFBamTimeDefObj
	: public CFBamAtomObj,
	  public virtual ICFBamTimeDefObj
	{
	protected:
	public:
		...
		CFBamTimeDefObj();
		CFBamTimeDefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTimeDefObj();
