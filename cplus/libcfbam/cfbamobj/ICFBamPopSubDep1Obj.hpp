...
// Description: C++18 Object interface for CFBam PopSubDep1.
...
namespace cfbam {
	...
	public:
		ICFBamPopSubDep1Obj();
		virtual ~ICFBamPopSubDep1Obj();
		virtual cfbam::ICFBamScopeEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamPopSubDep1EditObj* getPopSubDep1Edit() = 0;

		inline cfbam::CFBamPopSubDep1Buff* getPopSubDep1Buff() {
			return( static_cast<cfbam::CFBamPopSubDep1Buff*>( getBuff() ) );
		};

		inline cfbam::CFBamPopSubDep1Buff* getPopSubDep1EditBuff() {
			return( dynamic_cast<cfbam::CFBamPopSubDep1Buff*>( getBuff() ) );
		};

		virtual const int64_t getRequiredPopTopDepTenantId() = 0;
		virtual const int64_t* getRequiredPopTopDepTenantIdReference() = 0;

		virtual const int64_t getRequiredPopTopDepId() = 0;
		virtual const int64_t* getRequiredPopTopDepIdReference() = 0;

		virtual const std::string& getRequiredName() = 0;
		virtual const std::string* getRequiredNameReference() = 0;

		virtual cfbam::ICFBamPopTopDepObj* getRequiredContainerContPopTopDep( bool forceRead = false ) = 0;

		virtual std::vector<cfbam::ICFBamPopSubDep2Obj*> getOptionalComponentsPopDep( bool forceRead = false ) = 0;
