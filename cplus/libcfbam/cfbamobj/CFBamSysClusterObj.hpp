...
// Description: C++18 base object instance specification for CFBam SysCluster.
...
namespace cfbam {
	...
	class CFBamSysClusterObj
	: public virtual ICFBamSysClusterObj,
	...
	public:
		...
		CFBamSysClusterObj();
		CFBamSysClusterObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamSysClusterObj();
