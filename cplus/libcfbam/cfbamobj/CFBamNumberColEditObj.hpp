...
// Description: C++18 edit object instance specification for CFBam NumberCol.
...
namespace cfbam {
	...
	class CFBamNumberColEditObj
	: public CFBamNumberDefEditObj,
	  public virtual ICFBamNumberColEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamNumberColEditObj( cfbam::ICFBamNumberColObj* argOrig );
		virtual ~CFBamNumberColEditObj();
		...
		virtual cfbam::ICFBamNumberColTableObj* getNumberColTable();

		virtual cfbam::ICFBamNumberColEditObj* getNumberColEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamNumberColObj* getOrigAsNumberCol();
		...
		inline cfbam::CFBamNumberColBuff* getNumberColBuff() {
			...
			return( static_cast<cfbam::CFBamNumberColBuff*>( buff ) );
		};
