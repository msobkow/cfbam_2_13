...
// Description: C++18 Object interface for CFBam Index.
...
namespace cfbam {
	...
	public:
		ICFBamIndexObj();
		virtual ~ICFBamIndexObj();
		virtual cfbam::ICFBamScopeEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamIndexEditObj* getIndexEdit() = 0;
		...
		virtual std::vector<cfbam::ICFBamIndexColObj*> getOptionalComponentsColumns( bool forceRead = false ) = 0;
