...
namespace cfbam {
	...
	class CFBamInt32TypeTableObj
	: public virtual ICFBamInt32TypeTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32TypeObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32TypeObj*>* allInt32Type;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamInt32TypeObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32TypeObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32TypeObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32TypeObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32TypeObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32TypeObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32TypeObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32TypeObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamInt32TypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32TypeObj*>*>* indexBySchemaIdx;
	...
	public:
		...
		CFBamInt32TypeTableObj();
		CFBamInt32TypeTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamInt32TypeTableObj();
		...
		virtual cfbam::ICFBamInt32TypeObj* newInstance();

		virtual cfbam::ICFBamInt32TypeEditObj* newEditInstance( cfbam::ICFBamInt32TypeObj* orig );

		virtual cfbam::ICFBamInt32TypeObj* realizeInt32Type( cfbam::ICFBamInt32TypeObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeInt32Type( cfbam::ICFBamInt32TypeObj* Obj );
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );
		virtual cfbam::ICFBamInt32TypeObj* createInt32Type( cfbam::ICFBamInt32TypeEditObj* Obj );

		virtual cfbam::ICFBamInt32TypeObj* readInt32Type( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamInt32TypeObj* lockInt32Type( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamInt32TypeObj*> readAllInt32Type( bool forceRead = false );

		virtual cfbam::ICFBamInt32TypeObj* readInt32TypeByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamInt32TypeObj* readInt32TypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt32TypeObj*> readInt32TypeByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt32TypeObj*> readInt32TypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt32TypeObj*> readInt32TypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt32TypeObj*> readInt32TypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt32TypeObj*> readInt32TypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt32TypeObj*> readInt32TypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt32TypeObj*> readInt32TypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt32TypeObj*> readInt32TypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId,
			bool forceRead = false );

		virtual cfbam::ICFBamInt32TypeObj* readCachedInt32Type( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamInt32TypeObj* readCachedInt32TypeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamInt32TypeObj* readCachedInt32TypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamInt32TypeObj*> readCachedInt32TypeByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamInt32TypeObj*> readCachedInt32TypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamInt32TypeObj*> readCachedInt32TypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamInt32TypeObj*> readCachedInt32TypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamInt32TypeObj*> readCachedInt32TypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamInt32TypeObj*> readCachedInt32TypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamInt32TypeObj*> readCachedInt32TypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamInt32TypeObj*> readCachedInt32TypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual cfbam::ICFBamInt32TypeObj* updateInt32Type( cfbam::ICFBamInt32TypeEditObj* Obj );

		virtual void deleteInt32Type( cfbam::ICFBamInt32TypeEditObj* Obj );

		virtual void deleteInt32TypeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteInt32TypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteInt32TypeByValTentIdx( const int64_t TenantId );

		virtual void deleteInt32TypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteInt32TypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteInt32TypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteInt32TypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteInt32TypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteInt32TypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteInt32TypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual cfbam::ICFBamInt32TypeObj* moveUpInt32Type( cfbam::ICFBamInt32TypeObj* Obj );

		virtual cfbam::ICFBamInt32TypeObj* moveDownInt32Type( cfbam::ICFBamInt32TypeObj* Obj );

		virtual void reallyDetachFromIndexesInt32Type( cfbam::ICFBamInt32TypeObj* Obj );
