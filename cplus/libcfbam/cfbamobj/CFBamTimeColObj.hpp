...
// Description: C++18 base object instance specification for CFBam TimeCol.
...
namespace cfbam {
	...
	class CFBamTimeColObj
	: public CFBamTimeDefObj,
	  public virtual ICFBamTimeColObj
	{
	protected:
	public:
		...
		CFBamTimeColObj();
		CFBamTimeColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTimeColObj();
