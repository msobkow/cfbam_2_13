...
// Description: C++18 Instance Edit Object interface for CFBam TimestampCol.
...
namespace cfbam {
	...
	class ICFBamTimestampColEditObj
	: public virtual cfbam::ICFBamTimestampDefEditObj,
	  public virtual cfbam::ICFBamTimestampColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamTimestampColEditObj();
		virtual ~ICFBamTimestampColEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamTimestampColBuff* getTimestampColBuff() {
			return( static_cast<cfbam::CFBamTimestampColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamTimestampColBuff* getTimestampColEditBuff() {
			return( dynamic_cast<cfbam::CFBamTimestampColBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamTimestampColObj* getOrigAsTimestampCol() = 0;
