...
// Description: C++18 edit object instance specification for CFBam MimeType.
...
namespace cfbam {
	...
	class CFBamMimeTypeEditObj
	: public virtual ICFBamMimeTypeEditObj,
	  public virtual cfint::ICFIntMimeTypeEditObj
	{
	public:
	...
	public:
		CFBamMimeTypeEditObj( cfint::ICFIntMimeTypeObj* argOrig );
		virtual ~CFBamMimeTypeEditObj();
