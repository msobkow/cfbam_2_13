...
namespace cfbam {
	...
	{
	public:
		ICFBamClearTopDepTableObj();
		virtual ~ICFBamClearTopDepTableObj();
		...
		virtual cfbam::ICFBamClearTopDepObj* newInstance() = 0;

		virtual cfbam::ICFBamClearTopDepEditObj* newEditInstance( cfbam::ICFBamClearTopDepObj* orig ) = 0;

		virtual cfbam::ICFBamClearTopDepObj* realizeClearTopDep( cfbam::ICFBamClearTopDepObj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByTenantIdx( const int64_t TenantId ) = 0;
		virtual void reallyDeepDisposeClearTopDep( cfbam::ICFBamClearTopDepObj* Obj ) = 0;
		...
		virtual cfbam::ICFBamClearTopDepObj* createClearTopDep( cfbam::ICFBamClearTopDepEditObj* Obj ) = 0;

		virtual cfbam::ICFBamClearTopDepObj* readClearTopDep( cfbam::CFBamScopePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamClearTopDepObj* lockClearTopDep( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamClearTopDepObj*> readAllClearTopDep( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamClearTopDepObj* readCachedClearTopDep( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual cfbam::ICFBamClearTopDepObj* readCachedClearTopDepByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamClearTopDepObj*> readCachedClearTopDepByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamClearTopDepObj* updateClearTopDep( cfbam::ICFBamClearTopDepEditObj* Obj ) = 0;

		virtual void deleteClearTopDep( cfbam::ICFBamClearTopDepEditObj* Obj ) = 0;

		virtual void deleteClearTopDepByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deleteClearTopDepByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamClearTopDepObj* moveUpClearTopDep( cfbam::ICFBamClearTopDepObj* Obj ) = 0;

		virtual cfbam::ICFBamClearTopDepObj* moveDownClearTopDep( cfbam::ICFBamClearTopDepObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesClearTopDep( cfbam::ICFBamClearTopDepObj* Obj ) = 0;
