...
// Description: C++18 Instance Edit Object interface for CFBam DoubleDef.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamAtomEditObj,
	  public virtual cfbam::ICFBamDoubleDefObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamDoubleDefEditObj();
		virtual ~ICFBamDoubleDefEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamDoubleDefBuff* getDoubleDefBuff() {
			return( static_cast<cfbam::CFBamDoubleDefBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamDoubleDefBuff* getDoubleDefEditBuff() {
			return( dynamic_cast<cfbam::CFBamDoubleDefBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamDoubleDefObj* getOrigAsDoubleDef() = 0;

		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual bool isOptionalInitValueNull() = 0;
		virtual const double getOptionalInitValueValue() = 0;
		virtual const double* getOptionalInitValueReference() = 0;
		virtual void setOptionalInitValueNull() = 0;
		virtual void setOptionalInitValueValue( const double value ) = 0;

		virtual bool isOptionalMinValueNull() = 0;
		virtual const double getOptionalMinValueValue() = 0;
		virtual const double* getOptionalMinValueReference() = 0;
		virtual void setOptionalMinValueNull() = 0;
		virtual void setOptionalMinValueValue( const double value ) = 0;

		virtual bool isOptionalMaxValueNull() = 0;
		virtual const double getOptionalMaxValueValue() = 0;
		virtual const double* getOptionalMaxValueReference() = 0;
		virtual void setOptionalMaxValueNull() = 0;
		virtual void setOptionalMaxValueValue( const double value ) = 0;
