...
namespace cfbam {
	...
	{
	public:
		ICFBamServerProcTableObj();
		virtual ~ICFBamServerProcTableObj();
		...
		virtual cfbam::ICFBamServerProcObj* newInstance() = 0;

		virtual cfbam::ICFBamServerProcEditObj* newEditInstance( cfbam::ICFBamServerProcObj* orig ) = 0;

		virtual cfbam::ICFBamServerProcObj* realizeServerProc( cfbam::ICFBamServerProcObj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByTenantIdx( const int64_t TenantId ) = 0;
		virtual void reallyDeepDisposeServerProc( cfbam::ICFBamServerProcObj* Obj ) = 0;
		...
		virtual cfbam::ICFBamServerProcObj* createServerProc( cfbam::ICFBamServerProcEditObj* Obj ) = 0;

		virtual cfbam::ICFBamServerProcObj* readServerProc( cfbam::CFBamScopePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamServerProcObj* lockServerProc( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamServerProcObj*> readAllServerProc( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamServerProcObj* readCachedServerProc( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual cfbam::ICFBamServerProcObj* readCachedServerProcByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamServerProcObj*> readCachedServerProcByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamServerProcObj* updateServerProc( cfbam::ICFBamServerProcEditObj* Obj ) = 0;

		virtual void deleteServerProc( cfbam::ICFBamServerProcEditObj* Obj ) = 0;

		virtual void deleteServerProcByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deleteServerProcByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesServerProc( cfbam::ICFBamServerProcObj* Obj ) = 0;
