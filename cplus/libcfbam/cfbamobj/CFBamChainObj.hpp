...
// Description: C++18 base object instance specification for CFBam Chain.
...
namespace cfbam {
	...
	class CFBamChainObj
	: public virtual ICFBamChainObj
	{
	protected:
		cfsec::ICFSecSecUserObj* createdBy = NULL;
		cfsec::ICFSecSecUserObj* updatedBy = NULL;
		bool isNew;
		cfbam::ICFBamChainEditObj* edit;
	...
	public:
		...
		CFBamChainObj();
		CFBamChainObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamChainObj();
		...
		virtual cfbam::ICFBamChainObj* realize();
		...
		virtual cfbam::ICFBamChainEditObj* beginEdit();
