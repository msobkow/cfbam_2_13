...
// Description: C++18 edit object instance specification for CFBam ISOCtry.
...
namespace cfbam {
	...
	class CFBamISOCtryEditObj
	: public virtual ICFBamISOCtryEditObj,
	  public virtual cfsec::ICFSecISOCtryEditObj,
	  public virtual cfint::ICFIntISOCtryEditObj
	{
	public:
	...
	public:
		CFBamISOCtryEditObj( cfsec::ICFSecISOCtryObj* argOrig );
		virtual ~CFBamISOCtryEditObj();
