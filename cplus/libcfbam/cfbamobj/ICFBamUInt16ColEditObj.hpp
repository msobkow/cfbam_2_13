...
// Description: C++18 Instance Edit Object interface for CFBam UInt16Col.
...
namespace cfbam {
	...
	class ICFBamUInt16ColEditObj
	: public virtual cfbam::ICFBamUInt16DefEditObj,
	  public virtual cfbam::ICFBamUInt16ColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamUInt16ColEditObj();
		virtual ~ICFBamUInt16ColEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamUInt16ColBuff* getUInt16ColBuff() {
			return( static_cast<cfbam::CFBamUInt16ColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamUInt16ColBuff* getUInt16ColEditBuff() {
			return( dynamic_cast<cfbam::CFBamUInt16ColBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamUInt16ColObj* getOrigAsUInt16Col() = 0;
