...
// Description: C++18 Object interface for CFBam TableCol.
...
namespace cfbam {
	...
	public:
		ICFBamTableColObj();
		virtual ~ICFBamTableColObj();
		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamTableColEditObj* getTableColEdit() = 0;

		inline cfbam::CFBamTableColBuff* getTableColBuff() {
			return( static_cast<cfbam::CFBamTableColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamTableColBuff* getTableColEditBuff() {
			return( dynamic_cast<cfbam::CFBamTableColBuff*>( getBuff() ) );
		};
		...
		virtual bool isOptionalDataTenantIdNull() = 0;
		virtual const int64_t getOptionalDataTenantIdValue() = 0;
		virtual const int64_t* getOptionalDataTenantIdReference() = 0;

		virtual bool isOptionalDataIdNull() = 0;
		virtual const int64_t getOptionalDataIdValue() = 0;
		virtual const int64_t* getOptionalDataIdReference() = 0;
		...
		virtual cfbam::ICFBamValueObj* getRequiredParentDataType( bool forceRead = false ) = 0;
