...
namespace cfbam {
	...
	public:
		...
		virtual cfbam::ICFBamChainObj* newInstance() = 0;

		virtual cfbam::ICFBamChainEditObj* newEditInstance( cfbam::ICFBamChainObj* orig ) = 0;

		virtual cfbam::ICFBamChainObj* realizeChain( cfbam::ICFBamChainObj* Obj ) = 0;
		...
		virtual void reallyDeepDisposeChain( cfbam::ICFBamChainObj* Obj ) = 0;
		virtual cfbam::ICFBamChainObj* createChain( cfbam::ICFBamChainEditObj* Obj ) = 0;

		virtual cfbam::ICFBamChainObj* readChain( cfbam::CFBamChainPKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamChainObj* lockChain( cfbam::CFBamChainPKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamChainObj*> readAllChain( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamChainObj* readCachedChain( cfbam::CFBamChainPKey* pkey ) = 0;

		virtual cfbam::ICFBamChainObj* readCachedChainByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamChainObj*> readCachedChainByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamChainObj* updateChain( cfbam::ICFBamChainEditObj* Obj ) = 0;

		virtual void deleteChain( cfbam::ICFBamChainEditObj* Obj ) = 0;

		virtual void deleteChainByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deleteChainByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesChain( cfbam::ICFBamChainObj* Obj ) = 0;
