...
namespace cfbam {
	...
	class CFBamTSecGrpMembTableObj
	: public virtual ICFBamTSecGrpMembTableObj,
	  public virtual cfsec::ICFSecTSecGrpMembTableObj,
	  public virtual cfint::ICFIntTSecGrpMembTableObj
	{
	protected:
	...
	public:
		...
		CFBamTSecGrpMembTableObj();
		CFBamTSecGrpMembTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamTSecGrpMembTableObj();
