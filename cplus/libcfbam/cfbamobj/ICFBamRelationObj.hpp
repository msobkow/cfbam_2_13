...
// Description: C++18 Object interface for CFBam Relation.
...
namespace cfbam {
	...
	public:
		ICFBamRelationObj();
		virtual ~ICFBamRelationObj();
		virtual cfbam::ICFBamScopeEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamRelationEditObj* getRelationEdit() = 0;

		inline cfbam::CFBamRelationBuff* getRelationBuff() {
			return( static_cast<cfbam::CFBamRelationBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamRelationBuff* getRelationEditBuff() {
			return( dynamic_cast<cfbam::CFBamRelationBuff*>( getBuff() ) );
		};

		virtual const int64_t getRequiredTableId() = 0;
		virtual const int64_t* getRequiredTableIdReference() = 0;
		...
		virtual const cfbam::ICFBamSchema::RelationTypeEnum getRequiredRelationType() = 0;
		virtual const cfbam::ICFBamSchema::RelationTypeEnum* getRequiredRelationTypeReference() = 0;
		...
		virtual bool isOptionalSuffixNull() = 0;
		virtual const std::string& getOptionalSuffixValue() = 0;
		virtual const std::string* getOptionalSuffixReference() = 0;

		virtual const int64_t getRequiredFromIndexId() = 0;
		virtual const int64_t* getRequiredFromIndexIdReference() = 0;

		virtual const int64_t getRequiredToTableId() = 0;
		virtual const int64_t* getRequiredToTableIdReference() = 0;

		virtual const int64_t getRequiredToIndexId() = 0;
		virtual const int64_t* getRequiredToIndexIdReference() = 0;

		virtual const bool getRequiredIsRequired() = 0;
		virtual const bool* getRequiredIsRequiredReference() = 0;

		virtual const bool getRequiredIsXsdContainer() = 0;
		virtual const bool* getRequiredIsXsdContainerReference() = 0;

		virtual const bool getRequiredIsLateResolver() = 0;
		virtual const bool* getRequiredIsLateResolverReference() = 0;

		virtual const bool getRequiredAllowAddendum() = 0;
		virtual const bool* getRequiredAllowAddendumReference() = 0;

		virtual bool isOptionalNarrowedTenantIdNull() = 0;
		virtual const int64_t getOptionalNarrowedTenantIdValue() = 0;
		virtual const int64_t* getOptionalNarrowedTenantIdReference() = 0;

		virtual bool isOptionalNarrowedIdNull() = 0;
		virtual const int64_t getOptionalNarrowedIdValue() = 0;
		virtual const int64_t* getOptionalNarrowedIdReference() = 0;

		virtual cfbam::ICFBamSchemaDefObj* getOptionalLookupDefSchema( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTableObj* getRequiredContainerFromTable( bool forceRead = false ) = 0;

		virtual std::vector<cfbam::ICFBamRelationColObj*> getOptionalComponentsColumns( bool forceRead = false ) = 0;

		virtual std::vector<cfbam::ICFBamPopTopDepObj*> getOptionalComponentsPopDep( bool forceRead = false ) = 0;

		virtual cfsec::ICFSecTenantObj* getRequiredOwnerRelTenant( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamIndexObj* getRequiredLookupFromIndex( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTableObj* getRequiredLookupToTable( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamIndexObj* getRequiredLookupToIndex( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamRelationObj* getOptionalLookupNarrowed( bool forceRead = false ) = 0;

		protected:
			virtual std::string getVersionStringForVersion( cflib::ICFLibAnyObj* value ) = 0;
		public:
			virtual cfbam::ICFBamSubProjectObj* getProject() = 0;
			virtual cfbam::ICFBamTopDomainObj* getCompany() = 0;
			virtual cfbam::ICFBamSchemaDefObj* getSchemaDef() = 0;
			virtual cfbam::ICFBamMinorVersionObj* getVersion() = 0;
