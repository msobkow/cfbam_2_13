...
// Description: C++18 base object instance specification for CFBam TZTimestampCol.
...
namespace cfbam {
	...
	class CFBamTZTimestampColObj
	: public CFBamTZTimestampDefObj,
	  public virtual ICFBamTZTimestampColObj
	{
	protected:
	public:
		...
		CFBamTZTimestampColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTZTimestampColObj();
