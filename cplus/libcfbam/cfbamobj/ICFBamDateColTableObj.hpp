...
namespace cfbam {
	...
	{
	public:
		ICFBamDateColTableObj();
		virtual ~ICFBamDateColTableObj();
		...
		virtual cfbam::ICFBamDateColObj* newInstance() = 0;

		virtual cfbam::ICFBamDateColEditObj* newEditInstance( cfbam::ICFBamDateColObj* orig ) = 0;

		virtual cfbam::ICFBamDateColObj* realizeDateCol( cfbam::ICFBamDateColObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeDateCol( cfbam::ICFBamDateColObj* Obj ) = 0;
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId ) = 0;
		virtual cfbam::ICFBamDateColObj* createDateCol( cfbam::ICFBamDateColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamDateColObj* readDateCol( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamDateColObj* lockDateCol( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamDateColObj*> readAllDateCol( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamDateColObj* readCachedDateCol( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamDateColObj*> readCachedDateColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamDateColObj* updateDateCol( cfbam::ICFBamDateColEditObj* Obj ) = 0;

		virtual void deleteDateCol( cfbam::ICFBamDateColEditObj* Obj ) = 0;
		...
		virtual void deleteDateColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamDateColObj* moveUpDateCol( cfbam::ICFBamDateColObj* Obj ) = 0;

		virtual cfbam::ICFBamDateColObj* moveDownDateCol( cfbam::ICFBamDateColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesDateCol( cfbam::ICFBamDateColObj* Obj ) = 0;
