...
namespace cfbam {
	...
	{
	public:
		ICFBamFloatTypeTableObj();
		virtual ~ICFBamFloatTypeTableObj();
		...
		virtual cfbam::ICFBamFloatTypeObj* newInstance() = 0;

		virtual cfbam::ICFBamFloatTypeEditObj* newEditInstance( cfbam::ICFBamFloatTypeObj* orig ) = 0;

		virtual cfbam::ICFBamFloatTypeObj* realizeFloatType( cfbam::ICFBamFloatTypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeFloatType( cfbam::ICFBamFloatTypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamFloatTypeObj* createFloatType( cfbam::ICFBamFloatTypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamFloatTypeObj* readFloatType( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamFloatTypeObj* lockFloatType( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamFloatTypeObj*> readAllFloatType( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamFloatTypeObj* readCachedFloatType( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamFloatTypeObj*> readCachedFloatTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamFloatTypeObj* updateFloatType( cfbam::ICFBamFloatTypeEditObj* Obj ) = 0;

		virtual void deleteFloatType( cfbam::ICFBamFloatTypeEditObj* Obj ) = 0;
		...
		virtual void deleteFloatTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamFloatTypeObj* moveUpFloatType( cfbam::ICFBamFloatTypeObj* Obj ) = 0;

		virtual cfbam::ICFBamFloatTypeObj* moveDownFloatType( cfbam::ICFBamFloatTypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesFloatType( cfbam::ICFBamFloatTypeObj* Obj ) = 0;
