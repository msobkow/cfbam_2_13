...
// Description: C++18 base object instance specification for CFBam EnumDef.
...
namespace cfbam {
	...
	class CFBamEnumDefObj
	: public CFBamInt16DefObj,
	  public virtual ICFBamEnumDefObj
	{
	protected:
	public:
		...
		CFBamEnumDefObj();
		CFBamEnumDefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamEnumDefObj();
