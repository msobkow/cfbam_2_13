...
// Description: C++18 base object instance specification for CFBam TopProject.
...
namespace cfbam {
	...
	class CFBamTopProjectObj
	: public virtual ICFBamTopProjectObj,
	...
	public:
		...
		CFBamTopProjectObj();
		CFBamTopProjectObj( cfint::ICFIntSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTopProjectObj();
