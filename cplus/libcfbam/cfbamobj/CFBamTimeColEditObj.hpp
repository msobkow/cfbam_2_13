...
// Description: C++18 edit object instance specification for CFBam TimeCol.
...
namespace cfbam {
	...
	class CFBamTimeColEditObj
	: public CFBamTimeDefEditObj,
	  public virtual ICFBamTimeColEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamTimeColEditObj( cfbam::ICFBamTimeColObj* argOrig );
		virtual ~CFBamTimeColEditObj();
		...
		virtual cfbam::ICFBamTimeColTableObj* getTimeColTable();

		virtual cfbam::ICFBamTimeColEditObj* getTimeColEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamTimeColObj* getOrigAsTimeCol();
		...
		inline cfbam::CFBamTimeColBuff* getTimeColBuff() {
			...
			return( static_cast<cfbam::CFBamTimeColBuff*>( buff ) );
		};
