...
// Description: C++18 base object instance specification for CFBam IndexCol.
...
namespace cfbam {
	...
	class CFBamIndexColObj
	: public virtual ICFBamIndexColObj
	{
	protected:
		cfsec::ICFSecSecUserObj* createdBy = NULL;
		cfsec::ICFSecSecUserObj* updatedBy = NULL;
		bool isNew;
		cfbam::ICFBamIndexColEditObj* edit;
	...
	public:
		...
		CFBamIndexColObj();
		CFBamIndexColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamIndexColObj();
		...
		virtual cfbam::ICFBamIndexColObj* realize();
		...
		virtual cfbam::ICFBamIndexColEditObj* beginEdit();
