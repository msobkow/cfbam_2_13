...
namespace cfbam {
	...
	class CFBamUInt64ColTableObj
	: public virtual ICFBamUInt64ColTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64ColObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64ColObj*>* allUInt64Col;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamUInt64ColObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64ColObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64ColObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64ColObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64ColObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64ColObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64ColObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64ColObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamUInt64ColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64ColObj*>*>* indexByTableIdx;
	...
	public:
		...
		CFBamUInt64ColTableObj();
		CFBamUInt64ColTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamUInt64ColTableObj();
		...
		virtual cfbam::ICFBamUInt64ColObj* newInstance();

		virtual cfbam::ICFBamUInt64ColEditObj* newEditInstance( cfbam::ICFBamUInt64ColObj* orig );

		virtual cfbam::ICFBamUInt64ColObj* realizeUInt64Col( cfbam::ICFBamUInt64ColObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeUInt64Col( cfbam::ICFBamUInt64ColObj* Obj );
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId );
		virtual cfbam::ICFBamUInt64ColObj* createUInt64Col( cfbam::ICFBamUInt64ColEditObj* Obj );

		virtual cfbam::ICFBamUInt64ColObj* readUInt64Col( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamUInt64ColObj* lockUInt64Col( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamUInt64ColObj*> readAllUInt64Col( bool forceRead = false );

		virtual cfbam::ICFBamUInt64ColObj* readUInt64ColByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamUInt64ColObj* readUInt64ColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt64ColObj*> readUInt64ColByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt64ColObj*> readUInt64ColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt64ColObj*> readUInt64ColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt64ColObj*> readUInt64ColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt64ColObj*> readUInt64ColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt64ColObj*> readUInt64ColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt64ColObj*> readUInt64ColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt64ColObj*> readUInt64ColByTableIdx( const int64_t TenantId,
			const int64_t TableId,
			bool forceRead = false );

		virtual cfbam::ICFBamUInt64ColObj* readCachedUInt64Col( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamUInt64ColObj* readCachedUInt64ColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamUInt64ColObj* readCachedUInt64ColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamUInt64ColObj*> readCachedUInt64ColByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamUInt64ColObj*> readCachedUInt64ColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamUInt64ColObj*> readCachedUInt64ColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamUInt64ColObj*> readCachedUInt64ColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamUInt64ColObj*> readCachedUInt64ColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamUInt64ColObj*> readCachedUInt64ColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamUInt64ColObj*> readCachedUInt64ColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamUInt64ColObj*> readCachedUInt64ColByTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual cfbam::ICFBamUInt64ColObj* updateUInt64Col( cfbam::ICFBamUInt64ColEditObj* Obj );

		virtual void deleteUInt64Col( cfbam::ICFBamUInt64ColEditObj* Obj );

		virtual void deleteUInt64ColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteUInt64ColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteUInt64ColByValTentIdx( const int64_t TenantId );

		virtual void deleteUInt64ColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteUInt64ColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteUInt64ColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteUInt64ColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteUInt64ColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteUInt64ColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteUInt64ColByTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual cfbam::ICFBamUInt64ColObj* moveUpUInt64Col( cfbam::ICFBamUInt64ColObj* Obj );

		virtual cfbam::ICFBamUInt64ColObj* moveDownUInt64Col( cfbam::ICFBamUInt64ColObj* Obj );

		virtual void reallyDetachFromIndexesUInt64Col( cfbam::ICFBamUInt64ColObj* Obj );
