...
namespace cfbam {
	...
	{
	public:
		ICFBamTextDefTableObj();
		virtual ~ICFBamTextDefTableObj();
		...
		virtual cfbam::ICFBamTextDefObj* newInstance() = 0;

		virtual cfbam::ICFBamTextDefEditObj* newEditInstance( cfbam::ICFBamTextDefObj* orig ) = 0;

		virtual cfbam::ICFBamTextDefObj* realizeTextDef( cfbam::ICFBamTextDefObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeTextDef( cfbam::ICFBamTextDefObj* Obj ) = 0;
		virtual cfbam::ICFBamTextDefObj* createTextDef( cfbam::ICFBamTextDefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamTextDefObj* readTextDef( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTextDefObj* lockTextDef( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamTextDefObj*> readAllTextDef( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamTextDefObj* readCachedTextDef( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamTextDefObj*> readCachedTextDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTextDefObj* updateTextDef( cfbam::ICFBamTextDefEditObj* Obj ) = 0;

		virtual void deleteTextDef( cfbam::ICFBamTextDefEditObj* Obj ) = 0;
		...
		virtual void deleteTextDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTextDefObj* moveUpTextDef( cfbam::ICFBamTextDefObj* Obj ) = 0;

		virtual cfbam::ICFBamTextDefObj* moveDownTextDef( cfbam::ICFBamTextDefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesTextDef( cfbam::ICFBamTextDefObj* Obj ) = 0;
