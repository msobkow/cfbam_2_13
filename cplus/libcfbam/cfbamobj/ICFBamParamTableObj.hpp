...
namespace cfbam {
	...
	public:
		...
		virtual cfbam::ICFBamParamObj* newInstance() = 0;

		virtual cfbam::ICFBamParamEditObj* newEditInstance( cfbam::ICFBamParamObj* orig ) = 0;

		virtual cfbam::ICFBamParamObj* realizeParam( cfbam::ICFBamParamObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ServerMethodId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeParam( cfbam::ICFBamParamObj* Obj ) = 0;
		virtual cfbam::ICFBamParamObj* createParam( cfbam::ICFBamParamEditObj* Obj ) = 0;

		virtual cfbam::ICFBamParamObj* readParam( cfbam::CFBamParamPKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamParamObj* lockParam( cfbam::CFBamParamPKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamParamObj*> readAllParam( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamParamObj* readCachedParam( cfbam::CFBamParamPKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamParamObj*> readCachedParamByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamParamObj* updateParam( cfbam::ICFBamParamEditObj* Obj ) = 0;

		virtual void deleteParam( cfbam::ICFBamParamEditObj* Obj ) = 0;
		...
		virtual void deleteParamByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamParamObj* moveUpParam( cfbam::ICFBamParamObj* Obj ) = 0;

		virtual cfbam::ICFBamParamObj* moveDownParam( cfbam::ICFBamParamObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesParam( cfbam::ICFBamParamObj* Obj ) = 0;
