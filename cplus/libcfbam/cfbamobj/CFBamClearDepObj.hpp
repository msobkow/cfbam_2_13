...
// Description: C++18 base object instance specification for CFBam ClearDep.
...
namespace cfbam {
	...
	class CFBamClearDepObj
	: public CFBamScopeObj,
	  public virtual ICFBamClearDepObj
	{
	protected:
	public:
		...
		CFBamClearDepObj();
		CFBamClearDepObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamClearDepObj();
