...
// Description: C++18 edit object instance specification for CFBam DateDef.
...
namespace cfbam {
	...
	class CFBamDateDefEditObj
	: public CFBamAtomEditObj,
	  public virtual ICFBamDateDefEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamDateDefEditObj( cfbam::ICFBamDateDefObj* argOrig );
		virtual ~CFBamDateDefEditObj();
		...
		virtual cfbam::ICFBamDateDefTableObj* getDateDefTable();

		virtual cfbam::ICFBamDateDefEditObj* getDateDefEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamDateDefObj* getOrigAsDateDef();
		...
		inline cfbam::CFBamDateDefBuff* getDateDefBuff() {
			...
			return( static_cast<cfbam::CFBamDateDefBuff*>( buff ) );
		};
