...
// Description: C++18 edit object instance specification for CFBam UInt16Type.
...
namespace cfbam {
	...
	class CFBamUInt16TypeEditObj
	: public CFBamUInt16DefEditObj,
	  public virtual ICFBamUInt16TypeEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamUInt16TypeEditObj( cfbam::ICFBamUInt16TypeObj* argOrig );
		virtual ~CFBamUInt16TypeEditObj();
		...
		virtual cfbam::ICFBamUInt16TypeTableObj* getUInt16TypeTable();

		virtual cfbam::ICFBamUInt16TypeEditObj* getUInt16TypeEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamUInt16TypeObj* getOrigAsUInt16Type();

		virtual cfbam::CFBamValueBuff* getBuff();
		virtual void setBuff( cfbam::CFBamValueBuff* value );

		inline cfbam::CFBamUInt16TypeBuff* getUInt16TypeBuff() {
			// Buff is always instantiated when constructed over an original object
			return( static_cast<cfbam::CFBamUInt16TypeBuff*>( buff ) );
		};

		inline cfbam::CFBamUInt16TypeBuff* getUInt16TypeEditBuff() {
			// Buff is always instantiated when constructed over an original object
