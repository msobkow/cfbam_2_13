...
// Description: C++18 base object instance specification for CFBam Service.
...
namespace cfbam {
	...
	class CFBamServiceObj
	: public virtual ICFBamServiceObj,
	...
	public:
		...
		CFBamServiceObj();
		CFBamServiceObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamServiceObj();
