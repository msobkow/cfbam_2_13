...
namespace cfbam {
	...
	{
	public:
		ICFBamEnumTagTableObj();
		virtual ~ICFBamEnumTagTableObj();
		...
		virtual cfbam::ICFBamEnumTagObj* newInstance() = 0;

		virtual cfbam::ICFBamEnumTagEditObj* newEditInstance( cfbam::ICFBamEnumTagObj* orig ) = 0;

		virtual cfbam::ICFBamEnumTagObj* realizeEnumTag( cfbam::ICFBamEnumTagObj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByEnumTagTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDeepDisposeEnumTag( cfbam::ICFBamEnumTagObj* Obj ) = 0;
		virtual cfbam::ICFBamEnumTagObj* createEnumTag( cfbam::ICFBamEnumTagEditObj* Obj ) = 0;

		virtual cfbam::ICFBamEnumTagObj* readEnumTag( cfbam::CFBamEnumTagPKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamEnumTagObj* lockEnumTag( cfbam::CFBamEnumTagPKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamEnumTagObj*> readAllEnumTag( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamEnumTagObj* readCachedEnumTag( cfbam::CFBamEnumTagPKey* pkey ) = 0;

		virtual cfbam::ICFBamEnumTagObj* readCachedEnumTagByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamEnumTagObj*> readCachedEnumTagByEnumTagTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamEnumTagObj* updateEnumTag( cfbam::ICFBamEnumTagEditObj* Obj ) = 0;

		virtual void deleteEnumTag( cfbam::ICFBamEnumTagEditObj* Obj ) = 0;

		virtual void deleteEnumTagByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deleteEnumTagByEnumTagTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamEnumTagObj* moveUpEnumTag( cfbam::ICFBamEnumTagObj* Obj ) = 0;

		virtual cfbam::ICFBamEnumTagObj* moveDownEnumTag( cfbam::ICFBamEnumTagObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesEnumTag( cfbam::ICFBamEnumTagObj* Obj ) = 0;
