...
// Description: C++18 Object interface for CFBam DelSubDep1.
...
namespace cfbam {
	...
	public:
		ICFBamDelSubDep1Obj();
		virtual ~ICFBamDelSubDep1Obj();
		virtual cfbam::ICFBamScopeEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamDelSubDep1EditObj* getDelSubDep1Edit() = 0;

		inline cfbam::CFBamDelSubDep1Buff* getDelSubDep1Buff() {
			return( static_cast<cfbam::CFBamDelSubDep1Buff*>( getBuff() ) );
		};

		inline cfbam::CFBamDelSubDep1Buff* getDelSubDep1EditBuff() {
			return( dynamic_cast<cfbam::CFBamDelSubDep1Buff*>( getBuff() ) );
		};

		virtual const int64_t getRequiredDelTopDepTenantId() = 0;
		virtual const int64_t* getRequiredDelTopDepTenantIdReference() = 0;

		virtual const int64_t getRequiredDelTopDepId() = 0;
		virtual const int64_t* getRequiredDelTopDepIdReference() = 0;

		virtual const std::string& getRequiredName() = 0;
		virtual const std::string* getRequiredNameReference() = 0;

		virtual cfbam::ICFBamDelTopDepObj* getRequiredContainerDelTopDep( bool forceRead = false ) = 0;

		virtual std::vector<cfbam::ICFBamDelSubDep2Obj*> getOptionalComponentsDelDep( bool forceRead = false ) = 0;
