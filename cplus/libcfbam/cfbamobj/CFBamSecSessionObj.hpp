...
// Description: C++18 base object instance specification for CFBam SecSession.
...
namespace cfbam {
	...
	class CFBamSecSessionObj
	: public virtual ICFBamSecSessionObj,
	...
	public:
		...
		CFBamSecSessionObj();
		CFBamSecSessionObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamSecSessionObj();
