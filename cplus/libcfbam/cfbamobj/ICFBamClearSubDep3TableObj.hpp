...
namespace cfbam {
	...
	{
	public:
		ICFBamClearSubDep3TableObj();
		virtual ~ICFBamClearSubDep3TableObj();
		...
		virtual cfbam::ICFBamClearSubDep3Obj* newInstance() = 0;

		virtual cfbam::ICFBamClearSubDep3EditObj* newEditInstance( cfbam::ICFBamClearSubDep3Obj* orig ) = 0;

		virtual cfbam::ICFBamClearSubDep3Obj* realizeClearSubDep3( cfbam::ICFBamClearSubDep3Obj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByTenantIdx( const int64_t TenantId ) = 0;
		virtual void reallyDeepDisposeClearSubDep3( cfbam::ICFBamClearSubDep3Obj* Obj ) = 0;
		...
		virtual cfbam::ICFBamClearSubDep3Obj* createClearSubDep3( cfbam::ICFBamClearSubDep3EditObj* Obj ) = 0;

		virtual cfbam::ICFBamClearSubDep3Obj* readClearSubDep3( cfbam::CFBamScopePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamClearSubDep3Obj* lockClearSubDep3( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamClearSubDep3Obj*> readAllClearSubDep3( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamClearSubDep3Obj* readCachedClearSubDep3( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual cfbam::ICFBamClearSubDep3Obj* readCachedClearSubDep3ByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamClearSubDep3Obj*> readCachedClearSubDep3ByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamClearSubDep3Obj* updateClearSubDep3( cfbam::ICFBamClearSubDep3EditObj* Obj ) = 0;

		virtual void deleteClearSubDep3( cfbam::ICFBamClearSubDep3EditObj* Obj ) = 0;

		virtual void deleteClearSubDep3ByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deleteClearSubDep3ByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesClearSubDep3( cfbam::ICFBamClearSubDep3Obj* Obj ) = 0;
