...
// Description: C++18 Object interface for CFBam RelationCol.
...
namespace cfbam {
	...
	public:
		...
		virtual cfbam::ICFBamRelationColObj* realize() = 0;

		virtual cfbam::ICFBamRelationColObj* read( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamRelationColObj* moveUp() = 0;

		virtual cfbam::ICFBamRelationColObj* moveDown() = 0;

		virtual cfbam::ICFBamRelationColEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfbam::ICFBamRelationColEditObj* getEdit() = 0;

		virtual cfbam::ICFBamRelationColEditObj* getRelationColEdit() = 0;

		virtual cfbam::ICFBamRelationColTableObj* getRelationColTable() = 0;

		virtual cfbam::ICFBamSchemaObj* getSchema() = 0;

		virtual cfbam::CFBamRelationColBuff* getBuff() = 0;
		virtual void setBuff( cfbam::CFBamRelationColBuff* value ) = 0;

		inline cfbam::CFBamRelationColBuff* getRelationColBuff() {
			return( static_cast<cfbam::CFBamRelationColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamRelationColBuff* getRelationColEditBuff() {
			return( dynamic_cast<cfbam::CFBamRelationColBuff*>( getBuff() ) );
		};

		virtual cfbam::CFBamRelationColPKey* getPKey() = 0;
		virtual void setPKey( cfbam::CFBamRelationColPKey* value ) = 0;
		...
		virtual const int64_t getRequiredRelationId() = 0;
		virtual const int64_t* getRequiredRelationIdReference() = 0;
		...
		virtual const int64_t getRequiredFromColId() = 0;
		virtual const int64_t* getRequiredFromColIdReference() = 0;

		virtual const int64_t getRequiredToColId() = 0;
		virtual const int64_t* getRequiredToColIdReference() = 0;
		...
		virtual cfbam::ICFBamRelationObj* getRequiredContainerRelation( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamRelationColObj* getOptionalLookupPrev( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamRelationColObj* getOptionalLookupNext( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamIndexColObj* getRequiredLookupFromCol( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamIndexColObj* getRequiredLookupToCol( bool forceRead = false ) = 0;
