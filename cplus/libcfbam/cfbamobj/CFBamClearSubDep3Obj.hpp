...
// Description: C++18 base object instance specification for CFBam ClearSubDep3.
...
namespace cfbam {
	...
	class CFBamClearSubDep3Obj
	: public CFBamClearDepObj,
	  public virtual ICFBamClearSubDep3Obj
	{
	protected:
	public:
		...
		CFBamClearSubDep3Obj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamClearSubDep3Obj();
