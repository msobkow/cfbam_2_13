...
namespace cfbam {
	...
	{
	public:
		ICFBamTZDateColTableObj();
		virtual ~ICFBamTZDateColTableObj();
		...
		virtual cfbam::ICFBamTZDateColObj* newInstance() = 0;

		virtual cfbam::ICFBamTZDateColEditObj* newEditInstance( cfbam::ICFBamTZDateColObj* orig ) = 0;

		virtual cfbam::ICFBamTZDateColObj* realizeTZDateCol( cfbam::ICFBamTZDateColObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeTZDateCol( cfbam::ICFBamTZDateColObj* Obj ) = 0;
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId ) = 0;
		virtual cfbam::ICFBamTZDateColObj* createTZDateCol( cfbam::ICFBamTZDateColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamTZDateColObj* readTZDateCol( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTZDateColObj* lockTZDateCol( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamTZDateColObj*> readAllTZDateCol( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamTZDateColObj* readCachedTZDateCol( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamTZDateColObj*> readCachedTZDateColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTZDateColObj* updateTZDateCol( cfbam::ICFBamTZDateColEditObj* Obj ) = 0;

		virtual void deleteTZDateCol( cfbam::ICFBamTZDateColEditObj* Obj ) = 0;
		...
		virtual void deleteTZDateColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTZDateColObj* moveUpTZDateCol( cfbam::ICFBamTZDateColObj* Obj ) = 0;

		virtual cfbam::ICFBamTZDateColObj* moveDownTZDateCol( cfbam::ICFBamTZDateColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesTZDateCol( cfbam::ICFBamTZDateColObj* Obj ) = 0;
