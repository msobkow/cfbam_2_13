...
namespace cfbam {
	...
	class CFBamBoolDefTableObj
	: public virtual ICFBamBoolDefTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBoolDefObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBoolDefObj*>* allBoolDef;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamBoolDefObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBoolDefObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBoolDefObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBoolDefObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBoolDefObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBoolDefObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBoolDefObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBoolDefObj*>*>* indexByContNextIdx;
	...
	public:
		...
		CFBamBoolDefTableObj();
		CFBamBoolDefTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamBoolDefTableObj();
		...
		virtual cfbam::ICFBamBoolDefObj* newInstance();

		virtual cfbam::ICFBamBoolDefEditObj* newEditInstance( cfbam::ICFBamBoolDefObj* orig );

		virtual cfbam::ICFBamBoolDefObj* realizeBoolDef( cfbam::ICFBamBoolDefObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeBoolDef( cfbam::ICFBamBoolDefObj* Obj );
		virtual cfbam::ICFBamBoolDefObj* createBoolDef( cfbam::ICFBamBoolDefEditObj* Obj );

		virtual cfbam::ICFBamBoolDefObj* readBoolDef( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamBoolDefObj* lockBoolDef( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamBoolDefObj*> readAllBoolDef( bool forceRead = false );
		...
		virtual cfbam::ICFBamBoolDefObj* readCachedBoolDef( cfbam::CFBamValuePKey* pkey );
		...
		virtual std::vector<cfbam::ICFBamBoolDefObj*> readCachedBoolDefByValTentIdx( const int64_t TenantId );
		...
		virtual cfbam::ICFBamBoolDefObj* updateBoolDef( cfbam::ICFBamBoolDefEditObj* Obj );

		virtual void deleteBoolDef( cfbam::ICFBamBoolDefEditObj* Obj );
		...
		virtual void deleteBoolDefByValTentIdx( const int64_t TenantId );
		...
		virtual cfbam::ICFBamBoolDefObj* moveUpBoolDef( cfbam::ICFBamBoolDefObj* Obj );

		virtual cfbam::ICFBamBoolDefObj* moveDownBoolDef( cfbam::ICFBamBoolDefObj* Obj );

		virtual void reallyDetachFromIndexesBoolDef( cfbam::ICFBamBoolDefObj* Obj );
