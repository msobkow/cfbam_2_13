...
namespace cfbam {
	...
	class CFBamStringDefTableObj
	: public virtual ICFBamStringDefTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamStringDefObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamStringDefObj*>* allStringDef;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamStringDefObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamStringDefObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamStringDefObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamStringDefObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamStringDefObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamStringDefObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamStringDefObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamStringDefObj*>*>* indexByContNextIdx;
	...
	public:
		...
		CFBamStringDefTableObj();
		CFBamStringDefTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamStringDefTableObj();
		...
		virtual cfbam::ICFBamStringDefObj* newInstance();

		virtual cfbam::ICFBamStringDefEditObj* newEditInstance( cfbam::ICFBamStringDefObj* orig );

		virtual cfbam::ICFBamStringDefObj* realizeStringDef( cfbam::ICFBamStringDefObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeStringDef( cfbam::ICFBamStringDefObj* Obj );
		virtual cfbam::ICFBamStringDefObj* createStringDef( cfbam::ICFBamStringDefEditObj* Obj );

		virtual cfbam::ICFBamStringDefObj* readStringDef( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamStringDefObj* lockStringDef( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamStringDefObj*> readAllStringDef( bool forceRead = false );

		virtual cfbam::ICFBamStringDefObj* readStringDefByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamStringDefObj* readStringDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamStringDefObj*> readStringDefByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamStringDefObj*> readStringDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamStringDefObj*> readStringDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamStringDefObj*> readStringDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamStringDefObj*> readStringDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamStringDefObj*> readStringDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamStringDefObj*> readStringDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual cfbam::ICFBamStringDefObj* readCachedStringDef( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamStringDefObj* readCachedStringDefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamStringDefObj* readCachedStringDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamStringDefObj*> readCachedStringDefByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamStringDefObj*> readCachedStringDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamStringDefObj*> readCachedStringDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamStringDefObj*> readCachedStringDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamStringDefObj*> readCachedStringDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamStringDefObj*> readCachedStringDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamStringDefObj*> readCachedStringDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamStringDefObj* updateStringDef( cfbam::ICFBamStringDefEditObj* Obj );

		virtual void deleteStringDef( cfbam::ICFBamStringDefEditObj* Obj );

		virtual void deleteStringDefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteStringDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteStringDefByValTentIdx( const int64_t TenantId );

		virtual void deleteStringDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteStringDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteStringDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteStringDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteStringDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteStringDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamStringDefObj* moveUpStringDef( cfbam::ICFBamStringDefObj* Obj );

		virtual cfbam::ICFBamStringDefObj* moveDownStringDef( cfbam::ICFBamStringDefObj* Obj );

		virtual void reallyDetachFromIndexesStringDef( cfbam::ICFBamStringDefObj* Obj );
