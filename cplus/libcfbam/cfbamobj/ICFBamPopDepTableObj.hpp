...
namespace cfbam {
	...
	{
	public:
		ICFBamPopDepTableObj();
		virtual ~ICFBamPopDepTableObj();
		...
		virtual cfbam::ICFBamPopDepObj* newInstance() = 0;

		virtual cfbam::ICFBamPopDepEditObj* newEditInstance( cfbam::ICFBamPopDepObj* orig ) = 0;

		virtual cfbam::ICFBamPopDepObj* realizePopDep( cfbam::ICFBamPopDepObj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByTenantIdx( const int64_t TenantId ) = 0;
		virtual void reallyDeepDisposePopDep( cfbam::ICFBamPopDepObj* Obj ) = 0;
		...
		virtual cfbam::ICFBamPopDepObj* createPopDep( cfbam::ICFBamPopDepEditObj* Obj ) = 0;

		virtual cfbam::ICFBamPopDepObj* readPopDep( cfbam::CFBamScopePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamPopDepObj* lockPopDep( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamPopDepObj*> readAllPopDep( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamPopDepObj* readCachedPopDep( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual cfbam::ICFBamPopDepObj* readCachedPopDepByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamPopDepObj*> readCachedPopDepByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamPopDepObj* updatePopDep( cfbam::ICFBamPopDepEditObj* Obj ) = 0;

		virtual void deletePopDep( cfbam::ICFBamPopDepEditObj* Obj ) = 0;

		virtual void deletePopDepByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deletePopDepByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesPopDep( cfbam::ICFBamPopDepObj* Obj ) = 0;
