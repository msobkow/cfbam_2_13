...
namespace cfbam {
	...
	class CFBamServiceTypeTableObj
	: public virtual ICFBamServiceTypeTableObj,
	  public virtual cfsec::ICFSecServiceTypeTableObj,
	  public virtual cfint::ICFIntServiceTypeTableObj
	{
	protected:
	...
	public:
		...
		CFBamServiceTypeTableObj();
		CFBamServiceTypeTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamServiceTypeTableObj();
