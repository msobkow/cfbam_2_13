...
namespace cfbam {
	...
	class CFBamISOTZoneTableObj
	: public virtual ICFBamISOTZoneTableObj,
	  public virtual cfsec::ICFSecISOTZoneTableObj,
	  public virtual cfint::ICFIntISOTZoneTableObj
	{
	protected:
	...
	public:
		...
		CFBamISOTZoneTableObj();
		CFBamISOTZoneTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamISOTZoneTableObj();
