...
// Description: C++18 edit object instance specification for CFBam SecGroup.
...
namespace cfbam {
	...
	class CFBamSecGroupEditObj
	: public virtual ICFBamSecGroupEditObj,
	  public virtual cfsec::ICFSecSecGroupEditObj,
	  public virtual cfint::ICFIntSecGroupEditObj
	{
	public:
	...
	public:
		CFBamSecGroupEditObj( cfsec::ICFSecSecGroupObj* argOrig );
		virtual ~CFBamSecGroupEditObj();
