...
// Description: C++18 edit object instance specification for CFBam TSecGrpInc.
...
namespace cfbam {
	...
	class CFBamTSecGrpIncEditObj
	: public virtual ICFBamTSecGrpIncEditObj,
	  public virtual cfsec::ICFSecTSecGrpIncEditObj,
	  public virtual cfint::ICFIntTSecGrpIncEditObj
	{
	public:
	...
	public:
		CFBamTSecGrpIncEditObj( cfsec::ICFSecTSecGrpIncObj* argOrig );
		virtual ~CFBamTSecGrpIncEditObj();
