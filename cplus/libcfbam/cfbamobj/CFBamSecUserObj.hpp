...
// Description: C++18 base object instance specification for CFBam SecUser.
...
namespace cfbam {
	...
	class CFBamSecUserObj
	: public virtual ICFBamSecUserObj,
	...
	public:
		...
		CFBamSecUserObj();
		CFBamSecUserObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamSecUserObj();
