...
// Description: C++18 edit object instance specification for CFBam SecDevice.
...
namespace cfbam {
	...
	class CFBamSecDeviceEditObj
	: public virtual ICFBamSecDeviceEditObj,
	  public virtual cfsec::ICFSecSecDeviceEditObj,
	  public virtual cfint::ICFIntSecDeviceEditObj
	{
	public:
	...
	public:
		CFBamSecDeviceEditObj( cfsec::ICFSecSecDeviceObj* argOrig );
		virtual ~CFBamSecDeviceEditObj();
