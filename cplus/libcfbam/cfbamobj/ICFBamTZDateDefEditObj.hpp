...
// Description: C++18 Instance Edit Object interface for CFBam TZDateDef.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamAtomEditObj,
	  public virtual cfbam::ICFBamTZDateDefObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamTZDateDefEditObj();
		virtual ~ICFBamTZDateDefEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamTZDateDefBuff* getTZDateDefBuff() {
			return( static_cast<cfbam::CFBamTZDateDefBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamTZDateDefBuff* getTZDateDefEditBuff() {
			return( dynamic_cast<cfbam::CFBamTZDateDefBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamTZDateDefObj* getOrigAsTZDateDef() = 0;
