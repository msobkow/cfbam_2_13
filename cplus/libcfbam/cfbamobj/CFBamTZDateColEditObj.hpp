...
// Description: C++18 edit object instance specification for CFBam TZDateCol.
...
namespace cfbam {
	...
	class CFBamTZDateColEditObj
	: public CFBamTZDateDefEditObj,
	  public virtual ICFBamTZDateColEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamTZDateColEditObj( cfbam::ICFBamTZDateColObj* argOrig );
		virtual ~CFBamTZDateColEditObj();
		...
		virtual cfbam::ICFBamTZDateColTableObj* getTZDateColTable();

		virtual cfbam::ICFBamTZDateColEditObj* getTZDateColEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamTZDateColObj* getOrigAsTZDateCol();
		...
		inline cfbam::CFBamTZDateColBuff* getTZDateColBuff() {
			...
			return( static_cast<cfbam::CFBamTZDateColBuff*>( buff ) );
		};
