...
// Description: C++18 base object instance specification for CFBam NumberDef.
...
namespace cfbam {
	...
	class CFBamNumberDefObj
	: public CFBamAtomObj,
	  public virtual ICFBamNumberDefObj
	{
	protected:
	public:
		...
		CFBamNumberDefObj();
		CFBamNumberDefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamNumberDefObj();
