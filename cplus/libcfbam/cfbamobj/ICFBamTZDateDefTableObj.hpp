...
namespace cfbam {
	...
	{
	public:
		ICFBamTZDateDefTableObj();
		virtual ~ICFBamTZDateDefTableObj();
		...
		virtual cfbam::ICFBamTZDateDefObj* newInstance() = 0;

		virtual cfbam::ICFBamTZDateDefEditObj* newEditInstance( cfbam::ICFBamTZDateDefObj* orig ) = 0;

		virtual cfbam::ICFBamTZDateDefObj* realizeTZDateDef( cfbam::ICFBamTZDateDefObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeTZDateDef( cfbam::ICFBamTZDateDefObj* Obj ) = 0;
		virtual cfbam::ICFBamTZDateDefObj* createTZDateDef( cfbam::ICFBamTZDateDefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamTZDateDefObj* readTZDateDef( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTZDateDefObj* lockTZDateDef( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamTZDateDefObj*> readAllTZDateDef( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamTZDateDefObj* readCachedTZDateDef( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamTZDateDefObj*> readCachedTZDateDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTZDateDefObj* updateTZDateDef( cfbam::ICFBamTZDateDefEditObj* Obj ) = 0;

		virtual void deleteTZDateDef( cfbam::ICFBamTZDateDefEditObj* Obj ) = 0;
		...
		virtual void deleteTZDateDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTZDateDefObj* moveUpTZDateDef( cfbam::ICFBamTZDateDefObj* Obj ) = 0;

		virtual cfbam::ICFBamTZDateDefObj* moveDownTZDateDef( cfbam::ICFBamTZDateDefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesTZDateDef( cfbam::ICFBamTZDateDefObj* Obj ) = 0;
