...
// Description: C++18 Object interface for CFBam DelSubDep2.
...
namespace cfbam {
	...
	public:
		ICFBamDelSubDep2Obj();
		virtual ~ICFBamDelSubDep2Obj();
		virtual cfbam::ICFBamScopeEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamDelSubDep2EditObj* getDelSubDep2Edit() = 0;

		inline cfbam::CFBamDelSubDep2Buff* getDelSubDep2Buff() {
			return( static_cast<cfbam::CFBamDelSubDep2Buff*>( getBuff() ) );
		};

		inline cfbam::CFBamDelSubDep2Buff* getDelSubDep2EditBuff() {
			return( dynamic_cast<cfbam::CFBamDelSubDep2Buff*>( getBuff() ) );
		};

		virtual const int64_t getRequiredDelSubDep1TenantId() = 0;
		virtual const int64_t* getRequiredDelSubDep1TenantIdReference() = 0;

		virtual const int64_t getRequiredDelSubDep1Id() = 0;
		virtual const int64_t* getRequiredDelSubDep1IdReference() = 0;

		virtual const std::string& getRequiredName() = 0;
		virtual const std::string* getRequiredNameReference() = 0;

		virtual cfbam::ICFBamDelSubDep1Obj* getRequiredContainerDelSubDep1( bool forceRead = false ) = 0;

		virtual std::vector<cfbam::ICFBamDelSubDep3Obj*> getOptionalComponentsDelDep( bool forceRead = false ) = 0;
