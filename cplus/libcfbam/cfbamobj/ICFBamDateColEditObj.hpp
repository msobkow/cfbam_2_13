...
// Description: C++18 Instance Edit Object interface for CFBam DateCol.
...
namespace cfbam {
	...
	class ICFBamDateColEditObj
	: public virtual cfbam::ICFBamDateDefEditObj,
	  public virtual cfbam::ICFBamDateColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamDateColEditObj();
		virtual ~ICFBamDateColEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamDateColBuff* getDateColBuff() {
			return( static_cast<cfbam::CFBamDateColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamDateColBuff* getDateColEditBuff() {
			return( dynamic_cast<cfbam::CFBamDateColBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamDateColObj* getOrigAsDateCol() = 0;
