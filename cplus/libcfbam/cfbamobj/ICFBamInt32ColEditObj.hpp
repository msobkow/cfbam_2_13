...
// Description: C++18 Instance Edit Object interface for CFBam Int32Col.
...
namespace cfbam {
	...
	class ICFBamInt32ColEditObj
	: public virtual cfbam::ICFBamInt32DefEditObj,
	  public virtual cfbam::ICFBamInt32ColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamInt32ColEditObj();
		virtual ~ICFBamInt32ColEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamInt32ColBuff* getInt32ColBuff() {
			return( static_cast<cfbam::CFBamInt32ColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamInt32ColBuff* getInt32ColEditBuff() {
			return( dynamic_cast<cfbam::CFBamInt32ColBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamInt32ColObj* getOrigAsInt32Col() = 0;
