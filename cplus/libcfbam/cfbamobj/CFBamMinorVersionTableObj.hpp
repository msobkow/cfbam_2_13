...
namespace cfbam {
	...
	class CFBamMinorVersionTableObj
	: public virtual ICFBamMinorVersionTableObj,
	  public virtual cfint::ICFIntMinorVersionTableObj
	{
	protected:
	...
	public:
		...
		CFBamMinorVersionTableObj();
		CFBamMinorVersionTableObj( cfint::ICFIntSchemaObj* argSchema );
		virtual ~CFBamMinorVersionTableObj();
