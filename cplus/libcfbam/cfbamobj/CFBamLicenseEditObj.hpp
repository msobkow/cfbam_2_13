...
// Description: C++18 edit object instance specification for CFBam License.
...
namespace cfbam {
	...
	class CFBamLicenseEditObj
	: public virtual ICFBamLicenseEditObj,
	  public virtual cfint::ICFIntLicenseEditObj
	{
	public:
	...
	public:
		CFBamLicenseEditObj( cfint::ICFIntLicenseObj* argOrig );
		virtual ~CFBamLicenseEditObj();
