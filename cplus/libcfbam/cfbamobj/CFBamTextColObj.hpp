...
// Description: C++18 base object instance specification for CFBam TextCol.
...
namespace cfbam {
	...
	class CFBamTextColObj
	: public CFBamTextDefObj,
	  public virtual ICFBamTextColObj
	{
	protected:
	public:
		...
		CFBamTextColObj();
		CFBamTextColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTextColObj();
