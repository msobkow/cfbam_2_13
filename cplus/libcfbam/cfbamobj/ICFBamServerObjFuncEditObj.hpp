...
// Description: C++18 Instance Edit Object interface for CFBam ServerObjFunc.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamServerMethodEditObj,
	  public virtual cfbam::ICFBamServerObjFuncObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamServerObjFuncEditObj();
		virtual ~ICFBamServerObjFuncEditObj();
		...
		virtual cfbam::ICFBamServerObjFuncObj* getOrigAsServerObjFunc() = 0;
