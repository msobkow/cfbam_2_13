...
// Description: C++18 Instance Edit Object interface for CFBam Int16Col.
...
namespace cfbam {
	...
	class ICFBamInt16ColEditObj
	: public virtual cfbam::ICFBamInt16DefEditObj,
	  public virtual cfbam::ICFBamInt16ColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamInt16ColEditObj();
		virtual ~ICFBamInt16ColEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamInt16ColBuff* getInt16ColBuff() {
			return( static_cast<cfbam::CFBamInt16ColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamInt16ColBuff* getInt16ColEditBuff() {
			return( dynamic_cast<cfbam::CFBamInt16ColBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamInt16ColObj* getOrigAsInt16Col() = 0;
