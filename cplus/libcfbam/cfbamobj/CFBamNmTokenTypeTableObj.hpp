...
namespace cfbam {
	...
	class CFBamNmTokenTypeTableObj
	: public virtual ICFBamNmTokenTypeTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenTypeObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenTypeObj*>* allNmTokenType;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamNmTokenTypeObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenTypeObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenTypeObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenTypeObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenTypeObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenTypeObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenTypeObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenTypeObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamNmTokenTypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenTypeObj*>*>* indexBySchemaIdx;
	...
	public:
		...
		CFBamNmTokenTypeTableObj();
		CFBamNmTokenTypeTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamNmTokenTypeTableObj();
		...
		virtual cfbam::ICFBamNmTokenTypeObj* newInstance();

		virtual cfbam::ICFBamNmTokenTypeEditObj* newEditInstance( cfbam::ICFBamNmTokenTypeObj* orig );

		virtual cfbam::ICFBamNmTokenTypeObj* realizeNmTokenType( cfbam::ICFBamNmTokenTypeObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeNmTokenType( cfbam::ICFBamNmTokenTypeObj* Obj );
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );
		virtual cfbam::ICFBamNmTokenTypeObj* createNmTokenType( cfbam::ICFBamNmTokenTypeEditObj* Obj );

		virtual cfbam::ICFBamNmTokenTypeObj* readNmTokenType( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamNmTokenTypeObj* lockNmTokenType( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamNmTokenTypeObj*> readAllNmTokenType( bool forceRead = false );

		virtual cfbam::ICFBamNmTokenTypeObj* readNmTokenTypeByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamNmTokenTypeObj* readNmTokenTypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokenTypeObj*> readNmTokenTypeByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokenTypeObj*> readNmTokenTypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokenTypeObj*> readNmTokenTypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokenTypeObj*> readNmTokenTypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokenTypeObj*> readNmTokenTypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokenTypeObj*> readNmTokenTypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokenTypeObj*> readNmTokenTypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokenTypeObj*> readNmTokenTypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId,
			bool forceRead = false );

		virtual cfbam::ICFBamNmTokenTypeObj* readCachedNmTokenType( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamNmTokenTypeObj* readCachedNmTokenTypeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamNmTokenTypeObj* readCachedNmTokenTypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamNmTokenTypeObj*> readCachedNmTokenTypeByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamNmTokenTypeObj*> readCachedNmTokenTypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamNmTokenTypeObj*> readCachedNmTokenTypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamNmTokenTypeObj*> readCachedNmTokenTypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamNmTokenTypeObj*> readCachedNmTokenTypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamNmTokenTypeObj*> readCachedNmTokenTypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamNmTokenTypeObj*> readCachedNmTokenTypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamNmTokenTypeObj*> readCachedNmTokenTypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual cfbam::ICFBamNmTokenTypeObj* updateNmTokenType( cfbam::ICFBamNmTokenTypeEditObj* Obj );

		virtual void deleteNmTokenType( cfbam::ICFBamNmTokenTypeEditObj* Obj );

		virtual void deleteNmTokenTypeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteNmTokenTypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteNmTokenTypeByValTentIdx( const int64_t TenantId );

		virtual void deleteNmTokenTypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteNmTokenTypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteNmTokenTypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteNmTokenTypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteNmTokenTypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteNmTokenTypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteNmTokenTypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual cfbam::ICFBamNmTokenTypeObj* moveUpNmTokenType( cfbam::ICFBamNmTokenTypeObj* Obj );

		virtual cfbam::ICFBamNmTokenTypeObj* moveDownNmTokenType( cfbam::ICFBamNmTokenTypeObj* Obj );

		virtual void reallyDetachFromIndexesNmTokenType( cfbam::ICFBamNmTokenTypeObj* Obj );
