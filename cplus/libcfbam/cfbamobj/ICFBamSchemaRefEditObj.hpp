...
// Description: C++18 Instance Edit Object interface for CFBam SchemaRef.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamScopeEditObj,
	  public virtual cfbam::ICFBamSchemaRefObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamSchemaRefEditObj();
		virtual ~ICFBamSchemaRefEditObj();
		...
		virtual cfbam::ICFBamSchemaRefObj* getOrigAsSchemaRef() = 0;
