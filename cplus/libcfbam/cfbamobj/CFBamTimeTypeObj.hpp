...
// Description: C++18 base object instance specification for CFBam TimeType.
...
namespace cfbam {
	...
	class CFBamTimeTypeObj
	: public CFBamTimeDefObj,
	  public virtual ICFBamTimeTypeObj
	{
	protected:
	public:
		...
		CFBamTimeTypeObj();
		CFBamTimeTypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTimeTypeObj();
