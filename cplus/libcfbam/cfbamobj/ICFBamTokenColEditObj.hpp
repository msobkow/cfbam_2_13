...
// Description: C++18 Instance Edit Object interface for CFBam TokenCol.
...
namespace cfbam {
	...
	class ICFBamTokenColEditObj
	: public virtual cfbam::ICFBamTokenDefEditObj,
	  public virtual cfbam::ICFBamTokenColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamTokenColEditObj();
		virtual ~ICFBamTokenColEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamTokenColBuff* getTokenColBuff() {
			return( static_cast<cfbam::CFBamTokenColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamTokenColBuff* getTokenColEditBuff() {
			return( dynamic_cast<cfbam::CFBamTokenColBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamTokenColObj* getOrigAsTokenCol() = 0;
