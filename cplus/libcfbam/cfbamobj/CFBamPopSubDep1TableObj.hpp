...
namespace cfbam {
	...
	class CFBamPopSubDep1TableObj
	: public virtual ICFBamPopSubDep1TableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopSubDep1Obj*>* members;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopSubDep1Obj*>* allPopSubDep1;
		std::map< cfbam::CFBamScopeByTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopSubDep1Obj*>*>* indexByTenantIdx;
		std::map< cfbam::CFBamPopDepByRelationIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopSubDep1Obj*>*>* indexByRelationIdx;
		std::map< cfbam::CFBamPopDepByDefSchemaIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopSubDep1Obj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamPopSubDep1ByPopTopDepIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopSubDep1Obj*>*>* indexByPopTopDepIdx;
		std::map< cfbam::CFBamPopSubDep1ByUNameIdxKey,
			cfbam::ICFBamPopSubDep1Obj*>* indexByUNameIdx;
	...
	public:
		...
		CFBamPopSubDep1TableObj();
		CFBamPopSubDep1TableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamPopSubDep1TableObj();
		...
		virtual cfbam::ICFBamPopSubDep1Obj* newInstance();

		virtual cfbam::ICFBamPopSubDep1EditObj* newEditInstance( cfbam::ICFBamPopSubDep1Obj* orig );

		virtual cfbam::ICFBamPopSubDep1Obj* realizePopSubDep1( cfbam::ICFBamPopSubDep1Obj* Obj );

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id );
		virtual void deepDisposeByTenantIdx( const int64_t TenantId );
		virtual void reallyDeepDisposePopSubDep1( cfbam::ICFBamPopSubDep1Obj* Obj );
		...
		virtual void deepDisposeByPopTopDepIdx( const int64_t PopTopDepTenantId,
			const int64_t PopTopDepId );
		virtual void deepDisposeByUNameIdx( const int64_t PopTopDepTenantId,
			const int64_t PopTopDepId,
			const std::string& Name );
		virtual cfbam::ICFBamPopSubDep1Obj* createPopSubDep1( cfbam::ICFBamPopSubDep1EditObj* Obj );

		virtual cfbam::ICFBamPopSubDep1Obj* readPopSubDep1( cfbam::CFBamScopePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamPopSubDep1Obj* lockPopSubDep1( cfbam::CFBamScopePKey* pkey );

		virtual std::vector<cfbam::ICFBamPopSubDep1Obj*> readAllPopSubDep1( bool forceRead = false );

		virtual cfbam::ICFBamPopSubDep1Obj* readPopSubDep1ByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamPopSubDep1Obj*> readPopSubDep1ByTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamPopSubDep1Obj*> readPopSubDep1ByRelationIdx( const int64_t RelationTenantId,
			const int64_t RelationId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamPopSubDep1Obj*> readPopSubDep1ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamPopSubDep1Obj*> readPopSubDep1ByPopTopDepIdx( const int64_t PopTopDepTenantId,
			const int64_t PopTopDepId,
			bool forceRead = false );

		virtual cfbam::ICFBamPopSubDep1Obj* readPopSubDep1ByUNameIdx( const int64_t PopTopDepTenantId,
			const int64_t PopTopDepId,
			const std::string& Name, bool forceRead = false );

		virtual cfbam::ICFBamPopSubDep1Obj* readCachedPopSubDep1( cfbam::CFBamScopePKey* pkey );

		virtual cfbam::ICFBamPopSubDep1Obj* readCachedPopSubDep1ByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual std::vector<cfbam::ICFBamPopSubDep1Obj*> readCachedPopSubDep1ByTenantIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamPopSubDep1Obj*> readCachedPopSubDep1ByRelationIdx( const int64_t RelationTenantId,
			const int64_t RelationId );

		virtual std::vector<cfbam::ICFBamPopSubDep1Obj*> readCachedPopSubDep1ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamPopSubDep1Obj*> readCachedPopSubDep1ByPopTopDepIdx( const int64_t PopTopDepTenantId,
			const int64_t PopTopDepId );

		virtual cfbam::ICFBamPopSubDep1Obj* readCachedPopSubDep1ByUNameIdx( const int64_t PopTopDepTenantId,
			const int64_t PopTopDepId,
			const std::string& Name );

		virtual cfbam::ICFBamPopSubDep1Obj* updatePopSubDep1( cfbam::ICFBamPopSubDep1EditObj* Obj );

		virtual void deletePopSubDep1( cfbam::ICFBamPopSubDep1EditObj* Obj );

		virtual void deletePopSubDep1ByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deletePopSubDep1ByTenantIdx( const int64_t TenantId );

		virtual void deletePopSubDep1ByRelationIdx( const int64_t RelationTenantId,
			const int64_t RelationId );

		virtual void deletePopSubDep1ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deletePopSubDep1ByPopTopDepIdx( const int64_t PopTopDepTenantId,
			const int64_t PopTopDepId );

		virtual void deletePopSubDep1ByUNameIdx( const int64_t PopTopDepTenantId,
			const int64_t PopTopDepId,
			const std::string& Name );

		virtual void reallyDetachFromIndexesPopSubDep1( cfbam::ICFBamPopSubDep1Obj* Obj );
