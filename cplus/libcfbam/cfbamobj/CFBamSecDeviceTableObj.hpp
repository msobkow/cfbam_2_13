...
namespace cfbam {
	...
	class CFBamSecDeviceTableObj
	: public virtual ICFBamSecDeviceTableObj,
	  public virtual cfsec::ICFSecSecDeviceTableObj,
	  public virtual cfint::ICFIntSecDeviceTableObj
	{
	protected:
	...
	public:
		...
		CFBamSecDeviceTableObj();
		CFBamSecDeviceTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamSecDeviceTableObj();
