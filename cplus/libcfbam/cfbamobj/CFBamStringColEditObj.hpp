...
// Description: C++18 edit object instance specification for CFBam StringCol.
...
namespace cfbam {
	...
	class CFBamStringColEditObj
	: public CFBamStringDefEditObj,
	  public virtual ICFBamStringColEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamStringColEditObj( cfbam::ICFBamStringColObj* argOrig );
		virtual ~CFBamStringColEditObj();
		...
		virtual cfbam::ICFBamStringColTableObj* getStringColTable();

		virtual cfbam::ICFBamStringColEditObj* getStringColEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamStringColObj* getOrigAsStringCol();
		...
		inline cfbam::CFBamStringColBuff* getStringColBuff() {
			...
			return( static_cast<cfbam::CFBamStringColBuff*>( buff ) );
		};
