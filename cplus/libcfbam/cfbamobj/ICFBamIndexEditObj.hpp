...
// Description: C++18 Instance Edit Object interface for CFBam Index.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamScopeEditObj,
	  public virtual cfbam::ICFBamIndexObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamIndexEditObj();
		virtual ~ICFBamIndexEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamIndexBuff* getIndexBuff() {
			return( static_cast<cfbam::CFBamIndexBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamIndexBuff* getIndexEditBuff() {
			return( dynamic_cast<cfbam::CFBamIndexBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamIndexObj* getOrigAsIndex() = 0;
		...
		virtual const bool getRequiredIsUnique() = 0;
		virtual const bool* getRequiredIsUniqueReference() = 0;
		virtual void setRequiredIsUnique( const bool value ) = 0;

		virtual const bool getRequiredIsDbMapped() = 0;
		virtual const bool* getRequiredIsDbMappedReference() = 0;
		virtual void setRequiredIsDbMapped( const bool value ) = 0;
		...
		virtual cfsec::ICFSecTenantObj* getRequiredOwnerIdxTenant( bool forceRead = false ) = 0;
		virtual void setRequiredOwnerIdxTenant( cfsec::ICFSecTenantObj* value ) = 0;
