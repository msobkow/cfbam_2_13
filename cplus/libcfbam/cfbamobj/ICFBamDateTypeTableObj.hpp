...
namespace cfbam {
	...
	{
	public:
		ICFBamDateTypeTableObj();
		virtual ~ICFBamDateTypeTableObj();
		...
		virtual cfbam::ICFBamDateTypeObj* newInstance() = 0;

		virtual cfbam::ICFBamDateTypeEditObj* newEditInstance( cfbam::ICFBamDateTypeObj* orig ) = 0;

		virtual cfbam::ICFBamDateTypeObj* realizeDateType( cfbam::ICFBamDateTypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeDateType( cfbam::ICFBamDateTypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamDateTypeObj* createDateType( cfbam::ICFBamDateTypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamDateTypeObj* readDateType( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamDateTypeObj* lockDateType( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamDateTypeObj*> readAllDateType( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamDateTypeObj* readCachedDateType( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamDateTypeObj*> readCachedDateTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamDateTypeObj* updateDateType( cfbam::ICFBamDateTypeEditObj* Obj ) = 0;

		virtual void deleteDateType( cfbam::ICFBamDateTypeEditObj* Obj ) = 0;
		...
		virtual void deleteDateTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamDateTypeObj* moveUpDateType( cfbam::ICFBamDateTypeObj* Obj ) = 0;

		virtual cfbam::ICFBamDateTypeObj* moveDownDateType( cfbam::ICFBamDateTypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesDateType( cfbam::ICFBamDateTypeObj* Obj ) = 0;
