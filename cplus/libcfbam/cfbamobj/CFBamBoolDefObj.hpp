...
// Description: C++18 base object instance specification for CFBam BoolDef.
...
namespace cfbam {
	...
	class CFBamBoolDefObj
	: public CFBamAtomObj,
	  public virtual ICFBamBoolDefObj
	{
	protected:
	public:
		...
		CFBamBoolDefObj();
		CFBamBoolDefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamBoolDefObj();
		...
		virtual cfbam::ICFBamValueObj* realize();
		...
		virtual cfbam::ICFBamValueEditObj* beginEdit();
