...
namespace cfbam {
	...
	{
	public:
		ICFBamTZTimestampTypeTableObj();
		virtual ~ICFBamTZTimestampTypeTableObj();
		...
		virtual cfbam::ICFBamTZTimestampTypeObj* newInstance() = 0;

		virtual cfbam::ICFBamTZTimestampTypeEditObj* newEditInstance( cfbam::ICFBamTZTimestampTypeObj* orig ) = 0;

		virtual cfbam::ICFBamTZTimestampTypeObj* realizeTZTimestampType( cfbam::ICFBamTZTimestampTypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeTZTimestampType( cfbam::ICFBamTZTimestampTypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamTZTimestampTypeObj* createTZTimestampType( cfbam::ICFBamTZTimestampTypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamTZTimestampTypeObj* readTZTimestampType( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTZTimestampTypeObj* lockTZTimestampType( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamTZTimestampTypeObj*> readAllTZTimestampType( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamTZTimestampTypeObj* readCachedTZTimestampType( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamTZTimestampTypeObj*> readCachedTZTimestampTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTZTimestampTypeObj* updateTZTimestampType( cfbam::ICFBamTZTimestampTypeEditObj* Obj ) = 0;

		virtual void deleteTZTimestampType( cfbam::ICFBamTZTimestampTypeEditObj* Obj ) = 0;
		...
		virtual void deleteTZTimestampTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTZTimestampTypeObj* moveUpTZTimestampType( cfbam::ICFBamTZTimestampTypeObj* Obj ) = 0;

		virtual cfbam::ICFBamTZTimestampTypeObj* moveDownTZTimestampType( cfbam::ICFBamTZTimestampTypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesTZTimestampType( cfbam::ICFBamTZTimestampTypeObj* Obj ) = 0;
