...
namespace cfbam {
	...
	class CFBamTZTimestampTypeTableObj
	: public virtual ICFBamTZTimestampTypeTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampTypeObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampTypeObj*>* allTZTimestampType;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamTZTimestampTypeObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampTypeObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampTypeObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampTypeObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampTypeObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampTypeObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampTypeObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampTypeObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamTZTimestampTypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampTypeObj*>*>* indexBySchemaIdx;
	...
	public:
		...
		CFBamTZTimestampTypeTableObj();
		CFBamTZTimestampTypeTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamTZTimestampTypeTableObj();
		...
		virtual cfbam::ICFBamTZTimestampTypeObj* newInstance();

		virtual cfbam::ICFBamTZTimestampTypeEditObj* newEditInstance( cfbam::ICFBamTZTimestampTypeObj* orig );

		virtual cfbam::ICFBamTZTimestampTypeObj* realizeTZTimestampType( cfbam::ICFBamTZTimestampTypeObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeTZTimestampType( cfbam::ICFBamTZTimestampTypeObj* Obj );
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );
		virtual cfbam::ICFBamTZTimestampTypeObj* createTZTimestampType( cfbam::ICFBamTZTimestampTypeEditObj* Obj );

		virtual cfbam::ICFBamTZTimestampTypeObj* readTZTimestampType( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamTZTimestampTypeObj* lockTZTimestampType( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamTZTimestampTypeObj*> readAllTZTimestampType( bool forceRead = false );

		virtual cfbam::ICFBamTZTimestampTypeObj* readTZTimestampTypeByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamTZTimestampTypeObj* readTZTimestampTypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimestampTypeObj*> readTZTimestampTypeByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimestampTypeObj*> readTZTimestampTypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimestampTypeObj*> readTZTimestampTypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimestampTypeObj*> readTZTimestampTypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimestampTypeObj*> readTZTimestampTypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimestampTypeObj*> readTZTimestampTypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimestampTypeObj*> readTZTimestampTypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimestampTypeObj*> readTZTimestampTypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId,
			bool forceRead = false );

		virtual cfbam::ICFBamTZTimestampTypeObj* readCachedTZTimestampType( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamTZTimestampTypeObj* readCachedTZTimestampTypeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamTZTimestampTypeObj* readCachedTZTimestampTypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamTZTimestampTypeObj*> readCachedTZTimestampTypeByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamTZTimestampTypeObj*> readCachedTZTimestampTypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamTZTimestampTypeObj*> readCachedTZTimestampTypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamTZTimestampTypeObj*> readCachedTZTimestampTypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamTZTimestampTypeObj*> readCachedTZTimestampTypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamTZTimestampTypeObj*> readCachedTZTimestampTypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamTZTimestampTypeObj*> readCachedTZTimestampTypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamTZTimestampTypeObj*> readCachedTZTimestampTypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual cfbam::ICFBamTZTimestampTypeObj* updateTZTimestampType( cfbam::ICFBamTZTimestampTypeEditObj* Obj );

		virtual void deleteTZTimestampType( cfbam::ICFBamTZTimestampTypeEditObj* Obj );

		virtual void deleteTZTimestampTypeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteTZTimestampTypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteTZTimestampTypeByValTentIdx( const int64_t TenantId );

		virtual void deleteTZTimestampTypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteTZTimestampTypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteTZTimestampTypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteTZTimestampTypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteTZTimestampTypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteTZTimestampTypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteTZTimestampTypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual cfbam::ICFBamTZTimestampTypeObj* moveUpTZTimestampType( cfbam::ICFBamTZTimestampTypeObj* Obj );

		virtual cfbam::ICFBamTZTimestampTypeObj* moveDownTZTimestampType( cfbam::ICFBamTZTimestampTypeObj* Obj );

		virtual void reallyDetachFromIndexesTZTimestampType( cfbam::ICFBamTZTimestampTypeObj* Obj );
