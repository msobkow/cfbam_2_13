...
// Description: C++18 Instance Edit Object interface for CFBam UInt64Type.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamUInt64DefEditObj,
	  public virtual cfbam::ICFBamUInt64TypeObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamUInt64TypeEditObj();
		virtual ~ICFBamUInt64TypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamUInt64TypeBuff* getUInt64TypeBuff() {
			return( static_cast<cfbam::CFBamUInt64TypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamUInt64TypeBuff* getUInt64TypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamUInt64TypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamUInt64TypeObj* getOrigAsUInt64Type() = 0;
