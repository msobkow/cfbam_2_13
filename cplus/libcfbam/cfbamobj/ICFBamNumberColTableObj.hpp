...
namespace cfbam {
	...
	{
	public:
		ICFBamNumberColTableObj();
		virtual ~ICFBamNumberColTableObj();
		...
		virtual cfbam::ICFBamNumberColObj* newInstance() = 0;

		virtual cfbam::ICFBamNumberColEditObj* newEditInstance( cfbam::ICFBamNumberColObj* orig ) = 0;

		virtual cfbam::ICFBamNumberColObj* realizeNumberCol( cfbam::ICFBamNumberColObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeNumberCol( cfbam::ICFBamNumberColObj* Obj ) = 0;
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId ) = 0;
		virtual cfbam::ICFBamNumberColObj* createNumberCol( cfbam::ICFBamNumberColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamNumberColObj* readNumberCol( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamNumberColObj* lockNumberCol( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamNumberColObj*> readAllNumberCol( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamNumberColObj* readCachedNumberCol( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamNumberColObj*> readCachedNumberColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamNumberColObj* updateNumberCol( cfbam::ICFBamNumberColEditObj* Obj ) = 0;

		virtual void deleteNumberCol( cfbam::ICFBamNumberColEditObj* Obj ) = 0;
		...
		virtual void deleteNumberColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamNumberColObj* moveUpNumberCol( cfbam::ICFBamNumberColObj* Obj ) = 0;

		virtual cfbam::ICFBamNumberColObj* moveDownNumberCol( cfbam::ICFBamNumberColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesNumberCol( cfbam::ICFBamNumberColObj* Obj ) = 0;
