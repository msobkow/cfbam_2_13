...
// Description: C++18 base object instance specification for CFBam UInt16Col.
...
namespace cfbam {
	...
	class CFBamUInt16ColObj
	: public CFBamUInt16DefObj,
	  public virtual ICFBamUInt16ColObj
	{
	protected:
	public:
		...
		CFBamUInt16ColObj();
		CFBamUInt16ColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamUInt16ColObj();
