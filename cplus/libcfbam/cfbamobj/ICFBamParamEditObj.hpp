...
// Description: C++18 Instance Edit Object interface for CFBam Param.
...
namespace cfbam {
	...
	class ICFBamParamEditObj
	: public virtual cfbam::ICFBamParamObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamParamEditObj();
		virtual ~ICFBamParamEditObj();
		...
		virtual cfbam::ICFBamParamObj* getOrig() = 0;

		virtual cfbam::ICFBamParamObj* getOrigAsParam() = 0;
		...
		virtual cfbam::ICFBamParamObj* create() = 0;

		virtual cfbam::ICFBamParamEditObj* update() = 0;

		virtual cfbam::ICFBamParamEditObj* deleteInstance() = 0;
		...
		virtual void setRequiredContainerServerMeth( cfbam::ICFBamServerMethodObj* value ) = 0;
		...
		virtual void setOptionalLookupPrev( cfbam::ICFBamParamObj* value ) = 0;

		virtual cfbam::ICFBamParamObj* getOptionalLookupNext( bool forceRead = false ) = 0;
		virtual void setOptionalLookupNext( cfbam::ICFBamParamObj* value ) = 0;

		virtual cfbam::ICFBamValueObj* getRequiredLookupType( bool forceRead = false ) = 0;
		virtual void setRequiredLookupType( cfbam::ICFBamValueObj* value ) = 0;
