...
// Description: C++18 Instance Edit Object interface for CFBam TimestampDef.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamAtomEditObj,
	  public virtual cfbam::ICFBamTimestampDefObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamTimestampDefEditObj();
		virtual ~ICFBamTimestampDefEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamTimestampDefBuff* getTimestampDefBuff() {
			return( static_cast<cfbam::CFBamTimestampDefBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamTimestampDefBuff* getTimestampDefEditBuff() {
			return( dynamic_cast<cfbam::CFBamTimestampDefBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamTimestampDefObj* getOrigAsTimestampDef() = 0;
