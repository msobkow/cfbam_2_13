...
// Description: C++18 Instance Edit Object interface for CFBam DelSubDep1.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamDelDepEditObj,
	  public virtual cfbam::ICFBamDelSubDep1Obj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamDelSubDep1EditObj();
		virtual ~ICFBamDelSubDep1EditObj();
		...
		virtual cfbam::ICFBamDelSubDep1Obj* getOrigAsDelSubDep1() = 0;
		...
		virtual void setRequiredContainerDelTopDep( cfbam::ICFBamDelTopDepObj* value ) = 0;
