...
// Description: C++18 Instance Edit Object interface for CFBam IndexCol.
...
namespace cfbam {
	...
	class ICFBamIndexColEditObj
	: public virtual cfbam::ICFBamIndexColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamIndexColEditObj();
		virtual ~ICFBamIndexColEditObj();
		...
		virtual cfbam::ICFBamIndexColObj* getOrig() = 0;

		virtual cfbam::ICFBamIndexColObj* getOrigAsIndexCol() = 0;
		...
		virtual cfbam::ICFBamIndexColObj* create() = 0;

		virtual cfbam::ICFBamIndexColEditObj* update() = 0;

		virtual cfbam::ICFBamIndexColEditObj* deleteInstance() = 0;
		...
		virtual void setRequiredIsAscending( const bool value ) = 0;
		...
		virtual void setRequiredContainerIndex( cfbam::ICFBamIndexObj* value ) = 0;
		...
		virtual void setOptionalLookupPrev( cfbam::ICFBamIndexColObj* value ) = 0;

		virtual cfbam::ICFBamIndexColObj* getOptionalLookupNext( bool forceRead = false ) = 0;
		virtual void setOptionalLookupNext( cfbam::ICFBamIndexColObj* value ) = 0;

		virtual cfbam::ICFBamValueObj* getRequiredLookupColumn( bool forceRead = false ) = 0;
		virtual void setRequiredLookupColumn( cfbam::ICFBamValueObj* value ) = 0;
