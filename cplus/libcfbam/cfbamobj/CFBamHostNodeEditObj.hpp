...
// Description: C++18 edit object instance specification for CFBam HostNode.
...
namespace cfbam {
	...
	class CFBamHostNodeEditObj
	: public virtual ICFBamHostNodeEditObj,
	  public virtual cfsec::ICFSecHostNodeEditObj,
	  public virtual cfint::ICFIntHostNodeEditObj
	{
	public:
	...
	public:
		CFBamHostNodeEditObj( cfsec::ICFSecHostNodeObj* argOrig );
		virtual ~CFBamHostNodeEditObj();
