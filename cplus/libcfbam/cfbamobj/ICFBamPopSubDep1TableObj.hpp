...
namespace cfbam {
	...
	{
	public:
		ICFBamPopSubDep1TableObj();
		virtual ~ICFBamPopSubDep1TableObj();
		...
		virtual cfbam::ICFBamPopSubDep1Obj* newInstance() = 0;

		virtual cfbam::ICFBamPopSubDep1EditObj* newEditInstance( cfbam::ICFBamPopSubDep1Obj* orig ) = 0;

		virtual cfbam::ICFBamPopSubDep1Obj* realizePopSubDep1( cfbam::ICFBamPopSubDep1Obj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByTenantIdx( const int64_t TenantId ) = 0;
		virtual void reallyDeepDisposePopSubDep1( cfbam::ICFBamPopSubDep1Obj* Obj ) = 0;
		...
		virtual void deepDisposeByPopTopDepIdx( const int64_t PopTopDepTenantId,
			const int64_t PopTopDepId ) = 0;
		virtual void deepDisposeByUNameIdx( const int64_t PopTopDepTenantId,
			const int64_t PopTopDepId,
			const std::string& Name ) = 0;
		virtual cfbam::ICFBamPopSubDep1Obj* createPopSubDep1( cfbam::ICFBamPopSubDep1EditObj* Obj ) = 0;

		virtual cfbam::ICFBamPopSubDep1Obj* readPopSubDep1( cfbam::CFBamScopePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamPopSubDep1Obj* lockPopSubDep1( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamPopSubDep1Obj*> readAllPopSubDep1( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamPopSubDep1Obj* readCachedPopSubDep1( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual cfbam::ICFBamPopSubDep1Obj* readCachedPopSubDep1ByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamPopSubDep1Obj*> readCachedPopSubDep1ByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamPopSubDep1Obj* updatePopSubDep1( cfbam::ICFBamPopSubDep1EditObj* Obj ) = 0;

		virtual void deletePopSubDep1( cfbam::ICFBamPopSubDep1EditObj* Obj ) = 0;

		virtual void deletePopSubDep1ByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deletePopSubDep1ByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesPopSubDep1( cfbam::ICFBamPopSubDep1Obj* Obj ) = 0;
