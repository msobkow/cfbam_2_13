...
namespace cfbam {
	...
	class CFBamNmTokensTypeTableObj
	: public virtual ICFBamNmTokensTypeTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensTypeObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensTypeObj*>* allNmTokensType;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamNmTokensTypeObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensTypeObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensTypeObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensTypeObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensTypeObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensTypeObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensTypeObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensTypeObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamNmTokensTypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokensTypeObj*>*>* indexBySchemaIdx;
	...
	public:
		...
		CFBamNmTokensTypeTableObj();
		CFBamNmTokensTypeTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamNmTokensTypeTableObj();
		...
		virtual cfbam::ICFBamNmTokensTypeObj* newInstance();

		virtual cfbam::ICFBamNmTokensTypeEditObj* newEditInstance( cfbam::ICFBamNmTokensTypeObj* orig );

		virtual cfbam::ICFBamNmTokensTypeObj* realizeNmTokensType( cfbam::ICFBamNmTokensTypeObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeNmTokensType( cfbam::ICFBamNmTokensTypeObj* Obj );
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );
		virtual cfbam::ICFBamNmTokensTypeObj* createNmTokensType( cfbam::ICFBamNmTokensTypeEditObj* Obj );

		virtual cfbam::ICFBamNmTokensTypeObj* readNmTokensType( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamNmTokensTypeObj* lockNmTokensType( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamNmTokensTypeObj*> readAllNmTokensType( bool forceRead = false );

		virtual cfbam::ICFBamNmTokensTypeObj* readNmTokensTypeByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamNmTokensTypeObj* readNmTokensTypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokensTypeObj*> readNmTokensTypeByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokensTypeObj*> readNmTokensTypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokensTypeObj*> readNmTokensTypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokensTypeObj*> readNmTokensTypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokensTypeObj*> readNmTokensTypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokensTypeObj*> readNmTokensTypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokensTypeObj*> readNmTokensTypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokensTypeObj*> readNmTokensTypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId,
			bool forceRead = false );

		virtual cfbam::ICFBamNmTokensTypeObj* readCachedNmTokensType( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamNmTokensTypeObj* readCachedNmTokensTypeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamNmTokensTypeObj* readCachedNmTokensTypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamNmTokensTypeObj*> readCachedNmTokensTypeByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamNmTokensTypeObj*> readCachedNmTokensTypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamNmTokensTypeObj*> readCachedNmTokensTypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamNmTokensTypeObj*> readCachedNmTokensTypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamNmTokensTypeObj*> readCachedNmTokensTypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamNmTokensTypeObj*> readCachedNmTokensTypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamNmTokensTypeObj*> readCachedNmTokensTypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamNmTokensTypeObj*> readCachedNmTokensTypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual cfbam::ICFBamNmTokensTypeObj* updateNmTokensType( cfbam::ICFBamNmTokensTypeEditObj* Obj );

		virtual void deleteNmTokensType( cfbam::ICFBamNmTokensTypeEditObj* Obj );

		virtual void deleteNmTokensTypeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteNmTokensTypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteNmTokensTypeByValTentIdx( const int64_t TenantId );

		virtual void deleteNmTokensTypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteNmTokensTypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteNmTokensTypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteNmTokensTypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteNmTokensTypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteNmTokensTypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteNmTokensTypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual cfbam::ICFBamNmTokensTypeObj* moveUpNmTokensType( cfbam::ICFBamNmTokensTypeObj* Obj );

		virtual cfbam::ICFBamNmTokensTypeObj* moveDownNmTokensType( cfbam::ICFBamNmTokensTypeObj* Obj );

		virtual void reallyDetachFromIndexesNmTokensType( cfbam::ICFBamNmTokensTypeObj* Obj );
