...
// Description: C++18 base object instance specification for CFBam ServerListFunc.
...
namespace cfbam {
	...
	class CFBamServerListFuncObj
	: public CFBamServerMethodObj,
	  public virtual ICFBamServerListFuncObj
	{
	protected:
	public:
		...
		CFBamServerListFuncObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamServerListFuncObj();
