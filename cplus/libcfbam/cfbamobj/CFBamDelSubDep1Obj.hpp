...
// Description: C++18 base object instance specification for CFBam DelSubDep1.
...
namespace cfbam {
	...
	class CFBamDelSubDep1Obj
	: public CFBamDelDepObj,
	  public virtual ICFBamDelSubDep1Obj
	{
	protected:
	public:
		...
		CFBamDelSubDep1Obj();
		CFBamDelSubDep1Obj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamDelSubDep1Obj();
