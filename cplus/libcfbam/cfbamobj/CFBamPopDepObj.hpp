...
// Description: C++18 base object instance specification for CFBam PopDep.
...
namespace cfbam {
	...
	class CFBamPopDepObj
	: public CFBamScopeObj,
	  public virtual ICFBamPopDepObj
	{
	protected:
	public:
		...
		CFBamPopDepObj();
		CFBamPopDepObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamPopDepObj();
