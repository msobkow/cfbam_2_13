...
// Description: C++18 base object instance specification for CFBam DelSubDep2.
...
namespace cfbam {
	...
	class CFBamDelSubDep2Obj
	: public CFBamDelDepObj,
	  public virtual ICFBamDelSubDep2Obj
	{
	protected:
	public:
		...
		CFBamDelSubDep2Obj();
		CFBamDelSubDep2Obj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamDelSubDep2Obj();
