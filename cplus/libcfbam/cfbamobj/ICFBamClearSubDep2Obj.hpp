...
// Description: C++18 Object interface for CFBam ClearSubDep2.
...
namespace cfbam {
	...
	public:
		...
		virtual ~ICFBamClearSubDep2Obj();
		virtual cfbam::ICFBamScopeEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamClearSubDep2EditObj* getClearSubDep2Edit() = 0;

		inline cfbam::CFBamClearSubDep2Buff* getClearSubDep2Buff() {
			return( static_cast<cfbam::CFBamClearSubDep2Buff*>( getBuff() ) );
		};

		inline cfbam::CFBamClearSubDep2Buff* getClearSubDep2EditBuff() {
			return( dynamic_cast<cfbam::CFBamClearSubDep2Buff*>( getBuff() ) );
		};

		virtual const int64_t getRequiredClearSubDep1TenantId() = 0;
		virtual const int64_t* getRequiredClearSubDep1TenantIdReference() = 0;

		virtual const int64_t getRequiredClearSubDep1Id() = 0;
		virtual const int64_t* getRequiredClearSubDep1IdReference() = 0;

		virtual const std::string& getRequiredName() = 0;
		virtual const std::string* getRequiredNameReference() = 0;

		virtual cfbam::ICFBamClearSubDep1Obj* getRequiredContainerClearSubDep1( bool forceRead = false ) = 0;

		virtual std::vector<cfbam::ICFBamClearSubDep3Obj*> getOptionalComponentsClearDep( bool forceRead = false ) = 0;
