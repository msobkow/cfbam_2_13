...
// Description: C++18 Instance Edit Object interface for CFBam Int64Def.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamAtomEditObj,
	  public virtual cfbam::ICFBamInt64DefObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamInt64DefEditObj();
		virtual ~ICFBamInt64DefEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamInt64DefBuff* getInt64DefBuff() {
			return( static_cast<cfbam::CFBamInt64DefBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamInt64DefBuff* getInt64DefEditBuff() {
			return( dynamic_cast<cfbam::CFBamInt64DefBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamInt64DefObj* getOrigAsInt64Def() = 0;

		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual bool isOptionalInitValueNull() = 0;
		virtual const int64_t getOptionalInitValueValue() = 0;
		virtual const int64_t* getOptionalInitValueReference() = 0;
		virtual void setOptionalInitValueNull() = 0;
		virtual void setOptionalInitValueValue( const int64_t value ) = 0;

		virtual bool isOptionalMinValueNull() = 0;
		virtual const int64_t getOptionalMinValueValue() = 0;
		virtual const int64_t* getOptionalMinValueReference() = 0;
		virtual void setOptionalMinValueNull() = 0;
		virtual void setOptionalMinValueValue( const int64_t value ) = 0;

		virtual bool isOptionalMaxValueNull() = 0;
		virtual const int64_t getOptionalMaxValueValue() = 0;
		virtual const int64_t* getOptionalMaxValueReference() = 0;
		virtual void setOptionalMaxValueNull() = 0;
		virtual void setOptionalMaxValueValue( const int64_t value ) = 0;
