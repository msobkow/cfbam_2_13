...
// Description: C++18 Instance Edit Object interface for CFBam TZDateType.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamTZDateDefEditObj,
	  public virtual cfbam::ICFBamTZDateTypeObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamTZDateTypeEditObj();
		virtual ~ICFBamTZDateTypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamTZDateTypeBuff* getTZDateTypeBuff() {
			return( static_cast<cfbam::CFBamTZDateTypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamTZDateTypeBuff* getTZDateTypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamTZDateTypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamTZDateTypeObj* getOrigAsTZDateType() = 0;
