...
// Description: C++18 Instance Edit Object interface for CFBam Id16Gen.
...
namespace cfbam {
	...
	class ICFBamId16GenEditObj
	: public virtual cfbam::ICFBamInt16TypeEditObj,
	  public virtual cfbam::ICFBamId16GenObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamId16GenEditObj();
		virtual ~ICFBamId16GenEditObj();
		...
		virtual cfbam::ICFBamId16GenObj* getOrigAsId16Gen() = 0;
		...
		virtual void setRequiredBlockSize( const int16_t value ) = 0;
