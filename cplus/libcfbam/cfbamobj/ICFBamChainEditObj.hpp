...
// Description: C++18 Instance Edit Object interface for CFBam Chain.
...
namespace cfbam {
	...
	class ICFBamChainEditObj
	: public virtual cfbam::ICFBamChainObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamChainEditObj();
		virtual ~ICFBamChainEditObj();
		...
		virtual cfbam::ICFBamChainObj* getOrig() = 0;

		virtual cfbam::ICFBamChainObj* getOrigAsChain() = 0;
		...
		virtual cfbam::ICFBamChainObj* create() = 0;

		virtual cfbam::ICFBamChainEditObj* update() = 0;

		virtual cfbam::ICFBamChainEditObj* deleteInstance() = 0;
		...
		virtual void setRequiredContainerTable( cfbam::ICFBamTableObj* value ) = 0;
		...
		virtual void setRequiredLookupPrevRel( cfbam::ICFBamRelationObj* value ) = 0;

		virtual cfbam::ICFBamRelationObj* getRequiredLookupNextRel( bool forceRead = false ) = 0;
		virtual void setRequiredLookupNextRel( cfbam::ICFBamRelationObj* value ) = 0;
