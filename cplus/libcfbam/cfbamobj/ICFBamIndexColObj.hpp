...
// Description: C++18 Object interface for CFBam IndexCol.
...
namespace cfbam {
	...
	public:
		...
		virtual cfbam::ICFBamIndexColObj* realize() = 0;

		virtual cfbam::ICFBamIndexColObj* read( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamIndexColObj* moveUp() = 0;

		virtual cfbam::ICFBamIndexColObj* moveDown() = 0;

		virtual cfbam::ICFBamIndexColEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfbam::ICFBamIndexColEditObj* getEdit() = 0;

		virtual cfbam::ICFBamIndexColEditObj* getIndexColEdit() = 0;

		virtual cfbam::ICFBamIndexColTableObj* getIndexColTable() = 0;

		virtual cfbam::ICFBamSchemaObj* getSchema() = 0;

		virtual cfbam::CFBamIndexColBuff* getBuff() = 0;
		virtual void setBuff( cfbam::CFBamIndexColBuff* value ) = 0;

		inline cfbam::CFBamIndexColBuff* getIndexColBuff() {
			return( static_cast<cfbam::CFBamIndexColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamIndexColBuff* getIndexColEditBuff() {
			return( dynamic_cast<cfbam::CFBamIndexColBuff*>( getBuff() ) );
		};

		virtual cfbam::CFBamIndexColPKey* getPKey() = 0;
		virtual void setPKey( cfbam::CFBamIndexColPKey* value ) = 0;
		...
		virtual const int64_t getRequiredIndexId() = 0;
		virtual const int64_t* getRequiredIndexIdReference() = 0;
		...
		virtual const int64_t getRequiredColumnId() = 0;
		virtual const int64_t* getRequiredColumnIdReference() = 0;

		virtual const bool getRequiredIsAscending() = 0;
		virtual const bool* getRequiredIsAscendingReference() = 0;
		...
		virtual cfbam::ICFBamIndexObj* getRequiredContainerIndex( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamSchemaDefObj* getOptionalLookupDefSchema( bool forceRead = false ) = 0;

		virtual std::vector<cfbam::ICFBamRelationColObj*> getOptionalChildrenRefRelFromCol( bool forceRead = false ) = 0;

		virtual std::vector<cfbam::ICFBamRelationColObj*> getOptionalChildrenRefRelToCol( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamIndexColObj* getOptionalLookupPrev( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamIndexColObj* getOptionalLookupNext( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamValueObj* getRequiredLookupColumn( bool forceRead = false ) = 0;
