...
namespace cfbam {
	...
	class CFBamServerMethodTableObj
	: public virtual ICFBamServerMethodTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamServerMethodObj*>* members;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamServerMethodObj*>* allServerMethod;
		std::map< cfbam::CFBamScopeByTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamServerMethodObj*>*>* indexByTenantIdx;
		std::map< cfbam::CFBamServerMethodByUNameIdxKey,
			cfbam::ICFBamServerMethodObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamServerMethodByMethTableIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamServerMethodObj*>*>* indexByMethTableIdx;
		std::map< cfbam::CFBamServerMethodByDefSchemaIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamServerMethodObj*>*>* indexByDefSchemaIdx;
	...
	public:
		...
		CFBamServerMethodTableObj();
		CFBamServerMethodTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamServerMethodTableObj();
		...
		virtual cfbam::ICFBamServerMethodObj* newInstance();

		virtual cfbam::ICFBamServerMethodEditObj* newEditInstance( cfbam::ICFBamServerMethodObj* orig );

		virtual cfbam::ICFBamServerMethodObj* realizeServerMethod( cfbam::ICFBamServerMethodObj* Obj );

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id );
		virtual void deepDisposeByTenantIdx( const int64_t TenantId );
		virtual void reallyDeepDisposeServerMethod( cfbam::ICFBamServerMethodObj* Obj );
		...
		virtual cfbam::ICFBamServerMethodObj* createServerMethod( cfbam::ICFBamServerMethodEditObj* Obj );

		virtual cfbam::ICFBamServerMethodObj* readServerMethod( cfbam::CFBamScopePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamServerMethodObj* lockServerMethod( cfbam::CFBamScopePKey* pkey );

		virtual std::vector<cfbam::ICFBamServerMethodObj*> readAllServerMethod( bool forceRead = false );

		virtual cfbam::ICFBamServerMethodObj* readServerMethodByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamServerMethodObj*> readServerMethodByTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual cfbam::ICFBamServerMethodObj* readServerMethodByUNameIdx( const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamServerMethodObj*> readServerMethodByMethTableIdx( const int64_t TenantId,
			const int64_t TableId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamServerMethodObj*> readServerMethodByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual cfbam::ICFBamServerMethodObj* readCachedServerMethod( cfbam::CFBamScopePKey* pkey );

		virtual cfbam::ICFBamServerMethodObj* readCachedServerMethodByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual std::vector<cfbam::ICFBamServerMethodObj*> readCachedServerMethodByTenantIdx( const int64_t TenantId );

		virtual cfbam::ICFBamServerMethodObj* readCachedServerMethodByUNameIdx( const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamServerMethodObj*> readCachedServerMethodByMethTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual std::vector<cfbam::ICFBamServerMethodObj*> readCachedServerMethodByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual cfbam::ICFBamServerMethodObj* readServerMethodByLookupUNameIdx( const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name, bool forceRead = false );

		virtual cfbam::ICFBamServerMethodObj* readCachedServerMethodByLookupUNameIdx( const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name );

		virtual cfbam::ICFBamServerMethodObj* updateServerMethod( cfbam::ICFBamServerMethodEditObj* Obj );

		virtual void deleteServerMethod( cfbam::ICFBamServerMethodEditObj* Obj );

		virtual void deleteServerMethodByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteServerMethodByTenantIdx( const int64_t TenantId );

		virtual void deleteServerMethodByUNameIdx( const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name );

		virtual void deleteServerMethodByMethTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual void deleteServerMethodByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void reallyDetachFromIndexesServerMethod( cfbam::ICFBamServerMethodObj* Obj );
