...
// Description: C++18 base object instance specification for CFBam Param.
...
namespace cfbam {
	...
	class CFBamParamObj
	: public virtual ICFBamParamObj
	{
	protected:
		cfsec::ICFSecSecUserObj* createdBy = NULL;
		cfsec::ICFSecSecUserObj* updatedBy = NULL;
		bool isNew;
		cfbam::ICFBamParamEditObj* edit;
	...
	public:
		...
		CFBamParamObj();
		CFBamParamObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamParamObj();
		...
		virtual cfbam::ICFBamParamObj* realize();
		...
		virtual cfbam::ICFBamParamEditObj* beginEdit();
