...
namespace cfbam {
	...
	public:
		...
		virtual cfbam::ICFBamScopeObj* newInstance() = 0;

		virtual cfbam::ICFBamScopeEditObj* newEditInstance( cfbam::ICFBamScopeObj* orig ) = 0;

		virtual cfbam::ICFBamScopeObj* constructByClassCode( const classcode_t argClassCode ) = 0;

		virtual cfbam::ICFBamScopeObj* realizeScope( cfbam::ICFBamScopeObj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByTenantIdx( const int64_t TenantId ) = 0;
		virtual void reallyDeepDisposeScope( cfbam::ICFBamScopeObj* Obj ) = 0;
		virtual cfbam::ICFBamScopeObj* createScope( cfbam::ICFBamScopeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamScopeObj* readScope( cfbam::CFBamScopePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamScopeObj* lockScope( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamScopeObj*> readAllScope( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamScopeObj* readCachedScope( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual cfbam::ICFBamScopeObj* readCachedScopeByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamScopeObj*> readCachedScopeByTenantIdx( const int64_t TenantId ) = 0;

		virtual cfbam::ICFBamScopeObj* updateScope( cfbam::ICFBamScopeEditObj* Obj ) = 0;

		virtual void deleteScope( cfbam::ICFBamScopeEditObj* Obj ) = 0;

		virtual void deleteScopeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deleteScopeByTenantIdx( const int64_t TenantId ) = 0;

		virtual void reallyDetachFromIndexesScope( cfbam::ICFBamScopeObj* Obj ) = 0;
