...
namespace cfbam {
	...
	class CFBamClearSubDep1TableObj
	: public virtual ICFBamClearSubDep1TableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearSubDep1Obj*>* members;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearSubDep1Obj*>* allClearSubDep1;
		std::map< cfbam::CFBamScopeByTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearSubDep1Obj*>*>* indexByTenantIdx;
		std::map< cfbam::CFBamClearDepByClearDepIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearSubDep1Obj*>*>* indexByClearDepIdx;
		std::map< cfbam::CFBamClearDepByDefSchemaIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearSubDep1Obj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamClearSubDep1ByClearTopDepIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearSubDep1Obj*>*>* indexByClearTopDepIdx;
		std::map< cfbam::CFBamClearSubDep1ByUNameIdxKey,
			cfbam::ICFBamClearSubDep1Obj*>* indexByUNameIdx;
	...
	public:
		...
		CFBamClearSubDep1TableObj();
		CFBamClearSubDep1TableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamClearSubDep1TableObj();
		...
		virtual cfbam::ICFBamClearSubDep1Obj* newInstance();

		virtual cfbam::ICFBamClearSubDep1EditObj* newEditInstance( cfbam::ICFBamClearSubDep1Obj* orig );

		virtual cfbam::ICFBamClearSubDep1Obj* realizeClearSubDep1( cfbam::ICFBamClearSubDep1Obj* Obj );

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id );
		virtual void deepDisposeByTenantIdx( const int64_t TenantId );
		virtual void reallyDeepDisposeClearSubDep1( cfbam::ICFBamClearSubDep1Obj* Obj );
		...
		virtual void deepDisposeByClearTopDepIdx( const int64_t ClearTopDepTenantId,
			const int64_t ClearTopDepId );
		virtual void deepDisposeByUNameIdx( const int64_t ClearTopDepTenantId,
			const int64_t ClearTopDepId,
			const std::string& Name );
		virtual cfbam::ICFBamClearSubDep1Obj* createClearSubDep1( cfbam::ICFBamClearSubDep1EditObj* Obj );

		virtual cfbam::ICFBamClearSubDep1Obj* readClearSubDep1( cfbam::CFBamScopePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamClearSubDep1Obj* lockClearSubDep1( cfbam::CFBamScopePKey* pkey );

		virtual std::vector<cfbam::ICFBamClearSubDep1Obj*> readAllClearSubDep1( bool forceRead = false );

		virtual cfbam::ICFBamClearSubDep1Obj* readClearSubDep1ByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamClearSubDep1Obj*> readClearSubDep1ByTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamClearSubDep1Obj*> readClearSubDep1ByClearDepIdx( const int64_t TenantId,
			const int64_t RelationId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamClearSubDep1Obj*> readClearSubDep1ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamClearSubDep1Obj*> readClearSubDep1ByClearTopDepIdx( const int64_t ClearTopDepTenantId,
			const int64_t ClearTopDepId,
			bool forceRead = false );

		virtual cfbam::ICFBamClearSubDep1Obj* readClearSubDep1ByUNameIdx( const int64_t ClearTopDepTenantId,
			const int64_t ClearTopDepId,
			const std::string& Name, bool forceRead = false );

		virtual cfbam::ICFBamClearSubDep1Obj* readCachedClearSubDep1( cfbam::CFBamScopePKey* pkey );

		virtual cfbam::ICFBamClearSubDep1Obj* readCachedClearSubDep1ByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual std::vector<cfbam::ICFBamClearSubDep1Obj*> readCachedClearSubDep1ByTenantIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamClearSubDep1Obj*> readCachedClearSubDep1ByClearDepIdx( const int64_t TenantId,
			const int64_t RelationId );

		virtual std::vector<cfbam::ICFBamClearSubDep1Obj*> readCachedClearSubDep1ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamClearSubDep1Obj*> readCachedClearSubDep1ByClearTopDepIdx( const int64_t ClearTopDepTenantId,
			const int64_t ClearTopDepId );

		virtual cfbam::ICFBamClearSubDep1Obj* readCachedClearSubDep1ByUNameIdx( const int64_t ClearTopDepTenantId,
			const int64_t ClearTopDepId,
			const std::string& Name );

		virtual cfbam::ICFBamClearSubDep1Obj* updateClearSubDep1( cfbam::ICFBamClearSubDep1EditObj* Obj );

		virtual void deleteClearSubDep1( cfbam::ICFBamClearSubDep1EditObj* Obj );

		virtual void deleteClearSubDep1ByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteClearSubDep1ByTenantIdx( const int64_t TenantId );

		virtual void deleteClearSubDep1ByClearDepIdx( const int64_t TenantId,
			const int64_t RelationId );

		virtual void deleteClearSubDep1ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteClearSubDep1ByClearTopDepIdx( const int64_t ClearTopDepTenantId,
			const int64_t ClearTopDepId );

		virtual void deleteClearSubDep1ByUNameIdx( const int64_t ClearTopDepTenantId,
			const int64_t ClearTopDepId,
			const std::string& Name );

		virtual void reallyDetachFromIndexesClearSubDep1( cfbam::ICFBamClearSubDep1Obj* Obj );
