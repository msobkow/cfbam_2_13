...
namespace cfbam {
	...
	class CFBamInt64TypeTableObj
	: public virtual ICFBamInt64TypeTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64TypeObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64TypeObj*>* allInt64Type;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamInt64TypeObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64TypeObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64TypeObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64TypeObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64TypeObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64TypeObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64TypeObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64TypeObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamInt64TypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64TypeObj*>*>* indexBySchemaIdx;
	...
	public:
		...
		CFBamInt64TypeTableObj();
		CFBamInt64TypeTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamInt64TypeTableObj();
		...
		virtual cfbam::ICFBamInt64TypeObj* newInstance();

		virtual cfbam::ICFBamInt64TypeEditObj* newEditInstance( cfbam::ICFBamInt64TypeObj* orig );

		virtual cfbam::ICFBamInt64TypeObj* realizeInt64Type( cfbam::ICFBamInt64TypeObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeInt64Type( cfbam::ICFBamInt64TypeObj* Obj );
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );
		virtual cfbam::ICFBamInt64TypeObj* createInt64Type( cfbam::ICFBamInt64TypeEditObj* Obj );

		virtual cfbam::ICFBamInt64TypeObj* readInt64Type( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamInt64TypeObj* lockInt64Type( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamInt64TypeObj*> readAllInt64Type( bool forceRead = false );

		virtual cfbam::ICFBamInt64TypeObj* readInt64TypeByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamInt64TypeObj* readInt64TypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt64TypeObj*> readInt64TypeByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt64TypeObj*> readInt64TypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt64TypeObj*> readInt64TypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt64TypeObj*> readInt64TypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt64TypeObj*> readInt64TypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt64TypeObj*> readInt64TypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt64TypeObj*> readInt64TypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt64TypeObj*> readInt64TypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId,
			bool forceRead = false );

		virtual cfbam::ICFBamInt64TypeObj* readCachedInt64Type( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamInt64TypeObj* readCachedInt64TypeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamInt64TypeObj* readCachedInt64TypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamInt64TypeObj*> readCachedInt64TypeByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamInt64TypeObj*> readCachedInt64TypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamInt64TypeObj*> readCachedInt64TypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamInt64TypeObj*> readCachedInt64TypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamInt64TypeObj*> readCachedInt64TypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamInt64TypeObj*> readCachedInt64TypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamInt64TypeObj*> readCachedInt64TypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamInt64TypeObj*> readCachedInt64TypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual cfbam::ICFBamInt64TypeObj* updateInt64Type( cfbam::ICFBamInt64TypeEditObj* Obj );

		virtual void deleteInt64Type( cfbam::ICFBamInt64TypeEditObj* Obj );

		virtual void deleteInt64TypeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteInt64TypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteInt64TypeByValTentIdx( const int64_t TenantId );

		virtual void deleteInt64TypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteInt64TypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteInt64TypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteInt64TypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteInt64TypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteInt64TypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteInt64TypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual cfbam::ICFBamInt64TypeObj* moveUpInt64Type( cfbam::ICFBamInt64TypeObj* Obj );

		virtual cfbam::ICFBamInt64TypeObj* moveDownInt64Type( cfbam::ICFBamInt64TypeObj* Obj );

		virtual void reallyDetachFromIndexesInt64Type( cfbam::ICFBamInt64TypeObj* Obj );
