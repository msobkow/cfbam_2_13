...
namespace cfbam {
	...
	{
	public:
		ICFBamTimeDefTableObj();
		virtual ~ICFBamTimeDefTableObj();
		...
		virtual cfbam::ICFBamTimeDefObj* newInstance() = 0;

		virtual cfbam::ICFBamTimeDefEditObj* newEditInstance( cfbam::ICFBamTimeDefObj* orig ) = 0;

		virtual cfbam::ICFBamTimeDefObj* realizeTimeDef( cfbam::ICFBamTimeDefObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeTimeDef( cfbam::ICFBamTimeDefObj* Obj ) = 0;
		virtual cfbam::ICFBamTimeDefObj* createTimeDef( cfbam::ICFBamTimeDefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamTimeDefObj* readTimeDef( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTimeDefObj* lockTimeDef( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamTimeDefObj*> readAllTimeDef( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamTimeDefObj* readCachedTimeDef( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamTimeDefObj*> readCachedTimeDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTimeDefObj* updateTimeDef( cfbam::ICFBamTimeDefEditObj* Obj ) = 0;

		virtual void deleteTimeDef( cfbam::ICFBamTimeDefEditObj* Obj ) = 0;
		...
		virtual void deleteTimeDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTimeDefObj* moveUpTimeDef( cfbam::ICFBamTimeDefObj* Obj ) = 0;

		virtual cfbam::ICFBamTimeDefObj* moveDownTimeDef( cfbam::ICFBamTimeDefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesTimeDef( cfbam::ICFBamTimeDefObj* Obj ) = 0;
