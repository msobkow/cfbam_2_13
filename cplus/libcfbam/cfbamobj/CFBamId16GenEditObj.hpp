...
// Description: C++18 edit object instance specification for CFBam Id16Gen.
...
namespace cfbam {
	...
	class CFBamId16GenEditObj
	: public CFBamInt16TypeEditObj,
	  public virtual ICFBamId16GenEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamId16GenEditObj( cfbam::ICFBamId16GenObj* argOrig );
		virtual ~CFBamId16GenEditObj();
		...
		virtual cfbam::ICFBamId16GenTableObj* getId16GenTable();

		virtual cfbam::ICFBamId16GenEditObj* getId16GenEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamId16GenObj* getOrigAsId16Gen();
		...
		inline cfbam::CFBamId16GenBuff* getId16GenBuff() {
			...
			return( static_cast<cfbam::CFBamId16GenBuff*>( buff ) );
		};
		...
		virtual const int16_t getRequiredBlockSize();
		virtual const int16_t* getRequiredBlockSizeReference();
