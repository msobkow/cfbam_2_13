...
// Description: C++18 Object interface for CFBam Scope.
...
namespace cfbam {
	...
	public:
		...
		virtual cfbam::ICFBamScopeObj* realize() = 0;

		virtual cfbam::ICFBamScopeObj* read( bool forceRead = false ) = 0;

		virtual cfbam::ICFBamScopeEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfbam::ICFBamScopeEditObj* getEdit() = 0;

		virtual cfbam::ICFBamScopeEditObj* getScopeEdit() = 0;

		virtual cfbam::ICFBamScopeTableObj* getScopeTable() = 0;

		virtual cfbam::ICFBamSchemaObj* getSchema() = 0;

		virtual cfbam::CFBamScopeBuff* getBuff() = 0;
		virtual void setBuff( cfbam::CFBamScopeBuff* value ) = 0;

		inline cfbam::CFBamScopeBuff* getScopeBuff() {
			return( static_cast<cfbam::CFBamScopeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamScopeBuff* getScopeEditBuff() {
			return( dynamic_cast<cfbam::CFBamScopeBuff*>( getBuff() ) );
		};

		virtual cfbam::CFBamScopePKey* getPKey() = 0;
		virtual void setPKey( cfbam::CFBamScopePKey* value ) = 0;
