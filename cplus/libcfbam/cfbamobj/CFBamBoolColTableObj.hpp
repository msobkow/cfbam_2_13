...
namespace cfbam {
	...
	class CFBamBoolColTableObj
	: public virtual ICFBamBoolColTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBoolColObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBoolColObj*>* allBoolCol;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamBoolColObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBoolColObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBoolColObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBoolColObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBoolColObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBoolColObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBoolColObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBoolColObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamBoolColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBoolColObj*>*>* indexByTableIdx;
	...
	public:
		...
		CFBamBoolColTableObj();
		CFBamBoolColTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamBoolColTableObj();
		...
		virtual cfbam::ICFBamBoolColObj* newInstance();

		virtual cfbam::ICFBamBoolColEditObj* newEditInstance( cfbam::ICFBamBoolColObj* orig );

		virtual cfbam::ICFBamBoolColObj* realizeBoolCol( cfbam::ICFBamBoolColObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeBoolCol( cfbam::ICFBamBoolColObj* Obj );
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId );
		virtual cfbam::ICFBamBoolColObj* createBoolCol( cfbam::ICFBamBoolColEditObj* Obj );

		virtual cfbam::ICFBamBoolColObj* readBoolCol( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamBoolColObj* lockBoolCol( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamBoolColObj*> readAllBoolCol( bool forceRead = false );

		virtual cfbam::ICFBamBoolColObj* readBoolColByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamBoolColObj* readBoolColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamBoolColObj*> readBoolColByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamBoolColObj*> readBoolColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamBoolColObj*> readBoolColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamBoolColObj*> readBoolColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamBoolColObj*> readBoolColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamBoolColObj*> readBoolColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamBoolColObj*> readBoolColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamBoolColObj*> readBoolColByTableIdx( const int64_t TenantId,
			const int64_t TableId,
			bool forceRead = false );

		virtual cfbam::ICFBamBoolColObj* readCachedBoolCol( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamBoolColObj* readCachedBoolColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamBoolColObj* readCachedBoolColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamBoolColObj*> readCachedBoolColByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamBoolColObj*> readCachedBoolColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamBoolColObj*> readCachedBoolColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamBoolColObj*> readCachedBoolColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamBoolColObj*> readCachedBoolColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamBoolColObj*> readCachedBoolColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamBoolColObj*> readCachedBoolColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamBoolColObj*> readCachedBoolColByTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual cfbam::ICFBamBoolColObj* updateBoolCol( cfbam::ICFBamBoolColEditObj* Obj );

		virtual void deleteBoolCol( cfbam::ICFBamBoolColEditObj* Obj );

		virtual void deleteBoolColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteBoolColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteBoolColByValTentIdx( const int64_t TenantId );

		virtual void deleteBoolColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteBoolColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteBoolColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteBoolColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteBoolColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteBoolColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteBoolColByTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual cfbam::ICFBamBoolColObj* moveUpBoolCol( cfbam::ICFBamBoolColObj* Obj );

		virtual cfbam::ICFBamBoolColObj* moveDownBoolCol( cfbam::ICFBamBoolColObj* Obj );

		virtual void reallyDetachFromIndexesBoolCol( cfbam::ICFBamBoolColObj* Obj );
