...
// Description: C++18 edit object instance specification for CFBam SecGroupForm.
...
namespace cfbam {
	...
	class CFBamSecGroupFormEditObj
	: public virtual ICFBamSecGroupFormEditObj,
	  public virtual cfsec::ICFSecSecGroupFormEditObj,
	  public virtual cfint::ICFIntSecGroupFormEditObj
	{
	public:
	...
	public:
		CFBamSecGroupFormEditObj( cfsec::ICFSecSecGroupFormObj* argOrig );
		virtual ~CFBamSecGroupFormEditObj();
