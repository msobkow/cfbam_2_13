...
// Description: C++18 base object instance specification for CFBam TimestampDef.
...
namespace cfbam {
	...
	class CFBamTimestampDefObj
	: public CFBamAtomObj,
	  public virtual ICFBamTimestampDefObj
	{
	protected:
	public:
		...
		CFBamTimestampDefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTimestampDefObj();
