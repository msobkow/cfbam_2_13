...
namespace cfbam {
	...
	class CFBamISOCcyTableObj
	: public virtual ICFBamISOCcyTableObj,
	  public virtual cfsec::ICFSecISOCcyTableObj,
	  public virtual cfint::ICFIntISOCcyTableObj
	{
	protected:
	...
	public:
		...
		CFBamISOCcyTableObj();
		CFBamISOCcyTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamISOCcyTableObj();
