...
namespace cfbam {
	...
	{
	public:
		ICFBamSchemaRefTableObj();
		virtual ~ICFBamSchemaRefTableObj();
		...
		virtual cfbam::ICFBamSchemaRefObj* newInstance() = 0;

		virtual cfbam::ICFBamSchemaRefEditObj* newEditInstance( cfbam::ICFBamSchemaRefObj* orig ) = 0;

		virtual cfbam::ICFBamSchemaRefObj* realizeSchemaRef( cfbam::ICFBamSchemaRefObj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByTenantIdx( const int64_t TenantId ) = 0;
		virtual void reallyDeepDisposeSchemaRef( cfbam::ICFBamSchemaRefObj* Obj ) = 0;
		...
		virtual cfbam::ICFBamSchemaRefObj* createSchemaRef( cfbam::ICFBamSchemaRefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamSchemaRefObj* readSchemaRef( cfbam::CFBamScopePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamSchemaRefObj* lockSchemaRef( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamSchemaRefObj*> readAllSchemaRef( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamSchemaRefObj* readCachedSchemaRef( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual cfbam::ICFBamSchemaRefObj* readCachedSchemaRefByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamSchemaRefObj*> readCachedSchemaRefByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamSchemaRefObj* updateSchemaRef( cfbam::ICFBamSchemaRefEditObj* Obj ) = 0;

		virtual void deleteSchemaRef( cfbam::ICFBamSchemaRefEditObj* Obj ) = 0;

		virtual void deleteSchemaRefByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deleteSchemaRefByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamSchemaRefObj* moveUpSchemaRef( cfbam::ICFBamSchemaRefObj* Obj ) = 0;

		virtual cfbam::ICFBamSchemaRefObj* moveDownSchemaRef( cfbam::ICFBamSchemaRefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesSchemaRef( cfbam::ICFBamSchemaRefObj* Obj ) = 0;
