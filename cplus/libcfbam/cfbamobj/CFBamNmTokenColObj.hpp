...
// Description: C++18 base object instance specification for CFBam NmTokenCol.
...
namespace cfbam {
	...
	class CFBamNmTokenColObj
	: public CFBamNmTokenDefObj,
	  public virtual ICFBamNmTokenColObj
	{
	protected:
	public:
		...
		CFBamNmTokenColObj();
		CFBamNmTokenColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamNmTokenColObj();
