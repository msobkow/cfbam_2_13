...
// Description: C++18 edit object instance specification for CFBam TextType.
...
namespace cfbam {
	...
	class CFBamTextTypeEditObj
	: public CFBamTextDefEditObj,
	  public virtual ICFBamTextTypeEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamTextTypeEditObj( cfbam::ICFBamTextTypeObj* argOrig );
		virtual ~CFBamTextTypeEditObj();
		...
		virtual cfbam::ICFBamTextTypeTableObj* getTextTypeTable();

		virtual cfbam::ICFBamTextTypeEditObj* getTextTypeEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamTextTypeObj* getOrigAsTextType();

		virtual cfbam::CFBamValueBuff* getBuff();
		virtual void setBuff( cfbam::CFBamValueBuff* value );

		inline cfbam::CFBamTextTypeBuff* getTextTypeBuff() {
			// Buff is always instantiated when constructed over an original object
			return( static_cast<cfbam::CFBamTextTypeBuff*>( buff ) );
		};

		inline cfbam::CFBamTextTypeBuff* getTextTypeEditBuff() {
			// Buff is always instantiated when constructed over an original object
