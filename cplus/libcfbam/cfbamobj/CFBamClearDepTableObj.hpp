...
namespace cfbam {
	...
	class CFBamClearDepTableObj
	: public virtual ICFBamClearDepTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearDepObj*>* members;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearDepObj*>* allClearDep;
		std::map< cfbam::CFBamScopeByTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearDepObj*>*>* indexByTenantIdx;
		std::map< cfbam::CFBamClearDepByClearDepIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearDepObj*>*>* indexByClearDepIdx;
		std::map< cfbam::CFBamClearDepByDefSchemaIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamClearDepObj*>*>* indexByDefSchemaIdx;
	...
	public:
		...
		CFBamClearDepTableObj();
		CFBamClearDepTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamClearDepTableObj();
		...
		virtual cfbam::ICFBamClearDepObj* newInstance();

		virtual cfbam::ICFBamClearDepEditObj* newEditInstance( cfbam::ICFBamClearDepObj* orig );

		virtual cfbam::ICFBamClearDepObj* realizeClearDep( cfbam::ICFBamClearDepObj* Obj );

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id );
		virtual void deepDisposeByTenantIdx( const int64_t TenantId );
		virtual void reallyDeepDisposeClearDep( cfbam::ICFBamClearDepObj* Obj );
		...
		virtual cfbam::ICFBamClearDepObj* createClearDep( cfbam::ICFBamClearDepEditObj* Obj );

		virtual cfbam::ICFBamClearDepObj* readClearDep( cfbam::CFBamScopePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamClearDepObj* lockClearDep( cfbam::CFBamScopePKey* pkey );

		virtual std::vector<cfbam::ICFBamClearDepObj*> readAllClearDep( bool forceRead = false );

		virtual cfbam::ICFBamClearDepObj* readClearDepByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamClearDepObj*> readClearDepByTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamClearDepObj*> readClearDepByClearDepIdx( const int64_t TenantId,
			const int64_t RelationId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamClearDepObj*> readClearDepByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual cfbam::ICFBamClearDepObj* readCachedClearDep( cfbam::CFBamScopePKey* pkey );

		virtual cfbam::ICFBamClearDepObj* readCachedClearDepByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual std::vector<cfbam::ICFBamClearDepObj*> readCachedClearDepByTenantIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamClearDepObj*> readCachedClearDepByClearDepIdx( const int64_t TenantId,
			const int64_t RelationId );

		virtual std::vector<cfbam::ICFBamClearDepObj*> readCachedClearDepByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual cfbam::ICFBamClearDepObj* updateClearDep( cfbam::ICFBamClearDepEditObj* Obj );

		virtual void deleteClearDep( cfbam::ICFBamClearDepEditObj* Obj );

		virtual void deleteClearDepByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteClearDepByTenantIdx( const int64_t TenantId );

		virtual void deleteClearDepByClearDepIdx( const int64_t TenantId,
			const int64_t RelationId );

		virtual void deleteClearDepByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void reallyDetachFromIndexesClearDep( cfbam::ICFBamClearDepObj* Obj );
