...
namespace cfbam {
	...
	{
	public:
		ICFBamTZTimeTypeTableObj();
		virtual ~ICFBamTZTimeTypeTableObj();
		...
		virtual cfbam::ICFBamTZTimeTypeObj* newInstance() = 0;

		virtual cfbam::ICFBamTZTimeTypeEditObj* newEditInstance( cfbam::ICFBamTZTimeTypeObj* orig ) = 0;

		virtual cfbam::ICFBamTZTimeTypeObj* realizeTZTimeType( cfbam::ICFBamTZTimeTypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeTZTimeType( cfbam::ICFBamTZTimeTypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamTZTimeTypeObj* createTZTimeType( cfbam::ICFBamTZTimeTypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamTZTimeTypeObj* readTZTimeType( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTZTimeTypeObj* lockTZTimeType( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamTZTimeTypeObj*> readAllTZTimeType( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamTZTimeTypeObj* readCachedTZTimeType( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamTZTimeTypeObj*> readCachedTZTimeTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTZTimeTypeObj* updateTZTimeType( cfbam::ICFBamTZTimeTypeEditObj* Obj ) = 0;

		virtual void deleteTZTimeType( cfbam::ICFBamTZTimeTypeEditObj* Obj ) = 0;
		...
		virtual void deleteTZTimeTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTZTimeTypeObj* moveUpTZTimeType( cfbam::ICFBamTZTimeTypeObj* Obj ) = 0;

		virtual cfbam::ICFBamTZTimeTypeObj* moveDownTZTimeType( cfbam::ICFBamTZTimeTypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesTZTimeType( cfbam::ICFBamTZTimeTypeObj* Obj ) = 0;
