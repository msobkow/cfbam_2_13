...
namespace cfbam {
	...
	class CFBamEnumTagTableObj
	: public virtual ICFBamEnumTagTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamEnumTagPKey, cfbam::ICFBamEnumTagObj*>* members;
		std::map<cfbam::CFBamEnumTagPKey, cfbam::ICFBamEnumTagObj*>* allEnumTag;
		std::map< cfbam::CFBamEnumTagByEnumTagTenantIdxKey,
			std::map<cfbam::CFBamEnumTagPKey, cfbam::ICFBamEnumTagObj*>*>* indexByEnumTagTenantIdx;
		std::map< cfbam::CFBamEnumTagByEnumIdxKey,
			std::map<cfbam::CFBamEnumTagPKey, cfbam::ICFBamEnumTagObj*>*>* indexByEnumIdx;
		std::map< cfbam::CFBamEnumTagByDefSchemaIdxKey,
			std::map<cfbam::CFBamEnumTagPKey, cfbam::ICFBamEnumTagObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamEnumTagByEnumNameIdxKey,
			cfbam::ICFBamEnumTagObj*>* indexByEnumNameIdx;
		std::map< cfbam::CFBamEnumTagByPrevIdxKey,
			std::map<cfbam::CFBamEnumTagPKey, cfbam::ICFBamEnumTagObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamEnumTagByNextIdxKey,
			std::map<cfbam::CFBamEnumTagPKey, cfbam::ICFBamEnumTagObj*>*>* indexByNextIdx;
	...
	public:
		...
		CFBamEnumTagTableObj();
		CFBamEnumTagTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamEnumTagTableObj();
		...
		virtual cfbam::ICFBamEnumTagObj* newInstance();

		virtual cfbam::ICFBamEnumTagEditObj* newEditInstance( cfbam::ICFBamEnumTagObj* orig );

		virtual cfbam::ICFBamEnumTagObj* realizeEnumTag( cfbam::ICFBamEnumTagObj* Obj );

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id );
		virtual void deepDisposeByEnumTagTenantIdx( const int64_t TenantId );
		virtual void deepDisposeByEnumIdx( const int64_t TenantId,
			const int64_t EnumId );
		virtual void deepDisposeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );
		virtual void deepDisposeByEnumNameIdx( const int64_t TenantId,
			const int64_t EnumId,
		...
		virtual void reallyDeepDisposeEnumTag( cfbam::ICFBamEnumTagObj* Obj );
		virtual cfbam::ICFBamEnumTagObj* createEnumTag( cfbam::ICFBamEnumTagEditObj* Obj );

		virtual cfbam::ICFBamEnumTagObj* readEnumTag( cfbam::CFBamEnumTagPKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamEnumTagObj* lockEnumTag( cfbam::CFBamEnumTagPKey* pkey );

		virtual std::vector<cfbam::ICFBamEnumTagObj*> readAllEnumTag( bool forceRead = false );

		virtual cfbam::ICFBamEnumTagObj* readEnumTagByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamEnumTagObj*> readEnumTagByEnumTagTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamEnumTagObj*> readEnumTagByEnumIdx( const int64_t TenantId,
			const int64_t EnumId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamEnumTagObj*> readEnumTagByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual cfbam::ICFBamEnumTagObj* readEnumTagByEnumNameIdx( const int64_t TenantId,
			const int64_t EnumId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamEnumTagObj*> readEnumTagByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamEnumTagObj*> readEnumTagByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual cfbam::ICFBamEnumTagObj* readCachedEnumTag( cfbam::CFBamEnumTagPKey* pkey );

		virtual cfbam::ICFBamEnumTagObj* readCachedEnumTagByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual std::vector<cfbam::ICFBamEnumTagObj*> readCachedEnumTagByEnumTagTenantIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamEnumTagObj*> readCachedEnumTagByEnumIdx( const int64_t TenantId,
			const int64_t EnumId );

		virtual std::vector<cfbam::ICFBamEnumTagObj*> readCachedEnumTagByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual cfbam::ICFBamEnumTagObj* readCachedEnumTagByEnumNameIdx( const int64_t TenantId,
			const int64_t EnumId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamEnumTagObj*> readCachedEnumTagByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamEnumTagObj*> readCachedEnumTagByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual cfbam::ICFBamEnumTagObj* updateEnumTag( cfbam::ICFBamEnumTagEditObj* Obj );

		virtual void deleteEnumTag( cfbam::ICFBamEnumTagEditObj* Obj );

		virtual void deleteEnumTagByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteEnumTagByEnumTagTenantIdx( const int64_t TenantId );

		virtual void deleteEnumTagByEnumIdx( const int64_t TenantId,
			const int64_t EnumId );

		virtual void deleteEnumTagByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteEnumTagByEnumNameIdx( const int64_t TenantId,
			const int64_t EnumId,
			const std::string& Name );

		virtual void deleteEnumTagByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteEnumTagByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual cfbam::ICFBamEnumTagObj* moveUpEnumTag( cfbam::ICFBamEnumTagObj* Obj );

		virtual cfbam::ICFBamEnumTagObj* moveDownEnumTag( cfbam::ICFBamEnumTagObj* Obj );

		virtual void reallyDetachFromIndexesEnumTag( cfbam::ICFBamEnumTagObj* Obj );
