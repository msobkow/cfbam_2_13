...
// Description: C++18 edit object instance specification for CFBam DateCol.
...
namespace cfbam {
	...
	class CFBamDateColEditObj
	: public CFBamDateDefEditObj,
	  public virtual ICFBamDateColEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamDateColEditObj( cfbam::ICFBamDateColObj* argOrig );
		virtual ~CFBamDateColEditObj();
		...
		virtual cfbam::ICFBamDateColTableObj* getDateColTable();

		virtual cfbam::ICFBamDateColEditObj* getDateColEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamDateColObj* getOrigAsDateCol();
		...
		inline cfbam::CFBamDateColBuff* getDateColBuff() {
			...
			return( static_cast<cfbam::CFBamDateColBuff*>( buff ) );
		};
