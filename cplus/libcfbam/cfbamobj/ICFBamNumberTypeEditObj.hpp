...
// Description: C++18 Instance Edit Object interface for CFBam NumberType.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamNumberDefEditObj,
	  public virtual cfbam::ICFBamNumberTypeObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamNumberTypeEditObj();
		virtual ~ICFBamNumberTypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamNumberTypeBuff* getNumberTypeBuff() {
			return( static_cast<cfbam::CFBamNumberTypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamNumberTypeBuff* getNumberTypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamNumberTypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamNumberTypeObj* getOrigAsNumberType() = 0;
