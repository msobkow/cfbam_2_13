...
// Description: C++18 Instance Edit Object interface for CFBam DoubleCol.
...
namespace cfbam {
	...
	class ICFBamDoubleColEditObj
	: public virtual cfbam::ICFBamDoubleDefEditObj,
	  public virtual cfbam::ICFBamDoubleColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamDoubleColEditObj();
		virtual ~ICFBamDoubleColEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamDoubleColBuff* getDoubleColBuff() {
			return( static_cast<cfbam::CFBamDoubleColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamDoubleColBuff* getDoubleColEditBuff() {
			return( dynamic_cast<cfbam::CFBamDoubleColBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamDoubleColObj* getOrigAsDoubleCol() = 0;
