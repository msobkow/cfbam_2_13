...
// Description: C++18 Instance Edit Object interface for CFBam Int16Def.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamAtomEditObj,
	  public virtual cfbam::ICFBamInt16DefObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamInt16DefEditObj();
		virtual ~ICFBamInt16DefEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamInt16DefBuff* getInt16DefBuff() {
			return( static_cast<cfbam::CFBamInt16DefBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamInt16DefBuff* getInt16DefEditBuff() {
			return( dynamic_cast<cfbam::CFBamInt16DefBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamInt16DefObj* getOrigAsInt16Def() = 0;

		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual bool isOptionalInitValueNull() = 0;
		virtual const int16_t getOptionalInitValueValue() = 0;
		virtual const int16_t* getOptionalInitValueReference() = 0;
		virtual void setOptionalInitValueNull() = 0;
		virtual void setOptionalInitValueValue( const int16_t value ) = 0;

		virtual bool isOptionalMinValueNull() = 0;
		virtual const int16_t getOptionalMinValueValue() = 0;
		virtual const int16_t* getOptionalMinValueReference() = 0;
		virtual void setOptionalMinValueNull() = 0;
		virtual void setOptionalMinValueValue( const int16_t value ) = 0;

		virtual bool isOptionalMaxValueNull() = 0;
		virtual const int16_t getOptionalMaxValueValue() = 0;
		virtual const int16_t* getOptionalMaxValueReference() = 0;
		virtual void setOptionalMaxValueNull() = 0;
		virtual void setOptionalMaxValueValue( const int16_t value ) = 0;
