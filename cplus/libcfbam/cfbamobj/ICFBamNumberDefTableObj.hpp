...
namespace cfbam {
	...
	{
	public:
		ICFBamNumberDefTableObj();
		virtual ~ICFBamNumberDefTableObj();
		...
		virtual cfbam::ICFBamNumberDefObj* newInstance() = 0;

		virtual cfbam::ICFBamNumberDefEditObj* newEditInstance( cfbam::ICFBamNumberDefObj* orig ) = 0;

		virtual cfbam::ICFBamNumberDefObj* realizeNumberDef( cfbam::ICFBamNumberDefObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeNumberDef( cfbam::ICFBamNumberDefObj* Obj ) = 0;
		virtual cfbam::ICFBamNumberDefObj* createNumberDef( cfbam::ICFBamNumberDefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamNumberDefObj* readNumberDef( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamNumberDefObj* lockNumberDef( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamNumberDefObj*> readAllNumberDef( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamNumberDefObj* readCachedNumberDef( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamNumberDefObj*> readCachedNumberDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamNumberDefObj* updateNumberDef( cfbam::ICFBamNumberDefEditObj* Obj ) = 0;

		virtual void deleteNumberDef( cfbam::ICFBamNumberDefEditObj* Obj ) = 0;
		...
		virtual void deleteNumberDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamNumberDefObj* moveUpNumberDef( cfbam::ICFBamNumberDefObj* Obj ) = 0;

		virtual cfbam::ICFBamNumberDefObj* moveDownNumberDef( cfbam::ICFBamNumberDefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesNumberDef( cfbam::ICFBamNumberDefObj* Obj ) = 0;
