...
// Description: C++18 Instance Edit Object interface for CFBam UuidGen.
...
namespace cfbam {
	...
	class ICFBamUuidGenEditObj
	: public virtual cfbam::ICFBamUuidTypeEditObj,
	  public virtual cfbam::ICFBamUuidGenObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamUuidGenEditObj();
		virtual ~ICFBamUuidGenEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamUuidGenBuff* getUuidGenBuff() {
			return( static_cast<cfbam::CFBamUuidGenBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamUuidGenBuff* getUuidGenEditBuff() {
			return( dynamic_cast<cfbam::CFBamUuidGenBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamUuidGenObj* getOrigAsUuidGen() = 0;
