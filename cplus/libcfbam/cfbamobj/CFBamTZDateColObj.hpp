...
// Description: C++18 base object instance specification for CFBam TZDateCol.
...
namespace cfbam {
	...
	class CFBamTZDateColObj
	: public CFBamTZDateDefObj,
	  public virtual ICFBamTZDateColObj
	{
	protected:
	public:
		...
		CFBamTZDateColObj();
		CFBamTZDateColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTZDateColObj();
