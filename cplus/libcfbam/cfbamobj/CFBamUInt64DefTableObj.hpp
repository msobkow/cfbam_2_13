...
namespace cfbam {
	...
	class CFBamUInt64DefTableObj
	: public virtual ICFBamUInt64DefTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64DefObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64DefObj*>* allUInt64Def;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamUInt64DefObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64DefObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64DefObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64DefObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64DefObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64DefObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64DefObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt64DefObj*>*>* indexByContNextIdx;
	...
	public:
		...
		CFBamUInt64DefTableObj();
		CFBamUInt64DefTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamUInt64DefTableObj();
		...
		virtual cfbam::ICFBamUInt64DefObj* newInstance();

		virtual cfbam::ICFBamUInt64DefEditObj* newEditInstance( cfbam::ICFBamUInt64DefObj* orig );

		virtual cfbam::ICFBamUInt64DefObj* realizeUInt64Def( cfbam::ICFBamUInt64DefObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeUInt64Def( cfbam::ICFBamUInt64DefObj* Obj );
		virtual cfbam::ICFBamUInt64DefObj* createUInt64Def( cfbam::ICFBamUInt64DefEditObj* Obj );

		virtual cfbam::ICFBamUInt64DefObj* readUInt64Def( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamUInt64DefObj* lockUInt64Def( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamUInt64DefObj*> readAllUInt64Def( bool forceRead = false );

		virtual cfbam::ICFBamUInt64DefObj* readUInt64DefByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamUInt64DefObj* readUInt64DefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt64DefObj*> readUInt64DefByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt64DefObj*> readUInt64DefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt64DefObj*> readUInt64DefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt64DefObj*> readUInt64DefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt64DefObj*> readUInt64DefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt64DefObj*> readUInt64DefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt64DefObj*> readUInt64DefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual cfbam::ICFBamUInt64DefObj* readCachedUInt64Def( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamUInt64DefObj* readCachedUInt64DefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamUInt64DefObj* readCachedUInt64DefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamUInt64DefObj*> readCachedUInt64DefByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamUInt64DefObj*> readCachedUInt64DefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamUInt64DefObj*> readCachedUInt64DefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamUInt64DefObj*> readCachedUInt64DefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamUInt64DefObj*> readCachedUInt64DefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamUInt64DefObj*> readCachedUInt64DefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamUInt64DefObj*> readCachedUInt64DefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamUInt64DefObj* updateUInt64Def( cfbam::ICFBamUInt64DefEditObj* Obj );

		virtual void deleteUInt64Def( cfbam::ICFBamUInt64DefEditObj* Obj );

		virtual void deleteUInt64DefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteUInt64DefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteUInt64DefByValTentIdx( const int64_t TenantId );

		virtual void deleteUInt64DefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteUInt64DefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteUInt64DefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteUInt64DefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteUInt64DefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteUInt64DefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamUInt64DefObj* moveUpUInt64Def( cfbam::ICFBamUInt64DefObj* Obj );

		virtual cfbam::ICFBamUInt64DefObj* moveDownUInt64Def( cfbam::ICFBamUInt64DefObj* Obj );

		virtual void reallyDetachFromIndexesUInt64Def( cfbam::ICFBamUInt64DefObj* Obj );
