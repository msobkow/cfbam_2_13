...
namespace cfbam {
	...
	class CFBamSecGroupTableObj
	: public virtual ICFBamSecGroupTableObj,
	  public virtual cfsec::ICFSecSecGroupTableObj,
	  public virtual cfint::ICFIntSecGroupTableObj
	{
	protected:
	...
	public:
		...
		CFBamSecGroupTableObj();
		CFBamSecGroupTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamSecGroupTableObj();
