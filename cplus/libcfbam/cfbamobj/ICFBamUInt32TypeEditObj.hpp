...
// Description: C++18 Instance Edit Object interface for CFBam UInt32Type.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamUInt32DefEditObj,
	  public virtual cfbam::ICFBamUInt32TypeObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamUInt32TypeEditObj();
		virtual ~ICFBamUInt32TypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamUInt32TypeBuff* getUInt32TypeBuff() {
			return( static_cast<cfbam::CFBamUInt32TypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamUInt32TypeBuff* getUInt32TypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamUInt32TypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamUInt32TypeObj* getOrigAsUInt32Type() = 0;
