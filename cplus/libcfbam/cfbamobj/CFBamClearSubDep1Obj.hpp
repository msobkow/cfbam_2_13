...
// Description: C++18 base object instance specification for CFBam ClearSubDep1.
...
namespace cfbam {
	...
	class CFBamClearSubDep1Obj
	: public CFBamClearDepObj,
	  public virtual ICFBamClearSubDep1Obj
	{
	protected:
	public:
		...
		CFBamClearSubDep1Obj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamClearSubDep1Obj();
