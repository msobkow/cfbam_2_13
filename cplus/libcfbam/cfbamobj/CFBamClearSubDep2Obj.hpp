...
// Description: C++18 base object instance specification for CFBam ClearSubDep2.
...
namespace cfbam {
	...
	class CFBamClearSubDep2Obj
	: public CFBamClearDepObj,
	  public virtual ICFBamClearSubDep2Obj
	{
	protected:
	public:
		...
		CFBamClearSubDep2Obj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamClearSubDep2Obj();
