...
// Description: C++18 edit object instance specification for CFBam TextCol.
...
namespace cfbam {
	...
	class CFBamTextColEditObj
	: public CFBamTextDefEditObj,
	  public virtual ICFBamTextColEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamTextColEditObj( cfbam::ICFBamTextColObj* argOrig );
		virtual ~CFBamTextColEditObj();
		...
		virtual cfbam::ICFBamTextColTableObj* getTextColTable();

		virtual cfbam::ICFBamTextColEditObj* getTextColEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamTextColObj* getOrigAsTextCol();
		...
		inline cfbam::CFBamTextColBuff* getTextColBuff() {
			...
			return( static_cast<cfbam::CFBamTextColBuff*>( buff ) );
		};
