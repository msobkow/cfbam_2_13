...
namespace cfbam {
	...
	{
	public:
		ICFBamId32GenTableObj();
		virtual ~ICFBamId32GenTableObj();
		...
		virtual cfbam::ICFBamId32GenObj* newInstance() = 0;

		virtual cfbam::ICFBamId32GenEditObj* newEditInstance( cfbam::ICFBamId32GenObj* orig ) = 0;

		virtual cfbam::ICFBamId32GenObj* realizeId32Gen( cfbam::ICFBamId32GenObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeId32Gen( cfbam::ICFBamId32GenObj* Obj ) = 0;
		...
		virtual cfbam::ICFBamId32GenObj* createId32Gen( cfbam::ICFBamId32GenEditObj* Obj ) = 0;

		virtual cfbam::ICFBamId32GenObj* readId32Gen( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamId32GenObj* lockId32Gen( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamId32GenObj*> readAllId32Gen( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamId32GenObj* readCachedId32Gen( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamId32GenObj*> readCachedId32GenByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamId32GenObj* updateId32Gen( cfbam::ICFBamId32GenEditObj* Obj ) = 0;

		virtual void deleteId32Gen( cfbam::ICFBamId32GenEditObj* Obj ) = 0;
		...
		virtual void deleteId32GenByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamId32GenObj* moveUpId32Gen( cfbam::ICFBamId32GenObj* Obj ) = 0;

		virtual cfbam::ICFBamId32GenObj* moveDownId32Gen( cfbam::ICFBamId32GenObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesId32Gen( cfbam::ICFBamId32GenObj* Obj ) = 0;
