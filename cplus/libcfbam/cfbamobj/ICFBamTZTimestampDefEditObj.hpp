...
// Description: C++18 Instance Edit Object interface for CFBam TZTimestampDef.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamAtomEditObj,
	  public virtual cfbam::ICFBamTZTimestampDefObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamTZTimestampDefEditObj();
		virtual ~ICFBamTZTimestampDefEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamTZTimestampDefBuff* getTZTimestampDefBuff() {
			return( static_cast<cfbam::CFBamTZTimestampDefBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamTZTimestampDefBuff* getTZTimestampDefEditBuff() {
			return( dynamic_cast<cfbam::CFBamTZTimestampDefBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamTZTimestampDefObj* getOrigAsTZTimestampDef() = 0;

		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual bool isOptionalDummyNull() = 0;
		virtual const std::string& getOptionalDummyValue() = 0;
		virtual const std::string* getOptionalDummyReference() = 0;
		virtual void setOptionalDummyNull() = 0;
		virtual void setOptionalDummyValue( const std::string& value ) = 0;
