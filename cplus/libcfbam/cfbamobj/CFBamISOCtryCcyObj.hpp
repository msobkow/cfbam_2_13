...
// Description: C++18 base object instance specification for CFBam ISOCtryCcy.
...
namespace cfbam {
	...
	class CFBamISOCtryCcyObj
	: public virtual ICFBamISOCtryCcyObj,
	...
	public:
		...
		CFBamISOCtryCcyObj();
		CFBamISOCtryCcyObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamISOCtryCcyObj();
