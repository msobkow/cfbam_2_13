...
// Description: C++18 Instance Edit Object interface for CFBam Value.
...
namespace cfbam {
	...
	class ICFBamValueEditObj
	: public virtual cfbam::ICFBamValueObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamValueEditObj();
		virtual ~ICFBamValueEditObj();
		...
		virtual cfbam::ICFBamValueObj* getOrig() = 0;

		virtual cfbam::ICFBamValueObj* getOrigAsValue() = 0;
		...
		virtual cfbam::ICFBamValueObj* create() = 0;

		virtual cfbam::ICFBamValueEditObj* update() = 0;

		virtual cfbam::ICFBamValueEditObj* deleteInstance() = 0;
		...
		virtual void setOptionalDefaultXmlValueNull() = 0;
		virtual void setOptionalDefaultXmlValueValue( const std::string& value ) = 0;

		virtual const bool getRequiredIsNullable() = 0;
		virtual const bool* getRequiredIsNullableReference() = 0;
		virtual void setRequiredIsNullable( const bool value ) = 0;
		...
		virtual void setOptionalGenerateIdNull() = 0;
		virtual void setOptionalGenerateIdValue( const bool value ) = 0;

		virtual const bool getRequiredImplementsPolymorph() = 0;
		virtual const bool* getRequiredImplementsPolymorphReference() = 0;
		virtual void setRequiredImplementsPolymorph( const bool value ) = 0;
		...
		virtual void setRequiredContainerScope( cfbam::ICFBamScopeObj* value ) = 0;
		...
		virtual void setOptionalLookupPrev( cfbam::ICFBamValueObj* value ) = 0;

		virtual cfbam::ICFBamValueObj* getOptionalLookupNext( bool forceRead = false ) = 0;
		virtual void setOptionalLookupNext( cfbam::ICFBamValueObj* value ) = 0;
