...
// Description: C++18 base object instance specification for CFBam PopSubDep3.
...
namespace cfbam {
	...
	class CFBamPopSubDep3Obj
	: public CFBamPopDepObj,
	  public virtual ICFBamPopSubDep3Obj
	{
	protected:
	public:
		...
		CFBamPopSubDep3Obj();
		CFBamPopSubDep3Obj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamPopSubDep3Obj();
