...
// Description: C++18 base object instance specification for CFBam RelationCol.
...
namespace cfbam {
	...
	class CFBamRelationColObj
	: public virtual ICFBamRelationColObj
	{
	protected:
		cfsec::ICFSecSecUserObj* createdBy = NULL;
		cfsec::ICFSecSecUserObj* updatedBy = NULL;
		bool isNew;
		cfbam::ICFBamRelationColEditObj* edit;
	...
	public:
		...
		CFBamRelationColObj();
		CFBamRelationColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamRelationColObj();
		...
		virtual cfbam::ICFBamRelationColObj* realize();
		...
		virtual cfbam::ICFBamRelationColEditObj* beginEdit();
