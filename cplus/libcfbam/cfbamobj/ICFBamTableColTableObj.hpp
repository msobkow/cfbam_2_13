...
namespace cfbam {
	...
	{
	public:
		ICFBamTableColTableObj();
		virtual ~ICFBamTableColTableObj();
		...
		virtual cfbam::ICFBamTableColObj* newInstance() = 0;

		virtual cfbam::ICFBamTableColEditObj* newEditInstance( cfbam::ICFBamTableColObj* orig ) = 0;

		virtual cfbam::ICFBamTableColObj* realizeTableCol( cfbam::ICFBamTableColObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeTableCol( cfbam::ICFBamTableColObj* Obj ) = 0;
		...
		virtual cfbam::ICFBamTableColObj* createTableCol( cfbam::ICFBamTableColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamTableColObj* readTableCol( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTableColObj* lockTableCol( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamTableColObj*> readAllTableCol( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamTableColObj* readCachedTableCol( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamTableColObj*> readCachedTableColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTableColObj* updateTableCol( cfbam::ICFBamTableColEditObj* Obj ) = 0;

		virtual void deleteTableCol( cfbam::ICFBamTableColEditObj* Obj ) = 0;
		...
		virtual void deleteTableColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTableColObj* moveUpTableCol( cfbam::ICFBamTableColObj* Obj ) = 0;

		virtual cfbam::ICFBamTableColObj* moveDownTableCol( cfbam::ICFBamTableColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesTableCol( cfbam::ICFBamTableColObj* Obj ) = 0;
