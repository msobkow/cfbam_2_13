...
// Description: C++18 edit object instance specification for CFBam Tenant.
...
namespace cfbam {
	...
	class CFBamTenantEditObj
	: public virtual ICFBamTenantEditObj,
	  public virtual cfsec::ICFSecTenantEditObj,
	  public virtual cfint::ICFIntTenantEditObj
	{
	public:
	...
	public:
		CFBamTenantEditObj( cfsec::ICFSecTenantObj* argOrig );
		virtual ~CFBamTenantEditObj();
		...
		virtual std::vector<cfbam::ICFBamSchemaDefObj*> getOptionalComponentsSchema( bool forceRead = false );
