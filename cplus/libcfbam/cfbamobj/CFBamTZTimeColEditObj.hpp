...
// Description: C++18 edit object instance specification for CFBam TZTimeCol.
...
namespace cfbam {
	...
	class CFBamTZTimeColEditObj
	: public CFBamTZTimeDefEditObj,
	  public virtual ICFBamTZTimeColEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamTZTimeColEditObj( cfbam::ICFBamTZTimeColObj* argOrig );
		virtual ~CFBamTZTimeColEditObj();
		...
		virtual cfbam::ICFBamTZTimeColTableObj* getTZTimeColTable();

		virtual cfbam::ICFBamTZTimeColEditObj* getTZTimeColEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamTZTimeColObj* getOrigAsTZTimeCol();
		...
		inline cfbam::CFBamTZTimeColBuff* getTZTimeColBuff() {
			...
			return( static_cast<cfbam::CFBamTZTimeColBuff*>( buff ) );
		};
