...
namespace cfbam {
	...
	public:
		...
		virtual cfbam::ICFBamValueObj* newInstance() = 0;

		virtual cfbam::ICFBamValueEditObj* newEditInstance( cfbam::ICFBamValueObj* orig ) = 0;

		virtual cfbam::ICFBamValueObj* constructByClassCode( const classcode_t argClassCode ) = 0;

		virtual cfbam::ICFBamValueObj* realizeValue( cfbam::ICFBamValueObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeValue( cfbam::ICFBamValueObj* Obj ) = 0;
		virtual cfbam::ICFBamValueObj* createValue( cfbam::ICFBamValueEditObj* Obj ) = 0;

		virtual cfbam::ICFBamValueObj* readValue( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamValueObj* lockValue( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamValueObj*> readAllValue( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamValueObj* readCachedValue( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamValueObj*> readCachedValueByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamValueObj* updateValue( cfbam::ICFBamValueEditObj* Obj ) = 0;

		virtual void deleteValue( cfbam::ICFBamValueEditObj* Obj ) = 0;
		...
		virtual void deleteValueByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamValueObj* moveUpValue( cfbam::ICFBamValueObj* Obj ) = 0;

		virtual cfbam::ICFBamValueObj* moveDownValue( cfbam::ICFBamValueObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesValue( cfbam::ICFBamValueObj* Obj ) = 0;
