...
namespace cfbam {
	...
	class CFBamISOCtryLangTableObj
	: public virtual ICFBamISOCtryLangTableObj,
	  public virtual cfsec::ICFSecISOCtryLangTableObj,
	  public virtual cfint::ICFIntISOCtryLangTableObj
	{
	protected:
	...
	public:
		...
		CFBamISOCtryLangTableObj();
		CFBamISOCtryLangTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamISOCtryLangTableObj();
