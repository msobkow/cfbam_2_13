...
// Description: C++18 Instance Edit Object interface for CFBam TimeDef.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamAtomEditObj,
	  public virtual cfbam::ICFBamTimeDefObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamTimeDefEditObj();
		virtual ~ICFBamTimeDefEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamTimeDefBuff* getTimeDefBuff() {
			return( static_cast<cfbam::CFBamTimeDefBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamTimeDefBuff* getTimeDefEditBuff() {
			return( dynamic_cast<cfbam::CFBamTimeDefBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamTimeDefObj* getOrigAsTimeDef() = 0;
