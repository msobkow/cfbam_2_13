...
// Description: C++18 edit object instance specification for CFBam TimeDef.
...
namespace cfbam {
	...
	class CFBamTimeDefEditObj
	: public CFBamAtomEditObj,
	  public virtual ICFBamTimeDefEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamTimeDefEditObj( cfbam::ICFBamTimeDefObj* argOrig );
		virtual ~CFBamTimeDefEditObj();
		...
		virtual cfbam::ICFBamTimeDefTableObj* getTimeDefTable();

		virtual cfbam::ICFBamTimeDefEditObj* getTimeDefEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamTimeDefObj* getOrigAsTimeDef();
		...
		inline cfbam::CFBamTimeDefBuff* getTimeDefBuff() {
			...
			return( static_cast<cfbam::CFBamTimeDefBuff*>( buff ) );
		};
