...
namespace cfbam {
	...
	{
	public:
		ICFBamPopTopDepTableObj();
		virtual ~ICFBamPopTopDepTableObj();
		...
		virtual cfbam::ICFBamPopTopDepObj* newInstance() = 0;

		virtual cfbam::ICFBamPopTopDepEditObj* newEditInstance( cfbam::ICFBamPopTopDepObj* orig ) = 0;

		virtual cfbam::ICFBamPopTopDepObj* realizePopTopDep( cfbam::ICFBamPopTopDepObj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByTenantIdx( const int64_t TenantId ) = 0;
		virtual void reallyDeepDisposePopTopDep( cfbam::ICFBamPopTopDepObj* Obj ) = 0;
		...
		virtual cfbam::ICFBamPopTopDepObj* createPopTopDep( cfbam::ICFBamPopTopDepEditObj* Obj ) = 0;

		virtual cfbam::ICFBamPopTopDepObj* readPopTopDep( cfbam::CFBamScopePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamPopTopDepObj* lockPopTopDep( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamPopTopDepObj*> readAllPopTopDep( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamPopTopDepObj* readCachedPopTopDep( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual cfbam::ICFBamPopTopDepObj* readCachedPopTopDepByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamPopTopDepObj*> readCachedPopTopDepByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamPopTopDepObj* updatePopTopDep( cfbam::ICFBamPopTopDepEditObj* Obj ) = 0;

		virtual void deletePopTopDep( cfbam::ICFBamPopTopDepEditObj* Obj ) = 0;

		virtual void deletePopTopDepByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deletePopTopDepByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesPopTopDep( cfbam::ICFBamPopTopDepObj* Obj ) = 0;
