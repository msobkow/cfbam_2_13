...
// Description: C++18 edit object instance specification for CFBam DoubleType.
...
namespace cfbam {
	...
	class CFBamDoubleTypeEditObj
	: public CFBamDoubleDefEditObj,
	  public virtual ICFBamDoubleTypeEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamDoubleTypeEditObj( cfbam::ICFBamDoubleTypeObj* argOrig );
		virtual ~CFBamDoubleTypeEditObj();
		...
		virtual cfbam::ICFBamDoubleTypeTableObj* getDoubleTypeTable();

		virtual cfbam::ICFBamDoubleTypeEditObj* getDoubleTypeEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamDoubleTypeObj* getOrigAsDoubleType();

		virtual cfbam::CFBamValueBuff* getBuff();
		virtual void setBuff( cfbam::CFBamValueBuff* value );

		inline cfbam::CFBamDoubleTypeBuff* getDoubleTypeBuff() {
			// Buff is always instantiated when constructed over an original object
			return( static_cast<cfbam::CFBamDoubleTypeBuff*>( buff ) );
		};

		inline cfbam::CFBamDoubleTypeBuff* getDoubleTypeEditBuff() {
			// Buff is always instantiated when constructed over an original object
