...
// Description: C++18 Instance Edit Object interface for CFBam TimeCol.
...
namespace cfbam {
	...
	class ICFBamTimeColEditObj
	: public virtual cfbam::ICFBamTimeDefEditObj,
	  public virtual cfbam::ICFBamTimeColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamTimeColEditObj();
		virtual ~ICFBamTimeColEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamTimeColBuff* getTimeColBuff() {
			return( static_cast<cfbam::CFBamTimeColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamTimeColBuff* getTimeColEditBuff() {
			return( dynamic_cast<cfbam::CFBamTimeColBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamTimeColObj* getOrigAsTimeCol() = 0;
