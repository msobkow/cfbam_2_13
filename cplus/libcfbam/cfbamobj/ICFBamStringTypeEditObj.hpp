...
// Description: C++18 Instance Edit Object interface for CFBam StringType.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamStringDefEditObj,
	  public virtual cfbam::ICFBamStringTypeObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamStringTypeEditObj();
		virtual ~ICFBamStringTypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamStringTypeBuff* getStringTypeBuff() {
			return( static_cast<cfbam::CFBamStringTypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamStringTypeBuff* getStringTypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamStringTypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamStringTypeObj* getOrigAsStringType() = 0;
