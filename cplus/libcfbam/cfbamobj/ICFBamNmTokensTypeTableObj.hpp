...
namespace cfbam {
	...
	{
	public:
		ICFBamNmTokensTypeTableObj();
		virtual ~ICFBamNmTokensTypeTableObj();
		...
		virtual cfbam::ICFBamNmTokensTypeObj* newInstance() = 0;

		virtual cfbam::ICFBamNmTokensTypeEditObj* newEditInstance( cfbam::ICFBamNmTokensTypeObj* orig ) = 0;

		virtual cfbam::ICFBamNmTokensTypeObj* realizeNmTokensType( cfbam::ICFBamNmTokensTypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeNmTokensType( cfbam::ICFBamNmTokensTypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamNmTokensTypeObj* createNmTokensType( cfbam::ICFBamNmTokensTypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamNmTokensTypeObj* readNmTokensType( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamNmTokensTypeObj* lockNmTokensType( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamNmTokensTypeObj*> readAllNmTokensType( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamNmTokensTypeObj* readCachedNmTokensType( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamNmTokensTypeObj*> readCachedNmTokensTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamNmTokensTypeObj* updateNmTokensType( cfbam::ICFBamNmTokensTypeEditObj* Obj ) = 0;

		virtual void deleteNmTokensType( cfbam::ICFBamNmTokensTypeEditObj* Obj ) = 0;
		...
		virtual void deleteNmTokensTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamNmTokensTypeObj* moveUpNmTokensType( cfbam::ICFBamNmTokensTypeObj* Obj ) = 0;

		virtual cfbam::ICFBamNmTokensTypeObj* moveDownNmTokensType( cfbam::ICFBamNmTokensTypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesNmTokensType( cfbam::ICFBamNmTokensTypeObj* Obj ) = 0;
