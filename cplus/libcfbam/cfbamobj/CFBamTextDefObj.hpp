...
// Description: C++18 base object instance specification for CFBam TextDef.
...
namespace cfbam {
	...
	class CFBamTextDefObj
	: public CFBamAtomObj,
	  public virtual ICFBamTextDefObj
	{
	protected:
	public:
		...
		CFBamTextDefObj();
		CFBamTextDefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTextDefObj();
