...
namespace cfbam {
	...
	class CFBamInt16TypeTableObj
	: public virtual ICFBamInt16TypeTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16TypeObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16TypeObj*>* allInt16Type;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamInt16TypeObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16TypeObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16TypeObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16TypeObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16TypeObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16TypeObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16TypeObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16TypeObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamInt16TypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt16TypeObj*>*>* indexBySchemaIdx;
	...
	public:
		...
		CFBamInt16TypeTableObj();
		CFBamInt16TypeTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamInt16TypeTableObj();
		...
		virtual cfbam::ICFBamInt16TypeObj* newInstance();

		virtual cfbam::ICFBamInt16TypeEditObj* newEditInstance( cfbam::ICFBamInt16TypeObj* orig );

		virtual cfbam::ICFBamInt16TypeObj* realizeInt16Type( cfbam::ICFBamInt16TypeObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeInt16Type( cfbam::ICFBamInt16TypeObj* Obj );
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );
		virtual cfbam::ICFBamInt16TypeObj* createInt16Type( cfbam::ICFBamInt16TypeEditObj* Obj );

		virtual cfbam::ICFBamInt16TypeObj* readInt16Type( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamInt16TypeObj* lockInt16Type( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamInt16TypeObj*> readAllInt16Type( bool forceRead = false );

		virtual cfbam::ICFBamInt16TypeObj* readInt16TypeByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamInt16TypeObj* readInt16TypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt16TypeObj*> readInt16TypeByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt16TypeObj*> readInt16TypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt16TypeObj*> readInt16TypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt16TypeObj*> readInt16TypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt16TypeObj*> readInt16TypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt16TypeObj*> readInt16TypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt16TypeObj*> readInt16TypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt16TypeObj*> readInt16TypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId,
			bool forceRead = false );

		virtual cfbam::ICFBamInt16TypeObj* readCachedInt16Type( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamInt16TypeObj* readCachedInt16TypeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamInt16TypeObj* readCachedInt16TypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamInt16TypeObj*> readCachedInt16TypeByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamInt16TypeObj*> readCachedInt16TypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamInt16TypeObj*> readCachedInt16TypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamInt16TypeObj*> readCachedInt16TypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamInt16TypeObj*> readCachedInt16TypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamInt16TypeObj*> readCachedInt16TypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamInt16TypeObj*> readCachedInt16TypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamInt16TypeObj*> readCachedInt16TypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual cfbam::ICFBamInt16TypeObj* updateInt16Type( cfbam::ICFBamInt16TypeEditObj* Obj );

		virtual void deleteInt16Type( cfbam::ICFBamInt16TypeEditObj* Obj );

		virtual void deleteInt16TypeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteInt16TypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteInt16TypeByValTentIdx( const int64_t TenantId );

		virtual void deleteInt16TypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteInt16TypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteInt16TypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteInt16TypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteInt16TypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteInt16TypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteInt16TypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual cfbam::ICFBamInt16TypeObj* moveUpInt16Type( cfbam::ICFBamInt16TypeObj* Obj );

		virtual cfbam::ICFBamInt16TypeObj* moveDownInt16Type( cfbam::ICFBamInt16TypeObj* Obj );

		virtual void reallyDetachFromIndexesInt16Type( cfbam::ICFBamInt16TypeObj* Obj );
