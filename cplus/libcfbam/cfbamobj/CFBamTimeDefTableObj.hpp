...
namespace cfbam {
	...
	class CFBamTimeDefTableObj
	: public virtual ICFBamTimeDefTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTimeDefObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTimeDefObj*>* allTimeDef;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamTimeDefObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTimeDefObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTimeDefObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTimeDefObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTimeDefObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTimeDefObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTimeDefObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTimeDefObj*>*>* indexByContNextIdx;
	...
	public:
		...
		CFBamTimeDefTableObj();
		CFBamTimeDefTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamTimeDefTableObj();
		...
		virtual cfbam::ICFBamTimeDefObj* newInstance();

		virtual cfbam::ICFBamTimeDefEditObj* newEditInstance( cfbam::ICFBamTimeDefObj* orig );

		virtual cfbam::ICFBamTimeDefObj* realizeTimeDef( cfbam::ICFBamTimeDefObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeTimeDef( cfbam::ICFBamTimeDefObj* Obj );
		virtual cfbam::ICFBamTimeDefObj* createTimeDef( cfbam::ICFBamTimeDefEditObj* Obj );

		virtual cfbam::ICFBamTimeDefObj* readTimeDef( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamTimeDefObj* lockTimeDef( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamTimeDefObj*> readAllTimeDef( bool forceRead = false );

		virtual cfbam::ICFBamTimeDefObj* readTimeDefByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamTimeDefObj* readTimeDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTimeDefObj*> readTimeDefByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTimeDefObj*> readTimeDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTimeDefObj*> readTimeDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTimeDefObj*> readTimeDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTimeDefObj*> readTimeDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTimeDefObj*> readTimeDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTimeDefObj*> readTimeDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual cfbam::ICFBamTimeDefObj* readCachedTimeDef( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamTimeDefObj* readCachedTimeDefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamTimeDefObj* readCachedTimeDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamTimeDefObj*> readCachedTimeDefByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamTimeDefObj*> readCachedTimeDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamTimeDefObj*> readCachedTimeDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamTimeDefObj*> readCachedTimeDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamTimeDefObj*> readCachedTimeDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamTimeDefObj*> readCachedTimeDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamTimeDefObj*> readCachedTimeDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamTimeDefObj* updateTimeDef( cfbam::ICFBamTimeDefEditObj* Obj );

		virtual void deleteTimeDef( cfbam::ICFBamTimeDefEditObj* Obj );

		virtual void deleteTimeDefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteTimeDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteTimeDefByValTentIdx( const int64_t TenantId );

		virtual void deleteTimeDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteTimeDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteTimeDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteTimeDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteTimeDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteTimeDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamTimeDefObj* moveUpTimeDef( cfbam::ICFBamTimeDefObj* Obj );

		virtual cfbam::ICFBamTimeDefObj* moveDownTimeDef( cfbam::ICFBamTimeDefObj* Obj );

		virtual void reallyDetachFromIndexesTimeDef( cfbam::ICFBamTimeDefObj* Obj );
