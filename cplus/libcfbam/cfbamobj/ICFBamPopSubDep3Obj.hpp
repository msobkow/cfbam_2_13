...
// Description: C++18 Object interface for CFBam PopSubDep3.
...
namespace cfbam {
	...
	public:
		ICFBamPopSubDep3Obj();
		virtual ~ICFBamPopSubDep3Obj();
		virtual cfbam::ICFBamScopeEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamPopSubDep3EditObj* getPopSubDep3Edit() = 0;

		inline cfbam::CFBamPopSubDep3Buff* getPopSubDep3Buff() {
			return( static_cast<cfbam::CFBamPopSubDep3Buff*>( getBuff() ) );
		};

		inline cfbam::CFBamPopSubDep3Buff* getPopSubDep3EditBuff() {
			return( dynamic_cast<cfbam::CFBamPopSubDep3Buff*>( getBuff() ) );
		};

		virtual const int64_t getRequiredPopSubDep2TenantId() = 0;
		virtual const int64_t* getRequiredPopSubDep2TenantIdReference() = 0;

		virtual const int64_t getRequiredPopSubDep2Id() = 0;
		virtual const int64_t* getRequiredPopSubDep2IdReference() = 0;

		virtual const std::string& getRequiredName() = 0;
		virtual const std::string* getRequiredNameReference() = 0;

		virtual cfbam::ICFBamPopSubDep2Obj* getRequiredContainerPopSubDep2( bool forceRead = false ) = 0;
