...
// Description: C++18 base object instance specification for CFBam UInt32Col.
...
namespace cfbam {
	...
	class CFBamUInt32ColObj
	: public CFBamUInt32DefObj,
	  public virtual ICFBamUInt32ColObj
	{
	protected:
	public:
		...
		CFBamUInt32ColObj();
		CFBamUInt32ColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamUInt32ColObj();
