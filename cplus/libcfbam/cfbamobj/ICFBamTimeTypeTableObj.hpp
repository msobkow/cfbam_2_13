...
namespace cfbam {
	...
	{
	public:
		ICFBamTimeTypeTableObj();
		virtual ~ICFBamTimeTypeTableObj();
		...
		virtual cfbam::ICFBamTimeTypeObj* newInstance() = 0;

		virtual cfbam::ICFBamTimeTypeEditObj* newEditInstance( cfbam::ICFBamTimeTypeObj* orig ) = 0;

		virtual cfbam::ICFBamTimeTypeObj* realizeTimeType( cfbam::ICFBamTimeTypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeTimeType( cfbam::ICFBamTimeTypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamTimeTypeObj* createTimeType( cfbam::ICFBamTimeTypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamTimeTypeObj* readTimeType( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTimeTypeObj* lockTimeType( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamTimeTypeObj*> readAllTimeType( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamTimeTypeObj* readCachedTimeType( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamTimeTypeObj*> readCachedTimeTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTimeTypeObj* updateTimeType( cfbam::ICFBamTimeTypeEditObj* Obj ) = 0;

		virtual void deleteTimeType( cfbam::ICFBamTimeTypeEditObj* Obj ) = 0;
		...
		virtual void deleteTimeTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTimeTypeObj* moveUpTimeType( cfbam::ICFBamTimeTypeObj* Obj ) = 0;

		virtual cfbam::ICFBamTimeTypeObj* moveDownTimeType( cfbam::ICFBamTimeTypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesTimeType( cfbam::ICFBamTimeTypeObj* Obj ) = 0;
