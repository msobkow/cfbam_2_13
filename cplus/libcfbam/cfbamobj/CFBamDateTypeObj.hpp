...
// Description: C++18 base object instance specification for CFBam DateType.
...
namespace cfbam {
	...
	class CFBamDateTypeObj
	: public CFBamDateDefObj,
	  public virtual ICFBamDateTypeObj
	{
	protected:
	public:
		...
		CFBamDateTypeObj();
		CFBamDateTypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamDateTypeObj();
