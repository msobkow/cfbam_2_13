...
namespace cfbam {
	...
	class CFBamAtomTableObj
	: public virtual ICFBamAtomTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamAtomObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamAtomObj*>* allAtom;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamAtomObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamAtomObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamAtomObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamAtomObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamAtomObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamAtomObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamAtomObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamAtomObj*>*>* indexByContNextIdx;
	...
	public:
		...
		CFBamAtomTableObj();
		CFBamAtomTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamAtomTableObj();
		...
		virtual cfbam::ICFBamAtomObj* newInstance();

		virtual cfbam::ICFBamAtomEditObj* newEditInstance( cfbam::ICFBamAtomObj* orig );

		virtual cfbam::ICFBamAtomObj* realizeAtom( cfbam::ICFBamAtomObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeAtom( cfbam::ICFBamAtomObj* Obj );
		virtual cfbam::ICFBamAtomObj* createAtom( cfbam::ICFBamAtomEditObj* Obj );

		virtual cfbam::ICFBamAtomObj* readAtom( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamAtomObj* lockAtom( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamAtomObj*> readAllAtom( bool forceRead = false );
		...
		virtual cfbam::ICFBamAtomObj* readCachedAtom( cfbam::CFBamValuePKey* pkey );
		...
		virtual std::vector<cfbam::ICFBamAtomObj*> readCachedAtomByValTentIdx( const int64_t TenantId );
		...
		virtual cfbam::ICFBamAtomObj* updateAtom( cfbam::ICFBamAtomEditObj* Obj );

		virtual void deleteAtom( cfbam::ICFBamAtomEditObj* Obj );
		...
		virtual void deleteAtomByValTentIdx( const int64_t TenantId );
		...
		virtual cfbam::ICFBamAtomObj* moveUpAtom( cfbam::ICFBamAtomObj* Obj );

		virtual cfbam::ICFBamAtomObj* moveDownAtom( cfbam::ICFBamAtomObj* Obj );

		virtual void reallyDetachFromIndexesAtom( cfbam::ICFBamAtomObj* Obj );
