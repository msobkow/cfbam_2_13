...
namespace cfbam {
	...
	{
	public:
		ICFBamInt32TypeTableObj();
		virtual ~ICFBamInt32TypeTableObj();
		...
		virtual cfbam::ICFBamInt32TypeObj* newInstance() = 0;

		virtual cfbam::ICFBamInt32TypeEditObj* newEditInstance( cfbam::ICFBamInt32TypeObj* orig ) = 0;

		virtual cfbam::ICFBamInt32TypeObj* realizeInt32Type( cfbam::ICFBamInt32TypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeInt32Type( cfbam::ICFBamInt32TypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamInt32TypeObj* createInt32Type( cfbam::ICFBamInt32TypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamInt32TypeObj* readInt32Type( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamInt32TypeObj* lockInt32Type( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamInt32TypeObj*> readAllInt32Type( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamInt32TypeObj* readCachedInt32Type( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamInt32TypeObj*> readCachedInt32TypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamInt32TypeObj* updateInt32Type( cfbam::ICFBamInt32TypeEditObj* Obj ) = 0;

		virtual void deleteInt32Type( cfbam::ICFBamInt32TypeEditObj* Obj ) = 0;
		...
		virtual void deleteInt32TypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamInt32TypeObj* moveUpInt32Type( cfbam::ICFBamInt32TypeObj* Obj ) = 0;

		virtual cfbam::ICFBamInt32TypeObj* moveDownInt32Type( cfbam::ICFBamInt32TypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesInt32Type( cfbam::ICFBamInt32TypeObj* Obj ) = 0;
