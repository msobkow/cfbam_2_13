...
// Description: C++18 Instance Edit Object interface for CFBam BlobCol.
...
namespace cfbam {
	...
	class ICFBamBlobColEditObj
	: public virtual cfbam::ICFBamBlobDefEditObj,
	  public virtual cfbam::ICFBamBlobColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamBlobColEditObj();
		virtual ~ICFBamBlobColEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamBlobColBuff* getBlobColBuff() {
			return( static_cast<cfbam::CFBamBlobColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamBlobColBuff* getBlobColEditBuff() {
			return( dynamic_cast<cfbam::CFBamBlobColBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamBlobColObj* getOrigAsBlobCol() = 0;
