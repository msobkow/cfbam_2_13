...
// Description: C++18 base object instance specification for CFBam FloatCol.
...
namespace cfbam {
	...
	class CFBamFloatColObj
	: public CFBamFloatDefObj,
	  public virtual ICFBamFloatColObj
	{
	protected:
	public:
		...
		CFBamFloatColObj();
		CFBamFloatColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamFloatColObj();
