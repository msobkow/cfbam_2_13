...
// Description: C++18 edit object instance specification for CFBam URLProtocol.
...
namespace cfbam {
	...
	class CFBamURLProtocolEditObj
	: public virtual ICFBamURLProtocolEditObj,
	  public virtual cfint::ICFIntURLProtocolEditObj
	{
	public:
	...
	public:
		CFBamURLProtocolEditObj( cfint::ICFIntURLProtocolObj* argOrig );
		virtual ~CFBamURLProtocolEditObj();
