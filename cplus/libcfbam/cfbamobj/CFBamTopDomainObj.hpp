...
// Description: C++18 base object instance specification for CFBam TopDomain.
...
namespace cfbam {
	...
	class CFBamTopDomainObj
	: public virtual ICFBamTopDomainObj,
	...
	public:
		...
		CFBamTopDomainObj();
		CFBamTopDomainObj( cfint::ICFIntSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTopDomainObj();
