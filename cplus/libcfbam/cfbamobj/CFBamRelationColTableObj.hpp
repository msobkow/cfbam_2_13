...
namespace cfbam {
	...
	class CFBamRelationColTableObj
	: public virtual ICFBamRelationColTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamRelationColPKey, cfbam::ICFBamRelationColObj*>* members;
		std::map<cfbam::CFBamRelationColPKey, cfbam::ICFBamRelationColObj*>* allRelationCol;
		std::map< cfbam::CFBamRelationColByUNameIdxKey,
			cfbam::ICFBamRelationColObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamRelationColByRelColTenantIdxKey,
			std::map<cfbam::CFBamRelationColPKey, cfbam::ICFBamRelationColObj*>*>* indexByRelColTenantIdx;
		std::map< cfbam::CFBamRelationColByRelationIdxKey,
			std::map<cfbam::CFBamRelationColPKey, cfbam::ICFBamRelationColObj*>*>* indexByRelationIdx;
		std::map< cfbam::CFBamRelationColByDefSchemaIdxKey,
			std::map<cfbam::CFBamRelationColPKey, cfbam::ICFBamRelationColObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamRelationColByFromColIdxKey,
			std::map<cfbam::CFBamRelationColPKey, cfbam::ICFBamRelationColObj*>*>* indexByFromColIdx;
		std::map< cfbam::CFBamRelationColByToColIdxKey,
			std::map<cfbam::CFBamRelationColPKey, cfbam::ICFBamRelationColObj*>*>* indexByToColIdx;
		std::map< cfbam::CFBamRelationColByPrevIdxKey,
			std::map<cfbam::CFBamRelationColPKey, cfbam::ICFBamRelationColObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamRelationColByNextIdxKey,
			std::map<cfbam::CFBamRelationColPKey, cfbam::ICFBamRelationColObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamRelationColByRelPrevIdxKey,
			std::map<cfbam::CFBamRelationColPKey, cfbam::ICFBamRelationColObj*>*>* indexByRelPrevIdx;
		std::map< cfbam::CFBamRelationColByRelNextIdxKey,
			std::map<cfbam::CFBamRelationColPKey, cfbam::ICFBamRelationColObj*>*>* indexByRelNextIdx;
	...
	public:
		...
		CFBamRelationColTableObj();
		CFBamRelationColTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamRelationColTableObj();
		...
		virtual cfbam::ICFBamRelationColObj* newInstance();

		virtual cfbam::ICFBamRelationColEditObj* newEditInstance( cfbam::ICFBamRelationColObj* orig );

		virtual cfbam::ICFBamRelationColObj* realizeRelationCol( cfbam::ICFBamRelationColObj* Obj );
		...
		virtual void deepDisposeByRelColTenantIdx( const int64_t TenantId );
		...
		virtual void deepDisposeByRelNextIdx( const int64_t TenantId,
			const int64_t RelationId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeRelationCol( cfbam::ICFBamRelationColObj* Obj );
		virtual cfbam::ICFBamRelationColObj* createRelationCol( cfbam::ICFBamRelationColEditObj* Obj );

		virtual cfbam::ICFBamRelationColObj* readRelationCol( cfbam::CFBamRelationColPKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamRelationColObj* lockRelationCol( cfbam::CFBamRelationColPKey* pkey );

		virtual std::vector<cfbam::ICFBamRelationColObj*> readAllRelationCol( bool forceRead = false );
		...
		virtual cfbam::ICFBamRelationColObj* readCachedRelationCol( cfbam::CFBamRelationColPKey* pkey );
		...
		virtual std::vector<cfbam::ICFBamRelationColObj*> readCachedRelationColByRelColTenantIdx( const int64_t TenantId );
		...
		virtual cfbam::ICFBamRelationColObj* updateRelationCol( cfbam::ICFBamRelationColEditObj* Obj );

		virtual void deleteRelationCol( cfbam::ICFBamRelationColEditObj* Obj );
		...
		virtual void deleteRelationColByRelColTenantIdx( const int64_t TenantId );
		...
		virtual cfbam::ICFBamRelationColObj* moveUpRelationCol( cfbam::ICFBamRelationColObj* Obj );

		virtual cfbam::ICFBamRelationColObj* moveDownRelationCol( cfbam::ICFBamRelationColObj* Obj );

		virtual void reallyDetachFromIndexesRelationCol( cfbam::ICFBamRelationColObj* Obj );
