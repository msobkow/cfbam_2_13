...
namespace cfbam {
	...
	class CFBamTopProjectTableObj
	: public virtual ICFBamTopProjectTableObj,
	  public virtual cfint::ICFIntTopProjectTableObj
	{
	protected:
	...
	public:
		...
		CFBamTopProjectTableObj();
		CFBamTopProjectTableObj( cfint::ICFIntSchemaObj* argSchema );
		virtual ~CFBamTopProjectTableObj();
