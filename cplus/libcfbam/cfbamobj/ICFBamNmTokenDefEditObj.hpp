...
// Description: C++18 Instance Edit Object interface for CFBam NmTokenDef.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamAtomEditObj,
	  public virtual cfbam::ICFBamNmTokenDefObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamNmTokenDefEditObj();
		virtual ~ICFBamNmTokenDefEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamNmTokenDefBuff* getNmTokenDefBuff() {
			return( static_cast<cfbam::CFBamNmTokenDefBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamNmTokenDefBuff* getNmTokenDefEditBuff() {
			return( dynamic_cast<cfbam::CFBamNmTokenDefBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamNmTokenDefObj* getOrigAsNmTokenDef() = 0;
