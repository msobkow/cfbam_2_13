...
namespace cfbam {
	...
	{
	public:
		ICFBamUInt64TypeTableObj();
		virtual ~ICFBamUInt64TypeTableObj();
		...
		virtual cfbam::ICFBamUInt64TypeObj* newInstance() = 0;

		virtual cfbam::ICFBamUInt64TypeEditObj* newEditInstance( cfbam::ICFBamUInt64TypeObj* orig ) = 0;

		virtual cfbam::ICFBamUInt64TypeObj* realizeUInt64Type( cfbam::ICFBamUInt64TypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeUInt64Type( cfbam::ICFBamUInt64TypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamUInt64TypeObj* createUInt64Type( cfbam::ICFBamUInt64TypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamUInt64TypeObj* readUInt64Type( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamUInt64TypeObj* lockUInt64Type( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamUInt64TypeObj*> readAllUInt64Type( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamUInt64TypeObj* readCachedUInt64Type( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamUInt64TypeObj*> readCachedUInt64TypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUInt64TypeObj* updateUInt64Type( cfbam::ICFBamUInt64TypeEditObj* Obj ) = 0;

		virtual void deleteUInt64Type( cfbam::ICFBamUInt64TypeEditObj* Obj ) = 0;
		...
		virtual void deleteUInt64TypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUInt64TypeObj* moveUpUInt64Type( cfbam::ICFBamUInt64TypeObj* Obj ) = 0;

		virtual cfbam::ICFBamUInt64TypeObj* moveDownUInt64Type( cfbam::ICFBamUInt64TypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesUInt64Type( cfbam::ICFBamUInt64TypeObj* Obj ) = 0;
