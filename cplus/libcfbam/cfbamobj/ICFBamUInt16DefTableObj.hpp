...
namespace cfbam {
	...
	{
	public:
		ICFBamUInt16DefTableObj();
		virtual ~ICFBamUInt16DefTableObj();
		...
		virtual cfbam::ICFBamUInt16DefObj* newInstance() = 0;

		virtual cfbam::ICFBamUInt16DefEditObj* newEditInstance( cfbam::ICFBamUInt16DefObj* orig ) = 0;

		virtual cfbam::ICFBamUInt16DefObj* realizeUInt16Def( cfbam::ICFBamUInt16DefObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeUInt16Def( cfbam::ICFBamUInt16DefObj* Obj ) = 0;
		virtual cfbam::ICFBamUInt16DefObj* createUInt16Def( cfbam::ICFBamUInt16DefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamUInt16DefObj* readUInt16Def( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamUInt16DefObj* lockUInt16Def( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamUInt16DefObj*> readAllUInt16Def( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamUInt16DefObj* readCachedUInt16Def( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamUInt16DefObj*> readCachedUInt16DefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUInt16DefObj* updateUInt16Def( cfbam::ICFBamUInt16DefEditObj* Obj ) = 0;

		virtual void deleteUInt16Def( cfbam::ICFBamUInt16DefEditObj* Obj ) = 0;
		...
		virtual void deleteUInt16DefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUInt16DefObj* moveUpUInt16Def( cfbam::ICFBamUInt16DefObj* Obj ) = 0;

		virtual cfbam::ICFBamUInt16DefObj* moveDownUInt16Def( cfbam::ICFBamUInt16DefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesUInt16Def( cfbam::ICFBamUInt16DefObj* Obj ) = 0;
