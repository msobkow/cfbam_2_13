...
namespace cfbam {
	...
	{
	public:
		ICFBamDoubleTypeTableObj();
		virtual ~ICFBamDoubleTypeTableObj();
		...
		virtual cfbam::ICFBamDoubleTypeObj* newInstance() = 0;

		virtual cfbam::ICFBamDoubleTypeEditObj* newEditInstance( cfbam::ICFBamDoubleTypeObj* orig ) = 0;

		virtual cfbam::ICFBamDoubleTypeObj* realizeDoubleType( cfbam::ICFBamDoubleTypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeDoubleType( cfbam::ICFBamDoubleTypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamDoubleTypeObj* createDoubleType( cfbam::ICFBamDoubleTypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamDoubleTypeObj* readDoubleType( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamDoubleTypeObj* lockDoubleType( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamDoubleTypeObj*> readAllDoubleType( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamDoubleTypeObj* readCachedDoubleType( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamDoubleTypeObj*> readCachedDoubleTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamDoubleTypeObj* updateDoubleType( cfbam::ICFBamDoubleTypeEditObj* Obj ) = 0;

		virtual void deleteDoubleType( cfbam::ICFBamDoubleTypeEditObj* Obj ) = 0;
		...
		virtual void deleteDoubleTypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamDoubleTypeObj* moveUpDoubleType( cfbam::ICFBamDoubleTypeObj* Obj ) = 0;

		virtual cfbam::ICFBamDoubleTypeObj* moveDownDoubleType( cfbam::ICFBamDoubleTypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesDoubleType( cfbam::ICFBamDoubleTypeObj* Obj ) = 0;
