...
namespace cfbam {
	...
	class CFBamUInt16ColTableObj
	: public virtual ICFBamUInt16ColTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16ColObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16ColObj*>* allUInt16Col;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamUInt16ColObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16ColObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16ColObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16ColObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16ColObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16ColObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16ColObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16ColObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamUInt16ColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt16ColObj*>*>* indexByTableIdx;
	...
	public:
		...
		CFBamUInt16ColTableObj();
		CFBamUInt16ColTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamUInt16ColTableObj();
		...
		virtual cfbam::ICFBamUInt16ColObj* newInstance();

		virtual cfbam::ICFBamUInt16ColEditObj* newEditInstance( cfbam::ICFBamUInt16ColObj* orig );

		virtual cfbam::ICFBamUInt16ColObj* realizeUInt16Col( cfbam::ICFBamUInt16ColObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeUInt16Col( cfbam::ICFBamUInt16ColObj* Obj );
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId );
		virtual cfbam::ICFBamUInt16ColObj* createUInt16Col( cfbam::ICFBamUInt16ColEditObj* Obj );

		virtual cfbam::ICFBamUInt16ColObj* readUInt16Col( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamUInt16ColObj* lockUInt16Col( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamUInt16ColObj*> readAllUInt16Col( bool forceRead = false );
		...
		virtual cfbam::ICFBamUInt16ColObj* readCachedUInt16Col( cfbam::CFBamValuePKey* pkey );
		...
		virtual std::vector<cfbam::ICFBamUInt16ColObj*> readCachedUInt16ColByValTentIdx( const int64_t TenantId );
		...
		virtual cfbam::ICFBamUInt16ColObj* updateUInt16Col( cfbam::ICFBamUInt16ColEditObj* Obj );

		virtual void deleteUInt16Col( cfbam::ICFBamUInt16ColEditObj* Obj );
		...
		virtual void deleteUInt16ColByValTentIdx( const int64_t TenantId );
		...
		virtual cfbam::ICFBamUInt16ColObj* moveUpUInt16Col( cfbam::ICFBamUInt16ColObj* Obj );

		virtual cfbam::ICFBamUInt16ColObj* moveDownUInt16Col( cfbam::ICFBamUInt16ColObj* Obj );

		virtual void reallyDetachFromIndexesUInt16Col( cfbam::ICFBamUInt16ColObj* Obj );
