...
namespace cfbam {
	...
	{
	public:
		ICFBamDelSubDep1TableObj();
		virtual ~ICFBamDelSubDep1TableObj();
		...
		virtual cfbam::ICFBamDelSubDep1Obj* newInstance() = 0;

		virtual cfbam::ICFBamDelSubDep1EditObj* newEditInstance( cfbam::ICFBamDelSubDep1Obj* orig ) = 0;

		virtual cfbam::ICFBamDelSubDep1Obj* realizeDelSubDep1( cfbam::ICFBamDelSubDep1Obj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByTenantIdx( const int64_t TenantId ) = 0;
		virtual void reallyDeepDisposeDelSubDep1( cfbam::ICFBamDelSubDep1Obj* Obj ) = 0;
		...
		virtual cfbam::ICFBamDelSubDep1Obj* createDelSubDep1( cfbam::ICFBamDelSubDep1EditObj* Obj ) = 0;

		virtual cfbam::ICFBamDelSubDep1Obj* readDelSubDep1( cfbam::CFBamScopePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamDelSubDep1Obj* lockDelSubDep1( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamDelSubDep1Obj*> readAllDelSubDep1( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamDelSubDep1Obj* readCachedDelSubDep1( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual cfbam::ICFBamDelSubDep1Obj* readCachedDelSubDep1ByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamDelSubDep1Obj*> readCachedDelSubDep1ByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamDelSubDep1Obj* updateDelSubDep1( cfbam::ICFBamDelSubDep1EditObj* Obj ) = 0;

		virtual void deleteDelSubDep1( cfbam::ICFBamDelSubDep1EditObj* Obj ) = 0;

		virtual void deleteDelSubDep1ByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deleteDelSubDep1ByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesDelSubDep1( cfbam::ICFBamDelSubDep1Obj* Obj ) = 0;
