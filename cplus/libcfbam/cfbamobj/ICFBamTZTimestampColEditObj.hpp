...
// Description: C++18 Instance Edit Object interface for CFBam TZTimestampCol.
...
namespace cfbam {
	...
	class ICFBamTZTimestampColEditObj
	: public virtual cfbam::ICFBamTZTimestampDefEditObj,
	  public virtual cfbam::ICFBamTZTimestampColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamTZTimestampColEditObj();
		virtual ~ICFBamTZTimestampColEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamTZTimestampColBuff* getTZTimestampColBuff() {
			return( static_cast<cfbam::CFBamTZTimestampColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamTZTimestampColBuff* getTZTimestampColEditBuff() {
			return( dynamic_cast<cfbam::CFBamTZTimestampColBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamTZTimestampColObj* getOrigAsTZTimestampCol() = 0;
