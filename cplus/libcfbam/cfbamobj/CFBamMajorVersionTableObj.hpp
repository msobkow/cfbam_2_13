...
namespace cfbam {
	...
	class CFBamMajorVersionTableObj
	: public virtual ICFBamMajorVersionTableObj,
	  public virtual cfint::ICFIntMajorVersionTableObj
	{
	protected:
	...
	public:
		...
		CFBamMajorVersionTableObj();
		CFBamMajorVersionTableObj( cfint::ICFIntSchemaObj* argSchema );
		virtual ~CFBamMajorVersionTableObj();
