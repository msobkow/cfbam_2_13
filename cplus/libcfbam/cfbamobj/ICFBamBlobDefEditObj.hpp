...
// Description: C++18 Instance Edit Object interface for CFBam BlobDef.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamAtomEditObj,
	  public virtual cfbam::ICFBamBlobDefObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamBlobDefEditObj();
		virtual ~ICFBamBlobDefEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamBlobDefBuff* getBlobDefBuff() {
			return( static_cast<cfbam::CFBamBlobDefBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamBlobDefBuff* getBlobDefEditBuff() {
			return( dynamic_cast<cfbam::CFBamBlobDefBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamBlobDefObj* getOrigAsBlobDef() = 0;
		...
		virtual const std::vector<cflib::BYTE>& getOptionalInitValueValue() = 0;
		virtual const std::vector<cflib::BYTE>* getOptionalInitValueReference() = 0;
		virtual void setOptionalInitValueNull() = 0;
		virtual void setOptionalInitValueValue( const std::vector<cflib::BYTE>& value ) = 0;
