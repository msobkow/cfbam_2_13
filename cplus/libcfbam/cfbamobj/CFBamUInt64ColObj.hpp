...
// Description: C++18 base object instance specification for CFBam UInt64Col.
...
namespace cfbam {
	...
	class CFBamUInt64ColObj
	: public CFBamUInt64DefObj,
	  public virtual ICFBamUInt64ColObj
	{
	protected:
	public:
		...
		CFBamUInt64ColObj();
		CFBamUInt64ColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamUInt64ColObj();
