...
// Description: C++18 edit object instance specification for CFBam SecGrpMemb.
...
namespace cfbam {
	...
	class CFBamSecGrpMembEditObj
	: public virtual ICFBamSecGrpMembEditObj,
	  public virtual cfsec::ICFSecSecGrpMembEditObj,
	  public virtual cfint::ICFIntSecGrpMembEditObj
	{
	public:
	...
	public:
		CFBamSecGrpMembEditObj( cfsec::ICFSecSecGrpMembObj* argOrig );
		virtual ~CFBamSecGrpMembEditObj();
