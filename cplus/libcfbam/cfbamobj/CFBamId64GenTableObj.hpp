...
namespace cfbam {
	...
	class CFBamId64GenTableObj
	: public virtual ICFBamId64GenTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId64GenObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId64GenObj*>* allId64Gen;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamId64GenObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId64GenObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId64GenObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId64GenObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId64GenObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId64GenObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId64GenObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId64GenObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamInt64TypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId64GenObj*>*>* indexBySchemaIdx;
		std::map< cfbam::CFBamId64GenByDispIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamId64GenObj*>*>* indexByDispIdx;
	...
	public:
		...
		CFBamId64GenTableObj();
		CFBamId64GenTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamId64GenTableObj();
		...
		virtual cfbam::ICFBamId64GenObj* newInstance();

		virtual cfbam::ICFBamId64GenEditObj* newEditInstance( cfbam::ICFBamId64GenObj* orig );

		virtual cfbam::ICFBamId64GenObj* realizeId64Gen( cfbam::ICFBamId64GenObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeId64Gen( cfbam::ICFBamId64GenObj* Obj );
		...
		virtual cfbam::ICFBamId64GenObj* createId64Gen( cfbam::ICFBamId64GenEditObj* Obj );

		virtual cfbam::ICFBamId64GenObj* readId64Gen( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamId64GenObj* lockId64Gen( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamId64GenObj*> readAllId64Gen( bool forceRead = false );

		virtual cfbam::ICFBamId64GenObj* readId64GenByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamId64GenObj* readId64GenByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId64GenObj*> readId64GenByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId64GenObj*> readId64GenByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId64GenObj*> readId64GenByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId64GenObj*> readId64GenByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId64GenObj*> readId64GenByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId64GenObj*> readId64GenByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId64GenObj*> readId64GenByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId64GenObj*> readId64GenBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamId64GenObj*> readId64GenByDispIdx( const int64_t* DispenserTenantId,
			const int64_t* DispenserId,
			bool forceRead = false );

		virtual cfbam::ICFBamId64GenObj* readCachedId64Gen( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamId64GenObj* readCachedId64GenByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamId64GenObj* readCachedId64GenByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamId64GenObj*> readCachedId64GenByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamId64GenObj*> readCachedId64GenByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamId64GenObj*> readCachedId64GenByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamId64GenObj*> readCachedId64GenByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamId64GenObj*> readCachedId64GenByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamId64GenObj*> readCachedId64GenByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamId64GenObj*> readCachedId64GenByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamId64GenObj*> readCachedId64GenBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual std::vector<cfbam::ICFBamId64GenObj*> readCachedId64GenByDispIdx( const int64_t* DispenserTenantId,
			const int64_t* DispenserId );

		virtual cfbam::ICFBamId64GenObj* updateId64Gen( cfbam::ICFBamId64GenEditObj* Obj );

		virtual void deleteId64Gen( cfbam::ICFBamId64GenEditObj* Obj );

		virtual void deleteId64GenByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteId64GenByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteId64GenByValTentIdx( const int64_t TenantId );

		virtual void deleteId64GenByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteId64GenByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteId64GenByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteId64GenByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteId64GenByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteId64GenByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteId64GenBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual void deleteId64GenByDispIdx( const int64_t* DispenserTenantId,
			const int64_t* DispenserId );

		virtual cfbam::ICFBamId64GenObj* moveUpId64Gen( cfbam::ICFBamId64GenObj* Obj );

		virtual cfbam::ICFBamId64GenObj* moveDownId64Gen( cfbam::ICFBamId64GenObj* Obj );

		virtual void reallyDetachFromIndexesId64Gen( cfbam::ICFBamId64GenObj* Obj );
