...
// Description: C++18 Object interface for CFBam PopTopDep.
...
namespace cfbam {
	...
	class ICFBamPopTopDepObj
	: public virtual cfbam::ICFBamPopDepObj
	{
	public:
		ICFBamPopTopDepObj();
		virtual ~ICFBamPopTopDepObj();
		virtual cfbam::ICFBamScopeEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamPopTopDepEditObj* getPopTopDepEdit() = 0;

		inline cfbam::CFBamPopTopDepBuff* getPopTopDepBuff() {
			return( static_cast<cfbam::CFBamPopTopDepBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamPopTopDepBuff* getPopTopDepEditBuff() {
			return( dynamic_cast<cfbam::CFBamPopTopDepBuff*>( getBuff() ) );
		};

		virtual const int64_t getRequiredContRelationTenantId() = 0;
		virtual const int64_t* getRequiredContRelationTenantIdReference() = 0;

		virtual const int64_t getRequiredContRelationId() = 0;
		virtual const int64_t* getRequiredContRelationIdReference() = 0;

		virtual const std::string& getRequiredName() = 0;
		virtual const std::string* getRequiredNameReference() = 0;

		virtual cfbam::ICFBamRelationObj* getRequiredContainerContRelation( bool forceRead = false ) = 0;

		virtual std::vector<cfbam::ICFBamPopSubDep1Obj*> getOptionalComponentsPopDep( bool forceRead = false ) = 0;
