...
// Description: C++18 Object interface for CFBam ClearSubDep3.
...
namespace cfbam {
	...
	public:
		...
		virtual ~ICFBamClearSubDep3Obj();
		virtual cfbam::ICFBamScopeEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamClearSubDep3EditObj* getClearSubDep3Edit() = 0;

		inline cfbam::CFBamClearSubDep3Buff* getClearSubDep3Buff() {
			return( static_cast<cfbam::CFBamClearSubDep3Buff*>( getBuff() ) );
		};

		inline cfbam::CFBamClearSubDep3Buff* getClearSubDep3EditBuff() {
			return( dynamic_cast<cfbam::CFBamClearSubDep3Buff*>( getBuff() ) );
		};

		virtual const int64_t getRequiredClearSubDep2TenantId() = 0;
		virtual const int64_t* getRequiredClearSubDep2TenantIdReference() = 0;

		virtual const int64_t getRequiredClearSubDep2Id() = 0;
		virtual const int64_t* getRequiredClearSubDep2IdReference() = 0;

		virtual const std::string& getRequiredName() = 0;
		virtual const std::string* getRequiredNameReference() = 0;

		virtual cfbam::ICFBamClearSubDep2Obj* getRequiredContainerClearSubDep2( bool forceRead = false ) = 0;
