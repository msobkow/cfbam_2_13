...
// Description: C++18 base object instance specification for CFBam BlobCol.
...
namespace cfbam {
	...
	class CFBamBlobColObj
	: public CFBamBlobDefObj,
	  public virtual ICFBamBlobColObj
	{
	protected:
	public:
		...
		CFBamBlobColObj();
		CFBamBlobColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamBlobColObj();
