...
namespace cfbam {
	...
	{
	public:
		ICFBamTZTimeColTableObj();
		virtual ~ICFBamTZTimeColTableObj();
		...
		virtual cfbam::ICFBamTZTimeColObj* newInstance() = 0;

		virtual cfbam::ICFBamTZTimeColEditObj* newEditInstance( cfbam::ICFBamTZTimeColObj* orig ) = 0;

		virtual cfbam::ICFBamTZTimeColObj* realizeTZTimeCol( cfbam::ICFBamTZTimeColObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeTZTimeCol( cfbam::ICFBamTZTimeColObj* Obj ) = 0;
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId ) = 0;
		virtual cfbam::ICFBamTZTimeColObj* createTZTimeCol( cfbam::ICFBamTZTimeColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamTZTimeColObj* readTZTimeCol( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTZTimeColObj* lockTZTimeCol( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamTZTimeColObj*> readAllTZTimeCol( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamTZTimeColObj* readCachedTZTimeCol( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamTZTimeColObj*> readCachedTZTimeColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTZTimeColObj* updateTZTimeCol( cfbam::ICFBamTZTimeColEditObj* Obj ) = 0;

		virtual void deleteTZTimeCol( cfbam::ICFBamTZTimeColEditObj* Obj ) = 0;
		...
		virtual void deleteTZTimeColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTZTimeColObj* moveUpTZTimeCol( cfbam::ICFBamTZTimeColObj* Obj ) = 0;

		virtual cfbam::ICFBamTZTimeColObj* moveDownTZTimeCol( cfbam::ICFBamTZTimeColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesTZTimeCol( cfbam::ICFBamTZTimeColObj* Obj ) = 0;
