...
namespace cfbam {
	...
	class CFBamClusterTableObj
	: public virtual ICFBamClusterTableObj,
	  public virtual cfsec::ICFSecClusterTableObj,
	  public virtual cfint::ICFIntClusterTableObj
	{
	protected:
	...
	public:
		...
		CFBamClusterTableObj();
		CFBamClusterTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamClusterTableObj();
