...
namespace cfbam {
	...
	class CFBamInt64DefTableObj
	: public virtual ICFBamInt64DefTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64DefObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64DefObj*>* allInt64Def;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamInt64DefObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64DefObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64DefObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64DefObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64DefObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64DefObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64DefObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64DefObj*>*>* indexByContNextIdx;
	...
	public:
		...
		CFBamInt64DefTableObj();
		CFBamInt64DefTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamInt64DefTableObj();
		...
		virtual cfbam::ICFBamInt64DefObj* newInstance();

		virtual cfbam::ICFBamInt64DefEditObj* newEditInstance( cfbam::ICFBamInt64DefObj* orig );

		virtual cfbam::ICFBamInt64DefObj* realizeInt64Def( cfbam::ICFBamInt64DefObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeInt64Def( cfbam::ICFBamInt64DefObj* Obj );
		virtual cfbam::ICFBamInt64DefObj* createInt64Def( cfbam::ICFBamInt64DefEditObj* Obj );

		virtual cfbam::ICFBamInt64DefObj* readInt64Def( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamInt64DefObj* lockInt64Def( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamInt64DefObj*> readAllInt64Def( bool forceRead = false );

		virtual cfbam::ICFBamInt64DefObj* readInt64DefByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamInt64DefObj* readInt64DefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt64DefObj*> readInt64DefByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt64DefObj*> readInt64DefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt64DefObj*> readInt64DefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt64DefObj*> readInt64DefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt64DefObj*> readInt64DefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt64DefObj*> readInt64DefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt64DefObj*> readInt64DefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual cfbam::ICFBamInt64DefObj* readCachedInt64Def( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamInt64DefObj* readCachedInt64DefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamInt64DefObj* readCachedInt64DefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamInt64DefObj*> readCachedInt64DefByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamInt64DefObj*> readCachedInt64DefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamInt64DefObj*> readCachedInt64DefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamInt64DefObj*> readCachedInt64DefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamInt64DefObj*> readCachedInt64DefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamInt64DefObj*> readCachedInt64DefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamInt64DefObj*> readCachedInt64DefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamInt64DefObj* updateInt64Def( cfbam::ICFBamInt64DefEditObj* Obj );

		virtual void deleteInt64Def( cfbam::ICFBamInt64DefEditObj* Obj );

		virtual void deleteInt64DefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteInt64DefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteInt64DefByValTentIdx( const int64_t TenantId );

		virtual void deleteInt64DefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteInt64DefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteInt64DefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteInt64DefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteInt64DefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteInt64DefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamInt64DefObj* moveUpInt64Def( cfbam::ICFBamInt64DefObj* Obj );

		virtual cfbam::ICFBamInt64DefObj* moveDownInt64Def( cfbam::ICFBamInt64DefObj* Obj );

		virtual void reallyDetachFromIndexesInt64Def( cfbam::ICFBamInt64DefObj* Obj );
