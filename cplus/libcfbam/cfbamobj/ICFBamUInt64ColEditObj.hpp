...
// Description: C++18 Instance Edit Object interface for CFBam UInt64Col.
...
namespace cfbam {
	...
	class ICFBamUInt64ColEditObj
	: public virtual cfbam::ICFBamUInt64DefEditObj,
	  public virtual cfbam::ICFBamUInt64ColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamUInt64ColEditObj();
		virtual ~ICFBamUInt64ColEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamUInt64ColBuff* getUInt64ColBuff() {
			return( static_cast<cfbam::CFBamUInt64ColBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamUInt64ColBuff* getUInt64ColEditBuff() {
			return( dynamic_cast<cfbam::CFBamUInt64ColBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamUInt64ColObj* getOrigAsUInt64Col() = 0;
