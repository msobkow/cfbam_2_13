...
namespace cfbam {
	...
	{
	public:
		ICFBamUuidGenTableObj();
		virtual ~ICFBamUuidGenTableObj();
		...
		virtual cfbam::ICFBamUuidGenObj* newInstance() = 0;

		virtual cfbam::ICFBamUuidGenEditObj* newEditInstance( cfbam::ICFBamUuidGenObj* orig ) = 0;

		virtual cfbam::ICFBamUuidGenObj* realizeUuidGen( cfbam::ICFBamUuidGenObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeUuidGen( cfbam::ICFBamUuidGenObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamUuidGenObj* createUuidGen( cfbam::ICFBamUuidGenEditObj* Obj ) = 0;

		virtual cfbam::ICFBamUuidGenObj* readUuidGen( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamUuidGenObj* lockUuidGen( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamUuidGenObj*> readAllUuidGen( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamUuidGenObj* readCachedUuidGen( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamUuidGenObj*> readCachedUuidGenByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUuidGenObj* updateUuidGen( cfbam::ICFBamUuidGenEditObj* Obj ) = 0;

		virtual void deleteUuidGen( cfbam::ICFBamUuidGenEditObj* Obj ) = 0;
		...
		virtual void deleteUuidGenByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUuidGenObj* moveUpUuidGen( cfbam::ICFBamUuidGenObj* Obj ) = 0;

		virtual cfbam::ICFBamUuidGenObj* moveDownUuidGen( cfbam::ICFBamUuidGenObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesUuidGen( cfbam::ICFBamUuidGenObj* Obj ) = 0;
