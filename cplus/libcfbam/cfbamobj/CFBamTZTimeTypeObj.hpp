...
// Description: C++18 base object instance specification for CFBam TZTimeType.
...
namespace cfbam {
	...
	class CFBamTZTimeTypeObj
	: public CFBamTZTimeDefObj,
	  public virtual ICFBamTZTimeTypeObj
	{
	protected:
	public:
		...
		CFBamTZTimeTypeObj();
		CFBamTZTimeTypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTZTimeTypeObj();
