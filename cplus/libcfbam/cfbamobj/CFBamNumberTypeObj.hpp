...
// Description: C++18 base object instance specification for CFBam NumberType.
...
namespace cfbam {
	...
	class CFBamNumberTypeObj
	: public CFBamNumberDefObj,
	  public virtual ICFBamNumberTypeObj
	{
	protected:
	public:
		...
		CFBamNumberTypeObj();
		CFBamNumberTypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamNumberTypeObj();
