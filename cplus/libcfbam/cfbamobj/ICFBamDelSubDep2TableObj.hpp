...
namespace cfbam {
	...
	{
	public:
		ICFBamDelSubDep2TableObj();
		virtual ~ICFBamDelSubDep2TableObj();
		...
		virtual cfbam::ICFBamDelSubDep2Obj* newInstance() = 0;

		virtual cfbam::ICFBamDelSubDep2EditObj* newEditInstance( cfbam::ICFBamDelSubDep2Obj* orig ) = 0;

		virtual cfbam::ICFBamDelSubDep2Obj* realizeDelSubDep2( cfbam::ICFBamDelSubDep2Obj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByTenantIdx( const int64_t TenantId ) = 0;
		virtual void reallyDeepDisposeDelSubDep2( cfbam::ICFBamDelSubDep2Obj* Obj ) = 0;
		...
		virtual cfbam::ICFBamDelSubDep2Obj* createDelSubDep2( cfbam::ICFBamDelSubDep2EditObj* Obj ) = 0;

		virtual cfbam::ICFBamDelSubDep2Obj* readDelSubDep2( cfbam::CFBamScopePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamDelSubDep2Obj* lockDelSubDep2( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamDelSubDep2Obj*> readAllDelSubDep2( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamDelSubDep2Obj* readCachedDelSubDep2( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual cfbam::ICFBamDelSubDep2Obj* readCachedDelSubDep2ByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamDelSubDep2Obj*> readCachedDelSubDep2ByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamDelSubDep2Obj* updateDelSubDep2( cfbam::ICFBamDelSubDep2EditObj* Obj ) = 0;

		virtual void deleteDelSubDep2( cfbam::ICFBamDelSubDep2EditObj* Obj ) = 0;

		virtual void deleteDelSubDep2ByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deleteDelSubDep2ByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesDelSubDep2( cfbam::ICFBamDelSubDep2Obj* Obj ) = 0;
