...
// Description: C++18 edit object instance specification for CFBam BlobCol.
...
namespace cfbam {
	...
	class CFBamBlobColEditObj
	: public CFBamBlobDefEditObj,
	  public virtual ICFBamBlobColEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamBlobColEditObj( cfbam::ICFBamBlobColObj* argOrig );
		virtual ~CFBamBlobColEditObj();
		...
		virtual cfbam::ICFBamBlobColTableObj* getBlobColTable();

		virtual cfbam::ICFBamBlobColEditObj* getBlobColEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamBlobColObj* getOrigAsBlobCol();
		...
		inline cfbam::CFBamBlobColBuff* getBlobColBuff() {
			...
			return( static_cast<cfbam::CFBamBlobColBuff*>( buff ) );
		};
