...
namespace cfbam {
	...
	{
	public:
		ICFBamTimestampDefTableObj();
		virtual ~ICFBamTimestampDefTableObj();
		...
		virtual cfbam::ICFBamTimestampDefObj* newInstance() = 0;

		virtual cfbam::ICFBamTimestampDefEditObj* newEditInstance( cfbam::ICFBamTimestampDefObj* orig ) = 0;

		virtual cfbam::ICFBamTimestampDefObj* realizeTimestampDef( cfbam::ICFBamTimestampDefObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeTimestampDef( cfbam::ICFBamTimestampDefObj* Obj ) = 0;
		virtual cfbam::ICFBamTimestampDefObj* createTimestampDef( cfbam::ICFBamTimestampDefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamTimestampDefObj* readTimestampDef( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTimestampDefObj* lockTimestampDef( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamTimestampDefObj*> readAllTimestampDef( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamTimestampDefObj* readCachedTimestampDef( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamTimestampDefObj*> readCachedTimestampDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTimestampDefObj* updateTimestampDef( cfbam::ICFBamTimestampDefEditObj* Obj ) = 0;

		virtual void deleteTimestampDef( cfbam::ICFBamTimestampDefEditObj* Obj ) = 0;
		...
		virtual void deleteTimestampDefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTimestampDefObj* moveUpTimestampDef( cfbam::ICFBamTimestampDefObj* Obj ) = 0;

		virtual cfbam::ICFBamTimestampDefObj* moveDownTimestampDef( cfbam::ICFBamTimestampDefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesTimestampDef( cfbam::ICFBamTimestampDefObj* Obj ) = 0;
