...
// Description: C++18 edit object instance specification for CFBam UuidType.
...
namespace cfbam {
	...
	class CFBamUuidTypeEditObj
	: public CFBamUuidDefEditObj,
	  public virtual ICFBamUuidTypeEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamUuidTypeEditObj( cfbam::ICFBamUuidTypeObj* argOrig );
		virtual ~CFBamUuidTypeEditObj();
		...
		virtual cfbam::ICFBamUuidTypeTableObj* getUuidTypeTable();

		virtual cfbam::ICFBamUuidTypeEditObj* getUuidTypeEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamUuidTypeObj* getOrigAsUuidType();

		virtual cfbam::CFBamValueBuff* getBuff();
		virtual void setBuff( cfbam::CFBamValueBuff* value );

		inline cfbam::CFBamUuidTypeBuff* getUuidTypeBuff() {
			// Buff is always instantiated when constructed over an original object
			return( static_cast<cfbam::CFBamUuidTypeBuff*>( buff ) );
		};

		inline cfbam::CFBamUuidTypeBuff* getUuidTypeEditBuff() {
			// Buff is always instantiated when constructed over an original object
