...
// Description: C++18 base object instance specification for CFBam Value.
...
namespace cfbam {
	...
	class CFBamValueObj
	: public virtual ICFBamValueObj
	{
	protected:
		cfsec::ICFSecSecUserObj* createdBy = NULL;
		cfsec::ICFSecSecUserObj* updatedBy = NULL;
		bool isNew;
		cfbam::ICFBamValueEditObj* edit;
	...
	public:
		...
		CFBamValueObj();
		CFBamValueObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamValueObj();
