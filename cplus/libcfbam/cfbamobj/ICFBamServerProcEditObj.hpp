...
// Description: C++18 Instance Edit Object interface for CFBam ServerProc.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamServerMethodEditObj,
	  public virtual cfbam::ICFBamServerProcObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamServerProcEditObj();
		virtual ~ICFBamServerProcEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamServerProcBuff* getServerProcBuff() {
			return( static_cast<cfbam::CFBamServerProcBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamServerProcBuff* getServerProcEditBuff() {
			return( dynamic_cast<cfbam::CFBamServerProcBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamServerProcObj* getOrigAsServerProc() = 0;
