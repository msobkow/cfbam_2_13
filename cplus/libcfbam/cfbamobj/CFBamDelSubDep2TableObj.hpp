...
namespace cfbam {
	...
	class CFBamDelSubDep2TableObj
	: public virtual ICFBamDelSubDep2TableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamDelSubDep2Obj*>* members;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamDelSubDep2Obj*>* allDelSubDep2;
		std::map< cfbam::CFBamScopeByTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamDelSubDep2Obj*>*>* indexByTenantIdx;
		std::map< cfbam::CFBamDelDepByDefSchemaIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamDelSubDep2Obj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamDelDepByDelDepIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamDelSubDep2Obj*>*>* indexByDelDepIdx;
		std::map< cfbam::CFBamDelSubDep2ByContDelDep1IdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamDelSubDep2Obj*>*>* indexByContDelDep1Idx;
		std::map< cfbam::CFBamDelSubDep2ByUNameIdxKey,
			cfbam::ICFBamDelSubDep2Obj*>* indexByUNameIdx;
	...
	public:
		...
		CFBamDelSubDep2TableObj();
		CFBamDelSubDep2TableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamDelSubDep2TableObj();
		...
		virtual cfbam::ICFBamDelSubDep2Obj* newInstance();

		virtual cfbam::ICFBamDelSubDep2EditObj* newEditInstance( cfbam::ICFBamDelSubDep2Obj* orig );

		virtual cfbam::ICFBamDelSubDep2Obj* realizeDelSubDep2( cfbam::ICFBamDelSubDep2Obj* Obj );

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id );
		virtual void deepDisposeByTenantIdx( const int64_t TenantId );
		virtual void reallyDeepDisposeDelSubDep2( cfbam::ICFBamDelSubDep2Obj* Obj );
		...
		virtual void deepDisposeByContDelDep1Idx( const int64_t DelSubDep1TenantId,
			const int64_t DelSubDep1Id );
		virtual void deepDisposeByUNameIdx( const int64_t DelSubDep1TenantId,
			const int64_t DelSubDep1Id,
			const std::string& Name );
		virtual cfbam::ICFBamDelSubDep2Obj* createDelSubDep2( cfbam::ICFBamDelSubDep2EditObj* Obj );

		virtual cfbam::ICFBamDelSubDep2Obj* readDelSubDep2( cfbam::CFBamScopePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamDelSubDep2Obj* lockDelSubDep2( cfbam::CFBamScopePKey* pkey );

		virtual std::vector<cfbam::ICFBamDelSubDep2Obj*> readAllDelSubDep2( bool forceRead = false );

		virtual cfbam::ICFBamDelSubDep2Obj* readDelSubDep2ByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDelSubDep2Obj*> readDelSubDep2ByTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDelSubDep2Obj*> readDelSubDep2ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDelSubDep2Obj*> readDelSubDep2ByDelDepIdx( const int64_t RelationTenantId,
			const int64_t RelationId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDelSubDep2Obj*> readDelSubDep2ByContDelDep1Idx( const int64_t DelSubDep1TenantId,
			const int64_t DelSubDep1Id,
			bool forceRead = false );

		virtual cfbam::ICFBamDelSubDep2Obj* readDelSubDep2ByUNameIdx( const int64_t DelSubDep1TenantId,
			const int64_t DelSubDep1Id,
			const std::string& Name, bool forceRead = false );

		virtual cfbam::ICFBamDelSubDep2Obj* readCachedDelSubDep2( cfbam::CFBamScopePKey* pkey );

		virtual cfbam::ICFBamDelSubDep2Obj* readCachedDelSubDep2ByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual std::vector<cfbam::ICFBamDelSubDep2Obj*> readCachedDelSubDep2ByTenantIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamDelSubDep2Obj*> readCachedDelSubDep2ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamDelSubDep2Obj*> readCachedDelSubDep2ByDelDepIdx( const int64_t RelationTenantId,
			const int64_t RelationId );

		virtual std::vector<cfbam::ICFBamDelSubDep2Obj*> readCachedDelSubDep2ByContDelDep1Idx( const int64_t DelSubDep1TenantId,
			const int64_t DelSubDep1Id );

		virtual cfbam::ICFBamDelSubDep2Obj* readCachedDelSubDep2ByUNameIdx( const int64_t DelSubDep1TenantId,
			const int64_t DelSubDep1Id,
			const std::string& Name );

		virtual cfbam::ICFBamDelSubDep2Obj* updateDelSubDep2( cfbam::ICFBamDelSubDep2EditObj* Obj );

		virtual void deleteDelSubDep2( cfbam::ICFBamDelSubDep2EditObj* Obj );

		virtual void deleteDelSubDep2ByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteDelSubDep2ByTenantIdx( const int64_t TenantId );

		virtual void deleteDelSubDep2ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteDelSubDep2ByDelDepIdx( const int64_t RelationTenantId,
			const int64_t RelationId );

		virtual void deleteDelSubDep2ByContDelDep1Idx( const int64_t DelSubDep1TenantId,
			const int64_t DelSubDep1Id );

		virtual void deleteDelSubDep2ByUNameIdx( const int64_t DelSubDep1TenantId,
			const int64_t DelSubDep1Id,
			const std::string& Name );

		virtual void reallyDetachFromIndexesDelSubDep2( cfbam::ICFBamDelSubDep2Obj* Obj );
