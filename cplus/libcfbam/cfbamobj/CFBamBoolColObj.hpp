...
// Description: C++18 base object instance specification for CFBam BoolCol.
...
namespace cfbam {
	...
	class CFBamBoolColObj
	: public CFBamBoolDefObj,
	  public virtual ICFBamBoolColObj
	{
	protected:
	public:
		...
		CFBamBoolColObj();
		CFBamBoolColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamBoolColObj();
