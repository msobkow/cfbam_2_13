...
// Description: C++18 Instance Edit Object interface for CFBam UInt32Def.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamAtomEditObj,
	  public virtual cfbam::ICFBamUInt32DefObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamUInt32DefEditObj();
		virtual ~ICFBamUInt32DefEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamUInt32DefBuff* getUInt32DefBuff() {
			return( static_cast<cfbam::CFBamUInt32DefBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamUInt32DefBuff* getUInt32DefEditBuff() {
			return( dynamic_cast<cfbam::CFBamUInt32DefBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamUInt32DefObj* getOrigAsUInt32Def() = 0;

		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual bool isOptionalInitValueNull() = 0;
		virtual const uint32_t getOptionalInitValueValue() = 0;
		virtual const uint32_t* getOptionalInitValueReference() = 0;
		virtual void setOptionalInitValueNull() = 0;
		virtual void setOptionalInitValueValue( const uint32_t value ) = 0;

		virtual bool isOptionalMinValueNull() = 0;
		virtual const uint32_t getOptionalMinValueValue() = 0;
		virtual const uint32_t* getOptionalMinValueReference() = 0;
		virtual void setOptionalMinValueNull() = 0;
		virtual void setOptionalMinValueValue( const uint32_t value ) = 0;

		virtual bool isOptionalMaxValueNull() = 0;
		virtual const uint32_t getOptionalMaxValueValue() = 0;
		virtual const uint32_t* getOptionalMaxValueReference() = 0;
		virtual void setOptionalMaxValueNull() = 0;
		virtual void setOptionalMaxValueValue( const uint32_t value ) = 0;
