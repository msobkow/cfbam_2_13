...
// Description: C++18 Object interface for CFBam ServerListFunc.
...
namespace cfbam {
	...
	public:
		...
		virtual ~ICFBamServerListFuncObj();
		virtual cfbam::ICFBamScopeEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamServerListFuncEditObj* getServerListFuncEdit() = 0;

		inline cfbam::CFBamServerListFuncBuff* getServerListFuncBuff() {
			return( static_cast<cfbam::CFBamServerListFuncBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamServerListFuncBuff* getServerListFuncEditBuff() {
			return( dynamic_cast<cfbam::CFBamServerListFuncBuff*>( getBuff() ) );
		};

		virtual bool isOptionalRetTenantIdNull() = 0;
		virtual const int64_t getOptionalRetTenantIdValue() = 0;
		virtual const int64_t* getOptionalRetTenantIdReference() = 0;

		virtual bool isOptionalRetTableIdNull() = 0;
		virtual const int64_t getOptionalRetTableIdValue() = 0;
		virtual const int64_t* getOptionalRetTableIdReference() = 0;

		virtual cfbam::ICFBamTableObj* getOptionalLookupRetTable( bool forceRead = false ) = 0;
