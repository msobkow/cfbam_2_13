...
// Description: C++18 Instance Edit Object interface for CFBam NmTokenType.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamNmTokenDefEditObj,
	  public virtual cfbam::ICFBamNmTokenTypeObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamNmTokenTypeEditObj();
		virtual ~ICFBamNmTokenTypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamNmTokenTypeBuff* getNmTokenTypeBuff() {
			return( static_cast<cfbam::CFBamNmTokenTypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamNmTokenTypeBuff* getNmTokenTypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamNmTokenTypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamNmTokenTypeObj* getOrigAsNmTokenType() = 0;
