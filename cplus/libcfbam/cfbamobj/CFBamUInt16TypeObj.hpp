...
// Description: C++18 base object instance specification for CFBam UInt16Type.
...
namespace cfbam {
	...
	class CFBamUInt16TypeObj
	: public CFBamUInt16DefObj,
	  public virtual ICFBamUInt16TypeObj
	{
	protected:
	public:
		...
		CFBamUInt16TypeObj();
		CFBamUInt16TypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamUInt16TypeObj();
