...
namespace cfbam {
	...
	class CFBamRelationTableObj
	: public virtual ICFBamRelationTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamRelationObj*>* members;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamRelationObj*>* allRelation;
		std::map< cfbam::CFBamScopeByTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamRelationObj*>*>* indexByTenantIdx;
		std::map< cfbam::CFBamRelationByUNameIdxKey,
			cfbam::ICFBamRelationObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamRelationByRelnTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamRelationObj*>*>* indexByRelnTenantIdx;
		std::map< cfbam::CFBamRelationByRelTableIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamRelationObj*>*>* indexByRelTableIdx;
		std::map< cfbam::CFBamRelationByDefSchemaIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamRelationObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamRelationByFromKeyIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamRelationObj*>*>* indexByFromKeyIdx;
		std::map< cfbam::CFBamRelationByToTblIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamRelationObj*>*>* indexByToTblIdx;
		std::map< cfbam::CFBamRelationByToKeyIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamRelationObj*>*>* indexByToKeyIdx;
		std::map< cfbam::CFBamRelationByNarrowedIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamRelationObj*>*>* indexByNarrowedIdx;
	...
	public:
		...
		CFBamRelationTableObj();
		CFBamRelationTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamRelationTableObj();
		...
		virtual cfbam::ICFBamRelationObj* newInstance();

		virtual cfbam::ICFBamRelationEditObj* newEditInstance( cfbam::ICFBamRelationObj* orig );

		virtual cfbam::ICFBamRelationObj* realizeRelation( cfbam::ICFBamRelationObj* Obj );

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id );
		virtual void deepDisposeByTenantIdx( const int64_t TenantId );
		virtual void reallyDeepDisposeRelation( cfbam::ICFBamRelationObj* Obj );
		virtual void deepDisposeByUNameIdx( const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name );
		virtual void deepDisposeByRelnTenantIdx( const int64_t TenantId );
		virtual void deepDisposeByRelTableIdx( const int64_t TenantId,
			const int64_t TableId );
		virtual void deepDisposeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );
		virtual void deepDisposeByFromKeyIdx( const int64_t TenantId,
			const int64_t FromIndexId );
		virtual void deepDisposeByToTblIdx( const int64_t TenantId,
			const int64_t ToTableId );
		virtual void deepDisposeByToKeyIdx( const int64_t TenantId,
			const int64_t ToIndexId );
		virtual void deepDisposeByNarrowedIdx( const int64_t* NarrowedTenantId,
			const int64_t* NarrowedId );
		virtual cfbam::ICFBamRelationObj* createRelation( cfbam::ICFBamRelationEditObj* Obj );

		virtual cfbam::ICFBamRelationObj* readRelation( cfbam::CFBamScopePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamRelationObj* lockRelation( cfbam::CFBamScopePKey* pkey );

		virtual std::vector<cfbam::ICFBamRelationObj*> readAllRelation( bool forceRead = false );

		virtual cfbam::ICFBamRelationObj* readRelationByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamRelationObj*> readRelationByTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual cfbam::ICFBamRelationObj* readRelationByUNameIdx( const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamRelationObj*> readRelationByRelnTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamRelationObj*> readRelationByRelTableIdx( const int64_t TenantId,
			const int64_t TableId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamRelationObj*> readRelationByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamRelationObj*> readRelationByFromKeyIdx( const int64_t TenantId,
			const int64_t FromIndexId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamRelationObj*> readRelationByToTblIdx( const int64_t TenantId,
			const int64_t ToTableId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamRelationObj*> readRelationByToKeyIdx( const int64_t TenantId,
			const int64_t ToIndexId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamRelationObj*> readRelationByNarrowedIdx( const int64_t* NarrowedTenantId,
			const int64_t* NarrowedId,
			bool forceRead = false );

		virtual cfbam::ICFBamRelationObj* readCachedRelation( cfbam::CFBamScopePKey* pkey );

		virtual cfbam::ICFBamRelationObj* readCachedRelationByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual std::vector<cfbam::ICFBamRelationObj*> readCachedRelationByTenantIdx( const int64_t TenantId );

		virtual cfbam::ICFBamRelationObj* readCachedRelationByUNameIdx( const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamRelationObj*> readCachedRelationByRelnTenantIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamRelationObj*> readCachedRelationByRelTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual std::vector<cfbam::ICFBamRelationObj*> readCachedRelationByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamRelationObj*> readCachedRelationByFromKeyIdx( const int64_t TenantId,
			const int64_t FromIndexId );

		virtual std::vector<cfbam::ICFBamRelationObj*> readCachedRelationByToTblIdx( const int64_t TenantId,
			const int64_t ToTableId );

		virtual std::vector<cfbam::ICFBamRelationObj*> readCachedRelationByToKeyIdx( const int64_t TenantId,
			const int64_t ToIndexId );

		virtual std::vector<cfbam::ICFBamRelationObj*> readCachedRelationByNarrowedIdx( const int64_t* NarrowedTenantId,
			const int64_t* NarrowedId );

		virtual cfbam::ICFBamRelationObj* readRelationByLookupUNameIdx( const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name, bool forceRead = false );

		virtual cfbam::ICFBamRelationObj* readCachedRelationByLookupUNameIdx( const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name );

		virtual cfbam::ICFBamRelationObj* updateRelation( cfbam::ICFBamRelationEditObj* Obj );

		virtual void deleteRelation( cfbam::ICFBamRelationEditObj* Obj );

		virtual void deleteRelationByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteRelationByTenantIdx( const int64_t TenantId );

		virtual void deleteRelationByUNameIdx( const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name );

		virtual void deleteRelationByRelnTenantIdx( const int64_t TenantId );

		virtual void deleteRelationByRelTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual void deleteRelationByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteRelationByFromKeyIdx( const int64_t TenantId,
			const int64_t FromIndexId );

		virtual void deleteRelationByToTblIdx( const int64_t TenantId,
			const int64_t ToTableId );

		virtual void deleteRelationByToKeyIdx( const int64_t TenantId,
			const int64_t ToIndexId );

		virtual void deleteRelationByNarrowedIdx( const int64_t* NarrowedTenantId,
			const int64_t* NarrowedId );

		virtual void reallyDetachFromIndexesRelation( cfbam::ICFBamRelationObj* Obj );
