...
namespace cfbam {
	...
	class CFBamTZTimestampDefTableObj
	: public virtual ICFBamTZTimestampDefTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampDefObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampDefObj*>* allTZTimestampDef;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamTZTimestampDefObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampDefObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampDefObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampDefObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampDefObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampDefObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampDefObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampDefObj*>*>* indexByContNextIdx;
	...
	public:
		...
		CFBamTZTimestampDefTableObj();
		CFBamTZTimestampDefTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamTZTimestampDefTableObj();
		...
		virtual cfbam::ICFBamTZTimestampDefObj* newInstance();

		virtual cfbam::ICFBamTZTimestampDefEditObj* newEditInstance( cfbam::ICFBamTZTimestampDefObj* orig );

		virtual cfbam::ICFBamTZTimestampDefObj* realizeTZTimestampDef( cfbam::ICFBamTZTimestampDefObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeTZTimestampDef( cfbam::ICFBamTZTimestampDefObj* Obj );
		virtual cfbam::ICFBamTZTimestampDefObj* createTZTimestampDef( cfbam::ICFBamTZTimestampDefEditObj* Obj );

		virtual cfbam::ICFBamTZTimestampDefObj* readTZTimestampDef( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamTZTimestampDefObj* lockTZTimestampDef( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamTZTimestampDefObj*> readAllTZTimestampDef( bool forceRead = false );

		virtual cfbam::ICFBamTZTimestampDefObj* readTZTimestampDefByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamTZTimestampDefObj* readTZTimestampDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimestampDefObj*> readTZTimestampDefByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimestampDefObj*> readTZTimestampDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimestampDefObj*> readTZTimestampDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimestampDefObj*> readTZTimestampDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimestampDefObj*> readTZTimestampDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimestampDefObj*> readTZTimestampDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimestampDefObj*> readTZTimestampDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual cfbam::ICFBamTZTimestampDefObj* readCachedTZTimestampDef( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamTZTimestampDefObj* readCachedTZTimestampDefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamTZTimestampDefObj* readCachedTZTimestampDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamTZTimestampDefObj*> readCachedTZTimestampDefByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamTZTimestampDefObj*> readCachedTZTimestampDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamTZTimestampDefObj*> readCachedTZTimestampDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamTZTimestampDefObj*> readCachedTZTimestampDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamTZTimestampDefObj*> readCachedTZTimestampDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamTZTimestampDefObj*> readCachedTZTimestampDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamTZTimestampDefObj*> readCachedTZTimestampDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamTZTimestampDefObj* updateTZTimestampDef( cfbam::ICFBamTZTimestampDefEditObj* Obj );

		virtual void deleteTZTimestampDef( cfbam::ICFBamTZTimestampDefEditObj* Obj );

		virtual void deleteTZTimestampDefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteTZTimestampDefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteTZTimestampDefByValTentIdx( const int64_t TenantId );

		virtual void deleteTZTimestampDefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteTZTimestampDefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteTZTimestampDefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteTZTimestampDefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteTZTimestampDefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteTZTimestampDefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamTZTimestampDefObj* moveUpTZTimestampDef( cfbam::ICFBamTZTimestampDefObj* Obj );

		virtual cfbam::ICFBamTZTimestampDefObj* moveDownTZTimestampDef( cfbam::ICFBamTZTimestampDefObj* Obj );

		virtual void reallyDetachFromIndexesTZTimestampDef( cfbam::ICFBamTZTimestampDefObj* Obj );
