...
// Description: C++18 base object instance specification for CFBam NmTokenType.
...
namespace cfbam {
	...
	class CFBamNmTokenTypeObj
	: public CFBamNmTokenDefObj,
	  public virtual ICFBamNmTokenTypeObj
	{
	protected:
	public:
		...
		CFBamNmTokenTypeObj();
		CFBamNmTokenTypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamNmTokenTypeObj();
