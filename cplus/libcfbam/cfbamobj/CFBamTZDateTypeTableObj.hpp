...
namespace cfbam {
	...
	class CFBamTZDateTypeTableObj
	: public virtual ICFBamTZDateTypeTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZDateTypeObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZDateTypeObj*>* allTZDateType;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamTZDateTypeObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZDateTypeObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZDateTypeObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZDateTypeObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZDateTypeObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZDateTypeObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZDateTypeObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZDateTypeObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamTZDateTypeBySchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZDateTypeObj*>*>* indexBySchemaIdx;
	...
	public:
		...
		CFBamTZDateTypeTableObj();
		CFBamTZDateTypeTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamTZDateTypeTableObj();
		...
		virtual cfbam::ICFBamTZDateTypeObj* newInstance();

		virtual cfbam::ICFBamTZDateTypeEditObj* newEditInstance( cfbam::ICFBamTZDateTypeObj* orig );

		virtual cfbam::ICFBamTZDateTypeObj* realizeTZDateType( cfbam::ICFBamTZDateTypeObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeTZDateType( cfbam::ICFBamTZDateTypeObj* Obj );
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );
		virtual cfbam::ICFBamTZDateTypeObj* createTZDateType( cfbam::ICFBamTZDateTypeEditObj* Obj );

		virtual cfbam::ICFBamTZDateTypeObj* readTZDateType( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamTZDateTypeObj* lockTZDateType( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamTZDateTypeObj*> readAllTZDateType( bool forceRead = false );

		virtual cfbam::ICFBamTZDateTypeObj* readTZDateTypeByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamTZDateTypeObj* readTZDateTypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZDateTypeObj*> readTZDateTypeByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZDateTypeObj*> readTZDateTypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZDateTypeObj*> readTZDateTypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZDateTypeObj*> readTZDateTypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZDateTypeObj*> readTZDateTypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZDateTypeObj*> readTZDateTypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZDateTypeObj*> readTZDateTypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZDateTypeObj*> readTZDateTypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId,
			bool forceRead = false );

		virtual cfbam::ICFBamTZDateTypeObj* readCachedTZDateType( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamTZDateTypeObj* readCachedTZDateTypeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamTZDateTypeObj* readCachedTZDateTypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamTZDateTypeObj*> readCachedTZDateTypeByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamTZDateTypeObj*> readCachedTZDateTypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamTZDateTypeObj*> readCachedTZDateTypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamTZDateTypeObj*> readCachedTZDateTypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamTZDateTypeObj*> readCachedTZDateTypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamTZDateTypeObj*> readCachedTZDateTypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamTZDateTypeObj*> readCachedTZDateTypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamTZDateTypeObj*> readCachedTZDateTypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual cfbam::ICFBamTZDateTypeObj* updateTZDateType( cfbam::ICFBamTZDateTypeEditObj* Obj );

		virtual void deleteTZDateType( cfbam::ICFBamTZDateTypeEditObj* Obj );

		virtual void deleteTZDateTypeByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteTZDateTypeByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteTZDateTypeByValTentIdx( const int64_t TenantId );

		virtual void deleteTZDateTypeByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteTZDateTypeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteTZDateTypeByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteTZDateTypeByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteTZDateTypeByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteTZDateTypeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteTZDateTypeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId );

		virtual cfbam::ICFBamTZDateTypeObj* moveUpTZDateType( cfbam::ICFBamTZDateTypeObj* Obj );

		virtual cfbam::ICFBamTZDateTypeObj* moveDownTZDateType( cfbam::ICFBamTZDateTypeObj* Obj );

		virtual void reallyDetachFromIndexesTZDateType( cfbam::ICFBamTZDateTypeObj* Obj );
