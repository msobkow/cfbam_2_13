...
namespace cfbam {
	...
	class CFBamPopTopDepTableObj
	: public virtual ICFBamPopTopDepTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopTopDepObj*>* members;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopTopDepObj*>* allPopTopDep;
		std::map< cfbam::CFBamScopeByTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopTopDepObj*>*>* indexByTenantIdx;
		std::map< cfbam::CFBamPopDepByRelationIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopTopDepObj*>*>* indexByRelationIdx;
		std::map< cfbam::CFBamPopDepByDefSchemaIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopTopDepObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamPopTopDepByContRelIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopTopDepObj*>*>* indexByContRelIdx;
		std::map< cfbam::CFBamPopTopDepByUNameIdxKey,
			cfbam::ICFBamPopTopDepObj*>* indexByUNameIdx;
	...
	public:
		...
		CFBamPopTopDepTableObj();
		CFBamPopTopDepTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamPopTopDepTableObj();
		...
		virtual cfbam::ICFBamPopTopDepObj* newInstance();

		virtual cfbam::ICFBamPopTopDepEditObj* newEditInstance( cfbam::ICFBamPopTopDepObj* orig );

		virtual cfbam::ICFBamPopTopDepObj* realizePopTopDep( cfbam::ICFBamPopTopDepObj* Obj );

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id );
		virtual void deepDisposeByTenantIdx( const int64_t TenantId );
		virtual void reallyDeepDisposePopTopDep( cfbam::ICFBamPopTopDepObj* Obj );
		...
		virtual void deepDisposeByContRelIdx( const int64_t ContRelationTenantId,
			const int64_t ContRelationId );
		virtual void deepDisposeByUNameIdx( const int64_t ContRelationTenantId,
			const int64_t ContRelationId,
			const std::string& Name );
		virtual cfbam::ICFBamPopTopDepObj* createPopTopDep( cfbam::ICFBamPopTopDepEditObj* Obj );

		virtual cfbam::ICFBamPopTopDepObj* readPopTopDep( cfbam::CFBamScopePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamPopTopDepObj* lockPopTopDep( cfbam::CFBamScopePKey* pkey );

		virtual std::vector<cfbam::ICFBamPopTopDepObj*> readAllPopTopDep( bool forceRead = false );

		virtual cfbam::ICFBamPopTopDepObj* readPopTopDepByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamPopTopDepObj*> readPopTopDepByTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamPopTopDepObj*> readPopTopDepByRelationIdx( const int64_t RelationTenantId,
			const int64_t RelationId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamPopTopDepObj*> readPopTopDepByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamPopTopDepObj*> readPopTopDepByContRelIdx( const int64_t ContRelationTenantId,
			const int64_t ContRelationId,
			bool forceRead = false );

		virtual cfbam::ICFBamPopTopDepObj* readPopTopDepByUNameIdx( const int64_t ContRelationTenantId,
			const int64_t ContRelationId,
			const std::string& Name, bool forceRead = false );

		virtual cfbam::ICFBamPopTopDepObj* readCachedPopTopDep( cfbam::CFBamScopePKey* pkey );

		virtual cfbam::ICFBamPopTopDepObj* readCachedPopTopDepByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual std::vector<cfbam::ICFBamPopTopDepObj*> readCachedPopTopDepByTenantIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamPopTopDepObj*> readCachedPopTopDepByRelationIdx( const int64_t RelationTenantId,
			const int64_t RelationId );

		virtual std::vector<cfbam::ICFBamPopTopDepObj*> readCachedPopTopDepByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamPopTopDepObj*> readCachedPopTopDepByContRelIdx( const int64_t ContRelationTenantId,
			const int64_t ContRelationId );

		virtual cfbam::ICFBamPopTopDepObj* readCachedPopTopDepByUNameIdx( const int64_t ContRelationTenantId,
			const int64_t ContRelationId,
			const std::string& Name );

		virtual cfbam::ICFBamPopTopDepObj* updatePopTopDep( cfbam::ICFBamPopTopDepEditObj* Obj );

		virtual void deletePopTopDep( cfbam::ICFBamPopTopDepEditObj* Obj );

		virtual void deletePopTopDepByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deletePopTopDepByTenantIdx( const int64_t TenantId );

		virtual void deletePopTopDepByRelationIdx( const int64_t RelationTenantId,
			const int64_t RelationId );

		virtual void deletePopTopDepByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deletePopTopDepByContRelIdx( const int64_t ContRelationTenantId,
			const int64_t ContRelationId );

		virtual void deletePopTopDepByUNameIdx( const int64_t ContRelationTenantId,
			const int64_t ContRelationId,
			const std::string& Name );

		virtual void reallyDetachFromIndexesPopTopDep( cfbam::ICFBamPopTopDepObj* Obj );
