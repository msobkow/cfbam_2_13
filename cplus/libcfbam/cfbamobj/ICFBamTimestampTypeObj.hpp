...
// Description: C++18 Object interface for CFBam TimestampType.
...
namespace cfbam {
	...
	public:
		...
		virtual ~ICFBamTimestampTypeObj();
		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamTimestampTypeEditObj* getTimestampTypeEdit() = 0;
