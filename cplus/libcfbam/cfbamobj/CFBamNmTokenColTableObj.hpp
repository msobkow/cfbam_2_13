...
namespace cfbam {
	...
	class CFBamNmTokenColTableObj
	: public virtual ICFBamNmTokenColTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenColObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenColObj*>* allNmTokenCol;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamNmTokenColObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenColObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenColObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenColObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenColObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenColObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenColObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenColObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamNmTokenColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamNmTokenColObj*>*>* indexByTableIdx;
	...
	public:
		...
		CFBamNmTokenColTableObj();
		CFBamNmTokenColTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamNmTokenColTableObj();
		...
		virtual cfbam::ICFBamNmTokenColObj* newInstance();

		virtual cfbam::ICFBamNmTokenColEditObj* newEditInstance( cfbam::ICFBamNmTokenColObj* orig );

		virtual cfbam::ICFBamNmTokenColObj* realizeNmTokenCol( cfbam::ICFBamNmTokenColObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeNmTokenCol( cfbam::ICFBamNmTokenColObj* Obj );
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId );
		virtual cfbam::ICFBamNmTokenColObj* createNmTokenCol( cfbam::ICFBamNmTokenColEditObj* Obj );

		virtual cfbam::ICFBamNmTokenColObj* readNmTokenCol( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamNmTokenColObj* lockNmTokenCol( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamNmTokenColObj*> readAllNmTokenCol( bool forceRead = false );

		virtual cfbam::ICFBamNmTokenColObj* readNmTokenColByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamNmTokenColObj* readNmTokenColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokenColObj*> readNmTokenColByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokenColObj*> readNmTokenColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokenColObj*> readNmTokenColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokenColObj*> readNmTokenColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokenColObj*> readNmTokenColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokenColObj*> readNmTokenColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokenColObj*> readNmTokenColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamNmTokenColObj*> readNmTokenColByTableIdx( const int64_t TenantId,
			const int64_t TableId,
			bool forceRead = false );

		virtual cfbam::ICFBamNmTokenColObj* readCachedNmTokenCol( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamNmTokenColObj* readCachedNmTokenColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamNmTokenColObj* readCachedNmTokenColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamNmTokenColObj*> readCachedNmTokenColByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamNmTokenColObj*> readCachedNmTokenColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamNmTokenColObj*> readCachedNmTokenColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamNmTokenColObj*> readCachedNmTokenColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamNmTokenColObj*> readCachedNmTokenColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamNmTokenColObj*> readCachedNmTokenColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamNmTokenColObj*> readCachedNmTokenColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamNmTokenColObj*> readCachedNmTokenColByTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual cfbam::ICFBamNmTokenColObj* updateNmTokenCol( cfbam::ICFBamNmTokenColEditObj* Obj );

		virtual void deleteNmTokenCol( cfbam::ICFBamNmTokenColEditObj* Obj );

		virtual void deleteNmTokenColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteNmTokenColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteNmTokenColByValTentIdx( const int64_t TenantId );

		virtual void deleteNmTokenColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteNmTokenColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteNmTokenColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteNmTokenColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteNmTokenColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteNmTokenColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteNmTokenColByTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual cfbam::ICFBamNmTokenColObj* moveUpNmTokenCol( cfbam::ICFBamNmTokenColObj* Obj );

		virtual cfbam::ICFBamNmTokenColObj* moveDownNmTokenCol( cfbam::ICFBamNmTokenColObj* Obj );

		virtual void reallyDetachFromIndexesNmTokenCol( cfbam::ICFBamNmTokenColObj* Obj );
