...
namespace cfbam {
	...
	{
	public:
		ICFBamUInt32TypeTableObj();
		virtual ~ICFBamUInt32TypeTableObj();
		...
		virtual cfbam::ICFBamUInt32TypeObj* newInstance() = 0;

		virtual cfbam::ICFBamUInt32TypeEditObj* newEditInstance( cfbam::ICFBamUInt32TypeObj* orig ) = 0;

		virtual cfbam::ICFBamUInt32TypeObj* realizeUInt32Type( cfbam::ICFBamUInt32TypeObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeUInt32Type( cfbam::ICFBamUInt32TypeObj* Obj ) = 0;
		virtual void deepDisposeBySchemaIdx( const int64_t TenantId,
			const int64_t SchemaDefId ) = 0;
		virtual cfbam::ICFBamUInt32TypeObj* createUInt32Type( cfbam::ICFBamUInt32TypeEditObj* Obj ) = 0;

		virtual cfbam::ICFBamUInt32TypeObj* readUInt32Type( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamUInt32TypeObj* lockUInt32Type( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamUInt32TypeObj*> readAllUInt32Type( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamUInt32TypeObj* readCachedUInt32Type( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamUInt32TypeObj*> readCachedUInt32TypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUInt32TypeObj* updateUInt32Type( cfbam::ICFBamUInt32TypeEditObj* Obj ) = 0;

		virtual void deleteUInt32Type( cfbam::ICFBamUInt32TypeEditObj* Obj ) = 0;
		...
		virtual void deleteUInt32TypeByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUInt32TypeObj* moveUpUInt32Type( cfbam::ICFBamUInt32TypeObj* Obj ) = 0;

		virtual cfbam::ICFBamUInt32TypeObj* moveDownUInt32Type( cfbam::ICFBamUInt32TypeObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesUInt32Type( cfbam::ICFBamUInt32TypeObj* Obj ) = 0;
