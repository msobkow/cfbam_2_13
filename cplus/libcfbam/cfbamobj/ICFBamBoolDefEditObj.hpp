...
// Description: C++18 Instance Edit Object interface for CFBam BoolDef.
...
namespace cfbam {
	...
	class ICFBamBoolDefEditObj
	: public virtual cfbam::ICFBamAtomEditObj,
	  public virtual cfbam::ICFBamBoolDefObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamBoolDefEditObj();
		virtual ~ICFBamBoolDefEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamBoolDefBuff* getBoolDefBuff() {
			return( static_cast<cfbam::CFBamBoolDefBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamBoolDefBuff* getBoolDefEditBuff() {
			return( dynamic_cast<cfbam::CFBamBoolDefBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamBoolDefObj* getOrigAsBoolDef() = 0;

		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual bool isOptionalInitValueNull() = 0;
		virtual const bool getOptionalInitValueValue() = 0;
		virtual const bool* getOptionalInitValueReference() = 0;
		virtual void setOptionalInitValueNull() = 0;
		virtual void setOptionalInitValueValue( const bool value ) = 0;

		virtual bool isOptionalFalseStringNull() = 0;
		virtual const std::string& getOptionalFalseStringValue() = 0;
		virtual const std::string* getOptionalFalseStringReference() = 0;
		virtual void setOptionalFalseStringNull() = 0;
		virtual void setOptionalFalseStringValue( const std::string& value ) = 0;

		virtual bool isOptionalTrueStringNull() = 0;
		virtual const std::string& getOptionalTrueStringValue() = 0;
		virtual const std::string* getOptionalTrueStringReference() = 0;
		virtual void setOptionalTrueStringNull() = 0;
		virtual void setOptionalTrueStringValue( const std::string& value ) = 0;

		virtual bool isOptionalNullStringNull() = 0;
		virtual const std::string& getOptionalNullStringValue() = 0;
		virtual const std::string* getOptionalNullStringReference() = 0;
		virtual void setOptionalNullStringNull() = 0;
		virtual void setOptionalNullStringValue( const std::string& value ) = 0;
