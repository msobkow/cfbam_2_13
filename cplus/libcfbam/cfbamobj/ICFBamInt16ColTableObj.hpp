...
namespace cfbam {
	...
	{
	public:
		ICFBamInt16ColTableObj();
		virtual ~ICFBamInt16ColTableObj();
		...
		virtual cfbam::ICFBamInt16ColObj* newInstance() = 0;

		virtual cfbam::ICFBamInt16ColEditObj* newEditInstance( cfbam::ICFBamInt16ColObj* orig ) = 0;

		virtual cfbam::ICFBamInt16ColObj* realizeInt16Col( cfbam::ICFBamInt16ColObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeInt16Col( cfbam::ICFBamInt16ColObj* Obj ) = 0;
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId ) = 0;
		virtual cfbam::ICFBamInt16ColObj* createInt16Col( cfbam::ICFBamInt16ColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamInt16ColObj* readInt16Col( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamInt16ColObj* lockInt16Col( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamInt16ColObj*> readAllInt16Col( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamInt16ColObj* readCachedInt16Col( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamInt16ColObj*> readCachedInt16ColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamInt16ColObj* updateInt16Col( cfbam::ICFBamInt16ColEditObj* Obj ) = 0;

		virtual void deleteInt16Col( cfbam::ICFBamInt16ColEditObj* Obj ) = 0;
		...
		virtual void deleteInt16ColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamInt16ColObj* moveUpInt16Col( cfbam::ICFBamInt16ColObj* Obj ) = 0;

		virtual cfbam::ICFBamInt16ColObj* moveDownInt16Col( cfbam::ICFBamInt16ColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesInt16Col( cfbam::ICFBamInt16ColObj* Obj ) = 0;
