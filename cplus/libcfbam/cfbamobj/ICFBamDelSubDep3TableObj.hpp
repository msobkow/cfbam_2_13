...
namespace cfbam {
	...
	{
	public:
		ICFBamDelSubDep3TableObj();
		virtual ~ICFBamDelSubDep3TableObj();
		...
		virtual cfbam::ICFBamDelSubDep3Obj* newInstance() = 0;

		virtual cfbam::ICFBamDelSubDep3EditObj* newEditInstance( cfbam::ICFBamDelSubDep3Obj* orig ) = 0;

		virtual cfbam::ICFBamDelSubDep3Obj* realizeDelSubDep3( cfbam::ICFBamDelSubDep3Obj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByTenantIdx( const int64_t TenantId ) = 0;
		virtual void reallyDeepDisposeDelSubDep3( cfbam::ICFBamDelSubDep3Obj* Obj ) = 0;
		...
		virtual cfbam::ICFBamDelSubDep3Obj* createDelSubDep3( cfbam::ICFBamDelSubDep3EditObj* Obj ) = 0;

		virtual cfbam::ICFBamDelSubDep3Obj* readDelSubDep3( cfbam::CFBamScopePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamDelSubDep3Obj* lockDelSubDep3( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamDelSubDep3Obj*> readAllDelSubDep3( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamDelSubDep3Obj* readCachedDelSubDep3( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual cfbam::ICFBamDelSubDep3Obj* readCachedDelSubDep3ByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamDelSubDep3Obj*> readCachedDelSubDep3ByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamDelSubDep3Obj* updateDelSubDep3( cfbam::ICFBamDelSubDep3EditObj* Obj ) = 0;

		virtual void deleteDelSubDep3( cfbam::ICFBamDelSubDep3EditObj* Obj ) = 0;

		virtual void deleteDelSubDep3ByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deleteDelSubDep3ByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesDelSubDep3( cfbam::ICFBamDelSubDep3Obj* Obj ) = 0;
