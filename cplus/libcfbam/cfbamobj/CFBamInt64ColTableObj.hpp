...
namespace cfbam {
	...
	class CFBamInt64ColTableObj
	: public virtual ICFBamInt64ColTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64ColObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64ColObj*>* allInt64Col;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamInt64ColObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64ColObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64ColObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64ColObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64ColObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64ColObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64ColObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64ColObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamInt64ColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt64ColObj*>*>* indexByTableIdx;
	...
	public:
		...
		CFBamInt64ColTableObj();
		CFBamInt64ColTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamInt64ColTableObj();
		...
		virtual cfbam::ICFBamInt64ColObj* newInstance();

		virtual cfbam::ICFBamInt64ColEditObj* newEditInstance( cfbam::ICFBamInt64ColObj* orig );

		virtual cfbam::ICFBamInt64ColObj* realizeInt64Col( cfbam::ICFBamInt64ColObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeInt64Col( cfbam::ICFBamInt64ColObj* Obj );
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId );
		virtual cfbam::ICFBamInt64ColObj* createInt64Col( cfbam::ICFBamInt64ColEditObj* Obj );

		virtual cfbam::ICFBamInt64ColObj* readInt64Col( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamInt64ColObj* lockInt64Col( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamInt64ColObj*> readAllInt64Col( bool forceRead = false );

		virtual cfbam::ICFBamInt64ColObj* readInt64ColByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamInt64ColObj* readInt64ColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt64ColObj*> readInt64ColByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt64ColObj*> readInt64ColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt64ColObj*> readInt64ColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt64ColObj*> readInt64ColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt64ColObj*> readInt64ColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt64ColObj*> readInt64ColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt64ColObj*> readInt64ColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt64ColObj*> readInt64ColByTableIdx( const int64_t TenantId,
			const int64_t TableId,
			bool forceRead = false );

		virtual cfbam::ICFBamInt64ColObj* readCachedInt64Col( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamInt64ColObj* readCachedInt64ColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamInt64ColObj* readCachedInt64ColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamInt64ColObj*> readCachedInt64ColByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamInt64ColObj*> readCachedInt64ColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamInt64ColObj*> readCachedInt64ColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamInt64ColObj*> readCachedInt64ColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamInt64ColObj*> readCachedInt64ColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamInt64ColObj*> readCachedInt64ColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamInt64ColObj*> readCachedInt64ColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamInt64ColObj*> readCachedInt64ColByTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual cfbam::ICFBamInt64ColObj* updateInt64Col( cfbam::ICFBamInt64ColEditObj* Obj );

		virtual void deleteInt64Col( cfbam::ICFBamInt64ColEditObj* Obj );

		virtual void deleteInt64ColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteInt64ColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteInt64ColByValTentIdx( const int64_t TenantId );

		virtual void deleteInt64ColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteInt64ColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteInt64ColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteInt64ColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteInt64ColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteInt64ColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteInt64ColByTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual cfbam::ICFBamInt64ColObj* moveUpInt64Col( cfbam::ICFBamInt64ColObj* Obj );

		virtual cfbam::ICFBamInt64ColObj* moveDownInt64Col( cfbam::ICFBamInt64ColObj* Obj );

		virtual void reallyDetachFromIndexesInt64Col( cfbam::ICFBamInt64ColObj* Obj );
