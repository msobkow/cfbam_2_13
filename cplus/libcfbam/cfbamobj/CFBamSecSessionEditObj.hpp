...
// Description: C++18 edit object instance specification for CFBam SecSession.
...
namespace cfbam {
	...
	class CFBamSecSessionEditObj
	: public virtual ICFBamSecSessionEditObj,
	  public virtual cfsec::ICFSecSecSessionEditObj,
	  public virtual cfint::ICFIntSecSessionEditObj
	{
	public:
	...
	public:
		CFBamSecSessionEditObj( cfsec::ICFSecSecSessionObj* argOrig );
		virtual ~CFBamSecSessionEditObj();
