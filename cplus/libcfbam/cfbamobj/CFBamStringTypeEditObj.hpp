...
// Description: C++18 edit object instance specification for CFBam StringType.
...
namespace cfbam {
	...
	class CFBamStringTypeEditObj
	: public CFBamStringDefEditObj,
	  public virtual ICFBamStringTypeEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamStringTypeEditObj( cfbam::ICFBamStringTypeObj* argOrig );
		virtual ~CFBamStringTypeEditObj();
		...
		virtual cfbam::ICFBamStringTypeTableObj* getStringTypeTable();

		virtual cfbam::ICFBamStringTypeEditObj* getStringTypeEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamStringTypeObj* getOrigAsStringType();

		virtual cfbam::CFBamValueBuff* getBuff();
		virtual void setBuff( cfbam::CFBamValueBuff* value );

		inline cfbam::CFBamStringTypeBuff* getStringTypeBuff() {
			// Buff is always instantiated when constructed over an original object
			return( static_cast<cfbam::CFBamStringTypeBuff*>( buff ) );
		};

		inline cfbam::CFBamStringTypeBuff* getStringTypeEditBuff() {
			// Buff is always instantiated when constructed over an original object
