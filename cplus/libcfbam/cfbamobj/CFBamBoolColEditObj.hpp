...
// Description: C++18 edit object instance specification for CFBam BoolCol.
...
namespace cfbam {
	...
	class CFBamBoolColEditObj
	: public CFBamBoolDefEditObj,
	  public virtual ICFBamBoolColEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamBoolColEditObj( cfbam::ICFBamBoolColObj* argOrig );
		virtual ~CFBamBoolColEditObj();
		...
		virtual cfbam::ICFBamBoolColTableObj* getBoolColTable();

		virtual cfbam::ICFBamBoolColEditObj* getBoolColEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamBoolColObj* getOrigAsBoolCol();
		...
		inline cfbam::CFBamBoolColBuff* getBoolColBuff() {
			...
			return( static_cast<cfbam::CFBamBoolColBuff*>( buff ) );
		};
