...
// Description: C++18 Object interface for CFBam MinorVersion.
...
namespace cfbam {
	...
	public:
		...
		virtual std::vector<cfbam::ICFBamSchemaDefObj*> getOptionalComponentsSchemaDef( bool forceRead = false ) = 0;
