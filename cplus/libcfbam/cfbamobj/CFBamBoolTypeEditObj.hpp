...
// Description: C++18 edit object instance specification for CFBam BoolType.
...
namespace cfbam {
	...
	class CFBamBoolTypeEditObj
	: public CFBamBoolDefEditObj,
	  public virtual ICFBamBoolTypeEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamBoolTypeEditObj( cfbam::ICFBamBoolTypeObj* argOrig );
		virtual ~CFBamBoolTypeEditObj();
		...
		virtual cfbam::ICFBamBoolTypeTableObj* getBoolTypeTable();

		virtual cfbam::ICFBamBoolTypeEditObj* getBoolTypeEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamBoolTypeObj* getOrigAsBoolType();

		virtual cfbam::CFBamValueBuff* getBuff();
		virtual void setBuff( cfbam::CFBamValueBuff* value );

		inline cfbam::CFBamBoolTypeBuff* getBoolTypeBuff() {
			// Buff is always instantiated when constructed over an original object
			return( static_cast<cfbam::CFBamBoolTypeBuff*>( buff ) );
		};

		inline cfbam::CFBamBoolTypeBuff* getBoolTypeEditBuff() {
			// Buff is always instantiated when constructed over an original object
