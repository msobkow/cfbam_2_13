...
// Description: C++18 base object instance specification for CFBam DateDef.
...
namespace cfbam {
	...
	class CFBamDateDefObj
	: public CFBamAtomObj,
	  public virtual ICFBamDateDefObj
	{
	protected:
	public:
		...
		CFBamDateDefObj();
		CFBamDateDefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamDateDefObj();
