...
// Description: C++18 edit object instance specification for CFBam TopDomain.
...
namespace cfbam {
	...
	class CFBamTopDomainEditObj
	: public virtual ICFBamTopDomainEditObj,
	  public virtual cfint::ICFIntTopDomainEditObj
	{
	public:
	...
	public:
		CFBamTopDomainEditObj( cfint::ICFIntTopDomainObj* argOrig );
		virtual ~CFBamTopDomainEditObj();
