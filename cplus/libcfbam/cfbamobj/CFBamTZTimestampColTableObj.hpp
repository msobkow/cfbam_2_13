...
namespace cfbam {
	...
	class CFBamTZTimestampColTableObj
	: public virtual ICFBamTZTimestampColTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampColObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampColObj*>* allTZTimestampCol;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamTZTimestampColObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampColObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampColObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampColObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampColObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampColObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampColObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampColObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamTZTimestampColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamTZTimestampColObj*>*>* indexByTableIdx;
	...
	public:
		...
		CFBamTZTimestampColTableObj();
		CFBamTZTimestampColTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamTZTimestampColTableObj();
		...
		virtual cfbam::ICFBamTZTimestampColObj* newInstance();

		virtual cfbam::ICFBamTZTimestampColEditObj* newEditInstance( cfbam::ICFBamTZTimestampColObj* orig );

		virtual cfbam::ICFBamTZTimestampColObj* realizeTZTimestampCol( cfbam::ICFBamTZTimestampColObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeTZTimestampCol( cfbam::ICFBamTZTimestampColObj* Obj );
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId );
		virtual cfbam::ICFBamTZTimestampColObj* createTZTimestampCol( cfbam::ICFBamTZTimestampColEditObj* Obj );

		virtual cfbam::ICFBamTZTimestampColObj* readTZTimestampCol( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamTZTimestampColObj* lockTZTimestampCol( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamTZTimestampColObj*> readAllTZTimestampCol( bool forceRead = false );

		virtual cfbam::ICFBamTZTimestampColObj* readTZTimestampColByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamTZTimestampColObj* readTZTimestampColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimestampColObj*> readTZTimestampColByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimestampColObj*> readTZTimestampColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimestampColObj*> readTZTimestampColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimestampColObj*> readTZTimestampColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimestampColObj*> readTZTimestampColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimestampColObj*> readTZTimestampColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimestampColObj*> readTZTimestampColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamTZTimestampColObj*> readTZTimestampColByTableIdx( const int64_t TenantId,
			const int64_t TableId,
			bool forceRead = false );

		virtual cfbam::ICFBamTZTimestampColObj* readCachedTZTimestampCol( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamTZTimestampColObj* readCachedTZTimestampColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamTZTimestampColObj* readCachedTZTimestampColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamTZTimestampColObj*> readCachedTZTimestampColByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamTZTimestampColObj*> readCachedTZTimestampColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamTZTimestampColObj*> readCachedTZTimestampColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamTZTimestampColObj*> readCachedTZTimestampColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamTZTimestampColObj*> readCachedTZTimestampColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamTZTimestampColObj*> readCachedTZTimestampColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamTZTimestampColObj*> readCachedTZTimestampColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamTZTimestampColObj*> readCachedTZTimestampColByTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual cfbam::ICFBamTZTimestampColObj* updateTZTimestampCol( cfbam::ICFBamTZTimestampColEditObj* Obj );

		virtual void deleteTZTimestampCol( cfbam::ICFBamTZTimestampColEditObj* Obj );

		virtual void deleteTZTimestampColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteTZTimestampColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteTZTimestampColByValTentIdx( const int64_t TenantId );

		virtual void deleteTZTimestampColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteTZTimestampColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteTZTimestampColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteTZTimestampColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteTZTimestampColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteTZTimestampColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteTZTimestampColByTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual cfbam::ICFBamTZTimestampColObj* moveUpTZTimestampCol( cfbam::ICFBamTZTimestampColObj* Obj );

		virtual cfbam::ICFBamTZTimestampColObj* moveDownTZTimestampCol( cfbam::ICFBamTZTimestampColObj* Obj );

		virtual void reallyDetachFromIndexesTZTimestampCol( cfbam::ICFBamTZTimestampColObj* Obj );
