...
// Description: C++18 edit object instance specification for CFBam UuidGen.
...
namespace cfbam {
	...
	class CFBamUuidGenEditObj
	: public CFBamUuidTypeEditObj,
	  public virtual ICFBamUuidGenEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamUuidGenEditObj( cfbam::ICFBamUuidGenObj* argOrig );
		virtual ~CFBamUuidGenEditObj();
		...
		virtual cfbam::ICFBamUuidGenTableObj* getUuidGenTable();

		virtual cfbam::ICFBamUuidGenEditObj* getUuidGenEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamUuidGenObj* getOrigAsUuidGen();
		...
		inline cfbam::CFBamUuidGenBuff* getUuidGenBuff() {
			...
			return( static_cast<cfbam::CFBamUuidGenBuff*>( buff ) );
		};
