...
// Description: C++18 Instance Edit Object interface for CFBam EnumTag.
...
namespace cfbam {
	...
	class ICFBamEnumTagEditObj
	: public virtual cfbam::ICFBamEnumTagObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamEnumTagEditObj();
		virtual ~ICFBamEnumTagEditObj();
		...
		virtual cfbam::ICFBamEnumTagObj* getOrig() = 0;

		virtual cfbam::ICFBamEnumTagObj* getOrigAsEnumTag() = 0;
		...
		virtual cfbam::ICFBamEnumTagObj* create() = 0;

		virtual cfbam::ICFBamEnumTagEditObj* update() = 0;

		virtual cfbam::ICFBamEnumTagEditObj* deleteInstance() = 0;
		...
		virtual void setOptionalEnumCodeNull() = 0;
		virtual void setOptionalEnumCodeValue( const int16_t value ) = 0;
		...
		virtual void setRequiredContainerEnumDef( cfbam::ICFBamEnumDefObj* value ) = 0;
		...
		virtual void setOptionalLookupPrev( cfbam::ICFBamEnumTagObj* value ) = 0;

		virtual cfbam::ICFBamEnumTagObj* getOptionalLookupNext( bool forceRead = false ) = 0;
		virtual void setOptionalLookupNext( cfbam::ICFBamEnumTagObj* value ) = 0;
