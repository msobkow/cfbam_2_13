...
// Description: C++18 edit object instance specification for CFBam UInt64Type.
...
namespace cfbam {
	...
	class CFBamUInt64TypeEditObj
	: public CFBamUInt64DefEditObj,
	  public virtual ICFBamUInt64TypeEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamUInt64TypeEditObj( cfbam::ICFBamUInt64TypeObj* argOrig );
		virtual ~CFBamUInt64TypeEditObj();
		...
		virtual cfbam::ICFBamUInt64TypeTableObj* getUInt64TypeTable();

		virtual cfbam::ICFBamUInt64TypeEditObj* getUInt64TypeEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamUInt64TypeObj* getOrigAsUInt64Type();

		virtual cfbam::CFBamValueBuff* getBuff();
		virtual void setBuff( cfbam::CFBamValueBuff* value );

		inline cfbam::CFBamUInt64TypeBuff* getUInt64TypeBuff() {
			// Buff is always instantiated when constructed over an original object
			return( static_cast<cfbam::CFBamUInt64TypeBuff*>( buff ) );
		};

		inline cfbam::CFBamUInt64TypeBuff* getUInt64TypeEditBuff() {
			// Buff is always instantiated when constructed over an original object
