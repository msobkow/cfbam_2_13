...
// Description: C++18 base object instance specification for CFBam UInt32Def.
...
namespace cfbam {
	...
	class CFBamUInt32DefObj
	: public CFBamAtomObj,
	  public virtual ICFBamUInt32DefObj
	{
	protected:
	public:
		...
		CFBamUInt32DefObj();
		CFBamUInt32DefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamUInt32DefObj();
