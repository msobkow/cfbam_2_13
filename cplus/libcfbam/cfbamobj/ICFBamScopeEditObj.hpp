...
// Description: C++18 Instance Edit Object interface for CFBam Scope.
...
namespace cfbam {
	...
	public:
		...
		virtual cfbam::ICFBamScopeObj* getOrig() = 0;

		virtual cfbam::ICFBamScopeObj* getOrigAsScope() = 0;
		...
		virtual cfbam::ICFBamScopeObj* create() = 0;

		virtual cfbam::ICFBamScopeEditObj* update() = 0;

		virtual cfbam::ICFBamScopeEditObj* deleteInstance() = 0;
