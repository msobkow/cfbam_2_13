...
namespace cfbam {
	...
	class CFBamBlobColTableObj
	: public virtual ICFBamBlobColTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBlobColObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBlobColObj*>* allBlobCol;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamBlobColObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBlobColObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBlobColObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBlobColObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBlobColObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBlobColObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBlobColObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBlobColObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamBlobColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamBlobColObj*>*>* indexByTableIdx;
	...
	public:
		...
		CFBamBlobColTableObj();
		CFBamBlobColTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamBlobColTableObj();
		...
		virtual cfbam::ICFBamBlobColObj* newInstance();

		virtual cfbam::ICFBamBlobColEditObj* newEditInstance( cfbam::ICFBamBlobColObj* orig );

		virtual cfbam::ICFBamBlobColObj* realizeBlobCol( cfbam::ICFBamBlobColObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeBlobCol( cfbam::ICFBamBlobColObj* Obj );
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId );
		virtual cfbam::ICFBamBlobColObj* createBlobCol( cfbam::ICFBamBlobColEditObj* Obj );

		virtual cfbam::ICFBamBlobColObj* readBlobCol( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamBlobColObj* lockBlobCol( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamBlobColObj*> readAllBlobCol( bool forceRead = false );

		virtual cfbam::ICFBamBlobColObj* readBlobColByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamBlobColObj* readBlobColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamBlobColObj*> readBlobColByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamBlobColObj*> readBlobColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamBlobColObj*> readBlobColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamBlobColObj*> readBlobColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamBlobColObj*> readBlobColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamBlobColObj*> readBlobColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamBlobColObj*> readBlobColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamBlobColObj*> readBlobColByTableIdx( const int64_t TenantId,
			const int64_t TableId,
			bool forceRead = false );

		virtual cfbam::ICFBamBlobColObj* readCachedBlobCol( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamBlobColObj* readCachedBlobColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamBlobColObj* readCachedBlobColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamBlobColObj*> readCachedBlobColByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamBlobColObj*> readCachedBlobColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamBlobColObj*> readCachedBlobColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamBlobColObj*> readCachedBlobColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamBlobColObj*> readCachedBlobColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamBlobColObj*> readCachedBlobColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamBlobColObj*> readCachedBlobColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamBlobColObj*> readCachedBlobColByTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual cfbam::ICFBamBlobColObj* updateBlobCol( cfbam::ICFBamBlobColEditObj* Obj );

		virtual void deleteBlobCol( cfbam::ICFBamBlobColEditObj* Obj );

		virtual void deleteBlobColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteBlobColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteBlobColByValTentIdx( const int64_t TenantId );

		virtual void deleteBlobColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteBlobColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteBlobColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteBlobColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteBlobColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteBlobColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteBlobColByTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual cfbam::ICFBamBlobColObj* moveUpBlobCol( cfbam::ICFBamBlobColObj* Obj );

		virtual cfbam::ICFBamBlobColObj* moveDownBlobCol( cfbam::ICFBamBlobColObj* Obj );

		virtual void reallyDetachFromIndexesBlobCol( cfbam::ICFBamBlobColObj* Obj );
