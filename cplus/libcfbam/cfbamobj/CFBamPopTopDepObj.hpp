...
// Description: C++18 base object instance specification for CFBam PopTopDep.
...
namespace cfbam {
	...
	class CFBamPopTopDepObj
	: public CFBamPopDepObj,
	  public virtual ICFBamPopTopDepObj
	{
	protected:
	public:
		...
		CFBamPopTopDepObj();
		CFBamPopTopDepObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamPopTopDepObj();
