...
// Description: C++18 Instance Edit Object interface for CFBam TZTimeType.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamTZTimeDefEditObj,
	  public virtual cfbam::ICFBamTZTimeTypeObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamTZTimeTypeEditObj();
		virtual ~ICFBamTZTimeTypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamTZTimeTypeBuff* getTZTimeTypeBuff() {
			return( static_cast<cfbam::CFBamTZTimeTypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamTZTimeTypeBuff* getTZTimeTypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamTZTimeTypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamTZTimeTypeObj* getOrigAsTZTimeType() = 0;
