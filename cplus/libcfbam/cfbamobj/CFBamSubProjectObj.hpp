...
// Description: C++18 base object instance specification for CFBam SubProject.
...
namespace cfbam {
	...
	class CFBamSubProjectObj
	: public virtual ICFBamSubProjectObj,
	...
	public:
		...
		CFBamSubProjectObj();
		CFBamSubProjectObj( cfint::ICFIntSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamSubProjectObj();
