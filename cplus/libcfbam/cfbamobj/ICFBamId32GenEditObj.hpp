...
// Description: C++18 Instance Edit Object interface for CFBam Id32Gen.
...
namespace cfbam {
	...
	class ICFBamId32GenEditObj
	: public virtual cfbam::ICFBamInt32TypeEditObj,
	  public virtual cfbam::ICFBamId32GenObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamId32GenEditObj();
		virtual ~ICFBamId32GenEditObj();
		...
		virtual cfbam::ICFBamId32GenObj* getOrigAsId32Gen() = 0;
		...
		virtual void setRequiredBlockSize( const int32_t value ) = 0;
