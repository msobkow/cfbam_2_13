...
// Description: C++18 base object instance specification for CFBam Int64Def.
...
namespace cfbam {
	...
	class CFBamInt64DefObj
	: public CFBamAtomObj,
	  public virtual ICFBamInt64DefObj
	{
	protected:
	public:
		...
		CFBamInt64DefObj();
		CFBamInt64DefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamInt64DefObj();
