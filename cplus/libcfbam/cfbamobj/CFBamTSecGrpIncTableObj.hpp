...
namespace cfbam {
	...
	class CFBamTSecGrpIncTableObj
	: public virtual ICFBamTSecGrpIncTableObj,
	...
	public:
		...
		CFBamTSecGrpIncTableObj();
		CFBamTSecGrpIncTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamTSecGrpIncTableObj();
