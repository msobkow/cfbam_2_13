...
namespace cfbam {
	...
	class CFBamDelSubDep3TableObj
	: public virtual ICFBamDelSubDep3TableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamDelSubDep3Obj*>* members;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamDelSubDep3Obj*>* allDelSubDep3;
		std::map< cfbam::CFBamScopeByTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamDelSubDep3Obj*>*>* indexByTenantIdx;
		std::map< cfbam::CFBamDelDepByDefSchemaIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamDelSubDep3Obj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamDelDepByDelDepIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamDelSubDep3Obj*>*>* indexByDelDepIdx;
		std::map< cfbam::CFBamDelSubDep3ByDelSubDep2IdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamDelSubDep3Obj*>*>* indexByDelSubDep2Idx;
		std::map< cfbam::CFBamDelSubDep3ByUNameIdxKey,
			cfbam::ICFBamDelSubDep3Obj*>* indexByUNameIdx;
	...
	public:
		...
		CFBamDelSubDep3TableObj();
		CFBamDelSubDep3TableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamDelSubDep3TableObj();
		...
		virtual cfbam::ICFBamDelSubDep3Obj* newInstance();

		virtual cfbam::ICFBamDelSubDep3EditObj* newEditInstance( cfbam::ICFBamDelSubDep3Obj* orig );

		virtual cfbam::ICFBamDelSubDep3Obj* realizeDelSubDep3( cfbam::ICFBamDelSubDep3Obj* Obj );

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id );
		virtual void deepDisposeByTenantIdx( const int64_t TenantId );
		virtual void reallyDeepDisposeDelSubDep3( cfbam::ICFBamDelSubDep3Obj* Obj );
		...
		virtual void deepDisposeByDelSubDep2Idx( const int64_t DelSubDep2TenantId,
			const int64_t DelSubDep2Id );
		virtual void deepDisposeByUNameIdx( const int64_t DelSubDep2TenantId,
			const int64_t DelSubDep2Id,
			const std::string& Name );
		virtual cfbam::ICFBamDelSubDep3Obj* createDelSubDep3( cfbam::ICFBamDelSubDep3EditObj* Obj );

		virtual cfbam::ICFBamDelSubDep3Obj* readDelSubDep3( cfbam::CFBamScopePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamDelSubDep3Obj* lockDelSubDep3( cfbam::CFBamScopePKey* pkey );

		virtual std::vector<cfbam::ICFBamDelSubDep3Obj*> readAllDelSubDep3( bool forceRead = false );

		virtual cfbam::ICFBamDelSubDep3Obj* readDelSubDep3ByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDelSubDep3Obj*> readDelSubDep3ByTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDelSubDep3Obj*> readDelSubDep3ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDelSubDep3Obj*> readDelSubDep3ByDelDepIdx( const int64_t RelationTenantId,
			const int64_t RelationId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamDelSubDep3Obj*> readDelSubDep3ByDelSubDep2Idx( const int64_t DelSubDep2TenantId,
			const int64_t DelSubDep2Id,
			bool forceRead = false );

		virtual cfbam::ICFBamDelSubDep3Obj* readDelSubDep3ByUNameIdx( const int64_t DelSubDep2TenantId,
			const int64_t DelSubDep2Id,
			const std::string& Name, bool forceRead = false );

		virtual cfbam::ICFBamDelSubDep3Obj* readCachedDelSubDep3( cfbam::CFBamScopePKey* pkey );

		virtual cfbam::ICFBamDelSubDep3Obj* readCachedDelSubDep3ByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual std::vector<cfbam::ICFBamDelSubDep3Obj*> readCachedDelSubDep3ByTenantIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamDelSubDep3Obj*> readCachedDelSubDep3ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamDelSubDep3Obj*> readCachedDelSubDep3ByDelDepIdx( const int64_t RelationTenantId,
			const int64_t RelationId );

		virtual std::vector<cfbam::ICFBamDelSubDep3Obj*> readCachedDelSubDep3ByDelSubDep2Idx( const int64_t DelSubDep2TenantId,
			const int64_t DelSubDep2Id );

		virtual cfbam::ICFBamDelSubDep3Obj* readCachedDelSubDep3ByUNameIdx( const int64_t DelSubDep2TenantId,
			const int64_t DelSubDep2Id,
			const std::string& Name );

		virtual cfbam::ICFBamDelSubDep3Obj* updateDelSubDep3( cfbam::ICFBamDelSubDep3EditObj* Obj );

		virtual void deleteDelSubDep3( cfbam::ICFBamDelSubDep3EditObj* Obj );

		virtual void deleteDelSubDep3ByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteDelSubDep3ByTenantIdx( const int64_t TenantId );

		virtual void deleteDelSubDep3ByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteDelSubDep3ByDelDepIdx( const int64_t RelationTenantId,
			const int64_t RelationId );

		virtual void deleteDelSubDep3ByDelSubDep2Idx( const int64_t DelSubDep2TenantId,
			const int64_t DelSubDep2Id );

		virtual void deleteDelSubDep3ByUNameIdx( const int64_t DelSubDep2TenantId,
			const int64_t DelSubDep2Id,
			const std::string& Name );

		virtual void reallyDetachFromIndexesDelSubDep3( cfbam::ICFBamDelSubDep3Obj* Obj );
