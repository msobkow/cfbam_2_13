...
// Description: C++18 base object instance specification for CFBam UuidType.
...
namespace cfbam {
	...
	class CFBamUuidTypeObj
	: public CFBamUuidDefObj,
	  public virtual ICFBamUuidTypeObj
	{
	protected:
	public:
		...
		CFBamUuidTypeObj();
		CFBamUuidTypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamUuidTypeObj();
