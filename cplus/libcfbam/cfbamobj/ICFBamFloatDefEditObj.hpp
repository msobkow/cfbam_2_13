...
// Description: C++18 Instance Edit Object interface for CFBam FloatDef.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamAtomEditObj,
	  public virtual cfbam::ICFBamFloatDefObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamFloatDefEditObj();
		virtual ~ICFBamFloatDefEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamFloatDefBuff* getFloatDefBuff() {
			return( static_cast<cfbam::CFBamFloatDefBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamFloatDefBuff* getFloatDefEditBuff() {
			return( dynamic_cast<cfbam::CFBamFloatDefBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamFloatDefObj* getOrigAsFloatDef() = 0;

		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual bool isOptionalInitValueNull() = 0;
		virtual const float getOptionalInitValueValue() = 0;
		virtual const float* getOptionalInitValueReference() = 0;
		virtual void setOptionalInitValueNull() = 0;
		virtual void setOptionalInitValueValue( const float value ) = 0;

		virtual bool isOptionalMinValueNull() = 0;
		virtual const float getOptionalMinValueValue() = 0;
		virtual const float* getOptionalMinValueReference() = 0;
		virtual void setOptionalMinValueNull() = 0;
		virtual void setOptionalMinValueValue( const float value ) = 0;

		virtual bool isOptionalMaxValueNull() = 0;
		virtual const float getOptionalMaxValueValue() = 0;
		virtual const float* getOptionalMaxValueReference() = 0;
		virtual void setOptionalMaxValueNull() = 0;
		virtual void setOptionalMaxValueValue( const float value ) = 0;
