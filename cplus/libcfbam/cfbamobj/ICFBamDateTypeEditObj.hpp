...
// Description: C++18 Instance Edit Object interface for CFBam DateType.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamDateDefEditObj,
	  public virtual cfbam::ICFBamDateTypeObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamDateTypeEditObj();
		virtual ~ICFBamDateTypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamDateTypeBuff* getDateTypeBuff() {
			return( static_cast<cfbam::CFBamDateTypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamDateTypeBuff* getDateTypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamDateTypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamDateTypeObj* getOrigAsDateType() = 0;
