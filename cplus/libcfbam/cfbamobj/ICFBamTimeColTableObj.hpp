...
namespace cfbam {
	...
	{
	public:
		ICFBamTimeColTableObj();
		virtual ~ICFBamTimeColTableObj();
		...
		virtual cfbam::ICFBamTimeColObj* newInstance() = 0;

		virtual cfbam::ICFBamTimeColEditObj* newEditInstance( cfbam::ICFBamTimeColObj* orig ) = 0;

		virtual cfbam::ICFBamTimeColObj* realizeTimeCol( cfbam::ICFBamTimeColObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeTimeCol( cfbam::ICFBamTimeColObj* Obj ) = 0;
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId ) = 0;
		virtual cfbam::ICFBamTimeColObj* createTimeCol( cfbam::ICFBamTimeColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamTimeColObj* readTimeCol( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamTimeColObj* lockTimeCol( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamTimeColObj*> readAllTimeCol( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamTimeColObj* readCachedTimeCol( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamTimeColObj*> readCachedTimeColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTimeColObj* updateTimeCol( cfbam::ICFBamTimeColEditObj* Obj ) = 0;

		virtual void deleteTimeCol( cfbam::ICFBamTimeColEditObj* Obj ) = 0;
		...
		virtual void deleteTimeColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamTimeColObj* moveUpTimeCol( cfbam::ICFBamTimeColObj* Obj ) = 0;

		virtual cfbam::ICFBamTimeColObj* moveDownTimeCol( cfbam::ICFBamTimeColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesTimeCol( cfbam::ICFBamTimeColObj* Obj ) = 0;
