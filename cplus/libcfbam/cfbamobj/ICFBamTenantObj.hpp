...
// Description: C++18 Object interface for CFBam Tenant.
...
namespace cfbam {
	...
	public:
		...
		virtual std::vector<cfbam::ICFBamSchemaDefObj*> getOptionalComponentsSchema( bool forceRead = false ) = 0;
