...
// Description: C++18 base object instance specification for CFBam ISOCtryLang.
...
namespace cfbam {
	...
	class CFBamISOCtryLangObj
	: public virtual ICFBamISOCtryLangObj,
	...
	public:
		...
		CFBamISOCtryLangObj();
		CFBamISOCtryLangObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamISOCtryLangObj();
