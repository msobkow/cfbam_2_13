...
// Description: C++18 base object instance specification for CFBam Atom.
...
namespace cfbam {
	...
	public:
		...
		CFBamAtomObj();
		CFBamAtomObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamAtomObj();
