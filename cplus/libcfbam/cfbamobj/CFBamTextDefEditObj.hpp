...
// Description: C++18 edit object instance specification for CFBam TextDef.
...
namespace cfbam {
	...
	class CFBamTextDefEditObj
	: public CFBamAtomEditObj,
	  public virtual ICFBamTextDefEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamTextDefEditObj( cfbam::ICFBamTextDefObj* argOrig );
		virtual ~CFBamTextDefEditObj();
		...
		virtual cfbam::ICFBamTextDefTableObj* getTextDefTable();

		virtual cfbam::ICFBamTextDefEditObj* getTextDefEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamTextDefObj* getOrigAsTextDef();
		...
		inline cfbam::CFBamTextDefBuff* getTextDefBuff() {
			...
			return( static_cast<cfbam::CFBamTextDefBuff*>( buff ) );
		};
