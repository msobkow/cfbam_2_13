...
// Description: C++18 base object instance specification for CFBam DateCol.
...
namespace cfbam {
	...
	class CFBamDateColObj
	: public CFBamDateDefObj,
	  public virtual ICFBamDateColObj
	{
	protected:
	public:
		...
		CFBamDateColObj();
		CFBamDateColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamDateColObj();
