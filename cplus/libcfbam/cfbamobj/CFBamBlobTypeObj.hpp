...
// Description: C++18 base object instance specification for CFBam BlobType.
...
namespace cfbam {
	...
	class CFBamBlobTypeObj
	: public CFBamBlobDefObj,
	  public virtual ICFBamBlobTypeObj
	{
	protected:
	public:
		...
		CFBamBlobTypeObj();
		CFBamBlobTypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamBlobTypeObj();
