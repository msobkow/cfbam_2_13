...
namespace cfbam {
	...
	{
	public:
		ICFBamInt16DefTableObj();
		virtual ~ICFBamInt16DefTableObj();
		...
		virtual cfbam::ICFBamInt16DefObj* newInstance() = 0;

		virtual cfbam::ICFBamInt16DefEditObj* newEditInstance( cfbam::ICFBamInt16DefObj* orig ) = 0;

		virtual cfbam::ICFBamInt16DefObj* realizeInt16Def( cfbam::ICFBamInt16DefObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeInt16Def( cfbam::ICFBamInt16DefObj* Obj ) = 0;
		virtual cfbam::ICFBamInt16DefObj* createInt16Def( cfbam::ICFBamInt16DefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamInt16DefObj* readInt16Def( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamInt16DefObj* lockInt16Def( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamInt16DefObj*> readAllInt16Def( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamInt16DefObj* readCachedInt16Def( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamInt16DefObj*> readCachedInt16DefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamInt16DefObj* updateInt16Def( cfbam::ICFBamInt16DefEditObj* Obj ) = 0;

		virtual void deleteInt16Def( cfbam::ICFBamInt16DefEditObj* Obj ) = 0;
		...
		virtual void deleteInt16DefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamInt16DefObj* moveUpInt16Def( cfbam::ICFBamInt16DefObj* Obj ) = 0;

		virtual cfbam::ICFBamInt16DefObj* moveDownInt16Def( cfbam::ICFBamInt16DefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesInt16Def( cfbam::ICFBamInt16DefObj* Obj ) = 0;
