...
// Description: C++18 Instance Edit Object interface for CFBam TableCol.
...
namespace cfbam {
	...
	class ICFBamTableColEditObj
	: public virtual cfbam::ICFBamValueEditObj,
	  public virtual cfbam::ICFBamTableColObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamTableColEditObj();
		virtual ~ICFBamTableColEditObj();
		...
		virtual cfbam::ICFBamTableColObj* getOrigAsTableCol() = 0;
		...
		virtual void setRequiredParentDataType( cfbam::ICFBamValueObj* value ) = 0;
