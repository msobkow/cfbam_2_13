...
namespace cfbam {
	...
	class CFBamIndexTableObj
	: public virtual ICFBamIndexTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamIndexObj*>* members;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamIndexObj*>* allIndex;
		std::map< cfbam::CFBamScopeByTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamIndexObj*>*>* indexByTenantIdx;
		std::map< cfbam::CFBamIndexByUNameIdxKey,
			cfbam::ICFBamIndexObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamIndexByIndexTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamIndexObj*>*>* indexByIndexTenantIdx;
		std::map< cfbam::CFBamIndexByIdxTableIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamIndexObj*>*>* indexByIdxTableIdx;
		std::map< cfbam::CFBamIndexByDefSchemaIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamIndexObj*>*>* indexByDefSchemaIdx;
	...
	public:
		...
		CFBamIndexTableObj();
		CFBamIndexTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamIndexTableObj();
		...
		virtual cfbam::ICFBamIndexObj* newInstance();

		virtual cfbam::ICFBamIndexEditObj* newEditInstance( cfbam::ICFBamIndexObj* orig );

		virtual cfbam::ICFBamIndexObj* realizeIndex( cfbam::ICFBamIndexObj* Obj );

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id );
		virtual void deepDisposeByTenantIdx( const int64_t TenantId );
		virtual void reallyDeepDisposeIndex( cfbam::ICFBamIndexObj* Obj );
		virtual void deepDisposeByUNameIdx( const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name );
		virtual void deepDisposeByIndexTenantIdx( const int64_t TenantId );
		...
		virtual cfbam::ICFBamIndexObj* createIndex( cfbam::ICFBamIndexEditObj* Obj );

		virtual cfbam::ICFBamIndexObj* readIndex( cfbam::CFBamScopePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamIndexObj* lockIndex( cfbam::CFBamScopePKey* pkey );

		virtual std::vector<cfbam::ICFBamIndexObj*> readAllIndex( bool forceRead = false );
		...
		virtual cfbam::ICFBamIndexObj* readCachedIndex( cfbam::CFBamScopePKey* pkey );

		virtual cfbam::ICFBamIndexObj* readCachedIndexByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual std::vector<cfbam::ICFBamIndexObj*> readCachedIndexByTenantIdx( const int64_t TenantId );

		virtual cfbam::ICFBamIndexObj* readCachedIndexByUNameIdx( const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamIndexObj*> readCachedIndexByIndexTenantIdx( const int64_t TenantId );
		...
		virtual cfbam::ICFBamIndexObj* updateIndex( cfbam::ICFBamIndexEditObj* Obj );

		virtual void deleteIndex( cfbam::ICFBamIndexEditObj* Obj );

		virtual void deleteIndexByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteIndexByTenantIdx( const int64_t TenantId );

		virtual void deleteIndexByUNameIdx( const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name );

		virtual void deleteIndexByIndexTenantIdx( const int64_t TenantId );
		...
		virtual void reallyDetachFromIndexesIndex( cfbam::ICFBamIndexObj* Obj );
