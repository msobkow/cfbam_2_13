...
namespace cfbam {
	...
	class CFBamSchemaDefTableObj
	: public virtual ICFBamSchemaDefTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamSchemaDefObj*>* members;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamSchemaDefObj*>* allSchemaDef;
		std::map< cfbam::CFBamScopeByTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamSchemaDefObj*>*>* indexByTenantIdx;
		std::map< cfbam::CFBamSchemaDefByCTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamSchemaDefObj*>*>* indexByCTenantIdx;
		std::map< cfbam::CFBamSchemaDefByMinorVersionIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamSchemaDefObj*>*>* indexByMinorVersionIdx;
		std::map< cfbam::CFBamSchemaDefByUNameIdxKey,
			cfbam::ICFBamSchemaDefObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamSchemaDefByAuthEMailIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamSchemaDefObj*>*>* indexByAuthEMailIdx;
		std::map< cfbam::CFBamSchemaDefByProjectURLIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamSchemaDefObj*>*>* indexByProjectURLIdx;
		std::map< cfbam::CFBamSchemaDefByPubURIIdxKey,
			cfbam::ICFBamSchemaDefObj*>* indexByPubURIIdx;
	...
	public:
		...
		CFBamSchemaDefTableObj();
		CFBamSchemaDefTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamSchemaDefTableObj();
		...
		virtual cfbam::ICFBamSchemaDefObj* newInstance();

		virtual cfbam::ICFBamSchemaDefEditObj* newEditInstance( cfbam::ICFBamSchemaDefObj* orig );

		virtual cfbam::ICFBamSchemaDefObj* realizeSchemaDef( cfbam::ICFBamSchemaDefObj* Obj );

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id );
		virtual void deepDisposeByTenantIdx( const int64_t TenantId );
		virtual void reallyDeepDisposeSchemaDef( cfbam::ICFBamSchemaDefObj* Obj );
		virtual void deepDisposeByCTenantIdx( const int64_t TenantId );
		virtual void deepDisposeByMinorVersionIdx( const int64_t TenantId,
			const int64_t MinorVersionId );
		virtual void deepDisposeByUNameIdx( const int64_t TenantId,
			const int64_t MinorVersionId,
			const std::string& Name );
		virtual void deepDisposeByAuthEMailIdx( const int64_t TenantId,
			const std::string& AuthorEMail );
		virtual void deepDisposeByProjectURLIdx( const int64_t TenantId,
			const std::string& ProjectURL );
		virtual void deepDisposeByPubURIIdx( const int64_t TenantId,
			const std::string& PublishURI );
		virtual cfbam::ICFBamSchemaDefObj* createSchemaDef( cfbam::ICFBamSchemaDefEditObj* Obj );

		virtual cfbam::ICFBamSchemaDefObj* readSchemaDef( cfbam::CFBamScopePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamSchemaDefObj* lockSchemaDef( cfbam::CFBamScopePKey* pkey );

		virtual std::vector<cfbam::ICFBamSchemaDefObj*> readAllSchemaDef( bool forceRead = false );

		virtual cfbam::ICFBamSchemaDefObj* readSchemaDefByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamSchemaDefObj*> readSchemaDefByTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamSchemaDefObj*> readSchemaDefByCTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamSchemaDefObj*> readSchemaDefByMinorVersionIdx( const int64_t TenantId,
			const int64_t MinorVersionId,
			bool forceRead = false );

		virtual cfbam::ICFBamSchemaDefObj* readSchemaDefByUNameIdx( const int64_t TenantId,
			const int64_t MinorVersionId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamSchemaDefObj*> readSchemaDefByAuthEMailIdx( const int64_t TenantId,
			const std::string& AuthorEMail,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamSchemaDefObj*> readSchemaDefByProjectURLIdx( const int64_t TenantId,
			const std::string& ProjectURL,
			bool forceRead = false );

		virtual cfbam::ICFBamSchemaDefObj* readSchemaDefByPubURIIdx( const int64_t TenantId,
			const std::string& PublishURI, bool forceRead = false );

		virtual cfbam::ICFBamSchemaDefObj* readCachedSchemaDef( cfbam::CFBamScopePKey* pkey );

		virtual cfbam::ICFBamSchemaDefObj* readCachedSchemaDefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual std::vector<cfbam::ICFBamSchemaDefObj*> readCachedSchemaDefByTenantIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamSchemaDefObj*> readCachedSchemaDefByCTenantIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamSchemaDefObj*> readCachedSchemaDefByMinorVersionIdx( const int64_t TenantId,
			const int64_t MinorVersionId );

		virtual cfbam::ICFBamSchemaDefObj* readCachedSchemaDefByUNameIdx( const int64_t TenantId,
			const int64_t MinorVersionId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamSchemaDefObj*> readCachedSchemaDefByAuthEMailIdx( const int64_t TenantId,
			const std::string& AuthorEMail );

		virtual std::vector<cfbam::ICFBamSchemaDefObj*> readCachedSchemaDefByProjectURLIdx( const int64_t TenantId,
			const std::string& ProjectURL );

		virtual cfbam::ICFBamSchemaDefObj* readCachedSchemaDefByPubURIIdx( const int64_t TenantId,
			const std::string& PublishURI );

		virtual cfbam::ICFBamSchemaDefObj* readSchemaDefByLookupUNameIdx( const int64_t TenantId,
			const int64_t MinorVersionId,
			const std::string& Name, bool forceRead = false );

		virtual cfbam::ICFBamSchemaDefObj* readCachedSchemaDefByLookupUNameIdx( const int64_t TenantId,
			const int64_t MinorVersionId,
			const std::string& Name );

		virtual cfbam::ICFBamSchemaDefObj* updateSchemaDef( cfbam::ICFBamSchemaDefEditObj* Obj );

		virtual void deleteSchemaDef( cfbam::ICFBamSchemaDefEditObj* Obj );

		virtual void deleteSchemaDefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteSchemaDefByTenantIdx( const int64_t TenantId );

		virtual void deleteSchemaDefByCTenantIdx( const int64_t TenantId );

		virtual void deleteSchemaDefByMinorVersionIdx( const int64_t TenantId,
			const int64_t MinorVersionId );

		virtual void deleteSchemaDefByUNameIdx( const int64_t TenantId,
			const int64_t MinorVersionId,
			const std::string& Name );

		virtual void deleteSchemaDefByAuthEMailIdx( const int64_t TenantId,
			const std::string& AuthorEMail );

		virtual void deleteSchemaDefByProjectURLIdx( const int64_t TenantId,
			const std::string& ProjectURL );

		virtual void deleteSchemaDefByPubURIIdx( const int64_t TenantId,
			const std::string& PublishURI );

		virtual void reallyDetachFromIndexesSchemaDef( cfbam::ICFBamSchemaDefObj* Obj );
