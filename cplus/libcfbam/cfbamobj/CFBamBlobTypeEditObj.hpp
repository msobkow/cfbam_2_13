...
// Description: C++18 edit object instance specification for CFBam BlobType.
...
namespace cfbam {
	...
	class CFBamBlobTypeEditObj
	: public CFBamBlobDefEditObj,
	  public virtual ICFBamBlobTypeEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamBlobTypeEditObj( cfbam::ICFBamBlobTypeObj* argOrig );
		virtual ~CFBamBlobTypeEditObj();
		...
		virtual cfbam::ICFBamBlobTypeTableObj* getBlobTypeTable();

		virtual cfbam::ICFBamBlobTypeEditObj* getBlobTypeEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamBlobTypeObj* getOrigAsBlobType();

		virtual cfbam::CFBamValueBuff* getBuff();
		virtual void setBuff( cfbam::CFBamValueBuff* value );

		inline cfbam::CFBamBlobTypeBuff* getBlobTypeBuff() {
			// Buff is always instantiated when constructed over an original object
			return( static_cast<cfbam::CFBamBlobTypeBuff*>( buff ) );
		};

		inline cfbam::CFBamBlobTypeBuff* getBlobTypeEditBuff() {
			// Buff is always instantiated when constructed over an original object
