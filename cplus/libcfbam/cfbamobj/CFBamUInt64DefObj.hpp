...
// Description: C++18 base object instance specification for CFBam UInt64Def.
...
namespace cfbam {
	...
	class CFBamUInt64DefObj
	: public CFBamAtomObj,
	  public virtual ICFBamUInt64DefObj
	{
	protected:
	public:
		...
		CFBamUInt64DefObj();
		CFBamUInt64DefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamUInt64DefObj();
