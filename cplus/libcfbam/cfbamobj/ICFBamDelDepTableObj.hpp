...
namespace cfbam {
	...
	{
	public:
		ICFBamDelDepTableObj();
		virtual ~ICFBamDelDepTableObj();
		...
		virtual cfbam::ICFBamDelDepObj* newInstance() = 0;

		virtual cfbam::ICFBamDelDepEditObj* newEditInstance( cfbam::ICFBamDelDepObj* orig ) = 0;

		virtual cfbam::ICFBamDelDepObj* realizeDelDep( cfbam::ICFBamDelDepObj* Obj ) = 0;

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;
		virtual void deepDisposeByTenantIdx( const int64_t TenantId ) = 0;
		virtual void reallyDeepDisposeDelDep( cfbam::ICFBamDelDepObj* Obj ) = 0;
		...
		virtual cfbam::ICFBamDelDepObj* createDelDep( cfbam::ICFBamDelDepEditObj* Obj ) = 0;

		virtual cfbam::ICFBamDelDepObj* readDelDep( cfbam::CFBamScopePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamDelDepObj* lockDelDep( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamDelDepObj*> readAllDelDep( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamDelDepObj* readCachedDelDep( cfbam::CFBamScopePKey* pkey ) = 0;

		virtual cfbam::ICFBamDelDepObj* readCachedDelDepByIdIdx(const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual std::vector<cfbam::ICFBamDelDepObj*> readCachedDelDepByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamDelDepObj* updateDelDep( cfbam::ICFBamDelDepEditObj* Obj ) = 0;

		virtual void deleteDelDep( cfbam::ICFBamDelDepEditObj* Obj ) = 0;

		virtual void deleteDelDepByIdIdx( const int64_t TenantId,
			const int64_t Id ) = 0;

		virtual void deleteDelDepByTenantIdx( const int64_t TenantId ) = 0;
		...
		virtual void reallyDetachFromIndexesDelDep( cfbam::ICFBamDelDepObj* Obj ) = 0;
