...
namespace cfbam {
	...
	class CFBamTldTableObj
	: public virtual ICFBamTldTableObj,
	  public virtual cfint::ICFIntTldTableObj
	{
	protected:
	...
	public:
		...
		CFBamTldTableObj();
		CFBamTldTableObj( cfint::ICFIntSchemaObj* argSchema );
		virtual ~CFBamTldTableObj();
