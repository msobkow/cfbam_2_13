...
// Description: C++18 base object instance specification for CFBam Cluster.
...
namespace cfbam {
	...
	class CFBamClusterObj
	: public virtual ICFBamClusterObj,
	...
	public:
		...
		CFBamClusterObj();
		CFBamClusterObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamClusterObj();
