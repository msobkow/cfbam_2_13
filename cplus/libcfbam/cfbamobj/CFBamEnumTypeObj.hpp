...
// Description: C++18 base object instance specification for CFBam EnumType.
...
namespace cfbam {
	...
	class CFBamEnumTypeObj
	: public CFBamEnumDefObj,
	  public virtual ICFBamEnumTypeObj
	{
	protected:
	public:
		...
		CFBamEnumTypeObj();
		CFBamEnumTypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamEnumTypeObj();
