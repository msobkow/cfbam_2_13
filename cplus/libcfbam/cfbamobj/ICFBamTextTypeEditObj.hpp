...
// Description: C++18 Instance Edit Object interface for CFBam TextType.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamTextDefEditObj,
	  public virtual cfbam::ICFBamTextTypeObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamTextTypeEditObj();
		virtual ~ICFBamTextTypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamTextTypeBuff* getTextTypeBuff() {
			return( static_cast<cfbam::CFBamTextTypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamTextTypeBuff* getTextTypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamTextTypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamTextTypeObj* getOrigAsTextType() = 0;
