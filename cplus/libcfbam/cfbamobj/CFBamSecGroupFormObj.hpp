...
// Description: C++18 base object instance specification for CFBam SecGroupForm.
...
namespace cfbam {
	...
	class CFBamSecGroupFormObj
	: public virtual ICFBamSecGroupFormObj,
	...
	public:
		...
		CFBamSecGroupFormObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamSecGroupFormObj();
