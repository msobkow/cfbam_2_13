...
// Description: C++18 Object interface for CFBam DelSubDep3.
...
namespace cfbam {
	...
	public:
		ICFBamDelSubDep3Obj();
		virtual ~ICFBamDelSubDep3Obj();
		virtual cfbam::ICFBamScopeEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamDelSubDep3EditObj* getDelSubDep3Edit() = 0;

		inline cfbam::CFBamDelSubDep3Buff* getDelSubDep3Buff() {
			return( static_cast<cfbam::CFBamDelSubDep3Buff*>( getBuff() ) );
		};

		inline cfbam::CFBamDelSubDep3Buff* getDelSubDep3EditBuff() {
			return( dynamic_cast<cfbam::CFBamDelSubDep3Buff*>( getBuff() ) );
		};

		virtual const int64_t getRequiredDelSubDep2TenantId() = 0;
		virtual const int64_t* getRequiredDelSubDep2TenantIdReference() = 0;

		virtual const int64_t getRequiredDelSubDep2Id() = 0;
		virtual const int64_t* getRequiredDelSubDep2IdReference() = 0;

		virtual const std::string& getRequiredName() = 0;
		virtual const std::string* getRequiredNameReference() = 0;

		virtual cfbam::ICFBamDelSubDep2Obj* getRequiredContainerDelSubDep2( bool forceRead = false ) = 0;
