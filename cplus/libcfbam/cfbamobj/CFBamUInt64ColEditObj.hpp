...
// Description: C++18 edit object instance specification for CFBam UInt64Col.
...
namespace cfbam {
	...
	class CFBamUInt64ColEditObj
	: public CFBamUInt64DefEditObj,
	  public virtual ICFBamUInt64ColEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamUInt64ColEditObj( cfbam::ICFBamUInt64ColObj* argOrig );
		virtual ~CFBamUInt64ColEditObj();
		...
		virtual cfbam::ICFBamUInt64ColTableObj* getUInt64ColTable();

		virtual cfbam::ICFBamUInt64ColEditObj* getUInt64ColEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamUInt64ColObj* getOrigAsUInt64Col();
		...
		inline cfbam::CFBamUInt64ColBuff* getUInt64ColBuff() {
			...
			return( static_cast<cfbam::CFBamUInt64ColBuff*>( buff ) );
		};
