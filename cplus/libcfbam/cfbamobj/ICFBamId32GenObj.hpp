...
// Description: C++18 Object interface for CFBam Id32Gen.
...
namespace cfbam {
	...
	class ICFBamId32GenObj
	: public virtual cfbam::ICFBamInt32TypeObj
	{
	public:
		ICFBamId32GenObj();
		virtual ~ICFBamId32GenObj();
		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamId32GenEditObj* getId32GenEdit() = 0;

		inline cfbam::CFBamId32GenBuff* getId32GenBuff() {
			return( static_cast<cfbam::CFBamId32GenBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamId32GenBuff* getId32GenEditBuff() {
			return( dynamic_cast<cfbam::CFBamId32GenBuff*>( getBuff() ) );
		};
		...
		virtual const int32_t getRequiredBlockSize() = 0;
		virtual const int32_t* getRequiredBlockSizeReference() = 0;
