...
// Description: C++18 Object interface for CFBam TZTimestampCol.
...
namespace cfbam {
	...
	public:
		...
		virtual ~ICFBamTZTimestampColObj();
		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamTZTimestampColEditObj* getTZTimestampColEdit() = 0;
