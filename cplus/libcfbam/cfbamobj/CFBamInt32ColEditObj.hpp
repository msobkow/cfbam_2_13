...
// Description: C++18 edit object instance specification for CFBam Int32Col.
...
namespace cfbam {
	...
	class CFBamInt32ColEditObj
	: public CFBamInt32DefEditObj,
	  public virtual ICFBamInt32ColEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamInt32ColEditObj( cfbam::ICFBamInt32ColObj* argOrig );
		virtual ~CFBamInt32ColEditObj();
		...
		virtual cfbam::ICFBamInt32ColTableObj* getInt32ColTable();

		virtual cfbam::ICFBamInt32ColEditObj* getInt32ColEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamInt32ColObj* getOrigAsInt32Col();
		...
		inline cfbam::CFBamInt32ColBuff* getInt32ColBuff() {
			...
			return( static_cast<cfbam::CFBamInt32ColBuff*>( buff ) );
		};
