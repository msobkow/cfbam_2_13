...
// Description: C++18 Object interface for CFBam Id16Gen.
...
namespace cfbam {
	...
	class ICFBamId16GenObj
	: public virtual cfbam::ICFBamInt16TypeObj
	{
	public:
		ICFBamId16GenObj();
		virtual ~ICFBamId16GenObj();
		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamId16GenEditObj* getId16GenEdit() = 0;

		inline cfbam::CFBamId16GenBuff* getId16GenBuff() {
			return( static_cast<cfbam::CFBamId16GenBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamId16GenBuff* getId16GenEditBuff() {
			return( dynamic_cast<cfbam::CFBamId16GenBuff*>( getBuff() ) );
		};
		...
		virtual const int16_t getRequiredBlockSize() = 0;
		virtual const int16_t* getRequiredBlockSizeReference() = 0;
