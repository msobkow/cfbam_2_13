...
// Description: C++18 Instance Edit Object interface for CFBam ClearTopDep.
...
namespace cfbam {
	...
	class ICFBamClearTopDepEditObj
	: public virtual cfbam::ICFBamClearDepEditObj,
	  public virtual cfbam::ICFBamClearTopDepObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamClearTopDepEditObj();
		virtual ~ICFBamClearTopDepEditObj();
		...
		virtual cfbam::ICFBamClearTopDepObj* getOrigAsClearTopDep() = 0;
		...
		virtual void setOptionalLookupPrev( cfbam::ICFBamClearTopDepObj* value ) = 0;

		virtual cfbam::ICFBamClearTopDepObj* getOptionalLookupNext( bool forceRead = false ) = 0;
		virtual void setOptionalLookupNext( cfbam::ICFBamClearTopDepObj* value ) = 0;
