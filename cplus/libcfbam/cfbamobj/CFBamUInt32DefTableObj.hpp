...
namespace cfbam {
	...
	class CFBamUInt32DefTableObj
	: public virtual ICFBamUInt32DefTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32DefObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32DefObj*>* allUInt32Def;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamUInt32DefObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32DefObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32DefObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32DefObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32DefObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32DefObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32DefObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32DefObj*>*>* indexByContNextIdx;
	...
	public:
		...
		CFBamUInt32DefTableObj();
		CFBamUInt32DefTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamUInt32DefTableObj();
		...
		virtual cfbam::ICFBamUInt32DefObj* newInstance();

		virtual cfbam::ICFBamUInt32DefEditObj* newEditInstance( cfbam::ICFBamUInt32DefObj* orig );

		virtual cfbam::ICFBamUInt32DefObj* realizeUInt32Def( cfbam::ICFBamUInt32DefObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeUInt32Def( cfbam::ICFBamUInt32DefObj* Obj );
		virtual cfbam::ICFBamUInt32DefObj* createUInt32Def( cfbam::ICFBamUInt32DefEditObj* Obj );

		virtual cfbam::ICFBamUInt32DefObj* readUInt32Def( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamUInt32DefObj* lockUInt32Def( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamUInt32DefObj*> readAllUInt32Def( bool forceRead = false );

		virtual cfbam::ICFBamUInt32DefObj* readUInt32DefByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamUInt32DefObj* readUInt32DefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt32DefObj*> readUInt32DefByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt32DefObj*> readUInt32DefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt32DefObj*> readUInt32DefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt32DefObj*> readUInt32DefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt32DefObj*> readUInt32DefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt32DefObj*> readUInt32DefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt32DefObj*> readUInt32DefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual cfbam::ICFBamUInt32DefObj* readCachedUInt32Def( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamUInt32DefObj* readCachedUInt32DefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamUInt32DefObj* readCachedUInt32DefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamUInt32DefObj*> readCachedUInt32DefByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamUInt32DefObj*> readCachedUInt32DefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamUInt32DefObj*> readCachedUInt32DefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamUInt32DefObj*> readCachedUInt32DefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamUInt32DefObj*> readCachedUInt32DefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamUInt32DefObj*> readCachedUInt32DefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamUInt32DefObj*> readCachedUInt32DefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamUInt32DefObj* updateUInt32Def( cfbam::ICFBamUInt32DefEditObj* Obj );

		virtual void deleteUInt32Def( cfbam::ICFBamUInt32DefEditObj* Obj );

		virtual void deleteUInt32DefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteUInt32DefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteUInt32DefByValTentIdx( const int64_t TenantId );

		virtual void deleteUInt32DefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteUInt32DefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteUInt32DefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteUInt32DefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteUInt32DefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteUInt32DefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamUInt32DefObj* moveUpUInt32Def( cfbam::ICFBamUInt32DefObj* Obj );

		virtual cfbam::ICFBamUInt32DefObj* moveDownUInt32Def( cfbam::ICFBamUInt32DefObj* Obj );

		virtual void reallyDetachFromIndexesUInt32Def( cfbam::ICFBamUInt32DefObj* Obj );
