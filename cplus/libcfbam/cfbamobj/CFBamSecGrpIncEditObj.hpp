...
// Description: C++18 edit object instance specification for CFBam SecGrpInc.
...
namespace cfbam {
	...
	class CFBamSecGrpIncEditObj
	: public virtual ICFBamSecGrpIncEditObj,
	  public virtual cfsec::ICFSecSecGrpIncEditObj,
	  public virtual cfint::ICFIntSecGrpIncEditObj
	{
	public:
	...
	public:
		CFBamSecGrpIncEditObj( cfsec::ICFSecSecGrpIncObj* argOrig );
		virtual ~CFBamSecGrpIncEditObj();
