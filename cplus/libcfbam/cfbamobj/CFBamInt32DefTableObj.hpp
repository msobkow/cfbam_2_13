...
namespace cfbam {
	...
	class CFBamInt32DefTableObj
	: public virtual ICFBamInt32DefTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32DefObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32DefObj*>* allInt32Def;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamInt32DefObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32DefObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32DefObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32DefObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32DefObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32DefObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32DefObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamInt32DefObj*>*>* indexByContNextIdx;
	...
	public:
		...
		CFBamInt32DefTableObj();
		CFBamInt32DefTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamInt32DefTableObj();
		...
		virtual cfbam::ICFBamInt32DefObj* newInstance();

		virtual cfbam::ICFBamInt32DefEditObj* newEditInstance( cfbam::ICFBamInt32DefObj* orig );

		virtual cfbam::ICFBamInt32DefObj* realizeInt32Def( cfbam::ICFBamInt32DefObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeInt32Def( cfbam::ICFBamInt32DefObj* Obj );
		virtual cfbam::ICFBamInt32DefObj* createInt32Def( cfbam::ICFBamInt32DefEditObj* Obj );

		virtual cfbam::ICFBamInt32DefObj* readInt32Def( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamInt32DefObj* lockInt32Def( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamInt32DefObj*> readAllInt32Def( bool forceRead = false );

		virtual cfbam::ICFBamInt32DefObj* readInt32DefByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamInt32DefObj* readInt32DefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt32DefObj*> readInt32DefByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt32DefObj*> readInt32DefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt32DefObj*> readInt32DefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt32DefObj*> readInt32DefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt32DefObj*> readInt32DefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt32DefObj*> readInt32DefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamInt32DefObj*> readInt32DefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual cfbam::ICFBamInt32DefObj* readCachedInt32Def( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamInt32DefObj* readCachedInt32DefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamInt32DefObj* readCachedInt32DefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamInt32DefObj*> readCachedInt32DefByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamInt32DefObj*> readCachedInt32DefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamInt32DefObj*> readCachedInt32DefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamInt32DefObj*> readCachedInt32DefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamInt32DefObj*> readCachedInt32DefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamInt32DefObj*> readCachedInt32DefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamInt32DefObj*> readCachedInt32DefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamInt32DefObj* updateInt32Def( cfbam::ICFBamInt32DefEditObj* Obj );

		virtual void deleteInt32Def( cfbam::ICFBamInt32DefEditObj* Obj );

		virtual void deleteInt32DefByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteInt32DefByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteInt32DefByValTentIdx( const int64_t TenantId );

		virtual void deleteInt32DefByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteInt32DefByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteInt32DefByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteInt32DefByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteInt32DefByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteInt32DefByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual cfbam::ICFBamInt32DefObj* moveUpInt32Def( cfbam::ICFBamInt32DefObj* Obj );

		virtual cfbam::ICFBamInt32DefObj* moveDownInt32Def( cfbam::ICFBamInt32DefObj* Obj );

		virtual void reallyDetachFromIndexesInt32Def( cfbam::ICFBamInt32DefObj* Obj );
