...
namespace cfbam {
	...
	class CFBamSecAppTableObj
	: public virtual ICFBamSecAppTableObj,
	  public virtual cfsec::ICFSecSecAppTableObj,
	  public virtual cfint::ICFIntSecAppTableObj
	{
	protected:
	...
	public:
		...
		CFBamSecAppTableObj();
		CFBamSecAppTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamSecAppTableObj();
