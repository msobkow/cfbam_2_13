...
namespace cfbam {
	...
	class CFBamServerObjFuncTableObj
	: public virtual ICFBamServerObjFuncTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamServerObjFuncObj*>* members;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamServerObjFuncObj*>* allServerObjFunc;
		std::map< cfbam::CFBamScopeByTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamServerObjFuncObj*>*>* indexByTenantIdx;
		std::map< cfbam::CFBamServerMethodByUNameIdxKey,
			cfbam::ICFBamServerObjFuncObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamServerMethodByMethTableIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamServerObjFuncObj*>*>* indexByMethTableIdx;
		std::map< cfbam::CFBamServerMethodByDefSchemaIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamServerObjFuncObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamServerObjFuncByRetTblIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamServerObjFuncObj*>*>* indexByRetTblIdx;
	...
	public:
		...
		CFBamServerObjFuncTableObj();
		CFBamServerObjFuncTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamServerObjFuncTableObj();
		...
		virtual cfbam::ICFBamServerObjFuncObj* newInstance();

		virtual cfbam::ICFBamServerObjFuncEditObj* newEditInstance( cfbam::ICFBamServerObjFuncObj* orig );

		virtual cfbam::ICFBamServerObjFuncObj* realizeServerObjFunc( cfbam::ICFBamServerObjFuncObj* Obj );

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id );
		virtual void deepDisposeByTenantIdx( const int64_t TenantId );
		virtual void reallyDeepDisposeServerObjFunc( cfbam::ICFBamServerObjFuncObj* Obj );
		...
		virtual cfbam::ICFBamServerObjFuncObj* createServerObjFunc( cfbam::ICFBamServerObjFuncEditObj* Obj );

		virtual cfbam::ICFBamServerObjFuncObj* readServerObjFunc( cfbam::CFBamScopePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamServerObjFuncObj* lockServerObjFunc( cfbam::CFBamScopePKey* pkey );

		virtual std::vector<cfbam::ICFBamServerObjFuncObj*> readAllServerObjFunc( bool forceRead = false );

		virtual cfbam::ICFBamServerObjFuncObj* readServerObjFuncByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamServerObjFuncObj*> readServerObjFuncByTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual cfbam::ICFBamServerObjFuncObj* readServerObjFuncByUNameIdx( const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamServerObjFuncObj*> readServerObjFuncByMethTableIdx( const int64_t TenantId,
			const int64_t TableId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamServerObjFuncObj*> readServerObjFuncByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamServerObjFuncObj*> readServerObjFuncByRetTblIdx( const int64_t* RetTenantId,
			const int64_t* RetTableId,
			bool forceRead = false );

		virtual cfbam::ICFBamServerObjFuncObj* readCachedServerObjFunc( cfbam::CFBamScopePKey* pkey );

		virtual cfbam::ICFBamServerObjFuncObj* readCachedServerObjFuncByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual std::vector<cfbam::ICFBamServerObjFuncObj*> readCachedServerObjFuncByTenantIdx( const int64_t TenantId );

		virtual cfbam::ICFBamServerObjFuncObj* readCachedServerObjFuncByUNameIdx( const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamServerObjFuncObj*> readCachedServerObjFuncByMethTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual std::vector<cfbam::ICFBamServerObjFuncObj*> readCachedServerObjFuncByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamServerObjFuncObj*> readCachedServerObjFuncByRetTblIdx( const int64_t* RetTenantId,
			const int64_t* RetTableId );

		virtual cfbam::ICFBamServerObjFuncObj* updateServerObjFunc( cfbam::ICFBamServerObjFuncEditObj* Obj );

		virtual void deleteServerObjFunc( cfbam::ICFBamServerObjFuncEditObj* Obj );

		virtual void deleteServerObjFuncByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteServerObjFuncByTenantIdx( const int64_t TenantId );

		virtual void deleteServerObjFuncByUNameIdx( const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name );

		virtual void deleteServerObjFuncByMethTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual void deleteServerObjFuncByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteServerObjFuncByRetTblIdx( const int64_t* RetTenantId,
			const int64_t* RetTableId );

		virtual void reallyDetachFromIndexesServerObjFunc( cfbam::ICFBamServerObjFuncObj* Obj );
