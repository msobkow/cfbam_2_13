...
namespace cfbam {
	...
	class CFBamISOCtryCcyTableObj
	: public virtual ICFBamISOCtryCcyTableObj,
	  public virtual cfsec::ICFSecISOCtryCcyTableObj,
	  public virtual cfint::ICFIntISOCtryCcyTableObj
	{
	protected:
	...
	public:
		...
		CFBamISOCtryCcyTableObj();
		CFBamISOCtryCcyTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamISOCtryCcyTableObj();
