...
// Description: C++18 Object interface for CFBam BoolDef.
...
namespace cfbam {
	...
	class ICFBamBoolDefObj
	: public virtual cfbam::ICFBamAtomObj
	{
	public:
		ICFBamBoolDefObj();
		virtual ~ICFBamBoolDefObj();
		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamBoolDefEditObj* getBoolDefEdit() = 0;
