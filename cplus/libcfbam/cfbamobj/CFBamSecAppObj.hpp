...
// Description: C++18 base object instance specification for CFBam SecApp.
...
namespace cfbam {
	...
	class CFBamSecAppObj
	: public virtual ICFBamSecAppObj,
	...
	public:
		...
		CFBamSecAppObj();
		CFBamSecAppObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamSecAppObj();
