...
namespace cfbam {
	...
	class CFBamServerListFuncTableObj
	: public virtual ICFBamServerListFuncTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamServerListFuncObj*>* members;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamServerListFuncObj*>* allServerListFunc;
		std::map< cfbam::CFBamScopeByTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamServerListFuncObj*>*>* indexByTenantIdx;
		std::map< cfbam::CFBamServerMethodByUNameIdxKey,
			cfbam::ICFBamServerListFuncObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamServerMethodByMethTableIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamServerListFuncObj*>*>* indexByMethTableIdx;
		std::map< cfbam::CFBamServerMethodByDefSchemaIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamServerListFuncObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamServerListFuncByRetTblIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamServerListFuncObj*>*>* indexByRetTblIdx;
	...
	public:
		...
		CFBamServerListFuncTableObj();
		CFBamServerListFuncTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamServerListFuncTableObj();
		...
		virtual cfbam::ICFBamServerListFuncObj* newInstance();

		virtual cfbam::ICFBamServerListFuncEditObj* newEditInstance( cfbam::ICFBamServerListFuncObj* orig );

		virtual cfbam::ICFBamServerListFuncObj* realizeServerListFunc( cfbam::ICFBamServerListFuncObj* Obj );

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id );
		virtual void deepDisposeByTenantIdx( const int64_t TenantId );
		virtual void reallyDeepDisposeServerListFunc( cfbam::ICFBamServerListFuncObj* Obj );
		virtual void deepDisposeByUNameIdx( const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name );
		virtual void deepDisposeByMethTableIdx( const int64_t TenantId,
			const int64_t TableId );
		virtual void deepDisposeByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );
		virtual void deepDisposeByRetTblIdx( const int64_t* RetTenantId,
			const int64_t* RetTableId );
		virtual cfbam::ICFBamServerListFuncObj* createServerListFunc( cfbam::ICFBamServerListFuncEditObj* Obj );

		virtual cfbam::ICFBamServerListFuncObj* readServerListFunc( cfbam::CFBamScopePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamServerListFuncObj* lockServerListFunc( cfbam::CFBamScopePKey* pkey );

		virtual std::vector<cfbam::ICFBamServerListFuncObj*> readAllServerListFunc( bool forceRead = false );

		virtual cfbam::ICFBamServerListFuncObj* readServerListFuncByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamServerListFuncObj*> readServerListFuncByTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual cfbam::ICFBamServerListFuncObj* readServerListFuncByUNameIdx( const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamServerListFuncObj*> readServerListFuncByMethTableIdx( const int64_t TenantId,
			const int64_t TableId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamServerListFuncObj*> readServerListFuncByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamServerListFuncObj*> readServerListFuncByRetTblIdx( const int64_t* RetTenantId,
			const int64_t* RetTableId,
			bool forceRead = false );

		virtual cfbam::ICFBamServerListFuncObj* readCachedServerListFunc( cfbam::CFBamScopePKey* pkey );

		virtual cfbam::ICFBamServerListFuncObj* readCachedServerListFuncByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual std::vector<cfbam::ICFBamServerListFuncObj*> readCachedServerListFuncByTenantIdx( const int64_t TenantId );

		virtual cfbam::ICFBamServerListFuncObj* readCachedServerListFuncByUNameIdx( const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamServerListFuncObj*> readCachedServerListFuncByMethTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual std::vector<cfbam::ICFBamServerListFuncObj*> readCachedServerListFuncByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamServerListFuncObj*> readCachedServerListFuncByRetTblIdx( const int64_t* RetTenantId,
			const int64_t* RetTableId );

		virtual cfbam::ICFBamServerListFuncObj* updateServerListFunc( cfbam::ICFBamServerListFuncEditObj* Obj );

		virtual void deleteServerListFunc( cfbam::ICFBamServerListFuncEditObj* Obj );

		virtual void deleteServerListFuncByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteServerListFuncByTenantIdx( const int64_t TenantId );

		virtual void deleteServerListFuncByUNameIdx( const int64_t TenantId,
			const int64_t TableId,
			const std::string& Name );

		virtual void deleteServerListFuncByMethTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual void deleteServerListFuncByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteServerListFuncByRetTblIdx( const int64_t* RetTenantId,
			const int64_t* RetTableId );

		virtual void reallyDetachFromIndexesServerListFunc( cfbam::ICFBamServerListFuncObj* Obj );
