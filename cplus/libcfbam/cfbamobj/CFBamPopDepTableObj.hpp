...
namespace cfbam {
	...
	class CFBamPopDepTableObj
	: public virtual ICFBamPopDepTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopDepObj*>* members;
		std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopDepObj*>* allPopDep;
		std::map< cfbam::CFBamScopeByTenantIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopDepObj*>*>* indexByTenantIdx;
		std::map< cfbam::CFBamPopDepByRelationIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopDepObj*>*>* indexByRelationIdx;
		std::map< cfbam::CFBamPopDepByDefSchemaIdxKey,
			std::map<cfbam::CFBamScopePKey, cfbam::ICFBamPopDepObj*>*>* indexByDefSchemaIdx;
	...
	public:
		...
		CFBamPopDepTableObj();
		CFBamPopDepTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamPopDepTableObj();
		...
		virtual cfbam::ICFBamPopDepObj* newInstance();

		virtual cfbam::ICFBamPopDepEditObj* newEditInstance( cfbam::ICFBamPopDepObj* orig );

		virtual cfbam::ICFBamPopDepObj* realizePopDep( cfbam::ICFBamPopDepObj* Obj );

		virtual void deepDisposeByIdIdx( const int64_t TenantId,
			const int64_t Id );
		virtual void deepDisposeByTenantIdx( const int64_t TenantId );
		virtual void reallyDeepDisposePopDep( cfbam::ICFBamPopDepObj* Obj );
		...
		virtual cfbam::ICFBamPopDepObj* createPopDep( cfbam::ICFBamPopDepEditObj* Obj );

		virtual cfbam::ICFBamPopDepObj* readPopDep( cfbam::CFBamScopePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamPopDepObj* lockPopDep( cfbam::CFBamScopePKey* pkey );

		virtual std::vector<cfbam::ICFBamPopDepObj*> readAllPopDep( bool forceRead = false );

		virtual cfbam::ICFBamPopDepObj* readPopDepByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamPopDepObj*> readPopDepByTenantIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamPopDepObj*> readPopDepByRelationIdx( const int64_t RelationTenantId,
			const int64_t RelationId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamPopDepObj*> readPopDepByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual cfbam::ICFBamPopDepObj* readCachedPopDep( cfbam::CFBamScopePKey* pkey );

		virtual cfbam::ICFBamPopDepObj* readCachedPopDepByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual std::vector<cfbam::ICFBamPopDepObj*> readCachedPopDepByTenantIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamPopDepObj*> readCachedPopDepByRelationIdx( const int64_t RelationTenantId,
			const int64_t RelationId );

		virtual std::vector<cfbam::ICFBamPopDepObj*> readCachedPopDepByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual cfbam::ICFBamPopDepObj* updatePopDep( cfbam::ICFBamPopDepEditObj* Obj );

		virtual void deletePopDep( cfbam::ICFBamPopDepEditObj* Obj );

		virtual void deletePopDepByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deletePopDepByTenantIdx( const int64_t TenantId );

		virtual void deletePopDepByRelationIdx( const int64_t RelationTenantId,
			const int64_t RelationId );

		virtual void deletePopDepByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void reallyDetachFromIndexesPopDep( cfbam::ICFBamPopDepObj* Obj );
