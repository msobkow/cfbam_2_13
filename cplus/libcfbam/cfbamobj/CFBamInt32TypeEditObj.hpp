...
// Description: C++18 edit object instance specification for CFBam Int32Type.
...
namespace cfbam {
	...
	class CFBamInt32TypeEditObj
	: public CFBamInt32DefEditObj,
	  public virtual ICFBamInt32TypeEditObj
	{
	public:
		static const std::string CLASS_NAME;
	protected:
	public:
		CFBamInt32TypeEditObj( cfbam::ICFBamInt32TypeObj* argOrig );
		virtual ~CFBamInt32TypeEditObj();
		...
		virtual cfbam::ICFBamInt32TypeTableObj* getInt32TypeTable();

		virtual cfbam::ICFBamInt32TypeEditObj* getInt32TypeEdit();

		virtual ICFBamValueEditObj* beginEdit();

		virtual cfbam::ICFBamInt32TypeObj* getOrigAsInt32Type();

		virtual cfbam::CFBamValueBuff* getBuff();
		virtual void setBuff( cfbam::CFBamValueBuff* value );

		inline cfbam::CFBamInt32TypeBuff* getInt32TypeBuff() {
			// Buff is always instantiated when constructed over an original object
			return( static_cast<cfbam::CFBamInt32TypeBuff*>( buff ) );
		};

		inline cfbam::CFBamInt32TypeBuff* getInt32TypeEditBuff() {
			// Buff is always instantiated when constructed over an original object
