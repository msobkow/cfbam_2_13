...
// Description: C++18 Instance Edit Object interface for CFBam TimestampType.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamTimestampDefEditObj,
	  public virtual cfbam::ICFBamTimestampTypeObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamTimestampTypeEditObj();
		virtual ~ICFBamTimestampTypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamTimestampTypeBuff* getTimestampTypeBuff() {
			return( static_cast<cfbam::CFBamTimestampTypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamTimestampTypeBuff* getTimestampTypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamTimestampTypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamTimestampTypeObj* getOrigAsTimestampType() = 0;
