...
// Description: C++18 base object instance specification for CFBam SecGroup.
...
namespace cfbam {
	...
	class CFBamSecGroupObj
	: public virtual ICFBamSecGroupObj,
	...
	public:
		...
		CFBamSecGroupObj();
		CFBamSecGroupObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamSecGroupObj();
