...
// Description: C++18 base object instance specification for CFBam StringCol.
...
namespace cfbam {
	...
	class CFBamStringColObj
	: public CFBamStringDefObj,
	  public virtual ICFBamStringColObj
	{
	protected:
	public:
		...
		CFBamStringColObj();
		CFBamStringColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamStringColObj();
