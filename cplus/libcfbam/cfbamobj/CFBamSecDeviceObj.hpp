...
// Description: C++18 base object instance specification for CFBam SecDevice.
...
namespace cfbam {
	...
	class CFBamSecDeviceObj
	: public virtual ICFBamSecDeviceObj,
	...
	public:
		...
		CFBamSecDeviceObj();
		CFBamSecDeviceObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamSecDeviceObj();
