...
// Description: C++18 base object instance specification for CFBam ServiceType.
...
namespace cfbam {
	...
	class CFBamServiceTypeObj
	: public virtual ICFBamServiceTypeObj,
	...
	public:
		...
		CFBamServiceTypeObj();
		CFBamServiceTypeObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamServiceTypeObj();
