...
// Description: C++18 edit object instance specification for CFBam SubProject.
...
namespace cfbam {
	...
	class CFBamSubProjectEditObj
	: public virtual ICFBamSubProjectEditObj,
	  public virtual cfint::ICFIntSubProjectEditObj
	{
	public:
	...
	public:
		CFBamSubProjectEditObj( cfint::ICFIntSubProjectObj* argOrig );
		virtual ~CFBamSubProjectEditObj();
