...
namespace cfbam {
	...
	{
	public:
		ICFBamUInt64ColTableObj();
		virtual ~ICFBamUInt64ColTableObj();
		...
		virtual cfbam::ICFBamUInt64ColObj* newInstance() = 0;

		virtual cfbam::ICFBamUInt64ColEditObj* newEditInstance( cfbam::ICFBamUInt64ColObj* orig ) = 0;

		virtual cfbam::ICFBamUInt64ColObj* realizeUInt64Col( cfbam::ICFBamUInt64ColObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeUInt64Col( cfbam::ICFBamUInt64ColObj* Obj ) = 0;
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId ) = 0;
		virtual cfbam::ICFBamUInt64ColObj* createUInt64Col( cfbam::ICFBamUInt64ColEditObj* Obj ) = 0;

		virtual cfbam::ICFBamUInt64ColObj* readUInt64Col( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamUInt64ColObj* lockUInt64Col( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamUInt64ColObj*> readAllUInt64Col( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamUInt64ColObj* readCachedUInt64Col( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamUInt64ColObj*> readCachedUInt64ColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUInt64ColObj* updateUInt64Col( cfbam::ICFBamUInt64ColEditObj* Obj ) = 0;

		virtual void deleteUInt64Col( cfbam::ICFBamUInt64ColEditObj* Obj ) = 0;
		...
		virtual void deleteUInt64ColByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamUInt64ColObj* moveUpUInt64Col( cfbam::ICFBamUInt64ColObj* Obj ) = 0;

		virtual cfbam::ICFBamUInt64ColObj* moveDownUInt64Col( cfbam::ICFBamUInt64ColObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesUInt64Col( cfbam::ICFBamUInt64ColObj* Obj ) = 0;
