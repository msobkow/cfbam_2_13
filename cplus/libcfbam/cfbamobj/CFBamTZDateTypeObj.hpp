...
// Description: C++18 base object instance specification for CFBam TZDateType.
...
namespace cfbam {
	...
	class CFBamTZDateTypeObj
	: public CFBamTZDateDefObj,
	  public virtual ICFBamTZDateTypeObj
	{
	protected:
	public:
		...
		CFBamTZDateTypeObj();
		CFBamTZDateTypeObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTZDateTypeObj();
