...
// Description: C++18 edit object instance specification for CFBam ISOCcy.
...
namespace cfbam {
	...
	class CFBamISOCcyEditObj
	: public virtual ICFBamISOCcyEditObj,
	  public virtual cfsec::ICFSecISOCcyEditObj,
	  public virtual cfint::ICFIntISOCcyEditObj
	{
	public:
	...
	public:
		CFBamISOCcyEditObj( cfsec::ICFSecISOCcyObj* argOrig );
		virtual ~CFBamISOCcyEditObj();
