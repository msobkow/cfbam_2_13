...
// Description: C++18 base object instance specification for CFBam URLProtocol.
...
namespace cfbam {
	...
	class CFBamURLProtocolObj
	: public virtual ICFBamURLProtocolObj,
	...
	public:
		...
		CFBamURLProtocolObj();
		CFBamURLProtocolObj( cfint::ICFIntSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamURLProtocolObj();
