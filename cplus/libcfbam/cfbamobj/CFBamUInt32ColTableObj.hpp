...
namespace cfbam {
	...
	class CFBamUInt32ColTableObj
	: public virtual ICFBamUInt32ColTableObj
	{
	protected:
		cfbam::ICFBamSchemaObj* schema;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32ColObj*>* members;
		std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32ColObj*>* allUInt32Col;
		std::map< cfbam::CFBamValueByUNameIdxKey,
			cfbam::ICFBamUInt32ColObj*>* indexByUNameIdx;
		std::map< cfbam::CFBamValueByValTentIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32ColObj*>*>* indexByValTentIdx;
		std::map< cfbam::CFBamValueByScopeIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32ColObj*>*>* indexByScopeIdx;
		std::map< cfbam::CFBamValueByDefSchemaIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32ColObj*>*>* indexByDefSchemaIdx;
		std::map< cfbam::CFBamValueByPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32ColObj*>*>* indexByPrevIdx;
		std::map< cfbam::CFBamValueByNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32ColObj*>*>* indexByNextIdx;
		std::map< cfbam::CFBamValueByContPrevIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32ColObj*>*>* indexByContPrevIdx;
		std::map< cfbam::CFBamValueByContNextIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32ColObj*>*>* indexByContNextIdx;
		std::map< cfbam::CFBamUInt32ColByTableIdxKey,
			std::map<cfbam::CFBamValuePKey, cfbam::ICFBamUInt32ColObj*>*>* indexByTableIdx;
	...
	public:
		...
		CFBamUInt32ColTableObj();
		CFBamUInt32ColTableObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual ~CFBamUInt32ColTableObj();
		...
		virtual cfbam::ICFBamUInt32ColObj* newInstance();

		virtual cfbam::ICFBamUInt32ColEditObj* newEditInstance( cfbam::ICFBamUInt32ColObj* orig );

		virtual cfbam::ICFBamUInt32ColObj* realizeUInt32Col( cfbam::ICFBamUInt32ColObj* Obj );
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );
		virtual void reallyDeepDisposeUInt32Col( cfbam::ICFBamUInt32ColObj* Obj );
		virtual void deepDisposeByTableIdx( const int64_t TenantId,
			const int64_t TableId );
		virtual cfbam::ICFBamUInt32ColObj* createUInt32Col( cfbam::ICFBamUInt32ColEditObj* Obj );

		virtual cfbam::ICFBamUInt32ColObj* readUInt32Col( cfbam::CFBamValuePKey* pkey, bool forceRead = false );

		virtual cfbam::ICFBamUInt32ColObj* lockUInt32Col( cfbam::CFBamValuePKey* pkey );

		virtual std::vector<cfbam::ICFBamUInt32ColObj*> readAllUInt32Col( bool forceRead = false );

		virtual cfbam::ICFBamUInt32ColObj* readUInt32ColByIdIdx( const int64_t TenantId,
			const int64_t Id, bool forceRead = false );

		virtual cfbam::ICFBamUInt32ColObj* readUInt32ColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name, bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt32ColObj*> readUInt32ColByValTentIdx( const int64_t TenantId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt32ColObj*> readUInt32ColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt32ColObj*> readUInt32ColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt32ColObj*> readUInt32ColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt32ColObj*> readUInt32ColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt32ColObj*> readUInt32ColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt32ColObj*> readUInt32ColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId,
			bool forceRead = false );

		virtual std::vector<cfbam::ICFBamUInt32ColObj*> readUInt32ColByTableIdx( const int64_t TenantId,
			const int64_t TableId,
			bool forceRead = false );

		virtual cfbam::ICFBamUInt32ColObj* readCachedUInt32Col( cfbam::CFBamValuePKey* pkey );

		virtual cfbam::ICFBamUInt32ColObj* readCachedUInt32ColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual cfbam::ICFBamUInt32ColObj* readCachedUInt32ColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual std::vector<cfbam::ICFBamUInt32ColObj*> readCachedUInt32ColByValTentIdx( const int64_t TenantId );

		virtual std::vector<cfbam::ICFBamUInt32ColObj*> readCachedUInt32ColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual std::vector<cfbam::ICFBamUInt32ColObj*> readCachedUInt32ColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual std::vector<cfbam::ICFBamUInt32ColObj*> readCachedUInt32ColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamUInt32ColObj*> readCachedUInt32ColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamUInt32ColObj*> readCachedUInt32ColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual std::vector<cfbam::ICFBamUInt32ColObj*> readCachedUInt32ColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual std::vector<cfbam::ICFBamUInt32ColObj*> readCachedUInt32ColByTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual cfbam::ICFBamUInt32ColObj* updateUInt32Col( cfbam::ICFBamUInt32ColEditObj* Obj );

		virtual void deleteUInt32Col( cfbam::ICFBamUInt32ColEditObj* Obj );

		virtual void deleteUInt32ColByIdIdx( const int64_t TenantId,
			const int64_t Id );

		virtual void deleteUInt32ColByUNameIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const std::string& Name );

		virtual void deleteUInt32ColByValTentIdx( const int64_t TenantId );

		virtual void deleteUInt32ColByScopeIdx( const int64_t TenantId,
			const int64_t ScopeId );

		virtual void deleteUInt32ColByDefSchemaIdx( const int64_t* DefSchemaTenantId,
			const int64_t* DefSchemaId );

		virtual void deleteUInt32ColByPrevIdx( const int64_t* PrevTenantId,
			const int64_t* PrevId );

		virtual void deleteUInt32ColByNextIdx( const int64_t* NextTenantId,
			const int64_t* NextId );

		virtual void deleteUInt32ColByContPrevIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* PrevId );

		virtual void deleteUInt32ColByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId );

		virtual void deleteUInt32ColByTableIdx( const int64_t TenantId,
			const int64_t TableId );

		virtual cfbam::ICFBamUInt32ColObj* moveUpUInt32Col( cfbam::ICFBamUInt32ColObj* Obj );

		virtual cfbam::ICFBamUInt32ColObj* moveDownUInt32Col( cfbam::ICFBamUInt32ColObj* Obj );

		virtual void reallyDetachFromIndexesUInt32Col( cfbam::ICFBamUInt32ColObj* Obj );
