...
// Description: C++18 Instance Edit Object interface for CFBam TextDef.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamAtomEditObj,
	  public virtual cfbam::ICFBamTextDefObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamTextDefEditObj();
		virtual ~ICFBamTextDefEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamTextDefBuff* getTextDefBuff() {
			return( static_cast<cfbam::CFBamTextDefBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamTextDefBuff* getTextDefEditBuff() {
			return( dynamic_cast<cfbam::CFBamTextDefBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamTextDefObj* getOrigAsTextDef() = 0;

		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual const int32_t getRequiredMaxLen() = 0;
		virtual const int32_t* getRequiredMaxLenReference() = 0;
		virtual void setRequiredMaxLen( const int32_t value ) = 0;

		virtual bool isOptionalInitValueNull() = 0;
		virtual const std::string& getOptionalInitValueValue() = 0;
		virtual const std::string* getOptionalInitValueReference() = 0;
		virtual void setOptionalInitValueNull() = 0;
		virtual void setOptionalInitValueValue( const std::string& value ) = 0;

		virtual bool isOptionalXmlElementNameNull() = 0;
		virtual const std::string& getOptionalXmlElementNameValue() = 0;
		virtual const std::string* getOptionalXmlElementNameReference() = 0;
		virtual void setOptionalXmlElementNameNull() = 0;
		virtual void setOptionalXmlElementNameValue( const std::string& value ) = 0;
