...
// Description: C++18 base object instance specification for CFBam NumberCol.
...
namespace cfbam {
	...
	class CFBamNumberColObj
	: public CFBamNumberDefObj,
	  public virtual ICFBamNumberColObj
	{
	protected:
	public:
		...
		CFBamNumberColObj();
		CFBamNumberColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamNumberColObj();
