...
namespace cfbam {
	...
	class CFBamISOLangTableObj
	: public virtual ICFBamISOLangTableObj,
	  public virtual cfsec::ICFSecISOLangTableObj,
	  public virtual cfint::ICFIntISOLangTableObj
	{
	protected:
	...
	public:
		...
		CFBamISOLangTableObj();
		CFBamISOLangTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFBamISOLangTableObj();
