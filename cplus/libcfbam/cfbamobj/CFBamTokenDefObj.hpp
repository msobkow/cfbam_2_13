...
// Description: C++18 base object instance specification for CFBam TokenDef.
...
namespace cfbam {
	...
	class CFBamTokenDefObj
	: public CFBamAtomObj,
	  public virtual ICFBamTokenDefObj
	{
	protected:
	public:
		...
		CFBamTokenDefObj();
		CFBamTokenDefObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamTokenDefObj();
