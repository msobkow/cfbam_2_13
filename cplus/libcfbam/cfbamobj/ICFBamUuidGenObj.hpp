...
// Description: C++18 Object interface for CFBam UuidGen.
...
namespace cfbam {
	...
	class ICFBamUuidGenObj
	: public virtual cfbam::ICFBamUuidTypeObj
	{
	public:
		ICFBamUuidGenObj();
		virtual ~ICFBamUuidGenObj();
		virtual cfbam::ICFBamValueEditObj* beginEdit() = 0;

		virtual cfbam::ICFBamUuidGenEditObj* getUuidGenEdit() = 0;
