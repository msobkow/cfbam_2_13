...
// Description: C++18 Instance Edit Object interface for CFBam UInt16Type.
...
namespace cfbam {
	...
	: public virtual cfbam::ICFBamUInt16DefEditObj,
	  public virtual cfbam::ICFBamUInt16TypeObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFBamUInt16TypeEditObj();
		virtual ~ICFBamUInt16TypeEditObj();
		virtual const std::string& getClassName() const = 0;

		inline cfbam::CFBamUInt16TypeBuff* getUInt16TypeBuff() {
			return( static_cast<cfbam::CFBamUInt16TypeBuff*>( getBuff() ) );
		};

		inline cfbam::CFBamUInt16TypeBuff* getUInt16TypeEditBuff() {
			return( dynamic_cast<cfbam::CFBamUInt16TypeBuff*>( getBuff() ) );
		};

		virtual cfbam::ICFBamUInt16TypeObj* getOrigAsUInt16Type() = 0;
