...
namespace cfbam {
	...
	{
	public:
		ICFBamInt32DefTableObj();
		virtual ~ICFBamInt32DefTableObj();
		...
		virtual cfbam::ICFBamInt32DefObj* newInstance() = 0;

		virtual cfbam::ICFBamInt32DefEditObj* newEditInstance( cfbam::ICFBamInt32DefObj* orig ) = 0;

		virtual cfbam::ICFBamInt32DefObj* realizeInt32Def( cfbam::ICFBamInt32DefObj* Obj ) = 0;
		...
		virtual void deepDisposeByContNextIdx( const int64_t TenantId,
			const int64_t ScopeId,
			const int64_t* NextId ) = 0;
		virtual void reallyDeepDisposeInt32Def( cfbam::ICFBamInt32DefObj* Obj ) = 0;
		virtual cfbam::ICFBamInt32DefObj* createInt32Def( cfbam::ICFBamInt32DefEditObj* Obj ) = 0;

		virtual cfbam::ICFBamInt32DefObj* readInt32Def( cfbam::CFBamValuePKey* pkey,
			bool forceRead = false ) = 0;

		virtual cfbam::ICFBamInt32DefObj* lockInt32Def( cfbam::CFBamValuePKey* pkey ) = 0;

		virtual std::vector<cfbam::ICFBamInt32DefObj*> readAllInt32Def( bool forceRead = false ) = 0;
		...
		virtual cfbam::ICFBamInt32DefObj* readCachedInt32Def( cfbam::CFBamValuePKey* pkey ) = 0;
		...
		virtual std::vector<cfbam::ICFBamInt32DefObj*> readCachedInt32DefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamInt32DefObj* updateInt32Def( cfbam::ICFBamInt32DefEditObj* Obj ) = 0;

		virtual void deleteInt32Def( cfbam::ICFBamInt32DefEditObj* Obj ) = 0;
		...
		virtual void deleteInt32DefByValTentIdx( const int64_t TenantId ) = 0;
		...
		virtual cfbam::ICFBamInt32DefObj* moveUpInt32Def( cfbam::ICFBamInt32DefObj* Obj ) = 0;

		virtual cfbam::ICFBamInt32DefObj* moveDownInt32Def( cfbam::ICFBamInt32DefObj* Obj ) = 0;

		virtual void reallyDetachFromIndexesInt32Def( cfbam::ICFBamInt32DefObj* Obj ) = 0;
