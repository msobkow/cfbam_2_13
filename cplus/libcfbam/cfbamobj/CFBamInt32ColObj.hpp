...
// Description: C++18 base object instance specification for CFBam Int32Col.
...
namespace cfbam {
	...
	class CFBamInt32ColObj
	: public CFBamInt32DefObj,
	  public virtual ICFBamInt32ColObj
	{
	protected:
	public:
		...
		CFBamInt32ColObj();
		CFBamInt32ColObj( cfbam::ICFBamSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFBamInt32ColObj();
