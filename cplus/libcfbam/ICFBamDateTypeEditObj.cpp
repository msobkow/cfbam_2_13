// Description: C++18 Instance Edit Object interface implementation for CFBam DateType.
...
namespace cfbam {
	...
	const std::string ICFBamDateTypeEditObj::CLASS_NAME( "ICFBamDateTypeEditObj" );

	ICFBamDateTypeEditObj::ICFBamDateTypeEditObj()
