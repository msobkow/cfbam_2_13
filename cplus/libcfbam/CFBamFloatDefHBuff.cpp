// Description: C++18 implementation of a FloatDef history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamFloatDefHBuff::CLASS_NAME( "CFBamFloatDefHBuff" );
	CFBamFloatDefHBuff::CFBamFloatDefHBuff()
	...
	CFBamFloatDefHBuff::CFBamFloatDefHBuff( const CFBamFloatDefHBuff& src )
	: cfbam::CFBamAtomHBuff() {
		optionalInitValue.setNull();
		optionalMinValue.setNull();
		optionalMaxValue.setNull();
	...
	cflib::ICFLibCloneableObj* CFBamFloatDefHBuff::clone() {
		CFBamFloatDefHBuff* copy = new CFBamFloatDefHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const float CFBamFloatDefHBuff::getOptionalInitValueValue() const {
		return( optionalInitValue.getValue() );
	}

	const float* CFBamFloatDefHBuff::getOptionalInitValueReference() const {
		return( optionalInitValue.getReference() );
	}

	const bool CFBamFloatDefHBuff::isOptionalInitValueNull() const {
		return( optionalInitValue.isNull() );
	}

	void CFBamFloatDefHBuff::setOptionalInitValueNull() {
		optionalInitValue.setNull();
	}

	void CFBamFloatDefHBuff::setOptionalInitValueValue( const float value ) {
	...
	const float CFBamFloatDefHBuff::getOptionalMinValueValue() const {
		return( optionalMinValue.getValue() );
	}

	const float* CFBamFloatDefHBuff::getOptionalMinValueReference() const {
		return( optionalMinValue.getReference() );
	}

	const bool CFBamFloatDefHBuff::isOptionalMinValueNull() const {
		return( optionalMinValue.isNull() );
	}

	void CFBamFloatDefHBuff::setOptionalMinValueNull() {
		optionalMinValue.setNull();
	}

	void CFBamFloatDefHBuff::setOptionalMinValueValue( const float value ) {
	...
	const float CFBamFloatDefHBuff::getOptionalMaxValueValue() const {
		return( optionalMaxValue.getValue() );
	}

	const float* CFBamFloatDefHBuff::getOptionalMaxValueReference() const {
		return( optionalMaxValue.getReference() );
	}

	const bool CFBamFloatDefHBuff::isOptionalMaxValueNull() const {
		return( optionalMaxValue.isNull() );
	}

	void CFBamFloatDefHBuff::setOptionalMaxValueNull() {
		optionalMaxValue.setNull();
	}

	void CFBamFloatDefHBuff::setOptionalMaxValueValue( const float value ) {
	...
	size_t CFBamFloatDefHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamFloatDefHBuff::hashCode();
	...
	CFBamFloatDefHBuff CFBamFloatDefHBuff::operator =( cfbam::CFBamFloatDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamFloatDefHBuff CFBamFloatDefHBuff::operator =( cfbam::CFBamFloatDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamFloatDefHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamFloatDefHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamFloatDefHBuff::operator <( const CFBamFloatDefHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamFloatDefHBuff::operator <( const CFBamFloatDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamFloatDefHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamFloatDefHBuff" );
