// Description: C++18 base object instance implementation for CFBam TimestampType.
...
namespace cfbam {
	...
	const std::string CFBamTimestampTypeObj::CLASS_NAME( "CFBamTimestampTypeObj" );
	const classcode_t CFBamTimestampTypeObj::CLASS_CODE = 0xa847L;

	const int64_t CFBamTimestampTypeObj::getRequiredSchemaDefId() {
		return( getTimestampTypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamTimestampTypeObj::getRequiredSchemaDefIdReference() {
		return( getTimestampTypeBuff()->getRequiredSchemaDefIdReference() );
	}


	cfbam::ICFBamSchemaDefObj* CFBamTimestampTypeObj::getRequiredContainerSchemaDef( bool forceRead ) {
	...
	CFBamTimestampTypeObj::CFBamTimestampTypeObj()
	: ICFBamTimestampTypeObj(),
	  CFBamTimestampDefObj()
	{
	}

	CFBamTimestampTypeObj::CFBamTimestampTypeObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamTimestampTypeObj(),
	  CFBamTimestampDefObj( argSchema )
	{
	}
	...
	cfbam::CFBamValueBuff* CFBamTimestampTypeObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamTimestampTypeBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableTimestampType()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamTimestampTypeObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamTimestampTypeObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTimestampTypeObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTimestampTypeObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamTimestampTypeBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamTimestampDefObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamTimestampTypeObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTimestampTypeObj" );
		...
		if( ! CFBamTimestampDefObj::isOptionalDummyNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredXmlString( &S_Space, S_Dummy, CFBamTimestampDefObj::getOptionalDummyValue() ) );
		}
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamTimestampTypeObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamTimestampTypeObj::getObjName() {
	...
	const std::string CFBamTimestampTypeObj::getGenDefName() {
		return( cfbam::CFBamTimestampTypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTimestampTypeObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTimestampTypeObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTimestampTypeObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTimestampTypeObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTimestampTypeObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTimestampTypeObj::getObjQualifiedName() {
	...
	std::string CFBamTimestampTypeObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTimestampTypeObj::realize() {
		cfbam::ICFBamTimestampTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimestampTypeTableObj()->realizeTimestampType(
			(cfbam::ICFBamTimestampTypeObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTimestampTypeObj::read( bool forceRead ) {
		cfbam::ICFBamTimestampTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimestampTypeTableObj()->readTimestampTypeByIdIdx( getTimestampTypeBuff()->getRequiredTenantId(),
		getTimestampTypeBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTimestampTypeObj::moveUp() {
		cfbam::ICFBamTimestampTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimestampTypeTableObj()->moveUpTimestampType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTimestampTypeObj::moveDown() {
		cfbam::ICFBamTimestampTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimestampTypeTableObj()->moveDownTimestampType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamTimestampTypeObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamTimestampTypeObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimestampTypeTableObj()->lockTimestampType( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimestampTypeTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamTimestampTypeEditObj* CFBamTimestampTypeObj::getTimestampTypeEdit() {
		return( dynamic_cast<cfbam::ICFBamTimestampTypeEditObj*>( edit ) );
	}
