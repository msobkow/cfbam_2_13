// Description: C++18 implementation of a TableCol history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTableColHBuff::CLASS_NAME( "CFBamTableColHBuff" );
	CFBamTableColHBuff::CFBamTableColHBuff()
	: cfbam::CFBamValueHBuff() {
	...
	CFBamTableColHBuff::CFBamTableColHBuff( const CFBamTableColHBuff& src )
	: cfbam::CFBamValueHBuff() {
		requiredTableId = cfbam::CFBamTableColBuff::TABLEID_INIT_VALUE;
		optionalDbName = NULL;
		optionalDataTenantId.setNull();
	...
	cflib::ICFLibCloneableObj* CFBamTableColHBuff::clone() {
		CFBamTableColHBuff* copy = new CFBamTableColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamTableColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamTableColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamTableColHBuff::setRequiredTableId( const int64_t value ) {
	...
	const std::string& CFBamTableColHBuff::getOptionalDbNameValue() const {
	...
	const std::string* CFBamTableColHBuff::getOptionalDbNameReference() const {
		return( optionalDbName );
	}

	const bool CFBamTableColHBuff::isOptionalDbNameNull() const {
		return( optionalDbName == NULL );
	}

	void CFBamTableColHBuff::setOptionalDbNameNull() {
		if( optionalDbName != NULL ) {
			delete optionalDbName;
			optionalDbName = NULL;
		}
	...
	void CFBamTableColHBuff::setOptionalDbNameValue( const std::string& value ) {
	...
	const int64_t CFBamTableColHBuff::getOptionalDataTenantIdValue() const {
		return( optionalDataTenantId.getValue() );
	}

	const int64_t* CFBamTableColHBuff::getOptionalDataTenantIdReference() const {
		return( optionalDataTenantId.getReference() );
	}

	const bool CFBamTableColHBuff::isOptionalDataTenantIdNull() const {
		return( optionalDataTenantId.isNull() );
	}

	void CFBamTableColHBuff::setOptionalDataTenantIdNull() {
		optionalDataTenantId.setNull();
	}

	void CFBamTableColHBuff::setOptionalDataTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamTableColHBuff::getOptionalDataIdValue() const {
		return( optionalDataId.getValue() );
	}

	const int64_t* CFBamTableColHBuff::getOptionalDataIdReference() const {
		return( optionalDataId.getReference() );
	}

	const bool CFBamTableColHBuff::isOptionalDataIdNull() const {
		return( optionalDataId.isNull() );
	}

	void CFBamTableColHBuff::setOptionalDataIdNull() {
		optionalDataId.setNull();
	}

	void CFBamTableColHBuff::setOptionalDataIdValue( const int64_t value ) {
	...
	const std::string& CFBamTableColHBuff::getOptionalXmlElementNameValue() const {
	...
	const std::string* CFBamTableColHBuff::getOptionalXmlElementNameReference() const {
		return( optionalXmlElementName );
	}

	const bool CFBamTableColHBuff::isOptionalXmlElementNameNull() const {
		return( optionalXmlElementName == NULL );
	}

	void CFBamTableColHBuff::setOptionalXmlElementNameNull() {
		if( optionalXmlElementName != NULL ) {
			delete optionalXmlElementName;
			optionalXmlElementName = NULL;
		}
	...
	void CFBamTableColHBuff::setOptionalXmlElementNameValue( const std::string& value ) {
	...
	size_t CFBamTableColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamTableColHBuff::hashCode();
	...
	CFBamTableColHBuff CFBamTableColHBuff::operator =( cfbam::CFBamTableColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamTableColHBuff CFBamTableColHBuff::operator =( cfbam::CFBamTableColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTableColHBuff::operator <( const CFBamTableColByTableIdxKey& rhs ) {
	...
	bool CFBamTableColHBuff::operator <( const CFBamTableColByDataIdxKey& rhs ) {
		if( ! isOptionalDataTenantIdNull() ) {
	...
	bool CFBamTableColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTableColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamTableColHBuff::operator <( const CFBamTableColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamTableColHBuff::operator <( const CFBamTableColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTableColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTableColHBuff" );
