// Description: C++18 base object instance implementation for CFBam TimeCol.
...
namespace cfbam {
	...
	const std::string CFBamTimeColObj::CLASS_NAME( "CFBamTimeColObj" );
	const classcode_t CFBamTimeColObj::CLASS_CODE = 0xa867L;

	const int64_t CFBamTimeColObj::getRequiredTableId() {
		return( getTimeColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamTimeColObj::getRequiredTableIdReference() {
		return( getTimeColBuff()->getRequiredTableIdReference() );
	}


	cfbam::ICFBamTableObj* CFBamTimeColObj::getRequiredContainerTable( bool forceRead ) {
	...
	CFBamTimeColObj::CFBamTimeColObj()
	: ICFBamTimeColObj(),
	  CFBamTimeDefObj()
	{
	}

	CFBamTimeColObj::CFBamTimeColObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamTimeColObj(),
	...
	cfbam::CFBamValueBuff* CFBamTimeColObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamTimeColBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableTimeCol()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamTimeColObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamTimeColObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTimeColObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTimeColObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamTimeColObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTimeColObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamTimeColObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamTimeColObj::getObjName() {
	...
	const std::string CFBamTimeColObj::getGenDefName() {
		return( cfbam::CFBamTimeColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTimeColObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTimeColObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTimeColObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTimeColObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTimeColObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTimeColObj::getObjQualifiedName() {
	...
	std::string CFBamTimeColObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTimeColObj::realize() {
		cfbam::ICFBamTimeColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimeColTableObj()->realizeTimeCol(
			(cfbam::ICFBamTimeColObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTimeColObj::read( bool forceRead ) {
		cfbam::ICFBamTimeColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimeColTableObj()->readTimeColByIdIdx( getTimeColBuff()->getRequiredTenantId(),
		getTimeColBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTimeColObj::moveUp() {
		cfbam::ICFBamTimeColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimeColTableObj()->moveUpTimeCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTimeColObj::moveDown() {
		cfbam::ICFBamTimeColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimeColTableObj()->moveDownTimeCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamTimeColObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamTimeColObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimeColTableObj()->lockTimeCol( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimeColTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamTimeColEditObj* CFBamTimeColObj::getTimeColEdit() {
		return( dynamic_cast<cfbam::ICFBamTimeColEditObj*>( edit ) );
	}
