// Description: C++18 implementation for a UInt16Col buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUInt16ColBuff::GENDEFNAME( "UInt16Col" );
	const classcode_t CFBamUInt16ColBuff::CLASS_CODE = 0xa86aL;
	const std::string CFBamUInt16ColBuff::CLASS_NAME( "CFBamUInt16ColBuff" );
		const std::string CFBamUInt16ColBuff::COLNAME_TABLEID( "TableId" );
	const int64_t CFBamUInt16ColBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamUInt16ColBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamUInt16ColBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamUInt16ColBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamUInt16ColBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamUInt16ColBuff::TABLEID_MIN_VALUE = 0LL;

	CFBamUInt16ColBuff::CFBamUInt16ColBuff()
	: CFBamUInt16DefBuff()
	{
		requiredTableId = cfbam::CFBamUInt16ColBuff::TABLEID_INIT_VALUE;
	}

	CFBamUInt16ColBuff::CFBamUInt16ColBuff( const CFBamUInt16ColBuff& src )
	: CFBamUInt16DefBuff()
	{
		requiredTableId = cfbam::CFBamUInt16ColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamUInt16ColBuff::clone() {
		CFBamUInt16ColBuff* copy = new CFBamUInt16ColBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamUInt16ColBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUInt16ColBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamUInt16ColBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamUInt16DefBuff::implementsClassCode( argClassCode ) );
		}
	}

	const int64_t CFBamUInt16ColBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamUInt16ColBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamUInt16ColBuff::setRequiredTableId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredTableId" );
		if( value < cfbam::CFBamUInt16ColBuff::TABLEID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamUInt16ColBuff::TABLEID_MIN_VALUE );
		}
		requiredTableId = value;
	}

	size_t CFBamUInt16ColBuff::hashCode() const {
		size_t hashCode = CFBamUInt16DefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamUInt16ColBuff CFBamUInt16ColBuff::operator =( cfbam::CFBamUInt16ColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamUInt16ColBuff CFBamUInt16ColBuff::operator =( cfbam::CFBamUInt16ColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUInt16ColBuff::operator <( const CFBamUInt16ColByTableIdxKey& rhs ) {
	...
	bool CFBamUInt16ColBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt16ColBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt16ColBuff::operator <( const CFBamUInt16ColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt16ColBuff::operator <( const CFBamUInt16ColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUInt16ColBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt16ColBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamUInt16ColBuff& lhs, const cfbam::CFBamUInt16ColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamUInt16ColBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamUInt16ColBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamUInt16ColBuff& lhs, const cfbam::CFBamUInt16ColHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamUInt16ColBuff& lhs, const cfbam::CFBamUInt16ColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
