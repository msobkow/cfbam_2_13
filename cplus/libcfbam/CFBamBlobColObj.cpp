// Description: C++18 base object instance implementation for CFBam BlobCol.
...
namespace cfbam {
	...
	const std::string CFBamBlobColObj::CLASS_NAME( "CFBamBlobColObj" );
	const classcode_t CFBamBlobColObj::CLASS_CODE = 0xa852L;

	const int64_t CFBamBlobColObj::getRequiredTableId() {
		return( getBlobColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamBlobColObj::getRequiredTableIdReference() {
		return( getBlobColBuff()->getRequiredTableIdReference() );
	}


	cfbam::ICFBamTableObj* CFBamBlobColObj::getRequiredContainerTable( bool forceRead ) {
	...
	CFBamBlobColObj::CFBamBlobColObj()
	: ICFBamBlobColObj(),
	  CFBamBlobDefObj()
	{
	}

	CFBamBlobColObj::CFBamBlobColObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamBlobColObj(),
	...
	cfbam::CFBamValueBuff* CFBamBlobColObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamBlobColBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableBlobCol()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamBlobColObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamBlobColObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamBlobColObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamBlobColObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamBlobColObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamBlobColObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamBlobColObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamBlobColObj::getObjName() {
	...
	const std::string CFBamBlobColObj::getGenDefName() {
		return( cfbam::CFBamBlobColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamBlobColObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamBlobColObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamBlobColObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamBlobColObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamBlobColObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamBlobColObj::getObjQualifiedName() {
	...
	std::string CFBamBlobColObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamBlobColObj::realize() {
		cfbam::ICFBamBlobColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getBlobColTableObj()->realizeBlobCol(
			(cfbam::ICFBamBlobColObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamBlobColObj::read( bool forceRead ) {
		cfbam::ICFBamBlobColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getBlobColTableObj()->readBlobColByIdIdx( getBlobColBuff()->getRequiredTenantId(),
		getBlobColBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamBlobColObj::moveUp() {
		cfbam::ICFBamBlobColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getBlobColTableObj()->moveUpBlobCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamBlobColObj::moveDown() {
		cfbam::ICFBamBlobColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getBlobColTableObj()->moveDownBlobCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamBlobColObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamBlobColObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getBlobColTableObj()->lockBlobCol( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getBlobColTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamBlobColEditObj* CFBamBlobColObj::getBlobColEdit() {
		return( dynamic_cast<cfbam::ICFBamBlobColEditObj*>( edit ) );
	}
