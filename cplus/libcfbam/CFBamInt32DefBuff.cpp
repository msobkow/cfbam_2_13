// Description: C++18 implementation for a Int32Def buffer object.
...
namespace cfbam {
	...
	const std::string CFBamInt32DefBuff::GENDEFNAME( "Int32Def" );
	const classcode_t CFBamInt32DefBuff::CLASS_CODE = 0xa825L;
	const std::string CFBamInt32DefBuff::CLASS_NAME( "CFBamInt32DefBuff" );
		const std::string CFBamInt32DefBuff::COLNAME_INITVALUE( "InitValue" );
		const std::string CFBamInt32DefBuff::COLNAME_MINVALUE( "MinValue" );
		const std::string CFBamInt32DefBuff::COLNAME_MAXVALUE( "MaxValue" );
	const int64_t CFBamInt32DefBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamInt32DefBuff::ID_INIT_VALUE = 0LL;
	const int CFBamInt32DefBuff::INITVALUE_INIT_VALUE = 0L;
	const int CFBamInt32DefBuff::MINVALUE_INIT_VALUE = 0L;
	const int CFBamInt32DefBuff::MAXVALUE_INIT_VALUE = 0L;
	const int64_t CFBamInt32DefBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamInt32DefBuff::ID_MIN_VALUE = 0LL;
	const int CFBamInt32DefBuff::INITVALUE_MIN_VALUE = -2147483648L;
	const int CFBamInt32DefBuff::MINVALUE_MIN_VALUE = -2147483648L;
	const int CFBamInt32DefBuff::MAXVALUE_MIN_VALUE = -2147483648L;
	const int CFBamInt32DefBuff::INITVALUE_MAX_VALUE = 2147483647L;
	const int CFBamInt32DefBuff::MINVALUE_MAX_VALUE = 2147483647L;
	const int CFBamInt32DefBuff::MAXVALUE_MAX_VALUE = 2147483647L;

	CFBamInt32DefBuff::CFBamInt32DefBuff()
	: CFBamAtomBuff()
	{
	...
	CFBamInt32DefBuff::CFBamInt32DefBuff( const CFBamInt32DefBuff& src )
	: CFBamAtomBuff()
	{
		optionalInitValue.setNull();
		optionalMinValue.setNull();
	...
	cflib::ICFLibCloneableObj* CFBamInt32DefBuff::clone() {
		CFBamInt32DefBuff* copy = new CFBamInt32DefBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamInt32DefBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamInt32DefBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamInt32DefBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const bool CFBamInt32DefBuff::isOptionalInitValueNull() const {
		return( optionalInitValue.isNull() );
	}

	const int32_t CFBamInt32DefBuff::getOptionalInitValueValue() const {
		return( optionalInitValue.getValue() );
	}

	const int32_t* CFBamInt32DefBuff::getOptionalInitValueReference() const {
		return( optionalInitValue.getReference() );
	}

	void CFBamInt32DefBuff::setOptionalInitValueNull() {
		optionalInitValue.setNull();
	}

	void CFBamInt32DefBuff::setOptionalInitValueValue( const int32_t value ) {
		static const std::string S_ProcName( "setOptionalInitValueValue" );
		if( value < cfbam::CFBamInt32DefBuff::INITVALUE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamInt32DefBuff::INITVALUE_MIN_VALUE );
		}
		if( value > cfbam::CFBamInt32DefBuff::INITVALUE_MAX_VALUE ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamInt32DefBuff::INITVALUE_MAX_VALUE );
		}
		optionalInitValue.setValue( value );
	}

	const bool CFBamInt32DefBuff::isOptionalMinValueNull() const {
		return( optionalMinValue.isNull() );
	}

	const int32_t CFBamInt32DefBuff::getOptionalMinValueValue() const {
		return( optionalMinValue.getValue() );
	}

	const int32_t* CFBamInt32DefBuff::getOptionalMinValueReference() const {
		return( optionalMinValue.getReference() );
	}

	void CFBamInt32DefBuff::setOptionalMinValueNull() {
		optionalMinValue.setNull();
	}

	void CFBamInt32DefBuff::setOptionalMinValueValue( const int32_t value ) {
		static const std::string S_ProcName( "setOptionalMinValueValue" );
		if( value < cfbam::CFBamInt32DefBuff::MINVALUE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamInt32DefBuff::MINVALUE_MIN_VALUE );
		}
		if( value > cfbam::CFBamInt32DefBuff::MINVALUE_MAX_VALUE ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamInt32DefBuff::MINVALUE_MAX_VALUE );
		}
		optionalMinValue.setValue( value );
	}

	const bool CFBamInt32DefBuff::isOptionalMaxValueNull() const {
		return( optionalMaxValue.isNull() );
	}

	const int32_t CFBamInt32DefBuff::getOptionalMaxValueValue() const {
		return( optionalMaxValue.getValue() );
	}

	const int32_t* CFBamInt32DefBuff::getOptionalMaxValueReference() const {
		return( optionalMaxValue.getReference() );
	}

	void CFBamInt32DefBuff::setOptionalMaxValueNull() {
		optionalMaxValue.setNull();
	}

	void CFBamInt32DefBuff::setOptionalMaxValueValue( const int32_t value ) {
		static const std::string S_ProcName( "setOptionalMaxValueValue" );
		if( value < cfbam::CFBamInt32DefBuff::MAXVALUE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamInt32DefBuff::MAXVALUE_MIN_VALUE );
		}
		if( value > cfbam::CFBamInt32DefBuff::MAXVALUE_MAX_VALUE ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamInt32DefBuff::MAXVALUE_MAX_VALUE );
		}
		optionalMaxValue.setValue( value );
	}

	size_t CFBamInt32DefBuff::hashCode() const {
	...
	CFBamInt32DefBuff CFBamInt32DefBuff::operator =( cfbam::CFBamInt32DefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamInt32DefBuff CFBamInt32DefBuff::operator =( cfbam::CFBamInt32DefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamInt32DefBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamInt32DefBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt32DefBuff::operator <( const CFBamInt32DefHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt32DefBuff::operator <( const CFBamInt32DefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamInt32DefBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt32DefBuff" );
