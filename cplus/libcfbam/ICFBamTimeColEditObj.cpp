// Description: C++18 Instance Edit Object interface implementation for CFBam TimeCol.
...
namespace cfbam {
	...
	const std::string ICFBamTimeColEditObj::CLASS_NAME( "ICFBamTimeColEditObj" );

	ICFBamTimeColEditObj::ICFBamTimeColEditObj()
