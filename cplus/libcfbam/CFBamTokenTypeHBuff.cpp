// Description: C++18 implementation of a TokenType history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTokenTypeHBuff::CLASS_NAME( "CFBamTokenTypeHBuff" );
	CFBamTokenTypeHBuff::CFBamTokenTypeHBuff()
	: cfbam::CFBamTokenDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamTokenTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamTokenTypeHBuff::CFBamTokenTypeHBuff( const CFBamTokenTypeHBuff& src )
	: cfbam::CFBamTokenDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamTokenTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTokenTypeHBuff::clone() {
		CFBamTokenTypeHBuff* copy = new CFBamTokenTypeHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamTokenTypeHBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamTokenTypeHBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamTokenTypeHBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamTokenTypeHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamTokenTypeHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamTokenTypeHBuff CFBamTokenTypeHBuff::operator =( cfbam::CFBamTokenTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamTokenTypeHBuff CFBamTokenTypeHBuff::operator =( cfbam::CFBamTokenTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTokenTypeHBuff::operator <( const CFBamTokenTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamTokenTypeHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTokenTypeHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamTokenTypeHBuff::operator <( const CFBamTokenTypeHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamTokenTypeHBuff::operator <( const CFBamTokenTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTokenTypeHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTokenTypeHBuff" );
