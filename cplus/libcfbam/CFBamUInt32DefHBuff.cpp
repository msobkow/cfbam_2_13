// Description: C++18 implementation of a UInt32Def history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUInt32DefHBuff::CLASS_NAME( "CFBamUInt32DefHBuff" );
	CFBamUInt32DefHBuff::CFBamUInt32DefHBuff()
	...
	CFBamUInt32DefHBuff::CFBamUInt32DefHBuff( const CFBamUInt32DefHBuff& src )
	: cfbam::CFBamAtomHBuff() {
		optionalInitValue.setNull();
		optionalMinValue.setNull();
		optionalMaxValue.setNull();
	...
	cflib::ICFLibCloneableObj* CFBamUInt32DefHBuff::clone() {
		CFBamUInt32DefHBuff* copy = new CFBamUInt32DefHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const uint32_t CFBamUInt32DefHBuff::getOptionalInitValueValue() const {
		return( optionalInitValue.getValue() );
	}

	const uint32_t* CFBamUInt32DefHBuff::getOptionalInitValueReference() const {
		return( optionalInitValue.getReference() );
	}

	const bool CFBamUInt32DefHBuff::isOptionalInitValueNull() const {
		return( optionalInitValue.isNull() );
	}

	void CFBamUInt32DefHBuff::setOptionalInitValueNull() {
		optionalInitValue.setNull();
	}

	void CFBamUInt32DefHBuff::setOptionalInitValueValue( const uint32_t value ) {
	...
	const uint32_t CFBamUInt32DefHBuff::getOptionalMinValueValue() const {
		return( optionalMinValue.getValue() );
	}

	const uint32_t* CFBamUInt32DefHBuff::getOptionalMinValueReference() const {
		return( optionalMinValue.getReference() );
	}

	const bool CFBamUInt32DefHBuff::isOptionalMinValueNull() const {
		return( optionalMinValue.isNull() );
	}

	void CFBamUInt32DefHBuff::setOptionalMinValueNull() {
		optionalMinValue.setNull();
	}

	void CFBamUInt32DefHBuff::setOptionalMinValueValue( const uint32_t value ) {
	...
	const uint32_t CFBamUInt32DefHBuff::getOptionalMaxValueValue() const {
		return( optionalMaxValue.getValue() );
	}

	const uint32_t* CFBamUInt32DefHBuff::getOptionalMaxValueReference() const {
		return( optionalMaxValue.getReference() );
	}

	const bool CFBamUInt32DefHBuff::isOptionalMaxValueNull() const {
		return( optionalMaxValue.isNull() );
	}

	void CFBamUInt32DefHBuff::setOptionalMaxValueNull() {
		optionalMaxValue.setNull();
	}

	void CFBamUInt32DefHBuff::setOptionalMaxValueValue( const uint32_t value ) {
	...
	size_t CFBamUInt32DefHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamUInt32DefHBuff::hashCode();
	...
	CFBamUInt32DefHBuff CFBamUInt32DefHBuff::operator =( cfbam::CFBamUInt32DefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamUInt32DefHBuff CFBamUInt32DefHBuff::operator =( cfbam::CFBamUInt32DefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUInt32DefHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamUInt32DefHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamUInt32DefHBuff::operator <( const CFBamUInt32DefHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamUInt32DefHBuff::operator <( const CFBamUInt32DefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUInt32DefHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt32DefHBuff" );
