// Description: C++18 base object instance implementation for CFBam Int32Def.
...
namespace cfbam {
	...
	const std::string CFBamInt32DefObj::CLASS_NAME( "CFBamInt32DefObj" );
	const classcode_t CFBamInt32DefObj::CLASS_CODE = 0xa825L;

	bool CFBamInt32DefObj::isOptionalInitValueNull() {
		return( getInt32DefBuff()->isOptionalInitValueNull() );
	}

	const int32_t CFBamInt32DefObj::getOptionalInitValueValue() {
		return( getInt32DefBuff()->getOptionalInitValueValue() );
	}

	const int32_t* CFBamInt32DefObj::getOptionalInitValueReference() {
		return( getInt32DefBuff()->getOptionalInitValueReference() );
	}

	bool CFBamInt32DefObj::isOptionalMinValueNull() {
		return( getInt32DefBuff()->isOptionalMinValueNull() );
	}

	const int32_t CFBamInt32DefObj::getOptionalMinValueValue() {
		return( getInt32DefBuff()->getOptionalMinValueValue() );
	}

	const int32_t* CFBamInt32DefObj::getOptionalMinValueReference() {
		return( getInt32DefBuff()->getOptionalMinValueReference() );
	}

	bool CFBamInt32DefObj::isOptionalMaxValueNull() {
		return( getInt32DefBuff()->isOptionalMaxValueNull() );
	}

	const int32_t CFBamInt32DefObj::getOptionalMaxValueValue() {
		return( getInt32DefBuff()->getOptionalMaxValueValue() );
	}

	const int32_t* CFBamInt32DefObj::getOptionalMaxValueReference() {
		return( getInt32DefBuff()->getOptionalMaxValueReference() );
	}


	CFBamInt32DefObj::CFBamInt32DefObj()
	: ICFBamInt32DefObj(),
	  CFBamAtomObj()
	{
	}

	CFBamInt32DefObj::CFBamInt32DefObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamInt32DefObj(),
	...
	cfbam::CFBamValueBuff* CFBamInt32DefObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamInt32DefBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableInt32Def()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamInt32DefObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamInt32DefObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamInt32DefObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamInt32DefObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamInt32DefObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt32DefObj" );
	...
	std::string CFBamInt32DefObj::getObjName() {
	...
	const std::string CFBamInt32DefObj::getGenDefName() {
		return( cfbam::CFBamInt32DefBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamInt32DefObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamInt32DefObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamInt32DefObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamInt32DefObj::getObjQualifiedName() {
	...
	std::string CFBamInt32DefObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamInt32DefObj::realize() {
		cfbam::ICFBamInt32DefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt32DefTableObj()->realizeInt32Def(
			(cfbam::ICFBamInt32DefObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamInt32DefObj::read( bool forceRead ) {
		cfbam::ICFBamInt32DefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt32DefTableObj()->readInt32DefByIdIdx( getInt32DefBuff()->getRequiredTenantId(),
		getInt32DefBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamInt32DefObj::moveUp() {
		cfbam::ICFBamInt32DefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt32DefTableObj()->moveUpInt32Def( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamInt32DefObj::moveDown() {
		cfbam::ICFBamInt32DefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt32DefTableObj()->moveDownInt32Def( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamInt32DefObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamInt32DefObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt32DefTableObj()->lockInt32Def( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt32DefTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamInt32DefEditObj* CFBamInt32DefObj::getInt32DefEdit() {
		return( dynamic_cast<cfbam::ICFBamInt32DefEditObj*>( edit ) );
	}
