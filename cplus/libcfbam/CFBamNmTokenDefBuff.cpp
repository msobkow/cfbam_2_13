// Description: C++18 implementation for a NmTokenDef buffer object.
...
namespace cfbam {
	...
	const std::string CFBamNmTokenDefBuff::GENDEFNAME( "NmTokenDef" );
	const classcode_t CFBamNmTokenDefBuff::CLASS_CODE = 0xa829L;
	const std::string CFBamNmTokenDefBuff::CLASS_NAME( "CFBamNmTokenDefBuff" );
		const std::string CFBamNmTokenDefBuff::COLNAME_MAXLEN( "MaxLen" );
		const std::string CFBamNmTokenDefBuff::COLNAME_INITVALUE( "InitValue" );
	const int64_t CFBamNmTokenDefBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamNmTokenDefBuff::ID_INIT_VALUE = 0LL;
	const int CFBamNmTokenDefBuff::MAXLEN_INIT_VALUE = 0L;
	const int64_t CFBamNmTokenDefBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamNmTokenDefBuff::ID_MIN_VALUE = 0LL;
	const int CFBamNmTokenDefBuff::MAXLEN_MIN_VALUE = 0L;
	const int CFBamNmTokenDefBuff::MAXLEN_MAX_VALUE = 2147483647L;
	const std::string::size_type CFBamNmTokenDefBuff::INITVALUE_MAX_LEN = 64;

	CFBamNmTokenDefBuff::CFBamNmTokenDefBuff()
	: CFBamAtomBuff()
	{
		requiredMaxLen = cfbam::CFBamNmTokenDefBuff::MAXLEN_INIT_VALUE;
		optionalInitValue = NULL;
	}

	CFBamNmTokenDefBuff::CFBamNmTokenDefBuff( const CFBamNmTokenDefBuff& src )
	: CFBamAtomBuff()
	{
		requiredMaxLen = cfbam::CFBamNmTokenDefBuff::MAXLEN_INIT_VALUE;
		optionalInitValue = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamNmTokenDefBuff::clone() {
		CFBamNmTokenDefBuff* copy = new CFBamNmTokenDefBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamNmTokenDefBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamNmTokenDefBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamNmTokenDefBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int32_t CFBamNmTokenDefBuff::getRequiredMaxLen() const {
		return( requiredMaxLen );
	}

	const int32_t* CFBamNmTokenDefBuff::getRequiredMaxLenReference() const {
		return( &requiredMaxLen );
	}

	void CFBamNmTokenDefBuff::setRequiredMaxLen( const int32_t value ) {
		static const std::string S_ProcName( "setRequiredMaxLen" );
		if( value < cfbam::CFBamNmTokenDefBuff::MAXLEN_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamNmTokenDefBuff::MAXLEN_MIN_VALUE );
		}
		if( value > cfbam::CFBamNmTokenDefBuff::MAXLEN_MAX_VALUE ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamNmTokenDefBuff::MAXLEN_MAX_VALUE );
		}
		requiredMaxLen = value;
	}

	const bool CFBamNmTokenDefBuff::isOptionalInitValueNull() const {
		return( optionalInitValue == NULL );
	}

	const std::string& CFBamNmTokenDefBuff::getOptionalInitValueValue() const {
	...
	const std::string* CFBamNmTokenDefBuff::getOptionalInitValueReference() const {
		return( optionalInitValue );
	}

	void CFBamNmTokenDefBuff::setOptionalInitValueNull() {
		if( optionalInitValue != NULL ) {
			delete optionalInitValue;
			optionalInitValue = NULL;
		}
	...
	void CFBamNmTokenDefBuff::setOptionalInitValueValue( const std::string& value ) {
		static const std::string S_ProcName( "setOptionalInitValueValue" );
		if( value.length() > CFBamNmTokenDefBuff::INITVALUE_MAX_LEN ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE_LENGTH,
				value.length(),
				CFBamNmTokenDefBuff::INITVALUE_MAX_LEN );
		}
		if( optionalInitValue != NULL ) {
			delete optionalInitValue;
			optionalInitValue = NULL;
	...
	size_t CFBamNmTokenDefBuff::hashCode() const {
	...
	CFBamNmTokenDefBuff CFBamNmTokenDefBuff::operator =( cfbam::CFBamNmTokenDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamNmTokenDefBuff CFBamNmTokenDefBuff::operator =( cfbam::CFBamNmTokenDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamNmTokenDefBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamNmTokenDefBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNmTokenDefBuff::operator <( const CFBamNmTokenDefHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNmTokenDefBuff::operator <( const CFBamNmTokenDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamNmTokenDefBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNmTokenDefBuff" );
