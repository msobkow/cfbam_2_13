// Description: C++18 implementation for a StringCol buffer object.
...
namespace cfbam {
	...
	const std::string CFBamStringColBuff::GENDEFNAME( "StringCol" );
	const classcode_t CFBamStringColBuff::CLASS_CODE = 0xa862L;
	const std::string CFBamStringColBuff::CLASS_NAME( "CFBamStringColBuff" );
		const std::string CFBamStringColBuff::COLNAME_TABLEID( "TableId" );
	const int64_t CFBamStringColBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamStringColBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamStringColBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamStringColBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamStringColBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamStringColBuff::TABLEID_MIN_VALUE = 0LL;

	CFBamStringColBuff::CFBamStringColBuff()
	: CFBamStringDefBuff()
	{
		requiredTableId = cfbam::CFBamStringColBuff::TABLEID_INIT_VALUE;
	}

	CFBamStringColBuff::CFBamStringColBuff( const CFBamStringColBuff& src )
	: CFBamStringDefBuff()
	{
		requiredTableId = cfbam::CFBamStringColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamStringColBuff::clone() {
		CFBamStringColBuff* copy = new CFBamStringColBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamStringColBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamStringColBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamStringColBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamStringDefBuff::implementsClassCode( argClassCode ) );
		}
	}

	const int64_t CFBamStringColBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamStringColBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamStringColBuff::setRequiredTableId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredTableId" );
		if( value < cfbam::CFBamStringColBuff::TABLEID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamStringColBuff::TABLEID_MIN_VALUE );
		}
		requiredTableId = value;
	}

	size_t CFBamStringColBuff::hashCode() const {
		size_t hashCode = CFBamStringDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamStringColBuff CFBamStringColBuff::operator =( cfbam::CFBamStringColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamStringColBuff CFBamStringColBuff::operator =( cfbam::CFBamStringColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamStringColBuff::operator <( const CFBamStringColByTableIdxKey& rhs ) {
	...
	bool CFBamStringColBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamStringColBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamStringColBuff::operator <( const CFBamStringColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamStringColBuff::operator <( const CFBamStringColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamStringColBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamStringColBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamStringColBuff& lhs, const cfbam::CFBamStringColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamStringColBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamStringColBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamStringColBuff& lhs, const cfbam::CFBamStringColHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamStringColBuff& lhs, const cfbam::CFBamStringColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
