// Description: C++18 base object instance implementation for CFBam TokenDef.
...
namespace cfbam {
	...
	const std::string CFBamTokenDefObj::CLASS_NAME( "CFBamTokenDefObj" );
	const classcode_t CFBamTokenDefObj::CLASS_CODE = 0xa848L;

	const int32_t CFBamTokenDefObj::getRequiredMaxLen() {
		return( getTokenDefBuff()->getRequiredMaxLen() );
	}

	const int32_t* CFBamTokenDefObj::getRequiredMaxLenReference() {
		return( getTokenDefBuff()->getRequiredMaxLenReference() );
	}

	bool CFBamTokenDefObj::isOptionalInitValueNull() {
		return( getTokenDefBuff()->isOptionalInitValueNull() );
	}

	const std::string& CFBamTokenDefObj::getOptionalInitValueValue() {
		return( getTokenDefBuff()->getOptionalInitValueValue() );
	}

	const std::string* CFBamTokenDefObj::getOptionalInitValueReference() {
		return( getTokenDefBuff()->getOptionalInitValueReference() );
	}


	CFBamTokenDefObj::CFBamTokenDefObj()
	: ICFBamTokenDefObj(),
	  CFBamAtomObj()
	{
	}

	CFBamTokenDefObj::CFBamTokenDefObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamTokenDefObj(),
	...
	cfbam::CFBamValueBuff* CFBamTokenDefObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamTokenDefBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableTokenDef()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamTokenDefObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamTokenDefObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTokenDefObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTokenDefObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamTokenDefObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTokenDefObj" );
	...
	std::string CFBamTokenDefObj::getObjName() {
	...
	const std::string CFBamTokenDefObj::getGenDefName() {
		return( cfbam::CFBamTokenDefBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTokenDefObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTokenDefObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTokenDefObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTokenDefObj::getObjQualifiedName() {
	...
	std::string CFBamTokenDefObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTokenDefObj::realize() {
		cfbam::ICFBamTokenDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTokenDefTableObj()->realizeTokenDef(
			(cfbam::ICFBamTokenDefObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTokenDefObj::read( bool forceRead ) {
		cfbam::ICFBamTokenDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTokenDefTableObj()->readTokenDefByIdIdx( getTokenDefBuff()->getRequiredTenantId(),
		getTokenDefBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTokenDefObj::moveUp() {
		cfbam::ICFBamTokenDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTokenDefTableObj()->moveUpTokenDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTokenDefObj::moveDown() {
		cfbam::ICFBamTokenDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTokenDefTableObj()->moveDownTokenDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamTokenDefObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamTokenDefObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTokenDefTableObj()->lockTokenDef( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTokenDefTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamTokenDefEditObj* CFBamTokenDefObj::getTokenDefEdit() {
		return( dynamic_cast<cfbam::ICFBamTokenDefEditObj*>( edit ) );
	}
