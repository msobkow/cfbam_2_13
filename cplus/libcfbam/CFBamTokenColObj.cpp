// Description: C++18 base object instance implementation for CFBam TokenCol.
...
namespace cfbam {
	...
	const std::string CFBamTokenColObj::CLASS_NAME( "CFBamTokenColObj" );
	const classcode_t CFBamTokenColObj::CLASS_CODE = 0xa869L;

	const int64_t CFBamTokenColObj::getRequiredTableId() {
		return( getTokenColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamTokenColObj::getRequiredTableIdReference() {
		return( getTokenColBuff()->getRequiredTableIdReference() );
	}


	cfbam::ICFBamTableObj* CFBamTokenColObj::getRequiredContainerTable( bool forceRead ) {
	...
	CFBamTokenColObj::CFBamTokenColObj()
	: ICFBamTokenColObj(),
	  CFBamTokenDefObj()
	{
	}

	CFBamTokenColObj::CFBamTokenColObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamTokenColObj(),
	...
	cfbam::CFBamValueBuff* CFBamTokenColObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamTokenColBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableTokenCol()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamTokenColObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamTokenColObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTokenColObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTokenColObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamTokenColObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTokenColObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamTokenColObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamTokenColObj::getObjName() {
	...
	const std::string CFBamTokenColObj::getGenDefName() {
		return( cfbam::CFBamTokenColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTokenColObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTokenColObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTokenColObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTokenColObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTokenColObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTokenColObj::getObjQualifiedName() {
	...
	std::string CFBamTokenColObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTokenColObj::realize() {
		cfbam::ICFBamTokenColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTokenColTableObj()->realizeTokenCol(
			(cfbam::ICFBamTokenColObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTokenColObj::read( bool forceRead ) {
		cfbam::ICFBamTokenColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTokenColTableObj()->readTokenColByIdIdx( getTokenColBuff()->getRequiredTenantId(),
		getTokenColBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTokenColObj::moveUp() {
		cfbam::ICFBamTokenColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTokenColTableObj()->moveUpTokenCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTokenColObj::moveDown() {
		cfbam::ICFBamTokenColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTokenColTableObj()->moveDownTokenCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamTokenColObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamTokenColObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTokenColTableObj()->lockTokenCol( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTokenColTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamTokenColEditObj* CFBamTokenColObj::getTokenColEdit() {
		return( dynamic_cast<cfbam::ICFBamTokenColEditObj*>( edit ) );
	}
