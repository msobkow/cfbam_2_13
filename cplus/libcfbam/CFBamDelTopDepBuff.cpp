// Description: C++18 implementation for a DelTopDep buffer object.
...
namespace cfbam {
	...
	const std::string CFBamDelTopDepBuff::GENDEFNAME( "DelTopDep" );
	const classcode_t CFBamDelTopDepBuff::CLASS_CODE = 0xa81bL;
	const std::string CFBamDelTopDepBuff::CLASS_NAME( "CFBamDelTopDepBuff" );
		const std::string CFBamDelTopDepBuff::COLNAME_NAME( "Name" );
		const std::string CFBamDelTopDepBuff::COLNAME_TABLETENANTID( "TableTenantId" );
		const std::string CFBamDelTopDepBuff::COLNAME_TABLEID( "TableId" );
		const std::string CFBamDelTopDepBuff::COLNAME_PREVTENANTID( "PrevTenantId" );
		const std::string CFBamDelTopDepBuff::COLNAME_PREVID( "PrevId" );
		const std::string CFBamDelTopDepBuff::COLNAME_NEXTTENANTID( "NextTenantId" );
		const std::string CFBamDelTopDepBuff::COLNAME_NEXTID( "NextId" );
	const int64_t CFBamDelTopDepBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamDelTopDepBuff::ID_INIT_VALUE = 0LL;
	const std::string CFBamDelTopDepBuff::NAME_INIT_VALUE( "" );
	const int64_t CFBamDelTopDepBuff::TABLETENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamDelTopDepBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamDelTopDepBuff::PREVTENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamDelTopDepBuff::PREVID_INIT_VALUE = 0LL;
	const int64_t CFBamDelTopDepBuff::NEXTTENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamDelTopDepBuff::NEXTID_INIT_VALUE = 0LL;
	const int64_t CFBamDelTopDepBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamDelTopDepBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamDelTopDepBuff::TABLETENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamDelTopDepBuff::TABLEID_MIN_VALUE = 0LL;
	const int64_t CFBamDelTopDepBuff::PREVTENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamDelTopDepBuff::PREVID_MIN_VALUE = 0LL;
	const int64_t CFBamDelTopDepBuff::NEXTTENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamDelTopDepBuff::NEXTID_MIN_VALUE = 0LL;
	const std::string::size_type CFBamDelTopDepBuff::NAME_MAX_LEN = 192;

	CFBamDelTopDepBuff::CFBamDelTopDepBuff()
	: CFBamDelDepBuff()
	{
	...
	CFBamDelTopDepBuff::CFBamDelTopDepBuff( const CFBamDelTopDepBuff& src )
	: CFBamDelDepBuff()
	{
		requiredName = new std::string( cfbam::CFBamDelTopDepBuff::NAME_INIT_VALUE );
		requiredTableTenantId = cfbam::CFBamDelTopDepBuff::TABLETENANTID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamDelTopDepBuff::clone() {
		CFBamDelTopDepBuff* copy = new CFBamDelTopDepBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamDelTopDepBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamDelTopDepBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamDelTopDepBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const std::string& CFBamDelTopDepBuff::getRequiredName() const {
		return( *requiredName );
	}

	const std::string* CFBamDelTopDepBuff::getRequiredNameReference() const {
		return( requiredName );
	}

	void CFBamDelTopDepBuff::setRequiredName( const std::string& value ) {
	...
	const int64_t CFBamDelTopDepBuff::getRequiredTableTenantId() const {
		return( requiredTableTenantId );
	}

	const int64_t* CFBamDelTopDepBuff::getRequiredTableTenantIdReference() const {
		return( &requiredTableTenantId );
	}

	void CFBamDelTopDepBuff::setRequiredTableTenantId( const int64_t value ) {
	...
	const int64_t CFBamDelTopDepBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamDelTopDepBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamDelTopDepBuff::setRequiredTableId( const int64_t value ) {
	...
	const bool CFBamDelTopDepBuff::isOptionalPrevTenantIdNull() const {
		return( optionalPrevTenantId.isNull() );
	}

	const int64_t CFBamDelTopDepBuff::getOptionalPrevTenantIdValue() const {
		return( optionalPrevTenantId.getValue() );
	}

	const int64_t* CFBamDelTopDepBuff::getOptionalPrevTenantIdReference() const {
		return( optionalPrevTenantId.getReference() );
	}

	void CFBamDelTopDepBuff::setOptionalPrevTenantIdNull() {
		optionalPrevTenantId.setNull();
	}

	void CFBamDelTopDepBuff::setOptionalPrevTenantIdValue( const int64_t value ) {
	...
	const bool CFBamDelTopDepBuff::isOptionalPrevIdNull() const {
		return( optionalPrevId.isNull() );
	}

	const int64_t CFBamDelTopDepBuff::getOptionalPrevIdValue() const {
		return( optionalPrevId.getValue() );
	}

	const int64_t* CFBamDelTopDepBuff::getOptionalPrevIdReference() const {
		return( optionalPrevId.getReference() );
	}

	void CFBamDelTopDepBuff::setOptionalPrevIdNull() {
		optionalPrevId.setNull();
	}

	void CFBamDelTopDepBuff::setOptionalPrevIdValue( const int64_t value ) {
	...
	const bool CFBamDelTopDepBuff::isOptionalNextTenantIdNull() const {
		return( optionalNextTenantId.isNull() );
	}

	const int64_t CFBamDelTopDepBuff::getOptionalNextTenantIdValue() const {
		return( optionalNextTenantId.getValue() );
	}

	const int64_t* CFBamDelTopDepBuff::getOptionalNextTenantIdReference() const {
		return( optionalNextTenantId.getReference() );
	}

	void CFBamDelTopDepBuff::setOptionalNextTenantIdNull() {
		optionalNextTenantId.setNull();
	}

	void CFBamDelTopDepBuff::setOptionalNextTenantIdValue( const int64_t value ) {
	...
	const bool CFBamDelTopDepBuff::isOptionalNextIdNull() const {
		return( optionalNextId.isNull() );
	}

	const int64_t CFBamDelTopDepBuff::getOptionalNextIdValue() const {
		return( optionalNextId.getValue() );
	}

	const int64_t* CFBamDelTopDepBuff::getOptionalNextIdReference() const {
		return( optionalNextId.getReference() );
	}

	void CFBamDelTopDepBuff::setOptionalNextIdNull() {
		optionalNextId.setNull();
	}

	void CFBamDelTopDepBuff::setOptionalNextIdValue( const int64_t value ) {
	...
	size_t CFBamDelTopDepBuff::hashCode() const {
	...
	CFBamDelTopDepBuff CFBamDelTopDepBuff::operator =( cfbam::CFBamDelTopDepBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamDelTopDepBuff CFBamDelTopDepBuff::operator =( cfbam::CFBamDelTopDepHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		if( src.isOptionalDefSchemaTenantIdNull() ) {
	...
	bool CFBamDelTopDepBuff::operator <( const CFBamDelTopDepByDelTopDepTblIdxKey& rhs ) {
	...
	bool CFBamDelTopDepBuff::operator <( const CFBamDelTopDepByUNameIdxKey& rhs ) {
		if( getRequiredTableTenantId() > rhs.getRequiredTableTenantId() ) {
			return( false );
		}
		else if( getRequiredTableTenantId() < rhs.getRequiredTableTenantId() ) {
	...
	bool CFBamDelTopDepBuff::operator <( const CFBamDelTopDepByPrevIdxKey& rhs ) {
		if( ! isOptionalPrevTenantIdNull() ) {
	...
	bool CFBamDelTopDepBuff::operator <( const CFBamDelTopDepByNextIdxKey& rhs ) {
		if( ! isOptionalNextTenantIdNull() ) {
	...
	bool CFBamDelTopDepBuff::operator <( const CFBamScopePKey& rhs ) {
	...
	bool CFBamDelTopDepBuff::operator <( const CFBamScopeHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamDelTopDepBuff::operator <( const CFBamDelTopDepHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamDelTopDepBuff::operator <( const CFBamDelTopDepBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamDelTopDepBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamDelTopDepBuff" );
