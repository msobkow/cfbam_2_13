// Description: C++18 implementation of a NumberType history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamNumberTypeHBuff::CLASS_NAME( "CFBamNumberTypeHBuff" );
	CFBamNumberTypeHBuff::CFBamNumberTypeHBuff()
	: cfbam::CFBamNumberDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamNumberTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamNumberTypeHBuff::CFBamNumberTypeHBuff( const CFBamNumberTypeHBuff& src )
	: cfbam::CFBamNumberDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamNumberTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamNumberTypeHBuff::clone() {
		CFBamNumberTypeHBuff* copy = new CFBamNumberTypeHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamNumberTypeHBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamNumberTypeHBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamNumberTypeHBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamNumberTypeHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamNumberTypeHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamNumberTypeHBuff CFBamNumberTypeHBuff::operator =( cfbam::CFBamNumberTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamNumberTypeHBuff CFBamNumberTypeHBuff::operator =( cfbam::CFBamNumberTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamNumberTypeHBuff::operator <( const CFBamNumberTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamNumberTypeHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNumberTypeHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamNumberTypeHBuff::operator <( const CFBamNumberTypeHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamNumberTypeHBuff::operator <( const CFBamNumberTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamNumberTypeHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNumberTypeHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamNumberTypeHBuff& lhs, const cfbam::CFBamNumberTypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamNumberTypeHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamNumberTypeHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamNumberTypeHBuff& lhs, const cfbam::CFBamNumberTypeHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamNumberTypeHBuff& lhs, const cfbam::CFBamNumberTypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
