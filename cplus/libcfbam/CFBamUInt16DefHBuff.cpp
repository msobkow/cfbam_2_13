// Description: C++18 implementation of a UInt16Def history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUInt16DefHBuff::CLASS_NAME( "CFBamUInt16DefHBuff" );
	CFBamUInt16DefHBuff::CFBamUInt16DefHBuff()
	...
	CFBamUInt16DefHBuff::CFBamUInt16DefHBuff( const CFBamUInt16DefHBuff& src )
	: cfbam::CFBamAtomHBuff() {
		optionalInitValue.setNull();
		optionalMinValue.setNull();
		optionalMaxValue.setNull();
	...
	cflib::ICFLibCloneableObj* CFBamUInt16DefHBuff::clone() {
		CFBamUInt16DefHBuff* copy = new CFBamUInt16DefHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const uint16_t CFBamUInt16DefHBuff::getOptionalInitValueValue() const {
		return( optionalInitValue.getValue() );
	}

	const uint16_t* CFBamUInt16DefHBuff::getOptionalInitValueReference() const {
		return( optionalInitValue.getReference() );
	}

	const bool CFBamUInt16DefHBuff::isOptionalInitValueNull() const {
		return( optionalInitValue.isNull() );
	}

	void CFBamUInt16DefHBuff::setOptionalInitValueNull() {
		optionalInitValue.setNull();
	}

	void CFBamUInt16DefHBuff::setOptionalInitValueValue( const uint16_t value ) {
	...
	const uint16_t CFBamUInt16DefHBuff::getOptionalMinValueValue() const {
		return( optionalMinValue.getValue() );
	}

	const uint16_t* CFBamUInt16DefHBuff::getOptionalMinValueReference() const {
		return( optionalMinValue.getReference() );
	}

	const bool CFBamUInt16DefHBuff::isOptionalMinValueNull() const {
		return( optionalMinValue.isNull() );
	}

	void CFBamUInt16DefHBuff::setOptionalMinValueNull() {
		optionalMinValue.setNull();
	}

	void CFBamUInt16DefHBuff::setOptionalMinValueValue( const uint16_t value ) {
	...
	const uint16_t CFBamUInt16DefHBuff::getOptionalMaxValueValue() const {
		return( optionalMaxValue.getValue() );
	}

	const uint16_t* CFBamUInt16DefHBuff::getOptionalMaxValueReference() const {
		return( optionalMaxValue.getReference() );
	}

	const bool CFBamUInt16DefHBuff::isOptionalMaxValueNull() const {
		return( optionalMaxValue.isNull() );
	}

	void CFBamUInt16DefHBuff::setOptionalMaxValueNull() {
		optionalMaxValue.setNull();
	}

	void CFBamUInt16DefHBuff::setOptionalMaxValueValue( const uint16_t value ) {
	...
	size_t CFBamUInt16DefHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamUInt16DefHBuff::hashCode();
	...
	CFBamUInt16DefHBuff CFBamUInt16DefHBuff::operator =( cfbam::CFBamUInt16DefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamUInt16DefHBuff CFBamUInt16DefHBuff::operator =( cfbam::CFBamUInt16DefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUInt16DefHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamUInt16DefHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamUInt16DefHBuff::operator <( const CFBamUInt16DefHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamUInt16DefHBuff::operator <( const CFBamUInt16DefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUInt16DefHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt16DefHBuff" );
