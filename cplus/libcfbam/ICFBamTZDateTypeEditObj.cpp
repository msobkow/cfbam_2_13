// Description: C++18 Instance Edit Object interface implementation for CFBam TZDateType.
...
namespace cfbam {
	...
	const std::string ICFBamTZDateTypeEditObj::CLASS_NAME( "ICFBamTZDateTypeEditObj" );

	ICFBamTZDateTypeEditObj::ICFBamTZDateTypeEditObj()
