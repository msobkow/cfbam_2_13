// Description: C++18 base object instance implementation for CFBam TZTimestampCol.
...
namespace cfbam {
	...
	const std::string CFBamTZTimestampColObj::CLASS_NAME( "CFBamTZTimestampColObj" );
	const classcode_t CFBamTZTimestampColObj::CLASS_CODE = 0xa865L;

	const int64_t CFBamTZTimestampColObj::getRequiredTableId() {
		return( getTZTimestampColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamTZTimestampColObj::getRequiredTableIdReference() {
		return( getTZTimestampColBuff()->getRequiredTableIdReference() );
	}


	cfbam::ICFBamTableObj* CFBamTZTimestampColObj::getRequiredContainerTable( bool forceRead ) {
	...
	CFBamTZTimestampColObj::CFBamTZTimestampColObj()
	: ICFBamTZTimestampColObj(),
	  CFBamTZTimestampDefObj()
	{
	}

	CFBamTZTimestampColObj::CFBamTZTimestampColObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamTZTimestampColObj(),
	  CFBamTZTimestampDefObj( argSchema )
	{
	}
	...
	cfbam::CFBamValueBuff* CFBamTZTimestampColObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamTZTimestampColBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableTZTimestampCol()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamTZTimestampColObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamTZTimestampColObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTZTimestampColObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTZTimestampColObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamTZTimestampColBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamTZTimestampDefObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamTZTimestampColObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZTimestampColObj" );
		...
		if( ! CFBamTZTimestampDefObj::isOptionalDummyNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredXmlString( &S_Space, S_Dummy, CFBamTZTimestampDefObj::getOptionalDummyValue() ) );
		}
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamTZTimestampColObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamTZTimestampColObj::getObjName() {
	...
	const std::string CFBamTZTimestampColObj::getGenDefName() {
		return( cfbam::CFBamTZTimestampColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTZTimestampColObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTZTimestampColObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTZTimestampColObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTZTimestampColObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTZTimestampColObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTZTimestampColObj::getObjQualifiedName() {
	...
	std::string CFBamTZTimestampColObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTZTimestampColObj::realize() {
		cfbam::ICFBamTZTimestampColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimestampColTableObj()->realizeTZTimestampCol(
			(cfbam::ICFBamTZTimestampColObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTZTimestampColObj::read( bool forceRead ) {
		cfbam::ICFBamTZTimestampColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimestampColTableObj()->readTZTimestampColByIdIdx( getTZTimestampColBuff()->getRequiredTenantId(),
		getTZTimestampColBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTZTimestampColObj::moveUp() {
		cfbam::ICFBamTZTimestampColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimestampColTableObj()->moveUpTZTimestampCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTZTimestampColObj::moveDown() {
		cfbam::ICFBamTZTimestampColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimestampColTableObj()->moveDownTZTimestampCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamTZTimestampColObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamTZTimestampColObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimestampColTableObj()->lockTZTimestampCol( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimestampColTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamTZTimestampColEditObj* CFBamTZTimestampColObj::getTZTimestampColEdit() {
		return( dynamic_cast<cfbam::ICFBamTZTimestampColEditObj*>( edit ) );
	}
