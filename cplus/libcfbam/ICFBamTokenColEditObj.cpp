// Description: C++18 Instance Edit Object interface implementation for CFBam TokenCol.
...
namespace cfbam {
	...
	const std::string ICFBamTokenColEditObj::CLASS_NAME( "ICFBamTokenColEditObj" );

	ICFBamTokenColEditObj::ICFBamTokenColEditObj()
