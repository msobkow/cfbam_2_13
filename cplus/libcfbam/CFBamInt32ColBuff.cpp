// Description: C++18 implementation for a Int32Col buffer object.
...
namespace cfbam {
	...
	const std::string CFBamInt32ColBuff::GENDEFNAME( "Int32Col" );
	const classcode_t CFBamInt32ColBuff::CLASS_CODE = 0xa85dL;
	const std::string CFBamInt32ColBuff::CLASS_NAME( "CFBamInt32ColBuff" );
		const std::string CFBamInt32ColBuff::COLNAME_TABLEID( "TableId" );
	const int64_t CFBamInt32ColBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamInt32ColBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamInt32ColBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamInt32ColBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamInt32ColBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamInt32ColBuff::TABLEID_MIN_VALUE = 0LL;

	CFBamInt32ColBuff::CFBamInt32ColBuff()
	: CFBamInt32DefBuff()
	{
		requiredTableId = cfbam::CFBamInt32ColBuff::TABLEID_INIT_VALUE;
	}

	CFBamInt32ColBuff::CFBamInt32ColBuff( const CFBamInt32ColBuff& src )
	: CFBamInt32DefBuff()
	{
		requiredTableId = cfbam::CFBamInt32ColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamInt32ColBuff::clone() {
		CFBamInt32ColBuff* copy = new CFBamInt32ColBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamInt32ColBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamInt32ColBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamInt32ColBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFBamInt32ColBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamInt32ColBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamInt32ColBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamInt32ColBuff::hashCode() const {
		size_t hashCode = CFBamInt32DefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamInt32ColBuff CFBamInt32ColBuff::operator =( cfbam::CFBamInt32ColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamInt32ColBuff CFBamInt32ColBuff::operator =( cfbam::CFBamInt32ColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamInt32ColBuff::operator <( const CFBamInt32ColByTableIdxKey& rhs ) {
	...
	bool CFBamInt32ColBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt32ColBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt32ColBuff::operator <( const CFBamInt32ColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt32ColBuff::operator <( const CFBamInt32ColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamInt32ColBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt32ColBuff" );
