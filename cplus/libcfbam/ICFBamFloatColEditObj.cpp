// Description: C++18 Instance Edit Object interface implementation for CFBam FloatCol.
...
namespace cfbam {
	...
	const std::string ICFBamFloatColEditObj::CLASS_NAME( "ICFBamFloatColEditObj" );

	ICFBamFloatColEditObj::ICFBamFloatColEditObj()
