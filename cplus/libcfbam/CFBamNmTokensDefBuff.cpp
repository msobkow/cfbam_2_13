// Description: C++18 implementation for a NmTokensDef buffer object.
...
namespace cfbam {
	...
	const std::string CFBamNmTokensDefBuff::GENDEFNAME( "NmTokensDef" );
	const classcode_t CFBamNmTokensDefBuff::CLASS_CODE = 0xa82bL;
	const std::string CFBamNmTokensDefBuff::CLASS_NAME( "CFBamNmTokensDefBuff" );
		const std::string CFBamNmTokensDefBuff::COLNAME_MAXLEN( "MaxLen" );
		const std::string CFBamNmTokensDefBuff::COLNAME_INITVALUE( "InitValue" );
	const int64_t CFBamNmTokensDefBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamNmTokensDefBuff::ID_INIT_VALUE = 0LL;
	const int CFBamNmTokensDefBuff::MAXLEN_INIT_VALUE = 0L;
	const int64_t CFBamNmTokensDefBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamNmTokensDefBuff::ID_MIN_VALUE = 0LL;
	const int CFBamNmTokensDefBuff::MAXLEN_MIN_VALUE = 0L;
	const int CFBamNmTokensDefBuff::MAXLEN_MAX_VALUE = 2147483647L;
	const std::string::size_type CFBamNmTokensDefBuff::INITVALUE_MAX_LEN = 256;

	CFBamNmTokensDefBuff::CFBamNmTokensDefBuff()
	: CFBamAtomBuff()
	{
		requiredMaxLen = cfbam::CFBamNmTokensDefBuff::MAXLEN_INIT_VALUE;
		optionalInitValue = NULL;
	}

	CFBamNmTokensDefBuff::CFBamNmTokensDefBuff( const CFBamNmTokensDefBuff& src )
	: CFBamAtomBuff()
	{
		requiredMaxLen = cfbam::CFBamNmTokensDefBuff::MAXLEN_INIT_VALUE;
		optionalInitValue = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamNmTokensDefBuff::clone() {
		CFBamNmTokensDefBuff* copy = new CFBamNmTokensDefBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamNmTokensDefBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamNmTokensDefBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamNmTokensDefBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int32_t CFBamNmTokensDefBuff::getRequiredMaxLen() const {
		return( requiredMaxLen );
	}

	const int32_t* CFBamNmTokensDefBuff::getRequiredMaxLenReference() const {
		return( &requiredMaxLen );
	}

	void CFBamNmTokensDefBuff::setRequiredMaxLen( const int32_t value ) {
		static const std::string S_ProcName( "setRequiredMaxLen" );
		if( value < cfbam::CFBamNmTokensDefBuff::MAXLEN_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamNmTokensDefBuff::MAXLEN_MIN_VALUE );
		}
		if( value > cfbam::CFBamNmTokensDefBuff::MAXLEN_MAX_VALUE ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamNmTokensDefBuff::MAXLEN_MAX_VALUE );
		}
		requiredMaxLen = value;
	}

	const bool CFBamNmTokensDefBuff::isOptionalInitValueNull() const {
		return( optionalInitValue == NULL );
	}

	const std::string& CFBamNmTokensDefBuff::getOptionalInitValueValue() const {
	...
	const std::string* CFBamNmTokensDefBuff::getOptionalInitValueReference() const {
		return( optionalInitValue );
	}

	void CFBamNmTokensDefBuff::setOptionalInitValueNull() {
		if( optionalInitValue != NULL ) {
			delete optionalInitValue;
			optionalInitValue = NULL;
		}
	...
	void CFBamNmTokensDefBuff::setOptionalInitValueValue( const std::string& value ) {
		static const std::string S_ProcName( "setOptionalInitValueValue" );
		if( value.length() > CFBamNmTokensDefBuff::INITVALUE_MAX_LEN ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE_LENGTH,
				value.length(),
				CFBamNmTokensDefBuff::INITVALUE_MAX_LEN );
		}
		if( optionalInitValue != NULL ) {
			delete optionalInitValue;
			optionalInitValue = NULL;
	...
	size_t CFBamNmTokensDefBuff::hashCode() const {
	...
	CFBamNmTokensDefBuff CFBamNmTokensDefBuff::operator =( cfbam::CFBamNmTokensDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamNmTokensDefBuff CFBamNmTokensDefBuff::operator =( cfbam::CFBamNmTokensDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamNmTokensDefBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamNmTokensDefBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNmTokensDefBuff::operator <( const CFBamNmTokensDefHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNmTokensDefBuff::operator <( const CFBamNmTokensDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamNmTokensDefBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNmTokensDefBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamNmTokensDefBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamNmTokensDefBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamNmTokensDefBuff& lhs, const cfbam::CFBamNmTokensDefHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamNmTokensDefBuff& lhs, const cfbam::CFBamNmTokensDefBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
