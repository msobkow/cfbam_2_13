// Description: C++18 implementation for a TZTimeType buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTZTimeTypeBuff::GENDEFNAME( "TZTimeType" );
	const classcode_t CFBamTZTimeTypeBuff::CLASS_CODE = 0xa83dL;
	const std::string CFBamTZTimeTypeBuff::CLASS_NAME( "CFBamTZTimeTypeBuff" );
		const std::string CFBamTZTimeTypeBuff::COLNAME_SCHEMADEFID( "SchemaDefId" );
	const int64_t CFBamTZTimeTypeBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamTZTimeTypeBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamTZTimeTypeBuff::SCHEMADEFID_INIT_VALUE = 0LL;
	const int64_t CFBamTZTimeTypeBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamTZTimeTypeBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamTZTimeTypeBuff::SCHEMADEFID_MIN_VALUE = 0LL;

	CFBamTZTimeTypeBuff::CFBamTZTimeTypeBuff()
	: CFBamTZTimeDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamTZTimeTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamTZTimeTypeBuff::CFBamTZTimeTypeBuff( const CFBamTZTimeTypeBuff& src )
	: CFBamTZTimeDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamTZTimeTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTZTimeTypeBuff::clone() {
		CFBamTZTimeTypeBuff* copy = new CFBamTZTimeTypeBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTZTimeTypeBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTZTimeTypeBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTZTimeTypeBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamTZTimeDefBuff::implementsClassCode( argClassCode ) );
		}
	}

	const int64_t CFBamTZTimeTypeBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamTZTimeTypeBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamTZTimeTypeBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamTZTimeTypeBuff::hashCode() const {
		size_t hashCode = CFBamTZTimeDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamTZTimeTypeBuff CFBamTZTimeTypeBuff::operator =( cfbam::CFBamTZTimeTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamTZTimeTypeBuff CFBamTZTimeTypeBuff::operator =( cfbam::CFBamTZTimeTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTZTimeTypeBuff::operator <( const CFBamTZTimeTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamTZTimeTypeBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZTimeTypeBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZTimeTypeBuff::operator <( const CFBamTZTimeTypeHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZTimeTypeBuff::operator <( const CFBamTZTimeTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTZTimeTypeBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZTimeTypeBuff" );
