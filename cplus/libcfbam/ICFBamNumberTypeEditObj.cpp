// Description: C++18 Instance Edit Object interface implementation for CFBam NumberType.
...
namespace cfbam {
	...
	const std::string ICFBamNumberTypeEditObj::CLASS_NAME( "ICFBamNumberTypeEditObj" );

	ICFBamNumberTypeEditObj::ICFBamNumberTypeEditObj()
