// Description: C++18 implementation of a BlobCol history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamBlobColHBuff::CLASS_NAME( "CFBamBlobColHBuff" );
	CFBamBlobColHBuff::CFBamBlobColHBuff()
	: cfbam::CFBamBlobDefHBuff() {
		requiredTableId = cfbam::CFBamBlobColBuff::TABLEID_INIT_VALUE;
	}

	CFBamBlobColHBuff::CFBamBlobColHBuff( const CFBamBlobColHBuff& src )
	: cfbam::CFBamBlobDefHBuff() {
		requiredTableId = cfbam::CFBamBlobColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamBlobColHBuff::clone() {
		CFBamBlobColHBuff* copy = new CFBamBlobColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamBlobColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamBlobColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamBlobColHBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamBlobColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamBlobColHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamBlobColHBuff CFBamBlobColHBuff::operator =( cfbam::CFBamBlobColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamBlobColHBuff CFBamBlobColHBuff::operator =( cfbam::CFBamBlobColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamBlobColHBuff::operator <( const CFBamBlobColByTableIdxKey& rhs ) {
	...
	bool CFBamBlobColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamBlobColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamBlobColHBuff::operator <( const CFBamBlobColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamBlobColHBuff::operator <( const CFBamBlobColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamBlobColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamBlobColHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamBlobColHBuff& lhs, const cfbam::CFBamBlobColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamBlobColHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamBlobColHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamBlobColHBuff& lhs, const cfbam::CFBamBlobColHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamBlobColHBuff& lhs, const cfbam::CFBamBlobColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
