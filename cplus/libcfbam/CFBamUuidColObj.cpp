// Description: C++18 base object instance implementation for CFBam UuidCol.
...
namespace cfbam {
	...
	const std::string CFBamUuidColObj::CLASS_NAME( "CFBamUuidColObj" );
	const classcode_t CFBamUuidColObj::CLASS_CODE = 0xa86dL;

	const int64_t CFBamUuidColObj::getRequiredTableId() {
		return( getUuidColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamUuidColObj::getRequiredTableIdReference() {
		return( getUuidColBuff()->getRequiredTableIdReference() );
	}


	cfbam::ICFBamTableObj* CFBamUuidColObj::getRequiredContainerTable( bool forceRead ) {
	...
	CFBamUuidColObj::CFBamUuidColObj()
	: ICFBamUuidColObj(),
	  CFBamUuidDefObj()
	{
	}

	CFBamUuidColObj::CFBamUuidColObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamUuidColObj(),
	...
	cfbam::CFBamValueBuff* CFBamUuidColObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamUuidColBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableUuidCol()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamUuidColObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamUuidColObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUuidColObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamUuidColObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamUuidColObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUuidColObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamUuidColObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamUuidColObj::getObjName() {
	...
	const std::string CFBamUuidColObj::getGenDefName() {
		return( cfbam::CFBamUuidColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamUuidColObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamUuidColObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamUuidColObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamUuidColObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamUuidColObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamUuidColObj::getObjQualifiedName() {
	...
	std::string CFBamUuidColObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamUuidColObj::realize() {
		cfbam::ICFBamUuidColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUuidColTableObj()->realizeUuidCol(
			(cfbam::ICFBamUuidColObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUuidColObj::read( bool forceRead ) {
		cfbam::ICFBamUuidColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUuidColTableObj()->readUuidColByIdIdx( getUuidColBuff()->getRequiredTenantId(),
		getUuidColBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUuidColObj::moveUp() {
		cfbam::ICFBamUuidColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUuidColTableObj()->moveUpUuidCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUuidColObj::moveDown() {
		cfbam::ICFBamUuidColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUuidColTableObj()->moveDownUuidCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamUuidColObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamUuidColObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUuidColTableObj()->lockUuidCol( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUuidColTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamUuidColEditObj* CFBamUuidColObj::getUuidColEdit() {
		return( dynamic_cast<cfbam::ICFBamUuidColEditObj*>( edit ) );
	}
