// Description: C++18 base object instance implementation for CFBam UuidDef.
...
namespace cfbam {
	...
	const std::string CFBamUuidDefObj::CLASS_NAME( "CFBamUuidDefObj" );
	const classcode_t CFBamUuidDefObj::CLASS_CODE = 0xa850L;

	bool CFBamUuidDefObj::isOptionalInitValueNull() {
		return( getUuidDefBuff()->isOptionalInitValueNull() );
	}

	const uuid_ptr_t CFBamUuidDefObj::getOptionalInitValueValue() {
		return( getUuidDefBuff()->getOptionalInitValueValue() );
	}

	const uuid_ptr_t CFBamUuidDefObj::getOptionalInitValueReference() {
		return( getUuidDefBuff()->getOptionalInitValueReference() );
	}


	CFBamUuidDefObj::CFBamUuidDefObj()
	: ICFBamUuidDefObj(),
	  CFBamAtomObj()
	{
	}

	CFBamUuidDefObj::CFBamUuidDefObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamUuidDefObj(),
	...
	cfbam::CFBamValueBuff* CFBamUuidDefObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamUuidDefBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableUuidDef()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamUuidDefObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamUuidDefObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUuidDefObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamUuidDefObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamUuidDefObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUuidDefObj" );
	...
	std::string CFBamUuidDefObj::getObjName() {
	...
	const std::string CFBamUuidDefObj::getGenDefName() {
		return( cfbam::CFBamUuidDefBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamUuidDefObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamUuidDefObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamUuidDefObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamUuidDefObj::getObjQualifiedName() {
	...
	std::string CFBamUuidDefObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamUuidDefObj::realize() {
		cfbam::ICFBamUuidDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUuidDefTableObj()->realizeUuidDef(
			(cfbam::ICFBamUuidDefObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUuidDefObj::read( bool forceRead ) {
		cfbam::ICFBamUuidDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUuidDefTableObj()->readUuidDefByIdIdx( getUuidDefBuff()->getRequiredTenantId(),
		getUuidDefBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUuidDefObj::moveUp() {
		cfbam::ICFBamUuidDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUuidDefTableObj()->moveUpUuidDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUuidDefObj::moveDown() {
		cfbam::ICFBamUuidDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUuidDefTableObj()->moveDownUuidDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamUuidDefObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamUuidDefObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUuidDefTableObj()->lockUuidDef( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUuidDefTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamUuidDefEditObj* CFBamUuidDefObj::getUuidDefEdit() {
		return( dynamic_cast<cfbam::ICFBamUuidDefEditObj*>( edit ) );
	}
