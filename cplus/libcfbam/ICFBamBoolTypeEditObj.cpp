// Description: C++18 Instance Edit Object interface implementation for CFBam BoolType.
...
namespace cfbam {
	...
	const std::string ICFBamBoolTypeEditObj::CLASS_NAME( "ICFBamBoolTypeEditObj" );

	ICFBamBoolTypeEditObj::ICFBamBoolTypeEditObj()
