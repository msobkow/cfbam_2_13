// Description: C++18 base object instance implementation for CFBam TZTimeType.
...
namespace cfbam {
	...
	const std::string CFBamTZTimeTypeObj::CLASS_NAME( "CFBamTZTimeTypeObj" );
	const classcode_t CFBamTZTimeTypeObj::CLASS_CODE = 0xa83dL;

	const int64_t CFBamTZTimeTypeObj::getRequiredSchemaDefId() {
		return( getTZTimeTypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamTZTimeTypeObj::getRequiredSchemaDefIdReference() {
		return( getTZTimeTypeBuff()->getRequiredSchemaDefIdReference() );
	}


	cfbam::ICFBamSchemaDefObj* CFBamTZTimeTypeObj::getRequiredContainerSchemaDef( bool forceRead ) {
	...
	CFBamTZTimeTypeObj::CFBamTZTimeTypeObj()
	: ICFBamTZTimeTypeObj(),
	  CFBamTZTimeDefObj()
	{
	}

	CFBamTZTimeTypeObj::CFBamTZTimeTypeObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamTZTimeTypeObj(),
	...
	cfbam::CFBamValueBuff* CFBamTZTimeTypeObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamTZTimeTypeBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableTZTimeType()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamTZTimeTypeObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamTZTimeTypeObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTZTimeTypeObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTZTimeTypeObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamTZTimeTypeObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZTimeTypeObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamTZTimeTypeObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamTZTimeTypeObj::getObjName() {
	...
	const std::string CFBamTZTimeTypeObj::getGenDefName() {
		return( cfbam::CFBamTZTimeTypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTZTimeTypeObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTZTimeTypeObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTZTimeTypeObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTZTimeTypeObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTZTimeTypeObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTZTimeTypeObj::getObjQualifiedName() {
	...
	std::string CFBamTZTimeTypeObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTZTimeTypeObj::realize() {
		cfbam::ICFBamTZTimeTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimeTypeTableObj()->realizeTZTimeType(
			(cfbam::ICFBamTZTimeTypeObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTZTimeTypeObj::read( bool forceRead ) {
		cfbam::ICFBamTZTimeTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimeTypeTableObj()->readTZTimeTypeByIdIdx( getTZTimeTypeBuff()->getRequiredTenantId(),
		getTZTimeTypeBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTZTimeTypeObj::moveUp() {
		cfbam::ICFBamTZTimeTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimeTypeTableObj()->moveUpTZTimeType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTZTimeTypeObj::moveDown() {
		cfbam::ICFBamTZTimeTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimeTypeTableObj()->moveDownTZTimeType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamTZTimeTypeObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamTZTimeTypeObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimeTypeTableObj()->lockTZTimeType( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimeTypeTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamTZTimeTypeEditObj* CFBamTZTimeTypeObj::getTZTimeTypeEdit() {
		return( dynamic_cast<cfbam::ICFBamTZTimeTypeEditObj*>( edit ) );
	}
