// Description: C++18 edit object instance implementation for CFBam UuidType.
...
namespace cfbam {
	...
	const std::string CFBamUuidTypeEditObj::CLASS_NAME( "CFBamUuidTypeEditObj" );

	CFBamUuidTypeEditObj::CFBamUuidTypeEditObj( cfbam::ICFBamUuidTypeObj* argOrig )
	: ICFBamUuidTypeEditObj(),
	  CFBamUuidDefEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamUuidTypeEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamUuidTypeEditObj::~CFBamUuidTypeEditObj() {
	}

	const std::string& CFBamUuidTypeEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUuidTypeEditObj::getClassCode() const {
		return( cfbam::CFBamUuidTypeBuff::CLASS_CODE );
	}

	bool CFBamUuidTypeEditObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamUuidTypeBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamUuidDefEditObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamUuidTypeEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUuidTypeEditObj" );
		...
		if( ! CFBamUuidDefEditObj::isOptionalInitValueNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredUuid( &S_Space, S_InitValue, CFBamUuidDefEditObj::getOptionalInitValueValue() ) );
		}
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamUuidTypeEditObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	const std::string CFBamUuidTypeEditObj::getGenDefName() {
		return( cfbam::CFBamUuidTypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamUuidTypeEditObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamUuidTypeEditObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamUuidTypeEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamUuidTypeEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamUuidTypeEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamUuidTypeEditObj::getObjQualifiedName() {
	...
	std::string CFBamUuidTypeEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamUuidTypeEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamUuidTypeObj* retobj = getSchema()->getUuidTypeTableObj()->realizeUuidType( dynamic_cast<cfbam::ICFBamUuidTypeObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamUuidTypeEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamUuidTypeEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamUuidTypeEditObj::create() {
		cfbam::ICFBamUuidTypeObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsUuidType()->getSchema() )->getUuidTypeTableObj()->createUuidType( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamUuidTypeEditObj::update() {
		getSchema()->getUuidTypeTableObj()->updateUuidType( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamUuidTypeEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getUuidTypeTableObj()->deleteUuidType( this );
		return( NULL );
	}

	cfbam::ICFBamUuidTypeTableObj* CFBamUuidTypeEditObj::getUuidTypeTable() {
		return( orig->getSchema()->getUuidTypeTableObj() );
	}

	cfbam::ICFBamUuidTypeEditObj* CFBamUuidTypeEditObj::getUuidTypeEdit() {
		return( (cfbam::ICFBamUuidTypeEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamUuidTypeEditObj::beginEdit() {
	...
	cfbam::ICFBamUuidTypeObj* CFBamUuidTypeEditObj::getOrigAsUuidType() {
		return( dynamic_cast<cfbam::ICFBamUuidTypeObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamUuidTypeEditObj::getBuff() {
		return( buff );
	}

	void CFBamUuidTypeEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamUuidDefEditObj::setBuff( value );
		}
	}

	const int64_t CFBamUuidTypeEditObj::getRequiredSchemaDefId() {
		return( getUuidTypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamUuidTypeEditObj::getRequiredSchemaDefIdReference() {
		return( getUuidTypeBuff()->getRequiredSchemaDefIdReference() );
	}

	void CFBamUuidTypeEditObj::setRequiredContainerScope( cfbam::ICFBamScopeObj* value ) {
		if( value == NULL ) {
	...
	cfbam::ICFBamSchemaDefObj* CFBamUuidTypeEditObj::getRequiredContainerSchemaDef( bool forceRead ) {
		cfbam::ICFBamSchemaDefObj* retobj = NULL;
		bool anyMissing = false;
		if( ! anyMissing ) {
			retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsUuidType()->getSchema() )->getSchemaDefTableObj()->readSchemaDefByIdIdx( getPKey()->getRequiredTenantId(),
					getUuidTypeBuff()->getRequiredSchemaDefId() );
		}
		return( retobj );
	}

	void CFBamUuidTypeEditObj::setRequiredContainerSchemaDef( cfbam::ICFBamSchemaDefObj* value ) {
			
			if( value != NULL ) {
				getPKey()->setRequiredTenantId
( value->getRequiredTenantId() );
				getUuidTypeEditBuff()->setRequiredTenantId( value->getRequiredTenantId() );
				getUuidTypeEditBuff()->setRequiredSchemaDefId( value->getRequiredId() );
			}

			CFBamUuidDefEditObj::setRequiredContainerScope( value );		}

	void CFBamUuidTypeEditObj::copyBuffToOrig() {
		cfbam::CFBamUuidTypeBuff* origBuff = getOrigAsUuidType()->getUuidTypeEditBuff();
		cfbam::CFBamUuidTypeBuff* myBuff = getUuidTypeBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamUuidTypeEditObj::copyOrigToBuff() {
		cfbam::CFBamUuidTypeBuff* origBuff = getOrigAsUuidType()->getUuidTypeBuff();
		cfbam::CFBamUuidTypeBuff* myBuff = getUuidTypeEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
