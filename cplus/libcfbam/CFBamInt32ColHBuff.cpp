// Description: C++18 implementation of a Int32Col history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamInt32ColHBuff::CLASS_NAME( "CFBamInt32ColHBuff" );
	CFBamInt32ColHBuff::CFBamInt32ColHBuff()
	: cfbam::CFBamInt32DefHBuff() {
		requiredTableId = cfbam::CFBamInt32ColBuff::TABLEID_INIT_VALUE;
	}

	CFBamInt32ColHBuff::CFBamInt32ColHBuff( const CFBamInt32ColHBuff& src )
	: cfbam::CFBamInt32DefHBuff() {
		requiredTableId = cfbam::CFBamInt32ColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamInt32ColHBuff::clone() {
		CFBamInt32ColHBuff* copy = new CFBamInt32ColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamInt32ColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamInt32ColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamInt32ColHBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamInt32ColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamInt32ColHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamInt32ColHBuff CFBamInt32ColHBuff::operator =( cfbam::CFBamInt32ColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamInt32ColHBuff CFBamInt32ColHBuff::operator =( cfbam::CFBamInt32ColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamInt32ColHBuff::operator <( const CFBamInt32ColByTableIdxKey& rhs ) {
	...
	bool CFBamInt32ColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt32ColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamInt32ColHBuff::operator <( const CFBamInt32ColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamInt32ColHBuff::operator <( const CFBamInt32ColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamInt32ColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt32ColHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamInt32ColHBuff& lhs, const cfbam::CFBamInt32ColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamInt32ColHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamInt32ColHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamInt32ColHBuff& lhs, const cfbam::CFBamInt32ColHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamInt32ColHBuff& lhs, const cfbam::CFBamInt32ColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
