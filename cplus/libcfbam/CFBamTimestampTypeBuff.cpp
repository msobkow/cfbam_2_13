// Description: C++18 implementation for a TimestampType buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTimestampTypeBuff::GENDEFNAME( "TimestampType" );
	const classcode_t CFBamTimestampTypeBuff::CLASS_CODE = 0xa847L;
	const std::string CFBamTimestampTypeBuff::CLASS_NAME( "CFBamTimestampTypeBuff" );
		const std::string CFBamTimestampTypeBuff::COLNAME_SCHEMADEFID( "SchemaDefId" );
	const int64_t CFBamTimestampTypeBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamTimestampTypeBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamTimestampTypeBuff::SCHEMADEFID_INIT_VALUE = 0LL;
	const int64_t CFBamTimestampTypeBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamTimestampTypeBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamTimestampTypeBuff::SCHEMADEFID_MIN_VALUE = 0LL;

	CFBamTimestampTypeBuff::CFBamTimestampTypeBuff()
	: CFBamTimestampDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamTimestampTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamTimestampTypeBuff::CFBamTimestampTypeBuff( const CFBamTimestampTypeBuff& src )
	: CFBamTimestampDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamTimestampTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTimestampTypeBuff::clone() {
		CFBamTimestampTypeBuff* copy = new CFBamTimestampTypeBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTimestampTypeBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTimestampTypeBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTimestampTypeBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamTimestampDefBuff::implementsClassCode( argClassCode ) );
		}
	}

	const int64_t CFBamTimestampTypeBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamTimestampTypeBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamTimestampTypeBuff::setRequiredSchemaDefId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredSchemaDefId" );
		if( value < cfbam::CFBamTimestampTypeBuff::SCHEMADEFID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamTimestampTypeBuff::SCHEMADEFID_MIN_VALUE );
		}
		requiredSchemaDefId = value;
	}

	size_t CFBamTimestampTypeBuff::hashCode() const {
		size_t hashCode = CFBamTimestampDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamTimestampTypeBuff CFBamTimestampTypeBuff::operator =( cfbam::CFBamTimestampTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamTimestampTypeBuff CFBamTimestampTypeBuff::operator =( cfbam::CFBamTimestampTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTimestampTypeBuff::operator <( const CFBamTimestampTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamTimestampTypeBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTimestampTypeBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTimestampTypeBuff::operator <( const CFBamTimestampTypeHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTimestampTypeBuff::operator <( const CFBamTimestampTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTimestampTypeBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTimestampTypeBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamTimestampTypeBuff& lhs, const cfbam::CFBamTimestampTypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTimestampTypeBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTimestampTypeBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTimestampTypeBuff& lhs, const cfbam::CFBamTimestampTypeHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTimestampTypeBuff& lhs, const cfbam::CFBamTimestampTypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
