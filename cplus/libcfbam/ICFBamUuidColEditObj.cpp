// Description: C++18 Instance Edit Object interface implementation for CFBam UuidCol.
...
namespace cfbam {
	...
	const std::string ICFBamUuidColEditObj::CLASS_NAME( "ICFBamUuidColEditObj" );

	ICFBamUuidColEditObj::ICFBamUuidColEditObj()
