// Description: C++18 implementation of a TZDateType history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTZDateTypeHBuff::CLASS_NAME( "CFBamTZDateTypeHBuff" );
	CFBamTZDateTypeHBuff::CFBamTZDateTypeHBuff()
	: cfbam::CFBamTZDateDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamTZDateTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamTZDateTypeHBuff::CFBamTZDateTypeHBuff( const CFBamTZDateTypeHBuff& src )
	: cfbam::CFBamTZDateDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamTZDateTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTZDateTypeHBuff::clone() {
		CFBamTZDateTypeHBuff* copy = new CFBamTZDateTypeHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamTZDateTypeHBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamTZDateTypeHBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamTZDateTypeHBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamTZDateTypeHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamTZDateTypeHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamTZDateTypeHBuff CFBamTZDateTypeHBuff::operator =( cfbam::CFBamTZDateTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamTZDateTypeHBuff CFBamTZDateTypeHBuff::operator =( cfbam::CFBamTZDateTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTZDateTypeHBuff::operator <( const CFBamTZDateTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamTZDateTypeHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZDateTypeHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamTZDateTypeHBuff::operator <( const CFBamTZDateTypeHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamTZDateTypeHBuff::operator <( const CFBamTZDateTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTZDateTypeHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZDateTypeHBuff" );
