// Description: C++18 Instance Edit Object interface implementation for CFBam DoubleType.
...
namespace cfbam {
	...
	const std::string ICFBamDoubleTypeEditObj::CLASS_NAME( "ICFBamDoubleTypeEditObj" );

	ICFBamDoubleTypeEditObj::ICFBamDoubleTypeEditObj()
