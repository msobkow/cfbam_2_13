// Description: C++18 implementation of a FloatType history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamFloatTypeHBuff::CLASS_NAME( "CFBamFloatTypeHBuff" );
	CFBamFloatTypeHBuff::CFBamFloatTypeHBuff()
	: cfbam::CFBamFloatDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamFloatTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamFloatTypeHBuff::CFBamFloatTypeHBuff( const CFBamFloatTypeHBuff& src )
	: cfbam::CFBamFloatDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamFloatTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamFloatTypeHBuff::clone() {
		CFBamFloatTypeHBuff* copy = new CFBamFloatTypeHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamFloatTypeHBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamFloatTypeHBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamFloatTypeHBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamFloatTypeHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamFloatTypeHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamFloatTypeHBuff CFBamFloatTypeHBuff::operator =( cfbam::CFBamFloatTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamFloatTypeHBuff CFBamFloatTypeHBuff::operator =( cfbam::CFBamFloatTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamFloatTypeHBuff::operator <( const CFBamFloatTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamFloatTypeHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamFloatTypeHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamFloatTypeHBuff::operator <( const CFBamFloatTypeHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamFloatTypeHBuff::operator <( const CFBamFloatTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamFloatTypeHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamFloatTypeHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamFloatTypeHBuff& lhs, const cfbam::CFBamFloatTypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamFloatTypeHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamFloatTypeHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamFloatTypeHBuff& lhs, const cfbam::CFBamFloatTypeHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamFloatTypeHBuff& lhs, const cfbam::CFBamFloatTypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
