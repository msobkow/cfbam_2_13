// Description: C++18 implementation for a Param by DefSchemaIdx index key object.
...
namespace cfbam {
	const std::string CFBamParamByDefSchemaIdxKey::CLASS_NAME( "CFBamParamByDefSchemaIdxKey" );
	const std::string CFBamParamByDefSchemaIdxKey::S_VALUE( "value" );
	const std::string CFBamParamByDefSchemaIdxKey::S_VALUE_LENGTH( "value.length()" );


	CFBamParamByDefSchemaIdxKey::CFBamParamByDefSchemaIdxKey() {
		optionalDefSchemaTenantId.setNull();
		optionalDefSchemaId.setNull();
	}

	CFBamParamByDefSchemaIdxKey::CFBamParamByDefSchemaIdxKey( const CFBamParamByDefSchemaIdxKey& src ) {
		optionalDefSchemaTenantId.setNull();
		optionalDefSchemaId.setNull();
	...
	const int64_t CFBamParamByDefSchemaIdxKey::getOptionalDefSchemaTenantIdValue() const {
		return( optionalDefSchemaTenantId.getValue() );
	}

	const int64_t* CFBamParamByDefSchemaIdxKey::getOptionalDefSchemaTenantIdReference() const {
		return( optionalDefSchemaTenantId.getReference() );
	}

	const bool CFBamParamByDefSchemaIdxKey::isOptionalDefSchemaTenantIdNull() const {
		return( optionalDefSchemaTenantId.isNull() );
	}

	void CFBamParamByDefSchemaIdxKey::setOptionalDefSchemaTenantIdNull() {
		optionalDefSchemaTenantId.setNull();
	}

	void CFBamParamByDefSchemaIdxKey::setOptionalDefSchemaTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamParamByDefSchemaIdxKey::getOptionalDefSchemaIdValue() const {
		return( optionalDefSchemaId.getValue() );
	}

	const int64_t* CFBamParamByDefSchemaIdxKey::getOptionalDefSchemaIdReference() const {
		return( optionalDefSchemaId.getReference() );
	}

	const bool CFBamParamByDefSchemaIdxKey::isOptionalDefSchemaIdNull() const {
		return( optionalDefSchemaId.isNull() );
	}

	void CFBamParamByDefSchemaIdxKey::setOptionalDefSchemaIdNull() {
		optionalDefSchemaId.setNull();
	}

	void CFBamParamByDefSchemaIdxKey::setOptionalDefSchemaIdValue( const int64_t value ) {
	...
	size_t CFBamParamByDefSchemaIdxKey::hashCode() const {
		size_t hashCode = 0;
	...
	std::string CFBamParamByDefSchemaIdxKey::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamParamByDefSchemaIdxKey" );
	...
	bool CFBamParamByDefSchemaIdxKey::operator <( const CFBamParamByDefSchemaIdxKey& rhs ) {
		if( ! isOptionalDefSchemaTenantIdNull() ) {
	...
	bool CFBamParamByDefSchemaIdxKey::operator <( const CFBamParamHBuff& rhs ) {
		if( ! isOptionalDefSchemaTenantIdNull() ) {
			if( rhs.isOptionalDefSchemaTenantIdNull() ) {
				return( false );
			}
	...
	bool CFBamParamByDefSchemaIdxKey::operator <( const CFBamParamBuff& rhs ) {
		if( ! isOptionalDefSchemaTenantIdNull() ) {
			if( rhs.isOptionalDefSchemaTenantIdNull() ) {
				return( false );
			}
	...
	CFBamParamByDefSchemaIdxKey CFBamParamByDefSchemaIdxKey::operator =( cfbam::CFBamParamByDefSchemaIdxKey& src ) {
		if( src.isOptionalDefSchemaTenantIdNull() ) {
			setOptionalDefSchemaTenantIdNull();
		}
		else {
	...
	CFBamParamByDefSchemaIdxKey CFBamParamByDefSchemaIdxKey::operator =( cfbam::CFBamParamBuff& src ) {
		if( src.isOptionalDefSchemaTenantIdNull() ) {
			setOptionalDefSchemaTenantIdNull();
		}
		else {
	...
	CFBamParamByDefSchemaIdxKey CFBamParamByDefSchemaIdxKey::operator =( cfbam::CFBamParamHBuff& src ) {
		if( src.isOptionalDefSchemaTenantIdNull() ) {
			setOptionalDefSchemaTenantIdNull();
		}
		else {
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamParamByDefSchemaIdxKey& lhs, const cfbam::CFBamParamByDefSchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamParamByDefSchemaIdxKey& lhs, const cfbam::CFBamParamHBuff& rhs ) {
		if( ! lhs.isOptionalDefSchemaTenantIdNull() ) {
			if( rhs.isOptionalDefSchemaTenantIdNull() ) {
				return( false );
			}
	...
	bool operator <(const  cfbam::CFBamParamByDefSchemaIdxKey& lhs, const cfbam::CFBamParamBuff& rhs ) {
		if( ! lhs.isOptionalDefSchemaTenantIdNull() ) {
			if( rhs.isOptionalDefSchemaTenantIdNull() ) {
				return( false );
			}
