// Description: C++18 base object instance implementation for CFBam Atom.
...
namespace cfbam {
	...
	const std::string CFBamAtomObj::CLASS_NAME( "CFBamAtomObj" );
	const classcode_t CFBamAtomObj::CLASS_CODE = 0xa80aL;

	bool CFBamAtomObj::isOptionalDbNameNull() {
		return( getAtomBuff()->isOptionalDbNameNull() );
	}

	const std::string& CFBamAtomObj::getOptionalDbNameValue() {
		return( getAtomBuff()->getOptionalDbNameValue() );
	}

	const std::string* CFBamAtomObj::getOptionalDbNameReference() {
		return( getAtomBuff()->getOptionalDbNameReference() );
	}


	CFBamAtomObj::CFBamAtomObj()
	: ICFBamAtomObj(),
	  CFBamValueObj()
	{
	}

	CFBamAtomObj::CFBamAtomObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamAtomObj(),
	...
	cfbam::CFBamValueBuff* CFBamAtomObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamAtomBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableAtom()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamAtomObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamAtomObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamAtomObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamAtomObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamAtomObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamAtomObj" );
	...
	std::string CFBamAtomObj::getObjName() {
	...
	const std::string CFBamAtomObj::getGenDefName() {
		return( cfbam::CFBamAtomBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamAtomObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamAtomObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamAtomObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamAtomObj::getObjQualifiedName() {
	...
	std::string CFBamAtomObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamAtomObj::realize() {
		cfbam::ICFBamAtomObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAtomTableObj()->realizeAtom(
			(cfbam::ICFBamAtomObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamAtomObj::read( bool forceRead ) {
		cfbam::ICFBamAtomObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAtomTableObj()->readAtomByIdIdx( getAtomBuff()->getRequiredTenantId(),
		getAtomBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamAtomObj::moveUp() {
		cfbam::ICFBamAtomObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAtomTableObj()->moveUpAtom( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamAtomObj::moveDown() {
		cfbam::ICFBamAtomObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAtomTableObj()->moveDownAtom( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamAtomObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamAtomObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAtomTableObj()->lockAtom( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAtomTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamAtomEditObj* CFBamAtomObj::getAtomEdit() {
		return( dynamic_cast<cfbam::ICFBamAtomEditObj*>( edit ) );
	}
