// Description: C++18 implementation of a DelDep history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamDelDepHBuff::CLASS_NAME( "CFBamDelDepHBuff" );
	CFBamDelDepHBuff::CFBamDelDepHBuff()
	...
	CFBamDelDepHBuff::CFBamDelDepHBuff( const CFBamDelDepHBuff& src )
	: cfbam::CFBamScopeHBuff() {
		optionalDefSchemaTenantId.setNull();
		optionalDefSchemaId.setNull();
		requiredRelationTenantId = cfbam::CFBamDelDepBuff::RELATIONTENANTID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamDelDepHBuff::clone() {
		CFBamDelDepHBuff* copy = new CFBamDelDepHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamDelDepHBuff::getOptionalDefSchemaTenantIdValue() const {
		return( optionalDefSchemaTenantId.getValue() );
	}

	const int64_t* CFBamDelDepHBuff::getOptionalDefSchemaTenantIdReference() const {
		return( optionalDefSchemaTenantId.getReference() );
	}

	const bool CFBamDelDepHBuff::isOptionalDefSchemaTenantIdNull() const {
		return( optionalDefSchemaTenantId.isNull() );
	}

	void CFBamDelDepHBuff::setOptionalDefSchemaTenantIdNull() {
		optionalDefSchemaTenantId.setNull();
	}

	void CFBamDelDepHBuff::setOptionalDefSchemaTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamDelDepHBuff::getOptionalDefSchemaIdValue() const {
		return( optionalDefSchemaId.getValue() );
	}

	const int64_t* CFBamDelDepHBuff::getOptionalDefSchemaIdReference() const {
		return( optionalDefSchemaId.getReference() );
	}

	const bool CFBamDelDepHBuff::isOptionalDefSchemaIdNull() const {
		return( optionalDefSchemaId.isNull() );
	}

	void CFBamDelDepHBuff::setOptionalDefSchemaIdNull() {
		optionalDefSchemaId.setNull();
	}

	void CFBamDelDepHBuff::setOptionalDefSchemaIdValue( const int64_t value ) {
	...
	const int64_t CFBamDelDepHBuff::getRequiredRelationTenantId() const {
		return( requiredRelationTenantId );
	}

	const int64_t* CFBamDelDepHBuff::getRequiredRelationTenantIdReference() const {
		return( &requiredRelationTenantId );
	}

	void CFBamDelDepHBuff::setRequiredRelationTenantId( const int64_t value ) {
	...
	const int64_t CFBamDelDepHBuff::getRequiredRelationId() const {
		return( requiredRelationId );
	}

	const int64_t* CFBamDelDepHBuff::getRequiredRelationIdReference() const {
		return( &requiredRelationId );
	}

	void CFBamDelDepHBuff::setRequiredRelationId( const int64_t value ) {
	...
	size_t CFBamDelDepHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamDelDepHBuff::hashCode();
	...
	CFBamDelDepHBuff CFBamDelDepHBuff::operator =( cfbam::CFBamDelDepBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		if( src.isOptionalDefSchemaTenantIdNull() ) {
	...
	CFBamDelDepHBuff CFBamDelDepHBuff::operator =( cfbam::CFBamDelDepHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		if( src.isOptionalDefSchemaTenantIdNull() ) {
	...
	bool CFBamDelDepHBuff::operator <( const CFBamDelDepByDefSchemaIdxKey& rhs ) {
		if( ! isOptionalDefSchemaTenantIdNull() ) {
	...
	bool CFBamDelDepHBuff::operator <( const CFBamDelDepByDelDepIdxKey& rhs ) {
	...
	bool CFBamDelDepHBuff::operator <( const CFBamScopePKey& rhs ) {
	...
	bool CFBamDelDepHBuff::operator <( const CFBamScopeHPKey& rhs ) {
	...
	bool CFBamDelDepHBuff::operator <( const CFBamDelDepHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamDelDepHBuff::operator <( const CFBamDelDepBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamDelDepHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamDelDepHBuff" );
