// Description: C++18 implementation of a Int32Def history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamInt32DefHBuff::CLASS_NAME( "CFBamInt32DefHBuff" );
	CFBamInt32DefHBuff::CFBamInt32DefHBuff()
	...
	CFBamInt32DefHBuff::CFBamInt32DefHBuff( const CFBamInt32DefHBuff& src )
	: cfbam::CFBamAtomHBuff() {
		optionalInitValue.setNull();
		optionalMinValue.setNull();
		optionalMaxValue.setNull();
	...
	cflib::ICFLibCloneableObj* CFBamInt32DefHBuff::clone() {
		CFBamInt32DefHBuff* copy = new CFBamInt32DefHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int32_t CFBamInt32DefHBuff::getOptionalInitValueValue() const {
		return( optionalInitValue.getValue() );
	}

	const int32_t* CFBamInt32DefHBuff::getOptionalInitValueReference() const {
		return( optionalInitValue.getReference() );
	}

	const bool CFBamInt32DefHBuff::isOptionalInitValueNull() const {
		return( optionalInitValue.isNull() );
	}

	void CFBamInt32DefHBuff::setOptionalInitValueNull() {
		optionalInitValue.setNull();
	}

	void CFBamInt32DefHBuff::setOptionalInitValueValue( const int32_t value ) {
	...
	const int32_t CFBamInt32DefHBuff::getOptionalMinValueValue() const {
		return( optionalMinValue.getValue() );
	}

	const int32_t* CFBamInt32DefHBuff::getOptionalMinValueReference() const {
		return( optionalMinValue.getReference() );
	}

	const bool CFBamInt32DefHBuff::isOptionalMinValueNull() const {
		return( optionalMinValue.isNull() );
	}

	void CFBamInt32DefHBuff::setOptionalMinValueNull() {
		optionalMinValue.setNull();
	}

	void CFBamInt32DefHBuff::setOptionalMinValueValue( const int32_t value ) {
	...
	const int32_t CFBamInt32DefHBuff::getOptionalMaxValueValue() const {
		return( optionalMaxValue.getValue() );
	}

	const int32_t* CFBamInt32DefHBuff::getOptionalMaxValueReference() const {
		return( optionalMaxValue.getReference() );
	}

	const bool CFBamInt32DefHBuff::isOptionalMaxValueNull() const {
		return( optionalMaxValue.isNull() );
	}

	void CFBamInt32DefHBuff::setOptionalMaxValueNull() {
		optionalMaxValue.setNull();
	}

	void CFBamInt32DefHBuff::setOptionalMaxValueValue( const int32_t value ) {
	...
	size_t CFBamInt32DefHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamInt32DefHBuff::hashCode();
	...
	CFBamInt32DefHBuff CFBamInt32DefHBuff::operator =( cfbam::CFBamInt32DefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamInt32DefHBuff CFBamInt32DefHBuff::operator =( cfbam::CFBamInt32DefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamInt32DefHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamInt32DefHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamInt32DefHBuff::operator <( const CFBamInt32DefHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamInt32DefHBuff::operator <( const CFBamInt32DefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamInt32DefHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt32DefHBuff" );
