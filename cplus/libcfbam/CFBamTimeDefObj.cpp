// Description: C++18 base object instance implementation for CFBam TimeDef.
...
namespace cfbam {
	...
	const std::string CFBamTimeDefObj::CLASS_NAME( "CFBamTimeDefObj" );
	const classcode_t CFBamTimeDefObj::CLASS_CODE = 0xa843L;

	bool CFBamTimeDefObj::isOptionalDummyNull() {
		return( getTimeDefBuff()->isOptionalDummyNull() );
	}

	const std::string& CFBamTimeDefObj::getOptionalDummyValue() {
		return( getTimeDefBuff()->getOptionalDummyValue() );
	}

	const std::string* CFBamTimeDefObj::getOptionalDummyReference() {
		return( getTimeDefBuff()->getOptionalDummyReference() );
	}


	CFBamTimeDefObj::CFBamTimeDefObj()
	: ICFBamTimeDefObj(),
	  CFBamAtomObj()
	{
	}

	CFBamTimeDefObj::CFBamTimeDefObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamTimeDefObj(),
	...
	cfbam::CFBamValueBuff* CFBamTimeDefObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamTimeDefBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableTimeDef()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamTimeDefObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamTimeDefObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTimeDefObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTimeDefObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamTimeDefObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTimeDefObj" );
	...
	std::string CFBamTimeDefObj::getObjName() {
	...
	const std::string CFBamTimeDefObj::getGenDefName() {
		return( cfbam::CFBamTimeDefBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTimeDefObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTimeDefObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTimeDefObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTimeDefObj::getObjQualifiedName() {
	...
	std::string CFBamTimeDefObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTimeDefObj::realize() {
		cfbam::ICFBamTimeDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimeDefTableObj()->realizeTimeDef(
			(cfbam::ICFBamTimeDefObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTimeDefObj::read( bool forceRead ) {
		cfbam::ICFBamTimeDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimeDefTableObj()->readTimeDefByIdIdx( getTimeDefBuff()->getRequiredTenantId(),
		getTimeDefBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTimeDefObj::moveUp() {
		cfbam::ICFBamTimeDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimeDefTableObj()->moveUpTimeDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTimeDefObj::moveDown() {
		cfbam::ICFBamTimeDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimeDefTableObj()->moveDownTimeDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamTimeDefObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamTimeDefObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimeDefTableObj()->lockTimeDef( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTimeDefTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamTimeDefEditObj* CFBamTimeDefObj::getTimeDefEdit() {
		return( dynamic_cast<cfbam::ICFBamTimeDefEditObj*>( edit ) );
	}
