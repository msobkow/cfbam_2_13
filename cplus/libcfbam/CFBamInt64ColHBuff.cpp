// Description: C++18 implementation of a Int64Col history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamInt64ColHBuff::CLASS_NAME( "CFBamInt64ColHBuff" );
	CFBamInt64ColHBuff::CFBamInt64ColHBuff()
	: cfbam::CFBamInt64DefHBuff() {
		requiredTableId = cfbam::CFBamInt64ColBuff::TABLEID_INIT_VALUE;
	}

	CFBamInt64ColHBuff::CFBamInt64ColHBuff( const CFBamInt64ColHBuff& src )
	: cfbam::CFBamInt64DefHBuff() {
		requiredTableId = cfbam::CFBamInt64ColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamInt64ColHBuff::clone() {
		CFBamInt64ColHBuff* copy = new CFBamInt64ColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamInt64ColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamInt64ColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamInt64ColHBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamInt64ColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamInt64ColHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamInt64ColHBuff CFBamInt64ColHBuff::operator =( cfbam::CFBamInt64ColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamInt64ColHBuff CFBamInt64ColHBuff::operator =( cfbam::CFBamInt64ColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamInt64ColHBuff::operator <( const CFBamInt64ColByTableIdxKey& rhs ) {
	...
	bool CFBamInt64ColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt64ColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamInt64ColHBuff::operator <( const CFBamInt64ColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamInt64ColHBuff::operator <( const CFBamInt64ColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamInt64ColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt64ColHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamInt64ColHBuff& lhs, const cfbam::CFBamInt64ColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamInt64ColHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamInt64ColHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamInt64ColHBuff& lhs, const cfbam::CFBamInt64ColHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamInt64ColHBuff& lhs, const cfbam::CFBamInt64ColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
