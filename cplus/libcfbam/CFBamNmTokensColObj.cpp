// Description: C++18 base object instance implementation for CFBam NmTokensCol.
...
namespace cfbam {
	...
	const std::string CFBamNmTokensColObj::CLASS_NAME( "CFBamNmTokensColObj" );
	const classcode_t CFBamNmTokensColObj::CLASS_CODE = 0xa860L;

	const int64_t CFBamNmTokensColObj::getRequiredTableId() {
		return( getNmTokensColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamNmTokensColObj::getRequiredTableIdReference() {
		return( getNmTokensColBuff()->getRequiredTableIdReference() );
	}


	cfbam::ICFBamTableObj* CFBamNmTokensColObj::getRequiredContainerTable( bool forceRead ) {
	...
	CFBamNmTokensColObj::CFBamNmTokensColObj()
	: ICFBamNmTokensColObj(),
	  CFBamNmTokensDefObj()
	{
	}

	CFBamNmTokensColObj::CFBamNmTokensColObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamNmTokensColObj(),
	...
	cfbam::CFBamValueBuff* CFBamNmTokensColObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamNmTokensColBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableNmTokensCol()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamNmTokensColObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamNmTokensColObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamNmTokensColObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamNmTokensColObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamNmTokensColObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNmTokensColObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamNmTokensColObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamNmTokensColObj::getObjName() {
	...
	const std::string CFBamNmTokensColObj::getGenDefName() {
		return( cfbam::CFBamNmTokensColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamNmTokensColObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamNmTokensColObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamNmTokensColObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamNmTokensColObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamNmTokensColObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamNmTokensColObj::getObjQualifiedName() {
	...
	std::string CFBamNmTokensColObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamNmTokensColObj::realize() {
		cfbam::ICFBamNmTokensColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokensColTableObj()->realizeNmTokensCol(
			(cfbam::ICFBamNmTokensColObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamNmTokensColObj::read( bool forceRead ) {
		cfbam::ICFBamNmTokensColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokensColTableObj()->readNmTokensColByIdIdx( getNmTokensColBuff()->getRequiredTenantId(),
		getNmTokensColBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamNmTokensColObj::moveUp() {
		cfbam::ICFBamNmTokensColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokensColTableObj()->moveUpNmTokensCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamNmTokensColObj::moveDown() {
		cfbam::ICFBamNmTokensColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokensColTableObj()->moveDownNmTokensCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamNmTokensColObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamNmTokensColObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokensColTableObj()->lockNmTokensCol( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getNmTokensColTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamNmTokensColEditObj* CFBamNmTokensColObj::getNmTokensColEdit() {
		return( dynamic_cast<cfbam::ICFBamNmTokensColEditObj*>( edit ) );
	}
