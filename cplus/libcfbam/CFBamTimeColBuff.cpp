// Description: C++18 implementation for a TimeCol buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTimeColBuff::GENDEFNAME( "TimeCol" );
	const classcode_t CFBamTimeColBuff::CLASS_CODE = 0xa867L;
	const std::string CFBamTimeColBuff::CLASS_NAME( "CFBamTimeColBuff" );
		const std::string CFBamTimeColBuff::COLNAME_TABLEID( "TableId" );
	const int64_t CFBamTimeColBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamTimeColBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamTimeColBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamTimeColBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamTimeColBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamTimeColBuff::TABLEID_MIN_VALUE = 0LL;

	CFBamTimeColBuff::CFBamTimeColBuff()
	: CFBamTimeDefBuff()
	{
		requiredTableId = cfbam::CFBamTimeColBuff::TABLEID_INIT_VALUE;
	}

	CFBamTimeColBuff::CFBamTimeColBuff( const CFBamTimeColBuff& src )
	: CFBamTimeDefBuff()
	{
		requiredTableId = cfbam::CFBamTimeColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTimeColBuff::clone() {
		CFBamTimeColBuff* copy = new CFBamTimeColBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTimeColBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTimeColBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTimeColBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFBamTimeColBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamTimeColBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamTimeColBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamTimeColBuff::hashCode() const {
		size_t hashCode = CFBamTimeDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamTimeColBuff CFBamTimeColBuff::operator =( cfbam::CFBamTimeColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamTimeColBuff CFBamTimeColBuff::operator =( cfbam::CFBamTimeColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTimeColBuff::operator <( const CFBamTimeColByTableIdxKey& rhs ) {
	...
	bool CFBamTimeColBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTimeColBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTimeColBuff::operator <( const CFBamTimeColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTimeColBuff::operator <( const CFBamTimeColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTimeColBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTimeColBuff" );
