// Description: C++18 implementation for a Chain by DefSchemaIdx index key object.
...
namespace cfbam {
	const std::string CFBamChainByDefSchemaIdxKey::CLASS_NAME( "CFBamChainByDefSchemaIdxKey" );
	const std::string CFBamChainByDefSchemaIdxKey::S_VALUE( "value" );
	const std::string CFBamChainByDefSchemaIdxKey::S_VALUE_LENGTH( "value.length()" );


	CFBamChainByDefSchemaIdxKey::CFBamChainByDefSchemaIdxKey() {
		optionalDefSchemaTenantId.setNull();
		optionalDefSchemaId.setNull();
	}

	CFBamChainByDefSchemaIdxKey::CFBamChainByDefSchemaIdxKey( const CFBamChainByDefSchemaIdxKey& src ) {
		optionalDefSchemaTenantId.setNull();
		optionalDefSchemaId.setNull();
	...
	const int64_t CFBamChainByDefSchemaIdxKey::getOptionalDefSchemaTenantIdValue() const {
		return( optionalDefSchemaTenantId.getValue() );
	}

	const int64_t* CFBamChainByDefSchemaIdxKey::getOptionalDefSchemaTenantIdReference() const {
		return( optionalDefSchemaTenantId.getReference() );
	}

	const bool CFBamChainByDefSchemaIdxKey::isOptionalDefSchemaTenantIdNull() const {
		return( optionalDefSchemaTenantId.isNull() );
	}

	void CFBamChainByDefSchemaIdxKey::setOptionalDefSchemaTenantIdNull() {
		optionalDefSchemaTenantId.setNull();
	}

	void CFBamChainByDefSchemaIdxKey::setOptionalDefSchemaTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamChainByDefSchemaIdxKey::getOptionalDefSchemaIdValue() const {
		return( optionalDefSchemaId.getValue() );
	}

	const int64_t* CFBamChainByDefSchemaIdxKey::getOptionalDefSchemaIdReference() const {
		return( optionalDefSchemaId.getReference() );
	}

	const bool CFBamChainByDefSchemaIdxKey::isOptionalDefSchemaIdNull() const {
		return( optionalDefSchemaId.isNull() );
	}

	void CFBamChainByDefSchemaIdxKey::setOptionalDefSchemaIdNull() {
		optionalDefSchemaId.setNull();
	}

	void CFBamChainByDefSchemaIdxKey::setOptionalDefSchemaIdValue( const int64_t value ) {
	...
	size_t CFBamChainByDefSchemaIdxKey::hashCode() const {
		size_t hashCode = 0;
	...
	std::string CFBamChainByDefSchemaIdxKey::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamChainByDefSchemaIdxKey" );
	...
	bool CFBamChainByDefSchemaIdxKey::operator <( const CFBamChainByDefSchemaIdxKey& rhs ) {
		if( ! isOptionalDefSchemaTenantIdNull() ) {
	...
	bool CFBamChainByDefSchemaIdxKey::operator <( const CFBamChainHBuff& rhs ) {
		if( ! isOptionalDefSchemaTenantIdNull() ) {
			if( rhs.isOptionalDefSchemaTenantIdNull() ) {
				return( false );
			}
	...
	bool CFBamChainByDefSchemaIdxKey::operator <( const CFBamChainBuff& rhs ) {
		if( ! isOptionalDefSchemaTenantIdNull() ) {
			if( rhs.isOptionalDefSchemaTenantIdNull() ) {
				return( false );
			}
	...
	CFBamChainByDefSchemaIdxKey CFBamChainByDefSchemaIdxKey::operator =( cfbam::CFBamChainByDefSchemaIdxKey& src ) {
		if( src.isOptionalDefSchemaTenantIdNull() ) {
			setOptionalDefSchemaTenantIdNull();
		}
		else {
	...
	CFBamChainByDefSchemaIdxKey CFBamChainByDefSchemaIdxKey::operator =( cfbam::CFBamChainBuff& src ) {
		if( src.isOptionalDefSchemaTenantIdNull() ) {
			setOptionalDefSchemaTenantIdNull();
		}
		else {
	...
	CFBamChainByDefSchemaIdxKey CFBamChainByDefSchemaIdxKey::operator =( cfbam::CFBamChainHBuff& src ) {
		if( src.isOptionalDefSchemaTenantIdNull() ) {
			setOptionalDefSchemaTenantIdNull();
		}
		else {
