// Description: C++18 Instance Edit Object interface implementation for CFBam TokenType.
...
namespace cfbam {
	...
	const std::string ICFBamTokenTypeEditObj::CLASS_NAME( "ICFBamTokenTypeEditObj" );

	ICFBamTokenTypeEditObj::ICFBamTokenTypeEditObj()
