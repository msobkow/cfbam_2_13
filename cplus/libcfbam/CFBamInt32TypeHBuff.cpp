// Description: C++18 implementation of a Int32Type history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamInt32TypeHBuff::CLASS_NAME( "CFBamInt32TypeHBuff" );
	CFBamInt32TypeHBuff::CFBamInt32TypeHBuff()
	: cfbam::CFBamInt32DefHBuff() {
		requiredSchemaDefId = cfbam::CFBamInt32TypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamInt32TypeHBuff::CFBamInt32TypeHBuff( const CFBamInt32TypeHBuff& src )
	: cfbam::CFBamInt32DefHBuff() {
		requiredSchemaDefId = cfbam::CFBamInt32TypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamInt32TypeHBuff::clone() {
		CFBamInt32TypeHBuff* copy = new CFBamInt32TypeHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamInt32TypeHBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamInt32TypeHBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamInt32TypeHBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamInt32TypeHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamInt32TypeHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamInt32TypeHBuff CFBamInt32TypeHBuff::operator =( cfbam::CFBamInt32TypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamInt32TypeHBuff CFBamInt32TypeHBuff::operator =( cfbam::CFBamInt32TypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamInt32TypeHBuff::operator <( const CFBamInt32TypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamInt32TypeHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamInt32TypeHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamInt32TypeHBuff::operator <( const CFBamInt32TypeHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamInt32TypeHBuff::operator <( const CFBamInt32TypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamInt32TypeHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt32TypeHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamInt32TypeHBuff& lhs, const cfbam::CFBamInt32TypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamInt32TypeHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamInt32TypeHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamInt32TypeHBuff& lhs, const cfbam::CFBamInt32TypeHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamInt32TypeHBuff& lhs, const cfbam::CFBamInt32TypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
