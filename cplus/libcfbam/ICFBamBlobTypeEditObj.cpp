// Description: C++18 Instance Edit Object interface implementation for CFBam BlobType.
...
namespace cfbam {
	...
	const std::string ICFBamBlobTypeEditObj::CLASS_NAME( "ICFBamBlobTypeEditObj" );

	ICFBamBlobTypeEditObj::ICFBamBlobTypeEditObj()
