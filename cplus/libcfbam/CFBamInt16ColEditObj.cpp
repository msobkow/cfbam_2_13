// Description: C++18 edit object instance implementation for CFBam Int16Col.
...
namespace cfbam {
	...
	const std::string CFBamInt16ColEditObj::CLASS_NAME( "CFBamInt16ColEditObj" );

	CFBamInt16ColEditObj::CFBamInt16ColEditObj( cfbam::ICFBamInt16ColObj* argOrig )
	: ICFBamInt16ColEditObj(),
	  CFBamInt16DefEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamInt16ColEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamInt16ColEditObj::~CFBamInt16ColEditObj() {
	}

	const std::string& CFBamInt16ColEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamInt16ColEditObj::getClassCode() const {
		return( cfbam::CFBamInt16ColBuff::CLASS_CODE );
	}

	bool CFBamInt16ColEditObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamInt16ColBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamInt16DefEditObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamInt16ColEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt16ColEditObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamInt16ColEditObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	const std::string CFBamInt16ColEditObj::getGenDefName() {
		return( cfbam::CFBamInt16ColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamInt16ColEditObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamInt16ColEditObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamInt16ColEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamInt16ColEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamInt16ColEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamInt16ColEditObj::getObjQualifiedName() {
	...
	std::string CFBamInt16ColEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamInt16ColEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamInt16ColObj* retobj = getSchema()->getInt16ColTableObj()->realizeInt16Col( dynamic_cast<cfbam::ICFBamInt16ColObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamInt16ColEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamInt16ColEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamInt16ColEditObj::create() {
		cfbam::ICFBamInt16ColObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsInt16Col()->getSchema() )->getInt16ColTableObj()->createInt16Col( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamInt16ColEditObj::update() {
		getSchema()->getInt16ColTableObj()->updateInt16Col( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamInt16ColEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getInt16ColTableObj()->deleteInt16Col( this );
		return( NULL );
	}

	cfbam::ICFBamInt16ColTableObj* CFBamInt16ColEditObj::getInt16ColTable() {
		return( orig->getSchema()->getInt16ColTableObj() );
	}

	cfbam::ICFBamInt16ColEditObj* CFBamInt16ColEditObj::getInt16ColEdit() {
		return( (cfbam::ICFBamInt16ColEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamInt16ColEditObj::beginEdit() {
	...
	cfbam::ICFBamInt16ColObj* CFBamInt16ColEditObj::getOrigAsInt16Col() {
		return( dynamic_cast<cfbam::ICFBamInt16ColObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamInt16ColEditObj::getBuff() {
		return( buff );
	}

	void CFBamInt16ColEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamInt16DefEditObj::setBuff( value );
		}
	}

	const int64_t CFBamInt16ColEditObj::getRequiredTableId() {
		return( getInt16ColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamInt16ColEditObj::getRequiredTableIdReference() {
		return( getInt16ColBuff()->getRequiredTableIdReference() );
	}

	void CFBamInt16ColEditObj::setRequiredContainerScope( cfbam::ICFBamScopeObj* value ) {
		if( value == NULL ) {
	...
	cfbam::ICFBamTableObj* CFBamInt16ColEditObj::getRequiredContainerTable( bool forceRead ) {
		cfbam::ICFBamTableObj* retobj = NULL;
		bool anyMissing = false;
		if( ! anyMissing ) {
			retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsInt16Col()->getSchema() )->getTableTableObj()->readTableByIdIdx( getPKey()->getRequiredTenantId(),
					getInt16ColBuff()->getRequiredTableId() );
		}
		return( retobj );
	}

	void CFBamInt16ColEditObj::setRequiredContainerTable( cfbam::ICFBamTableObj* value ) {
			
			if( value != NULL ) {
				getPKey()->setRequiredTenantId
( value->getRequiredTenantId() );
				getInt16ColEditBuff()->setRequiredTenantId( value->getRequiredTenantId() );
				getInt16ColEditBuff()->setRequiredTableId( value->getRequiredId() );
			}

			CFBamInt16DefEditObj::setRequiredContainerScope( value );		}

	void CFBamInt16ColEditObj::copyBuffToOrig() {
		cfbam::CFBamInt16ColBuff* origBuff = getOrigAsInt16Col()->getInt16ColEditBuff();
		cfbam::CFBamInt16ColBuff* myBuff = getInt16ColBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamInt16ColEditObj::copyOrigToBuff() {
		cfbam::CFBamInt16ColBuff* origBuff = getOrigAsInt16Col()->getInt16ColBuff();
		cfbam::CFBamInt16ColBuff* myBuff = getInt16ColEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
