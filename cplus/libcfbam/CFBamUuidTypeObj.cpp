// Description: C++18 base object instance implementation for CFBam UuidType.
...
namespace cfbam {
	...
	const std::string CFBamUuidTypeObj::CLASS_NAME( "CFBamUuidTypeObj" );
	const classcode_t CFBamUuidTypeObj::CLASS_CODE = 0xa851L;

	const int64_t CFBamUuidTypeObj::getRequiredSchemaDefId() {
		return( getUuidTypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamUuidTypeObj::getRequiredSchemaDefIdReference() {
		return( getUuidTypeBuff()->getRequiredSchemaDefIdReference() );
	}


	cfbam::ICFBamSchemaDefObj* CFBamUuidTypeObj::getRequiredContainerSchemaDef( bool forceRead ) {
	...
	CFBamUuidTypeObj::CFBamUuidTypeObj()
	: ICFBamUuidTypeObj(),
	  CFBamUuidDefObj()
	{
	}

	CFBamUuidTypeObj::CFBamUuidTypeObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamUuidTypeObj(),
	  CFBamUuidDefObj( argSchema )
	{
	}
	...
	cfbam::CFBamValueBuff* CFBamUuidTypeObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamUuidTypeBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableUuidType()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamUuidTypeObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamUuidTypeObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUuidTypeObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamUuidTypeObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamUuidTypeBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamUuidDefObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamUuidTypeObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUuidTypeObj" );
	...
	std::string CFBamUuidTypeObj::getObjName() {
	...
	const std::string CFBamUuidTypeObj::getGenDefName() {
		return( cfbam::CFBamUuidTypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamUuidTypeObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamUuidTypeObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamUuidTypeObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamUuidTypeObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamUuidTypeObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamUuidTypeObj::getObjQualifiedName() {
	...
	std::string CFBamUuidTypeObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamUuidTypeObj::realize() {
		cfbam::ICFBamUuidTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUuidTypeTableObj()->realizeUuidType(
			(cfbam::ICFBamUuidTypeObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUuidTypeObj::read( bool forceRead ) {
		cfbam::ICFBamUuidTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUuidTypeTableObj()->readUuidTypeByIdIdx( getUuidTypeBuff()->getRequiredTenantId(),
		getUuidTypeBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUuidTypeObj::moveUp() {
		cfbam::ICFBamUuidTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUuidTypeTableObj()->moveUpUuidType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUuidTypeObj::moveDown() {
		cfbam::ICFBamUuidTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUuidTypeTableObj()->moveDownUuidType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamUuidTypeObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamUuidTypeObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUuidTypeTableObj()->lockUuidType( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUuidTypeTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamUuidTypeEditObj* CFBamUuidTypeObj::getUuidTypeEdit() {
		return( dynamic_cast<cfbam::ICFBamUuidTypeEditObj*>( edit ) );
	}
