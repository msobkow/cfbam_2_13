// Description: C++18 implementation of a NmTokenCol history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamNmTokenColHBuff::CLASS_NAME( "CFBamNmTokenColHBuff" );
	CFBamNmTokenColHBuff::CFBamNmTokenColHBuff()
	: cfbam::CFBamNmTokenDefHBuff() {
		requiredTableId = cfbam::CFBamNmTokenColBuff::TABLEID_INIT_VALUE;
	}

	CFBamNmTokenColHBuff::CFBamNmTokenColHBuff( const CFBamNmTokenColHBuff& src )
	: cfbam::CFBamNmTokenDefHBuff() {
		requiredTableId = cfbam::CFBamNmTokenColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamNmTokenColHBuff::clone() {
		CFBamNmTokenColHBuff* copy = new CFBamNmTokenColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamNmTokenColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamNmTokenColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamNmTokenColHBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamNmTokenColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamNmTokenColHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamNmTokenColHBuff CFBamNmTokenColHBuff::operator =( cfbam::CFBamNmTokenColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamNmTokenColHBuff CFBamNmTokenColHBuff::operator =( cfbam::CFBamNmTokenColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamNmTokenColHBuff::operator <( const CFBamNmTokenColByTableIdxKey& rhs ) {
	...
	bool CFBamNmTokenColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNmTokenColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamNmTokenColHBuff::operator <( const CFBamNmTokenColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamNmTokenColHBuff::operator <( const CFBamNmTokenColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamNmTokenColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNmTokenColHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamNmTokenColHBuff& lhs, const cfbam::CFBamNmTokenColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamNmTokenColHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamNmTokenColHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamNmTokenColHBuff& lhs, const cfbam::CFBamNmTokenColHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamNmTokenColHBuff& lhs, const cfbam::CFBamNmTokenColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
