// Description: C++18 base object instance implementation for CFBam DateType.
...
namespace cfbam {
	...
	const std::string CFBamDateTypeObj::CLASS_NAME( "CFBamDateTypeObj" );
	const classcode_t CFBamDateTypeObj::CLASS_CODE = 0xa816L;

	const int64_t CFBamDateTypeObj::getRequiredSchemaDefId() {
		return( getDateTypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamDateTypeObj::getRequiredSchemaDefIdReference() {
		return( getDateTypeBuff()->getRequiredSchemaDefIdReference() );
	}


	cfbam::ICFBamSchemaDefObj* CFBamDateTypeObj::getRequiredContainerSchemaDef( bool forceRead ) {
	...
	CFBamDateTypeObj::CFBamDateTypeObj()
	: ICFBamDateTypeObj(),
	  CFBamDateDefObj()
	{
	}

	CFBamDateTypeObj::CFBamDateTypeObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamDateTypeObj(),
	...
	cfbam::CFBamValueBuff* CFBamDateTypeObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamDateTypeBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableDateType()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamDateTypeObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamDateTypeObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamDateTypeObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamDateTypeObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamDateTypeObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamDateTypeObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamDateTypeObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamDateTypeObj::getObjName() {
	...
	const std::string CFBamDateTypeObj::getGenDefName() {
		return( cfbam::CFBamDateTypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamDateTypeObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamDateTypeObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamDateTypeObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamDateTypeObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamDateTypeObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamDateTypeObj::getObjQualifiedName() {
	...
	std::string CFBamDateTypeObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamDateTypeObj::realize() {
		cfbam::ICFBamDateTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDateTypeTableObj()->realizeDateType(
			(cfbam::ICFBamDateTypeObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamDateTypeObj::read( bool forceRead ) {
		cfbam::ICFBamDateTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDateTypeTableObj()->readDateTypeByIdIdx( getDateTypeBuff()->getRequiredTenantId(),
		getDateTypeBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamDateTypeObj::moveUp() {
		cfbam::ICFBamDateTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDateTypeTableObj()->moveUpDateType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamDateTypeObj::moveDown() {
		cfbam::ICFBamDateTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDateTypeTableObj()->moveDownDateType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamDateTypeObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamDateTypeObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDateTypeTableObj()->lockDateType( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getDateTypeTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamDateTypeEditObj* CFBamDateTypeObj::getDateTypeEdit() {
		return( dynamic_cast<cfbam::ICFBamDateTypeEditObj*>( edit ) );
	}
