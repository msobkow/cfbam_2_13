// Description: C++18 implementation for a TimeDef buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTimeDefBuff::GENDEFNAME( "TimeDef" );
	const classcode_t CFBamTimeDefBuff::CLASS_CODE = 0xa843L;
	const std::string CFBamTimeDefBuff::CLASS_NAME( "CFBamTimeDefBuff" );
		const std::string CFBamTimeDefBuff::COLNAME_DUMMY( "Dummy" );
	const int64_t CFBamTimeDefBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamTimeDefBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamTimeDefBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamTimeDefBuff::ID_MIN_VALUE = 0LL;
	const std::string::size_type CFBamTimeDefBuff::DUMMY_MAX_LEN = 4;

	CFBamTimeDefBuff::CFBamTimeDefBuff()
	: CFBamAtomBuff()
	{
		optionalDummy = NULL;
	}

	CFBamTimeDefBuff::CFBamTimeDefBuff( const CFBamTimeDefBuff& src )
	: CFBamAtomBuff()
	{
		optionalDummy = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamTimeDefBuff::clone() {
		CFBamTimeDefBuff* copy = new CFBamTimeDefBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTimeDefBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTimeDefBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTimeDefBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const bool CFBamTimeDefBuff::isOptionalDummyNull() const {
		return( optionalDummy == NULL );
	}

	const std::string& CFBamTimeDefBuff::getOptionalDummyValue() const {
	...
	const std::string* CFBamTimeDefBuff::getOptionalDummyReference() const {
		return( optionalDummy );
	}

	void CFBamTimeDefBuff::setOptionalDummyNull() {
		if( optionalDummy != NULL ) {
			delete optionalDummy;
			optionalDummy = NULL;
		}
	...
	void CFBamTimeDefBuff::setOptionalDummyValue( const std::string& value ) {
		static const std::string S_ProcName( "setOptionalDummyValue" );
		if( value.length() > CFBamTimeDefBuff::DUMMY_MAX_LEN ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE_LENGTH,
				value.length(),
				CFBamTimeDefBuff::DUMMY_MAX_LEN );
		}
		if( optionalDummy != NULL ) {
			delete optionalDummy;
			optionalDummy = NULL;
	...
	size_t CFBamTimeDefBuff::hashCode() const {
	...
	CFBamTimeDefBuff CFBamTimeDefBuff::operator =( cfbam::CFBamTimeDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamTimeDefBuff CFBamTimeDefBuff::operator =( cfbam::CFBamTimeDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTimeDefBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamTimeDefBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTimeDefBuff::operator <( const CFBamTimeDefHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTimeDefBuff::operator <( const CFBamTimeDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTimeDefBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTimeDefBuff" );
