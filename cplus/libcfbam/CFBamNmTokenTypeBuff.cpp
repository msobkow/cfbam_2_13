// Description: C++18 implementation for a NmTokenType buffer object.
...
namespace cfbam {
	...
	const std::string CFBamNmTokenTypeBuff::GENDEFNAME( "NmTokenType" );
	const classcode_t CFBamNmTokenTypeBuff::CLASS_CODE = 0xa82aL;
	const std::string CFBamNmTokenTypeBuff::CLASS_NAME( "CFBamNmTokenTypeBuff" );
		const std::string CFBamNmTokenTypeBuff::COLNAME_SCHEMADEFID( "SchemaDefId" );
	const int64_t CFBamNmTokenTypeBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamNmTokenTypeBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamNmTokenTypeBuff::SCHEMADEFID_INIT_VALUE = 0LL;
	const int64_t CFBamNmTokenTypeBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamNmTokenTypeBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamNmTokenTypeBuff::SCHEMADEFID_MIN_VALUE = 0LL;

	CFBamNmTokenTypeBuff::CFBamNmTokenTypeBuff()
	: CFBamNmTokenDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamNmTokenTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamNmTokenTypeBuff::CFBamNmTokenTypeBuff( const CFBamNmTokenTypeBuff& src )
	: CFBamNmTokenDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamNmTokenTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamNmTokenTypeBuff::clone() {
		CFBamNmTokenTypeBuff* copy = new CFBamNmTokenTypeBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamNmTokenTypeBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamNmTokenTypeBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamNmTokenTypeBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamNmTokenDefBuff::implementsClassCode( argClassCode ) );
		}
	}

	const int64_t CFBamNmTokenTypeBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamNmTokenTypeBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamNmTokenTypeBuff::setRequiredSchemaDefId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredSchemaDefId" );
		if( value < cfbam::CFBamNmTokenTypeBuff::SCHEMADEFID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamNmTokenTypeBuff::SCHEMADEFID_MIN_VALUE );
		}
		requiredSchemaDefId = value;
	}

	size_t CFBamNmTokenTypeBuff::hashCode() const {
		size_t hashCode = CFBamNmTokenDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamNmTokenTypeBuff CFBamNmTokenTypeBuff::operator =( cfbam::CFBamNmTokenTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamNmTokenTypeBuff CFBamNmTokenTypeBuff::operator =( cfbam::CFBamNmTokenTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamNmTokenTypeBuff::operator <( const CFBamNmTokenTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamNmTokenTypeBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNmTokenTypeBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNmTokenTypeBuff::operator <( const CFBamNmTokenTypeHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNmTokenTypeBuff::operator <( const CFBamNmTokenTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamNmTokenTypeBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNmTokenTypeBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamNmTokenTypeBuff& lhs, const cfbam::CFBamNmTokenTypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamNmTokenTypeBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamNmTokenTypeBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamNmTokenTypeBuff& lhs, const cfbam::CFBamNmTokenTypeHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamNmTokenTypeBuff& lhs, const cfbam::CFBamNmTokenTypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
