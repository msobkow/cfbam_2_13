// Description: C++18 Instance Edit Object interface implementation for CFBam Id32Gen.
...
namespace cfbam {
	...
	const std::string ICFBamId32GenEditObj::CLASS_NAME( "ICFBamId32GenEditObj" );

	ICFBamId32GenEditObj::ICFBamId32GenEditObj()
