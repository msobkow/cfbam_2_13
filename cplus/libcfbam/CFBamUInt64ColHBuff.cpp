// Description: C++18 implementation of a UInt64Col history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUInt64ColHBuff::CLASS_NAME( "CFBamUInt64ColHBuff" );
	CFBamUInt64ColHBuff::CFBamUInt64ColHBuff()
	: cfbam::CFBamUInt64DefHBuff() {
		requiredTableId = cfbam::CFBamUInt64ColBuff::TABLEID_INIT_VALUE;
	}

	CFBamUInt64ColHBuff::CFBamUInt64ColHBuff( const CFBamUInt64ColHBuff& src )
	: cfbam::CFBamUInt64DefHBuff() {
		requiredTableId = cfbam::CFBamUInt64ColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamUInt64ColHBuff::clone() {
		CFBamUInt64ColHBuff* copy = new CFBamUInt64ColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamUInt64ColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamUInt64ColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamUInt64ColHBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamUInt64ColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamUInt64ColHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamUInt64ColHBuff CFBamUInt64ColHBuff::operator =( cfbam::CFBamUInt64ColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamUInt64ColHBuff CFBamUInt64ColHBuff::operator =( cfbam::CFBamUInt64ColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUInt64ColHBuff::operator <( const CFBamUInt64ColByTableIdxKey& rhs ) {
	...
	bool CFBamUInt64ColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt64ColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamUInt64ColHBuff::operator <( const CFBamUInt64ColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamUInt64ColHBuff::operator <( const CFBamUInt64ColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUInt64ColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt64ColHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamUInt64ColHBuff& lhs, const cfbam::CFBamUInt64ColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamUInt64ColHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamUInt64ColHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamUInt64ColHBuff& lhs, const cfbam::CFBamUInt64ColHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamUInt64ColHBuff& lhs, const cfbam::CFBamUInt64ColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
