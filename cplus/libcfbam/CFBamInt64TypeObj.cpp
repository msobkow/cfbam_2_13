// Description: C++18 base object instance implementation for CFBam Int64Type.
...
namespace cfbam {
	...
	const std::string CFBamInt64TypeObj::CLASS_NAME( "CFBamInt64TypeObj" );
	const classcode_t CFBamInt64TypeObj::CLASS_CODE = 0xa828L;

	const int64_t CFBamInt64TypeObj::getRequiredSchemaDefId() {
		return( getInt64TypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamInt64TypeObj::getRequiredSchemaDefIdReference() {
		return( getInt64TypeBuff()->getRequiredSchemaDefIdReference() );
	}


	cfbam::ICFBamSchemaDefObj* CFBamInt64TypeObj::getRequiredContainerSchemaDef( bool forceRead ) {
	...
	CFBamInt64TypeObj::CFBamInt64TypeObj()
	: ICFBamInt64TypeObj(),
	  CFBamInt64DefObj()
	{
	}

	CFBamInt64TypeObj::CFBamInt64TypeObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamInt64TypeObj(),
	...
	cfbam::CFBamValueBuff* CFBamInt64TypeObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamInt64TypeBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableInt64Type()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamInt64TypeObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamInt64TypeObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamInt64TypeObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamInt64TypeObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamInt64TypeObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt64TypeObj" );
	...
	std::string CFBamInt64TypeObj::getObjName() {
	...
	const std::string CFBamInt64TypeObj::getGenDefName() {
		return( cfbam::CFBamInt64TypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamInt64TypeObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamInt64TypeObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamInt64TypeObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamInt64TypeObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamInt64TypeObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamInt64TypeObj::getObjQualifiedName() {
	...
	std::string CFBamInt64TypeObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamInt64TypeObj::realize() {
		cfbam::ICFBamInt64TypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt64TypeTableObj()->realizeInt64Type(
			(cfbam::ICFBamInt64TypeObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamInt64TypeObj::read( bool forceRead ) {
		cfbam::ICFBamInt64TypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt64TypeTableObj()->readInt64TypeByIdIdx( getInt64TypeBuff()->getRequiredTenantId(),
		getInt64TypeBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamInt64TypeObj::moveUp() {
		cfbam::ICFBamInt64TypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt64TypeTableObj()->moveUpInt64Type( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamInt64TypeObj::moveDown() {
		cfbam::ICFBamInt64TypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt64TypeTableObj()->moveDownInt64Type( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamInt64TypeObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamInt64TypeObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt64TypeTableObj()->lockInt64Type( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt64TypeTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamInt64TypeEditObj* CFBamInt64TypeObj::getInt64TypeEdit() {
		return( dynamic_cast<cfbam::ICFBamInt64TypeEditObj*>( edit ) );
	}
