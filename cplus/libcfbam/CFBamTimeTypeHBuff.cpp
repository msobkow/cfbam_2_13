// Description: C++18 implementation of a TimeType history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTimeTypeHBuff::CLASS_NAME( "CFBamTimeTypeHBuff" );
	CFBamTimeTypeHBuff::CFBamTimeTypeHBuff()
	: cfbam::CFBamTimeDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamTimeTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamTimeTypeHBuff::CFBamTimeTypeHBuff( const CFBamTimeTypeHBuff& src )
	: cfbam::CFBamTimeDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamTimeTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTimeTypeHBuff::clone() {
		CFBamTimeTypeHBuff* copy = new CFBamTimeTypeHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamTimeTypeHBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamTimeTypeHBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamTimeTypeHBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamTimeTypeHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamTimeTypeHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamTimeTypeHBuff CFBamTimeTypeHBuff::operator =( cfbam::CFBamTimeTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamTimeTypeHBuff CFBamTimeTypeHBuff::operator =( cfbam::CFBamTimeTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTimeTypeHBuff::operator <( const CFBamTimeTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamTimeTypeHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTimeTypeHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamTimeTypeHBuff::operator <( const CFBamTimeTypeHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamTimeTypeHBuff::operator <( const CFBamTimeTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTimeTypeHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTimeTypeHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamTimeTypeHBuff& lhs, const cfbam::CFBamTimeTypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTimeTypeHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTimeTypeHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTimeTypeHBuff& lhs, const cfbam::CFBamTimeTypeHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamTimeTypeHBuff& lhs, const cfbam::CFBamTimeTypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
