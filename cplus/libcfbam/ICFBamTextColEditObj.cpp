// Description: C++18 Instance Edit Object interface implementation for CFBam TextCol.
...
namespace cfbam {
	...
	const std::string ICFBamTextColEditObj::CLASS_NAME( "ICFBamTextColEditObj" );

	ICFBamTextColEditObj::ICFBamTextColEditObj()
