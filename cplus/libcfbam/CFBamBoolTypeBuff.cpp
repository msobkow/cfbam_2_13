// Description: C++18 implementation for a BoolType buffer object.
...
namespace cfbam {
	...
	const std::string CFBamBoolTypeBuff::GENDEFNAME( "BoolType" );
	const classcode_t CFBamBoolTypeBuff::CLASS_CODE = 0xa80eL;
	const std::string CFBamBoolTypeBuff::CLASS_NAME( "CFBamBoolTypeBuff" );
		const std::string CFBamBoolTypeBuff::COLNAME_SCHEMADEFID( "SchemaDefId" );
	const int64_t CFBamBoolTypeBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamBoolTypeBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamBoolTypeBuff::SCHEMADEFID_INIT_VALUE = 0LL;
	const int64_t CFBamBoolTypeBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamBoolTypeBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamBoolTypeBuff::SCHEMADEFID_MIN_VALUE = 0LL;

	CFBamBoolTypeBuff::CFBamBoolTypeBuff()
	: CFBamBoolDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamBoolTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamBoolTypeBuff::CFBamBoolTypeBuff( const CFBamBoolTypeBuff& src )
	: CFBamBoolDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamBoolTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamBoolTypeBuff::clone() {
		CFBamBoolTypeBuff* copy = new CFBamBoolTypeBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamBoolTypeBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamBoolTypeBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamBoolTypeBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamBoolDefBuff::implementsClassCode( argClassCode ) );
		}
	}

	const int64_t CFBamBoolTypeBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamBoolTypeBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamBoolTypeBuff::setRequiredSchemaDefId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredSchemaDefId" );
		if( value < cfbam::CFBamBoolTypeBuff::SCHEMADEFID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamBoolTypeBuff::SCHEMADEFID_MIN_VALUE );
		}
		requiredSchemaDefId = value;
	}

	size_t CFBamBoolTypeBuff::hashCode() const {
		size_t hashCode = CFBamBoolDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamBoolTypeBuff CFBamBoolTypeBuff::operator =( cfbam::CFBamBoolTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamBoolTypeBuff CFBamBoolTypeBuff::operator =( cfbam::CFBamBoolTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamBoolTypeBuff::operator <( const CFBamBoolTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamBoolTypeBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamBoolTypeBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamBoolTypeBuff::operator <( const CFBamBoolTypeHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamBoolTypeBuff::operator <( const CFBamBoolTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamBoolTypeBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamBoolTypeBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamBoolTypeBuff& lhs, const cfbam::CFBamBoolTypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamBoolTypeBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamBoolTypeBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamBoolTypeBuff& lhs, const cfbam::CFBamBoolTypeHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamBoolTypeBuff& lhs, const cfbam::CFBamBoolTypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
