// Description: C++18 implementation of a BoolDef history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamBoolDefHBuff::CLASS_NAME( "CFBamBoolDefHBuff" );
	CFBamBoolDefHBuff::CFBamBoolDefHBuff()
	...
	CFBamBoolDefHBuff::CFBamBoolDefHBuff( const CFBamBoolDefHBuff& src )
	: cfbam::CFBamAtomHBuff() {
		optionalInitValue.setNull();
		optionalFalseString = NULL;
		optionalTrueString = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamBoolDefHBuff::clone() {
		CFBamBoolDefHBuff* copy = new CFBamBoolDefHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const bool CFBamBoolDefHBuff::getOptionalInitValueValue() const {
		return( optionalInitValue.getValue() );
	}

	const bool* CFBamBoolDefHBuff::getOptionalInitValueReference() const {
		return( optionalInitValue.getReference() );
	}

	const bool CFBamBoolDefHBuff::isOptionalInitValueNull() const {
		return( optionalInitValue.isNull() );
	}

	void CFBamBoolDefHBuff::setOptionalInitValueNull() {
		optionalInitValue.setNull();
	}

	void CFBamBoolDefHBuff::setOptionalInitValueValue( const bool value ) {
		optionalInitValue.setValue( value );
	}

	const std::string& CFBamBoolDefHBuff::getOptionalFalseStringValue() const {
	...
	const std::string* CFBamBoolDefHBuff::getOptionalFalseStringReference() const {
		return( optionalFalseString );
	}

	const bool CFBamBoolDefHBuff::isOptionalFalseStringNull() const {
		return( optionalFalseString == NULL );
	}

	void CFBamBoolDefHBuff::setOptionalFalseStringNull() {
		if( optionalFalseString != NULL ) {
			delete optionalFalseString;
			optionalFalseString = NULL;
		}
	...
	void CFBamBoolDefHBuff::setOptionalFalseStringValue( const std::string& value ) {
	...
	const std::string& CFBamBoolDefHBuff::getOptionalTrueStringValue() const {
	...
	const std::string* CFBamBoolDefHBuff::getOptionalTrueStringReference() const {
		return( optionalTrueString );
	}

	const bool CFBamBoolDefHBuff::isOptionalTrueStringNull() const {
		return( optionalTrueString == NULL );
	}

	void CFBamBoolDefHBuff::setOptionalTrueStringNull() {
		if( optionalTrueString != NULL ) {
			delete optionalTrueString;
			optionalTrueString = NULL;
		}
	...
	void CFBamBoolDefHBuff::setOptionalTrueStringValue( const std::string& value ) {
	...
	const std::string& CFBamBoolDefHBuff::getOptionalNullStringValue() const {
	...
	const std::string* CFBamBoolDefHBuff::getOptionalNullStringReference() const {
		return( optionalNullString );
	}

	const bool CFBamBoolDefHBuff::isOptionalNullStringNull() const {
		return( optionalNullString == NULL );
	}

	void CFBamBoolDefHBuff::setOptionalNullStringNull() {
		if( optionalNullString != NULL ) {
			delete optionalNullString;
			optionalNullString = NULL;
		}
	...
	void CFBamBoolDefHBuff::setOptionalNullStringValue( const std::string& value ) {
	...
	size_t CFBamBoolDefHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamBoolDefHBuff::hashCode();
	...
	CFBamBoolDefHBuff CFBamBoolDefHBuff::operator =( cfbam::CFBamBoolDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamBoolDefHBuff CFBamBoolDefHBuff::operator =( cfbam::CFBamBoolDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamBoolDefHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamBoolDefHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamBoolDefHBuff::operator <( const CFBamBoolDefHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamBoolDefHBuff::operator <( const CFBamBoolDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamBoolDefHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamBoolDefHBuff" );
