// Description: C++18 implementation of a PopSubDep2 history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamPopSubDep2HBuff::CLASS_NAME( "CFBamPopSubDep2HBuff" );
	CFBamPopSubDep2HBuff::CFBamPopSubDep2HBuff()
	...
	CFBamPopSubDep2HBuff::CFBamPopSubDep2HBuff( const CFBamPopSubDep2HBuff& src )
	: cfbam::CFBamPopDepHBuff() {
		requiredPopSubDep1TenantId = cfbam::CFBamPopSubDep2Buff::POPSUBDEP1TENANTID_INIT_VALUE;
		requiredPopSubDep1Id = cfbam::CFBamPopSubDep2Buff::POPSUBDEP1ID_INIT_VALUE;
		requiredName = new std::string( cfbam::CFBamPopSubDep2Buff::NAME_INIT_VALUE );
	...
	cflib::ICFLibCloneableObj* CFBamPopSubDep2HBuff::clone() {
		CFBamPopSubDep2HBuff* copy = new CFBamPopSubDep2HBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamPopSubDep2HBuff::getRequiredPopSubDep1TenantId() const {
		return( requiredPopSubDep1TenantId );
	}

	const int64_t* CFBamPopSubDep2HBuff::getRequiredPopSubDep1TenantIdReference() const {
		return( &requiredPopSubDep1TenantId );
	}

	void CFBamPopSubDep2HBuff::setRequiredPopSubDep1TenantId( const int64_t value ) {
	...
	const int64_t CFBamPopSubDep2HBuff::getRequiredPopSubDep1Id() const {
		return( requiredPopSubDep1Id );
	}

	const int64_t* CFBamPopSubDep2HBuff::getRequiredPopSubDep1IdReference() const {
		return( &requiredPopSubDep1Id );
	}

	void CFBamPopSubDep2HBuff::setRequiredPopSubDep1Id( const int64_t value ) {
	...
	const std::string& CFBamPopSubDep2HBuff::getRequiredName() const {
		return( *requiredName );
	}

	const std::string* CFBamPopSubDep2HBuff::getRequiredNameReference() const {
		return( requiredName );
	}

	void CFBamPopSubDep2HBuff::setRequiredName( const std::string& value ) {
	...
	size_t CFBamPopSubDep2HBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamPopSubDep2HBuff::hashCode();
	...
	CFBamPopSubDep2HBuff CFBamPopSubDep2HBuff::operator =( cfbam::CFBamPopSubDep2Buff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		if( src.isOptionalDefSchemaTenantIdNull() ) {
	...
	CFBamPopSubDep2HBuff CFBamPopSubDep2HBuff::operator =( cfbam::CFBamPopSubDep2HBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		if( src.isOptionalDefSchemaTenantIdNull() ) {
	...
	bool CFBamPopSubDep2HBuff::operator <( const CFBamPopSubDep2ByPopSubDep1IdxKey& rhs ) {
	...
	bool CFBamPopSubDep2HBuff::operator <( const CFBamPopSubDep2ByUNameIdxKey& rhs ) {
		if( getRequiredPopSubDep1TenantId() > rhs.getRequiredPopSubDep1TenantId() ) {
			return( false );
		}
		else if( getRequiredPopSubDep1TenantId() < rhs.getRequiredPopSubDep1TenantId() ) {
	...
	bool CFBamPopSubDep2HBuff::operator <( const CFBamScopePKey& rhs ) {
	...
	bool CFBamPopSubDep2HBuff::operator <( const CFBamScopeHPKey& rhs ) {
	...
	bool CFBamPopSubDep2HBuff::operator <( const CFBamPopSubDep2HBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamPopSubDep2HBuff::operator <( const CFBamPopSubDep2Buff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamPopSubDep2HBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamPopSubDep2HBuff" );
