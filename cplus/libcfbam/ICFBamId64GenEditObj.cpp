// Description: C++18 Instance Edit Object interface implementation for CFBam Id64Gen.
...
namespace cfbam {
	...
	const std::string ICFBamId64GenEditObj::CLASS_NAME( "ICFBamId64GenEditObj" );

	ICFBamId64GenEditObj::ICFBamId64GenEditObj()
