// Description: C++18 implementation for a Value by PrevIdx index key object.
...
namespace cfbam {
	const std::string CFBamValueByPrevIdxKey::CLASS_NAME( "CFBamValueByPrevIdxKey" );
	const std::string CFBamValueByPrevIdxKey::S_VALUE( "value" );
	const std::string CFBamValueByPrevIdxKey::S_VALUE_LENGTH( "value.length()" );


	CFBamValueByPrevIdxKey::CFBamValueByPrevIdxKey() {
		optionalPrevTenantId.setNull();
		optionalPrevId.setNull();
	}

	CFBamValueByPrevIdxKey::CFBamValueByPrevIdxKey( const CFBamValueByPrevIdxKey& src ) {
		optionalPrevTenantId.setNull();
		optionalPrevId.setNull();
	...
	const int64_t CFBamValueByPrevIdxKey::getOptionalPrevTenantIdValue() const {
		return( optionalPrevTenantId.getValue() );
	}

	const int64_t* CFBamValueByPrevIdxKey::getOptionalPrevTenantIdReference() const {
		return( optionalPrevTenantId.getReference() );
	}

	const bool CFBamValueByPrevIdxKey::isOptionalPrevTenantIdNull() const {
		return( optionalPrevTenantId.isNull() );
	}

	void CFBamValueByPrevIdxKey::setOptionalPrevTenantIdNull() {
		optionalPrevTenantId.setNull();
	}

	void CFBamValueByPrevIdxKey::setOptionalPrevTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamValueByPrevIdxKey::getOptionalPrevIdValue() const {
		return( optionalPrevId.getValue() );
	}

	const int64_t* CFBamValueByPrevIdxKey::getOptionalPrevIdReference() const {
		return( optionalPrevId.getReference() );
	}

	const bool CFBamValueByPrevIdxKey::isOptionalPrevIdNull() const {
		return( optionalPrevId.isNull() );
	}

	void CFBamValueByPrevIdxKey::setOptionalPrevIdNull() {
		optionalPrevId.setNull();
	}

	void CFBamValueByPrevIdxKey::setOptionalPrevIdValue( const int64_t value ) {
	...
	size_t CFBamValueByPrevIdxKey::hashCode() const {
		size_t hashCode = 0;
	...
	std::string CFBamValueByPrevIdxKey::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamValueByPrevIdxKey" );
	...
	bool CFBamValueByPrevIdxKey::operator <( const CFBamValueByPrevIdxKey& rhs ) {
		if( ! isOptionalPrevTenantIdNull() ) {
	...
	bool CFBamValueByPrevIdxKey::operator <( const CFBamValueHBuff& rhs ) {
		if( ! isOptionalPrevTenantIdNull() ) {
			if( rhs.isOptionalPrevTenantIdNull() ) {
				return( false );
			}
	...
	bool CFBamValueByPrevIdxKey::operator <( const CFBamValueBuff& rhs ) {
		if( ! isOptionalPrevTenantIdNull() ) {
			if( rhs.isOptionalPrevTenantIdNull() ) {
				return( false );
			}
	...
	CFBamValueByPrevIdxKey CFBamValueByPrevIdxKey::operator =( cfbam::CFBamValueByPrevIdxKey& src ) {
		if( src.isOptionalPrevTenantIdNull() ) {
			setOptionalPrevTenantIdNull();
		}
		else {
	...
	CFBamValueByPrevIdxKey CFBamValueByPrevIdxKey::operator =( cfbam::CFBamValueBuff& src ) {
		if( src.isOptionalPrevTenantIdNull() ) {
			setOptionalPrevTenantIdNull();
		}
		else {
	...
	CFBamValueByPrevIdxKey CFBamValueByPrevIdxKey::operator =( cfbam::CFBamValueHBuff& src ) {
		if( src.isOptionalPrevTenantIdNull() ) {
			setOptionalPrevTenantIdNull();
		}
		else {
