// Description: C++18 implementation of a StringType history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamStringTypeHBuff::CLASS_NAME( "CFBamStringTypeHBuff" );
	CFBamStringTypeHBuff::CFBamStringTypeHBuff()
	: cfbam::CFBamStringDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamStringTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamStringTypeHBuff::CFBamStringTypeHBuff( const CFBamStringTypeHBuff& src )
	: cfbam::CFBamStringDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamStringTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamStringTypeHBuff::clone() {
		CFBamStringTypeHBuff* copy = new CFBamStringTypeHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamStringTypeHBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamStringTypeHBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamStringTypeHBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamStringTypeHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamStringTypeHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamStringTypeHBuff CFBamStringTypeHBuff::operator =( cfbam::CFBamStringTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamStringTypeHBuff CFBamStringTypeHBuff::operator =( cfbam::CFBamStringTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamStringTypeHBuff::operator <( const CFBamStringTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamStringTypeHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamStringTypeHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamStringTypeHBuff::operator <( const CFBamStringTypeHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamStringTypeHBuff::operator <( const CFBamStringTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamStringTypeHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamStringTypeHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamStringTypeHBuff& lhs, const cfbam::CFBamStringTypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamStringTypeHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamStringTypeHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamStringTypeHBuff& lhs, const cfbam::CFBamStringTypeHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamStringTypeHBuff& lhs, const cfbam::CFBamStringTypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
