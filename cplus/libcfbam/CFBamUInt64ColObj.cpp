// Description: C++18 base object instance implementation for CFBam UInt64Col.
...
namespace cfbam {
	...
	const std::string CFBamUInt64ColObj::CLASS_NAME( "CFBamUInt64ColObj" );
	const classcode_t CFBamUInt64ColObj::CLASS_CODE = 0xa86cL;

	const int64_t CFBamUInt64ColObj::getRequiredTableId() {
		return( getUInt64ColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamUInt64ColObj::getRequiredTableIdReference() {
		return( getUInt64ColBuff()->getRequiredTableIdReference() );
	}


	cfbam::ICFBamTableObj* CFBamUInt64ColObj::getRequiredContainerTable( bool forceRead ) {
	...
	CFBamUInt64ColObj::CFBamUInt64ColObj()
	: ICFBamUInt64ColObj(),
	  CFBamUInt64DefObj()
	{
	}

	CFBamUInt64ColObj::CFBamUInt64ColObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamUInt64ColObj(),
	...
	cfbam::CFBamValueBuff* CFBamUInt64ColObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamUInt64ColBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableUInt64Col()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamUInt64ColObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamUInt64ColObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUInt64ColObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamUInt64ColObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamUInt64ColObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt64ColObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamUInt64ColObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamUInt64ColObj::getObjName() {
	...
	const std::string CFBamUInt64ColObj::getGenDefName() {
		return( cfbam::CFBamUInt64ColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamUInt64ColObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamUInt64ColObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamUInt64ColObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamUInt64ColObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamUInt64ColObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamUInt64ColObj::getObjQualifiedName() {
	...
	std::string CFBamUInt64ColObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamUInt64ColObj::realize() {
		cfbam::ICFBamUInt64ColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt64ColTableObj()->realizeUInt64Col(
			(cfbam::ICFBamUInt64ColObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUInt64ColObj::read( bool forceRead ) {
		cfbam::ICFBamUInt64ColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt64ColTableObj()->readUInt64ColByIdIdx( getUInt64ColBuff()->getRequiredTenantId(),
		getUInt64ColBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUInt64ColObj::moveUp() {
		cfbam::ICFBamUInt64ColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt64ColTableObj()->moveUpUInt64Col( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUInt64ColObj::moveDown() {
		cfbam::ICFBamUInt64ColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt64ColTableObj()->moveDownUInt64Col( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamUInt64ColObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamUInt64ColObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt64ColTableObj()->lockUInt64Col( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt64ColTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamUInt64ColEditObj* CFBamUInt64ColObj::getUInt64ColEdit() {
		return( dynamic_cast<cfbam::ICFBamUInt64ColEditObj*>( edit ) );
	}
