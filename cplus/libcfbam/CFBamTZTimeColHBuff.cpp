// Description: C++18 implementation of a TZTimeCol history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTZTimeColHBuff::CLASS_NAME( "CFBamTZTimeColHBuff" );
	CFBamTZTimeColHBuff::CFBamTZTimeColHBuff()
	: cfbam::CFBamTZTimeDefHBuff() {
		requiredTableId = cfbam::CFBamTZTimeColBuff::TABLEID_INIT_VALUE;
	}

	CFBamTZTimeColHBuff::CFBamTZTimeColHBuff( const CFBamTZTimeColHBuff& src )
	: cfbam::CFBamTZTimeDefHBuff() {
		requiredTableId = cfbam::CFBamTZTimeColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTZTimeColHBuff::clone() {
		CFBamTZTimeColHBuff* copy = new CFBamTZTimeColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamTZTimeColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamTZTimeColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamTZTimeColHBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamTZTimeColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamTZTimeColHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamTZTimeColHBuff CFBamTZTimeColHBuff::operator =( cfbam::CFBamTZTimeColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamTZTimeColHBuff CFBamTZTimeColHBuff::operator =( cfbam::CFBamTZTimeColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTZTimeColHBuff::operator <( const CFBamTZTimeColByTableIdxKey& rhs ) {
	...
	bool CFBamTZTimeColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZTimeColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamTZTimeColHBuff::operator <( const CFBamTZTimeColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamTZTimeColHBuff::operator <( const CFBamTZTimeColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTZTimeColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZTimeColHBuff" );
