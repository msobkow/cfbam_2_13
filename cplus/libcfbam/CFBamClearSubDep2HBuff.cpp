// Description: C++18 implementation of a ClearSubDep2 history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamClearSubDep2HBuff::CLASS_NAME( "CFBamClearSubDep2HBuff" );
	CFBamClearSubDep2HBuff::CFBamClearSubDep2HBuff()
	...
	CFBamClearSubDep2HBuff::CFBamClearSubDep2HBuff( const CFBamClearSubDep2HBuff& src )
	: cfbam::CFBamClearDepHBuff() {
		requiredClearSubDep1TenantId = cfbam::CFBamClearSubDep2Buff::CLEARSUBDEP1TENANTID_INIT_VALUE;
		requiredClearSubDep1Id = cfbam::CFBamClearSubDep2Buff::CLEARSUBDEP1ID_INIT_VALUE;
		requiredName = new std::string( cfbam::CFBamClearSubDep2Buff::NAME_INIT_VALUE );
	...
	cflib::ICFLibCloneableObj* CFBamClearSubDep2HBuff::clone() {
		CFBamClearSubDep2HBuff* copy = new CFBamClearSubDep2HBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamClearSubDep2HBuff::getRequiredClearSubDep1TenantId() const {
		return( requiredClearSubDep1TenantId );
	}

	const int64_t* CFBamClearSubDep2HBuff::getRequiredClearSubDep1TenantIdReference() const {
		return( &requiredClearSubDep1TenantId );
	}

	void CFBamClearSubDep2HBuff::setRequiredClearSubDep1TenantId( const int64_t value ) {
	...
	const int64_t CFBamClearSubDep2HBuff::getRequiredClearSubDep1Id() const {
		return( requiredClearSubDep1Id );
	}

	const int64_t* CFBamClearSubDep2HBuff::getRequiredClearSubDep1IdReference() const {
		return( &requiredClearSubDep1Id );
	}

	void CFBamClearSubDep2HBuff::setRequiredClearSubDep1Id( const int64_t value ) {
	...
	const std::string& CFBamClearSubDep2HBuff::getRequiredName() const {
		return( *requiredName );
	}

	const std::string* CFBamClearSubDep2HBuff::getRequiredNameReference() const {
		return( requiredName );
	}

	void CFBamClearSubDep2HBuff::setRequiredName( const std::string& value ) {
	...
	size_t CFBamClearSubDep2HBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamClearSubDep2HBuff::hashCode();
	...
	CFBamClearSubDep2HBuff CFBamClearSubDep2HBuff::operator =( cfbam::CFBamClearSubDep2Buff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredRelationId( src.getRequiredRelationId() );
	...
	CFBamClearSubDep2HBuff CFBamClearSubDep2HBuff::operator =( cfbam::CFBamClearSubDep2HBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredRelationId( src.getRequiredRelationId() );
	...
	bool CFBamClearSubDep2HBuff::operator <( const CFBamClearSubDep2ByClearSubDep1IdxKey& rhs ) {
	...
	bool CFBamClearSubDep2HBuff::operator <( const CFBamClearSubDep2ByUNameIdxKey& rhs ) {
		if( getRequiredClearSubDep1TenantId() > rhs.getRequiredClearSubDep1TenantId() ) {
			return( false );
		}
		else if( getRequiredClearSubDep1TenantId() < rhs.getRequiredClearSubDep1TenantId() ) {
	...
	bool CFBamClearSubDep2HBuff::operator <( const CFBamScopePKey& rhs ) {
	...
	bool CFBamClearSubDep2HBuff::operator <( const CFBamScopeHPKey& rhs ) {
	...
	bool CFBamClearSubDep2HBuff::operator <( const CFBamClearSubDep2HBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamClearSubDep2HBuff::operator <( const CFBamClearSubDep2Buff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamClearSubDep2HBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamClearSubDep2HBuff" );
