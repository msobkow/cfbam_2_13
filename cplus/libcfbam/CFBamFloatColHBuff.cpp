// Description: C++18 implementation of a FloatCol history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamFloatColHBuff::CLASS_NAME( "CFBamFloatColHBuff" );
	CFBamFloatColHBuff::CFBamFloatColHBuff()
	: cfbam::CFBamFloatDefHBuff() {
		requiredTableId = cfbam::CFBamFloatColBuff::TABLEID_INIT_VALUE;
	}

	CFBamFloatColHBuff::CFBamFloatColHBuff( const CFBamFloatColHBuff& src )
	: cfbam::CFBamFloatDefHBuff() {
		requiredTableId = cfbam::CFBamFloatColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamFloatColHBuff::clone() {
		CFBamFloatColHBuff* copy = new CFBamFloatColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamFloatColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamFloatColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamFloatColHBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamFloatColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamFloatColHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamFloatColHBuff CFBamFloatColHBuff::operator =( cfbam::CFBamFloatColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamFloatColHBuff CFBamFloatColHBuff::operator =( cfbam::CFBamFloatColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamFloatColHBuff::operator <( const CFBamFloatColByTableIdxKey& rhs ) {
	...
	bool CFBamFloatColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamFloatColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamFloatColHBuff::operator <( const CFBamFloatColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamFloatColHBuff::operator <( const CFBamFloatColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamFloatColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamFloatColHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamFloatColHBuff& lhs, const cfbam::CFBamFloatColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamFloatColHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamFloatColHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamFloatColHBuff& lhs, const cfbam::CFBamFloatColHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamFloatColHBuff& lhs, const cfbam::CFBamFloatColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
