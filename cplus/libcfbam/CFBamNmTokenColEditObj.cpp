// Description: C++18 edit object instance implementation for CFBam NmTokenCol.
...
namespace cfbam {
	...
	const std::string CFBamNmTokenColEditObj::CLASS_NAME( "CFBamNmTokenColEditObj" );

	CFBamNmTokenColEditObj::CFBamNmTokenColEditObj( cfbam::ICFBamNmTokenColObj* argOrig )
	: ICFBamNmTokenColEditObj(),
	  CFBamNmTokenDefEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamNmTokenColEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamNmTokenColEditObj::~CFBamNmTokenColEditObj() {
	}

	const std::string& CFBamNmTokenColEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamNmTokenColEditObj::getClassCode() const {
		return( cfbam::CFBamNmTokenColBuff::CLASS_CODE );
	}

	bool CFBamNmTokenColEditObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamNmTokenColBuff::CLASS_CODE ) {
			return( true );
		}
		else {
	...
	std::string CFBamNmTokenColEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNmTokenColEditObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamNmTokenColEditObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	const std::string CFBamNmTokenColEditObj::getGenDefName() {
		return( cfbam::CFBamNmTokenColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamNmTokenColEditObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamNmTokenColEditObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamNmTokenColEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamNmTokenColEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamNmTokenColEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamNmTokenColEditObj::getObjQualifiedName() {
	...
	std::string CFBamNmTokenColEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamNmTokenColEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamNmTokenColObj* retobj = getSchema()->getNmTokenColTableObj()->realizeNmTokenCol( dynamic_cast<cfbam::ICFBamNmTokenColObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamNmTokenColEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamNmTokenColEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamNmTokenColEditObj::create() {
		cfbam::ICFBamNmTokenColObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsNmTokenCol()->getSchema() )->getNmTokenColTableObj()->createNmTokenCol( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamNmTokenColEditObj::update() {
		getSchema()->getNmTokenColTableObj()->updateNmTokenCol( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamNmTokenColEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getNmTokenColTableObj()->deleteNmTokenCol( this );
		return( NULL );
	}

	cfbam::ICFBamNmTokenColTableObj* CFBamNmTokenColEditObj::getNmTokenColTable() {
		return( orig->getSchema()->getNmTokenColTableObj() );
	}

	cfbam::ICFBamNmTokenColEditObj* CFBamNmTokenColEditObj::getNmTokenColEdit() {
		return( (cfbam::ICFBamNmTokenColEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamNmTokenColEditObj::beginEdit() {
	...
	cfbam::ICFBamNmTokenColObj* CFBamNmTokenColEditObj::getOrigAsNmTokenCol() {
		return( dynamic_cast<cfbam::ICFBamNmTokenColObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamNmTokenColEditObj::getBuff() {
		return( buff );
	}

	void CFBamNmTokenColEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamNmTokenDefEditObj::setBuff( value );
		}
	}

	const int64_t CFBamNmTokenColEditObj::getRequiredTableId() {
		return( getNmTokenColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamNmTokenColEditObj::getRequiredTableIdReference() {
		return( getNmTokenColBuff()->getRequiredTableIdReference() );
	}

	void CFBamNmTokenColEditObj::setRequiredContainerScope( cfbam::ICFBamScopeObj* value ) {
		if( value == NULL ) {
	...
	cfbam::ICFBamTableObj* CFBamNmTokenColEditObj::getRequiredContainerTable( bool forceRead ) {
		cfbam::ICFBamTableObj* retobj = NULL;
		bool anyMissing = false;
		if( ! anyMissing ) {
			retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsNmTokenCol()->getSchema() )->getTableTableObj()->readTableByIdIdx( getPKey()->getRequiredTenantId(),
					getNmTokenColBuff()->getRequiredTableId() );
		}
		return( retobj );
	}

	void CFBamNmTokenColEditObj::setRequiredContainerTable( cfbam::ICFBamTableObj* value ) {
			
			if( value != NULL ) {
				getPKey()->setRequiredTenantId
( value->getRequiredTenantId() );
				getNmTokenColEditBuff()->setRequiredTenantId( value->getRequiredTenantId() );
				getNmTokenColEditBuff()->setRequiredTableId( value->getRequiredId() );
			}

			CFBamNmTokenDefEditObj::setRequiredContainerScope( value );		}

	void CFBamNmTokenColEditObj::copyBuffToOrig() {
		cfbam::CFBamNmTokenColBuff* origBuff = getOrigAsNmTokenCol()->getNmTokenColEditBuff();
		cfbam::CFBamNmTokenColBuff* myBuff = getNmTokenColBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamNmTokenColEditObj::copyOrigToBuff() {
		cfbam::CFBamNmTokenColBuff* origBuff = getOrigAsNmTokenCol()->getNmTokenColBuff();
		cfbam::CFBamNmTokenColBuff* myBuff = getNmTokenColEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
