// Description: C++18 implementation for a TokenCol buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTokenColBuff::GENDEFNAME( "TokenCol" );
	const classcode_t CFBamTokenColBuff::CLASS_CODE = 0xa869L;
	const std::string CFBamTokenColBuff::CLASS_NAME( "CFBamTokenColBuff" );
		const std::string CFBamTokenColBuff::COLNAME_TABLEID( "TableId" );
	const int64_t CFBamTokenColBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamTokenColBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamTokenColBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamTokenColBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamTokenColBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamTokenColBuff::TABLEID_MIN_VALUE = 0LL;

	CFBamTokenColBuff::CFBamTokenColBuff()
	: CFBamTokenDefBuff()
	{
		requiredTableId = cfbam::CFBamTokenColBuff::TABLEID_INIT_VALUE;
	}

	CFBamTokenColBuff::CFBamTokenColBuff( const CFBamTokenColBuff& src )
	: CFBamTokenDefBuff()
	{
		requiredTableId = cfbam::CFBamTokenColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTokenColBuff::clone() {
		CFBamTokenColBuff* copy = new CFBamTokenColBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTokenColBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTokenColBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTokenColBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFBamTokenColBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamTokenColBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamTokenColBuff::setRequiredTableId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredTableId" );
		if( value < cfbam::CFBamTokenColBuff::TABLEID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamTokenColBuff::TABLEID_MIN_VALUE );
		}
		requiredTableId = value;
	}

	size_t CFBamTokenColBuff::hashCode() const {
		size_t hashCode = CFBamTokenDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamTokenColBuff CFBamTokenColBuff::operator =( cfbam::CFBamTokenColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamTokenColBuff CFBamTokenColBuff::operator =( cfbam::CFBamTokenColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTokenColBuff::operator <( const CFBamTokenColByTableIdxKey& rhs ) {
	...
	bool CFBamTokenColBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTokenColBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTokenColBuff::operator <( const CFBamTokenColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTokenColBuff::operator <( const CFBamTokenColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTokenColBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTokenColBuff" );
