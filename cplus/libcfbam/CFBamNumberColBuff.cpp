// Description: C++18 implementation for a NumberCol buffer object.
...
namespace cfbam {
	...
	const std::string CFBamNumberColBuff::GENDEFNAME( "NumberCol" );
	const classcode_t CFBamNumberColBuff::CLASS_CODE = 0xa861L;
	const std::string CFBamNumberColBuff::CLASS_NAME( "CFBamNumberColBuff" );
		const std::string CFBamNumberColBuff::COLNAME_TABLEID( "TableId" );
	const int64_t CFBamNumberColBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamNumberColBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamNumberColBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamNumberColBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamNumberColBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamNumberColBuff::TABLEID_MIN_VALUE = 0LL;

	CFBamNumberColBuff::CFBamNumberColBuff()
	: CFBamNumberDefBuff()
	{
		requiredTableId = cfbam::CFBamNumberColBuff::TABLEID_INIT_VALUE;
	}

	CFBamNumberColBuff::CFBamNumberColBuff( const CFBamNumberColBuff& src )
	: CFBamNumberDefBuff()
	{
		requiredTableId = cfbam::CFBamNumberColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamNumberColBuff::clone() {
		CFBamNumberColBuff* copy = new CFBamNumberColBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamNumberColBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamNumberColBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamNumberColBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFBamNumberColBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamNumberColBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamNumberColBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamNumberColBuff::hashCode() const {
		size_t hashCode = CFBamNumberDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamNumberColBuff CFBamNumberColBuff::operator =( cfbam::CFBamNumberColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamNumberColBuff CFBamNumberColBuff::operator =( cfbam::CFBamNumberColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamNumberColBuff::operator <( const CFBamNumberColByTableIdxKey& rhs ) {
	...
	bool CFBamNumberColBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNumberColBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNumberColBuff::operator <( const CFBamNumberColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNumberColBuff::operator <( const CFBamNumberColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamNumberColBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNumberColBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamNumberColBuff& lhs, const cfbam::CFBamNumberColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamNumberColBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamNumberColBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamNumberColBuff& lhs, const cfbam::CFBamNumberColHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamNumberColBuff& lhs, const cfbam::CFBamNumberColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
