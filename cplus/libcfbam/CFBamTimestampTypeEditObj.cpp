// Description: C++18 edit object instance implementation for CFBam TimestampType.
...
namespace cfbam {
	...
	const std::string CFBamTimestampTypeEditObj::CLASS_NAME( "CFBamTimestampTypeEditObj" );

	CFBamTimestampTypeEditObj::CFBamTimestampTypeEditObj( cfbam::ICFBamTimestampTypeObj* argOrig )
	: ICFBamTimestampTypeEditObj(),
	  CFBamTimestampDefEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamTimestampTypeEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamTimestampTypeEditObj::~CFBamTimestampTypeEditObj() {
	}

	const std::string& CFBamTimestampTypeEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTimestampTypeEditObj::getClassCode() const {
		return( cfbam::CFBamTimestampTypeBuff::CLASS_CODE );
	}

	bool CFBamTimestampTypeEditObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamTimestampTypeBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamTimestampDefEditObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamTimestampTypeEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTimestampTypeEditObj" );
		...
		if( ! CFBamTimestampDefEditObj::isOptionalDummyNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredXmlString( &S_Space, S_Dummy, CFBamTimestampDefEditObj::getOptionalDummyValue() ) );
		}
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamTimestampTypeEditObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	const std::string CFBamTimestampTypeEditObj::getGenDefName() {
		return( cfbam::CFBamTimestampTypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTimestampTypeEditObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTimestampTypeEditObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTimestampTypeEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTimestampTypeEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTimestampTypeEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTimestampTypeEditObj::getObjQualifiedName() {
	...
	std::string CFBamTimestampTypeEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTimestampTypeEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamTimestampTypeObj* retobj = getSchema()->getTimestampTypeTableObj()->realizeTimestampType( dynamic_cast<cfbam::ICFBamTimestampTypeObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamTimestampTypeEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamTimestampTypeEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamTimestampTypeEditObj::create() {
		cfbam::ICFBamTimestampTypeObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsTimestampType()->getSchema() )->getTimestampTypeTableObj()->createTimestampType( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamTimestampTypeEditObj::update() {
		getSchema()->getTimestampTypeTableObj()->updateTimestampType( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamTimestampTypeEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getTimestampTypeTableObj()->deleteTimestampType( this );
		return( NULL );
	}

	cfbam::ICFBamTimestampTypeTableObj* CFBamTimestampTypeEditObj::getTimestampTypeTable() {
		return( orig->getSchema()->getTimestampTypeTableObj() );
	}

	cfbam::ICFBamTimestampTypeEditObj* CFBamTimestampTypeEditObj::getTimestampTypeEdit() {
		return( (cfbam::ICFBamTimestampTypeEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamTimestampTypeEditObj::beginEdit() {
	...
	cfbam::ICFBamTimestampTypeObj* CFBamTimestampTypeEditObj::getOrigAsTimestampType() {
		return( dynamic_cast<cfbam::ICFBamTimestampTypeObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamTimestampTypeEditObj::getBuff() {
		return( buff );
	}

	void CFBamTimestampTypeEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamTimestampDefEditObj::setBuff( value );
		}
	}

	const int64_t CFBamTimestampTypeEditObj::getRequiredSchemaDefId() {
		return( getTimestampTypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamTimestampTypeEditObj::getRequiredSchemaDefIdReference() {
		return( getTimestampTypeBuff()->getRequiredSchemaDefIdReference() );
	}

	void CFBamTimestampTypeEditObj::setRequiredContainerScope( cfbam::ICFBamScopeObj* value ) {
		if( value == NULL ) {
	...
	cfbam::ICFBamSchemaDefObj* CFBamTimestampTypeEditObj::getRequiredContainerSchemaDef( bool forceRead ) {
		cfbam::ICFBamSchemaDefObj* retobj = NULL;
		bool anyMissing = false;
		if( ! anyMissing ) {
			retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsTimestampType()->getSchema() )->getSchemaDefTableObj()->readSchemaDefByIdIdx( getPKey()->getRequiredTenantId(),
					getTimestampTypeBuff()->getRequiredSchemaDefId() );
		}
		return( retobj );
	}

	void CFBamTimestampTypeEditObj::setRequiredContainerSchemaDef( cfbam::ICFBamSchemaDefObj* value ) {
			
			if( value != NULL ) {
				getPKey()->setRequiredTenantId
( value->getRequiredTenantId() );
				getTimestampTypeEditBuff()->setRequiredTenantId( value->getRequiredTenantId() );
				getTimestampTypeEditBuff()->setRequiredSchemaDefId( value->getRequiredId() );
			}

			CFBamTimestampDefEditObj::setRequiredContainerScope( value );		}

	void CFBamTimestampTypeEditObj::copyBuffToOrig() {
		cfbam::CFBamTimestampTypeBuff* origBuff = getOrigAsTimestampType()->getTimestampTypeEditBuff();
		cfbam::CFBamTimestampTypeBuff* myBuff = getTimestampTypeBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamTimestampTypeEditObj::copyOrigToBuff() {
		cfbam::CFBamTimestampTypeBuff* origBuff = getOrigAsTimestampType()->getTimestampTypeBuff();
		cfbam::CFBamTimestampTypeBuff* myBuff = getTimestampTypeEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
