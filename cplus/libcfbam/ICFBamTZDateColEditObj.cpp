// Description: C++18 Instance Edit Object interface implementation for CFBam TZDateCol.
...
namespace cfbam {
	...
	const std::string ICFBamTZDateColEditObj::CLASS_NAME( "ICFBamTZDateColEditObj" );

	ICFBamTZDateColEditObj::ICFBamTZDateColEditObj()
