// Description: C++18 implementation of a TZTimeType history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTZTimeTypeHBuff::CLASS_NAME( "CFBamTZTimeTypeHBuff" );
	CFBamTZTimeTypeHBuff::CFBamTZTimeTypeHBuff()
	: cfbam::CFBamTZTimeDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamTZTimeTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamTZTimeTypeHBuff::CFBamTZTimeTypeHBuff( const CFBamTZTimeTypeHBuff& src )
	: cfbam::CFBamTZTimeDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamTZTimeTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTZTimeTypeHBuff::clone() {
		CFBamTZTimeTypeHBuff* copy = new CFBamTZTimeTypeHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamTZTimeTypeHBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamTZTimeTypeHBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamTZTimeTypeHBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamTZTimeTypeHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamTZTimeTypeHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamTZTimeTypeHBuff CFBamTZTimeTypeHBuff::operator =( cfbam::CFBamTZTimeTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamTZTimeTypeHBuff CFBamTZTimeTypeHBuff::operator =( cfbam::CFBamTZTimeTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTZTimeTypeHBuff::operator <( const CFBamTZTimeTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamTZTimeTypeHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZTimeTypeHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamTZTimeTypeHBuff::operator <( const CFBamTZTimeTypeHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamTZTimeTypeHBuff::operator <( const CFBamTZTimeTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTZTimeTypeHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZTimeTypeHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamTZTimeTypeHBuff& lhs, const cfbam::CFBamTZTimeTypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTZTimeTypeHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamTZTimeTypeHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamTZTimeTypeHBuff& lhs, const cfbam::CFBamTZTimeTypeHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamTZTimeTypeHBuff& lhs, const cfbam::CFBamTZTimeTypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
