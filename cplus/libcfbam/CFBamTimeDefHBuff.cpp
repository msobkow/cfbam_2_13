// Description: C++18 implementation of a TimeDef history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTimeDefHBuff::CLASS_NAME( "CFBamTimeDefHBuff" );
	CFBamTimeDefHBuff::CFBamTimeDefHBuff()
	: cfbam::CFBamAtomHBuff() {
		optionalDummy = NULL;
	}

	CFBamTimeDefHBuff::CFBamTimeDefHBuff( const CFBamTimeDefHBuff& src )
	: cfbam::CFBamAtomHBuff() {
		optionalDummy = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamTimeDefHBuff::clone() {
		CFBamTimeDefHBuff* copy = new CFBamTimeDefHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamTimeDefHBuff::getOptionalDummyValue() const {
	...
	const std::string* CFBamTimeDefHBuff::getOptionalDummyReference() const {
		return( optionalDummy );
	}

	const bool CFBamTimeDefHBuff::isOptionalDummyNull() const {
		return( optionalDummy == NULL );
	}

	void CFBamTimeDefHBuff::setOptionalDummyNull() {
		if( optionalDummy != NULL ) {
			delete optionalDummy;
			optionalDummy = NULL;
		}
	...
	void CFBamTimeDefHBuff::setOptionalDummyValue( const std::string& value ) {
	...
	size_t CFBamTimeDefHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamTimeDefHBuff::hashCode();
	...
	CFBamTimeDefHBuff CFBamTimeDefHBuff::operator =( cfbam::CFBamTimeDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamTimeDefHBuff CFBamTimeDefHBuff::operator =( cfbam::CFBamTimeDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTimeDefHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamTimeDefHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamTimeDefHBuff::operator <( const CFBamTimeDefHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamTimeDefHBuff::operator <( const CFBamTimeDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTimeDefHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTimeDefHBuff" );
