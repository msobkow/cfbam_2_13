...
namespace cfbam {
	...
	const std::string CFBamISOCtryLangTableObj::CLASS_NAME( "CFBamISOCtryLangTableObj" );
	const std::string CFBamISOCtryLangTableObj::TABLE_NAME( "ISOCtryLang" );
	const std::string CFBamISOCtryLangTableObj::TABLE_DBNAME( "iso_cntrylng" );

	CFBamISOCtryLangTableObj::CFBamISOCtryLangTableObj() {
		schema = NULL;
	...
	CFBamISOCtryLangTableObj::CFBamISOCtryLangTableObj( cfsec::ICFSecSchemaObj* argSchema ) {
	...
	cfsec::ICFSecSchemaObj* CFBamISOCtryLangTableObj::getSchema() {
		return( schema );
	}

	void CFBamISOCtryLangTableObj::setSchema( cfsec::ICFSecSchemaObj* value ) {
		schema = dynamic_cast<cfbam::ICFBamSchemaObj*>( value );
	}

	const std::string CFBamISOCtryLangTableObj::getTableName() {
		return( TABLE_NAME );
	}

	const std::string CFBamISOCtryLangTableObj::getTableDbName() {
		return( TABLE_DBNAME );
	}
	const classcode_t* CFBamISOCtryLangTableObj::getObjQualifyingClassCode() {
		return( NULL );
	}


	void CFBamISOCtryLangTableObj::minimizeMemory() {
	...
	cfsec::ICFSecISOCtryLangObj* CFBamISOCtryLangTableObj::newInstance() {
		cfsec::ICFSecISOCtryLangObj* inst = dynamic_cast<cfsec::ICFSecISOCtryLangObj*>( new CFBamISOCtryLangObj( schema ) );
		return( inst );
	}

	cfsec::ICFSecISOCtryLangEditObj* CFBamISOCtryLangTableObj::newEditInstance( cfsec::ICFSecISOCtryLangObj* orig ) {
		cfsec::ICFSecISOCtryLangEditObj* edit = dynamic_cast<cfsec::ICFSecISOCtryLangEditObj*>( new CFBamISOCtryLangEditObj( orig ));
		return( edit );
	}

	cfsec::ICFSecISOCtryLangObj* CFBamISOCtryLangTableObj::realizeISOCtryLang( cfsec::ICFSecISOCtryLangObj* Obj ) {
	...
	void CFBamISOCtryLangTableObj::deepDisposeByIdIdx( const int16_t ISOCtryId,
		...
		while( listIter != listEnd ) {
			...
			if( cur != NULL ) {
				...
				if( classCode == cfsec::CFSecISOCtryLangBuff::CLASS_CODE ) {
					dynamic_cast<cfbam::CFBamISOCtryLangTableObj*>( schema->getISOCtryLangTableObj() )->reallyDeepDisposeISOCtryLang( dynamic_cast<cfsec::ICFSecISOCtryLangObj*>( cur ) );
				}
			}
			listIter ++;
		}
	...
	void CFBamISOCtryLangTableObj::deepDisposeByCtryIdx( const int16_t ISOCtryId ) {
	...
	void CFBamISOCtryLangTableObj::deepDisposeByLangIdx( const int16_t ISOLangId ) {
	...
	void CFBamISOCtryLangTableObj::reallyDeepDisposeISOCtryLang( cfsec::ICFSecISOCtryLangObj* Obj ) {
		...
		if( classCode == cfsec::CFSecISOCtryLangBuff::CLASS_CODE ) {
			dynamic_cast<cfbam::CFBamISOCtryLangTableObj*>( schema->getISOCtryLangTableObj() )->reallyDetachFromIndexesISOCtryLang( dynamic_cast<cfsec::ICFSecISOCtryLangObj*>( obj ) );
		}
	...
	cfsec::ICFSecISOCtryLangObj* CFBamISOCtryLangTableObj::createISOCtryLang( cfsec::ICFSecISOCtryLangEditObj* Obj ) {
		...
		try {
			...
			cflib::ICFLibCloneableObj* cloneable = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableISOCtryLang()->createISOCtryLang(
	...
	cfsec::ICFSecISOCtryLangObj* CFBamISOCtryLangTableObj::readISOCtryLang( cfsec::CFSecISOCtryLangPKey* pkey, bool forceRead ) {
		static const std::string S_Obj( "obj" );
		...
		if( forceRead || ( obj == NULL ) ) {
			cfsec::CFSecISOCtryLangBuff* readBuff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableISOCtryLang()->readDerivedByIdIdx( schema->getAuthorization(),
			pkey->getRequiredISOCtryId(),
			pkey->getRequiredISOLangId() );
			if( readBuff != NULL ) {
			obj = dynamic_cast<cfbam::CFBamISOCtryLangTableObj*>( schema->getISOCtryLangTableObj() )->newInstance();
	...
	cfsec::ICFSecISOCtryLangObj* CFBamISOCtryLangTableObj::lockISOCtryLang( cfsec::CFSecISOCtryLangPKey* pkey ) {
		static const std::string S_ProcName( "lockISOCtryLang" );
		cfsec::ICFSecISOCtryLangObj* locked = NULL;
		cfsec::CFSecISOCtryLangBuff* lockBuff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableISOCtryLang()->lockDerived( schema->getAuthorization(), pkey );
		if( lockBuff != NULL ) {
			locked = dynamic_cast<cfbam::CFBamISOCtryLangTableObj*>( schema->getISOCtryLangTableObj() )->newInstance();
	...
	std::vector<cfsec::ICFSecISOCtryLangObj*> CFBamISOCtryLangTableObj::readAllISOCtryLang( bool forceRead ) {
		...
		if( forceRead || ( allISOCtryLang == NULL ) ) {
			...
			allISOCtryLang = map;
			std::TCFLibOwningVector<cfsec::CFSecISOCtryLangBuff*> buffList = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableISOCtryLang()->readAllDerived( schema->getAuthorization() );
	...
	cfsec::ICFSecISOCtryLangObj* CFBamISOCtryLangTableObj::readISOCtryLangByIdIdx( const int16_t ISOCtryId,
	...
	std::vector<cfsec::ICFSecISOCtryLangObj*> CFBamISOCtryLangTableObj::readISOCtryLangByCtryIdx( const int16_t ISOCtryId,
		bool forceRead )
	{
		...
		if( ( oldDict != NULL ) && ( ! forceRead ) ) {
			...
			std::TCFLibOwningVector<cfsec::CFSecISOCtryLangBuff*> buffList = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableISOCtryLang()->readDerivedByCtryIdx( schema->getAuthorization(),
				ISOCtryId );
	...
	std::vector<cfsec::ICFSecISOCtryLangObj*> CFBamISOCtryLangTableObj::readISOCtryLangByLangIdx( const int16_t ISOLangId,
		bool forceRead )
	{
		...
		if( ( oldDict != NULL ) && ( ! forceRead ) ) {
			...
			dict = new std::map<cfsec::CFSecISOCtryLangPKey, cfsec::ICFSecISOCtryLangObj*>();
			cfsec::ICFSecISOCtryLangObj* obj;
			std::TCFLibOwningVector<cfsec::CFSecISOCtryLangBuff*> buffList = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableISOCtryLang()->readDerivedByLangIdx( schema->getAuthorization(),
				ISOLangId );
			cfsec::CFSecISOCtryLangBuff* buff;
			for( size_t idx = 0; idx < buffList.size(); idx ++ ) {
				buff = buffList[ idx ];
	...
	cfsec::ICFSecISOCtryLangObj* CFBamISOCtryLangTableObj::readCachedISOCtryLang( cfsec::CFSecISOCtryLangPKey* pkey ) {
		static const std::string S_Obj( "obj" );
		static const std::string S_Realized( "realized" );
		static const std::string S_ProcName( "readISOCtryLang" );
		cfsec::ICFSecISOCtryLangObj* obj = NULL;
	...
	cfsec::ICFSecISOCtryLangObj* CFBamISOCtryLangTableObj::readCachedISOCtryLangByIdIdx( const int16_t ISOCtryId,
			const int16_t ISOLangId )
	{
	...
	std::vector<cfsec::ICFSecISOCtryLangObj*> CFBamISOCtryLangTableObj::readCachedISOCtryLangByCtryIdx( const int16_t ISOCtryId )
	{
	...
	std::vector<cfsec::ICFSecISOCtryLangObj*> CFBamISOCtryLangTableObj::readCachedISOCtryLangByLangIdx( const int16_t ISOLangId )
	{
	...
	cfsec::ICFSecISOCtryLangObj* CFBamISOCtryLangTableObj::updateISOCtryLang( cfsec::ICFSecISOCtryLangEditObj* Obj ) {
		...
		cfsec::ICFSecISOCtryLangObj* obj = dynamic_cast<cfsec::ICFSecISOCtryLangObj*>( Obj->getOrig() );
		try {
			cfsec::CFSecISOCtryLangBuff* updated = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableISOCtryLang()->updateISOCtryLang( schema->getAuthorization(),
			...
			obj = dynamic_cast<cfsec::ICFSecISOCtryLangObj*>( dynamic_cast<cfbam::CFBamISOCtryLangTableObj*>( schema->getISOCtryLangTableObj() )->newInstance() );
			obj->setBuff( updated );
			obj = dynamic_cast<cfsec::ICFSecISOCtryLangObj*>( obj->realize() );
			if( obj == NULL ) {
				throw cflib::CFLibNullArgumentException( CLASS_NAME,
	...
	void CFBamISOCtryLangTableObj::deleteISOCtryLang( cfsec::ICFSecISOCtryLangEditObj* Obj ) {
		cfsec::ICFSecISOCtryLangObj* obj = Obj;
		dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableISOCtryLang()->deleteISOCtryLang( schema->getAuthorization(),
			obj->getISOCtryLangBuff() );
		deepDisposeByIdIdx( obj->getRequiredISOCtryId(),
			obj->getRequiredISOLangId() );
	}

	void CFBamISOCtryLangTableObj::deleteISOCtryLangByIdIdx( const int16_t ISOCtryId,
			const int16_t ISOLangId )
	{
		cfsec::CFSecISOCtryLangPKey pkey;
		pkey.setRequiredISOCtryId( ISOCtryId );
	...
	void CFBamISOCtryLangTableObj::deleteISOCtryLangByCtryIdx( const int16_t ISOCtryId )
	{
	...
	void CFBamISOCtryLangTableObj::deleteISOCtryLangByLangIdx( const int16_t ISOLangId )
	{
	...
	void CFBamISOCtryLangTableObj::reallyDetachFromIndexesISOCtryLang( cfsec::ICFSecISOCtryLangObj* Obj ) {
