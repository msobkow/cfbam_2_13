// Description: C++18 implementation of a NmTokensType history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamNmTokensTypeHBuff::CLASS_NAME( "CFBamNmTokensTypeHBuff" );
	CFBamNmTokensTypeHBuff::CFBamNmTokensTypeHBuff()
	: cfbam::CFBamNmTokensDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamNmTokensTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamNmTokensTypeHBuff::CFBamNmTokensTypeHBuff( const CFBamNmTokensTypeHBuff& src )
	: cfbam::CFBamNmTokensDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamNmTokensTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamNmTokensTypeHBuff::clone() {
		CFBamNmTokensTypeHBuff* copy = new CFBamNmTokensTypeHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamNmTokensTypeHBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamNmTokensTypeHBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamNmTokensTypeHBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamNmTokensTypeHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamNmTokensTypeHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamNmTokensTypeHBuff CFBamNmTokensTypeHBuff::operator =( cfbam::CFBamNmTokensTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamNmTokensTypeHBuff CFBamNmTokensTypeHBuff::operator =( cfbam::CFBamNmTokensTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamNmTokensTypeHBuff::operator <( const CFBamNmTokensTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamNmTokensTypeHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNmTokensTypeHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamNmTokensTypeHBuff::operator <( const CFBamNmTokensTypeHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamNmTokensTypeHBuff::operator <( const CFBamNmTokensTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamNmTokensTypeHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNmTokensTypeHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamNmTokensTypeHBuff& lhs, const cfbam::CFBamNmTokensTypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamNmTokensTypeHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamNmTokensTypeHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamNmTokensTypeHBuff& lhs, const cfbam::CFBamNmTokensTypeHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamNmTokensTypeHBuff& lhs, const cfbam::CFBamNmTokensTypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
