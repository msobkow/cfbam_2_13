// Description: C++18 implementation for a FloatType buffer object.
...
namespace cfbam {
	...
	const std::string CFBamFloatTypeBuff::GENDEFNAME( "FloatType" );
	const classcode_t CFBamFloatTypeBuff::CLASS_CODE = 0xa820L;
	const std::string CFBamFloatTypeBuff::CLASS_NAME( "CFBamFloatTypeBuff" );
		const std::string CFBamFloatTypeBuff::COLNAME_SCHEMADEFID( "SchemaDefId" );
	const int64_t CFBamFloatTypeBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamFloatTypeBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamFloatTypeBuff::SCHEMADEFID_INIT_VALUE = 0LL;
	const int64_t CFBamFloatTypeBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamFloatTypeBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamFloatTypeBuff::SCHEMADEFID_MIN_VALUE = 0LL;

	CFBamFloatTypeBuff::CFBamFloatTypeBuff()
	: CFBamFloatDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamFloatTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamFloatTypeBuff::CFBamFloatTypeBuff( const CFBamFloatTypeBuff& src )
	: CFBamFloatDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamFloatTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamFloatTypeBuff::clone() {
		CFBamFloatTypeBuff* copy = new CFBamFloatTypeBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamFloatTypeBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamFloatTypeBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamFloatTypeBuff::implementsClassCode( const classcode_t argClassCode ) {
		if( argClassCode == CLASS_CODE ) {
			return( true );
		}
		else {
			return( cfbam::CFBamFloatDefBuff::implementsClassCode( argClassCode ) );
		}
	}

	const int64_t CFBamFloatTypeBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamFloatTypeBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamFloatTypeBuff::setRequiredSchemaDefId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredSchemaDefId" );
		if( value < cfbam::CFBamFloatTypeBuff::SCHEMADEFID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamFloatTypeBuff::SCHEMADEFID_MIN_VALUE );
		}
		requiredSchemaDefId = value;
	}

	size_t CFBamFloatTypeBuff::hashCode() const {
		size_t hashCode = CFBamFloatDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamFloatTypeBuff CFBamFloatTypeBuff::operator =( cfbam::CFBamFloatTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamFloatTypeBuff CFBamFloatTypeBuff::operator =( cfbam::CFBamFloatTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamFloatTypeBuff::operator <( const CFBamFloatTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamFloatTypeBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamFloatTypeBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamFloatTypeBuff::operator <( const CFBamFloatTypeHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamFloatTypeBuff::operator <( const CFBamFloatTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamFloatTypeBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamFloatTypeBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamFloatTypeBuff& lhs, const cfbam::CFBamFloatTypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamFloatTypeBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamFloatTypeBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamFloatTypeBuff& lhs, const cfbam::CFBamFloatTypeHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamFloatTypeBuff& lhs, const cfbam::CFBamFloatTypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
