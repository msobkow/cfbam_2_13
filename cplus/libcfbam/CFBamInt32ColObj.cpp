// Description: C++18 base object instance implementation for CFBam Int32Col.
...
namespace cfbam {
	...
	const std::string CFBamInt32ColObj::CLASS_NAME( "CFBamInt32ColObj" );
	const classcode_t CFBamInt32ColObj::CLASS_CODE = 0xa85dL;

	const int64_t CFBamInt32ColObj::getRequiredTableId() {
		return( getInt32ColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamInt32ColObj::getRequiredTableIdReference() {
		return( getInt32ColBuff()->getRequiredTableIdReference() );
	}


	cfbam::ICFBamTableObj* CFBamInt32ColObj::getRequiredContainerTable( bool forceRead ) {
	...
	CFBamInt32ColObj::CFBamInt32ColObj()
	: ICFBamInt32ColObj(),
	  CFBamInt32DefObj()
	{
	}

	CFBamInt32ColObj::CFBamInt32ColObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamInt32ColObj(),
	...
	cfbam::CFBamValueBuff* CFBamInt32ColObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamInt32ColBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableInt32Col()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamInt32ColObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamInt32ColObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamInt32ColObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamInt32ColObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamInt32ColObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt32ColObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamInt32ColObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamInt32ColObj::getObjName() {
	...
	const std::string CFBamInt32ColObj::getGenDefName() {
		return( cfbam::CFBamInt32ColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamInt32ColObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamInt32ColObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamInt32ColObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamInt32ColObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamInt32ColObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamInt32ColObj::getObjQualifiedName() {
	...
	std::string CFBamInt32ColObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamInt32ColObj::realize() {
		cfbam::ICFBamInt32ColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt32ColTableObj()->realizeInt32Col(
			(cfbam::ICFBamInt32ColObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamInt32ColObj::read( bool forceRead ) {
		cfbam::ICFBamInt32ColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt32ColTableObj()->readInt32ColByIdIdx( getInt32ColBuff()->getRequiredTenantId(),
		getInt32ColBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamInt32ColObj::moveUp() {
		cfbam::ICFBamInt32ColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt32ColTableObj()->moveUpInt32Col( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamInt32ColObj::moveDown() {
		cfbam::ICFBamInt32ColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt32ColTableObj()->moveDownInt32Col( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamInt32ColObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamInt32ColObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt32ColTableObj()->lockInt32Col( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt32ColTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamInt32ColEditObj* CFBamInt32ColObj::getInt32ColEdit() {
		return( dynamic_cast<cfbam::ICFBamInt32ColEditObj*>( edit ) );
	}
