// Description: C++18 edit object instance implementation for CFBam TokenType.
...
namespace cfbam {
	...
	const std::string CFBamTokenTypeEditObj::CLASS_NAME( "CFBamTokenTypeEditObj" );

	CFBamTokenTypeEditObj::CFBamTokenTypeEditObj( cfbam::ICFBamTokenTypeObj* argOrig )
	: ICFBamTokenTypeEditObj(),
	  CFBamTokenDefEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamTokenTypeEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamTokenTypeEditObj::~CFBamTokenTypeEditObj() {
	}

	const std::string& CFBamTokenTypeEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTokenTypeEditObj::getClassCode() const {
		return( cfbam::CFBamTokenTypeBuff::CLASS_CODE );
	}

	bool CFBamTokenTypeEditObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamTokenTypeBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamTokenDefEditObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamTokenTypeEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTokenTypeEditObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt32( &S_Space, S_MaxLen, CFBamTokenDefEditObj::getRequiredMaxLen() ) );
		if( ! CFBamTokenDefEditObj::isOptionalInitValueNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredXmlString( &S_Space, S_InitValue, CFBamTokenDefEditObj::getOptionalInitValueValue() ) );
		}
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamTokenTypeEditObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	const std::string CFBamTokenTypeEditObj::getGenDefName() {
		return( cfbam::CFBamTokenTypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTokenTypeEditObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTokenTypeEditObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTokenTypeEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTokenTypeEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTokenTypeEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTokenTypeEditObj::getObjQualifiedName() {
	...
	std::string CFBamTokenTypeEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTokenTypeEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamTokenTypeObj* retobj = getSchema()->getTokenTypeTableObj()->realizeTokenType( dynamic_cast<cfbam::ICFBamTokenTypeObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamTokenTypeEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamTokenTypeEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamTokenTypeEditObj::create() {
		cfbam::ICFBamTokenTypeObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsTokenType()->getSchema() )->getTokenTypeTableObj()->createTokenType( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamTokenTypeEditObj::update() {
		getSchema()->getTokenTypeTableObj()->updateTokenType( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamTokenTypeEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getTokenTypeTableObj()->deleteTokenType( this );
		return( NULL );
	}

	cfbam::ICFBamTokenTypeTableObj* CFBamTokenTypeEditObj::getTokenTypeTable() {
		return( orig->getSchema()->getTokenTypeTableObj() );
	}

	cfbam::ICFBamTokenTypeEditObj* CFBamTokenTypeEditObj::getTokenTypeEdit() {
		return( (cfbam::ICFBamTokenTypeEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamTokenTypeEditObj::beginEdit() {
	...
	cfbam::ICFBamTokenTypeObj* CFBamTokenTypeEditObj::getOrigAsTokenType() {
		return( dynamic_cast<cfbam::ICFBamTokenTypeObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamTokenTypeEditObj::getBuff() {
		return( buff );
	}

	void CFBamTokenTypeEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamTokenDefEditObj::setBuff( value );
		}
	}

	const int64_t CFBamTokenTypeEditObj::getRequiredSchemaDefId() {
		return( getTokenTypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamTokenTypeEditObj::getRequiredSchemaDefIdReference() {
		return( getTokenTypeBuff()->getRequiredSchemaDefIdReference() );
	}

	void CFBamTokenTypeEditObj::setRequiredContainerScope( cfbam::ICFBamScopeObj* value ) {
		if( value == NULL ) {
	...
	cfbam::ICFBamSchemaDefObj* CFBamTokenTypeEditObj::getRequiredContainerSchemaDef( bool forceRead ) {
		cfbam::ICFBamSchemaDefObj* retobj = NULL;
		bool anyMissing = false;
		if( ! anyMissing ) {
			retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsTokenType()->getSchema() )->getSchemaDefTableObj()->readSchemaDefByIdIdx( getPKey()->getRequiredTenantId(),
					getTokenTypeBuff()->getRequiredSchemaDefId() );
		}
		return( retobj );
	}

	void CFBamTokenTypeEditObj::setRequiredContainerSchemaDef( cfbam::ICFBamSchemaDefObj* value ) {
			
			if( value != NULL ) {
				getPKey()->setRequiredTenantId
( value->getRequiredTenantId() );
				getTokenTypeEditBuff()->setRequiredTenantId( value->getRequiredTenantId() );
				getTokenTypeEditBuff()->setRequiredSchemaDefId( value->getRequiredId() );
			}

			CFBamTokenDefEditObj::setRequiredContainerScope( value );		}

	void CFBamTokenTypeEditObj::copyBuffToOrig() {
		cfbam::CFBamTokenTypeBuff* origBuff = getOrigAsTokenType()->getTokenTypeEditBuff();
		cfbam::CFBamTokenTypeBuff* myBuff = getTokenTypeBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamTokenTypeEditObj::copyOrigToBuff() {
		cfbam::CFBamTokenTypeBuff* origBuff = getOrigAsTokenType()->getTokenTypeBuff();
		cfbam::CFBamTokenTypeBuff* myBuff = getTokenTypeEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
