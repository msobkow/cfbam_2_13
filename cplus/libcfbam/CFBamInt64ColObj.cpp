// Description: C++18 base object instance implementation for CFBam Int64Col.
...
namespace cfbam {
	...
	const std::string CFBamInt64ColObj::CLASS_NAME( "CFBamInt64ColObj" );
	const classcode_t CFBamInt64ColObj::CLASS_CODE = 0xa85eL;

	const int64_t CFBamInt64ColObj::getRequiredTableId() {
		return( getInt64ColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamInt64ColObj::getRequiredTableIdReference() {
		return( getInt64ColBuff()->getRequiredTableIdReference() );
	}


	cfbam::ICFBamTableObj* CFBamInt64ColObj::getRequiredContainerTable( bool forceRead ) {
	...
	CFBamInt64ColObj::CFBamInt64ColObj()
	: ICFBamInt64ColObj(),
	  CFBamInt64DefObj()
	{
	}

	CFBamInt64ColObj::CFBamInt64ColObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamInt64ColObj(),
	  CFBamInt64DefObj( argSchema )
	{
	}
	...
	cfbam::CFBamValueBuff* CFBamInt64ColObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamInt64ColBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableInt64Col()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamInt64ColObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamInt64ColObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamInt64ColObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamInt64ColObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamInt64ColBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamInt64DefObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamInt64ColObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt64ColObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamInt64ColObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamInt64ColObj::getObjName() {
	...
	const std::string CFBamInt64ColObj::getGenDefName() {
		return( cfbam::CFBamInt64ColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamInt64ColObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamInt64ColObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamInt64ColObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamInt64ColObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamInt64ColObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamInt64ColObj::getObjQualifiedName() {
	...
	std::string CFBamInt64ColObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamInt64ColObj::realize() {
		cfbam::ICFBamInt64ColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt64ColTableObj()->realizeInt64Col(
			(cfbam::ICFBamInt64ColObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamInt64ColObj::read( bool forceRead ) {
		cfbam::ICFBamInt64ColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt64ColTableObj()->readInt64ColByIdIdx( getInt64ColBuff()->getRequiredTenantId(),
		getInt64ColBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamInt64ColObj::moveUp() {
		cfbam::ICFBamInt64ColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt64ColTableObj()->moveUpInt64Col( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamInt64ColObj::moveDown() {
		cfbam::ICFBamInt64ColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt64ColTableObj()->moveDownInt64Col( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamInt64ColObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamInt64ColObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt64ColTableObj()->lockInt64Col( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getInt64ColTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamInt64ColEditObj* CFBamInt64ColObj::getInt64ColEdit() {
		return( dynamic_cast<cfbam::ICFBamInt64ColEditObj*>( edit ) );
	}
