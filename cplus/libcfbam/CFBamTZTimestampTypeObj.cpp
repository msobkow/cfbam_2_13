// Description: C++18 base object instance implementation for CFBam TZTimestampType.
...
namespace cfbam {
	...
	const std::string CFBamTZTimestampTypeObj::CLASS_NAME( "CFBamTZTimestampTypeObj" );
	const classcode_t CFBamTZTimestampTypeObj::CLASS_CODE = 0xa83fL;

	const int64_t CFBamTZTimestampTypeObj::getRequiredSchemaDefId() {
		return( getTZTimestampTypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamTZTimestampTypeObj::getRequiredSchemaDefIdReference() {
		return( getTZTimestampTypeBuff()->getRequiredSchemaDefIdReference() );
	}


	cfbam::ICFBamSchemaDefObj* CFBamTZTimestampTypeObj::getRequiredContainerSchemaDef( bool forceRead ) {
	...
	CFBamTZTimestampTypeObj::CFBamTZTimestampTypeObj()
	: ICFBamTZTimestampTypeObj(),
	  CFBamTZTimestampDefObj()
	{
	}

	CFBamTZTimestampTypeObj::CFBamTZTimestampTypeObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamTZTimestampTypeObj(),
	...
	cfbam::CFBamValueBuff* CFBamTZTimestampTypeObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamTZTimestampTypeBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableTZTimestampType()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamTZTimestampTypeObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamTZTimestampTypeObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTZTimestampTypeObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTZTimestampTypeObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamTZTimestampTypeObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZTimestampTypeObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamTZTimestampTypeObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamTZTimestampTypeObj::getObjName() {
	...
	const std::string CFBamTZTimestampTypeObj::getGenDefName() {
		return( cfbam::CFBamTZTimestampTypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTZTimestampTypeObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTZTimestampTypeObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTZTimestampTypeObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTZTimestampTypeObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTZTimestampTypeObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTZTimestampTypeObj::getObjQualifiedName() {
	...
	std::string CFBamTZTimestampTypeObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTZTimestampTypeObj::realize() {
		cfbam::ICFBamTZTimestampTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimestampTypeTableObj()->realizeTZTimestampType(
			(cfbam::ICFBamTZTimestampTypeObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTZTimestampTypeObj::read( bool forceRead ) {
		cfbam::ICFBamTZTimestampTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimestampTypeTableObj()->readTZTimestampTypeByIdIdx( getTZTimestampTypeBuff()->getRequiredTenantId(),
		getTZTimestampTypeBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTZTimestampTypeObj::moveUp() {
		cfbam::ICFBamTZTimestampTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimestampTypeTableObj()->moveUpTZTimestampType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTZTimestampTypeObj::moveDown() {
		cfbam::ICFBamTZTimestampTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimestampTypeTableObj()->moveDownTZTimestampType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamTZTimestampTypeObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamTZTimestampTypeObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimestampTypeTableObj()->lockTZTimestampType( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZTimestampTypeTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamTZTimestampTypeEditObj* CFBamTZTimestampTypeObj::getTZTimestampTypeEdit() {
		return( dynamic_cast<cfbam::ICFBamTZTimestampTypeEditObj*>( edit ) );
	}
