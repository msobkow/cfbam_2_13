// Description: C++18 Instance Edit Object interface implementation for CFBam Id16Gen.
...
namespace cfbam {
	...
	const std::string ICFBamId16GenEditObj::CLASS_NAME( "ICFBamId16GenEditObj" );

	ICFBamId16GenEditObj::ICFBamId16GenEditObj()
