// Description: C++18 base object instance implementation for CFBam EnumType.
...
namespace cfbam {
	...
	const std::string CFBamEnumTypeObj::CLASS_NAME( "CFBamEnumTypeObj" );
	const classcode_t CFBamEnumTypeObj::CLASS_CODE = 0xa857L;

	const int64_t CFBamEnumTypeObj::getRequiredSchemaDefId() {
		return( getEnumTypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamEnumTypeObj::getRequiredSchemaDefIdReference() {
		return( getEnumTypeBuff()->getRequiredSchemaDefIdReference() );
	}


	cfbam::ICFBamSchemaDefObj* CFBamEnumTypeObj::getRequiredContainerSchemaDef( bool forceRead ) {
	...
	CFBamEnumTypeObj::CFBamEnumTypeObj()
	: ICFBamEnumTypeObj(),
	  CFBamEnumDefObj()
	{
	}

	CFBamEnumTypeObj::CFBamEnumTypeObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamEnumTypeObj(),
	  CFBamEnumDefObj( argSchema )
	{
	}
	...
	cfbam::CFBamValueBuff* CFBamEnumTypeObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamEnumTypeBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableEnumType()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamEnumTypeObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamEnumTypeObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamEnumTypeObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamEnumTypeObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamEnumTypeBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamEnumDefObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamEnumTypeObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamEnumTypeObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamEnumTypeObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamEnumTypeObj::getObjName() {
	...
	const std::string CFBamEnumTypeObj::getGenDefName() {
		return( cfbam::CFBamEnumTypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamEnumTypeObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamEnumTypeObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamEnumTypeObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamEnumTypeObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamEnumTypeObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamEnumTypeObj::getObjQualifiedName() {
	...
	std::string CFBamEnumTypeObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamEnumTypeObj::realize() {
		cfbam::ICFBamEnumTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getEnumTypeTableObj()->realizeEnumType(
			(cfbam::ICFBamEnumTypeObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamEnumTypeObj::read( bool forceRead ) {
		cfbam::ICFBamEnumTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getEnumTypeTableObj()->readEnumTypeByIdIdx( getEnumTypeBuff()->getRequiredTenantId(),
		getEnumTypeBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamEnumTypeObj::moveUp() {
		cfbam::ICFBamEnumTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getEnumTypeTableObj()->moveUpEnumType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamEnumTypeObj::moveDown() {
		cfbam::ICFBamEnumTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getEnumTypeTableObj()->moveDownEnumType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamEnumTypeObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamEnumTypeObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getEnumTypeTableObj()->lockEnumType( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getEnumTypeTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamEnumTypeEditObj* CFBamEnumTypeObj::getEnumTypeEdit() {
		return( dynamic_cast<cfbam::ICFBamEnumTypeEditObj*>( edit ) );
	}
