// Description: C++18 Instance Edit Object interface implementation for CFBam BlobCol.
...
namespace cfbam {
	...
	const std::string ICFBamBlobColEditObj::CLASS_NAME( "ICFBamBlobColEditObj" );

	ICFBamBlobColEditObj::ICFBamBlobColEditObj()
