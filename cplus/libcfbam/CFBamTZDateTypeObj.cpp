// Description: C++18 base object instance implementation for CFBam TZDateType.
...
namespace cfbam {
	...
	const std::string CFBamTZDateTypeObj::CLASS_NAME( "CFBamTZDateTypeObj" );
	const classcode_t CFBamTZDateTypeObj::CLASS_CODE = 0xa83bL;

	const int64_t CFBamTZDateTypeObj::getRequiredSchemaDefId() {
		return( getTZDateTypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamTZDateTypeObj::getRequiredSchemaDefIdReference() {
		return( getTZDateTypeBuff()->getRequiredSchemaDefIdReference() );
	}


	cfbam::ICFBamSchemaDefObj* CFBamTZDateTypeObj::getRequiredContainerSchemaDef( bool forceRead ) {
	...
	CFBamTZDateTypeObj::CFBamTZDateTypeObj()
	: ICFBamTZDateTypeObj(),
	  CFBamTZDateDefObj()
	{
	}

	CFBamTZDateTypeObj::CFBamTZDateTypeObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamTZDateTypeObj(),
	...
	cfbam::CFBamValueBuff* CFBamTZDateTypeObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamTZDateTypeBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableTZDateType()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamTZDateTypeObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamTZDateTypeObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTZDateTypeObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamTZDateTypeObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamTZDateTypeObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZDateTypeObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamTZDateTypeObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamTZDateTypeObj::getObjName() {
	...
	const std::string CFBamTZDateTypeObj::getGenDefName() {
		return( cfbam::CFBamTZDateTypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTZDateTypeObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTZDateTypeObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamTZDateTypeObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTZDateTypeObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTZDateTypeObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTZDateTypeObj::getObjQualifiedName() {
	...
	std::string CFBamTZDateTypeObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTZDateTypeObj::realize() {
		cfbam::ICFBamTZDateTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZDateTypeTableObj()->realizeTZDateType(
			(cfbam::ICFBamTZDateTypeObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTZDateTypeObj::read( bool forceRead ) {
		cfbam::ICFBamTZDateTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZDateTypeTableObj()->readTZDateTypeByIdIdx( getTZDateTypeBuff()->getRequiredTenantId(),
		getTZDateTypeBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTZDateTypeObj::moveUp() {
		cfbam::ICFBamTZDateTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZDateTypeTableObj()->moveUpTZDateType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamTZDateTypeObj::moveDown() {
		cfbam::ICFBamTZDateTypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZDateTypeTableObj()->moveDownTZDateType( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamTZDateTypeObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamTZDateTypeObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZDateTypeTableObj()->lockTZDateType( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getTZDateTypeTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamTZDateTypeEditObj* CFBamTZDateTypeObj::getTZDateTypeEdit() {
		return( dynamic_cast<cfbam::ICFBamTZDateTypeEditObj*>( edit ) );
	}
