// Description: C++18 implementation for a UInt16Def buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUInt16DefBuff::GENDEFNAME( "UInt16Def" );
	const classcode_t CFBamUInt16DefBuff::CLASS_CODE = 0xa84aL;
	const std::string CFBamUInt16DefBuff::CLASS_NAME( "CFBamUInt16DefBuff" );
		const std::string CFBamUInt16DefBuff::COLNAME_INITVALUE( "InitValue" );
		const std::string CFBamUInt16DefBuff::COLNAME_MINVALUE( "MinValue" );
		const std::string CFBamUInt16DefBuff::COLNAME_MAXVALUE( "MaxValue" );
	const int64_t CFBamUInt16DefBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamUInt16DefBuff::ID_INIT_VALUE = 0LL;
	const uint16_t CFBamUInt16DefBuff::INITVALUE_INIT_VALUE = 0;
	const uint16_t CFBamUInt16DefBuff::MINVALUE_INIT_VALUE = 0;
	const uint16_t CFBamUInt16DefBuff::MAXVALUE_INIT_VALUE = 0;
	const int64_t CFBamUInt16DefBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamUInt16DefBuff::ID_MIN_VALUE = 0LL;
	const uint16_t CFBamUInt16DefBuff::INITVALUE_MIN_VALUE = 0;
	const uint16_t CFBamUInt16DefBuff::MINVALUE_MIN_VALUE = 0;
	const uint16_t CFBamUInt16DefBuff::MAXVALUE_MIN_VALUE = 0;

	CFBamUInt16DefBuff::CFBamUInt16DefBuff()
	: CFBamAtomBuff()
	{
	...
	CFBamUInt16DefBuff::CFBamUInt16DefBuff( const CFBamUInt16DefBuff& src )
	: CFBamAtomBuff()
	{
		optionalInitValue.setNull();
		optionalMinValue.setNull();
	...
	cflib::ICFLibCloneableObj* CFBamUInt16DefBuff::clone() {
		CFBamUInt16DefBuff* copy = new CFBamUInt16DefBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamUInt16DefBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUInt16DefBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamUInt16DefBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const bool CFBamUInt16DefBuff::isOptionalInitValueNull() const {
		return( optionalInitValue.isNull() );
	}

	const uint16_t CFBamUInt16DefBuff::getOptionalInitValueValue() const {
		return( optionalInitValue.getValue() );
	}

	const uint16_t* CFBamUInt16DefBuff::getOptionalInitValueReference() const {
		return( optionalInitValue.getReference() );
	}

	void CFBamUInt16DefBuff::setOptionalInitValueNull() {
		optionalInitValue.setNull();
	}

	void CFBamUInt16DefBuff::setOptionalInitValueValue( const uint16_t value ) {
		static const std::string S_ProcName( "setOptionalInitValueValue" );
		if( value < cfbam::CFBamUInt16DefBuff::INITVALUE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamUInt16DefBuff::INITVALUE_MIN_VALUE );
		}
		optionalInitValue.setValue( value );
	}

	const bool CFBamUInt16DefBuff::isOptionalMinValueNull() const {
		return( optionalMinValue.isNull() );
	}

	const uint16_t CFBamUInt16DefBuff::getOptionalMinValueValue() const {
		return( optionalMinValue.getValue() );
	}

	const uint16_t* CFBamUInt16DefBuff::getOptionalMinValueReference() const {
		return( optionalMinValue.getReference() );
	}

	void CFBamUInt16DefBuff::setOptionalMinValueNull() {
		optionalMinValue.setNull();
	}

	void CFBamUInt16DefBuff::setOptionalMinValueValue( const uint16_t value ) {
		static const std::string S_ProcName( "setOptionalMinValueValue" );
		if( value < cfbam::CFBamUInt16DefBuff::MINVALUE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamUInt16DefBuff::MINVALUE_MIN_VALUE );
		}
		optionalMinValue.setValue( value );
	}

	const bool CFBamUInt16DefBuff::isOptionalMaxValueNull() const {
		return( optionalMaxValue.isNull() );
	}

	const uint16_t CFBamUInt16DefBuff::getOptionalMaxValueValue() const {
		return( optionalMaxValue.getValue() );
	}

	const uint16_t* CFBamUInt16DefBuff::getOptionalMaxValueReference() const {
		return( optionalMaxValue.getReference() );
	}

	void CFBamUInt16DefBuff::setOptionalMaxValueNull() {
		optionalMaxValue.setNull();
	}

	void CFBamUInt16DefBuff::setOptionalMaxValueValue( const uint16_t value ) {
		static const std::string S_ProcName( "setOptionalMaxValueValue" );
		if( value < cfbam::CFBamUInt16DefBuff::MAXVALUE_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamUInt16DefBuff::MAXVALUE_MIN_VALUE );
		}
		optionalMaxValue.setValue( value );
	}

	size_t CFBamUInt16DefBuff::hashCode() const {
	...
	CFBamUInt16DefBuff CFBamUInt16DefBuff::operator =( cfbam::CFBamUInt16DefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamUInt16DefBuff CFBamUInt16DefBuff::operator =( cfbam::CFBamUInt16DefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUInt16DefBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamUInt16DefBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt16DefBuff::operator <( const CFBamUInt16DefHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt16DefBuff::operator <( const CFBamUInt16DefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUInt16DefBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt16DefBuff" );
		...
		if( ! isOptionalInitValueNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredUInt16( &S_Space, S_InitValue, getOptionalInitValueValue() ) );
		}
		if( ! isOptionalMinValueNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredUInt16( &S_Space, S_MinValue, getOptionalMinValueValue() ) );
		}
		if( ! isOptionalMaxValueNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredUInt16( &S_Space, S_MaxValue, getOptionalMaxValueValue() ) );
		}
