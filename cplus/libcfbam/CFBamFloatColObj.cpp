// Description: C++18 base object instance implementation for CFBam FloatCol.
...
namespace cfbam {
	...
	const std::string CFBamFloatColObj::CLASS_NAME( "CFBamFloatColObj" );
	const classcode_t CFBamFloatColObj::CLASS_CODE = 0xa858L;

	const int64_t CFBamFloatColObj::getRequiredTableId() {
		return( getFloatColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamFloatColObj::getRequiredTableIdReference() {
		return( getFloatColBuff()->getRequiredTableIdReference() );
	}


	cfbam::ICFBamTableObj* CFBamFloatColObj::getRequiredContainerTable( bool forceRead ) {
	...
	CFBamFloatColObj::CFBamFloatColObj()
	: ICFBamFloatColObj(),
	  CFBamFloatDefObj()
	{
	}

	CFBamFloatColObj::CFBamFloatColObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamFloatColObj(),
	...
	cfbam::CFBamValueBuff* CFBamFloatColObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamFloatColBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableFloatCol()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamFloatColObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamFloatColObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamFloatColObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamFloatColObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamFloatColObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamFloatColObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamFloatColObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamFloatColObj::getObjName() {
	...
	const std::string CFBamFloatColObj::getGenDefName() {
		return( cfbam::CFBamFloatColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamFloatColObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamFloatColObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamFloatColObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamFloatColObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamFloatColObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamFloatColObj::getObjQualifiedName() {
	...
	std::string CFBamFloatColObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamFloatColObj::realize() {
		cfbam::ICFBamFloatColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getFloatColTableObj()->realizeFloatCol(
			(cfbam::ICFBamFloatColObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamFloatColObj::read( bool forceRead ) {
		cfbam::ICFBamFloatColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getFloatColTableObj()->readFloatColByIdIdx( getFloatColBuff()->getRequiredTenantId(),
		getFloatColBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamFloatColObj::moveUp() {
		cfbam::ICFBamFloatColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getFloatColTableObj()->moveUpFloatCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamFloatColObj::moveDown() {
		cfbam::ICFBamFloatColObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getFloatColTableObj()->moveDownFloatCol( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamFloatColObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamFloatColObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getFloatColTableObj()->lockFloatCol( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getFloatColTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamFloatColEditObj* CFBamFloatColObj::getFloatColEdit() {
		return( dynamic_cast<cfbam::ICFBamFloatColEditObj*>( edit ) );
	}
