// Description: C++18 implementation for a BoolDef buffer object.
...
namespace cfbam {
	...
	const std::string CFBamBoolDefBuff::GENDEFNAME( "BoolDef" );
	const classcode_t CFBamBoolDefBuff::CLASS_CODE = 0xa80dL;
	const std::string CFBamBoolDefBuff::CLASS_NAME( "CFBamBoolDefBuff" );
		const std::string CFBamBoolDefBuff::COLNAME_INITVALUE( "InitValue" );
		const std::string CFBamBoolDefBuff::COLNAME_FALSESTRING( "FalseString" );
		const std::string CFBamBoolDefBuff::COLNAME_TRUESTRING( "TrueString" );
		const std::string CFBamBoolDefBuff::COLNAME_NULLSTRING( "NullString" );
	const int64_t CFBamBoolDefBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamBoolDefBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamBoolDefBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamBoolDefBuff::ID_MIN_VALUE = 0LL;
	const std::string::size_type CFBamBoolDefBuff::FALSESTRING_MAX_LEN = 32;
	const std::string::size_type CFBamBoolDefBuff::TRUESTRING_MAX_LEN = 32;
	const std::string::size_type CFBamBoolDefBuff::NULLSTRING_MAX_LEN = 32;

	CFBamBoolDefBuff::CFBamBoolDefBuff()
	: CFBamAtomBuff()
	{
	...
	CFBamBoolDefBuff::CFBamBoolDefBuff( const CFBamBoolDefBuff& src )
	: CFBamAtomBuff()
	{
		optionalInitValue.setNull();
		optionalFalseString = NULL;
		...
		if( src.isOptionalFalseStringNull() ) {
			setOptionalFalseStringNull();
		}
		else {
			setOptionalFalseStringValue( src.getOptionalFalseStringValue() );
		}
		if( src.isOptionalTrueStringNull() ) {
			setOptionalTrueStringNull();
		}
		else {
			setOptionalTrueStringValue( src.getOptionalTrueStringValue() );
		}
		if( src.isOptionalNullStringNull() ) {
			setOptionalNullStringNull();
		}
		else {
			setOptionalNullStringValue( src.getOptionalNullStringValue() );
		}
	}

	CFBamBoolDefBuff::~CFBamBoolDefBuff() {
		if( optionalFalseString != NULL ) {
			delete optionalFalseString;
			optionalFalseString = NULL;
		}
		if( optionalTrueString != NULL ) {
			delete optionalTrueString;
			optionalTrueString = NULL;
		}
		if( optionalNullString != NULL ) {
			delete optionalNullString;
			optionalNullString = NULL;
		}
	}

	cflib::ICFLibCloneableObj* CFBamBoolDefBuff::clone() {
		CFBamBoolDefBuff* copy = new CFBamBoolDefBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamBoolDefBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamBoolDefBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamBoolDefBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const bool CFBamBoolDefBuff::isOptionalInitValueNull() const {
		return( optionalInitValue.isNull() );
	}

	const bool CFBamBoolDefBuff::getOptionalInitValueValue() const {
		return( optionalInitValue.getValue() );
	}

	const bool* CFBamBoolDefBuff::getOptionalInitValueReference() const {
		return( optionalInitValue.getReference() );
	}

	void CFBamBoolDefBuff::setOptionalInitValueNull() {
		optionalInitValue.setNull();
	}

	void CFBamBoolDefBuff::setOptionalInitValueValue( const bool value ) {
		optionalInitValue.setValue( value );
	}

	const bool CFBamBoolDefBuff::isOptionalFalseStringNull() const {
		return( optionalFalseString == NULL );
	}

	const std::string& CFBamBoolDefBuff::getOptionalFalseStringValue() const {
		static const std::string S_ProcName( "getOptionalFalseStringValue" );
		if( optionalFalseString == NULL ) {
	...
	const std::string* CFBamBoolDefBuff::getOptionalFalseStringReference() const {
		return( optionalFalseString );
	}

	void CFBamBoolDefBuff::setOptionalFalseStringNull() {
		if( optionalFalseString != NULL ) {
			delete optionalFalseString;
			optionalFalseString = NULL;
		}
	...
	void CFBamBoolDefBuff::setOptionalFalseStringValue( const std::string& value ) {
		static const std::string S_ProcName( "setOptionalFalseStringValue" );
		if( value.length() > CFBamBoolDefBuff::FALSESTRING_MAX_LEN ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE_LENGTH,
				value.length(),
				CFBamBoolDefBuff::FALSESTRING_MAX_LEN );
		}
		if( optionalFalseString != NULL ) {
			delete optionalFalseString;
			optionalFalseString = NULL;
		}
		optionalFalseString = new std::string( value );
	}

	const bool CFBamBoolDefBuff::isOptionalTrueStringNull() const {
		return( optionalTrueString == NULL );
	}

	const std::string& CFBamBoolDefBuff::getOptionalTrueStringValue() const {
		static const std::string S_ProcName( "getOptionalTrueStringValue" );
		if( optionalTrueString == NULL ) {
			throw cflib::CFLibNullArgumentException( CLASS_NAME,
				S_ProcName,
				0,
	...
	const std::string* CFBamBoolDefBuff::getOptionalTrueStringReference() const {
		return( optionalTrueString );
	}

	void CFBamBoolDefBuff::setOptionalTrueStringNull() {
		if( optionalTrueString != NULL ) {
			delete optionalTrueString;
			optionalTrueString = NULL;
		}
	...
	void CFBamBoolDefBuff::setOptionalTrueStringValue( const std::string& value ) {
		static const std::string S_ProcName( "setOptionalTrueStringValue" );
		if( value.length() > CFBamBoolDefBuff::TRUESTRING_MAX_LEN ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE_LENGTH,
				value.length(),
				CFBamBoolDefBuff::TRUESTRING_MAX_LEN );
		}
		if( optionalTrueString != NULL ) {
			delete optionalTrueString;
			optionalTrueString = NULL;
		}
		optionalTrueString = new std::string( value );
	}

	const bool CFBamBoolDefBuff::isOptionalNullStringNull() const {
		return( optionalNullString == NULL );
	}

	const std::string& CFBamBoolDefBuff::getOptionalNullStringValue() const {
		static const std::string S_ProcName( "getOptionalNullStringValue" );
		if( optionalNullString == NULL ) {
			throw cflib::CFLibNullArgumentException( CLASS_NAME,
				S_ProcName,
				0,
	...
	const std::string* CFBamBoolDefBuff::getOptionalNullStringReference() const {
		return( optionalNullString );
	}

	void CFBamBoolDefBuff::setOptionalNullStringNull() {
		if( optionalNullString != NULL ) {
			delete optionalNullString;
			optionalNullString = NULL;
		}
	...
	void CFBamBoolDefBuff::setOptionalNullStringValue( const std::string& value ) {
		static const std::string S_ProcName( "setOptionalNullStringValue" );
		if( value.length() > CFBamBoolDefBuff::NULLSTRING_MAX_LEN ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE_LENGTH,
				value.length(),
				CFBamBoolDefBuff::NULLSTRING_MAX_LEN );
		}
		if( optionalNullString != NULL ) {
			delete optionalNullString;
			optionalNullString = NULL;
		}
		optionalNullString = new std::string( value );
	}

	size_t CFBamBoolDefBuff::hashCode() const {
		size_t hashCode = CFBamAtomBuff::hashCode();
		if(  ! isOptionalInitValueNull() ) {
			if( getOptionalInitValueValue() ) {
		...
		if( ! isOptionalFalseStringNull() ) {
			hashCode = hashCode + cflib::CFLib::hash( getOptionalFalseStringValue() );
		}
		if( ! isOptionalTrueStringNull() ) {
			hashCode = hashCode + cflib::CFLib::hash( getOptionalTrueStringValue() );
		}
		if( ! isOptionalNullStringNull() ) {
			hashCode = hashCode + cflib::CFLib::hash( getOptionalNullStringValue() );
		}
		return( hashCode );
	}

	CFBamBoolDefBuff CFBamBoolDefBuff::operator =( cfbam::CFBamBoolDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamBoolDefBuff CFBamBoolDefBuff::operator =( cfbam::CFBamBoolDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamBoolDefBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamBoolDefBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamBoolDefBuff::operator <( const CFBamBoolDefHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
		...
		if( ! isOptionalFalseStringNull() ) {
			if( rhs.isOptionalFalseStringNull() ) {
				return( false );
			}
			if( getOptionalFalseStringValue() > rhs.getOptionalFalseStringValue() ) {
				return( false );
			}
			else if( getOptionalFalseStringValue() < rhs.getOptionalFalseStringValue() ) {
				return( true );
			}
		}
		else {
		...
		if( ! isOptionalTrueStringNull() ) {
			if( rhs.isOptionalTrueStringNull() ) {
				return( false );
			}
			if( getOptionalTrueStringValue() > rhs.getOptionalTrueStringValue() ) {
				return( false );
			}
			else if( getOptionalTrueStringValue() < rhs.getOptionalTrueStringValue() ) {
				return( true );
			}
		}
		else {
		...
		if( ! isOptionalNullStringNull() ) {
			if( rhs.isOptionalNullStringNull() ) {
				return( false );
			}
			if( getOptionalNullStringValue() > rhs.getOptionalNullStringValue() ) {
				return( false );
			}
			else if( getOptionalNullStringValue() < rhs.getOptionalNullStringValue() ) {
				return( true );
			}
		}
		else {
	...
	bool CFBamBoolDefBuff::operator <( const CFBamBoolDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamBoolDefBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamBoolDefBuff" );
		...
		if( ! isOptionalInitValueNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredBoolean( &S_Space, S_InitValue, getOptionalInitValueValue() ) );
		}
		if( ! isOptionalFalseStringNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredXmlString( &S_Space, S_FalseString, getOptionalFalseStringValue() ) );
		}
		if( ! isOptionalTrueStringNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredXmlString( &S_Space, S_TrueString, getOptionalTrueStringValue() ) );
		}
		if( ! isOptionalNullStringNull() ) {
			ret.append( cflib::CFLibXmlUtil::formatRequiredXmlString( &S_Space, S_NullString, getOptionalNullStringValue() ) );
		}
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamBoolDefBuff& lhs, const cfbam::CFBamBoolDefHBuff& rhs ) {
		...
		if( ! lhs.isOptionalFalseStringNull() ) {
			if( rhs.isOptionalFalseStringNull() ) {
				return( false );
			}
			if( lhs.getOptionalFalseStringValue() > rhs.getOptionalFalseStringValue() ) {
				return( false );
			}
			else if( lhs.getOptionalFalseStringValue() < rhs.getOptionalFalseStringValue() ) {
				return( true );
			}
		}
		else {
		...
		if( ! lhs.isOptionalTrueStringNull() ) {
			if( rhs.isOptionalTrueStringNull() ) {
				return( false );
			}
			if( lhs.getOptionalTrueStringValue() > rhs.getOptionalTrueStringValue() ) {
				return( false );
			}
			else if( lhs.getOptionalTrueStringValue() < rhs.getOptionalTrueStringValue() ) {
				return( true );
			}
		}
		else {
		...
		if( ! lhs.isOptionalNullStringNull() ) {
			if( rhs.isOptionalNullStringNull() ) {
				return( false );
			}
			if( lhs.getOptionalNullStringValue() > rhs.getOptionalNullStringValue() ) {
				return( false );
			}
			else if( lhs.getOptionalNullStringValue() < rhs.getOptionalNullStringValue() ) {
				return( true );
			}
		}
		else {
