// Description: C++18 edit object instance implementation for CFBam BoolType.
...
namespace cfbam {
	...
	const std::string CFBamBoolTypeEditObj::CLASS_NAME( "CFBamBoolTypeEditObj" );

	CFBamBoolTypeEditObj::CFBamBoolTypeEditObj( cfbam::ICFBamBoolTypeObj* argOrig )
	: ICFBamBoolTypeEditObj(),
	  CFBamBoolDefEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamBoolTypeEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamBoolTypeEditObj::~CFBamBoolTypeEditObj() {
	}

	const std::string& CFBamBoolTypeEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamBoolTypeEditObj::getClassCode() const {
		return( cfbam::CFBamBoolTypeBuff::CLASS_CODE );
	}

	bool CFBamBoolTypeEditObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamBoolTypeEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamBoolTypeEditObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamBoolTypeEditObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	const std::string CFBamBoolTypeEditObj::getGenDefName() {
		return( cfbam::CFBamBoolTypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamBoolTypeEditObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamBoolTypeEditObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamBoolTypeEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamBoolTypeEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamBoolTypeEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamBoolTypeEditObj::getObjQualifiedName() {
	...
	std::string CFBamBoolTypeEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamBoolTypeEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamBoolTypeObj* retobj = getSchema()->getBoolTypeTableObj()->realizeBoolType( dynamic_cast<cfbam::ICFBamBoolTypeObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamBoolTypeEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamBoolTypeEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamBoolTypeEditObj::create() {
		cfbam::ICFBamBoolTypeObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsBoolType()->getSchema() )->getBoolTypeTableObj()->createBoolType( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamBoolTypeEditObj::update() {
		getSchema()->getBoolTypeTableObj()->updateBoolType( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamBoolTypeEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getBoolTypeTableObj()->deleteBoolType( this );
		return( NULL );
	}

	cfbam::ICFBamBoolTypeTableObj* CFBamBoolTypeEditObj::getBoolTypeTable() {
		return( orig->getSchema()->getBoolTypeTableObj() );
	}

	cfbam::ICFBamBoolTypeEditObj* CFBamBoolTypeEditObj::getBoolTypeEdit() {
		return( (cfbam::ICFBamBoolTypeEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamBoolTypeEditObj::beginEdit() {
	...
	cfbam::ICFBamBoolTypeObj* CFBamBoolTypeEditObj::getOrigAsBoolType() {
		return( dynamic_cast<cfbam::ICFBamBoolTypeObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamBoolTypeEditObj::getBuff() {
		return( buff );
	}

	void CFBamBoolTypeEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamBoolDefEditObj::setBuff( value );
		}
	}

	const int64_t CFBamBoolTypeEditObj::getRequiredSchemaDefId() {
		return( getBoolTypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamBoolTypeEditObj::getRequiredSchemaDefIdReference() {
		return( getBoolTypeBuff()->getRequiredSchemaDefIdReference() );
	}

	void CFBamBoolTypeEditObj::setRequiredContainerScope( cfbam::ICFBamScopeObj* value ) {
		if( value == NULL ) {
	...
	cfbam::ICFBamSchemaDefObj* CFBamBoolTypeEditObj::getRequiredContainerSchemaDef( bool forceRead ) {
		cfbam::ICFBamSchemaDefObj* retobj = NULL;
		bool anyMissing = false;
		if( ! anyMissing ) {
			retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsBoolType()->getSchema() )->getSchemaDefTableObj()->readSchemaDefByIdIdx( getPKey()->getRequiredTenantId(),
					getBoolTypeBuff()->getRequiredSchemaDefId() );
		}
		return( retobj );
	}

	void CFBamBoolTypeEditObj::setRequiredContainerSchemaDef( cfbam::ICFBamSchemaDefObj* value ) {
			
			if( value != NULL ) {
				getPKey()->setRequiredTenantId
( value->getRequiredTenantId() );
				getBoolTypeEditBuff()->setRequiredTenantId( value->getRequiredTenantId() );
				getBoolTypeEditBuff()->setRequiredSchemaDefId( value->getRequiredId() );
			}

			CFBamBoolDefEditObj::setRequiredContainerScope( value );		}

	void CFBamBoolTypeEditObj::copyBuffToOrig() {
		cfbam::CFBamBoolTypeBuff* origBuff = getOrigAsBoolType()->getBoolTypeEditBuff();
		cfbam::CFBamBoolTypeBuff* myBuff = getBoolTypeBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamBoolTypeEditObj::copyOrigToBuff() {
		cfbam::CFBamBoolTypeBuff* origBuff = getOrigAsBoolType()->getBoolTypeBuff();
		cfbam::CFBamBoolTypeBuff* myBuff = getBoolTypeEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
