// Description: C++18 edit object instance implementation for CFBam TZDateDef.
...
namespace cfbam {
	...
	const std::string CFBamTZDateDefEditObj::CLASS_NAME( "CFBamTZDateDefEditObj" );

	CFBamTZDateDefEditObj::CFBamTZDateDefEditObj( cfbam::ICFBamTZDateDefObj* argOrig )
	: ICFBamTZDateDefEditObj(),
	  CFBamAtomEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamTZDateDefEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamTZDateDefEditObj::~CFBamTZDateDefEditObj() {
	}

	const std::string& CFBamTZDateDefEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamTZDateDefEditObj::getClassCode() const {
		return( cfbam::CFBamTZDateDefBuff::CLASS_CODE );
	}

	bool CFBamTZDateDefEditObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamTZDateDefEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZDateDefEditObj" );
	...
	const std::string CFBamTZDateDefEditObj::getGenDefName() {
		return( cfbam::CFBamTZDateDefBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamTZDateDefEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamTZDateDefEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamTZDateDefEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamTZDateDefEditObj::getObjQualifiedName() {
	...
	std::string CFBamTZDateDefEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamTZDateDefEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamTZDateDefObj* retobj = getSchema()->getTZDateDefTableObj()->realizeTZDateDef( dynamic_cast<cfbam::ICFBamTZDateDefObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamTZDateDefEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamTZDateDefEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamTZDateDefEditObj::create() {
		cfbam::ICFBamTZDateDefObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsTZDateDef()->getSchema() )->getTZDateDefTableObj()->createTZDateDef( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamTZDateDefEditObj::update() {
		getSchema()->getTZDateDefTableObj()->updateTZDateDef( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamTZDateDefEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getTZDateDefTableObj()->deleteTZDateDef( this );
		return( NULL );
	}

	cfbam::ICFBamTZDateDefTableObj* CFBamTZDateDefEditObj::getTZDateDefTable() {
		return( orig->getSchema()->getTZDateDefTableObj() );
	}

	cfbam::ICFBamTZDateDefEditObj* CFBamTZDateDefEditObj::getTZDateDefEdit() {
		return( (cfbam::ICFBamTZDateDefEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamTZDateDefEditObj::beginEdit() {
	...
	cfbam::ICFBamTZDateDefObj* CFBamTZDateDefEditObj::getOrigAsTZDateDef() {
		return( dynamic_cast<cfbam::ICFBamTZDateDefObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamTZDateDefEditObj::getBuff() {
		return( buff );
	}

	void CFBamTZDateDefEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamAtomEditObj::setBuff( value );
		}
	}

	bool CFBamTZDateDefEditObj::isOptionalDummyNull() {
		return( getTZDateDefBuff()->isOptionalDummyNull() );
	}

	const std::string& CFBamTZDateDefEditObj::getOptionalDummyValue() {
		return( getTZDateDefBuff()->getOptionalDummyValue() );
	}

	const std::string* CFBamTZDateDefEditObj::getOptionalDummyReference() {
		return( getTZDateDefBuff()->getOptionalDummyReference() );
	}

	void CFBamTZDateDefEditObj::setOptionalDummyNull() {
		if( ! getTZDateDefBuff()->isOptionalDummyNull() ) {
			getTZDateDefEditBuff()->setOptionalDummyNull();
		}
	}

	void CFBamTZDateDefEditObj::setOptionalDummyValue( const std::string& value ) {
		if( getTZDateDefBuff()->isOptionalDummyNull() ) {
			getTZDateDefEditBuff()->setOptionalDummyValue( value );
		}
		else if( getTZDateDefBuff()->getOptionalDummyValue() != value ) {
			getTZDateDefEditBuff()->setOptionalDummyValue( value );
		}
	}

	void CFBamTZDateDefEditObj::copyBuffToOrig() {
		cfbam::CFBamTZDateDefBuff* origBuff = getOrigAsTZDateDef()->getTZDateDefEditBuff();
		cfbam::CFBamTZDateDefBuff* myBuff = getTZDateDefBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamTZDateDefEditObj::copyOrigToBuff() {
		cfbam::CFBamTZDateDefBuff* origBuff = getOrigAsTZDateDef()->getTZDateDefBuff();
		cfbam::CFBamTZDateDefBuff* myBuff = getTZDateDefEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
