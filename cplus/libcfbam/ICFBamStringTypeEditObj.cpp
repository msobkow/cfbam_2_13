// Description: C++18 Instance Edit Object interface implementation for CFBam StringType.
...
namespace cfbam {
	...
	const std::string ICFBamStringTypeEditObj::CLASS_NAME( "ICFBamStringTypeEditObj" );

	ICFBamStringTypeEditObj::ICFBamStringTypeEditObj()
