// Description: C++18 implementation for a BlobCol buffer object.
...
namespace cfbam {
	...
	const std::string CFBamBlobColBuff::GENDEFNAME( "BlobCol" );
	const classcode_t CFBamBlobColBuff::CLASS_CODE = 0xa852L;
	const std::string CFBamBlobColBuff::CLASS_NAME( "CFBamBlobColBuff" );
		const std::string CFBamBlobColBuff::COLNAME_TABLEID( "TableId" );
	const int64_t CFBamBlobColBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamBlobColBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamBlobColBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamBlobColBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamBlobColBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamBlobColBuff::TABLEID_MIN_VALUE = 0LL;

	CFBamBlobColBuff::CFBamBlobColBuff()
	: CFBamBlobDefBuff()
	{
		requiredTableId = cfbam::CFBamBlobColBuff::TABLEID_INIT_VALUE;
	}

	CFBamBlobColBuff::CFBamBlobColBuff( const CFBamBlobColBuff& src )
	: CFBamBlobDefBuff()
	{
		requiredTableId = cfbam::CFBamBlobColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamBlobColBuff::clone() {
		CFBamBlobColBuff* copy = new CFBamBlobColBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamBlobColBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamBlobColBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamBlobColBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFBamBlobColBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamBlobColBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamBlobColBuff::setRequiredTableId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredTableId" );
		if( value < cfbam::CFBamBlobColBuff::TABLEID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamBlobColBuff::TABLEID_MIN_VALUE );
		}
		requiredTableId = value;
	}

	size_t CFBamBlobColBuff::hashCode() const {
		size_t hashCode = CFBamBlobDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamBlobColBuff CFBamBlobColBuff::operator =( cfbam::CFBamBlobColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamBlobColBuff CFBamBlobColBuff::operator =( cfbam::CFBamBlobColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamBlobColBuff::operator <( const CFBamBlobColByTableIdxKey& rhs ) {
	...
	bool CFBamBlobColBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamBlobColBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamBlobColBuff::operator <( const CFBamBlobColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamBlobColBuff::operator <( const CFBamBlobColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamBlobColBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamBlobColBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamBlobColBuff& lhs, const cfbam::CFBamBlobColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamBlobColBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamBlobColBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamBlobColBuff& lhs, const cfbam::CFBamBlobColHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamBlobColBuff& lhs, const cfbam::CFBamBlobColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
