// Description: C++18 implementation of a NumberDef history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamNumberDefHBuff::CLASS_NAME( "CFBamNumberDefHBuff" );
	CFBamNumberDefHBuff::CFBamNumberDefHBuff()
	...
	CFBamNumberDefHBuff::CFBamNumberDefHBuff( const CFBamNumberDefHBuff& src )
	: cfbam::CFBamAtomHBuff() {
		requiredDigits = cfbam::CFBamNumberDefBuff::DIGITS_INIT_VALUE;
		requiredPrecis = cfbam::CFBamNumberDefBuff::PRECIS_INIT_VALUE;
		optionalInitValue = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamNumberDefHBuff::clone() {
		CFBamNumberDefHBuff* copy = new CFBamNumberDefHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int16_t CFBamNumberDefHBuff::getRequiredDigits() const {
		return( requiredDigits );
	}

	const int16_t* CFBamNumberDefHBuff::getRequiredDigitsReference() const {
		return( &requiredDigits );
	}

	void CFBamNumberDefHBuff::setRequiredDigits( const int16_t value ) {
	...
	const int16_t CFBamNumberDefHBuff::getRequiredPrecis() const {
		return( requiredPrecis );
	}

	const int16_t* CFBamNumberDefHBuff::getRequiredPrecisReference() const {
		return( &requiredPrecis );
	}

	void CFBamNumberDefHBuff::setRequiredPrecis( const int16_t value ) {
	...
	const cflib::TCFLibBigDecimal<31,5>& CFBamNumberDefHBuff::getOptionalInitValueValue() const {
	...
	const cflib::TCFLibBigDecimal<31,5>* CFBamNumberDefHBuff::getOptionalInitValueReference() const {
		return( optionalInitValue );
	}

	const bool CFBamNumberDefHBuff::isOptionalInitValueNull() const {
		return( optionalInitValue == NULL );
	}

	void CFBamNumberDefHBuff::setOptionalInitValueNull() {
		if( optionalInitValue != NULL ) {
			delete optionalInitValue;
			optionalInitValue = NULL;
		}
	...
	void CFBamNumberDefHBuff::setOptionalInitValueValue( const cflib::CFLibGenericBigDecimal& value ) {
	...
	const cflib::TCFLibBigDecimal<31,5>& CFBamNumberDefHBuff::getOptionalMinValueValue() const {
	...
	const cflib::TCFLibBigDecimal<31,5>* CFBamNumberDefHBuff::getOptionalMinValueReference() const {
		return( optionalMinValue );
	}

	const bool CFBamNumberDefHBuff::isOptionalMinValueNull() const {
		return( optionalMinValue == NULL );
	}

	void CFBamNumberDefHBuff::setOptionalMinValueNull() {
		if( optionalMinValue != NULL ) {
			delete optionalMinValue;
			optionalMinValue = NULL;
		}
	...
	void CFBamNumberDefHBuff::setOptionalMinValueValue( const cflib::CFLibGenericBigDecimal& value ) {
	...
	const cflib::TCFLibBigDecimal<31,5>& CFBamNumberDefHBuff::getOptionalMaxValueValue() const {
	...
	const cflib::TCFLibBigDecimal<31,5>* CFBamNumberDefHBuff::getOptionalMaxValueReference() const {
		return( optionalMaxValue );
	}

	const bool CFBamNumberDefHBuff::isOptionalMaxValueNull() const {
		return( optionalMaxValue == NULL );
	}

	void CFBamNumberDefHBuff::setOptionalMaxValueNull() {
		if( optionalMaxValue != NULL ) {
			delete optionalMaxValue;
			optionalMaxValue = NULL;
		}
	...
	void CFBamNumberDefHBuff::setOptionalMaxValueValue( const cflib::CFLibGenericBigDecimal& value ) {
	...
	size_t CFBamNumberDefHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamNumberDefHBuff::hashCode();
	...
	CFBamNumberDefHBuff CFBamNumberDefHBuff::operator =( cfbam::CFBamNumberDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamNumberDefHBuff CFBamNumberDefHBuff::operator =( cfbam::CFBamNumberDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamNumberDefHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamNumberDefHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamNumberDefHBuff::operator <( const CFBamNumberDefHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamNumberDefHBuff::operator <( const CFBamNumberDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamNumberDefHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNumberDefHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamNumberDefHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamNumberDefHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamNumberDefHBuff& lhs, const cfbam::CFBamNumberDefHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamNumberDefHBuff& lhs, const cfbam::CFBamNumberDefBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
