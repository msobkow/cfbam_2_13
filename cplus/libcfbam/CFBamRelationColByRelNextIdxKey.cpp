// Description: C++18 implementation for a RelationCol by RelNextIdx index key object.
...
namespace cfbam {
	const std::string CFBamRelationColByRelNextIdxKey::CLASS_NAME( "CFBamRelationColByRelNextIdxKey" );
	const std::string CFBamRelationColByRelNextIdxKey::S_VALUE( "value" );
	const std::string CFBamRelationColByRelNextIdxKey::S_VALUE_LENGTH( "value.length()" );


	CFBamRelationColByRelNextIdxKey::CFBamRelationColByRelNextIdxKey() {
	...
	CFBamRelationColByRelNextIdxKey::CFBamRelationColByRelNextIdxKey( const CFBamRelationColByRelNextIdxKey& src ) {
		requiredTenantId = cfbam::CFBamRelationColBuff::TENANTID_INIT_VALUE;
		requiredRelationId = cfbam::CFBamRelationColBuff::RELATIONID_INIT_VALUE;
		optionalNextId.setNull();
	...
	const int64_t CFBamRelationColByRelNextIdxKey::getRequiredTenantId() const {
		return( requiredTenantId );
	}

	const int64_t* CFBamRelationColByRelNextIdxKey::getRequiredTenantIdReference() const {
		return( &requiredTenantId );
	}

	void CFBamRelationColByRelNextIdxKey::setRequiredTenantId( const int64_t value ) {
	...
	const int64_t CFBamRelationColByRelNextIdxKey::getRequiredRelationId() const {
		return( requiredRelationId );
	}

	const int64_t* CFBamRelationColByRelNextIdxKey::getRequiredRelationIdReference() const {
		return( &requiredRelationId );
	}

	void CFBamRelationColByRelNextIdxKey::setRequiredRelationId( const int64_t value ) {
	...
	const int64_t CFBamRelationColByRelNextIdxKey::getOptionalNextIdValue() const {
		return( optionalNextId.getValue() );
	}

	const int64_t* CFBamRelationColByRelNextIdxKey::getOptionalNextIdReference() const {
		return( optionalNextId.getReference() );
	}

	const bool CFBamRelationColByRelNextIdxKey::isOptionalNextIdNull() const {
		return( optionalNextId.isNull() );
	}

	void CFBamRelationColByRelNextIdxKey::setOptionalNextIdNull() {
		optionalNextId.setNull();
	}

	void CFBamRelationColByRelNextIdxKey::setOptionalNextIdValue( const int64_t value ) {
	...
	size_t CFBamRelationColByRelNextIdxKey::hashCode() const {
		size_t hashCode = 0;
	...
	std::string CFBamRelationColByRelNextIdxKey::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamRelationColByRelNextIdxKey" );
	...
	bool CFBamRelationColByRelNextIdxKey::operator <( const CFBamRelationColByRelNextIdxKey& rhs ) {
	...
	bool CFBamRelationColByRelNextIdxKey::operator <( const CFBamRelationColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamRelationColByRelNextIdxKey::operator <( const CFBamRelationColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	CFBamRelationColByRelNextIdxKey CFBamRelationColByRelNextIdxKey::operator =( cfbam::CFBamRelationColByRelNextIdxKey& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredRelationId( src.getRequiredRelationId() );
		if( src.isOptionalNextIdNull() ) {
			setOptionalNextIdNull();
	...
	CFBamRelationColByRelNextIdxKey CFBamRelationColByRelNextIdxKey::operator =( cfbam::CFBamRelationColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredRelationId( src.getRequiredRelationId() );
		if( src.isOptionalNextIdNull() ) {
			setOptionalNextIdNull();
	...
	CFBamRelationColByRelNextIdxKey CFBamRelationColByRelNextIdxKey::operator =( cfbam::CFBamRelationColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredRelationId( src.getRequiredRelationId() );
		if( src.isOptionalNextIdNull() ) {
			setOptionalNextIdNull();
