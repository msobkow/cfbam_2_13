// Description: C++18 base object instance implementation for CFBam EnumDef.
...
namespace cfbam {
	...
	const std::string CFBamEnumDefObj::CLASS_NAME( "CFBamEnumDefObj" );
	const classcode_t CFBamEnumDefObj::CLASS_CODE = 0xa856L;


	std::vector<cfbam::ICFBamEnumTagObj*> CFBamEnumDefObj::getRequiredComponentsTag( bool forceRead ) {
		std::vector<cfbam::ICFBamEnumTagObj*> retval;
		retval = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getEnumTagTableObj()->readEnumTagByEnumIdx( getPKey()->getRequiredTenantId(),
					getPKey()->getRequiredId(),
			forceRead );
		return( retval );
	}

	CFBamEnumDefObj::CFBamEnumDefObj()
	: ICFBamEnumDefObj(),
	  CFBamInt16DefObj()
	{
	}

	CFBamEnumDefObj::CFBamEnumDefObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamEnumDefObj(),
	...
	cfbam::CFBamValueBuff* CFBamEnumDefObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamEnumDefBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableEnumDef()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamEnumDefObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamEnumDefObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamEnumDefObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamEnumDefObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamEnumDefObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamEnumDefObj" );
	...
	std::string CFBamEnumDefObj::getObjName() {
	...
	const std::string CFBamEnumDefObj::getGenDefName() {
		return( cfbam::CFBamEnumDefBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamEnumDefObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamEnumDefObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamEnumDefObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamEnumDefObj::getObjQualifiedName() {
	...
	std::string CFBamEnumDefObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamEnumDefObj::realize() {
		cfbam::ICFBamEnumDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getEnumDefTableObj()->realizeEnumDef(
			(cfbam::ICFBamEnumDefObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamEnumDefObj::read( bool forceRead ) {
		cfbam::ICFBamEnumDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getEnumDefTableObj()->readEnumDefByIdIdx( getEnumDefBuff()->getRequiredTenantId(),
		getEnumDefBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamEnumDefObj::moveUp() {
		cfbam::ICFBamEnumDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getEnumDefTableObj()->moveUpEnumDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamEnumDefObj::moveDown() {
		cfbam::ICFBamEnumDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getEnumDefTableObj()->moveDownEnumDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamEnumDefObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamEnumDefObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getEnumDefTableObj()->lockEnumDef( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getEnumDefTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamEnumDefEditObj* CFBamEnumDefObj::getEnumDefEdit() {
		return( dynamic_cast<cfbam::ICFBamEnumDefEditObj*>( edit ) );
	}
