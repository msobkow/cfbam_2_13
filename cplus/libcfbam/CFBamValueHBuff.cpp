// Description: C++18 implementation of a Value history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamValueHBuff::CLASS_NAME( "CFBamValueHBuff" );
	CFBamValueHBuff::CFBamValueHBuff()
	...
	CFBamValueHBuff::CFBamValueHBuff( const CFBamValueHBuff& src )
	: CFBamHPKey(), cflib::ICFLibCloneableObj() {
		requiredTenantId = cfbam::CFBamValueBuff::TENANTID_INIT_VALUE;
		requiredScopeId = cfbam::CFBamValueBuff::SCOPEID_INIT_VALUE;
		requiredId = cfbam::CFBamValueBuff::ID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamValueHBuff::clone() {
		CFBamValueHBuff* copy = new CFBamValueHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamValueHBuff::getRequiredTenantId() const {
		return( requiredTenantId );
	}

	const int64_t* CFBamValueHBuff::getRequiredTenantIdReference() const {
		return( &requiredTenantId );
	}

	void CFBamValueHBuff::setRequiredTenantId( const int64_t value ) {
	...
	const int64_t CFBamValueHBuff::getRequiredScopeId() const {
		return( requiredScopeId );
	}

	const int64_t* CFBamValueHBuff::getRequiredScopeIdReference() const {
		return( &requiredScopeId );
	}

	void CFBamValueHBuff::setRequiredScopeId( const int64_t value ) {
	...
	const int64_t CFBamValueHBuff::getRequiredId() const {
		return( requiredId );
	}

	const int64_t* CFBamValueHBuff::getRequiredIdReference() const {
		return( &requiredId );
	}

	void CFBamValueHBuff::setRequiredId( const int64_t value ) {
	...
	const int64_t CFBamValueHBuff::getOptionalDefSchemaTenantIdValue() const {
		return( optionalDefSchemaTenantId.getValue() );
	}

	const int64_t* CFBamValueHBuff::getOptionalDefSchemaTenantIdReference() const {
		return( optionalDefSchemaTenantId.getReference() );
	}

	const bool CFBamValueHBuff::isOptionalDefSchemaTenantIdNull() const {
		return( optionalDefSchemaTenantId.isNull() );
	}

	void CFBamValueHBuff::setOptionalDefSchemaTenantIdNull() {
		optionalDefSchemaTenantId.setNull();
	}

	void CFBamValueHBuff::setOptionalDefSchemaTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamValueHBuff::getOptionalDefSchemaIdValue() const {
		return( optionalDefSchemaId.getValue() );
	}

	const int64_t* CFBamValueHBuff::getOptionalDefSchemaIdReference() const {
		return( optionalDefSchemaId.getReference() );
	}

	const bool CFBamValueHBuff::isOptionalDefSchemaIdNull() const {
		return( optionalDefSchemaId.isNull() );
	}

	void CFBamValueHBuff::setOptionalDefSchemaIdNull() {
		optionalDefSchemaId.setNull();
	}

	void CFBamValueHBuff::setOptionalDefSchemaIdValue( const int64_t value ) {
	...
	const std::string& CFBamValueHBuff::getRequiredName() const {
		return( *requiredName );
	}

	const std::string* CFBamValueHBuff::getRequiredNameReference() const {
		return( requiredName );
	}

	void CFBamValueHBuff::setRequiredName( const std::string& value ) {
	...
	const std::string& CFBamValueHBuff::getOptionalShortNameValue() const {
	...
	const std::string* CFBamValueHBuff::getOptionalShortNameReference() const {
		return( optionalShortName );
	}

	const bool CFBamValueHBuff::isOptionalShortNameNull() const {
		return( optionalShortName == NULL );
	}

	void CFBamValueHBuff::setOptionalShortNameNull() {
		if( optionalShortName != NULL ) {
			delete optionalShortName;
			optionalShortName = NULL;
		}
	...
	void CFBamValueHBuff::setOptionalShortNameValue( const std::string& value ) {
	...
	const std::string& CFBamValueHBuff::getOptionalLabelValue() const {
	...
	const std::string* CFBamValueHBuff::getOptionalLabelReference() const {
		return( optionalLabel );
	}

	const bool CFBamValueHBuff::isOptionalLabelNull() const {
		return( optionalLabel == NULL );
	}

	void CFBamValueHBuff::setOptionalLabelNull() {
		if( optionalLabel != NULL ) {
			delete optionalLabel;
			optionalLabel = NULL;
		}
	...
	void CFBamValueHBuff::setOptionalLabelValue( const std::string& value ) {
	...
	const std::string& CFBamValueHBuff::getOptionalShortDescriptionValue() const {
	...
	const std::string* CFBamValueHBuff::getOptionalShortDescriptionReference() const {
		return( optionalShortDescription );
	}

	const bool CFBamValueHBuff::isOptionalShortDescriptionNull() const {
		return( optionalShortDescription == NULL );
	}

	void CFBamValueHBuff::setOptionalShortDescriptionNull() {
		if( optionalShortDescription != NULL ) {
			delete optionalShortDescription;
			optionalShortDescription = NULL;
		}
	...
	void CFBamValueHBuff::setOptionalShortDescriptionValue( const std::string& value ) {
	...
	const std::string& CFBamValueHBuff::getOptionalDescriptionValue() const {
	...
	const std::string* CFBamValueHBuff::getOptionalDescriptionReference() const {
		return( optionalDescription );
	}

	const bool CFBamValueHBuff::isOptionalDescriptionNull() const {
		return( optionalDescription == NULL );
	}

	void CFBamValueHBuff::setOptionalDescriptionNull() {
		if( optionalDescription != NULL ) {
			delete optionalDescription;
			optionalDescription = NULL;
		}
	...
	void CFBamValueHBuff::setOptionalDescriptionValue( const std::string& value ) {
	...
	const std::string& CFBamValueHBuff::getOptionalDefaultXmlValueValue() const {
	...
	const std::string* CFBamValueHBuff::getOptionalDefaultXmlValueReference() const {
		return( optionalDefaultXmlValue );
	}

	const bool CFBamValueHBuff::isOptionalDefaultXmlValueNull() const {
		return( optionalDefaultXmlValue == NULL );
	}

	void CFBamValueHBuff::setOptionalDefaultXmlValueNull() {
		if( optionalDefaultXmlValue != NULL ) {
			delete optionalDefaultXmlValue;
			optionalDefaultXmlValue = NULL;
		}
	...
	void CFBamValueHBuff::setOptionalDefaultXmlValueValue( const std::string& value ) {
	...
	const bool CFBamValueHBuff::getRequiredIsNullable() const {
		return( requiredIsNullable );
	}

	const bool* CFBamValueHBuff::getRequiredIsNullableReference() const {
		return( &requiredIsNullable );
	}

	void CFBamValueHBuff::setRequiredIsNullable( const bool value ) {
		requiredIsNullable = value;
	}

	const bool CFBamValueHBuff::getOptionalGenerateIdValue() const {
		return( optionalGenerateId.getValue() );
	}

	const bool* CFBamValueHBuff::getOptionalGenerateIdReference() const {
		return( optionalGenerateId.getReference() );
	}

	const bool CFBamValueHBuff::isOptionalGenerateIdNull() const {
		return( optionalGenerateId.isNull() );
	}

	void CFBamValueHBuff::setOptionalGenerateIdNull() {
		optionalGenerateId.setNull();
	}

	void CFBamValueHBuff::setOptionalGenerateIdValue( const bool value ) {
		optionalGenerateId.setValue( value );
	}

	const bool CFBamValueHBuff::getRequiredImplementsPolymorph() const {
		return( requiredImplementsPolymorph );
	}

	const bool* CFBamValueHBuff::getRequiredImplementsPolymorphReference() const {
		return( &requiredImplementsPolymorph );
	}

	void CFBamValueHBuff::setRequiredImplementsPolymorph( const bool value ) {
		requiredImplementsPolymorph = value;
	}

	const int64_t CFBamValueHBuff::getOptionalPrevTenantIdValue() const {
		return( optionalPrevTenantId.getValue() );
	}

	const int64_t* CFBamValueHBuff::getOptionalPrevTenantIdReference() const {
		return( optionalPrevTenantId.getReference() );
	}

	const bool CFBamValueHBuff::isOptionalPrevTenantIdNull() const {
		return( optionalPrevTenantId.isNull() );
	}

	void CFBamValueHBuff::setOptionalPrevTenantIdNull() {
		optionalPrevTenantId.setNull();
	}

	void CFBamValueHBuff::setOptionalPrevTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamValueHBuff::getOptionalPrevIdValue() const {
		return( optionalPrevId.getValue() );
	}

	const int64_t* CFBamValueHBuff::getOptionalPrevIdReference() const {
		return( optionalPrevId.getReference() );
	}

	const bool CFBamValueHBuff::isOptionalPrevIdNull() const {
		return( optionalPrevId.isNull() );
	}

	void CFBamValueHBuff::setOptionalPrevIdNull() {
		optionalPrevId.setNull();
	}

	void CFBamValueHBuff::setOptionalPrevIdValue( const int64_t value ) {
	...
	const int64_t CFBamValueHBuff::getOptionalNextTenantIdValue() const {
		return( optionalNextTenantId.getValue() );
	}

	const int64_t* CFBamValueHBuff::getOptionalNextTenantIdReference() const {
		return( optionalNextTenantId.getReference() );
	}

	const bool CFBamValueHBuff::isOptionalNextTenantIdNull() const {
		return( optionalNextTenantId.isNull() );
	}

	void CFBamValueHBuff::setOptionalNextTenantIdNull() {
		optionalNextTenantId.setNull();
	}

	void CFBamValueHBuff::setOptionalNextTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamValueHBuff::getOptionalNextIdValue() const {
		return( optionalNextId.getValue() );
	}

	const int64_t* CFBamValueHBuff::getOptionalNextIdReference() const {
		return( optionalNextId.getReference() );
	}

	const bool CFBamValueHBuff::isOptionalNextIdNull() const {
		return( optionalNextId.isNull() );
	}

	void CFBamValueHBuff::setOptionalNextIdNull() {
		optionalNextId.setNull();
	}

	void CFBamValueHBuff::setOptionalNextIdValue( const int64_t value ) {
	...
	size_t CFBamValueHBuff::hashCode() const {
	...
	CFBamValueHBuff CFBamValueHBuff::operator =( cfbam::CFBamValueBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamValueHBuff CFBamValueHBuff::operator =( cfbam::CFBamValueHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamValueHBuff::operator <( const CFBamValueByUNameIdxKey& rhs ) {
	...
	bool CFBamValueHBuff::operator <( const CFBamValueByValTentIdxKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamValueHBuff::operator <( const CFBamValueByScopeIdxKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamValueHBuff::operator <( const CFBamValueByDefSchemaIdxKey& rhs ) {
		if( ! isOptionalDefSchemaTenantIdNull() ) {
	...
	bool CFBamValueHBuff::operator <( const CFBamValueByPrevIdxKey& rhs ) {
		if( ! isOptionalPrevTenantIdNull() ) {
	...
	bool CFBamValueHBuff::operator <( const CFBamValueByNextIdxKey& rhs ) {
		if( ! isOptionalNextTenantIdNull() ) {
	...
	bool CFBamValueHBuff::operator <( const CFBamValueByContPrevIdxKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamValueHBuff::operator <( const CFBamValueByContNextIdxKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamValueHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamValueHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamValueHBuff::operator <( const CFBamValueHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamValueHBuff::operator <( const CFBamValueBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamValueHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamValueHBuff" );
