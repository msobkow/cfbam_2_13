// Description: C++18 edit object instance implementation for CFBam NmTokensDef.
...
namespace cfbam {
	...
	const std::string CFBamNmTokensDefEditObj::CLASS_NAME( "CFBamNmTokensDefEditObj" );

	CFBamNmTokensDefEditObj::CFBamNmTokensDefEditObj( cfbam::ICFBamNmTokensDefObj* argOrig )
	: ICFBamNmTokensDefEditObj(),
	  CFBamAtomEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamNmTokensDefEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamNmTokensDefEditObj::~CFBamNmTokensDefEditObj() {
	}

	const std::string& CFBamNmTokensDefEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamNmTokensDefEditObj::getClassCode() const {
		return( cfbam::CFBamNmTokensDefBuff::CLASS_CODE );
	}

	bool CFBamNmTokensDefEditObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamNmTokensDefBuff::CLASS_CODE ) {
			return( true );
		}
		else {
	...
	std::string CFBamNmTokensDefEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNmTokensDefEditObj" );
	...
	const std::string CFBamNmTokensDefEditObj::getGenDefName() {
		return( cfbam::CFBamNmTokensDefBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamNmTokensDefEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamNmTokensDefEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamNmTokensDefEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamNmTokensDefEditObj::getObjQualifiedName() {
	...
	std::string CFBamNmTokensDefEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamNmTokensDefEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamNmTokensDefObj* retobj = getSchema()->getNmTokensDefTableObj()->realizeNmTokensDef( dynamic_cast<cfbam::ICFBamNmTokensDefObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamNmTokensDefEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamNmTokensDefEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamNmTokensDefEditObj::create() {
		cfbam::ICFBamNmTokensDefObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsNmTokensDef()->getSchema() )->getNmTokensDefTableObj()->createNmTokensDef( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamNmTokensDefEditObj::update() {
		getSchema()->getNmTokensDefTableObj()->updateNmTokensDef( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamNmTokensDefEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getNmTokensDefTableObj()->deleteNmTokensDef( this );
		return( NULL );
	}

	cfbam::ICFBamNmTokensDefTableObj* CFBamNmTokensDefEditObj::getNmTokensDefTable() {
		return( orig->getSchema()->getNmTokensDefTableObj() );
	}

	cfbam::ICFBamNmTokensDefEditObj* CFBamNmTokensDefEditObj::getNmTokensDefEdit() {
		return( (cfbam::ICFBamNmTokensDefEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamNmTokensDefEditObj::beginEdit() {
	...
	cfbam::ICFBamNmTokensDefObj* CFBamNmTokensDefEditObj::getOrigAsNmTokensDef() {
		return( dynamic_cast<cfbam::ICFBamNmTokensDefObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamNmTokensDefEditObj::getBuff() {
		return( buff );
	}

	void CFBamNmTokensDefEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamAtomEditObj::setBuff( value );
		}
	}

	const int32_t CFBamNmTokensDefEditObj::getRequiredMaxLen() {
		return( getNmTokensDefBuff()->getRequiredMaxLen() );
	}

	const int32_t* CFBamNmTokensDefEditObj::getRequiredMaxLenReference() {
		return( getNmTokensDefBuff()->getRequiredMaxLenReference() );
	}

	void CFBamNmTokensDefEditObj::setRequiredMaxLen( const int32_t value ) {
		if( getNmTokensDefBuff()->getRequiredMaxLen() != value ) {
			getNmTokensDefEditBuff()->setRequiredMaxLen( value );
		}
	}

	bool CFBamNmTokensDefEditObj::isOptionalInitValueNull() {
		return( getNmTokensDefBuff()->isOptionalInitValueNull() );
	}

	const std::string& CFBamNmTokensDefEditObj::getOptionalInitValueValue() {
		return( getNmTokensDefBuff()->getOptionalInitValueValue() );
	}

	const std::string* CFBamNmTokensDefEditObj::getOptionalInitValueReference() {
		return( getNmTokensDefBuff()->getOptionalInitValueReference() );
	}

	void CFBamNmTokensDefEditObj::setOptionalInitValueNull() {
		if( ! getNmTokensDefBuff()->isOptionalInitValueNull() ) {
			getNmTokensDefEditBuff()->setOptionalInitValueNull();
		}
	}

	void CFBamNmTokensDefEditObj::setOptionalInitValueValue( const std::string& value ) {
		if( getNmTokensDefBuff()->isOptionalInitValueNull() ) {
			getNmTokensDefEditBuff()->setOptionalInitValueValue( value );
		}
		else if( getNmTokensDefBuff()->getOptionalInitValueValue() != value ) {
			getNmTokensDefEditBuff()->setOptionalInitValueValue( value );
		}
	}

	void CFBamNmTokensDefEditObj::copyBuffToOrig() {
		cfbam::CFBamNmTokensDefBuff* origBuff = getOrigAsNmTokensDef()->getNmTokensDefEditBuff();
		cfbam::CFBamNmTokensDefBuff* myBuff = getNmTokensDefBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamNmTokensDefEditObj::copyOrigToBuff() {
		cfbam::CFBamNmTokensDefBuff* origBuff = getOrigAsNmTokensDef()->getNmTokensDefBuff();
		cfbam::CFBamNmTokensDefBuff* myBuff = getNmTokensDefEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
