// Description: C++18 implementation of a Id32Gen history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamId32GenHBuff::CLASS_NAME( "CFBamId32GenHBuff" );
	CFBamId32GenHBuff::CFBamId32GenHBuff()
	: cfbam::CFBamInt32TypeHBuff() {
	...
	CFBamId32GenHBuff::CFBamId32GenHBuff( const CFBamId32GenHBuff& src )
	: cfbam::CFBamInt32TypeHBuff() {
		optionalDispenserTenantId.setNull();
		optionalDispenserId.setNull();
		requiredSlice = cfbam::CFBamId32GenBuff::SLICE_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamId32GenHBuff::clone() {
		CFBamId32GenHBuff* copy = new CFBamId32GenHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamId32GenHBuff::getOptionalDispenserTenantIdValue() const {
		return( optionalDispenserTenantId.getValue() );
	}

	const int64_t* CFBamId32GenHBuff::getOptionalDispenserTenantIdReference() const {
		return( optionalDispenserTenantId.getReference() );
	}

	const bool CFBamId32GenHBuff::isOptionalDispenserTenantIdNull() const {
		return( optionalDispenserTenantId.isNull() );
	}

	void CFBamId32GenHBuff::setOptionalDispenserTenantIdNull() {
		optionalDispenserTenantId.setNull();
	}

	void CFBamId32GenHBuff::setOptionalDispenserTenantIdValue( const int64_t value ) {
	...
	const int64_t CFBamId32GenHBuff::getOptionalDispenserIdValue() const {
		return( optionalDispenserId.getValue() );
	}

	const int64_t* CFBamId32GenHBuff::getOptionalDispenserIdReference() const {
		return( optionalDispenserId.getReference() );
	}

	const bool CFBamId32GenHBuff::isOptionalDispenserIdNull() const {
		return( optionalDispenserId.isNull() );
	}

	void CFBamId32GenHBuff::setOptionalDispenserIdNull() {
		optionalDispenserId.setNull();
	}

	void CFBamId32GenHBuff::setOptionalDispenserIdValue( const int64_t value ) {
	...
	const int16_t CFBamId32GenHBuff::getRequiredSlice() const {
		return( requiredSlice );
	}

	const int16_t* CFBamId32GenHBuff::getRequiredSliceReference() const {
		return( &requiredSlice );
	}

	void CFBamId32GenHBuff::setRequiredSlice( const int16_t value ) {
	...
	const int32_t CFBamId32GenHBuff::getRequiredBlockSize() const {
		return( requiredBlockSize );
	}

	const int32_t* CFBamId32GenHBuff::getRequiredBlockSizeReference() const {
		return( &requiredBlockSize );
	}

	void CFBamId32GenHBuff::setRequiredBlockSize( const int32_t value ) {
	...
	size_t CFBamId32GenHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamId32GenHBuff::hashCode();
	...
	CFBamId32GenHBuff CFBamId32GenHBuff::operator =( cfbam::CFBamId32GenBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamId32GenHBuff CFBamId32GenHBuff::operator =( cfbam::CFBamId32GenHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamId32GenHBuff::operator <( const CFBamId32GenByDispIdxKey& rhs ) {
		if( ! isOptionalDispenserTenantIdNull() ) {
	...
	bool CFBamId32GenHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamId32GenHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamId32GenHBuff::operator <( const CFBamId32GenHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamId32GenHBuff::operator <( const CFBamId32GenBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamId32GenHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamId32GenHBuff" );
