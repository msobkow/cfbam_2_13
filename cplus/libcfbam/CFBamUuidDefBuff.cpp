// Description: C++18 implementation for a UuidDef buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUuidDefBuff::GENDEFNAME( "UuidDef" );
	const classcode_t CFBamUuidDefBuff::CLASS_CODE = 0xa850L;
	const std::string CFBamUuidDefBuff::CLASS_NAME( "CFBamUuidDefBuff" );
		const std::string CFBamUuidDefBuff::COLNAME_INITVALUE( "InitValue" );
	const int64_t CFBamUuidDefBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamUuidDefBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamUuidDefBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamUuidDefBuff::ID_MIN_VALUE = 0LL;

	CFBamUuidDefBuff::CFBamUuidDefBuff()
	: CFBamAtomBuff()
	{
		for( int i = 0; i < 16; i ++ ) {
			optionalInitValue[i] = 0;
		}
	}

	CFBamUuidDefBuff::CFBamUuidDefBuff( const CFBamUuidDefBuff& src )
	: CFBamAtomBuff()
	{
		for( int i = 0; i < 16; i ++ ) {
			optionalInitValue[i] = 0;
	...
	cflib::ICFLibCloneableObj* CFBamUuidDefBuff::clone() {
		CFBamUuidDefBuff* copy = new CFBamUuidDefBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamUuidDefBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUuidDefBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamUuidDefBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const bool CFBamUuidDefBuff::isOptionalInitValueNull() const {
		for( int i = 0; i < 16; i ++ ) {
			if( optionalInitValue[ i ] != 0 ) {
				return( false );
			}
		}
		return( true );
	...
	const uuid_ptr_t CFBamUuidDefBuff::getOptionalInitValueValue() const {
	...
	const uuid_ptr_t CFBamUuidDefBuff::getOptionalInitValueReference() const {
		if( isOptionalInitValueNull() ) {
			return( NULL );
		}
		else {
	...
	void CFBamUuidDefBuff::setOptionalInitValueNull() {
		for( int i = 0; i < 16; i ++ ) {
			optionalInitValue[i] = 0;
		}
	}

	void CFBamUuidDefBuff::setOptionalInitValueValue( const uuid_ptr_t value ) {
		uuid_copy( optionalInitValue, value );
	}

	void CFBamUuidDefBuff::generateOptionalInitValue() {
		uuid_generate_random( optionalInitValue );
	}

	size_t CFBamUuidDefBuff::hashCode() const {
	...
	CFBamUuidDefBuff CFBamUuidDefBuff::operator =( cfbam::CFBamUuidDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamUuidDefBuff CFBamUuidDefBuff::operator =( cfbam::CFBamUuidDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUuidDefBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamUuidDefBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUuidDefBuff::operator <( const CFBamUuidDefHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUuidDefBuff::operator <( const CFBamUuidDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUuidDefBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUuidDefBuff" );
