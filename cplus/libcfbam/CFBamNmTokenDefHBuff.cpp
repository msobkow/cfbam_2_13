// Description: C++18 implementation of a NmTokenDef history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamNmTokenDefHBuff::CLASS_NAME( "CFBamNmTokenDefHBuff" );
	CFBamNmTokenDefHBuff::CFBamNmTokenDefHBuff()
	: cfbam::CFBamAtomHBuff() {
		requiredMaxLen = cfbam::CFBamNmTokenDefBuff::MAXLEN_INIT_VALUE;
		optionalInitValue = NULL;
	}

	CFBamNmTokenDefHBuff::CFBamNmTokenDefHBuff( const CFBamNmTokenDefHBuff& src )
	: cfbam::CFBamAtomHBuff() {
		requiredMaxLen = cfbam::CFBamNmTokenDefBuff::MAXLEN_INIT_VALUE;
		optionalInitValue = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamNmTokenDefHBuff::clone() {
		CFBamNmTokenDefHBuff* copy = new CFBamNmTokenDefHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int32_t CFBamNmTokenDefHBuff::getRequiredMaxLen() const {
		return( requiredMaxLen );
	}

	const int32_t* CFBamNmTokenDefHBuff::getRequiredMaxLenReference() const {
		return( &requiredMaxLen );
	}

	void CFBamNmTokenDefHBuff::setRequiredMaxLen( const int32_t value ) {
	...
	const std::string& CFBamNmTokenDefHBuff::getOptionalInitValueValue() const {
	...
	const std::string* CFBamNmTokenDefHBuff::getOptionalInitValueReference() const {
		return( optionalInitValue );
	}

	const bool CFBamNmTokenDefHBuff::isOptionalInitValueNull() const {
		return( optionalInitValue == NULL );
	}

	void CFBamNmTokenDefHBuff::setOptionalInitValueNull() {
		if( optionalInitValue != NULL ) {
			delete optionalInitValue;
			optionalInitValue = NULL;
		}
	...
	void CFBamNmTokenDefHBuff::setOptionalInitValueValue( const std::string& value ) {
	...
	size_t CFBamNmTokenDefHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamNmTokenDefHBuff::hashCode();
	...
	CFBamNmTokenDefHBuff CFBamNmTokenDefHBuff::operator =( cfbam::CFBamNmTokenDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamNmTokenDefHBuff CFBamNmTokenDefHBuff::operator =( cfbam::CFBamNmTokenDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamNmTokenDefHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamNmTokenDefHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamNmTokenDefHBuff::operator <( const CFBamNmTokenDefHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamNmTokenDefHBuff::operator <( const CFBamNmTokenDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamNmTokenDefHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNmTokenDefHBuff" );
