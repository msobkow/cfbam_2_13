// Description: C++18 implementation of a EnumType history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamEnumTypeHBuff::CLASS_NAME( "CFBamEnumTypeHBuff" );
	CFBamEnumTypeHBuff::CFBamEnumTypeHBuff()
	: cfbam::CFBamEnumDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamEnumTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamEnumTypeHBuff::CFBamEnumTypeHBuff( const CFBamEnumTypeHBuff& src )
	: cfbam::CFBamEnumDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamEnumTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamEnumTypeHBuff::clone() {
		CFBamEnumTypeHBuff* copy = new CFBamEnumTypeHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamEnumTypeHBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamEnumTypeHBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamEnumTypeHBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamEnumTypeHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamEnumTypeHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamEnumTypeHBuff CFBamEnumTypeHBuff::operator =( cfbam::CFBamEnumTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamEnumTypeHBuff CFBamEnumTypeHBuff::operator =( cfbam::CFBamEnumTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamEnumTypeHBuff::operator <( const CFBamEnumTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamEnumTypeHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamEnumTypeHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamEnumTypeHBuff::operator <( const CFBamEnumTypeHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamEnumTypeHBuff::operator <( const CFBamEnumTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamEnumTypeHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamEnumTypeHBuff" );
