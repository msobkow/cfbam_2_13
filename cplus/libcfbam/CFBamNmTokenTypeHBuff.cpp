// Description: C++18 implementation of a NmTokenType history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamNmTokenTypeHBuff::CLASS_NAME( "CFBamNmTokenTypeHBuff" );
	CFBamNmTokenTypeHBuff::CFBamNmTokenTypeHBuff()
	: cfbam::CFBamNmTokenDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamNmTokenTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamNmTokenTypeHBuff::CFBamNmTokenTypeHBuff( const CFBamNmTokenTypeHBuff& src )
	: cfbam::CFBamNmTokenDefHBuff() {
		requiredSchemaDefId = cfbam::CFBamNmTokenTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamNmTokenTypeHBuff::clone() {
		CFBamNmTokenTypeHBuff* copy = new CFBamNmTokenTypeHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamNmTokenTypeHBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamNmTokenTypeHBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamNmTokenTypeHBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamNmTokenTypeHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamNmTokenTypeHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamNmTokenTypeHBuff CFBamNmTokenTypeHBuff::operator =( cfbam::CFBamNmTokenTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamNmTokenTypeHBuff CFBamNmTokenTypeHBuff::operator =( cfbam::CFBamNmTokenTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamNmTokenTypeHBuff::operator <( const CFBamNmTokenTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamNmTokenTypeHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamNmTokenTypeHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamNmTokenTypeHBuff::operator <( const CFBamNmTokenTypeHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamNmTokenTypeHBuff::operator <( const CFBamNmTokenTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamNmTokenTypeHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamNmTokenTypeHBuff" );
