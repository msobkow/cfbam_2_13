// Description: C++18 implementation for a Value buffer object.
...
namespace cfbam {
	...
	const std::string CFBamValueBuff::S_VALUE( "value" );
	const std::string CFBamValueBuff::S_VALUE_LENGTH( "value.length()" );

	const std::string CFBamValueBuff::GENDEFNAME( "Value" );
	const classcode_t CFBamValueBuff::CLASS_CODE = 0xa809L;
	const std::string CFBamValueBuff::CLASS_NAME( "CFBamValueBuff" );
		const std::string CFBamValueBuff::COLNAME_TENANTID( "TenantId" );
		const std::string CFBamValueBuff::COLNAME_SCOPEID( "ScopeId" );
		const std::string CFBamValueBuff::COLNAME_ID( "Id" );
		const std::string CFBamValueBuff::COLNAME_DEFSCHEMATENANTID( "DefSchemaTenantId" );
		const std::string CFBamValueBuff::COLNAME_DEFSCHEMAID( "DefSchemaId" );
		const std::string CFBamValueBuff::COLNAME_NAME( "Name" );
		const std::string CFBamValueBuff::COLNAME_SHORTNAME( "ShortName" );
		const std::string CFBamValueBuff::COLNAME_LABEL( "Label" );
		const std::string CFBamValueBuff::COLNAME_SHORTDESCRIPTION( "ShortDescription" );
		const std::string CFBamValueBuff::COLNAME_DESCRIPTION( "Description" );
		const std::string CFBamValueBuff::COLNAME_DEFAULTXMLVALUE( "DefaultXmlValue" );
		const std::string CFBamValueBuff::COLNAME_ISNULLABLE( "IsNullable" );
		const std::string CFBamValueBuff::COLNAME_GENERATEID( "GenerateId" );
		const std::string CFBamValueBuff::COLNAME_IMPLEMENTSPOLYMORPH( "ImplementsPolymorph" );
		const std::string CFBamValueBuff::COLNAME_PREVTENANTID( "PrevTenantId" );
		const std::string CFBamValueBuff::COLNAME_PREVID( "PrevId" );
		const std::string CFBamValueBuff::COLNAME_NEXTTENANTID( "NextTenantId" );
		const std::string CFBamValueBuff::COLNAME_NEXTID( "NextId" );
	const char* CFBamValueBuff::S_INIT_CREATEDBY = "654dbba0-eda7-11e1-aff1-0800200c9a66";
	const char* CFBamValueBuff::S_INIT_UPDATEDBY = "654dbba0-eda7-11e1-aff1-0800200c9a66";
	const int64_t CFBamValueBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamValueBuff::SCOPEID_INIT_VALUE = 0LL;
	const int64_t CFBamValueBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamValueBuff::DEFSCHEMATENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamValueBuff::DEFSCHEMAID_INIT_VALUE = 0LL;
	const std::string CFBamValueBuff::NAME_INIT_VALUE( "" );
	const bool CFBamValueBuff::ISNULLABLE_INIT_VALUE = false;
	const bool CFBamValueBuff::IMPLEMENTSPOLYMORPH_INIT_VALUE = false;
	const int64_t CFBamValueBuff::PREVTENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamValueBuff::PREVID_INIT_VALUE = 0LL;
	const int64_t CFBamValueBuff::NEXTTENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamValueBuff::NEXTID_INIT_VALUE = 0LL;
	const int64_t CFBamValueBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamValueBuff::SCOPEID_MIN_VALUE = 0LL;
	const int64_t CFBamValueBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamValueBuff::DEFSCHEMATENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamValueBuff::DEFSCHEMAID_MIN_VALUE = 0LL;
	const int64_t CFBamValueBuff::PREVTENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamValueBuff::PREVID_MIN_VALUE = 0LL;
	const int64_t CFBamValueBuff::NEXTTENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamValueBuff::NEXTID_MIN_VALUE = 0LL;
	const std::string::size_type CFBamValueBuff::NAME_MAX_LEN = 192;
	const std::string::size_type CFBamValueBuff::SHORTNAME_MAX_LEN = 16;
	const std::string::size_type CFBamValueBuff::LABEL_MAX_LEN = 64;
	const std::string::size_type CFBamValueBuff::SHORTDESCRIPTION_MAX_LEN = 128;
	const std::string::size_type CFBamValueBuff::DESCRIPTION_MAX_LEN = 1023;
	const std::string::size_type CFBamValueBuff::DEFAULTXMLVALUE_MAX_LEN = 1023;

	CFBamValueBuff::CFBamValueBuff()
	: cflib::ICFLibCloneableObj()
	{
		...
		requiredId = cfbam::CFBamValueBuff::ID_INIT_VALUE;
		optionalDefSchemaTenantId.setNull();
		optionalDefSchemaId.setNull();
		requiredName = new std::string( cfbam::CFBamValueBuff::NAME_INIT_VALUE );
		optionalShortName = NULL;
		optionalLabel = NULL;
		optionalShortDescription = NULL;
		optionalDescription = NULL;
		optionalDefaultXmlValue = NULL;
		requiredIsNullable = cfbam::CFBamValueBuff::ISNULLABLE_INIT_VALUE;
		optionalGenerateId.setNull();
		requiredImplementsPolymorph = cfbam::CFBamValueBuff::IMPLEMENTSPOLYMORPH_INIT_VALUE;
	...
	CFBamValueBuff::CFBamValueBuff( const CFBamValueBuff& src )
	: cflib::ICFLibCloneableObj()
	{
		requiredRevision = 1;
		for( int i = 0; i < 16; i++ ) {
	...
	CFBamValueBuff::~CFBamValueBuff() {
		...
		if( optionalDefaultXmlValue != NULL ) {
			delete optionalDefaultXmlValue;
			optionalDefaultXmlValue = NULL;
		}
		for( int i = 0; i < 16; i++ ) {
			createdByUserId[i] = 0;
	...
	cflib::ICFLibCloneableObj* CFBamValueBuff::clone() {
		CFBamValueBuff* copy = new CFBamValueBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamValueBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamValueBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamValueBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const uuid_ptr_t CFBamValueBuff::getCreatedByUserId() const {
		return( createdByUserId );
	}

	void CFBamValueBuff::setCreatedByUserId( const uuid_ptr_t value ) {
		uuid_copy( createdByUserId, value );
	}

	const std::chrono::system_clock::time_point& CFBamValueBuff::getCreatedAt() const {
		return( createdAt );
	}

	void CFBamValueBuff::setCreatedAt( const std::chrono::system_clock::time_point& value ) {
		createdAt = value;
	}

	const uuid_ptr_t CFBamValueBuff::getUpdatedByUserId() const {
		return( updatedByUserId );
	}

	void CFBamValueBuff::setUpdatedByUserId( const uuid_ptr_t value ) {
		uuid_copy( updatedByUserId, value );
	}

	const std::chrono::system_clock::time_point& CFBamValueBuff::getUpdatedAt() const {
		return( updatedAt );
	}

	void CFBamValueBuff::setUpdatedAt( const std::chrono::system_clock::time_point& value ) {
		updatedAt = value;
	}
	const int64_t CFBamValueBuff::getRequiredTenantId() const {
		return( requiredTenantId );
	}

	const int64_t* CFBamValueBuff::getRequiredTenantIdReference() const {
		return( &requiredTenantId );
	}

	void CFBamValueBuff::setRequiredTenantId( const int64_t value ) {
	...
	const int64_t CFBamValueBuff::getRequiredScopeId() const {
		return( requiredScopeId );
	}

	const int64_t* CFBamValueBuff::getRequiredScopeIdReference() const {
		return( &requiredScopeId );
	}

	void CFBamValueBuff::setRequiredScopeId( const int64_t value ) {
	...
	const int64_t CFBamValueBuff::getRequiredId() const {
		return( requiredId );
	}

	const int64_t* CFBamValueBuff::getRequiredIdReference() const {
		return( &requiredId );
	}

	void CFBamValueBuff::setRequiredId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredId" );
		if( value < cfbam::CFBamValueBuff::ID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamValueBuff::ID_MIN_VALUE );
		}
		requiredId = value;
	}

	const bool CFBamValueBuff::isOptionalDefSchemaTenantIdNull() const {
		return( optionalDefSchemaTenantId.isNull() );
	}

	const int64_t CFBamValueBuff::getOptionalDefSchemaTenantIdValue() const {
		return( optionalDefSchemaTenantId.getValue() );
	}

	const int64_t* CFBamValueBuff::getOptionalDefSchemaTenantIdReference() const {
		return( optionalDefSchemaTenantId.getReference() );
	}

	void CFBamValueBuff::setOptionalDefSchemaTenantIdNull() {
		optionalDefSchemaTenantId.setNull();
	}

	void CFBamValueBuff::setOptionalDefSchemaTenantIdValue( const int64_t value ) {
		static const std::string S_ProcName( "setOptionalDefSchemaTenantIdValue" );
		if( value < cfbam::CFBamValueBuff::DEFSCHEMATENANTID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamValueBuff::DEFSCHEMATENANTID_MIN_VALUE );
		}
		optionalDefSchemaTenantId.setValue( value );
	}

	const bool CFBamValueBuff::isOptionalDefSchemaIdNull() const {
		return( optionalDefSchemaId.isNull() );
	}

	const int64_t CFBamValueBuff::getOptionalDefSchemaIdValue() const {
		return( optionalDefSchemaId.getValue() );
	}

	const int64_t* CFBamValueBuff::getOptionalDefSchemaIdReference() const {
		return( optionalDefSchemaId.getReference() );
	}

	void CFBamValueBuff::setOptionalDefSchemaIdNull() {
		optionalDefSchemaId.setNull();
	}

	void CFBamValueBuff::setOptionalDefSchemaIdValue( const int64_t value ) {
		static const std::string S_ProcName( "setOptionalDefSchemaIdValue" );
		if( value < cfbam::CFBamValueBuff::DEFSCHEMAID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamValueBuff::DEFSCHEMAID_MIN_VALUE );
		}
		optionalDefSchemaId.setValue( value );
	}

	const std::string& CFBamValueBuff::getRequiredName() const {
		return( *requiredName );
	}

	const std::string* CFBamValueBuff::getRequiredNameReference() const {
		return( requiredName );
	}

	void CFBamValueBuff::setRequiredName( const std::string& value ) {
		static const std::string S_ProcName( "setRequiredName" );
		if( value.length() > CFBamValueBuff::NAME_MAX_LEN ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE_LENGTH,
				value.length(),
				CFBamValueBuff::NAME_MAX_LEN );
		}
		if( requiredName != NULL ) {
			delete requiredName;
			requiredName = NULL;
	...
	const bool CFBamValueBuff::isOptionalShortNameNull() const {
		return( optionalShortName == NULL );
	}

	const std::string& CFBamValueBuff::getOptionalShortNameValue() const {
	...
	const std::string* CFBamValueBuff::getOptionalShortNameReference() const {
		return( optionalShortName );
	}

	void CFBamValueBuff::setOptionalShortNameNull() {
		if( optionalShortName != NULL ) {
			delete optionalShortName;
			optionalShortName = NULL;
		}
	...
	void CFBamValueBuff::setOptionalShortNameValue( const std::string& value ) {
		static const std::string S_ProcName( "setOptionalShortNameValue" );
		if( value.length() > CFBamValueBuff::SHORTNAME_MAX_LEN ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE_LENGTH,
				value.length(),
				CFBamValueBuff::SHORTNAME_MAX_LEN );
		}
		if( optionalShortName != NULL ) {
			delete optionalShortName;
			optionalShortName = NULL;
	...
	const bool CFBamValueBuff::isOptionalLabelNull() const {
		return( optionalLabel == NULL );
	}

	const std::string& CFBamValueBuff::getOptionalLabelValue() const {
	...
	const std::string* CFBamValueBuff::getOptionalLabelReference() const {
		return( optionalLabel );
	}

	void CFBamValueBuff::setOptionalLabelNull() {
		if( optionalLabel != NULL ) {
			delete optionalLabel;
			optionalLabel = NULL;
		}
	...
	void CFBamValueBuff::setOptionalLabelValue( const std::string& value ) {
		static const std::string S_ProcName( "setOptionalLabelValue" );
		if( value.length() > CFBamValueBuff::LABEL_MAX_LEN ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE_LENGTH,
				value.length(),
				CFBamValueBuff::LABEL_MAX_LEN );
		}
		if( optionalLabel != NULL ) {
			delete optionalLabel;
			optionalLabel = NULL;
	...
	const bool CFBamValueBuff::isOptionalShortDescriptionNull() const {
		return( optionalShortDescription == NULL );
	}

	const std::string& CFBamValueBuff::getOptionalShortDescriptionValue() const {
	...
	const std::string* CFBamValueBuff::getOptionalShortDescriptionReference() const {
		return( optionalShortDescription );
	}

	void CFBamValueBuff::setOptionalShortDescriptionNull() {
		if( optionalShortDescription != NULL ) {
			delete optionalShortDescription;
			optionalShortDescription = NULL;
		}
	...
	void CFBamValueBuff::setOptionalShortDescriptionValue( const std::string& value ) {
		static const std::string S_ProcName( "setOptionalShortDescriptionValue" );
		if( value.length() > CFBamValueBuff::SHORTDESCRIPTION_MAX_LEN ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE_LENGTH,
				value.length(),
				CFBamValueBuff::SHORTDESCRIPTION_MAX_LEN );
		}
		if( optionalShortDescription != NULL ) {
			delete optionalShortDescription;
			optionalShortDescription = NULL;
	...
	const bool CFBamValueBuff::isOptionalDescriptionNull() const {
		return( optionalDescription == NULL );
	}

	const std::string& CFBamValueBuff::getOptionalDescriptionValue() const {
	...
	const std::string* CFBamValueBuff::getOptionalDescriptionReference() const {
		return( optionalDescription );
	}

	void CFBamValueBuff::setOptionalDescriptionNull() {
		if( optionalDescription != NULL ) {
			delete optionalDescription;
			optionalDescription = NULL;
		}
	...
	void CFBamValueBuff::setOptionalDescriptionValue( const std::string& value ) {
		static const std::string S_ProcName( "setOptionalDescriptionValue" );
		if( value.length() > CFBamValueBuff::DESCRIPTION_MAX_LEN ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE_LENGTH,
				value.length(),
				CFBamValueBuff::DESCRIPTION_MAX_LEN );
		}
		if( optionalDescription != NULL ) {
			delete optionalDescription;
			optionalDescription = NULL;
	...
	const bool CFBamValueBuff::isOptionalDefaultXmlValueNull() const {
		return( optionalDefaultXmlValue == NULL );
	}

	const std::string& CFBamValueBuff::getOptionalDefaultXmlValueValue() const {
		static const std::string S_ProcName( "getOptionalDefaultXmlValueValue" );
		if( optionalDefaultXmlValue == NULL ) {
			throw cflib::CFLibNullArgumentException( CLASS_NAME,
				S_ProcName,
				0,
	...
	const std::string* CFBamValueBuff::getOptionalDefaultXmlValueReference() const {
		return( optionalDefaultXmlValue );
	}

	void CFBamValueBuff::setOptionalDefaultXmlValueNull() {
		if( optionalDefaultXmlValue != NULL ) {
			delete optionalDefaultXmlValue;
			optionalDefaultXmlValue = NULL;
		}
	...
	void CFBamValueBuff::setOptionalDefaultXmlValueValue( const std::string& value ) {
		static const std::string S_ProcName( "setOptionalDefaultXmlValueValue" );
		if( value.length() > CFBamValueBuff::DEFAULTXMLVALUE_MAX_LEN ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE_LENGTH,
				value.length(),
				CFBamValueBuff::DEFAULTXMLVALUE_MAX_LEN );
		}
		if( optionalDefaultXmlValue != NULL ) {
			delete optionalDefaultXmlValue;
			optionalDefaultXmlValue = NULL;
		}
		optionalDefaultXmlValue = new std::string( value );
	}

	const bool CFBamValueBuff::getRequiredIsNullable() const {
		return( requiredIsNullable );
	}

	const bool* CFBamValueBuff::getRequiredIsNullableReference() const {
		return( &requiredIsNullable );
	}

	void CFBamValueBuff::setRequiredIsNullable( const bool value ) {
		requiredIsNullable = value;
	}

	const bool CFBamValueBuff::isOptionalGenerateIdNull() const {
		return( optionalGenerateId.isNull() );
	}

	const bool CFBamValueBuff::getOptionalGenerateIdValue() const {
		return( optionalGenerateId.getValue() );
	}

	const bool* CFBamValueBuff::getOptionalGenerateIdReference() const {
		return( optionalGenerateId.getReference() );
	}

	void CFBamValueBuff::setOptionalGenerateIdNull() {
		optionalGenerateId.setNull();
	}

	void CFBamValueBuff::setOptionalGenerateIdValue( const bool value ) {
		optionalGenerateId.setValue( value );
	}

	const bool CFBamValueBuff::getRequiredImplementsPolymorph() const {
		return( requiredImplementsPolymorph );
	}

	const bool* CFBamValueBuff::getRequiredImplementsPolymorphReference() const {
		return( &requiredImplementsPolymorph );
	}

	void CFBamValueBuff::setRequiredImplementsPolymorph( const bool value ) {
		requiredImplementsPolymorph = value;
	}

	const bool CFBamValueBuff::isOptionalPrevTenantIdNull() const {
		return( optionalPrevTenantId.isNull() );
	}

	const int64_t CFBamValueBuff::getOptionalPrevTenantIdValue() const {
		return( optionalPrevTenantId.getValue() );
	}

	const int64_t* CFBamValueBuff::getOptionalPrevTenantIdReference() const {
		return( optionalPrevTenantId.getReference() );
	}

	void CFBamValueBuff::setOptionalPrevTenantIdNull() {
		optionalPrevTenantId.setNull();
	}

	void CFBamValueBuff::setOptionalPrevTenantIdValue( const int64_t value ) {
		static const std::string S_ProcName( "setOptionalPrevTenantIdValue" );
		if( value < cfbam::CFBamValueBuff::PREVTENANTID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamValueBuff::PREVTENANTID_MIN_VALUE );
		}
		optionalPrevTenantId.setValue( value );
	}

	const bool CFBamValueBuff::isOptionalPrevIdNull() const {
		return( optionalPrevId.isNull() );
	}

	const int64_t CFBamValueBuff::getOptionalPrevIdValue() const {
		return( optionalPrevId.getValue() );
	}

	const int64_t* CFBamValueBuff::getOptionalPrevIdReference() const {
		return( optionalPrevId.getReference() );
	}

	void CFBamValueBuff::setOptionalPrevIdNull() {
		optionalPrevId.setNull();
	}

	void CFBamValueBuff::setOptionalPrevIdValue( const int64_t value ) {
	...
	const bool CFBamValueBuff::isOptionalNextTenantIdNull() const {
		return( optionalNextTenantId.isNull() );
	}

	const int64_t CFBamValueBuff::getOptionalNextTenantIdValue() const {
		return( optionalNextTenantId.getValue() );
	}

	const int64_t* CFBamValueBuff::getOptionalNextTenantIdReference() const {
		return( optionalNextTenantId.getReference() );
	}

	void CFBamValueBuff::setOptionalNextTenantIdNull() {
		optionalNextTenantId.setNull();
	}

	void CFBamValueBuff::setOptionalNextTenantIdValue( const int64_t value ) {
		static const std::string S_ProcName( "setOptionalNextTenantIdValue" );
		if( value < cfbam::CFBamValueBuff::NEXTTENANTID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamValueBuff::NEXTTENANTID_MIN_VALUE );
		}
		optionalNextTenantId.setValue( value );
	}

	const bool CFBamValueBuff::isOptionalNextIdNull() const {
		return( optionalNextId.isNull() );
	}

	const int64_t CFBamValueBuff::getOptionalNextIdValue() const {
		return( optionalNextId.getValue() );
	}

	const int64_t* CFBamValueBuff::getOptionalNextIdReference() const {
		return( optionalNextId.getReference() );
	}

	void CFBamValueBuff::setOptionalNextIdNull() {
		optionalNextId.setNull();
	}

	void CFBamValueBuff::setOptionalNextIdValue( const int64_t value ) {
		static const std::string S_ProcName( "setOptionalNextIdValue" );
		if( value < cfbam::CFBamValueBuff::NEXTID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamValueBuff::NEXTID_MIN_VALUE );
		}
		optionalNextId.setValue( value );
	}

	int32_t CFBamValueBuff::getRequiredRevision() const {
		return( requiredRevision );
	}

	void CFBamValueBuff::setRequiredRevision( int32_t value ) {
		requiredRevision = value;
	}

	size_t CFBamValueBuff::hashCode() const {
		size_t hashCode = 0L;
		...
		if( ! isOptionalDefaultXmlValueNull() ) {
			hashCode = hashCode + cflib::CFLib::hash( getOptionalDefaultXmlValueValue() );
		}
	...
	CFBamValueBuff CFBamValueBuff::operator =( cfbam::CFBamValueBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamValueBuff CFBamValueBuff::operator =( cfbam::CFBamValueHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamValueBuff::operator <( const CFBamValueByUNameIdxKey& rhs ) {
	...
	bool CFBamValueBuff::operator <( const CFBamValueByValTentIdxKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamValueBuff::operator <( const CFBamValueByScopeIdxKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamValueBuff::operator <( const CFBamValueByDefSchemaIdxKey& rhs ) {
		if( ! isOptionalDefSchemaTenantIdNull() ) {
	...
	bool CFBamValueBuff::operator <( const CFBamValueByPrevIdxKey& rhs ) {
		if( ! isOptionalPrevTenantIdNull() ) {
	...
	bool CFBamValueBuff::operator <( const CFBamValueByNextIdxKey& rhs ) {
		if( ! isOptionalNextTenantIdNull() ) {
	...
	bool CFBamValueBuff::operator <( const CFBamValueByContPrevIdxKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamValueBuff::operator <( const CFBamValueByContNextIdxKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamValueBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamValueBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamValueBuff::operator <( const CFBamValueHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamValueBuff::operator <( const CFBamValueBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamValueBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamValueBuff" );
