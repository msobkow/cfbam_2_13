// Description: C++18 implementation of a DoubleDef history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamDoubleDefHBuff::CLASS_NAME( "CFBamDoubleDefHBuff" );
	CFBamDoubleDefHBuff::CFBamDoubleDefHBuff()
	...
	CFBamDoubleDefHBuff::CFBamDoubleDefHBuff( const CFBamDoubleDefHBuff& src )
	: cfbam::CFBamAtomHBuff() {
		optionalInitValue.setNull();
		optionalMinValue.setNull();
		optionalMaxValue.setNull();
	...
	cflib::ICFLibCloneableObj* CFBamDoubleDefHBuff::clone() {
		CFBamDoubleDefHBuff* copy = new CFBamDoubleDefHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const double CFBamDoubleDefHBuff::getOptionalInitValueValue() const {
		return( optionalInitValue.getValue() );
	}

	const double* CFBamDoubleDefHBuff::getOptionalInitValueReference() const {
		return( optionalInitValue.getReference() );
	}

	const bool CFBamDoubleDefHBuff::isOptionalInitValueNull() const {
		return( optionalInitValue.isNull() );
	}

	void CFBamDoubleDefHBuff::setOptionalInitValueNull() {
		optionalInitValue.setNull();
	}

	void CFBamDoubleDefHBuff::setOptionalInitValueValue( const double value ) {
	...
	const double CFBamDoubleDefHBuff::getOptionalMinValueValue() const {
		return( optionalMinValue.getValue() );
	}

	const double* CFBamDoubleDefHBuff::getOptionalMinValueReference() const {
		return( optionalMinValue.getReference() );
	}

	const bool CFBamDoubleDefHBuff::isOptionalMinValueNull() const {
		return( optionalMinValue.isNull() );
	}

	void CFBamDoubleDefHBuff::setOptionalMinValueNull() {
		optionalMinValue.setNull();
	}

	void CFBamDoubleDefHBuff::setOptionalMinValueValue( const double value ) {
	...
	const double CFBamDoubleDefHBuff::getOptionalMaxValueValue() const {
		return( optionalMaxValue.getValue() );
	}

	const double* CFBamDoubleDefHBuff::getOptionalMaxValueReference() const {
		return( optionalMaxValue.getReference() );
	}

	const bool CFBamDoubleDefHBuff::isOptionalMaxValueNull() const {
		return( optionalMaxValue.isNull() );
	}

	void CFBamDoubleDefHBuff::setOptionalMaxValueNull() {
		optionalMaxValue.setNull();
	}

	void CFBamDoubleDefHBuff::setOptionalMaxValueValue( const double value ) {
	...
	size_t CFBamDoubleDefHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamDoubleDefHBuff::hashCode();
	...
	CFBamDoubleDefHBuff CFBamDoubleDefHBuff::operator =( cfbam::CFBamDoubleDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamDoubleDefHBuff CFBamDoubleDefHBuff::operator =( cfbam::CFBamDoubleDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamDoubleDefHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamDoubleDefHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamDoubleDefHBuff::operator <( const CFBamDoubleDefHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamDoubleDefHBuff::operator <( const CFBamDoubleDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamDoubleDefHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamDoubleDefHBuff" );
