// Description: C++18 base object instance implementation for CFBam UInt16Def.
...
namespace cfbam {
	...
	const std::string CFBamUInt16DefObj::CLASS_NAME( "CFBamUInt16DefObj" );
	const classcode_t CFBamUInt16DefObj::CLASS_CODE = 0xa84aL;

	bool CFBamUInt16DefObj::isOptionalInitValueNull() {
		return( getUInt16DefBuff()->isOptionalInitValueNull() );
	}

	const uint16_t CFBamUInt16DefObj::getOptionalInitValueValue() {
		return( getUInt16DefBuff()->getOptionalInitValueValue() );
	}

	const uint16_t* CFBamUInt16DefObj::getOptionalInitValueReference() {
		return( getUInt16DefBuff()->getOptionalInitValueReference() );
	}

	bool CFBamUInt16DefObj::isOptionalMinValueNull() {
		return( getUInt16DefBuff()->isOptionalMinValueNull() );
	}

	const uint16_t CFBamUInt16DefObj::getOptionalMinValueValue() {
		return( getUInt16DefBuff()->getOptionalMinValueValue() );
	}

	const uint16_t* CFBamUInt16DefObj::getOptionalMinValueReference() {
		return( getUInt16DefBuff()->getOptionalMinValueReference() );
	}

	bool CFBamUInt16DefObj::isOptionalMaxValueNull() {
		return( getUInt16DefBuff()->isOptionalMaxValueNull() );
	}

	const uint16_t CFBamUInt16DefObj::getOptionalMaxValueValue() {
		return( getUInt16DefBuff()->getOptionalMaxValueValue() );
	}

	const uint16_t* CFBamUInt16DefObj::getOptionalMaxValueReference() {
		return( getUInt16DefBuff()->getOptionalMaxValueReference() );
	}


	CFBamUInt16DefObj::CFBamUInt16DefObj()
	: ICFBamUInt16DefObj(),
	  CFBamAtomObj()
	{
	}

	CFBamUInt16DefObj::CFBamUInt16DefObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamUInt16DefObj(),
	...
	cfbam::CFBamValueBuff* CFBamUInt16DefObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamUInt16DefBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableUInt16Def()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamUInt16DefObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamUInt16DefObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUInt16DefObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamUInt16DefObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamUInt16DefObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt16DefObj" );
	...
	std::string CFBamUInt16DefObj::getObjName() {
	...
	const std::string CFBamUInt16DefObj::getGenDefName() {
		return( cfbam::CFBamUInt16DefBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamUInt16DefObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamUInt16DefObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamUInt16DefObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamUInt16DefObj::getObjQualifiedName() {
	...
	std::string CFBamUInt16DefObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamUInt16DefObj::realize() {
		cfbam::ICFBamUInt16DefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt16DefTableObj()->realizeUInt16Def(
			(cfbam::ICFBamUInt16DefObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUInt16DefObj::read( bool forceRead ) {
		cfbam::ICFBamUInt16DefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt16DefTableObj()->readUInt16DefByIdIdx( getUInt16DefBuff()->getRequiredTenantId(),
		getUInt16DefBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUInt16DefObj::moveUp() {
		cfbam::ICFBamUInt16DefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt16DefTableObj()->moveUpUInt16Def( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUInt16DefObj::moveDown() {
		cfbam::ICFBamUInt16DefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt16DefTableObj()->moveDownUInt16Def( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamUInt16DefObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamUInt16DefObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt16DefTableObj()->lockUInt16Def( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt16DefTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamUInt16DefEditObj* CFBamUInt16DefObj::getUInt16DefEdit() {
		return( dynamic_cast<cfbam::ICFBamUInt16DefEditObj*>( edit ) );
	}
