// Description: C++18 implementation of a UInt64Type history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUInt64TypeHBuff::CLASS_NAME( "CFBamUInt64TypeHBuff" );
	CFBamUInt64TypeHBuff::CFBamUInt64TypeHBuff()
	: cfbam::CFBamUInt64DefHBuff() {
		requiredSchemaDefId = cfbam::CFBamUInt64TypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamUInt64TypeHBuff::CFBamUInt64TypeHBuff( const CFBamUInt64TypeHBuff& src )
	: cfbam::CFBamUInt64DefHBuff() {
		requiredSchemaDefId = cfbam::CFBamUInt64TypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamUInt64TypeHBuff::clone() {
		CFBamUInt64TypeHBuff* copy = new CFBamUInt64TypeHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamUInt64TypeHBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamUInt64TypeHBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamUInt64TypeHBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamUInt64TypeHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamUInt64TypeHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamUInt64TypeHBuff CFBamUInt64TypeHBuff::operator =( cfbam::CFBamUInt64TypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamUInt64TypeHBuff CFBamUInt64TypeHBuff::operator =( cfbam::CFBamUInt64TypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUInt64TypeHBuff::operator <( const CFBamUInt64TypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamUInt64TypeHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt64TypeHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamUInt64TypeHBuff::operator <( const CFBamUInt64TypeHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamUInt64TypeHBuff::operator <( const CFBamUInt64TypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUInt64TypeHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt64TypeHBuff" );
