// Description: C++18 Instance Edit Object interface implementation for CFBam Int32Type.
...
namespace cfbam {
	...
	const std::string ICFBamInt32TypeEditObj::CLASS_NAME( "ICFBamInt32TypeEditObj" );

	ICFBamInt32TypeEditObj::ICFBamInt32TypeEditObj()
