// Description: C++18 implementation of a Atom history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamAtomHBuff::CLASS_NAME( "CFBamAtomHBuff" );
	CFBamAtomHBuff::CFBamAtomHBuff()
	: cfbam::CFBamValueHBuff() {
		optionalDbName = NULL;
	}

	CFBamAtomHBuff::CFBamAtomHBuff( const CFBamAtomHBuff& src )
	: cfbam::CFBamValueHBuff() {
		optionalDbName = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamAtomHBuff::clone() {
		CFBamAtomHBuff* copy = new CFBamAtomHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamAtomHBuff::getOptionalDbNameValue() const {
	...
	const std::string* CFBamAtomHBuff::getOptionalDbNameReference() const {
		return( optionalDbName );
	}

	const bool CFBamAtomHBuff::isOptionalDbNameNull() const {
		return( optionalDbName == NULL );
	}

	void CFBamAtomHBuff::setOptionalDbNameNull() {
		if( optionalDbName != NULL ) {
			delete optionalDbName;
			optionalDbName = NULL;
		}
	...
	void CFBamAtomHBuff::setOptionalDbNameValue( const std::string& value ) {
	...
	size_t CFBamAtomHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamAtomHBuff::hashCode();
	...
	CFBamAtomHBuff CFBamAtomHBuff::operator =( cfbam::CFBamAtomBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamAtomHBuff CFBamAtomHBuff::operator =( cfbam::CFBamAtomHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamAtomHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamAtomHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamAtomHBuff::operator <( const CFBamAtomHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamAtomHBuff::operator <( const CFBamAtomBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamAtomHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamAtomHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamAtomHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamAtomHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamAtomHBuff& lhs, const cfbam::CFBamAtomHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamAtomHBuff& lhs, const cfbam::CFBamAtomBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
