// Description: C++18 base object instance implementation for CFBam UInt64Type.
...
namespace cfbam {
	...
	const std::string CFBamUInt64TypeObj::CLASS_NAME( "CFBamUInt64TypeObj" );
	const classcode_t CFBamUInt64TypeObj::CLASS_CODE = 0xa84fL;

	const int64_t CFBamUInt64TypeObj::getRequiredSchemaDefId() {
		return( getUInt64TypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamUInt64TypeObj::getRequiredSchemaDefIdReference() {
		return( getUInt64TypeBuff()->getRequiredSchemaDefIdReference() );
	}


	cfbam::ICFBamSchemaDefObj* CFBamUInt64TypeObj::getRequiredContainerSchemaDef( bool forceRead ) {
	...
	CFBamUInt64TypeObj::CFBamUInt64TypeObj()
	: ICFBamUInt64TypeObj(),
	  CFBamUInt64DefObj()
	{
	}

	CFBamUInt64TypeObj::CFBamUInt64TypeObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamUInt64TypeObj(),
	  CFBamUInt64DefObj( argSchema )
	{
	}
	...
	cfbam::CFBamValueBuff* CFBamUInt64TypeObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamUInt64TypeBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableUInt64Type()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamUInt64TypeObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamUInt64TypeObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUInt64TypeObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamUInt64TypeObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamUInt64TypeBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamUInt64DefObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamUInt64TypeObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt64TypeObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_SchemaDefId, CFBamUInt64TypeObj::getRequiredSchemaDefId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	std::string CFBamUInt64TypeObj::getObjName() {
	...
	const std::string CFBamUInt64TypeObj::getGenDefName() {
		return( cfbam::CFBamUInt64TypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamUInt64TypeObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamUInt64TypeObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamUInt64TypeObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamUInt64TypeObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamUInt64TypeObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamUInt64TypeObj::getObjQualifiedName() {
	...
	std::string CFBamUInt64TypeObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamUInt64TypeObj::realize() {
		cfbam::ICFBamUInt64TypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt64TypeTableObj()->realizeUInt64Type(
			(cfbam::ICFBamUInt64TypeObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUInt64TypeObj::read( bool forceRead ) {
		cfbam::ICFBamUInt64TypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt64TypeTableObj()->readUInt64TypeByIdIdx( getUInt64TypeBuff()->getRequiredTenantId(),
		getUInt64TypeBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUInt64TypeObj::moveUp() {
		cfbam::ICFBamUInt64TypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt64TypeTableObj()->moveUpUInt64Type( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamUInt64TypeObj::moveDown() {
		cfbam::ICFBamUInt64TypeObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt64TypeTableObj()->moveDownUInt64Type( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamUInt64TypeObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamUInt64TypeObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt64TypeTableObj()->lockUInt64Type( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getUInt64TypeTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamUInt64TypeEditObj* CFBamUInt64TypeObj::getUInt64TypeEdit() {
		return( dynamic_cast<cfbam::ICFBamUInt64TypeEditObj*>( edit ) );
	}
