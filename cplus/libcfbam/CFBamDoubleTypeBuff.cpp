// Description: C++18 implementation for a DoubleType buffer object.
...
namespace cfbam {
	...
	const std::string CFBamDoubleTypeBuff::GENDEFNAME( "DoubleType" );
	const classcode_t CFBamDoubleTypeBuff::CLASS_CODE = 0xa81dL;
	const std::string CFBamDoubleTypeBuff::CLASS_NAME( "CFBamDoubleTypeBuff" );
		const std::string CFBamDoubleTypeBuff::COLNAME_SCHEMADEFID( "SchemaDefId" );
	const int64_t CFBamDoubleTypeBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamDoubleTypeBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamDoubleTypeBuff::SCHEMADEFID_INIT_VALUE = 0LL;
	const int64_t CFBamDoubleTypeBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamDoubleTypeBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamDoubleTypeBuff::SCHEMADEFID_MIN_VALUE = 0LL;

	CFBamDoubleTypeBuff::CFBamDoubleTypeBuff()
	: CFBamDoubleDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamDoubleTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamDoubleTypeBuff::CFBamDoubleTypeBuff( const CFBamDoubleTypeBuff& src )
	: CFBamDoubleDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamDoubleTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamDoubleTypeBuff::clone() {
		CFBamDoubleTypeBuff* copy = new CFBamDoubleTypeBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamDoubleTypeBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamDoubleTypeBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamDoubleTypeBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFBamDoubleTypeBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamDoubleTypeBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamDoubleTypeBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamDoubleTypeBuff::hashCode() const {
		size_t hashCode = CFBamDoubleDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamDoubleTypeBuff CFBamDoubleTypeBuff::operator =( cfbam::CFBamDoubleTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamDoubleTypeBuff CFBamDoubleTypeBuff::operator =( cfbam::CFBamDoubleTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamDoubleTypeBuff::operator <( const CFBamDoubleTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamDoubleTypeBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamDoubleTypeBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamDoubleTypeBuff::operator <( const CFBamDoubleTypeHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamDoubleTypeBuff::operator <( const CFBamDoubleTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamDoubleTypeBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamDoubleTypeBuff" );
