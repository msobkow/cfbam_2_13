// Description: C++18 Instance Edit Object interface implementation for CFBam TextType.
...
namespace cfbam {
	...
	const std::string ICFBamTextTypeEditObj::CLASS_NAME( "ICFBamTextTypeEditObj" );

	ICFBamTextTypeEditObj::ICFBamTextTypeEditObj()
