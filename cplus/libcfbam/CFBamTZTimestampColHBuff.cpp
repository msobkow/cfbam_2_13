// Description: C++18 implementation of a TZTimestampCol history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamTZTimestampColHBuff::CLASS_NAME( "CFBamTZTimestampColHBuff" );
	CFBamTZTimestampColHBuff::CFBamTZTimestampColHBuff()
	: cfbam::CFBamTZTimestampDefHBuff() {
		requiredTableId = cfbam::CFBamTZTimestampColBuff::TABLEID_INIT_VALUE;
	}

	CFBamTZTimestampColHBuff::CFBamTZTimestampColHBuff( const CFBamTZTimestampColHBuff& src )
	: cfbam::CFBamTZTimestampDefHBuff() {
		requiredTableId = cfbam::CFBamTZTimestampColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamTZTimestampColHBuff::clone() {
		CFBamTZTimestampColHBuff* copy = new CFBamTZTimestampColHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFBamTZTimestampColHBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamTZTimestampColHBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamTZTimestampColHBuff::setRequiredTableId( const int64_t value ) {
	...
	size_t CFBamTZTimestampColHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamTZTimestampColHBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamTZTimestampColHBuff CFBamTZTimestampColHBuff::operator =( cfbam::CFBamTZTimestampColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamTZTimestampColHBuff CFBamTZTimestampColHBuff::operator =( cfbam::CFBamTZTimestampColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamTZTimestampColHBuff::operator <( const CFBamTZTimestampColByTableIdxKey& rhs ) {
	...
	bool CFBamTZTimestampColHBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamTZTimestampColHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamTZTimestampColHBuff::operator <( const CFBamTZTimestampColHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamTZTimestampColHBuff::operator <( const CFBamTZTimestampColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamTZTimestampColHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamTZTimestampColHBuff" );
