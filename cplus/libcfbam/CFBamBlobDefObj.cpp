// Description: C++18 base object instance implementation for CFBam BlobDef.
...
namespace cfbam {
	...
	const std::string CFBamBlobDefObj::CLASS_NAME( "CFBamBlobDefObj" );
	const classcode_t CFBamBlobDefObj::CLASS_CODE = 0xa80bL;

	const int32_t CFBamBlobDefObj::getRequiredMaxLen() {
		return( getBlobDefBuff()->getRequiredMaxLen() );
	}

	const int32_t* CFBamBlobDefObj::getRequiredMaxLenReference() {
		return( getBlobDefBuff()->getRequiredMaxLenReference() );
	}

	bool CFBamBlobDefObj::isOptionalInitValueNull() {
		return( getBlobDefBuff()->isOptionalInitValueNull() );
	}

	const std::vector<cflib::BYTE>& CFBamBlobDefObj::getOptionalInitValueValue() {
		return( getBlobDefBuff()->getOptionalInitValueValue() );
	}

	const std::vector<cflib::BYTE>* CFBamBlobDefObj::getOptionalInitValueReference() {
		return( getBlobDefBuff()->getOptionalInitValueReference() );
	}


	CFBamBlobDefObj::CFBamBlobDefObj()
	: ICFBamBlobDefObj(),
	  CFBamAtomObj()
	{
	}

	CFBamBlobDefObj::CFBamBlobDefObj( cfbam::ICFBamSchemaObj* argSchema )
	: ICFBamBlobDefObj(),
	...
	cfbam::CFBamValueBuff* CFBamBlobDefObj::getBuff() {
		if( buff == NULL ) {
			if( isNew ) {
				buff = new cfbam::CFBamBlobDefBuff();
				copyBuffToPKey();
			}
			else {
				// Read the data buff via the backing store
				buff = dynamic_cast<ICFBamSchema*>( schema->getBackingStore() )->getTableBlobDef()->readDerivedByIdIdx( dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getAuthorization(),
	...
	void CFBamBlobDefObj::setBuff( cfbam::CFBamValueBuff* value ) {
	...
	const std::string& CFBamBlobDefObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamBlobDefObj::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamBlobDefObj::implementsClassCode( const classcode_t value ) const {
	...
	std::string CFBamBlobDefObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamBlobDefObj" );
	...
	std::string CFBamBlobDefObj::getObjName() {
	...
	const std::string CFBamBlobDefObj::getGenDefName() {
		return( cfbam::CFBamBlobDefBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamBlobDefObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamBlobDefObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamBlobDefObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamBlobDefObj::getObjQualifiedName() {
	...
	std::string CFBamBlobDefObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamBlobDefObj::realize() {
		cfbam::ICFBamBlobDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getBlobDefTableObj()->realizeBlobDef(
			(cfbam::ICFBamBlobDefObj*)this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamBlobDefObj::read( bool forceRead ) {
		cfbam::ICFBamBlobDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getBlobDefTableObj()->readBlobDefByIdIdx( getBlobDefBuff()->getRequiredTenantId(),
		getBlobDefBuff()->getRequiredId(), forceRead );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamBlobDefObj::moveUp() {
		cfbam::ICFBamBlobDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getBlobDefTableObj()->moveUpBlobDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueObj* CFBamBlobDefObj::moveDown() {
		cfbam::ICFBamBlobDefObj* retobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getBlobDefTableObj()->moveDownBlobDef( this );
		return( dynamic_cast<cfbam::ICFBamValueObj*>( retobj ) );
	}

	cfbam::ICFBamValueEditObj* CFBamBlobDefObj::beginEdit() {
		...
		if( ! getIsNew() ) {
			cfbam::ICFBamBlobDefObj* lockobj = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getBlobDefTableObj()->lockBlobDef( getPKey() );
			lockobj->realize();
		}
		edit = dynamic_cast<ICFBamSchemaObj*>( getSchema() )->getBlobDefTableObj()->newEditInstance( this );
		return( dynamic_cast<cfbam::ICFBamValueEditObj*>( edit ) );
	}

	cfbam::ICFBamBlobDefEditObj* CFBamBlobDefObj::getBlobDefEdit() {
		return( dynamic_cast<cfbam::ICFBamBlobDefEditObj*>( edit ) );
	}
