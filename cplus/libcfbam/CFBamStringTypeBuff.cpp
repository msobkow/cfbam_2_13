// Description: C++18 implementation for a StringType buffer object.
...
namespace cfbam {
	...
	const std::string CFBamStringTypeBuff::GENDEFNAME( "StringType" );
	const classcode_t CFBamStringTypeBuff::CLASS_CODE = 0xa839L;
	const std::string CFBamStringTypeBuff::CLASS_NAME( "CFBamStringTypeBuff" );
		const std::string CFBamStringTypeBuff::COLNAME_SCHEMADEFID( "SchemaDefId" );
	const int64_t CFBamStringTypeBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamStringTypeBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamStringTypeBuff::SCHEMADEFID_INIT_VALUE = 0LL;
	const int64_t CFBamStringTypeBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamStringTypeBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamStringTypeBuff::SCHEMADEFID_MIN_VALUE = 0LL;

	CFBamStringTypeBuff::CFBamStringTypeBuff()
	: CFBamStringDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamStringTypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamStringTypeBuff::CFBamStringTypeBuff( const CFBamStringTypeBuff& src )
	: CFBamStringDefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamStringTypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamStringTypeBuff::clone() {
		CFBamStringTypeBuff* copy = new CFBamStringTypeBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamStringTypeBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamStringTypeBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamStringTypeBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFBamStringTypeBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamStringTypeBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamStringTypeBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamStringTypeBuff::hashCode() const {
		size_t hashCode = CFBamStringDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamStringTypeBuff CFBamStringTypeBuff::operator =( cfbam::CFBamStringTypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamStringTypeBuff CFBamStringTypeBuff::operator =( cfbam::CFBamStringTypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamStringTypeBuff::operator <( const CFBamStringTypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamStringTypeBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamStringTypeBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamStringTypeBuff::operator <( const CFBamStringTypeHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamStringTypeBuff::operator <( const CFBamStringTypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamStringTypeBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamStringTypeBuff" );
