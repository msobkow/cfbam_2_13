// Description: C++18 implementation for a StringDef buffer object.
...
namespace cfbam {
	...
	const std::string CFBamStringDefBuff::GENDEFNAME( "StringDef" );
	const classcode_t CFBamStringDefBuff::CLASS_CODE = 0xa838L;
	const std::string CFBamStringDefBuff::CLASS_NAME( "CFBamStringDefBuff" );
		const std::string CFBamStringDefBuff::COLNAME_MAXLEN( "MaxLen" );
		const std::string CFBamStringDefBuff::COLNAME_ISPOLYMORPH( "IsPolymorph" );
		const std::string CFBamStringDefBuff::COLNAME_INITVALUE( "InitValue" );
	const int64_t CFBamStringDefBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamStringDefBuff::ID_INIT_VALUE = 0LL;
	const int CFBamStringDefBuff::MAXLEN_INIT_VALUE = 0L;
	const bool CFBamStringDefBuff::ISPOLYMORPH_INIT_VALUE = false;
	const int64_t CFBamStringDefBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamStringDefBuff::ID_MIN_VALUE = 0LL;
	const int CFBamStringDefBuff::MAXLEN_MIN_VALUE = 0L;
	const int CFBamStringDefBuff::MAXLEN_MAX_VALUE = 2147483647L;
	const std::string::size_type CFBamStringDefBuff::INITVALUE_MAX_LEN = 500;

	CFBamStringDefBuff::CFBamStringDefBuff()
	: CFBamAtomBuff()
	{
		requiredMaxLen = cfbam::CFBamStringDefBuff::MAXLEN_INIT_VALUE;
		requiredIsPolymorph = cfbam::CFBamStringDefBuff::ISPOLYMORPH_INIT_VALUE;
		optionalInitValue = NULL;
	}

	CFBamStringDefBuff::CFBamStringDefBuff( const CFBamStringDefBuff& src )
	: CFBamAtomBuff()
	{
		requiredMaxLen = cfbam::CFBamStringDefBuff::MAXLEN_INIT_VALUE;
		requiredIsPolymorph = cfbam::CFBamStringDefBuff::ISPOLYMORPH_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamStringDefBuff::clone() {
		CFBamStringDefBuff* copy = new CFBamStringDefBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamStringDefBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamStringDefBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamStringDefBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int32_t CFBamStringDefBuff::getRequiredMaxLen() const {
		return( requiredMaxLen );
	}

	const int32_t* CFBamStringDefBuff::getRequiredMaxLenReference() const {
		return( &requiredMaxLen );
	}

	void CFBamStringDefBuff::setRequiredMaxLen( const int32_t value ) {
		static const std::string S_ProcName( "setRequiredMaxLen" );
		if( value < cfbam::CFBamStringDefBuff::MAXLEN_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamStringDefBuff::MAXLEN_MIN_VALUE );
		}
		if( value > cfbam::CFBamStringDefBuff::MAXLEN_MAX_VALUE ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamStringDefBuff::MAXLEN_MAX_VALUE );
		}
		requiredMaxLen = value;
	}

	const bool CFBamStringDefBuff::getRequiredIsPolymorph() const {
		return( requiredIsPolymorph );
	}

	const bool* CFBamStringDefBuff::getRequiredIsPolymorphReference() const {
		return( &requiredIsPolymorph );
	}

	void CFBamStringDefBuff::setRequiredIsPolymorph( const bool value ) {
		requiredIsPolymorph = value;
	}

	const bool CFBamStringDefBuff::isOptionalInitValueNull() const {
		return( optionalInitValue == NULL );
	}

	const std::string& CFBamStringDefBuff::getOptionalInitValueValue() const {
	...
	const std::string* CFBamStringDefBuff::getOptionalInitValueReference() const {
		return( optionalInitValue );
	}

	void CFBamStringDefBuff::setOptionalInitValueNull() {
		if( optionalInitValue != NULL ) {
			delete optionalInitValue;
			optionalInitValue = NULL;
		}
	...
	void CFBamStringDefBuff::setOptionalInitValueValue( const std::string& value ) {
		static const std::string S_ProcName( "setOptionalInitValueValue" );
		if( value.length() > CFBamStringDefBuff::INITVALUE_MAX_LEN ) {
			throw cflib::CFLibArgumentOverflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE_LENGTH,
				value.length(),
				CFBamStringDefBuff::INITVALUE_MAX_LEN );
		}
		if( optionalInitValue != NULL ) {
			delete optionalInitValue;
			optionalInitValue = NULL;
	...
	size_t CFBamStringDefBuff::hashCode() const {
	...
	CFBamStringDefBuff CFBamStringDefBuff::operator =( cfbam::CFBamStringDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamStringDefBuff CFBamStringDefBuff::operator =( cfbam::CFBamStringDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamStringDefBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamStringDefBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamStringDefBuff::operator <( const CFBamStringDefHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
		...
		else if( getRequiredIsPolymorph() < rhs.getRequiredIsPolymorph() ) {
			return( true );
		}
		if( ! isOptionalInitValueNull() ) {
	...
	bool CFBamStringDefBuff::operator <( const CFBamStringDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamStringDefBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamStringDefBuff" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredBoolean( &S_Space, S_IsPolymorph, getRequiredIsPolymorph() ) );
		if( ! isOptionalInitValueNull() ) {
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamStringDefBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamStringDefBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamStringDefBuff& lhs, const cfbam::CFBamStringDefHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
		...
		if( lhs.getRequiredIsPolymorph() > rhs.getRequiredIsPolymorph() ) {
			return( false );
		}
		else if( lhs.getRequiredIsPolymorph() < rhs.getRequiredIsPolymorph() ) {
			return( true );
		}
	...
	bool operator <(const  cfbam::CFBamStringDefBuff& lhs, const cfbam::CFBamStringDefBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
