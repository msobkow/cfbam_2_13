// Description: C++18 Instance Edit Object interface implementation for CFBam TZTimestampType.
...
namespace cfbam {
	...
	const std::string ICFBamTZTimestampTypeEditObj::CLASS_NAME( "ICFBamTZTimestampTypeEditObj" );

	ICFBamTZTimestampTypeEditObj::ICFBamTZTimestampTypeEditObj()
