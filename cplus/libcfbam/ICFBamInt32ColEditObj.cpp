// Description: C++18 Instance Edit Object interface implementation for CFBam Int32Col.
...
namespace cfbam {
	...
	const std::string ICFBamInt32ColEditObj::CLASS_NAME( "ICFBamInt32ColEditObj" );

	ICFBamInt32ColEditObj::ICFBamInt32ColEditObj()
