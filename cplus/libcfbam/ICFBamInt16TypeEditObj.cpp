// Description: C++18 Instance Edit Object interface implementation for CFBam Int16Type.
...
namespace cfbam {
	...
	const std::string ICFBamInt16TypeEditObj::CLASS_NAME( "ICFBamInt16TypeEditObj" );

	ICFBamInt16TypeEditObj::ICFBamInt16TypeEditObj()
