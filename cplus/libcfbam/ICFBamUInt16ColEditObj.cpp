// Description: C++18 Instance Edit Object interface implementation for CFBam UInt16Col.
...
namespace cfbam {
	...
	const std::string ICFBamUInt16ColEditObj::CLASS_NAME( "ICFBamUInt16ColEditObj" );

	ICFBamUInt16ColEditObj::ICFBamUInt16ColEditObj()
