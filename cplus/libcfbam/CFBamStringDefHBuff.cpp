// Description: C++18 implementation of a StringDef history buffer object.
...
namespace cfbam {
	...
	const std::string CFBamStringDefHBuff::CLASS_NAME( "CFBamStringDefHBuff" );
	CFBamStringDefHBuff::CFBamStringDefHBuff()
	...
	CFBamStringDefHBuff::CFBamStringDefHBuff( const CFBamStringDefHBuff& src )
	: cfbam::CFBamAtomHBuff() {
		requiredMaxLen = cfbam::CFBamStringDefBuff::MAXLEN_INIT_VALUE;
		requiredIsPolymorph = cfbam::CFBamStringDefBuff::ISPOLYMORPH_INIT_VALUE;
		optionalInitValue = NULL;
	...
	cflib::ICFLibCloneableObj* CFBamStringDefHBuff::clone() {
		CFBamStringDefHBuff* copy = new CFBamStringDefHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int32_t CFBamStringDefHBuff::getRequiredMaxLen() const {
		return( requiredMaxLen );
	}

	const int32_t* CFBamStringDefHBuff::getRequiredMaxLenReference() const {
		return( &requiredMaxLen );
	}

	void CFBamStringDefHBuff::setRequiredMaxLen( const int32_t value ) {
	...
	const bool CFBamStringDefHBuff::getRequiredIsPolymorph() const {
		return( requiredIsPolymorph );
	}

	const bool* CFBamStringDefHBuff::getRequiredIsPolymorphReference() const {
		return( &requiredIsPolymorph );
	}

	void CFBamStringDefHBuff::setRequiredIsPolymorph( const bool value ) {
		requiredIsPolymorph = value;
	}

	const std::string& CFBamStringDefHBuff::getOptionalInitValueValue() const {
	...
	const std::string* CFBamStringDefHBuff::getOptionalInitValueReference() const {
		return( optionalInitValue );
	}

	const bool CFBamStringDefHBuff::isOptionalInitValueNull() const {
		return( optionalInitValue == NULL );
	}

	void CFBamStringDefHBuff::setOptionalInitValueNull() {
		if( optionalInitValue != NULL ) {
			delete optionalInitValue;
			optionalInitValue = NULL;
		}
	...
	void CFBamStringDefHBuff::setOptionalInitValueValue( const std::string& value ) {
	...
	size_t CFBamStringDefHBuff::hashCode() const {
		size_t hashCode = cfbam::CFBamStringDefHBuff::hashCode();
	...
	CFBamStringDefHBuff CFBamStringDefHBuff::operator =( cfbam::CFBamStringDefBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	CFBamStringDefHBuff CFBamStringDefHBuff::operator =( cfbam::CFBamStringDefHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamStringDefHBuff::operator <( const CFBamValuePKey& rhs ) {
	...
	bool CFBamStringDefHBuff::operator <( const CFBamValueHPKey& rhs ) {
	...
	bool CFBamStringDefHBuff::operator <( const CFBamStringDefHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFBamStringDefHBuff::operator <( const CFBamStringDefBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamStringDefHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamStringDefHBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamStringDefHBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamStringDefHBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamStringDefHBuff& lhs, const cfbam::CFBamStringDefHBuff& rhs ) {
		if( lhs.getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( lhs.getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool operator <(const  cfbam::CFBamStringDefHBuff& lhs, const cfbam::CFBamStringDefBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
