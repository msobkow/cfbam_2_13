// Description: C++18 edit object instance implementation for CFBam Int32Type.
...
namespace cfbam {
	...
	const std::string CFBamInt32TypeEditObj::CLASS_NAME( "CFBamInt32TypeEditObj" );

	CFBamInt32TypeEditObj::CFBamInt32TypeEditObj( cfbam::ICFBamInt32TypeObj* argOrig )
	: ICFBamInt32TypeEditObj(),
	  CFBamInt32DefEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamInt32TypeEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamInt32TypeEditObj::~CFBamInt32TypeEditObj() {
	}

	const std::string& CFBamInt32TypeEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamInt32TypeEditObj::getClassCode() const {
		return( cfbam::CFBamInt32TypeBuff::CLASS_CODE );
	}

	bool CFBamInt32TypeEditObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamInt32TypeBuff::CLASS_CODE ) {
			return( true );
		}
		else {
	...
	std::string CFBamInt32TypeEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamInt32TypeEditObj" );
	...
	const std::string CFBamInt32TypeEditObj::getGenDefName() {
		return( cfbam::CFBamInt32TypeBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamInt32TypeEditObj::getScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamInt32TypeEditObj::getObjScope() {
		cfbam::ICFBamSchemaDefObj* scope = getRequiredContainerSchemaDef();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamInt32TypeEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamInt32TypeEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamInt32TypeEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamInt32TypeEditObj::getObjQualifiedName() {
	...
	std::string CFBamInt32TypeEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamInt32TypeEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamInt32TypeObj* retobj = getSchema()->getInt32TypeTableObj()->realizeInt32Type( dynamic_cast<cfbam::ICFBamInt32TypeObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamInt32TypeEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamInt32TypeEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamInt32TypeEditObj::create() {
		cfbam::ICFBamInt32TypeObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsInt32Type()->getSchema() )->getInt32TypeTableObj()->createInt32Type( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamInt32TypeEditObj::update() {
		getSchema()->getInt32TypeTableObj()->updateInt32Type( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamInt32TypeEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getInt32TypeTableObj()->deleteInt32Type( this );
		return( NULL );
	}

	cfbam::ICFBamInt32TypeTableObj* CFBamInt32TypeEditObj::getInt32TypeTable() {
		return( orig->getSchema()->getInt32TypeTableObj() );
	}

	cfbam::ICFBamInt32TypeEditObj* CFBamInt32TypeEditObj::getInt32TypeEdit() {
		return( (cfbam::ICFBamInt32TypeEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamInt32TypeEditObj::beginEdit() {
	...
	cfbam::ICFBamInt32TypeObj* CFBamInt32TypeEditObj::getOrigAsInt32Type() {
		return( dynamic_cast<cfbam::ICFBamInt32TypeObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamInt32TypeEditObj::getBuff() {
		return( buff );
	}

	void CFBamInt32TypeEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamInt32DefEditObj::setBuff( value );
		}
	}

	const int64_t CFBamInt32TypeEditObj::getRequiredSchemaDefId() {
		return( getInt32TypeBuff()->getRequiredSchemaDefId() );
	}

	const int64_t* CFBamInt32TypeEditObj::getRequiredSchemaDefIdReference() {
		return( getInt32TypeBuff()->getRequiredSchemaDefIdReference() );
	}

	void CFBamInt32TypeEditObj::setRequiredContainerScope( cfbam::ICFBamScopeObj* value ) {
		if( value == NULL ) {
	...
	cfbam::ICFBamSchemaDefObj* CFBamInt32TypeEditObj::getRequiredContainerSchemaDef( bool forceRead ) {
		cfbam::ICFBamSchemaDefObj* retobj = NULL;
		bool anyMissing = false;
		if( ! anyMissing ) {
			retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsInt32Type()->getSchema() )->getSchemaDefTableObj()->readSchemaDefByIdIdx( getPKey()->getRequiredTenantId(),
					getInt32TypeBuff()->getRequiredSchemaDefId() );
		}
		return( retobj );
	}

	void CFBamInt32TypeEditObj::setRequiredContainerSchemaDef( cfbam::ICFBamSchemaDefObj* value ) {
			
			if( value != NULL ) {
				getPKey()->setRequiredTenantId
( value->getRequiredTenantId() );
				getInt32TypeEditBuff()->setRequiredTenantId( value->getRequiredTenantId() );
				getInt32TypeEditBuff()->setRequiredSchemaDefId( value->getRequiredId() );
			}

			CFBamInt32DefEditObj::setRequiredContainerScope( value );		}

	void CFBamInt32TypeEditObj::copyBuffToOrig() {
		cfbam::CFBamInt32TypeBuff* origBuff = getOrigAsInt32Type()->getInt32TypeEditBuff();
		cfbam::CFBamInt32TypeBuff* myBuff = getInt32TypeBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamInt32TypeEditObj::copyOrigToBuff() {
		cfbam::CFBamInt32TypeBuff* origBuff = getOrigAsInt32Type()->getInt32TypeBuff();
		cfbam::CFBamInt32TypeBuff* myBuff = getInt32TypeEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
