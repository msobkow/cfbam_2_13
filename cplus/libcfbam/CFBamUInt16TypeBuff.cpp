// Description: C++18 implementation for a UInt16Type buffer object.
...
namespace cfbam {
	...
	const std::string CFBamUInt16TypeBuff::GENDEFNAME( "UInt16Type" );
	const classcode_t CFBamUInt16TypeBuff::CLASS_CODE = 0xa84bL;
	const std::string CFBamUInt16TypeBuff::CLASS_NAME( "CFBamUInt16TypeBuff" );
		const std::string CFBamUInt16TypeBuff::COLNAME_SCHEMADEFID( "SchemaDefId" );
	const int64_t CFBamUInt16TypeBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamUInt16TypeBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamUInt16TypeBuff::SCHEMADEFID_INIT_VALUE = 0LL;
	const int64_t CFBamUInt16TypeBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamUInt16TypeBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamUInt16TypeBuff::SCHEMADEFID_MIN_VALUE = 0LL;

	CFBamUInt16TypeBuff::CFBamUInt16TypeBuff()
	: CFBamUInt16DefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamUInt16TypeBuff::SCHEMADEFID_INIT_VALUE;
	}

	CFBamUInt16TypeBuff::CFBamUInt16TypeBuff( const CFBamUInt16TypeBuff& src )
	: CFBamUInt16DefBuff()
	{
		requiredSchemaDefId = cfbam::CFBamUInt16TypeBuff::SCHEMADEFID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamUInt16TypeBuff::clone() {
		CFBamUInt16TypeBuff* copy = new CFBamUInt16TypeBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamUInt16TypeBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamUInt16TypeBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamUInt16TypeBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFBamUInt16TypeBuff::getRequiredSchemaDefId() const {
		return( requiredSchemaDefId );
	}

	const int64_t* CFBamUInt16TypeBuff::getRequiredSchemaDefIdReference() const {
		return( &requiredSchemaDefId );
	}

	void CFBamUInt16TypeBuff::setRequiredSchemaDefId( const int64_t value ) {
	...
	size_t CFBamUInt16TypeBuff::hashCode() const {
		size_t hashCode = CFBamUInt16DefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredSchemaDefId() );
		return( hashCode );
	}

	CFBamUInt16TypeBuff CFBamUInt16TypeBuff::operator =( cfbam::CFBamUInt16TypeBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamUInt16TypeBuff CFBamUInt16TypeBuff::operator =( cfbam::CFBamUInt16TypeHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamUInt16TypeBuff::operator <( const CFBamUInt16TypeBySchemaIdxKey& rhs ) {
	...
	bool CFBamUInt16TypeBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt16TypeBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt16TypeBuff::operator <( const CFBamUInt16TypeHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamUInt16TypeBuff::operator <( const CFBamUInt16TypeBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamUInt16TypeBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamUInt16TypeBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamUInt16TypeBuff& lhs, const cfbam::CFBamUInt16TypeBySchemaIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamUInt16TypeBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamUInt16TypeBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamUInt16TypeBuff& lhs, const cfbam::CFBamUInt16TypeHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamUInt16TypeBuff& lhs, const cfbam::CFBamUInt16TypeBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
