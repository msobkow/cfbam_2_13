// Description: C++18 edit object instance implementation for CFBam BoolCol.
...
namespace cfbam {
	...
	const std::string CFBamBoolColEditObj::CLASS_NAME( "CFBamBoolColEditObj" );

	CFBamBoolColEditObj::CFBamBoolColEditObj( cfbam::ICFBamBoolColObj* argOrig )
	: ICFBamBoolColEditObj(),
	  CFBamBoolDefEditObj( argOrig )
	{
		static const std::string S_ProcName( "CFBamBoolColEditObj-construct" );
		static const std::string S_OrigBuff( "origBuff" );
	}

	CFBamBoolColEditObj::~CFBamBoolColEditObj() {
	}

	const std::string& CFBamBoolColEditObj::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamBoolColEditObj::getClassCode() const {
		return( cfbam::CFBamBoolColBuff::CLASS_CODE );
	}

	bool CFBamBoolColEditObj::implementsClassCode( const classcode_t value ) const {
		if( value == cfbam::CFBamBoolColBuff::CLASS_CODE ) {
			return( true );
		}
		else {
			return( CFBamBoolDefEditObj::implementsClassCode( value ) );
		}
	}

	std::string CFBamBoolColEditObj::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamBoolColEditObj" );
		...
		ret.append( cflib::CFLibXmlUtil::formatRequiredInt64( &S_Space, S_TableId, CFBamBoolColEditObj::getRequiredTableId() ) );
		ret.append( S_Postamble );
		return( ret );
	}

	const std::string CFBamBoolColEditObj::getGenDefName() {
		return( cfbam::CFBamBoolColBuff::GENDEFNAME );
	}

	cflib::ICFLibAnyObj* CFBamBoolColEditObj::getScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamBoolColEditObj::getObjScope() {
		cfbam::ICFBamTableObj* scope = getRequiredContainerTable();
		return( scope );
	}

	cflib::ICFLibAnyObj* CFBamBoolColEditObj::getObjQualifier( const classcode_t* qualifyingClass ) {
	...
	cflib::ICFLibAnyObj* CFBamBoolColEditObj::getNamedObject( const classcode_t* qualifyingClass, const std::string& objName ) {
	...
	cflib::ICFLibAnyObj* CFBamBoolColEditObj::getNamedObject( const std::string& objName ) {
		std::string nextName;
	...
	std::string CFBamBoolColEditObj::getObjQualifiedName() {
	...
	std::string CFBamBoolColEditObj::getObjFullName() {
		const static std::string S_Dot( "." );
	...
	cfbam::ICFBamValueObj* CFBamBoolColEditObj::realize() {
		// We realize this so that it's buffer will get copied to orig during realization
		cfbam::ICFBamBoolColObj* retobj = getSchema()->getBoolColTableObj()->realizeBoolCol( dynamic_cast<cfbam::ICFBamBoolColObj*>( this ) );
		return( retobj );
	}

	cfbam::ICFBamValueObj* CFBamBoolColEditObj::moveUp() {
	...
	cfbam::ICFBamValueObj* CFBamBoolColEditObj::moveDown() {
	...
	cfbam::ICFBamValueObj* CFBamBoolColEditObj::create() {
		cfbam::ICFBamBoolColObj* retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsBoolCol()->getSchema() )->getBoolColTableObj()->createBoolCol( this );
		// Note that this instance is usually discarded during the creation process,
		// and retobj now references the cached instance of the created object.
		return( retobj );
	}

	cfbam::ICFBamValueEditObj* CFBamBoolColEditObj::update() {
		getSchema()->getBoolColTableObj()->updateBoolCol( this );
		return( NULL );
	}

	cfbam::ICFBamValueEditObj* CFBamBoolColEditObj::deleteInstance() {
		static const std::string S_MethodName( "deleteInstance" );
		static const std::string S_CannotDeleteNewInstance( "Cannot delete a new instance" );
		if( getIsNew() ) {
			throw cflib::CFLibUsageException( CLASS_NAME, S_MethodName, S_CannotDeleteNewInstance );
		}
		getSchema()->getBoolColTableObj()->deleteBoolCol( this );
		return( NULL );
	}

	cfbam::ICFBamBoolColTableObj* CFBamBoolColEditObj::getBoolColTable() {
		return( orig->getSchema()->getBoolColTableObj() );
	}

	cfbam::ICFBamBoolColEditObj* CFBamBoolColEditObj::getBoolColEdit() {
		return( (cfbam::ICFBamBoolColEditObj*)this );
	}

	cfbam::ICFBamValueEditObj* CFBamBoolColEditObj::beginEdit() {
	...
	cfbam::ICFBamBoolColObj* CFBamBoolColEditObj::getOrigAsBoolCol() {
		return( dynamic_cast<cfbam::ICFBamBoolColObj*>( orig ) );
	}

	cfbam::CFBamValueBuff* CFBamBoolColEditObj::getBuff() {
		return( buff );
	}

	void CFBamBoolColEditObj::setBuff( cfbam::CFBamValueBuff* value ) {
		if( buff != value ) {
			CFBamBoolDefEditObj::setBuff( value );
		}
	}

	const int64_t CFBamBoolColEditObj::getRequiredTableId() {
		return( getBoolColBuff()->getRequiredTableId() );
	}

	const int64_t* CFBamBoolColEditObj::getRequiredTableIdReference() {
		return( getBoolColBuff()->getRequiredTableIdReference() );
	}

	void CFBamBoolColEditObj::setRequiredContainerScope( cfbam::ICFBamScopeObj* value ) {
		if( value == NULL ) {
	...
	cfbam::ICFBamTableObj* CFBamBoolColEditObj::getRequiredContainerTable( bool forceRead ) {
		cfbam::ICFBamTableObj* retobj = NULL;
		bool anyMissing = false;
		if( ! anyMissing ) {
			retobj = dynamic_cast<cfbam::ICFBamSchemaObj*>( getOrigAsBoolCol()->getSchema() )->getTableTableObj()->readTableByIdIdx( getPKey()->getRequiredTenantId(),
					getBoolColBuff()->getRequiredTableId() );
		}
		return( retobj );
	}

	void CFBamBoolColEditObj::setRequiredContainerTable( cfbam::ICFBamTableObj* value ) {
			
			if( value != NULL ) {
				getPKey()->setRequiredTenantId
( value->getRequiredTenantId() );
				getBoolColEditBuff()->setRequiredTenantId( value->getRequiredTenantId() );
				getBoolColEditBuff()->setRequiredTableId( value->getRequiredId() );
			}

			CFBamBoolDefEditObj::setRequiredContainerScope( value );		}

	void CFBamBoolColEditObj::copyBuffToOrig() {
		cfbam::CFBamBoolColBuff* origBuff = getOrigAsBoolCol()->getBoolColEditBuff();
		cfbam::CFBamBoolColBuff* myBuff = getBoolColBuff();
		if( origBuff != myBuff ) {
			*origBuff = *myBuff;
		}
	}

	void CFBamBoolColEditObj::copyOrigToBuff() {
		cfbam::CFBamBoolColBuff* origBuff = getOrigAsBoolCol()->getBoolColBuff();
		cfbam::CFBamBoolColBuff* myBuff = getBoolColEditBuff();
		if( origBuff != myBuff ) {
			*myBuff = *origBuff;
		}
	}
