// Description: C++18 implementation for a DateCol buffer object.
...
namespace cfbam {
	...
	const std::string CFBamDateColBuff::GENDEFNAME( "DateCol" );
	const classcode_t CFBamDateColBuff::CLASS_CODE = 0xa854L;
	const std::string CFBamDateColBuff::CLASS_NAME( "CFBamDateColBuff" );
		const std::string CFBamDateColBuff::COLNAME_TABLEID( "TableId" );
	const int64_t CFBamDateColBuff::TENANTID_INIT_VALUE = 0LL;
	const int64_t CFBamDateColBuff::ID_INIT_VALUE = 0LL;
	const int64_t CFBamDateColBuff::TABLEID_INIT_VALUE = 0LL;
	const int64_t CFBamDateColBuff::TENANTID_MIN_VALUE = 0LL;
	const int64_t CFBamDateColBuff::ID_MIN_VALUE = 0LL;
	const int64_t CFBamDateColBuff::TABLEID_MIN_VALUE = 0LL;

	CFBamDateColBuff::CFBamDateColBuff()
	: CFBamDateDefBuff()
	{
		requiredTableId = cfbam::CFBamDateColBuff::TABLEID_INIT_VALUE;
	}

	CFBamDateColBuff::CFBamDateColBuff( const CFBamDateColBuff& src )
	: CFBamDateDefBuff()
	{
		requiredTableId = cfbam::CFBamDateColBuff::TABLEID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFBamDateColBuff::clone() {
		CFBamDateColBuff* copy = new CFBamDateColBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const std::string& CFBamDateColBuff::getClassName() const {
		return( CLASS_NAME );
	}

	const classcode_t CFBamDateColBuff::getClassCode() const {
		return( CLASS_CODE );
	}

	bool CFBamDateColBuff::implementsClassCode( const classcode_t argClassCode ) {
	...
	const int64_t CFBamDateColBuff::getRequiredTableId() const {
		return( requiredTableId );
	}

	const int64_t* CFBamDateColBuff::getRequiredTableIdReference() const {
		return( &requiredTableId );
	}

	void CFBamDateColBuff::setRequiredTableId( const int64_t value ) {
		static const std::string S_ProcName( "setRequiredTableId" );
		if( value < cfbam::CFBamDateColBuff::TABLEID_MIN_VALUE ) {
			throw cflib::CFLibArgumentUnderflowException( CLASS_NAME,
				S_ProcName,
				1,
				S_VALUE,
				value,
				cfbam::CFBamDateColBuff::TABLEID_MIN_VALUE );
		}
		requiredTableId = value;
	}

	size_t CFBamDateColBuff::hashCode() const {
		size_t hashCode = CFBamDateDefBuff::hashCode();
		hashCode = hashCode + (int)( getRequiredTableId() );
		return( hashCode );
	}

	CFBamDateColBuff CFBamDateColBuff::operator =( cfbam::CFBamDateColBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setCreatedByUserId( src.getCreatedByUserId() );
		setCreatedAt( src.getCreatedAt() );
	...
	CFBamDateColBuff CFBamDateColBuff::operator =( cfbam::CFBamDateColHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredScopeId( src.getRequiredScopeId() );
	...
	bool CFBamDateColBuff::operator <( const CFBamDateColByTableIdxKey& rhs ) {
	...
	bool CFBamDateColBuff::operator <( const CFBamValuePKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamDateColBuff::operator <( const CFBamValueHPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamDateColBuff::operator <( const CFBamDateColHBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFBamDateColBuff::operator <( const CFBamDateColBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFBamDateColBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFBamDateColBuff" );
...
namespace std {
	...
	bool operator <(const  cfbam::CFBamDateColBuff& lhs, const cfbam::CFBamDateColByTableIdxKey& rhs ) {
	...
	bool operator <(const  cfbam::CFBamDateColBuff& lhs, const cfbam::CFBamValuePKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamDateColBuff& lhs, const cfbam::CFBamValueHPKey& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamDateColBuff& lhs, const cfbam::CFBamDateColHBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool operator <(const  cfbam::CFBamDateColBuff& lhs, const cfbam::CFBamDateColBuff& rhs ) {
		if( lhs.getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( lhs.getRequiredTenantId() < rhs.getRequiredTenantId() ) {
