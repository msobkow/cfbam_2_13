// Description: C++18 Instance Edit Object interface implementation for CFBam Int64Col.
...
namespace cfbam {
	...
	const std::string ICFBamInt64ColEditObj::CLASS_NAME( "ICFBamInt64ColEditObj" );

	ICFBamInt64ColEditObj::ICFBamInt64ColEditObj()
